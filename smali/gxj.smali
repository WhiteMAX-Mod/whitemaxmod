...
# direct methods
.method public static a(Lws9;)Lwxe;
    .locals 31
    ...
    invoke-static {v9, v8, v12}, Ltej;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_3
    invoke-static {v7, v6, v12}, Ltej;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_8
    :try_start_4
    invoke-static {v1, v2, v3}, Lm1j;->o(Lws9;J)J
    ...
    instance-of v2, v1, Lr4c;

    if-eqz v2, :cond_2e

    check-cast v1, Lr4c;

    iget-boolean v2, v1, Lr4c;->Z:Z

    if-eqz v2, :cond_2e

    iget-object v2, v1, Lr4c;->u0:Ljava/lang/String;

    iput-object v2, v1, Lr4c;->o:Ljava/lang/String;
    ...
    invoke-direct/range {v16 .. v25}, Lwxe;-><init>(JLjava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/lang/Long;Ljava/lang/Long;J)V
...
.method public static final b(Likh;Ljava/lang/String;I)V
    .locals 0

    invoke-interface {p0, p1}, Likh;->findPath(Ljava/lang/String;)Lone/me/sdk/richvector/VectorPath;
    ...
    invoke-interface {p0}, Likh;->invalidatePath()V

    :cond_0
    return-void
.end method

.method public static final c(Likh;Ljava/lang/String;I)V
    .locals 0
