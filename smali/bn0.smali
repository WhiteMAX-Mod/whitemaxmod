...
.method public constructor <init>(Loof;)V
    ...
    invoke-direct {p0, p1}, Lct5;-><init>(Landroid/view/View;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lbn0;->r:Landroid/graphics/Rect;

    iput-object p1, p0, Lbn0;->q:Loof;
...
.method public final n(FF)I
    ...
    :goto_0
    iget-object v1, p0, Lbn0;->q:Loof;

    invoke-virtual {v1}, Ldn0;->getValues()Ljava/util/List;
    ...
    iget-object v2, p0, Lbn0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, v0, v2}, Ldn0;->u(ILandroid/graphics/Rect;)V
...
.method public final s(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2}, Ldn0;->s(IF)Z

    move-result p2

    if-eqz p2, :cond_8

    invoke-virtual {v0}, Ldn0;->v()V

    invoke-virtual {v0}, Landroid/view/View;->postInvalidate()V

    invoke-virtual {p0, p1}, Lct5;->p(I)V

    return v2

    :cond_3
    iget p3, v0, Ldn0;->i1:F
    ...
    :cond_7
    invoke-virtual {v0}, Ldn0;->getValues()Ljava/util/List;
    ...
    invoke-static {p2, p3, v1}, Lshj;->a(FFF)F
...
.method public final u(ILg5;)V
    ...
    invoke-virtual {v1}, Loof;->getValueFrom()F

    move-result v5

    invoke-virtual {v1}, Loof;->getValueTo()F
    ...
    sget v5, Lkid;->material_slider_value:I
    ...
    sget v4, Lkid;->material_slider_range_end:I
    ...
    sget v4, Lkid;->material_slider_range_start:I
    ...
    iget-object p2, p0, Lbn0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, p1, p2}, Ldn0;->u(ILandroid/graphics/Rect;)V
