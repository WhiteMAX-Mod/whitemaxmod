...
.method public constructor <init>(Lwnh;)V
    ...
    iput-object v0, p0, Lynh;->d:Ljava/util/HashSet;

    iput-object p1, p0, Lynh;->a:Lwnh;

    invoke-interface {p1}, Lwnh;->G()I
    ...
    iput-object v1, p0, Lynh;->b:Landroid/util/Range;

    invoke-interface {p1}, Lwnh;->S()I
    ...
    iput-object p1, p0, Lynh;->c:Landroid/util/Range;
...
.method public static a(Lwnh;Landroid/util/Size;)Lwnh;
    .locals 4

    instance-of v0, p0, Lynh;
    ...
    invoke-interface {p0, v0, v1}, Lwnh;->b(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lwnh;->T()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lwnh;->W()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lynh;-><init>(Lwnh;)V
    ...
    iget-object v0, v0, Lynh;->d:Ljava/util/HashSet;
...
.method public final O(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lynh;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lynh;->a:Lwnh;
    ...
    iget-object p1, p0, Lynh;->b:Landroid/util/Range;
...
.method public final R(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lynh;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Lynh;->c:Landroid/util/Range;
...
.method public final T()Landroid/util/Range;
    ...
    iget-object v0, p0, Lynh;->b:Landroid/util/Range;
...
.method public final U(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lwnh;->U(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lynh;->d:Ljava/util/HashSet;
...
.method public final W()Landroid/util/Range;
    ...
    iget-object v0, p0, Lynh;->c:Landroid/util/Range;
