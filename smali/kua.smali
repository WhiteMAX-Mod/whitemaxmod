...
.method public final b(Ljzg;)V
    ...
    iget-object v3, v0, Lkua;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v3, v1}, Luf7;->g(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v2, v3}, Ljua;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    invoke-static {v3}, Luf7;->d(Ljava/lang/Object;)I
    ...
    iget-object v7, v0, Lkua;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_6
    :goto_1
    iget-boolean v3, v0, Lkua;->g:Z

    if-eqz v3, :cond_8

    iget-object v3, v0, Lkua;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Liua;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_8
    :goto_2
    iget-boolean v1, v0, Lbva;->a:Z

    if-eqz v1, :cond_9

    iget-object v1, v0, Lbva;->d:Ljava/lang/Object;
    ...
    invoke-static {v2, v1}, Ljua;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Ljua;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
