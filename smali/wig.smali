...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object p1, p1, Lrbb;->a:Ljava/lang/String;

    new-instance v0, Lvig;

    const/4 v1, 0x0

    invoke-direct {v0, p1, p0, v1}, Lvig;-><init>(Ljava/lang/Object;Lwig;I)V

    iput-object v0, p0, Lwig;->a:Lvig;
    ...
    invoke-direct {p0}, Lwig;->getTheme()Lplb;
    ...
    iput-object p1, p0, Lwig;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget-object v2, v2, Ltyf;->b:Lzyf;

    iget v2, v2, Lzyf;->b:I

    invoke-virtual {v0, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object v0, p0, Lwig;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lwig;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lwig;->s0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lwig;->t0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lwig;)Lplb;
    .locals 0
...
.method private final getTheme()Lplb;
    .locals 3
    ...
    invoke-virtual {p0}, Lwig;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lrlb;->a(Ljava/lang/String;)Lrbb;
    ...
    invoke-virtual {v1, v2}, Lrbb;->a(Z)Lplb;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lwig;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lwig;->u0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lwig;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lwig;->v0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lwig;->w0:[Lp38;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lwig;->c:Lvig;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Lwig;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lwig;->s0:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lwig;->u0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lwig;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lwig;->t0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lwig;->v0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lplb;)V
    ...
    :goto_0
    iget-object v0, p0, Lwig;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lwig;->b:Landroid/graphics/drawable/GradientDrawable;
