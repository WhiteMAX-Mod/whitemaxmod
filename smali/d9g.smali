...
# virtual methods
.method public A(Ldp6;Ljava/lang/Object;)V
    .locals 11
    ...
    :goto_0
    iget-object v1, p2, Lhji;->b:Lnii;

    invoke-static {v1}, Lz8j;->m(Lnii;)I
    ...
    :cond_1
    invoke-interface {p1, v2, v1}, Lz4g;->i(ILjava/lang/String;)V

    :goto_1
    iget-object v1, p2, Lhji;->d:Ljava/lang/String;
    ...
    :cond_3
    invoke-interface {p1, v2, v1}, Lz4g;->c(I[B)V

    :goto_3
    iget-object v1, p2, Lhji;->f:Lyh4;
    ...
    iget-wide v2, p2, Lhji;->g:J

    invoke-interface {p1, v1, v2, v3}, Lz4g;->b(IJ)V

    const/16 v1, 0x8

    iget-wide v2, p2, Lhji;->h:J

    invoke-interface {p1, v1, v2, v3}, Lz4g;->b(IJ)V

    const/16 v1, 0x9

    iget-wide v2, p2, Lhji;->i:J
    ...
    invoke-interface {p1, v3, v1, v2}, Lz4g;->b(IJ)V

    iget-object v1, p2, Lhji;->l:Lah0;

    invoke-static {v1}, Lz8j;->a(Lah0;)I
    ...
    iget-wide v2, p2, Lhji;->m:J

    invoke-interface {p1, v1, v2, v3}, Lz4g;->b(IJ)V

    const/16 v1, 0xd

    iget-wide v2, p2, Lhji;->n:J

    invoke-interface {p1, v1, v2, v3}, Lz4g;->b(IJ)V

    const/16 v1, 0xe

    iget-wide v2, p2, Lhji;->o:J

    invoke-interface {p1, v1, v2, v3}, Lz4g;->b(IJ)V

    const/16 v1, 0xf

    iget-wide v2, p2, Lhji;->p:J

    invoke-interface {p1, v1, v2, v3}, Lz4g;->b(IJ)V

    iget-boolean v1, p2, Lhji;->q:Z
    ...
    iget-object v1, p2, Lhji;->r:Lxqb;

    invoke-static {v1}, Lz8j;->j(Lxqb;)I
    ...
    invoke-static {v9}, Lz8j;->i(I)I

    move-result v9

    int-to-long v9, v9

    invoke-interface {p1, v8, v9, v10}, Lz4g;->b(IJ)V

    iget-boolean v8, p2, Lvx3;->b:Z

    int-to-long v8, v8

    invoke-interface {p1, v7, v8, v9}, Lz4g;->b(IJ)V

    iget-boolean v7, p2, Lvx3;->c:Z

    int-to-long v7, v7

    invoke-interface {p1, v6, v7, v8}, Lz4g;->b(IJ)V

    iget-boolean v6, p2, Lvx3;->d:Z

    int-to-long v6, v6

    invoke-interface {p1, v5, v6, v7}, Lz4g;->b(IJ)V

    iget-boolean v5, p2, Lvx3;->e:Z

    int-to-long v5, v5

    invoke-interface {p1, v4, v5, v6}, Lz4g;->b(IJ)V

    iget-wide v4, p2, Lvx3;->f:J

    invoke-interface {p1, v3, v4, v5}, Lz4g;->b(IJ)V

    iget-wide v3, p2, Lvx3;->g:J
    ...
    invoke-interface {p1, v1, p2}, Lz4g;->c(I[B)V

    goto :goto_5

    :cond_5
    invoke-interface {p1, v8}, Lz4g;->e(I)V
    ...
    invoke-interface {p1, p2}, Lz4g;->e(I)V

    return-void

    :cond_6
    invoke-interface {p1, p2, v0}, Lz4g;->i(ILjava/lang/String;)V
