...
# static fields
.field public static volatile a:Lcec;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Llf;->b:Ljava/util/Map;
    ...
    sget-object v5, Llf;->a:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    sget-boolean v0, Lof;->e:Z

    if-eqz v0, :cond_11

    new-instance v2, Lof;

    invoke-direct {v2}, Lof;-><init>()V
    ...
    invoke-direct/range {v6 .. v11}, Lty7;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    :try_end_1
    ...
    sput-object v0, Lcec;->b:Ljava/util/logging/Logger;
...
.method public static i(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_0
    sget-object v0, Lcec;->b:Ljava/util/logging/Logger;
...
.method public b(Ljavax/net/ssl/X509TrustManager;)Lrlj;
    .locals 1

    new-instance v0, Lao0;

    invoke-virtual {p0, p1}, Lcec;->c(Ljavax/net/ssl/X509TrustManager;)Lw2h;

    move-result-object p1

    invoke-direct {v0, p1}, Lao0;-><init>(Lw2h;)V

    return-object v0
.end method

.method public c(Ljavax/net/ssl/X509TrustManager;)Lw2h;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lgo0;-><init>([Ljava/security/cert/X509Certificate;)V
...
.method public j(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v0, p2, p1}, Lcec;->i(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method public l(Ljavax/net/ssl/X509TrustManager;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    invoke-virtual {p0}, Lcec;->k()Ljavax/net/ssl/SSLContext;
