...
.method public constructor <init>(Lje9;)V
    ...
    iput-object v0, p0, Lt62;->a:Ljava/util/LinkedHashMap;
    ...
    iput-object v0, p0, Lt62;->b:Ljava/util/TreeMap;
    ...
    invoke-virtual {p1, v5}, Lje9;->u(I)Lej5;
    ...
    invoke-interface {v5}, Lej5;->d()Ljava/util/List;
    ...
    :cond_1
    invoke-interface {v5}, Lej5;->a()I

    move-result v8

    invoke-interface {v5}, Lej5;->b()I

    move-result v9

    invoke-interface {v5}, Lej5;->c()Ljava/util/List;
    ...
    invoke-static {v10, v7}, Ljkj;->a(Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v7 .. v13}, Lid0;-><init>(IILjava/util/List;Ljava/util/List;Lya0;Lab0;)V
    ...
    invoke-static {v4, v1}, Lm5j;->n(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    :cond_3
    iget-object v4, v3, Lid0;->f:Lab0;
    ...
    :cond_4
    iget-object p1, p0, Lt62;->a:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v4, p1}, Lm5j;->b(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v3, p0, Lt62;->d:Lid0;

    iput-object v3, p0, Lt62;->c:Lid0;
    ...
    iget-object v0, p0, Lt62;->a:Ljava/util/LinkedHashMap;
...
# virtual methods
.method public final a(Lgc0;)Lid0;
    .locals 3
