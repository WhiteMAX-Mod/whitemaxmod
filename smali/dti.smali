...
.method public static d(Ljava/lang/String;Z)Landroid/graphics/Point;
    ...
    invoke-direct {p1, p0}, Lko5;-><init>(Ljava/lang/String;)V

    const-string v1, "Orientation"

    invoke-virtual {p1, v0, v1}, Lko5;->e(ILjava/lang/String;)I
...
.method public static g(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0}, Ldti;->h(Ljava/lang/String;)Ljava/lang/String;
...
.method public static i(Ldqe;Ljava/lang/String;)V
    .locals 8

    new-instance v0, Lko5;

    invoke-direct {v0, p1}, Lko5;-><init>(Ljava/lang/String;)V

    const-string v1, "Orientation"

    const/4 v2, 0x1

    invoke-virtual {v0, v2, v1}, Lko5;->e(ILjava/lang/String;)I

    move-result v0

    invoke-static {v0}, Ldti;->f(I)I
    ...
    invoke-virtual {p0}, Lncc;->r()I

    move-result p0

    sget-object v1, Landroid/graphics/Bitmap$CompressFormat;->JPEG:Landroid/graphics/Bitmap$CompressFormat;

    invoke-static {p1, v0, p0, v1}, Ldti;->l(Ljava/lang/String;Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static j(Ldqe;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 17
    ...
    invoke-virtual {v2, v6, v4, v5}, Lncc;->m(Ljava/lang/Enum;J)J
    ...
    invoke-static {v0, v5}, Ldti;->d(Ljava/lang/String;Z)Landroid/graphics/Point;
    ...
    invoke-direct {v7, v0}, Lko5;-><init>(Ljava/lang/String;)V

    const/4 v8, 0x1

    const-string v9, "Orientation"

    invoke-virtual {v7, v8, v9}, Lko5;->e(ILjava/lang/String;)I
    ...
    invoke-static {v6, v3, v4}, Ldti;->e(Landroid/graphics/Point;II)I
    ...
    invoke-static {v1, v3, v2, v0}, Ldti;->l(Ljava/lang/String;Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;)V
    :try_end_0
    ...
    invoke-direct {v2, v1}, Lko5;-><init>(Ljava/lang/String;)V

    invoke-static {v7}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v2, v9, v0}, Lko5;->F(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, v2, Lko5;->b:Ljava/io/FileDescriptor;

    if-nez v0, :cond_5

    iget-object v0, v2, Lko5;->a:Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget-boolean v0, v2, Lko5;->h:Z

    if-eqz v0, :cond_7

    iget-boolean v0, v2, Lko5;->i:Z

    if-eqz v0, :cond_7

    iget-boolean v0, v2, Lko5;->j:Z
    ...
    :cond_9
    :goto_3
    invoke-virtual {v2}, Lko5;->o()[B

    move-result-object v0

    :goto_4
    iput-object v0, v2, Lko5;->m:[B
    ...
    iget-object v12, v2, Lko5;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v10, v11, v12}, Llo5;->c(Ljava/io/FileDescriptor;JI)J

    new-instance v0, Ljava/io/FileInputStream;

    iget-object v12, v2, Lko5;->b:Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-static {v12, v13}, Lgoj;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_8
    .catchall {:try_start_3 .. :try_end_3} :catchall_7

    invoke-static {v12}, Lgoj;->c(Ljava/io/Closeable;)V

    invoke-static {v13}, Lgoj;->c(Ljava/io/Closeable;)V
    ...
    iget-object v13, v2, Lko5;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v10, v11, v13}, Llo5;->c(Ljava/io/FileDescriptor;JI)J

    new-instance v0, Ljava/io/FileOutputStream;

    iget-object v13, v2, Lko5;->b:Ljava/io/FileDescriptor;
    ...
    invoke-virtual {v2, v14, v15}, Lko5;->C(Ljava/io/BufferedInputStream;Ljava/io/BufferedOutputStream;)V
    ...
    invoke-virtual {v2, v14, v15}, Lko5;->D(Ljava/io/BufferedInputStream;Ljava/io/BufferedOutputStream;)V
    ...
    invoke-virtual {v2, v14, v15}, Lko5;->E(Ljava/io/BufferedInputStream;Ljava/io/BufferedOutputStream;)V
    :try_end_8
    ...
    :cond_e
    :goto_c
    invoke-static {v14}, Lgoj;->c(Ljava/io/Closeable;)V

    invoke-static {v15}, Lgoj;->c(Ljava/io/Closeable;)V

    invoke-virtual {v7}, Ljava/io/File;->delete()Z

    iput-object v9, v2, Lko5;->m:[B
    ...
    :try_start_a
    iget-object v4, v2, Lko5;->a:Ljava/lang/String;

    if-nez v4, :cond_f

    iget-object v4, v2, Lko5;->b:Ljava/io/FileDescriptor;

    sget v6, Landroid/system/OsConstants;->SEEK_SET:I

    invoke-static {v4, v10, v11, v6}, Llo5;->c(Ljava/io/FileDescriptor;JI)J

    new-instance v4, Ljava/io/FileOutputStream;

    iget-object v2, v2, Lko5;->b:Ljava/io/FileDescriptor;
    ...
    iget-object v2, v2, Lko5;->a:Ljava/lang/String;
    ...
    :goto_f
    invoke-static {v3, v13}, Lgoj;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_a
    ...
    :goto_11
    :try_start_d
    invoke-static {v9}, Lgoj;->c(Ljava/io/Closeable;)V
...
.method public static l(Ljava/lang/String;Landroid/graphics/Bitmap;ILandroid/graphics/Bitmap$CompressFormat;)V
    .locals 3
    ...
    invoke-static {v0, p1, p0}, Lm4j;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    :goto_1
    invoke-static {v1}, Lsoj;->d(Ljava/io/Closeable;)V
...
.method public static n(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Ldti;->b:Landroid/os/Handler;
    ...
    sput-object v0, Ldti;->b:Landroid/os/Handler;
    ...
    invoke-direct {v1, p1, p2, p0, v2}, Lpp1;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V
...
.method public static o(IILandroid/content/Context;)Landroid/graphics/Bitmap;
    .locals 3
...
.method public abstract b()Lef9;
.end method

.method public abstract p(Llx0;)V
.end method
