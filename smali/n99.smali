...
.method public constructor <init>(Landroidx/mediarouter/app/d;)V
    ...
    iput-object p1, p0, Ln99;->a:Landroidx/mediarouter/app/d;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Ln99;->a:Landroidx/mediarouter/app/d;

    iget-object v1, v0, Landroidx/mediarouter/app/d;->w1:Landroid/view/accessibility/AccessibilityManager;
    ...
    :cond_0
    sget v3, Lr6d;->mr_control_playback_ctrl:I

    if-ne p1, v3, :cond_5

    iget-object p1, v0, Landroidx/mediarouter/app/d;->b1:Landroid/support/v4/media/session/MediaControllerCompat;

    if-eqz p1, :cond_6

    iget-object p1, v0, Landroidx/mediarouter/app/d;->d1:Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iget-object v2, v0, Landroidx/mediarouter/app/d;->t0:Landroid/content/Context;
    ...
    :cond_7
    :goto_2
    iget-object v1, v0, Landroidx/mediarouter/app/d;->s0:Lua9;

    invoke-virtual {v1}, Lua9;->g()Z

    move-result v1

    if-eqz v1, :cond_9

    iget-object v1, v0, Landroidx/mediarouter/app/d;->Y:Lva9;
