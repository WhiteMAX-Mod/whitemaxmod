...
.method public static c(Landroid/media/MediaRoute2Info;)Lr99;
    .locals 10
    ...
    invoke-static {p0}, Lc5;->s(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lv89;->i(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Ldii;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Ldii;->b:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Lv89;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lv89;->w(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lv89;->B(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lv89;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lc5;->k(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lv89;->y(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Lv89;->h(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Ldii;->d(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Ldii;->h()Lr99;
...
.method public static e(Ljava/lang/String;Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p1, p0}, Lw8j;->f(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;
