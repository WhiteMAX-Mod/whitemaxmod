...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lv60;->m:J

    return-void
.end method

.method public constructor <init>(Lga0;Landroid/content/Context;)V
    .locals 9
    ...
    iput-object v0, p0, Lv60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lv60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lv60;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lv60;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lv60;->b(ILga0;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lv60;->a:Landroid/media/AudioRecord;
...
.method public static b(ILga0;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
    ...
    invoke-static {v2, p2}, Lkl;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lv60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lv60;->i:Luoe;

    iget-object v1, p0, Lv60;->h:Lr60;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Lv60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v3, v1, p1}, Lti;-><init>(ILjava/lang/Object;Z)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lv60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Lv60;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lv60;->j:J

    iput-boolean v4, p0, Lv60;->l:Z

    iget-object v0, p0, Lv60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, Lv60;->a:Landroid/media/AudioRecord;

    invoke-static {v0}, Ljl;->b(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;
    ...
    :cond_4
    invoke-virtual {p0, v4}, Lv60;->c(Z)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lja0;
    ...
    iget-object v5, p0, Lv60;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lv60;->b:Lga0;

    iget v5, v5, Lga0;->b:I

    iget-wide v7, p0, Lv60;->j:J
    ...
    invoke-static {v11, v9}, Lpjj;->a(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v7, v8}, Lit8;->a(IJ)J
    ...
    sget-wide v7, Lv60;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_5

    iput-boolean v10, p0, Lv60;->l:Z
    ...
    invoke-static {p1, v1}, Lw4j;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    iget-wide v3, p0, Lv60;->j:J

    int-to-long v5, v0

    iget p1, p0, Lv60;->g:I

    invoke-static {p1, v5, v6}, Lit8;->h(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lv60;->j:J

    :cond_7
    new-instance p1, Lja0;

    invoke-direct {p1, v0, v1, v2}, Lja0;-><init>(IJ)V
