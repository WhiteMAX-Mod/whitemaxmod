...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lugg;->o:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lzqi;)V
    ...
    invoke-direct {v1, p1}, Ltgg;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lugg;->a:Landroid/content/Context;

    iput-object p2, p0, Lugg;->c:Lzqi;

    iput-object v0, p0, Lugg;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lugg;->d:Ltgg;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lugg;->o:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lm0j;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lugg;->o:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lm0j;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lsqi;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lsqi;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lugg;->a:Landroid/content/Context;

    iget-object v1, p0, Lugg;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lugg;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lugg;->f(Landroid/app/job/JobInfo;)Lsqi;
    ...
    invoke-static {v1, v2}, Lugg;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lugg;->c:Lzqi;

    iget-object v0, v0, Lzqi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->A()Lsgg;
    ...
    invoke-virtual {v0, v2}, Le3;->q(Lbr6;)V
...
.method public final varargs e([Lori;)V
    ...
    iget-object v7, v5, Lori;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lqri;->p(Ljava/lang/String;)Lori;
    ...
    sget-object v9, Lugg;->o:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lm0j;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lchj;->b(Lori;)Lsqi;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->A()Lsgg;

    move-result-object v7

    invoke-virtual {v7, v6}, Lsgg;->z(Lsqi;)Lqgg;
    ...
    iget-object v9, v2, Le05;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lrg7;

    invoke-direct {v10, v2, v8}, Lrg7;-><init>(Le05;I)V

    invoke-virtual {v9, v10}, Lm8e;->u(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lsqi;->a:Ljava/lang/String;

    iget v6, v6, Lsqi;->b:I

    invoke-direct {v7, v9, v6, v8}, Lqgg;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lzqi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->A()Lsgg;

    move-result-object v6

    invoke-virtual {v6, v7}, Lsgg;->A(Lqgg;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lugg;->g(Lori;I)V
...
.method public final g(Lori;I)V
    .locals 18
    ...
    iget-object v3, v1, Lugg;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lugg;->d:Ltgg;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lori;->j:Lny3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lori;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Lykc;->p(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Ltgg;->b:Ljava/lang/String;

    invoke-static {v6}, Ldna;->j(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lm0j;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lori;->l:Loi0;

    sget-object v8, Loi0;->b:Loi0;
    ...
    :cond_7
    iget-boolean v10, v2, Lori;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Lykc;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-boolean v11, v10, Lmy3;->b:Z

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v10, v10, Lmy3;->a:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lj79;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lm0j;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lm0j;->p(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lori;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lori;->r:Lktb;
    ...
    invoke-virtual {v5, v9, v4}, Lm0j;->c(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lugg;->g(Lori;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lm0j;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lugg;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lugg;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Lugg;->c:Lzqi;

    iget-object v5, v4, Lzqi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->D()Lqri;

    move-result-object v5

    invoke-virtual {v5}, Lqri;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lm0j;->e(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lzqi;->b:Lus3;
