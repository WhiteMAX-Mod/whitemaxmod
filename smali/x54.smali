...
.method public constructor <init>(Landroid/content/Context;Ly44;)V
    ...
    invoke-direct {v1, p1}, Lpeb;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v1}, Ltsd;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lx54;->F0:Ly44;

    iput-object v0, p0, Lx54;->G0:Laj0;
    ...
    invoke-virtual {v1, p1}, Lpeb;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Ljn1;

    const/4 p2, 0x1

    invoke-direct {p1, p2, p0}, Ljn1;-><init>(ILjava/lang/Object;)V
