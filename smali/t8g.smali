...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lt8g;->o:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lwhi;)V
    ...
    invoke-direct {v1, p1}, Ls8g;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lt8g;->a:Landroid/content/Context;

    iput-object p2, p0, Lt8g;->c:Lwhi;

    iput-object v0, p0, Lt8g;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lt8g;->d:Ls8g;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lt8g;->o:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lwki;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lt8g;->o:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lwki;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lphi;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lphi;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lt8g;->a:Landroid/content/Context;

    iget-object v1, p0, Lt8g;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lt8g;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lt8g;->f(Landroid/app/job/JobInfo;)Lphi;
    ...
    invoke-static {v1, v2}, Lt8g;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lt8g;->c:Lwhi;

    iget-object v0, v0, Lwhi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->x()Lr8g;
    ...
    invoke-virtual {v0, v2}, Lg3;->s(Lgp6;)V
...
.method public final varargs e([Lkii;)V
    ...
    iget-object v7, v5, Lkii;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lmii;->p(Ljava/lang/String;)Lkii;
    ...
    sget-object v9, Lt8g;->o:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lwki;->r(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lr7j;->b(Lkii;)Lphi;
    ...
    invoke-virtual {v7, v6}, Lr8g;->j(Lphi;)Lp8g;
    ...
    iget-object v9, v2, Lxp8;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lug7;

    invoke-direct {v10, v2, v8}, Lug7;-><init>(Lxp8;I)V

    invoke-virtual {v9, v10}, Le1e;->r(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lphi;->a:Ljava/lang/String;

    iget v6, v6, Lphi;->b:I

    invoke-direct {v7, v9, v6, v8}, Lp8g;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lwhi;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->x()Lr8g;

    move-result-object v6

    invoke-virtual {v6, v7}, Lr8g;->n(Lp8g;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lt8g;->g(Lkii;I)V
...
.method public final g(Lkii;I)V
    .locals 18
    ...
    iget-object v3, v1, Lt8g;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lt8g;->d:Ls8g;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lkii;->j:Lpx3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lkii;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Lzec;->p(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Ls8g;->b:Ljava/lang/String;

    invoke-static {v6}, Lgg9;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lwki;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lkii;->l:Lah0;

    sget-object v8, Lah0;->b:Lah0;
    ...
    :cond_7
    iget-boolean v10, v2, Lkii;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Lzec;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-boolean v11, v10, Lox3;->b:Z

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v10, v10, Lox3;->a:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lk69;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lwki;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lwki;->r(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lkii;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lkii;->r:Llqb;

    sget-object v5, Llqb;->a:Llqb;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Lwki;->f(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lt8g;->g(Lkii;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lwki;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lt8g;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lt8g;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lmii;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lwki;->h(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lwhi;->b:Las3;
