...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, Luad;->checkedTextViewStyle:I
    ...
    iput-object p1, p0, Lgp;->c:Lcr;

    invoke-virtual {p1, p2, v6}, Lcr;->f(Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lgp;->b:Lla;

    invoke-virtual {p1, p2, v6}, Lla;->v(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v0, v6}, Lsri;->r(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lsri;
    ...
    sget-object v3, Lkmd;->CheckedTextView:[I
    ...
    :try_start_0
    sget p2, Lkmd;->CheckedTextView_checkMarkCompat:I
    ...
    invoke-static {v3, p2}, Lbej;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Lgp;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    sget p2, Lkmd;->CheckedTextView_android_checkMark:I
    ...
    invoke-static {v2, p2}, Lbej;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    sget p2, Lkmd;->CheckedTextView_checkMarkTint:I
    ...
    :cond_2
    sget p2, Lkmd;->CheckedTextView_checkMarkTintMode:I
    ...
    invoke-static {p2, v0}, Lq95;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {p0}, Lgp;->getEmojiTextViewHelper()Ldq;

    move-result-object p1

    invoke-virtual {p1, v4, v6}, Ldq;->c(Landroid/util/AttributeSet;I)V
...
.method public setCheckMarkDrawable(I)V
    ...
    invoke-virtual {p0, p1}, Lgp;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
