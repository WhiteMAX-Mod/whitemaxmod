...
.method public static b(Lb3b;)Ljava/nio/ByteBuffer;
    .locals 7

    iget-object v0, p0, Lb3b;->b:Ljava/nio/ByteBuffer;
...
.method public static d(Landroid/text/Spannable;Ljava/lang/String;IIILgb2;I)V
    .locals 1
    ...
    :cond_1
    new-instance p6, Lue8;

    invoke-direct {p6, p1, p4, v0}, Lue8;-><init>(Ljava/lang/String;IZ)V

    iput-object p5, p6, Lue8;->d:Lte8;

    const/16 p1, 0x21

    invoke-static {p0, p6, p2, p3, p1}, Lchj;->c(Landroid/text/Spannable;Lxu8;III)V
...
.method public static final e(Landroid/text/Spannable;II)V
    ...
    invoke-static {p0, v3, p1, p2}, Lahj;->h(Landroid/text/Spannable;Lxu8;II)V
...
.method public static final f(Landroid/content/Context;)V
    ...
    sget-object v2, Lpqi;->a:Ljava/lang/String;
    ...
    sget-object p0, Lpqi;->b:[Ljava/lang/String;
    ...
    sget-object v3, Lpqi;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v4}, Lm0j;->p(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static final g(Landroid/text/Editable;IIZLxu8;)V
    .locals 5
    ...
    invoke-static {p0, p4, p1, p2, p3}, Lchj;->c(Landroid/text/Spannable;Lxu8;III)V
    ...
    invoke-static {p0, p4, p1, p2}, Lahj;->h(Landroid/text/Spannable;Lxu8;II)V
...
.method public static final h(Landroid/text/Spannable;Lxu8;II)V
    .locals 4
    ...
    invoke-interface {p1}, Lrc4;->copy()Lrc4;
...
.method public static j(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Lfe5;->p(Ljava/lang/CharSequence;)Ltrf;
