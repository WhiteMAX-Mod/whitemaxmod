...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lk1i;-><init>(I)V
...
.method public static I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;IIZ)V
    .locals 7
    ...
    invoke-virtual {p1, p2}, Lap;->h(Landroid/view/View;)Z

    move-result v3

    :cond_4
    invoke-virtual {p1, v3}, Lap;->g(Z)Z
    ...
    iget-object p0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lb5b;

    iget-object p0, p0, Lb5b;->c:Ljava/lang/Object;

    check-cast p0, Lblf;

    invoke-virtual {p0, p1}, Lblf;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
# virtual methods
.method public A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;II[II)V
    .locals 6
    ...
    invoke-virtual {p2}, Lap;->getTotalScrollRange()I

    move-result p4

    neg-int p4, p4

    invoke-virtual {p2}, Lap;->getDownNestedPreScrollRange()I
    ...
    :cond_0
    invoke-virtual {p2}, Lap;->getUpNestedPreScrollRange()I
    ...
    :goto_2
    iget-boolean p1, v2, Lap;->y0:Z

    if-eqz p1, :cond_2

    invoke-virtual {v2, p3}, Lap;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {v2, p1}, Lap;->g(Z)Z

    :cond_2
    return-void
.end method

.method public B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;IIIII[I)V
    .locals 6

    if-gez p7, :cond_0

    invoke-virtual {p2}, Lap;->getDownNestedScrollRange()I
    ...
    invoke-static {v1}, Lh0i;->d(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p1, p0, v2, v1}, Lvo;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Lap;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, p1}, Lh0i;->n(Landroid/view/View;Lt4;)V
...
.method public C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;Landroid/view/View;II)Z
    .locals 0
...
.method public D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;I)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;)V

    iget-boolean p1, p2, Lap;->y0:Z

    if-eqz p1, :cond_1

    invoke-virtual {p2, p3}, Lap;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p2, p1}, Lap;->g(Z)Z
...
.method public final E(Landroid/os/Parcelable;Lap;)Lwo;
    .locals 7

    invoke-virtual {p0}, Lk1i;->t()I
    ...
    invoke-virtual {p2}, Lap;->getTopInset()I
...
.method public final F(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, Lshj;->b(III)I

    move-result v2

    if-eq v4, v2, :cond_d

    iget-boolean v6, v3, Lap;->o:Z
    ...
    iget-object v11, v10, Lyo;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v3}, Lap;->getTopInset()I
    ...
    :goto_2
    invoke-virtual {v0, v8}, Lk1i;->v(I)Z
    ...
    iget-object v11, v10, Lyo;->b:Laoi;

    if-eqz v11, :cond_7

    iget v10, v10, Lyo;->a:I
    ...
    invoke-virtual {v0}, Lk1i;->t()I

    move-result v12

    int-to-float v12, v12

    iget-object v13, v11, Laoi;->c:Ljava/lang/Object;

    check-cast v13, Landroid/graphics/Rect;

    iget-object v11, v11, Laoi;->b:Ljava/lang/Object;
    ...
    invoke-static {v15, v12, v8}, Lshj;->a(FFF)F
    ...
    iget-object v6, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lb5b;

    iget-object v6, v6, Lb5b;->c:Ljava/lang/Object;

    check-cast v6, Lblf;

    invoke-virtual {v6, v3}, Lblf;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v1, v9, v3}, Llc4;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v6}, Lap;->e(I)V
    ...
    :goto_7
    invoke-static {v1, v3, v2, v8, v5}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;IIZ)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lvo;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Lap;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, v2}, Lh0i;->n(Landroid/view/View;Lt4;)V
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;)V
    .locals 12
    ...
    invoke-static {v8, v0, v3}, Lshj;->b(III)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->x(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;I)V
...
.method public final h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-super {p0, p1, p2, p3}, Lk1i;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z

    invoke-virtual {p2}, Lap;->getPendingAction()I

    move-result p3

    iget-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lwo;
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lwo;

    iget-boolean v3, v3, Lwo;->Y:Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->x(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;I)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->x(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lwo;
    ...
    invoke-static {p3, v0, v1}, Lshj;->b(III)I

    move-result p3

    invoke-virtual {p0, p3}, Lk1i;->v(I)Z

    invoke-virtual {p0}, Lk1i;->t()I

    move-result p3

    invoke-static {p1, p2, p3, v1, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;IIZ)V

    invoke-virtual {p0}, Lk1i;->t()I

    move-result p3

    invoke-virtual {p2, p3}, Lap;->e(I)V
    ...
    invoke-direct {p3, p0, p2, p1}, Lvo;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Lap;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {p1, p3}, Lh0i;->n(Landroid/view/View;Lt4;)V
...
.method public bridge synthetic k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;II[II)V
...
.method public bridge synthetic l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual/range {p0 .. p9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;IIIII[I)V
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    instance-of p1, p2, Lwo;

    if-eqz p1, :cond_0

    check-cast p2, Lwo;

    iput-object p2, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lwo;
    ...
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lwo;
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->E(Landroid/os/Parcelable;Lap;)Lwo;
...
.method public bridge synthetic q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;Landroid/view/View;II)Z
...
.method public bridge synthetic r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;Landroid/view/View;I)V
...
.method public final s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Lap;->getDownNestedScrollRange()I

    move-result v3

    neg-int v3, v3

    invoke-virtual {v1}, Lap;->getTopInset()I
    ...
    invoke-virtual {v9}, Lap;->getTotalScrollRange()I

    move-result v10

    neg-int v10, v10

    iget-object v11, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lpb;

    if-eqz v11, :cond_5

    invoke-virtual {v4, v11}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v2, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lpb;
    ...
    invoke-direct {v5, v0, v1, v4}, Lpb;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V

    iput-object v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lpb;
    ...
    :cond_7
    invoke-virtual {v0, v1, v9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;)V

    iget-boolean v4, v9, Lap;->y0:Z
    ...
    invoke-virtual {v9, v1}, Lap;->h(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v9, v1}, Lap;->g(Z)Z
...
.method public final x(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lap;I)V
    .locals 5
    ...
    sget-object v3, Lfi;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-direct {v3, p0, p1, p2, v4}, Luo;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/view/View;I)V
