...
.method public static C([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, v2}, Lms;-><init>([Ljava/lang/Object;Z)V
...
.method public static E([Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-static {p0, v0}, Lct;->A([Ljava/lang/Object;Ljava/util/HashSet;)V
...
.method public static f([Ljava/lang/Object;)Lfpe;
    .locals 2
...
.method public static i([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {p0, p1}, Lct;->x([Ljava/lang/Object;Ljava/lang/Object;)I
...
.method public static j([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    invoke-static {v4, v5}, Lct;->j([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    :cond_c
    instance-of v6, v4, Lt1h;

    const/4 v7, 0x0

    if-eqz v6, :cond_f

    instance-of v6, v5, Lt1h;

    if-eqz v6, :cond_f

    check-cast v4, Lt1h;

    iget-object v4, v4, Lt1h;->a:[B

    check-cast v5, Lt1h;

    iget-object v5, v5, Lt1h;->a:[B
    ...
    :cond_f
    instance-of v6, v4, Li2h;

    if-eqz v6, :cond_12

    instance-of v6, v5, Li2h;

    if-eqz v6, :cond_12

    check-cast v4, Li2h;

    iget-object v4, v4, Li2h;->a:[S

    check-cast v5, Li2h;

    iget-object v5, v5, Li2h;->a:[S
    ...
    :cond_12
    instance-of v6, v4, Ly1h;

    if-eqz v6, :cond_15

    instance-of v6, v5, Ly1h;

    if-eqz v6, :cond_15

    check-cast v4, Ly1h;

    iget-object v4, v4, Ly1h;->a:[I

    check-cast v5, Ly1h;

    iget-object v5, v5, Ly1h;->a:[I
    ...
    :cond_15
    instance-of v6, v4, Ld2h;

    if-eqz v6, :cond_18

    instance-of v6, v5, Ld2h;

    if-eqz v6, :cond_18

    check-cast v4, Ld2h;

    iget-object v4, v4, Ld2h;->a:[J

    check-cast v5, Ld2h;

    iget-object v5, v5, Ld2h;->a:[J
...
.method public static o(I[BI)[B
    ...
    invoke-static {p2, v0}, Lu5j;->d(II)V
...
.method public static z([Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p2, v5, v6}, Lsia;->b(Ljava/lang/StringBuilder;Ljava/lang/Object;Lnq6;)V
