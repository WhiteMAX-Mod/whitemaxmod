...
.method public constructor <init>(Lb5f;)V
    ...
    invoke-direct {p0}, Le5f;-><init>()V

    iput-object p1, p0, Lz4f;->c:Lb5f;
...
# virtual methods
.method public final a(Landroid/graphics/Matrix;Lu4f;ILandroid/graphics/Canvas;)V
    .locals 22
    ...
    iget v10, v4, Lb5f;->d:F

    iget v4, v4, Lb5f;->e:F

    invoke-direct {v7, v8, v9, v10, v4}, Landroid/graphics/RectF;-><init>(FFFF)V

    iget-object v8, v0, Lu4f;->b:Landroid/graphics/Paint;
    ...
    :goto_0
    iget-object v12, v0, Lu4f;->g:Landroid/graphics/Path;

    const/4 v13, 0x3

    const/4 v14, 0x2

    sget-object v19, Lu4f;->k:[I

    if-eqz v9, :cond_1

    aput v11, v19, v11

    iget v11, v0, Lu4f;->f:I

    aput v11, v19, v10

    iget v11, v0, Lu4f;->e:I

    aput v11, v19, v14

    iget v11, v0, Lu4f;->d:I
    ...
    iget-object v0, v0, Lu4f;->h:Landroid/graphics/Paint;
