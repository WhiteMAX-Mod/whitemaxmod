...
.method public constructor <init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;Landroid/view/View;I)V
    ...
    iput-object p2, p0, Lkp;->c:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v4, p0, Lkp;->d:Ljava/lang/Object;

    iget-object v5, p0, Lkp;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v5, v4, v3}, Lq8g;->b(Landroid/content/Intent;I)V
    ...
    iget-boolean v0, v4, Ltd8;->c:Z

    const-string v6, "Less than 0 remaining futures"

    iget-object v7, v4, Ltd8;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object v8, v4, Ltd8;->b:Ljava/util/ArrayList;

    invoke-virtual {v4}, Ltd8;->isDone()Z
    ...
    invoke-static {v11, v10}, Ljkj;->f(Ljava/lang/String;Z)V

    invoke-static {v5}, Lnge;->f(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    :cond_3
    invoke-static {v6, v2}, Ljkj;->f(Ljava/lang/String;Z)V

    if-nez v0, :cond_10

    iget-object v0, v4, Ltd8;->b:Ljava/util/ArrayList;

    if-eqz v0, :cond_4

    iget-object v1, v4, Ltd8;->X:Lqw1;
    ...
    :try_start_2
    iget-object v0, v4, Ltd8;->X:Lqw1;

    invoke-virtual {v0, v3}, Lqw1;->d(Ljava/lang/Throwable;)Z
    :try_end_2
    ...
    :try_start_4
    invoke-virtual {v4, v2}, Ltd8;->cancel(Z)Z
    :try_end_4
    ...
    iget-object v2, v4, Ltd8;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v3}, Lqw1;->b(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, Ljkj;->f(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v4, v3, v5}, Landroidx/biometric/BiometricFragment;->v0(ILjava/lang/CharSequence;)V
