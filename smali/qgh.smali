...
.method public synthetic constructor <init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iput-object p1, p0, Lqgh;->b:Ljava/lang/Object;

    iput-object p3, p0, Lqgh;->c:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v0, v1, Lqgh;->b:Ljava/lang/Object;

    check-cast v0, Lcom/my/tracker/core/o/h;

    iget-object v2, v1, Lqgh;->c:Ljava/lang/Object;
    ...
    iget-object v0, v1, Lqgh;->c:Ljava/lang/Object;
    ...
    invoke-interface {v5, v0, v6}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    iget-object v5, v2, Lwzi;->b:Ljava/lang/Object;
    ...
    invoke-interface {v5, v6, v7, v0}, Lcgd;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_1
    iget-object v3, v2, Ljmi;->d:Lf4e;

    iget-object v3, v3, Lf4e;->c:Lj4e;

    if-eqz v3, :cond_1

    iget-object v4, v2, Ljmi;->c:Le4e;

    invoke-interface {v3, v4, v0}, Lj4e;->a(Le4e;Lq4e;)V
    :try_end_1
    ...
    iget-object v3, v3, Lf4e;->d:Lf05;

    if-eqz v3, :cond_2

    iget-object v4, v2, Ljmi;->c:Le4e;

    invoke-virtual {v3, v4, v0}, Lf05;->b(Le4e;Ljava/lang/Throwable;)V
    :try_end_2
    ...
    iget-object v6, v1, Lqgh;->c:Ljava/lang/Object;

    check-cast v6, Leni;

    const-string v7, "DecoderWrapper"

    iget-object v8, v0, Ldmi;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v8}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v8, v0, Ldmi;->u:Lvkg;

    invoke-virtual {v8}, Lvkg;->a()V

    iget v8, v6, Leni;->b:I

    int-to-long v9, v8

    iget-wide v11, v0, Ldmi;->h:J
    ...
    iget-wide v4, v0, Ldmi;->h:J

    const-string v6, ")"

    invoke-static {v3, v4, v5, v6}, Lqf7;->k(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v7, v3}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v0, Ldmi;->n:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v8, v0, Ldmi;->A:Ltc4;

    iget-object v10, v8, Ltc4;->a:Ljava/lang/Object;

    check-cast v10, Lnkg;

    invoke-interface {v10}, Lnkg;->getMsSinceBoot()J

    move-result-wide v10

    iget-object v12, v8, Ltc4;->b:Ljava/lang/Object;
    ...
    iget-object v14, v8, Ltc4;->c:Ljava/lang/Object;

    check-cast v14, Ljp6;

    new-instance v15, Ljp6;

    iget v2, v14, Ljp6;->a:I

    add-int/2addr v2, v5

    move/from16 v16, v5

    iget-wide v4, v14, Ljp6;->b:J

    add-long/2addr v4, v12

    invoke-direct {v15, v2, v4, v5}, Ljp6;-><init>(IJ)V

    iput-object v15, v8, Ltc4;->c:Ljava/lang/Object;
    ...
    iput-object v2, v8, Ltc4;->b:Ljava/lang/Object;

    iget-object v2, v0, Ldmi;->f:Lo0b;
    ...
    invoke-interface {v2, v7, v4}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v0, Ldmi;->n:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    :cond_5
    iget-object v2, v0, Ldmi;->m:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :catch_0
    :cond_6
    iput-object v9, v0, Ldmi;->f:Lo0b;

    new-instance v2, Lo0b;

    invoke-direct {v2, v0, v6}, Lo0b;-><init>(Ldmi;Leni;)V
    ...
    iget-boolean v4, v2, Lo0b;->d:Z

    iget-byte v5, v6, Luce;->a:B
    ...
    iput-boolean v4, v2, Lo0b;->d:Z

    :goto_5
    iget-object v4, v6, Leni;->e:Ljava/nio/ByteBuffer;

    invoke-virtual {v4}, Ljava/nio/Buffer;->remaining()I

    move-result v4

    iget-object v5, v2, Lo0b;->f:Ljava/lang/Object;

    check-cast v5, Ldmi;

    iget-object v5, v5, Ldmi;->c:[B
    ...
    :cond_9
    iget-object v5, v6, Leni;->e:Ljava/nio/ByteBuffer;

    iget-object v8, v2, Lo0b;->f:Ljava/lang/Object;

    check-cast v8, Ldmi;

    iget-object v8, v8, Ldmi;->c:[B

    invoke-virtual {v5, v8, v3, v4}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object v5, v2, Lo0b;->e:Ljava/lang/Object;
    ...
    :cond_a
    :goto_6
    iget-byte v2, v6, Luce;->a:B

    and-int/lit8 v2, v2, 0x2

    if-eqz v2, :cond_29

    iget-object v2, v0, Ldmi;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v2, v0, Ldmi;->v:Lvkg;

    invoke-virtual {v2}, Lvkg;->a()V
    ...
    iget-object v4, v0, Ldmi;->g:Lul4;

    if-eqz v4, :cond_c

    iget-boolean v4, v4, Lul4;->Z:Z
    ...
    :cond_d
    iput-wide v4, v0, Ldmi;->i:J

    sget-object v4, Lhli;->a:[I
    ...
    sget-object v3, Ldmi;->F:[Ljava/lang/String;
    ...
    invoke-interface {v4, v7, v5}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_19
    iput-object v4, v0, Ldmi;->j:Ljava/lang/Integer;

    iput-object v3, v0, Ldmi;->k:Ljava/lang/Integer;

    iget-object v5, v0, Ldmi;->a:Lcgd;
    ...
    invoke-interface {v5, v7, v3}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, v0, Ldmi;->b:Lhga;

    iget-object v5, v0, Ldmi;->a:Lcgd;

    invoke-direct {v3, v0, v2, v4, v5}, Lul4;-><init>(Ldmi;ILhga;Lcgd;)V

    iput-object v3, v0, Ldmi;->g:Lul4;

    :goto_f
    iget-object v2, v0, Ldmi;->g:Lul4;
    ...
    :cond_1c
    iget-object v2, v0, Ldmi;->z:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v5, v2, Lul4;->s0:Z

    iget-object v3, v2, Lul4;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object v2, v2, Lul4;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v2, v0, Ldmi;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-boolean v5, v0, Ldmi;->B:Z
    ...
    iget-boolean v3, v2, Lo0b;->d:Z

    iget-boolean v4, v0, Ldmi;->B:Z
    ...
    iget-object v2, v0, Ldmi;->y:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, v7}, Lpc;-><init>(I)V
    ...
    iget-object v5, v0, Ldmi;->j:Ljava/lang/Integer;
    ...
    iget-object v5, v0, Ldmi;->k:Ljava/lang/Integer;
    ...
    :goto_11
    iget-boolean v7, v3, Lul4;->s0:Z

    if-eqz v7, :cond_21

    if-nez v4, :cond_21

    iget-object v4, v3, Lul4;->y0:Ldmi;

    iget-object v4, v4, Ldmi;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v4}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v3, v3, Lul4;->y0:Ldmi;

    iget-object v4, v2, Lorg/webrtc/EncodedImage;->buffer:Ljava/nio/ByteBuffer;

    iget-object v7, v3, Ldmi;->y:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v7}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    invoke-virtual {v4}, Ljava/nio/ByteBuffer;->rewind()Ljava/nio/Buffer;

    iget-object v3, v3, Ldmi;->z:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_21
    iget-object v7, v3, Lul4;->t0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v7, v3, Lul4;->s0:Z

    if-eqz v4, :cond_23

    iget-object v4, v3, Lul4;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v7, v3, Lul4;->o:Landroid/os/Handler;

    new-instance v8, Lpp1;

    const/4 v9, 0x7

    invoke-direct {v8, v3, v2, v4, v9}, Lpp1;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V
    ...
    iget-object v8, v4, Ldmi;->y:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v8}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    invoke-virtual {v7}, Ljava/nio/ByteBuffer;->rewind()Ljava/nio/Buffer;

    iget-object v4, v4, Ldmi;->z:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v4, v3, Lul4;->s0:Z

    iget-object v4, v3, Lul4;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object v3, v3, Lul4;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v3, v0, Ldmi;->p:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v2, v0, Ldmi;->q:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, v2}, Lski;->g(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v2}, Lski;->h(Lti7;)V
    ...
    invoke-static {v0, v2}, Lski;->f(Lski;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, v0, Lyii;->z0:Loue;
    ...
    invoke-virtual {v0, v2, v3}, Laii;->a(Luii;Z)V
    ...
    invoke-virtual {v0, v2}, Laii;->i(Lthi;)V
    ...
    invoke-virtual {v0}, Lbf8;->a()Lwe8;

    move-result-object v0

    invoke-virtual {v2, v0}, Loue;->k(Lwe8;)Z
    ...
    invoke-static {v0, v2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->e(Lidf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    ...
    invoke-direct {v3, v0, v9, v2}, Lqgh;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-direct {v4, v3, v2, v5}, Ltm4;-><init>(Lld;Ljava/lang/String;I)V
    ...
    iget-object v2, v2, La1i;->o:Ljava/lang/Object;

    check-cast v2, Lmd9;

    invoke-virtual {v0, v2}, Lmn4;->b(Lmd9;)Lkd;
    ...
    iput-object v2, v0, Lzp5;->q1:Lmph;
    ...
    invoke-direct {v3, v4, v2}, Lss4;-><init>(ILjava/lang/Object;)V

    const/16 v8, 0x19

    invoke-virtual {v0, v8, v3}, Ljf8;->f(ILef8;)V
    ...
    invoke-direct {v3, v2}, Lhn4;-><init>(Llph;)V

    const/16 v8, 0x19

    invoke-virtual {v0, v8, v3}, Lk5a;->t(ILdf8;)V
    ...
    iget-boolean v3, v0, Lvkh;->u0:Z

    if-eqz v3, :cond_2f

    iget-object v6, v0, Lvkh;->a:Ljava/lang/String;
    ...
    :try_start_5
    invoke-interface {v0}, Lsgh;->run()V
    :try_end_5
    ...
    invoke-virtual {v2, v0}, Lj02;->e(Ljava/lang/Exception;)V
