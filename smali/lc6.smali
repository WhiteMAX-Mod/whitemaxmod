...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llc6;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    return-void
.end method

.method public constructor <init>(Ls02;Lm47;Luoe;Lxp8;)V
    .locals 4
    ...
    iput-boolean v0, p0, Llc6;->d:Z

    const/4 v1, 0x0

    iput-object v1, p0, Llc6;->e:Landroid/util/Rational;

    iput-boolean v0, p0, Llc6;->g:Z

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iput-object v2, p0, Llc6;->h:Ljava/lang/Integer;

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Llc6;->k:J

    iput-boolean v0, p0, Llc6;->l:Z

    iput-boolean v0, p0, Llc6;->m:Z

    const/4 v2, 0x1

    iput v2, p0, Llc6;->n:I

    iput-object v1, p0, Llc6;->o:Lic6;

    sget-object v2, Llc6;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Llc6;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Llc6;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Llc6;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Llc6;->s:Lyw1;

    iput-boolean v0, p0, Llc6;->t:Z

    iput-object v1, p0, Llc6;->u:Lkc6;

    iput-object p1, p0, Llc6;->a:Ls02;

    iput-object p3, p0, Llc6;->b:Luoe;

    iput-object p2, p0, Llc6;->c:Lm47;

    new-instance p1, Lpme;

    const/16 p2, 0x1a

    invoke-direct {p1, p2, p4}, Lpme;-><init>(ILjava/lang/Object;)V

    iput-object p1, p0, Llc6;->f:Lpme;
...
.method public final a(ZZ)V
    ...
    invoke-virtual {v2, p1, v0}, Lgfa;->v(Lta0;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v0, p2}, Ls2e;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v1, p1}, Lm40;->c(Lkr3;)V

    iget-object p1, p0, Llc6;->a:Ls02;

    invoke-virtual {v1}, Lm40;->d()Lm72;
    ...
    invoke-virtual {p1, p2}, Ls02;->z(Ljava/util/List;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Llc6;->a:Ls02;

    iget-object v1, v0, Ls02;->b:Lq02;
    ...
    iget-object v1, p0, Llc6;->o:Lic6;

    iget-object v2, v0, Ls02;->b:Lq02;
    ...
    invoke-virtual {v1, v3}, Lyw1;->d(Ljava/lang/Throwable;)Z

    iput-object v2, p0, Llc6;->s:Lyw1;

    :cond_0
    iget-object v1, p0, Llc6;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, p0, Llc6;->i:Ljava/util/concurrent/ScheduledFuture;

    :cond_1
    iget-object v1, p0, Llc6;->j:Ljava/util/concurrent/ScheduledFuture;

    if-eqz v1, :cond_2

    invoke-interface {v1, v3}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v2, p0, Llc6;->j:Ljava/util/concurrent/ScheduledFuture;

    :cond_2
    iget-object v1, p0, Llc6;->p:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    invoke-virtual {p0, v3, v2}, Llc6;->a(ZZ)V

    :cond_3
    sget-object v1, Llc6;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Llc6;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Llc6;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Llc6;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-boolean v2, p0, Llc6;->g:Z
...
.method public final c(Z)Lwe8;
    ...
    invoke-static {v0, p1, v3}, Lzy4;->o(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Ls02;->e:Lk32;

    const/4 v1, 0x5

    invoke-static {v0, v1}, Ls02;->t(Lk32;I)I
    ...
    invoke-direct {v0, v1, p0, p1}, Lbu4;-><init>(ILjava/lang/Object;Z)V
...
.method public final d(Ljava/util/List;ILandroid/util/Rational;Landroid/graphics/Rect;I)Ljava/util/List;
    ...
    iget-object v5, v5, Lh5a;->d:Landroid/util/Rational;
    ...
    iget-object v12, v8, Llc6;->f:Lpme;

    iget-object v12, v12, Lpme;->b:Ljava/lang/Object;

    check-cast v12, Lxp8;

    const-class v13, Landroidx/camera/camera2/internal/compat/quirk/AfRegionFlipHorizontallyQuirk;

    invoke-virtual {v12, v13}, Lxp8;->n(Ljava/lang/Class;)Z
...
.method public final e(Lyw1;)V
    ...
    invoke-static {v3}, Lg22;->Q(Landroid/hardware/camera2/CaptureRequest$Key;)Lta0;

    move-result-object v3

    invoke-virtual {v2, v3, v1}, Lgfa;->v(Lta0;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v3, v2}, Ls2e;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Ls02;->z(Ljava/util/List;)V
...
.method public final f(Z)V
    ...
    iget-object v3, p0, Llc6;->a:Ls02;

    iget-object v3, v3, Ls02;->e:Lk32;

    invoke-static {v3, v1}, Ls02;->t(Lk32;I)I
    ...
    sget-object v3, Ljr3;->b:Ljr3;

    invoke-static {p1}, Lg22;->Q(Landroid/hardware/camera2/CaptureRequest$Key;)Lta0;

    move-result-object p1

    invoke-virtual {v2, p1, v3, v1}, Lgfa;->s(Lta0;Ljr3;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v2, v1}, Ls2e;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {p1, v1}, Lq72;-><init>(I)V
