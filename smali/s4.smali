...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    sget v1, Lred;->tag_screen_reader_focusable:I
    ...
    invoke-static {p1}, La0i;->d(Landroid/view/View;)Z
    ...
    invoke-static {p2, v1}, Lv4;->x(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    :cond_4
    :goto_2
    sget v1, Lred;->tag_accessibility_heading:I

    sget v9, Landroid/os/Build$VERSION;->SDK_INT:I

    if-lt v9, v4, :cond_5

    invoke-static {p1}, La0i;->c(Landroid/view/View;)Z
    ...
    invoke-static {p2, v6}, Lv4;->D(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    :cond_a
    :goto_6
    invoke-static {p1}, Lh0i;->e(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    if-lt v7, v4, :cond_b

    invoke-static {p2, v1}, Lv4;->w(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1}, Lc0i;->b(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    invoke-static {p2, v3}, Lb5;->c(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
    ...
    :goto_9
    iget-object v1, p0, Ls4;->a:Lt4;

    invoke-virtual {v1, p1, v0}, Lt4;->d(Landroid/view/View;Lg5;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    sget p2, Lred;->tag_accessibility_actions:I
    ...
    invoke-virtual {v0, p2}, Lg5;->b(La5;)V
...
.method public final performAccessibilityAction(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Lt4;->g(Landroid/view/View;ILandroid/os/Bundle;)Z
