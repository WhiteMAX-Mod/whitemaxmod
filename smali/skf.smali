...
.method public static d(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;
    ...
    instance-of p0, p1, Lbag;

    if-eqz p0, :cond_2

    check-cast p1, Lbag;

    invoke-virtual {p1}, Lbag;->getContentWidth()I

    move-result p0

    invoke-virtual {p1}, Lbag;->getContentHeight()I
...
.method public c(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {p1, p2}, Ldc5;->a(Landroid/content/Context;Ljava/lang/String;)I
...
.method public e(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;Landroid/view/View;FLandroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1, p2}, Lskf;->d(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;

    move-result-object p2

    invoke-static {p1, p3}, Lskf;->d(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p4, v0}, Ltg;->c(IFI)I
    ...
    invoke-static {p2, p4, p1}, Ltg;->c(IFI)I
