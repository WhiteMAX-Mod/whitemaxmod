...
# virtual methods
.method public abstract T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
.end method
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lfxi;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lfxi;->U(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Lubj;->f:Ludj;

    iget-object p1, p1, Ludj;->a:Ltuj;

    if-eqz p1, :cond_9

    iget-object p2, p3, Lubj;->e:Lvlg;

    iget-object p4, p1, Ltuj;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Ltuj;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Lwnj;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Ltuj;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Lubj;->d:Lusi;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lusi;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p4, p1, p2}, Ltyi;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lubj;->e:Lvlg;

    invoke-virtual {p1, p4}, Lvlg;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lnrj;->f:Lksj;

    iget-object p1, p1, Lksj;->a:Lhyj;

    iget-object p2, p3, Lnrj;->e:Lvlg;

    invoke-virtual {p1, p2}, Lhyj;->c(Lvlg;)V

    iget-object p1, p3, Lnrj;->d:Lp45;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lp45;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lp45;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lvlg;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lnrj;->g:Lksj;
    ...
    iget-object p1, p1, Lksj;->d:Lruj;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lruj;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lruj;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Les;-><init>(I)V

    invoke-virtual {p2, p1}, Lvlg;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Lfxi;->T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
