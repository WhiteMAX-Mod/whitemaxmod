...
.field public final o:Ljgc;

.field public final s0:Lsoh;

.field public t0:Lxp6;

.field public u0:Z

.field public v0:Lmfc;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v4, Lc9h;->B:Lipg;

    invoke-static {v4, v2}, Lipg;->d(Lipg;Landroid/widget/TextView;)V

    iput-object v2, p0, Lnfc;->c:Landroid/widget/TextView;

    new-instance v5, Landroid/widget/TextView;

    invoke-direct {v5, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v5}, Ltea;->r(Landroid/view/View;)Loob;
    ...
    invoke-static {v4, v5}, Lipg;->d(Lipg;Landroid/widget/TextView;)V

    iput-object v5, p0, Lnfc;->d:Landroid/widget/TextView;
    ...
    invoke-static {v7, v8}, Lirj;->b(IF)I
    ...
    iput-object v7, v6, Lsoh;->a:Landroid/widget/ImageView;
    ...
    iput-object v7, v6, Lsoh;->c:Landroid/widget/ProgressBar;

    new-instance v7, Landroid/widget/TextView;

    invoke-direct {v7, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v7}, Ltea;->r(Landroid/view/View;)Loob;
    ...
    sget-object p1, Lc9h;->s:Lipg;

    invoke-static {p1, v7}, Lipg;->d(Lipg;Landroid/widget/TextView;)V
    ...
    iput-object v7, v6, Lsoh;->b:Landroid/widget/TextView;
    ...
    invoke-virtual {v1, v7, v9}, Landroid/graphics/drawable/GradientDrawable;->setStroke(II)V
    ...
    invoke-direct {p1, p0, v0}, Lhb9;-><init>(Landroid/view/KeyEvent$Callback;I)V
...
# virtual methods
.method public final a(Lgs2;)V
    .locals 5

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-boolean v0, p1, Lgs2;->b:Z

    iget-object p1, p1, Lgs2;->a:Lxp6;
    ...
    iget-object v3, p1, Lxp6;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iput-object v3, p0, Lnfc;->t0:Lxp6;

    if-eqz v3, :cond_2

    iget-object v1, v3, Lxp6;->a:Landroid/graphics/Bitmap;

    :cond_2
    iget-object v3, p0, Lnfc;->s0:Lsoh;

    iget-object v4, v3, Lsoh;->a:Landroid/widget/ImageView;
    ...
    iget-object v2, v3, Lsoh;->c:Landroid/widget/ProgressBar;
...
.method public final getListener()Lmfc;
    .locals 1

    iget-object v0, p0, Lnfc;->v0:Lmfc;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lnfc;->s0:Lsoh;
    ...
    invoke-static {p1, p4, p2, p3, p5}, Lnfj;->c(Landroid/view/View;IIII)V

    :cond_0
    iget-object p1, p0, Lnfc;->c:Landroid/widget/TextView;

    const/4 p2, 0x0

    const/16 p5, 0xc

    invoke-static {p1, p4, p3, p2, p5}, Lnfj;->c(Landroid/view/View;IIII)V
    ...
    iget-object v1, p0, Lnfc;->d:Landroid/widget/TextView;
    ...
    invoke-static {v1, v0, p3, p2, p5}, Lnfj;->c(Landroid/view/View;IIII)V
    ...
    iget-object p3, p0, Lnfc;->o:Ljgc;

    invoke-static {p3, p4, p1, p2, p5}, Lnfj;->c(Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    iget-object v3, p0, Lnfc;->c:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lnfc;->d:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lnfc;->t0:Lxp6;
    ...
    iget-object v0, p0, Lnfc;->s0:Lsoh;
...
.method public final setListener(Lmfc;)V
    .locals 0

    iput-object p1, p0, Lnfc;->v0:Lmfc;
