...
# virtual methods
.method public final a(Lcpg;)Lgpg;
    .locals 4
...
.method public final b(Lt3i;)Lea1;
    .locals 11
    ...
    sget-object v2, Lp91;->c:Lp91;

    invoke-virtual {v1, v2}, Ljava/lang/Object;->equals(Ljava/lang/Object;)Z

    move-result v2

    iget-object v3, p0, Lzt1;->a:Landroid/content/Context;

    if-eqz v2, :cond_0

    sget v2, Lncd;->check_outline_16:I
    ...
    invoke-static {v2, v0, v3}, Lm0i;->z(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget v2, Lvbd;->ic_connection_fill_16:I
    ...
    sget v2, Lncd;->ic_microphone_off_fill_16:I
    ...
    invoke-direct {p1, v1, v2, v0}, Lea1;-><init>(JLandroid/text/SpannableStringBuilder;)V
...
.method public final c(Z)Landroid/text/SpannableStringBuilder;
    ...
    iget-object v4, p0, Lzt1;->a:Landroid/content/Context;

    if-eqz p1, :cond_1

    sget p1, Lsce;->e1:I

    invoke-virtual {v0, v4}, Ltea;->p(Landroid/content/Context;)Loob;
    ...
    invoke-static {p1, v0, v4}, Lm0i;->z(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public final d(Z)Landroid/text/SpannableStringBuilder;
    ...
    sget v0, Lvid;->call_incoming_video_call:I
    ...
    :cond_1
    sget p1, Lvid;->call_incoming_audio_call:I
    ...
    invoke-direct/range {v1 .. v7}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;-><init>(Landroid/graphics/drawable/Drawable;Lc76;ZZILfq4;)V
...
.method public final e(Ljava/lang/CharSequence;ZIZZZLwt5;)Landroid/text/SpannableStringBuilder;
    .locals 10
    ...
    instance-of v6, v2, Lst5;

    if-nez v6, :cond_0

    instance-of v6, v2, Lut5;
    ...
    iget-object v7, p0, Lzt1;->a:Landroid/content/Context;
    ...
    sget v1, Lvbd;->ic_share_screen_20:I

    invoke-virtual {v3, v7}, Ltea;->p(Landroid/content/Context;)Loob;
    ...
    invoke-static {v1, v3, v7}, Lm0i;->z(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Lvbd;->ic_microphone_disable_12:I
    ...
    invoke-direct {v3, v9}, Lnc1;-><init>(I)V

    invoke-direct {v4, v7, v1, v3}, Lipf;-><init>(Landroid/content/Context;Llob;Lnc1;)V
...
.method public final g(ZZZLwt5;)Ljava/lang/String;
    .locals 1
    ...
    instance-of p2, p4, Lst5;

    if-nez p2, :cond_0

    instance-of p2, p4, Lut5;
    ...
    :cond_1
    instance-of p1, p4, Lst5;

    if-nez p1, :cond_2

    instance-of p1, p4, Lut5;
    ...
    sget p1, Lvid;->call_connecting:I
    ...
    :cond_3
    instance-of p1, p4, Lpt5;

    if-eqz p1, :cond_4

    check-cast p4, Lpt5;

    iget-object p1, p4, Lpt5;->a:Lot5;
    ...
    :pswitch_1
    sget p1, Lvid;->call_opponent_reject_call:I
    ...
    :pswitch_2
    sget p1, Lvid;->call_participants_limit_reached:I
    ...
    :pswitch_3
    sget p1, Lvid;->call_user_restricted_info:I
    ...
    :pswitch_4
    sget p1, Lvid;->call_group_wait_admin:I
    ...
    :pswitch_5
    sget p1, Lvid;->call_group_user_not_in_chat:I
    ...
    :pswitch_6
    sget p1, Lvid;->call_group_was_removed_from_waiting_room:I
    ...
    :pswitch_7
    sget p1, Lvid;->call_group_was_removed_from_call:I
    ...
    :pswitch_8
    sget p1, Lvid;->call_opponent_failed_timout:I
    ...
    :pswitch_a
    sget p1, Lvid;->call_opponent_unavailable_privacy:I
    ...
    :pswitch_b
    sget p1, Lvid;->call_opponent_unavailable_busy:I
    ...
    :pswitch_c
    sget p1, Lvid;->call_opponent_unavailable_missed:I
...
.method public final h(ZILjava/lang/CharSequence;ZZZZLwt5;)Landroid/text/SpannableStringBuilder;
    .locals 8
    ...
    invoke-static {p3, p4}, Ld7g;->S(Ljava/lang/CharSequence;[C)Ljava/util/List;
...
.method public final i()Lyi8;
    ...
    invoke-direct {v0, v1, v2, v3}, Lyi8;-><init>(IILandroid/content/Context;)V
