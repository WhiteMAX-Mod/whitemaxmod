...
# static fields
.field public static volatile a:Lz8f;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, La9f;->c:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_1

    sput-object v0, La9f;->d:[I
    ...
    sput-object v0, La9f;->f:[I

    filled-new-array {v2}, [I

    move-result-object v0

    sput-object v0, La9f;->g:[I
...
.method public static h(Landroid/opengl/EGLContext;Landroid/opengl/EGLDisplay;I[I)Landroid/opengl/EGLContext;
    ...
    invoke-static {p1, p3}, La9f;->q(Landroid/opengl/EGLDisplay;[I)Landroid/opengl/EGLConfig;
...
.method public static i(Landroid/opengl/EGLContext;Landroid/opengl/EGLDisplay;)Landroid/opengl/EGLSurface;
    ...
    invoke-static {v0}, La9f;->v(Ljava/lang/String;)Z
    ...
    sget-object v3, La9f;->c:[I

    invoke-static {p1, v3}, La9f;->q(Landroid/opengl/EGLDisplay;[I)Landroid/opengl/EGLConfig;
    ...
    invoke-static {v3}, La9f;->c(Ljava/lang/String;)V
    ...
    invoke-static {p0}, La9f;->c(Ljava/lang/String;)V

    invoke-static {v1, v2, v2}, La9f;->m(III)V
...
.method public static k(Landroid/opengl/EGLContext;Landroid/opengl/EGLDisplay;)V
    ...
    invoke-static {v0}, La9f;->c(Ljava/lang/String;)V
...
.method public static final n(Ljava/lang/String;)Ljava/util/HashSet;
    .locals 3
    ...
    invoke-static {p0, v1, v2}, Lrzf;->U(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;
...
.method public static o(Ljavax/net/ssl/SSLSession;)Lb47;
    .locals 6
    ...
    :goto_0
    sget-object v2, Lfd3;->t:Lv1j;

    invoke-virtual {v2, v1}, Lv1j;->r(Ljava/lang/String;)Lfd3;
    ...
    invoke-static {v2}, Leui;->b(Ljava/lang/String;)Lpng;
    ...
    invoke-static {v3}, Llbh;->k([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {p0}, Llbh;->k([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {p0, v5, v3}, Lje;-><init>(ILjava/lang/Object;)V

    invoke-direct {v4, v2, v1, v0, p0}, Lb47;-><init>(Lpng;Lfd3;Ljava/util/List;Llq6;)V
...
.method public static p()Landroid/opengl/EGLDisplay;
    .locals 5
    ...
    invoke-static {v4, v2}, La9f;->e(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v0}, La9f;->e(Ljava/lang/String;Z)V
...
.method public static q(Landroid/opengl/EGLDisplay;[I)Landroid/opengl/EGLConfig;
    .locals 9
...
.method public static s(Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v0, La9f;->b:Ljava/util/ArrayList;
    ...
    :cond_4
    sget-object p0, La9f;->b:Ljava/util/ArrayList;

    if-nez p0, :cond_5

    sput-object v0, La9f;->b:Ljava/util/ArrayList;
...
.method public static t(Landroid/content/Context;)Lz8f;
    .locals 3

    sget-object v0, La9f;->a:Lz8f;
    ...
    sput-object p0, La9f;->a:Lz8f;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    sget-object p0, La9f;->a:Lz8f;
...
.method public static w(Landroid/content/Context;Ljava/util/List;)V
    ...
    iget-object v3, v1, Ly8f;->a:Landroid/content/Context;

    iget-object v4, v1, Ly8f;->b:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/content/pm/ShortcutInfo$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iget-object v3, v1, Ly8f;->d:Ljava/lang/String;
    ...
    iget-object v3, v1, Ly8f;->c:[Landroid/content/Intent;
    ...
    iget-object v3, v1, Ly8f;->f:Landroidx/core/graphics/drawable/IconCompat;

    if-eqz v3, :cond_2

    iget-object v4, v1, Ly8f;->a:Landroid/content/Context;

    invoke-static {v3, v4}, Lxe7;->g(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    ...
    :cond_2
    iget-object v3, v1, Ly8f;->e:Ljava/lang/String;
    ...
    iget-object v3, v1, Ly8f;->j:Landroid/os/PersistableBundle;
    ...
    iget-object v4, v1, Ly8f;->h:Lyj8;

    if-eqz v4, :cond_7

    iget-object v4, v4, Lyj8;->b:Landroid/content/LocusId;

    invoke-static {v2, v4}, Lrvd;->n(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)V

    :cond_7
    iget-boolean v1, v1, Ly8f;->i:Z

    invoke-static {v2, v1}, Lrvd;->o(Landroid/content/pm/ShortcutInfo$Builder;Z)V

    goto :goto_3

    :cond_8
    iget-object v4, v1, Ly8f;->j:Landroid/os/PersistableBundle;
    ...
    iput-object v4, v1, Ly8f;->j:Landroid/os/PersistableBundle;
    ...
    iget-object v5, v1, Ly8f;->j:Landroid/os/PersistableBundle;

    const-string v6, "extraLocusId"

    iget-object v4, v4, Lyj8;->a:Ljava/lang/String;
    ...
    iget-boolean v6, v1, Ly8f;->i:Z

    invoke-virtual {v4, v5, v6}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget-object v1, v1, Ly8f;->j:Landroid/os/PersistableBundle;
    ...
    invoke-static {v2}, Lyb5;->d(Landroid/content/pm/ShortcutInfo$Builder;)V
    ...
    :cond_d
    invoke-static {p0}, La9f;->t(Landroid/content/Context;)Lz8f;
    ...
    invoke-static {p0}, La9f;->s(Landroid/content/Context;)Ljava/util/List;
