...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorCallback",
        "send-B_83SRM",
        "(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lla7;)V",
        "send",
        "Lzn;",
        "getApiClient",
        "()Lzn;",
...
.method public static synthetic a(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lkzh;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/onelog/OneLogDirect;->send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lkzh;
...
.method public static synthetic c(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lzn;Lla7;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/onelog/OneLogDirect;->send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lzn;Lla7;)V
...
.method private final getApiClient()Lzn;
    .locals 0
    ...
    invoke-virtual {p0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Lzn;
...
.method private final send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lla7;)V
    .locals 6
    ...
    invoke-direct {p0}, Lru/ok/android/onelog/OneLogDirect;->getApiClient()Lzn;
    ...
    :cond_0
    sget-object p0, Ldob;->a:Ldob;

    sget-object v0, Ldob;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v0, Ldob;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    ...
    :cond_2
    :goto_2
    sget-object p0, Ldob;->c:Ljava/util/concurrent/Executor;
...
.method private static final send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lzn;Lla7;)V
    .locals 3
    ...
    invoke-interface {p2, v2}, Lzn;->a(Lmo;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_1
    invoke-interface {p3, p1, p0}, Lla7;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    return-void
.end method

.method private static final send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lkzh;
    .locals 0
...
.method public final send-PCEVtD0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lru/ok/android/onelog/OneLogDirect;->send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lla7;)V
