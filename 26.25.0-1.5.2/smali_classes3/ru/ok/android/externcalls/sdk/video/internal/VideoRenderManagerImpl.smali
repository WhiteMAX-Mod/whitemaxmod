...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "isEarlyVideoEnabled",
        "<init>",
        "(Lv97;Lk81;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Z)V",
        "Lk42;",
        "key",
        "",
...
.field private final state:Lv97;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lv97;"
        }
...
# direct methods
.method public constructor <init>(Lv97;Lk81;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lv97;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lk81;
...
.method public synthetic constructor <init>(Lv97;Lk81;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;ZILr55;)V
    .locals 6
    ...
    .line 21
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;-><init>(Lv97;Lk81;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Z)V

    return-void
.end method

.method private final setRenderers(Lk42;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final setRenderersForMe(Lk42;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderers(Lk42;Ljava/util/List;)V

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lk81;
    ...
    invoke-virtual {v0, p1, p2}, Lv22;->V(Lk42;Ljava/util/List;)V

    iget-object p0, p0, Lk81;->x0:Lxk;

    invoke-virtual {p0, p1, p2}, Lxk;->b(Lk42;Ljava/util/List;)V
    ...
    invoke-direct {v0, v2}, Logj;-><init>(I)V

    iput-object p1, v0, Logj;->b:Ljava/lang/Object;

    sget-object p1, Lkri;->c:Lkri;

    iput-object p1, v0, Logj;->c:Ljava/lang/Object;

    invoke-virtual {v0}, Logj;->l()Lk42;
    ...
    iput-object p1, p0, Lspf;->p:Lorg/webrtc/VideoSink;

    iget-object p0, p0, Lspf;->o:Lz49;

    if-eqz p0, :cond_9

    invoke-virtual {p0, p1}, Lz49;->j(Lorg/webrtc/VideoSink;)V
...
.method private final setRenderersForOthers(Lk42;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public getCallRenderer()Lfr1;
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lv97;
...
.method public getEglBaseContext()Lorg/webrtc/EglBase$Context;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lk81;

    iget-object v0, v0, Lk81;->r:Lorg/webrtc/EglBase;
...
.method public setRenderers(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Ljava/util/List;)V
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lkri;
    ...
    iput-object v4, p0, Lspf;->p:Lorg/webrtc/VideoSink;

    iget-object p0, p0, Lspf;->o:Lz49;

    if-eqz p0, :cond_7

    invoke-virtual {p0, v4}, Lz49;->j(Lorg/webrtc/VideoSink;)V
    ...
    invoke-direct {v1, v2}, Logj;-><init>(I)V

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lkri;

    move-result-object v2

    iput-object v2, v1, Logj;->c:Ljava/lang/Object;

    iput-object v3, v1, Logj;->b:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lpua;

    move-result-object v2

    iput-object v2, v1, Logj;->d:Ljava/lang/Object;

    invoke-virtual {v1}, Logj;->l()Lk42;
    ...
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForMe(Lk42;Ljava/util/List;)V

    return-void

    :cond_9
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForOthers(Lk42;Ljava/util/List;)V
