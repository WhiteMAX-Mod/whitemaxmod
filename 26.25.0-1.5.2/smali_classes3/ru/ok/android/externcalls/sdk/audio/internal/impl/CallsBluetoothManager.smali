...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsBluetoothManager$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Landroid/content/Context;Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsAudioManagerV2Impl;Lru/ok/android/externcalls/sdk/audio/Logger;)V
    ...
    invoke-direct {p2, p0, v0}, Lv62;-><init>(Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsBluetoothManager;I)V
...
.method private final closeProfileProxy(Landroid/bluetooth/BluetoothHeadset;)V
    ...
    invoke-interface {p0, v2, v1}, Lru/ok/android/externcalls/sdk/audio/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final getBluetoothDeviceName(Landroid/bluetooth/BluetoothDevice;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, Lzg;->q(Landroid/bluetooth/BluetoothDevice;)Ljava/lang/String;
...
.method private final getBluetoothProfileProxy(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;I)Z
    ...
    const-string p2, "CallsBluetoothManager"
...
.method private final getConnectedBluetoothDevice(Landroid/bluetooth/BluetoothHeadset;)Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-interface {p0, v2, p1}, Lru/ok/android/externcalls/sdk/audio/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final onAudioConnected()V
    ...
    invoke-interface {p0, v2, v0}, Lru/ok/android/externcalls/sdk/audio/Logger;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final onAudioConnecting()V
    ...
    const-string v3, "Weird! our state is wrong? Reset to connecting"

    invoke-interface {v4, v2, v3}, Lru/ok/android/externcalls/sdk/audio/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v4, v2, p0}, Lru/ok/android/externcalls/sdk/audio/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final onAudioDisconnected(Z)V
    ...
    const-string v1, "audio disconnected, state after update: "
    ...
    invoke-interface {p1, v2, p0}, Lru/ok/android/externcalls/sdk/audio/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final startScoAudio(I)Z
    ...
    iget-object v7, p0, Lru/ok/android/externcalls/sdk/audio/internal/impl/CallsBluetoothManager;->logger:Lru/ok/android/externcalls/sdk/audio/Logger;

    if-eqz v5, :cond_3

    const-string p0, "BT SCO is about to connect, ignore this attempt"

    invoke-interface {v7, v2, p0}, Lru/ok/android/externcalls/sdk/audio/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v7, v2, v4}, Lru/ok/android/externcalls/sdk/audio/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final updateCurrentConnectionState(Landroid/bluetooth/BluetoothHeadset;Z)Z
    ...
    const-string p2, "Error detecting remote audio device"

    invoke-interface {p0, v3, p2, p1}, Lru/ok/android/externcalls/sdk/audio/Logger;->reportError(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final start()V
    ...
    invoke-interface {v0, v2, p0}, Lru/ok/android/externcalls/sdk/audio/Logger;->w(Ljava/lang/String;Ljava/lang/String;)V
