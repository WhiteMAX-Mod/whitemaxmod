...
.field private badNetworkIndicatorConfig:Lin0;

.field private bitrates:Lls1;
...
.field protected final experiments:Lt0b;

.field private fastRecoverEnabled:Z

.field private forceRelayPolicy:Z

.field private groupCallMediaAdaptationConfig:Lfj9;

.field hangupDelegate:Lvn7;
...
.field joinConversationDelegate:Lsk8;

.field protected log:Luud;
...
.method public constructor <init>()V
    ...
    sget-object v1, Llle;->M0:Lso8;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Llle;

    const-string v1, "sdk-0.2.4"
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lls1;
    ...
    sget-object v2, Lin0;->e:Lin0;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lin0;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lyoe;
    ...
    invoke-direct {v0, v2}, Lt0b;-><init>(Ln32;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Lt0b;
...
.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactoryParams;Lv97;)Lkzh;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->lambda$new$0(Lv97;)Lkzh;
...
.method private synthetic lambda$new$0(Lv97;)Lkzh;
    .locals 1
...
.method public getBaseBuilder(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Lt0b;

    invoke-direct {v1, p1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lt0b;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lls1;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Lls1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Llle;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Llle;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Lfj9;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Lfj9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Lfj9;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Lfj9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lin0;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBadNetworkIndicatorConfig(Lin0;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Lque;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Lque;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lyoe;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setSSLProvider(Lyoe;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->hangupDelegate:Lvn7;

    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setHangupApiDelegate(Lvn7;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public setBadNetworkIndicatorConfig(Lin0;)V
    .locals 0

    if-nez p1, :cond_0

    sget-object p1, Lin0;->e:Lin0;

    :cond_0
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lin0;

    return-void
.end method

.method public setBitrates(Lls1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lls1;
...
.method public setGroupCallMediaAdaptationConfig(Lfj9;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Lfj9;

    return-void
.end method

.method public setHangupApiDelegate(Lvn7;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->hangupDelegate:Lvn7;
...
.method public setJoinConversationDelegate(Lsk8;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->joinConversationDelegate:Lsk8;
...
.method public setP2PCallMediaAdaptationConfig(Lfj9;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Lfj9;
...
.method public setRotationProvider(Llle;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Llle;
...
.method public setScreenCapturePermissionProvider(Lque;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Lque;
...
.method public setSslProvider(Lyoe;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lyoe;
