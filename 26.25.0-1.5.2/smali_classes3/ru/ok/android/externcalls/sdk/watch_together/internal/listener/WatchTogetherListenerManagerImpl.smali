...
.method private final getPosition(Ljava/lang/Long;)Lsua;
    .locals 4
    ...
    :cond_0
    new-instance p0, Lqua;

    invoke-virtual {p1}, Ljava/lang/Long;->longValue()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lqua;-><init>(J)V

    return-object p0

    :cond_1
    :goto_0
    sget-object p0, Lrua;->a:Lrua;
...
.method private final updateState(Lyua;)V
    .locals 12
    ...
    iget-object p1, p1, Lyua;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lxua;->a:Lk42;

    iget-object v3, v3, Lk42;->b:Los1;
    ...
    iget-object v11, v3, Lk42;->c:Lpua;
    ...
    sget-object v5, Lvua;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lmua;->d:Luua;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lmua;->a:Lpua;

    invoke-virtual {v8, v11}, Lpua;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lxua;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lsua;

    move-result-object v5

    iget-boolean v2, v1, Lxua;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lxua;->b:F

    invoke-static {v7}, Lcva;->a(F)V

    iget-boolean v8, v1, Lxua;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsua;ZFZLmua;Lr55;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lkdf;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lkdf;Lmua;)V
...
.method public final onVideoStarted(Lwua;)V
    .locals 12
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsua;ZFZLmua;Lr55;)V
    ...
    iget-object p1, p1, Lwua;->b:Lkdf;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lkdf;Lmua;)V
...
.method public final onVideoStatesUpdatedChanged(Lyua;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lyua;)V
...
.method public final onVideoStopped(Lzua;)V
    .locals 4
    ...
    iget-object v2, p1, Lzua;->b:Lkdf;

    iget-object v3, p1, Lzua;->c:Lpua;

    iget-object p1, p1, Lzua;->d:Luua;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lkdf;Lpua;Luua;)V
