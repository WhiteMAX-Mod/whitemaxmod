...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "tokenProvider",
        "setTokenProvider",
        "(Lzih;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;",
        "Lqp;",
        "tokenInfoProvider",
        "setTokenInfoProvider",
        "(Lqp;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;",
        "",
        "link",
        "setLink",
...
.method public build()Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getOnPrepared()Lx97;

    move-result-object v6

    if-eqz v6, :cond_1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getOnError()Lx97;
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getFrameInterceptor()Lwk2;

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenProvider:Lzih;

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenInfoProvider:Lqp;

    iget-object v4, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->payload:Ljava/lang/String;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getCameraCapturerFactory()Ljib;
    ...
    invoke-direct/range {v0 .. v13}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;-><init>(Ljava/lang/String;Lzih;Lqp;Ljava/lang/String;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lx97;Lx97;ZLru/ok/android/externcalls/sdk/events/ConversationEventsListener;Lwk2;Ljib;Ljava/lang/String;Lr55;)V
...
.method public final setTokenInfoProvider(Lqp;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenInfoProvider:Lqp;

    return-object p0
.end method

.method public final setTokenProvider(Lzih;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenProvider:Lzih;
