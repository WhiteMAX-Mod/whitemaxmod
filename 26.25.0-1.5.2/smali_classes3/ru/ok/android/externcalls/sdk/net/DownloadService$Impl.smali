...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lvxf;",
        "Luud;",
        "Companion",
        "calls-sdk"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Luud;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Luud;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lbyf;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$0(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lfyf;)V

    return-void
.end method

.method private static final download$lambda$0(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lfyf;)V
    .locals 8
    ...
    invoke-virtual {p2, v0}, Lbyf;->d(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Lno7;

    move-result-object p0

    iget-object p0, p0, Lno7;->a:Ljava/lang/String;
    ...
    invoke-virtual {p2, p3}, Lbyf;->a(Ljava/lang/Object;)V
    ...
    :goto_6
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Luud;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lgu1;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :try_start_d
    invoke-static {v4}, Ljp6;->b(Ljava/io/File;)V
    :try_end_d
    ...
    invoke-static {v2, p0}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$0$3(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljava/lang/String;)Lkzh;

    :goto_7
    check-cast p4, Lbyf;

    invoke-virtual {p4}, Lbyf;->b()Z

    move-result p0

    if-nez p0, :cond_7

    invoke-virtual {p4, p2}, Lbyf;->d(Ljava/lang/Throwable;)Z
...
.method private static final download$lambda$0$3(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljava/lang/String;)Lkzh;
    .locals 1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Luud;
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v1, p0, p3}, Lj8i;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v4, p2}, Ljp6;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lvxf;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p0}, Lbo;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
