...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "rtcLog",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Luud;)V",
        "",
        "from",
        "",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Luud;)V
    .locals 0
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Luud;
...
.method private final filterEmptyParticipantIds(Ljava/util/Collection;)Ljava/util/List;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Luud;
    ...
    invoke-interface {v3, v6, v5, v4}, Luud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public map(Ljava/util/Collection;Lru/ok/android/externcalls/sdk/id/mapping/MappingContext;)Ljava/util/Map;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->getOkIdsByExternalIds(Ljava/util/Collection;)Lvxf;

    move-result-object p1

    invoke-virtual {p1}, Lvxf;->d()Ljava/lang/Object;
    ...
    :goto_3
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Luud;

    const-string p2, "ExternalToInternalIdsMapper"

    const-string v1, "Can\'t map external ids to internal"

    invoke-interface {p0, p2, v1, p1}, Luud;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
