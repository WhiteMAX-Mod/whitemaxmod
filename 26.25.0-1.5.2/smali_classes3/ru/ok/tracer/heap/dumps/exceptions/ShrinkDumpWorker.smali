...
.method public final d()Lt19;
    ...
    iget-object v1, p0, Landroidx/work/WorkerParameters;->b:Lpy4;

    const-string v2, "param_dump_path"

    invoke-virtual {v1, v2}, Lpy4;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lpy4;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v6, v7}, Lbv7;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v6, v7}, Lxbk;->R(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v6}, Lbv7;->close()V
    :try_end_5
