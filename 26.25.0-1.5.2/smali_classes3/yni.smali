...
# direct methods
.method public constructor <init>(Landroid/util/Size;Ljt5;)V
    .locals 5

    invoke-direct {p0}, Lyl5;-><init>()V

    iput-object p1, p0, Lyni;->n:Landroid/util/Size;
    ...
    iput-object v0, p0, Lyni;->o:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lyni;->s:[F
    ...
    invoke-virtual {p0, p2}, Lyl5;->n(Ljt5;)Lzg0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lyni;->o:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lq87;->g0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lyni;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lyni;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lyni;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lyni;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lyni;->p:Ltag;

    if-eqz v2, :cond_2

    iget-object v3, v2, Ltag;->d:Ljava/lang/Object;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lq87;->g0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Ltag;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Ltag;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lyni;->p:Ltag;

    iput-object v0, p0, Lyni;->v:Lrsf;
...
.method public final v(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v0, v1}, Lyl5;->l(Landroid/view/Surface;)Lrh0;

    move-result-object v2

    sget-object v3, Ltb7;->j:Lrh0;

    invoke-virtual {v2, v3}, Lrh0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v0, v1}, Lyl5;->h(Landroid/view/Surface;)Lrh0;
    ...
    :cond_1
    iget-object v3, v0, Lyl5;->b:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Ltb7;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v0, Lyl5;->d:Ljava/lang/Object;
    ...
    iget v11, v2, Lrh0;->b:I

    iget v12, v2, Lrh0;->c:I

    iget-object v9, v2, Lrh0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v0, Lyni;->p:Ltag;

    if-nez v2, :cond_2

    new-instance v2, Ltag;

    iget-object v5, v0, Lyni;->n:Landroid/util/Size;

    invoke-direct {v2, v5}, Ltag;-><init>(Landroid/util/Size;)V

    iput-object v2, v0, Lyni;->p:Ltag;

    :cond_2
    move-object v10, v2

    iget-object v2, v0, Lyni;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v0, Lyni;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v0, Lyni;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v0, Lyni;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v0, Lyni;->t:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Ltag;->f:Ljava/lang/Object;
    ...
    iget v6, v10, Ltag;->a:I

    iget v7, v10, Ltag;->b:I
    ...
    iget-object v2, v10, Ltag;->f:Ljava/lang/Object;
    ...
    iget-object v3, v10, Ltag;->e:Ljava/lang/Object;

    check-cast v3, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Ltag;->f:Ljava/lang/Object;
    ...
    iget-object v5, v10, Ltag;->c:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lyl5;->j:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lyl5;->o(Landroid/opengl/EGLSurface;)V

    iput-object v1, v0, Lyl5;->j:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v3, Ltag;->f:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lyni;->v:Lrsf;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v3, v3, Ltag;->f:Ljava/lang/Object;
    ...
    iget-object v3, v0, Lyni;->v:Lrsf;

    if-eqz v3, :cond_8

    invoke-virtual {v3, v11}, Lrsf;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    const/4 v3, 0x0

    iput-object v3, v0, Lyni;->v:Lrsf;
    ...
    :cond_9
    :goto_2
    iget-object v3, v0, Lyl5;->e:Ljava/lang/Object;
    ...
    iget-object v11, v0, Lyni;->o:Ljava/lang/String;

    invoke-static {}, Landroid/opengl/EGL14;->eglGetError()I

    move-result v2

    invoke-static {v8}, Lywh;->p(I)V
    ...
    invoke-static {v8, v2, v3}, Lwkl;->c(IJ)Ljava/lang/String;
    ...
    invoke-static/range {v9 .. v15}, Lrwb;->f(Lrwb;Lq79;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;I)V

    :cond_a
    invoke-virtual {v0, v1, v4}, Lyl5;->s(Landroid/view/Surface;Z)V
