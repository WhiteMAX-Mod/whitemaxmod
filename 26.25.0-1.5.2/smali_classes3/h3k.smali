...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lh3k;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lh3k;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lsz0;->d(ILjava/lang/String;)I
    ...
    invoke-static {v2, p1}, Lsz0;->d(ILjava/lang/String;)I
    ...
    iput v2, p0, Lh3k;->programId:I

    const-string v3, "glCreateProgram"

    invoke-static {v3}, Lsz0;->c(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lsz0;->c(Ljava/lang/String;)V
    ...
    iput v0, p0, Lh3k;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Lsz0;->b(ILjava/lang/String;)V
    ...
    iput v1, p0, Lh3k;->aTextureCoordLoc:I

    invoke-static {v1, p1}, Lsz0;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Lh3k;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Lsz0;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Lh3k;->texMatrixLoc:I
    ...
    iput v3, p0, Lh3k;->textureLocation:I
    ...
    iput v2, p0, Lh3k;->alphaLocation:I

    invoke-static {v3, p1}, Lsz0;->b(ILjava/lang/String;)V

    new-instance p1, Lt1k;

    invoke-direct {p1, v0, v1}, Lt1k;-><init>(II)V

    iput-object p1, p0, Lh3k;->frame:Lt1k;
    ...
    const-string p0, "create program failed"
    ...
    :cond_1
    const-string p0, "Failed to load fragment shader"
    ...
    :cond_2
    const-string p0, "Failed to load vertex shader"
...
.method public getTextureCoordLoc()I
    ...
    iget p0, p0, Lh3k;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget p0, p0, Lh3k;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lh3k;->firstFreeTexture:I
    ...
    iget p1, p0, Lh3k;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lh3k;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lh3k;->frame:Lt1k;

    iget-object v0, v0, Lt1k;->a:Ly2k;

    invoke-interface {v0}, Ly2k;->a()V

    iget p0, p0, Lh3k;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lh3k;->use()V

    iget-object v0, p0, Lh3k;->frame:Lt1k;

    iget-object v0, v0, Lt1k;->a:Ly2k;

    invoke-interface {v0}, Ly2k;->b()V

    invoke-virtual {p0}, Lh3k;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    iget v0, p0, Lh3k;->programId:I

    invoke-static {v0, p1}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result p1

    iget-object p0, p0, Lh3k;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lh3k;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lh3k;->texMat:[F
...
.method public unUse()V
    ...
    invoke-static {p0}, Lsz0;->c(Ljava/lang/String;)V
...
.method public use()V
    ...
    iput v0, p0, Lh3k;->firstFreeTexture:I

    iget-object v1, p0, Lh3k;->mvpMat:[F
    ...
    iput-object v1, p0, Lh3k;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lh3k;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lh3k;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lh3k;->programId:I
    ...
    iget v1, p0, Lh3k;->mvpMatrixLoc:I

    iget-object v2, p0, Lh3k;->mvpMat:[F
    ...
    iget v2, p0, Lh3k;->texMatrixLoc:I

    iget-object v4, p0, Lh3k;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lsz0;->c(Ljava/lang/String;)V

    iget v0, p0, Lh3k;->textureLocation:I

    invoke-virtual {p0}, Lh3k;->getTarget()I

    move-result v1

    iget v2, p0, Lh3k;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lh3k;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lh3k;->alphaLocation:I

    iget v1, p0, Lh3k;->alpha:F
    ...
    iget-object v0, p0, Lh3k;->customParams:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lh3k;->customParams:Ljava/util/HashMap;
