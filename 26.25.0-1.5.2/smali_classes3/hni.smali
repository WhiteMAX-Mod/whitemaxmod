...
.field public final synthetic e:Lkni;


# direct methods
.method public constructor <init>(Lkni;Landroid/util/Size;Ljt5;)V
    .locals 0

    iput-object p1, p0, Lhni;->e:Lkni;

    const-string p1, "videomsg-gl-thread"

    invoke-direct {p0, p1}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Lhni;->a:Landroid/util/Size;

    iput-object p3, p0, Lhni;->b:Ljt5;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide p1

    iput-wide p1, p0, Lhni;->c:J

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lhni;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final run()V
    ...
    iget-object v1, p0, Lhni;->a:Landroid/util/Size;

    iget-object v2, p0, Lhni;->b:Ljt5;
    ...
    iget-object v1, p0, Lhni;->e:Lkni;

    if-eqz v0, :cond_0

    iget-object v0, v1, Lkni;->a:Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lhni;->a:Landroid/util/Size;

    iget-object v3, p0, Lhni;->b:Ljt5;

    invoke-static {v1, v0, v3}, Lkni;->a(Lkni;Landroid/util/Size;Ljt5;)V
    :try_end_0
    ...
    iget-object v1, p0, Lhni;->d:Ljava/util/concurrent/atomic/AtomicReference;
