...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v0}, Let9;->m(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Ljdc;->c:Ljava/util/Map;

    sget-object v1, Ly1k;->b:Ly1k;
    ...
    sput-object v0, Ljdc;->d:Ljava/util/List;
...
.method public final b()[B
    ...
    iget-object v0, p0, Ljdc;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Lw1k;->k:Lw1k;

    iget-short v6, v6, Lw1k;->a:S
    ...
    sget-object v2, Ljdc;->c:Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lcdc;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v1}, Ljdc;->e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v0}, Ljdc;->e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v1}, Lnt5;->p(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v1

    invoke-static {v1}, Lnt5;->o(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v1}, Ljdc;->f([B)V

    iget-object v0, v0, Lcdc;->a:Ly1k;
...
.method public final c(Ljava/nio/ByteBuffer;)I
    ...
    iget-object p0, p0, Ljdc;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v1, v7}, Lfrj;-><init>(II)V
    ...
    sget-object v3, Ljdc;->d:Ljava/util/List;
    ...
    sget-object v3, Ljdc;->c:Ljava/util/Map;
    ...
    invoke-static {v4}, Ljdc;->d(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v2, v1, v3}, Lbdc;-><init>(Ly1k;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :catch_0
    invoke-static {v7}, Lkie;->r(Ljava/lang/String;)V

    return v2

    :catch_1
    invoke-static {v6}, Lkie;->r(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lnt5;->q(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lnt5;->C()V

    invoke-static {v5, v4}, Lnt5;->r(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v3, v1, v2}, Lcdc;-><init>(Ly1k;Ljava/security/PublicKey;)V
