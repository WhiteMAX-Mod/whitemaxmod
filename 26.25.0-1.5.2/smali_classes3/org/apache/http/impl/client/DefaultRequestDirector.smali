...
.method public constructor <init>(Lorg/apache/http/protocol/HttpRequestExecutor;Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/ConnectionReuseStrategy;Lorg/apache/http/conn/ConnectionKeepAliveStrategy;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/client/HttpRequestRetryHandler;Lorg/apache/http/client/RedirectHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/UserTokenHandler;Lorg/apache/http/params/HttpParams;)V
    ...
    :cond_1
    const-string p0, "User token handler may not be null."
    ...
    :cond_2
    const-string p0, "Proxy authentication handler may not be null."
    ...
    :cond_3
    const-string p0, "Target authentication handler may not be null."
    ...
    :cond_4
    const-string p0, "Redirect handler may not be null."
    ...
    :cond_5
    const-string p0, "HTTP request retry handler may not be null."
    ...
    :cond_6
    const-string p0, "HTTP protocol processor may not be null."
    ...
    :cond_7
    const-string p0, "Route planner may not be null."
    ...
    :cond_8
    const-string p0, "Connection keep alive strategy may not be null."
    ...
    :cond_9
    const-string p0, "Connection reuse strategy may not be null."
    ...
    :cond_a
    const-string p0, "Client connection manager may not be null."
    ...
    :cond_b
    const-string p0, "Request executor may not be null."
...
.method public determineRoute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/conn/routing/HttpRoute;
    ...
    invoke-static {v2, p2, v0, p3, v1}, Lgu1;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p2

    invoke-static {p2, p0}, Lep6;->m(Ljava/lang/StringBuilder;Ljava/lang/Object;)V
...
.method public establishRoute(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)V
    ...
    :pswitch_5
    const-string p0, "Unable to establish route.\nplanned = "

    const-string p2, "\ncurrent = "

    invoke-static {p0, p1, p2, v1}, Lc;->s(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    :goto_1
    :try_start_2
    invoke-interface {v14, v7, v8, v5}, Lorg/apache/http/conn/ClientConnectionRequest;->getConnection(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/conn/ManagedClientConnection;
    ...
    invoke-interface {v15, v13, v3, v14}, Lorg/apache/http/conn/ManagedClientConnection;->open(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/params/HttpParams;)V
    ...
    invoke-static {v14}, Lorg/apache/http/params/HttpConnectionParams;->getSoTimeout(Lorg/apache/http/params/HttpParams;)I

    move-result v14

    invoke-interface {v15, v14}, Lorg/apache/http/HttpConnection;->setSocketTimeout(I)V
    :try_end_6
    ...
    :try_end_7
    .catch Lorg/apache/http/impl/client/TunnelRefusedException; {:try_start_7 .. :try_end_7} :catch_6
    ...
    invoke-virtual {v0, v12, v2, v3}, Lorg/apache/http/protocol/HttpRequestExecutor;->execute(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpClientConnection;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    invoke-interface {v2, v10}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;)V
    ...
    invoke-interface {v2, v0, v15, v3}, Lorg/apache/http/client/HttpRequestRetryHandler;->retryRequest(Ljava/io/IOException;ILorg/apache/http/protocol/HttpContext;)Z
    ...
    invoke-interface {v2, v7}, Lorg/apache/commons/logging/Log;->info(Ljava/lang/Object;)V
    ...
    invoke-interface {v2, v7, v0}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v11, v8, v3}, Lorg/apache/http/protocol/HttpRequestExecutor;->postProcess(Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/protocol/HttpContext;)V
    ...
    invoke-interface {v2, v12, v13, v5}, Lorg/apache/http/conn/ManagedClientConnection;->setIdleDuration(JLjava/util/concurrent/TimeUnit;)V
...
.method public handleResponse(Lorg/apache/http/impl/client/RoutedRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/impl/client/RoutedRequest;
    ...
    invoke-static {v2, v1, v3}, Lh45;->t(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
