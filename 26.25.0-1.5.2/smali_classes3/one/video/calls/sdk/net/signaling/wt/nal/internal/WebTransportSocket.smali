...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "handler",
        "handleAsync",
        "(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lla7;)V",
        "message",
        "send",
        "(Ljava/lang/String;)V",
        "",
...
# instance fields
.field private final client:Lr0k;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lone/video/calls/sdk/net/signaling/wt/nal/NALLog;Lr0k;Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$CompressorDecompressor;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0
    ...
    iput-object p4, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->client:Lr0k;
    ...
    invoke-direct {p0, p2, p3, p6, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lla7;)V

    return-void
.end method

.method private static final _init_$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lkzh;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lkzh;
    .locals 0
...
.method public static synthetic a(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;)V
    .locals 0

    invoke-static {p0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession$lambda$2(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;)V

    return-void
.end method

.method public static final synthetic access$sendStreamData(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->sendStreamData(Le0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
...
.method public static synthetic c(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lla7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lla7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    return-void
.end method

.method private final configureSession(Ld0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 2
    ...
    invoke-direct {v0, p0, v1, p2}, Lau2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iput-object v0, p2, Ll0k;->j:Ljava/util/function/BiConsumer;

    new-instance p2, Llgj;

    const/4 v0, 0x0

    invoke-direct {p2, p0, v0}, Llgj;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;I)V

    check-cast p1, Ll0k;

    iput-object p2, p1, Ll0k;->i:Ljava/util/function/Consumer;

    new-instance p2, Llgj;

    invoke-direct {p2, p0, v1}, Llgj;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;I)V

    iput-object p2, p1, Ll0k;->h:Ljava/util/function/Consumer;
...
.method private static final configureSession$lambda$1(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;)V
    .locals 1
...
.method private static final configureSession$lambda$2(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;)V
    .locals 1
...
.method private final connect(Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    ...
    iget-object v3, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->client:Lr0k;

    invoke-direct {v1, v0, v2, v3}, Lg0k;-><init>(Ljava/net/URI;Ljava/lang/String;Lr0k;)V

    invoke-virtual {v1, v0}, Lg0k;->a(Ljava/net/URI;)Ll0k;

    move-result-object v0

    iput-object v0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->session:Ld0k;

    invoke-direct {p0, v0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession(Ld0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    invoke-direct {p0, v0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->openSession(Ld0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    :try_end_0
...
.method public static synthetic d(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lkzh;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lkzh;
    .locals 0

    invoke-static {p0, p1, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->_init_$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lkzh;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lkzh;
...
.method public static synthetic e(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;)V
    .locals 0

    invoke-static {p0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession$lambda$1(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Le0k;)V

    return-void
.end method

.method private final handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lla7;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct/range {v1 .. v6}, Lu62;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lla7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
...
.method private static final handleAsync$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lla7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 4
    ...
    :try_start_0
    invoke-interface {p2, p3, p4}, Lla7;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final openSession(Ld0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 9
    ...
    invoke-virtual {v0, v1, v2, v3}, Ll0k;->c(Lk0k;Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Z

    iget-object v2, v0, Ll0k;->d:Lg0k;

    iget-object v3, v2, Lg0k;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, v2, Lg0k;->c:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v0, Ll0k;->c:J
    ...
    invoke-direct {v5, v4, v0}, Lx0k;-><init>(ILjava/lang/Object;)V
    ...
    :cond_0
    :goto_0
    iget-object v0, v2, Lg0k;->b:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v1, v0, Ll0k;->a:Ll70;

    iget-object v1, v1, Ll70;->b:Ljava/lang/Object;

    check-cast v1, Lnuj;

    invoke-virtual {v1, v4}, Lnuj;->c(Z)Lexj;

    move-result-object v1

    iget-object v2, v1, Lexj;->e:Ljxj;

    new-instance v3, Lb1k;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v1, v3, Lb1k;->a:Lexj;

    iput-object v2, v3, Lb1k;->b:Ljava/io/InputStream;

    iget-object v1, v1, Lexj;->f:Lpxj;
    ...
    invoke-static {v5, v6, v4}, Ldql;->c(JLjava/nio/ByteBuffer;)I
    ...
    invoke-static {v4, v5, v2}, Ldql;->c(JLjava/nio/ByteBuffer;)I
    ...
    :cond_2
    iget-object v1, v0, Ll0k;->k:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, v0, Ll0k;->l:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v0, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    new-instance v0, Lj0k;

    invoke-direct {v0, v6}, Lj0k;-><init>(I)V

    iput-object v3, v0, Lj0k;->b:Lv0k;
    ...
    invoke-direct {p0, v2, v0, p2, v1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lla7;)V

    invoke-direct {p0, p1, v0, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->readStreamData(Ld0k;Le0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    ...
    :goto_3
    iget-object p1, v2, Lg0k;->b:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private final readStreamData(Ld0k;Le0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 6
    ...
    :try_start_0
    invoke-interface {p2}, Le0k;->b()Ljava/io/InputStream;
    ...
    :goto_0
    :try_start_1
    invoke-static {p2}, Ldql;->d(Ljava/io/InputStream;)I
...
.method private final sendStreamData(Le0k;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    :try_start_4
    invoke-interface {p1}, Le0k;->a()Ljava/io/OutputStream;
...
.method public final close(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->session:Ld0k;
    ...
    invoke-virtual {v0, v1, v2, p2}, Ll0k;->a(JLjava/lang/String;)V
