...
# direct methods
.method public constructor <init>(Llb7;Lx85;Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmy0;->a:Llb7;

    iput-object p2, p0, Lmy0;->b:Lx85;

    iput-object p3, p0, Lmy0;->c:Ljava/util/concurrent/ExecutorService;

    iput-object p4, p0, Lmy0;->d:Ljava/lang/String;

    iput-boolean p5, p0, Lmy0;->e:Z
    ...
    iput-object p1, p0, Lmy0;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final b(Lz3b;)V
    ...
    iget-object v0, p0, Lmy0;->g:Ljava/util/concurrent/Future;
    ...
    :cond_0
    iget-object v0, p0, Lmy0;->c:Ljava/util/concurrent/ExecutorService;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, Lmy0;->c(Lz3b;)V

    return-void
.end method

.method public final c(Lz3b;)V
    .locals 7

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lmy0;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(Ld4b;Lz3b;)V
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lmy0;->d:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-boolean p1, p0, Lmy0;->e:Z

    if-eqz p1, :cond_4

    invoke-virtual {p0, p2}, Lmy0;->c(Lz3b;)V
...
.method public final e(Ljava/io/File;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lmy0;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final f()V
    ...
    invoke-direct {v1, v2, p0}, Lly0;-><init>(ILjava/lang/Object;)V

    invoke-interface {v0, v1}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    move-result-object v0

    iput-object v0, p0, Lmy0;->g:Ljava/util/concurrent/Future;
