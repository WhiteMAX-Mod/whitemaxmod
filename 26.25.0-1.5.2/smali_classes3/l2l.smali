...
# direct methods
.method public static a(Lfda;)Ltxc;
    .locals 15
    ...
    :try_start_b
    invoke-static {p0, v7}, Lbe3;->Y(Lfda;I)I
    ...
    invoke-direct {p0, v11, v10}, Ltxc;-><init>(Ljava/lang/String;I)V
...
.method public static final b(Loz1;)Ledf;
    .locals 8

    new-instance v0, Ledf;

    iget-object v3, p0, Loz1;->a:Ljdf;

    iget-object v5, p0, Loz1;->b:Ljava/lang/String;

    iget-boolean v7, p0, Loz1;->c:Z

    iget v1, p0, Loz1;->e:I

    iget-object v6, p0, Loz1;->d:Ljava/util/List;

    iget-object v2, p0, Loz1;->f:Los1;

    iget-object v4, p0, Loz1;->g:Ljava/lang/Long;

    invoke-direct/range {v0 .. v7}, Ledf;-><init>(ILos1;Ljdf;Ljava/lang/Long;Ljava/lang/String;Ljava/util/List;Z)V
