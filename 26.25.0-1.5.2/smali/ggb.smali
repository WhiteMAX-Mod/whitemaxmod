...
.method public final d(Lxoe;Ljava/lang/Object;)V
    ...
    iget-wide v1, p2, Lm1j;->a:J

    invoke-interface {p1, v0, v1, v2}, Lxoe;->c(IJ)V

    const/4 p0, 0x2

    iget-wide v3, p2, Lm1j;->b:J

    invoke-interface {p1, p0, v3, v4}, Lxoe;->c(IJ)V

    const/4 p0, 0x3

    iget-wide v3, p2, Lm1j;->c:J

    invoke-interface {p1, p0, v3, v4}, Lxoe;->c(IJ)V

    iget-object p0, p2, Lm1j;->d:Ljava/lang/String;
    ...
    :goto_0
    iget-boolean p0, p2, Lm1j;->e:Z

    const/4 v0, 0x5

    int-to-long v3, p0

    invoke-interface {p1, v0, v3, v4}, Lxoe;->c(IJ)V

    iget-boolean p0, p2, Lm1j;->f:Z

    const/4 p2, 0x6

    int-to-long v3, p0

    invoke-interface {p1, p2, v3, v4}, Lxoe;->c(IJ)V

    const/4 p0, 0x7

    invoke-interface {p1, p0, v1, v2}, Lxoe;->c(IJ)V
