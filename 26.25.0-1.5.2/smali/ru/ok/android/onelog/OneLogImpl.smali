...
.field private volatile forceFallbackLogs:Lru/ok/android/commons/util/function/Supplier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lru/ok/android/commons/util/function/Supplier<",
            "Ljava/lang/Boolean;",
            ">;"
        }
    .end annotation
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lru/ok/android/onelog/OneLogImpl;->forceFallbackLogs:Lru/ok/android/commons/util/function/Supplier;
...
.method public getApiClient()Lzn;
    .locals 3
    ...
    const-string v2, "ApiClient not attached to Collector"
...
.method public getForceFallbackLogs()Z
    ...
    iget-object v0, p0, Lru/ok/android/onelog/OneLogImpl;->forceFallbackLogs:Lru/ok/android/commons/util/function/Supplier;

    if-eqz v0, :cond_0

    iget-object p0, p0, Lru/ok/android/onelog/OneLogImpl;->forceFallbackLogs:Lru/ok/android/commons/util/function/Supplier;

    invoke-interface {p0}, Lru/ok/android/commons/util/function/Supplier;->get()Ljava/lang/Object;
...
.method public setForceFallbackLogs(Lru/ok/android/commons/util/function/Supplier;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/onelog/OneLogImpl;->forceFallbackLogs:Lru/ok/android/commons/util/function/Supplier;
...
.method public setMaxTimeToUpload(Ljava/lang/String;Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-virtual {p0, p2, p3, p4}, Lru/ok/android/onelog/Collector;->setMaxMillisToUpload(Ljava/lang/String;J)V
...
.method public setMaxTimeToUploadAny(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/android/onelog/Collector;->setMaxMillisToUploadAny(J)V
...
.method public startUpload(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, p1}, La0b;-><init>(ILjava/lang/Object;)V
...
.method public upload(Ljava/util/Collection;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lzn;Ljava/util/Collection;)V
...
.method public upload(Lru/ok/android/onelog/OneLogItem;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lzn;Lru/ok/android/onelog/OneLogItem;)V
