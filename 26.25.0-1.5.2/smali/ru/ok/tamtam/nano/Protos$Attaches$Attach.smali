...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lru/ok/tamtam/nano/Protos$Attaches$Attach$Poll;,
        Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;,
...
.field public static final POLL:I = 0x11
...
.field public static final STORY_REPLY:I = 0x12
...
.field public poll:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Poll;
...
.field public storiesReply:Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;
...
.method public static parseFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->mergeFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach;
...
.method public clear()Lru/ok/tamtam/nano/Protos$Attaches$Attach;
    ...
    iput-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->appVersion:Ljava/lang/String;

    iput-object v1, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->poll:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Poll;

    iput-object v1, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->storiesReply:Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;
...
.method public computeSerializedSize()I
    ...
    invoke-static {v1, v0}, Lqr3;->f(II)I
    ...
    invoke-static {v5, v1, v2}, Lqr3;->h(IJ)I
    ...
    invoke-static {v1, v5}, Lqr3;->l(ILjava/lang/String;)I
    ...
    iget-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->localPath:Ljava/lang/String;
    ...
    :cond_f
    iget-wide v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->totalBytes:J
    ...
    invoke-static {v1, v5, v6}, Lqr3;->h(IJ)I
    ...
    :cond_10
    iget-wide v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->bytesDownloaded:J
    ...
    invoke-static {v5, v1}, Lqr3;->i(ILsba;)I
    ...
    :cond_13
    iget-wide v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->lastModified:J
    ...
    invoke-static {v3, v1}, Lqr3;->i(ILsba;)I
    ...
    invoke-static {v3, v1}, Lqr3;->f(II)I
    ...
    :cond_1b
    iget-object v1, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->widget:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Widget;
    ...
    :cond_1c
    iget-object v1, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->appVersion:Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->appVersion:Ljava/lang/String;

    invoke-static {v1, v2}, Lqr3;->l(ILjava/lang/String;)I
    ...
    :cond_1d
    iget-object v1, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->poll:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Poll;
    ...
    :cond_1e
    iget-object p0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->storiesReply:Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;

    if-eqz p0, :cond_1f

    const/16 v1, 0x22

    invoke-static {v1, p0}, Lqr3;->i(ILsba;)I
...
.method public mergeFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :sswitch_0
    iget-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->storiesReply:Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;

    if-nez v0, :cond_1

    new-instance v0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;

    invoke-direct {v0}, Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;-><init>()V

    iput-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->storiesReply:Lru/ok/tamtam/nano/Protos$Attaches$Attach$StoriesReply;
    ...
    :sswitch_1
    iget-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->poll:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Poll;
    ...
    iput-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->poll:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Poll;
    ...
    iput-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->appVersion:Ljava/lang/String;
...
.method public bridge synthetic mergeFrom(Lor3;)Lsba;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 452
    invoke-virtual {p0, p1}, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->mergeFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach;
...
.method public writeTo(Lqr3;)V
    ...
    invoke-virtual {p1, v4, v0, v1}, Lqr3;->x(IJ)V
    ...
    invoke-virtual {p1, v0, v4}, Lqr3;->E(ILjava/lang/String;)V
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->localPath:Ljava/lang/String;
    ...
    invoke-virtual {p1, v4, v0}, Lqr3;->r(IZ)V
    ...
    :cond_f
    iget-wide v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->totalBytes:J
    ...
    invoke-virtual {p1, v0, v4, v5}, Lqr3;->x(IJ)V

    :cond_10
    iget-wide v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->bytesDownloaded:J
    ...
    invoke-virtual {p1, v4, v0}, Lqr3;->y(ILsba;)V
    ...
    :cond_13
    iget-wide v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->lastModified:J
    ...
    invoke-virtual {p1, v2, v0}, Lqr3;->y(ILsba;)V
    ...
    iget v2, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->progressFloat:F

    invoke-virtual {p1, v0, v2}, Lqr3;->v(IF)V
    ...
    invoke-virtual {p1, v2, v0}, Lqr3;->w(II)V
    ...
    invoke-virtual {p1, v2, v0}, Lqr3;->r(IZ)V
    ...
    :cond_1c
    iget-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach;->appVersion:Ljava/lang/String;
