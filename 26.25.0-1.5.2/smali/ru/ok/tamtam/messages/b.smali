...
# direct methods
.method public constructor <init>(Ls41;Lks8;Lks8;Lks8;Lks8;Lks8;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/tamtam/messages/b;->a:Ls41;

    iput-object p2, p0, Lru/ok/tamtam/messages/b;->b:Lks8;

    iput-object p3, p0, Lru/ok/tamtam/messages/b;->c:Lks8;

    iput-object p4, p0, Lru/ok/tamtam/messages/b;->d:Lks8;

    iput-object p5, p0, Lru/ok/tamtam/messages/b;->e:Lks8;

    iput-object p6, p0, Lru/ok/tamtam/messages/b;->f:Lks8;
...
.method public static a(Lfr2;Ls8a;)V
    .locals 9
    ...
    iget-object p1, p0, Lux3;->r:Loz3;

    :cond_3
    move-object v8, p1

    invoke-direct/range {v2 .. v8}, Lru/ok/tamtam/messages/ChatException$ChatMessageTypeMismatch;-><init>(JZJLoz3;)V

    const-string p0, "PreProcessDataCache"

    const-string p1, "Wrong chat/message type"

    invoke-static {p0, p1, v2}, Lq87;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-static {v2}, Lep6;->w(Ljava/lang/Throwable;)V
...
.method public static c(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    iput-object v2, v1, Lru/ok/tamtam/messages/c;->m:Lj05;

    iput-object v2, v1, Lru/ok/tamtam/messages/c;->n:Lt4d;
...
.method public final d(JJLvc5;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lvy3;-><init>(JJLvc5;)V
...
.method public final e(Lfr2;Ls8a;)V
    .locals 12
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/tamtam/messages/b;->f(Lfr2;Ls8a;)Lru/ok/tamtam/messages/c;
    ...
    iget-object v2, p0, Lru/ok/tamtam/messages/b;->d:Lks8;
    ...
    invoke-virtual {v2, v4}, Lgye;->C(Z)V

    new-instance v5, Lru/ok/tamtam/messages/ChatException$WrongMessage;

    iget-wide v6, p2, Lxp0;->a:J

    iget-wide v8, p2, Ls8a;->h:J
    ...
    invoke-static {v3, v2, v5}, Lq87;->d0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    invoke-static {p1, p2}, Lru/ok/tamtam/messages/b;->a(Lfr2;Ls8a;)V

    const/4 v2, 0x0

    invoke-virtual {p0, v2, p2}, Lru/ok/tamtam/messages/b;->f(Lfr2;Ls8a;)Lru/ok/tamtam/messages/c;

    move-result-object v2

    instance-of p2, p2, Llv3;
    ...
    invoke-virtual {v2, p1}, Lru/ok/tamtam/messages/c;->l(Lfr2;)V

    return-void
.end method

.method public final f(Lfr2;Ls8a;)Lru/ok/tamtam/messages/c;
    .locals 7

    new-instance v0, Lru/ok/tamtam/messages/c;

    iget-object v1, p0, Lru/ok/tamtam/messages/b;->b:Lks8;
    ...
    iget-object v2, p0, Lru/ok/tamtam/messages/b;->c:Lks8;
    ...
    iget-object v3, p0, Lru/ok/tamtam/messages/b;->d:Lks8;
    ...
    iget-object v4, p0, Lru/ok/tamtam/messages/b;->e:Lks8;
    ...
    iget-object p0, p0, Lru/ok/tamtam/messages/b;->f:Lks8;
    ...
    invoke-direct/range {v0 .. v6}, Lru/ok/tamtam/messages/c;-><init>(Lgxb;Laf4;Lv6d;Ls8a;Lfr2;Lwm;)V

    return-object v0
.end method

.method public final g(Lfr2;Ls8a;)Lru/ok/tamtam/messages/c;
    .locals 12
    ...
    iget-object v4, p0, Lru/ok/tamtam/messages/b;->d:Lks8;
    ...
    invoke-virtual {v4, v2}, Lgye;->C(Z)V
    ...
    iput-boolean v2, v3, Lo6e;->a:Z

    instance-of v2, p2, Llv3;
    ...
    invoke-direct {v1, v3, p0, p2, p1}, Lr4d;-><init>(Lo6e;Lru/ok/tamtam/messages/b;Ls8a;Lfr2;)V

    new-instance p0, Lyl;

    const/16 p2, 0x11

    invoke-direct {p0, p2, v1}, Lyl;-><init>(ILjava/lang/Object;)V
    ...
    iget-boolean p2, v3, Lo6e;->a:Z

    if-eqz p2, :cond_3

    invoke-virtual {p0, p1}, Lru/ok/tamtam/messages/c;->l(Lfr2;)V
