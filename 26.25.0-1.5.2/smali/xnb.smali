...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lxnb;->a:Lpnb;

    sget-object v0, Lonb;->b:Lonb;

    iput-object v0, p0, Lxnb;->b:Lonb;
    ...
    iget-object v2, p0, Lxnb;->a:Lpnb;

    iget-object v3, p0, Lxnb;->b:Lonb;

    invoke-direct {v0, v1, v2, v3}, Lqnb;-><init>(Llca;Lpnb;Lonb;)V

    iput-object v0, p0, Lxnb;->c:Lqnb;
    ...
    iput-object v0, p0, Lxnb;->d:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lxnb;->e:Landroid/widget/TextView;

    new-instance v0, Lwnb;

    invoke-direct {v0, p0, p1}, Lwnb;-><init>(Lxnb;Landroid/content/Context;)V

    iput-object v0, p0, Lxnb;->f:Lwnb;

    new-instance p1, Lyj7;

    const/16 v1, 0x17

    invoke-direct {p1, v1}, Lyj7;-><init>(I)V
    ...
    iput-object p1, p0, Lxnb;->g:Lks8;

    new-instance p1, Lyj7;

    const/16 v2, 0x18

    invoke-direct {p1, v2}, Lyj7;-><init>(I)V

    invoke-static {v1, p1}, Luie;->d0(ILv97;)Lks8;

    move-result-object p1

    iput-object p1, p0, Lxnb;->h:Lks8;
...
.method public final a(Landroid/util/Property;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-direct {p0}, Lxnb;->getShowScaleFirstStepInterpolator()Landroid/view/animation/PathInterpolator;
    ...
    invoke-direct {p0}, Lxnb;->getShowScaleSecondStepInterpolator()Landroid/view/animation/PathInterpolator;
    ...
    invoke-direct {p0}, Lxnb;->getShowScaleThirdStepInterpolator()Landroid/view/animation/PathInterpolator;
...
.method public final b(Lv97;)V
    .locals 14

    iget-object v0, p0, Lxnb;->m:Landroid/animation/AnimatorSet;
    ...
    iput-object v0, p0, Lxnb;->m:Landroid/animation/AnimatorSet;

    iget v0, p0, Lxnb;->n:F

    iget-object v1, p0, Lxnb;->f:Lwnb;
    ...
    invoke-direct {p0}, Lxnb;->getDismissInterpolator()Landroid/view/animation/PathInterpolator;
    ...
    iget-object v13, p0, Lxnb;->e:Landroid/widget/TextView;
    ...
    invoke-static {v0, p1}, Lgek;->c(Landroid/animation/AnimatorSet;Lv97;)V
...
.method public final c()V
    ...
    iget-object v2, p0, Lxnb;->e:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v4}, Lxnb;->a(Landroid/util/Property;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-virtual {p0, v7}, Lxnb;->a(Landroid/util/Property;)Landroid/animation/PropertyValuesHolder;
    ...
    invoke-direct {p0}, Lxnb;->getRotationInterpolator()Landroid/view/animation/PathInterpolator;
    ...
    invoke-direct {p0}, Lxnb;->getShowAlphaInterpolator()Landroid/view/animation/PathInterpolator;
    ...
    iput-object v3, p0, Lxnb;->m:Landroid/animation/AnimatorSet;
...
.method public final onThemeChanged(Lc4c;)V
    ...
    iget-object v0, p0, Lxnb;->d:Landroid/widget/ImageView;
    ...
    iget-object p0, p0, Lxnb;->e:Landroid/widget/TextView;
...
.method public final setArrowAlignment(Lonb;)V
    .locals 1

    iput-object p1, p0, Lxnb;->b:Lonb;

    iget-object v0, p0, Lxnb;->c:Lqnb;

    iget-object p0, p0, Lxnb;->a:Lpnb;

    invoke-virtual {v0, p0, p1}, Lqnb;->d(Lpnb;Lonb;)V

    return-void
.end method

.method public final setArrowSide(Lpnb;)V
    .locals 1

    iput-object p1, p0, Lxnb;->a:Lpnb;

    iget-object v0, p0, Lxnb;->c:Lqnb;

    iget-object p0, p0, Lxnb;->b:Lonb;

    invoke-virtual {v0, p1, p0}, Lqnb;->d(Lpnb;Lonb;)V

    return-void
.end method

.method public final setOnCloseClickListener(Lv97;)V
    .locals 2
    ...
    iget-object p0, p0, Lxnb;->d:Landroid/widget/ImageView;
...
.method public final setOnTooltipClickListener(Lv97;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setText(Lcch;)V
    .locals 1
