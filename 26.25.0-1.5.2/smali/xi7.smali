...
.field public static final d:Lxi7;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxi7;->c:Ljava/lang/Object;

    new-instance v0, Lxi7;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lxi7;->d:Lxi7;
...
.method public final d(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p2, p1, v0}, Lyi7;->b(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object p0

    invoke-static {p0, p1}, Lb7k;->a(Landroid/content/Intent;Lcom/google/android/gms/common/api/GoogleApiActivity;)Lb7k;
    ...
    :cond_2
    invoke-static {p1, p2}, Ls6k;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Ls6k;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Ls6k;->f(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0, p3}, Lx56;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lx56;
...
.method public final e(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p2, v0, v1}, Let9;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p1}, Ld7k;-><init>(Lxi7;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Ls6k;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1, p2}, Ls6k;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v4, p1, v5}, Lieb;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-boolean v1, v4, Lieb;->v:Z

    const/16 v6, 0x10

    invoke-virtual {v4, v6, v1}, Lieb;->f(IZ)V

    invoke-static {p0}, Lieb;->c(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object p0

    iput-object p0, v4, Lieb;->e:Ljava/lang/CharSequence;
    ...
    iput-object v6, p0, Lgeb;->e:Ljava/lang/CharSequence;

    invoke-virtual {v4, p0}, Lieb;->i(Lweb;)V

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p0

    sget-object v6, Lflj;->e:Ljava/lang/Boolean;
    ...
    sput-object p0, Lflj;->e:Ljava/lang/Boolean;

    :cond_3
    sget-object p0, Lflj;->e:Ljava/lang/Boolean;
    ...
    iget-object v0, v4, Lieb;->G:Landroid/app/Notification;

    iput p0, v0, Landroid/app/Notification;->icon:I

    iput v6, v4, Lieb;->k:I

    invoke-static {p1}, Lflj;->I(Landroid/content/Context;)Z
    ...
    iget-object v0, v4, Lieb;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v5, p0, p3}, Lceb;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    :cond_4
    iput-object p3, v4, Lieb;->g:Landroid/app/PendingIntent;
    ...
    iget-object v5, v4, Lieb;->G:Landroid/app/Notification;
    ...
    iget-object v2, v4, Lieb;->G:Landroid/app/Notification;
    ...
    iget-object p0, v4, Lieb;->G:Landroid/app/Notification;

    iput-wide v7, p0, Landroid/app/Notification;->when:J

    iput-object p3, v4, Lieb;->g:Landroid/app/PendingIntent;

    invoke-virtual {v4, v0}, Lieb;->d(Ljava/lang/CharSequence;)V

    :goto_0
    sget-object p0, Lxi7;->c:Ljava/lang/Object;
    ...
    :cond_7
    :goto_1
    iput-object p0, v4, Lieb;->A:Ljava/lang/String;

    invoke-virtual {v4}, Lieb;->a()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p1, Lnj7;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
