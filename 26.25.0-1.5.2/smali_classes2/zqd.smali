...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lzqd;->a:Landroid/graphics/Paint;
    ...
    invoke-direct {v0, p0, v6}, Lyqd;-><init>(Lzqd;I)V

    invoke-virtual {p1, v0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lzqd;->c:Landroid/animation/ValueAnimator;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lzqd;->d:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lzqd;->f:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lzqd;->g:Landroid/graphics/RectF;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lzqd;->c:Landroid/animation/ValueAnimator;

    invoke-virtual {v0}, Landroid/animation/ValueAnimator;->cancel()V

    iget-object v0, p0, Lzqd;->h:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object p0, p0, Lzqd;->i:Landroid/animation/ValueAnimator;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Lzqd;->l:Z

    iget-object v1, p0, Lzqd;->d:Landroid/graphics/RectF;

    const/high16 v2, 0x40000000    # 2.0f

    if-eqz v0, :cond_0

    iget-object v0, p0, Lzqd;->e:Landroid/graphics/RectF;
    ...
    iget-object v3, p0, Lzqd;->f:Landroid/graphics/RectF;
    ...
    iget-object v7, p0, Lzqd;->a:Landroid/graphics/Paint;
...
.method public final setOnQrAnimationCompleteListener(Lv97;)V
    .locals 0
