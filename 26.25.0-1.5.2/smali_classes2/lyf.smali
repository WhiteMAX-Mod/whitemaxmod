...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Llyf;->p:Lks8;

    new-instance v3, Lbub;

    invoke-direct {v3, p1}, Lbub;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Llyf;->q:Lbub;

    new-instance v5, Ljyf;

    invoke-direct {v5, p1, v2}, Ljyf;-><init>(Landroid/content/Context;I)V

    invoke-static {v4, v5}, Luie;->d0(ILv97;)Lks8;

    move-result-object v5

    iput-object v5, p0, Llyf;->r:Lks8;
...
.method public static final q(Llyf;Lv40;)V
    .locals 8

    iget-object v0, p0, Llyf;->o:Lij9;
    ...
    :cond_7
    :goto_4
    invoke-direct {p0}, Llyf;->getTransferStatusView()Logi;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v4, v0, Llyf;->q:Lbub;

    if-ne v2, v4, :cond_0

    iget-boolean v5, v0, Llyf;->s:Z
    ...
    :cond_0
    iget-object v5, v0, Llyf;->o:Lij9;

    if-eq v2, v5, :cond_2

    if-eq v2, v4, :cond_2

    iget-object v4, v0, Llyf;->n:Lnii;
...
.method public final l(Ljj9;)V
    ...
    iget-object v1, p0, Llyf;->o:Lij9;

    invoke-virtual {v1, v0}, Lm08;->setImageAttach(Lb08;)V

    iget-object v1, p0, Llyf;->q:Lbub;

    invoke-direct {p0}, Llyf;->getBlurPostProcessor()Lsy0;
    ...
    invoke-direct {p0}, Llyf;->getMediaType()Lp0a;
