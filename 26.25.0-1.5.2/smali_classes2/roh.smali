...
# static fields
.field public static final t:Lks8;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lroh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    iput-object v1, p0, Lroh;->b:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lroh;->c:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, Lroh;->d:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lroh;->e:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lroh;->f:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lroh;->g:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lroh;->h:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/PathMeasure;

    invoke-direct {p1}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object p1, p0, Lroh;->i:Landroid/graphics/PathMeasure;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lroh;->j:Landroid/graphics/RectF;

    new-instance p1, Lloh;

    invoke-direct {p1, p0, v2}, Lloh;-><init>(Lroh;I)V
    ...
    iput-object p1, p0, Lroh;->k:Lks8;

    new-instance p1, Lloh;

    invoke-direct {p1, p0, v4}, Lloh;-><init>(Lroh;I)V

    invoke-static {v3, p1}, Luie;->d0(ILv97;)Lks8;

    move-result-object p1

    iput-object p1, p0, Lroh;->l:Lks8;
    ...
    iput-object p1, p0, Lroh;->m:Lks8;

    new-instance p1, Lloh;

    invoke-direct {p1, p0, v3}, Lloh;-><init>(Lroh;I)V

    invoke-static {v3, p1}, Luie;->d0(ILv97;)Lks8;

    move-result-object p1

    iput-object p1, p0, Lroh;->n:Lks8;
...
.method public static a(Lroh;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-direct {p0, p1}, Lroh;->setDrawableColor(I)V
...
.method private final setDrawableColor(I)V
    ...
    iget-object p0, p0, Lroh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;

    invoke-static {p0, v0, p1}, Lprf;->d0(Lwei;Ljava/lang/String;I)V
...
.method public final b(IZ)V
    ...
    invoke-virtual {p0, v2}, Lroh;->onThemeChanged(Lc4c;)V

    const/4 v2, 0x3

    if-nez p2, :cond_1

    new-instance p2, Lg4a;

    invoke-direct {p2, p1, p0, v2}, Lg4a;-><init>(ILandroid/view/ViewGroup;I)V

    invoke-static {p0, p2}, Lcui;->e(Landroid/view/View;Lv97;)V
    ...
    :cond_2
    iget-object p2, p0, Lroh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    invoke-direct {p0}, Lroh;->getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lroh;->getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-boolean v0, p0, Lroh;->r:Z

    invoke-static {p2, v0}, Ll97;->e(Lg2f;Z)Lr3c;

    move-result-object p2

    iget-object p2, p2, Lr3c;->c:Lp3c;

    iget p2, p2, Lp3c;->a:I

    invoke-direct {p0, p2}, Lroh;->setDrawableColor(I)V
    ...
    iget-boolean p2, p0, Lroh;->s:Z

    if-nez p2, :cond_8

    invoke-direct {p0}, Lroh;->getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lroh;->getLoadingAnimator()Landroid/animation/ValueAnimator;
...
.method public final onAttachedToWindow()V
    ...
    invoke-direct {v1, v0, p0, v2}, Lg4a;-><init>(ILandroid/view/ViewGroup;I)V

    invoke-static {p0, v1}, Lcui;->e(Landroid/view/View;Lv97;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lroh;->d:Landroid/graphics/Paint;

    iget-object v3, p0, Lroh;->j:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-object v0, p0, Lroh;->i:Landroid/graphics/PathMeasure;
    ...
    invoke-static {v5, v4, v2, v4}, Let9;->c(FFFF)F
    ...
    iget-object v4, p0, Lroh;->h:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    cmpl-float v5, v2, v8

    iget-object p0, p0, Lroh;->f:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lroh;->b:Landroid/widget/ImageView;
    ...
    invoke-static {p2, p1, p3, p4, p5}, Ljm4;->M(Landroid/view/View;IIII)V
    ...
    iget-object p0, p0, Lroh;->c:Landroid/widget/ImageView;

    invoke-static {p0, p1, p3, p4, p5}, Ljm4;->M(Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    invoke-static {v1, v0, v2}, Lgu1;->a(FFI)I
    ...
    iget-object v4, p0, Lroh;->b:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lroh;->c:Landroid/widget/ImageView;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lroh;->j:Landroid/graphics/RectF;

    const/4 p4, 0x0

    invoke-virtual {p3, p4, p4, p1, p2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lroh;->g:Landroid/graphics/Path;
    ...
    iget-object p4, p0, Lroh;->e:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Lroh;->i:Landroid/graphics/PathMeasure;
...
.method public final onThemeChanged(Lc4c;)V
    ...
    iget-boolean v1, p0, Lroh;->r:Z

    invoke-static {v0, v1}, Ll97;->e(Lg2f;Z)Lr3c;

    move-result-object v0

    iget-object v1, v0, Lr3c;->d:Ln3c;

    iget-object v2, v0, Lr3c;->c:Lp3c;
    ...
    iget-object v5, p0, Lroh;->e:Landroid/graphics/Paint;

    invoke-virtual {v5, v4}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v4, p0, Lroh;->s:Z
    ...
    :goto_0
    iget-object v4, p0, Lroh;->f:Landroid/graphics/Paint;

    invoke-virtual {v4, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v1, p0, Lroh;->s:Z
    ...
    iget-object v4, p0, Lroh;->c:Landroid/widget/ImageView;
    ...
    :goto_3
    invoke-direct {p0, v2}, Lroh;->setDrawableColor(I)V
