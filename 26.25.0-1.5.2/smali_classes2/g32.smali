...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Ls32;->A(Ls32;)V
    ...
    iget-object v1, v0, Ls32;->A1:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, Ls32;->e0(Ljava/lang/CharSequence;)V
    ...
    iget-object v6, v0, Ls32;->w1:Lu52;

    const/4 v2, 0x1

    if-eqz v6, :cond_13

    iget-object v3, v6, Lu52;->a:Landroid/view/View;

    iget-object v5, v6, Lu52;->q:[F

    iget-object v7, v6, Lu52;->r:[F

    iget-object v8, v6, Lu52;->j:Landroid/view/ScaleGestureDetector;

    iget-object v11, v6, Lu52;->h:Landroid/graphics/Matrix;

    iget-object v12, v6, Lu52;->t:Landroid/graphics/Matrix;

    iget-boolean v9, v6, Lu52;->v:Z

    if-nez v9, :cond_0

    invoke-virtual {v6}, Lu52;->g()V

    :cond_0
    iget-boolean v9, v6, Lu52;->x:Z
    ...
    :cond_4
    iget-object v9, v6, Lu52;->n:Landroid/view/GestureDetector;
    ...
    iget-boolean v9, v6, Lu52;->k:Z

    if-nez v9, :cond_5

    iget-boolean v9, v6, Lu52;->l:Z
    ...
    :cond_9
    iput-boolean v4, v6, Lu52;->x:Z

    iget-boolean v8, v6, Lu52;->m:Z

    iput-boolean v4, v6, Lu52;->m:Z

    if-eqz v15, :cond_c

    iget-boolean v9, v6, Lu52;->A:Z
    ...
    invoke-direct/range {v5 .. v10}, Lfv1;-><init>(Lu52;FFFF)V

    invoke-static {v12}, Lrud;->a(Landroid/graphics/Matrix;)F

    move-result v16

    invoke-static {v11}, Lrud;->a(Landroid/graphics/Matrix;)F
    ...
    invoke-direct {v4, v6}, Lq52;-><init>(Lu52;)V
    ...
    invoke-direct {v4, v5, v6}, Lr52;-><init>(Lfv1;Lu52;)V

    invoke-virtual {v3, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    :goto_5
    iget-object v4, v6, Lu52;->w:Lo52;
    ...
    iput-object v3, v6, Lu52;->u:Landroid/animation/ValueAnimator;
    ...
    :goto_9
    iget-object v0, v0, Ls32;->v1:Landroid/view/GestureDetector;
    ...
    invoke-static {v0}, Ls32;->E(Ls32;)V
