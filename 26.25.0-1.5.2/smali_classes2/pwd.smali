...
.method public synthetic constructor <init>(Ljava/lang/Object;FI)V
    ...
    iput-object p1, p0, Lpwd;->c:Ljava/lang/Object;
...
.method public final onAnimationCancel(Landroid/animation/Animator;)V
    ...
    iget-object p1, p0, Lpwd;->c:Ljava/lang/Object;

    check-cast p1, Lzli;

    invoke-static {p1}, Lzli;->x(Lzli;)Landroid/graphics/Path;

    move-result-object v0

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    invoke-static {p1}, Lzli;->D(Lzli;)Landroid/graphics/RectF;

    move-result-object v1

    iget-object v2, p1, Lzli;->u1:Ljava/lang/Integer;
    ...
    :goto_0
    iget-object v4, p1, Lzli;->t1:Ljava/lang/Integer;
...
.method public final onAnimationEnd(Landroid/animation/Animator;)V
    ...
    iget-object p0, p0, Lpwd;->c:Ljava/lang/Object;

    packed-switch p1, :pswitch_data_0

    check-cast p0, Lzli;

    invoke-static {p0}, Lzli;->x(Lzli;)Landroid/graphics/Path;

    move-result-object p1

    invoke-virtual {p1}, Landroid/graphics/Path;->reset()V

    invoke-static {p0}, Lzli;->D(Lzli;)Landroid/graphics/RectF;

    move-result-object v1

    iget-object v2, p0, Lzli;->u1:Ljava/lang/Integer;
    ...
    :goto_0
    iget-object v4, p0, Lzli;->t1:Ljava/lang/Integer;
