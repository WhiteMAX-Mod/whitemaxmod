...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lhb;-><init>(Lwqb;)V

    iput-object v0, p0, Lwqb;->a:Lhb;

    new-instance v0, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v0}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v0, p0, Lwqb;->b:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v1, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v1}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v1, p0, Lwqb;->c:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v2}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v2, p0, Lwqb;->d:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v3, Landroid/graphics/Matrix;

    invoke-direct {v3}, Landroid/graphics/Matrix;-><init>()V

    iput-object v3, p0, Lwqb;->e:Landroid/graphics/Matrix;

    new-instance v3, Lz32;

    const/16 v4, 0x17

    invoke-direct {v3, p1, v4}, Lz32;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v3, p0, Lwqb;->f:Lks8;

    new-instance v3, Lsca;

    const/16 v5, 0xa

    invoke-direct {v3, p1, v5, p0}, Lsca;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v4, v3}, Luie;->d0(ILv97;)Lks8;

    move-result-object p1

    iput-object p1, p0, Lwqb;->g:Lks8;
    ...
    invoke-direct {p1, v3}, Ljq4;-><init>(F)V
    ...
    invoke-virtual {p0}, Lwqb;->getState()Lvqb;

    move-result-object p1

    invoke-virtual {p0, p1}, Lwqb;->a(Lvqb;)V
    ...
    invoke-virtual {p0, p1}, Lwqb;->onThemeChanged(Lc4c;)V
...
.method public final a(Lvqb;)V
    ...
    iget-object v1, p0, Lwqb;->g:Lks8;

    const/16 v2, 0x8

    iget-object p0, p0, Lwqb;->f:Lks8;
...
.method public final getState()Lvqb;
    .locals 2

    sget-object v0, Lwqb;->h:[Lfq8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, Lwqb;->a:Lhb;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lwqb;->e:Landroid/graphics/Matrix;
    ...
    iget-object p1, p0, Lwqb;->b:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object p1, p0, Lwqb;->c:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object p0, p0, Lwqb;->d:Landroid/graphics/drawable/ShapeDrawable;
...
.method public final onThemeChanged(Lc4c;)V
    ...
    iget-object v1, v0, Lwqb;->b:Landroid/graphics/drawable/ShapeDrawable;
    ...
    invoke-interface/range {p1 .. p1}, Lc4c;->x()Lymh;
    ...
    iget-object v3, v0, Lwqb;->e:Landroid/graphics/Matrix;

    invoke-virtual {v2, v3}, Landroid/graphics/Shader;->setLocalMatrix(Landroid/graphics/Matrix;)V

    invoke-virtual {v1, v2}, Landroid/graphics/Paint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;

    iget-object v1, v0, Lwqb;->c:Landroid/graphics/drawable/ShapeDrawable;
    ...
    invoke-interface/range {p1 .. p1}, Lc4c;->u()Lb4c;

    move-result-object v2

    iget-object v2, v2, Lb4c;->i:Ltnj;

    iget-object v2, v2, Ltnj;->a:Ljava/lang/Object;

    check-cast v2, Lof3;

    iget-object v2, v2, Lof3;->b:Ljava/lang/Object;

    check-cast v2, Ll3c;

    iget-object v13, v2, Ll3c;->a:[I
    ...
    iget-object v1, v0, Lwqb;->d:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object v2, v2, Lof3;->c:Ljava/lang/Object;

    check-cast v2, Lj3c;

    iget-object v13, v2, Lj3c;->a:[I
...
.method public final setState(Lvqb;)V
    .locals 2
