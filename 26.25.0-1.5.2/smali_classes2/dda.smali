...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2, v3, p0}, Lyf5;-><init>(ILjava/lang/Object;)V

    invoke-direct {v0, p1, v2}, Lvp3;-><init>(Landroid/content/Context;Lup3;)V

    iput-object v0, p0, Ldda;->a:Lvp3;
    ...
    invoke-direct {v4, v5, p0}, Llz8;-><init>(ILjava/lang/Object;)V

    const/4 v5, 0x7

    invoke-direct {v2, v1, v4, v5}, Laz8;-><init>(Lxy8;Lv97;I)V

    iput-object v2, p0, Ldda;->e:Laz8;

    new-instance v1, Lhb;

    const/16 v2, 0x14

    invoke-direct {v1, p0, v2}, Lhb;-><init>(Landroid/graphics/drawable/Drawable$Callback;I)V

    iput-object v1, p0, Ldda;->g:Lhb;

    iput-object v0, p0, Ldda;->h:Lvp3;

    const/4 v0, 0x1

    iput v0, p0, Ldda;->i:I

    iput-boolean v0, p0, Ldda;->m:Z

    invoke-static {p1}, Lw59;->H(Landroid/content/Context;)Landroid/view/WindowManager;
    ...
    iput-object p1, p0, Ldda;->r:Landroid/graphics/Rect;

    new-instance p1, Ltm;

    invoke-direct {p1, v3, p0}, Ltm;-><init>(ILjava/lang/Object;)V

    iput-object p1, p0, Ldda;->s:Ltm;
...
.method public static synthetic c(Ldda;)V
    .locals 0

    invoke-static {p0}, Ldda;->setLayout$lambda$0(Ldda;)V
...
.method public static synthetic d(Landroid/graphics/drawable/AnimationDrawable;)V
    ...
    invoke-static {p0}, Ldda;->setStartDrawable$lambda$0(Landroid/graphics/drawable/Drawable;)V

    return-void
.end method

.method public static f(Ldda;)V
    .locals 6

    invoke-direct {p0}, Ldda;->getHighlightTextHelper()Lqq7;

    move-result-object v0

    iget-object v0, v0, Lqq7;->a:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Lxze;->a:Landroid/text/style/ForegroundColorSpan;
    ...
    :cond_2
    iget-object v5, v4, Lxze;->b:Landroid/text/style/BackgroundColorSpan;
...
.method private final getHighlightTextHelper()Lqq7;
    .locals 0

    iget-object p0, p0, Ldda;->b:Lks8;
...
.method private static final setLayout$lambda$0(Ldda;)V
    .locals 4
...
.method public final a(Ljava/lang/String;Lcz8;Landroid/text/style/ClickableSpan;)V
    ...
    iget-object p0, p0, Ldda;->f:Lxy8;

    if-eqz p0, :cond_0

    invoke-interface {p0, p1, p2, p3}, Lxy8;->a(Ljava/lang/String;Lcz8;Landroid/text/style/ClickableSpan;)V
...
.method public final b(Lc9a;)V
    ...
    invoke-interface {p0, p1}, Lxy8;->b(Lc9a;)V
...
.method public final e(I)I
    ...
    invoke-virtual {p0}, Ldda;->getLayout()Landroid/text/Layout;
...
.method public final getDefaultMovementMethod()Lvp3;
    .locals 0

    iget-object p0, p0, Ldda;->a:Lvp3;
...
.method public final getMovementMethod()Lvp3;
    .locals 0

    iget-object p0, p0, Ldda;->h:Lvp3;

    return-object p0
.end method

.method public final getOnDoubleClickListener()Lx97;
    .locals 2
    ...
    sget-object v0, Ldda;->t:[Lfq8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, Ldda;->g:Lhb;
...
.method public final h(Ljava/util/List;)V
    ...
    invoke-direct/range {p0 .. p0}, Ldda;->getHighlightTextHelper()Lqq7;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Ldda;->getText()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Ldda;->getLayout()Landroid/text/Layout;

    move-result-object v2

    iget-object v3, v0, Lqq7;->a:Ljava/util/ArrayList;
    ...
    iget-object v6, v0, Lqq7;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v6 .. v13}, Lpq7;-><init>(ILjava/lang/String;FFFFF)V
...
.method public final j()V
    ...
    iget-object v1, v0, Ldda;->n:Lbda;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lbda;->b()Landroid/text/Layout;
    ...
    :goto_0
    iget-object v3, v0, Ldda;->o:Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iget-object v6, v0, Ldda;->n:Lbda;

    if-eqz v6, :cond_3

    iget-object v6, v6, Lbda;->d:Lj3h;
    ...
    iget-object v2, v15, Lutd;->a:Lttd;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v0, p0, Ldda;->n:Lbda;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lbda;->e:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final onDoubleTap(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0}, Ldda;->getOnDoubleClickListener()Lx97;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_1
    iget-object v1, p0, Ldda;->r:Landroid/graphics/Rect;
    ...
    :cond_2
    iget-object v1, p0, Ldda;->o:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, v1, Lqq7;->c:Lks8;

    iget-object v6, v1, Lqq7;->b:Lks8;
    ...
    iget-object p0, v1, Lqq7;->a:Ljava/util/ArrayList;
    ...
    iget-object p1, v0, Lpq7;->b:Ljava/lang/String;
...
.method public final onLongClick(Landroid/view/View;)Z
    ...
    iget-object p0, p0, Ldda;->c:Landroid/view/View$OnLongClickListener;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {v3, v4, v2}, Lbmi;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iput-object v3, v0, Lvp3;->d:Lbmi;

    iput-object v1, v0, Lvp3;->e:Landroid/text/Spannable;

    :cond_2
    iget-object v0, v0, Lvp3;->l:Landroid/view/GestureDetector;
...
.method public final setLayout(Lbda;)V
    .locals 2
    ...
    :cond_0
    iput-object p1, p0, Ldda;->n:Lbda;

    iget-object v0, p1, Lbda;->e:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final setLinkListener(Lxy8;)V
    ...
    iput-object p1, p0, Ldda;->f:Lxy8;

    iget-object p0, p0, Ldda;->e:Laz8;
...
.method public final setLinkLongClickListener(Lup3;)V
    .locals 0

    iput-object p1, p0, Ldda;->d:Lup3;
...
.method public final setMovementMethod(Lvp3;)V
    .locals 0

    iput-object p1, p0, Ldda;->h:Lvp3;

    return-void
.end method

.method public final setOnDoubleClickListener(Lx97;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V
    ...
    iput-object p1, p0, Ldda;->c:Landroid/view/View$OnLongClickListener;
...
.method public final setSingleClickAction(Ljava/lang/Runnable;)V
    ...
    invoke-direct {v0, p1, v1}, Lcda;-><init>(Ljava/lang/Runnable;I)V

    iput-object v0, p0, Lvp3;->h:Lv97;
...
.method public final setStartDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Ldda;->o:Landroid/graphics/drawable/Drawable;
...
.method public final setTextColors(Lr3c;)V
    .locals 6
    ...
    :cond_5
    instance-of v5, v3, Lutd;

    if-eqz v5, :cond_6

    check-cast v3, Lutd;

    invoke-virtual {v3, p1}, Lutd;->d(Lr3c;)V

    goto :goto_2

    :cond_6
    instance-of v5, v3, Lsld;
...
.method public final setTryToSingleClickAction(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, Lvp3;->j:Ljava/lang/Runnable;
