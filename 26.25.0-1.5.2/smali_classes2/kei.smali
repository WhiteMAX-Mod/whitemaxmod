...
.method public final e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iput-object p4, p0, Loei;->b:Ljava/lang/String;
    ...
    invoke-static {p4}, Ljm4;->v(Ljava/lang/String;)[Lbhc;

    move-result-object p4

    iput-object p4, p0, Loei;->a:[Lbhc;

    :cond_1
    const-string p4, "fillType"

    invoke-static {p2, p4}, Lxjl;->h(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
