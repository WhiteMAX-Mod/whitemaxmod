...
.method public final b(Lymh;)V
    ...
    iget-object v2, v1, Lymh;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lweb;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lfeb;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Leeb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Lfeb;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lfeb;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Ldeb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Lweb;->d:Z

    if-eqz v1, :cond_8

    iget-object v0, v0, Lweb;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v0}, Leeb;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v6}, Leeb;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
