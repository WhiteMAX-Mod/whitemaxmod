...
.field public static final j:Ls05;

.field public static final k:Lso8;

.field public static l:Lokl;

.field public static m:Lvml;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lvt5;->i:Ljava/lang/ThreadLocal;

    new-instance v0, Ls05;

    const/4 v1, 0x7

    invoke-direct {v0, v1}, Ls05;-><init>(I)V

    sput-object v0, Lvt5;->j:Ls05;

    new-instance v0, Lso8;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lvt5;->k:Lso8;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lvt5;->a:Landroid/content/Context;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v7, p1}, Lif8;->w(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static c(Landroid/content/Context;Lut5;Ljava/lang/String;)Lvt5;
    .locals 29
    ...
    sget-object v13, Lvt5;->i:Ljava/lang/ThreadLocal;
    ...
    sget-object v9, Lvt5;->k:Lso8;

    invoke-interface {v2, v1, v3, v9}, Lut5;->c(Landroid/content/Context;Ljava/lang/String;Ltt5;)Led0;
    ...
    invoke-direct {v0, v12}, Lvt5;-><init>(Landroid/content/Context;)V
    :try_end_0
    ...
    :goto_1
    iget-object v1, v15, Ligl;->a:Landroid/database/Cursor;
    ...
    :try_start_3
    invoke-static/range {p0 .. p0}, Lvt5;->e(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_11

    sget-object v5, Lvt5;->d:Ljava/lang/Boolean;
    ...
    iget-object v7, v4, Ligl;->a:Landroid/database/Cursor;
    ...
    iget-object v4, v4, Ligl;->a:Landroid/database/Cursor;

    new-instance v10, Lyib;

    const/4 v11, 0x0

    invoke-direct {v10, v11}, Lyib;-><init>(Ljava/lang/Object;)V

    const-class v10, Lvt5;
    ...
    invoke-direct {v5, v7}, Lyib;-><init>(Ljava/lang/Object;)V

    new-instance v7, Lyib;

    invoke-direct {v7, v4}, Lyib;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v6, v5, v3, v0, v7}, Lvml;->o0(Lyib;Ljava/lang/String;ILyib;)Lgy7;
    ...
    invoke-virtual {v6, v5, v3, v0, v7}, Lvml;->n0(Lyib;Ljava/lang/String;ILyib;)Lgy7;
    ...
    invoke-direct {v4, v0}, Lvt5;-><init>(Landroid/content/Context;)V
    ...
    invoke-static/range {p0 .. p0}, Lvt5;->h(Landroid/content/Context;)Lokl;

    move-result-object v4

    if-eqz v4, :cond_f

    invoke-virtual {v4}, Lg6k;->l0()Landroid/os/Parcel;

    move-result-object v6

    const/4 v7, 0x6

    invoke-virtual {v4, v7, v6}, Lg6k;->V(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    :try_start_d
    invoke-direct {v6, v10}, Lyib;-><init>(Ljava/lang/Object;)V

    iget-object v5, v5, Ligl;->a:Landroid/database/Cursor;

    new-instance v7, Lyib;

    invoke-direct {v7, v5}, Lyib;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v4, v6, v3, v0, v7}, Lokl;->q0(Lyib;Ljava/lang/String;ILyib;)Lgy7;
    ...
    invoke-direct {v5, v10}, Lyib;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v4, v5, v3, v0}, Lokl;->o0(Lyib;Ljava/lang/String;I)Lgy7;
    ...
    invoke-virtual {v4, v5, v3, v0}, Lokl;->n0(Lyib;Ljava/lang/String;I)Lgy7;
    ...
    invoke-direct {v5, v4, v6, v2}, Lxr6;-><init>(IIB)V

    move-object/from16 v2, p1

    invoke-interface {v2, v10, v3, v5}, Lut5;->c(Landroid/content/Context;Ljava/lang/String;Ltt5;)Led0;
    ...
    invoke-direct {v4, v12}, Lvt5;-><init>(Landroid/content/Context;)V
    :try_end_11
    ...
    :goto_b
    iget-object v0, v15, Ligl;->a:Landroid/database/Cursor;
    ...
    :cond_13
    sget-object v0, Lvt5;->i:Ljava/lang/ThreadLocal;
    ...
    :cond_18
    sget-object v1, Lvt5;->i:Ljava/lang/ThreadLocal;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Z)I
    ...
    :try_start_1
    sget-object v0, Lvt5;->d:Ljava/lang/Boolean;
    :try_end_1
    ...
    :try_start_4
    invoke-static {v8}, Lvt5;->g(Ljava/lang/ClassLoader;)V
    :try_end_4
    .catch Lcom/google/android/gms/dynamite/DynamiteModule$LoadingException; {:try_start_4 .. :try_end_4} :catch_0
    ...
    :cond_1
    invoke-static {p0}, Lvt5;->e(Landroid/content/Context;)Z
    ...
    :cond_3
    :try_start_8
    invoke-static {p0, p1, p2, v4}, Lvt5;->f(Landroid/content/Context;Ljava/lang/String;ZZ)I

    move-result v9

    sget-object v10, Lvt5;->e:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {}, Ljck;->d()Ljava/lang/ClassLoader;
    ...
    invoke-static {}, Llw;->f()V

    sget-object v10, Lvt5;->e:Ljava/lang/String;

    invoke-static {v10}, Lflj;->r(Ljava/lang/Object;)V

    invoke-static {}, Ljava/lang/ClassLoader;->getSystemClassLoader()Ljava/lang/ClassLoader;

    move-result-object v11

    invoke-static {v11, v10}, Llw;->d(Ljava/lang/ClassLoader;Ljava/lang/String;)Ldalvik/system/DelegateLastClassLoader;
    ...
    sget-object v11, Lvt5;->e:Ljava/lang/String;

    invoke-static {v11}, Lflj;->r(Ljava/lang/Object;)V
    ...
    :goto_6
    sput-object v0, Lvt5;->d:Ljava/lang/Boolean;
    ...
    :try_start_11
    invoke-static {p0, p1, p2, v6}, Lvt5;->f(Landroid/content/Context;Ljava/lang/String;ZZ)I
    ...
    invoke-static {p0}, Lvt5;->h(Landroid/content/Context;)Lokl;
    ...
    :cond_b
    :try_start_13
    invoke-virtual {v7}, Lg6k;->l0()Landroid/os/Parcel;

    move-result-object v0

    const/4 v2, 0x6

    invoke-virtual {v7, v2, v0}, Lg6k;->V(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    iget-object v2, v2, Ligl;->a:Landroid/database/Cursor;
    ...
    invoke-direct {v8, p0}, Lyib;-><init>(Ljava/lang/Object;)V

    sget-object v2, Lvt5;->j:Ls05;
    ...
    invoke-virtual/range {v7 .. v12}, Lokl;->p0(Lyib;Ljava/lang/String;ZJ)Lgy7;
    ...
    iget-object v2, v0, Ligl;->a:Landroid/database/Cursor;

    if-nez v2, :cond_e

    iput-object p1, v0, Ligl;->a:Landroid/database/Cursor;
    :try_end_14
    ...
    invoke-static {p2, p1}, Lxfk;->b(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    invoke-virtual {v7, p1, p2}, Lg6k;->V(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-virtual {v7, v0, p2}, Lg6k;->V(ILandroid/os/Parcel;)Landroid/os/Parcel;
...
.method public static e(Landroid/content/Context;)Z
    ...
    :cond_0
    sget-object v1, Lvt5;->h:Ljava/lang/Boolean;
    ...
    :cond_1
    sget-object v0, Lvt5;->h:Ljava/lang/Boolean;
    ...
    sget-object v4, Lyi7;->b:Lyi7;

    const v5, 0x989680

    invoke-virtual {v4, p0, v5}, Lyi7;->c(Landroid/content/Context;I)I
    ...
    sput-object p0, Lvt5;->h:Ljava/lang/Boolean;
...
.method public static f(Landroid/content/Context;Ljava/lang/String;ZZ)I
    ...
    sput-object p0, Lvt5;->e:Ljava/lang/String;
    ...
    :try_start_b
    sget-object v4, Lvt5;->i:Ljava/lang/ThreadLocal;
    ...
    iget-object v5, v4, Ligl;->a:Landroid/database/Cursor;

    if-nez v5, :cond_e

    iput-object v8, v4, Ligl;->a:Landroid/database/Cursor;
    :try_end_b
...
.method public static g(Ljava/lang/ClassLoader;)V
    ...
    invoke-direct {v1, p0, v0, v2}, Lg6k;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V

    :goto_0
    sput-object v1, Lvt5;->m:Lvml;
    :try_end_0
...
.method public static h(Landroid/content/Context;)Lokl;
    .locals 6
    ...
    invoke-direct {v3, p0, v4, v5}, Lg6k;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V

    :goto_0
    if-eqz v3, :cond_3

    sput-object v3, Lvt5;->l:Lokl;
    :try_end_1
...
.method public final b(Ljava/lang/String;)Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object p0, p0, Lvt5;->a:Landroid/content/Context;
