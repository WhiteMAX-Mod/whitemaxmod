...
.method public constructor <init>(Landroid/content/Context;Landroidx/media3/common/b;Landroid/media/MediaFormat;Ljava/lang/String;ZLandroid/view/Surface;)V
    ...
    iput-object p2, p0, Le25;->c:Landroidx/media3/common/b;

    iput-object p3, p0, Le25;->b:Landroid/media/MediaFormat;

    iput-boolean p5, p0, Le25;->g:Z
    ...
    iput-object v0, p0, Le25;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iput-object v0, p0, Le25;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v3, p6}, Ljz8;->t(ZLjava/lang/Object;)V
    ...
    iput-object v7, p0, Le25;->d:Landroid/media/MediaCodec;

    iput-object v6, p0, Le25;->e:Landroid/view/Surface;

    invoke-static {p1}, Lu2i;->P(Landroid/content/Context;)Z
    ...
    invoke-static {p2, p6, p1}, Lg9e;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    :goto_7
    iget-boolean p0, p0, Le25;->h:Z

    new-instance p6, Lag2;

    invoke-virtual {p3}, Landroid/media/MediaFormat;->toString()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p6, p3, p4, p0, p5}, Lag2;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, p2, p6}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILag2;)Landroidx/media3/transformer/ExportException;
...
.method public static a(Landroid/media/MediaFormat;ZLkia;)Landroidx/media3/common/b;
    .locals 1

    invoke-static {p0}, Lv2k;->a(Landroid/media/MediaFormat;)Landroidx/media3/common/b;
    ...
    iput-object p2, v0, Loy6;->k:Lkia;

    if-eqz p1, :cond_0

    iget p1, p0, Landroidx/media3/common/b;->H:I
...
.method public final b(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :goto_0
    invoke-virtual {p0}, Le25;->c()Ljava/lang/String;

    move-result-object v2

    new-instance v3, Lag2;

    iget-object v4, p0, Le25;->b:Landroid/media/MediaFormat;
    ...
    invoke-direct {v3, v4, v2, p0, v0}, Lag2;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, v1, v3}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILag2;)Landroidx/media3/transformer/ExportException;
...
.method public final c()Ljava/lang/String;
    ...
    iget-object p0, p0, Le25;->d:Landroid/media/MediaCodec;

    if-lt v0, v1, :cond_0

    invoke-static {p0}, Leo;->j(Landroid/media/MediaCodec;)Ljava/lang/String;
...
.method public final d()Ljava/nio/ByteBuffer;
    ...
    :cond_0
    iget-object v0, p0, Le25;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object p0, p0, Le25;->k:Ljava/nio/ByteBuffer;
...
.method public final f(Lwy4;)Z
    ...
    iget-object v2, p0, Le25;->d:Landroid/media/MediaCodec;

    iget-boolean v3, p0, Le25;->n:Z
    ...
    iput-object v2, p1, Lwy4;->d:Ljava/nio/ByteBuffer;
    :try_end_1
    ...
    invoke-static {v1, v0, p1}, Lg9e;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V

    invoke-virtual {p0, p1}, Le25;->b(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :cond_2
    :goto_1
    iget-object p0, p1, Lwy4;->d:Ljava/nio/ByteBuffer;
...
.method public final g(Z)Z
    ...
    iget-boolean v2, p0, Le25;->g:Z

    iget-object v3, p0, Le25;->c:Landroidx/media3/common/b;

    iget-object v4, p0, Le25;->d:Landroid/media/MediaCodec;

    iget-object v5, p0, Le25;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v0, v3, Landroidx/media3/common/b;->l:Lkia;

    invoke-static {p1, v2, v0}, Le25;->a(Landroid/media/MediaFormat;ZLkia;)Landroidx/media3/common/b;

    move-result-object p1

    iput-object p1, p0, Le25;->j:Landroidx/media3/common/b;

    if-eqz v2, :cond_2

    iget-object p1, v3, Landroidx/media3/common/b;->n:Ljava/lang/String;
    ...
    iget-object p1, p0, Le25;->j:Landroidx/media3/common/b;
    ...
    iget v0, v3, Landroidx/media3/common/b;->H:I
    ...
    iput-object v0, p0, Le25;->j:Landroidx/media3/common/b;
    ...
    iget-object p0, p0, Le25;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object p1, p0, Le25;->k:Ljava/nio/ByteBuffer;
    :try_end_5
...
.method public final h(Lwy4;)V
    .locals 9

    iget-boolean v0, p0, Le25;->n:Z
    ...
    iget-object v3, p1, Lwy4;->d:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p1, v6}, Lr01;->g(I)Z

    move-result v7

    if-eqz v7, :cond_4

    iput-boolean v1, p0, Le25;->n:Z

    sget-object v7, Liy4;->a:Ljava/util/LinkedHashMap;
    ...
    iput-object p0, p1, Lwy4;->d:Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1, p1}, Lg9e;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public final i()V
    ...
    iput-object v0, p0, Le25;->k:Ljava/nio/ByteBuffer;

    iget-object v0, p0, Le25;->e:Landroid/view/Surface;
...
.method public final j()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Le25;->k(JZ)V
...
.method public final k(JZ)V
    ...
    sget-object p1, Liy4;->a:Ljava/util/LinkedHashMap;
    ...
    invoke-static {p2, p3, p1}, Lg9e;->A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
