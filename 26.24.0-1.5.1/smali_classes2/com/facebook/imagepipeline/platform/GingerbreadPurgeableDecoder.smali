...
.method public static g(Lao3;I[B)Landroid/os/MemoryFile;
    .locals 8
    ...
    invoke-direct {v1, v4}, Lytc;-><init>(Ljx9;)V
    :try_end_0
    ...
    invoke-direct {v4, v1, p1}, Lhq8;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v4}, Lbo3;->b(Ljava/io/InputStream;)V

    invoke-static {v3}, Lbo3;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v3}, Lbo3;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lbo3;->b(Ljava/io/InputStream;)V

    invoke-static {p2}, Lbo3;->a(Ljava/io/Closeable;)V
...
.method public final c(Lao3;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Ljx9;->J()I

    move-result v0

    const/4 v1, 0x0

    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lao3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final d(Lao3;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lao3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final h(Lao3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->g(Lao3;I[B)Landroid/os/MemoryFile;
    ...
    invoke-static {p0, p2}, Lr98;->m(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
...
.method public final i(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-static {p1}, Lsel;->c(Ljava/lang/Throwable;)V
