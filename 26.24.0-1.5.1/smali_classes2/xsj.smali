...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lxsj;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lxsj;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lq21;->d(ILjava/lang/String;)I
    ...
    invoke-static {v2, p1}, Lq21;->d(ILjava/lang/String;)I
    ...
    iput v2, p0, Lxsj;->programId:I

    const-string v3, "glCreateProgram"

    invoke-static {v3}, Lq21;->b(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lq21;->b(Ljava/lang/String;)V
    ...
    iput v0, p0, Lxsj;->aVertexCoordLoc:I

    invoke-static {p1, v0}, Lq21;->c(Ljava/lang/String;I)V
    ...
    iput v1, p0, Lxsj;->aTextureCoordLoc:I

    invoke-static {p1, v1}, Lq21;->c(Ljava/lang/String;I)V
    ...
    iput v3, p0, Lxsj;->mvpMatrixLoc:I

    invoke-static {p1, v3}, Lq21;->c(Ljava/lang/String;I)V
    ...
    iput v3, p0, Lxsj;->texMatrixLoc:I
    ...
    iput v3, p0, Lxsj;->textureLocation:I
    ...
    iput v2, p0, Lxsj;->alphaLocation:I

    invoke-static {p1, v3}, Lq21;->c(Ljava/lang/String;I)V

    new-instance p1, Ljrj;

    invoke-direct {p1, v0, v1}, Ljrj;-><init>(II)V

    iput-object p1, p0, Lxsj;->frame:Ljrj;
...
.method public getTextureCoordLoc()I
    ...
    iget p0, p0, Lxsj;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget p0, p0, Lxsj;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lxsj;->firstFreeTexture:I
    ...
    iget p1, p0, Lxsj;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lxsj;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lxsj;->frame:Ljrj;

    iget-object v0, v0, Ljrj;->a:Lnsj;

    invoke-interface {v0}, Lnsj;->a()V

    iget p0, p0, Lxsj;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lxsj;->use()V

    iget-object v0, p0, Lxsj;->frame:Ljrj;

    iget-object v0, v0, Ljrj;->a:Lnsj;

    invoke-interface {v0}, Lnsj;->b()V

    invoke-virtual {p0}, Lxsj;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    iget v0, p0, Lxsj;->programId:I

    invoke-static {v0, p1}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result p1

    iget-object p0, p0, Lxsj;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lxsj;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lxsj;->texMat:[F
...
.method public unUse()V
    ...
    invoke-static {p0}, Lq21;->b(Ljava/lang/String;)V
...
.method public use()V
    ...
    iput v0, p0, Lxsj;->firstFreeTexture:I

    iget-object v1, p0, Lxsj;->mvpMat:[F
    ...
    iput-object v1, p0, Lxsj;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lxsj;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lxsj;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lxsj;->programId:I
    ...
    iget v1, p0, Lxsj;->mvpMatrixLoc:I

    iget-object v2, p0, Lxsj;->mvpMat:[F
    ...
    iget v2, p0, Lxsj;->texMatrixLoc:I

    iget-object v4, p0, Lxsj;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lq21;->b(Ljava/lang/String;)V

    iget v0, p0, Lxsj;->textureLocation:I

    invoke-virtual {p0}, Lxsj;->getTarget()I

    move-result v1

    iget v2, p0, Lxsj;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lxsj;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lxsj;->alphaLocation:I

    iget v1, p0, Lxsj;->alpha:F
    ...
    iget-object v0, p0, Lxsj;->customParams:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lxsj;->customParams:Ljava/util/HashMap;
