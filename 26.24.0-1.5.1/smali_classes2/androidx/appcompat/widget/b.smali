...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v1}, Lp3h;->a(Landroid/view/View;Landroid/content/Context;)V

    sget-object v1, Lvkd;->u:[I

    invoke-static {p1, p2, v1, v0}, Lmj6;->i(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lmj6;

    move-result-object v2

    iget-object v3, v2, Lmj6;->b:Ljava/lang/Object;
    ...
    iput-object v4, p0, Landroidx/appcompat/widget/b;->a:Lma;
    ...
    invoke-direct {v6, p1, v4}, Ljk4;-><init>(Landroid/content/Context;I)V

    iput-object v6, p0, Landroidx/appcompat/widget/b;->b:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v7, Landroidx/appcompat/widget/b;->i:[I
    ...
    iget-object v9, p0, Landroidx/appcompat/widget/b;->b:Landroid/content/Context;

    invoke-direct {v4, p0, v9, p2}, Los;-><init>(Landroidx/appcompat/widget/b;Landroid/content/Context;Landroid/util/AttributeSet;)V

    iget-object v9, p0, Landroidx/appcompat/widget/b;->b:Landroid/content/Context;

    invoke-static {v9, p2, v1, v0}, Lmj6;->i(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lmj6;

    move-result-object v1

    iget-object v9, v1, Lmj6;->b:Ljava/lang/Object;
    ...
    iput v9, p0, Landroidx/appcompat/widget/b;->g:I

    invoke-virtual {v1, v8}, Lmj6;->d(I)Landroid/graphics/drawable/Drawable;

    move-result-object v9

    invoke-virtual {v4, v9}, Lsu8;->p(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v3, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v4, Los;->C:Ljava/lang/CharSequence;

    invoke-virtual {v1}, Lmj6;->j()V

    iput-object v4, p0, Landroidx/appcompat/widget/b;->f:Lps;

    new-instance v1, Lhs;

    invoke-direct {v1, p0, p0, v4}, Lhs;-><init>(Landroidx/appcompat/widget/b;Landroidx/appcompat/widget/b;Los;)V

    iput-object v1, p0, Landroidx/appcompat/widget/b;->c:Lhs;
    ...
    invoke-direct {v1, p0}, Lks;-><init>(Landroidx/appcompat/widget/b;)V

    iput-object v1, p0, Landroidx/appcompat/widget/b;->f:Lps;

    invoke-virtual {v3, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v1, Lks;->c:Ljava/lang/CharSequence;
    ...
    iput-boolean v8, p0, Landroidx/appcompat/widget/b;->e:Z
    ...
    iput-object v6, p0, Landroidx/appcompat/widget/b;->d:Landroid/widget/SpinnerAdapter;

    :cond_6
    iget-object p0, p0, Landroidx/appcompat/widget/b;->a:Lma;
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/b;->f:Lps;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lps;->c()I
...
.method public final getInternalPopup()Lps;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/widget/b;->f:Lps;
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lps;->b()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lps;->f()Ljava/lang/CharSequence;
...
.method public final onDetachedFromWindow()V
    ...
    invoke-interface {p0}, Lps;->a()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p0}, Lps;->dismiss()V
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/b;->f:Lps;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/b;->c:Lhs;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lu07;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public final performClick()Z
    ...
    invoke-interface {v0, v1, p0}, Lps;->k(II)V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object p1, p0, Lls;->a:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v2, p0, Lls;->b:Landroid/widget/ListAdapter;
    ...
    invoke-static {p1, v1}, Ljs;->a(Landroid/widget/ThemedSpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    :cond_3
    invoke-interface {v0, p0}, Lps;->m(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lps;->j(I)V

    invoke-interface {v0, p1}, Lps;->d(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lps;->i(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lps;->p(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Lps;->g(Ljava/lang/CharSequence;)V
