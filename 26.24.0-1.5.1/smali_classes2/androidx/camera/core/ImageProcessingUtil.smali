...
.method public static a(Lww7;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lww7;)Z
...
.method public static b(Lre9;[B)Lww7;
    .locals 2

    invoke-virtual {p0}, Lre9;->f()I
    ...
    invoke-virtual {p0}, Lre9;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p1}, Lk7i;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    return-object p0
.end method

.method public static c(Lww7;)Landroid/graphics/Bitmap;
    .locals 15
...
.method public static d(Lww7;Lzw7;Ljava/nio/ByteBuffer;IZ)Ltu7;
    .locals 22

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lww7;)Z
    ...
    invoke-static {v2, v0}, Lk7i;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-interface/range {p1 .. p1}, Lzw7;->getSurface()Landroid/view/Surface;
    ...
    invoke-interface {v9}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v7}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v3, v4, v7, v5, v6}, Lqh5;->i(ILjava/lang/String;Ljava/lang/String;J)Ljava/lang/String;
    ...
    :cond_6
    invoke-interface/range {p1 .. p1}, Lzw7;->e()Lww7;
    ...
    invoke-direct {v1, v3}, Ltu7;-><init>(Lww7;)V

    new-instance v2, Lsw7;

    move-object/from16 v4, p0

    invoke-direct {v2, v3, v4, v0}, Lsw7;-><init>(Lww7;Lww7;I)V

    invoke-virtual {v1, v2}, Lk07;->b(Lj07;)V
...
.method public static i(Lww7;Lzw7;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Ltu7;
    .locals 26
    ...
    invoke-interface {v10}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v12}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v2, v0}, Ltu7;-><init>(Lww7;)V

    new-instance v3, Lsw7;

    move-object/from16 v4, p0

    invoke-direct {v3, v0, v4, v1}, Lsw7;-><init>(Lww7;Lww7;I)V

    invoke-virtual {v2, v3}, Lk07;->b(Lj07;)V
...
.method public static j(Lww7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Ltu7;
    .locals 25
    ...
    invoke-interface {v5}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v6}, Lvw7;->m()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1}, Lk7i;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v6 .. v12}, Luw7;-><init>(Lww7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II)V

    invoke-direct {v0, v6}, Ltu7;-><init>(Lww7;)V
