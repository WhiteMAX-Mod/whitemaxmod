...
.field public final synthetic b:Lpr7;


# direct methods
.method public constructor <init>(Lpr7;Lux;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lm66;->b:Lpr7;

    iput-object p2, p0, Lm66;->a:Lux;
...
.method public final T(Landroidx/media3/common/PlaybackException;)V
    ...
    :cond_0
    sget-object v0, Landroidx/media3/transformer/ExportException;->c:Lsyd;
    ...
    invoke-virtual {v0, v1}, Lsyd;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final t0(Lgch;)V
    ...
    iget-object v0, p0, Lm66;->a:Lux;

    const/4 v1, 0x1

    :try_start_0
    invoke-virtual {p1, v1}, Lgch;->a(I)Z

    move-result v2

    const/4 v3, 0x2

    invoke-virtual {p1, v3}, Lgch;->a(I)Z
    ...
    invoke-static {v6, v8, v7}, Lon4;->x(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :cond_3
    iget-object p0, p0, Lm66;->b:Lpr7;

    if-lez v2, :cond_4

    :try_start_1
    invoke-interface {v0, v2}, Lux;->c(I)V

    iget-object p0, p0, Lpr7;->f:Ljava/lang/Object;

    check-cast p0, Lc76;

    invoke-virtual {p0, v1}, Lc76;->n(Z)V
    ...
    invoke-static {v2, p0}, Lsfl;->b(Landroid/content/Context;Lfl9;)Ljava/lang/String;
    ...
    invoke-interface {v0, p0}, Lux;->d(Landroidx/media3/transformer/ExportException;)V
    :try_end_1
...
.method public final y0(La6h;I)V
    ...
    invoke-virtual {p1, v1, v0}, La6h;->n(ILz5h;)V

    iget-boolean p1, v0, Lz5h;->j:Z
    ...
    invoke-interface {p2, v0, v1}, Lux;->f(J)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p2, p0}, Lux;->d(Landroidx/media3/transformer/ExportException;)V
