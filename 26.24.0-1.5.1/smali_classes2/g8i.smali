...
.method public constructor <init>(Ld8i;)V
    ...
    iput-object p1, p0, Lg8i;->a:Ld8i;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lg8i;->d:Ljava/util/HashSet;

    invoke-interface {p1}, Ld8i;->f()I
    ...
    iput-object v1, p0, Lg8i;->b:Landroid/util/Range;

    invoke-interface {p1}, Ld8i;->c()I
    ...
    iput-object p1, p0, Lg8i;->c:Landroid/util/Range;
...
.method public final b(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lg8i;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lg8i;->a:Ld8i;

    if-eqz v0, :cond_0

    invoke-interface {v2}, Ld8i;->c()I
    ...
    iget-object p0, p0, Lg8i;->b:Landroid/util/Range;
...
.method public final d(II)Z
    ...
    iget-object v0, p0, Lg8i;->a:Ld8i;

    invoke-interface {v0, p1, p2}, Ld8i;->d(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lg8i;->d:Ljava/util/HashSet;
    ...
    :cond_3
    :goto_0
    iget-object v1, p0, Lg8i;->b:Landroid/util/Range;
    ...
    iget-object p0, p0, Lg8i;->c:Landroid/util/Range;
