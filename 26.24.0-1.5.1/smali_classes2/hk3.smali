...
.field public static final p:Laol;

.field public static final q:Lo7e;
...
.field public final synthetic n:Lik3;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhk3;->o:Landroid/graphics/Rect;
    ...
    sput-object v0, Lhk3;->q:Lo7e;

    return-void
.end method

.method public constructor <init>(Lik3;Lik3;)V
    .locals 1

    iput-object p1, p0, Lhk3;->n:Lik3;
    ...
    iput-object p1, p0, Lhk3;->d:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lhk3;->e:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lhk3;->f:Landroid/graphics/Rect;

    const/4 p1, 0x2

    new-array p1, p1, [I

    iput-object p1, p0, Lhk3;->g:[I
    ...
    iput-object p1, p0, Lhk3;->h:Landroid/view/accessibility/AccessibilityManager;
...
.method public final b(Landroid/view/View;)Lcia;
    ...
    iget-object p1, p0, Lhk3;->j:Lj86;

    if-nez p1, :cond_0

    new-instance p1, Lj86;

    invoke-direct {p1, p0}, Lj86;-><init>(Lhk3;)V

    iput-object p1, p0, Lhk3;->j:Lj86;

    :cond_0
    iget-object p0, p0, Lhk3;->j:Lj86;
...
.method public final d(Landroid/view/View;Lb5;)V
    ...
    iget-object v1, p0, Lq4;->a:Landroid/view/View$AccessibilityDelegate;

    invoke-virtual {v1, p1, v0}, Landroid/view/View$AccessibilityDelegate;->onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V

    iget-object p0, p0, Lhk3;->n:Lik3;

    iget-object p1, p0, Lik3;->e:Ljk3;

    if-eqz p1, :cond_0

    iget-boolean p1, p1, Ljk3;->o1:Z
    ...
    invoke-virtual {p2, p1}, Lb5;->h(Ljava/lang/CharSequence;)V
...
.method public final j(I)Z
    ...
    iget-object v2, p0, Lhk3;->n:Lik3;

    iput-boolean v1, v2, Lik3;->n:Z
    ...
    invoke-virtual {p0, p1, v1}, Lhk3;->p(II)V

    return v0
.end method

.method public final k(I)Lb5;
    .locals 11
    ...
    invoke-direct {v1, v0}, Lb5;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-virtual {v1, v3}, Lb5;->h(Ljava/lang/CharSequence;)V

    sget-object v3, Lhk3;->o:Landroid/graphics/Rect;

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInParent(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInScreen(Landroid/graphics/Rect;)V

    iget-object v4, p0, Lhk3;->i:Lik3;

    invoke-virtual {v0, v4}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    iget-object v5, v1, Lb5;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    const-string v6, ""

    if-ne p1, v2, :cond_2

    iget-object v7, p0, Lhk3;->n:Lik3;

    invoke-virtual {v7}, Lik3;->getCloseIconContentDescription()Ljava/lang/CharSequence;
    ...
    sget-object v6, Lik3;->x:Landroid/graphics/Rect;

    invoke-virtual {v5, v6}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInParent(Landroid/graphics/Rect;)V

    :goto_1
    invoke-virtual {v1}, Lb5;->g()Ljava/lang/CharSequence;
    ...
    :cond_4
    :goto_2
    iget-object v5, p0, Lhk3;->e:Landroid/graphics/Rect;

    invoke-virtual {v1, v5}, Lb5;->f(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, v7}, Lb5;->a(I)V
    ...
    invoke-virtual {v1, v5}, Lb5;->a(I)V
    ...
    invoke-virtual {v1, v2}, Lb5;->a(I)V

    :cond_8
    :goto_5
    invoke-virtual {v0, p1}, Landroid/view/accessibility/AccessibilityNodeInfo;->setFocused(Z)V

    iget-object p1, p0, Lhk3;->g:[I

    invoke-virtual {v4, p1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v5, p0, Lhk3;->d:Landroid/graphics/Rect;
    ...
    :cond_9
    iget-object p0, p0, Lhk3;->f:Landroid/graphics/Rect;
...
.method public final l(Ljava/util/ArrayList;)V
    ...
    iget-object p0, p0, Lik3;->h:Landroid/view/View$OnClickListener;
...
.method public final m(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v3}, Lhk3;->l(Ljava/util/ArrayList;)V

    new-instance v4, Lnuf;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Lnuf;-><init>(I)V
    ...
    invoke-virtual {v0, v7}, Lhk3;->k(I)Lb5;
    ...
    invoke-virtual {v4, v8, v7}, Lnuf;->b(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v4, v3}, Lnuf;->a(I)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v8, Lhk3;->p:Laol;

    sget-object v9, Lhk3;->q:Lo7e;

    iget-object v10, v0, Lhk3;->i:Lik3;
    ...
    invoke-virtual {v0, v5}, Lhk3;->n(I)Lb5;

    move-result-object v2

    invoke-virtual {v2, v13}, Lb5;->f(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v4, v10}, Lnuf;->c(I)Ljava/lang/Object;
    ...
    invoke-virtual {v9, v6}, Lb5;->f(Landroid/graphics/Rect;)V

    invoke-static {v1, v13, v6}, Lbgl;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v13, v2}, Lbgl;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v13, v6, v2}, Lbgl;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v13, v2, v6}, Lbgl;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v13, v6}, Lbgl;->d(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v11

    invoke-static {v1, v13, v6}, Lbgl;->e(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v13, v2}, Lbgl;->d(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v11

    invoke-static {v1, v13, v2}, Lbgl;->e(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-direct {v5, v2, v8}, Lcs6;-><init>(ZLaol;)V
    ...
    iget-object v3, v4, Lnuf;->b:[Ljava/lang/Object;
    ...
    :cond_20
    :goto_12
    iget-object v1, v4, Lnuf;->a:[I

    aget v7, v1, v12

    :goto_13
    invoke-virtual {v0, v7}, Lhk3;->o(I)Z
...
.method public final n(I)Lb5;
    ...
    invoke-virtual {p1, v0}, Lik3;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {p0, v2}, Lhk3;->l(Ljava/util/ArrayList;)V
    ...
    iget-object v4, v1, Lb5;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lhk3;->k(I)Lb5;
...
.method public final o(I)Z
    ...
    iget-object v1, p0, Lhk3;->n:Lik3;

    iput-boolean v0, v1, Lik3;->n:Z
...
.method public final p(II)V
    ...
    iget-object v0, p0, Lhk3;->h:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {p0, p1}, Lhk3;->n(I)Lb5;
    ...
    invoke-virtual {p0}, Lb5;->g()Ljava/lang/CharSequence;
