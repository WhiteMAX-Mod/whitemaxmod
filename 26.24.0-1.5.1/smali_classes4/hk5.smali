...
.method public constructor <init>(Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;)V
    ...
    iput-object p1, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;
...
.method public final a(Lok4;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;
    ...
    invoke-virtual {p1}, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->o()Ltxg;
    ...
    iget-object v0, p1, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->m:Ldl5;

    iget-object v2, p1, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->z:Ljava/lang/String;

    sget-object v1, Lal5;->f:Lal5;
    ...
    iget-object v0, p1, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->n:Ly21;
    ...
    iget-object p1, p1, Ltxg;->c:Ljava/lang/String;

    invoke-direct {v1, v2, v3}, Lth6;-><init>(J)V

    invoke-virtual {v0, v1}, Ly21;->c(Ljava/lang/Object;)V

    iget-object p0, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;
...
.method public final b(Lok4;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v2, v3}, Lvh6;-><init>(J)V

    invoke-virtual {v0, v1}, Ly21;->c(Ljava/lang/Object;)V

    iget-object p0, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;

    sget-object p1, Lck5;->a:Lck5;
...
.method public final c(Lok4;Ljava/lang/String;ZZ)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;
    ...
    invoke-direct {p1, p2}, Ldk5;-><init>(Z)V

    goto :goto_3

    :cond_3
    iget-object v0, p0, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->m:Ldl5;

    if-eqz p4, :cond_4

    sget-object v1, Lal5;->h:Lal5;
    ...
    invoke-direct {p2, p1}, Ldk5;-><init>(Z)V
...
.method public final d(Lok4;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Ltxg;->c:Ljava/lang/String;
...
.method public final e(FJJLok4;)Ljava/lang/Object;
    ...
    iget-wide v6, p1, Ltxg;->b:J

    invoke-direct/range {v2 .. v7}, Lek5;-><init>(IJJ)V

    iput-object v2, v0, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->A:Lfk5;

    iget-object p1, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;

    iget-object p1, p1, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->A:Lfk5;

    instance-of p4, p1, Lek5;
    ...
    invoke-static {p4, p0}, Lg9e;->B0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Llgl;->h(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, p4, v2, p5}, Lyob;->c(Lb19;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_9
    invoke-virtual {p0, p6}, Lru/ok/tamtam/upload/workers/ForegroundWorker;->n(Lmk4;)Ljava/lang/Object;
...
.method public final f()Ljava/lang/String;
    ...
    iget-wide v0, v0, Ltxg;->b:J

    invoke-virtual {p0}, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->o()Ltxg;

    move-result-object p0

    iget-wide v2, p0, Ltxg;->e:J
...
.method public final g(Ljava/io/File;Lok4;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;

    invoke-virtual {p2}, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->o()Ltxg;
    ...
    invoke-static {v0, v1, p2}, Lg9e;->C(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    if-eqz p1, :cond_0

    iget-object p2, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;

    iget-object v0, p2, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->n:Ly21;
    ...
    iget-object p2, p2, Ltxg;->c:Ljava/lang/String;

    invoke-direct {v1, p1, v2, v3}, Lwh6;-><init>(Ljava/io/File;J)V

    invoke-virtual {v0, v1}, Ly21;->c(Ljava/lang/Object;)V

    iget-object p2, p0, Lhk5;->a:Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;

    iget-object p2, p2, Lru/ok/tamtam/upload/workers/DownloadFileFromWebAppWorker;->o:Lfi6;

    invoke-virtual {p2, p1}, Lfi6;->b(Ljava/io/File;)V
