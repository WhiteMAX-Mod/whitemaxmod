...
# static fields
.field public static final t:Lon8;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ltdh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    iput-object v1, p0, Ltdh;->b:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Ltdh;->c:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, Ltdh;->d:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Ltdh;->e:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Ltdh;->f:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Ltdh;->g:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Ltdh;->h:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/PathMeasure;

    invoke-direct {p1}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object p1, p0, Ltdh;->i:Landroid/graphics/PathMeasure;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Ltdh;->j:Landroid/graphics/RectF;

    new-instance p1, Lndh;

    invoke-direct {p1, p0, v2}, Lndh;-><init>(Ltdh;I)V
    ...
    iput-object p1, p0, Ltdh;->k:Lon8;

    new-instance p1, Lndh;

    invoke-direct {p1, p0, v4}, Lndh;-><init>(Ltdh;I)V

    invoke-static {v3, p1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object p1

    iput-object p1, p0, Ltdh;->l:Lon8;
    ...
    iput-object p1, p0, Ltdh;->m:Lon8;

    new-instance p1, Lndh;

    invoke-direct {p1, p0, v3}, Lndh;-><init>(Ltdh;I)V

    invoke-static {v3, p1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object p1

    iput-object p1, p0, Ltdh;->n:Lon8;
...
.method public static a(Ltdh;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-direct {p0, p1}, Ltdh;->setDrawableColor(I)V
...
.method private final setDrawableColor(I)V
    ...
    iget-object p0, p0, Ltdh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;

    invoke-static {p0, v0, p1}, Lqj4;->Z(Lj4i;Ljava/lang/String;I)V
...
.method public final b(IZ)V
    ...
    invoke-virtual {p0, v2}, Ltdh;->onThemeChanged(Ljvb;)V
    ...
    invoke-direct {p2, p1, p0, v2}, Lox9;-><init>(ILandroid/view/ViewGroup;I)V

    invoke-static {p0, p2}, Lxji;->e(Landroid/view/View;Lv57;)V
    ...
    :cond_2
    iget-object p2, p0, Ltdh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    invoke-direct {p0}, Ltdh;->getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Ltdh;->getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-boolean v0, p0, Ltdh;->r:Z

    invoke-static {p2, v0}, Lg9e;->n(Lhv5;Z)Lyub;

    move-result-object p2

    iget-object p2, p2, Lyub;->c:Lwub;

    iget p2, p2, Lwub;->a:I

    invoke-direct {p0, p2}, Ltdh;->setDrawableColor(I)V
    ...
    iget-boolean p2, p0, Ltdh;->s:Z

    if-nez p2, :cond_8

    invoke-direct {p0}, Ltdh;->getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Ltdh;->getLoadingAnimator()Landroid/animation/ValueAnimator;
...
.method public final onAttachedToWindow()V
    ...
    invoke-direct {v1, v0, p0, v2}, Lox9;-><init>(ILandroid/view/ViewGroup;I)V

    invoke-static {p0, v1}, Lxji;->e(Landroid/view/View;Lv57;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Ltdh;->d:Landroid/graphics/Paint;

    iget-object v3, p0, Ltdh;->j:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-object v0, p0, Ltdh;->i:Landroid/graphics/PathMeasure;
    ...
    invoke-static {v5, v4, v2, v4}, Lqm9;->c(FFFF)F
    ...
    iget-object v4, p0, Ltdh;->h:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    cmpl-float v5, v2, v8

    iget-object p0, p0, Ltdh;->f:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Ltdh;->b:Landroid/widget/ImageView;
    ...
    invoke-static {p2, p1, p3, p4, p5}, Lbb3;->s(Landroid/view/View;IIII)V
    ...
    iget-object p0, p0, Ltdh;->c:Landroid/widget/ImageView;

    invoke-static {p0, p1, p3, p4, p5}, Lbb3;->s(Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    iget-object v4, p0, Ltdh;->b:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Ltdh;->c:Landroid/widget/ImageView;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Ltdh;->j:Landroid/graphics/RectF;

    const/4 p4, 0x0

    invoke-virtual {p3, p4, p4, p1, p2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Ltdh;->g:Landroid/graphics/Path;
    ...
    iget-object p4, p0, Ltdh;->e:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Ltdh;->i:Landroid/graphics/PathMeasure;
...
.method public final onThemeChanged(Ljvb;)V
    ...
    iget-boolean v1, p0, Ltdh;->r:Z

    invoke-static {v0, v1}, Lg9e;->n(Lhv5;Z)Lyub;

    move-result-object v0

    iget-object v1, v0, Lyub;->d:Luub;

    iget-object v2, v0, Lyub;->c:Lwub;
    ...
    iget-object v5, p0, Ltdh;->e:Landroid/graphics/Paint;

    invoke-virtual {v5, v4}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v4, p0, Ltdh;->s:Z
    ...
    :goto_0
    iget-object v4, p0, Ltdh;->f:Landroid/graphics/Paint;

    invoke-virtual {v4, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v1, p0, Ltdh;->s:Z
    ...
    iget-object v4, p0, Ltdh;->c:Landroid/widget/ImageView;
    ...
    :goto_3
    invoke-direct {p0, v2}, Ltdh;->setDrawableColor(I)V
