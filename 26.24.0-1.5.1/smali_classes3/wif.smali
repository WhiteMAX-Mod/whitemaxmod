...
.method public synthetic constructor <init>(Lone/me/location/map/show/ShowLocationScreen;I)V
    ...
    iput-object p1, p0, Lwif;->b:Lone/me/location/map/show/ShowLocationScreen;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p0, p0, Lwif;->b:Lone/me/location/map/show/ShowLocationScreen;
    ...
    iget-wide v1, v0, Lcom/huawei/hms/maps/model/LatLng;->latitude:D

    iget-wide v3, v0, Lcom/huawei/hms/maps/model/LatLng;->longitude:D

    new-instance v0, Lze5;

    sget-object v5, Lp88;->a:Ljava/lang/String;
    ...
    invoke-static {p1, v5}, Lp88;->l(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-direct {v0, v5, v7, v8, v9}, Lze5;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {p1, v7}, Lp88;->l(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-direct {v5, v7, v8, v10, v9}, Lze5;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct {v7, v8, v9, v10, v11}, Lze5;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct {v8, v9, v12, v10, v11}, Lze5;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V

    new-instance v9, Lze5;
    ...
    invoke-direct {v9, v1, v2, v10, v11}, Lze5;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V

    filled-new-array {v0, v5, v7, v8, v9}, [Lze5;
    ...
    iget-object v5, v2, Lze5;->a:Landroid/net/Uri;

    invoke-direct {v3, v4, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    iget-object v4, v2, Lze5;->c:Ljava/lang/String;
    ...
    iget-object v2, v2, Lze5;->b:Ljava/lang/String;

    invoke-direct {v4, v3, v2}, Lye5;-><init>(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v1}, Lsif;-><init>(Ljava/util/ArrayList;)V
    ...
    iget-object p1, p0, Lbjf;->q:Lm36;

    new-instance v0, Lpif;

    iget-object v1, p0, Lbjf;->b:Lcom/huawei/hms/maps/model/LatLng;

    move-object v3, v1

    iget-wide v1, v3, Lcom/huawei/hms/maps/model/LatLng;->latitude:D
    ...
    invoke-direct/range {v0 .. v5}, Lpif;-><init>(DDLjava/lang/Float;)V
