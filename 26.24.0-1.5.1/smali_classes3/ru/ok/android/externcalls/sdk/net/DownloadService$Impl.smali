...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ldof;",
        "Ljld;",
        "Companion",
        "calls-sdk_release"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Ljld;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ljld;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljof;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$0(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lnof;)V

    return-void
.end method

.method private static final download$lambda$0(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lnof;)V
    .locals 8
    ...
    invoke-virtual {p2, v0}, Ljof;->a(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Ldj7;

    move-result-object p0

    iget-object p0, p0, Ldj7;->a:Ljava/lang/String;
    ...
    invoke-virtual {p2, p3}, Ljof;->onSuccess(Ljava/lang/Object;)V
    ...
    :goto_6
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ljld;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lis1;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :try_start_d
    invoke-static {v4}, Ljl6;->b(Ljava/io/File;)V
    :try_end_d
    ...
    invoke-static {v2, p0}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$0$3(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljava/lang/String;)Lroh;

    :goto_7
    check-cast p4, Ljof;

    invoke-virtual {p4}, Ljof;->j()Z

    move-result p0

    if-nez p0, :cond_7

    invoke-virtual {p4, p2}, Ljof;->a(Ljava/lang/Throwable;)Z
...
.method private static final download$lambda$0$3(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljava/lang/String;)Lroh;
    .locals 1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ljld;
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v1, p3, p0}, Luxh;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v4, p2}, Ljl6;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ldof;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p0}, Lmo;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
