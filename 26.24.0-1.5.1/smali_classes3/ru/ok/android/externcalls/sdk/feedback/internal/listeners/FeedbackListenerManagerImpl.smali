...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lmq1;
    ...
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lmq1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILf25;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lwa0;-><init>(Ljava/lang/Object;JI)V
...
.method private final unrollReceivedFeedback(Lpf1;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p1, Lpf1;->b:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lof1;->b:Ljava/util/List;
    ...
    iget-object v4, v0, Lof1;->a:Ljava/lang/String;
    ...
    invoke-direct {v5, v3, v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Lmq1;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {v2, p1}, Lir3;->g0(Ljava/lang/Iterable;Ljava/util/Collection;)V
...
.method public onFeedback(Lpf1;)V
    .locals 5

    iget-object v0, p1, Lpf1;->a:Ln3f;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Ln3f;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lpf1;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lmq1;
    ...
    invoke-direct {v2, v4, p0, p1, v0}, Lhz5;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance p1, Lx65;

    const/16 v4, 0x1a

    invoke-direct {p1, v4, p0, v0}, Lx65;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
