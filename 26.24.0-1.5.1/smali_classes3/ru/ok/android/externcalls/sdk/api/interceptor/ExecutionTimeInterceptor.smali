...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ll5h;)V",
        "Lmdb;",
        "okApiChain",
        "Lqdb;",
        "intercept",
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v0, v1, v0}, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;-><init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ll5h;ILf25;)V

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ll5h;)V
    .locals 0
    ...
    .line 21
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;->timeProvider:Ll5h;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ll5h;ILf25;)V
    .locals 0
    ...
    new-instance p2, Ln5h;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    :cond_1
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;-><init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ll5h;)V
...
.method public intercept(Lmdb;)Lqdb;
    .locals 6
    ...
    iget-object v1, v0, Lpdb;->a:Lwo;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/api/interceptor/InterceptorUtilsKt;->getMethod(Llp;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;->timeProvider:Ll5h;
    ...
    invoke-virtual {p1, v0}, Lgw;->h(Lpdb;)Lqdb;
