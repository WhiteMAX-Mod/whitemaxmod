...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector$LegacyStorage;
    }
.end annotation
...
.method private getUploader()Lru/ok/android/externcalls/analytics/internal/upload/Uploader;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector;->dbHelper:Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;

    if-eqz v0, :cond_1

    new-instance v0, Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector$LegacyStorage;

    const/4 v2, 0x0

    invoke-direct {v0, p0, v2}, Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector$LegacyStorage;-><init>(Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector;I)V
    ...
    :cond_1
    new-instance v0, Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector$OneLogFile;

    const-string v2, "upload"

    invoke-direct {v0, p0, v2}, Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector$OneLogFile;-><init>(Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector;Ljava/lang/String;)V
...
.method private isDbCacheEnabled()Z
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/analytics/internal/event/EventQueueCollector;->dbCacheEnabled:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public addEvent(Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    ...
    invoke-static {v1, p0, v0, p1}, Lf;->k(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public grabAndUpload()V
    ...
    invoke-direct {v2, v1, v3}, Lr33;-><init>(Ljava/lang/Object;I)V
