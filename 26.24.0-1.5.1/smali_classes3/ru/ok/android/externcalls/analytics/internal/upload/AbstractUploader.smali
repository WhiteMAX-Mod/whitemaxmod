...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lko;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;",
        "Lroh;",
        "drop",
        "()V",
...
.method private final uploadFileWithContent(Lko;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    .locals 9
    ...
    invoke-static {p2}, Ljl6;->d(Ljava/io/File;)Z
    ...
    invoke-virtual {v5, p1, v6, v7}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Lko;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lzz0;)V
...
.method public final ensureStorageIsOfCorrectType(Z)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v0}, Ljl6;->b(Ljava/io/File;)V
    :try_end_0
...
.method public final uploadFile(Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    invoke-static {p1}, Ljl6;->e(Ljava/io/File;)J
    ...
    :cond_1
    invoke-virtual {v2}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Lkdb;

    move-result-object v0

    invoke-virtual {v0}, Lkdb;->b()Lko;

    move-result-object v0

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->uploadFileWithContent(Lko;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
