...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    ...
    iput-object p1, p0, Lep1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iput-object p2, p0, Lep1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lis1;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lep1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lap1;-><init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Landroid/opengl/EGLContext;[ILtgj;Ljava/lang/String;)V

    iput-object v1, p0, Lep1;->e:Lap1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lep1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Lep1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Lep1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lep1;->i:Ljava/util/ArrayList;

    new-instance v2, Ltb;

    const/16 v0, 0x8

    invoke-direct {v2, p0, v0}, Ltb;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v3, v1, Lap1;->j:Ljava/lang/String;

    const-string v4, "OpenGL tread died, is it fine?"

    iget-object v1, v1, Lap1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    invoke-interface {v1, v3, v4, v0}, Ljld;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Lep1;->c:Ltb;
...
.method public final a()V
    ...
    iget-object v1, p0, Lap1;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lap1;->i:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lap1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iget-object p0, p0, Lap1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Ljld;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean v2, p0, Lap1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v1

    iget-object v1, p0, Lap1;->k:Lqfj;
    ...
    iget-object v1, p0, Lap1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iget-object p0, p0, Lap1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Ljld;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lap1;La22;Lorg/webrtc/VideoFrame;Lft1;)V
    .locals 16
    ...
    iget-object v4, v2, Lbp1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lap1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lap1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lep1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, La22;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Lep1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lap1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Lep1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v0}, Lap1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v0, v1, Lap1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v2, La22;->l:Lb22;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v1, Lb22;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Lb22;->h:J

    iget-wide v5, v1, Lb22;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Lb22;->i:J
