...
.field public final synthetic g:Lujd;


# direct methods
.method public synthetic constructor <init>(Lmk4;Lujd;I)V
    .locals 0

    iput p3, p0, Ltjd;->e:I

    iput-object p2, p0, Ltjd;->g:Lujd;
...
.method public final create(Ljava/lang/Object;Lmk4;)Lmk4;
    ...
    invoke-direct {v0, p2, p0, v1}, Ltjd;-><init>(Lmk4;Lujd;I)V

    iput-object p1, v0, Ltjd;->f:Ljava/lang/Object;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Ltjd;->create(Ljava/lang/Object;Lmk4;)Lmk4;

    move-result-object p0

    check-cast p0, Ltjd;

    invoke-virtual {p0, v1}, Ltjd;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v6, v0, Ltjd;->g:Lujd;

    iget-object v0, v0, Ltjd;->f:Ljava/lang/Object;
    ...
    iget-object v1, v6, Lujd;->j:Landroid/widget/Chronometer;

    sget v7, Lujd;->t:F

    iget-object v8, v6, Lujd;->m:Lg92;

    iget-object v9, v6, Lujd;->k:Landroid/widget/LinearLayout;

    iget-object v10, v6, Lujd;->l:Lkqb;

    iget-object v11, v6, Lujd;->i:Lkqb;

    iget-object v12, v6, Lujd;->n:Lkqb;

    iget-object v13, v6, Lujd;->o:Lkqb;
    ...
    sget-object v0, Lf92;->a:Lf92;

    invoke-virtual {v8, v0}, Lg92;->setType(Lf92;)V

    invoke-virtual {v13, v7, v4, v15}, Lkqb;->a(FILjava/lang/String;)V

    invoke-virtual {v6}, Lujd;->getCameraApi()Lh82;
    ...
    invoke-virtual {v13, v7, v0, v1}, Lkqb;->a(FILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, v1, Lbf2;->c:Llp8;

    const/4 v2, 0x4

    invoke-virtual {v0, v2}, Laa2;->o(I)V
    :try_end_0
    ...
    invoke-direct {v2, v0}, Lye2;-><init>(Ljava/lang/Throwable;)V

    invoke-virtual {v1, v2}, Lbf2;->b(Lru/ok/tamtam/exception/IssueKeyException;)V

    goto :goto_0

    :cond_2
    instance-of v4, v0, Ljjd;
    ...
    sget-object v2, Lf92;->d:Lf92;

    invoke-virtual {v8, v2}, Lg92;->setType(Lf92;)V

    invoke-virtual {v9, v3}, Landroid/view/View;->setVisibility(I)V

    check-cast v0, Ljjd;

    iget-wide v2, v0, Ljjd;->a:J
    ...
    invoke-static {v6, v0}, Lujd;->b(Lujd;Lvjd;)V
    ...
    invoke-direct {v0, v2, v3}, Lio5;-><init>(J)V

    check-cast v1, Lbf2;

    invoke-virtual {v1, v4, v0}, Lbf2;->f(Ltec;Lio5;)V

    goto/16 :goto_5

    :cond_5
    instance-of v1, v0, Lcjd;
    ...
    iget-object v0, v0, Lcjd;->a:Ljava/io/File;
    ...
    invoke-static {v4, v6}, Lqj4;->i(Landroid/content/Context;Ljava/lang/String;)I
    ...
    :cond_6
    iget-object v2, v1, Lbf2;->c:Llp8;

    new-instance v4, Lcia;

    invoke-direct {v4, v0}, Lcia;-><init>(Ljava/io/File;)V

    invoke-virtual {v4}, Lcia;->r()Laj6;

    move-result-object v0

    iget-object v4, v1, Lbf2;->a:Ljava/util/concurrent/Executor;

    new-instance v7, Lbu1;

    const/4 v8, 0x1

    invoke-direct {v7, v1, v8}, Lbu1;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {}, Loel;->a()V

    iget-object v9, v2, Laa2;->q:Lp0d;
    ...
    invoke-static {v10, v9}, Lqhf;->p(Ljava/lang/String;Z)V
    ...
    iget-object v9, v2, Laa2;->j:Lrvd;

    if-eqz v9, :cond_9

    iget-object v9, v9, Lrvd;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v8, v3}, Lqhf;->p(Ljava/lang/String;Z)V

    iget-object v3, v2, Laa2;->G:Landroid/content/Context;

    invoke-static {v3}, Lqj4;->B(Landroid/content/Context;)Ljava/util/concurrent/Executor;

    move-result-object v8

    new-instance v9, Ly92;

    invoke-direct {v9, v2, v8, v7}, Ly92;-><init>(Llp8;Ljava/util/concurrent/Executor;Lbu1;)V

    iget-object v7, v2, Laa2;->i:Lf6i;

    invoke-virtual {v7}, Lf6i;->Q()Lefi;
    ...
    invoke-direct {v8, v3, v7, v0}, Lbx1;-><init>(Landroid/content/Context;Lpvd;Laj6;)V

    invoke-static {v3, v6}, Lyj0;->q(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v8}, Lbx1;->l(Lbx1;)V

    invoke-virtual {v8, v4, v9}, Lbx1;->h(Ljava/util/concurrent/Executor;Lwa4;)Lrvd;

    move-result-object v0

    iget-object v3, v2, Laa2;->k:Ljava/util/HashMap;

    invoke-virtual {v3, v9, v0}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iput-object v0, v2, Laa2;->j:Lrvd;

    iput-object v0, v1, Lbf2;->g:Lrvd;
