...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lvk;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Lq47;->j(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {v7}, Lhkg;->O(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lvk;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lvk;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Ll51;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Lvk;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Llk;->e:Llk;

    iget-object v12, v0, Lvk;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v13, Lnk;->d:Lnk;

    invoke-virtual {v13, v12, v3}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Lnk;->e:Lnk;

    invoke-virtual {v14, v12, v3}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Llk;->j:Llk;

    invoke-virtual {v15, v12, v3}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lbl;

    instance-of v12, v3, Lzk;

    if-nez v12, :cond_6

    instance-of v3, v3, Lal;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lg9e;->w(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-virtual {v0, v12, v3}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    iget-object p0, p0, Lvk;->a:Landroid/content/Context;

    invoke-virtual {v0, p0, p2}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p0, p2}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p0, p2}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lbl;

    sget-object v3, Llk;->j:Llk;

    invoke-virtual {v3, p0, p2}, Lk2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lbl;

    instance-of p2, v1, Lwk;
    ...
    :cond_0
    instance-of p2, p0, Lal;

    if-eqz p2, :cond_2

    new-instance p0, Lxk;

    invoke-direct {p0, v4}, Lxk;-><init>(F)V
    ...
    invoke-direct {p0, v3}, Lwk;-><init>(I)V

    :cond_2
    :goto_1
    instance-of p2, p0, Lxk;

    instance-of v5, p0, Lzk;

    const/4 v6, 0x0

    if-eqz v5, :cond_f

    instance-of p0, v1, Lzk;
    ...
    iget-object p2, p2, Lzk;->a:Ljava/lang/String;

    invoke-static {p2}, Lg9e;->v(Ljava/lang/String;)[Ly7c;
    ...
    iget-object v4, v4, Lzk;->a:Ljava/lang/String;

    invoke-static {v4}, Lg9e;->v(Ljava/lang/String;)[Ly7c;
    ...
    invoke-direct {v5}, Lied;-><init>()V

    if-eqz v4, :cond_d

    invoke-static {p2, v4}, Lg9e;->l([Ly7c;[Ly7c;)Z
    ...
    iget-object p0, v1, Lzk;->a:Ljava/lang/String;
    ...
    iget-object v6, v2, Lzk;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p0, v0, v6}, Lis1;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
