...
.method public static parseFrom(Lqo3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->mergeFrom(Lqo3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;
...
.method public clear()Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;
    ...
    iput-wide v2, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->photoId:J
    ...
    iput-object v1, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->thumbhashData:[B
...
.method public computeSerializedSize()I
    ...
    invoke-static {v0, v2}, Lso3;->l(ILjava/lang/String;)I
    ...
    invoke-static {v3, v2}, Lso3;->f(II)I
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->previewData:[B

    invoke-static {v2, v4}, Lso3;->b(I[B)I
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->photoToken:Ljava/lang/String;

    invoke-static {v2, v4}, Lso3;->l(ILjava/lang/String;)I
    ...
    :cond_5
    iget-wide v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->photoId:J
    ...
    invoke-static {v2, v4, v5}, Lso3;->h(IJ)I
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->mp4Url:Ljava/lang/String;
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->baseUrl:Ljava/lang/String;
    ...
    iget-object p0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->thumbhashData:[B
...
.method public bridge synthetic mergeFrom(Lqo3;)Le5a;
    ...
    .line 92
    invoke-virtual {p0, p1}, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->mergeFrom(Lqo3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;
...
.method public mergeFrom(Lqo3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iput-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->thumbhashData:[B
...
.method public writeTo(Lso3;)V
    ...
    invoke-virtual {p1, v0, v3}, Lso3;->s(I[B)V
    ...
    invoke-virtual {p1, v0, v3}, Lso3;->E(ILjava/lang/String;)V
    ...
    invoke-virtual {p1, v0, v3, v4}, Lso3;->x(IJ)V
    ...
    :cond_9
    iget-object v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Photo;->thumbhashData:[B
