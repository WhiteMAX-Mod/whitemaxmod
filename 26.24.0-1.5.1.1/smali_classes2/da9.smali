...
# direct methods
.method public constructor <init>(Lea9;Landroid/content/Context;I[Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, Lda9;->c:Lea9;
...
.method public final a()V
    ...
    iget-object v0, p0, Lda9;->c:Lea9;

    iget-object v1, v0, Lea9;->k:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v5, p0, Lda9;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v0, Lea9;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v2, v3}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v4

    iget-object v5, v0, Lea9;->k:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v4, v6}, Lwr3;->c(II)I

    move-result v4

    iget v6, v0, Lea9;->j:I

    invoke-static {v5, v6}, Lwr3;->c(II)I
    ...
    :cond_1
    iput-object v2, p0, Lda9;->a:Landroid/content/res/ColorStateList;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, Lda9;->b:Landroid/content/res/ColorStateList;

    if-eqz p3, :cond_0

    iget-object p3, p0, Lda9;->a:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, p3}, Landroid/graphics/drawable/Drawable;->setTintList(Landroid/content/res/ColorStateList;)V

    new-instance p3, Landroid/graphics/drawable/RippleDrawable;

    iget-object p0, p0, Lda9;->b:Landroid/content/res/ColorStateList;
