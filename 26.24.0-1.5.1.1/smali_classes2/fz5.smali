...
# direct methods
.method public synthetic constructor <init>(Lqz5;JI)V
    .locals 0

    iput p4, p0, Lfz5;->a:I

    iput-object p1, p0, Lfz5;->b:Lqz5;

    iput-wide p2, p0, Lfz5;->c:J
...
.method public final run()V
    ...
    iget-object v0, p0, Lfz5;->b:Lqz5;

    iget-wide v5, p0, Lfz5;->c:J
    ...
    invoke-virtual {v0, p0}, Lqz5;->j(I)V

    goto/16 :goto_4

    :pswitch_2
    iput-object v8, v0, Lqz5;->y:Ljava/lang/Long;

    iget-object p0, v0, Lqz5;->o:Ljava/util/ArrayDeque;
    ...
    iget-object v4, v0, Lqz5;->o:Ljava/util/ArrayDeque;
    ...
    iget-object p0, v0, Lqz5;->a:Ljava/lang/String;
    ...
    invoke-static {p0, v2}, Lk7i;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean p0, v0, Lqz5;->c:Z
    ...
    invoke-virtual {v2, p0}, Lckd;->b(Ljava/lang/Class;)Lyjd;
    ...
    :cond_2
    invoke-virtual {v0, v1}, Lqz5;->i(Z)V

    iget-object p0, v0, Lqz5;->f:Lxy5;

    instance-of v1, p0, Lmz5;

    if-eqz v1, :cond_3

    check-cast p0, Lmz5;

    invoke-virtual {p0, v9}, Lmz5;->a(Z)V
    ...
    :cond_4
    invoke-virtual {v0, v7}, Lqz5;->j(I)V
    ...
    :try_start_0
    iget-boolean p0, v0, Lqz5;->B:Z

    if-eqz p0, :cond_5

    invoke-virtual {v0}, Lqz5;->h()V
    ...
    iput-object p0, v0, Lqz5;->v:Landroid/util/Range;
    ...
    iget-object p0, v0, Lqz5;->e:Landroid/media/MediaCodec;
    ...
    invoke-virtual {v0, v9, v1, p0}, Lqz5;->b(ILjava/lang/String;Ljava/lang/Throwable;)V
