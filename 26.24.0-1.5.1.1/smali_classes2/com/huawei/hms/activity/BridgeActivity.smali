...
.method private a()V
    ...
    const-string v1, "finishBridgeActivity has an exception"
...
.method private b()V
    ...
    invoke-static {v2, v3, v1}, Ldac;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_2
    const-string p0, "rootView is null or not ViewGroup"
...
.method private c()Z
    ...
    const-string p0, "In initialize, Must not pass in a null intent."
    ...
    const-string v3, "onBridgeActivityCreate Exception."
    ...
    :cond_2
    :try_start_2
    const-string p0, "In initialize, Must not pass in a null or non class object."
    ...
    :catchall_1
    const-string p0, "In initialize, Failed to create \'IUpdateWizard\' instance, throwable occur."
...
.method private d()V
    ...
    invoke-static {p0, v0}, Lcom/huawei/hms/activity/BridgeActivity;->a(Landroid/view/Window;Z)V
...
.method public getIntent()Landroid/content/Intent;
    ...
    invoke-static {p0}, Lcom/huawei/hms/utils/UIUtil;->modifyIntentBehaviorsSafe(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p0}, Lcom/huawei/hms/ui/SafeIntent;-><init>(Landroid/content/Intent;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p0, p0, Lcom/huawei/hms/activity/BridgeActivity;->a:Lcom/huawei/hms/activity/IBridgeActivityDelegate;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lcom/huawei/hms/activity/IBridgeActivityDelegate;->onBridgeConfigurationChanged()V
...
.method public onDestroy()V
    ...
    :cond_0
    const-string p0, "BridgeActivity onDestroy"
