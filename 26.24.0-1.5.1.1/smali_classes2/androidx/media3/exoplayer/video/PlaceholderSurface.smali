...
# direct methods
.method public constructor <init>(Lelc;Landroid/graphics/SurfaceTexture;Z)V
    .locals 0

    invoke-direct {p0, p2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object p1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->b:Lelc;
...
.method public static declared-synchronized a()Z
    ...
    invoke-static {v1}, Lu5c;->v(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v1}, Lg9e;->G(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Z)Landroidx/media3/exoplayer/video/PlaceholderSurface;
    ...
    iput-object v3, v2, Lelc;->b:Landroid/os/Handler;

    new-instance v4, Lwp5;

    invoke-direct {v4, v3}, Lwp5;-><init>(Landroid/os/Handler;)V

    iput-object v4, v2, Lelc;->a:Lwp5;

    monitor-enter v2

    :try_start_0
    iget-object v3, v2, Lelc;->b:Landroid/os/Handler;
    ...
    :goto_3
    iget-object p0, v2, Lelc;->e:Landroidx/media3/exoplayer/video/PlaceholderSurface;

    if-nez p0, :cond_3

    iget-object p0, v2, Lelc;->d:Ljava/lang/RuntimeException;

    if-nez p0, :cond_3

    iget-object p0, v2, Lelc;->c:Ljava/lang/Error;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final release()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->b:Lelc;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->b:Lelc;

    iget-object v2, v1, Lelc;->b:Landroid/os/Handler;
