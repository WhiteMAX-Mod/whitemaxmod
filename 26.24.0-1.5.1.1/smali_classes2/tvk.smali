...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltvk;->a:[Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;)Landroid/content/res/AssetFileDescriptor;
    ...
    invoke-static {p0, p1, v0}, Ltvk;->e(Landroid/content/Context;Landroid/net/Uri;Lork;)Z
    ...
    invoke-static {p0, v2, p1, v0}, Ltvk;->d(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;Lork;)V
    :try_end_0
...
.method public static b(Landroid/content/Context;Landroid/net/Uri;Lork;)Ljava/io/InputStream;
    .locals 3
    ...
    invoke-static {p0, p1, p2}, Ltvk;->e(Landroid/content/Context;Landroid/net/Uri;Lork;)Z
    ...
    :try_start_1
    invoke-static {p0, v0, p1, p2}, Ltvk;->d(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;Lork;)V
...
.method public static d(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/net/Uri;Lork;)V
    .locals 7
    ...
    invoke-static {p1}, Ltvk;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v5}, Ltvk;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v4}, Ltvk;->c(Ljava/io/File;)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;Lork;)Z
    .locals 11
    ...
    invoke-static {p0, v10}, Lyj0;->q(Landroid/content/Context;Ljava/lang/String;)I
    ...
    sget-object p1, Ltvk;->a:[Ljava/lang/String;
