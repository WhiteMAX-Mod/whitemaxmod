...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lbva;->t:J

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lxua;Ljfa;ILandroidx/media3/common/b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lbva;->a:Ljava/lang/String;

    iput-object p2, p0, Lbva;->b:Lxua;

    iput-object p3, p0, Lbva;->c:Ljfa;
    ...
    invoke-static {p1, p2}, Ljz8;->t(ZLjava/lang/Object;)V

    iput-object p5, p0, Lbva;->e:Landroidx/media3/common/b;
    ...
    iput-wide p1, p0, Lbva;->p:J

    const-wide p1, 0x7fffffffffffffffL

    iput-wide p1, p0, Lbva;->j:J

    return-void
.end method

.method public static c(Landroid/util/SparseArray;)Lava;
    .locals 7
    ...
    iget-wide v3, v2, Lava;->f:J

    iget-wide v5, v0, Lava;->f:J
...
.method public final a(Landroidx/media3/common/b;)V
    ...
    invoke-static {v6, v0, v5}, Ljz8;->r(Ljava/lang/String;Ljava/lang/Object;Z)V
    ...
    iget-object v0, p0, Lbva;->e:Landroidx/media3/common/b;
    ...
    iget-object v7, p1, Landroidx/media3/common/b;->q:Ljava/util/List;

    iget-object v8, v0, Landroidx/media3/common/b;->q:Ljava/util/List;
    ...
    iput-object v7, p1, Loy6;->p:Ljava/util/List;
    ...
    iget-object v0, p0, Lbva;->d:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Lu2i;->l(ILandroid/util/SparseArray;)Z
    ...
    iget-object v0, v0, Lava;->a:Landroidx/media3/common/b;
    ...
    iget v1, v0, Landroidx/media3/common/b;->z:I

    iget v2, p1, Landroidx/media3/common/b;->z:I

    if-ne v1, v2, :cond_13

    iget-object p0, p0, Lbva;->e:Landroidx/media3/common/b;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p1, p0}, Landroidx/media3/common/b;->c(Landroidx/media3/common/b;)Z
    ...
    iget v0, v0, Landroidx/media3/common/b;->v:I
    ...
    invoke-static {v4, v0}, Lu2i;->l(ILandroid/util/SparseArray;)Z

    move-result v0

    invoke-static {v0}, Ljz8;->C(Z)V

    iget-object p0, p0, Lbva;->d:Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lava;->a:Landroidx/media3/common/b;
    ...
    iget-object v3, p0, Lbva;->d:Landroid/util/SparseArray;
    ...
    invoke-static {v1, v5, v3}, Ljz8;->A(ILjava/lang/String;Z)V

    iget-object v3, p0, Lbva;->l:Lyua;

    if-nez v3, :cond_1f

    iget-object v3, p0, Lbva;->b:Lxua;

    iget-object v5, p0, Lbva;->a:Ljava/lang/String;

    invoke-interface {v3, v5}, Lxua;->g(Ljava/lang/String;)Lyua;

    move-result-object v3

    iput-object v3, p0, Lbva;->l:Lyua;

    :cond_1f
    new-instance v3, Lava;

    iget-object v5, p0, Lbva;->l:Lyua;

    invoke-interface {v5, p1}, Lyua;->H0(Landroidx/media3/common/b;)I

    move-result v5

    invoke-direct {v3, v5, p1}, Lava;-><init>(ILandroidx/media3/common/b;)V

    if-ne v1, v4, :cond_20

    iget v5, p1, Landroidx/media3/common/b;->I:I
    ...
    invoke-static/range {v6 .. v12}, Lu2i;->i0(JJJLjava/math/RoundingMode;)J

    move-result-wide v5

    iput-wide v5, p0, Lbva;->q:J

    :cond_20
    iget-object v5, p0, Lbva;->d:Landroid/util/SparseArray;

    invoke-virtual {v5, v1, v3}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-static {v1}, Lu2i;->K(I)Ljava/lang/String;
    ...
    iget-object v1, p1, Landroidx/media3/common/b;->l:Lkia;
    ...
    invoke-interface {v3, v1}, Lyua;->k(Liia;)V
...
.method public final b(I)V
    ...
    iput-boolean v1, p0, Lbva;->f:Z

    iget-object p0, p0, Lbva;->l:Lyua;
...
.method public final d(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lbva;->b:Lxua;

    invoke-interface {p0, v0}, Lxua;->c(I)Lny7;

    move-result-object p0

    invoke-virtual {p0, p1}, Lny7;->contains(Ljava/lang/Object;)Z
...
.method public final e(ILjava/nio/ByteBuffer;ZJ)Z
    ...
    iget-object v1, p0, Lbva;->d:Landroid/util/SparseArray;

    iget-boolean v2, p0, Lbva;->f:Z
    ...
    iget-wide v5, v2, Lava;->f:J

    sub-long v5, p4, v5

    sget-wide v7, Lbva;->t:J

    cmp-long v2, v5, v7

    if-lez v2, :cond_3

    invoke-static {v1}, Lbva;->c(Landroid/util/SparseArray;)Lava;

    move-result-object v2

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, v2, Lava;->a:Landroidx/media3/common/b;
    ...
    iget-wide v1, v1, Lava;->f:J

    iput-wide v1, p0, Lbva;->i:J

    :cond_4
    iget-wide v1, p0, Lbva;->i:J
    ...
    :goto_1
    invoke-static {p1}, Lu2i;->K(I)Ljava/lang/String;

    sget-object v2, Liy4;->a:Ljava/util/LinkedHashMap;
    ...
    iget-wide v7, p0, Lbva;->p:J

    cmp-long v7, v7, v5

    if-nez v7, :cond_6

    iput-wide p4, p0, Lbva;->p:J
    ...
    invoke-static {v4, v1}, Lu2i;->l(ILandroid/util/SparseArray;)Z
    ...
    invoke-static {v7, p4}, Lg9e;->w0(Ljava/lang/String;Ljava/lang/String;)V

    move-wide p4, v1

    :cond_9
    iput-wide p4, v0, Lava;->c:J
    ...
    iput-wide v1, v0, Lava;->d:J

    iget-wide v1, v0, Lava;->f:J

    invoke-static {v1, v2, p4, p5}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v1

    iput-wide v1, v0, Lava;->f:J

    iget-object v1, p0, Lbva;->c:Ljfa;

    iget-object v1, v1, Ljfa;->a:Ljava/lang/Object;

    check-cast v1, Lcfh;

    iget-object v2, v1, Lcfh;->z:Lwu5;

    if-eqz v2, :cond_b

    iget-object v1, v2, Lwu5;->d:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lwu5;->c:Ljava/lang/Object;

    check-cast v1, Ljava/util/concurrent/ScheduledExecutorService;

    iget-object v3, v2, Lwu5;->b:Ljava/lang/Object;
    ...
    invoke-direct {v5, v3, v6}, Lkkf;-><init>(Ljava/lang/Object;I)V

    iget-wide v6, v2, Lwu5;->a:J
    ...
    iput-object v1, v2, Lwu5;->d:Ljava/lang/Object;

    goto :goto_4

    :cond_b
    iget-wide v1, v1, Lcfh;->e:J
    ...
    invoke-direct {v1, v2, p3, p4, p5}, Ly01;-><init>(IIJ)V

    iget-object p3, p0, Lbva;->l:Lyua;

    iget p4, v0, Lava;->b:I

    invoke-interface {p3, p4, p2, v1}, Lyua;->v0(ILjava/nio/ByteBuffer;Ly01;)V
