...
.method public constructor <init>(Landroid/content/Context;Lah4;Lwm0;)V
    ...
    invoke-direct {v0, p1}, Lwpb;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v0}, Lvwd;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lbi4;->u:Lah4;

    iput-object p3, p0, Lbi4;->v:Lwm0;
    ...
    invoke-virtual {v0, p1}, Lwpb;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Lot1;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, Lot1;-><init>(Ljava/lang/Object;I)V
