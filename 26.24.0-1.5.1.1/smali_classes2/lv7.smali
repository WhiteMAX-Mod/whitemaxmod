...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llv7;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x0

    sput-boolean v0, Llv7;->c:Z
...
.method public final a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    sget-boolean v0, Llv7;->c:Z

    if-eqz v0, :cond_0

    invoke-static {p1, p2, p3}, Llv7;->c(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_0
    :try_start_0
    sget-object v0, Llv7;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p0, p1, p2, p3}, Llv7;->b(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Llv7;->d(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
...
.method public final b(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, v2, p3}, Lg9e;->C(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final d(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, v1, v0}, Landroid/renderscript/Allocation;->createFromBitmap(Landroid/renderscript/RenderScript;Landroid/graphics/Bitmap;Landroid/renderscript/Allocation$MipmapControl;I)Landroid/renderscript/Allocation;
    ...
    invoke-virtual {p3, p0}, Landroid/renderscript/ScriptIntrinsicBlur;->setRadius(F)V
