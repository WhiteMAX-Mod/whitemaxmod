...
.method public constructor <init>(Lon8;Lon8;Lon8;)V
    ...
    iput-object p3, p0, Lc7c;->a:Lon8;

    iput-object p1, p0, Lc7c;->b:Lon8;

    iput-object p2, p0, Lc7c;->c:Lon8;
    ...
    iput-object p1, p0, Lc7c;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    iput-object p1, p0, Lc7c;->e:Lb7c;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lc7c;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    return-void
.end method

.method public static d(Lxgi;)La7c;
    .locals 2

    new-instance v0, La7c;

    iget-object v1, p0, Lxgi;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    iget-object p0, p0, Lxgi;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Ldhi;

    move-result-object p0

    invoke-direct {v0, v1, p0}, La7c;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldhi;)V
...
.method public final clear()V
    ...
    iget-object v0, p0, Lc7c;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2, v3}, Li22;->e(Z)V

    const/4 v3, 0x0

    iput-object v3, v2, Li22;->j:Lx1i;

    const/4 v3, 0x0

    iput-boolean v3, v2, Li22;->k:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lc7c;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/video/VideoRender;->clear()V

    iget-object p0, p0, Lc7c;->e:Lb7c;
...
.method public final e(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    .locals 2

    invoke-virtual {p0}, Lc7c;->c()Lru/ok/android/externcalls/sdk/Conversation;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object p0, p0, Lc7c;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Lpa1;->b()Z

    move-result v2

    check-cast v1, Li22;

    iget-object v3, v1, Li22;->l:Lxgi;
    ...
    iget-object v1, v1, Li22;->d:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lc7c;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-interface {v0}, Luq1;->u()Lxgi;

    move-result-object v0

    iget-object v0, v0, Lxgi;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lc7c;->e(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lc7c;->e(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p2, p2, Ll6c;->a:Lb6c;

    iget-object p2, p2, Lb6c;->a:Luq1;

    invoke-interface {p2}, Luq1;->u()Lxgi;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lc7c;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Ldhi;
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lep1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lep1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
