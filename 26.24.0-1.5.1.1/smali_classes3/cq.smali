...
.method public constructor <init>(Ljava/security/KeyStore;)V
    ...
    iput-object v0, p0, Lcq;->a:Lu21;

    new-instance v0, Lpt;

    invoke-direct {v0}, Lpt;-><init>()V

    iput-object v0, p0, Lcq;->b:Lpt;

    new-instance v0, Lwj2;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lwj2;-><init>(I)V

    iput-object v0, p0, Lcq;->c:Lwj2;

    new-instance v0, Lzq1;

    const/16 v2, 0xb

    invoke-direct {v0, v2}, Lzq1;-><init>(I)V

    iput-object v0, p0, Lcq;->e:Lzq1;

    new-instance v0, Lhde;

    const/4 v2, 0x0

    invoke-direct {v0, v2}, Lhde;-><init>(Ljava/util/Set;)V

    iput-object v0, p0, Lcq;->f:Lhde;
    ...
    new-array p1, v1, [Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {v8, v9, v2}, Ljava/security/cert/TrustAnchor;-><init>(Ljava/security/cert/X509Certificate;[B)V
    ...
    :cond_6
    :goto_5
    invoke-direct {v4, v5}, Lhde;-><init>(Ljava/util/Set;)V
    :try_end_4
    ...
    :goto_8
    iput-object v2, p0, Lcq;->h:Ljava/lang/Exception;

    iput-object v0, p0, Lcq;->d:Ljava/security/cert/CertPathValidator;

    iput-object v3, p0, Lcq;->i:Ljava/security/cert/CertificateFactory;

    iput-object v4, p0, Lcq;->g:Lhde;
    ...
    :cond_7
    iput-object p1, p0, Lcq;->j:[Ljava/security/cert/X509Certificate;
...
.method public final a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
    ...
    invoke-virtual {v1, v0, p1, p3}, Lpt;->c(Ljava/lang/String;[Ljava/security/cert/X509Certificate;Ljavax/net/ssl/SSLSession;)V

    :cond_1
    invoke-virtual {p0, p1, p2, p5}, Lcq;->b([Ljava/security/cert/X509Certificate;Ljava/lang/String;Z)Ljava/util/List;
...
.method public final b([Ljava/security/cert/X509Certificate;Ljava/lang/String;Z)Ljava/util/List;
    .locals 16
    ...
    iget-object v2, v0, Lcq;->h:Ljava/lang/Exception;
    ...
    iget-object v11, v9, Lhde;->a:Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v5}, Lcq;->c([Ljava/security/cert/X509Certificate;ZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/List;
    ...
    const-string v2, "Auth type is null or empty"

    invoke-direct {v1, v2}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    const-string v2, "Unacceptable auth type specified"
    ...
    const-string v2, "Certificates are null or empty"

    invoke-direct {v1, v2}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    const-string v2, "Unacceptable certificates specified"
...
.method public final c([Ljava/security/cert/X509Certificate;ZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/List;
    .locals 17
    ...
    invoke-virtual {v1, v4, v5, v3}, Lcq;->d(Ljava/util/ArrayList;Ljava/util/ArrayList;Z)Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, v1, Lcq;->g:Lhde;

    if-eqz v0, :cond_2

    invoke-virtual {v0, v7}, Lhde;->h(Ljava/security/cert/X509Certificate;)Ljava/util/Set;
    ...
    invoke-static {v8, v9}, Lhr3;->f0(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p5}, Lcq;->c([Ljava/security/cert/X509Certificate;ZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/List;
    ...
    invoke-static {v14}, Ld5e;->s(Ljava/lang/String;)V
    ...
    iget-object v0, v1, Lcq;->c:Lwj2;

    invoke-virtual {v0, v15}, Lwj2;->a(Ljava/security/cert/X509Certificate;)V
    :try_end_1
    ...
    invoke-static {v4}, Ldr3;->V(Ljava/util/List;)I
    ...
    invoke-static {v7, v9}, Lhr3;->f0(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    iget-object v0, v1, Lcq;->i:Ljava/security/cert/CertificateFactory;
    ...
    invoke-direct {v1, v0}, Lbq;-><init>(Ljava/security/cert/CertPath;)V
...
.method public final checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;)V
    ...
    .line 36
    invoke-virtual/range {v0 .. v5}, Lcq;->a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
...
.method public final checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/net/Socket;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcq;->a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
...
.method public final checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcq;->b([Ljava/security/cert/X509Certificate;Ljava/lang/String;Z)Ljava/util/List;

    move-result-object p2

    iget-object p0, p0, Lcq;->b:Lpt;

    aget-object p1, p1, v0

    invoke-virtual {p0, p3, p1}, Lpt;->b(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    const-string p2, "Hostname is null or empty"
...
.method public final d(Ljava/util/ArrayList;Ljava/util/ArrayList;Z)Ljava/util/ArrayList;
    .locals 10
    ...
    iget-object v3, p0, Lcq;->i:Ljava/security/cert/CertificateFactory;
    ...
    :try_start_0
    invoke-virtual {v5, v9}, Lwj2;->a(Ljava/security/cert/X509Certificate;)V
    :try_end_0
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p2, v5}, Ljava/security/cert/PKIXParameters;-><init>(Ljava/util/Set;)V

    invoke-virtual {p2, v6}, Ljava/security/cert/PKIXParameters;->setRevocationEnabled(Z)V
    ...
    invoke-direct {v7, p3, v5}, Lsj2;-><init>(ZLjava/security/cert/X509Certificate;)V

    invoke-virtual {p2, v7}, Ljava/security/cert/PKIXParameters;->addCertPathChecker(Ljava/security/cert/PKIXCertPathChecker;)V

    iget-object p3, p0, Lcq;->d:Ljava/security/cert/CertPathValidator;

    if-eqz p3, :cond_4

    invoke-virtual {p3, v3, p2}, Ljava/security/cert/CertPathValidator;->validate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    :try_end_1
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_1 .. :try_end_1} :catch_2
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_1 .. :try_end_1} :catch_1

    iget-object p0, p0, Lcq;->f:Lhde;

    iget-object p2, p0, Lhde;->a:Ljava/lang/Object;
    ...
    invoke-direct {p0, v3}, Lbq;-><init>(Ljava/security/cert/CertPath;)V
