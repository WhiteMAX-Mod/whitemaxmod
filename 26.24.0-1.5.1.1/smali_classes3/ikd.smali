...
.method public constructor <init>(Lhkd;)V
    ...
    iput-object v0, p0, Likd;->b:Ljava/lang/String;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Likd;->c:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Likd;->d:Ljava/lang/ref/WeakReference;

    iget-object v0, p1, Lhkd;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lhkd;->c:Lyub;

    invoke-virtual {p0, p1}, Likd;->d(Lyub;)V
...
.method public final chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;)V
    ...
    .line 83
    invoke-virtual/range {v0 .. v7}, Likd;->chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
...
.method public final copy()Ldn4;
    ...
    iget-object p0, p0, Likd;->a:Lhkd;

    invoke-direct {v0, p0}, Likd;-><init>(Lhkd;)V
...
.method public final d(Lyub;)V
    ...
    iget-object v0, p0, Likd;->a:Lhkd;

    iput-object p1, v0, Lhkd;->c:Lyub;
    ...
    iget-object p0, v0, Lhkd;->e:Landroid/graphics/drawable/Drawable;
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v6, v1, Likd;->a:Lhkd;

    iget-object v7, v6, Lhkd;->f:Lgkd;

    iget-object v8, v6, Lhkd;->t:Landroid/graphics/Path;

    iget v9, v6, Lhkd;->j:I

    iget v10, v6, Lhkd;->g:I

    iget v11, v6, Lhkd;->k:I

    iget v12, v6, Lhkd;->q:F

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Lgkd;->getAsInt()I
    ...
    :cond_2
    iget-object v7, v1, Likd;->d:Ljava/lang/ref/WeakReference;
    ...
    iput-object v5, v1, Likd;->d:Ljava/lang/ref/WeakReference;

    iput v13, v1, Likd;->e:F
    ...
    iget-object v7, v1, Likd;->b:Ljava/lang/String;

    const-string v8, "getSegment start&end failed"

    invoke-static {v7, v8, v5}, Lg9e;->A0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v13, v1, Likd;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual/range {p5 .. p12}, Likd;->c(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v7, v6, Lhkd;->s:Landroid/graphics/Path;
    ...
    :try_start_5
    iget-object v7, v6, Lhkd;->w:Landroid/graphics/Path;
    ...
    iget-object v8, v6, Lhkd;->v:Landroid/graphics/Path;
    ...
    iget-object v2, v6, Lhkd;->u:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v2, v6, Lhkd;->x:Landroid/graphics/Path;
    ...
    :cond_1b
    iget-object v0, v6, Lhkd;->e:Landroid/graphics/drawable/Drawable;
...
.method public final hashCode()I
    ...
    invoke-virtual {p0}, Lhkd;->hashCode()I
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v0, p0, Lhkd;->d:Lx1h;

    iget-object v1, p0, Lhkd;->a:Landroid/content/Context;

    iget-object p0, p0, Lhkd;->b:Ljzf;
...
.method public final updateMeasureState(Landroid/text/TextPaint;)V
    ...
    iget-object p1, p0, Lhkd;->f:Lgkd;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lgkd;->getAsInt()I
