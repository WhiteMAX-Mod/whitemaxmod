...
.field public final i:Lkqb;

.field public final j:Landroid/widget/Chronometer;

.field public final k:Landroid/widget/LinearLayout;

.field public final l:Lkqb;

.field public final m:Lg92;

.field public final n:Lkqb;

.field public final o:Lkqb;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lujd;->a:Landroid/animation/FloatEvaluator;

    new-instance v4, Lbf2;

    invoke-direct {v4, v1}, Lbf2;-><init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lujd;->g:Lbf2;

    new-instance v5, Lzr;

    invoke-direct {v5, v1}, Lzr;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v5}, Lsm0;->f(Landroid/view/View;)Ljvb;
    ...
    invoke-virtual {v5, v10}, Lzr;->setImageResource(I)V

    iput-object v5, v0, Lujd;->h:Lzr;

    new-instance v10, Lkqb;

    invoke-direct {v10, v1}, Lkqb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v10, v11}, Lkqb;->setMode(Lhqb;)V
    ...
    invoke-virtual {v10, v12, v13, v14}, Lkqb;->a(FILjava/lang/String;)V

    new-instance v13, Lqjd;

    invoke-direct {v13, v0, v3}, Lqjd;-><init>(Lujd;I)V

    invoke-static {v10, v13}, Lqhf;->q0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lujd;->i:Lkqb;
    ...
    invoke-virtual {v7, v13}, Lsm0;->f(Landroid/view/View;)Ljvb;

    invoke-virtual {v13, v6}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v13, v0, Lujd;->j:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v14}, Lsm0;->f(Landroid/view/View;)Ljvb;

    move-result-object v6

    invoke-interface {v6}, Ljvb;->h()Lzub;

    move-result-object v6

    iget v6, v6, Lzub;->i:I

    invoke-static {v6, v2}, Ljz8;->o0(ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v2, v1}, Lzr;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lsm0;->f(Landroid/view/View;)Ljvb;
    ...
    invoke-virtual {v2, v3}, Lzr;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v14, v2}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    invoke-virtual {v14, v13}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iput-object v14, v0, Lujd;->k:Landroid/widget/LinearLayout;

    new-instance v2, Lkqb;

    invoke-direct {v2, v1}, Lkqb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v11}, Lkqb;->setMode(Lhqb;)V

    new-instance v3, Lqjd;

    const/4 v6, 0x1

    invoke-direct {v3, v0, v6}, Lqjd;-><init>(Lujd;I)V

    invoke-static {v2, v3}, Lqhf;->q0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v2, v0, Lujd;->l:Lkqb;

    new-instance v3, Lg92;

    invoke-direct {v3, v1}, Lg92;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v6, v0, v7}, Lqjd;-><init>(Lujd;I)V

    invoke-static {v3, v6}, Lqhf;->q0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lujd;->m:Lg92;

    new-instance v6, Lkqb;

    invoke-direct {v6, v1}, Lkqb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v11}, Lkqb;->setMode(Lhqb;)V
    ...
    invoke-virtual {v6, v12, v7, v8}, Lkqb;->a(FILjava/lang/String;)V

    new-instance v7, Lqjd;

    const/4 v8, 0x3

    invoke-direct {v7, v0, v8}, Lqjd;-><init>(Lujd;I)V

    invoke-static {v6, v7}, Lqhf;->q0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lujd;->n:Lkqb;

    new-instance v7, Lkqb;

    invoke-direct {v7, v1}, Lkqb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v11}, Lkqb;->setMode(Lhqb;)V

    new-instance v8, Lqjd;

    const/4 v9, 0x4

    invoke-direct {v8, v0, v9}, Lqjd;-><init>(Lujd;I)V

    invoke-static {v7, v8}, Lqhf;->q0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lujd;->o:Lkqb;
    ...
    invoke-direct {v1, v2, v7, v6}, Lmy0;-><init>(IIZ)V
    ...
    invoke-static {v3, v1, v2}, Lq47;->e(Landroid/view/View;Lm78;Lx57;)V

    iput-object v3, v0, Lujd;->p:Landroid/widget/FrameLayout;

    new-instance v1, Lrjd;

    invoke-direct {v1, v0, v6}, Lrjd;-><init>(Lujd;I)V

    invoke-static {v7, v1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v1

    iput-object v1, v0, Lujd;->q:Lon8;
    ...
    iput-object v1, v0, Lujd;->r:Lon8;

    new-instance v1, Lrjd;

    const/4 v2, 0x2

    invoke-direct {v1, v0, v2}, Lrjd;-><init>(Lujd;I)V

    invoke-static {v7, v1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v1

    iput-object v1, v0, Lujd;->s:Lon8;
...
.method public static final synthetic a(Lujd;)Z
    .locals 0

    invoke-direct {p0}, Lujd;->getCanRecordingVideo()Z
...
.method public static final b(Lujd;Lvjd;)V
    .locals 8

    iget-object v0, p0, Lujd;->l:Lkqb;
    ...
    invoke-static {p0, p1, v2}, Lg9e;->Y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_1
    iget-boolean v1, p1, Lvjd;->d:Z
    ...
    invoke-direct {p0}, Lujd;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-direct {p0}, Lujd;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    invoke-direct {p0}, Lujd;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v7, v6}, Lkqb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V
    ...
    invoke-virtual {p0, p1}, Lbf2;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lujd;FFFFF)V
    .locals 2

    iget-object v0, p0, Lujd;->h:Lzr;

    iget-object v1, p0, Lujd;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lujd;->p:Landroid/widget/FrameLayout;
...
.method public final getCameraApi()Lh82;
    .locals 0

    iget-object p0, p0, Lujd;->g:Lbf2;
