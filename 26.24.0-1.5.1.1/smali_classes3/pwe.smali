...
.method public constructor <init>(Lqwe;)V
    ...
    iput-object v0, p0, Lpwe;->b:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lpwe;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lpwe;->e:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lpwe;->f:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lpwe;->g:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lpwe;->h:Landroid/graphics/DashPathEffect;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lpwe;->k:Landroid/graphics/RectF;
