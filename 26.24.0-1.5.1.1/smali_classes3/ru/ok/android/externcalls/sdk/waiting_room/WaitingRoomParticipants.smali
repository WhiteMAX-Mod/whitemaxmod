...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Ljld;)V",
        "Ln61;",
        "call",
        "Lroh;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Ldof;",
        "Ln22;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lmq1;)Ln22;",
        "",
        "Lm22;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Ln61;

.field private final compositeDisposable:Ld24;
...
.field private final loadEventSubject:Lkgd;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Ljld;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Ljld;

    new-instance p1, Lkgd;

    invoke-direct {p1}, Lkgd;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lkgd;

    new-instance p2, Ld24;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Ld24;
    ...
    invoke-direct {v0, p1, p4, v1}, Llbb;-><init>(Lhbb;Lvje;I)V
    ...
    invoke-direct {v0, p1, p4, v1}, Lzbb;-><init>(Lhbb;Ln67;I)V
    ...
    invoke-direct {p1, p3}, Lb77;-><init>(Ljava/lang/Object;)V

    new-instance p3, Lubb;

    invoke-direct {p3, v0, p1, v1}, Lubb;-><init>(Lhbb;Ljava/lang/Object;I)V

    invoke-static {}, Ljh;->a()Lvje;

    move-result-object p1

    invoke-virtual {p3, p1}, Lhbb;->f(Lvje;)Lxbb;
    ...
    sget-object p0, La0c;->d:Laol;

    new-instance p4, Lcn8;

    invoke-direct {p4, p3, p0}, Lcn8;-><init>(Lta4;Lta4;)V

    invoke-virtual {p1, p4}, Lhbb;->g(Lwcb;)V

    invoke-virtual {p2, p4}, Ld24;->a(Lxg5;)Z

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnof;Lf32;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnof;Lf32;)V
...
.method public static synthetic b(Lnof;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$0$0(Lnof;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method public static synthetic c(Lnof;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0$1(Lnof;)V

    return-void
.end method

.method public static synthetic d(Ln61;Ln22;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljof;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0(Ln61;Ln22;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnof;)V

    return-void
.end method

.method public static synthetic e(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Ljof;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lnof;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lmq1;)Ln22;
    .locals 2
    ...
    invoke-direct {p0, p2, v0, v1}, Ln22;-><init>(Lmq1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Lm22;->a:Ln22;

    iget-object v1, v1, Ln22;->b:Lmq1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lmq1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v1, Lm22;->a:Ln22;

    iget-object v2, v2, Ln22;->b:Lmq1;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lmq1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Ln61;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Ldof;

    move-result-object v6

    invoke-virtual {v6}, Ldof;->c()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lmq1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lmq1;)Ln22;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Ljld;
    ...
    invoke-interface {v2, v4, v0}, Ljld;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Ln61;Ln22;)Ldof;
...
.method private final loadWaitingParticipantIdsPageSingle(Ln61;Ln22;)Ldof;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p1, p2, p0}, Llo;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, Lv04;

    const/4 p1, 0x2

    invoke-direct {p0, v0, p1}, Lv04;-><init>(Ljava/lang/Object;I)V

    return-object p0
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$0(Ln61;Ln22;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnof;)V
    .locals 7
    ...
    invoke-direct {v0, v1, p2, p3}, Lpe5;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance p2, Lkkf;

    const/16 v1, 0x1b

    invoke-direct {p2, p3, v1}, Lkkf;-><init>(Ljava/lang/Object;I)V

    iget-object p3, p0, Ln61;->k:Ltkf;
    ...
    iget-object v5, p1, Ln22;->b:Lmq1;

    invoke-virtual {v5}, Lmq1;->b()Ljava/lang/String;
    ...
    invoke-direct {p1, v2, p0, v0, p2}, Lx51;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, Lmb;

    invoke-direct {p0, p2, v2}, Lmb;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p3, v1, v4, p1, p0}, Ltkf;->d(Lwkf;ZLqkf;Lqkf;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnof;Lf32;)V
    .locals 8

    iget-object v2, p2, Lf32;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lnof;Lf32;Lnof;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$2;-><init>(Lnof;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0$1(Lnof;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Ljof;->a(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v1, v0, Lm22;->b:Ldf1;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Ldf1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v0, v0, Lm22;->a:Ln22;

    iget-object v0, v0, Ln22;->b:Lmq1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmq1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Ldof;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p0, p1}, Lfdh;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private static final resolveInternalIdSingle$lambda$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lnof;)V
    .locals 4
    ...
    invoke-direct {v1, p2, v2}, Lra4;-><init>(Ljava/lang/Object;I)V

    new-instance v2, Lvpg;

    const/16 v3, 0x1a

    invoke-direct {v2, v3, p2, p1}, Lvpg;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lua4;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$0$0(Lnof;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
...
.method private final resolveInternalIds(Ljava/util/List;Lx57;Lx57;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lx57;Lx57;)V

    new-instance p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lx57;)V
...
.method private final scheduleLoad()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lkgd;

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-virtual {p0, v0}, Lkgd;->c(Ljava/lang/Object;)V
...
.method public final release()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Ld24;
...
.method public final setCall(Ln61;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Ln61;
