...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lsee;Ll5h;Lv57;Ljava/util/Set;Ljava/lang/Long;)V",
        "Ldof;",
        "",
        "getSettings",
        "(Ljava/util/Set;)Ldof;",
...
# instance fields
.field private volatile cachedSettingsSource:Ldof;
...
.field private newSettings:Ldof;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ldof;"
        }
...
.field private readSettingsDisposable:Lxg5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Lsee;Ll5h;Lv57;Ljava/util/Set;Ljava/lang/Long;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->rxApiClient:Lsee;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->timeProvider:Ll5h;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lv57;
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->createSettingsSource()Ldof;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Ldof;

    sget-object p1, Lqx5;->a:Lqx5;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettingsDisposable:Lxg5;
    ...
    invoke-interface {p1, p2, p3}, Ljld;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, p3}, La0e;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;I)V

    invoke-virtual {p1, p2}, Lvje;->b(Ljava/lang/Runnable;)Lxg5;

    :cond_0
    return-void
.end method

.method public synthetic constructor <init>(Lsee;Ll5h;Lv57;Ljava/util/Set;Ljava/lang/Long;ILf25;)V
    .locals 6
...
.method private static final _init_$lambda$0(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Ldof;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettings-IoAF18A(Ldof;)Ljava/lang/Object;
...
.method public static final synthetic access$applySettings(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;Ldof;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->applySettings(Ldof;)V
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)Lv57;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lv57;
...
.method private final applySettings(Ldof;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->newSettings:Ldof;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lv57;
    ...
    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->newSettings:Ldof;
...
.method private final createSettingsSource()Ldof;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->getSettings(Ljava/util/Set;)Ldof;
...
.method private final getSettings(Ljava/util/Set;)Ldof;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->rxApiClient:Lsee;
...
.method private final getSettingsSource()Ldof;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->timeProvider:Ll5h;
    ...
    :cond_1
    :goto_2
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Ldof;

    return-object p0
.end method

.method private final readSettings-IoAF18A(Ldof;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lv57;
    ...
    :try_start_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettingsDisposable:Lxg5;
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared$readSettings$1$1$1;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;Ldof;)V
    ...
    invoke-virtual {p1, v1, v2}, Ldof;->f(Lta4;Lta4;)Lt32;
...
.method private final scheduleCreateNewSettings()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lv57;
    ...
    invoke-direct {v2, p0, v3}, La0e;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;I)V

    sget-object p0, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    const-wide/16 v3, 0x1388

    invoke-virtual {v1, v2, v3, v4, p0}, Lvje;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lxg5;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final scheduleCreateNewSettings$lambda$0$0(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)V
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettings-IoAF18A(Ldof;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public get(Ljava/lang/String;)Ldof;
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->getSettingsSource()Ldof;
