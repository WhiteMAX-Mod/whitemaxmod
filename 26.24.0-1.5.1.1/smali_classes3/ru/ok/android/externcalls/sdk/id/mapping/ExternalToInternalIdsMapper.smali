...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "rtcLog",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljld;)V",
        "",
        "from",
        "",
...
.field private final rtcLog:Ljld;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljld;)V
    .locals 0
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Ljld;
...
.method private final filterEmptyParticipantIds(Ljava/util/Collection;)Ljava/util/List;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Ljld;
    ...
    invoke-interface {v3, v6, v5, v4}, Ljld;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public map(Ljava/util/Collection;Lru/ok/android/externcalls/sdk/id/mapping/MappingContext;)Ljava/util/Map;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->getOkIdsByExternalIds(Ljava/util/Collection;)Ldof;

    move-result-object p1

    invoke-virtual {p1}, Ldof;->c()Ljava/lang/Object;
    ...
    :goto_3
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Ljld;

    const-string p2, "ExternalToInternalIdsMapper"

    const-string v1, "Can\'t map external ids to internal"

    invoke-interface {p0, p2, v1, p1}, Ljld;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
