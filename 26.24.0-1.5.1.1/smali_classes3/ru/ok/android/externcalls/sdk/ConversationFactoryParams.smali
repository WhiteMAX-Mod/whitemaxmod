...
.field private badNetworkIndicatorConfig:Lpl0;

.field private bitrates:Ljq1;
...
.field protected final experiments:Lhta;

.field private fastRecoverEnabled:Z

.field private forceRelayPolicy:Z

.field private groupCallMediaAdaptationConfig:Lgc9;
...
.field joinConversationDelegate:Lff8;

.field protected log:Ljld;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lxbe;->K0:Lrm8;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lxbe;

    const-string v1, "sdk-0.2.3"
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Ljq1;
    ...
    sget-object v2, Lpl0;->e:Lpl0;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lpl0;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lefe;
    ...
    invoke-direct {v0, v2}, Lhta;-><init>(Li12;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Lhta;
...
.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactoryParams;Lv57;)Lroh;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->lambda$new$0(Lv57;)Lroh;
...
.method private synthetic lambda$new$0(Lv57;)Lroh;
    .locals 1
...
.method public getBaseBuilder(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Lhta;

    invoke-direct {v1, p1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lhta;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Ljq1;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Ljq1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lxbe;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Lxbe;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Lgc9;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Lgc9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Lgc9;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Lgc9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lpl0;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBadNetworkIndicatorConfig(Lpl0;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Luke;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Luke;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lefe;

    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setSSLProvider(Lefe;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public setBadNetworkIndicatorConfig(Lpl0;)V
    .locals 0

    if-nez p1, :cond_0

    sget-object p1, Lpl0;->e:Lpl0;

    :cond_0
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lpl0;

    return-void
.end method

.method public setBitrates(Ljq1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Ljq1;
...
.method public setGroupCallMediaAdaptationConfig(Lgc9;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:Lgc9;
...
.method public setJoinConversationDelegate(Lff8;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->joinConversationDelegate:Lff8;
...
.method public setP2PCallMediaAdaptationConfig(Lgc9;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:Lgc9;
...
.method public setRotationProvider(Lxbe;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lxbe;
...
.method public setScreenCapturePermissionProvider(Luke;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Luke;
...
.method public setSslProvider(Lefe;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lefe;
