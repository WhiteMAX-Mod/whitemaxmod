...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "tokenProvider",
        "setTokenProvider",
        "(Lh8h;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;",
        "Laq;",
        "tokenInfoProvider",
        "setTokenInfoProvider",
        "(Laq;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;",
        "",
        "link",
        "setLink",
...
.method public build()Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getOnPrepared()Lx57;

    move-result-object v6

    if-eqz v6, :cond_1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getOnError()Lx57;
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getFrameInterceptor()Lmi2;

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenProvider:Lh8h;

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenInfoProvider:Laq;

    iget-object v4, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->payload:Ljava/lang/String;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams$Builder;->getCameraCapturerFactory()Lqab;
    ...
    invoke-direct/range {v0 .. v13}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;-><init>(Ljava/lang/String;Lh8h;Laq;Ljava/lang/String;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lx57;Lx57;ZLru/ok/android/externcalls/sdk/events/ConversationEventsListener;Lmi2;Lqab;Ljava/lang/String;Lf25;)V
...
.method public final setTokenInfoProvider(Laq;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenInfoProvider:Laq;

    return-object p0
.end method

.method public final setTokenProvider(Lh8h;)Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams$Builder;->tokenProvider:Lh8h;
