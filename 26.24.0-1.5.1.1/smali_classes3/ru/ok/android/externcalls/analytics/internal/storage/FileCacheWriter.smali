...
.method private verifyOutputFormat(Ljava/io/File;)V
    ...
    :try_start_0
    invoke-static {p1}, Ljl6;->d(Ljava/io/File;)Z
...
.method private write(ZLru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;Ljava/io/OutputStream;)V
    ...
    invoke-direct {p1, p3}, Lq3c;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {p0, p1}, Lhlc;-><init>(Ljava/io/Writer;)V
    ...
    invoke-virtual {p1, p0, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->serialize(Lqk8;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0}, Lhlc;->close()V
...
.method public drop()V
    ...
    :goto_0
    invoke-static {v2}, Ljl6;->e(Ljava/io/File;)J
    ...
    :cond_0
    :try_start_2
    invoke-static {v2}, Ljl6;->b(Ljava/io/File;)V
...
.method public grab(Ljavax/inject/Provider;)V
    ...
    :goto_0
    invoke-static {v3}, Ljl6;->e(Ljava/io/File;)J
    ...
    invoke-static {p1, v3, v4}, Ljl6;->a(Ljava/io/File;Ljava/io/File;Z)V
...
.method public length()J
    ...
    invoke-static {v0}, Ljl6;->e(Ljava/io/File;)J
...
.method public writeToCache(Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    ...
    invoke-static {v3}, Ljl6;->g(Ljava/io/File;)V
    ...
    :try_start_7
    invoke-static {v3}, Ljl6;->b(Ljava/io/File;)V
    :try_end_7
