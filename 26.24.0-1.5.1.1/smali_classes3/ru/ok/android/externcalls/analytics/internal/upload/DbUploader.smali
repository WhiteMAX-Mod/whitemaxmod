...
.field private final multiUploadHelper$delegate:Lon8;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljava/util/concurrent/locks/Lock;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;ILjava/lang/Long;)V
    ...
    invoke-direct {p3, p5, p1, p0}, Lxi2;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance p5, Letg;

    invoke-direct {p5, p3}, Letg;-><init>(Lv57;)V

    iput-object p5, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lon8;
    ...
    invoke-direct {p1, p5, p2, p0}, Lf52;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public static synthetic d(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lroh;
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->upload$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lroh;
...
.method private final getMultiUploadHelper()Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lon8;
...
.method private static final multiUploadHelper_delegate$lambda$0(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    invoke-direct {v5, p1, v1}, Lfn3;-><init>(Ljava/lang/Object;I)V

    const-string v4, "CallAnalyticsDbUploader"

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;-><init>(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Ljava/lang/Long;Ljava/lang/String;Lv57;)V
...
.method private static final multiUploadHelper_delegate$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)Z
    ...
    invoke-static {v8, v5, v6, p0, v7}, Lis1;->o(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private static final upload$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lroh;
    .locals 0

    invoke-virtual {p1}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Lkdb;

    move-result-object p1

    invoke-virtual {p1}, Lkdb;->b()Lko;

    move-result-object p1

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->uploadImpl(Lko;Ljava/util/Iterator;)V
...
.method private final uploadImpl(Lko;Ljava/util/Iterator;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v6, p1, v7, v8}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Lko;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lzz0;)V
...
.method public upload()V
    ...
    invoke-direct {v6, v7, p0, v1}, Lre4;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v0, v2, v6}, Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;->grab(ILx57;)V
