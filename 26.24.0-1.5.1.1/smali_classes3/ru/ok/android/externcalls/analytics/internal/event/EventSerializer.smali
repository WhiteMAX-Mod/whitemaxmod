...
.method private final writeValue(Lqk8;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
    .locals 2
    ...
    invoke-virtual {p1, v0, v1}, Lc2;->l(D)V
    ...
    invoke-virtual {p1, p0}, Lc2;->p(I)V
    ...
    invoke-interface {p1, p0}, Lqk8;->p0(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-iurDigI(Lqk8;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-4i0utlQ(Lqk8;Ljava/util/Map;)V
...
.method private final writeValue-4i0utlQ(Lqk8;Ljava/util/Map;)V
    .locals 1
    ...
    invoke-interface {p1, p2}, Lqk8;->p0(Ljava/lang/String;)V
    :try_end_0
...
.method private final writeValue-iurDigI(Lqk8;Ljava/util/Collection;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final serialize(Lqk8;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    .locals 2
    ...
    invoke-interface {p1, v1}, Lqk8;->b0(Ljava/lang/String;)Lqk8;
    ...
    invoke-direct {p0, p1, v0}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue(Lqk8;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
