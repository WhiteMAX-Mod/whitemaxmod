...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lm4c;->c:Ljava/util/Map;

    sget-object v1, Lorj;->b:Lorj;
    ...
    sput-object v0, Lm4c;->d:Ljava/util/List;
...
.method public final b()[B
    ...
    iget-object v0, p0, Lm4c;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Lmrj;->k:Lmrj;

    iget-short v6, v6, Lmrj;->a:S
    ...
    sget-object v2, Lm4c;->c:Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lf4c;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v1}, Lm4c;->e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v0}, Lm4c;->e(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lorj;->e:Lorj;
    ...
    invoke-static {v1}, Lmp5;->n(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v1

    invoke-static {v1}, Lmp5;->m(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v1}, Lm4c;->f([B)V

    iget-object v0, v0, Lf4c;->a:Lorj;
...
.method public final c(Ljava/nio/ByteBuffer;)I
    ...
    iget-object p0, p0, Lm4c;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v1, v7}, Lxgj;-><init>(II)V
    ...
    sget-object v3, Lm4c;->d:Ljava/util/List;
    ...
    sget-object v3, Lm4c;->c:Ljava/util/Map;
    ...
    invoke-static {v4}, Lm4c;->d(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v2, v1, v3}, Le4c;-><init>(Lorj;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :catch_0
    invoke-static {v7}, Ld5e;->t(Ljava/lang/String;)V

    return v2

    :catch_1
    invoke-static {v6}, Ld5e;->t(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lmp5;->o(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lmp5;->A()V

    invoke-static {v5, v4}, Lmp5;->p(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v3, v1, v2}, Lf4c;-><init>(Lorj;Ljava/security/PublicKey;)V
