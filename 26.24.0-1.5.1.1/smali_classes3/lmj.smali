...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Ldhj;)V
    .locals 1
    ...
    iput-object v0, p0, Llmj;->c:Ljava/util/concurrent/ConcurrentLinkedDeque;

    new-instance v0, Ljava/util/concurrent/ConcurrentLinkedDeque;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentLinkedDeque;-><init>()V

    iput-object v0, p0, Llmj;->d:Ljava/util/concurrent/ConcurrentLinkedDeque;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Llmj;->e:Ljava/lang/Object;

    iput-object p1, p0, Llmj;->a:Ljava/time/Clock;

    iput-object p2, p0, Llmj;->b:Ldhj;
...
.method public final a()Ljava/util/List;
    ...
    iget-object p0, p0, Llmj;->d:Ljava/util/concurrent/ConcurrentLinkedDeque;
...
.method public final b(I)Ljava/util/Optional;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Llmj;->c:Ljava/util/concurrent/ConcurrentLinkedDeque;
...
.method public final c(Lukj;Ljava/util/function/Consumer;)V
    .locals 4
    ...
    invoke-direct {v0, p1, p2}, Lkoj;-><init>(Lukj;Ljava/util/function/Consumer;)V
...
.method public final d(Z)V
    ...
    iput-boolean v0, p0, Llmj;->g:Z

    iget-object v0, p0, Llmj;->c:Ljava/util/concurrent/ConcurrentLinkedDeque;

    invoke-virtual {v0}, Ljava/util/concurrent/ConcurrentLinkedDeque;->clear()V

    iget-object v0, p0, Llmj;->d:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    :try_start_0
    iput-object v0, p0, Llmj;->f:Ljava/time/Instant;
