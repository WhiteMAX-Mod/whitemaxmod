...
.method public static final create(Lone/me/sdk/media/ffmpeg/WebmFactory$Config;)Lone/me/sdk/media/ffmpeg/AnimatedFileDrawable;
    ...
    invoke-virtual {p0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->getWay$media_ffmpeg()Lone/me/sdk/media/ffmpeg/WebmFactory$Way;
    ...
    invoke-virtual {v1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Way$File;->getFile$media_ffmpeg()Ljava/io/File;

    move-result-object v2

    invoke-virtual {v0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Way;->getWidth$media_ffmpeg()I

    move-result v4

    invoke-virtual {v0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Way;->getHeight$media_ffmpeg()I

    move-result v5

    invoke-virtual {p0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->getPreCache$media_ffmpeg()Z

    move-result v3

    invoke-virtual {v0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Way;->getLimitFps$media_ffmpeg()Z

    move-result v6

    invoke-virtual {p0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->getAutoStart$media_ffmpeg()Z
    ...
    invoke-virtual {v1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Way$Url;->getUrl$media_ffmpeg()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Way$Url;->getNetworkFetchEnabled$media_ffmpeg()Z
...
.method public static final createByFile(Ljava/io/File;ZIIZZZ)Lone/me/sdk/media/ffmpeg/AnimatedFileDrawable;
    ...
    invoke-direct/range {v0 .. v5}, Lone/me/sdk/media/ffmpeg/AnimatedFileDrawable;-><init>(Ljava/io/File;IILzv0;Ljava/lang/String;)V
...
.method public static final createByUrl(Ljava/lang/String;IIZZZ)Lone/me/sdk/media/ffmpeg/AnimatedFileDrawable;
    ...
    invoke-static {p0, v5, p4}, Lowa;->a(ILjava/lang/String;Z)Llwa;
