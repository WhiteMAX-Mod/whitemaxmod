...
# direct methods
.method public constructor <init>(Lmbh;[ILwl0;JJJLny7;)V
    .locals 1
    ...
    invoke-static {p10}, Lny7;->m(Ljava/util/Collection;)Lny7;

    move-result-object p1

    iput-object p1, p0, Loa;->o:Lny7;

    sget-object p1, Lpn3;->a:Ljtg;

    iput-object p1, p0, Loa;->p:Ljtg;
...
.method public final m(JJJLjava/util/List;[Lnf9;)V
    ...
    invoke-interface {p2}, Lnf9;->next()Z
    ...
    invoke-interface {p1}, Lnf9;->d()J

    move-result-wide v2

    invoke-interface {p1}, Lnf9;->c()J
    ...
    invoke-interface {v3}, Lnf9;->next()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-interface {v3}, Lnf9;->d()J

    move-result-wide p1

    invoke-interface {v3}, Lnf9;->c()J
    ...
    :cond_4
    invoke-static/range {p7 .. p7}, Lqhf;->L(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v4}, Leq0;->b(Landroidx/media3/common/b;)I
    ...
    invoke-virtual {p0, p2, v0, v1}, Leq0;->a(IJ)Z
...
.method public final q(JLjava/util/List;)I
    ...
    invoke-static {v8, v9, v1}, Lu2i;->I(JF)J
    ...
    iget v1, v4, Landroidx/media3/common/b;->v:I
    ...
    iget v4, v4, Landroidx/media3/common/b;->u:I
    ...
    iget v4, v0, Landroidx/media3/common/b;->v:I
