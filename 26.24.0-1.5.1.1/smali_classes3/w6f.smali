...
# instance fields
.field public final g:Ljfa;


# direct methods
.method public constructor <init>(Ljfa;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lkmf;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lw6f;->g:Ljfa;
...
.method public final J(Lznf;I)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lv6f;->A(Lgu8;)V
    ...
    iget-object v0, p2, Lfre;->g:Lone/me/sdk/sections/SettingsItem$EndViewType;

    instance-of v0, v0, Lone/me/sdk/sections/SettingsItem$EndViewType$Switch;

    iget-object p0, p0, Lw6f;->g:Ljfa;
...
.method public final bridge synthetic t(Lvwd;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lw6f;->J(Lznf;I)V
