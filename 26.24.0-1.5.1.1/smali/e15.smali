...
# static fields
.field public static final p:Ltyd;

.field public static final q:Ltyd;

.field public static final r:Ltyd;

.field public static final s:Ltyd;

.field public static final t:Ltyd;

.field public static final u:Ltyd;

.field public static v:Le15;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/HashMap;)V
    ...
    :goto_0
    iput-object v0, p0, Le15;->a:Landroid/content/Context;

    invoke-static {p2}, Lry7;->a(Ljava/util/Map;)Lry7;

    move-result-object p2

    iput-object p2, p0, Le15;->b:Lry7;
    ...
    invoke-direct {p2, v0, v1}, Lidj;-><init>(IZ)V

    iput-object p2, p0, Le15;->c:Lidj;

    new-instance p2, Lcrf;

    const/16 v0, 0x7d0

    invoke-direct {p2, v0}, Lcrf;-><init>(I)V

    iput-object p2, p0, Le15;->f:Lcrf;

    sget-object p2, Lpn3;->a:Ljtg;

    iput-object p2, p0, Le15;->d:Ljtg;

    const/4 p2, 0x1

    iput-boolean p2, p0, Le15;->e:Z
    ...
    invoke-virtual {p0, p2}, Le15;->j(I)J

    move-result-wide v2

    iput-wide v2, p0, Le15;->l:J

    new-instance p2, Ld15;

    invoke-direct {p2, p0, v1}, Ld15;-><init>(Ljava/lang/Object;I)V

    invoke-static {}, Lyj0;->z()Ljava/util/concurrent/Executor;

    move-result-object p0

    invoke-virtual {p1, p2, p0}, Lqya;->c(Ld15;Ljava/util/concurrent/Executor;)V
...
.method public final a(Ls05;)V
    ...
    iget-object p0, p0, Le15;->c:Lidj;

    invoke-virtual {p0, p1}, Lidj;->w(Ls05;)V
...
.method public final declared-synchronized d(Lzv4;Lfw4;ZI)V
    ...
    :try_start_0
    invoke-virtual {p2, p1}, Lfw4;->c(I)Z
    ...
    :cond_1
    :try_start_1
    iget-wide p1, p0, Le15;->i:J

    int-to-long p3, p4

    add-long/2addr p1, p3

    iput-wide p1, p0, Le15;->i:J
    :try_end_1
...
.method public final g(Landroid/os/Handler;Ls05;)V
    .locals 1
    ...
    invoke-virtual {p0, p2}, Lidj;->w(Ls05;)V
    ...
    invoke-direct {v0, p1, p2}, Lvl0;-><init>(Landroid/os/Handler;Ls05;)V
...
.method public final declared-synchronized h(Lzv4;Lfw4;Z)V
    ...
    :try_start_0
    invoke-virtual {p2, p3}, Lfw4;->c(I)Z
    ...
    iget-wide v1, p0, Le15;->h:J

    sub-long v1, p1, v1

    long-to-int v4, v1

    iget-wide v1, p0, Le15;->j:J

    int-to-long v5, v4

    add-long/2addr v1, v5

    iput-wide v1, p0, Le15;->j:J

    iget-wide v1, p0, Le15;->k:J

    iget-wide v5, p0, Le15;->i:J

    add-long/2addr v1, v5

    iput-wide v1, p0, Le15;->k:J
    ...
    invoke-virtual {v1, v2, p3}, Lcrf;->a(IF)V
    ...
    :cond_3
    iget-object p3, p0, Le15;->f:Lcrf;

    const/high16 v1, 0x3f000000    # 0.5f

    invoke-virtual {p3, v1}, Lcrf;->b(F)F

    move-result p3

    float-to-long v1, p3

    iput-wide v1, p0, Le15;->l:J

    :cond_4
    iget-wide v5, p0, Le15;->i:J

    iget-wide v7, p0, Le15;->l:J
    ...
    :cond_5
    iput-wide v7, p0, Le15;->m:J

    iget-object v3, p0, Le15;->c:Lidj;

    invoke-virtual/range {v3 .. v8}, Lidj;->c(IJJ)V

    :goto_1
    iput-wide p1, p0, Le15;->h:J

    iput-wide v1, p0, Le15;->i:J
...
.method public final j(I)J
    ...
    iget-object p0, p0, Le15;->o:Ljava/lang/String;
