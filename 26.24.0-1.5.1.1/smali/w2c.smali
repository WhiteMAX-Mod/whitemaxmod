...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lg9e;->w(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object v0

    iput-object v0, p0, Lw2c;->c:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lw2c;->d:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lw2c;->e:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/PathMeasure;

    invoke-direct {v0}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object v0, p0, Lw2c;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v0, p0, Lw2c;->i:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lw2c;->j:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lw2c;->k:Landroid/graphics/Matrix;
...
# virtual methods
.method public final a(Lv57;)V
    .locals 3

    iget-object v0, p0, Lw2c;->m:Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {p0}, Lw2c;->getTrimPathInterpolator()Landroid/view/animation/PathInterpolator;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/animation/Animator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    invoke-static {v0, p1}, Le4k;->d(Landroid/animation/ValueAnimator;Lv57;)V

    invoke-virtual {v0}, Landroid/animation/ObjectAnimator;->start()V

    iput-object v0, p0, Lw2c;->m:Landroid/animation/ObjectAnimator;
...
.method public final b()V
    ...
    invoke-direct {p0, v0}, Lw2c;->setTrimEndValue(F)V
...
.method public final c(Landroid/view/View;II)V
    ...
    iget-object p1, p0, Lw2c;->c:Landroid/graphics/Path;

    iget-object v4, p0, Lw2c;->j:Landroid/graphics/RectF;
    ...
    iget-object p2, p0, Lw2c;->k:Landroid/graphics/Matrix;
    ...
    invoke-direct {p0, p1}, Lw2c;->setTrimEndValue(F)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, Lw2c;->getTrimEndValue()F
    ...
    :cond_0
    iget-object v0, p0, Lw2c;->e:Landroid/graphics/Path;
    ...
    iget-object v4, p0, Lw2c;->f:Landroid/graphics/PathMeasure;

    invoke-virtual {v4, v1, v2, v0, v3}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object p0, p0, Lw2c;->i:Landroid/graphics/Paint;
