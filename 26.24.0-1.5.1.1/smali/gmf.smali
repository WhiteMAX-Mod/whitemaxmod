...
.method public constructor <init>()V
    ...
    iput-short v0, p0, Lgmf;->j:S

    sget-object v0, Lu2i;->b:[B

    iput-object v0, p0, Lgmf;->s:[B

    iput-object v0, p0, Lgmf;->v:[B
...
.method public final b()V
    ...
    invoke-virtual {p0}, Lgmf;->isActive()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lpn0;->b:Loa0;
...
.method public final f(Ljava/nio/ByteBuffer;)V
    ...
    :goto_8
    invoke-virtual {p0, v2}, Lgmf;->n(Z)V
    ...
    invoke-virtual {p0, v1}, Lpn0;->l(I)Ljava/nio/ByteBuffer;
...
.method public final isActive()Z
    ...
    invoke-super {p0}, Lpn0;->isActive()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-boolean p0, p0, Lgmf;->o:Z
...
.method public final j()V
    ...
    invoke-virtual {p0, v0}, Lgmf;->n(Z)V
...
.method public final n(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lgmf;->o(II)V
    ...
    iget-object p1, p0, Lgmf;->s:[B

    array-length p1, p1

    div-int/2addr p1, v5

    invoke-virtual {p0, p1, v3}, Lgmf;->o(II)V
    ...
    invoke-virtual {p0, p1}, Lgmf;->m(I)I

    move-result p1

    iget-object v2, p0, Lgmf;->s:[B
    ...
    invoke-virtual {p0, p1, v5}, Lgmf;->o(II)V
    ...
    invoke-virtual {p0, v1, v4}, Lgmf;->o(II)V
    ...
    invoke-static {p1, v5, v2}, Ljz8;->A(ILjava/lang/String;Z)V
...
.method public final o(II)V
    ...
    iget-object v0, p0, Lgmf;->s:[B

    iget-object v6, p0, Lgmf;->v:[B
    ...
    iget-object v5, p0, Lgmf;->s:[B

    array-length v6, v5

    iget-object v7, p0, Lgmf;->v:[B
    ...
    invoke-static {p1, v4, v0}, Ljz8;->n(ILjava/lang/String;Z)V
    ...
    invoke-static {p1, v4, v1}, Ljz8;->n(ILjava/lang/String;Z)V
    ...
    :cond_e
    :goto_8
    invoke-virtual {p0, p1}, Lpn0;->l(I)Ljava/nio/ByteBuffer;
