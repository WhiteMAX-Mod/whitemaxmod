...
.method public static o(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lnmh;->q(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lnmh;->q(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static p([Lay6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Lay6;->b()Landroid/net/Uri;
...
.method public final f(Landroid/content/Context;Lxx6;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v2}, Lyx6;->c()Ljava/lang/String;
    ...
    invoke-static {p1, p4}, Lnmh;->o(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final h(Landroid/content/Context;[Lay6;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p0}, Lnmh;->p([Lay6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p0, p3}, Lnmh;->o(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final i(ILandroid/content/Context;Ljava/util/List;)Landroid/graphics/Typeface;
    .locals 4
    ...
    invoke-direct {v1, p2}, Landroid/graphics/Typeface$CustomFallbackBuilder;-><init>(Landroid/graphics/fonts/FontFamily;)V
    ...
    invoke-static {v3, p0}, Lnmh;->p([Lay6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {p2, p1}, Lnmh;->o(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final k(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
    .locals 0
