...
.field public static final c:Lc46;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lc46;-><init>(Ljava/util/Comparator;I)V

    new-instance v1, Lc46;

    const/4 v2, 0x3

    invoke-direct {v1, v0, v2}, Lc46;-><init>(Ljava/util/Comparator;I)V

    sput-object v1, Lip4;->c:Lc46;
...
.method public synthetic constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lip4;->a:Landroid/content/Context;
...
.method public static b(Ljava/io/File;)Lbp4;
    .locals 13
    ...
    invoke-static {v1, v2, v4, v3}, Lakg;->l0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {v0}, Ldac;->h(Ljava/lang/String;)I
    ...
    invoke-static {p0, v0}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v2}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    const-string v3, "all_stacktraces"

    invoke-static {p0, v3}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v7, "all_logs"

    invoke-static {p0, v7}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct/range {v3 .. v12}, Lbp4;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Lfh8;)Lrf9;
    ...
    :cond_0
    iget-object p0, p0, Lip4;->a:Landroid/content/Context;
    ...
    :goto_0
    iget-object p0, p1, Lfh8;->c:Ljava/lang/Object;
    ...
    invoke-static {p0}, Lu2i;->K(I)Ljava/lang/String;
    ...
    invoke-direct {v0, p0}, Lsg;-><init>(I)V

    invoke-virtual {v0}, Lsg;->k()V

    invoke-virtual {v0, p1}, Lsg;->i(Lfh8;)Lm30;
    ...
    invoke-direct {p0, v0}, Ldx8;-><init>(I)V

    invoke-virtual {p0, p1}, Ldx8;->a(Lfh8;)Lrf9;
...
.method public c(I[BLorg/json/JSONObject;Ljava/util/Map;Ljava/util/List;)Lbp4;
    .locals 16
    ...
    iget-object v3, v3, Lip4;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v4, v6, v5}, Likg;->V(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v4, v0}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    invoke-static/range {p1 .. p1}, Ldac;->q(I)Ljava/lang/String;
    ...
    invoke-static {v0, v3}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v10, v0}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    move-object/from16 v3, p2

    invoke-static {v0, v3}, Lml6;->W(Ljava/io/File;[B)V
    ...
    invoke-static {v3, v4}, Lml6;->X(Ljava/io/File;Ljava/lang/String;)V

    const-string v4, "tags"

    invoke-static {v10, v4}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v4

    const-string v6, "all_stacktraces"

    invoke-static {v10, v6}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    sget-object v7, Loo2;->a:Ljava/nio/charset/Charset;
    ...
    :try_start_2
    invoke-static {v15, v12, v5, v11}, Lqel;->d(Ljava/lang/StackTraceElement;Ljava/lang/Appendable;II)V
    :try_end_2
    ...
    invoke-static {v10, v7}, Lml6;->V(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v12, v11, v5}, Lv09;->a(Ljava/io/OutputStream;I)V
    :try_end_6
    ...
    :try_start_9
    invoke-static {v11, v1}, Lvaj;->T(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v0 .. v9}, Lbp4;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9
    ...
    :catch_1
    :goto_8
    invoke-static {v10}, Lml6;->Q(Ljava/io/File;)Z
