...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lj38;->c:Ljava/util/Map;

    sget-object v1, Llng;->b:Llng;
    ...
    sput-object v0, Lj38;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Lj38;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Ljng;->v0:Ljng;

    iget-short v6, v6, Ljng;->a:S
    ...
    iget-object v2, v1, Li38;->a:Llng;

    iget-short v2, v2, Llng;->a:S

    invoke-virtual {v5, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, v1, Li38;->a:Llng;

    sget-object v3, Lj38;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Li38;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Lj38;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Lj38;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Llng;->o:Llng;
    ...
    invoke-static {v2}, Lz4;->s(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Lz4;->r(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lj38;->e([B)V

    iget-object v1, v1, Li38;->a:Llng;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {}, Llng;->values()[Llng;
    ...
    invoke-direct {v6, v2, v7}, Lue3;-><init>(II)V
    ...
    sget-object v3, Lj38;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Lj38;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    new-instance v4, Lh38;

    invoke-direct {v4, v2, v3}, Lh38;-><init>(Llng;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :cond_1
    sget-object v3, Llng;->o:Llng;

    if-eq v2, v3, :cond_2

    sget-object v3, Llng;->X:Llng;
    ...
    invoke-static {v5}, Lksb;->d(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lz4;->w()V

    invoke-static {v5, v4}, Lz4;->t(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Li38;-><init>(Llng;Ljava/security/PublicKey;)V
