...
# direct methods
.method public static c(Ljava/nio/ByteBuffer;Lzmg;Lm82;)Ljava/util/ArrayList;
    .locals 20
    ...
    sget-object v11, Lymg;->b:Lymg;

    iget-short v11, v11, Lymg;->a:S
    ...
    invoke-virtual {v7, v0, v11, v6}, Lnr5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {v14, v0}, Les;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v0}, Les;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v6, v0}, Les;->c(ILjava/nio/ByteBuffer;)V
    ...
    iput-object v13, v7, Les;->b:Ljava/lang/Object;
    ...
    invoke-direct {v6, v7, v0}, Lyyc;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    :cond_8
    sget-object v11, Lymg;->d:Lymg;

    iget-short v14, v11, Lymg;->a:S
    ...
    iput-object v12, v8, Lrbf;->a:Ljava/util/List;

    iget-short v11, v11, Lymg;->a:S

    invoke-virtual {v8, v0, v11, v7}, Lnr5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    new-instance v13, Lje3;

    const/4 v14, 0x4

    invoke-direct {v13, v7, v14}, Lje3;-><init>(II)V
    ...
    invoke-direct {v12, v13, v8}, Lj4;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v6, v0}, Les;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_d
    sget-object v11, Lymg;->X:Lymg;

    iget-short v14, v11, Lymg;->a:S

    if-ne v8, v14, :cond_1e

    sget-object v6, Lzmg;->c:Lzmg;
    ...
    invoke-virtual {v6, v0, v14, v4}, Lnr5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0, v11, v12}, Lnr5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v12, v6, Loe3;->a:Ljava/util/List;
    ...
    iget-object v7, v6, Loe3;->a:Ljava/util/List;
    ...
    invoke-direct {v4, v8, v9, v15}, Lne3;-><init>(J[B)V
    ...
    iput-object v4, v6, Loe3;->b:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Loe3;->b:Ljava/util/ArrayList;

    new-instance v12, Lme3;

    invoke-direct {v12, v8}, Lme3;-><init>([B)V
    ...
    iget-object v4, v6, Loe3;->a:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v7, v6, Loe3;->b:Ljava/util/ArrayList;
    ...
    invoke-static {}, Lzmg;->values()[Lzmg;
    ...
    invoke-direct {v3, v4, v1}, Ly5;-><init>(ILjava/lang/Object;)V
    ...
    sget-object v4, Lymg;->Y:Lymg;

    iget-short v4, v4, Lymg;->a:S
    ...
    invoke-virtual {v7, v0, v4, v6}, Lnr5;->b(Ljava/nio/ByteBuffer;II)I

    move-result v4

    sget-object v6, Lzmg;->d:Lzmg;
    ...
    iput-object v4, v7, Lfc5;->a:Ljava/lang/Long;
    ...
    invoke-direct {v4, v0, v1}, Ls3g;-><init>(Ljava/nio/ByteBuffer;Lzmg;)V
    ...
    invoke-direct {v4, v6, v0}, Lyyc;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v0}, Li92;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_25
    sget-object v4, Lymg;->u0:Lymg;

    iget-short v6, v4, Lymg;->a:S
    ...
    iput-object v7, v6, Lz38;->b:Ljava/util/ArrayList;

    iget-short v4, v4, Lymg;->a:S

    const/4 v7, 0x1

    invoke-virtual {v6, v0, v4, v7}, Lnr5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0}, Lz38;->d(Ljava/nio/ByteBuffer;)I
    ...
    iget-object v4, v2, Lm82;->b:Ljava/lang/Object;
    ...
    iget-object v6, v4, Lse4;->a:Lwte;

    iget-object v6, v6, Lwte;->b:Ljava/lang/Object;

    check-cast v6, Loch;

    invoke-direct {v13, v6}, Le2d;-><init>(Loch;)V

    iget-object v4, v4, Lse4;->f:Lpl8;
    ...
    invoke-interface {v4, v12}, Lpl8;->debug(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v13, v0, v11, v4}, Le2d;->e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lpl8;)V
    :try_end_0
    ...
    invoke-static {v4}, Lol8;->a(Ljava/lang/String;)V
...
.method public abstract b()Lzmg;
.end method

.method public final d(Ljava/nio/ByteBuffer;Lzmg;I)I
    .locals 3
