...
# direct methods
.method public constructor <init>(Lcl8;Lxoe;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lana;->a:Lcl8;

    iput-object p2, p0, Lana;->d:Lxoe;

    const-wide/16 p1, 0x2ee0

    iput-wide p1, p0, Lana;->c:J

    const-wide p1, 0x7fffffffffffffffL

    iput-wide p1, p0, Lana;->e:J

    sget-object p1, Ljava/time/Instant;->MIN:Ljava/time/Instant;

    iput-object p1, p0, Lana;->f:Ljava/time/Instant;
...
.method public final a()V
    ...
    iget-object v0, p0, Lana;->a:Lcl8;

    const-string v1, "Inconsistency error in congestion controller; attempt to set bytes in-flight below 0"

    invoke-interface {v0, v1}, Lcl8;->error(Ljava/lang/String;)V

    iput-wide v2, p0, Lana;->b:J

    iget-object v0, p0, Lana;->d:Lxoe;
...
.method public final declared-synchronized b(Ljava/util/List;)V
    ...
    iget-wide v3, p0, Lana;->b:J

    sub-long/2addr v3, v1

    iput-wide v3, p0, Lana;->b:J

    iget-object v3, p0, Lana;->d:Lxoe;

    invoke-virtual {v3}, Lxoe;->k()V
    ...
    iget-object v3, p0, Lana;->a:Lcl8;

    iget-wide v4, p0, Lana;->b:J
    ...
    invoke-interface {v3, p1}, Lcl8;->debug(Ljava/lang/String;)V
    :try_end_0
...
.method public final declared-synchronized c(Ljava/util/List;)V
    ...
    iget-object v1, p0, Lana;->d:Lxoe;

    invoke-virtual {v1}, Lxoe;->k()V

    invoke-virtual {p0}, Lana;->a()V

    iget-object v1, p0, Lana;->a:Lcl8;
...
.method public final declared-synchronized d(Lc3d;)V
    ...
    invoke-interface {p1, v1}, Lcl8;->debug(Ljava/lang/String;)V

    iget-wide v1, p0, Lana;->b:J

    iget-wide v3, p0, Lana;->c:J
    ...
    invoke-interface {p1, v0}, Lcl8;->cc(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
