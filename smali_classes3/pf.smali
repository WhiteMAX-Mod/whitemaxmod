...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ltyb;Le98;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lpf;->b:Landroid/content/Context;

    iput-object p2, p0, Lpf;->c:Ltyb;

    iput-object p3, p0, Lpf;->d:Le98;
...
# virtual methods
.method public final a(Lzie;Ljava/lang/String;)Landroid/net/Uri;
    .locals 7

    invoke-interface {p1}, Lzie;->e()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1}, Lzie;->a()Lg8a;
    ...
    invoke-direct {v0, v5, p2}, Lyvb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iget-object p2, v1, Lg8a;->a:Ljava/lang/String;

    new-instance v1, Lyvb;

    const-string v5, "mime_type"

    invoke-direct {v1, v5, p2}, Lyvb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v6, p2}, Lyvb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    filled-new-array {v0, v1, v5, v2, v3}, [Lyvb;
    ...
    :cond_a
    invoke-interface {p1}, Lzie;->h()Ljava/lang/Integer;
    ...
    :cond_b
    invoke-interface {p1}, Lzie;->getWidth()Ljava/lang/Integer;
    ...
    :cond_c
    invoke-interface {p1}, Lzie;->getHeight()Ljava/lang/Integer;
    ...
    invoke-interface {p1}, Lzie;->d()Landroid/net/Uri;
    ...
    invoke-interface {p1, v5, v3}, Lzie;->b(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    iget-object p1, p0, Lpf;->b:Landroid/content/Context;

    invoke-static {p1, v3}, Lyie;->e(Landroid/content/Context;Landroid/net/Uri;)V

    return-object v3
.end method

.method public final b(Lzie;Ljava/lang/String;)Landroid/net/Uri;
    .locals 3

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Lpf;->c:Ltyb;

    invoke-virtual {v1}, Ltyb;->a()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v0, v2, p2}, Ljava/io/File;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {p1, v0}, Lzie;->o(Ljava/io/File;)V

    iget-object p1, v1, Ltyb;->a:Landroid/content/Context;
...
.method public final d()Le98;
    .locals 1

    iget-object v0, p0, Lpf;->d:Le98;
