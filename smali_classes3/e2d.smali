...
# instance fields
.field public final a:Loch;

.field public final b:I

.field public c:[B

.field public final d:Ldug;
...
.method public constructor <init>(Loch;)V
    ...
    iput-object p1, p0, Le2d;->d:Ldug;

    return-void
.end method

.method public constructor <init>(Loch;Ldug;)V
    .locals 0
...
.method public static c(IJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p3}, Lr3j;->c(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Lr3j;->d(JLjava/nio/ByteBuffer;)I
...
.method public static d(ILjava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, p1}, Lr3j;->c(ILjava/nio/ByteBuffer;)I
...
.method public final a()[B
    ...
    iget-object v3, p0, Le2d;->a:Loch;

    invoke-virtual {v3, v2}, Loch;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v3}, Loch;->b()Z
    ...
    iget-object v4, p0, Le2d;->d:Ldug;

    if-ne v3, v2, :cond_2

    iget-object v5, v4, Ldug;->a:[B

    invoke-static {v0, v1, v5}, Le2d;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_2
    iget-wide v5, v4, Ldug;->b:J

    const/4 v7, 0x1

    invoke-static {v7, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    if-ne v3, v2, :cond_3

    iget-object v5, v4, Ldug;->q:[B

    if-eqz v5, :cond_3

    invoke-static {v2, v1, v5}, Le2d;->d(ILjava/nio/ByteBuffer;[B)V
    ...
    iget-wide v5, v4, Ldug;->c:J

    const/4 v7, 0x4

    invoke-static {v7, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Ldug;->d:J

    const/4 v8, 0x5

    invoke-static {v8, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Ldug;->e:J

    const/4 v8, 0x6

    invoke-static {v8, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Ldug;->f:J

    const/4 v8, 0x7

    invoke-static {v8, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Ldug;->g:J

    const/16 v8, 0x8

    invoke-static {v8, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Ldug;->h:J
    ...
    iget-boolean v5, v4, Ldug;->j:Z

    if-eqz v5, :cond_4

    const/16 v5, 0xc

    invoke-static {v5, v1}, Lr3j;->c(ILjava/nio/ByteBuffer;)I

    invoke-static {v0, v1}, Lr3j;->c(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v0, v5, v6, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V

    iget-object v0, v4, Ldug;->n:[B

    const/16 v5, 0xf

    invoke-static {v5, v1, v0}, Le2d;->d(ILjava/nio/ByteBuffer;[B)V

    if-ne v3, v2, :cond_5

    iget-object v0, v4, Ldug;->o:[B

    if-eqz v0, :cond_5

    const/16 v3, 0x10

    invoke-static {v3, v1, v0}, Le2d;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_5
    iget-object v0, v4, Ldug;->r:Lb2e;

    if-eqz v0, :cond_6

    iget-object v3, v0, Lb2e;->c:Ljava/lang/Object;
    ...
    invoke-direct {v0, v6, v5}, Lds;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v0, v3, v4, v1}, Le2d;->c(IJLjava/nio/ByteBuffer;)V
...
.method public final e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lpl8;)V
    .locals 11
    ...
    invoke-static {p1}, Lr3j;->g(Ljava/nio/ByteBuffer;)I
    ...
    invoke-interface {p3, v1, v0}, Lpl8;->debug(Ljava/lang/String;[B)V

    iput-object v0, v6, Ldug;->a:[B
    ...
    invoke-interface {p3, v2}, Lpl8;->debug(Ljava/lang/String;)V

    iput-wide v0, v6, Ldug;->b:J
    ...
    invoke-interface {p3, v1}, Lpl8;->debug(Ljava/lang/String;)V

    iput-object v0, v6, Ldug;->q:[B
    ...
    iput-object v0, p3, Lqg8;->a:Ljava/lang/Object;
    ...
    iput-object v0, p3, Lqg8;->b:Ljava/lang/Object;
    ...
    iget-object v0, p3, Lqg8;->a:Ljava/lang/Object;

    check-cast v0, Ljava/net/InetAddress;

    if-nez v0, :cond_14

    iget-object v0, p3, Lqg8;->b:Ljava/lang/Object;
    ...
    iput-object v0, p3, Lqg8;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Loch;-><init>(I)V
    ...
    invoke-direct {v2, p3}, Loch;-><init>(I)V

    const/16 p3, 0x8

    invoke-direct {v1, v2, p3, v0}, Lb2e;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v1, v6, Ldug;->r:Lb2e;
    ...
    :goto_a
    invoke-interface {p3, v0}, Lpl8;->warn(Ljava/lang/String;)V
