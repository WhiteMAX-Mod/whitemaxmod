...
.method public constructor <init>(Ljava/security/KeyStore;)V
    ...
    iput-object v0, p0, Leq;->b:Ljava/util/Set;
    ...
    iput-object v0, p0, Leq;->f:Lmu1;

    new-instance v0, Lphf;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lphf;-><init>(Ljava/util/Set;)V

    iput-object v0, p0, Leq;->g:Lphf;
    ...
    :cond_6
    :goto_5
    invoke-direct {v4, v5}, Lphf;-><init>(Ljava/util/Set;)V
    :try_end_4
    ...
    :goto_8
    iput-object v1, p0, Leq;->i:Ljava/lang/Exception;

    iput-object v2, p0, Leq;->e:Ljava/security/cert/CertPathValidator;

    iput-object v3, p0, Leq;->j:Ljava/security/cert/CertificateFactory;

    iput-object v4, p0, Leq;->h:Lphf;
    ...
    :cond_7
    iput-object p1, p0, Leq;->k:[Ljava/security/cert/X509Certificate;
...
.method public final a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
    ...
    invoke-virtual {p4, v1, p3}, Ldue;->F(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    :cond_4
    :goto_3
    invoke-virtual {p0, p1, v0, p2, p5}, Leq;->b([Ljava/security/cert/X509Certificate;[BLjava/lang/String;Z)Ljava/util/List;
...
.method public final b([Ljava/security/cert/X509Certificate;[BLjava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v2, v0, Leq;->i:Ljava/lang/Exception;
    ...
    iget-object v11, v9, Lphf;->b:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v9, v9, Lphf;->c:Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v6}, Leq;->c([Ljava/security/cert/X509Certificate;[BZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/List;
...
.method public final c([Ljava/security/cert/X509Certificate;[BZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/List;
    ...
    invoke-virtual {v1, v5, v6, v4, v3}, Leq;->e(Ljava/util/ArrayList;Ljava/util/ArrayList;Z[B)Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, v1, Leq;->h:Lphf;

    if-eqz v0, :cond_2

    invoke-virtual {v0, v8}, Lphf;->n(Ljava/security/cert/X509Certificate;)Ljava/util/Set;
    ...
    invoke-static {v9, v10}, Lbx3;->Y0(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p6}, Leq;->c([Ljava/security/cert/X509Certificate;[BZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/HashSet;)Ljava/util/List;
    ...
    iget-object v0, v1, Leq;->d:Lrj5;

    invoke-virtual {v0, v15}, Lrj5;->N(Ljava/security/cert/X509Certificate;)V
    :try_end_1
    ...
    iget-object v2, v1, Leq;->g:Lphf;

    invoke-virtual {v2, v8}, Lphf;->n(Ljava/security/cert/X509Certificate;)Ljava/util/Set;
    ...
    invoke-static {v8, v10}, Lbx3;->Y0(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    iget-object v0, v1, Leq;->j:Ljava/security/cert/CertificateFactory;
...
.method public final checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;)V
    ...
    .line 40
    invoke-virtual {p0, p1, v1, p2, v0}, Leq;->b([Ljava/security/cert/X509Certificate;[BLjava/lang/String;Z)Ljava/util/List;
...
.method public final checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/net/Socket;)V
    ...
    invoke-virtual/range {v1 .. v6}, Leq;->a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
...
.method public final checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;)V
    ...
    .line 38
    invoke-virtual/range {v0 .. v5}, Leq;->a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
...
.method public final checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v0, p0, Leq;->c:Ldue;

    const/4 v1, 0x0

    aget-object v2, p1, v1

    invoke-virtual {v0, p3, v2}, Ldue;->F(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-virtual {p0, p1, p3, p2, v1}, Leq;->b([Ljava/security/cert/X509Certificate;[BLjava/lang/String;Z)Ljava/util/List;
...
.method public final d(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;[B)V
    ...
    :try_start_0
    iget-object v1, p0, Leq;->e:Ljava/security/cert/CertPathValidator;
    ...
    iget-object p0, p0, Leq;->b:Ljava/util/Set;
...
.method public final e(Ljava/util/ArrayList;Ljava/util/ArrayList;Z[B)Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Leq;->j:Ljava/security/cert/CertificateFactory;
    ...
    :try_start_0
    invoke-virtual {v4, v8}, Lrj5;->N(Ljava/security/cert/X509Certificate;)V
    :try_end_0
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, p2, v4, p4}, Leq;->d(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;[B)V

    new-instance p4, Lto2;

    invoke-direct {p4, p3, v4}, Lto2;-><init>(ZLjava/security/cert/X509Certificate;)V

    invoke-virtual {p2, p4}, Ljava/security/cert/PKIXParameters;->addCertPathChecker(Ljava/security/cert/PKIXCertPathChecker;)V

    iget-object p3, p0, Leq;->e:Ljava/security/cert/CertPathValidator;
    ...
    iget-object p0, p0, Leq;->g:Lphf;

    iget-object p2, p0, Lphf;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p4}, Lphf;->g(Ljava/security/cert/TrustAnchor;)V
    :try_end_2
