...
# static fields
.field public static final p:Llu8;
...
.field public final d:Lcki;

.field public final e:Lbki;

.field public final f:Laki;

.field public final g:Lze9;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldki;->p:Llu8;

    return-void
.end method

.method public constructor <init>(Landroid/net/Uri;Ljava/io/RandomAccessFile;Ljava/lang/String;ILcki;Lbki;Laki;Lze9;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Ldki;->a:Ljava/io/RandomAccessFile;

    iput-object p3, p0, Ldki;->b:Ljava/lang/String;

    iput p4, p0, Ldki;->c:I

    iput-object p5, p0, Ldki;->d:Lcki;

    iput-object p6, p0, Ldki;->e:Lbki;

    iput-object p7, p0, Ldki;->f:Laki;

    iput-object p8, p0, Ldki;->g:Lze9;
    ...
    invoke-direct {p2, p6, p7, p3}, Llr6;-><init>(JZ)V
    ...
    new-instance p6, Llr6;

    invoke-direct {p6, p2, p3, p4}, Llr6;-><init>(JZ)V

    move-object p2, p6

    :goto_0
    iput-object p2, p0, Ldki;->h:Llr6;
    ...
    sget-object p3, Ldki;->p:Llu8;

    :try_start_1
    sget-object p4, Ldki;->q:Ljavax/net/ssl/SSLContext;
    ...
    sput-object p4, Ldki;->q:Ljavax/net/ssl/SSLContext;
    :try_end_2
    ...
    :cond_4
    :goto_4
    sget-object p3, Ldki;->q:Ljavax/net/ssl/SSLContext;
    :try_end_3
    ...
    :goto_5
    iput-object p3, p0, Ldki;->i:Ljavax/net/ssl/SSLContext;

    new-instance p4, Led7;

    iget p5, p5, Lcki;->a:I

    invoke-direct {p4, p2, p5}, Led7;-><init>(Llr6;I)V

    iput-object p4, p0, Ldki;->j:Led7;
    ...
    iput-object p2, p0, Ldki;->k:Ljava/lang/String;
    ...
    iput-object p1, p0, Ldki;->m:Ljava/lang/String;

    new-instance p1, Ljava/util/concurrent/CompletableFuture;

    invoke-direct {p1}, Ljava/util/concurrent/CompletableFuture;-><init>()V

    iput-object p1, p0, Ldki;->n:Ljava/util/concurrent/CompletableFuture;

    new-instance p1, Leuc;

    invoke-direct {p1, p0, p8}, Leuc;-><init>(Ldki;Lze9;)V

    iput-object p1, p0, Ldki;->o:Leuc;
...
.method public final a(Z)V
    ...
    iget-object v8, p0, Ldki;->o:Leuc;

    invoke-virtual {v8}, Leuc;->r()Ljava/util/List;
    ...
    iget-object v1, p0, Ldki;->g:Lze9;

    invoke-direct {v10, v2, v1, v0}, Lmf;-><init>(ILjava/lang/Object;I)V

    new-instance v13, Lvuf;

    const/16 v0, 0x17

    invoke-direct {v13, v0, p0}, Lvuf;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lagi;

    iget-object v1, p0, Ldki;->k:Ljava/lang/String;

    iget-object v2, p0, Ldki;->m:Ljava/lang/String;

    iget-object v3, p0, Ldki;->b:Ljava/lang/String;

    iget-object v4, p0, Ldki;->j:Led7;

    iget v5, p0, Ldki;->c:I

    iget-object v6, p0, Ldki;->a:Ljava/io/RandomAccessFile;

    iget-object v7, p0, Ldki;->h:Llr6;

    iget-object v9, p0, Ldki;->f:Laki;

    iget-object v11, p0, Ldki;->i:Ljavax/net/ssl/SSLContext;

    move v12, p1

    invoke-direct/range {v0 .. v13}, Lagi;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Led7;ILjava/io/RandomAccessFile;Llr6;Leuc;Laki;Lmf;Ljavax/net/ssl/SSLContext;ZLvuf;)V
    ...
    invoke-direct {p0, v1}, Lzn3;-><init>(I)V

    const-string v2, "Connection"

    invoke-virtual {v10, v2, p0}, Lmf;->b(Ljava/lang/String;Laf7;)V
    ...
    iput-wide v3, v0, Lagi;->k:J

    :cond_4
    iget-object p0, v0, Lagi;->e:Li1m;

    iget-object v3, p0, Li1m;->a:Ljava/lang/Object;
    ...
    invoke-direct {p1, v3}, Lzn3;-><init>(I)V

    invoke-virtual {v10, v2, p1}, Lmf;->b(Ljava/lang/String;Laf7;)V

    iget-object p0, p0, Li1m;->a:Ljava/lang/Object;

    check-cast p0, Ljava/nio/channels/SocketChannel;

    iget-object p1, v8, Leuc;->b:Ljava/lang/Object;

    check-cast p1, Lze9;

    new-instance v2, Lzn3;

    invoke-direct {v2, v3}, Lzn3;-><init>(I)V

    const-string v3, "Poller"

    invoke-interface {p1, v3, v2}, Lze9;->b(Ljava/lang/String;Laf7;)V

    iget-object p1, v8, Leuc;->c:Ljava/lang/Object;
...
.method public final b()V
    ...
    iget-object v0, p0, Ldki;->n:Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v2, v3, v0}, Lbpg;-><init>(ILjava/lang/Object;)V

    iget-object p0, p0, Ldki;->g:Lze9;

    const-string v0, "Uploader"

    invoke-interface {p0, v0, v1, v2}, Lze9;->r(Ljava/lang/String;Laf7;Laf7;)V
...
.method public final c(JZ)Z
    ...
    invoke-direct {p1, v3}, Lyfi;-><init>(I)V

    iget-object p0, p0, Ldki;->g:Lze9;

    const-string p2, "Uploader"

    invoke-interface {p0, p2, p1}, Lze9;->f(Ljava/lang/String;Laf7;)V

    return v1

    :cond_0
    iget-object p0, v0, Lnr6;->b:Ljava/nio/channels/Pipe;
    ...
    invoke-direct {p3, v3, p0}, Lmp5;-><init>(ILjava/lang/Object;)V

    const-string p0, "FileInfoUpdateSender"

    invoke-interface {p1, p0, p2, p3}, Lze9;->r(Ljava/lang/String;Laf7;Laf7;)V
...
.method public final d()Z
    ...
    :try_start_2
    invoke-virtual {v0, v1}, Leuc;->A(Ljava/nio/channels/Selector;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    iput-object v2, v0, Leuc;->c:Ljava/lang/Object;
    :try_end_3
    ...
    iget-object p0, p0, Ldki;->j:Led7;

    iget-object v0, p0, Led7;->c:Ljava/lang/Object;

    check-cast v0, Llr6;

    iget-boolean v1, v0, Llr6;->b:Z

    if-eqz v1, :cond_0

    iget-wide v0, v0, Llr6;->a:J

    invoke-virtual {p0}, Led7;->V()J
    ...
    :try_start_7
    invoke-static {v1, v0}, Lrx8;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
