...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lmwf;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-virtual {v3, v8}, La8g;->h(Landroid/view/View;)Lkbc;

    move-result-object v10

    invoke-interface {v10}, Lkbc;->getText()Ldbc;

    move-result-object v10

    iget v10, v10, Ldbc;->h:I

    invoke-virtual {v8, v10}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v8, p0, Lmwf;->c:Landroidx/appcompat/widget/AppCompatTextView;

    new-instance v10, Landroidx/appcompat/widget/AppCompatTextView;

    invoke-direct {v10, p1}, Landroidx/appcompat/widget/AppCompatTextView;-><init>(Landroid/content/Context;)V

    const v11, 0x7f0906dc
    ...
    invoke-static {v9, v10}, Lq9i;->a(Lnoh;Landroid/widget/TextView;)V

    invoke-virtual {v3, v10}, La8g;->h(Landroid/view/View;)Lkbc;
    ...
    iget v11, v11, Ldbc;->c:I

    invoke-virtual {v10, v11}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v10, p0, Lmwf;->d:Landroidx/appcompat/widget/AppCompatTextView;

    new-instance v11, Landroidx/appcompat/widget/AppCompatTextView;

    invoke-direct {v11, p1}, Landroidx/appcompat/widget/AppCompatTextView;-><init>(Landroid/content/Context;)V

    const v12, 0x7f0906de

    invoke-virtual {v11, v12}, Landroid/view/View;->setId(I)V

    new-instance v12, Low3;

    invoke-direct {v12, v4, v4}, Low3;-><init>(II)V

    invoke-virtual {v11, v12}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v11, v2}, Landroid/widget/TextView;->setGravity(I)V

    invoke-static {v9, v11}, Lq9i;->a(Lnoh;Landroid/widget/TextView;)V
    ...
    iput-object v11, p0, Lmwf;->e:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {p1, v4, v4}, Low3;-><init>(II)V
    ...
    iput-object v3, p0, Lmwf;->f:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v5, v7, v4}, Low3;-><init>(II)V
...
.method private final setDivider(Z)V
    ...
    :goto_0
    iget-object p0, p0, Lmwf;->d:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setNickname(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object p0, p0, Lmwf;->e:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setPhoneNumber(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object p0, p0, Lmwf;->c:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final onThemeChanged(Lkbc;)V
    ...
    iget-object v1, p0, Lmwf;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lmwf;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lmwf;->e:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public setAlpha(F)V
    ...
    iget-object v0, p0, Lmwf;->f:Landroid/widget/LinearLayout;

    invoke-virtual {v0, p1}, Landroid/view/View;->setAlpha(F)V

    iget-object p0, p0, Lmwf;->a:Lkwb;
...
.method public final setAvatarClickedListener(Laf7;)V
    .locals 2
...
.method public final setNicknameClickListener(Laf7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setTopBarContent(Livf;)V
    .locals 4

    iget-object v0, p1, Livf;->b:Ljava/lang/String;

    iget-wide v1, p1, Livf;->a:J

    invoke-static {v1, v2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v1

    iget-object v2, p1, Livf;->d:Ljava/lang/CharSequence;

    iget-object v3, p0, Lmwf;->a:Lkwb;

    invoke-static {v3, v0, v1, v2}, Lkwb;->v(Lkwb;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmwf;->b:Landroidx/appcompat/widget/AppCompatTextView;

    iget-object v1, p1, Livf;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Livf;->e:Ljava/lang/String;

    invoke-direct {p0, v0}, Lmwf;->setPhoneNumber(Ljava/lang/String;)V

    iget-object p1, p1, Livf;->f:Ljava/lang/String;

    invoke-direct {p0, p1}, Lmwf;->setNickname(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-direct {p0, p1}, Lmwf;->setDivider(Z)V

    return-void
.end method

.method public final setUserPhoneClickListener(Laf7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
