...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    ...
    iput-object p1, p0, Lqs1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iput-object p2, p0, Lqs1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lqv1;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lqs1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lms1;-><init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Landroid/opengl/EGLContext;[ILysj;Ljava/lang/String;)V

    iput-object v0, p0, Lqs1;->e:Lms1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lqs1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Lqs1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Lqs1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lqs1;->i:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lqs1;->a(Lpi;)V

    iput-object v0, p0, Lqs1;->c:Lpi;
...
.method public final a(Lpi;)V
    ...
    iget-object p0, p0, Lqs1;->e:Lms1;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    :try_start_0
    iget-object v0, p0, Lms1;->k:Lk3k;
...
.method public final b()V
    ...
    iget-object v1, p0, Lms1;->j:Ljava/lang/String;
    ...
    iget-object v1, p0, Lms1;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lms1;->i:Z

    if-nez v2, :cond_0

    iget-object v2, p0, Lms1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iget-object p0, p0, Lms1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean v2, p0, Lms1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v1

    iget-object v1, p0, Lms1;->k:Lk3k;

    new-instance v2, Lqe;

    const/16 v3, 0x16

    invoke-direct {v2, p0, v3, v0}, Lqe;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v1, v2}, Landroid/os/Handler;->postAtFrontOfQueue(Ljava/lang/Runnable;)Z

    iget-object v1, p0, Lms1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iget-object p0, p0, Lms1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c(Lms1;Lu52;Lorg/webrtc/VideoFrame;Lqw1;)V
    .locals 16
    ...
    iget-object v4, v2, Lns1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lms1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lms1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lqs1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lu52;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Lqs1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lms1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Lqs1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v0}, Lms1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v0, v1, Lms1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v2, Lu52;->l:Lv52;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v1, Lv52;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Lv52;->h:J

    iget-wide v5, v1, Lv52;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Lv52;->i:J
