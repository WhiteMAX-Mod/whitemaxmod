...
.field public final l:Lm5c;

.field public final m:Lnd2;

.field public final n:Lm5c;

.field public final o:Lm5c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lk2e;->a:Landroid/animation/FloatEvaluator;

    new-instance v4, Lhj2;

    invoke-direct {v4, v1}, Lhj2;-><init>(Landroid/content/Context;)V
    ...
    iput-object v5, v0, Lk2e;->h:Lcs;

    new-instance v10, Lm5c;

    invoke-direct {v10, v1}, Lm5c;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v10, v11}, Lm5c;->setMode(Lj5c;)V
    ...
    invoke-virtual {v10, v12, v13, v14}, Lm5c;->a(FILjava/lang/String;)V

    new-instance v13, Lg2e;

    invoke-direct {v13, v0, v3}, Lg2e;-><init>(Lk2e;I)V

    invoke-static {v10, v13}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lk2e;->i:Lm5c;
    ...
    invoke-virtual {v7, v13}, La8g;->h(Landroid/view/View;)Lkbc;

    invoke-virtual {v13, v6}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v13, v0, Lk2e;->j:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v14}, La8g;->h(Landroid/view/View;)Lkbc;

    move-result-object v6

    invoke-interface {v6}, Lkbc;->h()Lyac;

    move-result-object v6

    iget v6, v6, Lyac;->i:I

    invoke-static {v6, v2}, Lsb8;->m0(ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v7, v2}, La8g;->h(Landroid/view/View;)Lkbc;
    ...
    iput-object v14, v0, Lk2e;->k:Landroid/widget/LinearLayout;

    new-instance v2, Lm5c;

    invoke-direct {v2, v1}, Lm5c;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v11}, Lm5c;->setMode(Lj5c;)V

    new-instance v3, Lg2e;

    const/4 v6, 0x1

    invoke-direct {v3, v0, v6}, Lg2e;-><init>(Lk2e;I)V

    invoke-static {v2, v3}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v2, v0, Lk2e;->l:Lm5c;

    new-instance v3, Lnd2;

    invoke-direct {v3, v1}, Lnd2;-><init>(Landroid/content/Context;)V
    ...
    new-instance v6, Lg2e;

    const/4 v7, 0x2

    invoke-direct {v6, v0, v7}, Lg2e;-><init>(Lk2e;I)V

    invoke-static {v3, v6}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lk2e;->m:Lnd2;

    new-instance v6, Lm5c;

    invoke-direct {v6, v1}, Lm5c;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v11}, Lm5c;->setMode(Lj5c;)V
    ...
    invoke-virtual {v6, v12, v7, v8}, Lm5c;->a(FILjava/lang/String;)V

    new-instance v7, Lg2e;

    const/4 v8, 0x3

    invoke-direct {v7, v0, v8}, Lg2e;-><init>(Lk2e;I)V

    invoke-static {v6, v7}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lk2e;->n:Lm5c;

    new-instance v7, Lm5c;

    invoke-direct {v7, v1}, Lm5c;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v11}, Lm5c;->setMode(Lj5c;)V

    new-instance v8, Lg2e;

    const/4 v9, 0x4

    invoke-direct {v8, v0, v9}, Lg2e;-><init>(Lk2e;I)V

    invoke-static {v7, v8}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lk2e;->o:Lm5c;
    ...
    invoke-direct {v1, v2, v7, v6}, Lj11;-><init>(IIZ)V

    new-instance v19, Loi8;
    ...
    invoke-direct/range {v19 .. v24}, Loi8;-><init>(IIILj11;I)V

    move-object/from16 v1, v19

    const/4 v2, 0x0

    invoke-static {v3, v1, v2}, Llvb;->H(Landroid/view/View;Loi8;Lcf7;)V

    iput-object v3, v0, Lk2e;->p:Landroid/widget/FrameLayout;

    new-instance v1, Lh2e;

    invoke-direct {v1, v0, v6}, Lh2e;-><init>(Lk2e;I)V

    invoke-static {v7, v1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object v1

    iput-object v1, v0, Lk2e;->q:Lny8;
    ...
    iput-object v1, v0, Lk2e;->r:Lny8;

    new-instance v1, Lh2e;

    const/4 v2, 0x2

    invoke-direct {v1, v0, v2}, Lh2e;-><init>(Lk2e;I)V

    invoke-static {v7, v1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object v1

    iput-object v1, v0, Lk2e;->s:Lny8;
...
.method public static final synthetic a(Lk2e;)Z
    .locals 0

    invoke-direct {p0}, Lk2e;->getCanRecordingVideo()Z
...
.method public static final b(Lk2e;Ll2e;)V
    .locals 8

    iget-object v0, p0, Lk2e;->l:Lm5c;

    iget-boolean v1, p1, Ll2e;->c:Z
    ...
    invoke-static {p0, p1, v2}, Lgm0;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_1
    iget-boolean v1, p1, Ll2e;->d:Z
    ...
    invoke-direct {p0}, Lk2e;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-direct {p0}, Lk2e;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    invoke-direct {p0}, Lk2e;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v7, v6}, Lm5c;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V
    ...
    invoke-virtual {p0, p1}, Lhj2;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lk2e;FFFFF)V
    .locals 2

    iget-object v0, p0, Lk2e;->h:Lcs;

    iget-object v1, p0, Lk2e;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lk2e;->p:Landroid/widget/FrameLayout;
...
.method public final getCameraApi()Loc2;
    .locals 0

    iget-object p0, p0, Lk2e;->g:Lhj2;
