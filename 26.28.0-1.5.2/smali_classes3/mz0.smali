...
.method public final call()Ljava/lang/Object;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/stat/supportedcodecs/SupportedCodecsStatistics;->b(Lxdd;)Ljava/lang/Long;
    ...
    iget-object p0, p0, Lzzf;->l:Lorg/webrtc/EglBase;
    ...
    iget-object v0, p0, Lcom/vk/push/core/remote/config/omicron/c;->g:Lg85;
    ...
    iget-object v3, p0, Latb;->d:Lcom/vk/push/core/remote/config/omicron/DataId;
    ...
    iget-object v5, p0, Latb;->c:Lcom/vk/push/core/remote/config/omicron/OmicronConfig;
    ...
    iget-object p0, p0, Latb;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_2
    iget-object p0, v0, Lg85;->c:Ljava/lang/Object;
    ...
    invoke-interface {p0, v2, v5}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :try_start_2
    invoke-interface {p0, v2, v0, v5}, Ly3e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
    ...
    invoke-interface {p0, v2, v0, v1}, Ly3e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_3
    iget-object v3, p0, Lhn5;->h:Lax5;

    invoke-virtual {v3}, Lax5;->m()V

    iget-object v3, p0, Lhn5;->e:Ljava/util/HashSet;
    ...
    :try_start_5
    iput-boolean v1, p0, Lfn5;->a:Z

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lfn5;->c:J

    iput-wide v3, p0, Lfn5;->b:J
    :try_end_5
    ...
    :try_start_9
    iget-object v0, p0, Lnz0;->b:Lpc5;

    iget-object v3, p0, Lnz0;->d:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lpc5;->b(Ljava/lang/String;)Libb;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v3, v0, Libb;->b:Ljava/io/File;
    ...
    iget-object v1, v0, Libb;->b:Ljava/io/File;

    iget-object v3, v0, Libb;->a:Ljava/lang/String;

    invoke-virtual {p0, v1, v3}, Lnz0;->e(Ljava/io/File;Ljava/lang/String;)V
    :try_end_9
    .catchall {:try_start_9 .. :try_end_9} :catchall_2

    sget-object p0, Lhbb;->a:Ljava/lang/String;
    ...
    iget-object v5, v0, Lpc5;->a:Liz8;

    invoke-virtual {v5}, Liz8;->a()Ljava/io/File;

    move-result-object v5

    invoke-virtual {v0, v3}, Lpc5;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    :try_start_c
    iget-object v0, p0, Lnz0;->a:Lqg7;

    iget-object v3, p0, Lnz0;->d:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lqg7;->f(Ljava/lang/String;)Ltsb;
    ...
    iget-object v3, v3, Lpne;->g:Lrne;

    if-eqz v3, :cond_a

    invoke-virtual {v3}, Lrne;->E()Ly41;

    move-result-object v3

    invoke-interface {v3}, Ly41;->Q0()Ljava/io/InputStream;
    ...
    invoke-virtual {v0}, Ltsb;->l()Ljava/lang/String;

    move-result-object v1

    iget-object v6, p0, Lnz0;->b:Lpc5;

    iget-object v7, p0, Lnz0;->d:Ljava/lang/String;

    invoke-virtual {v6, v7, v1}, Lpc5;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_9
    :try_start_10
    invoke-static {v4, v6}, Lhbb;->b(Ljava/io/File;Ljava/io/File;)V

    invoke-virtual {p0, v6, v1}, Lnz0;->e(Ljava/io/File;Ljava/lang/String;)V

    new-instance v2, Libb;

    invoke-direct {v2, v6, v1}, Libb;-><init>(Ljava/io/File;Ljava/lang/String;)V
    :try_end_10
    .catchall {:try_start_10 .. :try_end_10} :catchall_4

    invoke-static {v0}, Lhbb;->a(Ljava/io/Closeable;)V

    invoke-static {v3}, Lhbb;->a(Ljava/io/Closeable;)V

    invoke-static {v5}, Lhbb;->a(Ljava/io/Closeable;)V

    invoke-static {v4}, Lhbb;->c(Ljava/io/File;)V
    ...
    :goto_a
    :try_start_12
    invoke-static {v2}, Lhbb;->c(Ljava/io/File;)V

    iget-object p0, p0, Lnz0;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-interface {v6, v0}, Lebb;->onFailed(Ljava/lang/Throwable;)V
    ...
    invoke-static {v1}, Lhbb;->a(Ljava/io/Closeable;)V
