...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Lxt1;)V
    .locals 1
    ...
    iput-object p1, p0, Ltpb;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Ltpb;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    new-instance p1, Lppb;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lppb;-><init>(Ltpb;I)V

    new-instance p2, Lifh;

    invoke-direct {p2, p1}, Lifh;-><init>(Laf7;)V

    iput-object p2, p0, Ltpb;->c:Lifh;
    ...
    iput-object v0, p0, Ltpb;->d:Lifh;

    iget-object p1, p3, Lxt1;->r:Lv88;

    iget-boolean p1, p1, Lv88;->x:Z

    iput-boolean p1, p0, Ltpb;->e:Z

    iput-boolean p2, p0, Ltpb;->f:Z
...
# virtual methods
.method public final a(Lorg/webrtc/VideoCodecInfo;)Lspb;
    .locals 5
    ...
    :cond_1
    iget-boolean v1, p0, Ltpb;->f:Z

    if-nez v1, :cond_2

    iget-object v1, p0, Ltpb;->d:Lifh;
    ...
    invoke-direct {v0, v1, p1, p0}, Lspb;-><init>(Lorg/webrtc/VideoDecoder;Lorg/webrtc/VideoCodecInfo;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V

    return-object v0

    :cond_2
    :try_start_0
    iget-object v1, p0, Ltpb;->c:Lifh;
    ...
    iget-object v2, p0, Ltpb;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
...
.method public final createDecoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoDecoder;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Ltpb;->a(Lorg/webrtc/VideoCodecInfo;)Lspb;
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    :try_start_0
    invoke-virtual {p0}, Ltpb;->b()[Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-interface {p0, v1, v2, v0}, Ly3e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
