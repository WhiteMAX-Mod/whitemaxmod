...
# direct methods
.method public synthetic constructor <init>(Ly3e;)V
    .locals 0

    iput-object p1, p0, Lb72;->a:Ly3e;
...
# virtual methods
.method public a(Lorg/json/JSONObject;)La72;
    .locals 12
    ...
    invoke-static {v9}, Lyt1;->a(Ljava/lang/String;)Lyt1;

    move-result-object v8

    new-instance v9, Lh62;

    invoke-direct {v9, v8, v10, v11}, Lh62;-><init>(Lyt1;J)V

    invoke-static {v7}, Lkql;->i(Lorg/json/JSONObject;)Lhi1;

    move-result-object v7

    new-instance v8, Lg62;

    invoke-direct {v8, v9, v7}, Lg62;-><init>(Lh62;Lhi1;)V
    ...
    invoke-direct {v2, p1, v4, v0}, La72;-><init>(ILjava/util/ArrayList;Z)V
    :try_end_0
...
.method public onCameraError(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {p0, p2, p1, v0}, Ly3e;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
