...
.method public constructor <init>(Li18;Lzo;Luo;IZ)V
    .locals 0
...
.method public a()Lu80;
    ...
    invoke-direct/range {v1 .. v6}, Lu80;-><init>(ILandroid/media/AudioManager$OnAudioFocusChangeListener;Landroid/os/Handler;Lp70;Z)V
...
.method public e(Ljava/io/BufferedOutputStream;)V
    ...
    invoke-virtual {v3, p0, v2, v1, v0}, Lmp4;->b(Ljava/io/OutputStream;Lop;Luo;I)V

    invoke-virtual {p0}, Ljava/util/zip/DeflaterOutputStream;->finish()V

    invoke-virtual {p0}, Lf18;->l()V

    return-void

    :cond_0
    invoke-virtual {v3, p1, v2, v1, v0}, Lmp4;->b(Ljava/io/OutputStream;Lop;Luo;I)V
