...
.method public static a(Landroid/content/Context;Led6;)Ljava/util/Collection;
    .locals 21
    ...
    invoke-direct {v9, v10}, Lvi9;-><init>(Ljava/lang/Object;)V

    new-instance v11, Lvi9;

    invoke-direct {v11, v10}, Lvi9;-><init>(Ljava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v9, v10, v11}, Lvi9;->b(J)Ljava/lang/Object;
    ...
    invoke-static {v2}, Llvb;->J([Ljava/lang/Object;)Lpw;
    ...
    :goto_2
    invoke-virtual {v9, v10, v11, v5}, Lvi9;->f(JLjava/lang/Object;)V

    invoke-interface {v3, v4}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v10

    iput-wide v10, v15, Lytc;->e:J

    invoke-interface {v3, v7}, Landroid/database/Cursor;->getString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v5, v15, Lytc;->a:Ljava/lang/String;

    if-nez v5, :cond_3

    iput-object v2, v15, Lytc;->a:Ljava/lang/String;
    ...
    :cond_4
    iput-object v2, v15, Lytc;->c:Ljava/lang/String;

    iget v2, v15, Lytc;->d:I
    :try_end_2
    ...
    :try_start_3
    invoke-virtual {v2, v10, v11}, Lvi9;->b(J)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v10, v11, v5}, Lvi9;->f(JLjava/lang/Object;)V
    ...
    invoke-direct {v5}, Lytc;-><init>()V

    invoke-interface {v3, v6}, Landroid/database/Cursor;->getInt(I)I

    move-result v10

    iput v10, v5, Lytc;->d:I
    ...
    invoke-static {v11}, Lch3;->s(Ljava/lang/CharSequence;)Z

    move-result v0

    if-eqz v0, :cond_8

    iput-object v11, v5, Lytc;->a:Ljava/lang/String;
    ...
    iput-object v0, v5, Lytc;->a:Ljava/lang/String;
    ...
    iput-object v10, v5, Lytc;->a:Ljava/lang/String;
    ...
    iput-object v11, v5, Lytc;->b:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v1}, Lvi9;->b(J)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0, v1, v10}, Lvi9;->f(JLjava/lang/Object;)V
    :try_end_3
    ...
    invoke-virtual {v2, v4}, Lvi9;->e(I)J

    move-result-wide v5

    invoke-virtual {v2, v5, v6}, Lvi9;->b(J)Ljava/lang/Object;
    ...
    :cond_11
    iget-object v11, v10, Lytc;->b:Ljava/lang/String;

    if-eqz v11, :cond_10

    iget-object v12, v8, Lytc;->b:Ljava/lang/String;

    if-nez v12, :cond_10

    iget-object v12, v8, Lytc;->a:Ljava/lang/String;
    ...
    iget-object v7, v10, Lytc;->a:Ljava/lang/String;

    iput-object v7, v8, Lytc;->a:Ljava/lang/String;

    iget-object v7, v10, Lytc;->b:Ljava/lang/String;

    iput-object v7, v8, Lytc;->b:Ljava/lang/String;

    :cond_12
    if-eqz v8, :cond_13

    invoke-virtual {v0, v5, v6, v8}, Lvi9;->f(JLjava/lang/Object;)V
    ...
    :goto_e
    invoke-virtual {v9}, Lvi9;->i()I

    move-result v4

    if-ge v2, v4, :cond_1c

    invoke-virtual {v9, v2}, Lvi9;->e(I)J

    move-result-wide v4

    invoke-virtual {v9, v2}, Lvi9;->j(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Ljava/util/Set;

    invoke-virtual {v0, v4, v5}, Lvi9;->b(J)Ljava/lang/Object;
    ...
    invoke-static {v5, v4, v6}, Lgm0;->W(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-object v6, v7, Lqtc;->d:Ljava/lang/String;

    iget-object v8, v4, Lytc;->a:Ljava/lang/String;
    ...
    :goto_10
    iput-object v8, v7, Lqtc;->g:Ljava/lang/String;

    iget-object v8, v4, Lytc;->b:Ljava/lang/String;

    iput-object v8, v7, Lqtc;->h:Ljava/lang/String;

    iget-wide v10, v4, Lytc;->e:J

    iput-wide v10, v7, Lqtc;->b:J

    iput v3, v7, Lqtc;->j:I

    iget-object v8, v4, Lytc;->c:Ljava/lang/String;

    iput-object v8, v7, Lqtc;->i:Ljava/lang/String;
    ...
    :cond_19
    invoke-virtual {v8}, Lqtc;->b()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v7}, Lqtc;->b()Ljava/lang/String;
...
.method public static b(Landroid/content/ContentResolver;Landroid/net/Uri;Led6;)Ljava/lang/String;
    .locals 5
    ...
    invoke-static {p1, v1}, Lgm0;->q(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :try_start_4
    invoke-static {p1}, Loxl;->g(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-virtual {p2, v2}, Lt1c;->a(Ljava/lang/Throwable;)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_3

    invoke-static {v1}, Loxl;->d(Ljava/io/InputStream;)V
...
.method public static c(Landroid/content/Context;Ljava/util/List;Led6;)Landroid/util/SparseArray;
    .locals 9
    ...
    invoke-static {p0, p1}, Lgm0;->q(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v5, Liyg;->a:[Ljava/lang/String;
    ...
    invoke-static {v3, v5, p2}, Liyg;->b(Landroid/content/ContentResolver;Landroid/net/Uri;Led6;)Ljava/lang/String;
...
.method public static d(Lfka;)Ljyg;
    .locals 15
    ...
    sget-object v13, Lfjf;->a:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    :try_start_4
    invoke-static {v2, v1, v12}, Lgm0;->V(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v14}, Lone/me/android/initialization/AccountInitializer;->d()Lqzb;

    move-result-object v14

    invoke-virtual {v14}, Lqzb;->i()Lhgh;

    move-result-object v14

    invoke-virtual {v14}, Lhgh;->g()Liv4;

    move-result-object v14

    invoke-virtual {v14, v6, v12}, Liv4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    ...
    :try_start_5
    invoke-static {v2, v0, v14}, Lgm0;->V(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_7
    :try_start_7
    invoke-static {p0}, Lvm9;->c(Lfka;)Lcy8;
    ...
    :cond_c
    :try_start_b
    invoke-static {p0}, Lxs3;->b(Lfka;)Lys3;
    ...
    :try_start_f
    invoke-static {p0}, Lch3;->O(Lfka;)Ljava/lang/Byte;
    ...
    invoke-virtual {v0, v1, p0, v2, v6}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    sget-object v6, Lsyg;->b:Lsyg;

    :cond_22
    invoke-direct {p0, v6, v10, v11}, Ljyg;-><init>(Lsyg;Lcy8;Lys3;)V

    return-object p0
.end method

.method public static e(Ljava/lang/String;)Ljb9;
    .locals 3
    ...
    :pswitch_0
    sget-object p0, Ljb9;->a:Ljb9;

    return-object p0

    :pswitch_1
    sget-object p0, Ljb9;->d:Ljb9;

    return-object p0

    :pswitch_2
    sget-object p0, Ljb9;->c:Ljb9;
