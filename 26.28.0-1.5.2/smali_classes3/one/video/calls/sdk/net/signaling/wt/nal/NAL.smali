...
# instance fields
.field private final client$delegate:Lny8;
...
.method public constructor <init>(Lone/video/calls/sdk/net/signaling/wt/nal/NALHostnameVerifier;Ljava/lang/Long;Ljavax/net/ssl/X509TrustManager;Lone/video/calls/sdk/net/signaling/wt/nal/NALLog;)V
    ...
    new-instance p4, Lwre;

    const/16 v0, 0x18

    invoke-direct {p4, p1, p2, p3, v0}, Lwre;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lifh;

    invoke-direct {p1, p4}, Lifh;-><init>(Laf7;)V

    iput-object p1, p0, Lone/video/calls/sdk/net/signaling/wt/nal/NAL;->client$delegate:Lny8;
...
.method public static synthetic a(Lone/video/calls/sdk/net/signaling/wt/nal/NALHostnameVerifier;Ljava/lang/Long;Ljavax/net/ssl/X509TrustManager;)Ldek;
    .locals 0

    invoke-static {p0, p1, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/NAL;->client_delegate$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/NALHostnameVerifier;Ljava/lang/Long;Ljavax/net/ssl/X509TrustManager;)Ldek;
...
.method private static final client_delegate$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/NALHostnameVerifier;Ljava/lang/Long;Ljavax/net/ssl/X509TrustManager;)Ldek;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Ldek;-><init>(Ljava/time/Duration;ZLjavax/net/ssl/X509TrustManager;Lx5k;Lku8;)V

    return-object v0
.end method

.method private final getClient()Ldek;
    .locals 0

    iget-object p0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/NAL;->client$delegate:Lny8;
...
.method public final createSocket(Ljava/lang/String;Ljava/lang/String;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket;
    ...
    invoke-direct {p0}, Lone/video/calls/sdk/net/signaling/wt/nal/NAL;->getClient()Ldek;
    ...
    invoke-direct/range {v0 .. v6}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;-><init>(Ljava/lang/String;Ljava/lang/String;Lone/video/calls/sdk/net/signaling/wt/nal/NALLog;Ldek;Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$CompressorDecompressor;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
