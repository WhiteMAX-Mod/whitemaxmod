...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "handler",
        "handleAsync",
        "(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lqf7;)V",
        "message",
        "send",
        "(Ljava/lang/String;)V",
        "",
...
# instance fields
.field private final client:Ldek;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lone/video/calls/sdk/net/signaling/wt/nal/NALLog;Ldek;Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$CompressorDecompressor;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0
    ...
    iput-object p4, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->client:Ldek;
    ...
    invoke-direct {p0, p2, p3, p6, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lqf7;)V

    return-void
.end method

.method private static final _init_$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lsbi;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lsbi;
    .locals 0
...
.method public static synthetic a(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;)V
    .locals 0

    invoke-static {p0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession$lambda$2(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;)V

    return-void
.end method

.method public static final synthetic access$sendStreamData(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->sendStreamData(Lqdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
...
.method public static synthetic c(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lqf7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lqf7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    return-void
.end method

.method private final configureSession(Lpdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 2
    ...
    invoke-direct {v0, p0, v1, p2}, Lfw2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iput-object v0, p2, Lxdk;->j:Ljava/util/function/BiConsumer;

    new-instance p2, Lutj;

    const/4 v0, 0x0

    invoke-direct {p2, p0, v0}, Lutj;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;I)V

    check-cast p1, Lxdk;

    iput-object p2, p1, Lxdk;->i:Ljava/util/function/Consumer;

    new-instance p2, Lutj;

    invoke-direct {p2, p0, v1}, Lutj;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;I)V

    iput-object p2, p1, Lxdk;->h:Ljava/util/function/Consumer;
...
.method private static final configureSession$lambda$1(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;)V
    .locals 1
...
.method private static final configureSession$lambda$2(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;)V
    .locals 1
...
.method private final connect(Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    ...
    iget-object v3, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->client:Ldek;

    invoke-direct {v1, v0, v2, v3}, Lsdk;-><init>(Ljava/net/URI;Ljava/lang/String;Ldek;)V

    invoke-virtual {v1, v0}, Lsdk;->a(Ljava/net/URI;)Lxdk;

    move-result-object v0

    iput-object v0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->session:Lpdk;

    invoke-direct {p0, v0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession(Lpdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    invoke-direct {p0, v0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->openSession(Lpdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    :try_end_0
...
.method public static synthetic d(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lsbi;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lsbi;
    .locals 0

    invoke-static {p0, p1, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->_init_$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lsbi;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)Lsbi;
...
.method public static synthetic e(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;)V
    .locals 0

    invoke-static {p0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession$lambda$1(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Lqdk;)V

    return-void
.end method

.method private final handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lqf7;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct/range {v1 .. v6}, Lh82;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lqf7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
...
.method private static final handleAsync$lambda$0(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Lqf7;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 4
    ...
    :try_start_0
    invoke-interface {p2, p3, p4}, Lqf7;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final openSession(Lpdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 9
    ...
    invoke-virtual {v0, v1, v2, v3}, Lxdk;->c(Lwdk;Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Z

    iget-object v2, v0, Lxdk;->d:Lsdk;

    iget-object v3, v2, Lsdk;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, v2, Lsdk;->c:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v0, Lxdk;->c:J
    ...
    invoke-direct {v4, v5, v0}, Lr5k;-><init>(ILjava/lang/Object;)V
    ...
    :cond_0
    :goto_0
    iget-object v0, v2, Lsdk;->b:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v2, v0, Lxdk;->e:Lwdk;

    sget-object v3, Lwdk;->a:Lwdk;
    ...
    iget-object v1, v0, Lxdk;->a:Lx70;

    iget-object v1, v1, Lx70;->b:Ljava/lang/Object;

    check-cast v1, Lz7k;

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lz7k;->b(Z)Lpak;

    move-result-object v1

    iget-object v2, v1, Lpak;->e:Luak;

    new-instance v3, Lmek;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v1, v3, Lmek;->a:Lpak;

    iput-object v2, v3, Lmek;->b:Ljava/io/InputStream;

    iget-object v1, v1, Lpak;->f:Labk;
    ...
    invoke-static {v5, v6, v4}, Lti8;->c(JLjava/nio/ByteBuffer;)I
    ...
    invoke-static {v4, v5, v2}, Lti8;->c(JLjava/nio/ByteBuffer;)I
    ...
    :cond_2
    iget-object v1, v0, Lxdk;->k:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, v0, Lxdk;->l:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v0, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    new-instance v0, Lvdk;

    invoke-direct {v0, v6}, Lvdk;-><init>(I)V

    iput-object v3, v0, Lvdk;->b:Lhek;
    ...
    invoke-direct {p0, v2, v0, p2, v1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Lqf7;)V

    invoke-direct {p0, p1, v0, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->readStreamData(Lpdk;Lqdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    ...
    :goto_3
    iget-object p1, v2, Lsdk;->b:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private final readStreamData(Lpdk;Lqdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 6
    ...
    :try_start_0
    invoke-interface {p2}, Lqdk;->b()Ljava/io/InputStream;
    ...
    :goto_0
    :try_start_1
    invoke-static {p2}, Lti8;->d(Ljava/io/InputStream;)I
...
.method private final sendStreamData(Lqdk;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    :try_start_4
    invoke-interface {p1}, Lqdk;->a()Ljava/io/OutputStream;
    ...
    sget-object v5, Lpt2;->a:Ljava/nio/charset/Charset;
...
.method public final close(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->session:Lpdk;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lxdk;->a(JLjava/lang/String;)V
