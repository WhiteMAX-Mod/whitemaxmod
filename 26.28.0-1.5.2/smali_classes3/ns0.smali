...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lns0;->b:Lks9;

    new-instance v0, Lqo7;

    const/16 v3, 0x13

    invoke-direct {v0, v3, p0}, Lqo7;-><init>(ILjava/lang/Object;)V

    invoke-static {v2, v0}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object v0

    iput-object v0, p0, Lns0;->c:Lny8;
...
.method private final getAgslDelegate()Lxe;
    .locals 0

    iget-object p0, p0, Lns0;->c:Lny8;
...
# virtual methods
.method public abstract a(Lwe;FF)V
.end method

.method public final b()V
    .locals 1

    iget-boolean v0, p0, Lns0;->e:Z
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lns0;->e:Z

    iget-boolean v1, p0, Lns0;->a:Z

    if-eqz v1, :cond_6

    invoke-direct {p0}, Lns0;->getAgslDelegate()Lxe;

    move-result-object p0

    iget-object v1, p0, Lxe;->a:Lks9;

    iget-object v2, p0, Lxe;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iget-object v2, v1, Lks9;->b:Ljava/lang/Object;

    check-cast v2, Lns0;

    invoke-virtual {v2}, Lns0;->getSpec()Lqbi;
    ...
    sget-object v3, Lxe;->g:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v2}, Lve;->b(Ljava/lang/Object;)Landroid/graphics/RuntimeShader;
    ...
    :goto_0
    iput-object v2, p0, Lxe;->b:Landroid/graphics/RuntimeShader;

    if-nez v2, :cond_8

    sget-object v2, Lrwf;->a:Lny8;

    iget-object v1, v1, Lks9;->b:Ljava/lang/Object;

    check-cast v1, Lns0;

    invoke-virtual {v1}, Lns0;->getSpec()Lqbi;
    ...
    invoke-virtual {v1}, Lzpe;->x()Ljava/util/List;
    ...
    invoke-static {v8, v5, v6, v3, v7}, Lnbh;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, v4}, Lchf;-><init>(I)V
    ...
    invoke-virtual {v1, v5, v3}, Llge;->c(Ljava/lang/String;Lcf7;)Ljava/lang/String;
    ...
    invoke-direct {v1, v4}, Lchf;-><init>(I)V
    ...
    invoke-virtual {v0, v3, v1}, Llge;->c(Ljava/lang/String;Lcf7;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lve;->c(Ljava/lang/String;)Landroid/graphics/RuntimeShader;

    move-result-object v0

    iput-object v0, p0, Lxe;->b:Landroid/graphics/RuntimeShader;

    return-void

    :cond_6
    iget-object v1, p0, Lns0;->d:Lgn7;
    ...
    iget-object v3, p0, Lns0;->b:Lks9;

    invoke-direct {v1, v2, v3}, Lgn7;-><init>(Landroid/content/Context;Lks9;)V

    iput-object v1, p0, Lns0;->d:Lgn7;
    ...
    invoke-virtual {p0, v0}, Lgn7;->setStarted(Z)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lxe;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iput-object v1, p0, Lxe;->b:Landroid/graphics/RuntimeShader;

    sget-object v1, Lxe;->g:Ljava/util/LinkedHashMap;

    iget-object p0, p0, Lxe;->a:Lks9;

    iget-object p0, p0, Lks9;->b:Ljava/lang/Object;

    check-cast p0, Lns0;

    invoke-virtual {p0}, Lns0;->getSpec()Lqbi;
...
.method public abstract getSpec()Lqbi;
.end method
...
.method public final onDrawForeground(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v1, Lxe;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_3
    iget-object v4, v0, Lxe;->e:[F

    iget-object v5, v0, Lxe;->c:Lny8;
    ...
    invoke-static {v1, v4}, Lve;->B(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, v0, Lxe;->f:Lny8;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lns0;->a(Lwe;FF)V
