...
.method public static a(Lhfk;)I
    .locals 2

    sget-object v0, Lsx5;->a:[I
...
.method public static e(Lr17;Ljava/lang/String;Lm8b;Ljava/util/LinkedHashSet;Ljava/util/Set;)Lo67;
    .locals 8
    ...
    iget-object p1, p0, Lr17;->b:Ljava/lang/CharSequence;
    ...
    iget-object p3, p0, Lr17;->j:Ljava/util/LinkedHashSet;
    ...
    iget-object p1, p0, Lr17;->e:Ljava/util/Set;
    ...
    iget-object p4, p0, Lr17;->d:Ljava/util/Set;

    :cond_3
    move-object v5, p4

    iget-object v6, p0, Lr17;->i:Ljava/util/Set;

    new-instance v0, Lo67;

    const/4 v7, 0x4

    invoke-direct/range {v0 .. v7}, Lo67;-><init>(Ljava/lang/String;Ljava/lang/String;Lm8b;Ljava/util/LinkedHashSet;Ljava/util/Set;Ljava/util/Set;I)V

    return-object v0
.end method

.method public static synthetic f(Lcr0;Lr17;Lm8b;Ljava/util/LinkedHashSet;I)Lo67;
    .locals 2
    ...
    invoke-static {p1, v1, p2, p3, v1}, Lcr0;->e(Lr17;Ljava/lang/String;Lm8b;Ljava/util/LinkedHashSet;Ljava/util/Set;)Lo67;
...
# virtual methods
.method public b(Lmfk;)Ljava/security/Signature;
    .locals 8
    ...
    :try_start_0
    invoke-interface {p0, p1}, Lcs7;->c(I)Ljava/lang/String;
...
.method public c([B[B)[B
    ...
    iget-short v0, p0, Loj6;->e:S

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v1, Loj6;->u:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0, p2, v2, v1, v0}, Loj6;->a([BLjava/lang/String;[BS)[B
    ...
    invoke-static {p2, v0}, Lzo5;->h(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, v0}, Lc0a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-static {p1}, Lore;->q(Ljava/lang/String;)V

    return-object p0
.end method

.method public g(Lo67;Lnq4;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-direct {v1, p0, p2}, Lbr0;-><init>(Lcr0;Lnq4;)V
    ...
    invoke-static {p2, p1, v0, v2, v1}, Lcqk;->H(Lpvb;Lhih;Ljava/lang/String;Led6;Lnq4;)Ljava/lang/Object;
    ...
    iget-wide v6, p2, Lp67;->d:J

    iget-object p1, p2, Lp67;->c:Lvy2;

    iput v3, v1, Lbr0;->f:I

    invoke-virtual {p0, v6, v7, p1, v1}, Lsy4;->p(JLvy2;Lnq4;)Ljava/lang/Object;
