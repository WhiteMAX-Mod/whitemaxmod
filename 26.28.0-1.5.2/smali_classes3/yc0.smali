...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lyc0;->h:Landroid/graphics/Paint;

    new-instance v6, Landroid/graphics/Paint;

    invoke-direct {v6, v3}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object v6, p0, Lyc0;->i:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lyc0;->j:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lyc0;->k:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Path;

    invoke-direct {v3}, Landroid/graphics/Path;-><init>()V

    iput-object v3, p0, Lyc0;->l:Landroid/graphics/Path;
    ...
    iput-object v1, p0, Lyc0;->m:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, p1}, Lyc0;->onThemeChanged(Lkbc;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lyc0;->f:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lyc0;->l:Landroid/graphics/Path;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lyc0;->l:Landroid/graphics/Path;
    ...
    iget-object v5, p0, Lyc0;->h:Landroid/graphics/Paint;

    const/high16 v6, 0x40000000    # 2.0f

    if-nez v2, :cond_3

    iget-boolean v2, p0, Lyc0;->p:Z
    ...
    invoke-static {v4, v7, v8, v2}, Lr5a;->f(FFII)I
    ...
    iget-object v9, p0, Lyc0;->i:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lyc0;->k:Landroid/graphics/Paint;

    invoke-virtual {p1, v8, v0, v1, v3}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object p0, p0, Lyc0;->j:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-virtual {p0}, Lyc0;->getPeaksCount()I
    ...
    iget-object p0, p1, Lphf;->c:Ljava/lang/Object;
    ...
    iget-object p0, v1, Lvc0;->n:Ljava/lang/Integer;
    ...
    iget-object p0, v1, Lvc0;->l:Ljava/lang/Float;

    invoke-static {p0, v3}, Lcqk;->c(Ljava/lang/Float;F)Z

    move-result p0

    if-eqz p0, :cond_1

    iget-object p0, v1, Lvc0;->m:Ljava/lang/Float;

    invoke-static {p0, v4}, Lcqk;->c(Ljava/lang/Float;F)Z
...
.method public final onThemeChanged(Lkbc;)V
    ...
    :goto_0
    iget-object v1, p0, Lyc0;->h:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setColor(I)V

    iget-object v0, p0, Lyc0;->j:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lyc0;->k:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lyc0;->i:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lyc0;->b(Landroid/view/MotionEvent;)F

    move-result v0

    iput v0, p0, Lyc0;->e:F

    iget-object v0, p0, Lyc0;->q:Lwc0;
    ...
    iget-object v1, v0, Lphf;->b:Ljava/lang/Object;

    check-cast v1, Lyc0;

    invoke-virtual {v1}, Lyc0;->getDuration()J
    ...
    invoke-static {v3, v4}, Lmxl;->b(J)Ljava/lang/String;

    move-result-object p1

    iget-object v0, v0, Lphf;->c:Ljava/lang/Object;

    check-cast v0, Lycj;

    iget-object v0, v0, Lycj;->j:Landroid/widget/TextView;
    ...
    invoke-virtual {v0}, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->I1()Ljce;
    ...
    invoke-interface {v0, v3, v4}, Ld89;->seekTo(J)V
...
.method public final setLinesColor(I)V
    ...
    iget-object v0, p0, Lyc0;->h:Landroid/graphics/Paint;
...
.method public final setListener(Lwc0;)V
    .locals 0

    iput-object p1, p0, Lyc0;->q:Lwc0;
...
.method public final setShiftOffset(J)V
    ...
    iget-object p0, p0, Lyc0;->m:Landroid/animation/ValueAnimator;
