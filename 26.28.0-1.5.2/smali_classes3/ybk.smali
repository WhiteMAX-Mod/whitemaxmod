...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Leck;Lfck;Ly5k;Lgak;Llu8;)V
    .locals 2
    ...
    iput-wide v0, p0, Lybk;->h:J

    iput-object p1, p0, Lybk;->a:Ljava/time/Clock;

    iput-object p2, p0, Lybk;->b:Leck;

    iput-object p3, p0, Lybk;->c:Lfck;

    iput-object p4, p0, Lybk;->d:Ly5k;

    iput-object p5, p0, Lybk;->e:Lgak;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Lybk;->g:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lybk;->f:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final declared-synchronized a()V
    ...
    iget-object v1, p0, Lybk;->d:Ly5k;

    invoke-virtual {v1, v0}, Ly5k;->b(Ljava/util/List;)V

    iget-object v0, p0, Lybk;->g:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lybk;->i:Ljava/time/Instant;

    iput-object v0, p0, Lybk;->j:Ljava/time/Instant;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lybk;->k:Z
    :try_end_0
...
.method public final b()V
    ...
    iget-object v1, p0, Lybk;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Lybk;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v5, v6}, Llak;-><init>(I)V
    ...
    invoke-direct {v5, p0, v6, v0}, Lbaf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-direct {v5, v7}, Llak;-><init>(I)V
    ...
    invoke-direct {v7, v8}, Llak;-><init>(I)V
    ...
    iget-object v7, p0, Lybk;->g:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, v7, p0}, Lt81;-><init>(ILjava/lang/Object;)V

    invoke-interface {v2, v5}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    iget-object v2, p0, Lybk;->e:Lgak;

    invoke-virtual {v2}, Lgak;->run()V

    iget-object v2, p0, Lybk;->d:Ly5k;
    ...
    iget-wide v9, v2, Ly5k;->a:J

    sub-long/2addr v9, v7

    iput-wide v9, v2, Ly5k;->a:J

    iget-object v9, v2, Ly5k;->c:Lhak;

    invoke-virtual {v9}, Lhak;->h()V
    ...
    invoke-direct {v7, v8}, Lps0;-><init>(I)V
    ...
    iget-object v5, v5, Lzbk;->a:Ljava/time/Instant;

    iget-object v7, v2, Ly5k;->e:Ljava/time/Instant;
    ...
    iput-object v5, v2, Ly5k;->e:Ljava/time/Instant;

    iget-wide v7, v2, Ly5k;->b:J

    const-wide/16 v9, 0x2

    div-long/2addr v7, v9

    iput-wide v7, v2, Ly5k;->b:J
    ...
    iput-wide v9, v2, Ly5k;->b:J

    :cond_3
    iget-wide v7, v2, Ly5k;->b:J

    iput-wide v7, v2, Ly5k;->d:J
    ...
    invoke-direct {v2, p0, v6}, Lxbk;-><init>(Lybk;I)V
    ...
    invoke-direct {v2, v5}, Llak;-><init>(I)V
    ...
    invoke-direct {v2, p0, v6}, Lwbk;-><init>(Lybk;I)V
    ...
    invoke-direct {v2, v5}, Llbk;-><init>(I)V
    ...
    invoke-direct {v2, v5}, Lhbk;-><init>(I)V
