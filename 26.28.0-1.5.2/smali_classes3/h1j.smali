...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lfx5;)V
    .locals 5

    invoke-direct {p0}, Lpp5;-><init>()V

    iput-object p1, p0, Lh1j;->n:Landroid/util/Size;
    ...
    iput-object v0, p0, Lh1j;->o:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lh1j;->s:[F
    ...
    invoke-virtual {p0, p2}, Lpp5;->n(Lfx5;)Loh0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lh1j;->o:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lgm0;->Y(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lh1j;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lh1j;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lh1j;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lh1j;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lh1j;->p:Lxkg;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lxkg;->d:Ljava/lang/Object;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lgm0;->Y(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lxkg;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lxkg;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lh1j;->p:Lxkg;

    iput-object v0, p0, Lh1j;->v:Lpni;
...
.method public final v(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v0, v1}, Lpp5;->l(Landroid/view/Surface;)Lgi0;

    move-result-object v2

    sget-object v3, Lxg7;->j:Lgi0;

    invoke-virtual {v2, v3}, Lgi0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v0, v1}, Lpp5;->h(Landroid/view/Surface;)Lgi0;
    ...
    :cond_0
    iget-object v3, v0, Lpp5;->c:Ljava/lang/Object;
    ...
    :cond_1
    iget-object v3, v0, Lpp5;->b:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Lxg7;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v0, Lpp5;->d:Ljava/lang/Object;
    ...
    iget v11, v2, Lgi0;->b:I

    iget v12, v2, Lgi0;->c:I

    iget-object v9, v2, Lgi0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v0, Lh1j;->p:Lxkg;

    if-nez v2, :cond_2

    new-instance v2, Lxkg;

    iget-object v5, v0, Lh1j;->n:Landroid/util/Size;

    invoke-direct {v2, v5}, Lxkg;-><init>(Landroid/util/Size;)V

    iput-object v2, v0, Lh1j;->p:Lxkg;

    :cond_2
    move-object v10, v2

    iget-object v2, v0, Lh1j;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v0, Lh1j;->q:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v0, Lh1j;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v0, Lh1j;->r:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v0, Lh1j;->t:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Lxkg;->f:Ljava/lang/Object;
    ...
    iget v6, v10, Lxkg;->a:I

    iget v7, v10, Lxkg;->b:I
    ...
    iget-object v2, v10, Lxkg;->f:Ljava/lang/Object;
    ...
    iget-object v3, v10, Lxkg;->e:Ljava/lang/Object;

    check-cast v3, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Lxkg;->f:Ljava/lang/Object;
    ...
    iget-object v5, v10, Lxkg;->c:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lpp5;->j:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lpp5;->o(Landroid/opengl/EGLSurface;)V

    iput-object v1, v0, Lpp5;->j:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v3, Lxkg;->f:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lh1j;->v:Lpni;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v3, v3, Lxkg;->f:Ljava/lang/Object;
    ...
    iget-object v3, v0, Lh1j;->v:Lpni;

    if-eqz v3, :cond_8

    invoke-virtual {v3, v11}, Lpni;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    const/4 v3, 0x0

    iput-object v3, v0, Lh1j;->v:Lpni;
    ...
    :cond_9
    :goto_2
    iget-object v3, v0, Lpp5;->e:Ljava/lang/Object;
    ...
    iget-object v11, v0, Lh1j;->o:Ljava/lang/String;

    invoke-static {}, Landroid/opengl/EGL14;->eglGetError()I

    move-result v2

    invoke-static {v8}, Ltre;->M(I)V
    ...
    invoke-static {v8, v2, v3}, Lp0m;->c(IJ)Ljava/lang/String;
    ...
    :cond_a
    invoke-virtual {v0, v1, v4}, Lpp5;->s(Landroid/view/Surface;Z)V
