...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lpbk;->b:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lpbk;->c:Ljava/util/ArrayList;
...
.method public abstract d(Lz7k;Lc4h;)I
.end method
...
.method public final g(Ljava/nio/ByteBuffer;BILz4k;J)V
    .locals 24
    ...
    invoke-virtual {v4, v8}, Lz4k;->f([B)[B
    ...
    :goto_1
    invoke-virtual {v0, v2}, Lpbk;->l(B)V
    ...
    iget-short v6, v6, Lrbk;->g:S

    iget v13, v4, Lz4k;->m:I

    rem-int/2addr v13, v10

    if-eq v13, v6, :cond_6

    iget-object v6, v4, Lz4k;->e:[B

    if-nez v6, :cond_5

    invoke-virtual {v4, v9}, Lz4k;->a(Z)V

    :cond_5
    iput-boolean v8, v4, Lz4k;->n:Z

    :cond_6
    iget-boolean v6, v4, Lz4k;->n:Z

    if-eqz v6, :cond_7

    iget-object v6, v4, Lz4k;->g:[B

    goto :goto_5

    :cond_7
    iget-object v6, v4, Lz4k;->f:[B
    ...
    :try_start_0
    invoke-virtual {v4}, Lz4k;->k()Ljavax/crypto/Cipher;
    ...
    invoke-virtual {v4}, Lz4k;->j()Ljavax/crypto/spec/SecretKeySpec;
    ...
    invoke-virtual {v4}, Lz4k;->l()Ljavax/crypto/spec/SecretKeySpec;

    move-result-object v3

    invoke-virtual {v4}, Lz4k;->m()Ljavax/crypto/Cipher;
    ...
    iput-object v3, v0, Lpbk;->c:Ljava/util/ArrayList;
    ...
    new-instance v4, Lt8k;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v4, v1}, Lt8k;->i(Ljava/nio/ByteBuffer;)V
    ...
    :cond_c
    :goto_b
    invoke-static {v1}, Lti8;->h(Ljava/nio/ByteBuffer;)J

    move-result-wide v13

    iput-wide v13, v4, Lf5k;->a:J
    ...
    iput-wide v13, v4, Lf5k;->b:J

    :cond_d
    invoke-static {v1}, Lti8;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {v1}, Lo8k;->e(Ljava/nio/ByteBuffer;)I
    ...
    new-instance v4, Li8k;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v4, v1}, Li8k;->i(Ljava/nio/ByteBuffer;)V
    ...
    :goto_d
    iput-boolean v5, v4, Lv8k;->a:Z

    invoke-static {v1}, Lti8;->h(Ljava/nio/ByteBuffer;)J

    move-result-wide v13

    iput-wide v13, v4, Lv8k;->b:J
    ...
    new-instance v4, Lk5k;

    invoke-direct {v4, v10}, Lk5k;-><init>(I)V

    invoke-virtual {v4, v1}, Lk5k;->m(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v9}, Lh5k;-><init>(I)V
    ...
    :goto_f
    iput-boolean v5, v4, Ll5k;->b:Z

    invoke-static {v1}, Lti8;->h(Ljava/nio/ByteBuffer;)J

    move-result-wide v13

    iput-wide v13, v4, Ll5k;->a:J
    ...
    invoke-direct {v4, v9}, Lk5k;-><init>(I)V

    invoke-virtual {v4, v1}, Lk5k;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v5}, Lh5k;-><init>(I)V
    ...
    invoke-virtual {v4, v1}, Lg5k;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v5}, Lk5k;-><init>(I)V

    invoke-virtual {v4, v1}, Lk5k;->k(Ljava/nio/ByteBuffer;)V
    ...
    new-instance v4, Lr8k;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v4, v1}, Lr8k;->i(Ljava/nio/ByteBuffer;)V
    ...
    iput v12, v4, Le5k;->e:I

    iput-object v6, v4, Le5k;->f:Ljava/lang/String;

    invoke-virtual {v4, v1}, Le5k;->k(Ljava/nio/ByteBuffer;)V
    ...
    :cond_1a
    invoke-virtual {v0, v2}, Lpbk;->e(B)V
...
.method public final h(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lz4k;)V
    .locals 11
    ...
    iget-wide v4, p0, Lpbk;->b:J

    iget-boolean p3, p4, Lz4k;->n:Z

    if-eqz p3, :cond_0

    iget-object p3, p4, Lz4k;->g:[B

    goto :goto_0

    :cond_0
    iget-object p3, p4, Lz4k;->f:[B
    ...
    :try_start_0
    invoke-virtual {p4}, Lz4k;->k()Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p4}, Lz4k;->j()Ljavax/crypto/spec/SecretKeySpec;
    ...
    :pswitch_0
    invoke-virtual {p4}, Lz4k;->m()Ljavax/crypto/Cipher;

    move-result-object p3

    invoke-virtual {p4}, Lz4k;->l()Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-wide p2, p0, Lpbk;->b:J

    invoke-static {p2, p3}, Lpbk;->m(J)[B
    ...
    invoke-virtual {p4, v1}, Lz4k;->f([B)[B
...
.method public abstract i(Ljava/nio/ByteBuffer;Lz4k;JLku8;I)V
.end method

.method public abstract j(Lz4k;)[B
.end method
...
.method public final k(I)Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Lpbk;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v0, v3}, Lbo8;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-direct {v1, v2}, Lk8k;-><init>(I)V

    iget-object p0, p0, Lpbk;->c:Ljava/util/ArrayList;

    invoke-virtual {p0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, v0}, Lk8k;->d(Ljava/nio/ByteBuffer;)V
...
.method public abstract n()Lw4k;
.end method

.method public abstract o()Ly4k;
.end method

.method public p()Ljava/lang/Long;
    .locals 4

    iget-wide v0, p0, Lpbk;->b:J
...
.method public s()Z
    ...
    invoke-direct {v0, v1}, Llak;-><init>(I)V
