...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lugk;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lugk;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lbgc;->d(ILjava/lang/String;)I
    ...
    invoke-static {v2, p1}, Lbgc;->d(ILjava/lang/String;)I
    ...
    iput v2, p0, Lugk;->programId:I

    const-string v3, "glCreateProgram"

    invoke-static {v3}, Lbgc;->c(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lbgc;->c(Ljava/lang/String;)V
    ...
    iput v0, p0, Lugk;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Lbgc;->b(ILjava/lang/String;)V
    ...
    iput v1, p0, Lugk;->aTextureCoordLoc:I

    invoke-static {v1, p1}, Lbgc;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Lugk;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Lbgc;->b(ILjava/lang/String;)V
    ...
    iput v3, p0, Lugk;->texMatrixLoc:I
    ...
    iput v3, p0, Lugk;->textureLocation:I
    ...
    iput v2, p0, Lugk;->alphaLocation:I

    invoke-static {v3, p1}, Lbgc;->b(ILjava/lang/String;)V

    new-instance p1, Lffk;

    invoke-direct {p1, v0, v1}, Lffk;-><init>(II)V

    iput-object p1, p0, Lugk;->frame:Lffk;
...
.method public getTextureCoordLoc()I
    ...
    iget p0, p0, Lugk;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget p0, p0, Lugk;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lugk;->firstFreeTexture:I
    ...
    iget p1, p0, Lugk;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lugk;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lugk;->frame:Lffk;

    iget-object v0, v0, Lffk;->a:Lngk;

    invoke-interface {v0}, Lngk;->a()V

    iget p0, p0, Lugk;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lugk;->use()V

    iget-object v0, p0, Lugk;->frame:Lffk;

    iget-object v0, v0, Lffk;->a:Lngk;

    invoke-interface {v0}, Lngk;->b()V

    invoke-virtual {p0}, Lugk;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    iget v0, p0, Lugk;->programId:I

    invoke-static {v0, p1}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result p1

    iget-object p0, p0, Lugk;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lugk;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lugk;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Lugk;->firstFreeTexture:I

    iget-object v1, p0, Lugk;->mvpMat:[F
    ...
    iput-object v1, p0, Lugk;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lugk;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lugk;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lugk;->programId:I
    ...
    iget v1, p0, Lugk;->mvpMatrixLoc:I

    iget-object v2, p0, Lugk;->mvpMat:[F
    ...
    iget v2, p0, Lugk;->texMatrixLoc:I

    iget-object v4, p0, Lugk;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lbgc;->c(Ljava/lang/String;)V

    iget v0, p0, Lugk;->textureLocation:I

    invoke-virtual {p0}, Lugk;->getTarget()I

    move-result v1

    iget v2, p0, Lugk;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lugk;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lugk;->alphaLocation:I

    iget v1, p0, Lugk;->alpha:F
    ...
    iget-object v0, p0, Lugk;->customParams:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lugk;->customParams:Ljava/util/HashMap;
