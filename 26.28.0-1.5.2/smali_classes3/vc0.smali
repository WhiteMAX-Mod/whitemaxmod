...
.method public constructor <init>(Lny8;Lny8;Lny8;)V
    ...
    iput-object p1, p0, Lvc0;->a:Lny8;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lvc0;->d:Ljava/util/ArrayList;

    new-instance p1, Landroid/animation/IntEvaluator;

    invoke-direct {p1}, Landroid/animation/IntEvaluator;-><init>()V

    iput-object p1, p0, Lvc0;->e:Landroid/animation/IntEvaluator;

    new-instance p1, Landroid/animation/FloatEvaluator;

    invoke-direct {p1}, Landroid/animation/FloatEvaluator;-><init>()V

    iput-object p1, p0, Lvc0;->f:Landroid/animation/FloatEvaluator;
    ...
    iput-object p1, p0, Lvc0;->g:Ldq4;

    sget-object p1, Loc0;->a:Loc0;

    invoke-static {p1}, Lp90;->a(Ljava/lang/Object;)Lmjg;

    move-result-object p1

    iput-object p1, p0, Lvc0;->h:Lmjg;

    new-instance p2, Lr8e;

    invoke-direct {p2, p1}, Lr8e;-><init>(Lf9b;)V

    iput-object p2, p0, Lvc0;->i:Lr8e;
...
.method public final a()V
    ...
    :cond_0
    iget-object v4, v0, Lvc0;->n:Ljava/lang/Integer;
    ...
    :cond_1
    iget-object v6, v0, Lvc0;->k:Ljava/lang/Byte;
    ...
    iput-object v1, v0, Lvc0;->k:Ljava/lang/Byte;
    ...
    iget-object v8, v0, Lvc0;->f:Landroid/animation/FloatEvaluator;
    ...
    iput-object v6, v0, Lvc0;->k:Ljava/lang/Byte;

    invoke-virtual {v0, v5}, Lvc0;->b(B)F
    ...
    :cond_4
    iget-object v9, v0, Lvc0;->m:Ljava/lang/Float;
    ...
    iget-object v9, v0, Lvc0;->h:Lmjg;

    new-instance v10, Ljava/util/ArrayList;

    const/16 v11, 0xa

    invoke-static {v3, v11}, Lyw3;->W0(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v7, v1, v14}, Loc9;->u(FFF)F

    move-result v7

    iget v8, v12, Lsc0;->b:F

    iget-object v14, v0, Lvc0;->f:Landroid/animation/FloatEvaluator;
    ...
    :cond_a
    iget v7, v12, Lsc0;->a:F

    :goto_4
    iput v7, v12, Lsc0;->a:F
    ...
    invoke-direct {v0, v10}, Lqc0;-><init>(Ljava/util/ArrayList;)V

    invoke-virtual {v9}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    move-object/from16 v1, v17

    invoke-virtual {v9, v1, v0}, Lmjg;->j(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public final b(B)F
    ...
    iget-object v0, p0, Lvc0;->l:Ljava/lang/Float;
    ...
    iget-object p0, p0, Lvc0;->m:Ljava/lang/Float;
...
.method public final c(I[B)[B
    ...
    iget-object v6, p0, Lvc0;->e:Landroid/animation/IntEvaluator;
