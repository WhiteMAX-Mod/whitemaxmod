...
.method public constructor <init>(Lflf;)V
    ...
    iget-object v0, p1, Lflf;->i:Ljava/lang/String;

    iput-object v0, p0, Lglf;->l:Ljava/lang/String;

    iget-object v0, p1, Lflf;->j:Ljava/util/List;

    iput-object v0, p0, Lglf;->m:Ljava/util/List;

    iget-object v0, p1, Lflf;->h:Ljava/util/List;

    iput-object v0, p0, Lglf;->n:Ljava/util/List;

    iget-boolean p1, p1, Lflf;->k:Z

    iput-boolean p1, p0, Lglf;->o:Z
...
.method public C()Lrfa;
    ...
    :cond_4
    iget-object v2, p0, Lglf;->l:Ljava/lang/String;
    ...
    :cond_7
    iget-object p0, p0, Lglf;->m:Ljava/util/List;
...
.method public final G(Lrt2;JLjava/lang/String;)J
    ...
    invoke-super/range {p0 .. p4}, Lilf;->G(Lrt2;JLjava/lang/String;)J
    ...
    invoke-virtual {v2, p2, p3}, Lqfa;->l(J)Lsfa;
    ...
    :cond_0
    iget-object v3, p0, Lglf;->n:Ljava/util/List;
    ...
    invoke-virtual {v3, v11}, Lc46;->h(I)Le70;

    move-result-object v3

    iget-object v9, v3, Le70;->t:Ljava/lang/String;

    instance-of v3, v4, Lq50;
    ...
    invoke-virtual/range {v3 .. v9}, Lcq6;->c(Lt2;JJLjava/lang/String;)V
