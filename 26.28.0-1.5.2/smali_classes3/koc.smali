...
# direct methods
.method public constructor <init>(Lioc;Lfi1;Lxt1;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V
    .locals 0
    ...
    iput-object p1, p0, Lkoc;->a:Lioc;

    iput-object p2, p0, Lkoc;->b:Lfi1;

    iput-object p4, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-direct {p2, p3, p4, p3, p4}, Lbq9;-><init>(DD)V

    const/4 p3, 0x0

    const/4 p4, 0x1

    invoke-direct {p1, p4, p2, p3}, Lajk;-><init>(ILbq9;Z)V

    iput-object p1, p0, Lkoc;->g:Lajk;

    iput-boolean p4, p0, Lkoc;->h:Z

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lkoc;->i:Ljava/lang/Object;
...
.method public final a()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lkoc;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_0
    iget-object v0, p0, Lkoc;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_3
    iget-object v0, p0, Lkoc;->g:Lajk;

    iget v3, v0, Lajk;->a:I

    sget-object v4, Ljoc;->$EnumSwitchMapping$0:[I
    ...
    :cond_4
    iget-boolean v0, v0, Lajk;->c:Z

    iget-object v3, p0, Lkoc;->a:Lioc;

    if-eqz v0, :cond_7

    iget-object v0, v3, Lioc;->a:Lxt1;

    iget-object v0, v0, Lxt1;->r:Lv88;

    iget-object v0, v0, Lv88;->E:Lfh6;

    sget-object v4, Lfh6;->b:Lfh6;

    if-ne v0, v4, :cond_5

    iget-object v0, v3, Lioc;->c:Ldue;

    invoke-virtual {v0}, Ldue;->w()Lzvh;
    ...
    invoke-static {v0, v3}, Lkoc;->b([Lorg/webrtc/VideoCodecInfo;Ljava/lang/String;)Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lkoc;->a:Lioc;

    invoke-virtual {v0}, Lioc;->a()[Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_7
    invoke-virtual {v3}, Lioc;->a()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v3, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    const-string v4, "PatchedVideoEncoderFactoryCodecSelector"

    const-string v5, "Software VP8 encoder not found"

    invoke-interface {v3, v4, v5}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V

    :cond_8
    :goto_3
    iget-object v3, p0, Lkoc;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_d
    iget-object v5, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-static {v6, v4, v7, v3, v8}, Lnbh;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lkoc;->i:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-boolean v6, p0, Lkoc;->h:Z
    ...
    :cond_e
    iput-boolean v2, p0, Lkoc;->h:Z

    iget-object v6, p0, Lkoc;->g:Lajk;
    :try_end_0
    ...
    iget-object v5, p0, Lkoc;->b:Lfi1;

    new-instance v6, Lorg/json/JSONObject;

    invoke-direct {v6}, Lorg/json/JSONObject;-><init>()V

    iget-object v7, p0, Lkoc;->g:Lajk;

    iget-object v7, v7, Lajk;->b:Lbq9;

    iget-wide v7, v7, Lbq9;->a:D
    ...
    iput-boolean v2, p0, Lkoc;->f:Z

    iget-object p0, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-interface {p0, v0, v2}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final f(Laq9;)V
    ...
    iget-object v0, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    iget-object v0, p0, Lkoc;->i:Ljava/lang/Object;
    ...
    iget-object v3, p1, Laq9;->b:Lbq9;

    iget-boolean p1, p1, Laq9;->d:Z

    invoke-direct {v1, v2, v3, p1}, Lajk;-><init>(ILbq9;Z)V

    iput-object v1, p0, Lkoc;->g:Lajk;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lkoc;->h:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onAvailableBitrate(I)Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-virtual {p0}, Lkoc;->a()Lorg/webrtc/VideoCodecInfo;
...
.method public final onCurrentEncoder(Lorg/webrtc/VideoCodecInfo;)V
    ...
    iget-object v2, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    iput-object p1, p0, Lkoc;->e:Lorg/webrtc/VideoCodecInfo;

    :cond_0
    iput-object p1, p0, Lkoc;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-interface {v2, v1, p0}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onEncoderBroken()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v1, p0, Lkoc;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v4, p0, Lkoc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    :cond_0
    iput-object v1, p0, Lkoc;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_2
    iput-object v1, p0, Lkoc;->d:Lorg/webrtc/VideoCodecInfo;
