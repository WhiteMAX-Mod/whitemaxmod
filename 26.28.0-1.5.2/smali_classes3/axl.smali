...
# direct methods
.method public static a(Landroid/content/Context;Lky8;)Lfoh;
    .locals 25
    ...
    invoke-direct {v3, v8}, Lc29;-><init>(Ljava/lang/CharSequence;)V

    invoke-virtual {v3}, Lc29;->hasNext()Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-virtual {v3}, Lc29;->next()Ljava/lang/Object;
    ...
    invoke-static/range {v7 .. v16}, Lky8;->a(Lky8;Ljava/lang/CharSequence;Landroid/text/TextPaint;IIZLandroid/text/TextUtils$TruncateAt;FZI)Landroid/text/Layout;
    ...
    invoke-direct {v3, v4, v6}, Lenh;-><init>(FF)V

    invoke-virtual {v3, v11, v8}, Lenh;->b(Landroid/text/Layout;Ljava/lang/CharSequence;)V

    new-instance v13, Landroid/graphics/RectF;

    invoke-direct {v13}, Landroid/graphics/RectF;-><init>()V

    iget-object v12, v3, Lenh;->d:Landroid/graphics/Path;
    ...
    invoke-static {v1, v2}, Lwk8;->p(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    new-instance v9, Lfoh;

    move-object v10, v0

    invoke-direct/range {v9 .. v24}, Lfoh;-><init>(Landroid/graphics/Paint;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/RectF;FIZLandroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;FFFFFF)V
...
.method public static final b(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {v1, v6, v0, v4, v5}, Lc0a;->r(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
