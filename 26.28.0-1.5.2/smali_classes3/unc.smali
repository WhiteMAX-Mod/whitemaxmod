...
.field public final d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public constructor <init>(Lny8;Lny8;Lny8;)V
    ...
    iput-object p3, p0, Lunc;->a:Lny8;

    iput-object p1, p0, Lunc;->b:Lny8;

    iput-object p2, p0, Lunc;->c:Lny8;
    ...
    iput-object p1, p0, Lunc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    iput-object p1, p0, Lunc;->e:Ltnc;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lunc;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    return-void
.end method

.method public static f(Lp4j;)Lsnc;
    .locals 2

    new-instance v0, Lsnc;

    iget-object v1, p0, Lp4j;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getParticipantId()Lru/ok/android/externcalls/sdk/id/ParticipantId;

    move-result-object v1

    iget-object p0, p0, Lp4j;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lv4j;

    move-result-object p0

    invoke-direct {v0, v1, p0}, Lsnc;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lv4j;)V
...
.method public final clear()V
    ...
    iget-object v0, p0, Lunc;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2, v3}, Lc62;->e(Z)V

    const/4 v3, 0x0

    iput-object v3, v2, Lc62;->j:Lnpi;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lc62;->k:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lunc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/video/VideoRender;->clear()V

    iget-object p0, p0, Lunc;->e:Ltnc;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILj95;)V
...
.method public final e()Lru/ok/android/externcalls/sdk/Conversation;
    .locals 0

    iget-object p0, p0, Lunc;->b:Lny8;
...
.method public final g()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    .locals 0

    iget-object p0, p0, Lunc;->c:Lny8;
...
.method public final getOwnVideoTrack()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    invoke-virtual {p0}, Lunc;->e()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final h(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    .locals 2
    ...
    iget-object p0, p0, Lunc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Lrd1;->b()Z

    move-result v2

    check-cast v1, Lc62;

    iget-object v3, v1, Lc62;->l:Lp4j;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lp4j;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lc62;->d:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lunc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0}, Lunc;->g()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v0

    invoke-virtual {p0, v0, p1}, Lunc;->h(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lunc;->h(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lunc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lv4j;

    move-result-object v1

    sget-object v2, Lv4j;->a:Lv4j;

    if-ne v1, v2, :cond_1

    iget-object p0, p0, Lunc;->a:Lny8;
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lqs1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lqs1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
