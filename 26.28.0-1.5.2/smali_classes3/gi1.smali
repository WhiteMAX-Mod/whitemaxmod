...
.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lesh;Lzfh;Lvn7;Lih;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V
    .locals 0
    ...
    iput-object p2, p0, Lgi1;->b:Lesh;

    iput-object p3, p0, Lgi1;->c:Lzfh;

    iput-object p4, p0, Lgi1;->d:Lvn7;

    iput-object p5, p0, Lgi1;->e:Lih;
...
# virtual methods
.method public final b(Lvhk;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    .locals 7

    iget-object v0, p1, Lvhk;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p1, Lvhk;->d:Lcth;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-wide v1, p2, Lcth;->a:J

    iget-object v3, p0, Lgi1;->b:Lesh;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget p2, p2, Lcth;->b:I

    sget-object v4, Lbth;->$EnumSwitchMapping$0:[I
    ...
    iget-object v3, p1, Lvhk;->a:Ljava/lang/String;

    iget-object p1, p1, Lvhk;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
...
.method public final c(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    invoke-virtual {p0, v1, p1}, Lgi1;->b(Lvhk;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
...
.method public final d(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Lgi1;->b:Lesh;

    check-cast v0, Lgsh;

    invoke-virtual {v0}, Lgsh;->c()Lcth;

    move-result-object v0

    invoke-virtual {p0, v0, p1, p2, p3}, Lgi1;->e(Lcth;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    return-void
.end method

.method public final e(Lcth;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    .locals 3
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lvhk;-><init>(Lcth;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lgi1;->b(Lvhk;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
...
.method public final onTopologyUpdated(Lzvh;Lzvh;)V
    ...
    iget-object p2, p0, Lgi1;->e:Lih;

    iget-object v0, p0, Lgi1;->d:Lvn7;

    iget-object v1, p0, Lgi1;->c:Lzfh;

    if-eqz p1, :cond_0

    invoke-virtual {v1, p1}, Lzfh;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {v0, p1}, Lvn7;->h(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {p2, p1}, Lih;->q(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    invoke-virtual {p0, p1}, Lgi1;->c(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
