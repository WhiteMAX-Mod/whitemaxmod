.class public abstract Ly3m;
.super Ljava/lang/Object;
.source "SourceFile"


# direct methods
.method public static final a(Lfe8;)I
    .locals 0
...
.method public static d(Landroid/content/Context;Landroid/net/Uri;)Lmf5;
    .locals 1

    const/16 v0, 0x200

    invoke-static {p0, p1, v0}, Ly3m;->e(Landroid/content/Context;Landroid/net/Uri;I)Lmf5;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;I)Lmf5;
    .locals 16
    ...
    :try_start_2
    invoke-static {v8}, Ly3m;->c(Landroid/media/MediaMetadataRetriever;)J

    move-result-wide v5

    invoke-static {v8}, Ly3m;->g(Landroid/media/MediaMetadataRetriever;)Landroid/graphics/Point;

    move-result-object v4

    invoke-static {v8}, Ly3m;->b(Landroid/media/MediaMetadataRetriever;)I
    ...
    invoke-static {v2, v11, v0}, Lgm0;->V(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    .catch Ljava/lang/RuntimeException; {:try_start_4 .. :try_end_4} :catch_0
    .catchall {:try_start_4 .. :try_end_4} :catchall_1

    :goto_0
    invoke-static {v8}, Ly3m;->h(Landroid/media/MediaMetadataRetriever;)V
    ...
    invoke-static {v2, v0, v3}, Lgm0;->W(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_2

    invoke-static {v4}, Ly3m;->h(Landroid/media/MediaMetadataRetriever;)V
    ...
    invoke-direct/range {v8 .. v13}, Lmf5;-><init>(Landroid/graphics/Bitmap;JLandroid/graphics/Point;I)V
...
.method public static f(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Point;
    ...
    invoke-static {v1}, Ly3m;->g(Landroid/media/MediaMetadataRetriever;)Landroid/graphics/Point;

    move-result-object p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-static {v1}, Ly3m;->h(Landroid/media/MediaMetadataRetriever;)V
    ...
    invoke-static {v0}, Ly3m;->h(Landroid/media/MediaMetadataRetriever;)V
...
.method public static final i(I)Lfe8;
    .locals 1
    ...
    invoke-direct {p0, v0}, Lfe8;-><init>(B)V
    ...
    invoke-direct {v0, p0}, Lfe8;-><init>(B)V
