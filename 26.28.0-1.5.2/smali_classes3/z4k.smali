...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lz4k;->q:Ljava/nio/charset/Charset;

    return-void
.end method

.method public constructor <init>(Le8k;ILku8;I)V
    .locals 0
    ...
    .line 34
    iput-boolean p2, p0, Lz4k;->n:Z

    .line 35
    iput-object p1, p0, Lz4k;->a:Le8k;

    return-void
.end method

.method public constructor <init>(Le8k;[BILku8;)V
    .locals 0
    ...
    :goto_0
    invoke-virtual {p0}, Lz4k;->h()S

    move-result p4

    invoke-virtual {p0, p2, p3, p4}, Lz4k;->d([BLjava/lang/String;S)[B

    move-result-object p2

    invoke-virtual {p0, p2, p1, p1}, Lz4k;->c([BZZ)V
...
.method public final declared-synchronized a(Z)V
    ...
    :try_start_0
    iget-object v1, p0, Lz4k;->a:Le8k;

    invoke-virtual {v1}, Le8k;->b()Z
    ...
    invoke-virtual {p0, v2, v0, v1}, Lz4k;->d([BLjava/lang/String;S)[B

    move-result-object v0

    iput-object v0, p0, Lz4k;->c:[B

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1, p1}, Lz4k;->c([BZZ)V

    if-eqz p1, :cond_1

    iget-object p1, p0, Lz4k;->c:[B

    iput-object p1, p0, Lz4k;->b:[B
...
.method public final declared-synchronized b([B)V
    ...
    invoke-virtual {p0, p1, v0, v0}, Lz4k;->c([BZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final c([BZZ)V
    ...
    invoke-virtual {p0}, Lz4k;->g()S

    move-result v2

    invoke-virtual {p0, p1, v1, v2}, Lz4k;->d([BLjava/lang/String;S)[B
    ...
    iput-object v1, p0, Lz4k;->d:[B

    iput-object v2, p0, Lz4k;->j:Ljavax/crypto/spec/SecretKeySpec;

    goto :goto_1

    :cond_1
    iput-object v1, p0, Lz4k;->e:[B

    iput-object v2, p0, Lz4k;->k:Ljavax/crypto/spec/SecretKeySpec;
    ...
    iput-object v1, p0, Lz4k;->f:[B

    goto :goto_2

    :cond_2
    iput-object v1, p0, Lz4k;->g:[B
    ...
    invoke-virtual {p0, p1, p2, p3}, Lz4k;->d([BLjava/lang/String;S)[B

    move-result-object p1

    iput-object p1, p0, Lz4k;->h:[B
...
.method public final d([BLjava/lang/String;S)[B
    ...
    sget-object v1, Lz4k;->q:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lrai;->d([B[BI)[B
...
.method public final declared-synchronized e()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lz4k;->n:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lz4k;->c:[B

    iput-object v0, p0, Lz4k;->b:[B

    iget-object v0, p0, Lz4k;->e:[B

    iput-object v0, p0, Lz4k;->d:[B

    const/4 v0, 0x0

    iput-object v0, p0, Lz4k;->j:Ljavax/crypto/spec/SecretKeySpec;

    iget-object v1, p0, Lz4k;->g:[B
    ...
    iput-boolean v1, p0, Lz4k;->n:Z

    iput-object v0, p0, Lz4k;->e:[B

    iput-object v0, p0, Lz4k;->g:[B

    iget-object v0, p0, Lz4k;->o:Lz4k;
    ...
    invoke-virtual {v0, v2}, Lz4k;->a(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final f([B)[B
    ...
    invoke-static {}, Lu26;->k()V

    invoke-static {p1, v4}, Lu26;->j(I[B)Ljavax/crypto/spec/ChaCha20ParameterSpec;

    move-result-object p1

    new-instance v4, Ljavax/crypto/spec/SecretKeySpec;

    iget-object p0, p0, Lz4k;->h:[B
    ...
    :pswitch_0
    iget-object v0, p0, Lz4k;->i:Ljavax/crypto/Cipher;
    ...
    iput-object v0, p0, Lz4k;->i:Ljavax/crypto/Cipher;

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v3, p0, Lz4k;->h:[B

    const-string v4, "AES"

    invoke-direct {v0, v3, v4}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iget-object v3, p0, Lz4k;->i:Ljavax/crypto/Cipher;
    ...
    :cond_0
    :goto_2
    iget-object p0, p0, Lz4k;->i:Ljavax/crypto/Cipher;
...
.method public j()Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-object v0, p0, Lz4k;->k:Ljavax/crypto/spec/SecretKeySpec;

    if-nez v0, :cond_0

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lz4k;->e:[B

    invoke-direct {v0, v2, v1}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iput-object v0, p0, Lz4k;->k:Ljavax/crypto/spec/SecretKeySpec;

    :cond_0
    iget-object p0, p0, Lz4k;->k:Ljavax/crypto/spec/SecretKeySpec;

    return-object p0

    :cond_1
    iget-object v0, p0, Lz4k;->j:Ljavax/crypto/spec/SecretKeySpec;

    if-nez v0, :cond_2

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lz4k;->d:[B
    ...
    :cond_2
    iget-object p0, p0, Lz4k;->j:Ljavax/crypto/spec/SecretKeySpec;
...
.method public k()Ljavax/crypto/Cipher;
    ...
    iget-object v0, p0, Lz4k;->l:Ljavax/crypto/Cipher;
    ...
    iput-object v0, p0, Lz4k;->l:Ljavax/crypto/Cipher;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, Lz4k;->l:Ljavax/crypto/Cipher;
