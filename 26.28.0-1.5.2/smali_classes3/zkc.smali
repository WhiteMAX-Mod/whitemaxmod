...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v0}, Lc0a;->n(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Lzkc;->c:Ljava/util/Map;
    ...
    sput-object v0, Lzkc;->d:Ljava/util/List;
...
.method public final b()[B
    ...
    iget-object v0, p0, Lzkc;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v4}, Lqkc;-><init>(I)V
    ...
    sget-object v6, Lifk;->k:Lifk;

    iget-short v6, v6, Lifk;->a:S
    ...
    iget-object v1, v0, Lskc;->a:Lkfk;

    iget-short v1, v1, Lkfk;->a:S

    invoke-virtual {v5, v1}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v1, v0, Lskc;->a:Lkfk;

    sget-object v2, Lzkc;->c:Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lskc;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v1}, Lzkc;->e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v0}, Lzkc;->e(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lkfk;->e:Lkfk;
    ...
    invoke-static {v1}, Ljx5;->p(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v1

    invoke-static {v1}, Ljx5;->o(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v1}, Lzkc;->f([B)V

    iget-object v0, v0, Lskc;->a:Lkfk;
...
.method public final c(Ljava/nio/ByteBuffer;)I
    ...
    iget-object p0, p0, Lzkc;->b:Ljava/util/ArrayList;
    ...
    new-instance v6, Lr4k;

    const/4 v7, 0x5

    invoke-direct {v6, v1, v7}, Lr4k;-><init>(II)V
    ...
    sget-object v3, Lzkc;->d:Ljava/util/List;
    ...
    sget-object v3, Lzkc;->c:Ljava/util/Map;
    ...
    invoke-static {v4}, Lzkc;->d(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v2, v1, v3}, Lrkc;-><init>(Lkfk;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :catch_0
    invoke-static {v7}, Lore;->q(Ljava/lang/String;)V

    return v2

    :catch_1
    invoke-static {v6}, Lore;->q(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Ljx5;->q(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Ljx5;->C()V

    invoke-static {v5, v4}, Ljx5;->r(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v3, v1, v2}, Lskc;-><init>(Lkfk;Ljava/security/PublicKey;)V
    ...
    invoke-static {v5, v0, p1, v1}, Lnbh;->r(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
