...
.method public final onCreate()Z
    ...
    new-instance v4, Ljt5$a;

    invoke-direct {v4}, Ljt5$a;-><init>()V

    invoke-virtual {v4, v0}, Ljt5$a;->t(Landroid/app/Application;)Ljt5$a;

    move-result-object v4

    instance-of v5, v0, Lgt3;
    ...
    invoke-virtual {v4, v5}, Ljt5$a;->w(Lgt3;)Ljt5$a;

    :cond_6
    instance-of v5, v0, Ldni;
    ...
    invoke-virtual {v4, v5}, Ljt5$a;->L(Ldni;)Ljt5$a;

    :cond_7
    instance-of v5, v0, Lmk5;

    if-eqz v5, :cond_8

    check-cast v0, Lmk5;

    invoke-virtual {v4, v0}, Ljt5$a;->y(Lmk5;)Ljt5$a;
    ...
    invoke-direct {v5, v0}, Lt95;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Ljt5$a;->y(Lmk5;)Ljt5$a;

    :goto_2
    invoke-virtual {v4, v1}, Ljt5$a;->r(Ljava/lang/String;)Ljt5$a;

    move-result-object v0

    if-eqz v3, :cond_9

    invoke-virtual {v0, v3}, Ljt5$a;->K(Ljava/lang/String;)Ljt5$a;

    :cond_9
    if-eqz p0, :cond_a

    invoke-virtual {v0, p0}, Ljt5$a;->u(Ljava/lang/String;)Ljt5$a;

    :cond_a
    invoke-virtual {v0}, Ljt5$a;->e()Ljt5;
