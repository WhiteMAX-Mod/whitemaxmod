...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "configuration",
        "<init>",
        "(Lru/ok/tracer/lite/TracerLite;Lzwh;)V",
        "",
        "severity",
        "",
        "e",
        ...
        "Lpwf;",
        "(Lpwf;Ljava/lang/Throwable;Ljava/lang/String;)V",
        "msg",
        "log",
        "(Ljava/lang/String;)V",
        "Lru/ok/tracer/lite/TracerLite;",
...
# static fields
.field private static final Companion:Lywh;
...
# instance fields
.field private final configuration:Lzwh;

.field private final limits:Loxh;

.field private final logStorage:Lpe9;

.field private final nonFatalBucket:Luuh;

.field private final nonFatalDropCount:Ljava/util/concurrent/atomic/AtomicInteger;

.field private final nonFatalsEnabled$delegate:Lny8;

.field private final tracer:Lru/ok/tracer/lite/TracerLite;

.field private volatile tracerIsDisabled:Z

.field private final uploader:Lkv4;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->Companion:Lywh;
...
.method public constructor <init>(Lru/ok/tracer/lite/TracerLite;)V
    ...
    invoke-direct {p0, p1, v0, v1, v0}, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;-><init>(Lru/ok/tracer/lite/TracerLite;Lzwh;ILj95;)V

    return-void
.end method

.method public constructor <init>(Lru/ok/tracer/lite/TracerLite;Lzwh;)V
    .locals 3
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
    ...
    iput-object p2, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->configuration:Lzwh;

    new-instance p2, Lpe9;

    invoke-direct {p2}, Lpe9;-><init>()V

    iput-object p2, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->logStorage:Lpe9;

    invoke-virtual {p1}, Lru/ok/tracer/lite/TracerLite;->getLimits$tracer_lite_commons_release()Loxh;

    move-result-object p2

    iput-object p2, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->limits:Loxh;

    new-instance v0, Lkv4;

    invoke-direct {v0, p1, p2}, Lkv4;-><init>(Lru/ok/tracer/lite/TracerLite;Loxh;)V

    iput-object v0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->uploader:Lkv4;
    ...
    invoke-static {v0, p2}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object p2

    iput-object p2, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->nonFatalsEnabled$delegate:Lny8;
    ...
    invoke-direct {v0, v1, v2}, Luuh;-><init>(J)V
    ...
    iput-object v0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->nonFatalBucket:Luuh;
...
.method public constructor <init>(Lru/ok/tracer/lite/TracerLite;Lzwh;ILj95;)V
    .locals 0
    ...
    .line 86
    :cond_0
    invoke-direct {p0, p1, p2}, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;-><init>(Lru/ok/tracer/lite/TracerLite;Lzwh;)V
...
.method public static final synthetic access$getConfiguration$p(Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;)Lzwh;
    .locals 0

    iget-object p0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->configuration:Lzwh;
...
.method private final getDropManager()Lpv5;
    .locals 0

    iget-object p0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->tracer:Lru/ok/tracer/lite/TracerLite;

    invoke-virtual {p0}, Lru/ok/tracer/lite/TracerLite;->getDropHolder$tracer_lite_commons_release()Laxh;

    move-result-object p0

    iget-object p0, p0, Laxh;->a:Lifh;
...
.method private final getIoExecutor()Ljava/util/concurrent/Executor;
    ...
    invoke-virtual {p0}, Lru/ok/tracer/lite/TracerLite;->getExecutorHolder$tracer_lite_commons_release()Lcxh;

    move-result-object p0

    iget-object p0, p0, Lcxh;->a:Ljava/util/concurrent/Executor;
...
.method private final getNonFatalsEnabled()Z
    ...
    iget-object p0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->nonFatalsEnabled$delegate:Lny8;
...
.method private final getTagsStorage()Llhh;
    .locals 0

    iget-object p0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->tracer:Lru/ok/tracer/lite/TracerLite;

    invoke-virtual {p0}, Lru/ok/tracer/lite/TracerLite;->getTagsStorage$tracer_lite_commons_release()Llhh;
...
.method public static synthetic report$default(Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;Lpwf;Ljava/lang/Throwable;Ljava/lang/String;ILjava/lang/Object;)V
    .locals 0
    ...
    .line 9
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->report(Lpwf;Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method private final reportException(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->limits:Loxh;

    invoke-virtual {v0}, Loxh;->b()Z
    ...
    :cond_2
    iget-object v0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->nonFatalBucket:Luuh;

    invoke-static {v0}, Luuh;->a(Luuh;)Z
    ...
    invoke-direct {p2, p3, p0}, Lf4g;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct/range {v1 .. v6}, Lsc2;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method private static final reportException$lambda$1(Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;)V
    ...
    iget-object v1, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->configuration:Lzwh;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-direct {p0}, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->getDropManager()Lpv5;

    move-result-object p0

    invoke-virtual {p0, v0}, Lpv5;->a(I)V
...
.method private static final reportException$lambda$2(Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, v0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->limits:Loxh;

    invoke-virtual {v1}, Loxh;->b()Z
    ...
    :cond_1
    iget-object v1, v0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->uploader:Lkv4;

    const/4 v3, 0x0

    if-eqz p3, :cond_3

    invoke-static/range {p3 .. p3}, Lr5h;->y1(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-static {v5, v4}, Lr5h;->u1(ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    iget-object v5, v0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->logStorage:Lpe9;

    iget-object v6, v5, Lpe9;->b:Lzv;

    monitor-enter v6

    :try_start_0
    iget-object v5, v5, Lpe9;->b:Lzv;
    ...
    invoke-direct {v0}, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->getTagsStorage()Llhh;
    ...
    iget-object v7, v0, Llhh;->a:Ljava/util/concurrent/ConcurrentHashMap;

    monitor-enter v7

    :try_start_1
    iget-object v0, v0, Llhh;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v9, v1, Lkv4;->a:Lru/ok/tracer/lite/TracerLite;
    ...
    :try_start_3
    const-class v11, Lswh;

    sget-object v12, Lswh;->a:Lswh;
    ...
    invoke-static {v11}, Lmyl;->c(Ljava/lang/String;)Lqxh;
    ...
    invoke-static {v8, v11}, Loc9;->P(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lru/ok/tracer/lite/TracerLite;->getLibraryInfo()Ldxh;
    ...
    invoke-static {v9, v14}, Le9i;->d0(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v14}, Lmyl;->c(Ljava/lang/String;)Lqxh;

    move-result-object v14

    if-eqz v14, :cond_9

    const-string v14, "8029e1d0-9b0b-11f1-9268-0c152d90928f"
    ...
    invoke-static {v8, v14}, Loc9;->P(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9}, Ln1g;->z(Landroid/content/pm/PackageInfo;)J
    ...
    invoke-static/range {v18 .. v18}, Lyab;->I(Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_start_4
    invoke-static/range {v18 .. v18}, Lyab;->G(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static/range {v18 .. v18}, Lyab;->f0(Landroid/content/Context;)Z
    ...
    invoke-static/range {v17 .. v17}, Liql;->a(Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lc79;->listIterator(I)Ljava/util/ListIterator;
    ...
    invoke-virtual {v6}, Lb79;->hasNext()Z

    move-result v9

    if-eqz v9, :cond_10

    invoke-virtual {v6}, Lb79;->next()Ljava/lang/Object;
    ...
    iget-object v4, v12, Ldxh;->a:Ljava/lang/String;

    invoke-virtual {v1, v5, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    iget-object v4, v12, Ldxh;->b:Ljava/lang/String;

    invoke-virtual {v1, v2, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    iget-object v2, v12, Ldxh;->c:Ljava/lang/String;

    invoke-virtual {v1, v3, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v2, "environment"

    iget-object v3, v12, Ldxh;->d:Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lyxl;->b(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
    ...
    iget-wide v8, v5, Lee9;->a:J

    sget-object v6, Lfe9;->a:Ljava/text/SimpleDateFormat;
    ...
    iget-object v5, v5, Lee9;->b:Ljava/lang/String;
    ...
    :goto_f
    iget-object v4, v3, Lkv4;->a:Lru/ok/tracer/lite/TracerLite;

    invoke-virtual {v4}, Lru/ok/tracer/lite/TracerLite;->getDropHolder$tracer_lite_commons_release()Laxh;

    move-result-object v4

    iget-object v4, v4, Laxh;->a:Lifh;
    ...
    invoke-virtual {v4}, Lpv5;->e()Ljava/util/Collection;
    ...
    iget-object v11, v8, Lrv5;->a:Ljava/lang/String;

    invoke-virtual {v9, v10, v11}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v10, "reason"

    iget-object v11, v8, Lrv5;->b:Ljava/lang/String;
    ...
    :goto_12
    invoke-virtual/range {p0 .. p0}, Lru/ok/tracer/lite/TracerLite;->getConfiguration()Lkxh;

    move-result-object v6

    iget-object v6, v6, Lkxh;->a:Lixh;
    ...
    new-instance v8, Lrj5;

    const/16 v9, 0x10

    invoke-direct {v8, v9}, Lrj5;-><init>(I)V

    const-string v9, "type"

    const-string v10, "NON_FATAL"

    invoke-virtual {v8, v9, v10}, Lrj5;->E(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v11, v12, v13, v1}, Lpr6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v8, v9, v10, v11}, Lrj5;->C(Ljava/lang/String;Ljava/lang/String;Lpr6;)V

    const-string v1, "application/json; charset=utf-8"

    sget-object v9, Lpt2;->a:Ljava/nio/charset/Charset;
    ...
    invoke-direct {v10, v1, v13, v0}, Lpr6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    const-string v0, "uploadBean"

    const/4 v1, 0x0

    invoke-virtual {v8, v0, v1, v10}, Lrj5;->C(Ljava/lang/String;Ljava/lang/String;Lpr6;)V
    ...
    invoke-direct {v10, v12, v13, v2}, Lpr6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-direct {v10, v2, v13, v5}, Lpr6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v8, v0, v1, v10}, Lrj5;->C(Ljava/lang/String;Ljava/lang/String;Lpr6;)V

    :cond_19
    invoke-virtual {v8}, Lrj5;->I()Lq36;

    move-result-object v0

    new-instance v1, Leuc;

    invoke-direct {v1, v6, v0}, Leuc;-><init>(Ljava/lang/String;Lx18;)V

    :try_start_5
    iget-object v0, v3, Lkv4;->b:Lnxh;

    iget-object v0, v0, Lnxh;->c:Lifh;
    ...
    invoke-virtual {v0, v1}, Ll28;->b(Leuc;)La28;
    ...
    iget-object v2, v1, La28;->c:Ljava/lang/Object;

    check-cast v2, Ljava/lang/String;

    iget-object v5, v1, La28;->d:Ljava/io/Closeable;

    check-cast v5, Lpr6;

    iget-object v6, v5, Lpr6;->b:Ljava/lang/Object;
    ...
    iget-object v8, v3, Lkv4;->c:Lc7k;

    invoke-virtual {v8, v6, v5}, Lc7k;->u(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v3, Lkv4;->a:Lru/ok/tracer/lite/TracerLite;

    invoke-virtual {v0}, Lru/ok/tracer/lite/TracerLite;->getDropHolder$tracer_lite_commons_release()Laxh;

    move-result-object v0

    iget-object v0, v0, Laxh;->a:Lifh;
    ...
    invoke-virtual {v0, v4}, Lpv5;->b(Ljava/util/Collection;)V
...
.method public final log(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p0, p0, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->logStorage:Lpe9;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const v0, 0xffdc

    invoke-static {v0, p1}, Lr5h;->u1(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2, p1}, Lee9;-><init>(JLjava/lang/String;)V

    iget-object v1, p0, Lpe9;->b:Lzv;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lpe9;->b:Lzv;
    ...
    iget-object p1, p1, Lee9;->b:Ljava/lang/String;
...
.method public final report(Lpwf;Ljava/lang/Throwable;)V
    .locals 6
    ...
    .line 43
    invoke-static/range {v0 .. v5}, Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;->report$default(Lru/ok/tracer/lite/crash/report/TracerCrashReportLite;Lpwf;Ljava/lang/Throwable;Ljava/lang/String;ILjava/lang/Object;)V

    return-void
.end method

.method public final report(Lpwf;Ljava/lang/Throwable;Ljava/lang/String;)V
    .locals 1
