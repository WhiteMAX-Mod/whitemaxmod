...
.method public final d()Ll89;
    ...
    iget-object v1, p0, Landroidx/work/WorkerParameters;->b:Ld25;

    const-string v2, "param_dump_path"

    invoke-virtual {v1, v2}, Ld25;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Ld25;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v6, v7}, Lg08;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v6, v7}, Legl;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v6}, Lg08;->close()V
    :try_end_5
