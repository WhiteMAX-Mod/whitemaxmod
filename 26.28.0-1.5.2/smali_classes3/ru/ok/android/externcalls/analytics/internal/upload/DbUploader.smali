...
.field private final multiUploadHelper$delegate:Lny8;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljava/util/concurrent/locks/Lock;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;ILjava/lang/Long;)V
    ...
    invoke-direct {p3, p1, p5, p0}, Ldx4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p5, Lifh;

    invoke-direct {p5, p3}, Lifh;-><init>(Laf7;)V

    iput-object p5, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lny8;
    ...
    invoke-direct {p1, p2, p5, p0}, Lf92;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method private static final _init_$lambda$0(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)V
    ...
    invoke-static {p0}, Liu6;->b(Ljava/io/File;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic d(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lsbi;
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->upload$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lsbi;
...
.method private final getMultiUploadHelper()Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lny8;
...
.method private static final multiUploadHelper_delegate$lambda$0(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    invoke-direct {v5, v1, p1}, Lpe3;-><init>(ILjava/lang/Object;)V

    const-string v4, "CallAnalyticsDbUploader"

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;-><init>(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Ljava/lang/Long;Ljava/lang/String;Laf7;)V
...
.method private static final multiUploadHelper_delegate$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)Z
    ...
    invoke-static {v8, v5, v6, p0, v7}, Lqv1;->p(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private static final upload$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lsbi;
    .locals 0

    invoke-virtual {p1}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Lfsb;

    move-result-object p1

    invoke-virtual {p1}, Lfsb;->b()Lno;
...
.method private final uploadImpl(Lno;Ljava/util/Iterator;)V
    ...
    invoke-virtual {v6, p1, v7, v8}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics(Lno;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lu21;)V
...
.method public upload()V
    ...
    invoke-direct {v6, p0, v7, v1}, Lw14;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v0, v2, v6}, Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;->grab(ILcf7;)V
