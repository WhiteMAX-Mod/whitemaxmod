...
.method private final uploadFileWithContent(Lno;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    invoke-static {p2}, Liu6;->d(Ljava/io/File;)Z
    ...
    invoke-virtual {v5, p1, v6, v7}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics(Lno;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lu21;)V
...
.method public final ensureStorageIsOfCorrectType(Z)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v0}, Liu6;->b(Ljava/io/File;)V
    :try_end_0
...
.method public final uploadFile(Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    :cond_1
    invoke-virtual {v2}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Lfsb;
