...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "upload",
        "<init>",
        "(Lfsb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V",
        "Lfsb;",
        "getOkApi",
        "()Lfsb;",
        "Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;",
...
.field private final okApi:Lfsb;

.field private final upload:Lru/ok/android/externcalls/analytics/config/UploadConfig;


# direct methods
.method public constructor <init>(Lfsb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
    .locals 0
    ...
    .line 68
    iput-object p1, p0, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->okApi:Lfsb;
...
.method public synthetic constructor <init>(Lfsb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;ILj95;)V
    .locals 20
    ...
    invoke-direct {v0, v2, v1, v2}, Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;-><init>(Laf7;ILj95;)V
    ...
    invoke-direct/range {v3 .. v19}, Lru/ok/android/externcalls/analytics/config/UploadConfig;-><init>(ILjava/util/concurrent/Executor;JJLaf7;Laf7;Laf7;Laf7;Laf7;Laf7;Laf7;Laf7;ILj95;)V
    ...
    :goto_3
    invoke-direct {v2, v4, v0, v1, v3}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;-><init>(Lfsb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
...
.method public final getOkApi()Lfsb;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->okApi:Lfsb;
