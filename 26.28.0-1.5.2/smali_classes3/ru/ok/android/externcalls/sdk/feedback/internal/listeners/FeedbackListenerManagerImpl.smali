...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;J)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->scheduleRemoving$lambda$0(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;J)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;Ljava/util/ArrayList;)V
    .locals 0
...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lyt1;
    ...
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lyt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILj95;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lkb0;-><init>(Ljava/lang/Object;JI)V
...
.method private static final scheduleRemoving$lambda$0(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;J)V
    .locals 0
...
.method private final unrollReceivedFeedback(Lui1;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p1, Lui1;->b:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lti1;->b:Ljava/util/List;
    ...
    iget-object v4, v0, Lti1;->a:Ljava/lang/String;
    ...
    invoke-direct {v5, v3, v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Lyt1;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {v2, p1}, Lcx3;->Z0(Ljava/lang/Iterable;Ljava/util/Collection;)V
...
.method public onFeedback(Lui1;)V
    .locals 5

    iget-object v0, p1, Lui1;->a:Ldnf;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Ldnf;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lui1;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lyt1;
    ...
    invoke-direct {v2, p0, p1, v0}, Ld86;-><init>(Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;Ljava/util/List;Ljava/util/ArrayList;)V

    new-instance p1, Lgf5;

    const/16 v4, 0x1a

    invoke-direct {p1, p0, v4, v0}, Lgf5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
