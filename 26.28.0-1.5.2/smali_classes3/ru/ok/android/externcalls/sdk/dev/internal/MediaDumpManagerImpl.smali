...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Lo91;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "",
        "path",
        "Lsbi;",
...
# direct methods
.method public constructor <init>(Lo91;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;->call:Lo91;
...
.method public cancelAudioDumpRecord()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;->call:Lo91;
    ...
    invoke-direct {v1, v2, p0}, Lo01;-><init>(ILjava/lang/Object;)V
...
.method public recordAudioDump(ILjava/util/Set;Lru/ok/android/externcalls/sdk/dev/MediaDumpManager$LocalAudioDumpRecordListener;)Ljava/lang/String;
    ...
    const-string v5, "calldump_"

    invoke-static {p1, v5, v0, v3, v4}, Lc0a;->l(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v5, p0, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;->call:Lo91;
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/dev/MediaDumpManager$Source;->getWebrtcDumpSource$calls_sdk()Lorg/webrtc/DumpSource;
    ...
    iget-object p0, v5, Lo91;->e0:Lzzf;
    ...
    invoke-direct/range {v4 .. v9}, Lz81;-><init>(Lo91;Ljava/lang/String;ILjava/util/Set;Lorg/webrtc/NativeDumpCallback;)V

    new-instance p1, Lt81;

    const/4 p2, 0x0

    invoke-direct {p1, p2}, Lt81;-><init>(I)V

    invoke-virtual {p0, v4, p1}, Lzzf;->a(Ljava/util/function/Consumer;Ljava/util/function/Consumer;)V
    :try_end_0
...
.method public requestMediaDump(IZZLru/ok/android/externcalls/sdk/dev/MediaDumpManager$RemoteMediaDumpRequestListener;)V
    ...
    invoke-static {v0, p1}, Lkql;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lvj7;
    ...
    invoke-direct {p2, p3, p4}, Lmb;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p0, p1, p2}, Lq4g;->j(Lvj7;Ln4g;)V
