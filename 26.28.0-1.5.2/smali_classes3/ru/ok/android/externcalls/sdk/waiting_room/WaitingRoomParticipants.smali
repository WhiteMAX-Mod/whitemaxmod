...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Ly3e;)V",
        "Lo91;",
        "call",
        "Lsbi;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lv7g;",
        "Lh62;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lyt1;)Lh62;",
        "",
        "Lg62;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Lo91;

.field private final compositeDisposable:Lw74;
...
.field private final loadEventSubject:Lqyd;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Ly3e;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Ly3e;

    new-instance p1, Lqyd;

    invoke-direct {p1}, Lqyd;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lqyd;

    new-instance p2, Lw74;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lw74;
    ...
    invoke-direct {v0, p1, p4, v1}, Ljqb;-><init>(Lfqb;Lz2f;I)V

    invoke-static {}, Li3f;->b()Lz2f;

    move-result-object p1

    invoke-virtual {v0, p1}, Lfqb;->e(Lz2f;)Lvqb;
    ...
    invoke-direct {v0, p1, p4, v1}, Lxqb;-><init>(Lfqb;Lsf7;I)V
    ...
    invoke-direct {p1, p3}, Lgg7;-><init>(Ljava/lang/Object;)V

    new-instance p3, Lsqb;

    invoke-direct {p3, v0, p1, v1}, Lsqb;-><init>(Lfqb;Ljava/lang/Object;I)V

    invoke-static {}, Lth;->a()Lz2f;

    move-result-object p1

    invoke-virtual {p3, p1}, Lfqb;->e(Lz2f;)Lvqb;
    ...
    sget-object p0, Lvm9;->f:Lso2;

    new-instance p4, Lvx8;

    invoke-direct {p4, p3, p0}, Lvx8;-><init>(Lrg4;Lrg4;)V

    invoke-virtual {p1, p4}, Lfqb;->f(Lrrb;)V

    invoke-virtual {p2, p4}, Lw74;->a(Lko5;)Z

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lf8g;La72;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lf8g;La72;)V
...
.method public static synthetic b(Lf8g;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$0$0(Lf8g;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method public static synthetic c(Lf8g;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0$1(Lf8g;)V

    return-void
.end method

.method public static synthetic d(Lo91;Lh62;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lb8g;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$0(Lo91;Lh62;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lf8g;)V

    return-void
.end method

.method public static synthetic e(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lb8g;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lf8g;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lyt1;)Lh62;
    .locals 2
    ...
    invoke-direct {p0, p2, v0, v1}, Lh62;-><init>(Lyt1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Lg62;->a:Lh62;

    iget-object v1, v1, Lh62;->b:Lyt1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lyt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v1, Lg62;->a:Lh62;

    iget-object v2, v2, Lh62;->b:Lyt1;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lyt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lo91;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lv7g;

    move-result-object v6

    invoke-virtual {v6}, Lv7g;->d()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lyt1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lyt1;)Lh62;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Ly3e;
    ...
    invoke-interface {v2, v4, v0}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Lo91;Lh62;)Lv7g;
...
.method private final loadWaitingParticipantIdsPageSingle(Lo91;Lh62;)Lv7g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Ld7i;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0(Lo91;Lh62;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lf8g;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lbm5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Lf4g;

    const/16 v1, 0x1b

    invoke-direct {p2, v1, p3}, Lf4g;-><init>(ILjava/lang/Object;)V

    iget-object p3, p0, Lo91;->k:Lq4g;
    ...
    iget-object v5, p1, Lh62;->b:Lyt1;

    invoke-virtual {v5}, Lyt1;->b()Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Lx81;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lmb;

    invoke-direct {p0, v2, p2}, Lmb;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p3, v1, v4, p1, p0}, Lq4g;->d(Lt4g;ZLn4g;Ln4g;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lf8g;La72;)V
    .locals 8

    iget-object v2, p2, La72;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lf8g;La72;Lf8g;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$2;-><init>(Lf8g;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$0$1(Lf8g;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lb8g;->d(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v0, v0, Lg62;->a:Lh62;

    iget-object v0, v0, Lh62;->b:Lyt1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lyt1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lv7g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final resolveInternalIdSingle$lambda$0(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lf8g;)V
    .locals 4
    ...
    invoke-direct {v1, v2, p2}, Lpg4;-><init>(ILjava/lang/Object;)V

    new-instance v2, Lewg;

    const/16 v3, 0x1c

    invoke-direct {v2, p2, v3, p1}, Lewg;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lsg4;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$0$0(Lf8g;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
...
.method private final resolveInternalIds(Ljava/util/List;Lcf7;Lcf7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lcf7;Lcf7;)V

    new-instance p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lcf7;)V
...
.method private final scheduleLoad()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lqyd;

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-virtual {p0, v0}, Lqyd;->d(Ljava/lang/Object;)V
...
.method public final release()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lw74;
...
.method public final setCall(Lo91;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lo91;
