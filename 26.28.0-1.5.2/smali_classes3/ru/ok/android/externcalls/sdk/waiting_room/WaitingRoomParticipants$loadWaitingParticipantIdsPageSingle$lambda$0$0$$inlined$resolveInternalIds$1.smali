...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Lo91;Lh62;)Lv7g;
.end annotation
...
# instance fields
.field final synthetic $emitter$inlined:Lf8g;

.field final synthetic $emitter$inlined$1:Lf8g;

.field final synthetic $page$inlined:La72;
...
# direct methods
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lf8g;La72;Lf8g;)V
    .locals 0
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;->$emitter$inlined:Lf8g;

    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;->$page$inlined:La72;

    iput-object p5, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;->$emitter$inlined$1:Lf8g;
...
.method public final run()V
    ...
    :try_start_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;->$emitter$inlined:Lf8g;

    new-instance v2, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;->$page$inlined:La72;

    iget-boolean v3, v3, La72;->b:Z
    ...
    invoke-virtual {v1, v2}, Lb8g;->a(Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$0$0$$inlined$resolveInternalIds$1;->$emitter$inlined$1:Lf8g;
    ...
    invoke-virtual {p0, v1}, Lb8g;->d(Ljava/lang/Throwable;)Z
