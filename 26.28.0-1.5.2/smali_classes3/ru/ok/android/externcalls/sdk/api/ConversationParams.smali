...
.field public static final PARSER:Lhu8;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lru/ok/android/externcalls/sdk/api/ConversationParams;->PARSER:Lhu8;
...
.method public static synthetic a(Lvu8;)Lru/ok/android/externcalls/sdk/api/ConversationParams;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/api/ConversationParams;->parseCallParams(Lvu8;)Lru/ok/android/externcalls/sdk/api/ConversationParams;
...
.method public static decode(Ljava/lang/String;)Lru/ok/android/externcalls/sdk/api/ConversationParams;
    ...
    invoke-static {v1, p0}, Lore;->h(Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v0
.end method

.method public static fromInternalParams(Ljava/lang/String;Lvu8;Z)Lru/ok/android/externcalls/sdk/api/ConversationParams;
    .locals 3
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/api/CallInfoParser;->parseIpAddresses(Lvu8;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lru/ok/android/externcalls/sdk/api/ConversationParams;->wtIps:Ljava/util/List;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/api/CallInfoParser;->parseTurn(Lvu8;)Ljava/util/List;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/api/CallInfoParser;->parseStun(Lvu8;)Ljava/util/List;
    ...
    const-string p2, "Exception during parsing internal params "
    ...
    :goto_2
    const-string p2, "ConversationParams"

    invoke-static {p2, p1, p0}, Lru/ok/android/externcalls/sdk/log/GlobalRTCLogger;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static parseCallParams(Lvu8;)Lru/ok/android/externcalls/sdk/api/ConversationParams;
    .locals 0
    ...
    .line 236
    invoke-static {p0}, Lxel;->c(Lvu8;)Lorg/json/JSONObject;
...
.method private static parseCallParamsCompact(Lorg/json/JSONObject;)Lru/ok/android/externcalls/sdk/api/ConversationParams;
    ...
    invoke-static {v2}, Lru/ok/android/externcalls/sdk/api/ConversationParams;->jsonArrayToStringList(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v2

    iput-object v2, v0, Lru/ok/android/externcalls/sdk/api/ConversationParams;->wsIps:Ljava/util/List;
