...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lvf7;)V",
        "",
        "handleInterruptedIO",
        "()Ljava/lang/Object;",
        "canRepeat",
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lvf7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lit0;-><init>(Landroid/net/Uri;)V

    sget-object v0, Lup;->c:Lup;

    iput-object v0, v1, Lit0;->b:Lup;
    ...
    invoke-virtual {v1, v0, v2}, Lit0;->c(Ljava/lang/String;Z)V

    const-string v0, "turnServers"

    invoke-virtual {v1, v0, p1}, Lit0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "conversationId"

    invoke-virtual {v1, p1, p2}, Lit0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "createJoinLink"

    invoke-virtual {v1, p1, p3}, Lit0;->c(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, p1, p2}, Lit0;->c(Ljava/lang/String;Z)V
    ...
    invoke-direct {p1, v0, p2, p3}, Llj8;-><init>(Ljava/lang/String;J)V

    iget-object p2, v1, Lit0;->c:Lnp;
    ...
    invoke-virtual {v1, p2, p1}, Lit0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-interface {p7, p4, p5, p6, v1}, Lvf7;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p2, p1}, Lit0;->c(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;->getPARSER()Lhu8;

    move-result-object p1

    invoke-virtual {v1, p1}, Lit0;->a(Lhu8;)Ljt0;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;->$$delegate_0:Ljt0;
...
.method public canRepeat()Z
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;->$$delegate_0:Ljt0;
