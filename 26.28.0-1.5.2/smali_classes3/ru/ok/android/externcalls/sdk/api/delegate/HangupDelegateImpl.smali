...
# virtual methods
.method public invoke(Lat7;)Ldt7;
    .locals 3
    ...
    iget-object v2, p1, Lat7;->a:Ljava/lang/String;

    iget-object p1, p1, Lat7;->b:Lit7;

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/delegate/HangupDelegateImpl;->anonToken:Ljava/lang/String;

    invoke-direct {v1, v2, p1, p0}, Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Request;-><init>(Ljava/lang/String;Lit7;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v0, p0}, Lbt7;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
