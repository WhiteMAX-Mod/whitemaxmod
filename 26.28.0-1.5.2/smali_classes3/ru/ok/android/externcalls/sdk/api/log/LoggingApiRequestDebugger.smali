...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Ly3e;Lyp;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ly3e;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ly3e;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Lylc;
    .locals 1
...
.method private final getRawParams(Lop;)Ljava/lang/String;
    ...
    invoke-direct {v1, v0}, Lh2d;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lh2d;->p()V

    invoke-interface {p1, v1}, Lop;->writeParams(Lmv8;)V

    invoke-virtual {v1}, Lh2d;->t()V

    invoke-virtual {v1}, Lh2d;->flush()V
    :try_end_0
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Lylc;

    move-result-object p0

    iget-object v0, p0, Lylc;->a:Ljava/lang/Object;
...
.method public debugApiRequest(Lto;Lop;Luo;)V
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ly3e;
    ...
    invoke-static {p2, p0, v0, p1}, Lqv1;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    const-string p1, "CallsApiDebug"

    invoke-interface {p3, p1, p0}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public debugApiResponseFail(Lto;Lop;Lvu8;)Lvu8;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p3}, Lvu8;->E0()Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ly3e;
    ...
    invoke-static {p2, p0, v1, p3}, Lqv1;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    const-string p2, "CallsApiDebug"

    invoke-interface {v0, p2, p0}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Lwu8;->g(Ljava/lang/String;)Lwu8;
...
.method public debugApiResponseOk(Lto;Lop;Lvu8;)Lvu8;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public debugIoException(Lto;Lop;Ljava/io/IOException;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ly3e;
    ...
    invoke-interface {p1, p2, p0, p3}, Ly3e;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
