...
.method private final getPosition(Ljava/lang/Long;)Lx1b;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lv1b;-><init>(J)V

    return-object p0

    :cond_1
    :goto_0
    sget-object p0, Lw1b;->a:Lw1b;
...
.method private static final sendActualState$lambda$0(Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;Lru/ok/android/externcalls/sdk/watch_together/listener/WatchTogetherListener;)V
    .locals 1
...
.method private final updateState(Ld2b;)V
    .locals 12
    ...
    iget-object p1, p1, Ld2b;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lc2b;->a:Lx52;

    iget-object v3, v3, Lx52;->b:Lyt1;
    ...
    iget-object v11, v3, Lx52;->c:Lu1b;
    ...
    sget-object v5, La2b;->$EnumSwitchMapping$1:[I
    ...
    :cond_3
    sget-object v3, Lz1b;->b:Lz1b;

    goto :goto_1

    :cond_4
    sget-object v3, Lz1b;->a:Lz1b;
    ...
    iget-object v9, v8, Lr1b;->d:Lz1b;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lr1b;->a:Lu1b;

    invoke-virtual {v8, v11}, Lu1b;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lc2b;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lx1b;

    move-result-object v5

    iget-boolean v2, v1, Lc2b;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lc2b;->b:F

    invoke-static {v7}, Lh2b;->a(F)V

    iget-boolean v8, v1, Lc2b;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lx1b;ZFZLr1b;Lj95;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Ldnf;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldnf;Lr1b;)V
...
.method public final onVideoStarted(Lb2b;)V
    .locals 12
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lx1b;ZFZLr1b;Lj95;)V
    ...
    iget-object p1, p1, Lb2b;->b:Ldnf;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldnf;Lr1b;)V
...
.method public final onVideoStatesUpdatedChanged(Ld2b;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Ld2b;)V
...
.method public final onVideoStopped(Le2b;)V
    .locals 4
    ...
    iget-object v2, p1, Le2b;->b:Ldnf;

    iget-object v3, p1, Le2b;->c:Lu1b;

    iget-object p1, p1, Le2b;->d:Lz1b;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldnf;Lu1b;Lz1b;)V
