...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lsbi;",
        "init",
        "(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Lfsb;Laf7;)V",
        "calls-sdk"
    }
    k = 0x1
    mv = {
...
.method public static synthetic a(Llb1;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$6(Laf7;)Ljava/lang/Boolean;
...
.method public static synthetic b(Llb1;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$8(Laf7;)Ljava/lang/Boolean;
...
.method public static synthetic c(Llb1;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$7(Laf7;)Ljava/lang/Boolean;
...
.method public static synthetic d(Llb1;)Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$2(Laf7;)Ljava/lang/Integer;
...
.method public static synthetic e(Llb1;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$5(Laf7;)Ljava/lang/Long;
...
.method public static synthetic f(Llb1;)Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$4(Laf7;)Ljava/lang/Integer;
...
.method public static synthetic g(Llb1;)Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$3(Laf7;)Ljava/lang/Integer;
...
.method public static synthetic h(Llb1;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$9(Laf7;)Ljava/lang/Boolean;
...
.method private static final init$lambda$2(Laf7;)Ljava/lang/Integer;
    .locals 0
...
.method private static final init$lambda$3(Laf7;)Ljava/lang/Integer;
    .locals 0
...
.method private static final init$lambda$4(Laf7;)Ljava/lang/Integer;
    .locals 0
...
.method private static final init$lambda$5(Laf7;)Ljava/lang/Long;
    .locals 0
...
.method private static final init$lambda$6(Laf7;)Ljava/lang/Boolean;
    .locals 0
...
.method private static final init$lambda$7(Laf7;)Ljava/lang/Boolean;
    .locals 0
...
.method private static final init$lambda$8(Laf7;)Ljava/lang/Boolean;
    .locals 0
...
.method private static final init$lambda$9(Laf7;)Ljava/lang/Boolean;
    .locals 0
...
# virtual methods
.method public final init(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Lfsb;Laf7;)V
    .locals 24
    ...
    invoke-direct {v4, v5}, Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;-><init>(Laf7;)V

    new-instance v0, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsLoggerImpl;

    move-object/from16 v5, p4

    invoke-direct {v0, v5}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsLoggerImpl;-><init>(Laf7;)V
    ...
    invoke-direct/range {v7 .. v23}, Lru/ok/android/externcalls/analytics/config/UploadConfig;-><init>(ILjava/util/concurrent/Executor;JJLaf7;Laf7;Laf7;Laf7;Laf7;Laf7;Laf7;Laf7;ILj95;)V

    move-object/from16 v1, p3

    invoke-direct {v3, v1, v4, v0, v7}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;-><init>(Lfsb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
