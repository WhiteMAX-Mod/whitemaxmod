...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "downloadModel",
        "(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lv7g;",
        "stage",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Lxj9;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Ly3e;Landroid/content/Context;Lru/ok/android/externcalls/sdk/ml/model/ModelSpec;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lxj9;
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Ly3e;
...
.method public static final synthetic access$downloadModel(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lv7g;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lv7g;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;)Ly3e;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Ly3e;
...
.method private final clearDir()V
    ...
    invoke-static {v3, v4}, Lwxl;->b(Ljava/io/File;Lcf7;)V
...
.method private final downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lv7g;
    .locals 5
    ...
    sget-object v4, Lwt7;->b:Lwt7;

    invoke-direct {v3, p1, v4}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;-><init>(Ljava/lang/String;Lwt7;)V

    invoke-interface {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/net/DownloadService;->download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lv7g;
    ...
    iget-object p1, p1, Lf17;->a:Lb17;

    invoke-direct {p0, p1}, Ld17;-><init>(Lb17;)V
    ...
    invoke-direct {p0, p1}, Lbag;-><init>(Lv7g;)V

    :goto_0
    new-instance p1, Lb17;

    invoke-direct {p1, p0, v1}, Lb17;-><init>(Lw07;Luv0;)V

    new-instance p0, Lf17;

    invoke-direct {p0, p1}, Lf17;-><init>(Lb17;)V
...
.method private final fetchConfig()Ldp9;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Ldp9;
...
.method private final fileName()Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lzo5;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final removeCurrentModel()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lxj9;
...
.method private final renameFiles(Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;)Lru/ok/android/externcalls/sdk/ml/stage/RenameStage;
    ...
    invoke-static {v12, v9, v5}, Lz5h;->G0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v2, v3}, Lwxl;->b(Ljava/io/File;Lcf7;)V
    ...
    invoke-static {v1, v0}, Lzo5;->m(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
...
.method private final saveNewModelInfo(Lru/ok/android/externcalls/sdk/ml/stage/RenameStage;)Lru/ok/android/externcalls/sdk/ml/stage/SaveNewModelInfoStage;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lxj9;
    ...
    invoke-virtual {v1, p0, v0}, Lsr;->X(Ljava/lang/String;Ljava/io/Serializable;)V
...
.method private final unzipModel(Lru/ok/android/externcalls/sdk/ml/stage/DownloadStage;)Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;
    ...
    invoke-static {v0, v1}, Liu6;->i(Ljava/io/File;Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v0}, Lwxl;->b(Ljava/io/File;Lcf7;)V
    ...
    invoke-static {p1, v1}, Lwxl;->b(Ljava/io/File;Lcf7;)V
...
.method private final validateCurrentModel()Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$MLModelValidationResult;
    ...
    invoke-virtual {v0, v1, v2}, Lsr;->y(Ljava/lang/String;Ljava/lang/Class;)Ljava/io/Serializable;
...
# virtual methods
.method public final checkModel()Lv7g;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->fetchConfig()Ldp9;
    ...
    invoke-direct {v3, v0, v1, v4}, Llp9;-><init>(Ldp9;Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, v3, v0, v2}, Llp9;-><init>(Ldp9;Ljava/lang/Object;I)V
    ...
    invoke-direct {p0, v1, v0, v2}, Lip9;-><init>(Ljava/lang/Object;Lsf7;I)V
...
.method public isModelValid(Ljava/io/File;)Z
    ...
    invoke-static {v2}, Llu6;->m0(Ljava/io/File;)Ljava/lang/String;
