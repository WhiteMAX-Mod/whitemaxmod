...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lnxe;Lesh;Laf7;Ljava/util/Set;Ljava/lang/Long;)V",
        "Lv7g;",
        "",
        "getSettings",
        "(Ljava/util/Set;)Lv7g;",
...
# instance fields
.field private volatile cachedSettingsSource:Lv7g;
...
.field private newSettings:Lv7g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lv7g;"
        }
...
.field private readSettingsDisposable:Lko5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Lnxe;Lesh;Laf7;Ljava/util/Set;Ljava/lang/Long;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->rxApiClient:Lnxe;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->timeProvider:Lesh;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Laf7;
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->createSettingsSource()Lv7g;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Lv7g;

    sget-object p1, Ll66;->a:Ll66;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettingsDisposable:Lko5;
    ...
    invoke-interface {p1, p2, p3}, Ly3e;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, p3}, Loie;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;I)V

    invoke-virtual {p1, p2}, Lz2f;->b(Ljava/lang/Runnable;)Lko5;

    :cond_0
    return-void
.end method

.method public synthetic constructor <init>(Lnxe;Lesh;Laf7;Ljava/util/Set;Ljava/lang/Long;ILj95;)V
    .locals 6
...
.method private static final _init_$lambda$0(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Lv7g;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettings-IoAF18A(Lv7g;)Ljava/lang/Object;
...
.method public static final synthetic access$applySettings(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;Lv7g;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->applySettings(Lv7g;)V
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)Laf7;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Laf7;
...
.method private final applySettings(Lv7g;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->newSettings:Lv7g;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Laf7;
    ...
    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->newSettings:Lv7g;
...
.method private final createSettingsSource()Lv7g;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->getSettings(Ljava/util/Set;)Lv7g;
...
.method private final getSettings(Ljava/util/Set;)Lv7g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->rxApiClient:Lnxe;
...
.method private final getSettingsSource()Lv7g;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->timeProvider:Lesh;
    ...
    :cond_1
    :goto_2
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Lv7g;

    return-object p0
.end method

.method private final readSettings-IoAF18A(Lv7g;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Laf7;
    ...
    :try_start_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettingsDisposable:Lko5;
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared$readSettings$1$1$1;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;Lv7g;)V
    ...
    invoke-virtual {p1, v1, v2}, Lv7g;->g(Lrg4;Lrg4;)Lo72;
...
.method private final scheduleCreateNewSettings()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Laf7;
    ...
    invoke-direct {v2, p0, v3}, Loie;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;I)V

    sget-object p0, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    const-wide/16 v3, 0x1388

    invoke-virtual {v1, v2, v3, v4, p0}, Lz2f;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lko5;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final scheduleCreateNewSettings$lambda$0$0(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)V
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettings-IoAF18A(Lv7g;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public get(Ljava/lang/String;)Lv7g;
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->getSettingsSource()Lv7g;
