...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/stereo/internal/command/StereoRoomCommandExecutor;Lqf7;Lcf7;Lru/ok/android/externcalls/sdk/stereo/internal/listener/StereoRoomListenerManagerImpl;Lesh;)V",
        "onSuccess",
        "",
        "onError",
        "loadHandsQueue",
...
.field private final getExternalId:Lcf7;
...
.field private final idsResolverHelper:Lqf7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqf7;"
        }
...
# direct methods
.method public constructor <init>(Lru/ok/android/externcalls/sdk/stereo/internal/command/StereoRoomCommandExecutor;Lqf7;Lcf7;Lru/ok/android/externcalls/sdk/stereo/internal/listener/StereoRoomListenerManagerImpl;Lesh;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->idsResolverHelper:Lqf7;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->getExternalId:Lcf7;
    ...
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->timeProvider:Lesh;
...
.method public static synthetic a(Lk62;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->onHandUp$lambda$0(Lk62;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Laf7;IZLjava/util/List;)Lsbi;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue$lambda$0(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Laf7;IZLjava/util/List;)Lsbi;
...
.method public static synthetic c(Lcf7;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadMoreElements$lambda$0(Lcf7;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
...
.method public static synthetic d(Ljava/util/List;Laf7;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue$lambda$0$1(Ljava/util/List;Laf7;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
...
.method private final loadHandsQueue(Laf7;Lcf7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v2, p1}, Lp8d;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v0, v1, p2}, Lru/ok/android/externcalls/sdk/stereo/internal/command/StereoRoomCommandExecutor;->getHandsQueue(Ltf7;Lcf7;)V

    return-void
.end method

.method public static synthetic loadHandsQueue$default(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Laf7;Lcf7;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue(Laf7;Lcf7;)V

    return-void
.end method

.method private static final loadHandsQueue$lambda$0(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Laf7;IZLjava/util/List;)Lsbi;
    .locals 2
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->idsResolverHelper:Lqf7;
    ...
    invoke-static {p3, v1}, Lyw3;->W0(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {p3, p4, p1, p0, v1}, Li8f;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-interface {p2, v0, p3}, Lqf7;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final loadHandsQueue$lambda$0$1(Ljava/util/List;Laf7;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
    .locals 5
    ...
    iget-object v1, p2, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->getExternalId:Lcf7;

    iget-object v2, v0, Lh62;->b:Lyt1;
...
.method private static final loadMoreElements$lambda$0(Lcf7;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
    .locals 0
...
.method private static final onHandUp$lambda$0(Lk62;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lsbi;
    .locals 5

    iget-object v0, p0, Lk62;->c:Ljava/util/List;
    ...
    iget-object v2, p1, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->getExternalId:Lcf7;

    invoke-interface {v2, v1}, Lcf7;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, p1, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->timeProvider:Lesh;
    ...
    :cond_1
    iget-object v0, p0, Lk62;->b:Ljava/util/List;
...
.method public loadMoreElements(Lcf7;Lcf7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, p2}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue(Laf7;Lcf7;)V
...
.method public final onHandUp(Lk62;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->idsResolverHelper:Lqf7;

    iget-object v1, p1, Lk62;->b:Ljava/util/List;

    check-cast v1, Ljava/util/Collection;

    iget-object v2, p1, Lk62;->c:Ljava/util/List;
    ...
    invoke-direct {v2, p1, v3, p0}, Lxre;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
