...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Laf7;Litj;Lru/ok/android/externcalls/sdk/Conversation$CallType;Lesh;Ly3e;ZZ)V",
        "Lsbi;",
        "release",
        "()V",
...
# direct methods
.method public constructor <init>(Laf7;Litj;Lru/ok/android/externcalls/sdk/Conversation$CallType;Lesh;Ly3e;ZZ)V
    .locals 1
    ...
    invoke-direct {v0, p4, p1}, Lru/ok/android/externcalls/sdk/stat/connect/ConversationConnectedToSignalingStat;-><init>(Lesh;Laf7;)V
    ...
    invoke-direct {v0, p4, p1}, Lru/ok/android/externcalls/sdk/stat/warmup/ConversationPreparedStat;-><init>(Lesh;Laf7;)V
    ...
    invoke-direct {v0, p3, p4, p1}, Lru/ok/android/externcalls/sdk/stat/start/ConversationStartedStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;Lesh;Laf7;)V
    ...
    invoke-direct {v0, p1, p4, p5, p7}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;-><init>(Laf7;Lesh;Ly3e;Z)V
    ...
    invoke-direct {p7, p1}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;-><init>(Laf7;)V
    ...
    invoke-direct {p7, p3, p6, p1}, Lru/ok/android/externcalls/sdk/stat/init/CallInitStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;ZLaf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidatePairChangedStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/icerestart/IceRestartStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1, p4}, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;-><init>(Laf7;Lesh;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/connection/PeerConnectionChangedStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/negotiation/NegotiationErrorStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/p2prelay/P2PRelayRequestedStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/accept/AcceptCallStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/audio/AudioErrorStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateGatheringFailedStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateAddFailedStat;-><init>(Laf7;)V
    ...
    invoke-direct {p3, p2, p5, p4, p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;-><init>(Litj;Ly3e;Lesh;Laf7;)V
