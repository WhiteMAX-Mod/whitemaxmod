...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(La4e;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Lfqb;",
        "observeStat",
        "()Lfqb;",
        "rtcStat",
...
.field private final statSubject:Lsv0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Ly3e;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Ly3e;

    new-instance p1, Lsv0;

    invoke-direct {p1}, Lsv0;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lsv0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ly3e;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Ly3e;

    return-object p0
.end method

.method private final mapToMonitoringStat(La4e;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILj95;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Lpk2;->h:Ljava/lang/Double;
    ...
    :goto_0
    iget-object p1, p1, La4e;->b:Ljava/util/List;

    invoke-static {p1, v0}, Lgrl;->d(Ljava/util/List;Lpk2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ly3e;
    ...
    :cond_6
    iget-object v4, v5, Lcgg;->i:Ljava/math/BigInteger;

    iget-object v5, v5, Lcgg;->h:Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ly3e;
    ...
    :cond_b
    iget-object p1, v5, Lcgg;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Lcgg;->h:Ljava/math/BigInteger;
    ...
    :goto_6
    iget-object p1, v0, Lpk2;->b:Ljava/lang/String;
...
# virtual methods
.method public observeStat()Lfqb;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lsv0;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v0, Lzqb;

    invoke-direct {v0, p0}, Ly2;-><init>(Lfqb;)V

    return-object v0
.end method

.method public onRtcStats(La4e;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(La4e;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    ...
    invoke-virtual {p0, p1}, Lsv0;->d(Ljava/lang/Object;)V
