...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lv7g;",
        "Ly3e;",
        "Companion",
        "calls-sdk"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lj95;)V
...
.method public constructor <init>(Ly3e;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ly3e;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lb8g;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$0(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lf8g;)V

    return-void
.end method

.method private static final download$lambda$0(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lf8g;)V
    .locals 8
    ...
    invoke-virtual {p2, v0}, Lb8g;->d(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Lwt7;
    ...
    invoke-virtual {p2, p3}, Lb8g;->a(Ljava/lang/Object;)V
    ...
    :goto_6
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ly3e;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lqv1;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :try_start_d
    invoke-static {v4}, Liu6;->b(Ljava/io/File;)V
    :try_end_d
    ...
    invoke-static {v2, p0}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$0$3(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljava/lang/String;)Lsbi;

    :goto_7
    check-cast p4, Lb8g;

    invoke-virtual {p4}, Lb8g;->b()Z

    move-result p0

    if-nez p0, :cond_7

    invoke-virtual {p4, p2}, Lb8g;->d(Ljava/lang/Throwable;)Z
...
.method private static final download$lambda$0$3(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Ljava/lang/String;)Lsbi;
    .locals 1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ly3e;
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v1, p0, p3}, Lwki;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v4, p2}, Liu6;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lv7g;
    .locals 1
