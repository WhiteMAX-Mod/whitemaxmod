...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, p1}, Lckc;-><init>(Ljava/io/OutputStream;)V
...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/Writer;)V
    ...
    invoke-direct {v0, p1}, Lh2d;-><init>(Ljava/io/Writer;)V

    .line 22
    invoke-static {p0, v0}, Lru/ok/android/onelog/ItemDumper;->dump(Lru/ok/android/onelog/OneLogItem;Lmv8;)V

    .line 23
    invoke-virtual {v0}, Lh2d;->flush()V

    return-void
.end method

.method public static dump(Lru/ok/android/onelog/OneLogItem;Lmv8;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1, p0}, Lru/ok/android/onelog/OneLogItemSerializer;->serialize(Lmv8;Lru/ok/android/onelog/OneLogItem;)V
