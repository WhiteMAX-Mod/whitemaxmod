...
.method public synthetic constructor <init>(Ljava/lang/String;ILjava/lang/String;IJLjava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;I)V
    .locals 0
...
.method private buildNetworkClass()Ljava/lang/String;
    ...
    iget-object p0, p0, Lru/ok/android/onelog/OneLogItem$Builder;->network:Ljava/lang/String;

    return-object p0

    :cond_0
    sget-object p0, Lru/ok/android/onelog/OneLogItem$Builder;->networkClassProvider:Lru/ok/android/onelog/NetworkClassProvider;

    if-eqz p0, :cond_1

    invoke-interface {p0}, Lru/ok/android/onelog/NetworkClassProvider;->getNetworkClass()Ljava/lang/String;
...
.method private buildUserId()Ljava/lang/String;
    ...
    iget-object p0, p0, Lru/ok/android/onelog/OneLogItem$Builder;->uid:Ljava/lang/String;

    return-object p0

    :cond_0
    sget-object p0, Lru/ok/android/onelog/OneLogItem$Builder;->userIdProvider:Lru/ok/android/onelog/UserIdProvider;

    if-eqz p0, :cond_1

    invoke-interface {p0}, Lru/ok/android/onelog/UserIdProvider;->getUserId()Ljava/lang/String;
...
.method private static withParam(Ljava/util/ArrayList;ILjava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, p0}, Lqv1;->f(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method public build()Lru/ok/android/onelog/OneLogItem;
    ...
    invoke-direct/range {v0 .. v13}, Lru/ok/android/onelog/OneLogItem;-><init>(Ljava/lang/String;ILjava/lang/String;IJLjava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;I)V
