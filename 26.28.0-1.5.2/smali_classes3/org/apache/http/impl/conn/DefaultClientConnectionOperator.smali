...
.method public updateSecureConnection(Lorg/apache/http/conn/OperatedClientConnection;Lorg/apache/http/HttpHost;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/params/HttpParams;)V
    ...
    const-string p1, ") must have layered socket factory."

    const-string p2, "Target scheme ("

    invoke-static {p0, p1, p2}, Lc;->f(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;)V

    return-void

    :cond_1
    const-string p0, "Connection must be open."
    ...
    :cond_4
    const-string p0, "Connection must not be null."
