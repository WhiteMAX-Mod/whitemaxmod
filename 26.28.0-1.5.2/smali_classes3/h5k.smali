...
.method public final b(Lz7k;Lpbk;Lc4h;)V
    ...
    iget-object p1, p1, Lz7k;->o:Lmak;

    monitor-enter p1

    :try_start_0
    iget-wide p2, p0, Lh5k;->b:J

    iget-wide v0, p1, Lmak;->e:J

    cmp-long p0, p2, v0

    if-lez p0, :cond_1

    iget-wide v2, p1, Lmak;->f:J
    ...
    :goto_0
    iput-wide p2, p1, Lmak;->e:J

    if-eqz p0, :cond_1

    iget-object p0, p1, Lmak;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p2, Lma4;

    const/4 p3, 0x6

    invoke-direct {p2, p3, p1}, Lma4;-><init>(ILjava/lang/Object;)V
