...
.method public constructor <init>(Lfx5;)V
    ...
    iput-object v0, p0, Lfe5;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lfe5;->f:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lfe5;->g:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lfe5;->h:Ljava/util/LinkedHashMap;

    iput v1, p0, Lfe5;->i:I

    iput-boolean v1, p0, Lfe5;->j:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lfe5;->k:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lfe5;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lfe5;->d:Landroid/os/Handler;

    new-instance v0, Lus7;

    invoke-direct {v0, v1}, Lus7;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lfe5;->c:Lus7;

    new-instance v0, Lpp5;

    invoke-direct {v0}, Lpp5;-><init>()V

    iput-object v0, p0, Lfe5;->a:Lpp5;

    :try_start_0
    invoke-virtual {p0, p1}, Lfe5;->h(Lfx5;)V
    :try_end_0
    ...
    invoke-virtual {p0}, Lfe5;->release()V
...
.method public final a()V
    ...
    iget-object v0, p0, Lfe5;->h:Ljava/util/LinkedHashMap;
    ...
    :cond_0
    iget-object v1, p0, Lfe5;->k:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lr72;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lfe5;->a:Lpp5;

    invoke-virtual {v0}, Lpp5;->q()V

    iget-object p0, p0, Lfe5;->b:Landroid/os/HandlerThread;
...
.method public final c(II)Le89;
    ...
    invoke-direct {v3, p1, p2, v1}, Ldh0;-><init>(IILr72;)V

    new-instance p1, Lf92;

    const/16 p2, 0x1b

    invoke-direct {p1, p0, p2, v3}, Lf92;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Ljj2;

    const/16 v3, 0x13

    invoke-direct {p2, v3, v1}, Ljj2;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p0, p1, p2}, Lfe5;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final d(Lcch;)V
    ...
    iget-object v0, p0, Lfe5;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, v0, v1}, Lfe5;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final f(Ljava/lang/Exception;)V
    ...
    iget-object p0, p0, Lfe5;->k:Ljava/util/ArrayList;
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lwqk;->a([FF)V

    invoke-static {v1}, Lwqk;->b([F)V

    move-object/from16 v2, p1

    invoke-static {v0, v2}, Ly1i;->h(ILandroid/util/Size;)Landroid/util/Size;

    move-result-object v0

    move-object/from16 v2, p0

    iget-object v2, v2, Lfe5;->a:Lpp5;
    ...
    invoke-static {v5, v4}, Lqyj;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v5}, Lxg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v14}, Lxg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lxg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lxg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lxg7;->b(Ljava/lang/String;)V
    ...
    iput-object v5, v2, Lpp5;->j:Ljava/lang/Object;
    ...
    iget-object v5, v2, Lpp5;->l:Ljava/lang/Object;

    check-cast v5, Lvg7;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v9, v5, Lwg7;
    ...
    invoke-static {v3}, Lxg7;->b(Ljava/lang/String;)V
...
.method public final h(Lfx5;)V
    ...
    invoke-direct {v3, p0, p1, v1}, Li0;-><init>(Lfe5;Lfx5;Lr72;)V

    new-instance p1, Lce5;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    invoke-virtual {p0, v3, p1}, Lfe5;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final i(Le5i;)V
    .locals 11

    iget-object v0, p0, Lfe5;->k:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, Lfe5;->f(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Le5i;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Le5i;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lfe5;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Le5i;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Ldh0;->c:Lr72;

    invoke-virtual {v8, v3}, Lr72;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lfe5;->f:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lfe5;->h:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lfe5;->g:[F

    const/4 v6, 0x1

    invoke-virtual {v3, v5, v0, v6}, Lcch;->y([F[FZ)V
    ...
    :try_start_0
    iget-object v3, p0, Lfe5;->a:Lpp5;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lpp5;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v7, v8}, Lqyj;->l(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v6}, Lqyj;->l(Ljava/lang/String;Z)V

    new-instance v2, Le5i;

    iget-object v3, v3, Lcch;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Le5i;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lfe5;->i(Le5i;)V
    :try_end_1
