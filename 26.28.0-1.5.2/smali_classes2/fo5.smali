...
# static fields
.field public static final g:Ldul;
...
.field public static volatile k:Lfo5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfo5;->h:Landroid/util/Size;
    ...
    sput-object v0, Lfo5;->i:Landroid/util/Size;
    ...
    sput-object v0, Lfo5;->j:Landroid/util/Size;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lfo5;->b:Lvn7;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lfo5;->c:Ljava/lang/Object;

    new-instance v0, Leo5;

    const/4 v1, 0x0

    invoke-direct {v0, v1, p0}, Leo5;-><init>(ILjava/lang/Object;)V
    ...
    iput-object p1, p0, Lfo5;->e:Landroid/hardware/display/DisplayManager;
...
.method public final a()Landroid/util/Size;
    ...
    invoke-virtual {p0, v1}, Lfo5;->b(Z)Landroid/view/Display;
    ...
    sget-object v2, Lfo5;->i:Landroid/util/Size;
    ...
    sget-object v0, Lfo5;->j:Landroid/util/Size;
    ...
    :cond_3
    sget-object v0, Lfo5;->h:Landroid/util/Size;

    invoke-static {v0}, Lmag;->a(Landroid/util/Size;)I
    ...
    :cond_5
    sget-object p0, Lsbh;->a:Lsbh;

    invoke-static {p0}, Landroidx/camera/camera2/compat/quirk/ExtraCroppingQuirk;->e(Lsbh;)Landroid/util/Size;
...
.method public final b(Z)Landroid/view/Display;
    ...
    :try_start_0
    iget-object v1, p0, Lfo5;->d:[Landroid/view/Display;
    :try_end_0
    ...
    :cond_0
    :try_start_1
    iget-object v1, p0, Lfo5;->e:Landroid/hardware/display/DisplayManager;

    invoke-virtual {v1}, Landroid/hardware/display/DisplayManager;->getDisplays()[Landroid/view/Display;

    move-result-object v1

    iput-object v1, p0, Lfo5;->d:[Landroid/view/Display;
    :try_end_1
    ...
    invoke-static {v0, p1, p0}, Lo75;->f(ILjava/lang/Object;Ljava/lang/String;)V
...
.method public final c()Landroid/util/Size;
    ...
    :try_start_0
    iget-object v1, p0, Lfo5;->f:Landroid/util/Size;

    if-eqz v1, :cond_0

    iget-object p0, p0, Lfo5;->f:Landroid/util/Size;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0}, Lfo5;->a()Landroid/util/Size;

    move-result-object v1

    iput-object v1, p0, Lfo5;->f:Landroid/util/Size;
