...
.method public static c(ILandroid/os/Bundle;Ly3f;I)Ljc4;
    .locals 1
    ...
    invoke-static {v0, p1, p2, p3}, Lmol;->a(Lynh;Landroid/os/Bundle;Ly3f;I)Ljc4;
...
.method public static d(Landroid/widget/TextView;Lnoh;La8g;Landroid/widget/TextView;)Ldbc;
    .locals 0

    invoke-static {p1, p0}, Lq9i;->a(Lnoh;Landroid/widget/TextView;)V

    invoke-virtual {p2, p3}, La8g;->h(Landroid/view/View;)Lkbc;
...
.method public static g(Ljava/lang/Class;Lz30;)Ljava/util/HashMap;
    .locals 1
...
.method public static i(Lh1b;)V
    .locals 6

    iget-object v0, p0, Lh1b;->a:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {p0}, Lh1b;->shutdown()V
    ...
    invoke-virtual {p0}, Lh1b;->shutdownNow()Ljava/util/List;
...
.method public static k(ZLlve;ZLjava/lang/String;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Llve;->c(Lgr4;)V

    new-instance p0, Lr7g;

    invoke-direct {p0, p2}, Lr7g;-><init>(Z)V

    invoke-virtual {p1, p0}, Llve;->a(Lgr4;)V

    invoke-virtual {p1, p3}, Llve;->e(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic l(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Lp41;Lgcf;Lgcf;)Z
    .locals 1
