...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lox5;->b:Landroid/graphics/Path;
    ...
    iput-object v1, p0, Lox5;->c:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lox5;->d:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lox5;->e:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0, p1}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v0, p0, Lox5;->f:Landroid/graphics/Path;
...
.method public final getStrokeWidthPx()F
    ...
    sget-object v0, Lox5;->g:[Lzv8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, Lox5;->a:Lzb;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lox5;->b:Landroid/graphics/Path;

    iget-object v2, p0, Lox5;->d:Landroid/graphics/RectF;
    ...
    iget-object v8, p0, Lox5;->e:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lox5;->c:Landroid/graphics/Paint;
    ...
    :cond_0
    iget-object p0, p0, Lox5;->f:Landroid/graphics/Path;
