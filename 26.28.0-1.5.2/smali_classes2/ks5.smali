...
# static fields
.field public static final h:Ltme;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lks5;->h:Ltme;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lm35;Lj6g;Ls25;Ljava/util/concurrent/ExecutorService;)V
    .locals 3

    new-instance v0, Ly95;

    invoke-direct {v0, p2}, Ly95;-><init>(Lm35;)V
    ...
    iput-object p3, v1, Lj71;->a:Lj6g;

    iput-object p4, v1, Lj71;->f:Ls25;

    invoke-direct {p2, v1, p5}, Lxtj;-><init>(Lj71;Ljava/util/concurrent/Executor;)V
    ...
    iput-boolean p3, p0, Lks5;->d:Z

    sget-object p4, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p4, p0, Lks5;->g:Ljava/util/List;
    ...
    iput-object p4, p0, Lks5;->b:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p4, Lw84;

    const/4 p5, 0x3

    invoke-direct {p4, p5, p0}, Lw84;-><init>(ILjava/lang/Object;)V

    invoke-static {p4}, Lvqi;->q(Landroid/os/Handler$Callback;)Landroid/os/Handler;
    ...
    invoke-direct {v1, p5, v0, p2, p4}, Lis5;-><init>(Landroid/os/HandlerThread;Ly95;Lxtj;Landroid/os/Handler;)V

    iput-object v1, p0, Lks5;->a:Lis5;

    new-instance p2, Ls63;

    const/16 p4, 0x12

    invoke-direct {p2, p4, p0}, Ls63;-><init>(ILjava/lang/Object;)V

    new-instance p4, Lake;

    invoke-direct {p4, p1, p2}, Lake;-><init>(Landroid/content/Context;Ls63;)V

    iget-object p1, p4, Lake;->d:Ljava/lang/Object;

    check-cast p1, Ltme;

    iget-object p2, p4, Lake;->b:Ljava/lang/Object;

    check-cast p2, Landroid/content/Context;

    invoke-virtual {p1, p2}, Ltme;->a(Landroid/content/Context;)I
    ...
    invoke-direct {v2, p4}, Lvme;-><init>(Lake;)V

    iput-object v2, p4, Lake;->f:Ljava/lang/Object;
    ...
    invoke-direct {p1, v0, p4}, Lcg;-><init>(ILjava/lang/Object;)V

    iget-object v0, p4, Lake;->e:Ljava/lang/Object;
...
.method public final a()V
    ...
    iget-object p0, p0, Lks5;->b:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, Lks5;->g:Ljava/util/List;
