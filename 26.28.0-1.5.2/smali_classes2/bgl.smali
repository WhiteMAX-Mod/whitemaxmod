...
.method public static c(Ly61;)[B
    ...
    invoke-virtual {p0, v7, v8, v9}, Ly61;->read([BII)I

    move-result v9

    if-ne v9, v5, :cond_0

    invoke-static {v0, v4}, Lbgl;->a(Ljava/util/ArrayDeque;I)[B
    ...
    :cond_5
    invoke-virtual {p0}, Ly61;->read()I

    move-result p0

    if-ne p0, v5, :cond_6

    invoke-static {v0, v6}, Lbgl;->a(Ljava/util/ArrayDeque;I)[B
