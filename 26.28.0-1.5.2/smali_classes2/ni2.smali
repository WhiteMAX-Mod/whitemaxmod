...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, Lfo5;->g:Ldul;

    invoke-virtual {v0, p1}, Ldul;->z(Landroid/content/Context;)Lfo5;

    move-result-object v0

    iput-object v0, p0, Lni2;->b:Lfo5;
...
# virtual methods
.method public final a(Lemi;I)Lt94;
    .locals 31
    ...
    :cond_2
    invoke-static {v13}, Luk5;->a(Ljava/lang/Class;)Lo2e;
    ...
    new-instance v17, Lhl2;

    new-instance v10, Ljava/util/ArrayList;

    invoke-direct {v10, v4}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    invoke-static {v5}, Ldhc;->a(Lt94;)Ldhc;
    ...
    invoke-direct {v6, v5}, Lghh;-><init>(Landroid/util/ArrayMap;)V
    ...
    invoke-direct/range {v17 .. v22}, Lhl2;-><init>(Ljava/util/ArrayList;Ldhc;ILjava/util/ArrayList;Lghh;)V
    ...
    invoke-direct/range {v21 .. v30}, Llmf;-><init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Lhl2;Ljmf;Landroid/hardware/camera2/params/InputConfiguration;ILui0;)V

    move-object/from16 v1, v21

    invoke-virtual {v2, v11, v1}, Lw8b;->m(Lbh0;Ljava/lang/Object;)V
    ...
    iget-object v5, v5, Lghh;->a:Landroid/util/ArrayMap;
    ...
    invoke-direct {v11, v1}, Lghh;-><init>(Landroid/util/ArrayMap;)V

    invoke-direct/range {v6 .. v11}, Lhl2;-><init>(Ljava/util/ArrayList;Ldhc;ILjava/util/ArrayList;Lghh;)V

    invoke-virtual {v2, v12, v6}, Lw8b;->m(Lbh0;Ljava/lang/Object;)V

    sget-object v1, Lcmi;->Y0:Lbh0;

    sget-object v3, Lemi;->a:Lemi;

    if-ne v0, v3, :cond_d

    sget-object v3, Lli2;->b:Lli2;
    ...
    iget-object v3, v3, Lni2;->b:Lfo5;

    if-ne v0, v1, :cond_e

    invoke-virtual {v3}, Lfo5;->c()Landroid/util/Size;
    ...
    sget-object v1, Lfo5;->g:Ldul;

    const/4 v7, 0x1

    invoke-virtual {v3, v7}, Lfo5;->b(Z)Landroid/view/Display;
