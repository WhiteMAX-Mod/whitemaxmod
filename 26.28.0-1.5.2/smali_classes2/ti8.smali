...
.method public static c(JLjava/nio/ByteBuffer;)I
    ...
    invoke-static {p0, p2}, Lti8;->a(ILjava/nio/ByteBuffer;)I
...
.method public static d(Ljava/io/InputStream;)I
    ...
    invoke-static {p0}, Lti8;->g(Ljava/io/InputStream;)J
...
.method public static e(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {p0}, Lti8;->h(Ljava/nio/ByteBuffer;)J
...
.method public static i(Landroid/view/View;Landroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-static {p0}, Lh7j;->a(Landroid/view/View;)Lh7j;

    move-result-object p0

    iget-object v0, p0, Lh7j;->c:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, p0, Lh7j;->c:Ljava/lang/ref/WeakReference;
...
.method public static j(Lgw8;Landroid/view/View;Landroid/view/Window$Callback;Landroid/view/KeyEvent;)Z
    .locals 7
    ...
    invoke-interface {p0, p3}, Lgw8;->a(Landroid/view/KeyEvent;)Z
    ...
    sput-object v1, Lti8;->f:Ljava/lang/reflect/Method;
    :try_end_0
    .catch Ljava/lang/NoSuchMethodException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    sput-boolean v5, Lti8;->e:Z

    :cond_2
    sget-object v1, Lti8;->f:Ljava/lang/reflect/Method;
    ...
    invoke-virtual {p1, p0, p3}, Lh7j;->b(Landroid/view/View;Landroid/view/KeyEvent;)Z
    ...
    sput-object p0, Lti8;->h:Ljava/lang/reflect/Field;
    ...
    :catch_2
    sput-boolean v5, Lti8;->g:Z

    :cond_b
    sget-object p0, Lti8;->h:Ljava/lang/reflect/Field;
    ...
    :cond_13
    invoke-static {p1}, Lh7j;->a(Landroid/view/View;)Lh7j;

    move-result-object p2

    invoke-virtual {p2, p1, p3}, Lh7j;->b(Landroid/view/View;Landroid/view/KeyEvent;)Z
...
.method public static declared-synchronized k(Landroid/content/Context;)Z
    ...
    sget-object v1, Lti8;->a:Landroid/content/Context;

    if-eqz v1, :cond_0

    sget-object v2, Lti8;->b:Ljava/lang/Boolean;
    ...
    :try_start_1
    sput-object v1, Lti8;->b:Ljava/lang/Boolean;
    ...
    sput-object p0, Lti8;->a:Landroid/content/Context;
...
.method public static l(IIJZZ)D
    .locals 6
    ...
    invoke-static {p1, p2, p3, p4}, Lti8;->m(IJZ)D
    ...
    invoke-static {p0, p2, p3, p4}, Lti8;->m(IJZ)D
...
.method public static m(IJZ)D
    ...
    invoke-static {p1, p2, v0, v1}, Lhl6;->e(JJ)J
...
.method public static n(JJJZZ)D
    .locals 4
    ...
    :cond_0
    const-wide/16 p4, -0x3fe

    cmp-long p4, p4, p2

    if-gtz p4, :cond_3

    const-wide/16 p4, 0x3ff
    ...
    const-wide/high16 p0, 0x43f0000000000000L    # 1.8446744073709552E19
