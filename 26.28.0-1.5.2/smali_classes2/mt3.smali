...
# direct methods
.method public constructor <init>(Lush;JJZ)V
    .locals 6
    ...
    invoke-virtual {p1, v2, v1, v4, v5}, Lush;->m(ILtsh;J)Ltsh;
    ...
    :cond_6
    iput-wide p2, p0, Lmt3;->f:J

    iput-wide p4, p0, Lmt3;->g:J
    ...
    :goto_3
    iput-wide p2, p0, Lmt3;->h:J

    iget-boolean p1, p1, Ltsh;->h:Z
...
.method public final f(ILrsh;Z)Lrsh;
    ...
    iget-object v2, p0, Lna7;->e:Lush;

    const/4 v3, 0x0

    invoke-virtual {v2, v3, p2, p3}, Lush;->f(ILrsh;Z)Lrsh;

    iget-wide v2, p2, Lrsh;->e:J

    iget-wide v4, p0, Lmt3;->f:J

    sub-long v6, v2, v4

    iget-wide v2, p0, Lmt3;->h:J
    ...
    :goto_0
    iget-object v0, p2, Lrsh;->a:Ljava/lang/Object;

    iget-object v2, p2, Lrsh;->b:Ljava/lang/Object;
...
.method public final m(ILtsh;J)Ltsh;
    ...
    iget-wide p3, p2, Ltsh;->o:J

    iget-wide v0, p0, Lmt3;->f:J

    add-long/2addr p3, v0

    iput-wide p3, p2, Ltsh;->o:J

    iget-wide p3, p0, Lmt3;->h:J

    iput-wide p3, p2, Ltsh;->l:J

    iget-boolean p1, p0, Lmt3;->i:Z

    iput-boolean p1, p2, Ltsh;->h:Z

    iget-wide p3, p2, Ltsh;->k:J
    ...
    iput-wide p3, p2, Ltsh;->k:J

    iget-wide p0, p0, Lmt3;->g:J
    ...
    iput-wide p3, p2, Ltsh;->d:J

    :cond_2
    iget-wide p3, p2, Ltsh;->e:J
