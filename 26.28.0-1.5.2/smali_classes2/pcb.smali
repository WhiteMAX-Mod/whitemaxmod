...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lpcb;->a:Landroid/content/Context;
...
.method public final a()Lmcb;
    ...
    invoke-static {v0, v5}, Lpcb;->b(Landroid/os/health/HealthStats;I)J

    move-result-wide v5

    const/16 v7, 0x2741

    invoke-static {v0, v7}, Lpcb;->b(Landroid/os/health/HealthStats;I)J

    move-result-wide v7

    const/16 v9, 0x2728

    invoke-static {v0, v9}, Lpcb;->b(Landroid/os/health/HealthStats;I)J

    move-result-wide v9

    invoke-direct/range {v4 .. v10}, Locb;-><init>(JJJ)V

    new-instance v5, Locb;

    const/16 v6, 0x2742

    invoke-static {v0, v6}, Lpcb;->b(Landroid/os/health/HealthStats;I)J

    move-result-wide v6

    const/16 v8, 0x2743

    invoke-static {v0, v8}, Lpcb;->b(Landroid/os/health/HealthStats;I)J

    move-result-wide v8

    const/16 v10, 0x2720

    invoke-static {v0, v10}, Lpcb;->b(Landroid/os/health/HealthStats;I)J

    move-result-wide v10

    invoke-direct/range {v5 .. v11}, Locb;-><init>(JJJ)V

    invoke-direct {v3, v4, v5}, Lncb;-><init>(Locb;Locb;)V
    :try_end_0
    ...
    iget-object v4, p0, Lpcb;->b:Ljava/lang/String;
    ...
    invoke-virtual {v5, v1, v4, v6, v0}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_1
    iget-object v0, p0, Lpcb;->a:Landroid/content/Context;
    ...
    invoke-direct/range {v6 .. v12}, Locb;-><init>(JJJ)V
    ...
    invoke-direct/range {v7 .. v13}, Locb;-><init>(JJJ)V

    invoke-direct {v5, v6, v7}, Lncb;-><init>(Locb;Locb;)V
    :try_end_1
    ...
    iget-object v6, p0, Lpcb;->b:Ljava/lang/String;
    ...
    invoke-virtual {v7, v1, v6, v8, v0}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object p0, p0, Lpcb;->b:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, p0, v1, v4}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, v3, v5}, Lmcb;-><init>(Lncb;Lncb;)V
