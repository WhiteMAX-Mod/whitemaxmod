...
.method public constructor <init>(Landroid/content/Context;Lum4;Lkp0;)V
    ...
    invoke-direct {v0, p1}, Ly8j;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {p1, p2, p3}, Lvm4;-><init>(Lum4;Lkp0;)V

    iput-object p1, p0, Lmp0;->v:Lvm4;
    ...
    invoke-virtual {v0, p1}, Ly8j;->setOrientation(I)V

    const/4 p2, 0x2

    invoke-virtual {v0, p2}, Ly8j;->setOffscreenPageLimit(I)V
    ...
    invoke-virtual {v0, p1}, Ly8j;->setPageTransformer(Lu8j;)V

    new-instance p1, Lwy7;

    invoke-direct {p1, p2, p0}, Lwy7;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, p1}, Ly8j;->e(Lt8j;)V
...
.method public final bridge synthetic B(Lk79;)V
    ...
    invoke-virtual {p0, p1}, Lmp0;->H(Lbp0;)V

    return-void
.end method

.method public final H(Lbp0;)V
    .locals 4

    iget-object p1, p1, Lbp0;->b:Ljava/util/List;
    ...
    iget-object v1, p0, Lmp0;->v:Lvm4;

    invoke-virtual {v1, p1, v0}, Ly69;->I(Ljava/util/List;Ljava/lang/Runnable;)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Ly8j;->setUserInputEnabled(Z)V
