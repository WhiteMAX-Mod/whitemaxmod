...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/Collection;Llsa;ZLk01;Lmsa;Ljava/util/concurrent/ExecutorService;Llsa;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ltda;->a:Landroid/content/Context;

    iput-object p2, p0, Ltda;->b:Ljava/util/Collection;

    iput-object p3, p0, Ltda;->c:Llsa;

    iput-boolean p4, p0, Ltda;->d:Z

    iput-object p5, p0, Ltda;->e:Lk01;

    iput-object p6, p0, Ltda;->f:Lmsa;

    iput-object p7, p0, Ltda;->g:Ljava/util/concurrent/ExecutorService;

    new-instance p1, Llda;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Llda;-><init>(Ltda;I)V
    ...
    iput-object p1, p0, Ltda;->m:Lny8;

    new-instance p1, Llda;

    const/4 p3, 0x1

    invoke-direct {p1, p0, p3}, Llda;-><init>(Ltda;I)V

    invoke-static {p2, p1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object p1

    iput-object p1, p0, Ltda;->n:Lny8;

    new-instance p1, Lvx9;

    const/4 p3, 0x4

    invoke-direct {p1, p0, p3, p8}, Lvx9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {p2, p1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object p1

    iput-object p1, p0, Ltda;->o:Lny8;
...
.method public final b()Lkda;
    .locals 0

    iget-object p0, p0, Ltda;->n:Lny8;
...
.method public final d()Landroid/view/View;
    ...
    iget-object v1, p0, Ltda;->a:Landroid/content/Context;
    ...
    invoke-static {v6, v5}, Loc9;->Z(ILkbc;)I
    ...
    invoke-direct {v7, v3, v5, v1}, Lnda;-><init>(Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v7}, La8g;->h(Landroid/view/View;)Lkbc;
    ...
    invoke-static {v8, v10, v12, v11}, Lcol;->c(ILandroid/graphics/drawable/Drawable;Landroid/graphics/drawable/ShapeDrawable;I)Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-direct {v3, p0, v2}, Lmda;-><init>(Ltda;I)V

    invoke-static {v7, v3}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v3, v7}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Lvee;)V

    iget-object v7, p0, Ltda;->o:Lny8;
    ...
    invoke-virtual {v3, v7}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lnee;)V
    ...
    invoke-virtual {v3, v12}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lsee;)V

    iput-object v3, p0, Ltda;->i:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {v3, v1, v2}, Lbq4;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Ltda;->h:Lpda;

    return-object v0
.end method

.method public final e()Lqda;
    .locals 9
    ...
    invoke-static {v4, v3}, Loc9;->Z(ILkbc;)I
    ...
    iput-object v3, p0, Ltda;->l:Landroid/widget/TextView;
    ...
    invoke-direct {v5, v0, v3, v4, v1}, Lqda;-><init>(Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/ImageView;Landroid/content/Context;)V
    ...
    invoke-static {v1, v7, v2, v8}, Lcol;->c(ILandroid/graphics/drawable/Drawable;Landroid/graphics/drawable/ShapeDrawable;I)Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-direct {v0, p0, v1}, Lmda;-><init>(Ltda;I)V

    invoke-static {v5, v0}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V
...
.method public final f(I)V
    ...
    invoke-virtual {p0}, Ltda;->d()Landroid/view/View;
    ...
    iput-object v2, v1, Lr2i;->d:Landroid/animation/TimeInterpolator;

    invoke-virtual {p0}, Ltda;->b()Lkda;

    move-result-object v2

    invoke-virtual {v1, v2}, Lr2i;->b(Landroid/view/View;)V

    invoke-static {v1, p1}, Lx2i;->a(Lr2i;Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p1, v0, v0, p0}, Lsda;-><init>(Landroid/view/View;Landroid/view/View;I)V
...
.method public final g(Z)Z
    ...
    :cond_0
    iget-object p0, p0, Ltda;->i:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final onThemeChanged(Lkbc;)V
    ...
    invoke-virtual {v0, p1}, Lkda;->onThemeChanged(Lkbc;)V
