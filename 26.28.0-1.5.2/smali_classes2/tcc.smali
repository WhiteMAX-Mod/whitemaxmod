...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v4, v0, v5}, Lzu;-><init>(ILlq4;I)V
    ...
    iput-object v1, p0, Ltcc;->a:Landroidx/appcompat/widget/AppCompatTextView;

    new-instance v6, Lv0c;

    invoke-direct {v6, p1}, Lv0c;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v2}, Lv0c;->setHasBackground(Z)V

    invoke-virtual {v6, v0}, Lv0c;->setTypography(Lnoh;)V
    ...
    invoke-virtual {v6, v0}, Lv0c;->setTextColor(I)V

    const/16 v0, 0x8

    invoke-virtual {v6, v0}, Landroid/view/View;->setVisibility(I)V

    iput-object v6, p0, Ltcc;->b:Lv0c;
    ...
    invoke-virtual {v1, v2}, Lcyb;->setIconResource(I)V
    ...
    iput-object v1, p0, Ltcc;->c:Lcyb;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Ltcc;->d:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v3}, Lcka;-><init>(I)V

    invoke-static {v4, v2}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object v2

    iput-object v2, p0, Ltcc;->g:Lny8;
...
.method public static d(Ltcc;Lcf7;Lmcc;)V
    .locals 0

    invoke-direct {p0}, Ltcc;->getPopupWindow()Landroid/widget/PopupWindow;
...
.method public final a()V
    ...
    invoke-virtual {p0, v0, v1}, Ltcc;->e(ZLaf7;)V
...
.method public final c(Ljava/lang/String;Ljava/util/List;Laf7;Lcf7;)V
    ...
    invoke-virtual/range {p0 .. p1}, Ltcc;->setSelectionTitle(Ljava/lang/String;)V

    iget-object v2, v0, Ltcc;->d:Ljava/util/ArrayList;
    ...
    invoke-static {v3, v4}, Lww3;->N1(Ljava/lang/Iterable;I)Ljava/util/List;

    move-result-object v5

    invoke-static {v3, v4}, Lww3;->l1(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-direct {v6, v11, v10}, Lgcd;-><init>(Landroid/content/Context;Z)V
    ...
    invoke-direct {v12, v13, v10}, Lfcd;-><init>(Landroid/content/Context;Z)V

    iget v13, v11, Lmcc;->b:I

    new-instance v14, Ltnh;

    invoke-direct {v14, v13}, Ltnh;-><init>(I)V
    ...
    invoke-virtual/range {v12 .. v17}, Lfcd;->c(Lfcd;Lynh;Ljava/lang/Integer;ZZ)V

    iget v13, v11, Lmcc;->c:I
    ...
    invoke-virtual {v12, v13, v14}, Lfcd;->b(Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v13, Laa1;

    invoke-direct {v13, v0, v1, v11, v7}, Laa1;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {v12, v13}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    :cond_1
    invoke-direct {v0}, Ltcc;->getPopupWindow()Landroid/widget/PopupWindow;
    ...
    invoke-direct {v11, v6}, Lcyb;-><init>(Landroid/content/Context;)V

    sget-object v6, Layb;->i:Layb;
    ...
    invoke-virtual {v11, v6}, Lcyb;->setIconResource(I)V
    ...
    invoke-direct {v6, v13, v3}, Lo37;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v15, v11, Lmcc;->e:Lzxb;

    move/from16 p1, v14

    new-instance v14, Lcyb;

    invoke-direct {v14, v6}, Lcyb;-><init>(Landroid/content/Context;)V

    sget-object v6, Layb;->i:Layb;

    invoke-virtual {v14, v6}, Lcyb;->setSize(Layb;)V

    invoke-virtual {v14, v15}, Lcyb;->setAppearance(Lzxb;)V

    iget v6, v11, Lmcc;->a:I

    invoke-virtual {v14, v6}, Landroid/view/View;->setId(I)V

    iget-object v6, v11, Lmcc;->f:Ljava/lang/Integer;

    invoke-virtual {v14, v6}, Lcyb;->setIconColor(Ljava/lang/Integer;)V

    iget v6, v11, Lmcc;->c:I

    invoke-virtual {v14, v6}, Lcyb;->setIconResource(I)V
    ...
    iget-boolean v6, v11, Lmcc;->d:Z

    if-eqz v6, :cond_4

    invoke-virtual {v14, v10}, Lcyb;->setEnabled(Z)V
    ...
    invoke-direct {v6, v1, v13, v11}, Laeb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v14, v6}, Lqe7;->I(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    invoke-static {v11, v6, v13}, Lqyj;->y(Landroid/view/View;II)Landroid/graphics/Rect;
    ...
    invoke-direct {v1, v0, v2, v3}, Lvx9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v0, v1}, Ltcc;->setCloseListener(Laf7;)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1, v9}, Ltcc;->e(ZLaf7;)V

    return-void
.end method

.method public final e(ZLaf7;)V
    .locals 16

    move-object/from16 v0, p0

    iget-object v1, v0, Ltcc;->e:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v1, v3, v0}, Llh9;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v0}, Ltcc;->getOpacityMotionInterpolator()Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v2, v0, v4, v1, v3}, Lscc;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    iput-object v6, v0, Ltcc;->e:Landroid/animation/AnimatorSet;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Ltcc;->e:Landroid/animation/AnimatorSet;
    ...
    iput-object v0, p0, Ltcc;->e:Landroid/animation/AnimatorSet;
...
.method public final onThemeChanged(Lkbc;)V
    ...
    iget-object v1, p0, Ltcc;->a:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v0, p0, Ltcc;->b:Lv0c;

    invoke-virtual {v0, p1}, Lv0c;->setTextColor(I)V

    iget-object p0, p0, Ltcc;->c:Lcyb;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p0, p0, Ltcc;->d:Ljava/util/ArrayList;
...
.method public final setCloseListener(Laf7;)V
    .locals 2
...
.method public final setOffEditMode(Laf7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1}, Ltcc;->e(ZLaf7;)V
...
.method public final setSelectionTitle(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Ltcc;->b:Lv0c;

    const/16 v3, 0x8

    iget-object p0, p0, Ltcc;->a:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v2, v0, p0, p1}, Lpu4;->c(Lpu4;Ljava/lang/Number;ZI)V
