...
.method public constructor <init>(Lone/me/sdk/arch/Widget;)V
    ...
    iput-object p1, p0, Lkve;->d:Lone/me/sdk/arch/Widget;

    new-instance p1, Landroid/util/LongSparseArray;

    invoke-direct {p1}, Landroid/util/LongSparseArray;-><init>()V

    iput-object p1, p0, Lkve;->e:Landroid/util/LongSparseArray;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lkve;->f:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lkve;->h:Landroid/util/SparseArray;
...
.method public static I(Landroidx/recyclerview/widget/RecyclerView;)Ly8j;
    .locals 3
...
.method public final A(Llfe;)V
    ...
    invoke-virtual {p0, p1}, Lkve;->H(Lnve;)V

    iget-object p0, p1, Lnve;->u:Ltp2;
...
.method public bridge synthetic B(Llfe;)V
    ...
    invoke-virtual {p0, p1}, Lkve;->J(Lnve;)V

    return-void
.end method

.method public final F(Lnve;I)V
    .locals 7

    invoke-virtual {p0, p2}, Lkve;->m(I)J

    move-result-wide v0

    iget-object v2, p1, Lnve;->u:Ltp2;
    ...
    iget-object v5, p0, Lkve;->d:Lone/me/sdk/arch/Widget;

    const/4 v6, 0x1

    invoke-virtual {v5, v2, v3, v6, v4}, Lbr4;->getChildRouter(Landroid/view/ViewGroup;Ljava/lang/String;ZZ)Lhve;

    move-result-object v2

    iput v6, v2, Lhve;->e:I

    iget-object v3, p1, Lnve;->v:Lhve;
    ...
    invoke-virtual {v5, v3}, Lbr4;->removeChildRouter(Lhve;)V

    :cond_0
    iput-object v2, p1, Lnve;->v:Lhve;

    iput-wide v0, p1, Lnve;->x:J
    ...
    iget-object v3, p0, Lkve;->e:Landroid/util/LongSparseArray;
    ...
    iget-object v3, p0, Lkve;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, p2}, Lkve;->G(Lhve;I)V
    ...
    invoke-virtual {v1, v6}, Lbr4;->setOptionsMenuHidden(Z)V
...
.method public final H(Lnve;)V
    .locals 3

    iget-boolean v0, p1, Lnve;->y:Z
    ...
    :cond_0
    iget-object v0, p1, Lnve;->v:Lhve;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lhve;->H()V

    iget-wide v1, p1, Lnve;->x:J

    invoke-virtual {p0, v1, v2, v0}, Lkve;->K(JLhve;)V
    ...
    iput-boolean p0, p1, Lnve;->y:Z

    return-void
.end method

.method public J(Lnve;)V
    .locals 1
    ...
    iget-object p0, p0, Lkve;->d:Lone/me/sdk/arch/Widget;

    invoke-virtual {p0, v0}, Lbr4;->removeChildRouter(Lhve;)V

    const/4 p0, 0x0

    iput-object p0, p1, Lnve;->v:Lhve;
...
.method public final K(JLhve;)V
    ...
    iget-object p3, p0, Lkve;->e:Landroid/util/LongSparseArray;

    invoke-virtual {p3, p1, p2, v0}, Landroid/util/LongSparseArray;->put(JLjava/lang/Object;)V

    iget-object p3, p0, Lkve;->f:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object p1, p0, Lkve;->e:Landroid/util/LongSparseArray;
    ...
    iget-object p1, p0, Lkve;->f:Ljava/util/ArrayList;
...
.method public final a()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v3}, Lkve;->m(I)J
    ...
    invoke-virtual {p0, v5, v6, v3}, Lkve;->K(JLhve;)V
    ...
    :cond_2
    iget-object v0, p0, Lkve;->e:Landroid/util/LongSparseArray;
    ...
    iget-object v5, p0, Lkve;->e:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Lkve;->e:Landroid/util/LongSparseArray;
    ...
    :cond_4
    iget-object v0, p0, Lkve;->f:Ljava/util/ArrayList;

    iget p0, p0, Lkve;->g:I

    new-instance v3, Ljve;

    invoke-direct {v3, v1, v2, v0, p0}, Ljve;-><init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;I)V
...
.method public final e(Landroid/os/Parcelable;)V
    ...
    iput-object v0, p0, Lkve;->e:Landroid/util/LongSparseArray;

    check-cast p1, Ljve;

    iget-object v0, p1, Ljve;->a:Ljava/util/ArrayList;
    ...
    iget-object v6, p1, Ljve;->b:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p1, Ljve;->c:Ljava/util/List;
    ...
    iput-object v1, p0, Lkve;->f:Ljava/util/ArrayList;
...
.method public final t(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-static {p1}, Lkve;->I(Landroidx/recyclerview/widget/RecyclerView;)Ly8j;
...
.method public final u(Llfe;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lkve;->F(Lnve;I)V
...
.method public final w(Landroid/view/ViewGroup;I)Llfe;
    ...
    invoke-direct {p1, p0}, Lnve;-><init>(Ltp2;)V
...
.method public final z(Llfe;)V
    ...
    invoke-virtual {p0, p1, v0}, Lkve;->F(Lnve;I)V
