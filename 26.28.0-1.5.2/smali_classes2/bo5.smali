...
# direct methods
.method public constructor <init>(Lcq4;Landroid/view/View;IILjava/lang/Float;ZLandroid/view/View;FFZLyp4;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lbo5;->a:Lcq4;

    iput-object p2, p0, Lbo5;->b:Landroid/view/View;

    iput p3, p0, Lbo5;->c:I

    iput p4, p0, Lbo5;->d:I

    iput-object p5, p0, Lbo5;->e:Ljava/lang/Float;

    iput-boolean p6, p0, Lbo5;->f:Z

    iput-object p7, p0, Lbo5;->g:Landroid/view/View;

    iput p8, p0, Lbo5;->h:F

    iput p9, p0, Lbo5;->i:F

    iput-boolean p10, p0, Lbo5;->j:Z

    iput-object p11, p0, Lbo5;->k:Lyp4;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lbo5;->l:Landroid/graphics/Rect;

    const/4 p1, 0x2

    new-array p1, p1, [I

    iput-object p1, p0, Lbo5;->m:[I

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lbo5;->n:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lbo5;->o:Landroid/graphics/Rect;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lbo5;->p:Z
...
.method public final a(Landroid/graphics/Rect;Landroid/view/View;)V
    ...
    iget-boolean v0, p0, Lbo5;->q:Z

    if-nez v0, :cond_1a

    iget-object v0, p0, Lbo5;->l:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lbo5;->b:Landroid/view/View;
    ...
    iget-object v3, p0, Lbo5;->n:Landroid/graphics/Rect;
    ...
    iget-object v6, v1, Lixj;->a:Lexj;

    invoke-virtual {v6, v5}, Lexj;->f(I)Lmi8;
    ...
    iget-object v1, v1, Lixj;->a:Lexj;

    invoke-virtual {v1}, Lexj;->e()Ldo5;
    ...
    iget-object v6, p0, Lbo5;->o:Landroid/graphics/Rect;
    ...
    :goto_7
    iget-object p2, p0, Lbo5;->g:Landroid/view/View;
    ...
    :cond_e
    iget-object v1, p0, Lbo5;->e:Ljava/lang/Float;
    ...
    invoke-static {v11, v12, p1}, Loc9;->v(III)I
    ...
    iget-boolean p1, p0, Lbo5;->p:Z

    if-eqz p1, :cond_1a

    iput-boolean v4, p0, Lbo5;->p:Z

    iget-boolean p1, p0, Lbo5;->j:Z

    iput-boolean p1, p0, Lbo5;->q:Z

    iget-object p1, p0, Lbo5;->k:Lyp4;

    invoke-virtual {p1}, Lyp4;->invoke()Ljava/lang/Object;

    iget-boolean p0, p0, Lbo5;->f:Z
