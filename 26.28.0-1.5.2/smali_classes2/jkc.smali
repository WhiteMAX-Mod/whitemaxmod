...
# direct methods
.method public constructor <init>(Landroid/content/Context;ZLc98;)V
    .locals 7
    ...
    :cond_3
    iput-object p2, p0, Ljkc;->k:[I

    goto :goto_3

    :cond_4
    iput-object v1, p0, Ljkc;->k:[I
    ...
    invoke-static {p2, v0}, Llvb;->O(Ljava/lang/Object;Z)V

    :goto_3
    iput-object p3, p0, Ljkc;->j:Lc98;

    new-instance p2, Lyye;

    invoke-direct {p2}, Lyye;-><init>()V

    iput-object p2, p0, Ljkc;->i:Lyye;

    new-instance p2, Landroid/util/SparseArray;

    invoke-direct {p2}, Landroid/util/SparseArray;-><init>()V

    iput-object p2, p0, Ljkc;->l:Landroid/util/SparseArray;

    new-instance p2, Landroid/util/SparseIntArray;

    invoke-direct {p2}, Landroid/util/SparseIntArray;-><init>()V

    iput-object p2, p0, Ljkc;->m:Landroid/util/SparseIntArray;
    ...
    invoke-static {v0}, Ljkc;->k(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Ljkc;->k:[I

    invoke-static {p1, p3, v1}, Ljkc;->j(Landroid/content/Context;I[I)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p2, v0, p1}, Lv30;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p2, p0, Ljkc;->h:Lv30;
    :try_end_0
    ...
    invoke-virtual {p2, p0}, Lv30;->y([F)V
...
.method public static j(Landroid/content/Context;I[I)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lvqi;->U(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public final f(II)Llag;
    ...
    iget-object p1, p0, Ljkc;->i:Lyye;

    iput-object v0, p1, Ljj0;->j:Ljava/lang/Object;

    iget-object p0, p0, Ljkc;->j:Lc98;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lc98;->q(I)La98;
...
.method public final h(IJ)V
    ...
    iget-object v0, p0, Ljkc;->m:Landroid/util/SparseIntArray;

    iget-object v1, p0, Ljkc;->l:Landroid/util/SparseArray;

    iget-object v2, p0, Ljkc;->j:Lc98;

    iget-object v3, p0, Ljkc;->h:Lv30;
    ...
    iget-object v6, v8, Ley0;->e:Landroid/graphics/Bitmap;

    invoke-static {v6}, Lrh;->w(Landroid/graphics/Bitmap;)Z

    move-result v7

    invoke-static {v7}, Llvb;->R(Z)V

    invoke-static {v6}, Lrh;->e(Landroid/graphics/Bitmap;)Landroid/graphics/Gainmap;

    move-result-object v6

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v6}, Lrh;->f(Ljava/lang/Object;)Landroid/graphics/Gainmap;
    ...
    invoke-static {v7}, Lyg7;->d(Ljava/lang/Object;)Landroid/graphics/Gainmap;

    move-result-object v7

    if-eqz v7, :cond_0

    invoke-static {v7, v6}, Lrzl;->c(Landroid/graphics/Gainmap;Landroid/graphics/Gainmap;)Z
    ...
    invoke-static {v6}, Lrh;->d(Landroid/graphics/Gainmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v7}, Ltab;->y(Landroid/graphics/Bitmap;I)V
    ...
    invoke-virtual {v3, v7, v9, v6}, Lv30;->C(IILjava/lang/String;)V

    invoke-virtual {v1, v5}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object v6

    invoke-static {v6}, Lyg7;->d(Ljava/lang/Object;)Landroid/graphics/Gainmap;

    move-result-object v6

    invoke-static {v3, v6, v5}, Lrzl;->e(Lv30;Landroid/graphics/Gainmap;I)V
    ...
    invoke-virtual {v3, v7, v6}, Lv30;->A(Ljava/lang/String;[F)V
    ...
    invoke-virtual {v8}, Ley0;->a()I

    move-result v7

    invoke-virtual {v3, v7, v5, v6}, Lv30;->C(IILjava/lang/String;)V
    ...
    iget-object v7, v8, Ley0;->a:[F

    invoke-virtual {v3, v6, v7}, Lv30;->A(Ljava/lang/String;[F)V

    iget-object v6, v8, Ley0;->f:Lwjg;

    new-instance v7, Llag;

    iget-object v9, v8, Ley0;->d:Landroid/graphics/Bitmap;
    ...
    iget-object v8, v8, Ley0;->d:Landroid/graphics/Bitmap;
    ...
    invoke-direct {v7, v9, v8}, Llag;-><init>(II)V
    ...
    iget-object v9, p0, Ljkc;->i:Lyye;

    invoke-virtual {v9, v7, v6}, Lyye;->f(Llag;Likc;)[F

    move-result-object v6

    invoke-virtual {v3, v8, v6}, Lv30;->A(Ljava/lang/String;[F)V
    ...
    invoke-virtual {v3, v6, v10}, Lv30;->z(Ljava/lang/String;F)V
    ...
    invoke-virtual {v3, p1, v7, p0}, Lv30;->C(IILjava/lang/String;)V
...
.method public final release()V
    ...
    iget-object v0, p0, Ljkc;->j:Lc98;

    :try_start_0
    iget-object v1, p0, Ler0;->a:Lp11;

    invoke-virtual {v1}, Lp11;->c()V
    :try_end_0
    .catch Landroidx/media3/common/util/GlUtil$GlException; {:try_start_0 .. :try_end_0} :catch_2

    :try_start_1
    iget-object v1, p0, Ljkc;->h:Lv30;
    ...
    iput-object v4, v3, Ley0;->d:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Ljkc;->m:Landroid/util/SparseIntArray;
