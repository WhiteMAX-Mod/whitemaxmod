...
.field public static final D:Lixj;
...
.field public final y:Lz7;

.field public final z:Lz7;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v2, v1, v2}, Lmi8;->b(IIII)Lmi8;

    move-result-object v1

    invoke-virtual {v0, v1}, Lxwj;->g(Lmi8;)V

    invoke-virtual {v0}, Lxwj;->b()Lixj;

    move-result-object v0

    sput-object v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Lixj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lixj;->b:Lixj;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lixj;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lixj;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lixj;

    new-instance p2, Ly7;

    const/4 v0, 0x0

    invoke-direct {p2, v0, p0}, Ly7;-><init>(ILjava/lang/Object;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Ly7;

    new-instance p2, Lz7;

    invoke-direct {p2, p0, v0}, Lz7;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;I)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lz7;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lz7;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Lbs0;

    new-instance p2, Lc8;

    const/4 v0, 0x0

    invoke-direct {p2, p1, v0}, Lc8;-><init>(Landroid/content/Context;I)V

    const/4 p1, 0x1

    invoke-virtual {p2, p1}, Landroid/view/View;->setWillNotDraw(Z)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lc8;
...
.method public final b()Z
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:La65;

    check-cast p0, Lgvh;

    iget-object p0, p0, Lgvh;->a:Landroidx/appcompat/widget/Toolbar;
...
.method public final c()V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuView;->t:Lm8;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lm8;->j()Z

    iget-object p0, p0, Lm8;->t:Lj8;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Ljca;->b()Z
    ...
    invoke-interface {p0}, Lx3g;->dismiss()V
...
.method public final d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lz7;

    invoke-virtual {p0, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lz7;
...
.method public getNestedScrollAxes()I
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Lbs0;
...
.method public final k()Z
    ...
    iget-object v0, p0, Lm8;->u:Lng7;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lm8;->k()Z
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, Lixj;->g(Landroid/view/WindowInsets;Landroid/view/View;)Lixj;

    move-result-object p1

    new-instance v0, Landroid/graphics/Rect;

    invoke-virtual {p1}, Lixj;->b()I
    ...
    invoke-virtual {p1}, Lixj;->c()I

    move-result v3

    invoke-virtual {p1}, Lixj;->a()I
    ...
    invoke-static {p0, p1, v1}, Ly6j;->b(Landroid/view/View;Lixj;Landroid/graphics/Rect;)Lixj;
    ...
    invoke-virtual {p1, v2, v3, v4, v5}, Lexj;->l(IIII)Lixj;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lixj;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lixj;

    invoke-virtual {v3, v2}, Lixj;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lixj;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lixj;
...
.method public final onMeasure(II)V
    ...
    iget-object v7, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lixj;

    iput-object v7, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lc8;

    sget-object v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Lixj;

    iget-object v9, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->p:Landroid/graphics/Rect;

    invoke-static {v3, v7, v9}, Ly6j;->b(Landroid/view/View;Lixj;Landroid/graphics/Rect;)Lixj;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    iget-object v3, v3, Lixj;->a:Lexj;

    invoke-virtual {v3, p2, v6, p2, p2}, Lexj;->l(IIII)Lixj;

    move-result-object p2

    iput-object p2, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    goto :goto_3

    :cond_4
    iget-object p2, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    invoke-virtual {p2}, Lixj;->b()I
    ...
    iget-object v6, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    invoke-virtual {v6}, Lixj;->c()I

    move-result v6

    iget-object v7, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    invoke-virtual {v7}, Lixj;->a()I

    move-result v7

    invoke-static {p2, v3, v6, v7}, Lmi8;->b(IIII)Lmi8;
    ...
    new-instance v6, Lwwj;

    invoke-direct {v6, v3}, Lwwj;-><init>(Lixj;)V
    ...
    invoke-direct {v6, v3}, Lvwj;-><init>(Lixj;)V
    ...
    invoke-direct {v6, v3}, Luwj;-><init>(Lixj;)V
    ...
    invoke-direct {v6, v3}, Ltwj;-><init>(Lixj;)V

    :goto_2
    invoke-virtual {v6, p2}, Lxwj;->g(Lmi8;)V

    invoke-virtual {v6}, Lxwj;->b()Lixj;
    ...
    iget-object p2, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lixj;

    iget-object v3, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lixj;

    invoke-virtual {p2, v3}, Lixj;->equals(Ljava/lang/Object;)Z
    ...
    iput-object p2, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lixj;

    iget-object v3, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v3, p2}, Li7j;->b(Landroid/view/View;Lixj;)V
...
.method public final onNestedFling(Landroid/view/View;FFZ)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lz7;

    invoke-virtual {p1}, Lz7;->run()V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lz7;
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Lbs0;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:La8;

    if-eqz p0, :cond_0

    check-cast p0, Llwj;

    iget-object p1, p0, Llwj;->s:Lgg1;
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_1
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:La8;
    ...
    :cond_2
    iget-boolean p1, v4, Llwj;->p:Z

    if-nez p1, :cond_4

    iput-boolean v3, v4, Llwj;->p:Z

    invoke-virtual {v4, v3}, Llwj;->n(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:La8;
...
.method public final p()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/Toolbar;->getWrapper()La65;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:La65;
...
.method public final q(Landroid/view/Menu;Loca;)V
    .locals 3
    ...
    iget-object v0, p0, Lgvh;->a:Landroidx/appcompat/widget/Toolbar;

    iget-object v1, p0, Lgvh;->m:Lm8;
    ...
    invoke-direct {v1, v2}, Lm8;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lgvh;->m:Lm8;

    :cond_0
    iget-object p0, p0, Lgvh;->m:Lm8;

    iput-object p2, p0, Lm8;->e:Loca;
    ...
    iget-object p2, p2, Landroidx/appcompat/widget/ActionMenuView;->p:Lyba;
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->K:Lm8;

    invoke-virtual {p2, v1}, Lyba;->s(Lpca;)V

    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->n1:Lzuh;

    invoke-virtual {p2, v1}, Lyba;->s(Lpca;)V

    :cond_3
    iget-object p2, v0, Landroidx/appcompat/widget/Toolbar;->n1:Lzuh;

    if-nez p2, :cond_4

    new-instance p2, Lzuh;

    invoke-direct {p2, v0}, Lzuh;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object p2, v0, Landroidx/appcompat/widget/Toolbar;->n1:Lzuh;

    :cond_4
    const/4 p2, 0x1

    iput-boolean p2, p0, Lm8;->q:Z

    iget-object p2, v0, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    if-eqz p1, :cond_5

    invoke-virtual {p1, p0, p2}, Lyba;->c(Lpca;Landroid/content/Context;)V

    iget-object p2, v0, Landroidx/appcompat/widget/Toolbar;->n1:Lzuh;

    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, p2, v1}, Lyba;->c(Lpca;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p2, p1}, Lm8;->i(Landroid/content/Context;Lyba;)V

    iget-object p2, v0, Landroidx/appcompat/widget/Toolbar;->n1:Lzuh;

    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p2, v1, p1}, Lzuh;->i(Landroid/content/Context;Lyba;)V

    invoke-virtual {p0}, Lm8;->e()V

    iget-object p1, v0, Landroidx/appcompat/widget/Toolbar;->n1:Lzuh;

    invoke-virtual {p1}, Lzuh;->e()V

    :goto_1
    iget-object p1, v0, Landroidx/appcompat/widget/Toolbar;->a:Landroidx/appcompat/widget/ActionMenuView;

    iget p2, v0, Landroidx/appcompat/widget/Toolbar;->k:I

    invoke-virtual {p1, p2}, Landroidx/appcompat/widget/ActionMenuView;->setPopupTheme(I)V

    iget-object p1, v0, Landroidx/appcompat/widget/Toolbar;->a:Landroidx/appcompat/widget/ActionMenuView;

    invoke-virtual {p1, p0}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(Lm8;)V

    iput-object p0, v0, Landroidx/appcompat/widget/Toolbar;->K:Lm8;
...
.method public setActionBarVisibilityCallback(La8;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:La8;
...
.method public setIcon(I)V
    ...
    :goto_0
    iput-object p1, p0, Lgvh;->d:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Lgvh;->c()V
...
.method public setLogo(I)V
    ...
    :goto_0
    iput-object p1, p0, Lgvh;->e:Landroid/graphics/drawable/Drawable;
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    iput-object p1, p0, Lgvh;->k:Landroid/view/Window$Callback;
...
.method public setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Lgvh;->h:Ljava/lang/CharSequence;
    ...
    invoke-static {p0, p1}, Li7j;->m(Landroid/view/View;Ljava/lang/CharSequence;)V
