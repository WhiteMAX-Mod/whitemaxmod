...
# virtual methods
.method public final a(Lcca;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcca;

    invoke-virtual {p1}, Lcca;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setIcon(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p1}, Lcca;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Lcca;->isVisible()Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lh8;

    if-nez p1, :cond_1

    new-instance p1, Lh8;

    invoke-direct {p1, p0}, Lh8;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lh8;
...
.method public final d()Z
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcca;

    invoke-virtual {p0}, Lcca;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public getItemData()Lcca;
    .locals 0
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lxba;

    if-eqz p1, :cond_0

    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcca;

    invoke-interface {p1, p0}, Lxba;->b(Lcca;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcca;

    invoke-virtual {v0}, Lcca;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lh8;
...
.method public final r()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Lcca;
    ...
    iget-object v2, v2, Lcca;->q:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lcca;->e:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lcca;->r:Ljava/lang/CharSequence;
    ...
    iget-object v1, v0, Lcca;->e:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Lhvh;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Lhvh;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public setItemInvoker(Lxba;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lxba;
...
.method public setPopupCallback(Li8;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:Li8;
