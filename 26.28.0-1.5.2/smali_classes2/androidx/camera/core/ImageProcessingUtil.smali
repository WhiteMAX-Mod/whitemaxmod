...
.method public static a(Ll78;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Ll78;)Z
    ...
    :cond_0
    invoke-interface {p0}, Ll78;->getWidth()I

    move-result v10

    invoke-interface {p0}, Ll78;->getHeight()I

    move-result v11

    invoke-interface {p0}, Ll78;->e0()[Lk78;
    ...
    invoke-interface {v0}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static b(Lls9;[B)Ll78;
    .locals 2

    invoke-virtual {p0}, Lls9;->e()I
    ...
    invoke-virtual {p0}, Lls9;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p1}, Ltvj;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    return-object p0
.end method

.method public static c(Ll78;)Landroid/graphics/Bitmap;
    .locals 15

    invoke-interface {p0}, Ll78;->getFormat()I
...
.method public static d(Ll78;Lo78;Ljava/nio/ByteBuffer;IZ)La58;
    .locals 22

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Ll78;)Z
    ...
    invoke-static {v2, v0}, Ltvj;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-interface/range {p1 .. p1}, Lo78;->getSurface()Landroid/view/Surface;

    move-result-object v13

    invoke-interface/range {p0 .. p0}, Ll78;->getWidth()I

    move-result v15

    invoke-interface/range {p0 .. p0}, Ll78;->getHeight()I

    move-result v16

    invoke-interface/range {p0 .. p0}, Ll78;->e0()[Lk78;
    ...
    invoke-interface {v9}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v7}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v3, v5, v6, v4, v7}, Lzo5;->g(IJLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_6
    invoke-interface/range {p1 .. p1}, Lo78;->d()Ll78;
    ...
    invoke-direct {v1, v3}, La58;-><init>(Ll78;)V

    new-instance v2, Lh78;

    move-object/from16 v4, p0

    invoke-direct {v2, v3, v4, v0}, Lh78;-><init>(Ll78;Ll78;I)V

    invoke-virtual {v1, v2}, Lw97;->b(Lv97;)V
...
.method public static i(Ll78;Lo78;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)La58;
    .locals 26
    ...
    invoke-interface {v10}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v12}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v2, v0}, La58;-><init>(Ll78;)V

    new-instance v3, Lh78;

    move-object/from16 v4, p0

    invoke-direct {v3, v0, v4, v1}, Lh78;-><init>(Ll78;Ll78;I)V

    invoke-virtual {v2, v3}, Lw97;->b(Lv97;)V
...
.method public static j(Ll78;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)La58;
    .locals 25
    ...
    invoke-interface {v4}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v5}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v6}, Lk78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1}, Ltvj;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v6 .. v12}, Lj78;-><init>(Ll78;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II)V

    invoke-direct {v0, v6}, La58;-><init>(Ll78;)V
