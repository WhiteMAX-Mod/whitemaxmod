...
.method public constructor <init>(Lawi;)V
    ...
    iput-object p1, p0, Ldwi;->a:Lawi;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Ldwi;->d:Ljava/util/HashSet;

    invoke-interface {p1}, Lawi;->g()I
    ...
    iput-object v1, p0, Ldwi;->b:Landroid/util/Range;

    invoke-interface {p1}, Lawi;->d()I
    ...
    iput-object p1, p0, Ldwi;->c:Landroid/util/Range;
...
.method public final b(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ldwi;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Ldwi;->a:Lawi;

    if-eqz v0, :cond_0

    invoke-interface {v2}, Lawi;->d()I
    ...
    iget-object p0, p0, Ldwi;->b:Landroid/util/Range;
...
.method public final e(II)Z
    ...
    iget-object v0, p0, Ldwi;->a:Lawi;

    invoke-interface {v0, p1, p2}, Lawi;->e(II)Z
    ...
    :cond_0
    iget-object v1, p0, Ldwi;->d:Ljava/util/HashSet;
    ...
    :cond_3
    :goto_0
    iget-object v1, p0, Ldwi;->b:Landroid/util/Range;
    ...
    iget-object p0, p0, Ldwi;->c:Landroid/util/Range;
