...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v4, Lq9i;->s:Lnoh;

    invoke-static {v4, v0}, Lq9i;->a(Lnoh;Landroid/widget/TextView;)V

    iput-object v0, p0, Ls3d;->c:Landroid/widget/TextView;
    ...
    invoke-virtual {v3, v5}, La8g;->l(Landroid/view/View;)Lnbc;
    ...
    invoke-static {v4, v5}, Lq9i;->a(Lnoh;Landroid/widget/TextView;)V

    iput-object v5, p0, Ls3d;->d:Landroid/widget/TextView;
    ...
    invoke-static {v7, v8}, Llvb;->I0(IF)I
    ...
    invoke-virtual {v3, v7}, La8g;->l(Landroid/view/View;)Lnbc;
    ...
    sget-object p1, Lq9i;->o:Lnoh;

    invoke-static {p1, v7}, Lq9i;->a(Lnoh;Landroid/widget/TextView;)V
    ...
    invoke-virtual {v3, v2}, La8g;->l(Landroid/view/View;)Lnbc;

    move-result-object v3

    iget-object v3, v3, Lnbc;->b:Lkbc;

    invoke-interface {v3}, Lkbc;->l()Ljbc;
    ...
    invoke-direct {v2, p1}, Lnt4;-><init>(F)V

    invoke-virtual {v1, v2}, Landroid/view/View;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    iput-object v1, p0, Ls3d;->f:Lyd1;
    ...
    invoke-direct {p1, p0}, Lq3d;-><init>(Ls3d;)V
...
.method public final a(Lj53;)V
    ...
    iget-object v3, p1, Lkc7;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iput-object v3, p0, Ls3d;->g:Lkc7;

    if-eqz v3, :cond_2

    iget-object v1, v3, Lkc7;->a:Landroid/graphics/Bitmap;

    :cond_2
    iget-object v3, p0, Ls3d;->f:Lyd1;
...
.method public final getListener()Lr3d;
    .locals 0

    iget-object p0, p0, Ls3d;->i:Lr3d;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1, p4, p2, p3, p5}, Lqyj;->M(Landroid/view/View;IIII)V

    :cond_0
    iget-object p1, p0, Ls3d;->c:Landroid/widget/TextView;

    const/4 p2, 0x0

    const/16 p5, 0xc

    invoke-static {p1, p4, p3, p2, p5}, Lqyj;->M(Landroid/view/View;IIII)V
    ...
    iget-object v1, p0, Ls3d;->d:Landroid/widget/TextView;
    ...
    invoke-static {v1, v0, p3, p2, p5}, Lqyj;->M(Landroid/view/View;IIII)V
    ...
    invoke-static {p0, p4, p1, p2, p5}, Lqyj;->M(Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    iget-object v3, p0, Ls3d;->c:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Ls3d;->d:Landroid/widget/TextView;
...
.method public final setListener(Lr3d;)V
    .locals 0

    iput-object p1, p0, Ls3d;->i:Lr3d;
