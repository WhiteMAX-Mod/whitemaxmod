...
# instance fields
.field public final a:Lym1;

.field public final b:Lk42;


# direct methods
.method public constructor <init>(Lym1;Lk42;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lsy1;->a:Lym1;

    iput-object p2, p0, Lsy1;->b:Lk42;
...
.method public final b(ZZ)V
    ...
    iget-object p0, p0, Lsy1;->a:Lym1;

    if-eqz p1, :cond_0

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lym1;->o(Z)V

    invoke-static {p0}, Lym1;->m(Lym1;)V

    return-void

    :cond_0
    invoke-virtual {p0, p2}, Lym1;->y(Z)V

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lym1;->t()V

    invoke-virtual {p0}, Lym1;->x()V
...
.method public final c(ZZ)V
    ...
    invoke-static {v9, p0, v10, p1, v8}, Lqt4;->o(Ljava/lang/String;ZLjava/lang/String;ZLjava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, v0, v4, p1, v6}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_6
    iput-object v6, v2, Lym1;->w:Lsgg;

    invoke-virtual {v2}, Lym1;->k()Lone/me/android/root/RootController;

    move-result-object p1

    new-instance v0, Lone/me/calls/ui/ui/indicator/CallIndicatorWidget;

    iget-object v1, v2, Lym1;->f:Lha9;

    invoke-direct {v0, v1}, Lone/me/calls/ui/ui/indicator/CallIndicatorWidget;-><init>(Lha9;)V
    ...
    invoke-static {p2}, Llvb;->w0(Landroid/content/Context;)Lpk5;

    move-result-object p2

    invoke-virtual {p2}, Lpk5;->a()Z

    move-result p2

    :goto_2
    invoke-virtual {p1}, Lone/me/android/root/RootController;->y1()Lhve;
    ...
    invoke-virtual {p1}, Lone/me/android/root/RootController;->z1()Ltp2;

    move-result-object v1

    invoke-static {p1, v1}, Lone/me/android/root/RootController;->o1(Lone/me/android/root/RootController;Ltp2;)Z
    ...
    invoke-virtual {v2, v7}, Lym1;->o(Z)V

    return-void

    :cond_b
    invoke-static {v2}, Lym1;->m(Lym1;)V

    iget-object p0, p0, Lsy1;->a:Lym1;

    if-eqz v1, :cond_c

    invoke-virtual {p0, v7}, Lym1;->o(Z)V
    ...
    invoke-static {p2, p0}, Lzo5;->s(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p1, v0, v4, p0, v6}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
