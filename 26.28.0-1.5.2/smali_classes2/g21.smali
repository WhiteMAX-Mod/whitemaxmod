...
.method public static a(Lg21;)V
    .locals 1

    const/4 v0, 0x0

    iput-boolean v0, p0, Lg21;->b:Z

    iget-object v0, p0, Lg21;->a:Lmvh;
    ...
    iput-object v0, p0, Lg21;->a:Lmvh;

    return-void
.end method

.method public static b(Lg21;Ltxb;ILynh;II)V
    .locals 12
    ...
    :goto_0
    invoke-static {v4}, Lyab;->P(Landroid/view/View;)I
    ...
    invoke-static {p2}, Lwk8;->D(Landroid/content/Context;)I
    ...
    iput-boolean v8, p0, Lg21;->b:Z

    iget-object p2, p0, Lg21;->a:Lmvh;
    ...
    invoke-virtual {v2, p3}, Lmvh;->c(Lynh;)V

    const-wide/16 v3, 0xbb8

    invoke-virtual {v2, v11, p1, v3, v4}, Lmvh;->e(Landroid/graphics/Point;IJ)V

    new-instance p1, Lf21;

    invoke-direct {p1, p0, v1, v0}, Lf21;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v2, p1}, Landroid/widget/PopupWindow;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    iput-object v2, p0, Lg21;->a:Lmvh;
