...
.method public final onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lqkk;->m0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lqkk;->l0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p0, Lfcl;->f:Lgfl;

    iget-object p1, p1, Lgfl;->a:Lt6m;

    if-eqz p1, :cond_9

    iget-object p2, p0, Lfcl;->e:Lqjh;

    iget-object p3, p1, Lt6m;->f:Ljava/lang/Object;

    monitor-enter p3

    :try_start_0
    iget-object p4, p1, Lt6m;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Ljul;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lt6m;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p0, Lfcl;->d:Lqd2;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lqd2;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p3, Lhmk;

    invoke-direct {p3, p1, p2}, Lhmk;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p0, p0, Lfcl;->e:Lqjh;

    invoke-virtual {p0, p3}, Lqjh;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lh1m;->f:Li3m;

    iget-object p1, p1, Li3m;->a:Lsbm;

    iget-object p2, p0, Lh1m;->e:Lqjh;

    invoke-virtual {p1, p2}, Lsbm;->d(Lqjh;)V

    iget-object p0, p0, Lh1m;->d:Lste;

    const-string p1, "onCompleteUpdate"

    new-array p2, v3, [Ljava/lang/Object;

    invoke-virtual {p0, p1, p2}, Lste;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lh1m;->d:Lste;

    const-string p3, "onRequestInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p3, p4}, Lste;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Li3m;->d:Lr6m;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v2, Ljava/io/File;

    iget-object p0, p0, Lr6m;->a:Landroid/content/Context;
    ...
    invoke-static {v2}, Lr6m;->a(Ljava/io/File;)J
    ...
    invoke-virtual {p2, p0}, Lqjh;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Lqkk;->k0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
