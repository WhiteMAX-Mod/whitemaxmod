...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILqg7;)V
    .locals 1
    ...
    iput-object p1, p0, Lhb5;->g:Ljava/lang/String;

    iput p2, p0, Lhb5;->e:I

    iput p3, p0, Lhb5;->f:I

    iput-object p4, p0, Lhb5;->h:Lqg7;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lhb5;->l:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Lhb5;->l:Ljava/io/InputStream;

    invoke-virtual {p0}, Lhb5;->e()V

    iget-boolean v2, p0, Lhb5;->m:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Lhb5;->m:Z

    invoke-virtual {p0}, Lpq0;->b()V

    :cond_1
    iput-object v1, p0, Lhb5;->k:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Lhb5;->j:La35;
...
.method public final e()V
    ...
    iget-object p0, p0, Lhb5;->k:Ljava/net/HttpURLConnection;
...
.method public final f(La35;)J
    ...
    iput-object v0, v1, Lhb5;->j:La35;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Lhb5;->p:J

    iput-wide v12, v1, Lhb5;->o:J
    ...
    iget-object v4, v0, La35;->d:[B

    iget-wide v5, v0, La35;->f:J

    iget-wide v7, v0, La35;->g:J

    invoke-virtual {v0, v14}, La35;->c(I)Z

    move-result v9

    iget-object v11, v0, La35;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lhb5;->g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, La35;->g:J

    iget-wide v5, v0, La35;->f:J

    iput-object v2, v1, Lhb5;->k:Ljava/net/HttpURLConnection;
    ...
    sget-object v8, Lp28;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, Llvb;->k0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, Lp28;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v3}, Llvb;->G0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10, v3}, Llvb;->k0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, Lhb5;->l:Ljava/io/InputStream;

    if-eqz v7, :cond_9

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v4, v1, Lhb5;->l:Ljava/io/InputStream;
    ...
    :goto_5
    iput-boolean v9, v1, Lhb5;->m:Z

    invoke-virtual/range {p0 .. p1}, Lpq0;->d(La35;)V

    :try_start_5
    invoke-virtual {v1, v5, v6}, Lhb5;->h(J)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_4

    iget-wide v0, v1, Lhb5;->o:J
    ...
    invoke-static {v7}, Lp28;->b(Ljava/lang/String;)J
...
.method public final g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lhb5;->h:Lqg7;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lqg7;->l()Ljava/util/Map;
    ...
    :cond_1
    invoke-static {p4, p5, p6, p7}, Lp28;->a(JJ)Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, p0, Lhb5;->g:Ljava/lang/String;
    ...
    invoke-static {p2}, La35;->b(I)Ljava/lang/String;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lhb5;->k:Ljava/net/HttpURLConnection;
...
.method public final h(J)V
    ...
    iget-object v4, p0, Lhb5;->l:Ljava/io/InputStream;
...
.method public final p()Ljava/util/Map;
    ...
    invoke-direct {v0, p0}, Lgb5;-><init>(Ljava/util/Map;)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lhb5;->l:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lhb5;->p:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lhb5;->p:J
