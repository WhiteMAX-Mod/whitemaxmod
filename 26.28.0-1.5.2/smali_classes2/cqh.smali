...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lbqh;-><init>(Ljava/lang/Object;Lcqh;I)V

    iput-object v0, p0, Lcqh;->a:Lbqh;
    ...
    invoke-direct {p0}, Lcqh;->getTheme()Lkbc;

    move-result-object v0

    invoke-interface {v0}, Lkbc;->C()Lzac;

    move-result-object v0

    iget-object v0, v0, Lzac;->a:Lvyh;
    ...
    iput-object p1, p0, Lcqh;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Lcqh;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lcqh;->e:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcqh;->f:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcqh;->g:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lcqh;)Lkbc;
    .locals 0
...
.method private final getTheme()Lkbc;
    ...
    invoke-virtual {p0}, Lcqh;->getThemeName()Ljava/lang/String;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lcqh;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lcqh;->h:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lcqh;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lcqh;->i:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lcqh;->j:[Lzv8;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object p0, p0, Lcqh;->c:Lbqh;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Lcqh;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lcqh;->f:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lcqh;->h:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lcqh;->e:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lcqh;->g:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p0, p0, Lcqh;->i:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lkbc;)V
    ...
    :goto_0
    iget-object v0, p0, Lcqh;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lcqh;->b:Landroid/graphics/drawable/GradientDrawable;
