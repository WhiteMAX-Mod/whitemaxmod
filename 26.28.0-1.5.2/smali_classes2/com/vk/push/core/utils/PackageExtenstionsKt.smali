...
.method public static final b(Landroid/content/pm/PackageInfo;)[Landroid/content/pm/Signature;
    ...
    invoke-static {p0}, Lb88;->e(Landroid/content/pm/PackageInfo;)Landroid/content/pm/SigningInfo;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-static {p0}, Ln4;->B(Landroid/content/pm/SigningInfo;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lb88;->u(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
    ...
    :cond_0
    invoke-static {p0}, Ln4;->C(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
...
.method public static final getAppStandbyBucket(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lb88;->a(Landroid/app/usage/UsageStatsManager;)I
...
.method public static final queryIntentServicesCompat(Landroid/content/pm/PackageManager;Landroid/content/Intent;I)Ljava/util/List;
    ...
    invoke-static {v2, v3}, Ljx5;->g(J)Landroid/content/pm/PackageManager$ResolveInfoFlags;

    move-result-object p2

    invoke-static {p0, p1, p2}, Ljx5;->s(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/pm/PackageManager$ResolveInfoFlags;)Ljava/util/List;
...
.method public static final resolveServiceCompat(Landroid/content/pm/PackageManager;Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
    ...
    invoke-static {v0, v1}, Ljx5;->g(J)Landroid/content/pm/PackageManager$ResolveInfoFlags;

    move-result-object p2

    invoke-static {p0, p1, p2}, Ljx5;->h(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/pm/PackageManager$ResolveInfoFlags;)Landroid/content/pm/ResolveInfo;
