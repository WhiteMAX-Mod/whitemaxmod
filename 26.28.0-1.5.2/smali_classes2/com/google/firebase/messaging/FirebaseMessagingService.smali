...
.method public constructor <init>()V
    ...
    invoke-direct {v7, v0, v1}, Laid;-><init>(Ljava/lang/String;I)V
...
.method public final a(Landroid/content/Intent;)V
    ...
    invoke-static {p1}, Ltpk;->c(Landroid/content/Intent;)V
...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lup4;->A(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v0}, Lup4;-><init>(Landroid/os/Bundle;)V

    new-instance v5, Laid;

    const-string v9, "Firebase-Messaging-Network-Io"

    invoke-direct {v5, v9, v8}, Laid;-><init>(Ljava/lang/String;I)V

    invoke-static {v5}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v5

    new-instance v8, Lxtj;

    invoke-direct {v8, p0, v4, v5}, Lxtj;-><init>(Lcom/google/firebase/messaging/FirebaseMessagingService;Lup4;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v8}, Lxtj;->y()Z
    ...
    invoke-static {p1}, Louk;->e(Landroid/content/Intent;)Z
    ...
    invoke-static {v5, v4}, Louk;->d(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {v4, v0}, Leie;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Leie;)V
    ...
    :cond_10
    :goto_4
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Love;
    ...
    invoke-direct {v0, v4}, Love;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Love;

    :cond_11
    iget-object p0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Love;

    iget-object v0, p0, Love;->c:Ljrc;

    invoke-virtual {v0}, Ljrc;->E()I
    ...
    invoke-direct {p1, v1, v6, v0, v7}, Lg3m;-><init>(IILandroid/os/Bundle;I)V

    invoke-virtual {p0, p1}, La9m;->m(Lg3m;)Lkam;
...
.method public final declared-synchronized onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->b:Lyxj;
    ...
    invoke-direct {p1, v0}, Lyxj;-><init>(Lex8;)V

    iput-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->b:Lyxj;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object p2, p2, Lljf;->e:Ljava/lang/Object;
    ...
    invoke-direct {v3, p0, p2, v1, v4}, Ld86;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-interface {v2, v3}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    iget-object p2, v1, Lqjh;->a:Lkam;

    invoke-virtual {p2}, Lkam;->i()Z
    ...
    invoke-virtual {p2, p3, v0}, Lkam;->c(Ljava/util/concurrent/Executor;Lotb;)Lkam;
