...
.method public static g(Lau3;I[B)Landroid/os/MemoryFile;
    .locals 8
    ...
    invoke-direct {v1, v4}, Lfbd;-><init>(Lcba;)V
    :try_end_0
    ...
    invoke-direct {v4, v1, p1}, Lm19;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v1}, Lbu3;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lbu3;->b(Ljava/io/InputStream;)V

    invoke-static {v3}, Lbu3;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v3}, Lbu3;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lbu3;->b(Ljava/io/InputStream;)V

    invoke-static {p2}, Lbu3;->a(Ljava/io/Closeable;)V
...
# virtual methods
.method public final c(Lau3;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-virtual {v0}, Lcba;->I()I

    move-result v0

    const/4 v1, 0x0

    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lau3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final d(Lau3;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    invoke-static {p2, p1}, Lcom/facebook/imagepipeline/nativecode/DalvikPurgeableDecoder;->e(ILau3;)Z
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lau3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final h(Lau3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->g(Lau3;I[B)Landroid/os/MemoryFile;
    ...
    invoke-static {p0, p2}, Loc9;->q(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_0
    :try_start_3
    invoke-static {p0}, Layl;->c(Ljava/lang/Throwable;)V
...
.method public final i(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-static {p1}, Layl;->c(Ljava/lang/Throwable;)V
