...
# direct methods
.method public constructor <init>(Lrg0;Landroid/content/Context;)V
    .locals 10
    ...
    iput-object v0, p0, Lac0;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lac0;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lac0;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lac0;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lac0;->b(ILrg0;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lac0;->a:Landroid/media/AudioRecord;
...
.method public static b(ILrg0;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
...
.method public final a()V
    ...
    iget-object p0, p0, Lac0;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lac0;->i:Leif;

    iget-object v1, p0, Lac0;->h:Lrj5;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object p0, p0, Lac0;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p0, v1, p1, v2}, Lnb0;-><init>(Ljava/lang/Object;ZI)V

    invoke-virtual {v0, p0}, Leif;->execute(Ljava/lang/Runnable;)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lac0;->a()V

    iget-object v0, p0, Lac0;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v3, v2}, Ls2e;->b(Ljava/lang/Class;)Lo2e;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object v2, p0, Lac0;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lac0;->j:J

    iput-boolean v4, p0, Lac0;->l:Z

    iget-object v0, p0, Lac0;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, Lac0;->a:Landroid/media/AudioRecord;
    ...
    :cond_4
    invoke-virtual {p0, v4}, Lac0;->c(Z)V
    ...
    iget-object p0, p0, Lac0;->a:Landroid/media/AudioRecord;
...
.method public final read(Ljava/nio/ByteBuffer;)Ltg0;
    ...
    iget-object v5, p0, Lac0;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lac0;->b:Lrg0;

    iget v5, v5, Lrg0;->b:I

    iget-wide v7, p0, Lac0;->j:J
    ...
    invoke-static {v11, v9}, Lqyj;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v9, v6}, Lqyj;->h(Ljava/lang/String;Z)V

    iget-wide v11, p1, Landroid/media/AudioTimestamp;->framePosition:J

    sub-long/2addr v7, v11

    invoke-static {v5, v7, v8}, Lwwk;->a(IJ)J
    ...
    :cond_6
    iget-wide v3, p0, Lac0;->j:J

    int-to-long v5, v0

    iget p1, p0, Lac0;->g:I

    invoke-static {p1, v5, v6}, Lwwk;->c(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lac0;->j:J

    :cond_7
    new-instance p0, Ltg0;

    invoke-direct {p0, v0, v1, v2}, Ltg0;-><init>(IJ)V
