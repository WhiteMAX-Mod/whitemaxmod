...
.method public final e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iput-object p4, p0, Lzri;->b:Ljava/lang/String;
    ...
    invoke-static {p4}, Lqyj;->q(Ljava/lang/String;)[Lqoc;

    move-result-object p4

    iput-object p4, p0, Lzri;->a:[Lqoc;

    :cond_1
    const-string p4, "fillType"

    invoke-static {p2, p4}, Lxzl;->g(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
