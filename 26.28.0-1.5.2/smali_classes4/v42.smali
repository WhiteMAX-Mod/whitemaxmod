...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lg52;->z(Lg52;)V
    ...
    iget-object v1, v0, Lg52;->A1:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, Lg52;->e0(Ljava/lang/CharSequence;)V
    ...
    iget-object v6, v0, Lg52;->w1:Li72;

    const/4 v2, 0x1

    if-eqz v6, :cond_13

    iget-object v3, v6, Li72;->a:Landroid/view/View;

    iget-object v5, v6, Li72;->q:[F

    iget-object v7, v6, Li72;->r:[F

    iget-object v8, v6, Li72;->j:Landroid/view/ScaleGestureDetector;

    iget-object v11, v6, Li72;->h:Landroid/graphics/Matrix;

    iget-object v12, v6, Li72;->t:Landroid/graphics/Matrix;

    iget-boolean v9, v6, Li72;->v:Z

    if-nez v9, :cond_0

    invoke-virtual {v6}, Li72;->g()V

    :cond_0
    iget-boolean v9, v6, Li72;->x:Z
    ...
    :cond_4
    iget-object v9, v6, Li72;->n:Landroid/view/GestureDetector;
    ...
    iget-boolean v9, v6, Li72;->k:Z

    if-nez v9, :cond_5

    iget-boolean v9, v6, Li72;->l:Z
    ...
    :cond_9
    iput-boolean v4, v6, Li72;->x:Z

    iget-boolean v8, v6, Li72;->m:Z

    iput-boolean v4, v6, Li72;->m:Z

    if-eqz v15, :cond_c

    iget-boolean v9, v6, Li72;->A:Z
    ...
    invoke-direct/range {v5 .. v10}, Lqw1;-><init>(Li72;FFFF)V

    invoke-static {v12}, Lv3e;->a(Landroid/graphics/Matrix;)F

    move-result v16

    invoke-static {v11}, Lv3e;->a(Landroid/graphics/Matrix;)F
    ...
    invoke-direct {v4, v6}, Le72;-><init>(Li72;)V
    ...
    invoke-direct {v4, v5, v6}, Lf72;-><init>(Lqw1;Li72;)V

    invoke-virtual {v3, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    :goto_5
    iget-object v4, v6, Li72;->w:Lc72;
    ...
    iput-object v3, v6, Li72;->u:Landroid/animation/ValueAnimator;
    ...
    :goto_9
    iget-object v0, v0, Lg52;->v1:Landroid/view/GestureDetector;
    ...
    invoke-static {v0}, Lg52;->E(Lg52;)V
