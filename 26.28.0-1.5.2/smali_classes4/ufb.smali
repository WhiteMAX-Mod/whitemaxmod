...
.field public static final w:Lsfb;
...
.field public final p:Llhf;

.field public final q:Lhq9;

.field public final r:Luxb;

.field public final s:Landroid/widget/ImageView;

.field public final t:Lu35;

.field public final u:Lfea;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lufb;->v:Ljava/lang/String;

    new-instance v0, Lsfb;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lufb;->w:Lsfb;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lufb;->a:Lp6e;

    iput-object v1, p0, Lufb;->b:Lgia;

    iput-object v2, p0, Lufb;->c:Ldhf;

    iput-object v3, p0, Lufb;->d:Li24;

    iput-object v4, p0, Lufb;->e:Lvyf;
    ...
    iput-object v5, p0, Lufb;->p:Llhf;

    new-instance v5, Lhq9;

    invoke-direct {v5, p1}, Lt58;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5}, Lfu5;->getHierarchy()Ldu5;

    move-result-object v6

    check-cast v6, Lwj7;

    sget-object v7, Li1f;->n:Li1f;

    invoke-virtual {v6, v7}, Lwj7;->h(Lcqk;)V

    iput-object v5, p0, Lufb;->q:Lhq9;

    new-instance v6, Luxb;

    invoke-direct {v6, p1}, Luxb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v7}, Luxb;->setText(Ljava/lang/CharSequence;)V

    iput-object v6, p0, Lufb;->r:Luxb;
    ...
    invoke-virtual {v8, v7}, La8g;->h(Landroid/view/View;)Lkbc;
    ...
    iput-object v7, p0, Lufb;->s:Landroid/widget/ImageView;

    new-instance v9, Lu35;

    invoke-direct {v9, p1}, Lu35;-><init>(Landroid/content/Context;)V

    const/4 p1, 0x0

    invoke-virtual {v9, p1}, Lu35;->setBackgroundEnabled$message_list(Z)V

    iput-object v9, p0, Lufb;->t:Lu35;

    sget-object p1, Lfea;->u:Lxr8;

    invoke-virtual {v8, p0}, La8g;->h(Landroid/view/View;)Lkbc;

    move-result-object v8

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v8}, Lxr8;->j(Lkbc;)Lfea;

    move-result-object p1

    iput-object p1, p0, Lufb;->u:Lfea;
...
.method public final a(Lzj7;)V
    .locals 3

    iget-wide v0, p1, Lzj7;->i:D

    iput-wide v0, p0, Lufb;->m:D
    ...
    :cond_1
    iget-object p1, p1, Lzj7;->h:Ljava/lang/String;

    goto :goto_1

    :cond_2
    :goto_0
    iget-object p1, p1, Lzj7;->g:Ljava/lang/String;
    ...
    sget-object v0, Lufb;->w:Lsfb;

    iput-object v0, p1, Lw78;->l:Lls0;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v0, p0, Lufb;->u:Lfea;

    iget-object v1, v0, Lfea;->h:Landroid/graphics/Path;

    if-nez v1, :cond_0

    iget-object v1, v0, Lfea;->g:Landroid/graphics/Path;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lufb;->u:Lfea;

    iget p1, p1, Lfea;->s:F

    float-to-int p1, p1

    iget-object p2, p0, Lufb;->p:Llhf;
    ...
    invoke-virtual {v0, v1, p2}, Lsr;->T(II)V

    :cond_1
    iget-object p2, p0, Lufb;->b:Lgia;
    ...
    invoke-static {v0, p4, p2, p3}, Lc0a;->e(FFII)I

    move-result p3

    :cond_3
    iget-object p2, p0, Lufb;->q:Lhq9;

    const/16 p4, 0xc

    invoke-static {p2, p5, p3, p5, p4}, Lqyj;->M(Landroid/view/View;IIII)V
    ...
    iget-object v2, p0, Lufb;->s:Landroid/widget/ImageView;

    invoke-static {v2, v0, v1, p5, p4}, Lqyj;->M(Landroid/view/View;IIII)V
    ...
    iget-object p3, p0, Lufb;->r:Luxb;

    invoke-static {p3, v0, p2, p5, p4}, Lqyj;->M(Landroid/view/View;IIII)V
    ...
    invoke-static {v0, p2, p3, p5, p4}, Lqyj;->M(Landroid/view/View;IIII)V

    iget-object p2, p0, Lufb;->a:Lp6e;
    ...
    invoke-virtual {p3, p5, v1}, Lsr;->T(II)V
...
.method public final onMeasure(II)V
    ...
    invoke-virtual {v3, v2, p2}, Lsr;->U(II)V

    :cond_0
    iget-object v3, v5, Llhf;->b:Lny8;
    ...
    invoke-virtual {v5, v2, p2}, Llhf;->d(II)V
    ...
    invoke-static {v5, v4, v3, v2}, Lc0a;->e(FFII)I

    move-result v2

    :cond_3
    iget-object v3, p0, Lufb;->t:Lu35;
    ...
    iget-object v2, p0, Lufb;->e:Lvyf;

    iget-object v5, v2, Lsr;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v5, p2}, Lsr;->U(II)V
    ...
    invoke-virtual {v2, v1, p2}, Lsr;->U(II)V
    ...
    invoke-virtual {v1, p1, p2}, Lsr;->U(II)V
...
.method public final setExternalMapButtonText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, Luxb;->setText(Ljava/lang/CharSequence;)V
