...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lyg;->b:Landroid/location/Address;

    new-instance v0, Lyo9;

    const/16 v1, 0x64

    invoke-direct {v0, v1}, Lyo9;-><init>(I)V

    invoke-static {v0}, Ljava/util/Collections;->synchronizedMap(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v0

    sput-object v0, Lyg;->c:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lifh;)V
    .locals 2
...
.method public static d(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lyg;->g(Ljava/lang/String;)Z
...
.method public static g(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lch3;->a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method public final a(DDDD)F
    ...
    invoke-static/range {p1 .. p8}, Luvl;->a(DDDD)D
...
.method public final b(DDDDLnq4;)Ljava/lang/Object;
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lyg;->f(DD)Landroid/location/Address;
    ...
    :cond_0
    invoke-virtual {p0, p5, p6, p7, p8}, Lyg;->f(DD)Landroid/location/Address;
    ...
    invoke-static {p3}, Lyg;->g(Ljava/lang/String;)Z
    ...
    invoke-static {p4}, Lyg;->g(Ljava/lang/String;)Z
    ...
    invoke-static {p3, p5, p4}, Lzo5;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p3, p0}, Lyg;->d(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p2, p0}, Lyg;->e(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lwoh;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p3, p0}, Lyg;->e(Landroid/location/Address;Ljava/lang/String;Landroid/location/Address;)Ljava/lang/String;
    ...
    :cond_8
    invoke-static {p2}, Lyg;->g(Ljava/lang/String;)Z
    ...
    invoke-static {p2, p0, p1}, Lzo5;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final f(DD)Landroid/location/Address;
    ...
    sget-object v0, Lyg;->c:Ljava/util/Map;
    ...
    sget-object v4, Lyg;->b:Landroid/location/Address;
