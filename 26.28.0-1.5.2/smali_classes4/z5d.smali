...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {v3, v2, v1}, Lx05;->j(FFLandroid/widget/ImageView;)V
    ...
    iput-object v1, p0, Lz5d;->a:Landroid/widget/ImageView;

    new-instance v4, Ljac;

    invoke-direct {v4, p1}, Ljac;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v0}, Ljac;->setEndIconDrawable(Lny8;)V

    new-instance p1, Lx5d;

    invoke-direct {p1}, Lx5d;-><init>()V
    ...
    invoke-virtual {v4, v0}, Ljac;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-virtual {v4, p1}, Ljac;->setLimitErrorTextColorAttr(Ljava/lang/Integer;)V

    iput-object v4, p0, Lz5d;->b:Ljac;
    ...
    invoke-virtual {p0, p1}, Lz5d;->onThemeChanged(Lkbc;)V
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p3, p0, Lz5d;->a:Landroid/widget/ImageView;
...
.method public final onMeasure(II)V
    ...
    iget-object v3, p0, Lz5d;->a:Landroid/widget/ImageView;
...
.method public final onThemeChanged(Lkbc;)V
    ...
    iget-object v1, p0, Lz5d;->a:Landroid/widget/ImageView;

    invoke-virtual {v1, v0}, Landroid/widget/ImageView;->setImageTintList(Landroid/content/res/ColorStateList;)V

    iget-object v0, p0, Lz5d;->b:Ljac;

    invoke-virtual {v0, p1}, Ljac;->onThemeChanged(Lkbc;)V
...
.method public final setImeOptions(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1}, Ljac;->setImeOptions(Ljava/lang/Integer;)V
...
.method public final setLengthLimit(I)V
    ...
    invoke-virtual {p0, p1}, Ljac;->setMaxLengthForLabel(I)V

    invoke-virtual {p0}, Ljac;->getFilters()[Landroid/text/InputFilter;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/a;->j1([Ljava/lang/Object;[Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Landroid/text/InputFilter;

    invoke-virtual {p0, p1}, Ljac;->setFilters([Landroid/text/InputFilter;)V
...
.method public final setOnDragIconTouchListener(Lqf7;)V
    ...
    iget-object p0, p0, Lz5d;->a:Landroid/widget/ImageView;
...
.method public final setOnEditorActionListener(Lcf7;)V
    ...
    invoke-virtual {p0, v0}, Ljac;->setOnEditorActionListener(Lcf7;)V

    return-void
.end method

.method public final setOnRemoveListener(Laf7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0}, Ljac;->setOnKeyListener(Lqf7;)V
...
.method public final setShowLengthLimitWhileFocused(Z)V
    ...
    invoke-virtual {p0, p1}, Ljac;->setShowLengthLimitWhileFocused(Z)V
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, Ljac;->setText(Ljava/lang/CharSequence;)V
