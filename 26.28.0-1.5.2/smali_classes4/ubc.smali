...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lubc;->c:Landroid/text/style/TextAppearanceSpan;
    ...
    iput-object v0, p0, Lubc;->e:Landroid/text/style/TextAppearanceSpan;
    ...
    iput-object v1, p0, Lubc;->g:Landroid/graphics/drawable/ShapeDrawable;
    ...
    invoke-static {v3, v1, v4, v5}, Lcol;->e(Lkbc;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/RippleDrawable;

    move-result-object v1

    iput-object v1, p0, Lubc;->h:Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-static {v0, v1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object v1

    iput-object v1, p0, Lubc;->i:Lny8;

    new-instance v1, Lvx9;

    const/16 v3, 0x13

    invoke-direct {v1, p1, v3, p0}, Lvx9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v0, v1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object p1

    iput-object p1, p0, Lubc;->j:Lny8;

    new-instance p1, Lzb;

    invoke-direct {p1, p0}, Lzb;-><init>(Lubc;)V

    iput-object p1, p0, Lubc;->k:Lzb;
    ...
    invoke-virtual {p0, p1}, Lubc;->onThemeChanged(Lkbc;)V

    return-void
.end method

.method public static final a(Lubc;Z)V
    .locals 2
    ...
    invoke-direct {p0, v1}, Lpyb;-><init>(I)V
...
.method public final b(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, v1}, Lubc;->setupTextViewParams(Landroid/widget/TextView;)V

    invoke-static {v1, p0}, Ln7j;->b(Landroid/view/View;Landroid/view/ViewGroup;)V

    iget-object v1, p0, Lubc;->a:Landroid/text/SpannableString;
    ...
    iget-object v6, p0, Lubc;->c:Landroid/text/style/TextAppearanceSpan;
    ...
    :goto_0
    iput-object v1, p0, Lubc;->a:Landroid/text/SpannableString;

    :cond_1
    iget-object p1, p0, Lubc;->b:Landroid/text/SpannableString;
    ...
    iget-object v1, p0, Lubc;->e:Landroid/text/style/TextAppearanceSpan;
    ...
    :cond_2
    iput-object v4, p0, Lubc;->b:Landroid/text/SpannableString;
    ...
    iget-object v0, p0, Lubc;->a:Landroid/text/SpannableString;
    ...
    iget-object p0, p0, Lubc;->b:Landroid/text/SpannableString;
...
.method public final c()V
    ...
    sget-object v1, Lf61;->$EnumSwitchMapping$0:[I
...
.method public final onThemeChanged(Lkbc;)V
    ...
    iget-object p1, p0, Lubc;->g:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object v0, p0, Lubc;->h:Landroid/graphics/drawable/RippleDrawable;

    invoke-virtual {v0, p1}, Landroid/graphics/drawable/RippleDrawable;->setColor(Landroid/content/res/ColorStateList;)V

    invoke-virtual {p0, v0}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0}, Lubc;->c()V
...
.method public final setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v0, p1}, Lubc;->b(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lubc;->b:Landroid/text/SpannableString;

    invoke-virtual {p0, p1, v0}, Lubc;->b(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
