...
.method public static a(FF)I
    ...
    invoke-static {v4, v1}, Lqyj;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, v0, v3, p1}, Lqyj;->j(ILjava/lang/String;II)V

    return p0
.end method

.method public static c(Lbg2;)F
    .locals 4
    ...
    invoke-static {p0, v0}, Lqyj;->k(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static d(Lbg2;)F
    ...
    invoke-virtual {p0, v1}, Lqb2;->c(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2}, Lqb2;->c(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v2

    const-string v3, "The active array size can\'t be null."

    invoke-static {v2, v3}, Lqyj;->k(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p0, v3}, Lqyj;->k(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Ly1i;->f(Landroid/graphics/Rect;)Landroid/util/Size;

    move-result-object v1

    invoke-static {p0}, Ly1i;->c(I)Z
...
# virtual methods
.method public final b(Lbg2;)I
    .locals 7

    iget-object p0, p0, Lvk8;->a:Lme2;
    ...
    invoke-virtual {p0}, Lme2;->c()Lya2;

    move-result-object v2

    iget-object v2, v2, Lya2;->c:Lkc2;

    invoke-virtual {v2, v1}, Lkc2;->d(Ljava/lang/String;)Lbg2;
    ...
    invoke-static {v4, v1}, Lqyj;->k(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4}, Lqyj;->k(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lvk8;->c(Lbg2;)F

    move-result p0

    invoke-static {v2}, Lvk8;->d(Lbg2;)F

    move-result p1

    invoke-static {p0, p1}, Lvk8;->a(FF)I
    ...
    iget-object p1, p1, Lqb2;->a:Ljava/lang/String;
