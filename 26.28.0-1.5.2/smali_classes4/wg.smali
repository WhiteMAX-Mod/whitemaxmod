...
.method public constructor <init>(Landroid/hardware/camera2/TotalCaptureResult;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lwg;->a:Landroid/hardware/camera2/TotalCaptureResult;

    new-instance v0, Lxg;

    invoke-direct {v0, p1, p2}, Lxg;-><init>(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)V

    iput-object v0, p0, Lwg;->b:Lxg;
    ...
    invoke-static {p1}, Lhg;->n(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/util/Map;
    ...
    invoke-static {p1}, Ln4;->q(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lef2;->a(Ljava/lang/String;)V

    new-instance v1, Lef2;

    invoke-direct {v1, v0}, Lef2;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, p2, v0}, Lxg;-><init>(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)V
...
.method public final W(Lsr3;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object p0, p0, Lwg;->a:Landroid/hardware/camera2/TotalCaptureResult;
