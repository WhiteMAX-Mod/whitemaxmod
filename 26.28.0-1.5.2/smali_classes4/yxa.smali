...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lyxa;->a:Landroid/content/Context;

    new-instance p1, Lwxa;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, Lwxa;-><init>(Lyxa;I)V
    ...
    iput-object p1, p0, Lyxa;->b:Lny8;

    new-instance p1, Lwxa;

    const/4 v2, 0x1

    invoke-direct {p1, p0, v2}, Lwxa;-><init>(Lyxa;I)V

    invoke-static {v1, p1}, Lrx8;->P(ILaf7;)Lny8;

    move-result-object p1

    iput-object p1, p0, Lyxa;->c:Lny8;
    ...
    invoke-direct {v1, p0, v0}, Lxxa;-><init>(Lyxa;I)V

    invoke-virtual {p1, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lyxa;->e:Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v0, p0, v2}, Lxxa;-><init>(Lyxa;I)V

    invoke-virtual {p1, v0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lyxa;->g:Landroid/animation/ObjectAnimator;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lyxa;->h:Landroid/graphics/Path;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, Lyxa;->h:Landroid/graphics/Path;
...
.method public final isRunning()Z
    ...
    iget-object v0, p0, Lyxa;->e:Landroid/animation/ObjectAnimator;
    ...
    iget-object p0, p0, Lyxa;->g:Landroid/animation/ObjectAnimator;
