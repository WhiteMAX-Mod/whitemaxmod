...
.field public volatile k:Lwe4;

.field public volatile l:J

.field public final m:Ljava/util/concurrent/CopyOnWriteArraySet;

.field public final n:Lbe4;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Liz8;Lifh;Lny8;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lde4;->a:Landroid/content/Context;

    iput-object p2, p0, Lde4;->b:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Lde4;->c:Liz8;

    iput-object p5, p0, Lde4;->d:Lny8;

    iput-object p4, p0, Lde4;->e:Lifh;
    ...
    iput-object p1, p0, Lde4;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lde4;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lde4;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Lzd4;

    invoke-direct {p3, p0, p2}, Lzd4;-><init>(Lde4;I)V

    new-instance p4, Lifh;

    invoke-direct {p4, p3}, Lifh;-><init>(Laf7;)V

    iput-object p4, p0, Lde4;->i:Lifh;

    new-instance p3, Lzd4;

    const/4 p4, 0x1

    invoke-direct {p3, p0, p4}, Lzd4;-><init>(Lde4;I)V

    new-instance p4, Lifh;

    invoke-direct {p4, p3}, Lifh;-><init>(Laf7;)V

    iput-object p4, p0, Lde4;->j:Lifh;

    sget-object p3, Lwe4;->b:Lwe4;

    iput-object p3, p0, Lde4;->k:Lwe4;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Lde4;->m:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lbe4;

    invoke-direct {p3, p0}, Lbe4;-><init>(Lde4;)V

    iput-object p3, p0, Lde4;->n:Lbe4;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lae4;->f:Lae4;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Lde4;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Lde4;->p:Ljava/lang/String;

    invoke-virtual {p0, p2}, Lde4;->o(Z)Z

    move-result p2

    invoke-virtual {p1, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p0}, Lde4;->n()V

    return-void
.end method

.method public static j(Lde4;)Landroid/net/NetworkCapabilities;
    .locals 4

    invoke-virtual {p0}, Lde4;->i()Landroid/net/Network;
    ...
    :try_start_0
    invoke-virtual {p0}, Lde4;->l()Landroid/net/ConnectivityManager;
    ...
    iget-object p0, p0, Lde4;->p:Ljava/lang/String;
...
.method public static k(Landroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)Lwe4;
    .locals 6
    ...
    :cond_a
    :goto_2
    sget-object p0, Lwe4;->b:Lwe4;

    return-object p0

    :cond_b
    :goto_3
    sget-object p0, Lwe4;->c:Lwe4;
...
.method public final a()Lwe4;
    ...
    iget-object v0, p0, Lde4;->k:Lwe4;

    sget-object v1, Lwe4;->b:Lwe4;

    if-eq v0, v1, :cond_0

    iget-object p0, p0, Lde4;->k:Lwe4;
    ...
    invoke-virtual {p0, v2}, Lde4;->m(Landroid/net/Network;)Landroid/net/NetworkInfo;

    move-result-object v1

    invoke-static {v0, v1}, Lde4;->k(Landroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)Lwe4;
    ...
    invoke-virtual {v3, v2, v0}, Liv4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, p0, Lde4;->k:Lwe4;
...
.method public final h()Z
    ...
    iget-object v0, p0, Lde4;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lde4;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Lde4;->p:Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Ljz8;->a(Ljava/lang/Throwable;)V
...
.method public final invalidate()V
    ...
    iget-object v0, p0, Lde4;->p:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lde4;->o(Z)Z
    ...
    invoke-virtual {p0, v2}, Lde4;->p(Lylc;)Lae4;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v0}, Lde4;->q(Lae4;)V
...
.method public final m(Landroid/net/Network;)Landroid/net/NetworkInfo;
    ...
    invoke-virtual {v3, v4, p0, p1, v1}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
...
.method public final n()V
    ...
    iget-object v0, p0, Lde4;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v3, v5, v0, v6, v4}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    :goto_0
    iget-object v3, p0, Lde4;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    :try_start_0
    iget-object v5, p0, Lde4;->a:Landroid/content/Context;

    new-instance v6, Lgu0;

    const/4 v0, 0x2

    invoke-direct {v6, v0, p0}, Lgu0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static/range {v5 .. v10}, Lnp4;->z(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    invoke-virtual {v5, v6, v0, v7, v4}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_2
    iget-object v4, p0, Lde4;->p:Ljava/lang/String;
    ...
    iget-object v4, p0, Lde4;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, v2}, Ljz8;->a(Ljava/lang/Throwable;)V
...
.method public final o(Z)Z
    ...
    invoke-virtual {v0, p1}, Ljz8;->a(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v2, p1}, Liv4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final p(Lylc;)Lae4;
    .locals 14
    ...
    iget-object v3, p1, Lylc;->a:Ljava/lang/Object;
    ...
    :cond_4
    invoke-static {p0}, Lde4;->j(Lde4;)Landroid/net/NetworkCapabilities;
    ...
    :cond_e
    invoke-virtual {p0, v3}, Lde4;->m(Landroid/net/Network;)Landroid/net/NetworkInfo;
    ...
    invoke-direct/range {v8 .. v13}, Lae4;-><init>(ZZZZZ)V
    ...
    invoke-static {v5, v6, v7, v10, v2}, Lqt4;->t(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final q(Lae4;)V
    .locals 7

    sget-object v0, Lje9;->c:Lje9;

    iget-object v1, p0, Lde4;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_2
    iget-object v2, p0, Lde4;->o:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v2, p1}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    iget-boolean v1, v1, Lae4;->e:Z

    iget-boolean v2, p1, Lae4;->e:Z
    ...
    iget-boolean v4, p1, Lae4;->e:Z

    const-string v5, "updateInet, vpn changed to "

    const-string v6, ", reset dns ..."

    invoke-static {v5, v6, v4}, Lqv1;->m(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object v2, v1, Lvo5;->e:Ljava/lang/String;
    ...
    :cond_6
    :goto_2
    iget-object v0, v1, Lvo5;->f:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    :try_start_0
    invoke-static {v1, v3, v2}, Lvo5;->c(Lvo5;Lv44;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_7
    :goto_3
    iget-object v0, p0, Lde4;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v0, v4, v1, p1, v3}, La4c;->c(Lje9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_b
    :goto_4
    iget-object p1, p0, Lde4;->b:Ljava/util/concurrent/ExecutorService;
