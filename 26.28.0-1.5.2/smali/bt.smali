...
.method public static c(Landroid/content/Context;Lxr;I)Llh6;
    .locals 1

    monitor-enter p1

    :try_start_0
    iget-object v0, p1, Lxr;->a:Lhne;

    invoke-virtual {v0, p0, p2}, Lhne;->g(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-boolean p2, p1, Llh6;->c:Z

    iput-object p0, p1, Llh6;->d:Ljava/lang/Object;
...
# virtual methods
.method public final a(Landroid/graphics/drawable/Drawable;Llh6;)V
    .locals 0
    ...
    invoke-static {p1, p2, p0}, Lxr;->d(Landroid/graphics/drawable/Drawable;Llh6;[I)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lbt;->c:Llh6;

    if-nez v0, :cond_0

    iget-object v0, p0, Lbt;->d:Llh6;

    if-nez v0, :cond_0

    iget-object v0, p0, Lbt;->e:Llh6;
    ...
    iget-object v5, p0, Lbt;->b:Llh6;

    invoke-virtual {p0, v4, v5}, Lbt;->a(Landroid/graphics/drawable/Drawable;Llh6;)V

    const/4 v4, 0x1

    aget-object v4, v0, v4

    iget-object v5, p0, Lbt;->c:Llh6;

    invoke-virtual {p0, v4, v5}, Lbt;->a(Landroid/graphics/drawable/Drawable;Llh6;)V

    aget-object v4, v0, v1

    iget-object v5, p0, Lbt;->d:Llh6;
    ...
    iget-object v4, p0, Lbt;->e:Llh6;

    invoke-virtual {p0, v0, v4}, Lbt;->a(Landroid/graphics/drawable/Drawable;Llh6;)V

    :cond_1
    iget-object v0, p0, Lbt;->f:Llh6;

    if-nez v0, :cond_3

    iget-object v0, p0, Lbt;->g:Llh6;
    ...
    iget-object v3, p0, Lbt;->f:Llh6;

    invoke-virtual {p0, v2, v3}, Lbt;->a(Landroid/graphics/drawable/Drawable;Llh6;)V

    aget-object v0, v0, v1

    iget-object v1, p0, Lbt;->g:Llh6;

    invoke-virtual {p0, v0, v1}, Lbt;->a(Landroid/graphics/drawable/Drawable;Llh6;)V
...
.method public final f(Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Ll3e;->h:[I

    invoke-static {v8, v3, v2, v5}, Lvbf;->k(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lvbf;
    ...
    iget-object v4, v10, Lvbf;->b:Ljava/lang/Object;
    ...
    iget-object v1, v10, Lvbf;->b:Ljava/lang/Object;
    ...
    invoke-static {v8, v9, v4}, Lbt;->c(Landroid/content/Context;Lxr;I)Llh6;

    move-result-object v4

    iput-object v4, v0, Lbt;->b:Llh6;
    ...
    invoke-static {v8, v9, v6}, Lbt;->c(Landroid/content/Context;Lxr;I)Llh6;

    move-result-object v6

    iput-object v6, v0, Lbt;->e:Llh6;
    ...
    invoke-static {v8, v9, v1}, Lbt;->c(Landroid/content/Context;Lxr;I)Llh6;

    move-result-object v1

    iput-object v1, v0, Lbt;->g:Llh6;

    :cond_5
    invoke-virtual {v10}, Lvbf;->l()V
    ...
    invoke-direct {v6, v8, v2}, Lvbf;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    :goto_0
    invoke-virtual {v0, v8, v6}, Lbt;->m(Landroid/content/Context;Lvbf;)V
    ...
    invoke-direct {v6, v8, v10}, Lvbf;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-static {v8, v2}, Lnp4;->l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :goto_22
    invoke-static {v7, v2}, Lixl;->g(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v1, v2}, Lvt5;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v1

    invoke-static {v7, v1}, Lixl;->h(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v7, v3, v4}, Lv4;->k(Landroid/widget/TextView;IF)V
...
.method public final g(Landroid/content/Context;I)V
    ...
    sget-object v1, Ll3e;->w:[I

    invoke-virtual {p1, p2, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p2

    invoke-direct {v0, p1, p2}, Lvbf;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    :cond_1
    invoke-virtual {p0, p1, v0}, Lbt;->m(Landroid/content/Context;Lvbf;)V
...
.method public final i([II)V
    ...
    invoke-static {p1, p0}, Lqr7;->j(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final k(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Lbt;->b:Llh6;

    iput-object v0, p0, Lbt;->c:Llh6;

    iput-object v0, p0, Lbt;->d:Llh6;

    iput-object v0, p0, Lbt;->e:Llh6;

    iput-object v0, p0, Lbt;->f:Llh6;

    iput-object v0, p0, Lbt;->g:Llh6;
...
.method public final m(Landroid/content/Context;Lvbf;)V
    .locals 11

    iget v0, p0, Lbt;->j:I

    iget-object v1, p2, Lvbf;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p2, v5, p1, v10}, Lvbf;->h(IILws;)Landroid/graphics/Typeface;
