...
.method public final attachBaseContext(Landroid/content/Context;)V
    ...
    :goto_0
    invoke-virtual {v0, p1, v2}, Lvr;->D(Landroid/content/Context;I)I
    ...
    :cond_1
    invoke-static {p1}, Lvr;->q(Landroid/content/Context;)Lmc9;
    ...
    invoke-static {p1, v0, v2, v5, v4}, Lvr;->u(Landroid/content/Context;ILmc9;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    invoke-virtual {v4, v3}, Lhq4;->a(Landroid/content/res/Configuration;)V
    :try_end_1
    ...
    :cond_12
    invoke-static {v3, v6, v5}, Lftk;->a(Landroid/content/res/Configuration;Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    :cond_18
    :goto_1
    invoke-static {p1, v0, v2, v5, v1}, Lvr;->u(Landroid/content/Context;ILmc9;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    invoke-direct {v1, p1, v2}, Lhq4;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v1, v0}, Lhq4;->a(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1}, Lhq4;->getTheme()Landroid/content/res/Resources$Theme;

    move-result-object p1

    invoke-static {p1}, Ly74;->a(Landroid/content/res/Resources$Theme;)V
...
.method public final dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-super {p0, p1}, Lg74;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public final getMenuInflater()Landroid/view/MenuInflater;
    ...
    invoke-virtual {v1}, Llwj;->e()Landroid/content/Context;
    ...
    :goto_0
    invoke-direct {v0, v1}, Lyah;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lvr;->o:Lyah;

    :cond_1
    iget-object p0, p0, Lvr;->o:Lyah;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lg74;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lvr;->n:Llwj;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Llwj;->g()V
    ...
    :try_start_1
    iget-object v2, v1, Lhne;->b:Ljava/util/WeakHashMap;
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lp90;->t(Lar;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Lqkh;->b(Lar;)Lqkh;

    move-result-object p1

    invoke-virtual {p1, p0}, Lqkh;->a(Lar;)V

    invoke-virtual {p1}, Lqkh;->c()V

    :try_start_0
    invoke-static {p0}, Ln9;->N(Lar;)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
