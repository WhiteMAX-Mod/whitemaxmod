...
# direct methods
.method public synthetic constructor <init>(Ljava/lang/String;Ljava/util/List;ILtoa;Lwja;)V
    .locals 0
    ...
    iput-object p2, p0, Lcoa;->b:Ljava/util/List;

    iput p3, p0, Lcoa;->c:I

    iput-object p4, p0, Lcoa;->d:Ltoa;

    iput-object p5, p0, Lcoa;->e:Lwja;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lcoa;->b:Ljava/util/List;

    iget v2, v0, Lcoa;->c:I

    iget-object v3, v0, Lcoa;->d:Ltoa;

    iget-object v4, v0, Lcoa;->e:Lwja;

    move-object/from16 v5, p1

    check-cast v5, Lqxe;

    iget-object v0, v0, Lcoa;->a:Ljava/lang/String;

    invoke-interface {v5, v0}, Lqxe;->O0(Ljava/lang/String;)Lvxe;
    ...
    invoke-interface {v5, v6, v7, v8}, Lvxe;->c(IJ)V
    ...
    invoke-interface {v5, v2, v6, v7}, Lvxe;->c(IJ)V
    ...
    invoke-interface {v5, v4}, Lvxe;->getLong(I)J

    move-result-wide v46

    invoke-interface {v5, v6}, Lvxe;->getLong(I)J

    move-result-wide v48

    invoke-interface {v5, v7}, Lvxe;->getLong(I)J
    ...
    invoke-interface {v5, v9}, Lvxe;->isNull(I)Z
    ...
    :cond_1
    invoke-interface {v5, v9}, Lvxe;->B0(I)Ljava/lang/String;
    ...
    invoke-static {v6}, Ldwa;->b(I)Lxfa;
    ...
    invoke-static {v6}, Ldwa;->d(I)Lwja;
    ...
    invoke-interface {v5, v14}, Lvxe;->isNull(I)Z
    ...
    :cond_3
    invoke-interface {v5, v14}, Lvxe;->B0(I)Ljava/lang/String;
    ...
    :goto_4
    invoke-interface {v5, v15}, Lvxe;->isNull(I)Z
    ...
    :cond_4
    invoke-interface {v5, v15}, Lvxe;->B0(I)Ljava/lang/String;
    ...
    :cond_5
    invoke-interface {v5, v1}, Lvxe;->getBlob(I)[B
    ...
    invoke-static {v6}, Ldwa;->a([B)Lc46;
    ...
    invoke-interface {v5, v2}, Lvxe;->isNull(I)Z
    ...
    :cond_9
    invoke-interface {v5, v0}, Lvxe;->B0(I)Ljava/lang/String;
