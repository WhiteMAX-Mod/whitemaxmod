...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcl;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Ln1g;->h(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {v7}, Ly5h;->B0(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lcl;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lcl;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Lk81;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Lcl;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lsk;->e:Lsk;

    iget-object v12, v0, Lcl;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v13, v12, v3}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Luk;->e:Luk;

    invoke-virtual {v14, v12, v3}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Lsk;->j:Lsk;

    invoke-virtual {v15, v12, v3}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lil;

    instance-of v12, v3, Lgl;

    if-nez v12, :cond_6

    instance-of v3, v3, Lhl;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lqyj;->r(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    :cond_12
    sget-object v0, Lsk;->f:Lsk;

    invoke-virtual {v0, v12, v3}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    iget-object p0, p0, Lcl;->a:Landroid/content/Context;

    invoke-virtual {v0, p0, p2}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p0, p2}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p0, p2}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lil;

    sget-object v3, Lsk;->j:Lsk;

    invoke-virtual {v3, p0, p2}, Lf2;->e(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lil;

    instance-of p2, v1, Ldl;
    ...
    :cond_0
    instance-of p2, p0, Lhl;

    if-eqz p2, :cond_2

    new-instance p0, Lel;

    invoke-direct {p0, v4}, Lel;-><init>(F)V
    ...
    invoke-direct {p0, v3}, Ldl;-><init>(I)V

    :cond_2
    :goto_1
    instance-of p2, p0, Lel;

    instance-of v5, p0, Lgl;

    const/4 v6, 0x0

    if-eqz v5, :cond_f

    instance-of p0, v1, Lgl;
    ...
    iget-object p2, p2, Lgl;->a:Ljava/lang/String;

    invoke-static {p2}, Lqyj;->q(Ljava/lang/String;)[Lqoc;
    ...
    iget-object v4, v4, Lgl;->a:Ljava/lang/String;

    invoke-static {v4}, Lqyj;->q(Ljava/lang/String;)[Lqoc;
    ...
    invoke-direct {v5}, Lgwd;-><init>()V

    if-eqz v4, :cond_d

    invoke-static {p2, v4}, Lqyj;->d([Lqoc;[Lqoc;)Z
    ...
    iget-object p0, v1, Lgl;->a:Ljava/lang/String;
    ...
    iget-object v6, v2, Lgl;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p0, v0, v6}, Lqv1;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
