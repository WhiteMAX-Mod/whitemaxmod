...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
    ...
    .line 91
    iput-wide p4, p0, Lx2d;->c:J

    .line 92
    iput p6, p0, Lx2d;->d:F

    .line 93
    iput-wide p7, p0, Lx2d;->e:J

    .line 94
    iput p9, p0, Lx2d;->f:I

    .line 95
    iput-object p10, p0, Lx2d;->g:Ljava/lang/CharSequence;

    .line 96
    iput-wide p11, p0, Lx2d;->h:J
    ...
    :goto_0
    iput-object p1, p0, Lx2d;->i:Ljava/util/List;

    move-wide p1, p14

    .line 100
    iput-wide p1, p0, Lx2d;->j:J

    move-object/from16 p1, p16

    .line 101
    iput-object p1, p0, Lx2d;->k:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-wide v0, p0, Lx2d;->h:J

    invoke-virtual {p1}, Landroid/os/Parcel;->readLong()J

    move-result-wide v0

    iput-wide v0, p0, Lx2d;->c:J

    invoke-virtual {p1}, Landroid/os/Parcel;->readLong()J

    move-result-wide v0

    iput-wide v0, p0, Lx2d;->e:J
    ...
    iput-object v0, p0, Lx2d;->g:Ljava/lang/CharSequence;

    sget-object v0, Lw2d;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :cond_0
    iput-object v0, p0, Lx2d;->i:Ljava/util/List;

    invoke-virtual {p1}, Landroid/os/Parcel;->readLong()J

    move-result-wide v0

    iput-wide v0, p0, Lx2d;->j:J
    ...
    iput-object v0, p0, Lx2d;->k:Landroid/os/Bundle;
...
.method public static a(Landroid/media/session/PlaybackState;)Lx2d;
    .locals 21
    ...
    :cond_0
    invoke-static {v3}, Lw2d;->a(Landroid/media/session/PlaybackState$CustomAction;)Lw2d;
    ...
    invoke-direct/range {v4 .. v20}, Lx2d;-><init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V

    iput-object v0, v4, Lx2d;->l:Landroid/media/session/PlaybackState;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lx2d;->g:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lx2d;->i:Ljava/util/List;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-wide v0, p0, Lx2d;->e:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object v0, p0, Lx2d;->g:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, Lx2d;->i:Ljava/util/List;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    iget-wide v0, p0, Lx2d;->j:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object p2, p0, Lx2d;->k:Landroid/os/Bundle;
