...
.field public static final d:Lfo7;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfo7;->c:Ljava/lang/Object;

    new-instance v0, Lfo7;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lfo7;->d:Lfo7;
...
.method public final d(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p2, p1, v0}, Lgo7;->b(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object p0

    invoke-static {p0, p1}, Lflk;->a(Landroid/content/Intent;Lcom/google/android/gms/common/api/GoogleApiActivity;)Lflk;
    ...
    :cond_2
    invoke-static {p1, p2}, Lwkk;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lwkk;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lwkk;->f(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0, p3}, Lpa6;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lpa6;
...
.method public final e(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p2, v0, v1}, Lc0a;->k(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p1}, Lhlk;-><init>(Lfo7;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lwkk;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1, p2}, Lwkk;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v4, p1, v5}, Lqlb;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-boolean v1, v4, Lqlb;->v:Z

    const/16 v6, 0x10

    invoke-virtual {v4, v6, v1}, Lqlb;->f(IZ)V

    invoke-static {p0}, Lqlb;->c(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object p0

    iput-object p0, v4, Lqlb;->e:Ljava/lang/CharSequence;
    ...
    iput-object v6, p0, Lolb;->e:Ljava/lang/CharSequence;

    invoke-virtual {v4, p0}, Lqlb;->i(Lemb;)V

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p0

    sget-object v6, Ltre;->h:Ljava/lang/Boolean;
    ...
    sput-object p0, Ltre;->h:Ljava/lang/Boolean;

    :cond_3
    sget-object p0, Ltre;->h:Ljava/lang/Boolean;
    ...
    iget-object v0, v4, Lqlb;->G:Landroid/app/Notification;

    iput p0, v0, Landroid/app/Notification;->icon:I

    iput v6, v4, Lqlb;->k:I

    invoke-static {p1}, Ltre;->k0(Landroid/content/Context;)Z
    ...
    iget-object v0, v4, Lqlb;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v5, p0, p3}, Lklb;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    :cond_4
    iput-object p3, v4, Lqlb;->g:Landroid/app/PendingIntent;
    ...
    iget-object v5, v4, Lqlb;->G:Landroid/app/Notification;
    ...
    iget-object v2, v4, Lqlb;->G:Landroid/app/Notification;
    ...
    iget-object p0, v4, Lqlb;->G:Landroid/app/Notification;

    iput-wide v7, p0, Landroid/app/Notification;->when:J

    iput-object p3, v4, Lqlb;->g:Landroid/app/PendingIntent;

    invoke-virtual {v4, v0}, Lqlb;->d(Ljava/lang/CharSequence;)V

    :goto_0
    sget-object p0, Lfo7;->c:Ljava/lang/Object;
    ...
    :cond_7
    :goto_1
    iput-object p0, v4, Lqlb;->A:Ljava/lang/String;

    invoke-virtual {v4}, Lqlb;->a()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p1, Lxo7;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
