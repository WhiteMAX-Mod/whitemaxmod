...
.method public constructor <init>(Landroid/content/Context;Lr80;)V
    ...
    .line 86
    invoke-static {p2, v0, p1}, Lzo5;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)V
    ...
    .line 99
    :cond_1
    invoke-static {p2}, Lqt4;->h(Ljava/util/Iterator;)Ljava/lang/ClassCastException;
...
.method public constructor <init>(Lm35;Ljava/io/File;Z)V
    .locals 3
    ...
    iput-object p1, v0, Lgvb;->c:Ljava/lang/Object;
...
.method public constructor <init>(Lrac;Lrac;Lrac;Lrac;Lfbc;Lfbc;)V
    .locals 0
...
.method public static a(Ljava/io/DataInputStream;)Lk95;
    .locals 11
    ...
    invoke-static {v5, p0}, Lzo5;->h(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lk95;-><init>(Ljava/util/Map;)V

    return-object p0
.end method

.method public static b(Lk95;Ljava/io/DataOutputStream;)V
    .locals 2

    invoke-virtual {p0}, Lk95;->c()Ljava/util/Set;
...
.method public static e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0}, Ldqh;->c(Landroid/content/Context;I)I

    move-result v0

    const v1, 0x7f0401dc

    invoke-static {p0, v1}, Ldqh;->b(Landroid/content/Context;I)I

    move-result p0

    sget-object v1, Ldqh;->b:[I

    sget-object v2, Ldqh;->d:[I

    invoke-static {v0, p1}, Lmx3;->c(II)I

    move-result v3

    sget-object v4, Ldqh;->c:[I

    invoke-static {v0, p1}, Lmx3;->c(II)I

    move-result v0

    sget-object v5, Ldqh;->f:[I
...
.method public static f(Ll3d;Lc98;Lx4a;Lrsh;)Lx4a;
    .locals 10

    invoke-interface {p0}, Ll3d;->v()Lush;

    move-result-object v0

    invoke-interface {p0}, Ll3d;->B()I
    ...
    :cond_1
    invoke-virtual {v0, v1, p3, v4}, Lush;->f(ILrsh;Z)Lrsh;

    move-result-object v0

    invoke-interface {p0}, Ll3d;->e()J
    ...
    iget-wide v6, p3, Lrsh;->e:J

    sub-long/2addr v1, v6

    invoke-virtual {v0, v1, v2}, Lrsh;->b(J)I
    ...
    invoke-interface {p0}, Ll3d;->s()I

    move-result v7

    invoke-interface {p0}, Ll3d;->C()I

    move-result v8

    invoke-static/range {v4 .. v9}, Ls80;->r(Lx4a;Ljava/lang/Object;ZIII)Z
...
.method public static m(Lhne;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    ...
    invoke-virtual {p0, p1, v0}, Lhne;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    const v1, 0x7f080494

    invoke-virtual {p0, p1, v1}, Lhne;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static r(Lx4a;Ljava/lang/Object;ZIII)Z
    .locals 2
...
.method public static w(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    :try_start_0
    invoke-static {p1, p2}, Lhne;->f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
# virtual methods
.method public c(Lhle;Lx4a;Lush;)V
    .locals 2
    ...
    invoke-virtual {p3, v0}, Lush;->b(Ljava/lang/Object;)I
    ...
    invoke-virtual {p1, p2, p3}, Lhle;->j(Ljava/lang/Object;Ljava/lang/Object;)Lhle;
    ...
    invoke-virtual {p0, p2}, Llhe;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p2, p0}, Lhle;->j(Ljava/lang/Object;Ljava/lang/Object;)Lhle;
...
.method public l(Ljava/lang/String;)Lg81;
    ...
    invoke-interface {p0, v2}, Li81;->b(Lg81;)V
...
.method public p(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p0}, Lnp4;->l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Ldqh;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v0, Ldqh;->e:[I

    aput-object v0, p2, v5

    invoke-static {p1, v4}, Ldqh;->c(Landroid/content/Context;I)I

    move-result p1

    aput p1, p0, v5

    sget-object p1, Ldqh;->f:[I
    ...
    :cond_2
    sget-object v2, Ldqh;->b:[I

    aput-object v2, p2, v1

    invoke-static {p1, v0}, Ldqh;->b(Landroid/content/Context;I)I

    move-result v2

    aput v2, p0, v1

    sget-object v1, Ldqh;->e:[I
    ...
    sget-object v1, Ldqh;->f:[I

    aput-object v1, p2, v3

    invoke-static {p1, v0}, Ldqh;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, p0}, Ldqh;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, p0}, Ldqh;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public q(J)V
    ...
    invoke-interface {v2, p1, p2}, Li81;->e(J)V
    ...
    invoke-interface {v3, p1, p2}, Li81;->e(J)V

    :cond_0
    invoke-interface {v2}, Li81;->c()Z
...
.method public t(I)V
    ...
    invoke-static {p0, v2, v1}, Lgm0;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public v(III)V
    ...
    invoke-static {v2, p2}, Lgm0;->n(Ljava/lang/String;Ljava/lang/String;)V
...
.method public x()V
    ...
    invoke-interface {v0, v1}, Li81;->d(Ljava/util/HashMap;)V
...
.method public y(Lush;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Ls80;->c(Lhle;Lx4a;Lush;)V
    ...
    invoke-virtual {p0, v0, v2, p1}, Ls80;->c(Lhle;Lx4a;Lush;)V
    ...
    invoke-virtual {v0, p1}, Lhle;->c(Z)Llhe;
