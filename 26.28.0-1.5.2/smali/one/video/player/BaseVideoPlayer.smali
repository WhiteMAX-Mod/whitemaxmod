...
.field public final k:Lga7;

.field public final l:Ljava/util/concurrent/CopyOnWriteArrayList;

.field public final m:Lpa7;

.field public final n:Lq97;

.field public final o:Ljava/util/concurrent/CopyOnWriteArrayList;

.field public final p:Lu97;

.field public q:D

.field public r:J

.field public final s:Lbt0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lone/video/player/BaseVideoPlayer;->C:Lwx;
    ...
    sput-object v1, Lone/video/player/BaseVideoPlayer;->D:Lifh;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lone/video/player/BaseVideoPlayer;->C:Lwx;
    ...
    invoke-virtual {v0, v1, v3, v2}, Lwx;->a(ZLjava/lang/String;Laf7;)V
    ...
    iput-object v0, p0, Lone/video/player/BaseVideoPlayer;->c:Lb6;

    sget-object v0, Lone/video/player/BaseVideoPlayer;->D:Lifh;
    ...
    iput-object v0, p0, Lone/video/player/BaseVideoPlayer;->d:Lwje;
    ...
    invoke-direct {v0, v1}, Lfbc;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lone/video/player/BaseVideoPlayer;->e:Lfbc;
    ...
    invoke-direct {v1}, Lga7;-><init>()V

    iput-object v1, p0, Lone/video/player/BaseVideoPlayer;->k:Lga7;
    ...
    invoke-direct {v1}, Lpa7;-><init>()V

    iput-object v1, p0, Lone/video/player/BaseVideoPlayer;->m:Lpa7;

    new-instance v1, Lq97;

    invoke-direct {v1}, Lq97;-><init>()V

    iput-object v1, p0, Lone/video/player/BaseVideoPlayer;->n:Lq97;
    ...
    iput-object v1, p0, Lone/video/player/BaseVideoPlayer;->p:Lu97;
    ...
    invoke-direct {v1, v2}, Lbt0;-><init>(Lldc;)V

    iput-object v1, p0, Lone/video/player/BaseVideoPlayer;->s:Lbt0;

    sget-object v3, Ln4d;->a:Lj85;

    iput-object v3, p0, Lone/video/player/BaseVideoPlayer;->t:Lj85;
    ...
    invoke-direct {v4, v2}, Let0;-><init>(Lldc;)V
    ...
    invoke-virtual {p0, v4}, Lone/video/player/BaseVideoPlayer;->g(Lxdc;)V
...
.method public static t(Lone/video/player/BaseVideoPlayer;I)V
    ...
    invoke-virtual {v1, p0, v0, p1}, Lga7;->s(Lone/video/player/BaseVideoPlayer;II)V
...
.method public a()Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lnql;->c(Lone/video/player/BaseVideoPlayer;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final g(Lxdc;)V
    ...
    iget-object p0, p0, Lone/video/player/BaseVideoPlayer;->k:Lga7;

    iget-object v0, p0, Lga7;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final h(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1, p1}, Lzo5;->i(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public i()Lo4d;
    .locals 0

    iget-object p0, p0, Lone/video/player/BaseVideoPlayer;->t:Lj85;
...
.method public final o(J)V
    ...
    invoke-interface {p2, p0, v0, v1}, Lzdc;->a(Lone/video/player/BaseVideoPlayer;J)V
...
.method public abstract p(Lm4d;Lp4d;Z)V
.end method

.method public final q(Lm4j;J)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Lm4d;-><init>(Ljava/lang/Iterable;)V

    sget-object p1, Lp4d;->d:Lp4d;

    invoke-virtual {p1, p2, p3}, Lp4d;->c(J)Lp4d;
    ...
    invoke-virtual {p0}, Lone/video/player/BaseVideoPlayer;->i()Lo4d;

    move-result-object p2

    invoke-virtual {v1}, Lm4d;->a()Ljava/util/ArrayList;

    move-result-object p3

    invoke-interface {p2, p3}, Lo4d;->g(Ljava/util/ArrayList;)Lm4d;

    move-result-object p2

    iput-object p2, p0, Lone/video/player/BaseVideoPlayer;->u:Lm4d;

    const/4 p3, 0x1

    invoke-virtual {p0, p2, p1, p3}, Lone/video/player/BaseVideoPlayer;->p(Lm4d;Lp4d;Z)V

    return-void
.end method

.method public final r(Lm4d;Lp4d;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lm4d;->a()Ljava/util/ArrayList;

    move-result-object p1

    invoke-interface {v0, p1}, Lo4d;->g(Ljava/util/ArrayList;)Lm4d;

    move-result-object p1

    iput-object p1, p0, Lone/video/player/BaseVideoPlayer;->u:Lm4d;

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lone/video/player/BaseVideoPlayer;->p(Lm4d;Lp4d;Z)V

    return-void
.end method

.method public final s(Lm4j;J)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lm4d;-><init>(Ljava/lang/Iterable;)V
    ...
    invoke-virtual {p0, v0, p1}, Lone/video/player/BaseVideoPlayer;->r(Lm4d;Lp4d;)V

    return-void
.end method

.method public final u(Lxva;)V
    .locals 2
    ...
    iget-object v0, p0, Lone/video/player/BaseVideoPlayer;->y:Lxva;
    ...
    :cond_0
    iput-object p1, p0, Lone/video/player/BaseVideoPlayer;->y:Lxva;

    const/4 v0, 0x0

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lxva;->B()Landroid/view/Surface;
    ...
    invoke-virtual {v0, p0, p1}, Lwje;->g(Ljava/lang/Object;Landroid/view/Surface;)V
    ...
    iget-object p1, p0, Lldc;->G:Lyxb;

    invoke-static {p1}, Lldc;->w(Laf7;)V

    iget-object p1, p0, Lone/video/player/BaseVideoPlayer;->d:Lwje;

    if-eqz p1, :cond_5

    invoke-virtual {p1, p0, v0}, Lwje;->g(Ljava/lang/Object;Landroid/view/Surface;)V
...
.method public final verifyThread(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v3, p0}, Lx5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    sget-object p0, Lone/video/player/BaseVideoPlayer;->C:Lwx;

    invoke-virtual {p0, v1, p1, v2}, Lwx;->a(ZLjava/lang/String;Laf7;)V
