...
.method public constructor <init>(Lny8;Lny8;)V
    ...
    iput-object p1, p0, Lcm0;->a:Lny8;

    iput-object p2, p0, Lcm0;->b:Lny8;

    return-void
.end method

.method public static final a(Lcm0;[BLsri;)Lgeh;
    .locals 2
    ...
    invoke-virtual {p2}, Lsri;->c()I

    move-result v0

    invoke-virtual {p2}, Lsri;->a()I

    move-result v1

    invoke-direct {p0, p1, v0, v1}, Lgeh;-><init>(Ljava/lang/String;II)V

    invoke-virtual {p2}, Lsri;->b()I

    move-result p1

    invoke-virtual {p0, p1}, Lgeh;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    invoke-virtual {p2}, Lsri;->d()Z
    ...
    invoke-virtual {p0, p1}, Lgeh;->c(Landroid/graphics/Xfermode;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Ltre;->Q(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lrri;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Lhm0;)Ljava/util/LinkedHashMap;
    .locals 29
    ...
    iget-object v15, v10, Lbm0;->a:Ljava/lang/String;
    ...
    invoke-direct {v13, v7}, Lhm0;-><init>(Ljava/lang/String;)V
    ...
    iget-object v7, v7, Lpq3;->d:Ljava/lang/Object;

    check-cast v7, Lmbc;

    iget-object v7, v7, Lmbc;->b:Ljava/util/Map;
    ...
    iget-boolean v2, v10, Lbm0;->b:Z

    invoke-static {v15, v2}, Lf55;->l(Lnbc;Z)Lkbc;

    move-result-object v2

    invoke-interface {v2}, Lkbc;->C()Lzac;

    move-result-object v2

    iget-object v2, v2, Lzac;->a:Lvyh;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v7, v2, Lvyh;->f:Ljava/lang/Object;

    check-cast v7, [I

    iget v10, v2, Lvyh;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v13}, Lhm0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v10}, Lanl;->c(I)I

    move-result v26

    invoke-direct/range {v20 .. v26}, Lsri;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v10, v7, v8}, Lqri;-><init>([IF)V
    ...
    iget-object v8, v2, Lvyh;->e:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v0, v8}, Lcm0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    iget-object v0, v2, Lvyh;->d:Ljava/lang/Object;

    check-cast v0, [I

    invoke-static {v4, v0}, Lcm0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    iget-object v2, v2, Lvyh;->c:Ljava/lang/Object;
    ...
    invoke-direct {v0, v2, v4}, Lqri;-><init>([IF)V
    ...
    invoke-static {v0, v7}, Lkotlin/collections/a;->c1(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Ltri;

    invoke-direct/range {v20 .. v26}, Ltri;-><init>(Lsri;Lqri;Lqri;Ljava/util/List;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lsri;Lmdh;)Ljava/lang/Object;
    .locals 7

    iget-object v0, p0, Lcm0;->a:Lny8;
