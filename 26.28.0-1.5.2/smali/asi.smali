...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lasi;->p:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lasi;->c:Landroid/graphics/Matrix;
    ...
    .line 106
    iput-object v0, p0, Lasi;->m:Ljava/lang/String;

    .line 107
    iput-object v0, p0, Lasi;->n:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lasi;->a:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lasi;->b:Landroid/graphics/Path;
...
.method public constructor <init>(Lasi;)V
    ...
    iget-object v2, p1, Lasi;->g:Lxri;

    invoke-direct {v1, v2, v0}, Lxri;-><init>(Lxri;Lmw;)V

    iput-object v1, p0, Lasi;->g:Lxri;

    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Lasi;->a:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lasi;->a:Landroid/graphics/Path;

    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Lasi;->b:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lasi;->b:Landroid/graphics/Path;
    ...
    iget-object v1, p1, Lasi;->m:Ljava/lang/String;

    iput-object v1, p0, Lasi;->m:Ljava/lang/String;
    ...
    :cond_0
    iget-object p1, p1, Lasi;->n:Ljava/lang/Boolean;

    iput-object p1, p0, Lasi;->n:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(Lxri;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 20

    move-object/from16 v0, p1

    iget-object v1, v0, Lxri;->a:Landroid/graphics/Matrix;

    iget-object v6, v0, Lxri;->b:Ljava/util/ArrayList;

    move-object/from16 v2, p2

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object v2, v0, Lxri;->a:Landroid/graphics/Matrix;

    iget-object v0, v0, Lxri;->j:Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v0 .. v5}, Lasi;->a(Lxri;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    iget-object v12, v1, Lasi;->c:Landroid/graphics/Matrix;
    ...
    :cond_2
    iget-object v5, v1, Lasi;->a:Landroid/graphics/Path;

    invoke-virtual {v0, v5}, Lzri;->d(Landroid/graphics/Path;)V

    iget-object v10, v1, Lasi;->b:Landroid/graphics/Path;

    invoke-virtual {v10}, Landroid/graphics/Path;->reset()V

    invoke-virtual {v0}, Lzri;->c()Z
    ...
    :cond_5
    iget v13, v0, Lwri;->k:F

    add-float/2addr v11, v13

    rem-float/2addr v11, v14

    iget v15, v0, Lwri;->j:F

    add-float/2addr v15, v13

    rem-float/2addr v15, v14

    iget-object v13, v1, Lasi;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v13, v1, Lasi;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v14, v1, Lasi;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v11, v1, Lasi;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v5, v0, Lwri;->f:Led7;

    invoke-virtual {v5}, Led7;->X()Z
    ...
    iget-object v15, v1, Lasi;->e:Landroid/graphics/Paint;
    ...
    iput-object v15, v1, Lasi;->e:Landroid/graphics/Paint;
    ...
    :goto_5
    iget-object v7, v1, Lasi;->e:Landroid/graphics/Paint;

    invoke-virtual {v5}, Led7;->L()Z

    move-result v15

    if-eqz v15, :cond_a

    invoke-virtual {v5}, Led7;->J()Landroid/graphics/Shader;
    ...
    invoke-virtual {v5}, Led7;->I()I

    move-result v5

    iget v15, v0, Lwri;->h:F

    sget-object v19, Ldsi;->j:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v7, v1, Lasi;->d:Landroid/graphics/Paint;
    ...
    iput-object v7, v1, Lasi;->d:Landroid/graphics/Paint;
    ...
    iget-object v14, v0, Lwri;->m:Landroid/graphics/Paint$Join;
    ...
    :cond_e
    iget-object v14, v0, Lwri;->l:Landroid/graphics/Paint$Cap;
    ...
    iget v12, v0, Lwri;->g:F

    sget-object v13, Ldsi;->j:Landroid/graphics/PorterDuff$Mode;
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Lasi;->setRootAlpha(I)V
