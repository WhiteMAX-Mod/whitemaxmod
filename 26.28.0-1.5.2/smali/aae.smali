...
.method public constructor <init>(Lrre;)V
    ...
    iput-object p1, p0, Laae;->c:Lonb;

    return-void
.end method

.method public static b(Laae;Ljava/util/ArrayList;Lnq4;)Ljava/lang/Object;
    .locals 9

    instance-of v0, p2, Lx9e;
    ...
    invoke-direct {v0, p0, p2}, Lx9e;-><init>(Laae;Lnq4;)V

    :goto_0
    iget-object p2, v0, Lx9e;->f:Ljava/lang/Object;
    ...
    :cond_2
    iget-object p1, v0, Lx9e;->e:Ljava/util/ArrayList;

    iget-object p0, v0, Lx9e;->d:Laae;
    ...
    iput-object p0, v0, Lx9e;->d:Laae;

    iput-object p1, v0, Lx9e;->e:Ljava/util/ArrayList;

    iput v6, v0, Lx9e;->h:I

    iget-object p2, p0, Laae;->a:Lrre;
    ...
    :cond_5
    :goto_2
    iput-object v4, v0, Lx9e;->d:Laae;

    iput-object v4, v0, Lx9e;->e:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p0, p1, v2}, Ly9e;-><init>(Laae;Ljava/util/List;I)V
...
# virtual methods
.method public final a(Ljava/util/List;)Lr07;
    .locals 4
    ...
    invoke-direct {v2, v3, v0, p1}, Ltj1;-><init>(ILjava/lang/String;Ljava/util/List;)V
