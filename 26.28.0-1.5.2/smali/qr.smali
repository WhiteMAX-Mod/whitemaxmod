...
.method public final d(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    invoke-static {p0, p1, p2, p3}, Lhwj;->a(Landroid/view/Window$Callback;Ljava/util/List;Landroid/view/Menu;I)V
...
.method public final dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1}, Lvr;->v(Landroid/view/KeyEvent;)Z
...
.method public final dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v2, p0, Lvr;->n:Llwj;

    if-eqz v2, :cond_0

    invoke-virtual {v2, v0, p1}, Llwj;->h(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v2}, Lvr;->A(I)Lur;
...
.method public final onMenuOpened(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {p0, v0}, Llwj;->c(Z)V
...
.method public final onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {p0, p1, v0}, Lvr;->t(Lur;Z)V
...
.method public final onPointerCaptureChanged(Z)V
    ...
    invoke-static {p0, p1}, Liwj;->a(Landroid/view/Window$Callback;Z)V
...
.method public final onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    invoke-virtual {v0, v2}, Lyba;->x(Z)V
    ...
    invoke-virtual {v0, v1}, Lyba;->x(Z)V
...
.method public final onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    invoke-virtual {v0, v1}, Lvr;->A(I)Lur;
...
.method public final onSearchRequested(Landroid/view/SearchEvent;)Z
    ...
    invoke-static {p0, p1}, Lgwj;->a(Landroid/view/Window$Callback;Landroid/view/SearchEvent;)Z
...
.method public final onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    invoke-direct {p0, v1, p1}, Lxde;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    iget-object p1, v0, Lvr;->t:Lq8;

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lq8;->a()V
    ...
    invoke-direct {p1, v0, p0, p2}, Lih;-><init>(Ljava/lang/Object;Ljava/lang/Object;Z)V

    invoke-virtual {v0}, Lvr;->B()V

    iget-object v2, v0, Lvr;->n:Llwj;

    if-eqz v2, :cond_2

    invoke-virtual {v2, p1}, Llwj;->m(Lih;)Lkwj;

    move-result-object v2

    iput-object v2, v0, Lvr;->t:Lq8;

    :cond_2
    iget-object v2, v0, Lvr;->t:Lq8;
    ...
    invoke-direct {v5, v1, p2}, Lhq4;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v5}, Lhq4;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    invoke-static {v5}, Lzjl;->e(Landroid/widget/PopupWindow;)V
    ...
    iget-object v1, v0, Lvr;->v:Landroid/widget/PopupWindow;
    ...
    iget-object v5, v0, Lvr;->n:Llwj;

    if-eqz v5, :cond_7

    invoke-virtual {v5}, Llwj;->e()Landroid/content/Context;
    ...
    iput-object v1, v0, Lvr;->u:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iget-object v1, v0, Lvr;->x:Ld9j;

    if-eqz v1, :cond_a

    invoke-virtual {v1}, Ld9j;->b()V
    ...
    invoke-direct {v1, v2, v5, p1}, Lrgg;-><init>(Landroid/content/Context;Landroidx/appcompat/widget/ActionBarContextView;Lih;)V

    invoke-virtual {v1}, Lrgg;->c()Lyba;

    move-result-object v2

    invoke-virtual {p1, v1, v2}, Lih;->D(Lq8;Landroid/view/Menu;)Z

    move-result p1

    if-eqz p1, :cond_e

    invoke-virtual {v1}, Lrgg;->g()V

    iget-object p1, v0, Lvr;->u:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {p1, v1}, Landroidx/appcompat/widget/ActionBarContextView;->c(Lq8;)V

    iput-object v1, v0, Lvr;->t:Lq8;
    ...
    invoke-virtual {p1, v2}, Ld9j;->a(F)V

    iput-object p1, v0, Lvr;->x:Ld9j;

    new-instance p2, Llr;

    invoke-direct {p2, v4, v0}, Llr;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1, p2}, Ld9j;->d(Le9j;)V
    ...
    invoke-static {p0, p1, p2}, Lgwj;->b(Landroid/view/Window$Callback;Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
