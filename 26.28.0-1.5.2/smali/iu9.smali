...
.field public final i:Lqu9;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lxnf;Landroid/os/Bundle;Lgu9;Landroid/os/Looper;Lqu9;Lv2a;)V
    .locals 7
    ...
    invoke-static {p2, v0}, Llvb;->W(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Liu9;->b:Ltsh;

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Liu9;->g:J

    iput-object p4, p0, Liu9;->e:Lgu9;

    new-instance p4, Landroid/os/Handler;

    invoke-direct {p4, p5}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    iput-object p4, p0, Liu9;->f:Landroid/os/Handler;

    iput-object p6, p0, Liu9;->i:Lqu9;

    iget-object p4, p2, Lxnf;->a:Lwnf;

    invoke-interface {p4}, Lwnf;->g()Z
    ...
    invoke-direct/range {v0 .. v6}, Lpv9;-><init>(Landroid/content/Context;Liu9;Lxnf;Landroid/os/Bundle;Landroid/os/Looper;Lxx0;)V
    ...
    new-instance p0, Ljv9;

    invoke-direct/range {p0 .. p5}, Ljv9;-><init>(Landroid/content/Context;Liu9;Lxnf;Landroid/os/Bundle;Landroid/os/Looper;)V

    move-object v0, p0

    :goto_0
    iput-object v0, p2, Liu9;->d:Lhu9;

    invoke-interface {v0}, Lhu9;->connect()V
...
.method public final A(Z)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->A(Z)V
...
.method public final D(I)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->D(I)V
...
.method public final G(Lry9;)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->G(Lry9;)V
...
.method public final K(Ljava/util/List;)V
    ...
    invoke-static {v3, v1, v2}, Llvb;->Q(Ljava/lang/String;IZ)V
    ...
    :cond_2
    invoke-interface {p0, p1}, Lhu9;->K(Ljava/util/List;)V
...
.method public final P()V
    ...
    iget-boolean v0, p0, Liu9;->h:Z

    xor-int/2addr v0, v2

    invoke-static {v0}, Llvb;->b0(Z)V

    iput-boolean v2, p0, Liu9;->h:Z

    iget-object p0, p0, Liu9;->i:Lqu9;

    iput-boolean v2, p0, Lqu9;->j:Z

    iget-object v0, p0, Lqu9;->i:Liu9;
...
.method public final Q()V
    ...
    iget-object v3, p0, Liu9;->f:Landroid/os/Handler;

    invoke-virtual {v3, v2}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    :try_start_0
    iget-object v2, p0, Liu9;->d:Lhu9;

    invoke-interface {v2}, Lhu9;->release()V
    :try_end_0
    ...
    invoke-static {v1, v4, v2}, Llvb;->h0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_0
    iget-boolean v1, p0, Liu9;->h:Z
    ...
    iget-object v0, p0, Liu9;->e:Lgu9;

    invoke-interface {v0, p0}, Lgu9;->t(Liu9;)V

    goto :goto_2

    :cond_2
    iput-boolean v0, p0, Liu9;->h:Z
...
.method public final R(I)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->N(I)V
...
.method public final S(Ljava/lang/Runnable;)V
    ...
    iget-object p0, p0, Liu9;->f:Landroid/os/Handler;

    invoke-static {p0, p1}, Lvqi;->d0(Landroid/os/Handler;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final T(Lp70;Z)V
    .locals 1
    ...
    :cond_0
    invoke-interface {p0, p1, p2}, Lhu9;->P(Lp70;Z)V
...
.method public final b(F)V
    ...
    :cond_1
    invoke-interface {p0, p1}, Lhu9;->b(F)V
...
.method public final c(I)Z
    ...
    :cond_0
    invoke-interface {p0}, Lhu9;->Q()Lh3d;
...
.method public final d(Lj3d;)V
    .locals 0

    iget-object p0, p0, Liu9;->d:Lhu9;

    invoke-interface {p0, p1}, Lhu9;->S(Lj3d;)V
...
.method public final getDuration()J
    ...
    invoke-interface {p0}, Lhu9;->getDuration()J
...
.method public final getPlaybackState()I
    ...
    invoke-interface {p0}, Lhu9;->getPlaybackState()I
...
.method public final getRepeatMode()I
    ...
    invoke-interface {p0}, Lhu9;->getRepeatMode()I
...
.method public final h(Lry9;J)V
    ...
    :cond_0
    invoke-interface {p0, p1, p2, p3}, Lhu9;->h(Lry9;J)V
...
.method public final k(Lryh;)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->k(Lryh;)V
...
.method public final m()Landroidx/media3/common/PlaybackException;
    ...
    invoke-interface {p0}, Lhu9;->m()Landroidx/media3/common/PlaybackException;
...
.method public final n(Z)V
    ...
    invoke-interface {p0, p1}, Lhu9;->n(Z)V
...
.method public final play()V
    ...
    :cond_0
    invoke-interface {p0}, Lhu9;->play()V
...
.method public final prepare()V
    ...
    :cond_0
    invoke-interface {p0}, Lhu9;->prepare()V
...
.method public final q()Lfzh;
    ...
    invoke-interface {p0}, Lhu9;->q()Lfzh;
...
.method public final r(Lb0a;)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->r(Lb0a;)V
...
.method public final seekTo(J)V
    ...
    :cond_0
    invoke-interface {p0, p1, p2}, Lhu9;->seekTo(J)V
...
.method public final setPlaybackSpeed(F)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->setPlaybackSpeed(F)V
...
.method public final setRepeatMode(I)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->setRepeatMode(I)V
...
.method public final stop()V
    ...
    :cond_0
    invoke-interface {p0}, Lhu9;->stop()V
...
.method public final t(Lry9;)V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lhu9;->t(Lry9;)V
...
.method public final v()Lush;
    ...
    invoke-interface {p0}, Lhu9;->v()Lush;
...
.method public final x(IJLjava/util/List;)V
    ...
    invoke-static {p4, v0}, Llvb;->W(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-interface {p0, p1, p2, p3, p4}, Lhu9;->x(IJLjava/util/List;)V
