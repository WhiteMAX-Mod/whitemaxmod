...
.method public final a(Lvxe;Ljava/lang/Object;)V
    ...
    invoke-virtual {v2}, Lkcg;->a()J

    move-result-wide v3

    invoke-interface {v1, v10, v3, v4}, Lvxe;->c(IJ)V

    invoke-virtual {v2}, Lkcg;->c()J

    move-result-wide v3

    invoke-interface {v1, v9, v3, v4}, Lvxe;->c(IJ)V

    invoke-virtual {v2}, Lkcg;->b()[B

    move-result-object v3

    invoke-interface {v1, v8, v3}, Lvxe;->d(I[B)V

    check-cast v0, Licg;

    iget-object v0, v0, Licg;->d:Lgp0;

    invoke-virtual {v2}, Lkcg;->d()Ljcg;
    ...
    invoke-interface {v1, v7, v2, v3}, Lvxe;->c(IJ)V
    ...
    iget-wide v11, v2, Lgga;->a:J

    invoke-interface {v1, v10, v11, v12}, Lvxe;->c(IJ)V

    iget-wide v10, v2, Lgga;->b:J

    invoke-interface {v1, v9, v10, v11}, Lvxe;->c(IJ)V

    iget-wide v9, v2, Lgga;->c:J

    invoke-interface {v1, v8, v9, v10}, Lvxe;->c(IJ)V

    iget-wide v8, v2, Lgga;->d:J

    invoke-interface {v1, v7, v8, v9}, Lvxe;->c(IJ)V

    iget-wide v7, v2, Lgga;->e:J

    invoke-interface {v1, v4, v7, v8}, Lvxe;->c(IJ)V

    iget-wide v7, v2, Lgga;->f:J

    invoke-interface {v1, v3, v7, v8}, Lvxe;->c(IJ)V

    iget-object v3, v2, Lgga;->g:Ljava/lang/String;

    if-nez v3, :cond_0

    invoke-interface {v1, v5}, Lvxe;->e(I)V

    goto :goto_0

    :cond_0
    invoke-interface {v1, v5, v3}, Lvxe;->B(ILjava/lang/String;)V
    ...
    iget-wide v4, v2, Lgga;->k:J

    invoke-interface {v1, v3, v4, v5}, Lvxe;->c(IJ)V

    iget-object v3, v2, Lgga;->l:Ljava/lang/String;

    const/16 v4, 0xc

    if-nez v3, :cond_1

    invoke-interface {v1, v4}, Lvxe;->e(I)V

    goto :goto_1

    :cond_1
    invoke-interface {v1, v4, v3}, Lvxe;->B(ILjava/lang/String;)V

    :goto_1
    iget-object v3, v2, Lgga;->m:Ljava/lang/String;
    ...
    invoke-static {v3}, Lru/ok/tamtam/nano/a;->f(Lc46;)Lru/ok/tamtam/nano/Protos$Attaches;
    ...
    :cond_4
    invoke-interface {v1, v4, v3}, Lvxe;->d(I[B)V
    ...
    invoke-interface {v1, v5, v3, v4}, Lvxe;->c(IJ)V

    iget-boolean v3, v2, Lgga;->p:Z
    ...
    iget-wide v4, v2, Lgga;->r:J

    invoke-interface {v1, v3, v4, v5}, Lvxe;->c(IJ)V

    iget-boolean v3, v2, Lgga;->s:Z
    ...
    iget-wide v4, v2, Lgga;->t:J

    invoke-interface {v1, v3, v4, v5}, Lvxe;->c(IJ)V

    iget-object v3, v2, Lgga;->u:Ljava/lang/String;
    ...
    :goto_5
    iget-object v3, v2, Lgga;->v:Ljava/lang/String;
    ...
    :goto_6
    iget-object v3, v2, Lgga;->w:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Ltoa;->d()Lvo3;

    move-result-object v4

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v3}, Lvo3;->b(I)Ljava/lang/Integer;
    ...
    iget-wide v4, v2, Lgga;->x:J

    invoke-interface {v1, v3, v4, v5}, Lvxe;->c(IJ)V

    const/16 v3, 0x1a

    iget-wide v4, v2, Lgga;->y:J
    ...
    iget-object v4, v2, Lgga;->F:Ljava/util/List;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4}, Ldga;->b(Ljava/util/List;)[B
    ...
    invoke-static {v3}, Lpm9;->x(Lkja;)[B
    ...
    :cond_9
    invoke-interface {v1, v3, v0}, Lvxe;->d(I[B)V

    :goto_9
    iget-object v0, v2, Lgga;->H:Ljava/lang/Long;
    ...
    :goto_a
    iget-object v0, v2, Lgga;->I:Ljava/lang/Boolean;
    ...
    invoke-interface {v1, v0}, Lvxe;->e(I)V
    ...
    invoke-interface {v1, v0, v3, v4}, Lvxe;->c(IJ)V

    :goto_c
    const/16 v0, 0x26

    iget-wide v2, v2, Lgga;->J:J
    ...
    iget-wide v11, v2, Ljy2;->a:J

    invoke-interface {v1, v10, v11, v12}, Lvxe;->c(IJ)V

    iget-wide v11, v2, Ljy2;->b:J

    invoke-interface {v1, v9, v11, v12}, Lvxe;->c(IJ)V
    ...
    iget-object v11, v2, Ljy2;->c:Lnx2;

    iget-object v0, v0, Lvo3;->a:Li1c;
    ...
    iget-object v15, v11, Lnx2;->u0:Lgj2;

    iget-object v5, v11, Lnx2;->m0:Lhx2;

    iget-object v3, v11, Lnx2;->I:Lzw2;

    iget-object v4, v11, Lnx2;->n:Lfx2;

    iget-object v6, v11, Lnx2;->z:Ljava/util/List;

    iget-object v7, v11, Lnx2;->C:Ljava/util/List;

    iput-wide v13, v12, Lru/ok/tamtam/nano/Protos$Chat;->serverId:J

    iget-object v13, v11, Lnx2;->b:Llx2;
    ...
    iget-object v13, v11, Lnx2;->c:Lkx2;
    ...
    iget-object v13, v11, Lnx2;->h:Ljava/lang/String;
    ...
    iget-object v13, v11, Lnx2;->i:Ljava/lang/String;
    ...
    invoke-static/range {v17 .. v17}, Lru/ok/tamtam/nano/a;->j(Lex2;)Lru/ok/tamtam/nano/Protos$Chat$Chunk;
    ...
    invoke-static {v13}, Lru/ok/tamtam/nano/a;->j(Lex2;)Lru/ok/tamtam/nano/Protos$Chat$Chunk;
    ...
    iget-object v8, v4, Lcx2;->b:Ljava/util/List;
    ...
    :goto_14
    iget-object v0, v11, Lnx2;->p:Lax2;
    ...
    :cond_1e
    iget-object v0, v11, Lnx2;->q:Lww2;
    ...
    :goto_17
    invoke-static {v0}, Lru/ok/tamtam/nano/a;->h(Lww2;)Lru/ok/tamtam/nano/Protos$Chat$ChatMedia;

    move-result-object v0

    iput-object v0, v12, Lru/ok/tamtam/nano/Protos$Chat;->mediaAll:Lru/ok/tamtam/nano/Protos$Chat$ChatMedia;

    iget-object v0, v11, Lnx2;->r:Lww2;
    ...
    iget-object v0, v11, Lnx2;->t:Lww2;
    ...
    iget-object v0, v11, Lnx2;->u:Lww2;
    ...
    iget-object v0, v11, Lnx2;->v:Lww2;
    ...
    iget-object v0, v11, Lnx2;->w:Lww2;
    ...
    iget-object v0, v11, Lnx2;->x:Lww2;
    ...
    iget-object v0, v11, Lnx2;->s:Lww2;
    ...
    iget-object v9, v4, Ljx2;->a:Ljava/lang/String;

    iput-object v9, v8, Lru/ok/tamtam/nano/Protos$Chat$Section;->id:Ljava/lang/String;

    iget-object v9, v4, Ljx2;->b:Ljava/lang/String;
    ...
    iget-object v0, v11, Lnx2;->A:Ljava/util/List;
    ...
    :cond_2e
    iget-object v0, v11, Lnx2;->D:Ldx2;

    if-eqz v0, :cond_2f

    invoke-virtual {v0}, Ldx2;->a()[J
    ...
    iget-object v0, v11, Lnx2;->F:Ljava/lang/String;
    ...
    iget-object v0, v11, Lnx2;->G:Ljava/util/List;
    ...
    invoke-virtual {v7}, Lzc8;->hasNext()Z

    move-result v8

    if-eqz v8, :cond_34

    invoke-virtual {v7}, Lzc8;->next()Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Ljava/lang/Long;

    invoke-virtual {v0, v7}, Lh6g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v11, Lnx2;->J:Ljava/lang/String;
    ...
    iget-object v0, v11, Lnx2;->K:Lix2;
    ...
    iget-object v0, v11, Lnx2;->L:Lgx2;
    ...
    iget-object v7, v3, Lmx2;->a:Ljava/lang/String;
    ...
    invoke-direct {v4}, Luwd;-><init>()V

    invoke-virtual {v0}, Lh1c;->a()J

    move-result-wide v6

    iput-wide v6, v4, Luwd;->f:J

    iget-object v6, v0, Lh1c;->b:Lwx8;

    invoke-static {v6}, Liel;->c(Lwx8;)Z

    move-result v7

    if-nez v7, :cond_4c

    invoke-virtual {v6}, Lwx8;->b()Ljava/lang/String;

    move-result-object v7

    iput-object v7, v4, Luwd;->a:Ljava/lang/String;

    invoke-virtual {v6}, Lwx8;->a()Ljava/util/List;
    ...
    :cond_4b
    invoke-static {v6}, Ldga;->c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;

    move-result-object v6

    iput-object v6, v4, Luwd;->e:Lru/ok/tamtam/nano/Protos$MessageElements;

    :cond_4c
    :goto_2c
    iget-object v6, v0, Lh1c;->d:Ljava/lang/Long;
    ...
    :goto_2d
    iput-wide v13, v4, Luwd;->b:J

    iget-object v0, v0, Lh1c;->c:Ljava/lang/Long;
    ...
    :cond_4e
    iput-wide v7, v4, Luwd;->c:J

    invoke-static {v4}, Lsia;->toByteArray(Lsia;)[B
    ...
    :cond_53
    invoke-static {v4}, Lru/ok/tamtam/nano/a;->d(Le70;)Lru/ok/tamtam/nano/Protos$Attaches$Attach;
    ...
    :cond_54
    iget v0, v11, Lnx2;->v0:I

    iput v0, v12, Lru/ok/tamtam/nano/Protos$Chat;->commentsBlacklistCount:I

    invoke-static {v12}, Lsia;->toByteArray(Lsia;)[B

    move-result-object v0

    const/4 v8, 0x3

    invoke-interface {v1, v8, v0}, Lvxe;->d(I[B)V

    iget-wide v3, v2, Ljy2;->d:J

    const/4 v14, 0x4

    invoke-interface {v1, v14, v3, v4}, Lvxe;->c(IJ)V

    iget-wide v3, v2, Ljy2;->e:J

    const/4 v0, 0x5

    invoke-interface {v1, v0, v3, v4}, Lvxe;->c(IJ)V

    iget-wide v2, v2, Ljy2;->f:J
