...
.method public constructor <init>(Lkbc;)V
    ...
    iput-object v0, p0, Lk0d;->a:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lk0d;->b:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lk0d;->c:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Lk0d;->onThemeChanged(Lkbc;)V
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lhfe;)V
    ...
    iget-object p2, p4, Lhfe;->b:Landroid/util/SparseArray;
    ...
    iput-object p2, p4, Lhfe;->b:Landroid/util/SparseArray;
...
.method public final g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lhfe;)V
    ...
    iget-object v0, p0, Lk0d;->b:Landroid/graphics/RectF;
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->S(Landroid/view/View;)Llfe;

    move-result-object v6

    instance-of v6, v6, Ltg3;

    if-eqz v6, :cond_5

    iget-object v6, p3, Lhfe;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Lk0d;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Lk0d;->a:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Lkbc;)V
    ...
    iget-object p0, p0, Lk0d;->a:Landroid/graphics/Paint;
