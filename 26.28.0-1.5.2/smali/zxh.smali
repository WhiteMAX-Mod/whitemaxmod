...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    invoke-static/range {p2 .. p2}, Lxwh;->a(Ljava/lang/Throwable;)[B
    ...
    invoke-static {v1, v2, v4}, Lsnf;->c(Lsnf;Lqwf;I)V
    ...
    sget-object v6, La8g;->g:Lfbc;

    if-eqz v6, :cond_9

    const-string v7, "system.shutdown.until.ts"

    invoke-static {v6, v7}, Lgol;->a(Lfbc;Ljava/lang/String;)Z
    ...
    invoke-static {v6, v1}, Lgol;->a(Lfbc;Ljava/lang/String;)Z
    ...
    invoke-virtual {v4}, Lsnf;->b()V

    iget-object v4, v4, Lsnf;->f:Ligh;
    ...
    iget-object v5, v4, Lkhh;->e:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v4, v4, Lkhh;->e:Ljava/util/ArrayList;
    ...
    sget-object v4, Lqwh;->d:Ljava/lang/reflect/Method;

    invoke-static {}, Lgyl;->a()Lqwh;

    move-result-object v12

    sget-object v4, Lswh;->d:Landroid/content/Context;
    ...
    invoke-static/range {v9 .. v17}, Lxvc;->j(Ligh;Ljava/util/List;Ljava/util/Date;Lqwh;JJI)Lorg/json/JSONObject;
    ...
    invoke-direct {v3, v0, v1, v2}, Lf92;-><init>(Ln3;Lcv4;Ljava/util/concurrent/CountDownLatch;)V

    invoke-static {v3}, Lyxh;->b(Ljava/lang/Runnable;)V
    ...
    :try_start_4
    iget-object v0, v0, Luy8;->c:Ljava/lang/Object;
