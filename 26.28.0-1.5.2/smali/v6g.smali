...
.method public b(Lp76;Liue;Lbne;)Z
    .locals 0
    ...
    :cond_0
    iget-boolean p0, p0, Lv6g;->a:Z

    if-eqz p0, :cond_1

    const/16 p0, 0x800

    invoke-static {p2, p3, p1, p0}, Lgm0;->p(Liue;Lbne;Lp76;I)I
...
.method public c(Lp76;Ldba;Liue;Lbne;Landroid/graphics/ColorSpace;)Lww6;
    .locals 20
    ...
    invoke-static {v5, v8, v0, v6}, Lgm0;->p(Liue;Lbne;Lp76;I)I
    ...
    :try_start_0
    invoke-virtual {v0}, Lp76;->A()Ljava/io/InputStream;
    ...
    invoke-interface {v0, v4, v2}, Laf9;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    new-instance v0, Lww6;

    invoke-direct {v0, v10, v1, v9}, Lww6;-><init>(IIB)V

    return-object v0

    :cond_4
    invoke-static {v0, v5}, Las8;->d(Lp76;Liue;)Landroid/graphics/Matrix;
    ...
    :cond_6
    invoke-direct {v0, v7, v1, v9}, Lww6;-><init>(IIB)V
    :try_end_2
    ...
    :goto_4
    :try_start_3
    invoke-static {v4, v3, v0}, Lpj6;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
