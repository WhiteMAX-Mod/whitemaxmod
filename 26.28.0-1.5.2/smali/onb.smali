...
.method public final c(Lvxe;Ljava/lang/Object;)V
    ...
    iget-wide v1, p2, Lsej;->a:J

    invoke-interface {p1, v0, v1, v2}, Lvxe;->c(IJ)V

    const/4 p0, 0x2

    iget-wide v3, p2, Lsej;->b:J

    invoke-interface {p1, p0, v3, v4}, Lvxe;->c(IJ)V

    const/4 p0, 0x3

    iget-wide v3, p2, Lsej;->c:J

    invoke-interface {p1, p0, v3, v4}, Lvxe;->c(IJ)V

    iget-object p0, p2, Lsej;->d:Ljava/lang/String;
    ...
    :goto_0
    iget-boolean p0, p2, Lsej;->e:Z

    const/4 v0, 0x5

    int-to-long v3, p0

    invoke-interface {p1, v0, v3, v4}, Lvxe;->c(IJ)V

    iget-boolean p0, p2, Lsej;->f:Z

    const/4 p2, 0x6

    int-to-long v3, p0

    invoke-interface {p1, p2, v3, v4}, Lvxe;->c(IJ)V

    const/4 p0, 0x7

    invoke-interface {p1, p0, v1, v2}, Lvxe;->c(IJ)V
