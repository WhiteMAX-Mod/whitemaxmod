...
.field public static g:Lhne;

.field public static final h:Lyx0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhne;->f:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {v0, v1, v2}, Lyx0;-><init>(II)V

    sput-object v0, Lhne;->h:Lyx0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lhne;->b:Ljava/util/WeakHashMap;

    return-void
.end method

.method public static declared-synchronized c()Lhne;
    .locals 2
...
.method public static declared-synchronized f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, v2}, Lmj9;->d(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lhne;->a:Ljava/util/WeakHashMap;
    ...
    iput-object v0, p0, Lhne;->a:Ljava/util/WeakHashMap;
    ...
    iget-object p0, p0, Lhne;->a:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3}, Lkeg;->b(ILjava/lang/Object;)V
    ...
    iget-object v2, v0, Lkeg;->a:[I

    invoke-static {v2, p1}, Ljava/util/Arrays;->copyOf([II)[I

    move-result-object v2

    iput-object v2, v0, Lkeg;->a:[I

    iget-object v2, v0, Lkeg;->b:[Ljava/lang/Object;

    invoke-static {v2, p1}, Ljava/util/Arrays;->copyOf([Ljava/lang/Object;I)[Ljava/lang/Object;

    move-result-object p1

    iput-object p1, v0, Lkeg;->b:[Ljava/lang/Object;
    ...
    iget-object p1, v0, Lkeg;->b:[Ljava/lang/Object;
...
.method public final b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lhne;->c:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Lhne;->c:Landroid/util/TypedValue;
    ...
    :try_start_0
    iget-object v3, p0, Lhne;->b:Ljava/util/WeakHashMap;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v3, v1, v2}, Lvi9;->b(J)Ljava/lang/Object;
    ...
    :cond_2
    :try_start_2
    invoke-virtual {v3, v1, v2}, Lvi9;->h(J)V
    :try_end_2
    ...
    invoke-virtual {p0, p1, v3}, Lhne;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    const v5, 0x7f080465

    invoke-virtual {p0, p1, v5}, Lhne;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2}, Ls80;->m(Lhne;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    ...
    invoke-direct {v3, v4}, Lvi9;-><init>(Ljava/lang/Object;)V

    iget-object v4, p0, Lhne;->b:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v3, v1, v2, p1}, Lvi9;->f(JLjava/lang/Object;)V
    :try_end_3
...
.method public final declared-synchronized d(ILandroid/content/Context;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v0}, Lhne;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_5

    instance-of v1, v0, Ldsi;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p2, p1}, Lhne;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, p1, p3, v0}, Lhne;->h(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Lvt5;->a(Landroid/graphics/drawable/Drawable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p2, p1, v0}, Lhne;->d(ILandroid/content/Context;Z)Landroid/graphics/drawable/Drawable;
...
.method public final declared-synchronized g(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p2}, Lkeg;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, v1}, Lhne;->a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final h(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Lhne;->g(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Ldqh;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v3}, Ldqh;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v2}, Ldqh;->b(Landroid/content/Context;I)I
    ...
    :try_start_0
    invoke-static {p1, v4}, Lhne;->f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
