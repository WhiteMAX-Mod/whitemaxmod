...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, p0, Lbve;->f:Landroid/graphics/RectF;

    const/16 v0, 0x8

    new-array v1, v0, [F

    iput-object v1, p0, Lbve;->g:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lbve;->h:[F

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, p1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lbve;->i:Landroid/graphics/Paint;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lbve;->j:Z
    ...
    iput-object p1, p0, Lbve;->o:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lbve;->p:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lbve;->q:Landroid/graphics/RectF;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lbve;->f:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lbve;->o:Landroid/graphics/Path;

    iget-object v8, p0, Lbve;->i:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Lbve;->p:Landroid/graphics/Path;
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-super {p0, p1}, Lt97;->onBoundsChange(Landroid/graphics/Rect;)V
...
.method public final p()V
    ...
    iget-object v0, p0, Lbve;->o:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lbve;->p:Landroid/graphics/Path;
    ...
    iget-object v3, p0, Lbve;->q:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-boolean v2, p0, Lbve;->j:Z

    iget-object v4, p0, Lbve;->g:[F
