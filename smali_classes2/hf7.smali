...
.method public constructor <init>(Landroid/content/Context;Lnq6;)V
    ...
    iput-object p1, p0, Lhf7;->b:Landroid/graphics/drawable/Drawable;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lhf7;->d:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lhf7;->u0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lhf7;->v0:Landroid/graphics/Matrix;

    const/4 p1, 0x0

    const/high16 p2, 0x3f400000    # 0.75f

    invoke-static {p1, p2}, Ldjj;->b(IF)I
...
# virtual methods
.method public final a(Landroid/graphics/Canvas;FFFILff7;)V
    .locals 13
    ...
    sget-object v9, Lff7;->d:Lff7;

    if-eq v2, v9, :cond_1

    iget-object v10, v2, Lff7;->a:Ljava/util/List;
    ...
    :goto_1
    invoke-interface {v8, v5}, Lnq6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lhf7;->d:Landroid/graphics/Rect;

    invoke-virtual {v7, v6, v8, v9, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v5, p0, Lhf7;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    sget-object v4, Lgf7;->$EnumSwitchMapping$0:[I
    ...
    iget-object v7, v6, Lktb;->a:Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v6}, Lhf7;->a(Landroid/graphics/Canvas;FFFILff7;)V

    sget-object v6, Lff7;->c:Lff7;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Lhf7;->w0:[I

    invoke-direct/range {v2 .. v8}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v0, p0, Lhf7;->v0:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lhf7;->u0:Landroid/graphics/Paint;
    ...
    sget-object v8, Lff7;->d:Lff7;

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Lhf7;->a(Landroid/graphics/Canvas;FFFILff7;)V
