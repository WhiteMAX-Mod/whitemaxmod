...
# static fields
.field public static final c:Lzyc;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Loh;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Lwnj;->a(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Loh;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Loh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Lx01;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Loh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Leh;->X:Leh;

    iget-object v12, v0, Loh;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v13, Leh;->Z:Leh;

    invoke-virtual {v13, v12, v3}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Leh;->s0:Leh;

    invoke-virtual {v14, v12, v3}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Leh;->w0:Leh;

    invoke-virtual {v15, v12, v3}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Luh;

    instance-of v12, v3, Lsh;

    if-nez v12, :cond_6

    instance-of v3, v3, Lth;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Ljij;->e(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    :cond_12
    sget-object v0, Leh;->Y:Leh;

    invoke-virtual {v0, v12, v3}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-virtual {v0, v1, p2}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v1, p2}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Luh;

    sget-object v3, Lhh;->o:Lhh;

    invoke-virtual {v3, v1, p2}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Luh;

    sget-object v4, Leh;->w0:Leh;

    invoke-virtual {v4, v1, p2}, Lk2;->H(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Luh;

    instance-of v1, v2, Lph;
    ...
    :cond_0
    instance-of v1, p2, Lth;

    if-eqz v1, :cond_2

    new-instance p2, Lqh;

    invoke-direct {p2, v5}, Lqh;-><init>(F)V
    ...
    invoke-direct {p2, v4}, Lph;-><init>(I)V

    :cond_2
    :goto_1
    instance-of v1, p2, Lqh;

    instance-of v6, p2, Lsh;

    const/4 v7, 0x0

    if-eqz v6, :cond_11

    instance-of p2, v2, Lsh;
    ...
    iget-object v1, v1, Lsh;->a:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v1}, Ljij;->d(Ljava/lang/String;)[Llvb;
    ...
    iget-object v5, v5, Lsh;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v5}, Ljij;->d(Ljava/lang/String;)[Llvb;
    ...
    invoke-static {v1, v5}, Ljij;->a([Llvb;[Llvb;)Z
    ...
    iget-object p2, v2, Lsh;->a:Ljava/lang/String;
    ...
    iget-object v7, v3, Lsh;->a:Ljava/lang/String;
    ...
    invoke-static {v0, p2, v1, v7}, Lx02;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
