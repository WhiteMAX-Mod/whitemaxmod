...
.method public constructor <init>(Landroid/view/View;Lkotlin/coroutines/Continuation;Lone/me/chatscreen/videomsg/VideoMessageWidget;)V
    ...
    iput-object p3, p0, Lcvh;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iput-object p1, p0, Lcvh;->Y:Landroid/view/View;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v0, p0, Lcvh;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iget-object v1, p0, Lcvh;->Y:Landroid/view/View;

    invoke-direct {p1, v1, p2, v0}, Lcvh;-><init>(Landroid/view/View;Lkotlin/coroutines/Continuation;Lone/me/chatscreen/videomsg/VideoMessageWidget;)V
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v4, v0, Lcvh;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;
    ...
    invoke-virtual {v9, v2, v4, v10, v7}, Lafb;->c(Lzm8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_4
    :goto_0
    iget-object v4, v0, Lcvh;->Y:Landroid/view/View;
    ...
    invoke-direct {v9, v8, v10}, Lm72;-><init>(ILkotlin/coroutines/Continuation;)V

    invoke-virtual {v9}, Lm72;->o()V
    ...
    invoke-virtual {v9, v1}, Lm72;->resumeWith(Ljava/lang/Object;)V
    ...
    invoke-direct {v10, v5, v9}, Ltu0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {v4}, Lone/me/chatscreen/videomsg/VideoMessageWidget;->J0()Lhqh;
    ...
    :cond_a
    :goto_4
    iget-object v10, v0, Lcvh;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    iget-object v12, v0, Lcvh;->Y:Landroid/view/View;

    invoke-static {v10, v12}, Lone/me/chatscreen/videomsg/VideoMessageWidget;->I0(Lone/me/chatscreen/videomsg/VideoMessageWidget;Landroid/view/View;)I

    move-result v10

    iput v10, v9, Lwyd;->a:I

    new-instance v10, Landroid/widget/FrameLayout$LayoutParams;

    iget v12, v9, Lwyd;->a:I
    ...
    invoke-virtual {v12, v2, v10, v13, v7}, Lafb;->c(Lzm8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_c
    :goto_6
    if-eqz v5, :cond_14

    iget-object v2, v0, Lcvh;->Y:Landroid/view/View;

    iget v3, v9, Lwyd;->a:I

    iget-object v5, v0, Lcvh;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    new-instance v10, Lw5;

    const/16 v12, 0x1a

    invoke-direct {v10, v5, v9, v4, v12}, Lw5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-direct {v15, v12, v4}, Lu20;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v12, v15, v10}, Lgg;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v10}, Lykc;->j(Landroid/view/WindowInsets;)Landroid/view/DisplayCutout;
    ...
    invoke-static {v10}, Lykc;->n(Landroid/view/DisplayCutout;)Ljava/util/List;
    ...
    invoke-static {v5, v6}, Let7;->a(II)J
    ...
    :cond_13
    invoke-static {v11, v11}, Let7;->a(II)J
    ...
    sget-object v6, Lssf;->w:Lcd5;

    invoke-direct {v5, v4, v6}, Lssf;-><init>(Ljava/lang/Object;Lht8;)V

    new-instance v4, Ltsf;

    invoke-direct {v4, v2}, Ltsf;-><init>(F)V

    const/high16 v2, 0x42f00000    # 120.0f

    invoke-virtual {v4, v2}, Ltsf;->b(F)V

    const v2, 0x3ee147ae    # 0.44f

    invoke-virtual {v4, v2}, Ltsf;->a(F)V

    iput-object v4, v5, Lssf;->m:Ltsf;
    ...
    iget-object v2, v0, Lcvh;->X:Lone/me/chatscreen/videomsg/VideoMessageWidget;

    invoke-virtual {v2}, Lone/me/chatscreen/videomsg/VideoMessageWidget;->P0()Luuh;
    ...
    invoke-virtual {v4}, Lhqh;->getSurfaceProvider()Lgmc;

    move-result-object v4

    move/from16 v15, v17

    iput v15, v0, Lcvh;->o:I

    iget-object v2, v2, Luuh;->b:Ldqh;

    check-cast v2, Loth;

    invoke-virtual {v2, v5, v4, v0}, Loth;->l(Landroid/util/Size;Lgmc;Lda4;)Ljava/lang/Object;
