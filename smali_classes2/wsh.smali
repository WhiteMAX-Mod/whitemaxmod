...
.field public final synthetic o:Lzsh;


# direct methods
.method public constructor <init>(Lzsh;Landroid/util/Size;Ljd5;)V
    .locals 0

    iput-object p1, p0, Lwsh;->o:Lzsh;

    const-string p1, "videomsg-gl-thread"

    invoke-direct {p0, p1}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Lwsh;->a:Landroid/util/Size;

    iput-object p3, p0, Lwsh;->b:Ljd5;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide p1

    iput-wide p1, p0, Lwsh;->c:J

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lwsh;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final run()V
    ...
    iget-object v1, p0, Lwsh;->a:Landroid/util/Size;

    iget-object v2, p0, Lwsh;->b:Ljd5;
    ...
    invoke-static {v0, v1, v2}, Ltej;->k(Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/CancellationException;)V
    ...
    iget-object v3, p0, Lwsh;->b:Ljd5;

    invoke-static {v0, v1, v3}, Lzsh;->a(Lzsh;Landroid/util/Size;Ljd5;)V
    :try_end_0
    ...
    iget-object v1, p0, Lwsh;->d:Ljava/util/concurrent/atomic/AtomicReference;
