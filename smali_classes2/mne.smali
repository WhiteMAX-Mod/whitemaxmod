...
.method public constructor <init>(Lfy8;)V
    ...
    sget-object v0, Lzj4;->e:Lzj4;

    invoke-direct {p0, v0}, Lnd8;-><init>(Ljnj;)V

    iput-object p1, p0, Lmne;->o:Lfy8;
...
.method public final s(Ltsd;I)V
    ...
    iget-object v0, p1, Llne;->G0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    iget-object v1, p2, Line;->Z:Landroid/net/Uri;

    iput-object p2, p1, Llne;->I0:Line;

    iget-object v2, p1, Llne;->J0:Landroid/net/Uri;

    iget-object v3, p2, Line;->d:Landroid/net/Uri;
    ...
    iget-object v2, p1, Llne;->K0:Landroid/net/Uri;
    ...
    :cond_0
    iput-object v3, p1, Llne;->J0:Landroid/net/Uri;

    iput-object v1, p1, Llne;->K0:Landroid/net/Uri;

    invoke-static {v3}, Ldj7;->d(Landroid/net/Uri;)Ldj7;

    move-result-object v2

    iput-boolean v4, v2, Ldj7;->h:Z
    ...
    invoke-direct {v3, v5, v1}, Lurb;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    iput-object v3, v2, Ldj7;->k:Lhfc;
    ...
    :cond_2
    iget-object p2, p2, Line;->a:Lwh8;

    iget-object p2, p2, Lwh8;->w0:Lvh8;
    ...
    :goto_0
    iget-object p1, p1, Llne;->H0:Landroidx/appcompat/widget/AppCompatImageView;
...
.method public final u(Landroid/view/ViewGroup;I)Ltsd;
    ...
    invoke-direct/range {v3 .. v8}, Lrj1;-><init>(Ljava/lang/Object;Ljava/lang/Object;Landroid/graphics/drawable/Drawable;Lkotlin/coroutines/Continuation;I)V
    ...
    iget-object v1, p0, Lmne;->o:Lfy8;

    move-object v3, p2

    invoke-direct/range {v0 .. v5}, Llne;-><init>(Lfy8;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/appcompat/widget/AppCompatImageView;Landroid/widget/FrameLayout;)V
