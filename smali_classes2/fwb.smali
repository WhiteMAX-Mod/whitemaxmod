...
.method public final accept(Ljava/lang/Object;)V
    ...
    invoke-static {v0, v1, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lidf;Lpw1;)V
    ...
    iget-object p1, v0, Lcu0;->b:Ljava/lang/Object;
    ...
    iget-object p1, p1, Llwb;->a0:Lwi8;

    const/4 v0, 0x0

    invoke-virtual {p1, v0, v0}, Lwi8;->l(Ljava/lang/Float;Ljava/lang/Float;)V

    goto :goto_0

    :cond_0
    iget-object v0, p1, Llwb;->a0:Lwi8;

    iget v1, p1, Llwb;->m0:F

    invoke-static {v1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v1

    iget p1, p1, Llwb;->n0:F

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    invoke-virtual {v0, v1, p1}, Lwi8;->l(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    invoke-virtual {v0, v1}, Llwb;->g(Ljava/util/List;)Lorg/webrtc/PeerConnection$RTCConfiguration;
    ...
    invoke-interface {p1, v3, v2}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v3, v1}, Ldc9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, v2}, Llwb;->u(Lorg/webrtc/PeerConnection;Z)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0, p1, v2}, Llwb;->l(Lorg/webrtc/PeerConnection;Z)V
    ...
    iget-object p1, v0, Llwb;->Z:Ljava/util/ArrayList;
    ...
    iget-boolean v1, v0, Llwb;->b0:Z

    if-eqz v1, :cond_7

    const/4 v1, 0x0

    iput-boolean v1, v0, Llwb;->b0:Z
    ...
    invoke-virtual {p1, v2, v0, v1}, Lfgd;->log(Lunf;Ljava/lang/String;Ljava/lang/String;)V
