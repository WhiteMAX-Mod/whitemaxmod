...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lqid;->a:Ljava/lang/String;
...
.method public static a(Lqid;JLone/me/rlottie/RLottieDrawable;Landroid/graphics/Rect;I)V
    .locals 10
    ...
    :cond_1
    iget-object p5, p0, Lqid;->a:Ljava/lang/String;

    invoke-direct {p0}, Lqid;->getLotties()Leoe;
    ...
    invoke-direct {v4, p1, p2, v5}, Lg33;-><init>(JI)V

    invoke-static {v3, v4}, Lpoe;->e(Leoe;Loq6;)Lv36;

    move-result-object v3

    new-instance v4, Lu36;

    invoke-direct {v4, v3}, Lu36;-><init>(Lv36;)V

    :goto_1
    invoke-virtual {v4}, Lu36;->hasNext()Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {v4}, Lu36;->next()Ljava/lang/Object;
    ...
    invoke-static {p5, p0}, Lm4j;->A(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v4, Ls9d;->tag_reaction_effects_view:I

    invoke-static {p1, p2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object p1

    invoke-static {v4, v5, p1}, Lc5j;->d(ILandroid/view/View;Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v0, p4}, Lqid;->c(ILandroid/graphics/Rect;)F
    ...
    invoke-direct {v8, p0, v5}, Loid;-><init>(Lqid;Lone/me/rlottie/RLottieImageView;)V
    ...
    invoke-direct {v9, p0, v5}, Lpid;-><init>(Lqid;Lone/me/rlottie/RLottieImageView;)V
    ...
    invoke-static {p5, p0}, Lm4j;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v4 .. v9}, Lnid;-><init>(Lone/me/rlottie/RLottieImageView;Lqid;Lone/me/rlottie/RLottieDrawable;Loid;Lpid;)V
...
.method private final getLotties()Leoe;
    .locals 2
...
.method public final d(JLandroid/graphics/Rect;)V
    ...
    sget v3, Ls9d;->tag_reaction_effects_view:I

    invoke-static {v2, v3}, Lc5j;->c(Landroid/view/View;I)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lqid;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p3}, Lqid;->c(ILandroid/graphics/Rect;)F
