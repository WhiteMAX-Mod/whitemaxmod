...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lub5;)V
    .locals 5

    invoke-direct {p0}, Lp35;-><init>()V

    iput-object p1, p0, Lmlh;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lmlh;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lmlh;->t:[F
    ...
    invoke-virtual {p0, p2}, Lp35;->n(Lub5;)Lgb0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lmlh;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lm4j;->A(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lmlh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lmlh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lmlh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lmlh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lmlh;->q:Lupf;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lupf;->d:Ljava/lang/String;

    invoke-static {v3, v1}, Lm4j;->A(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lupf;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;->release()V

    iget-object v1, v2, Lupf;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->release()V

    :cond_2
    iput-object v0, p0, Lmlh;->q:Lupf;

    iput-object v0, p0, Lmlh;->w:Lx1e;

    invoke-super {p0}, Lp35;->q()V
...
.method public final w(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Lp35;->l(Landroid/view/Surface;)Lxb0;

    move-result-object v2

    sget-object v3, Lrs6;->j:Lxb0;
    ...
    invoke-virtual {v1, v0}, Lp35;->h(Landroid/view/Surface;)Lxb0;
    ...
    invoke-static {v3, v8}, Lrs6;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V
    ...
    iget-object v2, v1, Lmlh;->q:Lupf;

    if-nez v2, :cond_2

    new-instance v2, Lupf;

    iget-object v5, v1, Lmlh;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Lupf;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lmlh;->q:Lupf;

    :cond_2
    move-object v10, v2

    iget-object v2, v1, Lmlh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lmlh;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lmlh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lmlh;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lmlh;->u:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Lupf;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v6}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->bind()V

    iget v6, v10, Lupf;->b:I

    iget v7, v10, Lupf;->c:I
    ...
    iget-object v9, v10, Lupf;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Lupf;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v4}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->getTextureId()I

    move-result v4

    iget-object v5, v10, Lupf;->a:Landroid/util/Size;
    ...
    iget-object v5, v1, Lp35;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Lp35;->o(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Lp35;->k:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v2, Lupf;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v5, v1, Lmlh;->w:Lx1e;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v2, v2, Lupf;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v2, v1, Lmlh;->w:Lx1e;

    if-eqz v2, :cond_8

    invoke-virtual {v2, v11}, Lx1e;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    const/4 v2, 0x0

    iput-object v2, v1, Lmlh;->w:Lx1e;
    ...
    :cond_9
    :goto_2
    iget-object v2, v1, Lp35;->f:Ljava/lang/Object;
    ...
    iget-object v11, v1, Lmlh;->p:Ljava/lang/String;
    ...
    invoke-static {v8, v2, v3}, Li2j;->d(IJ)Ljava/lang/String;
    ...
    :cond_b
    invoke-virtual {v1, v0, v4}, Lp35;->s(Landroid/view/Surface;Z)V
