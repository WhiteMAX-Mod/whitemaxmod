...
.method public final run()V
    ...
    iget-object v2, p0, Ld6;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;
    ...
    iget-object v4, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->h1:Lli8;

    invoke-virtual {v3, v4}, Lf89;->k(Lli8;)V
    ...
    iget-object v4, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->i1:Lli8;

    invoke-virtual {v3, v4}, Lf89;->k(Lli8;)V

    :cond_2
    iget-object v3, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->W0:Lw69;
    ...
    :cond_4
    iget-object v2, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->W0:Lw69;

    iget-wide v3, v0, Ldi8;->b:J

    invoke-virtual {v2, v3, v4}, Lw69;->F(J)Lru/ok/messages/media/mediabar/FrgLocalMedia;
    ...
    iget-object v2, v0, Lru/ok/messages/media/mediabar/FrgLocalVideo;->D1:Lqga;
    ...
    :cond_5
    iget-object v0, v0, Lru/ok/messages/media/mediabar/FrgLocalVideo;->B1:Lli8;

    iget-object v3, v0, Lli8;->b:Lap5;
    ...
    :cond_7
    iget v1, v3, Lap5;->u0:I

    :goto_2
    iget v2, v3, Lap5;->v0:I

    iget-object v0, v0, Lli8;->e:Lf3;

    if-eqz v0, :cond_8

    invoke-interface {v0, v4, v1, v2}, Ld89;->K(III)V
