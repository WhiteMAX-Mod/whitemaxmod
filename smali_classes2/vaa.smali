...
# direct methods
.method public constructor <init>(JJJJJLjava/lang/String;Ljava/lang/String;Lwq9;Ljava/util/List;Ljava/util/List;Z)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lum;-><init>(J)V

    iput-wide p3, p0, Lvaa;->d:J

    iput-wide p5, p0, Lvaa;->o:J

    iput-wide p7, p0, Lvaa;->X:J

    iput-wide p9, p0, Lvaa;->Y:J

    iput-object p13, p0, Lvaa;->Z:Lwq9;

    iput-object p14, p0, Lvaa;->s0:Ljava/util/List;

    iput-object p15, p0, Lvaa;->t0:Ljava/util/List;

    move/from16 p1, p16

    iput-boolean p1, p0, Lvaa;->u0:Z
    ...
    :cond_0
    iput-object p11, p0, Lvaa;->v0:Ljava/lang/String;
    ...
    :cond_1
    iput-object p12, p0, Lvaa;->w0:Ljava/lang/String;
...
.method public final c()I
    ...
    iget-wide v3, v0, Lvaa;->o:J

    invoke-virtual {v1, v3, v4}, Lbn9;->l(J)Ldn9;
    ...
    :goto_1
    invoke-virtual {v5}, Lvm;->c()Lch2;

    move-result-object v5

    iget-wide v6, v0, Lvaa;->d:J
    ...
    :goto_2
    invoke-virtual {v8}, Lvm;->f()Lkeg;

    move-result-object v8

    sget-object v9, Lhzb;->s0:Lhzb;

    iget-wide v10, v0, Lum;->a:J

    invoke-virtual {v8, v10, v11, v9}, Lkeg;->h(JLhzb;)Ljava/util/List;
    ...
    iget-object v9, v9, Lceg;->f:Lgzb;

    check-cast v9, Lvaa;

    iget-wide v14, v9, Lvaa;->d:J

    cmp-long v14, v14, v6

    if-nez v14, :cond_3

    iget-wide v14, v9, Lvaa;->o:J
    ...
    invoke-static {v13, v1}, Lm4j;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v1, Ldn9;->x0:Lcf9;
    ...
    invoke-virtual {v5}, Lud2;->H()Z

    move-result v4

    if-nez v4, :cond_5

    invoke-virtual {v5}, Lud2;->X()Z
    ...
    iget-boolean v14, v0, Lvaa;->u0:Z

    if-eqz v14, :cond_f

    sget-object v15, Li20;->c:Li20;

    invoke-virtual {v1, v15}, Ldn9;->s(Li20;)Z
    ...
    iget-object v15, v3, Lcf9;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v10, v11}, Lkeg;->j(J)Lceg;
    ...
    iget-wide v3, v0, Lvaa;->X:J

    invoke-virtual {v1, v3, v4, v2}, Lo2b;->x(JLjava/util/List;)J
    ...
    :goto_7
    invoke-virtual {v2}, Lvm;->f()Lkeg;

    move-result-object v1

    invoke-virtual {v1, v10, v11}, Lkeg;->c(J)V

    invoke-static {v13, v9}, Lm4j;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_11
    invoke-static {v3}, Lt20;->a(Lcf9;)Z
...
.method public final d()V
    ...
    iget-object v9, p0, Lvaa;->s0:Ljava/util/List;

    iget-boolean v10, p0, Lvaa;->u0:Z

    iget-wide v2, p0, Lvaa;->o:J

    iget-wide v4, p0, Lvaa;->d:J

    iget-object v6, p0, Lvaa;->w0:Ljava/lang/String;

    iget-object v7, p0, Lvaa;->t0:Ljava/util/List;

    iget-object v8, p0, Lvaa;->Z:Lwq9;

    invoke-virtual/range {v1 .. v10}, Lvc5;->a(JJLjava/lang/String;Ljava/util/List;Lwq9;Ljava/util/List;Z)V
...
.method public final e(Lxbg;)V
    ...
    iget-object v0, v7, Ldn9;->t0:Lwq9;
    ...
    invoke-direct {v0, v5, v4}, Ls0e;-><init>(ILmq6;)V

    invoke-virtual {p1, v0}, Le1e;->r(Ljava/util/concurrent/Callable;)Ljava/lang/Object;

    iget-object p1, v8, Lum;->c:Lvm;
    ...
    :goto_3
    invoke-virtual {p1}, Lvm;->c()Lch2;

    move-result-object p1

    iget-wide v4, v8, Lvaa;->d:J

    invoke-virtual {p1, v4, v5}, Lch2;->M(J)Lud2;

    move-result-object p1

    iget-object v0, v7, Ldn9;->R0:Llw4;

    invoke-virtual {v0}, Llw4;->c()Z
    ...
    invoke-virtual {p1, v4, v5}, Lch2;->H(J)V
...
.method public final f()[B
    ...
    iput-object v1, v2, Ln20;->a:Ljava/util/List;

    invoke-virtual {v2}, Ln20;->c()Lcf9;

    move-result-object v1

    invoke-static {v1}, Lru/ok/tamtam/nano/a;->f(Lcf9;)Lru/ok/tamtam/nano/Protos$Attaches;
    ...
    :cond_0
    iget-object v1, p0, Lvaa;->t0:Ljava/util/List;
...
.method public final h()Lk2;
    ...
    :cond_2
    iget-boolean v3, p0, Lvaa;->u0:Z

    if-eqz v3, :cond_4

    iget-object v3, v2, Ldn9;->x0:Lcf9;

    invoke-static {v3}, Let8;->d(Lcf9;)Lh00;
    ...
    :goto_2
    iget-object v3, v2, Ldn9;->N0:Ljava/util/List;

    if-eqz v3, :cond_5

    invoke-static {v3}, Let8;->u(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lvaa;->v0:Ljava/lang/String;

    iget-object v12, v2, Ldn9;->Q0:Lmw4;

    iget-wide v7, p0, Lvaa;->Y:J

    invoke-direct/range {v4 .. v12}, Li06;-><init>(JJLjava/lang/String;Lh00;Ljava/util/ArrayList;Lmw4;)V
...
.method public final l(Lcbg;)V
    ...
    invoke-virtual {p1, v1}, Lt20;->b(Ldn9;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p0}, Lvaa;->d()V
    ...
    invoke-direct {v3, v4, v5, p1}, Ljk0;-><init>(JLcbg;)V
