...
.method public constructor <init>(Lm4d;)V
    ...
    iput-object v0, p0, Ln4d;->b:Ljava/lang/String;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Ln4d;->c:Landroid/graphics/Paint;

    iget-object v0, p1, Lm4d;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lm4d;->c:Lfv0;

    invoke-virtual {p0, p1}, Ln4d;->d(Lfv0;)V
...
.method public final chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;)V
    ...
    .line 1
    invoke-virtual/range {v0 .. v7}, Ln4d;->chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
...
.method public final copy()Ldb4;
    ...
    invoke-direct {v0, v1}, Ln4d;-><init>(Lm4d;)V
...
.method public final d(Lfv0;)V
    ...
    iget-object p1, v0, Lm4d;->e:Landroid/graphics/drawable/Drawable;
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v6, v1, Ln4d;->a:Lm4d;

    iget-object v7, v6, Lm4d;->f:Lx2d;

    iget-object v8, v6, Lm4d;->s:Landroid/graphics/Path;

    iget v9, v6, Lm4d;->j:I

    iget v10, v6, Lm4d;->g:I

    iget v11, v6, Lm4d;->k:I

    iget v12, v6, Lm4d;->q:F

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Lx2d;->getAsInt()I
    ...
    iget-object v7, v1, Ln4d;->b:Ljava/lang/String;

    const-string v8, "getSegment start&end failed"

    invoke-static {v7, v8, v5}, Lc5j;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v13, v1, Ln4d;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual/range {p5 .. p12}, Ln4d;->c(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v7, v6, Lm4d;->r:Landroid/graphics/Path;
    ...
    :try_start_5
    iget-object v7, v6, Lm4d;->v:Landroid/graphics/Path;
    ...
    iget-object v8, v6, Lm4d;->u:Landroid/graphics/Path;
    ...
    iget-object v2, v6, Lm4d;->t:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v2, v6, Lm4d;->w:Landroid/graphics/Path;
    ...
    :cond_1a
    iget-object v0, v6, Lm4d;->e:Landroid/graphics/drawable/Drawable;
...
.method public final hashCode()I
    ...
    invoke-virtual {v0}, Lm4d;->hashCode()I
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v1, v0, Lm4d;->d:Lrhg;

    iget-object v2, v0, Lm4d;->a:Landroid/content/Context;

    iget-object v0, v0, Lm4d;->b:Llpf;
...
.method public final updateMeasureState(Landroid/text/TextPaint;)V
    ...
    iget-object p1, v0, Lm4d;->f:Lx2d;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lx2d;->getAsInt()I
