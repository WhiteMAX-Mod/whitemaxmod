...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v1}, La4b;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v4}, La4b;->setAvatarShape(Lt3b;)V

    iput-object v3, v0, Ll3f;->a:La4b;
    ...
    sget-object v8, Lj1h;->b:Lhhg;

    invoke-static {v8, v4}, Lhhg;->d(Lhhg;Landroid/widget/TextView;)V

    sget-object v8, Ldc3;->s0:Lole;

    invoke-virtual {v8, v4}, Lole;->n(Landroid/view/View;)Lplb;

    move-result-object v9

    invoke-interface {v9}, Lplb;->getText()Lifg;
    ...
    iput-object v4, v0, Ll3f;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    sget-object v12, Lj1h;->j:Lhhg;

    invoke-static {v12, v11}, Lhhg;->d(Lhhg;Landroid/widget/TextView;)V

    invoke-virtual {v8, v11}, Lole;->n(Landroid/view/View;)Lplb;
    ...
    iget v13, v13, Lifg;->j:I

    invoke-virtual {v11, v13}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v11, v0, Ll3f;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v12, v13}, Lhhg;->d(Lhhg;Landroid/widget/TextView;)V

    invoke-virtual {v8, v13}, Lole;->n(Landroid/view/View;)Lplb;
    ...
    iput-object v13, v0, Ll3f;->d:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v2, v7, v7}, Lyh3;-><init>(II)V

    invoke-virtual {v9, v2}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v9, v5}, Landroid/widget/TextView;->setGravity(I)V

    invoke-static {v12, v9}, Lhhg;->d(Lhhg;Landroid/widget/TextView;)V

    invoke-virtual {v8, v9}, Lole;->n(Landroid/view/View;)Lplb;
    ...
    iput-object v9, v0, Ll3f;->o:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v1, v7, v7}, Lyh3;-><init>(II)V
    ...
    iput-object v2, v0, Ll3f;->s0:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v6, v8, v7}, Lyh3;-><init>(II)V
...
.method private final setDivider(Z)V
    ...
    :goto_0
    iget-object v0, p0, Ll3f;->d:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setNickname(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object v1, p0, Ll3f;->o:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setPhoneNumber(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object v1, p0, Ll3f;->c:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final onThemeChanged(Lplb;)V
    ...
    iget-object v1, p0, Ll3f;->b:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public setAlpha(F)V
    ...
    iget-object v0, p0, Ll3f;->s0:Landroid/widget/LinearLayout;

    invoke-virtual {v0, p1}, Landroid/view/View;->setAlpha(F)V

    iget-object v0, p0, Ll3f;->a:La4b;
...
.method public final setAvatarClickedListener(Lmq6;)V
    .locals 2
...
.method public final setNicknameClickListener(Lmq6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Ll3f;->o:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final setTopBarContent(Le2f;)V
    .locals 4

    iget-object v0, p1, Le2f;->b:Ljava/lang/String;

    iget-wide v1, p1, Le2f;->a:J

    invoke-static {v1, v2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v1

    iget-object v2, p1, Le2f;->d:Ljava/lang/CharSequence;

    iget-object v3, p0, Ll3f;->a:La4b;

    invoke-static {v3, v0, v1, v2}, La4b;->o(La4b;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Ll3f;->b:Landroidx/appcompat/widget/AppCompatTextView;

    iget-object v1, p1, Le2f;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Le2f;->e:Ljava/lang/String;

    invoke-direct {p0, v0}, Ll3f;->setPhoneNumber(Ljava/lang/String;)V

    iget-object p1, p1, Le2f;->f:Ljava/lang/String;

    invoke-direct {p0, p1}, Ll3f;->setNickname(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-direct {p0, p1}, Ll3f;->setDivider(Z)V

    return-void
.end method

.method public final setUserPhoneClickListener(Lmq6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Ll3f;->c:Landroidx/appcompat/widget/AppCompatTextView;
