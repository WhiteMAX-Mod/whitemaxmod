...
.field public w0:Llog;

.field public x0:Lipg;

.field public y0:Lhd5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkpa;->G0:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lkpa;->H0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, Lkpa;->G0:Ljava/util/regex/Pattern;

    iput-object v0, p0, Lkpa;->a:Ljava/util/regex/Pattern;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lkpa;->b:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lkpa;->t0:F

    sget-object v0, Lhd5;->b:Lhd5;

    iput-object v0, p0, Lkpa;->y0:Lhd5;

    const/high16 v0, -0x1000000

    iput v0, p0, Lkpa;->z0:I

    sget-object v0, Lkpa;->H0:Landroid/text/TextPaint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTypeface()Landroid/graphics/Typeface;

    move-result-object v1

    iput-object v1, p0, Lkpa;->A0:Landroid/graphics/Typeface;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getLetterSpacing()F

    move-result v1

    iput v1, p0, Lkpa;->B0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTextSize()F

    move-result v1

    iput v1, p0, Lkpa;->C0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->isElegantTextHeight()Z

    move-result v0

    iput-boolean v0, p0, Lkpa;->D0:Z

    const/4 v0, 0x2

    iput v0, p0, Lkpa;->E0:I

    new-instance v0, Ljpa;

    invoke-direct {v0, p0, p1}, Ljpa;-><init>(Lkpa;Landroid/content/Context;)V

    iput-object v0, p0, Lkpa;->F0:Ljpa;

    return-void
.end method

.method public static final f(Lkpa;Landroid/text/TextPaint;)V
    .locals 1

    iget-object v0, p0, Lkpa;->A0:Landroid/graphics/Typeface;

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v0, p0, Lkpa;->B0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setLetterSpacing(F)V

    iget v0, p0, Lkpa;->C0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTextSize(F)V

    iget p0, p0, Lkpa;->z0:I
...
.method private final getFullyVisibleLinesCount()I
    ...
    invoke-virtual {p0, v0, v1}, Lkpa;->i(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
...
.method private final getLinesCount()I
    ...
    invoke-direct {p0}, Lkpa;->getFullyVisibleLinesCount()I
...
.method private final setContent(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lkpa;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lkpa;->j()V

    iput-object p1, p0, Lkpa;->d:Ljava/lang/CharSequence;

    const/4 p1, 0x0

    iput-object p1, p0, Lkpa;->w0:Llog;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lkpa;->s0:Z
...
.method private final setLayoutInternal(Landroid/text/Layout;)V
    ...
    :goto_0
    iput-object v0, p0, Lkpa;->c:Landroid/text/StaticLayout;
    ...
    :goto_1
    iput-object v0, p0, Lkpa;->d:Ljava/lang/CharSequence;
    ...
    :cond_2
    iput-object v1, p0, Lkpa;->o:Ljava/lang/CharSequence;
...
.method private final setStaticLayoutsTextColor(I)V
    ...
    iget-object v0, p0, Lkpa;->c:Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object v0, p0, Lkpa;->w0:Llog;

    if-eqz v0, :cond_1

    iget-object v1, v0, Llog;->a:Luog;
    ...
    iget-object v0, v0, Llog;->b:Luog;

    invoke-virtual {v0}, Luog;->a()Landroid/text/Layout;
...
.method public final a(Lhd5;)V
    ...
    iget-object v0, p0, Lkpa;->x0:Lipg;
    ...
    :cond_0
    iget-object v1, p0, Lkpa;->y0:Lhd5;
    ...
    :cond_1
    iput-object p1, p0, Lkpa;->y0:Lhd5;

    invoke-virtual {p0, v0, p1}, Lkpa;->g(Lipg;Lhd5;)V
...
.method public final c()Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lkpa;->b:Landroid/graphics/Rect;
...
.method public final e(Ljava/lang/String;)F
    ...
    :try_start_0
    invoke-static {p0, v0}, Lkpa;->f(Lkpa;Landroid/text/TextPaint;)V
...
.method public final g(Lipg;Lhd5;)V
    .locals 16
    ...
    iget-object v3, v0, Lipg;->f:Ljava/lang/String;
    ...
    invoke-static {v4}, Lo16;->c(I)I

    move-result v4

    invoke-static {v2, v3, v4}, Lu8h;->a(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;

    move-result-object v2

    iput-object v2, v1, Lkpa;->A0:Landroid/graphics/Typeface;
    ...
    iget-wide v3, v0, Lipg;->e:J

    invoke-static {v3, v4, v2}, La25;->c(JLandroid/util/DisplayMetrics;)F

    move-result v3

    iput v3, v1, Lkpa;->B0:F

    invoke-virtual/range {p1 .. p2}, Lipg;->e(Lhd5;)J
    ...
    iput v3, v1, Lkpa;->C0:F

    iget-object v3, v0, Lipg;->c:Ljava/util/EnumMap;
    ...
    sget-object v3, Lkpa;->H0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v3}, Lkpa;->f(Lkpa;Landroid/text/TextPaint;)V
    ...
    iput v2, v1, Lkpa;->u0:F

    move-object/from16 v0, p1

    iget-boolean v0, v0, Lipg;->d:Z

    iput-boolean v0, v1, Lkpa;->D0:Z

    const/4 v0, 0x1

    iput-boolean v0, v1, Lkpa;->s0:Z
...
.method public getLineHeight()I
    ...
    iget v0, p0, Lkpa;->u0:F

    int-to-float v1, v1

    iget v2, p0, Lkpa;->t0:F
...
.method public final h()V
    ...
    invoke-interface {v1, p0}, Lh1i;->attach(Landroid/view/View;)V
...
.method public final i(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    sget-object v4, Lkpa;->H0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v4}, Lkpa;->f(Lkpa;Landroid/text/TextPaint;)V
    :try_end_0
...
.method public final j()V
    ...
    invoke-interface {v1, p0}, Lh1i;->detach(Landroid/view/View;)V
...
.method public final k(Lipg;)V
    .locals 1

    iput-object p1, p0, Lkpa;->x0:Lipg;

    sget-object v0, Lhd5;->b:Lhd5;

    iput-object v0, p0, Lkpa;->y0:Lhd5;

    invoke-virtual {p0, p1, v0}, Lkpa;->g(Lipg;Lhd5;)V
...
.method public final onAttachedToWindow()V
    ...
    iget-object v2, v1, Luog;->c:Ljava/util/concurrent/CopyOnWriteArraySet;

    iget-object v3, p0, Lkpa;->F0:Ljpa;
    ...
    iget-object v0, v0, Luog;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v1, p0, Lkpa;->F0:Ljpa;

    if-eqz v0, :cond_0

    iget-object v0, v0, Llog;->a:Luog;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, v1, Lkpa;->s0:Z

    const/4 v3, 0x1

    if-nez v0, :cond_1

    iget-object v0, v1, Lkpa;->w0:Llog;
    ...
    :goto_0
    iget-object v0, v0, Luog;->b:Lhd5;

    iget-object v4, v1, Lkpa;->y0:Lhd5;
    ...
    :cond_3
    iget-object v0, v1, Lkpa;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v4, v0}, Lkpa;->i(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v5

    invoke-direct {v1}, Lkpa;->getLinesCount()I
    ...
    invoke-virtual {v1, v4, v9}, Lkpa;->i(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    iget-object v6, v1, Lkpa;->a:Ljava/util/regex/Pattern;
    ...
    :cond_8
    :goto_3
    iput-object v3, v1, Lkpa;->o:Ljava/lang/CharSequence;

    goto :goto_4

    :cond_9
    iput-object v0, v1, Lkpa;->o:Ljava/lang/CharSequence;

    :goto_4
    iget-object v0, v1, Lkpa;->o:Ljava/lang/CharSequence;
    ...
    :goto_5
    invoke-virtual {v1, v4, v8}, Lkpa;->i(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v0

    iput-object v0, v1, Lkpa;->c:Landroid/text/StaticLayout;

    iput-boolean v7, v1, Lkpa;->s0:Z

    :cond_b
    :goto_6
    iget-object v0, v1, Lkpa;->c:Landroid/text/StaticLayout;
...
.method public final onMeasure(II)V
    ...
    :goto_0
    iget-object v2, p0, Lkpa;->c:Landroid/text/StaticLayout;
    ...
    :cond_3
    invoke-virtual {p0, p2, v0}, Lkpa;->i(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    invoke-virtual {p0}, Lkpa;->getMaxLinesValue()I
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p2, p0, Lkpa;->w0:Llog;
    ...
    :cond_0
    iget-object p1, p2, Llog;->b:Luog;

    goto :goto_0

    :goto_1
    iget-object p2, p0, Lkpa;->c:Landroid/text/StaticLayout;

    if-eq p2, p1, :cond_1

    invoke-direct {p0, p1}, Lkpa;->setLayoutInternal(Landroid/text/Layout;)V
...
.method public final onWindowVisibilityChanged(I)V
    ...
    invoke-super {p0, p1}, Lx2b;->onWindowVisibilityChanged(I)V
...
.method public setLayout(Llog;)V
    .locals 3
    ...
    iget-object v0, p1, Llog;->a:Luog;

    iget-object v2, v0, Luog;->c:Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-virtual {v2, v1}, Ljava/util/concurrent/CopyOnWriteArraySet;->add(Ljava/lang/Object;)Z

    iget-object v2, p1, Llog;->b:Luog;

    if-eq v0, v2, :cond_2

    iget-object v0, v2, Luog;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Lkpa;->o:Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-object p1, p0, Lkpa;->c:Landroid/text/StaticLayout;
...
.method public setTextColor(I)V
    ...
    iput p1, p0, Lkpa;->z0:I

    invoke-direct {p0, p1}, Lkpa;->setStaticLayoutsTextColor(I)V
...
.method public setTextValue(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lkpa;->setContent(Ljava/lang/CharSequence;)V
