...
# direct methods
.method public constructor <init>(JJLz9b;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lum;-><init>(J)V

    iput-wide p3, p0, La75;->d:J

    iput-object p5, p0, La75;->o:Lz9b;
    ...
    iput-object p1, p0, La75;->X:Ljava/lang/String;
...
.method public final c()I
    ...
    iget-object v2, p0, La75;->X:Ljava/lang/String;
...
.method public final e(Lxbg;)V
    ...
    iget-object v1, p0, La75;->X:Ljava/lang/String;
    ...
    iget-object v4, v0, Lzh2;->d0:Lz9b;

    iget-wide v5, v0, Lzh2;->e0:J

    if-nez v4, :cond_1

    iget-wide v7, p1, Lb75;->c:J
    ...
    invoke-virtual {p1, v2, v3}, Lch2;->z(J)V
    ...
    :cond_5
    iget-wide v6, v0, Lz9b;->a:J

    iget-object v8, v0, Lz9b;->b:Lr58;

    iget-object v9, v0, Lz9b;->c:Ljava/lang/Long;

    iget-object v10, v0, Lz9b;->d:Ljava/lang/Long;

    iget-boolean v12, v0, Lz9b;->f:Z

    iget-object v13, v0, Lz9b;->g:Lcf9;

    new-instance v5, Lz9b;

    invoke-direct/range {v5 .. v13}, Lz9b;-><init>(JLr58;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;ZLcf9;)V
...
.method public final f()[B
    ...
    iget-object v1, p0, La75;->o:Lz9b;

    invoke-static {v1}, Lz65;->b(Lz9b;)[B
...
.method public final h()Lk2;
    ...
    iget-object v1, v0, La75;->X:Ljava/lang/String;

    invoke-virtual {v0}, Lum;->k()Lch2;

    move-result-object v2

    iget-wide v3, v0, La75;->d:J
    ...
    instance-of v9, v4, Lz9b;

    if-nez v9, :cond_7

    iget-object v11, v1, Laab;->a:Ljava/lang/String;
    ...
    invoke-direct/range {v16 .. v21}, Lope;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/lang/Long;Ljava/lang/Long;I)V
    ...
    :cond_9
    iget-object v9, v4, Lz9b;->b:Lr58;

    if-eqz v9, :cond_a

    iget-object v11, v9, Lr58;->a:Ljava/lang/String;

    if-eqz v11, :cond_a

    iget-object v12, v1, Laab;->d:Ld68;
    ...
    invoke-virtual {v12, v13, v14, v15}, Lncc;->m(Ljava/lang/Enum;J)J

    move-result-wide v12

    long-to-int v12, v12

    invoke-static {v12, v11}, Liyf;->a0(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v12, v9, Lr58;->a:Ljava/lang/String;
    ...
    iget-object v15, v9, Lr58;->b:Ljava/util/List;
    ...
    invoke-static {v6, v15, v11, v10}, Lnn9;->a(Lnn9;III)Lnn9;

    move-result-object v6

    invoke-virtual {v6}, Lnn9;->b()Lnn9;
    ...
    invoke-static {v6, v11, v10, v15}, Lnn9;->a(Lnn9;III)Lnn9;
    ...
    :goto_9
    iget-object v5, v1, Laab;->a:Ljava/lang/String;
    ...
    :cond_13
    iget-object v5, v4, Lz9b;->c:Ljava/lang/Long;
    ...
    iget-object v10, v1, Laab;->c:Ld68;
    ...
    invoke-virtual {v10, v5, v6}, Lbn9;->l(J)Ldn9;

    move-result-object v5

    if-eqz v5, :cond_14

    iget-wide v5, v5, Ldn9;->b:J
    ...
    :goto_a
    iget-object v4, v4, Lz9b;->d:Ljava/lang/Long;
    ...
    invoke-virtual {v1, v10, v11}, Lbn9;->l(J)Ldn9;

    move-result-object v1

    if-eqz v1, :cond_15

    iget-wide v10, v1, Ldn9;->b:J
    ...
    iget-object v10, v9, Lr58;->b:Ljava/util/List;
    ...
    :cond_17
    invoke-static {v14}, Let8;->u(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v12 .. v17}, Lope;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/lang/Long;Ljava/lang/Long;I)V
    ...
    invoke-direct {v1, v3, v2}, Lmj2;-><init>(Lmob;I)V

    if-eqz v4, :cond_1c

    const-string v2, "userId"

    invoke-virtual {v1, v7, v8, v2}, Lk2;->v(JLjava/lang/String;)V
    ...
    invoke-virtual {v1, v5, v6, v2}, Lk2;->v(JLjava/lang/String;)V

    :cond_1d
    const-string v2, "draft"

    invoke-virtual/range {v16 .. v16}, Lope;->a()Ljava/util/Map;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Lk2;->x(Ljava/lang/String;Ljava/util/Map;)V
