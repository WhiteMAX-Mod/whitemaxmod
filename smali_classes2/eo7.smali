...
.method public constructor <init>(Lj88;Lj88;Lj88;Lj88;)V
    ...
    const-string p4, "26.4.4(6554)"

    invoke-direct {v6, p4}, Lgpg;-><init>(Ljava/lang/CharSequence;)V

    sget p4, Lbjd;->oneme_settings_app_version:I

    new-instance v8, Lcpg;

    invoke-direct {v8, p4}, Lcpg;-><init>(I)V
    ...
    invoke-direct {v3, p2}, Lgpg;-><init>(Ljava/lang/CharSequence;)V

    sget p2, Lbjd;->oneme_settings_user_id:I
    ...
    iget-object p2, p2, Lu05;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance p4, Lc6e;

    invoke-direct {p4, p2}, Lc6e;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {p3, p4, v0}, Lhe2;-><init>(CC)V
    ...
    invoke-direct {p4, v0, v1}, Lhe2;-><init>(CC)V
    ...
    invoke-static {p3, p4}, Lek3;->Q(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-static {p3, v0}, Lkk3;->q(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V

    invoke-static {p4, v0}, Lkk3;->q(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
    ...
    invoke-static {v1, p3}, Lek3;->A(ILjava/util/Collection;)Ljava/lang/Object;
