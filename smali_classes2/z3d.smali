...
# instance fields
.field public final A0:Lz22;

.field public final B0:Lafb;

.field public final C0:Lafb;
...
.field public final u0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;

.field public final v0:Landroidx/appcompat/widget/AppCompatImageView;

.field public final w0:Lafb;

.field public final x0:Landroid/widget/Chronometer;

.field public final y0:Landroid/widget/LinearLayout;

.field public final z0:Lafb;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lz3d;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lz3d;->u0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v5}, Lkme;->p(Landroid/view/View;)Lzlb;

    move-result-object v10

    invoke-interface {v10}, Lzlb;->getIcon()Lwe7;
    ...
    iput-object v5, v0, Lz3d;->v0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lafb;

    invoke-direct {v10, v1}, Lafb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v10, v2}, Lafb;->setMode(Lxeb;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lafb;->a(FILjava/lang/String;)V

    new-instance v9, Lt3d;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lt3d;-><init>(Lz3d;I)V

    invoke-static {v10, v9}, Ljmj;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lz3d;->w0:Lafb;
    ...
    invoke-virtual {v7, v9}, Lkme;->p(Landroid/view/View;)Lzlb;
    ...
    iput-object v9, v0, Lz3d;->x0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lkme;->p(Landroid/view/View;)Lzlb;
    ...
    invoke-static {v3, v6}, Lpti;->f(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {v7, v3}, Lkme;->p(Landroid/view/View;)Lzlb;
    ...
    iput-object v13, v0, Lz3d;->y0:Landroid/widget/LinearLayout;

    new-instance v3, Lafb;

    invoke-direct {v3, v1}, Lafb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lafb;->setMode(Lxeb;)V

    new-instance v6, Lt3d;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lt3d;-><init>(Lz3d;I)V

    invoke-static {v3, v6}, Ljmj;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lz3d;->z0:Lafb;

    new-instance v6, Lz22;

    invoke-direct {v6, v1}, Lz22;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lt3d;-><init>(Lz3d;I)V

    invoke-static {v6, v7}, Ljmj;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lz3d;->A0:Lz22;

    new-instance v7, Lafb;

    invoke-direct {v7, v1}, Lafb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lafb;->setMode(Lxeb;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lafb;->a(FILjava/lang/String;)V

    new-instance v8, Lt3d;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lt3d;-><init>(Lz3d;I)V

    invoke-static {v7, v8}, Ljmj;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lz3d;->B0:Lafb;
    ...
    invoke-virtual {v8, v2}, Lafb;->setMode(Lxeb;)V

    new-instance v2, Lt3d;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lt3d;-><init>(Lz3d;I)V

    invoke-static {v8, v2}, Ljmj;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lz3d;->C0:Lafb;
    ...
    invoke-direct {v3, v2, v1, v7}, Les7;-><init>(ILzt0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lfui;->b(Landroid/view/View;Les7;Lnq6;)V

    iput-object v6, v0, Lz3d;->D0:Landroid/widget/FrameLayout;

    new-instance v1, Lu3d;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lu3d;-><init>(Lz3d;I)V

    invoke-static {v2, v1}, Le8;->b(ILlq6;)Lo58;

    move-result-object v1

    iput-object v1, v0, Lz3d;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lz3d;->F0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lz3d;->G0:Ljava/lang/Object;
...
.method public static final synthetic a(Lz3d;)Z
    .locals 0

    invoke-direct {p0}, Lz3d;->getCanRecordingVideo()Z
...
.method public static final b(Lz3d;Lb22;)V
    .locals 6
    ...
    invoke-direct {p0}, Lz3d;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lz3d;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lz3d;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lz3d;->z0:Lafb;

    sget v2, Lz3d;->H0:F

    invoke-virtual {v1, v0, v5, v2}, Lafb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Lz3d;->getCameraApi()Lc22;
    ...
    invoke-interface {p0, p1}, Lc22;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lz3d;FFFFF)V
    .locals 2

    iget-object v0, p0, Lz3d;->v0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lz3d;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lz3d;->D0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lz3d;->E0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lz3d;->G0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lz3d;->F0:Ljava/lang/Object;
...
.method public final getCameraApi()Lc22;
    .locals 1

    iget-object v0, p0, Lz3d;->u0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
