...
.field public volatile Y:Lpo6;

.field public volatile Z:Lpo6;
...
.field public final o:Lz2e;

.field public volatile s0:J

.field public final t0:Lvkg;

.field public final u0:Lvkg;
...
# direct methods
.method public constructor <init>(Lcgd;Lz2e;)V
    .locals 4
    ...
    iput-object v0, p0, Lbo6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lbo6;->d:Lcgd;

    iput-object p2, p0, Lbo6;->o:Lz2e;
    ...
    iput-object p1, p0, Lbo6;->c:Lp84;

    new-instance p1, Lvkg;

    invoke-direct {p1}, Lvkg;-><init>()V

    iput-object p1, p0, Lbo6;->t0:Lvkg;

    new-instance p1, Lvkg;

    invoke-direct {p1}, Lvkg;-><init>()V

    iput-object p1, p0, Lbo6;->u0:Lvkg;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lbo6;->w0:Z

    iget-object v0, p0, Lbo6;->X:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lbo6;->X:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Lbo6;->t0:Lvkg;
    ...
    iput-wide v2, p0, Lbo6;->s0:J

    :cond_0
    iget-object v0, p0, Lbo6;->Y:Lpo6;
    ...
    iput-boolean v1, v0, Lpo6;->h:Z

    :cond_2
    iget-object v1, v0, Lpo6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lpo6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Lpo6;->g:Lili;

    invoke-static {p1}, Lpo6;->b(Lili;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lbo6;->Z:Lpo6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lbo6;->x0:J

    iget-wide v7, p0, Lbo6;->b:J
    ...
    iget-object v5, v2, Lpo6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lpo6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lbo6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lbo6;->x0:J

    iget-object p1, p0, Lbo6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lbo6;->c:Lp84;

    new-instance v0, Lxe5;

    const/16 v3, 0xa

    invoke-direct {v0, p0, v2, v1, v3}, Lxe5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lbo6;->u0:Lvkg;

    invoke-virtual {p1}, Lvkg;->a()V
