...
.field public final x0:Lnfh;

.field public final y0:Ld68;

.field public final z0:Lkx8;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Ld69;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lodf;->x0:Lnfh;

    iput-object v1, p0, Lodf;->y0:Ld68;

    new-instance v1, Lkx8;

    invoke-direct {v1, p1}, Ldi7;-><init>(Landroid/content/Context;)V

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Ldi7;->setShowProgress(Z)V

    iput-object v1, p0, Lodf;->z0:Lkx8;

    new-instance v3, Lz7b;

    const/16 v4, 0x1d

    invoke-direct {v3, p1, v4}, Lz7b;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v3, p0, Lodf;->A0:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lodf;->B0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    new-instance v5, Lmdf;

    const/4 v6, 0x0

    invoke-direct {v5, p1, v6}, Lmdf;-><init>(Landroid/content/Context;I)V

    invoke-static {v4, v5}, Lv2j;->c(ILmq6;)Ld68;

    move-result-object v5

    iput-object v5, p0, Lodf;->C0:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lodf;->G0:Ljava/lang/Object;
...
.method private final getBlurPostProcessor()Lms0;
    ...
    iget-object v0, p0, Lodf;->C0:Ljava/lang/Object;
...
.method private final getFeaturePrefs()Lux5;
    ...
    iget-object v0, p0, Lodf;->y0:Ld68;
...
.method private final getMediaType()Lcg9;
    .locals 1

    iget-object v0, p0, Lodf;->G0:Ljava/lang/Object;
...
.method private final getTransferStatusView()Lbeh;
    ...
    iget-object v0, p0, Lodf;->A0:Ljava/lang/Object;
...
.method public static final y(Lodf;Ln00;)V
    .locals 7

    iget-object v0, p0, Lodf;->z0:Lkx8;

    invoke-virtual {p0}, Ld69;->getModel()Llx8;
    ...
    :cond_3
    iget-object p0, p0, Lodf;->A0:Ljava/lang/Object;
    ...
    :cond_5
    :goto_2
    invoke-direct {p0}, Lodf;->getTransferStatusView()Lbeh;
...
.method public final b(II)I
    ...
    iget-object v2, p0, Lodf;->B0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    iget-object p1, p0, Lodf;->x0:Lnfh;
    ...
    invoke-virtual {p1, v3, v1}, Lk2;->b0(II)V

    :cond_3
    iget-object p1, p0, Lodf;->A0:Ljava/lang/Object;
    ...
    invoke-static {p2, v1, v3}, Lzy4;->c(FFI)I
    ...
    invoke-static {p2, v4, v3}, Lzy4;->c(FFI)I

    move-result p2

    invoke-static {p1, v1, p2, v6, v5}, Lv5j;->e(Landroid/view/View;IIII)V

    :cond_4
    iget-object p1, p0, Lodf;->G0:Ljava/lang/Object;
    ...
    invoke-static {v1, v3, p2}, Lzy4;->c(FFI)I
    ...
    invoke-direct {p0}, Lodf;->getMediaType()Lcg9;
    ...
    invoke-static {p1, p2, v3, v6, v5}, Lv5j;->e(Landroid/view/View;IIII)V

    :cond_5
    iget-boolean p1, p0, Lodf;->D0:Z
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lodf;->x0:Lnfh;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v4, v1, Lodf;->B0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    if-ne v0, v4, :cond_0

    iget-boolean v5, v1, Lodf;->D0:Z
    ...
    :cond_0
    iget-object v5, v1, Lodf;->z0:Lkx8;

    if-eq v0, v5, :cond_2

    if-eq v0, v4, :cond_2

    iget-object v4, v1, Lodf;->x0:Lnfh;
...
.method public final q(Lkdf;)V
    .locals 1

    invoke-virtual {p0, p1}, Ld69;->setModel(Llx8;)V

    invoke-direct {p0}, Lodf;->getFeaturePrefs()Lux5;

    move-result-object p1

    check-cast p1, Loy5;

    invoke-virtual {p1}, Loy5;->z()Z
    ...
    iget-object p1, p0, Lodf;->E0:Lsk;

    if-eqz p1, :cond_1

    invoke-virtual {p1, p0}, Lsk;->onViewAttachedToWindow(Landroid/view/View;)V
...
.method public final v(IIII)J
    ...
    iget-object p2, p0, Lodf;->A0:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v1, p0, Lodf;->G0:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p3, p0, Lodf;->x0:Lnfh;
    ...
    invoke-virtual {p3, p4, v3}, Lk2;->d0(II)V

    :cond_2
    invoke-virtual {v0}, Lkx8;->getBlurOffset()I
    ...
    iget-object v4, p0, Lodf;->B0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    :cond_4
    iget p3, v0, Lkx8;->Q0:I

    if-lez p3, :cond_6

    iput-boolean v3, p0, Lodf;->D0:Z
    ...
    invoke-virtual {p0}, Ld69;->getDate()Lij4;
    ...
    invoke-static {p2}, Lo4j;->k(Ld68;)I
    ...
    invoke-static {p2}, Lo4j;->j(Ld68;)I
    ...
    invoke-static {p3, p2}, Llij;->c(I[I)I
...
.method public final x(Llx8;)V
    ...
    iget-object v0, p1, Lkdf;->c:Lsh7;

    iget-object v1, p0, Lodf;->z0:Lkx8;

    invoke-virtual {v1, v0}, Ldi7;->setImageAttach(Lsh7;)V

    iget-object v1, v0, Lsh7;->b:Landroid/net/Uri;

    invoke-static {v1}, Lwj7;->d(Landroid/net/Uri;)Lwj7;

    move-result-object v1

    iget-object v2, v0, Lsh7;->i:Loxd;

    iput-object v2, v1, Lwj7;->d:Loxd;

    invoke-direct {p0}, Lodf;->getBlurPostProcessor()Lms0;
    ...
    iget-object v3, p0, Lodf;->B0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    invoke-virtual {v3, v1, v2}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->i(Lvj7;Lvj7;)V
    ...
    invoke-static {p0, v0, v2}, Lq4j;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
