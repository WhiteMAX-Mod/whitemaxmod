...
.method public constructor <init>(Lkotlin/coroutines/Continuation;Lone/me/profile/ProfileScreen;)V
    ...
    iput-object p2, p0, Lduc;->X:Lone/me/profile/ProfileScreen;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lduc;->X:Lone/me/profile/ProfileScreen;

    invoke-direct {v0, p2, v1}, Lduc;-><init>(Lkotlin/coroutines/Continuation;Lone/me/profile/ProfileScreen;)V
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lduc;->o:Ljava/lang/Object;

    check-cast v1, Lric;

    sget-object v2, Lone/me/profile/ProfileScreen;->C0:Lcmj;

    iget-object v2, v0, Lduc;->X:Lone/me/profile/ProfileScreen;

    invoke-virtual {v2}, Lone/me/profile/ProfileScreen;->E0()Lpmb;

    move-result-object v3

    iget-boolean v4, v1, Lric;->b:Z

    iget-boolean v5, v1, Lric;->k:Z

    iget-object v6, v1, Lric;->e:Ljava/lang/CharSequence;

    iget-object v7, v1, Lric;->h:Lghg;
    ...
    invoke-direct {v11, v12, v2}, Ln31;-><init>(ILjava/lang/Object;)V

    invoke-direct {v9, v10, v11}, Limb;-><init>(ILoq6;)V

    invoke-direct {v4, v8, v9, v8}, Lcmb;-><init>(Llmb;Llmb;Limb;)V
    ...
    iget-object v3, v2, Lone/me/profile/ProfileScreen;->s0:Ljkd;
    ...
    invoke-interface {v3, v2, v9}, Ljkd;->D(Ljava/lang/Object;Lp38;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, La4b;

    iget-object v9, v1, Lric;->g:Lxe0;

    invoke-virtual {v3, v9}, La4b;->setCustomOverlay(Lxe0;)V

    iget-wide v9, v1, Lric;->a:J

    new-instance v11, Ljava/lang/Long;

    invoke-direct {v11, v9, v10}, Ljava/lang/Long;-><init>(J)V

    iget-object v9, v1, Lric;->f:Ljava/lang/CharSequence;
    ...
    :cond_1
    invoke-static {v9, v11}, Ln7j;->a(Ljava/lang/CharSequence;Ljava/lang/Long;)Lnd0;

    move-result-object v9

    const/4 v11, 0x1

    invoke-virtual {v3, v9, v11}, La4b;->m(Lnd0;Z)V

    iget-object v9, v1, Lric;->c:Ljava/util/List;

    invoke-virtual {v3, v9}, La4b;->setAvatarUrls(Ljava/util/List;)V

    iget-boolean v9, v1, Lric;->j:Z
    ...
    invoke-direct {v9, v12, v2}, Lp6;-><init>(ILjava/lang/Object;)V

    invoke-static {v3, v9}, Lnlj;->d(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iget-object v1, v1, Lric;->i:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v7, v12}, Lghg;->b(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    :goto_6
    iget-object v13, v2, Lone/me/profile/ProfileScreen;->w0:Ljkd;

    const/16 v14, 0x8

    aget-object v15, v4, v14

    invoke-interface {v13, v2, v15}, Ljkd;->D(Ljava/lang/Object;Lp38;)Ljava/lang/Object;
    ...
    iget-object v9, v2, Lone/me/profile/ProfileScreen;->v0:Ljkd;

    const/4 v12, 0x7

    aget-object v12, v4, v12

    invoke-interface {v9, v2, v12}, Ljkd;->D(Ljava/lang/Object;Lp38;)Ljava/lang/Object;
    ...
    iget-object v13, v9, Lfd8;->b:Lxc8;
    ...
    invoke-static {v12}, Lxc8;->a(Ljava/lang/CharSequence;)V
    ...
    :cond_c
    invoke-virtual {v13, v1}, Lxc8;->c(Ljava/lang/CharSequence;)V

    :cond_d
    :goto_a
    iget-object v1, v2, Lone/me/profile/ProfileScreen;->u0:Ljkd;

    const/4 v9, 0x6

    aget-object v4, v4, v9

    invoke-interface {v1, v2, v4}, Ljkd;->D(Ljava/lang/Object;Lp38;)Ljava/lang/Object;
    ...
    invoke-virtual {v7, v4}, Lghg;->b(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, Lpjj;->h(Landroid/content/Context;)I
    ...
    invoke-direct {v14, v7, v10, v3, v9}, Lnch;-><init>(Landroid/content/Context;IZLlch;)V
    ...
    invoke-static {v2, v5, v4}, Lzy4;->q(FFI)I

    move-result v2

    invoke-static {v10}, Lq3g;->d(I)I
    ...
    invoke-static {v4, v5, v2}, Lzy4;->q(FFI)I
    ...
    invoke-static {v0, v4, v5, v2}, Liyf;->P(Ljava/lang/CharSequence;IILjava/lang/CharSequence;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {v0, v7, v10, v3, v9}, Lnch;-><init>(Landroid/content/Context;IZLlch;)V
    ...
    invoke-virtual/range {v16 .. v16}, Lone/me/profile/ProfileScreen;->E0()Lpmb;
    ...
    invoke-static {v2, v0, v1}, Lone/me/profile/ProfileScreen;->A0(Lone/me/profile/ProfileScreen;Lpmb;Z)V
