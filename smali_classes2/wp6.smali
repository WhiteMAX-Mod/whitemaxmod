...
.method public synthetic constructor <init>(Lru/ok/messages/views/dialogs/FrgDlgPermissions;I)V
    ...
    iput-object p1, p0, Lwp6;->b:Lru/ok/messages/views/dialogs/FrgDlgPermissions;
...
.method public final onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Lwp6;->b:Lru/ok/messages/views/dialogs/FrgDlgPermissions;
    ...
    instance-of p2, p1, Lxp6;

    if-eqz p2, :cond_1

    check-cast p1, Lxp6;

    invoke-interface {p1}, Lxp6;->g()V

    :cond_1
    iget-object p1, v0, Landroidx/fragment/app/a;->H0:Landroidx/fragment/app/a;
    ...
    iget-object v0, v0, Landroidx/fragment/app/a;->K0:Ljava/lang/String;

    invoke-virtual {p2, v0, p1}, Landroidx/fragment/app/c;->b0(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Landroidx/fragment/app/a;->y()I

    move-result v0

    :try_start_0
    invoke-virtual {v1, p1, v0}, Landroidx/fragment/app/a;->f0([Ljava/lang/String;I)V

    invoke-virtual {v1}, Landroidx/fragment/app/a;->t()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lqti;->e:Landroid/content/SharedPreferences;
    ...
    sput-object v0, Lqti;->e:Landroid/content/SharedPreferences;

    :cond_6
    sget-object v0, Lqti;->e:Landroid/content/SharedPreferences;

    invoke-static {v0, p1}, Lqti;->c(Landroid/content/SharedPreferences;[Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {p2, p1, v0}, Lu7;->j(Landroidx/fragment/app/b;[Ljava/lang/String;I)V
    ...
    sput-object p2, Lqti;->e:Landroid/content/SharedPreferences;

    :cond_9
    sget-object p2, Lqti;->e:Landroid/content/SharedPreferences;

    invoke-static {p2, p1}, Lqti;->c(Landroid/content/SharedPreferences;[Ljava/lang/String;)V
