...
.method public final accept(Ljava/lang/Object;)V
    ...
    iput-object v6, v2, Llwb;->W:Lorg/webrtc/RtpSender;

    iput-object v6, v2, Llwb;->Y:Lorg/webrtc/RtpSender;
    ...
    iget-object v0, v2, Llwb;->C:Lcgd;

    const-string v10, "audioShareTransceiver found"

    invoke-interface {v0, v9, v10}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v11, v2, Llwb;->C:Lcgd;
    ...
    invoke-interface {v11, v9, v0}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    iget-object v0, v2, Llwb;->x:Lm6f;
    ...
    iput-object v7, v2, Llwb;->W:Lorg/webrtc/RtpSender;

    iget-object v11, v2, Llwb;->t:Lz39;

    const-string v12, "audio-share"

    invoke-virtual {v11, v7, v12}, Lz39;->g(Lorg/webrtc/RtpSender;Ljava/lang/String;)V

    invoke-virtual {v7, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v7, v2, Llwb;->C:Lcgd;
    ...
    invoke-interface {v7, v9, v0}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v9, v7}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v11 .. v17}, Lz39;->h(Lorg/webrtc/RtpSender;Ljava/lang/String;IILjava/lang/Double;Z)V

    iput-object v12, v2, Llwb;->Y:Lorg/webrtc/RtpSender;

    invoke-virtual {v12, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v5, v2, Llwb;->Y:Lorg/webrtc/RtpSender;

    iget-boolean v7, v2, Llwb;->l0:Z
    ...
    invoke-interface {v5, v9, v0}, Lcgd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_2
    iget-object v0, v2, Llwb;->Y:Lorg/webrtc/RtpSender;

    const/4 v5, 0x1

    invoke-virtual {v2, v3, v10, v5, v0}, Llwb;->m(Lorg/webrtc/PeerConnection;ZZLorg/webrtc/RtpSender;)V
    :try_end_2
    ...
    :cond_9
    :goto_8
    invoke-virtual {v2, v3}, Llwb;->v(Lorg/webrtc/PeerConnection;)V

    iget-object v0, v2, Llwb;->E:Lwk1;

    iget-boolean v4, v0, Lwk1;->z:Z

    if-eqz v4, :cond_a

    sget-object v4, Lpja;->b:Lpja;

    iget-object v0, v0, Lwk1;->y:Lpja;
    ...
    iget-object v3, v2, Llwb;->O:Lorg/webrtc/PeerConnection;
    ...
    invoke-direct {v0, v4, v5, v6, v3}, Lqja;-><init>(Lpja;Ljava/lang/String;Lorg/webrtc/SessionDescription;Lorg/webrtc/SessionDescription;)V

    invoke-virtual {v2, v0}, Llwb;->h(Lqja;)V
    ...
    invoke-direct {v0, v2, v4}, Liwb;-><init>(Llwb;I)V

    iget-object v2, v2, Llwb;->R:Lorg/webrtc/MediaConstraints;
    ...
    invoke-virtual {v0, v2, v3}, Llwb;->u(Lorg/webrtc/PeerConnection;Z)V

    invoke-virtual {v0, v2, v3}, Llwb;->l(Lorg/webrtc/PeerConnection;Z)V
