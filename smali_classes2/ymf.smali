...
# instance fields
.field public final G0:Lsnh;

.field public final H0:Lj88;

.field public final I0:Lby8;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lymf;->G0:Lsnh;

    iput-object v1, p0, Lymf;->H0:Lj88;

    new-instance v1, Lby8;

    invoke-direct {v1, p1}, Lci7;-><init>(Landroid/content/Context;)V

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lci7;->setShowProgress(Z)V

    iput-object v1, p0, Lymf;->I0:Lby8;

    new-instance v3, Liab;

    const/16 v4, 0x1d

    invoke-direct {v3, p1, v4}, Liab;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v3, p0, Lymf;->J0:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lymf;->K0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    invoke-static {v4, v5}, Lbdj;->d(ILis6;)Lj88;

    move-result-object v5

    iput-object v5, p0, Lymf;->L0:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lymf;->P0:Ljava/lang/Object;

    return-void
.end method

.method public static final D(Lymf;Lc20;)V
    .locals 8

    iget-object v0, p0, Lymf;->I0:Lby8;
    ...
    iget-object v1, v1, Lsmf;->b:Ljava/lang/String;
    ...
    :cond_5
    iget-object p0, p0, Lymf;->J0:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v3, p0, v4}, Lci7;->o(ZLjava/lang/Float;Z)V

    return-void

    :cond_7
    :goto_4
    invoke-direct {p0}, Lymf;->getTransferStatusView()Lcmh;
    ...
    invoke-static {p0, v1, v6}, Lhej;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v3, p0}, Lhpg;->b(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    :cond_8
    invoke-virtual {v1, p0}, Lcmh;->setContent(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v4, p0, v4}, Lci7;->o(ZLjava/lang/Float;Z)V
...
.method private final getBlurPostProcessor()Lnt0;
    ...
    iget-object v0, p0, Lymf;->L0:Ljava/lang/Object;
...
.method private final getFeaturePrefs()Liz5;
    ...
    iget-object v0, p0, Lymf;->H0:Lj88;
...
.method private final getMediaType()Lbh9;
    .locals 1

    iget-object v0, p0, Lymf;->P0:Ljava/lang/Object;
...
.method private final getTransferStatusView()Lcmh;
    ...
    iget-object v0, p0, Lymf;->J0:Ljava/lang/Object;
...
.method public final c(II)I
    ...
    iget-object v2, p0, Lymf;->K0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    iget-object p1, p0, Lymf;->G0:Lsnh;
    ...
    invoke-virtual {p1, v3, v1}, Lk2;->d0(II)V

    :cond_3
    iget-object p1, p0, Lymf;->J0:Ljava/lang/Object;
    ...
    invoke-static {p2, v1, v3}, Lj64;->b(FFI)I
    ...
    invoke-static {p2, v4, v3}, Lj64;->b(FFI)I

    move-result p2

    invoke-static {p1, v1, p2, v6, v5}, Lnfj;->c(Landroid/view/View;IIII)V

    :cond_4
    iget-object p1, p0, Lymf;->P0:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lymf;->getMediaType()Lbh9;
    ...
    invoke-static {p1, p2, v3, v6, v5}, Lnfj;->c(Landroid/view/View;IIII)V

    :cond_5
    iget-boolean p1, p0, Lymf;->M0:Z
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Lymf;->G0:Lsnh;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v4, v1, Lymf;->K0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    if-ne v0, v4, :cond_0

    iget-boolean v5, v1, Lymf;->M0:Z
    ...
    :cond_0
    iget-object v5, v1, Lymf;->I0:Lby8;

    if-eq v0, v5, :cond_2

    if-eq v0, v4, :cond_2

    iget-object v4, v1, Lymf;->G0:Lsnh;
...
.method public final j(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Lymf;->I0:Lby8;
    ...
    :cond_0
    iget-object v1, p0, Lymf;->K0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
...
.method public final q(Lsmf;)V
    .locals 1

    invoke-virtual {p0, p1}, Lnf9;->setModel(Lcy8;)V

    invoke-direct {p0}, Lymf;->getFeaturePrefs()Liz5;
...
.method public final x(IIII)J
    ...
    iget-object p2, p0, Lymf;->J0:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v1, p0, Lymf;->P0:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p3, p0, Lymf;->G0:Lsnh;
    ...
    invoke-virtual {p3, p4, v3}, Lk2;->f0(II)V

    :cond_2
    invoke-virtual {v0}, Lby8;->getBlurOffset()I
    ...
    iget-object v4, p0, Lymf;->K0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    :cond_4
    iget p3, v0, Lby8;->Q0:I

    if-lez p3, :cond_6

    iput-boolean v3, p0, Lymf;->M0:Z
    ...
    invoke-static {p2}, Lfej;->m(Lj88;)I
    ...
    invoke-static {p2}, Lfej;->l(Lj88;)I
    ...
    invoke-static {p3, p2}, Lxrj;->d(I[I)I
...
.method public final z(Lcy8;)V
    ...
    iget-object v0, p1, Lsmf;->c:Lrh7;

    iget-object v1, p0, Lymf;->I0:Lby8;

    invoke-virtual {v1, v0}, Lci7;->setImageAttach(Lrh7;)V

    iget-object v1, v0, Lrh7;->b:Landroid/net/Uri;

    invoke-static {v1}, Lxj7;->d(Landroid/net/Uri;)Lxj7;

    move-result-object v1

    iget-object v2, v0, Lrh7;->i:Lr4e;

    iput-object v2, v1, Lxj7;->d:Lr4e;

    invoke-direct {p0}, Lymf;->getBlurPostProcessor()Lnt0;
    ...
    iget-object v3, p0, Lymf;->K0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    invoke-virtual {v3, v1, v2}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->j(Lwj7;Lwj7;)V
    ...
    invoke-static {p0, v0, v2}, Lhej;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
