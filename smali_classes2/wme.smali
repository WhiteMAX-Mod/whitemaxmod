...
# direct methods
.method public constructor <init>(Lgha;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lzcf;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lwme;->o:Lgha;

    iput-object p2, p0, Lwme;->X:Ljava/util/concurrent/ExecutorService;
...
.method public final I(Ljef;I)V
    ...
    invoke-virtual {p1, p2}, Lvme;->D(Let6;)V
...
.method public final u(Landroid/view/ViewGroup;I)Ltsd;
    ...
    iget-object v2, p0, Lwme;->o:Lgha;

    invoke-direct {p1, v2, p2, v0, v1}, Lvme;-><init>(Lgha;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
