...
.method public constructor <init>(JJJJZZZ)V
    ...
    iput-wide p3, p0, Lwl2;->d:J

    iput-wide p5, p0, Lwl2;->o:J

    iput-wide p7, p0, Lwl2;->X:J

    iput-boolean p9, p0, Lwl2;->Y:Z

    iput-boolean p10, p0, Lwl2;->Z:Z

    iput-boolean p11, p0, Lwl2;->s0:Z
    ...
    iput-object p1, p0, Lwl2;->t0:Ljava/lang/String;
...
.method public final c()I
    ...
    iget-wide v1, p0, Lwl2;->d:J

    invoke-virtual {v0, v1, v2}, Lch2;->J(J)Lud2;

    move-result-object v0

    iget-object v3, p0, Lwl2;->t0:Ljava/lang/String;

    const/4 v4, 0x3

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lwl2;->Z:Z
    ...
    invoke-static {v3, v1, v0}, Lm4j;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_2
    iget-wide v5, p0, Lwl2;->o:J

    iget-boolean v7, p0, Lwl2;->Y:Z

    if-eqz v7, :cond_8

    iget-wide v8, p0, Lwl2;->X:J
    ...
    iget-wide v13, v0, Lud2;->a:J

    invoke-virtual {v12, v13, v14, v8, v9}, Lbn9;->h(JJ)Ldn9;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v8, v0, Ldn9;->t0:Lwq9;
    ...
    invoke-virtual {v0, v8, v12, v13}, Lncc;->m(Ljava/lang/Enum;J)J
    ...
    iget-wide v8, p0, Lum;->a:J

    sget-object v3, Lhzb;->v0:Lhzb;

    invoke-virtual {v0, v8, v9, v3}, Lkeg;->h(JLhzb;)Ljava/util/List;
    ...
    iget-object v3, v3, Lceg;->f:Lgzb;

    check-cast v3, Lwl2;

    iget-wide v5, v3, Lwl2;->d:J

    cmp-long v5, v5, v1

    if-nez v5, :cond_9

    iget-boolean v3, v3, Lwl2;->Y:Z
    ...
    iget-wide v7, v3, Lwl2;->d:J

    cmp-long v7, v7, v1

    if-nez v7, :cond_b

    iget-boolean v7, v3, Lwl2;->Y:Z

    if-nez v7, :cond_b

    iget-wide v7, v3, Lwl2;->o:J
...
.method public final e(Lxbg;)V
    ...
    iget-object v1, p1, Lxl2;->o:Ljava/lang/Boolean;

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    iget-object v1, p0, Lwl2;->t0:Ljava/lang/String;
    ...
    iget-object v5, p1, Lxl2;->o:Ljava/lang/Boolean;
    ...
    invoke-virtual {v1, v3}, Liab;->a(Ljava/lang/Throwable;)V

    :cond_3
    iget-wide v3, p1, Lxl2;->c:J
    ...
    invoke-static {v1, v5}, Lm4j;->A(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-wide v6, p0, Lwl2;->d:J

    iget-wide v8, p0, Lwl2;->o:J
    ...
    invoke-virtual {v1, v5}, Liab;->a(Ljava/lang/Throwable;)V

    iget-wide v3, p0, Lwl2;->o:J
    ...
    iget v12, p1, Lxl2;->d:I

    const/4 v13, 0x1

    invoke-virtual/range {v5 .. v13}, Lch2;->u0(JJJIZ)Lud2;
    ...
    iget-wide v6, p1, Ldn9;->c:J

    const-wide/16 v8, 0x0

    sget-object v10, Llw4;->o:Llw4;

    invoke-static/range {v1 .. v10}, Lxj2;->a(Lxj2;JJJJLlw4;)V
...
.method public final h()Lk2;
    ...
    iget-wide v2, p0, Lwl2;->d:J

    invoke-virtual {v0, v2, v3, v1}, Lk2;->v(JLjava/lang/String;)V

    const-string v1, "mark"

    iget-wide v2, p0, Lwl2;->o:J

    invoke-virtual {v0, v2, v3, v1}, Lk2;->v(JLjava/lang/String;)V

    const-wide/16 v1, -0x1

    iget-wide v3, p0, Lwl2;->X:J
