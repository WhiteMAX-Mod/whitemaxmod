...
.method public final onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    iget-object p3, p0, Lijh;->b:Lojh;

    packed-switch p2, :pswitch_data_0

    invoke-virtual {p1, p0}, Landroid/view/View;->removeOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    sget-object p1, Lojh;->M0:[Lp38;

    invoke-virtual {p3}, Lojh;->t()V
    ...
    :cond_1
    invoke-static {p3}, Lojh;->j(Lojh;)Z

    move-result p2

    invoke-virtual {p1}, Lfm9;->getMaxAvailableWidth$message_list_release()I

    move-result p1

    if-eqz p2, :cond_2

    invoke-static {p3}, Lsmj;->b(Landroid/view/View;)Z
    ...
    iget-object p2, p3, Lojh;->o:Lnfh;

    invoke-virtual {p2, p4}, Lnfh;->c(Z)V

    :cond_4
    iget p2, p3, Lojh;->L0:I

    iget-object p5, p3, Lojh;->K0:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p2, p4}, Ljjh;-><init>(I)V

    invoke-virtual {p1, p2}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->start()V

    iput-object p1, p3, Lojh;->K0:Landroid/animation/ValueAnimator;
