...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljl1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;",
        ...
        "(Ljava/util/Collection;Lis6;Lks6;)V",
        "getRoomParticipants",
        "(Lw1f;Lks6;Lks6;)V",
...
.method public static synthetic a(Lks6;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$9(Lks6;)V
...
.method public static final synthetic access$getRoomParticipantIds(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lv1f;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lv1f;)Ljava/util/Collection;
...
.method public static final synthetic access$mapInternalIdsToSessionRoomParticipants(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lw1f;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdsToSessionRoomParticipants(Lw1f;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static synthetic b(Lks6;Lks6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljl1;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$0(Lks6;Lks6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljl1;)V

    return-void
.end method

.method public static synthetic c(Lks6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$1(Lks6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
...
.method public static synthetic d(Lis6;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$8(Lis6;)V
...
.method private final getAllRoomParticipantIds()Ljava/util/Collection;
    ...
    iget-object v2, v2, Lq1f;->e:Ljava/util/List;
    ...
    :cond_0
    invoke-static {v1}, Lgk3;->o(Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method private final getMainCallParticipantIds(Lks6;Lks6;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2}, Lek3;->d0(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lw1f;)Ljava/util/Collection;
    ...
    invoke-static {v2, v0}, Lgk3;->n(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {v0, v1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants;-><init>(Lw1f;Ljava/util/Collection;)V
...
.method private final getRoomParticipantIds(Lv1f;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Lq1f;->e:Ljava/util/List;
...
.method private final mapConversationParticipantToSessionRoomParticipant(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {v2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lw1f;

    move-result-object v2

    invoke-direct {v0, v1, v2, p1}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lw1f;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V

    return-object v0
.end method

.method private final mapInternalIdToSessionRoomParticipant(Ljl1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    .locals 2
    ...
    invoke-direct {v1, p1, v0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lw1f;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
...
.method private final mapInternalIdsToSessionRoomParticipants(Lw1f;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdToSessionRoomParticipant(Ljl1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lw1f;)Ljava/util/Collection;
...
.method private static final resolveInternalIdByExternal$lambda$0(Lks6;Lks6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Ljl1;)V
    .locals 1

    if-eqz p3, :cond_0

    invoke-interface {p0, p3}, Lks6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final resolveInternalIdByExternal$lambda$1(Lks6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 3
...
.method private final resolveParticipantIds(Ljava/util/Collection;Lis6;Lks6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, p2}, Lel0;-><init>(ILis6;)V

    new-instance p2, Lx1f;

    const/4 v2, 0x0

    invoke-direct {p2, v2, p3}, Lx1f;-><init>(ILks6;)V
...
.method private static final resolveParticipantIds$lambda$8(Lis6;)V
    .locals 0
...
.method private static final resolveParticipantIds$lambda$9(Lks6;)V
    .locals 2
...
# virtual methods
.method public getAllInRoomParticipants(Lks6;Lks6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v0, p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getAllInRoomParticipants$1;-><init>(Ljava/util/Set;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lks6;)V

    invoke-direct {p0, v1, v2, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lis6;Lks6;)V
...
.method public final getInternalIdsByExternal(Ljava/util/Collection;)Ljava/util/Map;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Ljl1;
...
.method public getParticipantRoomId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lks6;Lks6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2}, Lks6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lw1f;
...
.method public getRoomParticipants(Lw1f;Lks6;Lks6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getMainCallParticipantIds(Lks6;Lks6;)V
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lv1f;)Ljava/util/Collection;
    ...
    invoke-direct {v1, p2, p1, p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getRoomParticipants$1;-><init>(Lks6;Lw1f;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ljava/util/Collection;)V

    invoke-direct {p0, v0, v1, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lis6;Lks6;)V

    :cond_1
    return-void
.end method

.method public final resolveInternalIdByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lks6;Lks6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2, p3, p1, v2}, Lgu4;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/Serializable;I)V

    new-instance p2, Lf1f;

    const/4 v2, 0x6

    invoke-direct {p2, p3, v2, p1}, Lf1f;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v0, p1, v1, p2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lty3;Ljava/lang/Runnable;)V
