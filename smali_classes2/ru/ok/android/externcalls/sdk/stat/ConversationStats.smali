...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lis6;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lbc4;Lru/ok/android/externcalls/sdk/Conversation$CallType;Losg;Ltmd;ZZ)V",
...
# direct methods
.method public constructor <init>(Lis6;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lbc4;Lru/ok/android/externcalls/sdk/Conversation$CallType;Losg;Ltmd;ZZ)V
    .locals 1
    ...
    invoke-direct {v0, p5, p1}, Lru/ok/android/externcalls/sdk/stat/connect/ConversationConnectedToSignalingStat;-><init>(Losg;Lis6;)V
    ...
    invoke-direct {v0, p2, p3}, Lru/ok/android/externcalls/sdk/stat/reconnect/ConversationReconnectStat;-><init>(Lru/ok/android/externcalls/sdk/log/ExtLogger;Lbc4;)V
    ...
    invoke-direct {p2, p5, p1}, Lru/ok/android/externcalls/sdk/stat/warmup/ConversationPreparedStat;-><init>(Losg;Lis6;)V
    ...
    invoke-direct {p2, p4, p5, p1}, Lru/ok/android/externcalls/sdk/stat/start/ConversationStartedStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;Losg;Lis6;)V
    ...
    invoke-direct {p2, p1, p5, p6, p8}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;-><init>(Lis6;Losg;Ltmd;Z)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/kws/ConversationKwsStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p4, p7, p1}, Lru/ok/android/externcalls/sdk/stat/init/CallInitStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;ZLis6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidateschanged/IceCandidatePairChangedStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/icerestart/IceRestartStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p1, p5}, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;-><init>(Lis6;Losg;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/connection/PeerConnectionChangedStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/negotiation/NegotiationErrorStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;-><init>(Lis6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/p2prelay/P2PRelayRequestedStat;-><init>(Lis6;)V
