...
.method private verifyOutputFormat(Ljava/io/File;)V
    ...
    :try_start_0
    invoke-static {p1}, Lo36;->d(Ljava/io/File;)Z
...
.method private write(ZLru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, p3}, Lbrb;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {p1, v0}, Lq9c;-><init>(Ljava/io/Writer;)V
    ...
    invoke-virtual {p3, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->serialize(Lx28;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p1}, Lq9c;->close()V
...
.method public drop()V
    ...
    :cond_0
    :try_start_2
    invoke-static {v2}, Lo36;->b(Ljava/io/File;)V
...
.method public grab(Ljavax/inject/Provider;)V
    ...
    :goto_0
    invoke-static {v3}, Lo36;->e(Ljava/io/File;)J
    ...
    invoke-static {p1}, Lo36;->e(Ljava/io/File;)J
    ...
    invoke-static {p1, v3, v4}, Lo36;->a(Ljava/io/File;Ljava/io/File;Z)V
...
.method public length()J
    ...
    invoke-static {v0}, Lo36;->e(Ljava/io/File;)J
...
.method public writeToCache(Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    ...
    invoke-static {v3}, Lo36;->g(Ljava/io/File;)V
    ...
    :try_start_7
    invoke-static {v3}, Lo36;->b(Ljava/io/File;)V
    :try_end_7
