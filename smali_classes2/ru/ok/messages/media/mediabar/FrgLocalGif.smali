...
.method public final O(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p2, Lt9d;->frg_local_gif__drawee:I
    ...
    invoke-direct {p3, v0, v1}, Ls20;-><init>(Landroid/content/Context;I)V

    const/4 v0, 0x3

    invoke-virtual {p2, p3, v0}, Lqv6;->i(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-direct {p3, v0, p0}, Lij6;-><init>(ILjava/lang/Object;)V
...
.method public final n(Ldi8;Landroid/net/Uri;ILandroid/net/Uri;)V
    ...
    invoke-virtual {p3, p2}, Le9c;->c(Landroid/net/Uri;)V
    ...
    iput-boolean p2, p3, Lw0;->g:Z

    iget-object p2, p1, Ldi8;->d:Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Ln85;->setController(Lh85;)V
