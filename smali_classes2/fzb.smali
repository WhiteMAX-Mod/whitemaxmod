...
.method public final accept(Ljava/lang/Object;)V
    ...
    iput-object v6, v2, Ltzb;->X:Lorg/webrtc/RtpSender;

    iput-object v6, v2, Ltzb;->Z:Lorg/webrtc/RtpSender;
    ...
    invoke-interface {v0, v9, v10}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v11, v2, Ltzb;->D:Ltmd;
    ...
    invoke-interface {v11, v9, v0}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    iget-object v0, v2, Ltzb;->y:Ldff;
    ...
    iput-object v7, v2, Ltzb;->X:Lorg/webrtc/RtpSender;

    iget-object v11, v2, Ltzb;->u:Ly49;

    const-string v12, "audio-share"

    invoke-virtual {v11, v7, v12}, Ly49;->j(Lorg/webrtc/RtpSender;Ljava/lang/String;)V

    invoke-virtual {v7, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v7, v2, Ltzb;->D:Ltmd;
    ...
    invoke-interface {v7, v9, v0}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v9, v7}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v11 .. v17}, Ly49;->k(Lorg/webrtc/RtpSender;Ljava/lang/String;IILjava/lang/Double;Z)V

    iput-object v12, v2, Ltzb;->Z:Lorg/webrtc/RtpSender;

    invoke-virtual {v12, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v5, v2, Ltzb;->Z:Lorg/webrtc/RtpSender;

    iget-boolean v7, v2, Ltzb;->m0:Z
    ...
    invoke-interface {v5, v9, v0}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_2
    iget-object v0, v2, Ltzb;->Z:Lorg/webrtc/RtpSender;

    const/4 v5, 0x1

    invoke-virtual {v2, v3, v10, v5, v0}, Ltzb;->m(Lorg/webrtc/PeerConnection;ZZLorg/webrtc/RtpSender;)V
    :try_end_2
    ...
    :cond_9
    :goto_8
    invoke-virtual {v2, v3}, Ltzb;->u(Lorg/webrtc/PeerConnection;)V

    sget-object v0, Lama;->b:Lama;

    iget-object v4, v2, Ltzb;->F:Lgl1;

    iget-object v4, v4, Lgl1;->u:Lama;
    ...
    invoke-direct {v3, v0, v5, v6, v4}, Lbma;-><init>(Lama;Ljava/lang/String;Lorg/webrtc/SessionDescription;Lorg/webrtc/SessionDescription;)V

    invoke-virtual {v2, v3}, Ltzb;->h(Lbma;)V
    ...
    invoke-direct {v0, v2, v4}, Lqzb;-><init>(Ltzb;I)V

    iget-object v2, v2, Ltzb;->S:Lorg/webrtc/MediaConstraints;
    ...
    invoke-virtual {v0, v2, v3}, Ltzb;->t(Lorg/webrtc/PeerConnection;Z)V

    invoke-virtual {v0, v2, v3}, Ltzb;->l(Lorg/webrtc/PeerConnection;Z)V
