...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILl4e;)V
    .locals 0

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    iput-object p1, p0, Lfq0;->a:Landroid/content/Context;

    iput-object p2, p0, Lfq0;->b:Landroid/net/Uri;

    iput-object p3, p0, Lfq0;->c:Landroid/net/Uri;

    iput p4, p0, Lfq0;->d:I

    iput p5, p0, Lfq0;->e:I

    iput-object p6, p0, Lfq0;->f:Ll4e;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lfq0;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v2, p0, Lfq0;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, Ln8j;->e(Ljava/io/Closeable;)V

    invoke-static {p1}, Ln8j;->e(Ljava/io/Closeable;)V

    iput-object v0, p0, Lfq0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Ln8j;->e(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-direct {v1}, La1b;-><init>()V

    iget-object v2, v1, La1b;->a:Lkqe;
    ...
    invoke-direct {v4, v5, v6}, Lgo4;-><init>(IZ)V
    ...
    invoke-virtual {v1, p1}, La1b;->b(Lnwd;)Lukd;
    ...
    :try_start_1
    iget-object v1, p1, Leyd;->Y:Lgyd;

    invoke-virtual {v1}, Lgyd;->c0()Lmx0;
    ...
    :try_start_2
    iget-object v5, p0, Lfq0;->a:Landroid/content/Context;
    ...
    sget-object v5, Lg1b;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v5, p2, v7, v6}, Lky;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-interface {v4, v5}, Lmx0;->R(Lky;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Ln8j;->e(Ljava/io/Closeable;)V

    invoke-static {v5}, Ln8j;->e(Ljava/io/Closeable;)V

    invoke-static {v1}, Ln8j;->e(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Lkqe;->e()V
    ...
    :goto_2
    invoke-static {v3}, Ln8j;->e(Ljava/io/Closeable;)V
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v1, p0, Lfq0;->a:Landroid/content/Context;

    invoke-static {v1, v0}, Lx7;->b(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lfq0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Leff;->c(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Leff;->c(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Leq0;
    ...
    iget-object v3, v1, Lfq0;->a:Landroid/content/Context;

    iget-object v0, v1, Lfq0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Leq0;-><init>(Ljava/lang/Exception;)V
    ...
    iget-object v4, v1, Lfq0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Lfq0;->d:I

    iget v13, v1, Lfq0;->e:I
    ...
    invoke-direct {v3, v0}, Lsi7;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lsi7;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Ln8j;->e(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Ldo5;->b:I

    iput v10, v4, Ldo5;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Leq0;-><init>(Landroid/graphics/Bitmap;Ldo5;)V
    ...
    invoke-direct {v0, v13, v4}, Leq0;-><init>(Landroid/graphics/Bitmap;Ldo5;)V
    ...
    invoke-direct {v2, v0}, Leq0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Lfq0;->c:Landroid/net/Uri;
    ...
    iget-object v0, p0, Lfq0;->a:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v1, p0, Lfq0;->b:Landroid/net/Uri;
    ...
    iput-object v1, p0, Lfq0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Lfq0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Lfq0;->b:Landroid/net/Uri;
    ...
    invoke-static {v2, v0}, Lx02;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v3}, Lfq0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Leq0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Lfq0;->f:Ll4e;

    if-nez v0, :cond_1

    iget-object p1, p1, Leq0;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v1, v1, Ll4e;->b:Ljava/lang/Object;

    check-cast v1, Lusg;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, v1, Lusg;->z0:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Lusg;->w0:Z

    invoke-virtual {v1, p1}, Lusg;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Ll4e;->b:Ljava/lang/Object;
