...
.field public final B0:Lfcb;

.field public final C0:Ljava/util/LinkedHashMap;

.field public final D0:Loha;

.field public final E0:Ljava/lang/Object;

.field public final F0:Ljava/lang/Object;

.field public y0:Ljab;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Ltd3;-><init>(Landroid/content/Context;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Llab;->z0:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Llab;->A0:Landroid/graphics/Rect;

    new-instance v0, Lfcb;

    const/16 v1, 0xe

    invoke-direct {v0, p1, v1}, Lfcb;-><init>(Landroid/content/Context;I)V
    ...
    invoke-static {v0, v1, v2}, Lj1j;->b(Landroid/view/View;Landroid/text/TextPaint;Lipg;)V
    ...
    iput-object v0, p0, Llab;->B0:Lfcb;

    new-instance v5, Ljava/util/LinkedHashMap;

    invoke-direct {v5}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v5, p0, Llab;->C0:Ljava/util/LinkedHashMap;

    new-instance v5, Loha;

    invoke-direct {v5}, Loha;-><init>()V

    iput-object v5, p0, Llab;->D0:Loha;
    ...
    iput-object v5, p0, Llab;->E0:Ljava/lang/Object;

    new-instance v5, Lnsa;

    const/4 v7, 0x5

    invoke-direct {v5, p1, v7, p0}, Lnsa;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v6, v5}, Lbdj;->d(ILis6;)Lj88;

    move-result-object p1

    iput-object p1, p0, Llab;->F0:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v3}, Ltd3;->setSingleSelection(Z)V
    ...
    invoke-direct {p1, p0}, Lkab;-><init>(Llab;)V
...
.method private final getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    iget-object v0, p0, Llab;->F0:Ljava/lang/Object;
...
.method private final getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    iget-object v0, p0, Llab;->E0:Ljava/lang/Object;
...
.method public final a(JJLjava/lang/CharSequence;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Llab;->C0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0}, Llab;->getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    invoke-static {v3, v0, v2}, Lj1j;->b(Landroid/view/View;Landroid/text/TextPaint;Lipg;)V
    ...
    invoke-virtual/range {v2 .. v10}, Llab;->b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v10}, Lhab;-><init>(Llab;Lcom/google/android/material/chip/Chip;JJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Llab;->y0:Ljab;
...
.method public final b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Llab;->getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    invoke-direct/range {p3 .. p8}, Lfu0;-><init>(Ljava/lang/Object;JLjava/lang/Object;I)V

    new-instance p2, Ltk1;

    const/4 p5, 0x3

    invoke-direct {p2, p1, p5, p3}, Ltk1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p2, p4, Llab;->D0:Loha;

    invoke-virtual {p2, p5, p6}, Loha;->d(J)Ljava/lang/Object;
    ...
    invoke-direct {p3, v0, v1}, Lp5b;-><init>(Landroid/content/Context;I)V

    invoke-virtual {p2, p5, p6, p3}, Loha;->j(JLjava/lang/Object;)V
    ...
    invoke-static {p7, p2}, Lchj;->a(Ljava/lang/CharSequence;Ljava/lang/Long;)Ljf0;

    move-result-object p2

    invoke-virtual {p3, p2, p8}, Lp5b;->b(Ljf0;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Llab;->setChipStyle(Lcom/google/android/material/chip/Chip;)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, Llab;->getEditText()Landroid/widget/EditText;

    move-result-object v0

    iget-object v1, p0, Llab;->z0:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/view/View;->getHitRect(Landroid/graphics/Rect;)V

    iget-object v0, p0, Llab;->A0:Landroid/graphics/Rect;
...
.method public final getCallback()Ljab;
    .locals 1

    iget-object v0, p0, Llab;->y0:Ljab;
...
.method public final getEditText()Landroid/widget/EditText;
    ...
    iget-object v0, p0, Llab;->B0:Lfcb;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Llab;->D0:Loha;

    invoke-virtual {v0}, Loha;->a()V

    iget-object v0, p0, Llab;->C0:Ljava/util/LinkedHashMap;
...
.method public final onThemeChanged(Llob;)V
    ...
    iget-object v1, p0, Llab;->B0:Lfcb;
    ...
    iget-object p1, p0, Llab;->C0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, v0}, Llab;->setChipStyle(Lcom/google/android/material/chip/Chip;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Llab;->F0:Ljava/lang/Object;
    ...
    invoke-static {p1, v0, v1}, Lgxj;->b(Likh;Ljava/lang/String;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Llab;->A0:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Llab;->z0:Landroid/graphics/Rect;
...
.method public final setCallback(Ljab;)V
    .locals 0

    iput-object p1, p0, Llab;->y0:Ljab;
