...
.method public constructor <init>(ILandroid/content/Context;Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;)V
    ...
    iput-object p3, p0, Lbhc;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
    ...
    invoke-static {p2}, Lk0j;->k(Landroid/content/Context;)Lzkg;
    ...
    iput-object v3, p0, Lbhc;->c:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lbhc;->d:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Lbhc;->e:Landroid/graphics/Paint;

    iget p2, p2, Lzkg;->k:I

    const v6, 0x3f19999a    # 0.6f

    invoke-static {p2, v6}, Lirj;->b(IF)I
    ...
    iput-object p2, p0, Lbhc;->g:Landroid/graphics/RectF;
    ...
    iput-object p3, p0, Lbhc;->i:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lbhc;->j:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lbhc;->k:Landroid/graphics/RectF;
...
.method public final a()F
    ...
    iget-object v0, p0, Lbhc;->i:Landroid/graphics/RectF;

    invoke-virtual {v0}, Landroid/graphics/RectF;->centerX()F

    move-result v0

    iget-object v1, p0, Lbhc;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
...
.method public final b(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, p1}, Lbhc;->c(F)V

    return-void

    :cond_1
    invoke-virtual {p0}, Lbhc;->a()F
...
.method public final c(F)V
    ...
    iget-object v0, p0, Lbhc;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v0, p1}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->b(F)F

    move-result p1

    iget-object v0, p0, Lbhc;->g:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lbhc;->j:Landroid/graphics/RectF;

    invoke-virtual {v2, p1, v1}, Landroid/graphics/RectF;->offsetTo(FF)V

    iget-object p1, p0, Lbhc;->k:Landroid/graphics/RectF;
