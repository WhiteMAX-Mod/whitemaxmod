...
# direct methods
.method public constructor <init>(Llyb;Lva1;Ltmd;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lnyb;->a:Llyb;

    iput-object p2, p0, Lnyb;->b:Lva1;

    iput-object p3, p0, Lnyb;->c:Ltmd;
    ...
    invoke-direct {p2, v0, v1, v0, v1}, Lvx8;-><init>(DD)V

    const/4 p3, 0x0

    const/4 v0, 0x1

    invoke-direct {p1, v0, p2, p3}, Lpwi;-><init>(ILvx8;Z)V

    iput-object p1, p0, Lnyb;->f:Lpwi;

    iput-boolean v0, p0, Lnyb;->g:Z

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lnyb;->h:Ljava/lang/Object;
...
.method public final a()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lnyb;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_0
    iget-object v0, p0, Lnyb;->f:Lpwi;

    iget v2, v0, Lpwi;->a:I

    sget-object v3, Lmyb;->$EnumSwitchMapping$0:[I
    ...
    :cond_1
    iget-boolean v0, v0, Lpwi;->c:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, Lnyb;->a:Llyb;

    iget-object v0, v0, Llyb;->f:Lbgg;
    ...
    invoke-static {v0, v2}, Lnyb;->b([Lorg/webrtc/VideoCodecInfo;Ljava/lang/String;)Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v2, p0, Lnyb;->c:Ltmd;

    const-string v4, "PatchedVideoEncoderFactoryCodecSelector"

    const-string v5, "Software VP8 encoder not found"

    invoke-interface {v2, v4, v5}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :cond_4
    :goto_0
    iget-object v2, p0, Lnyb;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-static {v6, v4, v7, v2, v8}, Lau1;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lnyb;->h:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-boolean v6, p0, Lnyb;->g:Z
    ...
    :cond_a
    iput-boolean v3, p0, Lnyb;->g:Z

    iget-object v3, p0, Lnyb;->f:Lpwi;
    :try_end_0
    ...
    iget-object v3, p0, Lnyb;->b:Lva1;

    new-instance v5, Lorg/json/JSONObject;

    invoke-direct {v5}, Lorg/json/JSONObject;-><init>()V

    iget-object v6, p0, Lnyb;->f:Lpwi;

    iget-object v6, v6, Lpwi;->b:Lvx8;

    iget-wide v6, v6, Lvx8;->a:D
    ...
    invoke-static {v3, v4, v2, v1, v5}, Lva1;->a(Lva1;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;I)V
...
.method public final n(Lux8;)V
    ...
    iget-object v0, p0, Lnyb;->h:Ljava/lang/Object;
    ...
    iget-object v3, p1, Lux8;->b:Lvx8;

    iget-boolean p1, p1, Lux8;->d:Z

    invoke-direct {v1, v2, v3, p1}, Lpwi;-><init>(ILvx8;Z)V

    iput-object v1, p0, Lnyb;->f:Lpwi;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lnyb;->g:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onAvailableBitrate(I)Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-virtual {p0}, Lnyb;->a()Lorg/webrtc/VideoCodecInfo;
...
.method public final onCurrentEncoder(Lorg/webrtc/VideoCodecInfo;)V
    ...
    iput-object p1, p0, Lnyb;->e:Lorg/webrtc/VideoCodecInfo;

    :cond_0
    iput-object p1, p0, Lnyb;->d:Lorg/webrtc/VideoCodecInfo;
...
.method public final onEncoderBroken()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lnyb;->d:Lorg/webrtc/VideoCodecInfo;

    iget-object v1, p0, Lnyb;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-interface {v4, v2, v0}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iput-object v1, p0, Lnyb;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_2
    iput-object v1, p0, Lnyb;->d:Lorg/webrtc/VideoCodecInfo;
