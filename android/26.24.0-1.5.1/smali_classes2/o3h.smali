...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Ln3h;-><init>(Ljava/lang/Object;Lo3h;I)V

    iput-object v0, p0, Lo3h;->a:Ln3h;
    ...
    invoke-direct {p0}, Lo3h;->getTheme()Ljvb;

    move-result-object v0

    invoke-interface {v0}, Ljvb;->C()Lavb;

    move-result-object v0

    iget-object v0, v0, Lavb;->a:Lach;
    ...
    iput-object p1, p0, Lo3h;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Lo3h;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lo3h;->e:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lo3h;->f:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lo3h;->g:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lo3h;)Ljvb;
    .locals 0
...
.method private final getTheme()Ljvb;
    ...
    invoke-virtual {p0}, Lo3h;->getThemeName()Ljava/lang/String;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lo3h;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lo3h;->h:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lo3h;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lo3h;->i:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lo3h;->j:[Lel8;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object p0, p0, Lo3h;->c:Ln3h;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Lo3h;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lo3h;->f:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lo3h;->h:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lo3h;->e:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lo3h;->g:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p0, p0, Lo3h;->i:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Ljvb;)V
    ...
    :goto_0
    iget-object v0, p0, Lo3h;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lo3h;->b:Landroid/graphics/drawable/GradientDrawable;
