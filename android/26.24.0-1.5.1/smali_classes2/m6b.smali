...
.method public final b(Lach;)V
    ...
    iget-object v2, v1, Lach;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Ld7b;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lm6b;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Ll6b;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    invoke-static {v3, v0}, Le17;->w(Ljava/lang/Object;Ljava/lang/String;)V

    return-void

    :cond_5
    :goto_1
    iget-boolean v3, v0, Lm6b;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lm6b;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lk6b;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Ld7b;->d:Z

    if-eqz v1, :cond_8

    iget-object v0, v0, Ld7b;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v0}, Ll6b;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v6}, Ll6b;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
