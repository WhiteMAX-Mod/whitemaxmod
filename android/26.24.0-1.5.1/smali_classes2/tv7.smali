...
# static fields
.field private static final a:Ltv7;
...
.method public static k(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0}, Ltv7;->l(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1, p2}, Ltv7;->n([BII)[B
    ...
    invoke-static {p0, p3, p1, p2}, Ltv7;->m(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public d(Landroid/media/Image;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0}, Ltm8;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, p2, p1, v0}, Ltv7;->m(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public e(Lw58;Z)Ljava/nio/ByteBuffer;
    .locals 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/mlkit/common/MlKitException;
    ...
    invoke-virtual/range {p1 .. p1}, Lw58;->j()I
    ...
    invoke-virtual/range {p1 .. p1}, Lw58;->h()Ljava/nio/ByteBuffer;

    move-result-object v1

    invoke-static {v1}, Ltm8;->m(Ljava/lang/Object;)V

    invoke-static {v1, v0}, Ltv7;->l(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    :cond_1
    invoke-virtual/range {p1 .. p1}, Lw58;->m()[Landroid/media/Image$Plane;

    move-result-object v0

    invoke-static {v0}, Ltm8;->m(Ljava/lang/Object;)V

    invoke-virtual/range {p1 .. p1}, Lw58;->o()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Lw58;->k()I

    move-result v2

    move-object/from16 v3, p0

    invoke-virtual {v3, v0, v1, v2}, Ltv7;->j([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0}, Ltv7;->a(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    :cond_4
    invoke-virtual/range {p1 .. p1}, Lw58;->g()Landroid/graphics/Bitmap;
...
.method public f(Lw58;)Landroid/graphics/Bitmap;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/mlkit/common/MlKitException;
    ...
    invoke-static {p0, v0, v1, p1}, Ltv7;->k(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, v1, v2}, Ltv7;->j([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, Ltv7;->i(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0, v1, p1}, Ltv7;->m(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public h(Lw58;)Landroid/graphics/Bitmap;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/mlkit/common/MlKitException;
    ...
    invoke-static {v0, p0, v1, p1}, Ltv7;->m(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Ltv7;->f(Lw58;)Landroid/graphics/Bitmap;
...
.method public i(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1}, Ltv7;->b(Ljava/nio/ByteBuffer;)[B

    move-result-object p0

    invoke-static {p0, p2, p3}, Ltv7;->n([BII)[B
    ...
    invoke-static {p0, p4, p1, p2}, Ltv7;->m(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public j([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {v5 .. v10}, Ltv7;->o(Landroid/media/Image$Plane;II[BII)V
    ...
    invoke-static/range {v0 .. v5}, Ltv7;->o(Landroid/media/Image$Plane;II[BII)V
