...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Ljzc;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p2, p1}, Ljzc;->c(ILandroid/util/Size;)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Ljzc;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object p0, p0, Ljzc;->b:Landroid/graphics/Rect;
...
.method public final c(ILandroid/util/Size;)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Ljzc;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p2, v1, v0}, Lweh;->d(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Lk7i;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v6, Llzc;->d:Llzc;

    if-eq v3, v6, :cond_5

    sget-object v6, Llzc;->c:Llzc;

    if-eq v3, v6, :cond_5

    sget-object v6, Llzc;->e:Llzc;
    ...
    iget-object v0, p0, Ljzc;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p2, p1, v0, v1}, Lweh;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Ljzc;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Ljzc;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Ljzc;->c:I

    invoke-static {p2}, Lweh;->c(I)Z
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Ljzc;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Ljzc;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, p0, v1}, Lweh;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(ILandroid/util/Size;)Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, p1, p2}, Ljzc;->c(ILandroid/util/Size;)Landroid/graphics/Matrix;

    move-result-object p1

    new-instance p2, Landroid/graphics/RectF;

    iget-object v0, p0, Ljzc;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Ljzc;->b:Landroid/graphics/Rect;
