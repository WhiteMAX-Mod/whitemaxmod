...
.method public static c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, p0}, Lcr3;->t0(ILjava/util/List;)Ljava/util/List;
...
.method public final a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v7, v5}, Lilc;->i(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_4
    invoke-static {v8, v6, v7}, Lkj8;->f([B[[BI)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v11, v7, v10}, Lkj8;->f([B[[BI)Ljava/lang/String;
    ...
    :cond_a
    invoke-static {v9, v6, v7}, Lkj8;->f([B[[BI)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lakg;->y0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v8, v2}, Lakg;->y0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v11, v1}, Lakg;->y0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-direct {p1, p0, v4}, Llw;-><init>(Ljava/lang/Object;I)V

    invoke-static {p1, v0}, Lkye;->d0(Lbye;I)Lbye;

    move-result-object p0

    const-string p1, "."

    invoke-static {p0, p1}, Lkye;->j0(Lbye;Ljava/lang/String;)Ljava/lang/String;
...
.method public final b()V
    ...
    sget-object v2, Lbeb;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v2, v4, v0, v3}, Li30;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {v1, v2}, Ldh7;-><init>(Lptf;)V

    new-instance v0, Ljqd;

    invoke-direct {v0, v1}, Ljqd;-><init>(Lptf;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    invoke-virtual {v0}, Ljqd;->readInt()I

    move-result v1

    int-to-long v1, v1

    invoke-virtual {v0, v1, v2}, Ljqd;->c0(J)V

    iget-object v3, v0, Ljqd;->b:Lp01;

    invoke-virtual {v3, v1, v2}, Lp01;->X(J)[B
    ...
    invoke-virtual {v0, v2, v3}, Ljqd;->c0(J)V

    iget-object v4, v0, Ljqd;->b:Lp01;

    invoke-virtual {v4, v2, v3}, Lp01;->X(J)[B
    ...
    :try_start_3
    invoke-virtual {v0}, Ljqd;->close()V
