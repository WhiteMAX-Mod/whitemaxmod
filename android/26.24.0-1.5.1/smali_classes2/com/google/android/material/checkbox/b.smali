...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v4, v0}, Lbb3;->H(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object p1

    invoke-direct {p0, p1, p2, v4}, Lar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1}, Lkj;->a(ILandroid/content/Context;)Lkj;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/checkbox/b;->w:Lkj;

    new-instance p1, Lx06;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, Lx06;-><init>(Landroid/graphics/drawable/Drawable$Callback;I)V

    iput-object p1, p0, Lcom/google/android/material/checkbox/b;->x:Lx06;
    ...
    invoke-interface {p0, p1}, Lq6h;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v1, p2, v4, v5}, Lk57;->i(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    sget-object v3, Lukd;->s:[I
    ...
    invoke-static {v3, v1}, Lgwa;->m(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iput-object v2, p0, Lcom/google/android/material/checkbox/b;->m:Landroid/graphics/drawable/Drawable;

    iget-object v2, p0, Lcom/google/android/material/checkbox/b;->l:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    const v2, 0x7f0403a6

    invoke-static {v2, v1, v7}, Lgwa;->E(ILandroid/content/Context;Z)Z
    ...
    sget v4, Lcom/google/android/material/checkbox/b;->B:I

    if-ne v2, v4, :cond_1

    if-nez v3, :cond_1

    invoke-super {p0, p1}, Lar;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/material/checkbox/b;->n:Z
    ...
    invoke-static {v2, v1}, Lqj4;->x(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iput-object v2, p0, Lcom/google/android/material/checkbox/b;->p:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v1}, Lyj0;->K(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method private getMaterialThemeColorsTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1}, Lqgb;->r(Landroid/view/View;I)I

    move-result v1

    const v2, 0x7f040203

    invoke-static {p0, v2}, Lqgb;->r(Landroid/view/View;I)I

    move-result v2

    const v3, 0x7f0401ec

    invoke-static {p0, v3}, Lqgb;->r(Landroid/view/View;I)I

    move-result v3

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-static {v2, v4, v1}, Lqgb;->D(IFI)I

    move-result v1

    invoke-static {v2, v4, v0}, Lqgb;->D(IFI)I

    move-result v0

    const v4, 0x3f0a3d71    # 0.54f

    invoke-static {v2, v4, v3}, Lqgb;->D(IFI)I

    move-result v4

    const v5, 0x3ec28f5c    # 0.38f

    invoke-static {v2, v5, v3}, Lqgb;->D(IFI)I
...
.method private getSuperButtonTintList()Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-interface {p0}, Lq6h;->getSupportButtonTintList()Landroid/content/res/ColorStateList;
...
.method public final a()V
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/android/material/checkbox/b;->w:Lkj;

    if-eqz v0, :cond_f

    iget-object v2, v0, Lkj;->b:Lij;

    iget-object v4, v0, Lw3i;->a:Landroid/graphics/drawable/Drawable;

    iget-object v5, p0, Lcom/google/android/material/checkbox/b;->x:Lx06;

    if-eqz v4, :cond_6

    check-cast v4, Landroid/graphics/drawable/AnimatedVectorDrawable;

    iget-object v6, v5, Lxh;->a:Lwh;

    if-nez v6, :cond_5

    new-instance v6, Lwh;

    invoke-direct {v6, v5}, Lwh;-><init>(Lxh;)V

    iput-object v6, v5, Lxh;->a:Lwh;
    ...
    :cond_6
    iget-object v4, v0, Lkj;->e:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lkj;->d:Lq7;

    if-eqz v4, :cond_8

    iget-object v6, v2, Lij;->b:Landroid/animation/AnimatorSet;

    invoke-virtual {v6, v4}, Landroid/animation/Animator;->removeListener(Landroid/animation/Animator$AnimatorListener;)V

    iput-object v3, v0, Lkj;->d:Lq7;

    :cond_8
    :goto_2
    iget-object v3, v0, Lw3i;->a:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_a

    check-cast v3, Landroid/graphics/drawable/AnimatedVectorDrawable;

    iget-object v2, v5, Lxh;->a:Lwh;

    if-nez v2, :cond_9

    new-instance v2, Lwh;

    invoke-direct {v2, v5}, Lwh;-><init>(Lxh;)V

    iput-object v2, v5, Lxh;->a:Lwh;
    ...
    :cond_b
    iget-object v3, v0, Lkj;->e:Ljava/util/ArrayList;
    ...
    iput-object v3, v0, Lkj;->e:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Lkj;->d:Lq7;

    if-nez v3, :cond_e

    new-instance v3, Lq7;

    invoke-direct {v3, v0, v1}, Lq7;-><init>(Ljava/lang/Object;I)V

    iput-object v3, v0, Lkj;->d:Lq7;

    :cond_e
    iget-object v2, v2, Lij;->b:Landroid/animation/AnimatorSet;
    ...
    iget-object v2, p0, Lcom/google/android/material/checkbox/b;->o:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, p0, Lcom/google/android/material/checkbox/b;->p:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, p0, Lcom/google/android/material/checkbox/b;->m:Landroid/graphics/drawable/Drawable;
    ...
    :goto_8
    invoke-super {p0, v0}, Lar;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public final onCreateDrawableState(I)[I
    ...
    :goto_1
    iput-object v1, p0, Lcom/google/android/material/checkbox/b;->s:[I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {p0}, Lyj0;->E(Landroid/view/View;)Z
...
.method public setButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, Lq6h;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCheckedState(I)V
    ...
    iget-object p1, p0, Lcom/google/android/material/checkbox/b;->u:Ljava/lang/CharSequence;
    ...
    :cond_1
    iget-boolean p1, p0, Lcom/google/android/material/checkbox/b;->t:Z
    ...
    :cond_4
    :goto_1
    iget p1, p0, Lcom/google/android/material/checkbox/b;->r:I

    const/4 v1, 0x2

    if-eq p1, v1, :cond_5

    iget-object p1, p0, Lcom/google/android/material/checkbox/b;->v:Landroid/widget/CompoundButton$OnCheckedChangeListener;
