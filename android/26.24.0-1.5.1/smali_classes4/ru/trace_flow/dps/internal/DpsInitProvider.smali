...
.method public final onCreate()Z
    ...
    invoke-static {v3}, Lqgb;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v4}, Lul5$a;-><init>()V

    invoke-virtual {v4, v0}, Lul5$a;->t(Landroid/app/Application;)Lul5$a;

    move-result-object v4

    instance-of v5, v0, Len3;
    ...
    invoke-virtual {v4, v5}, Lul5$a;->w(Len3;)Lul5$a;

    :cond_6
    instance-of v5, v0, La0i;
    ...
    invoke-virtual {v4, v5}, Lul5$a;->L(La0i;)Lul5$a;

    :cond_7
    instance-of v5, v0, Lad5;

    if-eqz v5, :cond_8

    check-cast v0, Lad5;

    invoke-virtual {v4, v0}, Lul5$a;->y(Lad5;)Lul5$a;
    ...
    invoke-direct {v5, v0}, Lp25;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Lul5$a;->y(Lad5;)Lul5$a;

    :goto_2
    invoke-virtual {v4, v1}, Lul5$a;->r(Ljava/lang/String;)Lul5$a;

    move-result-object v0

    if-eqz v3, :cond_9

    invoke-virtual {v0, v3}, Lul5$a;->K(Ljava/lang/String;)Lul5$a;

    :cond_9
    if-eqz p0, :cond_a

    invoke-virtual {v0, p0}, Lul5$a;->u(Ljava/lang/String;)Lul5$a;

    :cond_a
    invoke-virtual {v0}, Lul5$a;->e()Lul5;
