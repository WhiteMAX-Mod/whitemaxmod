...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Luof;->y:Ljc9;

    new-instance v3, Lrof;

    invoke-direct {v3, p1, v2}, Lrof;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v0, p1, v4}, Lrof;-><init>(Landroid/content/Context;I)V

    invoke-static {v4, v0}, Lqj4;->L(ILv57;)Lon8;

    move-result-object p1

    iput-object p1, p0, Luof;->F:Lon8;

    return-void
.end method

.method public static final M(Luof;Lx40;)V
    .locals 8

    iget-object v0, p0, Luof;->y:Ljc9;
    ...
    :cond_7
    :goto_4
    invoke-direct {p0}, Luof;->getTransferStatusView()La6i;
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v4, v0, Luof;->A:Llmb;

    if-ne v2, v4, :cond_0

    iget-boolean v5, v0, Luof;->C:Z
    ...
    :cond_0
    iget-object v5, v0, Luof;->y:Ljc9;

    if-eq v2, v5, :cond_2

    if-eq v2, v4, :cond_2

    iget-object v4, v0, Luof;->x:Ly7i;
...
.method public final k(Lkc9;)V
    ...
    iget-object v1, p0, Luof;->y:Ljc9;

    invoke-virtual {v1, v0}, Lkv7;->setImageAttach(Lzu7;)V

    iget-object v1, p0, Luof;->A:Llmb;

    invoke-direct {p0}, Luof;->getBlurPostProcessor()Lzw0;
    ...
    invoke-direct {p0}, Luof;->getMediaType()Lyt9;
