...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Llq1;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Luab;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Luab;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    new-instance p1, Lrab;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lrab;-><init>(Luab;I)V

    new-instance p2, Letg;

    invoke-direct {p2, p1}, Letg;-><init>(Lv57;)V

    iput-object p2, p0, Luab;->c:Letg;
    ...
    iput-object v0, p0, Luab;->d:Letg;

    iget-object p1, p3, Llq1;->r:Lgy7;

    iget-boolean p1, p1, Lgy7;->x:Z

    iput-boolean p1, p0, Luab;->e:Z

    iput-boolean p2, p0, Luab;->f:Z
...
# virtual methods
.method public final a(Lorg/webrtc/VideoCodecInfo;)Lyg;
    .locals 5
    ...
    :cond_1
    iget-boolean v1, p0, Luab;->f:Z

    if-nez v1, :cond_2

    iget-object v1, p0, Luab;->d:Letg;
    ...
    invoke-direct {v0, v1, p1, p0}, Lyg;-><init>(Lorg/webrtc/VideoDecoder;Lorg/webrtc/VideoCodecInfo;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V

    return-object v0

    :cond_2
    :try_start_0
    iget-object v1, p0, Luab;->c:Letg;
    ...
    iget-object v2, p0, Luab;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
...
.method public final createDecoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoDecoder;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Luab;->a(Lorg/webrtc/VideoCodecInfo;)Lyg;
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    :try_start_0
    invoke-virtual {p0}, Luab;->b()[Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-interface {p0, v1, v2, v0}, Ljld;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
