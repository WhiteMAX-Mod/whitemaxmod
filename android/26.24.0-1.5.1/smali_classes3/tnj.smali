...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Ltnj;->b:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Ltnj;->c:Ljava/util/ArrayList;
...
.method public abstract d(Lfkj;Lpab;)I
.end method
...
.method public final g(Ljava/nio/ByteBuffer;BILghj;J)V
    .locals 24
    ...
    invoke-virtual {v4, v8}, Lghj;->f([B)[B
    ...
    :goto_1
    invoke-virtual {v0, v2}, Ltnj;->l(B)V
    ...
    iget-short v6, v6, Lvnj;->g:S

    iget v13, v4, Lghj;->m:I

    rem-int/2addr v13, v10

    if-eq v13, v6, :cond_6

    iget-object v6, v4, Lghj;->e:[B

    if-nez v6, :cond_5

    invoke-virtual {v4, v9}, Lghj;->a(Z)V

    :cond_5
    iput-boolean v8, v4, Lghj;->n:Z

    :cond_6
    iget-boolean v6, v4, Lghj;->n:Z

    if-eqz v6, :cond_7

    iget-object v6, v4, Lghj;->g:[B

    goto :goto_5

    :cond_7
    iget-object v6, v4, Lghj;->f:[B
    ...
    :try_start_0
    invoke-virtual {v4}, Lghj;->k()Ljavax/crypto/Cipher;
    ...
    invoke-virtual {v4}, Lghj;->j()Ljavax/crypto/spec/SecretKeySpec;
    ...
    invoke-virtual {v4}, Lghj;->l()Ljavax/crypto/spec/SecretKeySpec;

    move-result-object v3

    invoke-virtual {v4}, Lghj;->m()Ljavax/crypto/Cipher;
    ...
    iput-object v3, v0, Ltnj;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4, v1}, Lzkj;->m(Ljava/nio/ByteBuffer;)V
    ...
    :cond_c
    :goto_b
    invoke-static {v1}, Lunl;->h(Ljava/nio/ByteBuffer;)J

    move-result-wide v13

    iput-wide v13, v4, Lmhj;->a:J
    ...
    iput-wide v13, v4, Lmhj;->b:J

    :cond_d
    invoke-static {v1}, Lunl;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {v1}, Lukj;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-virtual {v4, v1}, Lokj;->m(Ljava/nio/ByteBuffer;)V
    ...
    :goto_d
    iput-boolean v5, v4, Lblj;->a:Z

    invoke-static {v1}, Lunl;->h(Ljava/nio/ByteBuffer;)J

    move-result-wide v13

    iput-wide v13, v4, Lblj;->b:J
    ...
    invoke-direct {v4, v10}, Lrhj;-><init>(I)V

    invoke-virtual {v4, v1}, Lrhj;->q(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v9}, Lohj;-><init>(I)V
    ...
    :goto_f
    iput-boolean v5, v4, Lshj;->b:Z

    invoke-static {v1}, Lunl;->h(Ljava/nio/ByteBuffer;)J

    move-result-wide v13

    iput-wide v13, v4, Lshj;->a:J
    ...
    invoke-direct {v4, v9}, Lrhj;-><init>(I)V

    invoke-virtual {v4, v1}, Lrhj;->m(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v5}, Lohj;-><init>(I)V
    ...
    invoke-virtual {v4, v1}, Lnhj;->m(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v5}, Lrhj;-><init>(I)V

    invoke-virtual {v4, v1}, Lrhj;->p(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v4, v1}, Lxkj;->m(Ljava/nio/ByteBuffer;)V
    ...
    iput v12, v4, Llhj;->e:I

    iput-object v6, v4, Llhj;->f:Ljava/lang/String;

    invoke-virtual {v4, v1}, Llhj;->p(Ljava/nio/ByteBuffer;)V
    ...
    :cond_1a
    invoke-virtual {v0, v2}, Ltnj;->e(B)V
...
.method public final h(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lghj;)V
    .locals 11
    ...
    iget-wide v4, p0, Ltnj;->b:J

    iget-boolean p3, p4, Lghj;->n:Z

    if-eqz p3, :cond_0

    iget-object p3, p4, Lghj;->g:[B

    goto :goto_0

    :cond_0
    iget-object p3, p4, Lghj;->f:[B
    ...
    :try_start_0
    invoke-virtual {p4}, Lghj;->k()Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p4}, Lghj;->j()Ljavax/crypto/spec/SecretKeySpec;
    ...
    :pswitch_0
    invoke-virtual {p4}, Lghj;->m()Ljavax/crypto/Cipher;

    move-result-object p3

    invoke-virtual {p4}, Lghj;->l()Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-wide p2, p0, Ltnj;->b:J

    invoke-static {p2, p3}, Ltnj;->m(J)[B
    ...
    invoke-virtual {p4, v1}, Lghj;->f([B)[B
...
.method public abstract i(Ljava/nio/ByteBuffer;Lghj;JLsk8;I)V
.end method

.method public abstract j(Lghj;)[B
.end method
...
.method public final k(I)Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Ltnj;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v0, v3}, Lxc8;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-direct {v1, v2}, Lqkj;-><init>(I)V

    iget-object p0, p0, Ltnj;->c:Ljava/util/ArrayList;

    invoke-virtual {p0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, v0}, Lqkj;->e(Ljava/nio/ByteBuffer;)V
...
.method public abstract n()Ldhj;
.end method

.method public abstract o()Lfhj;
.end method

.method public p()Ljava/lang/Long;
    .locals 4

    iget-wide v0, p0, Ltnj;->b:J
