...
.method static constructor <clinit>()V
    ...
    invoke-direct {v4, v2, v3}, Leo6;-><init>(J)V

    const/high16 v2, 0x44610000    # 900.0f

    invoke-static {v2, v1}, Leo6;->a(FF)J

    move-result-wide v5

    new-instance v3, Leo6;

    invoke-direct {v3, v5, v6}, Leo6;-><init>(J)V
    ...
    invoke-direct {v8, v6, v7}, Leo6;-><init>(J)V

    const v6, 0x44dac000    # 1750.0f

    invoke-static {v6, v1}, Leo6;->a(FF)J

    move-result-wide v9

    new-instance v7, Leo6;

    invoke-direct {v7, v9, v10}, Leo6;-><init>(J)V

    const/high16 v9, 0x44fa0000    # 2000.0f

    invoke-static {v9, v1}, Leo6;->a(FF)J

    move-result-wide v10

    new-instance v12, Leo6;

    invoke-direct {v12, v10, v11}, Leo6;-><init>(J)V

    filled-new-array {v4, v3, v8, v7, v12}, [Leo6;
    ...
    sput-object v3, Lcei;->a:Ljava/util/List;

    new-instance v3, Liv;

    const v4, 0x3ba3d70a    # 0.005f

    invoke-direct {v3, v0, v0, v4, v0}, Liv;-><init>(FFFF)V
    ...
    invoke-direct {v4, v2, v0, v7, v8}, Liv;-><init>(FFFF)V
    ...
    invoke-direct {v0, v5, v8, v2, v7}, Liv;-><init>(FFFF)V
    ...
    invoke-direct {v2, v6, v8, v5, v7}, Liv;-><init>(FFFF)V
    ...
    invoke-direct {v5, v9, v6, v1, v7}, Liv;-><init>(FFFF)V

    filled-new-array {v3, v4, v0, v2, v5}, [Liv;
    ...
    sput-object v0, Lcei;->b:Ljava/util/List;
