...
# static fields
.field public static final j:[Ldhi;
...
.method static constructor <clinit>()V
    ...
    filled-new-array {v0, v1}, [Ldhi;

    move-result-object v0

    sput-object v0, Lx55;->j:[Ldhi;
...
.method public constructor <init>(Lfde;Ljld;Lk8c;Lcia;)V
    ...
    iput-object p1, p0, Lx55;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lx55;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lx55;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lx55;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lmq1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object p0, p0, Lx55;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1, p2}, Lhgi;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, p0, v2}, Lra4;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p0, v1, v2}, Luuj;-><init>(Ly8c;Lua4;I)V
...
.method public final e(Lmq1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lidc;-><init>(I)V

    iput-object v1, v2, Lidc;->c:Ljava/lang/Object;

    iput-object p1, v2, Lidc;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lidc;->F()Ld22;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lx55;->n(Ljava/lang/String;Ld22;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Lx55;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lhgi;->a:Lorg/webrtc/VideoSink;
...
.method public final j(Lorg/webrtc/RtpReceiver;[Lorg/webrtc/MediaStream;)V
    ...
    invoke-direct {p1, p0, v1, v2}, Luuj;-><init>(Ly8c;Lua4;I)V
...
.method public final n(Ljava/lang/String;Ld22;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lv55;-><init>(Lx55;Ljava/lang/String;Ld22;Ljava/util/List;)V
...
.method public final p(Ljava/lang/String;Ld22;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lx55;->g:Ljava/util/HashMap;
    ...
    iput-object v4, v1, Lhgi;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Lx55;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lx55;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lx55;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Lx55;->i:Ljava/util/concurrent/ConcurrentHashMap;
