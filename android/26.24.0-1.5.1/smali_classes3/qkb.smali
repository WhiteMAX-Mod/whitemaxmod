...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1, p0, v3}, Lnkb;-><init>(Landroid/content/Context;Lqkb;I)V

    invoke-static {v2, v1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v1

    iput-object v1, p0, Lqkb;->v:Lon8;

    new-instance v1, Lnkb;

    const/4 v4, 0x1

    invoke-direct {v1, p1, p0, v4}, Lnkb;-><init>(Landroid/content/Context;Lqkb;I)V

    invoke-static {v2, v1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v1

    iput-object v1, p0, Lqkb;->w:Lon8;
    ...
    iput-object v1, p0, Lqkb;->x:Lon8;

    new-instance v1, Lnkb;

    const/4 v5, 0x2

    invoke-direct {v1, p1, p0, v5}, Lnkb;-><init>(Landroid/content/Context;Lqkb;I)V

    invoke-static {v2, v1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v1

    iput-object v1, p0, Lqkb;->y:Lon8;
    ...
    iput-object v1, p0, Lqkb;->z:Landroid/graphics/drawable/LayerDrawable;

    new-instance v1, Lnkb;

    invoke-direct {v1, p1, p0, v2}, Lnkb;-><init>(Landroid/content/Context;Lqkb;I)V

    invoke-static {v2, v1}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v1

    iput-object v1, p0, Lqkb;->A:Lon8;
    ...
    iput-object v1, p0, Lqkb;->B:Landroid/view/View;
    ...
    invoke-direct {v6, v3, v7}, Lt94;-><init>(II)V
    ...
    invoke-virtual {v5, v3}, Lpt7;->setInitialRadius$common(F)V

    iput-object v5, p0, Lqkb;->C:Lpt7;
    ...
    iput-object v3, p0, Lqkb;->D:Landroid/graphics/drawable/GradientDrawable;

    new-instance v6, Lokb;

    invoke-direct {v6, p1, v4}, Lokb;-><init>(Landroid/content/Context;I)V

    invoke-static {v2, v6}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v6

    iput-object v6, p0, Lqkb;->E:Lon8;

    new-instance v6, Lnkb;

    invoke-direct {v6, p0, p1}, Lnkb;-><init>(Lqkb;Landroid/content/Context;)V

    invoke-static {v2, v6}, Lqj4;->L(ILv57;)Lon8;

    move-result-object v2

    iput-object v2, p0, Lqkb;->F:Lon8;

    sget-object v2, Lpkb;->a:Lpkb;

    iput-object v2, p0, Lqkb;->G:Lpkb;
    ...
    :goto_0
    invoke-virtual {p0, v2}, Lqkb;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, p1}, Lqkb;->onThemeChanged(Ljvb;)V
...
.method public static u(Lqkb;Landroid/content/Context;)Landroid/widget/ImageView;
    .locals 4
    ...
    invoke-direct {p0}, Lqkb;->getCloseBadgeDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, Lqkb;->getChevronDrawable()Landroid/graphics/drawable/Drawable;
...
.method public final setChevronAppearance(Lpkb;)V
    .locals 0

    iput-object p1, p0, Lqkb;->G:Lpkb;
...
.method public final v(Landroid/graphics/drawable/Drawable;II)V
    ...
    iget-object p2, p0, Lqkb;->C:Lpt7;

    invoke-virtual {p2, p1}, Lpt7;->setIcon$common(Landroid/graphics/drawable/Drawable;)V

    const/4 p1, 0x0

    invoke-static {p0, v0, p1}, Lqhf;->d(Landroid/view/ViewGroup;Landroid/view/View;Ljava/lang/Integer;)V

    invoke-static {p0, v2, p1}, Lqhf;->d(Landroid/view/ViewGroup;Landroid/view/View;Ljava/lang/Integer;)V
...
.method public final w()V
    ...
    iget-object v4, p0, Lqkb;->w:Lon8;

    const/4 v5, -0x1

    iget-object v6, p0, Lqkb;->A:Lon8;
...
.method public final x()V
    ...
    iget-object p0, p0, Lqkb;->B:Landroid/view/View;
