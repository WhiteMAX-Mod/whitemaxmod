...
.method public final b(I)I
    ...
    invoke-static {v0, v1}, Ltnj;->c(J)I
    ...
    iget-object v2, p0, Ltnj;->e:[B

    array-length v2, v2

    add-int/lit8 v2, v2, 0x1

    iget-wide v3, p0, Ltnj;->b:J
...
.method public final d(Lfkj;Lpab;)I
    ...
    iget-object v2, v0, Liij;->d:Lbhj;

    iget-object v3, v2, Lvgj;->b:[B
    ...
    iget-object v3, v2, Lvgj;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v6, v2, v5}, Lzgj;-><init>(Lbhj;I)V
    ...
    invoke-direct {v6, v5}, Lahj;-><init>(I)V

    invoke-interface {v3, v6}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    iput-object v1, v2, Lvgj;->b:[B

    iget-object v1, v2, Lvgj;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v3, v2, v4}, Lzgj;-><init>(Lbhj;I)V
    ...
    invoke-direct {v3, v5}, Lqt4;-><init>(I)V
    ...
    invoke-direct {v3, v2, v6}, Lzgj;-><init>(Lbhj;I)V
    ...
    iget-object v1, v0, Liij;->d:Lbhj;

    invoke-virtual {v1}, Lvgj;->b()Ljava/util/List;
...
.method public final i(Ljava/nio/ByteBuffer;Lghj;JLsk8;I)V
    ...
    :try_start_1
    invoke-virtual/range {v1 .. v7}, Ltnj;->g(Ljava/nio/ByteBuffer;BILghj;J)V

    invoke-virtual {v5}, Lghj;->e()V
    :try_end_1
    ...
    :try_start_3
    iget-boolean p1, v5, Lghj;->n:Z

    if-eqz p1, :cond_0

    const/4 p1, 0x0

    iput-object p1, v5, Lghj;->c:[B

    const/4 p2, 0x0

    iput-boolean p2, v5, Lghj;->n:Z

    iput-object p1, v5, Lghj;->e:[B

    iput-object p1, v5, Lghj;->g:[B
    :try_end_3
...
.method public final j(Lghj;)[B
    ...
    invoke-static {v2, v3, v1}, Ltnj;->a(JB)B
    ...
    invoke-static {v1, v2}, Ltnj;->m(J)[B
    ...
    invoke-virtual {p0, v2}, Ltnj;->k(I)Ljava/nio/ByteBuffer;

    move-result-object v2

    array-length v1, v1

    invoke-virtual {p0, v0, v1, v2, p1}, Ltnj;->h(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lghj;)V
...
.method public final toString()Ljava/lang/String;
    ...
    :goto_1
    iget-short v3, p0, Lvnj;->g:S

    iget-object v4, p0, Ltnj;->e:[B
    ...
    iget-object v6, p0, Ltnj;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v7, v8}, Lqnj;-><init>(I)V
    ...
    invoke-static {v5, v6, v0, v0, v7}, Lqh5;->C(IILjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v0, "  "

    invoke-static {v7, v0, p0}, Lqh5;->w(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
