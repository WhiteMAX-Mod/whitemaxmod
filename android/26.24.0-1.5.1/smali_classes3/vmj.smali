...
# direct methods
.method public constructor <init>(ILfkj;Lenj;Lsmj;Lsk8;)V
    .locals 2
    ...
    iput-object p2, p0, Lvmj;->b:Lfkj;

    iput-object p3, p0, Lvmj;->c:Lenj;

    iput-object p5, p0, Lvmj;->d:Lsk8;
    ...
    iget-object p3, p3, Lenj;->f:Laij;

    invoke-interface {p3}, Laij;->h()J
    ...
    invoke-interface {p3}, Laij;->g()J

    move-result-wide v0

    :goto_2
    invoke-direct {p2, p0, v0, v1, p5}, Lbnj;-><init>(Lvmj;JLsk8;)V
    ...
    iget-object p2, p0, Lvmj;->d:Lsk8;

    invoke-direct {p1, p0, p4, p2}, Ljnj;-><init>(Lvmj;Lsmj;Lsk8;)V
...
.method public final a(Lzkj;)J
    ...
    invoke-virtual {p0, p1}, Lt24;->b(Lzkj;)J
...
.method public final b(I)V
    ...
    iget-object p0, p0, Lvmj;->c:Lenj;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    :try_start_0
    iget-object v0, p0, Lenj;->t:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-wide v1, p0, Lenj;->p:J

    const/4 v3, 0x1

    invoke-direct {v0, v3}, Lohj;-><init>(I)V

    iput-wide v1, v0, Lohj;->b:J
    ...
    invoke-virtual {p1, v0, v1, v3}, Lfkj;->g(Lukj;Ljava/util/function/Consumer;Z)V
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, Lenj;->t:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final e()V
    ...
    :cond_1
    iget-object v0, p0, Lvmj;->c:Lenj;

    iget v1, p0, Lvmj;->a:I

    invoke-virtual {v0, v1}, Lenj;->g(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    iget-object p0, p0, Lvmj;->i:Ljava/util/concurrent/locks/ReentrantLock;
