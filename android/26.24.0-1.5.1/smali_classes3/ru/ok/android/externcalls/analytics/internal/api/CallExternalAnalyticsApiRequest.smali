...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "logger",
        "<init>",
        "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lzz0;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;)V",
        "Lqk8;",
        "writer",
        "Lroh;",
        "writeParams",
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lzz0;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;)V
    .locals 0

    invoke-direct {p0, p1, p5, p6}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;-><init>(Ljava/lang/String;Lzz0;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;)V
...
.method public writeParams(Lqk8;)V
    ...
    invoke-static/range {v0 .. v6}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString$default(Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;Lqk8;Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)V

    const-string p0, "data"

    invoke-interface {v1, p0}, Lqk8;->b0(Ljava/lang/String;)Lqk8;

    invoke-interface {v1}, Lqk8;->r()V
    ...
    :try_start_1
    invoke-static/range {v7 .. v13}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString$default(Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;Lqk8;Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)V
    :try_end_1
    ...
    invoke-virtual {v0, v1, p0, p1, v2}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lqk8;Ljava/lang/String;Ljava/lang/String;Z)V

    const-string p0, "items"

    invoke-interface {v1, p0}, Lqk8;->b0(Ljava/lang/String;)Lqk8;

    invoke-virtual {v0}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->getItems()Lzz0;

    move-result-object p0

    invoke-virtual {p0, v1}, Lzz0;->write(Lqk8;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    invoke-interface {v1}, Lqk8;->v()V
