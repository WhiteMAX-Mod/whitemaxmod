...
.method private final getPosition(Ljava/lang/Long;)Lhna;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lfna;-><init>(J)V

    return-object p0

    :cond_1
    :goto_0
    sget-object p0, Lgna;->a:Lgna;
...
.method private final updateState(Lnna;)V
    .locals 12
    ...
    iget-object p1, p1, Lnna;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lmna;->a:Ld22;

    iget-object v3, v3, Ld22;->b:Lmq1;
    ...
    iget-object v11, v3, Ld22;->c:Lena;
    ...
    sget-object v5, Lkna;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lbna;->d:Ljna;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lbna;->a:Lena;

    invoke-virtual {v8, v11}, Lena;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lmna;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lhna;

    move-result-object v5

    iget-boolean v2, v1, Lmna;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lmna;->b:F

    invoke-static {v7}, Lrna;->a(F)V

    iget-boolean v8, v1, Lmna;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhna;ZFZLbna;Lf25;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Ln3f;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ln3f;Lbna;)V
...
.method public final onVideoStarted(Llna;)V
    .locals 12
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lhna;ZFZLbna;Lf25;)V
    ...
    iget-object p1, p1, Llna;->b:Ln3f;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ln3f;Lbna;)V
...
.method public final onVideoStatesUpdatedChanged(Lnna;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lnna;)V
...
.method public final onVideoStopped(Lona;)V
    .locals 4
    ...
    iget-object v2, p1, Lona;->b:Ln3f;

    iget-object v3, p1, Lona;->c:Lena;

    iget-object p1, p1, Lona;->d:Ljna;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ln3f;Lena;Ljna;)V
