...
.field private final getConfigDisposable:Lxg5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Lo5j;Ljld;Ll5h;Lv57;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Ljld;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ll5h;

    iput-object p4, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getEventualStatSender:Lv57;
    ...
    invoke-interface {p1}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Leb9;
    ...
    invoke-direct {v0, p0, v1}, Lr33;-><init>(Ljava/lang/Object;I)V

    new-instance v1, Lfb9;

    invoke-direct {v1, p3, p4, v0}, Lfb9;-><init>(Lta4;Lta4;Ll7;)V
    ...
    invoke-direct {p3, v1, p2, p4}, Llb9;-><init>(Ljava/lang/Object;Lvje;I)V

    invoke-virtual {p1, p3}, Leb9;->b(Lnb9;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getConfigDisposable:Lxg5;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;)Ljld;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Ljld;

    return-object p0
.end method

.method public static final synthetic access$getTimeProvider$p(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;)Ll5h;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ll5h;

    return-object p0
.end method

.method public static final synthetic access$maybeInitWebRTCStat(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;Ln5j;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->maybeInitWebRTCStat(Ln5j;)V
...
.method private final maybeInitWebRTCStat(Ln5j;)V
    .locals 1
    ...
    iget-object p1, p1, Ln5j;->a:Ljava/util/Set;
...
.method private final onIceCandidateGenerated(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ll5h;
...
.method private final parseIceCandidateSdp(Ljava/lang/String;)Lkla;
    .locals 5
    ...
    :try_start_0
    invoke-static {p1}, Lkla;->a(Ljava/lang/String;)Lkla;

    move-result-object v4

    if-nez v4, :cond_0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Ljld;
    ...
    invoke-interface {v1, v0, p1}, Ljld;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v2, v4, Lkla;->b:Ljava/lang/String;

    if-nez v2, :cond_1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Ljld;
    ...
    invoke-interface {v2, v0, p1}, Ljld;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p0, v0, p1, v1}, Ljld;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final send(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat$Event;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getEventualStatSender:Lv57;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat$Event;->getTs()Li6h;
    ...
    invoke-virtual {v0, v4, v3, v5, v6}, Lcf1;->d(Li6h;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    :cond_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Ljld;
...
.method public final onAnswerReceived()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ll5h;
...
.method public final onIceCandidateGenerated(Ljava/lang/String;)V
    ...
    .line 35
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->parseIceCandidateSdp(Ljava/lang/String;)Lkla;
    ...
    .line 36
    iget-object v0, p1, Lkla;->b:Ljava/lang/String;

    iget-object v1, p1, Lkla;->a:Ljava/lang/String;

    iget-object p1, p1, Lkla;->c:Ljava/lang/String;
...
.method public final release()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getConfigDisposable:Lxg5;
