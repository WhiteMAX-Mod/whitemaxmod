...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lroh;",
        "init",
        "(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Lkdb;Lv57;)V",
        "calls-sdk_release"
    }
    k = 0x1
    mv = {
...
.method public static synthetic a(Ll81;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$6(Lv57;)Ljava/lang/Boolean;
...
.method public static synthetic b(Ll81;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$8(Lv57;)Ljava/lang/Boolean;
...
.method public static synthetic c(Ll81;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$7(Lv57;)Ljava/lang/Boolean;
...
.method public static synthetic d(Ll81;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$2(Lv57;)Ljava/lang/Integer;
...
.method public static synthetic e(Ll81;)Ljava/lang/Long;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$5(Lv57;)Ljava/lang/Long;
...
.method public static synthetic f(Ll81;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$4(Lv57;)Ljava/lang/Integer;
...
.method public static synthetic g(Ll81;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$3(Lv57;)Ljava/lang/Integer;
...
.method public static synthetic h(Ll81;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init$lambda$9(Lv57;)Ljava/lang/Boolean;
...
.method private static final init$lambda$2(Lv57;)Ljava/lang/Integer;
    .locals 0
...
.method private static final init$lambda$3(Lv57;)Ljava/lang/Integer;
    .locals 0
...
.method private static final init$lambda$4(Lv57;)Ljava/lang/Integer;
    .locals 0
...
.method private static final init$lambda$5(Lv57;)Ljava/lang/Long;
    .locals 0
...
.method private static final init$lambda$6(Lv57;)Ljava/lang/Boolean;
    .locals 0
...
.method private static final init$lambda$7(Lv57;)Ljava/lang/Boolean;
    .locals 0
...
.method private static final init$lambda$8(Lv57;)Ljava/lang/Boolean;
    .locals 0
...
.method private static final init$lambda$9(Lv57;)Ljava/lang/Boolean;
    .locals 0
...
# virtual methods
.method public final init(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Lkdb;Lv57;)V
    .locals 24
    ...
    invoke-direct {v1, v0, v2}, Ll81;-><init>(Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;I)V
    ...
    invoke-direct {v5, v0, v6}, Ll81;-><init>(Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;I)V

    invoke-direct {v4, v5}, Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;-><init>(Lv57;)V

    new-instance v0, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsLoggerImpl;

    move-object/from16 v5, p4

    invoke-direct {v0, v5}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsLoggerImpl;-><init>(Lv57;)V

    new-instance v7, Lru/ok/android/externcalls/analytics/config/UploadConfig;

    new-instance v14, Lm81;

    invoke-direct {v14, v1, v2}, Lm81;-><init>(Ll81;I)V

    new-instance v15, Lm81;

    invoke-direct {v15, v1, v6}, Lm81;-><init>(Ll81;I)V

    new-instance v2, Lm81;

    const/4 v5, 0x2

    invoke-direct {v2, v1, v5}, Lm81;-><init>(Ll81;I)V

    new-instance v5, Lm81;

    const/4 v6, 0x3

    invoke-direct {v5, v1, v6}, Lm81;-><init>(Ll81;I)V

    new-instance v6, Lm81;

    const/4 v8, 0x4

    invoke-direct {v6, v1, v8}, Lm81;-><init>(Ll81;I)V

    new-instance v8, Lm81;

    const/4 v9, 0x5

    invoke-direct {v8, v1, v9}, Lm81;-><init>(Ll81;I)V

    new-instance v9, Lm81;

    const/4 v10, 0x6

    invoke-direct {v9, v1, v10}, Lm81;-><init>(Ll81;I)V

    new-instance v10, Lm81;

    const/4 v11, 0x7

    invoke-direct {v10, v1, v11}, Lm81;-><init>(Ll81;I)V
    ...
    invoke-direct/range {v7 .. v23}, Lru/ok/android/externcalls/analytics/config/UploadConfig;-><init>(ILjava/util/concurrent/Executor;JJLv57;Lv57;Lv57;Lv57;Lv57;Lv57;Lv57;Lv57;ILf25;)V

    move-object/from16 v1, p3

    invoke-direct {v3, v1, v4, v0, v7}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;-><init>(Lkdb;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
