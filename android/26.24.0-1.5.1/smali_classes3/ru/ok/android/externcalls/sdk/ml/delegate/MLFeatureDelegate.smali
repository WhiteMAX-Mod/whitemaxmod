...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "downloadModel",
        "(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldof;",
        "stage",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Lm69;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Ljld;Landroid/content/Context;Lru/ok/android/externcalls/sdk/ml/model/ModelSpec;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lm69;
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Ljld;
...
.method public static final synthetic access$downloadModel(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldof;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldof;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;)Ljld;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Ljld;
...
.method private final clearDir()V
    ...
    invoke-static {v3, v4}, Lmfl;->b(Ljava/io/File;Lx57;)V
...
.method private final downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldof;
    .locals 5
    ...
    sget-object v4, Ldj7;->b:Ldj7;

    invoke-direct {v3, p1, v4}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;-><init>(Ljava/lang/String;Ldj7;)V

    invoke-interface {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/net/DownloadService;->download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ldof;
    ...
    iget-object p1, p1, Lrr6;->a:Lnr6;

    invoke-direct {p0, p1}, Lpr6;-><init>(Lnr6;)V
    ...
    invoke-direct {p0, p1}, Lkqf;-><init>(Ldof;)V

    :goto_0
    new-instance p1, Lnr6;

    invoke-direct {p1, p0, v1}, Lnr6;-><init>(Lir6;Lbt0;)V

    new-instance p0, Lrr6;

    invoke-direct {p0, p1}, Lrr6;-><init>(Lnr6;)V
...
.method private final fetchConfig()Leb9;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Leb9;
...
.method private final removeCurrentModel()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lm69;
...
.method private final renameFiles(Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;)Lru/ok/android/externcalls/sdk/ml/stage/RenameStage;
    ...
    invoke-static {v12, v9, v5}, Likg;->T(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v2, v3}, Lmfl;->b(Ljava/io/File;Lx57;)V
    ...
    invoke-static {v1, v0}, Le17;->j(Ljava/lang/Object;Ljava/lang/String;)V
...
.method private final saveNewModelInfo(Lru/ok/android/externcalls/sdk/ml/stage/RenameStage;)Lru/ok/android/externcalls/sdk/ml/stage/SaveNewModelInfoStage;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lm69;
    ...
    invoke-virtual {v1, p0, v0}, Lor;->c0(Ljava/lang/String;Ljava/io/Serializable;)V
...
.method private final unzipModel(Lru/ok/android/externcalls/sdk/ml/stage/DownloadStage;)Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;
    ...
    invoke-static {v0, v1}, Ljl6;->i(Ljava/io/File;Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v0}, Lmfl;->b(Ljava/io/File;Lx57;)V
    ...
    invoke-static {p1, v1}, Lmfl;->b(Ljava/io/File;Lx57;)V
...
.method private final validateCurrentModel()Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$MLModelValidationResult;
    ...
    invoke-virtual {v0, v1}, Lor;->L(Ljava/lang/String;)Ljava/io/Serializable;
...
# virtual methods
.method public final checkModel()Ldof;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->fetchConfig()Leb9;
    ...
    invoke-direct {v3, v0, v1, v4}, Lmb9;-><init>(Leb9;Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, v3, v0, v2}, Lmb9;-><init>(Leb9;Ljava/lang/Object;I)V
    ...
    invoke-direct {p0, v1, v0, v2}, Ljb9;-><init>(Ljava/lang/Object;Ln67;I)V
...
.method public isModelValid(Ljava/io/File;)Z
    ...
    invoke-static {v2}, Lml6;->R(Ljava/io/File;)Ljava/lang/String;
