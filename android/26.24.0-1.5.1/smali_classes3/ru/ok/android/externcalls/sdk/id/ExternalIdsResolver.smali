...
.method private applyExternals(Ljava/util/Map;)V
    ...
    invoke-virtual {v3, v0, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmq1;)V
...
.method private collectExternalIdResolutionCandidatesForSessionRoom(Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->getInternalIdExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lmq1;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmq1;)V
...
.method public resolveIds(Ljava/util/List;Lru/ok/android/externcalls/sdk/id/mapping/MappingContext;)Ln04;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p0, p1, p2}, Llo;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, Lq04;

    const/4 p1, 0x0

    invoke-direct {p0, v0, p1}, Lq04;-><init>(Ljava/lang/Object;I)V

    invoke-static {}, Leke;->b()Lvje;

    move-result-object p1

    invoke-virtual {p0, p1}, Ln04;->c(Lvje;)Lu04;
