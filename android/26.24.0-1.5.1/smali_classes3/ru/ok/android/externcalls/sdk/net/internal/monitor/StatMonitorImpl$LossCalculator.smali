...
# instance fields
.field private final lossCalc:Lo59;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lo59;
...
.method private final calculateLoss(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lo59;
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lo59;->a(JJ)D
    ...
    invoke-static {p1, p2, v0}, Ltm8;->r(FFF)F
...
.method private final synthetic findSender(Ljava/util/List;)Lgwf;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ljld;
    ...
    iget-object v0, v0, Lgwf;->n:Ljava/lang/Boolean;
...
.method public final synthetic getLoss(Ljava/util/List;)Ljava/lang/Float;
    ...
    iget-object v1, v1, Lgwf;->n:Ljava/lang/Boolean;
    ...
    iget-object p1, v0, Lgwf;->i:Ljava/math/BigInteger;

    iget-object v0, v0, Lgwf;->h:Ljava/math/BigInteger;
