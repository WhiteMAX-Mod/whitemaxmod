...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "handler",
        "handleAsync",
        "(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Ll67;)V",
        "message",
        "send",
        "(Ljava/lang/String;)V",
        "",
...
# instance fields
.field private final client:Lgqj;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$Companion;-><init>(Lf25;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lone/video/calls/sdk/net/signaling/wt/nal/NALLog;Lgqj;Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket$CompressorDecompressor;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0
    ...
    iput-object p4, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->client:Lgqj;
    ...
    invoke-direct {p0, p2, p3, p6, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Ll67;)V

    return-void
.end method

.method public static synthetic a(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;)V
    .locals 0

    invoke-static {p0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession$lambda$5(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;)V
...
.method public static final synthetic access$sendStreamData(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->sendStreamData(Ltpj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    return-void
.end method

.method public static synthetic b(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Ll67;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync$lambda$7(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Ll67;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    return-void
.end method

.method public static synthetic c(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;)V
    .locals 0

    invoke-static {p0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession$lambda$4(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;)V

    return-void
.end method

.method private final configureSession(Lspj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 2
    ...
    invoke-direct {v0, v1, p0, p2}, Lir2;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iput-object v0, p2, Laqj;->j:Ljava/util/function/BiConsumer;

    new-instance p2, Lb6j;

    const/4 v0, 0x0

    invoke-direct {p2, p0, v0}, Lb6j;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;I)V

    check-cast p1, Laqj;

    iput-object p2, p1, Laqj;->i:Ljava/util/function/Consumer;

    new-instance p2, Lb6j;

    invoke-direct {p2, p0, v1}, Lb6j;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;I)V

    iput-object p2, p1, Laqj;->h:Ljava/util/function/Consumer;
...
.method private static final configureSession$lambda$4(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;)V
    .locals 1
...
.method private static final configureSession$lambda$5(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ltpj;)V
    .locals 1
...
.method private final connect(Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    ...
    iget-object v3, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->client:Lgqj;

    invoke-direct {v1, v0, v2, v3}, Lvpj;-><init>(Ljava/net/URI;Ljava/lang/String;Lgqj;)V

    invoke-virtual {v1, v0}, Lvpj;->a(Ljava/net/URI;)Laqj;

    move-result-object v0

    iput-object v0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->session:Lspj;

    invoke-direct {p0, v0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->configureSession(Lspj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V

    invoke-direct {p0, v0, p1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->openSession(Lspj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    :try_end_0
...
.method private final handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Ll67;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct/range {v1 .. v6}, Lm42;-><init>(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Ll67;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
...
.method private static final handleAsync$lambda$7(Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;Ljava/lang/String;Ll67;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 5
    ...
    :try_start_0
    invoke-interface {p2, p3, p4}, Ll67;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final openSession(Lspj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 9
    ...
    invoke-virtual {v0, v1, v2, v3}, Laqj;->c(Lzpj;Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Z

    iget-object v2, v0, Laqj;->d:Lvpj;

    iget-object v3, v2, Lvpj;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, v2, Lvpj;->c:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v0, Laqj;->c:J
    ...
    invoke-direct {v5, v0, v4}, Lmqj;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_0
    :goto_0
    iget-object v0, v2, Lvpj;->b:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v2, v0, Laqj;->e:Lzpj;

    sget-object v3, Lzpj;->a:Lzpj;
    ...
    iget-object v1, v0, Laqj;->a:Lm70;

    iget-object v1, v1, Lm70;->b:Ljava/lang/Object;

    check-cast v1, Lfkj;

    invoke-virtual {v1, v4}, Lfkj;->b(Z)Lvmj;

    move-result-object v1

    iget-object v2, v1, Lvmj;->e:Lt24;

    new-instance v3, Lqqj;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v1, v3, Lqqj;->a:Lvmj;

    iput-object v2, v3, Lqqj;->b:Ljava/io/InputStream;

    iget-object v1, v1, Lvmj;->f:Lfnj;
    ...
    invoke-static {v5, v6, v4}, Lunl;->c(JLjava/nio/ByteBuffer;)I
    ...
    invoke-static {v4, v5, v2}, Lunl;->c(JLjava/nio/ByteBuffer;)I
    ...
    :cond_2
    iget-object v1, v0, Laqj;->k:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, v0, Laqj;->l:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v0, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    new-instance v0, Lypj;

    invoke-direct {v0, v6}, Lypj;-><init>(I)V

    iput-object v3, v0, Lypj;->b:Lkqj;
    ...
    invoke-direct {p0, v2, v0, p2, v1}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;Ll67;)V

    invoke-direct {p0, p1, v0, p2}, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->readStreamData(Lspj;Ltpj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    ...
    :goto_3
    iget-object p1, v2, Lvpj;->b:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private final readStreamData(Lspj;Ltpj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 6
    ...
    :try_start_0
    invoke-interface {p2}, Ltpj;->b()Ljava/io/InputStream;
    ...
    :goto_0
    :try_start_1
    invoke-static {p2}, Lunl;->d(Ljava/io/InputStream;)I
...
.method private final sendStreamData(Ltpj;Lone/video/calls/sdk/net/signaling/wt/nal/NALSocket$Listener;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    :try_start_4
    invoke-interface {p1}, Ltpj;->a()Ljava/io/OutputStream;
...
.method public final close(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lone/video/calls/sdk/net/signaling/wt/nal/internal/WebTransportSocket;->session:Lspj;
    ...
    invoke-virtual {v0, v1, v2, p2}, Laqj;->a(JLjava/lang/String;)V
