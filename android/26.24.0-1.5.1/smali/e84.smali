...
.field public volatile k:Lv84;

.field public volatile l:J

.field public final m:Ljava/util/concurrent/CopyOnWriteArraySet;

.field public final n:Lc84;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Lqwf;Letg;Lon8;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Le84;->a:Landroid/content/Context;

    iput-object p2, p0, Le84;->b:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Le84;->c:Lqwf;

    iput-object p5, p0, Le84;->d:Lon8;

    iput-object p4, p0, Le84;->e:Letg;
    ...
    iput-object p1, p0, Le84;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Le84;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Le84;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, La84;

    invoke-direct {p3, p0, p2}, La84;-><init>(Le84;I)V

    new-instance p4, Letg;

    invoke-direct {p4, p3}, Letg;-><init>(Lv57;)V

    iput-object p4, p0, Le84;->i:Letg;

    new-instance p3, La84;

    const/4 p4, 0x1

    invoke-direct {p3, p0, p4}, La84;-><init>(Le84;I)V

    new-instance p4, Letg;

    invoke-direct {p4, p3}, Letg;-><init>(Lv57;)V

    iput-object p4, p0, Le84;->j:Letg;

    sget-object p3, Lv84;->b:Lv84;

    iput-object p3, p0, Le84;->k:Lv84;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Le84;->m:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lc84;

    invoke-direct {p3, p0}, Lc84;-><init>(Le84;)V

    iput-object p3, p0, Le84;->n:Lc84;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lb84;->f:Lb84;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Le84;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Le84;->p:Ljava/lang/String;

    invoke-virtual {p0, p2}, Le84;->o(Z)Z
...
.method public static j(Le84;)Landroid/net/NetworkCapabilities;
    .locals 4

    invoke-virtual {p0}, Le84;->i()Landroid/net/Network;
    ...
    :try_start_0
    invoke-virtual {p0}, Le84;->l()Landroid/net/ConnectivityManager;
    ...
    iget-object p0, p0, Le84;->p:Ljava/lang/String;
...
.method public static k(Landroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)Lv84;
    .locals 6
    ...
    :cond_a
    :goto_2
    sget-object p0, Lv84;->b:Lv84;

    return-object p0

    :cond_b
    :goto_3
    sget-object p0, Lv84;->c:Lv84;
...
.method public final a()Lv84;
    ...
    iget-object v0, p0, Le84;->k:Lv84;

    sget-object v1, Lv84;->b:Lv84;

    if-eq v0, v1, :cond_0

    iget-object p0, p0, Le84;->k:Lv84;
    ...
    invoke-virtual {p0, v2}, Le84;->m(Landroid/net/Network;)Landroid/net/NetworkInfo;

    move-result-object v1

    invoke-static {v0, v1}, Le84;->k(Landroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)Lv84;
    ...
    iget-object v3, v3, Lqwf;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v3, v2, v0}, Lhp4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, p0, Le84;->k:Lv84;
...
.method public final c()Z
    ...
    iget-object v0, p0, Le84;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Le84;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-boolean p0, v0, Lb84;->e:Z

    return p0

    :cond_0
    invoke-static {p0}, Le84;->j(Le84;)Landroid/net/NetworkCapabilities;
...
.method public final f(Lw74;)V
    ...
    iget-object p0, p0, Le84;->m:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final h()Z
    ...
    iget-object v0, p0, Le84;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Le84;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Le84;->p:Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Ljo8;->a(Ljava/lang/Throwable;)V
...
.method public final invalidate()V
    ...
    iget-object v0, p0, Le84;->p:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Le84;->o(Z)Z
    ...
    invoke-virtual {p0, v2}, Le84;->p(Ll5c;)Lb84;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v0}, Le84;->q(Lb84;)V
...
.method public final n()V
    ...
    iget-object v0, p0, Le84;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v3, v5, v0, v6, v4}, Lyob;->c(Lb19;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v3, p0, Le84;->a:Landroid/content/Context;

    new-instance v5, Lur0;

    const/4 v6, 0x2

    invoke-direct {v5, p0, v6}, Lur0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v3, v5, v6, v4, v7}, Lqj4;->W(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Landroid/os/Handler;I)Landroid/content/Intent;

    iget-object v3, p0, Le84;->p:Ljava/lang/String;
    ...
    :goto_2
    iget-object v4, p0, Le84;->p:Ljava/lang/String;
    ...
    iget-object v4, p0, Le84;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, v2}, Ljo8;->a(Ljava/lang/Throwable;)V
...
.method public final o(Z)Z
    ...
    invoke-virtual {v0, p1}, Ljo8;->a(Ljava/lang/Throwable;)V
...
.method public final p(Ll5c;)Lb84;
    .locals 14
    ...
    :cond_e
    invoke-virtual {p0, v3}, Le84;->m(Landroid/net/Network;)Landroid/net/NetworkInfo;
    ...
    invoke-direct/range {v8 .. v13}, Lb84;-><init>(ZZZZZ)V
    ...
    invoke-static {v7, v10, v5, v6, v2}, Lqh5;->A(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v0, v1, p0, p1, v4}, Lyob;->c(Lb19;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final q(Lb84;)V
    .locals 7

    sget-object v0, Lb19;->c:Lb19;

    iget-object v1, p0, Le84;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_2
    iget-object v2, p0, Le84;->o:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v2, p1}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    iget-boolean v1, v1, Lb84;->e:Z

    iget-boolean v2, p1, Lb84;->e:Z
    ...
    iget-boolean v4, p1, Lb84;->e:Z

    const-string v5, "updateInet, vpn changed to "

    const-string v6, ", reset dns ..."

    invoke-static {v5, v6, v4}, Lis1;->l(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object v1, v0, Lmh5;->e:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lmh5;->f(Lv57;)V
    ...
    invoke-virtual {v0, v4, v1, p1, v3}, Lyob;->c(Lb19;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_b
    :goto_3
    iget-object p1, p0, Le84;->b:Ljava/util/concurrent/ExecutorService;
