...
# virtual methods
.method public a(Luy5;Lsbe;Lq4e;)Z
    .locals 0
    ...
    :cond_0
    iget-boolean p0, p0, Lanf;->a:Z

    if-eqz p0, :cond_1

    const/16 p0, 0x800

    invoke-static {p2, p3, p1, p0}, Ljz8;->K(Lsbe;Lq4e;Luy5;I)I
...
.method public b(Luy5;Lkx9;Lsbe;Lq4e;Landroid/graphics/ColorSpace;)Lkn6;
    .locals 20
    ...
    invoke-static {v5, v8, v0, v6}, Ljz8;->K(Lsbe;Lq4e;Luy5;I)I
    ...
    :try_start_0
    invoke-virtual {v0}, Luy5;->x()Ljava/io/InputStream;
    ...
    invoke-interface {v0, v4, v2}, Ls19;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    new-instance v0, Lkn6;

    invoke-direct {v0, v10, v1, v9}, Lkn6;-><init>(IIB)V

    return-object v0

    :cond_4
    invoke-static {v0, v5}, Lwg8;->d(Luy5;Lsbe;)Landroid/graphics/Matrix;
    ...
    :cond_6
    invoke-direct {v0, v7, v1, v9}, Lkn6;-><init>(IIB)V
    :try_end_2
    ...
    :goto_4
    :try_start_3
    invoke-static {v4, v3, v0}, Lma6;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
