...
.method public constructor <init>(Lao3;)V
    ...
    iput-object p1, p0, Luy5;->a:Lao3;

    return-void
.end method

.method public static J(Luy5;)Z
    .locals 1
...
.method public static W(Luy5;)Z
    .locals 0

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Luy5;->P()Z
...
.method public static b(Luy5;)Luy5;
    .locals 2
    ...
    invoke-direct {v0, v1}, Luy5;-><init>(Lao3;)V
    :try_end_0
    ...
    invoke-virtual {v0, p0}, Luy5;->l(Luy5;)V
...
.method public final X()V
    ...
    sget-object v1, Lzv7;->d:Lon8;

    const/4 v1, 0x0

    :try_start_0
    invoke-static {v0}, Limh;->y(Ljava/io/InputStream;)Lyv7;
    ...
    invoke-static {v1}, Lwv0;->a(Ljava/io/InputStream;)Ldm7;

    move-result-object v2

    iget-object v4, v2, Ldm7;->b:Ljava/lang/Object;

    check-cast v4, Landroid/graphics/ColorSpace;

    iput-object v4, p0, Luy5;->i:Landroid/graphics/ColorSpace;

    iget-object v4, v2, Ldm7;->c:Ljava/lang/Object;
    ...
    :catch_0
    iget-object v1, v2, Ldm7;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v6, v5, v3, v4}, Lytc;->read([BII)I

    const-string v6, "RIFF"

    invoke-static {v6, v5}, Lhy4;->f(Ljava/lang/String;[B)Z
    ...
    :cond_7
    :try_start_6
    invoke-static {v2}, Lhy4;->l(Ljava/io/InputStream;)V
    ...
    :cond_d
    invoke-static {v2}, Lhy4;->o(Ljava/io/InputStream;)Ll5c;
    ...
    invoke-static {v2}, Lhy4;->n(Ljava/io/InputStream;)Ll5c;
    ...
    iget-object v2, v1, Ll5c;->b:Ljava/lang/Object;
    ...
    invoke-static {v0}, Lfml;->b(Ljava/io/InputStream;)I

    move-result v0

    iput v0, p0, Luy5;->d:I

    invoke-static {v0}, Lfml;->a(I)I
    ...
    invoke-static {v0}, Lkil;->a(Ljava/io/InputStream;)I
...
.method public final l(Luy5;)V
    ...
    iput-object p1, p0, Luy5;->i:Landroid/graphics/ColorSpace;
...
.method public final p()Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v3, p0, v1}, Ljx9;->C(III[B)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final x()Ljava/io/InputStream;
    ...
    invoke-direct {v0, v1}, Lytc;-><init>(Ljx9;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
