...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-virtual {v0, p1, v2}, Lq2e;->c(Ljava/lang/String;Lg9e;)V
    ...
    .line 322
    invoke-interface {p2}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Ludb;
    ...
    .line 329
    iget-object p2, p1, Lf5e;->g:Lh5e;

    if-eqz p2, :cond_1

    .line 330
    invoke-virtual {p2}, Lh5e;->J()Ljava/lang/String;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Lf5e;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    sget-object v7, Lht9;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 349
    :try_start_6
    invoke-static {v1}, Lq47;->A(Ljava/lang/String;)Lht9;
    ...
    invoke-direct {v7}, Lq2e;-><init>()V

    invoke-virtual {v7, v0}, Lq2e;->f(Ljava/lang/String;)V
    ...
    .line 351
    iget-object v9, v7, Lq2e;->c:Ll77;

    invoke-virtual {v9, v0, v8}, Ll77;->r(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {v10 .. v15}, Lt2i;->c(JJJ)V

    .line 355
    new-instance v9, Lx2e;

    invoke-direct {v9, v1, v8, v0}, Lx2e;-><init>(Lht9;I[B)V

    .line 356
    const-string v0, "POST"

    invoke-virtual {v7, v0, v9}, Lq2e;->c(Ljava/lang/String;Lg9e;)V

    .line 357
    invoke-virtual {v7}, Lq2e;->a()Ls2e;
    ...
    .line 360
    invoke-interface/range {p4 .. p4}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Ludb;

    move-result-object v1

    .line 361
    invoke-virtual {v1, v0}, Ludb;->b(Ls2e;)Lnqd;
    ...
    .line 368
    invoke-virtual {v0}, Lh5e;->J()Ljava/lang/String;
    ...
    .line 376
    :goto_9
    invoke-virtual {v1}, Lf5e;->close()V
    ...
    .line 378
    invoke-virtual {v5}, Lf5e;->close()V
