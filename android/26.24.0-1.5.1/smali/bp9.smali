...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lbp9;->a:Ljava/lang/Object;

    new-instance v0, Lap9;

    invoke-direct {v0, p0}, Lap9;-><init>(Lbp9;)V

    iput-object v0, p0, Lbp9;->b:Lap9;
    ...
    iput-object v0, p0, Lbp9;->d:Ljava/lang/ref/WeakReference;
...
.method public final a(Ldp9;Landroid/os/Handler;)V
    .locals 8

    iget-boolean v0, p0, Lbp9;->c:Z
    ...
    iput-boolean v0, p0, Lbp9;->c:Z

    const/4 v1, 0x1

    invoke-virtual {p2, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p1, p1, Ldp9;->g:Landroidx/media3/session/legacy/PlaybackStateCompat;
    ...
    :cond_1
    iget-wide v4, p1, Landroidx/media3/session/legacy/PlaybackStateCompat;->e:J

    :goto_0
    if-eqz p1, :cond_2

    iget p1, p1, Landroidx/media3/session/legacy/PlaybackStateCompat;->a:I
...
.method public g(Landroid/content/Intent;)Z
    ...
    :cond_0
    iget-object v0, p0, Lbp9;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lbp9;->d:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p0, v1, v3}, Lbp9;->a(Ldp9;Landroid/os/Handler;)V
    ...
    iget-boolean p1, p0, Lbp9;->c:Z

    if-eqz p1, :cond_6

    invoke-virtual {v3, v4}, Landroid/os/Handler;->removeMessages(I)V

    iput-boolean v2, p0, Lbp9;->c:Z

    iget-object p1, v1, Ldp9;->g:Landroidx/media3/session/legacy/PlaybackStateCompat;
...
.method public u(Landroidx/media3/session/legacy/RatingCompat;)V
    .locals 0
