...
.method public constructor <init>(Lfa8;Lfa8;)V
    ...
    iput-object p1, p0, Lyi0;->a:Lfa8;

    iput-object p2, p0, Lyi0;->b:Lfa8;

    return-void
.end method

.method public static final a(Lyi0;[BLrnh;)Lrgg;
    .locals 2

    new-instance p0, Lrgg;
    ...
    invoke-direct {p0, p1, v0, v1}, Lrgg;-><init>(Ljava/lang/String;II)V

    invoke-virtual {p2}, Lrnh;->b()I

    move-result p1

    invoke-virtual {p0, p1}, Lrgg;->setAlpha(I)V
    ...
    invoke-virtual {p0, p1}, Lrgg;->c(Landroid/graphics/Xfermode;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lcj0;->i(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lqnh;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Ldj0;)Ljava/util/LinkedHashMap;
    .locals 28
    ...
    new-instance v14, Ldj0;

    invoke-virtual {v10, v2}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    iget-object v8, v11, Lxi0;->a:Ljava/lang/String;
    ...
    invoke-direct {v14, v2}, Ldj0;-><init>(Ljava/lang/String;)V

    sget-object v2, Lhf3;->j:Lpl0;

    move-object/from16 v8, p1

    invoke-virtual {v2, v8}, Lpl0;->d(Landroid/content/Context;)Lhf3;

    move-result-object v2

    iget-object v2, v2, Lhf3;->d:Ljava/lang/Object;

    check-cast v2, Lfob;

    iget-object v2, v2, Lfob;->b:Ljava/util/Map;
    ...
    iget-boolean v2, v11, Lxi0;->b:Z

    invoke-static {v15, v2}, Leja;->o(Lgob;Z)Ldob;

    move-result-object v2

    invoke-interface {v2}, Ldob;->B()Lunb;

    move-result-object v2

    iget-object v2, v2, Lunb;->a:Lr0h;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v11, v2, Lr0h;->f:Ljava/lang/Object;

    check-cast v11, [I

    iget v13, v2, Lr0h;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v14}, Ldj0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v13}, Lboj;->h(I)I

    move-result v26

    invoke-direct/range {v20 .. v26}, Lrnh;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v13, v11, v8}, Lpnh;-><init>([IF)V
    ...
    iget-object v8, v2, Lr0h;->e:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v4, v8}, Lyi0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v4}, Lyi0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lpnh;-><init>([IF)V
    ...
    invoke-static {v0, v11}, Lsu;->q0(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Lsnh;

    invoke-direct/range {v20 .. v26}, Lsnh;-><init>(Lrnh;Lpnh;Lpnh;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lrnh;Lxfg;)Ljava/lang/Object;
    .locals 7

    iget-object v0, p0, Lyi0;->a:Lfa8;
