...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lkeb;Lct4;Lw9b;Lepc;)V
    .locals 0
    ...
    iput-object p2, p0, Lusa;->b:Lkeb;

    iput-object p3, p0, Lusa;->c:Lct4;

    iput-object p4, p0, Lusa;->d:Lw9b;

    iput-object p5, p0, Lusa;->e:Lepc;
...
.method public final a()Ltsa;
    ...
    iget-object v1, p0, Lusa;->c:Lct4;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v1, "ru.oneme.app.new.activeCalls"

    invoke-virtual {v0, v1}, Ltsa;->c(Ljava/lang/String;)V

    iget-object v1, p0, Lusa;->a:Landroid/content/Context;

    sget v2, Lomd;->tt_notif_category_active_calls:I

    invoke-virtual {v1, v2}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Ltsa;->f(Ljava/lang/String;)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ltsa;->j(Z)V

    invoke-virtual {v0, v1}, Ltsa;->k(Z)V

    invoke-virtual {v0, v1}, Ltsa;->e(Z)V

    invoke-virtual {v0, v1}, Ltsa;->g(Z)V

    invoke-virtual {v0}, Ltsa;->d()V

    invoke-virtual {v0}, Ltsa;->a()Ltsa;
...
.method public final b()Ltsa;
    ...
    sget v2, Lomd;->tt_notif_category_incoming_calls:I
    ...
    invoke-virtual {v0, v1}, Ltsa;->h(Landroid/net/Uri;)V

    invoke-virtual {v0, v3}, Ltsa;->g(Z)V

    invoke-virtual {v0}, Ltsa;->b()V

    invoke-virtual {v0, v3}, Ltsa;->e(Z)V
...
.method public final c()Ltsa;
    ...
    invoke-virtual {v2, v3}, Lllh;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lusa;->i(Z)Landroid/net/Uri;

    move-result-object v4

    iget-object v5, p0, Lusa;->c:Lct4;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v5, "ru.oneme.app.chats"

    invoke-virtual {v0, v5}, Ltsa;->c(Ljava/lang/String;)V

    iget-object v5, p0, Lusa;->a:Landroid/content/Context;

    sget v6, Lomd;->tt_notif_category_chats:I

    invoke-virtual {v5, v6}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Ltsa;->f(Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Ltsa;->j(Z)V
    ...
    invoke-virtual {v2, v5, v3}, Lja8;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    invoke-virtual {v0, v2}, Ltsa;->k(Z)V

    invoke-virtual {v0, v4}, Ltsa;->h(Landroid/net/Uri;)V
...
.method public final d()Ltsa;
    ...
    invoke-virtual {p0, v3}, Lusa;->i(Z)Landroid/net/Uri;
    ...
    sget v6, Lomd;->tt_notif_category_dialogs:I
...
.method public final e()Ltsa;
    ...
    sget v2, Lomd;->tt_notif_category_inapp:I
    ...
    invoke-virtual {v0, v2}, Ltsa;->h(Landroid/net/Uri;)V

    iget-object v2, p0, Lusa;->e:Lepc;
    ...
    invoke-virtual {v2, v3, v1}, Lja8;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v0, v1}, Ltsa;->l([J)V
...
.method public final f(Ltsa;)V
    ...
    iget-object v1, p1, Ltsa;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Ltsa;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Ltsa;->f:Z
    ...
    iget-object v0, p0, Lusa;->b:Lkeb;

    sget-object v2, Lhf3;->j:Lpl0;

    iget-object v0, v0, Lkeb;->a:Landroid/content/Context;
    ...
    iget-object v0, p0, Lusa;->d:Lw9b;

    invoke-virtual {v0, v1}, Lw9b;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final g()V
    ...
    invoke-direct {v3, v2}, Lru;-><init>(I)V
    ...
    invoke-virtual {v3, v4}, Lru;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v1}, Lru;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v4, v1}, Lw9b;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v1}, Lw9b;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, Lusa;->c()Ltsa;

    move-result-object v3

    invoke-virtual {p0, v3}, Lusa;->f(Ltsa;)V
    ...
    iget-object v6, p0, Lusa;->e:Lepc;

    iget-object v7, v6, Lepc;->c:Lllh;

    const-string v8, "app.notification.ringtone"

    invoke-virtual {v7, v8}, Lllh;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Ltsa;->c(Ljava/lang/String;)V

    sget v9, Lomd;->tt_notif_category_misc:I

    invoke-virtual {v5, v9}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v3, v9}, Ltsa;->f(Ljava/lang/String;)V

    invoke-virtual {v3, v7}, Ltsa;->j(Z)V
    ...
    invoke-virtual {v6, v7, v4}, Lja8;->getBoolean(Ljava/lang/String;Z)Z

    move-result v6

    invoke-virtual {v3, v6}, Ltsa;->k(Z)V

    invoke-virtual {v3, v8}, Ltsa;->h(Landroid/net/Uri;)V

    invoke-virtual {v3}, Ltsa;->a()Ltsa;
    ...
    sget v6, Lomd;->tt_notif_category_file_loading:I

    invoke-virtual {v5, v6}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3, v6}, Ltsa;->f(Ljava/lang/String;)V

    invoke-virtual {v3, v2}, Ltsa;->j(Z)V

    invoke-virtual {v3, v2}, Ltsa;->k(Z)V

    invoke-virtual {v3, v2}, Ltsa;->g(Z)V
    ...
    sget v6, Lomd;->tt_notif_category_media:I
    ...
    invoke-virtual {v3, v4}, Ltsa;->j(Z)V

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Ltsa;->h(Landroid/net/Uri;)V
    ...
    sget v4, Lomd;->tt_notif_category_live_location:I

    invoke-virtual {v5, v4}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Ltsa;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lusa;->f(Ltsa;)V
...
.method public final i(Z)Landroid/net/Uri;
    ...
    iget-object v0, p0, Lusa;->e:Lepc;

    if-eqz p1, :cond_0

    iget-object p1, v0, Lepc;->c:Lllh;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Lllh;->j(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lusa;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lusa;->f:Landroid/app/NotificationManager;
...
.method public final k()Z
    ...
    invoke-virtual {p0, v0}, Lusa;->h(Ljava/lang/String;)Landroid/app/NotificationChannel;
