...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lg4i;-><init>(I)V
    ...
    .line 9
    sget-object v1, Lgnd;->ScrollingViewBehavior_Layout:[I
    ...
    .line 11
    sget p2, Lgnd;->ScrollingViewBehavior_Layout_behavior_overlapTop:I
...
.method public static u(Ljava/util/List;)Lxo;
    .locals 4
...
.method public d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->v(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;)I
    ...
    :cond_0
    instance-of p1, p3, Lxo;

    if-eqz p1, :cond_1

    check-cast p3, Lxo;

    iget-boolean p1, p3, Lxo;->l:Z

    if-eqz p1, :cond_1

    invoke-virtual {p3, p2}, Lxo;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p3, p1}, Lxo;->g(Z)Z
...
.method public final i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->u(Ljava/util/List;)Lxo;
    ...
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Lqsi;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Lqsi;->d()I

    move-result v4

    invoke-virtual {v3}, Lqsi;->a()I
    ...
    :cond_2
    :goto_0
    invoke-virtual {v2}, Lxo;->getTotalScrollRange()I
...
.method public final m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->u(Ljava/util/List;)Lxo;
    ...
    invoke-virtual {v0, v1, p2, p1}, Lxo;->f(ZZZ)V
...
.method public final v(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, p1}, Lbea;->l(III)I
