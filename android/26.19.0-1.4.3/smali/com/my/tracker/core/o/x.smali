...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-direct {v1, v4}, Loz4;-><init>(I)V

    invoke-virtual {v1, p1}, Loz4;->h(Ljava/lang/String;)V

    .line 32
    const-string p1, "GET"

    invoke-virtual {v1, p1, v3}, Loz4;->d(Ljava/lang/String;Lbq4;)V
    ...
    .line 41
    iget-object p2, p1, Lh6e;->g:Lj6e;

    if-eqz p2, :cond_1

    .line 42
    invoke-virtual {p2}, Lj6e;->V()Ljava/lang/String;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Lh6e;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    .line 100
    sget-object v4, Lsh9;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 101
    :try_start_6
    invoke-static {p2}, Lz9e;->C(Ljava/lang/String;)Lsh9;
    ...
    invoke-virtual {v4, p1}, Loz4;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, p1, v5}, Lucb;->z(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 105
    invoke-static {v5, p2, p1}, Lgi3;->m(ILsh9;[B)Lq4e;
    ...
    invoke-virtual {v4, p2, p1}, Loz4;->d(Ljava/lang/String;Lbq4;)V
    ...
    .line 128
    invoke-virtual {v3}, Lh6e;->close()V
