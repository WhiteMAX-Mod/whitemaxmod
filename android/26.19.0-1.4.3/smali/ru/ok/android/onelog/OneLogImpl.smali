...
.field private volatile forceFallbackLogs:Lvcg;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lvcg;"
        }
...
.method public getApiClient()Lzm;
    .locals 2
...
.method public setForceFallbackLogs(Lvcg;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public startUpload(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, p1}, Lzu9;-><init>(ILjava/lang/Object;)V
...
.method public upload(Ljava/util/Collection;)V
    ...
    .line 2
    invoke-virtual {p0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Lzm;

    move-result-object v0

    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lzm;Ljava/util/Collection;)V
...
.method public upload(Lru/ok/android/onelog/OneLogItem;)V
    ...
    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lzm;Lru/ok/android/onelog/OneLogItem;)V
