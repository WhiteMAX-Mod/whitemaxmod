...
.method static constructor <clinit>()V
    ...
    sput-object v0, Linf;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lgfe;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Linf;->d:Lgfe;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Linf;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Lxje;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Linf;->d:Lgfe;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Lxje;->a:Z
...
.method public final a()Lrje;
    ...
    iget-object v1, p0, Linf;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lhnf;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lq65;
    ...
    sget-object v7, Lqm5;->a:Lqm5;

    iget-object v6, p0, Linf;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lov7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lov7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
