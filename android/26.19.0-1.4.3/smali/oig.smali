...
.method static constructor <clinit>()V
    ...
    sput-object v0, Loig;->e:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lqti;)V
    ...
    invoke-direct {v1, p1}, Lnig;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Loig;->a:Landroid/content/Context;

    iput-object p2, p0, Loig;->c:Lqti;

    iput-object v0, p0, Loig;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Loig;->d:Lnig;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Loig;->e:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lbea;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Loig;->e:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lbea;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Llti;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Llti;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Loig;->a:Landroid/content/Context;

    iget-object v1, p0, Loig;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Loig;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Loig;->f(Landroid/app/job/JobInfo;)Llti;
    ...
    invoke-static {v1, v2}, Loig;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Loig;->c:Lqti;

    iget-object v0, v0, Lqti;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->y()Lmig;

    move-result-object v0

    iget-object v1, v0, Lmig;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lnef;->c(Lws6;)V
...
.method public final varargs e([Lgui;)V
    .locals 12
    ...
    invoke-direct {v2, v3, v1}, Lrv6;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v7, v5, Lgui;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Liui;->o(Ljava/lang/String;)Lgui;
    ...
    sget-object v9, Loig;->e:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lbea;->W(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lgp7;->r(Lgui;)Llti;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->y()Lmig;

    move-result-object v7

    invoke-virtual {v7, v6}, Lmig;->f(Llti;)Lkig;
    ...
    iget-object v9, v2, Lrv6;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Ldi7;

    invoke-direct {v10, v2, v8}, Ldi7;-><init>(Lrv6;I)V
    ...
    invoke-direct {v8, v11, v10}, Lc9a;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v9, v8}, Ly9e;->t(Lzt6;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Llti;->a:Ljava/lang/String;

    iget v6, v6, Llti;->b:I

    invoke-direct {v7, v9, v6, v8}, Lkig;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lqti;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->y()Lmig;

    move-result-object v6

    invoke-virtual {v6, v7}, Lmig;->i(Lkig;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Loig;->g(Lgui;I)V
...
.method public final g(Lgui;I)V
    .locals 18
    ...
    iget-object v3, v1, Loig;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Loig;->d:Lnig;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lgui;->j:Lt24;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lgui;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Lw4;->j(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Lnig;->b:Ljava/lang/String;

    invoke-static {v6}, Lgz5;->z(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lbea;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lgui;->l:Lzj0;

    sget-object v8, Lzj0;->b:Lzj0;
    ...
    :cond_7
    iget-boolean v10, v2, Lgui;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Lw4;->i(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v10}, Ls24;->b()Z

    move-result v11

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    invoke-virtual {v10}, Ls24;->a()Landroid/net/Uri;
    ...
    invoke-static {v4}, Lnx0;->v(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lbea;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lbea;->W(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lgui;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lgui;->r:Lrub;

    sget-object v5, Lrub;->a:Lrub;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Lbea;->p(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Loig;->g(Lgui;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lbea;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Loig;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Loig;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Loig;->c:Lqti;

    iget-object v5, v4, Lqti;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->B()Liui;

    move-result-object v5

    invoke-virtual {v5}, Liui;->k()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lbea;->s(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lqti;->b:Luw3;
