...
.field public final synthetic h:Lbob;
...
.method public final a()V
    ...
    iget-boolean v0, p0, Lb9g;->f:Z

    if-eqz v0, :cond_0

    invoke-virtual {v1, v4}, Ljig;->f(I)V

    :cond_0
    const/4 v0, 0x0

    iput-boolean v0, p0, Lb9g;->f:Z

    return-void

    :cond_1
    invoke-virtual {v2}, Liw5;->B()Lgvg;
    ...
    :cond_2
    invoke-virtual {v2}, Liw5;->j()I

    move-result v5

    invoke-virtual {v3, v5}, Lgvg;->l(I)Ljava/lang/Object;

    move-result-object v5

    :goto_0
    invoke-virtual {v2}, Liw5;->x()I

    move-result v6

    invoke-virtual {v2}, Liw5;->m()I

    move-result v7

    invoke-virtual {v2}, Liw5;->d()J
    ...
    iget-object v2, v0, Lbob;->e:Ljava/lang/Object;

    check-cast v2, Ldvg;

    invoke-virtual {v3, v5, v2}, Lgvg;->g(Ljava/lang/Object;Ldvg;)Ldvg;
    ...
    iget-boolean v10, p0, Lb9g;->f:Z

    iget v11, p0, Lb9g;->a:I

    if-eqz v10, :cond_5

    iget-object v10, p0, Lb9g;->b:Ljava/lang/Object;
    ...
    iget v10, p0, Lb9g;->c:I

    if-ne v6, v10, :cond_5

    iget v10, p0, Lb9g;->d:I

    if-ne v7, v10, :cond_5

    iget-wide v12, p0, Lb9g;->e:J

    cmp-long v10, v8, v12

    if-nez v10, :cond_5

    iget-wide v5, p0, Lb9g;->g:J
    ...
    iput-wide v2, p0, Lb9g;->g:J

    iput-object v5, p0, Lb9g;->b:Ljava/lang/Object;

    iput v6, p0, Lb9g;->c:I

    iput v7, p0, Lb9g;->d:I

    iput-wide v8, p0, Lb9g;->e:J

    invoke-virtual {v1, v4}, Ljig;->f(I)V

    invoke-virtual {v1, v4, v11}, Ljig;->h(II)Z
