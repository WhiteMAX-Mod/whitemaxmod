...
.method public constructor <init>(Lhg4;I)V
    ...
    invoke-direct {p0, p1, v2, v0, p2}, Lbpc;-><init>(Lhg4;Ljava/lang/String;II)V

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object p1, p0, Lvie;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object p1, p0, Lvie;->k:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public m(Ljava/lang/Long;)V
    ...
    iget-object v2, p0, Lbpc;->g:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lvie;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v5, v6, v3}, Laq9;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v3, p0, Lvie;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v5, v6}, Lz82;->a(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget-object v2, p0, Lvie;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p0, Lvie;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v3, v5}, Lz82;->a(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final t(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/Object;)Luie;
    .locals 7

    sget-object v0, Lqo8;->f:Lqo8;

    invoke-virtual {p0}, Lvie;->s()Z
    ...
    invoke-static {p3, v1}, Lp1c;->n(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0, p3}, Lvie;->r(Ljava/lang/Object;)Z
    ...
    iget-object v4, p0, Lvie;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_6
    :goto_1
    iget-object v0, p0, Lvie;->k:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v1, Lgn2;

    const/16 v2, 0x9

    invoke-direct {v1, p3, v2, p2}, Lgn2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lvie;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct/range {v1 .. v6}, Ltie;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Laq9;

    const/4 p2, 0x6

    invoke-direct {p1, p2, v1}, Laq9;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, v5, p1}, Ljava/util/concurrent/ConcurrentHashMap;->compute(Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;

    new-instance p1, Luie;

    invoke-direct {p1, p0, v5, v2, v4}, Luie;-><init>(Lvie;Ljava/lang/Long;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lvie;->k:Ljava/util/concurrent/ConcurrentHashMap;
