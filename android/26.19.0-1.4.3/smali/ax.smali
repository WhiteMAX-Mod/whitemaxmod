...
.method public final b(Lcv9;Ljava/lang/String;)V
    ...
    :pswitch_0
    invoke-static {v1}, Lj30;->e(Lcv9;)Lj30;

    move-result-object v1

    iput-object v1, v0, Lax;->g:Ljava/util/List;

    return-void

    :pswitch_1
    invoke-static {v1}, Lae5;->a(Lcv9;)Lae5;

    move-result-object v1

    iput-object v1, v0, Lax;->i:Ljava/util/Map;
    ...
    iput-object v2, v0, Lax;->d:Ljava/util/List;
    ...
    iget-object v12, v0, Lax;->d:Ljava/util/List;
    ...
    invoke-virtual {v15, v5}, Lsqe;->q(Z)V

    goto/16 :goto_8

    :pswitch_4
    invoke-static {v1}, Lj30;->d(Lcv9;)Lj30;

    move-result-object v5

    invoke-virtual {v15, v5}, Lsqe;->x(Lj30;)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->y(Lj30;)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->p(Lj30;)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->z(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lzf5;->p(Ljava/lang/String;)Lzf5;

    move-result-object v5

    invoke-virtual {v15, v5}, Lsqe;->B(Lzf5;)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->t(Ljava/lang/String;)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->r(Ljava/lang/String;)V
    ...
    invoke-static {v1, v5, v6}, Lvff;->z0(Lcv9;J)J

    move-result-wide v5

    invoke-virtual {v15, v5, v6}, Lsqe;->C(J)V
    ...
    invoke-static {v1}, Lstd;->a(Lcv9;)Lstd;
    ...
    :cond_18
    invoke-virtual {v15, v5}, Lsqe;->v(Ljava/util/List;)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->A(I)V
    ...
    invoke-virtual {v15, v5, v6}, Lsqe;->s(J)V
    ...
    invoke-virtual {v15, v5}, Lsqe;->u(Lj30;)V
    ...
    invoke-static {v1}, Lutd;->a(Lcv9;)Lutd;
    ...
    :cond_1a
    invoke-virtual {v15, v5}, Lsqe;->w(Ljava/util/ArrayList;)V
    ...
    :cond_1b
    invoke-virtual {v15}, Lsqe;->o()Ltqe;
    ...
    iput-object v1, v0, Lax;->e:Ljava/util/Map;
    ...
    iput-object v1, v0, Lax;->f:Ljava/util/Map;
    ...
    iput-object v1, v0, Lax;->h:Ljava/util/Map;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lax;->d:Ljava/util/List;
    ...
    invoke-static {v3}, Lgn8;->N(Ljava/util/Map;)I

    move-result v3

    iget-object v4, p0, Lax;->f:Ljava/util/Map;

    invoke-static {v4}, Lgn8;->N(Ljava/util/Map;)I

    move-result v4

    iget-object v5, p0, Lax;->g:Ljava/util/List;

    invoke-static {v5}, Lgn8;->j(Ljava/util/Collection;)I

    move-result v5

    iget-object v6, p0, Lax;->h:Ljava/util/Map;

    invoke-static {v6}, Lgn8;->N(Ljava/util/Map;)I

    move-result v6

    iget-object v7, p0, Lax;->i:Ljava/util/Map;

    invoke-static {v7}, Lgn8;->N(Ljava/util/Map;)I
