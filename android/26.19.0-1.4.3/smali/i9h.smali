...
.method public static q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Li9h;->s0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Li9h;->s0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static r0([Lbn6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Lbn6;->b()Landroid/net/Uri;
...
.method public final T(Landroid/content/Context;Lym6;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lzm6;->c()Ljava/lang/String;
    ...
    invoke-static {p2, p4}, Li9h;->q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final U(Landroid/content/Context;[Lbn6;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Li9h;->r0([Lbn6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, Li9h;->q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final V(ILandroid/content/Context;Ljava/util/List;)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p2}, Li9h;->r0([Lbn6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p2}, Li9h;->r0([Lbn6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p1}, Li9h;->q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final Z([Lbn6;I)Lbn6;
    .locals 0
