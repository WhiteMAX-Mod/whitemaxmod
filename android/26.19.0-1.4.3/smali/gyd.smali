...
.method public final b(Lyyd;)V
    ...
    iget-object v3, p1, Lyyd;->h:Lyyd;

    const/4 v4, 0x0

    if-eqz v3, :cond_0

    iget-object v3, p1, Lyyd;->i:Lyyd;

    if-nez v3, :cond_0

    iput-object v4, p1, Lyyd;->h:Lyyd;

    :cond_0
    iput-object v4, p1, Lyyd;->i:Lyyd;
    ...
    iget-object v4, v3, Lr0h;->d:Ljava/lang/Object;
    ...
    iget-object v1, v3, Lr0h;->f:Ljava/lang/Object;
    ...
    iget-object v6, v5, Ly70;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v3, v2}, Lr0h;->M(Landroid/view/View;)V
    :try_end_0
    ...
    :cond_4
    :try_start_1
    invoke-virtual {v4, v6}, Lme3;->d(I)Z

    move-result v8

    if-eqz v8, :cond_5

    invoke-virtual {v4, v6}, Lme3;->g(I)Z

    invoke-virtual {v3, v2}, Lr0h;->M(Landroid/view/View;)V

    invoke-virtual {v5, v6}, Ly70;->u(I)V
    :try_end_1
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView;->c:Lpyd;

    invoke-virtual {v4, v3}, Lpyd;->l(Lyyd;)V

    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView;->c:Lpyd;

    invoke-virtual {v4, v3}, Lpyd;->i(Lyyd;)V
...
.method public abstract c(Lyyd;)V
.end method
