...
# static fields
.field public static final c:Lcm5;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ljj;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Lbq4;->e(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Ljj;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Ljj;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Lw31;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Ljj;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lyi;->e:Lyi;

    iget-object v12, v0, Ljj;->a:Landroid/content/Context;
    ...
    instance-of v12, v3, Lnj;

    if-nez v12, :cond_6

    instance-of v3, v3, Loj;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Llb4;->X(Ljava/lang/String;)Landroid/graphics/Path;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    :cond_0
    instance-of v1, p2, Loj;

    if-eqz v1, :cond_2

    new-instance p2, Llj;

    invoke-direct {p2, v5}, Llj;-><init>(F)V
    ...
    invoke-direct {p2, v4}, Lkj;-><init>(I)V

    :cond_2
    :goto_1
    instance-of v1, p2, Llj;

    instance-of v6, p2, Lnj;

    const/4 v7, 0x0

    if-eqz v6, :cond_11

    instance-of p2, v2, Lnj;
    ...
    iget-object v1, v1, Lnj;->a:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v1}, Llb4;->W(Ljava/lang/String;)[Lc0c;
    ...
    iget-object v5, v5, Lnj;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v5}, Llb4;->W(Ljava/lang/String;)[Lc0c;
    ...
    invoke-direct {v6}, Lf5d;-><init>()V

    if-eqz v5, :cond_f

    invoke-static {v1, v5}, Llb4;->P([Lc0c;[Lc0c;)Z
    ...
    iget-object p2, v2, Lnj;->a:Ljava/lang/String;
    ...
    iget-object v7, v3, Lnj;->a:Ljava/lang/String;
    ...
    invoke-static {v0, p2, v1, v7}, Lc72;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
