...
.method public constructor <init>(Lfa8;Lfa8;Ltkg;Lmbe;)V
    ...
    iput-object p3, p0, Lfph;->a:Ltkg;

    iput-object p4, p0, Lfph;->b:Lmbe;

    iput-object p1, p0, Lfph;->c:Lfa8;

    iput-object p2, p0, Lfph;->d:Lfa8;
    ...
    iput-object p1, p0, Lfph;->e:Ljava/lang/String;

    const-wide/16 p1, -0x1

    iput-wide p1, p0, Lfph;->g:J

    iput-wide p1, p0, Lfph;->i:J
    ...
    iput-object p1, p0, Lfph;->j:Ljava/util/EnumSet;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Lfph;->k:Ljava/util/LinkedHashMap;
...
.method public final a()V
    ...
    iget-object v0, p0, Lfph;->e:Ljava/lang/String;
    ...
    iget-object v3, p0, Lfph;->h:Lnqh;

    const/4 v4, 0x0

    if-eqz v3, :cond_1

    invoke-interface {v3}, Lnqh;->k()J
    ...
    invoke-static {v3, v5, v6}, Lz82;->a(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0}, Lfph;->p()V

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lfph;->g:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lfph;->f:Z
...
.method public final c(Lnqh;)V
    ...
    iget-object v6, p0, Lfph;->h:Lnqh;

    if-eqz v6, :cond_1

    invoke-interface {v6}, Lnqh;->k()J
    ...
    invoke-virtual {v2, v0, v1, v6, v5}, Ledb;->c(Lqo8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_2
    :goto_1
    iput-object p1, p0, Lfph;->h:Lnqh;

    iget-object p1, p0, Lfph;->j:Ljava/util/EnumSet;
    ...
    iget-object v6, p0, Lfph;->k:Ljava/util/LinkedHashMap;
    ...
    iget-object p1, p0, Lfph;->e:Ljava/lang/String;
    ...
    iget-object v2, p0, Lfph;->h:Lnqh;

    if-eqz v2, :cond_4

    invoke-interface {v2}, Lnqh;->k()J
    ...
    invoke-static {v2, v4, v3}, Lz82;->a(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    iget-object v7, p0, Lfph;->k:Ljava/util/LinkedHashMap;

    invoke-interface {v6}, Lnqh;->getType()I

    move-result v8

    invoke-static {v8}, Lnhh;->b(I)I
    ...
    invoke-static {}, Lmu3;->b()Ljava/lang/String;
    ...
    iget-object v9, p0, Lfph;->k:Ljava/util/LinkedHashMap;
    ...
    :cond_8
    invoke-interface {v6}, Lnqh;->b()Landroid/net/Uri;
    ...
    iget-object v8, p0, Lfph;->k:Ljava/util/LinkedHashMap;
    ...
    :cond_a
    invoke-interface {v6}, Lnqh;->getContentType()Ljava/lang/String;

    move-result-object v6

    invoke-static {v1}, Lnhh;->a(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lnhh;->a(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lfph;->k:Ljava/util/LinkedHashMap;
    ...
    :cond_e
    iget-object p1, p0, Lfph;->l:Lezh;

    if-eqz p1, :cond_f

    iget-object v1, p0, Lfph;->k:Ljava/util/LinkedHashMap;

    invoke-virtual {p1}, Lezh;->a()I
...
.method public final f()V
    ...
    invoke-direct {v1, p0, v3, v2}, Ln5f;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    const/4 v2, 0x2

    iget-object v4, p0, Lfph;->b:Lmbe;
...
.method public final g()V
    ...
    iget-object v5, p0, Lfph;->h:Lnqh;

    if-eqz v5, :cond_1

    invoke-interface {v5}, Lnqh;->k()J
    ...
    invoke-static {v5, v2, v6}, Lz82;->a(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    iget-object v0, p0, Lfph;->j:Ljava/util/EnumSet;

    sget-object v1, Leph;->c:Leph;
    ...
    iget-object v2, p0, Lfph;->k:Ljava/util/LinkedHashMap;

    invoke-virtual {v1, v2}, Lkv8;->putAll(Ljava/util/Map;)V

    iget-object v2, p0, Lfph;->d:Lfa8;
    ...
    invoke-virtual {p0, v1, v0}, Lfph;->r(Ljava/lang/String;Lkv8;)V
...
.method public final j()V
    ...
    :goto_0
    iget-boolean v5, p0, Lfph;->f:Z

    iget-wide v6, p0, Lfph;->g:J
...
.method public final l(Ljava/lang/Throwable;)V
    ...
    iget-object v5, p0, Lfph;->e:Ljava/lang/String;
    ...
    iget-object v7, p0, Lfph;->h:Lnqh;

    if-eqz v7, :cond_1

    invoke-interface {v7}, Lnqh;->k()J
    ...
    invoke-virtual {v6, v0, v5, v2, v4}, Ledb;->c(Lqo8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1}, Lone/video/player/error/OneVideoPlaybackException;->a()Lpqb;
    ...
    invoke-virtual {p0, v0, p1}, Lfph;->r(Ljava/lang/String;Lkv8;)V
...
.method public final n(Z)V
    ...
    invoke-static {v5, p1}, Lgz5;->m(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final r(Ljava/lang/String;Lkv8;)V
    .locals 3

    iget-object v0, p0, Lfph;->c:Lfa8;
