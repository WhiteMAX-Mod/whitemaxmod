...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxs5;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lxs5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lxs5;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
# virtual methods
.method public final E0(JLvs5;)V
    .locals 5

    sget-object v0, Lxs5;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    sget-object v3, Lxs5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_3
    invoke-virtual {p3, p1, p2, v0, p0}, Lvs5;->b(JLws5;Lxs5;)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lys5;->i0(JLvs5;)V
    ...
    invoke-virtual {p0}, Lys5;->R()Ljava/lang/Thread;
...
.method public final Z()J
    ...
    :cond_0
    invoke-virtual {p0}, Lxs5;->m0()V

    :goto_0
    sget-object v0, Lxs5;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_5
    sget-object v5, Lzs5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_b
    sget-object v3, Lzs5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_c
    sget-object v0, Lxs5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public final dispatch(Lxf4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lxs5;->j0(Ljava/lang/Runnable;)V

    return-void
.end method

.method public invokeOnTimeout(JLjava/lang/Runnable;Lxf4;)Lt65;
    .locals 0

    invoke-static {p1, p2, p3, p4}, Ltwj;->b(JLjava/lang/Runnable;Lxf4;)Lt65;
...
.method public j0(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lxs5;->q0(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, p1}, Lnu4;->j0(Ljava/lang/Runnable;)V
...
.method public final m0()V
    ...
    invoke-virtual {p0, v3}, Lxs5;->q0(Ljava/lang/Runnable;)Z
...
.method public final q0(Ljava/lang/Runnable;)Z
    ...
    sget-object v2, Lxs5;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :cond_7
    sget-object v2, Lzs5;->b:Lkotlinx/coroutines/internal/Symbol;
...
.method public final scheduleResumeAfterDelay(JLac2;)V
    ...
    sget-object v0, Lzs5;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-direct {v2, p0, v0, v1, p3}, Lts5;-><init>(Lxs5;JLac2;)V

    invoke-virtual {p0, p1, p2, v2}, Lxs5;->E0(JLvs5;)V

    new-instance p1, Lmb2;

    const/4 p2, 0x1

    invoke-direct {p1, p2, v2}, Lmb2;-><init>(ILjava/lang/Object;)V
...
.method public shutdown()V
    ...
    sget-object v0, Latg;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v4, Lzs5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :goto_2
    sget-object v2, Lxs5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_7
    invoke-virtual {p0, v0, v1, v2}, Lys5;->i0(JLvs5;)V
