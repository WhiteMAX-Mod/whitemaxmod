...
.method public constructor <init>(Ldob;)V
    ...
    iput-object v0, p0, Lqbc;->a:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lqbc;->b:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lqbc;->c:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Lqbc;->onThemeChanged(Ldob;)V
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Luyd;)V
    ...
    iget-object p3, p4, Luyd;->b:Landroid/util/SparseArray;
    ...
    iput-object p3, p4, Luyd;->b:Landroid/util/SparseArray;
...
.method public final g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Luyd;)V
    ...
    iget-object v0, p0, Lqbc;->b:Landroid/graphics/RectF;
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->T(Landroid/view/View;)Lyyd;

    move-result-object v6

    instance-of v6, v6, Lw53;

    if-eqz v6, :cond_5

    iget-object v6, p3, Luyd;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Lqbc;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Lqbc;->a:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Ldob;)V
    ...
    iget-object v0, p0, Lqbc;->a:Landroid/graphics/Paint;
