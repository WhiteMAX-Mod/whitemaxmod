...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Lvo8;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lvo8;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput p1, p0, Lvo8;->g:I

    new-instance p1, Ldo8;

    invoke-direct {p1, p2}, Ldo8;-><init>(I)V

    iput-object p1, p0, Lvo8;->i:Ldo8;
...
.method public final a(I)V
    ...
    invoke-static {v0, p1}, Lvdg;->d(II)I
    ...
    invoke-static {v1, p1}, Lvdg;->d(II)I
    ...
    :cond_1
    :try_start_1
    iget-object v2, p0, Lvo8;->b:Landroid/content/Context;
    ...
    invoke-static {v2, v3}, Ls96;->h1(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v4, "b.log"

    invoke-static {v2, v4}, Ls96;->h1(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v4

    const-string v6, "stash-a.log"

    invoke-static {v2, v6}, Ls96;->h1(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v6

    const-string v7, "stash-b.log"

    invoke-static {v2, v7}, Ls96;->h1(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    sget-object v1, Luo8;->$EnumSwitchMapping$1:[I
    ...
    invoke-static {v1}, Lgmf;->i([Ljava/io/File;)V
    ...
    invoke-static {v1, v3}, Lgmf;->j([Ljava/io/File;I)Lbu;
    ...
    invoke-static {v1, v2}, Lgmf;->j([Ljava/io/File;I)Lbu;
    ...
    invoke-direct {v1, v3, v6}, Lnxb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final b()Lbu;
    ...
    invoke-virtual {p0, v0}, Lvo8;->a(I)V

    iget-object v0, p0, Lvo8;->e:Lbu;
...
.method public final c(Ljava/lang/Iterable;Z)V
    ...
    iget-object v1, p0, Lvo8;->h:Ljava/io/File;
...
.method public final d()V
    ...
    iget-object v0, p0, Lvo8;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Lvo8;->a(I)V

    invoke-virtual {p0}, Lvo8;->b()Lbu;
    ...
    sget-object v6, Lmo8;->a:Ljava/text/SimpleDateFormat;
    ...
    invoke-static {v6, v1, v7}, Lsu;->h0(I[BI)[B

    move-result-object v1

    :goto_0
    invoke-direct {v5, v3, v4, v1}, Lko8;-><init>(J[B)V
    ...
    :cond_6
    iget-object v3, p0, Lvo8;->i:Ldo8;

    iget-object v4, v3, Ldo8;->b:Lbu;
    ...
    :cond_7
    :try_start_4
    iget-object v6, v3, Ldo8;->b:Lbu;

    invoke-virtual {v6, v1}, Lbu;->addFirst(Ljava/lang/Object;)V
