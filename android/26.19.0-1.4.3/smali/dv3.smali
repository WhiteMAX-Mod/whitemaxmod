...
# static fields
.field public static final d:Lbv3;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lgfe;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lcoa;-><init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    invoke-direct {v3, v4, v0, v1}, Lgfe;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Ldv3;->e:Lgfe;

    new-instance v0, Lbv3;

    invoke-direct {v0, v2, v3}, Lbv3;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Ldv3;->d:Lbv3;

    iget-object v0, v0, Lbv3;->b:[Lcv3;
    ...
    invoke-virtual {v3}, Lcoa;->dispose()V
...
.method public constructor <init>()V
    ...
    sget-object v1, Ldv3;->d:Lbv3;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Ldv3;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v2, Lbv3;

    sget v3, Ldv3;->f:I

    sget-object v4, Ldv3;->e:Lgfe;

    invoke-direct {v2, v3, v4}, Lbv3;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()Lrje;
    ...
    iget-object v1, p0, Ldv3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v1}, Lbv3;->a()Lcv3;

    move-result-object v1

    invoke-direct {v0, v1}, Lav3;-><init>(Lcv3;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lq65;
    ...
    iget-object v0, p0, Ldv3;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lq65;
    ...
    iget-object v1, v0, Lcoa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    invoke-direct {p4, p1, v1}, Lov7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lov7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
