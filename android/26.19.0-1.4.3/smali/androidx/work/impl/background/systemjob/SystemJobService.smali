...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Ljoc;

    return-void
.end method

.method public static b(Landroid/app/job/JobParameters;)Llti;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Llti;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final a(Llti;Z)V
    ...
    iget-object v3, p1, Llti;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Ljoc;

    invoke-virtual {v0, p1}, Ljoc;->w(Llti;)Ljvf;
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lqti;
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lqti;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lqti;->f:Lnsc;

    invoke-virtual {v0, p0}, Lnsc;->e(Lvt5;)V
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lqti;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->b(Landroid/app/job/JobParameters;)Llti;
    ...
    invoke-virtual {p1, v0, v1}, Lbea;->s(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, Lbea;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lpig;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1}, Lpig;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    invoke-static {p1}, Lqig;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    :cond_5
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lqti;

    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Ljoc;

    invoke-virtual {v0, v2}, Ljoc;->y(Llti;)Ljvf;

    move-result-object v0

    invoke-virtual {p1, v0, v1}, Lqti;->h(Ljvf;Lpl0;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p1, v0, v2}, Lbea;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1, v2}, Lbea;->s(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Ljoc;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lqti;

    iget-object v4, v3, Lqti;->d:Lr73;

    new-instance v5, Lw2g;

    invoke-direct {v5, v3, v2, v0}, Lw2g;-><init>(Lqti;Ljvf;Z)V

    invoke-virtual {v4, v5}, Lr73;->e(Ljava/lang/Runnable;)V
    ...
    iget-object p1, p1, Llti;->a:Ljava/lang/String;
    ...
    :try_start_1
    iget-object v0, v0, Lnsc;->j:Ljava/util/HashSet;
