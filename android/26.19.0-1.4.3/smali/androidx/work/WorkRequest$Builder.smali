...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "setBackoffCriteria",
        "(Lzj0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;",
        "Ljava/time/Duration;",
        "duration",
        "(Lzj0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;",
        "Lt24;",
        "constraints",
        "setConstraints",
        "(Lt24;)Landroidx/work/WorkRequest$Builder;",
        "Lfn4;",
        "inputData",
        "setInputData",
        "(Lfn4;)Landroidx/work/WorkRequest$Builder;",
        "",
        "tag",
        "addTag",
        ...
        "policy",
        "setExpedited",
        "(Lrub;)Landroidx/work/WorkRequest$Builder;",
        "build",
        "()Landroidx/work/WorkRequest;",
        ...
        "state",
        "setInitialState",
        "(Lmti;)Landroidx/work/WorkRequest$Builder;",
        "",
        "runAttemptCount",
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    invoke-direct/range {v3 .. v31}, Lgui;-><init>(Ljava/lang/String;Lmti;Ljava/lang/String;Ljava/lang/String;Lfn4;Lfn4;JJJLt24;ILzj0;JJJJZLrub;III)V

    iput-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;
    ...
    invoke-static {v1, v2}, Lsu;->x0([Ljava/lang/Object;Ljava/util/HashSet;)V
...
.method public final build()Landroidx/work/WorkRequest;
    ...
    iget-object v1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;

    iget-object v1, v1, Lgui;->j:Lt24;

    iget-object v2, v1, Lt24;->h:Ljava/util/Set;
    ...
    iget-boolean v2, v1, Lt24;->d:Z

    if-nez v2, :cond_1

    iget-boolean v2, v1, Lt24;->b:Z

    if-nez v2, :cond_1

    iget-boolean v1, v1, Lt24;->c:Z
    ...
    :goto_1
    iget-object v2, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;

    iget-boolean v3, v2, Lgui;->q:Z

    if-eqz v3, :cond_4

    if-nez v1, :cond_3

    iget-wide v1, v2, Lgui;->g:J
...
.method public final getWorkSpec$work_runtime_release()Lgui;
    .locals 1

    iget-object v0, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;
...
.method public final keepResultsForAtLeast(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-static {p1}, Lfe5;->a(Ljava/time/Duration;)J

    move-result-wide v1

    iput-wide v1, v0, Lgui;->o:J
...
.method public final setBackoffCriteria(Lzj0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lgui;->e(J)V
...
.method public final setBackoffCriteria(Lzj0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p2}, Lfe5;->a(Ljava/time/Duration;)J
...
.method public final setConstraints(Lt24;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setExpedited(Lrub;)Landroidx/work/WorkRequest$Builder;
    .locals 2
    ...
    iput-boolean v1, v0, Lgui;->q:Z

    iput-object p1, v0, Lgui;->r:Lrub;
...
.method public final setId(Ljava/util/UUID;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;

    iget-object v4, v3, Lgui;->c:Ljava/lang/String;

    iget-object v5, v3, Lgui;->b:Lmti;

    move-object v6, v5

    iget-object v5, v3, Lgui;->d:Ljava/lang/String;

    move-object v7, v6

    new-instance v6, Lfn4;

    iget-object v8, v3, Lgui;->e:Lfn4;

    invoke-direct {v6, v8}, Lfn4;-><init>(Lfn4;)V

    move-object v8, v7

    new-instance v7, Lfn4;

    iget-object v9, v3, Lgui;->f:Lfn4;

    invoke-direct {v7, v9}, Lfn4;-><init>(Lfn4;)V

    move-object v10, v8

    iget-wide v8, v3, Lgui;->g:J

    move-object v12, v10

    iget-wide v10, v3, Lgui;->h:J

    move-object v14, v12

    iget-wide v12, v3, Lgui;->i:J

    new-instance v15, Lt24;

    move-object/from16 v26, v1

    iget-object v1, v3, Lgui;->j:Lt24;
    ...
    iget-wide v4, v1, Lt24;->f:J

    move-object/from16 v25, v2

    iget-wide v1, v1, Lt24;->g:J

    move-wide/from16 v23, v1

    move-wide/from16 v21, v4

    invoke-direct/range {v15 .. v25}, Lt24;-><init>(IZZZZJJLjava/util/Set;)V

    iget v1, v3, Lgui;->k:I

    iget-object v2, v3, Lgui;->l:Lzj0;

    iget-wide v4, v3, Lgui;->m:J

    move/from16 v16, v1

    move-object/from16 v17, v2

    iget-wide v1, v3, Lgui;->n:J

    move-wide/from16 v19, v1

    iget-wide v1, v3, Lgui;->o:J

    move-wide/from16 v21, v1

    iget-wide v1, v3, Lgui;->p:J

    move-wide/from16 v23, v1

    iget-boolean v1, v3, Lgui;->q:Z

    iget-object v2, v3, Lgui;->r:Lrub;
    ...
    invoke-direct/range {v1 .. v29}, Lgui;-><init>(Ljava/lang/String;Lmti;Ljava/lang/String;Ljava/lang/String;Lfn4;Lfn4;JJJLt24;ILzj0;JJJJZLrub;III)V

    iput-object v1, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;
...
.method public setInitialDelay(JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p3, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;

    iget-wide v0, p3, Lgui;->g:J
...
.method public setInitialDelay(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;

    iget-wide v2, p1, Lgui;->g:J
...
.method public final setInitialState(Lmti;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setInputData(Lfn4;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setWorkSpec$work_runtime_release(Lgui;)V
    .locals 0

    iput-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgui;
