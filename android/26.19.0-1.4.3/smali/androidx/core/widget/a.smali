...
# direct methods
.method public static a(Landroidx/appcompat/widget/AppCompatTextView;)Lvnc;
    .locals 5
    ...
    invoke-static {p0}, Lj65;->h(Landroidx/appcompat/widget/AppCompatTextView;)Landroid/text/PrecomputedText$Params;

    move-result-object p0

    invoke-direct {v0, p0}, Lvnc;-><init>(Landroid/text/PrecomputedText$Params;)V
    ...
    invoke-direct {v2, v3}, Loy0;-><init>(Landroid/text/TextPaint;)V

    invoke-static {p0}, Lywj;->a(Landroidx/appcompat/widget/AppCompatTextView;)I

    move-result v3

    invoke-virtual {v2, v3}, Loy0;->d(I)V

    invoke-static {p0}, Lywj;->b(Landroidx/appcompat/widget/AppCompatTextView;)I

    move-result v3

    invoke-virtual {v2, v3}, Loy0;->g(I)V
    ...
    invoke-static {p0}, Lzwj;->d(Ljava/util/Locale;)Landroid/icu/text/DecimalFormatSymbols;

    move-result-object p0

    invoke-static {p0}, Lj65;->a(Landroid/icu/text/DecimalFormatSymbols;)[Ljava/lang/String;
    ...
    :goto_2
    invoke-virtual {v2, p0}, Loy0;->h(Landroid/text/TextDirectionHeuristic;)V

    invoke-virtual {v2}, Loy0;->b()Lvnc;
...
.method public static b(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0, p1}, Lj65;->k(Landroid/widget/TextView;I)V
