...
.method public constructor <init>(Landroid/view/View;Liv7;Lbu6;)V
    ...
    iput-object p1, p0, Lswf;->a:Landroid/view/View;

    iput-object p2, p0, Lswf;->b:Liv7;

    iput-object p3, p0, Lswf;->c:Lbu6;
    ...
    invoke-direct {p2, p3, p0}, Lhde;-><init>(ILjava/lang/Object;)V
    ...
    iput-object p3, p0, Lswf;->h:Landroid/graphics/Rect;
    ...
    :goto_1
    iput-object v0, p0, Lswf;->i:Landroid/graphics/Rect;

    sget-object p3, Lf3i;->a:Ljava/util/WeakHashMap;

    invoke-static {p1, p2}, Lv2i;->l(Landroid/view/View;Li1b;)V
    ...
    sget-object p2, Ljv7;->a:Ldha;

    invoke-virtual {p2, p0}, Ldha;->a(Ljava/lang/Object;)V

    :cond_2
    new-instance p2, Lewb;

    invoke-direct {p2, p0}, Lewb;-><init>(Lswf;)V
...
# virtual methods
.method public final a(Lgv7;Llx0;)V
    .locals 3
    ...
    iget-object v0, p0, Lswf;->i:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object p2, p0, Lswf;->h:Landroid/graphics/Rect;
...
.method public c(Lqsi;)V
    ...
    iget-object v3, v0, Lswf;->b:Liv7;

    iget v4, v3, Liv7;->a:I

    const/16 v5, 0x80

    iget-object v6, v0, Lswf;->h:Landroid/graphics/Rect;

    const-string v7, "null cannot be cast to non-null type android.view.ViewGroup.MarginLayoutParams"

    iget-object v8, v0, Lswf;->i:Landroid/graphics/Rect;
    ...
    iget-object v13, v0, Lswf;->a:Landroid/view/View;

    iget v14, v0, Lswf;->d:I

    if-eqz v4, :cond_5

    or-int v15, v5, v14

    invoke-virtual {v2, v15}, Lmsi;->f(I)Lgv7;

    move-result-object v15

    iget v15, v15, Lgv7;->a:I
    ...
    invoke-virtual {v2, v5}, Lmsi;->f(I)Lgv7;
    ...
    invoke-virtual {v2, v14}, Lmsi;->f(I)Lgv7;
    ...
    :cond_11
    :goto_2
    iget-object v2, v3, Liv7;->d:Llx0;

    if-eqz v2, :cond_12

    invoke-virtual {v0, v1, v2}, Lswf;->b(Lqsi;Llx0;)V

    :cond_12
    iget-object v2, v0, Lswf;->c:Lbu6;
