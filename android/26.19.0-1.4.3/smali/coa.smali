...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lxje;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Lcoa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lq65;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lcoa;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lq65;
...
.method public final dispose()V
    ...
    iget-object v0, p0, Lcoa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lr65;)Lwie;
    .locals 3

    new-instance v0, Lwie;

    invoke-direct {v0, p1, p5}, Lwie;-><init>(Ljava/lang/Runnable;Lr65;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lr65;->a(Lq65;)Z
    ...
    iget-object v1, p0, Lcoa;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lwie;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lr65;->b(Lq65;)Z
