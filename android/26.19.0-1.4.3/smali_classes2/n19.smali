...
.method public final onConnected()V
    ...
    iget-object v5, v1, Lo19;->d:Lm19;

    iget-object v6, v1, Lo19;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-static {v7}, Lvmh;->n(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    iget-object v10, v1, Lo19;->c:Landroid/os/Bundle;

    invoke-direct {v9, v8, v10}, Lb7c;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v9, v1, Lo19;->f:Lb7c;

    new-instance v8, Landroid/os/Messenger;

    invoke-direct {v8, v5}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v8, v1, Lo19;->g:Landroid/os/Messenger;
    ...
    iput-object v10, v5, Lm19;->b:Ljava/lang/ref/WeakReference;

    :try_start_1
    iget-object v5, v1, Lo19;->a:Landroid/content/Context;
    ...
    iget-object v11, v9, Lb7c;->c:Ljava/lang/Object;
    ...
    iget-object v8, v9, Lb7c;->b:Ljava/lang/Object;
    ...
    invoke-static {v4, v5}, Lq98;->U(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v4}, Lah7;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v6, v4, v5}, Lud9;-><init>(Landroid/media/session/MediaSession$Token;Lch7;)V

    iput-object v6, v1, Lo19;->h:Lud9;
    ...
    invoke-static {v4, v5, v1}, Lq98;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v4, v1, Lo19;->h:Lud9;

    if-nez v4, :cond_5

    iget-object v4, v1, Lo19;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-direct {v5, v4, v3}, Lud9;-><init>(Landroid/media/session/MediaSession$Token;Lch7;)V

    iput-object v5, v1, Lo19;->h:Lud9;

    :cond_5
    iget-object v1, v1, Lo19;->h:Lud9;

    iget-object v3, v0, Lm49;->b:Lf39;

    new-instance v4, Ldc8;

    const/4 v5, 0x7

    invoke-direct {v4, v0, v5, v1}, Ldc8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3, v4}, Lf39;->R(Ljava/lang/Runnable;)V

    iget-object v1, v3, Lf39;->e:Landroid/os/Handler;

    new-instance v3, Li49;

    invoke-direct {v3, v0, v2}, Li49;-><init>(Lm49;I)V
...
.method public final onConnectionSuspended()V
    ...
    iput-object v2, v1, Lo19;->f:Lb7c;

    iput-object v2, v1, Lo19;->g:Landroid/os/Messenger;

    iput-object v2, v1, Lo19;->h:Lud9;

    iget-object v1, v1, Lo19;->d:Lm19;
    ...
    iput-object v3, v1, Lm19;->b:Ljava/lang/ref/WeakReference;
