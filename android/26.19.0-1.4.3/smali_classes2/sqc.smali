...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Lsqc;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p2, p1}, Lsqc;->c(ILandroid/util/Size;)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Lsqc;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object v2, p0, Lsqc;->b:Landroid/graphics/Rect;
...
.method public final c(ILandroid/util/Size;)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Lsqc;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p2, v1, v0}, Lu2h;->d(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Lyxb;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v6, Luqc;->d:Luqc;

    if-eq v3, v6, :cond_5

    sget-object v6, Luqc;->c:Luqc;

    if-eq v3, v6, :cond_5

    sget-object v6, Luqc;->e:Luqc;
    ...
    iget-object v0, p0, Lsqc;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p2, p1, v0, v1}, Lu2h;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Lsqc;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lsqc;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Lsqc;->c:I

    invoke-static {p2}, Lu2h;->c(I)Z
    ...
    iget-object p2, p0, Lsqc;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lsqc;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Lsqc;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, v1, v2}, Lu2h;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(ILandroid/util/Size;)Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, p1, p2}, Lsqc;->c(ILandroid/util/Size;)Landroid/graphics/Matrix;

    move-result-object p1

    new-instance p2, Landroid/graphics/RectF;

    iget-object v0, p0, Lsqc;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Lsqc;->b:Landroid/graphics/Rect;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lsqc;->a:Landroid/util/Size;
