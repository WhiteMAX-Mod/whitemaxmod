...
# direct methods
.method public constructor <init>(Lg0a;Lup5;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lfch;->a:Lg0a;

    iput-object p2, p0, Lfch;->b:Lup5;
    ...
    invoke-direct {p1, p2, v0}, Lucb;-><init>(IB)V

    iput-object p1, p0, Lfch;->d:Lucb;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lfch;->e:Landroid/graphics/Rect;

    sget-object p1, Lcf5;->b:Lcf5;

    iput-object p1, p0, Lfch;->h:Lcf5;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Luyd;)V
    ...
    iget-object v0, p0, Lfch;->d:Lucb;

    if-ltz p4, :cond_5

    iget-object v1, p0, Lfch;->a:Lg0a;

    iget-object v2, v1, Lyh8;->d:Lj00;
    ...
    :cond_0
    invoke-virtual {v1, v2, v3}, Lg0a;->N(J)I

    move-result v4

    invoke-virtual {v1, v4}, Lg0a;->P(I)Lone/me/messages/list/loader/MessageModel;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, Lfch;->i()Landroid/view/ViewGroup;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v0, p1, p2, p3}, Lucb;->q(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    invoke-virtual {v0, v1, v2}, Lg0a;->N(J)I
    ...
    :cond_4
    invoke-virtual {v0, v5}, Lg0a;->P(I)Lone/me/messages/list/loader/MessageModel;
    ...
    iget-object v6, p0, Lfch;->d:Lucb;

    iget-object v8, p0, Lfch;->e:Landroid/graphics/Rect;

    invoke-virtual {v6, v8, v3, v5}, Lucb;->n(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v8, p0, Lfch;->b:Lup5;

    invoke-static/range {v7 .. v12}, Lvff;->h0(Landroid/view/View;Landroid/view/View;IIII)V
...
.method public final i()Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, Lfch;->b:Lup5;

    invoke-virtual {v0}, Landroid/view/View;->getMeasuredWidth()I

    move-result v1

    iget-object v2, p0, Lfch;->f:Landroid/widget/FrameLayout;
    ...
    invoke-interface {v8}, Ldob;->m()Le35;

    move-result-object v8

    iget-object v8, v8, Le35;->d:Ljava/lang/Object;

    check-cast v8, Lj15;

    iget-object v8, v8, Lj15;->c:Ljava/lang/Object;

    check-cast v8, Lmnb;

    iget-object v8, v8, Lmnb;->a:[I
    ...
    iget-object v7, p0, Lfch;->h:Lcf5;

    invoke-virtual {v6, v5, v7}, Lerg;->b(Landroid/widget/TextView;Lcf5;)V
    ...
    :goto_1
    iput-object v3, p0, Lfch;->f:Landroid/widget/FrameLayout;

    iput v1, p0, Lfch;->g:I

    :cond_3
    iget-object v0, p0, Lfch;->f:Landroid/widget/FrameLayout;
...
.method public final onThemeChanged(Ldob;)V
    ...
    iget-object v3, v3, Le35;->d:Ljava/lang/Object;

    check-cast v3, Lj15;

    iget-object v3, v3, Lj15;->c:Ljava/lang/Object;
