...
.method public synthetic constructor <init>(Lkotlin/coroutines/Continuation;Lone/me/qrscanner/QrScannerWidget;I)V
    ...
    iput-object p2, p0, Lm9d;->g:Lone/me/qrscanner/QrScannerWidget;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p2}, Lm9d;->m(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lm9d;->g:Lone/me/qrscanner/QrScannerWidget;

    const/4 v2, 0x4

    invoke-direct {v0, p2, v1, v2}, Lm9d;-><init>(Lkotlin/coroutines/Continuation;Lone/me/qrscanner/QrScannerWidget;I)V

    iput-object p1, v0, Lm9d;->f:Ljava/lang/Object;
...
.method public final m(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v1, Lm9d;->g:Lone/me/qrscanner/QrScannerWidget;
    ...
    :cond_4
    iget-object v2, v0, Lone/me/qrscanner/QrScannerWidget;->m:Lzrd;
    ...
    invoke-virtual {v0, v5, v2, v3}, Lffb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V
    ...
    :pswitch_0
    iget-object v0, v1, Lm9d;->f:Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lone/me/qrscanner/QrScannerWidget;->k1()Lh9d;

    move-result-object v0

    sget-object v2, Liie;->a:Liie;

    invoke-virtual {v0, v2}, Lh9d;->q(Ljie;)V
    ...
    iget-object v2, v2, Lh9d;->k:Ljwf;

    sget-object v3, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    invoke-virtual {v2, v5, v3}, Ljwf;->m(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v3, v2, v5, v7}, Lm;->c(ILandroid/os/Bundle;Lqke;I)Lsy3;
    ...
    invoke-virtual {v2, v3}, Lsy3;->i(Ljava/lang/Integer;)V
    ...
    invoke-virtual {v2, v7}, Lsy3;->g(Lzqg;)V
    ...
    invoke-direct {v15, v7}, Luqg;-><init>(I)V
    ...
    invoke-static {v4, v7, v6, v2}, Lm;->k(ZLmde;ZLjava/lang/String;)V
    ...
    instance-of v4, v0, Lf9d;

    if-eqz v4, :cond_f

    iget-object v2, v1, Lm9d;->g:Lone/me/qrscanner/QrScannerWidget;
    ...
    invoke-virtual {v4, v2}, Lbu;->addLast(Ljava/lang/Object;)V
    ...
    :cond_b
    invoke-virtual {v7}, Lyc4;->getChildRouters()Ljava/util/List;

    move-result-object v7

    new-instance v8, Lc8e;

    invoke-direct {v8, v7}, Lc8e;-><init>(Ljava/util/List;)V

    invoke-virtual {v8}, Lc8e;->iterator()Ljava/util/Iterator;
    ...
    iget-object v9, v8, Lb8e;->b:Ljava/util/ListIterator;
    ...
    iget-object v8, v8, Lb8e;->b:Ljava/util/ListIterator;
    ...
    invoke-virtual {v4, v8}, Lbu;->addLast(Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Lf9d;->b:Ljie;

    invoke-interface {v5, v0}, Lg9d;->E(Ljie;)V
    ...
    iget-object v3, v1, Lm9d;->g:Lone/me/qrscanner/QrScannerWidget;

    sget-object v4, Lone/me/qrscanner/QrScannerWidget;->w:[Lf88;

    iget-object v4, v3, Lone/me/qrscanner/QrScannerWidget;->k:Lzrd;

    sget-object v6, Lone/me/qrscanner/QrScannerWidget;->w:[Lf88;
    ...
    invoke-virtual {v3}, Lwqc;->getController()Lr62;
    ...
    iget-object v4, v3, Lr62;->g:Lli7;

    iput-object v5, v3, Lr62;->f:Ljava/util/concurrent/ExecutorService;

    iput-object v5, v3, Lr62;->g:Lli7;

    iget-object v6, v3, Lr62;->h:Lqi7;

    iget-object v7, v6, Lqi7;->u:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    iget-object v8, v6, Lqi7;->v:Lti7;

    if-eqz v8, :cond_10

    invoke-virtual {v8, v5, v5}, Lti7;->h(Ljava/util/concurrent/Executor;Lli7;)V
    ...
    :cond_10
    :goto_8
    iget-object v8, v6, Lqi7;->x:Lli7;

    if-eqz v8, :cond_11

    iput v2, v6, Lajh;->e:I

    invoke-virtual {v6}, Lajh;->t()V

    :cond_11
    iput-object v5, v6, Lqi7;->w:Ljava/util/concurrent/Executor;

    iput-object v5, v6, Lqi7;->x:Lli7;

    monitor-exit v7
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v3, v4, v5}, Lr62;->m(Lli7;Lli7;)V
    ...
    :cond_14
    sget-object v3, Ll9d;->$EnumSwitchMapping$1:[I
    ...
    iget-object v2, v0, Lone/me/qrscanner/QrScannerWidget;->o:Lzrd;
    ...
    iget-object v3, v0, Lone/me/qrscanner/QrScannerWidget;->v:Lvhg;
    ...
    invoke-direct {v3, v0, v4}, Lk9d;-><init>(Lone/me/qrscanner/QrScannerWidget;I)V
