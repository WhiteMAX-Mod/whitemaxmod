...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-array v1, v0, [Lrq4;

    new-array v0, v0, [Lyt0;

    invoke-direct {p0, v1, v0}, Lzkf;-><init>([Lrq4;[Lsq4;)V

    iput-object p1, p0, Lau0;->n:Landroid/content/Context;
...
.method public final g()Lsq4;
    ...
    invoke-direct {v0, p0}, Lyt0;-><init>(Lau0;)V
...
.method public final i(Lrq4;Lsq4;Z)Landroidx/media3/decoder/DecoderException;
    ...
    iget-object p3, p1, Lrq4;->d:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iget-object v0, p0, Lau0;->n:Landroid/content/Context;

    if-eqz v0, :cond_4

    invoke-static {v0}, Lvmh;->A(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v1, p3, v0, v2}, Lcjj;->a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object p3

    iput-object p3, p2, Lyt0;->d:Landroid/graphics/Bitmap;
    :try_end_0
