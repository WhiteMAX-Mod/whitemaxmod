...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v5}, Lux1;->A(Lux1;)V
    ...
    iget-object v1, v5, Lux1;->s1:Ljava/lang/CharSequence;

    invoke-virtual {v5, v1}, Lux1;->a0(Ljava/lang/CharSequence;)V
    ...
    iget-object v7, v5, Lux1;->o1:Ltz1;

    const/4 v2, 0x1

    if-eqz v7, :cond_12

    iget-object v3, v7, Ltz1;->a:Landroid/view/View;

    iget-object v6, v7, Ltz1;->q:[F

    iget-object v8, v7, Ltz1;->r:[F

    iget-object v9, v7, Ltz1;->j:Landroid/view/ScaleGestureDetector;

    iget-object v12, v7, Ltz1;->h:Landroid/graphics/Matrix;

    iget-object v13, v7, Ltz1;->t:Landroid/graphics/Matrix;

    iget-boolean v10, v7, Ltz1;->v:Z

    if-nez v10, :cond_0

    invoke-virtual {v7}, Ltz1;->g()V

    :cond_0
    iget-boolean v10, v7, Ltz1;->x:Z
    ...
    :cond_3
    iget-object v10, v7, Ltz1;->n:Landroid/view/GestureDetector;
    ...
    iget-boolean v10, v7, Ltz1;->k:Z

    if-nez v10, :cond_4

    iget-boolean v10, v7, Ltz1;->l:Z
    ...
    :cond_8
    iput-boolean v4, v7, Ltz1;->x:Z

    iget-boolean v10, v7, Ltz1;->m:Z

    iput-boolean v4, v7, Ltz1;->m:Z

    if-eqz v9, :cond_b

    iget-boolean v11, v7, Ltz1;->A:Z
    ...
    invoke-direct/range {v6 .. v11}, Leq1;-><init>(Ltz1;FFFF)V

    invoke-static {v13}, Lvnd;->b(Landroid/graphics/Matrix;)F

    move-result v17

    invoke-static {v12}, Lvnd;->b(Landroid/graphics/Matrix;)F
    ...
    invoke-direct {v3, v7}, Lpz1;-><init>(Ltz1;)V
    ...
    invoke-direct {v3, v6, v7}, Lqz1;-><init>(Leq1;Ltz1;)V

    invoke-virtual {v2, v3}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    :goto_6
    iget-object v3, v7, Ltz1;->w:Lnz1;
    ...
    iput-object v2, v7, Ltz1;->u:Landroid/animation/ValueAnimator;
    ...
    :goto_a
    iget-object v4, v5, Lux1;->n1:Landroid/view/GestureDetector;
    ...
    invoke-static {v5}, Lux1;->E(Lux1;)V
