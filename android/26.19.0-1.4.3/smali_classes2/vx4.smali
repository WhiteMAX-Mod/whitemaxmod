...
.method public constructor <init>(Lef5;)V
    ...
    iput-object v0, p0, Lvx4;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lvx4;->f:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lvx4;->g:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lvx4;->h:Ljava/util/LinkedHashMap;

    iput v1, p0, Lvx4;->i:I

    iput-boolean v1, p0, Lvx4;->j:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lvx4;->k:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lvx4;->d:Landroid/os/Handler;

    new-instance v0, Lc77;

    invoke-direct {v0, v1}, Lc77;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lvx4;->c:Lc77;

    new-instance v0, Lt75;

    invoke-direct {v0}, Lt75;-><init>()V

    iput-object v0, p0, Lvx4;->a:Lt75;

    :try_start_0
    new-instance v0, Los;

    invoke-direct {v0, p0, p1}, Los;-><init>(Lvx4;Lef5;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lf02;->get()Ljava/lang/Object;
    :try_end_1
...
.method public final a()V
    ...
    iget-object v0, p0, Lvx4;->h:Ljava/util/LinkedHashMap;
    ...
    :cond_0
    iget-object v1, p0, Lvx4;->k:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lc02;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lvx4;->a:Lt75;

    invoke-virtual {v0}, Lt75;->q()V

    iget-object v0, p0, Lvx4;->b:Landroid/os/HandlerThread;
...
.method public final c(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lvx4;->k:Ljava/util/ArrayList;
...
.method public final d(Lreg;)V
    ...
    iget-object v0, p0, Lvx4;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p0, v1, p1}, Le52;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v1, Lux4;

    const/4 v2, 0x0

    invoke-direct {v1, p1, v2}, Lux4;-><init>(Lreg;I)V

    invoke-virtual {p0, v0, v1}, Lvx4;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final e(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Ltwi;->b([FF)V

    invoke-static {v1}, Ltwi;->c([F)V

    move-object/from16 v2, p1

    invoke-static {v0, v2}, Lu2h;->h(ILandroid/util/Size;)Landroid/util/Size;

    move-result-object v0

    move-object/from16 v2, p0

    iget-object v3, v2, Lvx4;->a:Lt75;
    ...
    invoke-static {v6, v5}, Lc80;->G(Ljava/lang/String;Z)V
    ...
    invoke-static {v6}, Lyv6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lyv6;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Lyv6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lyv6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lyv6;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Lt75;->j:Ljava/lang/Object;
    ...
    iget-object v6, v3, Lt75;->l:Ljava/lang/Object;

    check-cast v6, Lwv6;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lxv6;
    ...
    invoke-static {v4}, Lyv6;->b(Ljava/lang/String;)V
...
.method public final f(Lx4h;)V
    ...
    invoke-virtual {p0, p1}, Lvx4;->c(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lx4h;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lx4h;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lvx4;->e(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lx4h;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lqe0;->c:Lc02;

    invoke-virtual {v8, v3}, Lc02;->b(Ljava/lang/Object;)Z
...
.method public final i(II)Lwi8;
    .locals 1

    new-instance v0, Lzr4;

    invoke-direct {v0, p0, p1, p2}, Lzr4;-><init>(Ljava/lang/Object;II)V
...
.method public final j(Lkeg;)V
    ...
    invoke-direct {v1, v2, p1}, Lh92;-><init>(ILjava/lang/Object;)V
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lvx4;->f:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lvx4;->h:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lvx4;->g:[F

    const/4 v6, 0x1

    invoke-virtual {v3, v5, v0, v6}, Lkeg;->F([F[FZ)V
    ...
    :try_start_0
    iget-object v3, p0, Lvx4;->a:Lt75;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lt75;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v2, v6}, Lc80;->O(Ljava/lang/String;Z)V

    new-instance v2, Lx4h;

    iget-object v3, v3, Lkeg;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lx4h;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lvx4;->f(Lx4h;)V
    :try_end_1
