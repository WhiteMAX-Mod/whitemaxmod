...
.method public final b(Landroid/content/Intent;)V
    ...
    :pswitch_2
    invoke-static {p1}, Lgej;->e(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Llxj;->F(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v0}, Llxj;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v8, p0, v4, v5}, Lmh9;-><init>(Lcom/google/firebase/messaging/FirebaseMessagingService;Llxj;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v8}, Lmh9;->C()Z
    ...
    invoke-static {p1}, Lgej;->h(Landroid/content/Intent;)Z
    ...
    invoke-static {v4, v5}, Lgej;->f(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v0}, Lz1e;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Lz1e;)V
    ...
    :cond_10
    :goto_4
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lqde;
    ...
    invoke-direct {v0, v4}, Lqde;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lqde;

    :cond_11
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lqde;

    iget-object v4, v0, Lqde;->c:Lp2c;

    invoke-virtual {v4}, Lp2c;->B()I
    ...
    :cond_14
    iget-object p1, v0, Lqde;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, v1, v6, v4, v7}, Lgyj;-><init>(IILandroid/os/Bundle;I)V
