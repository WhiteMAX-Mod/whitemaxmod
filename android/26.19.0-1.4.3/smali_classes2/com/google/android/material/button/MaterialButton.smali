...
.method static constructor <clinit>()V
    ...
    sget v0, Lymd;->Widget_MaterialComponents_Button:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v3, Ljcd;->materialButtonStyle:I
    ...
    invoke-direct {p0, p1, p2, v3}, Lip;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Lgnd;->MaterialButton:[I
    ...
    sget v2, Lgnd;->MaterialButton_iconPadding:I
    ...
    sget v2, Lgnd;->MaterialButton_iconTintMode:I
    ...
    invoke-static {v2, v6}, Lb9h;->T(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget v7, Lgnd;->MaterialButton_iconTint:I

    invoke-static {v2, p2, v7}, Lpt6;->o(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget v7, Lgnd;->MaterialButton_icon:I

    invoke-static {v2, p2, v7}, Lpt6;->q(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButton;->i:Landroid/graphics/drawable/Drawable;

    sget v2, Lgnd;->MaterialButton_iconGravity:I
    ...
    sget v2, Lgnd;->MaterialButton_iconSize:I
    ...
    invoke-static {v0, v1, v3, v4}, Lmbf;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Laq7;
    ...
    invoke-direct {v1, p0, v0}, Lix8;-><init>(Lcom/google/android/material/button/MaterialButton;Lmbf;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lix8;

    sget v0, Lgnd;->MaterialButton_android_insetLeft:I
    ...
    sget v0, Lgnd;->MaterialButton_android_insetRight:I
    ...
    sget v0, Lgnd;->MaterialButton_android_insetTop:I
    ...
    sget v0, Lgnd;->MaterialButton_android_insetBottom:I
    ...
    sget v0, Lgnd;->MaterialButton_cornerRadius:I
    ...
    iget-object v2, v1, Lix8;->b:Lmbf;

    int-to-float v0, v0

    invoke-virtual {v2, v0}, Lmbf;->h(F)Lmbf;

    move-result-object v0

    invoke-virtual {v1, v0}, Lix8;->c(Lmbf;)V

    iput-boolean v7, v1, Lix8;->p:Z

    :cond_0
    sget v0, Lgnd;->MaterialButton_strokeWidth:I
    ...
    sget v0, Lgnd;->MaterialButton_backgroundTintMode:I

    invoke-virtual {p2, v0, v5}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v0

    invoke-static {v0, v6}, Lb9h;->T(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, Lix8;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Lgnd;->MaterialButton_backgroundTint:I

    invoke-static {v0, p2, v2}, Lpt6;->o(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lix8;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Lgnd;->MaterialButton_strokeColor:I

    invoke-static {v0, p2, v2}, Lpt6;->o(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lix8;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Lgnd;->MaterialButton_rippleColor:I

    invoke-static {v0, p2, v2}, Lpt6;->o(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lix8;->l:Landroid/content/res/ColorStateList;

    sget v0, Lgnd;->MaterialButton_android_checkable:I

    invoke-virtual {p2, v0, p1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, v1, Lix8;->q:Z

    sget v0, Lgnd;->MaterialButton_elevation:I
    ...
    sget v0, Lgnd;->MaterialButton_toggleCheckedStateOnClick:I

    invoke-virtual {p2, v0, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, v1, Lix8;->r:Z
    ...
    sget v5, Lgnd;->MaterialButton_android_background:I
    ...
    iput-boolean v7, v1, Lix8;->o:Z

    iget-object v5, v1, Lix8;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, Lix8;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lix8;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lix8;->o:Z
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lix8;->l:Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lix8;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lix8;->j:Landroid/content/res/ColorStateList;

    return-object v0

    :cond_0
    invoke-super {p0}, Lip;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lix8;->i:Landroid/graphics/PorterDuff$Mode;

    return-object v0

    :cond_0
    invoke-super {p0}, Lip;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lix8;->b(Z)Lvx8;
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, Lip;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lip;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lvx8;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lix8;

    iput-boolean v0, v1, Lix8;->o:Z

    iget-object v0, v1, Lix8;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v1, Lix8;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lix8;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {v0, v1}, Lcom/google/android/material/button/MaterialButton;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V

    invoke-super {p0, p1}, Lip;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setCornerRadius(I)V
    ...
    iput-boolean v1, v0, Lix8;->p:Z

    iget-object v1, v0, Lix8;->b:Lmbf;

    int-to-float p1, p1

    invoke-virtual {v1, p1}, Lmbf;->h(F)Lmbf;

    move-result-object p1

    invoke-virtual {v0, p1}, Lix8;->c(Lmbf;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lix8;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {v0, p1, v1}, Lix8;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lgx8;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->f:Lgx8;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->f:Lgx8;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lix8;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lix8;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p1, :cond_0

    iput-object p1, v0, Lix8;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1}, Lz8e;->c(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lix8;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lix8;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lix8;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lix8;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lix8;->b(Z)Lvx8;
    ...
    invoke-virtual {p1, v0}, Lvx8;->setTintList(Landroid/content/res/ColorStateList;)V

    :cond_0
    return-void

    :cond_1
    invoke-super {p0, p1}, Lip;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lix8;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lix8;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p1, v0}, Lvx8;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V

    :cond_0
    return-void

    :cond_1
    invoke-super {p0, p1}, Lip;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
