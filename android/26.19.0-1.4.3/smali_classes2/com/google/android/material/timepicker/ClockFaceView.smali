...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Ljcd;->materialClockStyle:I

    invoke-direct {p0, p1, p2, v0}, Lcod;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Lgnd;->ClockFaceView:[I

    sget v3, Lymd;->Widget_MaterialComponents_TimePicker_Clock:I
    ...
    sget v2, Lgnd;->ClockFaceView_clockNumberTextColor:I

    invoke-static {p1, p2, v2}, Lpt6;->o(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->c1:Landroid/content/res/ColorStateList;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Lkid;->material_clockface_view:I

    const/4 v5, 0x1

    invoke-virtual {v3, v4, p0, v5}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    sget v3, Lqed;->material_clock_hand:I
    ...
    sget v4, Lbdd;->material_clock_hand_padding:I
    ...
    sget v2, Lscd;->material_timepicker_clockface:I

    invoke-static {p1, v2}, Llb4;->l0(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v3, Lgnd;->ClockFaceView_clockFaceBackgroundColor:I

    invoke-static {p1, p2, v3}, Lpt6;->o(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    invoke-virtual {p0, v2}, Lcod;->setBackgroundColor(I)V
    ...
    sget v6, Lkid;->material_clockface_textview:I
    ...
    sget v7, Lqed;->material_value_index:I
    ...
    sget v8, Lqed;->material_clock_level:I
    ...
    invoke-static {v6, v7}, Lf3i;->l(Landroid/view/View;Lu4;)V

    iget-object v7, p0, Lcom/google/android/material/timepicker/ClockFaceView;->c1:Landroid/content/res/ColorStateList;
    ...
    sget p1, Lbdd;->material_time_picker_minimum_screen_height:I
    ...
    sget p1, Lbdd;->material_time_picker_minimum_screen_width:I
    ...
    sget p1, Lbdd;->material_clock_size:I
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {v1, v0, v1}, Ly70;->p(III)Ly70;
...
.method public final u()V
    ...
    :cond_0
    sget v5, Lqed;->material_clock_level:I
    ...
    sget v8, Lqed;->circle_center:I

    invoke-virtual {v0, v7}, Lm24;->g(I)Lh24;
