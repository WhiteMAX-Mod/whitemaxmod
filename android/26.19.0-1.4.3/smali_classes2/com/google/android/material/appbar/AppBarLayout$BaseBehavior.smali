...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lg4i;-><init>(I)V
...
.method public static I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;IIZ)V
    .locals 7
    ...
    invoke-virtual {p1, p2}, Lxo;->h(Landroid/view/View;)Z

    move-result v3

    :cond_4
    invoke-virtual {p1, v3}, Lxo;->g(Z)Z
    ...
    iget-object p0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lmig;

    iget-object p0, p0, Lmig;->b:Ljava/lang/Object;

    check-cast p0, Lmkf;

    invoke-virtual {p0, p1}, Lmkf;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
# virtual methods
.method public final A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;Landroid/view/View;I[I)V
    .locals 8
    ...
    invoke-virtual {p2}, Lxo;->getDownNestedPreScrollRange()I
    ...
    :cond_0
    invoke-virtual {p2}, Lxo;->getUpNestedPreScrollRange()I
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->F(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    :goto_2
    iget-boolean p1, v4, Lxo;->l:Z

    if-eqz p1, :cond_2

    invoke-virtual {v4, p3}, Lxo;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {v4, p1}, Lxo;->g(Z)Z

    :cond_2
    return-void
.end method

.method public B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;Landroid/view/View;Landroid/view/View;II)Z
    .locals 0
...
.method public C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;Landroid/view/View;I)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;)V

    iget-boolean p1, p2, Lxo;->l:Z

    if-eqz p1, :cond_1

    invoke-virtual {p2, p3}, Lxo;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p2, p1}, Lxo;->g(Z)Z
...
.method public final D(Lto;Z)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lto;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lto;

    return-void
.end method

.method public final E(Landroid/os/Parcelable;Lxo;)Lto;
    .locals 7

    invoke-virtual {p0}, Lg4i;->s()I
    ...
    invoke-virtual {p2}, Lxo;->getTopInset()I
...
.method public final F(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, Lbea;->l(III)I

    move-result v2

    if-eq v4, v2, :cond_e

    iget-boolean v6, v3, Lxo;->e:Z
    ...
    iget-object v11, v10, Lvo;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v3}, Lxo;->getTopInset()I
    ...
    :goto_2
    iget-object v6, v0, Lg4i;->a:Lh4i;

    if-eqz v6, :cond_5

    invoke-virtual {v6, v8}, Lh4i;->b(I)Z
    ...
    iget-object v11, v10, Lvo;->b:Lb7c;

    if-eqz v11, :cond_8

    iget v10, v10, Lvo;->a:I
    ...
    invoke-virtual {v0}, Lg4i;->s()I

    move-result v12

    int-to-float v12, v12

    iget-object v13, v11, Lb7c;->c:Ljava/lang/Object;

    check-cast v13, Landroid/graphics/Rect;

    iget-object v11, v11, Lb7c;->b:Ljava/lang/Object;
    ...
    invoke-static {v15, v12, v8}, Lbea;->k(FFF)F
    ...
    iget-object v6, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lmig;

    iget-object v6, v6, Lmig;->b:Ljava/lang/Object;

    check-cast v6, Lmkf;

    invoke-virtual {v6, v3}, Lmkf;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v1, v9, v3}, Ldf4;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v6}, Lxo;->d(I)V
    ...
    :goto_8
    invoke-static {v1, v3, v2, v8, v5}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;IIZ)V
    ...
    :cond_e
    :goto_9
    invoke-static {v1}, Lf3i;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {v2, v0, v3, v1}, Lso;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Lxo;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, v2}, Lf3i;->l(Landroid/view/View;Lu4;)V
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;)V
    .locals 12
    ...
    invoke-static {v8, v0, v3}, Lbea;->l(III)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;I)V
...
.method public final g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->o:Lnkf;
...
.method public bridge synthetic h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->z(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;I)V
...
.method public final bridge synthetic k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {p1 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;Landroid/view/View;I[I)V
...
.method public final l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III[I)V
    ...
    invoke-virtual {v2}, Lxo;->getDownNestedScrollRange()I
    ...
    invoke-direct {p1, p0, v2, v1}, Lso;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Lxo;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, p1}, Lf3i;->l(Landroid/view/View;Lu4;)V
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->D(Lto;Z)V

    iget-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lto;

    iget-object p1, p1, Lf0;->a:Landroid/os/Parcelable;
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->E(Landroid/os/Parcelable;Lxo;)Lto;
...
.method public bridge synthetic p(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;Landroid/view/View;Landroid/view/View;II)Z
...
.method public bridge synthetic q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;Landroid/view/View;I)V
...
.method public final r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Lxo;->getDownNestedScrollRange()I

    move-result v3

    neg-int v3, v3

    invoke-virtual {v1}, Lxo;->getTopInset()I
    ...
    invoke-virtual {v3}, Lxo;->getTotalScrollRange()I

    move-result v4

    neg-int v4, v4

    iget-object v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Laxh;

    if-eqz v5, :cond_5

    invoke-virtual {v2, v5}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v7, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Laxh;
    ...
    invoke-direct/range {v0 .. v5}, Laxh;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iput-object v1, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Laxh;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;)V

    iget-boolean v2, v3, Lxo;->l:Z

    if-eqz v2, :cond_8

    invoke-static {v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->x(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Landroid/view/View;

    move-result-object v1

    invoke-virtual {v3, v1}, Lxo;->h(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v3, v1}, Lxo;->g(Z)Z
...
.method public final w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;I)V
    .locals 5
    ...
    sget-object v3, Lri;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-direct {v3, p0, p1, p2, v4}, Lro;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/view/View;I)V
...
.method public z(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;I)V
    .locals 4

    invoke-super {p0, p1, p2, p3}, Lg4i;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z

    invoke-virtual {p2}, Lxo;->getPendingAction()I
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->G(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V

    goto :goto_2

    :cond_0
    iget-boolean p3, v0, Lto;->d:Z

    if-eqz p3, :cond_1

    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->G(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lto;

    iget-boolean v3, v3, Lto;->g:Z
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->G(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;I)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lto;
    ...
    invoke-static {p3, v0, v1}, Lbea;->l(III)I
    ...
    invoke-virtual {v0, p3}, Lh4i;->b(I)Z
    ...
    invoke-static {p1, p2, p3, v1, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lxo;IIZ)V

    invoke-virtual {p0}, Lg4i;->s()I

    move-result p3

    invoke-virtual {p2, p3}, Lxo;->d(I)V

    invoke-static {p1}, Lf3i;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p3, p0, p2, p1}, Lso;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Lxo;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {p1, p3}, Lf3i;->l(Landroid/view/View;Lu4;)V
