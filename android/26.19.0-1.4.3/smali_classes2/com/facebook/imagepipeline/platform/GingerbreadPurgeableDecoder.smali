...
.method public static g(Loi3;I[B)Landroid/os/MemoryFile;
    .locals 8
    ...
    invoke-direct {v1, v4}, Lemc;-><init>(Lwl9;)V
    :try_end_0
    ...
    invoke-direct {v4, v1, p1}, Lcd8;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v4}, Lqi3;->b(Ljava/io/InputStream;)V

    invoke-static {v3}, Lqi3;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v3}, Lqi3;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lqi3;->b(Ljava/io/InputStream;)V

    invoke-static {p2}, Lqi3;->a(Ljava/io/Closeable;)V
...
# virtual methods
.method public final c(Loi3;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Loi3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final d(Loi3;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    invoke-static {p2, p1}, Lcom/facebook/imagepipeline/nativecode/DalvikPurgeableDecoder;->e(ILoi3;)Z
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Loi3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final h(Loi3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->g(Loi3;I[B)Landroid/os/MemoryFile;
    ...
    invoke-static {p2, p3}, Lrpd;->i(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Lpxj;->e(Ljava/lang/Throwable;)V
...
.method public final i(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-static {p1}, Lpxj;->e(Ljava/lang/Throwable;)V
