...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lr1h;->t:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lr1h;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    iput-object v1, p0, Lr1h;->b:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lr1h;->c:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, Lr1h;->d:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lr1h;->e:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lr1h;->f:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lr1h;->g:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lr1h;->h:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/PathMeasure;

    invoke-direct {p1}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object p1, p0, Lr1h;->i:Landroid/graphics/PathMeasure;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lr1h;->j:Landroid/graphics/RectF;

    new-instance p1, Ll1h;

    const/4 v3, 0x0

    invoke-direct {p1, v3, p0}, Ll1h;-><init>(ILr1h;)V

    const/4 v3, 0x3

    invoke-static {v3, p1}, Lc80;->j0(ILzt6;)Lfa8;

    move-result-object p1

    iput-object p1, p0, Lr1h;->k:Ljava/lang/Object;

    new-instance p1, Ll1h;

    const/4 v4, 0x1

    invoke-direct {p1, v4, p0}, Ll1h;-><init>(ILr1h;)V

    invoke-static {v3, p1}, Lc80;->j0(ILzt6;)Lfa8;

    move-result-object p1

    iput-object p1, p0, Lr1h;->l:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lr1h;->m:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lr1h;->n:Ljava/lang/Object;
...
.method public static a(Lr1h;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-direct {p0, p1}, Lr1h;->setDrawableColor(I)V
...
.method private final getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lr1h;->l:Ljava/lang/Object;
...
.method private final getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lr1h;->m:Ljava/lang/Object;
...
.method private final getLoadingAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lr1h;->k:Ljava/lang/Object;
...
.method private final getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, Lr1h;->n:Ljava/lang/Object;
...
.method private final setDrawableColor(I)V
    ...
    iget-object v1, p0, Lr1h;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;

    invoke-static {v1, v0, p1}, Lcj0;->L(Lgoh;Ljava/lang/String;I)V
...
.method public final b(IZ)V
    ...
    invoke-virtual {p0, v1}, Lr1h;->onThemeChanged(Ldob;)V
    ...
    invoke-direct {p2, p1, p0}, Lwz9;-><init>(ILr1h;)V

    invoke-static {p0, p2}, Lgn8;->p(Landroid/view/View;Lzt6;)V
    ...
    :cond_2
    iget-object p2, p0, Lr1h;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    invoke-virtual {p2, v2, v3}, Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;->setDuration(J)V
    ...
    invoke-direct {p0}, Lr1h;->getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lr1h;->getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {v2, p2}, Lpl0;->d(Landroid/content/Context;)Lhf3;
    ...
    iget-boolean v0, p0, Lr1h;->r:Z

    invoke-static {p2, v0}, Leja;->d(Lhk5;Z)Lsnb;

    move-result-object p2

    iget-object p2, p2, Lsnb;->c:Lqnb;

    iget p2, p2, Lqnb;->a:I

    invoke-direct {p0, p2}, Lr1h;->setDrawableColor(I)V
    ...
    iget-boolean p2, p0, Lr1h;->s:Z

    if-nez p2, :cond_8

    invoke-direct {p0}, Lr1h;->getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lr1h;->getLoadingAnimator()Landroid/animation/ValueAnimator;
...
.method public final onAttachedToWindow()V
    ...
    invoke-direct {v1, v0, p0}, Lwz9;-><init>(ILr1h;)V

    invoke-static {p0, v1}, Lgn8;->p(Landroid/view/View;Lzt6;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lr1h;->d:Landroid/graphics/Paint;

    iget-object v3, p0, Lr1h;->j:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-object v0, p0, Lr1h;->i:Landroid/graphics/PathMeasure;
    ...
    iget-object v4, p0, Lr1h;->h:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    cmpl-float v5, v2, v8

    iget-object v6, p0, Lr1h;->f:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lr1h;->b:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lr1h;->c:Landroid/widget/ImageView;
...
.method public final onMeasure(II)V
    ...
    invoke-static {v0, v1, v2}, Lc72;->b(FFI)I
    ...
    iget-object v4, p0, Lr1h;->b:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lr1h;->c:Landroid/widget/ImageView;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lr1h;->j:Landroid/graphics/RectF;

    const/4 p4, 0x0

    invoke-virtual {p3, p4, p4, p1, p2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lr1h;->g:Landroid/graphics/Path;
    ...
    iget-object p4, p0, Lr1h;->e:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Lr1h;->i:Landroid/graphics/PathMeasure;
...
.method public final onThemeChanged(Ldob;)V
    ...
    iget-boolean v1, p0, Lr1h;->r:Z

    invoke-static {p1, v1}, Leja;->d(Lhk5;Z)Lsnb;

    move-result-object p1

    iget-object v1, p1, Lsnb;->d:Lonb;
    ...
    iget-object v5, p0, Lr1h;->e:Landroid/graphics/Paint;

    invoke-virtual {v5, v4}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v4, p0, Lr1h;->s:Z
    ...
    :goto_0
    iget-object v4, p0, Lr1h;->f:Landroid/graphics/Paint;

    invoke-virtual {v4, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v1, p0, Lr1h;->s:Z
    ...
    iget-object v4, p0, Lr1h;->c:Landroid/widget/ImageView;
    ...
    :goto_3
    invoke-direct {p0, v2}, Lr1h;->setDrawableColor(I)V
