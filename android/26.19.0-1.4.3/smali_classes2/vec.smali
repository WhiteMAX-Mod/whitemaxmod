...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v4, Ln9h;->s:Lerg;

    invoke-static {v4, v2}, Lerg;->e(Lerg;Landroid/widget/TextView;)V

    iput-object v2, p0, Lvec;->c:Landroid/widget/TextView;
    ...
    invoke-virtual {v3, v5}, Lpl0;->l(Landroid/view/View;)Lgob;
    ...
    invoke-static {v4, v5}, Lerg;->e(Lerg;Landroid/widget/TextView;)V

    iput-object v5, p0, Lvec;->d:Landroid/widget/TextView;
    ...
    invoke-static {v7, v8}, Lg63;->h0(IF)I
    ...
    iput-object v7, v6, Lgsh;->a:Landroid/widget/ImageView;
    ...
    iput-object v7, v6, Lgsh;->c:Landroid/widget/ProgressBar;

    new-instance v7, Landroid/widget/TextView;

    invoke-direct {v7, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v7}, Lpl0;->l(Landroid/view/View;)Lgob;
    ...
    sget-object p1, Ln9h;->o:Lerg;

    invoke-static {p1, v7}, Lerg;->e(Lerg;Landroid/widget/TextView;)V
    ...
    iput-object v7, v6, Lgsh;->b:Landroid/widget/TextView;
    ...
    invoke-direct {p1, p0, v0}, Ljc9;-><init>(Landroid/view/KeyEvent$Callback;I)V
...
# virtual methods
.method public final a(Law2;)V
    .locals 5

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-boolean v0, p1, Law2;->b:Z

    iget-object p1, p1, Law2;->a:Lrr6;
    ...
    iget-object v3, p1, Lrr6;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iput-object v3, p0, Lvec;->g:Lrr6;

    if-eqz v3, :cond_2

    iget-object v1, v3, Lrr6;->a:Landroid/graphics/Bitmap;

    :cond_2
    iget-object v3, p0, Lvec;->f:Lgsh;

    iget-object v4, v3, Lgsh;->a:Landroid/widget/ImageView;
    ...
    iget-object v2, v3, Lgsh;->c:Landroid/widget/ProgressBar;
...
.method public final getListener()Luec;
    .locals 1

    iget-object v0, p0, Lvec;->i:Luec;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1, p4, p2, p3, p5}, Luh3;->G(Landroid/view/View;IIII)V

    :cond_0
    iget-object p1, p0, Lvec;->c:Landroid/widget/TextView;

    const/4 p2, 0x0

    const/16 p5, 0xc

    invoke-static {p1, p4, p3, p2, p5}, Luh3;->G(Landroid/view/View;IIII)V
    ...
    iget-object v1, p0, Lvec;->d:Landroid/widget/TextView;
    ...
    invoke-static {v1, v0, p3, p2, p5}, Luh3;->G(Landroid/view/View;IIII)V
    ...
    iget-object p3, p0, Lvec;->e:Lkfc;

    invoke-static {p3, p4, p1, p2, p5}, Luh3;->G(Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    iget-object v3, p0, Lvec;->c:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lvec;->d:Landroid/widget/TextView;
...
.method public final setListener(Luec;)V
    .locals 0

    iput-object p1, p0, Lvec;->i:Luec;
