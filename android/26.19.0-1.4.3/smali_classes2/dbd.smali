...
.field public final m:Lz52;

.field public final n:Lffb;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Ldbd;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Ldbd;->g:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v10, v7}, Lpl0;->d(Landroid/content/Context;)Lhf3;
    ...
    iput-object v5, v0, Ldbd;->h:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v7, Lffb;

    invoke-direct {v7, v1}, Lffb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lffb;->setMode(Lcfb;)V
    ...
    invoke-virtual {v7, v11, v9, v13}, Lffb;->a(FILjava/lang/String;)V

    new-instance v9, Lzad;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lzad;-><init>(Ldbd;I)V

    invoke-static {v7, v9}, Lvff;->K0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Ldbd;->i:Lffb;
    ...
    invoke-virtual {v10, v13}, Lpl0;->d(Landroid/content/Context;)Lhf3;
    ...
    iput-object v9, v0, Ldbd;->j:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v10, v8}, Lpl0;->d(Landroid/content/Context;)Lhf3;
    ...
    invoke-interface {v8}, Ldob;->n()Ltnb;
    ...
    iput-object v13, v0, Ldbd;->k:Landroid/widget/LinearLayout;

    new-instance v3, Lffb;

    invoke-direct {v3, v1}, Lffb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lffb;->setMode(Lcfb;)V

    new-instance v6, Lzad;

    const/4 v8, 0x1

    invoke-direct {v6, v0, v8}, Lzad;-><init>(Ldbd;I)V

    invoke-static {v3, v6}, Lvff;->K0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Ldbd;->l:Lffb;

    new-instance v6, Lz52;

    invoke-direct {v6, v1}, Lz52;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v8, v0, v9}, Lzad;-><init>(Ldbd;I)V

    invoke-static {v6, v8}, Lvff;->K0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Ldbd;->m:Lz52;

    new-instance v8, Lffb;

    invoke-direct {v8, v1}, Lffb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lffb;->setMode(Lcfb;)V
    ...
    invoke-virtual {v8, v11, v9, v10}, Lffb;->a(FILjava/lang/String;)V

    new-instance v9, Lzad;

    const/4 v10, 0x3

    invoke-direct {v9, v0, v10}, Lzad;-><init>(Ldbd;I)V

    invoke-static {v8, v9}, Lvff;->K0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Ldbd;->n:Lffb;

    new-instance v9, Lffb;

    invoke-direct {v9, v1}, Lffb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v2}, Lffb;->setMode(Lcfb;)V

    new-instance v2, Lzad;

    const/4 v10, 0x4

    invoke-direct {v2, v0, v10}, Lzad;-><init>(Ldbd;I)V

    invoke-static {v9, v2}, Lvff;->K0(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v9, v0, Ldbd;->o:Lffb;
    ...
    invoke-direct {v3, v2, v1, v7}, Liv7;-><init>(ILlx0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lbq4;->b(Landroid/view/View;Liv7;Lbu6;)V

    iput-object v6, v0, Ldbd;->p:Landroid/widget/FrameLayout;

    new-instance v1, Labd;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Labd;-><init>(Ldbd;I)V

    invoke-static {v2, v1}, Lc80;->j0(ILzt6;)Lfa8;

    move-result-object v1

    iput-object v1, v0, Ldbd;->q:Ljava/lang/Object;
    ...
    iput-object v1, v0, Ldbd;->r:Ljava/lang/Object;
    ...
    iput-object v1, v0, Ldbd;->s:Ljava/lang/Object;
...
.method public static final synthetic a(Ldbd;)Z
    .locals 0

    invoke-direct {p0}, Ldbd;->getCanRecordingVideo()Z
...
.method public static final b(Ldbd;Lebd;)V
    .locals 7

    iget-object v0, p0, Ldbd;->l:Lffb;
    ...
    invoke-static {p0, p1, v0}, Lq98;->V(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_1
    iget-boolean v1, p1, Lebd;->d:Z
    ...
    invoke-direct {p0}, Ldbd;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-direct {p0}, Ldbd;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    invoke-direct {p0}, Ldbd;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v6, v2}, Lffb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Ldbd;->getCameraApi()Lz42;
    ...
    :goto_4
    invoke-interface {p0, p1}, Lz42;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Ldbd;FFFFF)V
    .locals 2

    iget-object v0, p0, Ldbd;->h:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Ldbd;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Ldbd;->p:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Ldbd;->q:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Ldbd;->s:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Ldbd;->r:Ljava/lang/Object;
...
.method public final getCameraApi()Lz42;
    .locals 1

    iget-object v0, p0, Ldbd;->g:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
