...
.method public static b(Lcv9;)Lgma;
    .locals 15
    ...
    :try_start_3
    invoke-static {v2, v1, v12}, Lq98;->I0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v14, v6, v12}, Ldh4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    invoke-direct {v10, v12}, Lhf9;-><init>(I)V

    invoke-static {p0, v10}, Lvff;->P0(Lcv9;Lcda;)Ljava/util/ArrayList;

    move-result-object v10

    if-eqz v10, :cond_d

    invoke-static {v10}, Lel3;->y0(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-direct {p0, v11, v10}, Lgma;-><init>(Ljava/lang/String;Ljava/util/List;)V
