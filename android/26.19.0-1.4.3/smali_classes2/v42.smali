...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljtg;Ld4c;Ljtj;Lijg;)V
    .locals 0
    ...
    iput-object p2, p0, Lv42;->b:Ljtg;

    iput-object p3, p0, Lv42;->c:Ld4c;

    iput-object p4, p0, Lv42;->d:Ljtj;

    iput-object p5, p0, Lv42;->e:Lijg;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lv42;->f:Landroid/util/ArrayMap;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lv42;->g:Landroid/util/ArrayMap;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lv42;->h:Landroid/util/ArrayMap;

    return-void
.end method

.method public static final a(Lv42;Ljava/lang/String;ZI)Lw32;
    .locals 8
    ...
    invoke-virtual {p0, p1}, Lv42;->e(Ljava/lang/String;)Landroid/hardware/camera2/CameraExtensionCharacteristics;

    move-result-object p0

    new-instance v3, Lw32;

    invoke-direct {v3, p1, p3, p0}, Lw32;-><init>(Ljava/lang/String;ILandroid/hardware/camera2/CameraExtensionCharacteristics;)V
...
.method public static final b(Lv42;Ljava/lang/String;Z)Lz32;
    .locals 12

    const-string v0, "CXCP"

    iget-object v1, p0, Lv42;->d:Ljtj;
    ...
    iget-object v4, p0, Lv42;->a:Landroid/content/Context;
    ...
    sget-object v11, Lgn5;->a:Lgn5;

    if-lt v9, v10, :cond_0

    :try_start_2
    invoke-static {}, Ly50;->c()Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    invoke-static {v11, v9}, Lc4f;->X(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v11, v9}, Lc4f;->W(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-direct {v1, p1, v4, p0, v11}, Lz32;-><init>(Ljava/lang/String;Landroid/hardware/camera2/CameraCharacteristics;Lv42;Ljava/util/Set;)V
...
.method public static final c(Lv42;)Z
    .locals 3

    iget-object p0, p0, Lv42;->c:Ld4c;
    ...
    iget-object v0, p0, Ld4c;->a:Landroid/content/Context;
    ...
    iput-boolean v1, p0, Ld4c;->b:Z

    :cond_1
    invoke-static {}, Landroid/os/Trace;->endSection()V

    :cond_2
    iget-boolean p0, p0, Ld4c;->b:Z
...
# virtual methods
.method public final d(Ljava/lang/String;)Lm82;
    .locals 3
    ...
    iget-object v0, p0, Lv42;->f:Landroid/util/ArrayMap;
    ...
    :try_start_1
    iget-object v1, p0, Lv42;->f:Landroid/util/ArrayMap;
    ...
    :cond_0
    :try_start_3
    invoke-static {p0}, Lv42;->c(Lv42;)Z
    ...
    invoke-static {p0, p1, v1}, Lv42;->b(Lv42;Ljava/lang/String;Z)Lz32;

    move-result-object v1

    iget-object v2, p0, Lv42;->f:Landroid/util/ArrayMap;
    ...
    invoke-static {p0, p1, v0}, Lv42;->b(Lv42;Ljava/lang/String;Z)Lz32;
...
.method public final e(Ljava/lang/String;)Landroid/hardware/camera2/CameraExtensionCharacteristics;
    ...
    iget-object v0, p0, Lv42;->h:Landroid/util/ArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lv42;->h:Landroid/util/ArrayMap;

    invoke-virtual {v1, p1}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    invoke-static {v1}, Lu32;->d(Ljava/lang/Object;)Landroid/hardware/camera2/CameraExtensionCharacteristics;
    ...
    iget-object v0, p0, Lv42;->a:Landroid/content/Context;
    ...
    invoke-static {v0, p1}, Lpe;->d(Landroid/hardware/camera2/CameraManager;Ljava/lang/String;)Landroid/hardware/camera2/CameraExtensionCharacteristics;
