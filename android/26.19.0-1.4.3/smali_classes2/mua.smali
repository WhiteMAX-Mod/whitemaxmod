...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Luyd;)V
    ...
    :cond_1
    invoke-virtual {p3, p2}, Lfv3;->G(I)Landroid/util/Pair;

    move-result-object p3

    iget-object p4, p3, Landroid/util/Pair;->first:Ljava/lang/Object;

    instance-of p4, p4, Lova;
    ...
    invoke-virtual {p3, v1}, Lyh8;->F(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lgi8;

    instance-of v2, v1, Liva;
    ...
    invoke-virtual {p3, v2}, Lkkf;->J(I)Lgi8;

    move-result-object p3

    instance-of v2, p3, Liva;
