...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lx8d;->a:Landroid/graphics/Paint;
    ...
    invoke-direct {v0, p0, v6}, Lw8d;-><init>(Lx8d;I)V

    invoke-virtual {p1, v0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lx8d;->c:Landroid/animation/ValueAnimator;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lx8d;->d:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lx8d;->f:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lx8d;->g:Landroid/graphics/RectF;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lx8d;->c:Landroid/animation/ValueAnimator;

    invoke-virtual {v0}, Landroid/animation/ValueAnimator;->cancel()V

    iget-object v0, p0, Lx8d;->h:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object v0, p0, Lx8d;->i:Landroid/animation/ValueAnimator;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Lx8d;->l:Z

    iget-object v1, p0, Lx8d;->d:Landroid/graphics/RectF;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lx8d;->e:Landroid/graphics/RectF;
    ...
    iget-object v3, p0, Lx8d;->f:Landroid/graphics/RectF;
    ...
    iget-object v7, p0, Lx8d;->a:Landroid/graphics/Paint;
...
.method public final setOnQrAnimationCompleteListener(Lzt6;)V
    .locals 0
