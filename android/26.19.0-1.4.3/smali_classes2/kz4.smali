...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lkz4;->k:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    sput-object v0, Lkz4;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    sput-object v0, Lkz4;->m:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>(ILandroid/util/Size;)V
    ...
    iput-object v0, p0, Lkz4;->a:Ljava/lang/Object;
    ...
    iput-object p2, p0, Lkz4;->h:Landroid/util/Size;
    ...
    invoke-direct {p1, p0, p2}, Ljz4;-><init>(Lkz4;I)V

    invoke-static {p1}, Lnkj;->a(Ld02;)Lf02;

    move-result-object p1

    iput-object p1, p0, Lkz4;->e:Lf02;

    new-instance p2, Ljz4;

    const/4 v0, 0x1

    invoke-direct {p2, p0, v0}, Ljz4;-><init>(Lkz4;I)V

    invoke-static {p2}, Lnkj;->a(Ld02;)Lf02;

    move-result-object p2

    iput-object p2, p0, Lkz4;->g:Lf02;
    ...
    sget-object p2, Lkz4;->m:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result p2

    sget-object v0, Lkz4;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p0, p2, v0, v1}, Lkz4;->e(IILjava/lang/String;)V
...
.method public a()V
    ...
    iget-object v1, p0, Lkz4;->a:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lkz4;->c:Z
    ...
    iput-boolean v2, p0, Lkz4;->c:Z

    iget-object v2, p0, Lkz4;->f:Lc02;

    invoke-virtual {v2, v3}, Lc02;->b(Ljava/lang/Object;)Z

    iget v2, p0, Lkz4;->b:I

    if-nez v2, :cond_0

    iget-object v2, p0, Lkz4;->d:Lc02;

    iput-object v3, p0, Lkz4;->d:Lc02;
...
.method public final b()V
    ...
    sget-object v4, Lkz4;->m:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v4}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v4

    sget-object v5, Lkz4;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    move-result v5

    invoke-virtual {p0, v4, v5, v0}, Lkz4;->e(IILjava/lang/String;)V
...
.method public final c()Lwi8;
    ...
    invoke-direct {v1, v2, p0}, Landroidx/camera/core/impl/DeferrableSurface$SurfaceClosedException;-><init>(Ljava/lang/String;Lkz4;)V
...
.method public final d()V
    ...
    invoke-direct {v0, v2, p0}, Landroidx/camera/core/impl/DeferrableSurface$SurfaceClosedException;-><init>(Ljava/lang/String;Lkz4;)V
    ...
    invoke-virtual {p0, v3, v4, v2}, Lkz4;->e(IILjava/lang/String;)V
