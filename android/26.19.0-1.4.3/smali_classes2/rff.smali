...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v7, Ln9h;->e:Lerg;

    invoke-static {v7, v3}, Lerg;->e(Lerg;Landroid/widget/TextView;)V

    iput-object v3, v0, Lrff;->v:Landroid/widget/TextView;

    new-instance v8, Lgq;

    const/4 v9, 0x0

    invoke-direct {v8, v1, v9}, Lgq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v7, v8}, Lerg;->e(Lerg;Landroid/widget/TextView;)V
    ...
    invoke-virtual {v12, v10}, Lpl0;->d(Landroid/content/Context;)Lhf3;
    ...
    new-instance v10, Lqff;

    invoke-direct {v10, v0, v8}, Lqff;-><init>(Lrff;Lgq;)V
    ...
    invoke-direct {v10, v14}, Lt15;-><init>(I)V
    ...
    iput-object v10, v0, Lrff;->x:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    sget-object v5, Lm5b;->b:Lm5b;

    invoke-virtual {v4, v5}, Lu5b;->setSize(Lm5b;)V

    sget-object v5, Ll5b;->b:Ll5b;

    invoke-virtual {v4, v5}, Lu5b;->setMode(Ll5b;)V

    sget-object v5, Lj5b;->a:Lj5b;

    invoke-virtual {v4, v5}, Lu5b;->setAppearance(Lj5b;)V
    ...
    invoke-direct {v7, v9, v0}, Llzb;-><init>(ILjava/lang/Object;)V

    invoke-static {v5, v7}, Lvff;->K0(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v12, v9}, Lpl0;->d(Landroid/content/Context;)Lhf3;
    ...
    invoke-static {v9, v7}, Lat6;->i0(ILandroid/graphics/drawable/Drawable;)V

    invoke-virtual {v5, v7}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v5, v0, Lrff;->z:Landroid/widget/ImageView;
    ...
    invoke-static {v9, v6}, Lat6;->i0(ILandroid/graphics/drawable/Drawable;)V

    invoke-virtual {v7, v6}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v7, v0, Lrff;->A:Landroid/widget/ImageView;
    ...
    invoke-direct {v9, v11}, Lsf4;-><init>(F)V
    ...
    iput-object v6, v0, Lrff;->B:Landroid/widget/LinearLayout;

    new-instance v3, Landroid/widget/TextView;

    invoke-direct {v3, v1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-static {v3, v12}, Lvdg;->i(Landroid/widget/TextView;Lpl0;)Lznb;
    ...
    iput-object v3, v0, Lrff;->C:Landroid/widget/TextView;
    ...
    iput-object v7, v0, Lrff;->D:Landroid/widget/TextView;
    ...
    invoke-direct {v1, v3, v0, v5, v4}, Lrma;-><init>(ILjava/lang/Object;Lkotlin/coroutines/Continuation;Z)V
...
.method public final B(Lgi8;)V
    ...
    invoke-virtual {p0, p1}, Lrff;->G(Lfpj;)V

    return-void
.end method

.method public final G(Lfpj;)V
    .locals 12
    ...
    iget-object v2, p0, Lrff;->D:Landroid/widget/TextView;

    iget-object v3, p0, Lrff;->A:Landroid/widget/ImageView;

    iget-object v4, p0, Lrff;->z:Landroid/widget/ImageView;

    iget-object v5, p0, Lrff;->B:Landroid/widget/LinearLayout;

    iget-object v6, p0, Lrff;->y:Lu5b;

    iget-object v7, p0, Lrff;->v:Landroid/widget/TextView;

    iget-object v8, p0, Lrff;->x:Landroidx/appcompat/widget/AppCompatTextView;

    iget-object v9, p0, Lrff;->w:Lgq;
    ...
    invoke-static {v9}, Lxw0;->d(Landroid/view/View;)V
    ...
    invoke-virtual {v9}, Lgq;->getText()Landroid/text/Editable;
    ...
    iget-object v4, v0, Lnff;->b:Ljava/lang/String;

    invoke-virtual {v3, v10}, Landroid/view/View;->setVisibility(I)V

    iget-boolean v3, v0, Lnff;->d:Z
    ...
    iget-object v2, v0, Lnff;->a:Ljava/lang/String;

    invoke-virtual {v7, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v2, p0, Lrff;->u:Lfpj;

    instance-of v2, v2, Lnff;

    if-nez v2, :cond_5

    const/4 v2, 0x1

    invoke-static {v9, v2}, Lxw0;->g(Landroid/view/View;Z)Z
    ...
    :goto_4
    iput-object p1, p0, Lrff;->u:Lfpj;

    invoke-virtual {p1}, Lfpj;->a()Lzqg;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-virtual {p1}, Lfpj;->b()Ljava/lang/Integer;
    ...
    :cond_6
    iget-object v0, p0, Lrff;->C:Landroid/widget/TextView;
