...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lmsg;-><init>(Ljava/lang/Object;Lnsg;I)V

    iput-object v0, p0, Lnsg;->a:Lmsg;
    ...
    invoke-direct {p0}, Lnsg;->getTheme()Ldob;

    move-result-object v0

    invoke-interface {v0}, Ldob;->B()Lunb;

    move-result-object v0

    iget-object v0, v0, Lunb;->a:Lr0h;
    ...
    iput-object p1, p0, Lnsg;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Lnsg;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lnsg;->e:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lnsg;->f:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lnsg;->g:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lnsg;)Ldob;
    .locals 0
...
.method private final getTheme()Ldob;
    ...
    invoke-virtual {p0}, Lnsg;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lfob;->a(Ljava/lang/String;)Lgob;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lnsg;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lnsg;->h:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lnsg;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lnsg;->i:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lnsg;->j:[Lf88;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lnsg;->c:Lmsg;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Lnsg;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lnsg;->f:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lnsg;->h:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lnsg;->e:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lnsg;->g:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lnsg;->i:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Ldob;)V
    ...
    :goto_0
    iget-object v0, p0, Lnsg;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lnsg;->b:Landroid/graphics/drawable/GradientDrawable;
