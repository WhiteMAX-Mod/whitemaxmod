...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Ll0j;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ll0j;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Lw1k;->c(ILjava/lang/String;)I
    ...
    invoke-static {v1, p1}, Lw1k;->c(ILjava/lang/String;)I
    ...
    iput v1, p0, Ll0j;->programId:I

    const-string v2, "glCreateProgram"

    invoke-static {v2}, Lw1k;->b(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lw1k;->b(Ljava/lang/String;)V
    ...
    iput v0, p0, Ll0j;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Lw1k;->a(ILjava/lang/String;)V
    ...
    iput v2, p0, Ll0j;->aTextureCoordLoc:I

    invoke-static {v2, p1}, Lw1k;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Ll0j;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Lw1k;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Ll0j;->texMatrixLoc:I
    ...
    iput v3, p0, Ll0j;->textureLocation:I
    ...
    iput v1, p0, Ll0j;->alphaLocation:I

    invoke-static {v3, p1}, Lw1k;->a(ILjava/lang/String;)V

    new-instance p1, Lyzi;

    invoke-direct {p1, v0, v2}, Lyzi;-><init>(II)V

    iput-object p1, p0, Ll0j;->frame:Lyzi;
...
.method public getTextureCoordLoc()I
    ...
    iget v0, p0, Ll0j;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget v0, p0, Ll0j;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ll0j;->firstFreeTexture:I
    ...
    invoke-static {p1}, Lw1k;->b(Ljava/lang/String;)V

    iget p1, p0, Ll0j;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Ll0j;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Ll0j;->frame:Lyzi;

    iget-object v0, v0, Lyzi;->a:Li0j;

    invoke-interface {v0}, Li0j;->a()V

    iget v0, p0, Ll0j;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Ll0j;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object v0, p0, Ll0j;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Ll0j;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Ll0j;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Ll0j;->firstFreeTexture:I

    iget-object v1, p0, Ll0j;->mvpMat:[F
    ...
    iput-object v1, p0, Ll0j;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Ll0j;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Ll0j;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Ll0j;->programId:I

    invoke-static {v1}, Landroid/opengl/GLES20;->glUseProgram(I)V

    const-string v1, "glUseProgram"

    invoke-static {v1}, Lw1k;->b(Ljava/lang/String;)V

    iget v1, p0, Ll0j;->mvpMatrixLoc:I

    iget-object v2, p0, Ll0j;->mvpMat:[F
    ...
    iget v2, p0, Ll0j;->texMatrixLoc:I

    iget-object v4, p0, Ll0j;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lw1k;->b(Ljava/lang/String;)V

    iget v0, p0, Ll0j;->textureLocation:I

    invoke-virtual {p0}, Ll0j;->getTarget()I

    move-result v1

    iget v2, p0, Ll0j;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Ll0j;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ll0j;->alphaLocation:I

    iget v1, p0, Ll0j;->alpha:F
    ...
    iget-object v3, p0, Ll0j;->customParams:Ljava/util/HashMap;
