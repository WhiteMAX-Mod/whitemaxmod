...
.method public final b(Lr0h;)V
    ...
    iget-object v2, v1, Lr0h;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lqta;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lzsa;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Lysa;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Lzsa;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lzsa;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lxsa;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Lqta;->d:Z

    if-eqz v1, :cond_8

    iget-object v1, v0, Lqta;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, Lysa;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lysa;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
