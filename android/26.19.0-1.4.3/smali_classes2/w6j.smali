...
.method public static b(Landroid/media/MediaRoute2Info;)Lub9;
    .locals 10
    ...
    invoke-static {p0}, Lag;->p(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lxa9;->i(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Lmh9;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Lmh9;->b:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Lxa9;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lxa9;->y(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lxa9;->C(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lxa9;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lag;->k(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lxa9;->z(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Lxa9;->g(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Lmh9;->n(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Lmh9;->o()Lub9;
