...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Lpj7;-><init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lfri;->b:Landroid/widget/TextView;
    ...
    iput-object v5, p0, Lfri;->c:Landroid/widget/TextView;

    new-instance v3, Lgt7;

    invoke-direct {v3, p1}, Lgt7;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p1}, Lpgg;-><init>(Logg;)V

    iput-object v2, p0, Lfri;->e:Lpgg;
    ...
    invoke-virtual {p0, p1}, Lfri;->onThemeChanged(Ldob;)V
...
.method public final a(Ldob;)V
    ...
    iget-object v1, p0, Lfri;->c:Landroid/widget/TextView;
...
.method public final onLayout(ZIIII)V
    ...
    :cond_0
    iget-object p1, p1, Lmri;->b:Ljava/util/ArrayList;
    ...
    instance-of v2, v1, Ljri;

    const/16 v3, 0xc

    if-eqz v2, :cond_1

    iget-object v1, p0, Lfri;->d:Lgt7;
    ...
    invoke-static {v1, v2, p2, p5, v3}, Luh3;->G(Landroid/view/View;IIII)V

    goto :goto_2

    :cond_1
    instance-of v2, v1, Lkri;

    if-eqz v2, :cond_2

    iget-object v1, p0, Lfri;->a:Lpj7;
    ...
    :cond_2
    instance-of v2, v1, Llri;

    if-eqz v2, :cond_4

    check-cast v1, Llri;

    iget-boolean v1, v1, Llri;->c:Z
    ...
    :cond_3
    iget-object v1, p0, Lfri;->b:Landroid/widget/TextView;
...
.method public final onMeasure(II)V
    ...
    :cond_0
    iget-object p1, v0, Lmri;->b:Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Lkri;->a:Landroid/util/Size;
    ...
    :cond_2
    instance-of v5, v4, Llri;

    if-eqz v5, :cond_4

    check-cast v4, Llri;

    iget-boolean v4, v4, Llri;->c:Z
    ...
    iget-object v4, p0, Lfri;->c:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lfri;->b:Landroid/widget/TextView;
...
.method public final onThemeChanged(Ldob;)V
    ...
    invoke-virtual {p0, p1}, Lfri;->a(Ldob;)V

    return-void
.end method

.method public final setKeyboardListener(Lft7;)V
    .locals 1

    iget-object v0, p0, Lfri;->d:Lgt7;

    invoke-virtual {v0, p1}, Lgt7;->setClickListener(Lft7;)V
