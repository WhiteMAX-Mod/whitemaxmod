...
# static fields
.field public static final b:Lwlf;
...
.field public static final j:Lbp4;

.field public static final k:Lnkf;

.field public static l:Lbwj;

.field public static m:Lgxj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpf5;->i:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lpf5;->j:Lbp4;

    new-instance v0, Lnkf;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lpf5;->k:Lnkf;

    new-instance v0, Lwlf;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lpf5;->b:Lwlf;

    new-instance v0, Lppf;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lpf5;->c:Lppf;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lpf5;->a:Landroid/content/Context;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v7, p1}, Lgn8;->q(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static c(Landroid/content/Context;Lof5;Ljava/lang/String;)Lpf5;
    .locals 29
    ...
    sget-object v13, Lpf5;->i:Ljava/lang/ThreadLocal;
    ...
    sget-object v9, Lpf5;->k:Lnkf;

    invoke-interface {v2, v1, v3, v9}, Lof5;->a(Landroid/content/Context;Ljava/lang/String;Lnf5;)Lfc0;
    ...
    invoke-direct {v0, v12}, Lpf5;-><init>(Landroid/content/Context;)V
    :try_end_0
    ...
    :goto_1
    iget-object v1, v15, Lrtj;->a:Landroid/database/Cursor;
    ...
    :try_start_3
    invoke-static/range {p0 .. p0}, Lpf5;->e(Landroid/content/Context;)Z

    move-result v4

    if-eqz v4, :cond_11

    sget-object v4, Lpf5;->d:Ljava/lang/Boolean;
    ...
    iget-object v6, v2, Lrtj;->a:Landroid/database/Cursor;
    ...
    iget-object v2, v2, Lrtj;->a:Landroid/database/Cursor;

    new-instance v7, Lmxa;

    const/4 v10, 0x0

    invoke-direct {v7, v10}, Lmxa;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v4, v6}, Lmxa;-><init>(Ljava/lang/Object;)V

    new-instance v6, Lmxa;

    invoke-direct {v6, v2}, Lmxa;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v5, v4, v3, v0, v6}, Lgxj;->r0(Lmxa;Ljava/lang/String;ILmxa;)Lkh7;
    ...
    invoke-virtual {v5, v4, v3, v0, v6}, Lgxj;->q0(Lmxa;Ljava/lang/String;ILmxa;)Lkh7;
    ...
    invoke-direct {v2, v0}, Lpf5;-><init>(Landroid/content/Context;)V
    ...
    invoke-static/range {p0 .. p0}, Lpf5;->h(Landroid/content/Context;)Lbwj;
    ...
    invoke-virtual {v2, v5, v6}, Lb2j;->L(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    :try_start_d
    invoke-direct {v5, v7}, Lmxa;-><init>(Ljava/lang/Object;)V

    iget-object v4, v4, Lrtj;->a:Landroid/database/Cursor;

    new-instance v6, Lmxa;

    invoke-direct {v6, v4}, Lmxa;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2, v5, v3, v0, v6}, Lbwj;->t0(Lmxa;Ljava/lang/String;ILmxa;)Lkh7;
    ...
    invoke-direct {v4, v7}, Lmxa;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2, v4, v3, v0}, Lbwj;->r0(Lmxa;Ljava/lang/String;I)Lkh7;
    ...
    invoke-virtual {v2, v4, v3, v0}, Lbwj;->q0(Lmxa;Ljava/lang/String;I)Lkh7;
    ...
    invoke-direct {v4, v2, v5, v6}, Lcc6;-><init>(IIB)V

    move-object/from16 v2, p1

    invoke-interface {v2, v7, v3, v4}, Lof5;->a(Landroid/content/Context;Ljava/lang/String;Lnf5;)Lfc0;
    ...
    invoke-direct {v2, v12}, Lpf5;-><init>(Landroid/content/Context;)V
    :try_end_11
    ...
    :goto_b
    iget-object v0, v15, Lrtj;->a:Landroid/database/Cursor;
    ...
    :cond_13
    sget-object v0, Lpf5;->i:Ljava/lang/ThreadLocal;
    ...
    :cond_18
    sget-object v1, Lpf5;->i:Ljava/lang/ThreadLocal;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Z)I
    ...
    :try_start_1
    sget-object v0, Lpf5;->d:Ljava/lang/Boolean;
    :try_end_1
    ...
    :try_start_4
    invoke-static {v8}, Lpf5;->g(Ljava/lang/ClassLoader;)V
    :try_end_4
    .catch Lcom/google/android/gms/dynamite/DynamiteModule$LoadingException; {:try_start_4 .. :try_end_4} :catch_0
    ...
    :cond_1
    invoke-static {p0}, Lpf5;->e(Landroid/content/Context;)Z
    ...
    :cond_3
    :try_start_8
    invoke-static {p0, p1, p2, v4}, Lpf5;->f(Landroid/content/Context;Ljava/lang/String;ZZ)I

    move-result v9

    sget-object v10, Lpf5;->e:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {}, Ls6j;->b()Ljava/lang/ClassLoader;
    ...
    invoke-static {}, Lbv;->f()V

    sget-object v10, Lpf5;->e:Ljava/lang/String;

    invoke-static {v10}, Lz9e;->r(Ljava/lang/Object;)V

    invoke-static {}, Ljava/lang/ClassLoader;->getSystemClassLoader()Ljava/lang/ClassLoader;

    move-result-object v11

    invoke-static {v11, v10}, Lbv;->d(Ljava/lang/ClassLoader;Ljava/lang/String;)Ldalvik/system/DelegateLastClassLoader;
    ...
    sget-object v11, Lpf5;->e:Ljava/lang/String;

    invoke-static {v11}, Lz9e;->r(Ljava/lang/Object;)V
    ...
    :goto_6
    sput-object v0, Lpf5;->d:Ljava/lang/Boolean;
    ...
    :try_start_11
    invoke-static {p0, p1, p2, v6}, Lpf5;->f(Landroid/content/Context;Ljava/lang/String;ZZ)I
    ...
    invoke-static {p0}, Lpf5;->h(Landroid/content/Context;)Lbwj;
    ...
    :cond_b
    :try_start_13
    invoke-virtual {v7}, Lb2j;->n0()Landroid/os/Parcel;

    move-result-object v0

    const/4 v2, 0x6

    invoke-virtual {v7, v0, v2}, Lb2j;->L(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    invoke-direct {v8, p0}, Lmxa;-><init>(Ljava/lang/Object;)V

    sget-object v2, Lpf5;->j:Lbp4;
    ...
    invoke-virtual/range {v7 .. v12}, Lbwj;->s0(Lmxa;Ljava/lang/String;ZJ)Lkh7;
    ...
    iget-object v2, v0, Lrtj;->a:Landroid/database/Cursor;

    if-nez v2, :cond_e

    iput-object p1, v0, Lrtj;->a:Landroid/database/Cursor;
    :try_end_14
    ...
    invoke-direct {p1, p0}, Lmxa;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v7}, Lb2j;->n0()Landroid/os/Parcel;

    move-result-object p2

    invoke-static {p2, p1}, Lk8j;->b(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    invoke-virtual {v7, p2, p1}, Lb2j;->L(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    invoke-virtual {v7, p2, v0}, Lb2j;->L(Landroid/os/Parcel;I)Landroid/os/Parcel;
...
.method public static e(Landroid/content/Context;)Z
    ...
    :cond_0
    sget-object v1, Lpf5;->h:Ljava/lang/Boolean;
    ...
    :cond_1
    sget-object v0, Lpf5;->h:Ljava/lang/Boolean;
    ...
    invoke-virtual {v4, p0, v5}, Lz27;->c(Landroid/content/Context;I)I
    ...
    sput-object p0, Lpf5;->h:Ljava/lang/Boolean;
...
.method public static f(Landroid/content/Context;Ljava/lang/String;ZZ)I
    ...
    sput-object p0, Lpf5;->e:Ljava/lang/String;
    ...
    :try_start_b
    sget-object v4, Lpf5;->i:Ljava/lang/ThreadLocal;
    ...
    iget-object v5, v4, Lrtj;->a:Landroid/database/Cursor;

    if-nez v5, :cond_e

    iput-object v8, v4, Lrtj;->a:Landroid/database/Cursor;
    :try_end_b
...
.method public static g(Ljava/lang/ClassLoader;)V
    ...
    invoke-direct {v1, p0, v0, v2}, Lb2j;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V

    :goto_0
    sput-object v1, Lpf5;->m:Lgxj;
    :try_end_0
...
.method public static h(Landroid/content/Context;)Lbwj;
    .locals 6
    ...
    invoke-direct {v3, p0, v4, v5}, Lb2j;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V

    :goto_0
    if-eqz v3, :cond_3

    sput-object v3, Lpf5;->l:Lbwj;
    :try_end_1
...
.method public final b(Ljava/lang/String;)Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object v0, p0, Lpf5;->a:Landroid/content/Context;
