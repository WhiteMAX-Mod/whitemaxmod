...
.method public constructor <init>(Landroid/hardware/camera2/params/DynamicRangeProfiles;)V
    ...
    iput-object p1, p0, Ljf5;->a:Landroid/hardware/camera2/params/DynamicRangeProfiles;
...
.method public static d(Ljava/util/Set;)Ljava/util/Set;
    ...
    sget-object v3, Lff5;->a:Ljava/util/LinkedHashMap;
...
.method public final a()Landroid/hardware/camera2/params/DynamicRangeProfiles;
    ...
    iget-object v0, p0, Ljf5;->a:Landroid/hardware/camera2/params/DynamicRangeProfiles;
...
.method public final b()Ljava/util/Set;
    ...
    invoke-static {v0}, Ljf5;->d(Ljava/util/Set;)Ljava/util/Set;
...
.method public final c(Lef5;)Ljava/util/Set;
    .locals 2

    sget-object v0, Lff5;->a:Ljava/util/LinkedHashMap;

    iget-object v0, p0, Ljf5;->a:Landroid/hardware/camera2/params/DynamicRangeProfiles;

    invoke-static {p1, v0}, Lff5;->a(Lef5;Landroid/hardware/camera2/params/DynamicRangeProfiles;)Ljava/lang/Long;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object p1, p0, Ljf5;->a:Landroid/hardware/camera2/params/DynamicRangeProfiles;
    ...
    invoke-static {p1}, Ljf5;->d(Ljava/util/Set;)Ljava/util/Set;
