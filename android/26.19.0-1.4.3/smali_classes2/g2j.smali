...
.method public abstract o0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
.end method
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lg2j;->o0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lg2j;->n0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Lhhj;->f:Lijj;

    iget-object p1, p1, Lijj;->a:Lq0k;

    if-eqz p1, :cond_9

    iget-object p2, p3, Lhhj;->e:Lbng;

    iget-object p4, p1, Lq0k;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lq0k;->e:Ljava/util/HashSet;
    ...
    new-instance p2, Lotj;

    invoke-direct {p2, v3, p1}, Lotj;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lq0k;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Lhhj;->d:Lovi;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lovi;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lb4j;

    invoke-direct {p4, p1, p2}, Lb4j;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lhhj;->e:Lbng;

    invoke-virtual {p1, p4}, Lbng;->d(Ljava/lang/Object;)V
    ...
    invoke-static {p1, p3}, Lgz5;->d(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, p3, Lkxj;->f:Liyj;

    iget-object p1, p1, Liyj;->a:Li4k;

    iget-object p2, p3, Lkxj;->e:Lbng;

    invoke-virtual {p1, p2}, Li4k;->d(Lbng;)V

    iget-object p1, p3, Lkxj;->d:Lpvi;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lpvi;->h(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lpvi;->h(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lbng;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lkxj;->g:Liyj;
    ...
    iget-object p1, p1, Liyj;->d:Lo0k;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lo0k;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lo0k;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lls;-><init>(I)V

    invoke-virtual {p2, p1}, Lbng;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Lg2j;->m0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
