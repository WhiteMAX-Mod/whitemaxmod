...
.method public final onFeatureEnabledChanged(Lpd1;Z)V
    ...
    invoke-static {v1, p2}, Lgz5;->m(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lg61;->a:Li61;

    iget-object p1, p1, Li61;->u:Ljwf;
...
.method public final onFeatureRolesChanged(Lpd1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
    .locals 12

    invoke-super {p0, p1, p2}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lpd1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
    ...
    invoke-static/range {v4 .. v11}, Lgb;->a(Lgb;ZZZZZZI)Lgb;
    ...
    invoke-direct {p2, v9}, Ljc;-><init>(Z)V
