...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lajc;->a:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lajc;->b:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Lajc;->c:Landroid/text/TextPaint;
    ...
    iput-object v1, p0, Lajc;->g:Lvhg;

    new-instance v0, Lzic;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lzic;-><init>(Lajc;I)V

    new-instance v1, Lvhg;

    invoke-direct {v1, v0}, Lvhg;-><init>(Lzt6;)V

    iput-object v1, p0, Lajc;->h:Lvhg;
    ...
    invoke-virtual {p0, p1}, Lajc;->onThemeChanged(Ldob;)V
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Luyd;)V
    ...
    invoke-static {p3, p4}, Lajc;->i(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
...
.method public final g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Luyd;)V
    ...
    invoke-static {p2, v2}, Lajc;->i(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-static {p2, v5}, Lajc;->i(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    iget-object v4, p0, Lajc;->j:Lucb;

    iget-object v5, p0, Lajc;->b:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Lajc;->c:Landroid/text/TextPaint;
...
.method public final onThemeChanged(Ldob;)V
    ...
    iget-object v3, p0, Lajc;->c:Landroid/text/TextPaint;
