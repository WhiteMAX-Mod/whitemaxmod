...
.method public constructor <init>(Lfa8;Lfa8;Lfa8;)V
    ...
    iput-object p3, p0, Ldzb;->a:Lfa8;

    iput-object p1, p0, Ldzb;->b:Lfa8;

    iput-object p2, p0, Ldzb;->c:Lfa8;
    ...
    iput-object p1, p0, Ldzb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Ldzb;->e:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Ldzb;->e:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lpy1;->d()V

    const/4 v3, 0x0

    iput-object v3, v2, Lpy1;->h:Limh;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lpy1;->i:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Ldzb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Ldzb;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Lu81;->b()Z

    move-result v2

    check-cast v1, Lpy1;

    iget-object v3, v1, Lpy1;->j:Lk0i;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lk0i;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lpy1;->d:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Ldzb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    iget-object v0, v0, Lk0i;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Ldzb;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Ldzb;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-virtual {p2}, Lazb;->c()Lfyb;

    move-result-object p2

    iget-object p2, p2, Lfyb;->a:Lho1;

    invoke-interface {p2}, Lho1;->t()Lk0i;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Ldzb;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    sget-object v2, Lq0i;->a:Lq0i;

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Ldzb;->a:Lfa8;
    ...
    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lqm1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lqm1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
