...
# direct methods
.method public synthetic constructor <init>(Lfy5;Lzt6;)V
    .locals 1
...
.method public synthetic constructor <init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iput-object p3, p0, Lt01;->c:Ljava/lang/Object;
...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lt01;->b:Ljava/lang/Object;

    check-cast v0, Lorg/webrtc/audio/WebRtcAudioRecord;

    iget-object v1, p0, Lt01;->c:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lzee;->a:Lzm;

    invoke-interface {v0, v1}, Lzm;->a(Lln;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lpfj;->a(Lun;)Ljava/lang/String;
    ...
    invoke-interface {v1}, Lln;->getOkParser()Ls68;
    ...
    :cond_1
    iget-object v3, v2, Lgze;->e:Ljava/lang/Object;
    ...
    iput-object v3, v2, Lgze;->b:Ljava/lang/Object;
    ...
    :goto_0
    iget-object v3, v2, Lgze;->b:Ljava/lang/Object;
    ...
    :cond_9
    :try_start_4
    invoke-virtual {v2, v0}, Lgze;->E(Landroid/content/Context;)Z

    move-result v2

    if-eqz v2, :cond_a

    invoke-static {v0, v1}, Lt7i;->c(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    iget-object v3, v0, Lg16;->a:Ljava/lang/String;

    iget-object v0, v0, Lg16;->b:Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;

    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;->isVideo()Z

    move-result v4

    iget-object v5, v1, Lh16;->j:Lzw7;

    invoke-virtual {v5, v0}, Lzw7;->a(Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v3, v0, v4}, Ls28;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V

    iget-object v0, v1, Lh16;->i:Lw28;
    ...
    invoke-direct {v1, v0, v2, v4, v3}, Lqpa;-><init>(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V
    ...
    invoke-direct {v0, v1}, Lt28;-><init>(Ljava/lang/Throwable;)V
    ...
    iget-object v2, v0, Lfy5;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v1, v0, Lwn4;->b:Lot4;

    invoke-virtual {v1}, Lot4;->b()Lpt4;

    move-result-object v1

    iget-object v8, v0, Lwn4;->c:Landroid/graphics/BitmapFactory$Options;

    iget v9, v0, Lwn4;->d:I

    iget-boolean v0, v0, Lwn4;->e:Z
    ...
    invoke-direct/range {v2 .. v7}, Lao4;-><init>(Landroid/net/Uri;JJ)V

    invoke-virtual {v1, v2}, Lpt4;->l(Lao4;)J
    ...
    invoke-virtual {v1, v2, v4, v3}, Lpt4;->read([BII)I
    ...
    invoke-static {v2, v3, v9, v8}, Lcjj;->a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v2

    if-eqz v0, :cond_10

    invoke-static {v2}, Lcjj;->c(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :cond_10
    :goto_d
    invoke-virtual {v1}, Lpt4;->close()V
    ...
    iget-boolean v2, v0, Lwn4;->e:Z

    array-length v3, v1

    iget-object v4, v0, Lwn4;->c:Landroid/graphics/BitmapFactory$Options;

    iget v0, v0, Lwn4;->d:I

    invoke-static {v1, v3, v0, v4}, Lcjj;->a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v0

    if-eqz v2, :cond_11

    invoke-static {v0}, Lcjj;->c(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iget-object v2, v0, Lv01;->g:Lmtf;

    invoke-virtual {v2, v1}, Lmtf;->w(Lskf;)V
    ...
    iget-object v3, v2, Lt55;->l:Ljava/lang/Object;

    monitor-enter v3

    :try_start_9
    invoke-static {v1}, Lq98;->S(Li31;)Ljava/util/ArrayList;
    ...
    iget-object v5, v2, Lt55;->g:Lbf5;

    invoke-virtual {v5, v4}, Lbf5;->remove(Ljava/lang/String;)J

    iget-object v5, v2, Lt55;->d:Ljava/util/HashSet;
