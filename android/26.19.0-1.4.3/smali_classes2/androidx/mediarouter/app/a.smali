...
.method public final onGlobalLayout()V
    ...
    :goto_0
    iget-object v7, v1, Landroidx/mediarouter/app/d;->D:Landroidx/mediarouter/app/OverlayListView;
    ...
    iget-object v12, v1, Landroidx/mediarouter/app/d;->E:Landroidx/mediarouter/app/c;
    ...
    :cond_1
    iget v12, v1, Landroidx/mediarouter/app/d;->d1:I
    ...
    iget-object v15, v1, Landroidx/mediarouter/app/d;->G:Ljava/util/HashSet;
    ...
    iget v15, v1, Landroidx/mediarouter/app/d;->x1:I
    ...
    iget v11, v1, Landroidx/mediarouter/app/d;->w1:I
    ...
    iget-object v11, v1, Landroidx/mediarouter/app/d;->z1:Landroid/view/animation/Interpolator;
    ...
    iget-object v7, v1, Landroidx/mediarouter/app/d;->H:Ljava/util/HashSet;
    ...
    invoke-direct {v5, v4, v6}, Lyvb;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    const/4 v12, 0x0

    iput v12, v5, Lyvb;->h:F

    iget v4, v1, Landroidx/mediarouter/app/d;->y1:I

    int-to-long v6, v4

    iput-wide v6, v5, Lyvb;->e:J

    iget-object v4, v1, Landroidx/mediarouter/app/d;->z1:Landroid/view/animation/Interpolator;

    iput-object v4, v5, Lyvb;->d:Landroid/view/animation/Interpolator;
    ...
    iget v7, v1, Landroidx/mediarouter/app/d;->d1:I

    mul-int/2addr v7, v2

    new-instance v9, Lyvb;

    invoke-direct {v9, v4, v6}, Lyvb;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    iput v7, v9, Lyvb;->g:I

    iget v4, v1, Landroidx/mediarouter/app/d;->w1:I

    int-to-long v6, v4

    iput-wide v6, v9, Lyvb;->e:J

    iget-object v4, v1, Landroidx/mediarouter/app/d;->z1:Landroid/view/animation/Interpolator;

    iput-object v4, v9, Lyvb;->d:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v4, v1, v5, v7, v6}, Lsf;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V

    iput-object v4, v9, Lyvb;->l:Lsf;

    iget-object v4, v1, Landroidx/mediarouter/app/d;->I:Ljava/util/HashSet;
