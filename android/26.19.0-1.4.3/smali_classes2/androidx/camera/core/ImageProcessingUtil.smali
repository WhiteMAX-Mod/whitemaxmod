...
.method public static a(Lal7;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lal7;)Z
    ...
    invoke-static {v1, p0}, Lyxb;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Lr19;[B)Lal7;
    .locals 2

    invoke-virtual {p0}, Lr19;->f()I
    ...
    invoke-virtual {p0}, Lr19;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p1}, Lyxb;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    return-object p0
.end method

.method public static c(Lal7;)Landroid/graphics/Bitmap;
    .locals 14
...
.method public static d(Lal7;Ldl7;Ljava/nio/ByteBuffer;IZ)Lxi7;
    .locals 22

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lal7;)Z
    ...
    invoke-static {v2, v0}, Lyxb;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-interface/range {p1 .. p1}, Ldl7;->getSurface()Landroid/view/Surface;
    ...
    invoke-interface {v7}, Lzk7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    :cond_6
    invoke-interface/range {p1 .. p1}, Ldl7;->e()Lal7;
    ...
    invoke-direct {v1, v0}, Lxi7;-><init>(Lal7;)V
    ...
    invoke-direct {v2, v0, v4, v3}, Lwk7;-><init>(Lal7;Lal7;I)V

    invoke-virtual {v1, v2}, Lmp6;->i(Llp6;)V
...
.method public static i(Lal7;Ldl7;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lxi7;
    .locals 25
    ...
    invoke-interface {v10}, Lzk7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Lzk7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v12}, Lzk7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static j(Lal7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lxi7;
    .locals 25
    ...
    invoke-interface {v6}, Lzk7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-direct/range {v6 .. v12}, Lyk7;-><init>(Lal7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II)V

    invoke-direct {v0, v6}, Lxi7;-><init>(Lal7;)V
...
.method public static k([BLandroid/view/Surface;)V
    ...
    invoke-static {p0, p1}, Lyxb;->c(Ljava/lang/String;Ljava/lang/String;)V
