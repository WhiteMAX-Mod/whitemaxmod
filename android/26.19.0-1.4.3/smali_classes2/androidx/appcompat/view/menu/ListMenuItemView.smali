...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Llcd;->listMenuViewStyle:I
    ...
    sget-object v2, Lrnd;->MenuView:[I

    invoke-static {v1, p2, v2, v0}, Ls76;->j(Landroid/content/Context;Landroid/util/AttributeSet;[II)Ls76;

    move-result-object p2

    sget v0, Lrnd;->MenuView_android_itemBackground:I

    invoke-virtual {p2, v0}, Ls76;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->j:Landroid/graphics/drawable/Drawable;

    sget v0, Lrnd;->MenuView_android_itemTextAppearance:I

    iget-object v1, p2, Ls76;->b:Ljava/lang/Object;
    ...
    sget v0, Lrnd;->MenuView_preserveIconSpacing:I
    ...
    sget v0, Lrnd;->MenuView_subMenuArrow:I
    ...
    sget v1, Llcd;->dropDownListViewStyle:I
...
.method public final c(Lvm9;)V
    .locals 10

    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvm9;

    invoke-virtual {p1}, Lvm9;->isVisible()Z
    ...
    iget-object v0, p1, Lvm9;->e:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Lvm9;->isCheckable()Z

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setCheckable(Z)V

    invoke-virtual {v1}, Lrm9;->p()Z
    ...
    invoke-virtual {v1}, Lrm9;->o()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Lvm9;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lvm9;->h:C
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvm9;

    iget-object v1, v0, Lvm9;->n:Lrm9;
    ...
    iget-char v0, v0, Lvm9;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Lvm9;->h:C
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvm9;

    iget-object v5, v1, Lvm9;->n:Lrm9;

    iget-object v6, v5, Lrm9;->a:Landroid/content/Context;

    invoke-virtual {v5}, Lrm9;->o()Z

    move-result v7

    if-eqz v7, :cond_6

    iget-char v7, v1, Lvm9;->j:C

    goto :goto_6

    :cond_6
    iget-char v7, v1, Lvm9;->h:C
    ...
    sget v6, Lumd;->abc_prepend_shortcut_label:I
    ...
    :goto_7
    sget v5, Lumd;->abc_menu_meta_shortcut_label:I
    ...
    invoke-static {v1, v6, v5, v9}, Lvm9;->b(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v5, Lumd;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v5, Lumd;->abc_menu_alt_shortcut_label:I
    ...
    sget v5, Lumd;->abc_menu_shift_shortcut_label:I

    invoke-virtual {v8, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v5

    invoke-static {v1, v4, v5, v9}, Lvm9;->b(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v4, Lumd;->abc_menu_sym_shortcut_label:I
    ...
    invoke-static {v1, v5, v4, v9}, Lvm9;->b(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v4, Lumd;->abc_menu_function_shortcut_label:I

    invoke-virtual {v8, v4}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v1, v2, v4, v9}, Lvm9;->b(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :cond_a
    sget v1, Lumd;->abc_menu_space_shortcut_label:I
    ...
    :cond_b
    sget v1, Lumd;->abc_menu_enter_shortcut_label:I
    ...
    :cond_c
    sget v1, Lumd;->abc_menu_delete_shortcut_label:I
    ...
    :cond_e
    invoke-virtual {p1}, Lvm9;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lvm9;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Lvm9;
    .locals 1
...
.method public setCheckable(Z)V
    ...
    sget v3, Loid;->abc_list_menu_item_radio:I
    ...
    sget v3, Loid;->abc_list_menu_item_checkbox:I
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvm9;

    invoke-virtual {p1}, Lvm9;->isChecked()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    sget v3, Loid;->abc_list_menu_item_icon:I
