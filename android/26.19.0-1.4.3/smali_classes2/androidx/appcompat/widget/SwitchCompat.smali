...
# static fields
.field public static final k1:Lfd8;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->k1:Lfd8;
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->l1:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {p0, v0}, Losg;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    sget-object v0, Lrnd;->SwitchCompat:[I

    invoke-static {p1, p2, v0, v5}, Ls76;->j(Landroid/content/Context;Landroid/util/AttributeSet;[II)Ls76;

    move-result-object v11

    iget-object v0, v11, Ls76;->b:Ljava/lang/Object;

    move-object v4, v0

    check-cast v4, Landroid/content/res/TypedArray;

    sget-object v2, Lrnd;->SwitchCompat:[I
    ...
    sget p1, Lrnd;->SwitchCompat_android_thumb:I

    invoke-virtual {v11, p1}, Ls76;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p1, Lrnd;->SwitchCompat_track:I
    ...
    :cond_1
    sget p1, Lrnd;->SwitchCompat_android_textOn:I
    ...
    sget p1, Lrnd;->SwitchCompat_android_textOff:I
    ...
    sget p1, Lrnd;->SwitchCompat_showText:I
    ...
    sget p1, Lrnd;->SwitchCompat_thumbTextPadding:I
    ...
    sget p1, Lrnd;->SwitchCompat_switchMinWidth:I
    ...
    sget p1, Lrnd;->SwitchCompat_switchPadding:I
    ...
    sget p1, Lrnd;->SwitchCompat_splitTrack:I
    ...
    sget p1, Lrnd;->SwitchCompat_thumbTint:I

    invoke-virtual {v11, p1}, Ls76;->a(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p1, Lrnd;->SwitchCompat_thumbTintMode:I
    ...
    invoke-static {p1, v7}, Lxb5;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget p1, Lrnd;->SwitchCompat_trackTint:I
    ...
    :cond_6
    sget p1, Lrnd;->SwitchCompat_trackTintMode:I
    ...
    :cond_9
    sget p1, Lrnd;->SwitchCompat_switchTextAppearance:I
    ...
    invoke-static {v1, v4}, Llb4;->l0(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v4, v0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/content/res/ColorStateList;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/content/res/ColorStateList;

    :goto_1
    sget v2, Lrnd;->TextAppearance_android_textSize:I
    ...
    :cond_c
    sget v2, Lrnd;->TextAppearance_android_typeface:I

    invoke-virtual {p1, v2, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    sget v4, Lrnd;->TextAppearance_android_textStyle:I
    ...
    :goto_6
    sget p2, Lrnd;->TextAppearance_textAllCaps:I
    ...
    iput-object v2, p2, Lxd;->a:Ljava/util/Locale;

    iput-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->f1:Lxd;

    goto :goto_7

    :cond_15
    iput-object v7, v0, Landroidx/appcompat/widget/SwitchCompat;->f1:Lxd;
    ...
    invoke-virtual {p1, v3, v5}, Lir;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v11}, Ls76;->k()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lhq;

    move-result-object p1

    invoke-virtual {p1, v3, v5}, Lhq;->b(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Lhq;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->h1:Lhq;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->h1:Lhq;
...
.method private getThumbScrollRange()I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Landroid/graphics/Rect;
    ...
    invoke-static {v0}, Lxb5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lxb5;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Lhq;->b:Lcm5;

    iget-object v0, v0, Lcm5;->a:Ljava/lang/Object;

    check-cast v0, Lc80;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->f1:Lxd;

    invoke-virtual {v0, v1}, Lc80;->w0(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method private setTextOnInternal(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/text/StaticLayout;
...
.method public final d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->i1:Lzl5;
    ...
    invoke-direct {v1, p0}, Lzl5;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->i1:Lzl5;

    invoke-virtual {v0, v1}, Lrk5;->f(Lpk5;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lxb5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lxb5;->c:Landroid/graphics/Rect;

    :goto_0
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/graphics/drawable/Drawable;

    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Landroid/graphics/Rect;
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->g1:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->g1:Landroid/animation/ObjectAnimator;
...
.method public final onCreateDrawableState(I)[I
    ...
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->l1:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lxb5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/text/StaticLayout;
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/content/res/ColorStateList;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p4, p1, Landroidx/appcompat/widget/SwitchCompat;->j1:Landroid/graphics/Rect;
    ...
    invoke-static {p2}, Lxb5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onMeasure(II)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/text/StaticLayout;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/text/StaticLayout;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/text/StaticLayout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->e1:Landroid/text/StaticLayout;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Landroid/graphics/Rect;
...
.method public setChecked(Z)V
    ...
    sget v1, Lcgd;->tag_state_description:I

    const/4 v5, 0x2

    invoke-direct/range {v0 .. v5}, Lr2i;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v0, p0, v6}, Liv8;->e(Landroid/view/View;Ljava/lang/Object;)V
    ...
    sget v1, Lumd;->abc_capital_off:I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->k1:Lfd8;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->g1:Landroid/animation/ObjectAnimator;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    sget v0, Lumd;->abc_capital_off:I
