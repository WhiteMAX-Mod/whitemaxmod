...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lns6;->f:Ljava/lang/String;

    new-instance v0, Lqm7;

    const/4 v2, 0x4

    invoke-direct {v0, v2}, Lhm7;-><init>(I)V
    ...
    invoke-virtual {v0, v2}, Lhm7;->d([Ljava/lang/Object;)V
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Lns6;->a:Landroid/media/MediaMuxer;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lns6;->b:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lns6;->c:Landroid/util/SparseArray;

    return-void
.end method

.method public static i(Landroid/media/MediaMuxer;)V
    .locals 5
...
.method public final P0(Lrn6;)I
    ...
    iget-object v5, p0, Lns6;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v6, p1, Lrn6;->D:Lnl3;

    invoke-static {v4, v6}, Lk6j;->d(Landroid/media/MediaFormat;Lnl3;)V
    ...
    :cond_10
    :goto_2
    iget-object v0, p1, Lrn6;->q:Ljava/util/List;

    invoke-static {v4, v0}, Lk6j;->i(Landroid/media/MediaFormat;Ljava/util/List;)V
...
.method public final U(Ln6a;)V
    ...
    iget-object v1, p0, Lns6;->a:Landroid/media/MediaMuxer;
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Lns6;->d:Z

    const/4 v1, 0x1

    iget-object v2, p0, Lns6;->a:Landroid/media/MediaMuxer;
    ...
    iput-boolean v0, p0, Lns6;->d:Z

    :try_start_1
    invoke-static {v2}, Lns6;->i(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final l0(ILjava/nio/ByteBuffer;Ltz0;)V
    ...
    iget-wide v3, v2, Ltz0;->a:J

    iget-boolean v5, v1, Lns6;->d:Z

    iget-object v6, v1, Lns6;->a:Landroid/media/MediaMuxer;

    const/4 v7, 0x1

    iget-object v8, v1, Lns6;->c:Landroid/util/SparseArray;
    ...
    iget-object v3, v1, Lns6;->b:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Lvmh;->l(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v8, v9, v5, v12}, Lvdg;->v(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v6, v7}, Lvdg;->v(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
