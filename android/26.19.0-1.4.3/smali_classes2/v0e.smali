...
.method public synthetic constructor <init>(Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;I)V
    ...
    iput-object p1, p0, Lv0e;->b:Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v5, p0, Lv0e;->b:Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;
    ...
    iget-object v7, v5, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->m:Lzrd;

    sget-object v8, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->u:[Lf88;

    aget-object v2, v8, v2

    invoke-interface {v7, v5, v2}, Lzrd;->C(Ljava/lang/Object;Lf88;)Ljava/lang/Object;
    ...
    iget-object v2, v5, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->c:Lmke;
    ...
    invoke-static {v6, v7, p1}, Lc72;->w(FFI)I

    move-result p1

    invoke-direct {v8, v2, p1}, Lone/me/login/neuroavatars/NeuroAvatarPickerBottomSheet;-><init>(Lmke;I)V
    ...
    invoke-static {v0, v7, v4, v1}, Lm;->k(ZLmde;ZLjava/lang/String;)V

    invoke-virtual {v3, v7}, Lide;->I(Lmde;)V
    ...
    invoke-virtual {v5}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->i1()Ls0e;
    ...
    :cond_4
    invoke-virtual {v5}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->j1()Lyma;
    ...
    sget v6, Lwkd;->oneme_login_neuro_avatars_bottomsheet_title:I

    invoke-static {v6, v3, v3, v2}, Lm;->c(ILandroid/os/Bundle;Lqke;I)Lsy3;
    ...
    invoke-virtual {v6}, Lbi8;->hasNext()Z

    move-result v7

    if-eqz v7, :cond_5

    invoke-virtual {v6}, Lbi8;->next()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lty3;

    filled-new-array {v6}, [Lty3;

    move-result-object v6

    invoke-virtual {v2, v6}, Lsy3;->a([Lty3;)V
    ...
    invoke-virtual {v5, v4}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->k1(Z)V
