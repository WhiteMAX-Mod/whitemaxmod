...
.method public constructor <init>(Lqbd;)V
    ...
    iput-object v0, p0, Lrbd;->b:Ljava/lang/String;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lrbd;->c:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lrbd;->d:Ljava/lang/ref/WeakReference;

    iget-object v0, p1, Lqbd;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lqbd;->c:Lsnb;

    invoke-virtual {p0, p1}, Lrbd;->d(Lsnb;)V
...
.method public final chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;)V
    ...
    .line 1
    invoke-virtual/range {v0 .. v7}, Lrbd;->chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
...
.method public final copy()Ljf4;
    ...
    invoke-direct {v0, v1}, Lrbd;-><init>(Lqbd;)V
...
.method public final d(Lsnb;)V
    ...
    iget-object v0, p0, Lrbd;->a:Lqbd;

    iput-object p1, v0, Lqbd;->c:Lsnb;
    ...
    iget-object p1, v0, Lqbd;->e:Landroid/graphics/drawable/Drawable;
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v6, v1, Lrbd;->a:Lqbd;

    iget-object v7, v6, Lqbd;->f:Lpbd;

    iget-object v8, v6, Lqbd;->t:Landroid/graphics/Path;

    iget v9, v6, Lqbd;->j:I

    iget v10, v6, Lqbd;->g:I

    iget v11, v6, Lqbd;->k:I

    iget v12, v6, Lqbd;->q:F

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Lpbd;->getAsInt()I
    ...
    :cond_2
    iget-object v7, v1, Lrbd;->d:Ljava/lang/ref/WeakReference;
    ...
    iput-object v5, v1, Lrbd;->d:Ljava/lang/ref/WeakReference;

    iput v13, v1, Lrbd;->e:F
    ...
    iget-object v7, v1, Lrbd;->b:Ljava/lang/String;
    ...
    iget-object v13, v1, Lrbd;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual/range {p5 .. p12}, Lrbd;->c(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v7, v6, Lqbd;->s:Landroid/graphics/Path;
    ...
    :try_start_5
    iget-object v7, v6, Lqbd;->w:Landroid/graphics/Path;
    ...
    iget-object v8, v6, Lqbd;->v:Landroid/graphics/Path;
    ...
    iget-object v2, v6, Lqbd;->u:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v2, v6, Lqbd;->x:Landroid/graphics/Path;
    ...
    :cond_1b
    iget-object v0, v6, Lqbd;->e:Landroid/graphics/drawable/Drawable;
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v1, v0, Lqbd;->d:Lerg;

    iget-object v2, v0, Lqbd;->a:Landroid/content/Context;

    iget-object v0, v0, Lqbd;->b:Lewf;
...
.method public final updateMeasureState(Landroid/text/TextPaint;)V
    ...
    iget-object p1, v0, Lqbd;->f:Lpbd;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lpbd;->getAsInt()I
