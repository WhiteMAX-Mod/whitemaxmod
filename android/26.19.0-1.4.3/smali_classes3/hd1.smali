...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhd1;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lpug;Lq19;Lp27;Ljz8;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhd1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lhd1;->b:Lpug;

    iput-object p3, p0, Lhd1;->c:Lq19;

    iput-object p4, p0, Lhd1;->d:Lp27;

    iput-object p5, p0, Lhd1;->e:Ljz8;

    iput-object p6, p0, Lhd1;->f:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lhd1;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Lhd1;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lhd1;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lel3;->c1(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Lhd1;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Ln1j;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Ln1j;->d:Ljava/lang/Long;
    ...
    iget-object v6, v1, Ln1j;->a:Ljava/lang/String;

    iget-object v1, v1, Ln1j;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Lhd1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Lhd1;->f:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    iget-object v1, p0, Lhd1;->b:Lpug;

    check-cast v1, Lrug;

    invoke-virtual {v1}, Lrug;->a()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Ln1j;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Lhd1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Lhd1;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lhd1;->h:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lhd1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Lhyg;Lhyg;)V
    ...
    iget-object p1, p0, Lhd1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    iget-object p2, p0, Lhd1;->e:Ljz8;

    iget-object v0, p0, Lhd1;->d:Lp27;

    iget-object v1, p0, Lhd1;->c:Lq19;

    if-eqz p1, :cond_0

    invoke-virtual {v1, p1}, Lq19;->s(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {v0, p1}, Lp27;->o(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {p2, p1}, Ljz8;->e(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    invoke-virtual {p0, p1}, Lhd1;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    :goto_0
    iput-object p1, p0, Lhd1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
