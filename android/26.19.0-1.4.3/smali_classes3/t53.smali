...
.method public constructor <init>(Lfa8;Lfa8;)V
    ...
    iput-object p1, p0, Lt53;->a:Lfa8;

    iput-object p2, p0, Lt53;->b:Lfa8;
...
.method public final a(JZLjc4;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p4}, Ls53;-><init>(Lt53;Ljc4;)V

    :goto_0
    iget-object p4, v0, Ls53;->e:Ljava/lang/Object;
    ...
    invoke-virtual {p4}, Lqk2;->Z()Z

    move-result p1

    if-eqz p1, :cond_5

    invoke-virtual {p4}, Lqk2;->q0()Z
    ...
    invoke-virtual/range {v0 .. v8}, Lv2b;->h(JJILjava/lang/String;ZLjava/util/Map;)J
