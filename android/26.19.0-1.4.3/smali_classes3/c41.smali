...
.method public synthetic constructor <init>(Ly41;Z)V
    .locals 0
...
.method public final run()V
    ...
    invoke-virtual {v0, v1, v2}, Ly41;->f(Lhyg;Z)V
    ...
    iget-object v4, v0, Ly41;->o0:Lyw1;

    invoke-virtual {v4, v2, v3}, Lyw1;->r(Ldo1;Z)V
    ...
    iget-boolean v2, v0, Ly41;->u:Z

    if-nez v2, :cond_7

    iget-object v2, v0, Ly41;->g0:Laef;

    invoke-virtual {v2}, Laef;->c()I
    ...
    iget-boolean v1, v1, Lrga;->f:Z

    const-string v3, ") != camera video enabled state ("

    const-string v5, "). Let us update media settings"

    invoke-static {v3, v5, v2, v1, v4}, Loh7;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;ZZ)Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {v0, v4}, Ly41;->o(Z)V
    ...
    invoke-interface {v2, v1, v3, v0}, Lynd;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v1, v0, Ly41;->l:Landroid/os/Handler;
