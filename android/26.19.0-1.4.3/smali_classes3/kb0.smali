...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lkb0;->h:Landroid/graphics/Paint;

    new-instance v6, Landroid/graphics/Paint;

    invoke-direct {v6, v3}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object v6, p0, Lkb0;->i:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lkb0;->j:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lkb0;->k:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Path;

    invoke-direct {v3}, Landroid/graphics/Path;-><init>()V

    iput-object v3, p0, Lkb0;->l:Landroid/graphics/Path;
    ...
    iput-object v1, p0, Lkb0;->m:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, p1}, Lkb0;->onThemeChanged(Ldob;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lkb0;->f:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lkb0;->l:Landroid/graphics/Path;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lkb0;->l:Landroid/graphics/Path;
    ...
    iget-object v6, p0, Lkb0;->h:Landroid/graphics/Paint;

    if-nez v2, :cond_3

    iget-boolean v2, p0, Lkb0;->p:Z
    ...
    invoke-static {v5, v8, v4, v7}, Ls84;->c(FFII)I
    ...
    iget-object v9, p0, Lkb0;->i:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, Lkb0;->k:Landroid/graphics/Paint;

    invoke-virtual {p1, v8, v0, v1, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object v1, p0, Lkb0;->j:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-virtual {p0}, Lkb0;->getPeaksCount()I
    ...
    sget-object p2, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->o1:[Lf88;
    ...
    iget-object p1, v1, Lhb0;->n:Ljava/lang/Integer;
    ...
    iget-object p1, v1, Lhb0;->l:Ljava/lang/Float;

    invoke-static {p1, v3}, Lgn8;->f(Ljava/lang/Float;F)Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, v1, Lhb0;->m:Ljava/lang/Float;

    invoke-static {p1, v4}, Lgn8;->f(Ljava/lang/Float;F)Z
    ...
    :cond_1
    :goto_0
    iget-object p1, v1, Lhb0;->g:Lkotlinx/coroutines/internal/ContextScope;
...
.method public final onThemeChanged(Ldob;)V
    ...
    :goto_0
    iget-object v1, p0, Lkb0;->h:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setColor(I)V

    invoke-interface {p1}, Ldob;->getIcon()Lznb;

    iget-object v0, p0, Lkb0;->j:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lkb0;->k:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lkb0;->i:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, Lh4e;->a:Ljava/lang/Object;

    check-cast v1, Lkb0;

    invoke-virtual {v1}, Lkb0;->getDuration()J
    ...
    invoke-static {v3, v4}, Lbxj;->b(J)Ljava/lang/String;
    ...
    iget-object v0, v0, Lx8i;->j:Landroid/widget/TextView;
    ...
    invoke-interface {v0, v3, v4}, Lvi8;->seekTo(J)V
...
.method public final setLinesColor(I)V
    ...
    iget-object v0, p0, Lkb0;->h:Landroid/graphics/Paint;
...
.method public final setListener(Lib0;)V
    .locals 0

    iput-object p1, p0, Lkb0;->q:Lib0;
...
.method public final setShiftOffset(J)V
    ...
    iget-object v0, p0, Lkb0;->m:Landroid/animation/ValueAnimator;
