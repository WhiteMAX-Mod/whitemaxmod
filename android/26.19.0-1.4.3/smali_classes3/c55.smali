...
.method public final a(Ljava/lang/Long;Ljava/lang/Long;J)V
    ...
    invoke-virtual {p2, v5, v6}, Lmn2;->M(J)Lqk2;
    ...
    invoke-virtual {p1, v5, v6}, Lmn2;->S(J)Lqk2;
    ...
    iget-object p2, p2, Llo2;->e0:Leab;

    if-nez p2, :cond_3

    const-string p1, "draft is null, ignore"

    invoke-static {v1, p1, v4}, Lq98;->V(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_3
    invoke-virtual {p2}, Leab;->d()Ljava/lang/Long;
    ...
    iget-wide p3, p1, Lqk2;->a:J

    invoke-virtual {p2, p3, p4}, Lmn2;->C(J)V
