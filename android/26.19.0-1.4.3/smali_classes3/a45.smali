...
# virtual methods
.method public a(Lrde;Ljava/lang/Throwable;)V
    .locals 2
    ...
    iget-object p1, p0, La45;->b:Lb45;

    iget-object p1, p1, Lb45;->a:Lynd;
    ...
    iget-object p2, p1, Lb45;->a:Lynd;

    const-string v0, "DisplayLayouts"

    const-string v1, "Resend next time after error"

    invoke-interface {p2, v0, v1}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p2, 0x1

    iput-boolean p2, p1, Lb45;->e:Z
...
.method public d(Lrde;Lbee;)V
    ...
    :pswitch_0
    iget-object p1, p2, Laeh;->a:Ljava/util/Map;
