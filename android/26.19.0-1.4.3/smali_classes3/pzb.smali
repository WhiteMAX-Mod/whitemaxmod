...
# direct methods
.method public constructor <init>(Lorg/webrtc/CameraVideoCapturer;Ls92;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lpzb;->a:Lorg/webrtc/CameraVideoCapturer;

    iput-object p2, p0, Lpzb;->b:Ls92;

    iput-object p3, p0, Lpzb;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
...
.method public final addMediaRecorderToCamera(Landroid/media/MediaRecorder;Lorg/webrtc/CameraVideoCapturer$MediaRecorderHandler;)V
    ...
    iget-object v0, p0, Lpzb;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
...
.method public final changeCaptureFormat(III)V
    ...
    iget-object v0, p0, Lpzb;->a:Lorg/webrtc/CameraVideoCapturer;
...
.method public final initialize(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V
    ...
    iget-object v2, p0, Lpzb;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    const-string v3, "PatchedVideoCapturer"

    invoke-interface {v2, v3, v1}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lpzb;->e:Lorg/webrtc/SurfaceTextureHelper;

    if-nez v1, :cond_0

    iput-object p1, p0, Lpzb;->e:Lorg/webrtc/SurfaceTextureHelper;
    ...
    iput-object v1, p0, Lpzb;->d:Lorg/webrtc/YuvConverter;
    :try_end_0
    ...
    :goto_0
    invoke-interface {v2, v3, v0, v1}, Lynd;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, p0, p3, v1}, Lgvh;-><init>(Ljava/lang/Object;Ljava/lang/Object;Z)V

    iget-object p3, p0, Lpzb;->a:Lorg/webrtc/CameraVideoCapturer;
...
.method public final removeMediaRecorderFromCamera(Lorg/webrtc/CameraVideoCapturer$MediaRecorderHandler;)V
    ...
    iget-object v1, p0, Lpzb;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    invoke-interface {v1, p1, v0}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
