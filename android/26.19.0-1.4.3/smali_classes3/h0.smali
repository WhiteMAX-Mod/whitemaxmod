...
# instance fields
.field private volatile cachedParams:Ltn;


# virtual methods
.method public final declared-synchronized a()Ltn;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lh0;->cachedParams:Ltn;
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lh0;->populateParams(Ltn;)V

    iput-object v0, p0, Lh0;->cachedParams:Ltn;
    :try_end_1
...
.method public abstract populateParams(Ltn;)V
.end method
