...
# direct methods
.method public constructor <init>(JJJILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lbf4;Ljava/lang/Long;Z)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lgo;-><init>(J)V

    iput-wide p3, p0, Ln53;->d:J

    iput-wide p5, p0, Ln53;->e:J

    iput p7, p0, Ln53;->f:I

    iput-object p8, p0, Ln53;->g:Ljava/lang/String;

    iput-boolean p9, p0, Ln53;->h:Z

    iput-object p10, p0, Ln53;->i:Ljava/lang/String;

    iput-object p11, p0, Ln53;->j:Ljava/util/Map;

    iput-object p12, p0, Ln53;->k:Ljava/lang/String;

    iput-object p13, p0, Ln53;->l:Ljava/lang/String;

    iput-object p14, p0, Ln53;->m:Lbf4;

    iput-object p15, p0, Ln53;->n:Ljava/lang/Long;

    move/from16 p1, p16

    iput-boolean p1, p0, Ln53;->o:Z
...
.method public final d(Lmlg;)V
    ...
    iget-object v0, p1, Lo53;->c:Lrk2;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Ln53;->w()V
...
.method public final f(Lukg;)V
    ...
    iget-object v0, p0, Ln53;->k:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Ln53;->l:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Ln53;->n:Ljava/lang/Long;

    if-nez v0, :cond_0

    iget-object v0, p0, Ln53;->i:Ljava/lang/String;
...
.method public final j()[B
    ...
    iget-object v2, p0, Ln53;->k:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Ln53;->l:Ljava/lang/String;
    ...
    :cond_2
    iget-object v2, p0, Ln53;->n:Ljava/lang/Long;
    ...
    :goto_2
    iget-boolean v2, p0, Ln53;->o:Z

    iput-boolean v2, v0, Lru/ok/tamtam/nano/Tasks$ChatUpdate;->notifyPin:Z

    iget-object v2, p0, Ln53;->i:Ljava/lang/String;
...
.method public final l()Ljlg;
    ...
    iget-object v1, v0, Ln53;->n:Ljava/lang/Long;
    ...
    :goto_1
    iget-boolean v14, v0, Ln53;->o:Z

    const-wide/16 v15, 0x0

    iget-wide v3, v0, Ln53;->e:J

    iget-object v6, v0, Ln53;->g:Ljava/lang/String;

    iget-boolean v7, v0, Ln53;->h:Z

    iget-object v8, v0, Ln53;->i:Ljava/lang/String;

    iget-object v9, v0, Ln53;->j:Ljava/util/Map;

    iget-object v10, v0, Ln53;->k:Ljava/lang/String;

    iget-object v11, v0, Ln53;->l:Ljava/lang/String;

    iget-object v12, v0, Ln53;->m:Lbf4;

    invoke-direct/range {v2 .. v16}, Lsp2;-><init>(JILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lbf4;Ljava/lang/Long;ZJ)V
...
.method public final w()V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lmn2;->b0(JLtn2;)V
