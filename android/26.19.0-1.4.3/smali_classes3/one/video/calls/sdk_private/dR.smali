...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lone/video/calls/sdk_private/dR$a;
    }
.end annotation


# static fields
.field private static a:[Lone/video/calls/sdk_private/dR$a;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lone/video/calls/sdk_private/dR;->b:I
...
.method public constructor <init>()V
    ...
    sget-object v0, Lone/video/calls/sdk_private/dR;->a:[Lone/video/calls/sdk_private/dR$a;

    if-nez v0, :cond_1

    sget v0, Lone/video/calls/sdk_private/dR;->b:I

    new-array v0, v0, [Lone/video/calls/sdk_private/dR$a;

    sput-object v0, Lone/video/calls/sdk_private/dR;->a:[Lone/video/calls/sdk_private/dR$a;
    ...
    invoke-direct {v1, v2, p0}, Lmzi;-><init>(ILjava/lang/Object;)V
...
.method private static synthetic a(II)I
    .locals 0
...
.method private a([Lone/video/calls/sdk_private/dR$a;Lone/video/calls/sdk_private/dN;)Lone/video/calls/sdk_private/dR$a;
    .locals 2

    .line 9
    :goto_0
    invoke-virtual {p2}, Lone/video/calls/sdk_private/dN;->a()B
    ...
    .line 11
    invoke-virtual {p1}, Lone/video/calls/sdk_private/dR$a;->a()Z
    ...
    .line 12
    iget v0, p1, Lone/video/calls/sdk_private/dR$a;->b:I

    invoke-virtual {p2, v0}, Lone/video/calls/sdk_private/dN;->a(I)V

    return-object p1

    .line 13
    :cond_0
    invoke-virtual {p2}, Lone/video/calls/sdk_private/dN;->c()I
    ...
    .line 14
    iget-object v0, p1, Lone/video/calls/sdk_private/dR$a;->c:[Lone/video/calls/sdk_private/dR$a;

    if-eqz v0, :cond_1

    .line 15
    invoke-virtual {p2, v1}, Lone/video/calls/sdk_private/dN;->a(I)V

    .line 16
    iget-object p1, p1, Lone/video/calls/sdk_private/dR$a;->c:[Lone/video/calls/sdk_private/dR$a;
    ...
    invoke-virtual {p2, p1}, Lone/video/calls/sdk_private/dN;->a(I)V
...
.method private synthetic a(Ljava/util/Map$Entry;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lone/video/calls/sdk_private/dR;->a([Lone/video/calls/sdk_private/dR$a;Ljava/lang/String;I)V

    return-void
.end method

.method private a([Lone/video/calls/sdk_private/dR$a;Ljava/lang/String;I)V
    .locals 5
    ...
    invoke-static {p2, v0}, Lone/video/calls/sdk_private/dR;->a(Ljava/lang/String;I)I

    move-result v0

    new-instance v2, Lone/video/calls/sdk_private/dR$a;

    invoke-virtual {p2}, Ljava/lang/String;->length()I

    move-result v3

    invoke-direct {v2, p3, v3}, Lone/video/calls/sdk_private/dR$a;-><init>(II)V
    ...
    invoke-direct {v0, p2, v1}, Litb;-><init>(II)V

    invoke-interface {p3, v0}, Ljava/util/stream/IntStream;->map(Ljava/util/function/IntUnaryOperator;)Ljava/util/stream/IntStream;

    move-result-object p2

    .line 23
    new-instance p3, Lone/video/calls/sdk_private/k0;

    invoke-direct {p3, p1, v2}, Lone/video/calls/sdk_private/k0;-><init>([Lone/video/calls/sdk_private/dR$a;Lone/video/calls/sdk_private/dR$a;)V
    ...
    :cond_0
    invoke-static {p2, v1}, Lone/video/calls/sdk_private/dR;->a(Ljava/lang/String;I)I
    ...
    new-instance v1, Lone/video/calls/sdk_private/dR$a;

    invoke-direct {v1}, Lone/video/calls/sdk_private/dR$a;-><init>()V
...
.method private static synthetic a([Lone/video/calls/sdk_private/dR$a;Lone/video/calls/sdk_private/dR$a;I)V
    .locals 0
...
.method public static synthetic b([Lone/video/calls/sdk_private/dR$a;Lone/video/calls/sdk_private/dR$a;I)V
    .locals 0

    invoke-static {p0, p1, p2}, Lone/video/calls/sdk_private/dR;->a([Lone/video/calls/sdk_private/dR$a;Lone/video/calls/sdk_private/dR$a;I)V
...
.method public static synthetic c(II)I
    ...
    invoke-static {p0, p1}, Lone/video/calls/sdk_private/dR;->a(II)I
...
.method public static synthetic d(Lone/video/calls/sdk_private/dR;Ljava/util/Map$Entry;)V
    .locals 0

    invoke-direct {p0, p1}, Lone/video/calls/sdk_private/dR;->a(Ljava/util/Map$Entry;)V
...
.method public final a([B)Ljava/lang/String;
    ...
    .line 4
    new-instance v1, Lone/video/calls/sdk_private/dN;

    invoke-direct {v1, p1}, Lone/video/calls/sdk_private/dN;-><init>([B)V

    .line 5
    :cond_0
    :goto_0
    invoke-virtual {v1}, Lone/video/calls/sdk_private/dN;->b()Z
    ...
    .line 6
    sget-object p1, Lone/video/calls/sdk_private/dR;->a:[Lone/video/calls/sdk_private/dR$a;

    invoke-direct {p0, p1, v1}, Lone/video/calls/sdk_private/dR;->a([Lone/video/calls/sdk_private/dR$a;Lone/video/calls/sdk_private/dN;)Lone/video/calls/sdk_private/dR$a;
    ...
    .line 7
    iget-char p1, p1, Lone/video/calls/sdk_private/dR$a;->a:C
