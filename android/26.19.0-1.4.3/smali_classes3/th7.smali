...
.method public constructor <init>(Landroid/content/Context;Lbu6;)V
    ...
    iput-object p1, p0, Lth7;->b:Landroid/graphics/drawable/Drawable;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lth7;->d:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lth7;->g:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lth7;->h:Landroid/graphics/Matrix;

    const/4 p1, 0x0

    const/high16 p2, 0x3f400000    # 0.75f

    invoke-static {p1, p2}, Lbq4;->R(IF)I
...
# virtual methods
.method public final a(Landroid/graphics/Canvas;FFFILrh7;)V
    .locals 13
    ...
    sget-object v9, Lrh7;->d:Lrh7;

    if-eq v2, v9, :cond_1

    iget-object v10, v2, Lrh7;->a:Ljava/util/List;
    ...
    :goto_1
    invoke-interface {v8, v5}, Lbu6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lth7;->d:Landroid/graphics/Rect;

    invoke-virtual {v7, v6, v8, v9, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v5, p0, Lth7;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    sget-object v4, Lsh7;->$EnumSwitchMapping$0:[I
    ...
    invoke-static {v4, v9}, Lgl3;->i0(Ljava/lang/Iterable;I)I
    ...
    invoke-virtual/range {v0 .. v6}, Lth7;->a(Landroid/graphics/Canvas;FFFILrh7;)V

    sget-object v6, Lrh7;->c:Lrh7;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Lth7;->i:[I

    invoke-direct/range {v2 .. v8}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v0, p0, Lth7;->h:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lth7;->g:Landroid/graphics/Paint;
    ...
    sget-object v8, Lrh7;->d:Lrh7;

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Lth7;->a(Landroid/graphics/Canvas;FFFILrh7;)V
