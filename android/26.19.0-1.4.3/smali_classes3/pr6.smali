...
.field public volatile g:Les6;

.field public volatile h:Les6;

.field public volatile i:J

.field public final j:Lzug;

.field public final k:Lzug;
...
# direct methods
.method public constructor <init>(Lynd;Llce;)V
    .locals 4
    ...
    iput-object v0, p0, Lpr6;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lpr6;->d:Lynd;

    iput-object p2, p0, Lpr6;->e:Llce;
    ...
    iput-object p1, p0, Lpr6;->c:Lnc4;

    new-instance p1, Lzug;

    invoke-direct {p1}, Lzug;-><init>()V

    iput-object p1, p0, Lpr6;->j:Lzug;

    new-instance p1, Lzug;

    invoke-direct {p1}, Lzug;-><init>()V

    iput-object p1, p0, Lpr6;->k:Lzug;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lpr6;->m:Z

    iget-object v0, p0, Lpr6;->f:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lpr6;->f:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iput-wide v2, p0, Lpr6;->i:J

    :cond_0
    iget-object v0, p0, Lpr6;->g:Les6;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lpr6;->g:Les6;

    iget-boolean v2, v0, Les6;->a:Z
    ...
    iput-boolean v1, v0, Les6;->h:Z

    :cond_2
    iget-object v1, v0, Les6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Les6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Les6;->g:Lixi;

    invoke-static {p1}, Les6;->b(Lixi;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lpr6;->h:Les6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lpr6;->n:J

    iget-wide v7, p0, Lpr6;->b:J
    ...
    iget-object v5, v2, Les6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Les6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lpr6;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lpr6;->n:J

    iget-object p1, p0, Lpr6;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lpr6;->c:Lnc4;

    new-instance v0, Luj5;

    const/16 v3, 0xa

    invoke-direct {v0, p0, v2, v1, v3}, Luj5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lpr6;->k:Lzug;

    invoke-virtual {p1}, Lzug;->a()V
