...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;Lewf;ZLulh;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ltw8;->a:Landroid/widget/EditText;

    iput-object p2, p0, Ltw8;->b:Lewf;

    iput-boolean p3, p0, Ltw8;->c:Z

    iput-object p4, p0, Ltw8;->d:Lulh;

    iput-boolean p5, p0, Ltw8;->e:Z

    new-instance p1, Lhga;

    invoke-direct {p1}, Lhga;-><init>()V

    iput-object p1, p0, Ltw8;->f:Lhga;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-direct {p1}, Lbw0;-><init>()V

    invoke-static {p2, p3, p4, v1, p1}, Lcj0;->C(Landroid/text/Editable;IIZLuw8;)V

    return-void

    :cond_0
    sget v0, Lxhd;->markdown_italic:I
    ...
    :cond_1
    sget v0, Lxhd;->markdown_underline:I
    ...
    invoke-static {p2, p3, p4, v2, p1}, Lcj0;->C(Landroid/text/Editable;IIZLuw8;)V

    return-void

    :cond_2
    sget v0, Lxhd;->markdown_mono:I
    ...
    :cond_3
    sget v0, Lxhd;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Ly7g;

    invoke-direct {p1, v1}, Ly7g;-><init>(I)V
    ...
    :cond_4
    sget v0, Lxhd;->markdown_heading:I

    if-ne p1, v0, :cond_5

    new-instance p1, Lp87;

    invoke-direct {p1}, Lp87;-><init>()V
    ...
    :cond_5
    sget v0, Lxhd;->markdown_quote:I

    sget-object v3, Lfbh;->a:Lfbh;

    iget-object v4, p0, Ltw8;->a:Landroid/widget/EditText;
    ...
    sget v0, Laid;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Ltw8;->b()Lqbd;

    move-result-object p4

    new-instance v0, Lrbd;

    invoke-direct {v0, p4}, Lrbd;-><init>(Lqbd;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Lg63;->f0(Landroid/text/Spannable;Luw8;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Lcj0;->D(Landroid/text/Spannable;Luw8;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Laid;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Ll7j;->c(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Laid;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Lxhd;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Lcj0;->D(Landroid/text/Spannable;Luw8;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Lcj0;->z(Landroid/text/Spannable;II)V
...
.method public final b()Lqbd;
    ...
    iget-object v1, v0, Ltw8;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Llb4;->o0(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v19}, Lqbd;-><init>(Landroid/content/Context;Lewf;Lsnb;Lerg;Landroid/graphics/drawable/Drawable;IIIIIIIIIIFZ)V
    ...
    invoke-direct {v1, v4, v3}, Lpbd;-><init>(ILjava/lang/Object;)V

    iput-object v1, v2, Lqbd;->f:Lpbd;
...
.method public final c()Z
    ...
    iget-object v0, p0, Ltw8;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Lng8;->c:Ljava/lang/String;

    iget-object v0, v2, Lulh;->b:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->I:[Lf88;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lfa8;
    ...
    invoke-direct {v1, p2, p3, p1}, Lza;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Lulh;->b:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lfa8;
    ...
    iget-object p1, p1, Lvw8;->c:Los5;

    new-instance v0, Lza;

    invoke-direct {v0, p2, p3, v1}, Lza;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Ltw8;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Lxhd;->markdown_italic:I
    ...
    :cond_2
    sget v5, Lxhd;->markdown_underline:I
    ...
    :cond_4
    sget v5, Lxhd;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Lxhd;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Ltw8;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Lxhd;->markdown_heading:I
    ...
    :cond_8
    sget v5, Lxhd;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Ltw8;->f:Lhga;

    invoke-virtual {p1}, Lhga;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lhga;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lhga;->a(I)V

    invoke-virtual {p0}, Ltw8;->c()Z

    move-result v0

    sget-object v1, Lsw8;->c:Luf3;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v1, Lsw8;->d:Ljava/util/LinkedHashSet;
    ...
    :cond_1
    sget v4, Lxhd;->markdown_link:I

    if-ne v3, v4, :cond_2

    iget-boolean v4, p0, Ltw8;->e:Z
    ...
    invoke-virtual {p1, v3}, Lhga;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Lsw8;->e:Lsw8;

    iget v2, v1, Lsw8;->a:I

    iget-object v3, p0, Ltw8;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lhga;->a(I)V

    :goto_2
    iget-boolean p1, p0, Ltw8;->e:Z

    if-nez p1, :cond_5

    sget p1, Lxhd;->markdown_link:I
    ...
    invoke-direct {p1, v1, p2}, Lwu;-><init>(ILjava/lang/Object;)V
