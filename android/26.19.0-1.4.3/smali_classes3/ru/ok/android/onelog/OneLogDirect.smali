...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorCallback",
        "send-B_83SRM",
        "(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lpu6;)V",
        "send",
        "Lzm;",
        "getApiClient",
        "()Lzm;",
...
.method public static synthetic a(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lfbh;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/onelog/OneLogDirect;->send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lfbh;
...
.method public static synthetic c(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lzm;Lpu6;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/onelog/OneLogDirect;->send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lzm;Lpu6;)V
...
.method private final getApiClient()Lzm;
    .locals 1
    ...
    invoke-virtual {v0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Lzm;
...
.method private final send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lpu6;)V
    .locals 7
    ...
    invoke-direct {p0}, Lru/ok/android/onelog/OneLogDirect;->getApiClient()Lzm;
    ...
    sget-object v0, Lp2b;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v0, Lp2b;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    ...
    :cond_2
    :goto_2
    sget-object v6, Lp2b;->c:Ljava/util/concurrent/Executor;
...
.method private static final send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lzm;Lpu6;)V
    .locals 3
    ...
    invoke-interface {p2, v2}, Lzm;->a(Lln;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_1
    invoke-interface {p3, p1, p0}, Lpu6;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    return-void
.end method

.method private static final send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lfbh;
    .locals 0
...
.method public final flush()V
    ...
    sget-object v1, Lp2b;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v1, Lp2b;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final send-PCEVtD0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lru/ok/android/onelog/OneLogDirect;->send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lpu6;)V
