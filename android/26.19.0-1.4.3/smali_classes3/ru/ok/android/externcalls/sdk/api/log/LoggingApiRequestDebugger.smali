...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;)Lnxb;",
        "Lun;",
        "request",
        "getParams",
        "(Lun;)Ljava/lang/String;",
        "jsonString",
        "eraseSecrets",
        ...
        "exception",
        "debugIoException",
        "(Lfn;Lun;Ljava/io/IOException;)V",
        "Lynd;",
        "Lfo;",
...
.field private final sessionStore:Lfo;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Lynd;Lfo;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lynd;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lfo;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lynd;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Lnxb;
    .locals 2
...
.method private final getParams(Lun;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lun;)Ljava/lang/String;
...
.method private final getRawParams(Lun;)Ljava/lang/String;
    .locals 3
    ...
    invoke-direct {v1, v0}, Lmdc;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lmdc;->r()V

    invoke-interface {p1, v1}, Lun;->writeParams(Lp78;)V

    invoke-virtual {v1}, Lmdc;->o()V

    invoke-virtual {v1}, Lmdc;->flush()V
    :try_end_0
    ...
    :catch_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lynd;

    const-string v1, "CallsApiDebug"

    const-string v2, "failed to log request params"

    invoke-interface {p1, v1, v2}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lfo;
    ...
    iget-object v0, v0, Leo;->c:Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Lnxb;
...
.method public debugApiRequest(Lfn;Lun;Lgn;)V
    ...
    instance-of p1, p2, Lxn;

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lun;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lynd;
    ...
    invoke-static {v0, p2, v1, p1}, Lc72;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugApiResponseFail(Lfn;Lun;Ld78;)Ld78;
    ...
    invoke-interface {p3}, Ld78;->w0()Ljava/lang/String;
    ...
    invoke-static {v1, p2, v2, p3}, Lc72;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string p3, "CallsApiDebug"

    invoke-interface {v0, p3, p2}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Le78;->j(Ljava/lang/String;)Le78;
...
.method public debugApiResponseOk(Lfn;Lun;Ld78;)Ld78;
    ...
    invoke-static {v0, p3}, Lc72;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugIoException(Lfn;Lun;Ljava/io/IOException;)V
    ...
    invoke-interface {p1, v0, p2, p3}, Lynd;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
