...
.field private final sender:Lbu6;
...
.field private final store:Lbu6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbu6;"
        }
...
# direct methods
.method public constructor <init>(Lbu6;Lbu6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lbu6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lbu6;
...
.method public sendDisplayLayouts(Ljava/util/Collection;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lbu6;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lq0i;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lbu6;

    invoke-interface {v4, v3}, Lbu6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v3, v4, Lxm8;->b:Ljava/lang/Object;

    iput-object v2, v4, Lxm8;->c:Ljava/lang/Object;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getVideoTrackParticipantKey()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v2

    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lwaa;

    move-result-object v2

    iput-object v2, v4, Lxm8;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getLayout()Lqrh;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Lqb1;-><init>(Lky1;Lqrh;)V
