...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lbmf;",
        "Lynd;",
        "Companion",
        "calls-sdk_release"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Lynd;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lynd;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lhmf;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lmmf;)V

    return-void
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;)Lynd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lynd;

    return-object p0
.end method

.method private static final download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lmmf;)V
    .locals 8
    ...
    invoke-static {p1, v1, v1}, Ltyj;->a(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    invoke-virtual {p2, v0}, Lhmf;->a(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    invoke-static {p1}, Lqzj;->b(Ljava/io/File;)V
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Lc87;

    move-result-object p0

    iget-object p0, p0, Lc87;->a:Ljava/lang/String;
    ...
    invoke-virtual {p2, p3}, Lhmf;->b(Ljava/lang/Object;)V
    ...
    :goto_3
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Lynd;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lc72;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {p0, p3, p1}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p0}, Lqzj;->a(Ljava/io/File;Lbu6;)V

    check-cast p4, Lhmf;

    invoke-virtual {p4}, Lhmf;->h()Z

    move-result p0

    if-nez p0, :cond_5

    invoke-virtual {p4, p2}, Lhmf;->a(Ljava/lang/Throwable;)V
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v2, v0, p3}, Luih;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v5, p2}, Lp96;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lbmf;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p0}, Lbn;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p2}, Lbmf;->j(Ltje;)Llmf;
