...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lzt6;Lru/ok/android/externcalls/sdk/Conversation$CallType;Lpug;Lynd;ZZ)V",
...
# direct methods
.method public constructor <init>(Lzt6;Lru/ok/android/externcalls/sdk/Conversation$CallType;Lpug;Lynd;ZZ)V
    .locals 1
    ...
    invoke-direct {v0, p3, p1}, Lru/ok/android/externcalls/sdk/stat/connect/ConversationConnectedToSignalingStat;-><init>(Lpug;Lzt6;)V
    ...
    invoke-direct {v0, p3, p1}, Lru/ok/android/externcalls/sdk/stat/warmup/ConversationPreparedStat;-><init>(Lpug;Lzt6;)V
    ...
    invoke-direct {v0, p2, p3, p1}, Lru/ok/android/externcalls/sdk/stat/start/ConversationStartedStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;Lpug;Lzt6;)V
    ...
    invoke-direct {v0, p1, p3, p4, p6}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;-><init>(Lzt6;Lpug;Lynd;Z)V
    ...
    invoke-direct {p4, p1}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p4, p2, p5, p1}, Lru/ok/android/externcalls/sdk/stat/init/CallInitStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;ZLzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidatePairChangedStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/icerestart/IceRestartStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1, p3}, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;-><init>(Lzt6;Lpug;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/connection/PeerConnectionChangedStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/negotiation/NegotiationErrorStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/p2prelay/P2PRelayRequestedStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/accept/AcceptCallStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/audio/AudioErrorStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateGatheringFailedStat;-><init>(Lzt6;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateAddFailedStat;-><init>(Lzt6;)V
