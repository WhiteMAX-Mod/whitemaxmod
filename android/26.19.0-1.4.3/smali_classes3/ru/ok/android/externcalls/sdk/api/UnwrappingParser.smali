...
.field private final valueParser:Ls68;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ls68;"
        }
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ls68;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;->valueParser:Ls68;
...
.method public parse(Ld78;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;->valueParser:Ls68;

    invoke-interface {v0, p1}, Ls68;->parse(Ld78;)Ljava/lang/Object;
