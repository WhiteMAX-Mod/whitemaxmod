...
.method private final getPosition(Ljava/lang/Long;)Lzaa;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lxaa;-><init>(J)V

    return-object v0

    :cond_1
    :goto_0
    sget-object p1, Lyaa;->a:Lyaa;
...
.method private final updateState(Lfba;)V
    .locals 12
    ...
    iget-object p1, p1, Lfba;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Leba;->a:Lky1;

    iget-object v3, v3, Lky1;->b:Lyn1;
    ...
    iget-object v11, v3, Lky1;->c:Lwaa;
    ...
    :cond_2
    iget-object v3, v3, Lky1;->a:Lq0i;

    sget-object v5, Lcba;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Ltaa;->d:Lbba;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Ltaa;->a:Lwaa;

    invoke-virtual {v8, v11}, Lwaa;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Leba;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lzaa;

    move-result-object v5

    iget-boolean v2, v1, Leba;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Leba;->b:F

    invoke-static {v7}, Ljba;->a(F)V

    iget-boolean v8, v1, Leba;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lzaa;ZFZLtaa;Lit4;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lu2f;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lu2f;Ltaa;)V
...
.method public final onVideoStarted(Ldba;)V
    .locals 12
    ...
    iget-object v11, v7, Ltaa;->a:Lwaa;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lzaa;ZFZLtaa;Lit4;)V
    ...
    iget-object p1, p1, Ldba;->b:Lu2f;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lu2f;Ltaa;)V
...
.method public final onVideoStatesUpdatedChanged(Lfba;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lfba;)V
...
.method public final onVideoStopped(Lgba;)V
    .locals 4
    ...
    iget-object v2, p1, Lgba;->b:Lu2f;

    iget-object v3, p1, Lgba;->c:Lwaa;

    iget-object p1, p1, Lgba;->d:Lbba;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lu2f;Lwaa;Lbba;)V
