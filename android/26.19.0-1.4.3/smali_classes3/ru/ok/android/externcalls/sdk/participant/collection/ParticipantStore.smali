...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "add",
        "(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lu2f;)V",
        "Lyn1;",
        ...
        "getByInternal",
        "(Lyn1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;",
        "removeByExternal",
        ...
        "(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lu2f;",
        "Ln2f;",
        "room",
...
.field private proposedRoom:Ln2f;

.field private proposedRoomId:Lu2f;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    sget-object p2, Ls2f;->a:Ls2f;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lu2f;
...
.method private final getSessionRoomParticipantsMap(Lu2f;)Ljava/util/LinkedHashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final onActiveRoomChanged(Lu2f;Lu2f;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lu2f;)V
...
.method private final setActiveRoomId(Lu2f;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lu2f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lu2f;

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->onActiveRoomChanged(Lu2f;Lu2f;)V
...
# virtual methods
.method public final add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lu2f;)V
    .locals 2
    ...
    .line 4
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getSessionRoomParticipantsMap(Lu2f;)Ljava/util/LinkedHashMap;
...
.method public final addToActiveSessionRoom(Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
    ...
    invoke-virtual {p0, p1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lu2f;)V
...
.method public final containsByInternal(Lyn1;)Z
    .locals 0

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lyn1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
...
.method public final getActiveRoom()Ln2f;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Ln2f;

    return-object v0
.end method

.method public final getActiveRoomId()Lu2f;
    .locals 1
...
.method public getByInternal(Lyn1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->localIdMappings:Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;->getLocalId(Lyn1;)Lru/ok/android/externcalls/sdk/id/local/LocalParticipantId;
...
.method public final getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lu2f;
    .locals 1
...
.method public getParticipants()Ljava/util/Collection;
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lu2f;)Ljava/util/Collection;
...
.method public final getParticipants(Lu2f;)Ljava/util/Collection;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getSessionRoomParticipantsMap(Lu2f;)Ljava/util/LinkedHashMap;
...
.method public final getProposedRoom()Ln2f;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Ln2f;

    return-object v0
.end method

.method public final getProposedRoomId()Lu2f;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lu2f;
...
.method public final maybeUpdateRoom(Ln2f;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lu2f;

    iget-object v1, p1, Ln2f;->a:Lt2f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Ln2f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Ln2f;
...
.method public final removeByInternal(Ljava/util/Collection;)V
    ...
    .line 4
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->removeByInternal(Lyn1;)V
...
.method public final removeByInternal(Lyn1;)V
    .locals 1
...
.method public final setActiveSessionRoom(Lu2f;Ln2f;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveRoomId(Lu2f;)V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Ln2f;

    return-void
.end method

.method public final setProposedSessionRoom(Lu2f;Ln2f;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lu2f;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Ln2f;
...
.method public toArray()[Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0}, Lat6;->o0(Ljava/util/Collection;)[Ljava/lang/Object;
...
.method public toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .line 2
    invoke-static {p0, p1}, Lat6;->p0(Ljava/util/Collection;[Ljava/lang/Object;)[Ljava/lang/Object;
