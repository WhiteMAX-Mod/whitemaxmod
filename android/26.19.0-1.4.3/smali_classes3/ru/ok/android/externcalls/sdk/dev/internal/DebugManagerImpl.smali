...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Ly41;Lynd;Lf1c;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "",
        "error",
        "Lfbh;",
        "reportError",
        ...
        "(Lzwf;ILjava/util/concurrent/TimeUnit;)V",
        "removeStatListener",
        "(Lzwf;)V",
...
.field private final peerVideoSettingsAdapter:Lf1c;

.field private final underlyingCall:Ly41;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Ly41;Lynd;Lf1c;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Ly41;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lynd;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->peerVideoSettingsAdapter:Lf1c;

    new-instance p1, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Ly41;

    move-result-object p2

    invoke-direct {p1, p2, p4}, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;-><init>(Ly41;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
...
.method public enableFullAudioDump(Ljava/lang/String;)V
    ...
    iget-object v1, v0, Ly41;->f0:Lgef;
    ...
    :cond_0
    iget-object v2, v0, Ly41;->c:Ljava/util/concurrent/ExecutorService;
...
.method public getCurrentVideoSettingsOverride()Lru/ok/android/externcalls/sdk/dev/DebugManager$VideoSettingsOverride;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->peerVideoSettingsAdapter:Lf1c;

    iget-boolean v2, v1, Lf1c;->a:Z
...
.method public getUnderlyingCall()Ly41;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Ly41;

    return-object v0
.end method

.method public registerStatListener(Lzwf;ILjava/util/concurrent/TimeUnit;)V
    .locals 3
    ...
    iget-object v0, v0, Ly41;->M0:Lwvf;

    int-to-long v1, p2

    iget-object p2, v0, Lwvf;->i:Ljava/util/HashMap;

    new-instance v0, Loxi;

    invoke-direct {v0, v1, v2, p3}, Loxi;-><init>(JLjava/util/concurrent/TimeUnit;)V
...
.method public removeStatListener(Lzwf;)V
    .locals 1
    ...
    iget-object v0, v0, Lwvf;->i:Ljava/util/HashMap;
...
.method public reportError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lynd;
...
.method public setVideoSettingsOverride(Lru/ok/android/externcalls/sdk/dev/DebugManager$VideoSettingsOverride;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->peerVideoSettingsAdapter:Lf1c;
    ...
    iput-boolean p1, v0, Lf1c;->a:Z

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Ly41;

    move-result-object p1

    invoke-virtual {p1}, Ly41;->x()V

    return-void
.end method

.method public updateCameraToggles(Lbu6;)V
    .locals 3
    ...
    iget-object v0, v0, Ly41;->h0:Li0e;

    iget-object v0, v0, Li0e;->i:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v2, v0, Lyg4;->b:Ljava/lang/Object;
    ...
    iput-object p1, v0, Lyg4;->b:Ljava/lang/Object;
