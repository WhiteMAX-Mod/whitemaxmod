...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(Laod;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Loxa;",
        "observeStat",
        "()Loxa;",
        "rtcStat",
...
.field private final statSubject:Lmr0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Lynd;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lynd;

    new-instance p1, Lmr0;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lmr0;-><init>(Ljava/io/Serializable;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lmr0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lynd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lynd;

    return-object p0
.end method

.method private final mapToMonitoringStat(Laod;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILit4;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Llc2;->h:Ljava/lang/Double;
    ...
    :goto_0
    iget-object p1, p1, Laod;->b:Ljava/util/List;

    invoke-static {p1, v0}, Lsqj;->f(Ljava/util/List;Llc2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lynd;
    ...
    :cond_6
    iget-object v4, v5, Latf;->i:Ljava/math/BigInteger;

    iget-object v5, v5, Latf;->h:Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lynd;
    ...
    :cond_b
    iget-object p1, v5, Latf;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Latf;->h:Ljava/math/BigInteger;
    ...
    :goto_6
    iget-object p1, v0, Llc2;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lynd;
...
# virtual methods
.method public observeStat()Loxa;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lmr0;
    ...
    invoke-direct {v1, v0, v2}, Lxya;-><init>(Loxa;I)V

    return-object v1
.end method

.method public onRtcStats(Laod;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(Laod;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    ...
    invoke-virtual {v0, p1}, Lmr0;->onNext(Ljava/lang/Object;)V
