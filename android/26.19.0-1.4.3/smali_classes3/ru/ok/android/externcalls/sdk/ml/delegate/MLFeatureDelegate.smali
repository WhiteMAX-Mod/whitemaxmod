...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "downloadModel",
        "(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lbmf;",
        "stage",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Lut8;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Lynd;Landroid/content/Context;Lru/ok/android/externcalls/sdk/ml/model/ModelSpec;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lut8;
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lynd;
...
.method public static final synthetic access$downloadModel(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lbmf;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lbmf;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;)Lynd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lynd;
...
.method private final clearDir()V
    ...
    invoke-static {v3, v4}, Lqzj;->a(Ljava/io/File;Lbu6;)V
...
.method private final downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Lbmf;
    .locals 5
    ...
    sget-object v4, Lc87;->b:Lc87;

    invoke-direct {v3, p1, v4}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;-><init>(Ljava/lang/String;Lc87;)V

    invoke-interface {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/net/DownloadService;->download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lbmf;
    ...
    iget-object p1, p1, Lsg6;->a:Log6;

    invoke-direct {v0, p1}, Lqg6;-><init>(Log6;)V
    ...
    invoke-direct {v0, p1}, Lonf;-><init>(Lbmf;)V

    :goto_0
    new-instance p1, Log6;

    invoke-direct {p1, v0, v1}, Log6;-><init>(Lmg6;Lbs0;)V

    new-instance v0, Lsg6;

    invoke-direct {v0, p1}, Lsg6;-><init>(Log6;)V
...
.method private final fetchConfig()Lly8;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lly8;
...
.method private final log(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lynd;
...
.method private final removeCurrentModel()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lut8;
...
.method private final saveNewModelInfo(Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;)Lru/ok/android/externcalls/sdk/ml/stage/SaveNewModelInfoStage;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lut8;
    ...
    invoke-virtual {v1, v2, v0}, Lyp;->U(Ljava/lang/String;Ljava/io/Serializable;)V
...
.method private final unzipModel(Lru/ok/android/externcalls/sdk/ml/stage/DownloadStage;)Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;
    ...
    invoke-static {v0, v1}, Lp96;->i(Ljava/io/File;Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v1}, Lqzj;->a(Ljava/io/File;Lbu6;)V
...
# virtual methods
.method public final checkModel()Lbmf;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->fetchConfig()Lly8;
    ...
    invoke-direct {v3, v0, v1, v4}, Lwy8;-><init>(Lly8;Ltje;I)V
    ...
    invoke-direct {v1, v3, v0, v2}, Lwy8;-><init>(Lly8;Ltje;I)V
    ...
    invoke-direct {v2, v1, v0}, Lsy8;-><init>(Lly8;Lru6;)V
...
.method public isModelValid(Ljava/io/File;)Z
    ...
    invoke-static {v1}, Ls96;->d1(Ljava/io/File;)Ljava/lang/String;
