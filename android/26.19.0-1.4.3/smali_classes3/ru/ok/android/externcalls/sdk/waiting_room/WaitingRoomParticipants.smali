...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lynd;)V",
        "Ly41;",
        "call",
        "Lfbh;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lbmf;",
        "Luy1;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lyn1;)Luy1;",
        "",
        "Lty1;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Ly41;

.field private final compositeDisposable:Lku3;
...
.field private final loadEventSubject:Lz7d;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lynd;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lynd;

    new-instance p1, Lz7d;

    invoke-direct {p1}, Lz7d;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lz7d;

    new-instance p2, Lku3;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lku3;
    ...
    invoke-direct {p4, p1, v0, v1}, Lxxa;-><init>(Lz7d;Ltje;I)V

    invoke-static {}, Ldke;->b()Ltje;

    move-result-object p1

    invoke-virtual {p4, p1}, Loxa;->f(Ltje;)Lfza;
    ...
    invoke-direct {v0, p1, p4, v1}, Lmya;-><init>(Loxa;Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p3}, Lhv6;-><init>(Ljava/lang/Object;)V

    new-instance p3, Lgza;

    const/4 p4, 0x0

    invoke-direct {p3, v0, p1, p4}, Lgza;-><init>(Loxa;Ljava/lang/Object;I)V

    invoke-static {}, Ldg;->a()Ltje;

    move-result-object p1

    invoke-virtual {p3, p1}, Loxa;->f(Ltje;)Lfza;
    ...
    invoke-direct {v0, p3, p4}, Lu98;-><init>(Ly24;Ly24;)V

    invoke-virtual {p1, v0}, Loxa;->h(Ld0b;)V

    invoke-virtual {p2, v0}, Lku3;->a(Lq65;)Z

    return-void
.end method

.method public static synthetic a(Ly41;Luy1;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lhmf;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6(Ly41;Luy1;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmmf;)V
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lhmf;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lmmf;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmmf;Llz1;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmmf;Llz1;)V

    return-void
.end method

.method public static synthetic d(Lmmf;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lmmf;)V

    return-void
.end method

.method public static synthetic e(Lmmf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1$lambda$0(Lmmf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lyn1;)Luy1;
    .locals 3
    ...
    invoke-direct {v0, p2, v1, v2}, Luy1;-><init>(Lyn1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Lty1;->a:Luy1;

    iget-object v1, v1, Luy1;->b:Lyn1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lyn1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lyn1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Ly41;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lbmf;

    move-result-object v6

    invoke-virtual {v6}, Lbmf;->d()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lyn1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lyn1;)Luy1;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lynd;
    ...
    invoke-interface {v2, v4, v0}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Ly41;Luy1;)Lbmf;
...
.method private final loadWaitingParticipantIdsPageSingle(Ly41;Luy1;)Lbmf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Lp7i;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Limf;

    const/4 p2, 0x0

    invoke-direct {p1, p2, v0}, Limf;-><init>(ILjava/lang/Object;)V

    return-object p1
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6(Ly41;Luy1;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmmf;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lt0c;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Lwrh;

    const/16 v1, 0x8

    invoke-direct {p2, v1, p3}, Lwrh;-><init>(ILjava/lang/Object;)V

    iget-object p3, p0, Ly41;->k:Luif;
    ...
    iget-object v5, p1, Luy1;->b:Lyn1;

    invoke-virtual {v5}, Lyn1;->b()Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Le41;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lr41;

    const/4 v0, 0x0

    invoke-direct {p0, v0, p2}, Lr41;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p3, v1, v4, p1, p0}, Luif;->d(Lxif;ZLrif;Lrif;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmmf;Llz1;)V
    .locals 8

    iget-object v2, p2, Llz1;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lmmf;Llz1;Lmmf;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$2;-><init>(Lmmf;)V
    ...
    invoke-virtual {p0, p1}, Lhmf;->b(Ljava/lang/Object;)V

    return-void
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lmmf;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lhmf;->c(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v0, v0, Lty1;->a:Luy1;

    iget-object v0, v0, Luy1;->b:Lyn1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lyn1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lbmf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, v1, p1}, Lq7i;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method private static final resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lmmf;)V
    .locals 4
    ...
    invoke-direct {v1, v2, p2}, Lw24;-><init>(ILjava/lang/Object;)V

    new-instance v2, Lsmh;

    const/16 v3, 0xc

    invoke-direct {v2, p2, v3, p1}, Lsmh;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lz24;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$1$lambda$0(Lmmf;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lhmf;->a(Ljava/lang/Throwable;)V

    return-void
.end method

.method private final resolveInternalIds(Ljava/util/List;Lbu6;Lbu6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lbu6;Lbu6;)V

    new-instance p1, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p1, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lbu6;)V
...
.method private final scheduleLoad()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lz7d;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lku3;
...
.method public final setCall(Ly41;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Ly41;
