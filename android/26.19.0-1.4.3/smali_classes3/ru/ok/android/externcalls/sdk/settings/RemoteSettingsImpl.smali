...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Lynd;)V",
        "Lfbh;",
        "drainEmitters",
        "()V",
        "requestReadSettings",
...
.field private final requestSettingsDisposable:Lq65;

.field private final wantedSettings:Lmr0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lmr0;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$Companion;-><init>(Lit4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Lynd;)V
    .locals 2
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Lynd;
    ...
    invoke-direct {p1, p2}, Lmr0;-><init>(Ljava/io/Serializable;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lmr0;

    const-wide/16 v0, 0x64

    sget-object p2, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {p1, v0, v1, p2}, Loxa;->g(JLjava/util/concurrent/TimeUnit;)Lkza;
    ...
    invoke-direct {v0, p1, p2, v1}, Lmya;-><init>(Loxa;Ljava/lang/Object;I)V

    invoke-static {}, Ldg;->a()Ltje;

    move-result-object p1

    invoke-virtual {v0, p1}, Loxa;->f(Ltje;)Lfza;
    ...
    invoke-direct {v1, p2, v0}, Lu98;-><init>(Ly24;Ly24;)V

    invoke-virtual {p1, v1}, Loxa;->h(Ld0b;)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Lq65;
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;)Lynd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Lynd;
...
.method public static synthetic b(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lhmf;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lmmf;)V
...
.method private static final get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lmmf;)V
    .locals 2

    new-instance v0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;

    invoke-direct {v0, p0, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;-><init>(Ljava/lang/String;Lmmf;)V
    ...
    invoke-direct {v0, v1, p0}, Lec2;-><init>(ILjava/lang/Object;)V

    invoke-static {p2, v0}, Lu65;->e(Ljava/util/concurrent/atomic/AtomicReference;Lec2;)V
...
.method private final requestReadSettings()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lmr0;

    invoke-virtual {v1, v0}, Lmr0;->onNext(Ljava/lang/Object;)V
...
.method public get(Ljava/lang/String;)Lbmf;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Lynd;
    ...
    invoke-direct {v0, p1, v1, p0}, Luxc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Lq65;
