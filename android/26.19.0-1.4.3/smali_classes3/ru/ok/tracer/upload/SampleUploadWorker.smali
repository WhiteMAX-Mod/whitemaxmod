...
.method public final g()Laj8;
    ...
    iget-object v0, p0, Lbj8;->a:Landroid/content/Context;
    ...
    iget-object v4, v1, Landroidx/work/WorkerParameters;->b:Lfn4;

    iget-object v1, v1, Landroidx/work/WorkerParameters;->b:Lfn4;

    const-string v5, "tracer_sample_file_path"

    invoke-virtual {v4, v5}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4, v5, v6}, Lfn4;->d(Ljava/lang/String;J)J
    ...
    invoke-virtual {v1, v4}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string v5, "tracer_version_code"

    invoke-virtual {v1, v5, v7, v8}, Lfn4;->d(Ljava/lang/String;J)J
    ...
    invoke-static {v1, v0}, Luh3;->w(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {v0}, Lb9h;->E(Landroid/content/pm/PackageInfo;)J
    ...
    :cond_2
    invoke-virtual {p0, v2, v4}, Lru/ok/tracer/upload/SampleUploadWorker;->h(Ljava/lang/Long;Ljava/lang/String;)Ljava/lang/String;
...
.method public final h(Ljava/lang/Long;Ljava/lang/String;)Ljava/lang/String;
    .locals 11
    ...
    iget-object v4, v3, Landroidx/work/WorkerParameters;->b:Lfn4;

    iget-object v5, v3, Landroidx/work/WorkerParameters;->b:Lfn4;

    const-string v6, "tracer_custom_properties_keys"

    iget-object v4, v4, Lfn4;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v5, v9}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    if-eqz v10, :cond_3

    invoke-virtual {v2, v9, v10}, Lkv8;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_2
    invoke-virtual {v4}, Lk3f;->b()V

    iget-object v4, v4, Lk3f;->f:Lhjg;
    ...
    :cond_6
    invoke-virtual {v2}, Lkv8;->isEmpty()Z
    ...
    :cond_7
    iget-object v7, v4, Lhjg;->n:Ljava/util/Map;

    invoke-static {v2, v7}, Lmw8;->C0(Ljava/util/Map;Ljava/util/Map;)Ljava/util/LinkedHashMap;

    move-result-object v2

    const/16 v7, 0x5fff

    invoke-static {v4, v6, v2, v7}, Lhjg;->a(Lhjg;ZLjava/util/Map;I)Lhjg;
    ...
    invoke-virtual {v4, v2}, Lhjg;->b(Ljava/util/Date;)Lhjg;

    move-result-object v2

    invoke-static {v2}, Lgn8;->W(Lhjg;)Lorg/json/JSONObject;

    move-result-object v2

    iget-object v4, v3, Landroidx/work/WorkerParameters;->b:Lfn4;

    const-string v7, "tracer_feature_name"

    invoke-virtual {v4, v7}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, p1, v6}, Lfn4;->b(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v5, p1, v8, v9}, Lfn4;->d(Ljava/lang/String;J)J
    ...
    :cond_9
    iget-object p1, v3, Landroidx/work/WorkerParameters;->b:Lfn4;

    const-string p2, "tracer_feature_tag"

    invoke-virtual {p1, p2}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p1, v4}, Lvd9;-><init>(I)V
    ...
    invoke-static {v4, v5}, Ldpa;->m(Ljava/lang/String;Ljava/lang/String;)Ljf7;

    move-result-object v4

    invoke-direct {v0, p1, v4}, Lc40;-><init>(Ljava/lang/String;Lxf7;)V

    invoke-virtual {v2}, Lorg/json/JSONObject;->toString()Ljava/lang/String;

    sget-object p1, Lxyg;->h:Lvhg;
    ...
    invoke-virtual {p1, v0}, Llg7;->b(Lc40;)Lzf7;

    move-result-object p1

    :try_start_0
    iget-object v0, p1, Lzf7;->c:Ljf7;

    new-instance v2, Lorg/json/JSONObject;

    iget-object v0, v0, Ljf7;->b:[B

    invoke-static {v0}, Lr8g;->e0([B)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v0}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V

    iget-object v0, v3, Landroidx/work/WorkerParameters;->b:Lfn4;

    invoke-virtual {v0, v7}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iget-object v3, v3, Landroidx/work/WorkerParameters;->b:Lfn4;

    invoke-virtual {v3, p2}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-static {v2, v0, p2}, Ldpa;->u(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final i(Ljava/io/File;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Landroidx/work/WorkerParameters;->b:Lfn4;
    ...
    iget-object v5, p0, Lbj8;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v6, v7, v2}, Lr8g;->h0(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v6}, Lvff;->i0(Ljava/io/File;)V
    ...
    invoke-static {v6, v1}, Ls96;->h1(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v1

    :try_start_0
    invoke-static {p1, v1}, Lnnj;->a(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    ...
    invoke-direct {v4, p1}, Lav0;-><init>(Ljava/io/File;)V
    ...
    invoke-direct {v6, v8, v9, v7, v4}, Lwf7;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lxf7;)V
    ...
    invoke-direct {v4, v3, v1}, Ltf7;-><init>(Ljava/lang/String;Ljava/util/List;)V

    new-instance v1, Lc40;

    invoke-direct {v1, p2, v4}, Lc40;-><init>(Ljava/lang/String;Lxf7;)V

    :try_start_1
    sget-object p2, Lxyg;->h:Lvhg;
    ...
    invoke-virtual {p2, v1}, Llg7;->b(Lc40;)Lzf7;
    ...
    iget-object v3, p2, Lzf7;->b:Ljava/lang/String;

    iget-object v4, p2, Lzf7;->c:Ljf7;
    ...
    :cond_4
    :goto_3
    iget-object v4, v0, Landroidx/work/WorkerParameters;->b:Lfn4;

    const-string v6, "tracer_feature_name"

    invoke-virtual {v4, v6}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lfn4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_4
    invoke-static {v2, v4, v0}, Ldpa;->u(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
