...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    ...
    iput-object p1, p0, Lqm1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    iput-object p2, p0, Lqm1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lc72;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lqm1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lom1;-><init>(Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Landroid/opengl/EGLContext;[ILpyi;Ljava/lang/String;)V

    iput-object v1, p0, Lqm1;->e:Lom1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lqm1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Lqm1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Lqm1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lqm1;->i:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lom1;->j:Ljava/lang/String;

    const-string v4, "OpenGL tread died, is it fine?"

    iget-object v1, v1, Lom1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    invoke-interface {v1, v3, v4, v0}, Lynd;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Lqm1;->c:Lcb;
...
.method public final a()V
    ...
    iget-object v2, v0, Lom1;->h:Ljava/lang/Object;
    ...
    iget-object v3, v0, Lom1;->a:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    :try_start_1
    iput-boolean v3, v0, Lom1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v2

    iget-object v2, v0, Lom1;->k:Lq1j;

    new-instance v3, Llf;

    const/16 v4, 0x14

    invoke-direct {v3, v0, v4, v1}, Llf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-interface {v2, v0, v3}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lom1;Lhy1;Lorg/webrtc/VideoFrame;Leq1;)V
    .locals 16
    ...
    iget-object v4, v2, Lpm1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lom1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lom1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Lqm1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lhy1;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Lqm1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lom1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Lqm1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v3}, Lom1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v1, v1, Lom1;->e:Landroid/opengl/EGLDisplay;
    ...
    invoke-static {v1}, Lom1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v3

    iget-object v2, v2, Lhy1;->l:Liy1;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v2, Liy1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v2, Liy1;->h:J

    iget-wide v5, v2, Liy1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v2, Liy1;->i:J
