...
# static fields
.field public static final j:[Lq0i;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lq0i;->b:Lq0i;

    filled-new-array {v0, v1}, [Lq0i;

    move-result-object v0

    sput-object v0, Lxw4;->j:[Lq0i;
...
.method public constructor <init>(Llih;Lynd;Lm0c;Lbw8;)V
    ...
    iput-object p1, p0, Lxw4;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lxw4;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lxw4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lxw4;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lyn1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Lxw4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, p2}, Lvzh;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v2, p0}, Lw24;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Ls1j;-><init>(La1c;Lz24;I)V
...
.method public final e(Lyn1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lxm8;-><init>(I)V

    iput-object v1, v2, Lxm8;->c:Ljava/lang/Object;

    iput-object p1, v2, Lxm8;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lxm8;->o()Lky1;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lxw4;->n(Ljava/lang/String;Lky1;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Lxw4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lvzh;->a:Lorg/webrtc/VideoSink;
...
.method public final n(Ljava/lang/String;Lky1;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lvw4;-><init>(Lxw4;Ljava/lang/String;Lky1;Ljava/util/List;)V
    ...
    invoke-direct {p2, p1, v1, p3}, Ls1j;-><init>(La1c;Lz24;I)V
...
.method public final p(Ljava/lang/String;Lky1;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lxw4;->g:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v1, p0, Lxw4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v1, v4, v0}, Lynd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, v1, Lvzh;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Lxw4;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lxw4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lxw4;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Lxw4;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Lxw4;->f:Ljava/util/concurrent/ConcurrentHashMap;
