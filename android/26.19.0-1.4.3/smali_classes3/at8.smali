...
.method public final e()V
    ...
    iput-object v0, p0, Lat8;->j:Ljava/lang/String;
...
.method public final f(IILjava/lang/String;)Z
    ...
    :cond_0
    iget-object v1, p0, Lat8;->j:Ljava/lang/String;

    if-eqz v1, :cond_1

    invoke-static {v1, p3}, Lgn8;->g(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_1
    iput-boolean v0, p0, Lat8;->k:Z

    iput-object p3, p0, Lat8;->j:Ljava/lang/String;
...
.method public final onNextFrameRendered(Lone/me/rlottie/RLottieDrawable;I)V
    ...
    iget-boolean p1, p0, Lat8;->k:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lat8;->l:Lzs8;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lzs8;->d()V

    :cond_0
    const/4 p1, 0x0

    iput-boolean p1, p0, Lat8;->k:Z

    :cond_1
    return-void
.end method

.method public final setFailureListener(Lys8;)V
    .locals 0

    iput-object p1, p0, Lat8;->m:Lys8;

    return-void
.end method

.method public final setOnFirstFrameListener(Lzs8;)V
    .locals 0

    iput-object p1, p0, Lat8;->l:Lzs8;
