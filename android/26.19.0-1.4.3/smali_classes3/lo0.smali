...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2, p0}, Lh98;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Llo0;->b:Lh98;

    new-instance v0, Lmn4;

    const/16 v2, 0xd

    invoke-direct {v0, v2, p0}, Lmn4;-><init>(ILjava/lang/Object;)V
    ...
    iput-object v0, p0, Llo0;->c:Ljava/lang/Object;
...
.method private final getAgslDelegate()Lmd;
    .locals 1
...
# virtual methods
.method public abstract a(Lld;FF)V
.end method

.method public final b()V
    .locals 1

    iget-boolean v0, p0, Llo0;->e:Z
    ...
    :cond_1
    iget-object v0, p0, Llo0;->d:La27;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, La27;->a()V
...
.method public final c()V
    ...
    iput-boolean v0, p0, Llo0;->e:Z

    iget-boolean v1, p0, Llo0;->a:Z

    if-eqz v1, :cond_6

    invoke-direct {p0}, Llo0;->getAgslDelegate()Lmd;

    move-result-object v1

    iget-object v2, v1, Lmd;->a:Lh98;

    iget-object v3, v1, Lmd;->b:Landroid/graphics/RuntimeShader;
    ...
    invoke-virtual {v3}, Llo0;->getSpec()Ldbh;
    ...
    sget-object v4, Lmd;->g:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v3}, Lkd;->b(Ljava/lang/Object;)Landroid/graphics/RuntimeShader;
    ...
    :goto_0
    iput-object v3, v1, Lmd;->b:Landroid/graphics/RuntimeShader;

    if-nez v3, :cond_8

    sget-object v3, Ljbf;->a:Ljava/lang/Object;

    iget-object v2, v2, Lh98;->b:Ljava/lang/Object;

    check-cast v2, Llo0;

    invoke-virtual {v2}, Llo0;->getSpec()Ldbh;
    ...
    invoke-virtual {v2}, Lzf2;->r()Ljava/util/List;
    ...
    :goto_2
    iget-object v4, v4, Lebh;->a:Ljava/lang/String;
    ...
    invoke-static {v9, v6, v7, v4, v8}, Lp1c;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Ljbf;->a:Ljava/lang/Object;
    ...
    invoke-direct {v5, v0}, Lr9f;-><init>(I)V
    ...
    invoke-virtual {v4, v6, v5}, Lzzd;->c(Ljava/lang/String;Lbu6;)Ljava/lang/String;
    ...
    invoke-direct {v4, v0}, Lr9f;-><init>(I)V
    ...
    invoke-virtual {v2, v0, v4}, Lzzd;->c(Ljava/lang/String;Lbu6;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lkd;->c(Ljava/lang/String;)Landroid/graphics/RuntimeShader;

    move-result-object v0

    iput-object v0, v1, Lmd;->b:Landroid/graphics/RuntimeShader;

    return-void

    :cond_6
    iget-object v1, p0, Llo0;->d:La27;
    ...
    iget-object v3, p0, Llo0;->b:Lh98;

    invoke-direct {v1, v2, v3}, La27;-><init>(Landroid/content/Context;Lh98;)V

    iput-object v1, p0, Llo0;->d:La27;
    ...
    invoke-virtual {v1, v0}, La27;->setStarted(Z)V
...
.method public final d()V
    ...
    iget-object v1, v0, Lmd;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iput-object v2, v0, Lmd;->b:Landroid/graphics/RuntimeShader;

    sget-object v2, Lmd;->g:Ljava/util/LinkedHashMap;

    iget-object v0, v0, Lmd;->a:Lh98;

    iget-object v0, v0, Lh98;->b:Ljava/lang/Object;

    check-cast v0, Llo0;

    invoke-virtual {v0}, Llo0;->getSpec()Ldbh;
...
.method public abstract getSpec()Ldbh;
.end method
...
.method public final onDrawForeground(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v1, Lmd;->b:Landroid/graphics/RuntimeShader;
    ...
    invoke-static {v1, v4}, Lkd;->B(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, v0, Lmd;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v2, v3}, Llo0;->a(Lld;FF)V
