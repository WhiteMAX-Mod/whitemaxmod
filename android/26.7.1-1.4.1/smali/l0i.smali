...
# direct methods
.method public static c0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 5
    ...
    invoke-static {v0, v1}, Ll0i;->e0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Ll0i;->e0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static d0([Ljv6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Ljv6;->b()Landroid/net/Uri;
...
.method public static e0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    .locals 2
...
.method public final B(Landroid/content/Context;Lgv6;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lhv6;->c()Ljava/lang/String;
    ...
    invoke-static {p2, p4}, Ll0i;->c0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final C(Landroid/content/Context;[Ljv6;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Ll0i;->d0([Ljv6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, Ll0i;->c0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final D(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1}, Ll0i;->d0([Ljv6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p1}, Ll0i;->d0([Ljv6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, Ll0i;->c0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final F(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
    .locals 0
...
.method public final H([Ljv6;I)Ljv6;
    .locals 0
