...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ll0h;->a:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Ll0h;->b:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Ll0h;->c:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0, p1}, Ll0h;->onThemeChanged(La6c;)V
...
.method public final g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lime;)V
    ...
    invoke-static {p3, p4}, Ll0h;->j(Landroidx/recyclerview/widget/RecyclerView;I)Z
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lime;)V
    ...
    invoke-static {p2, v2}, Ll0h;->j(Landroidx/recyclerview/widget/RecyclerView;I)Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v3, p0, Ll0h;->a:Landroid/content/Context;
    ...
    iget-object v4, p0, Ll0h;->d:Llhg;

    iget-object v5, p0, Ll0h;->b:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Ll0h;->c:Landroid/text/TextPaint;
...
.method public final onThemeChanged(La6c;)V
    ...
    iget-object v2, p0, Ll0h;->a:Landroid/content/Context;

    iget-object v3, p0, Ll0h;->c:Landroid/text/TextPaint;
