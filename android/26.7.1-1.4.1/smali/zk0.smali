...
.method public constructor <init>(Lxk8;Lxk8;)V
    ...
    iput-object p1, p0, Lzk0;->a:Lxk8;

    iput-object p2, p0, Lzk0;->b:Lxk8;

    return-void
.end method

.method public static final a(Lzk0;[BLqbi;)Ls5h;
    .locals 2
    ...
    invoke-virtual {p2}, Lqbi;->c()I

    move-result v0

    invoke-virtual {p2}, Lqbi;->a()I

    move-result v1

    invoke-direct {p0, p1, v0, v1}, Ls5h;-><init>(Ljava/lang/String;II)V

    invoke-virtual {p2}, Lqbi;->b()I

    move-result p1

    invoke-virtual {p0, p1}, Ls5h;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    invoke-virtual {p2}, Lqbi;->d()Z
    ...
    invoke-virtual {p0, p1}, Ls5h;->c(Landroid/graphics/Xfermode;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lexe;->s(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lpbi;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Lel0;)Ljava/util/LinkedHashMap;
    .locals 28
    ...
    iget-object v8, v11, Lxk0;->a:Ljava/lang/String;
    ...
    invoke-direct {v14, v2}, Lel0;-><init>(Ljava/lang/String;)V

    sget-object v2, Lil3;->v0:Lava;

    move-object/from16 v8, p1

    invoke-virtual {v2, v8}, Lava;->f(Landroid/content/Context;)Lil3;
    ...
    :goto_3
    invoke-static {v2, v13}, Lr90;->d(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-boolean v2, v11, Lxk0;->b:Z

    invoke-static {v15, v2}, Lzua;->y(Ld6c;Z)La6c;

    move-result-object v2

    invoke-interface {v2}, La6c;->z()Lt5c;

    move-result-object v2

    iget-object v2, v2, Lt5c;->a:Lvqh;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v11, v2, Lvqh;->f:Ljava/lang/Object;

    check-cast v11, [I

    iget v13, v2, Lvqh;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v14}, Lel0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v13}, Lkbk;->c(I)I

    move-result v26

    invoke-direct/range {v20 .. v26}, Lqbi;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v13, v11, v8}, Lobi;-><init>([IF)V
    ...
    iget-object v8, v2, Lvqh;->e:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v4, v8}, Lzk0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v4}, Lzk0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lobi;-><init>([IF)V
    ...
    invoke-static {v6, v0}, Lr90;->d(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v11}, Luv;->r0(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Lrbi;

    invoke-direct/range {v20 .. v26}, Lrbi;-><init>(Lqbi;Lobi;Lobi;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lqbi;Lm4h;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Lzk0;->a:Lxk8;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lyk0;-><init>(Lzk0;Landroid/content/Context;Lqbi;Lkotlin/coroutines/Continuation;)V
