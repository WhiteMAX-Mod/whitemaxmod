...
# direct methods
.method public constructor <init>(Lus4;Lyxc;)V
    .locals 1

    const/16 v0, 0x10

    invoke-direct {p0, v0}, Lu2h;-><init>(I)V

    iget-object v0, p1, Lus4;->e:Ljava/util/List;

    iput-object v0, p0, Luxe;->c:Ljava/util/List;

    iput-object p1, p0, Luxe;->b:Lus4;

    iput-object p2, p0, Luxe;->d:Lyxc;
...
.method public final b(Lo17;)V
    ...
    invoke-virtual {p1, v0}, Lo17;->Y(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {p1}, Lyxc;->n(Lo17;)V

    if-nez v2, :cond_2

    invoke-static {p1}, Lyxc;->w(Lo17;)Ltxe;

    move-result-object v0

    iget-boolean v1, v0, Ltxe;->a:Z
    ...
    iget-object v0, v0, Ltxe;->b:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lo17;->z(Ljava/lang/String;)V

    const-string v0, "5181942b9ebc31ce68dacb56c16fd79f"

    invoke-static {v0}, Lsak;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Lo17;->z(Ljava/lang/String;)V

    iget-object p1, p0, Luxe;->c:Ljava/util/List;
...
.method public final c(Lo17;II)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Luxe;->e(Lo17;II)V
...
.method public final d(Lo17;)V
    ...
    invoke-direct {v1, v4, v5, v3}, Lq7d;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {p1, v1}, Lo17;->w(Lz2h;)Landroid/database/Cursor;
    ...
    invoke-virtual {p1, v1}, Lo17;->z(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p1}, Ls2h;-><init>(Lt2h;)V

    invoke-virtual {v0, v1}, Lbxe;->r(Ln2f;)V

    iget-object v0, p0, Luxe;->c:Ljava/util/List;
    ...
    invoke-virtual {v1, p1}, Laxe;->a(Lt2h;)V

    goto :goto_4

    :cond_5
    iput-object v3, p0, Luxe;->b:Lus4;
...
.method public final e(Lo17;II)V
    ...
    iget-object v0, p0, Luxe;->b:Lus4;

    if-eqz v0, :cond_2

    iget-object v0, v0, Lus4;->d:Lar5;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v0, p2, p3}, Ly17;->u(Lar5;II)Ljava/util/List;
    ...
    invoke-direct {p2, p1}, Ls2h;-><init>(Lt2h;)V

    invoke-static {p2}, Lfek;->a(Ln2f;)V
    ...
    invoke-virtual {p3, v0}, Leoa;->a(Ln2f;)V
    ...
    invoke-virtual {p1, p2}, Lo17;->z(Ljava/lang/String;)V
    ...
    invoke-static {v0, p2, p3}, Ly17;->Q(Lus4;II)Z

    move-result v1

    if-nez v1, :cond_a

    iget-boolean p2, v0, Lus4;->s:Z

    if-eqz p2, :cond_7

    const-string p2, "SELECT name, type FROM sqlite_master WHERE type = \'table\' OR type = \'view\'"

    invoke-virtual {p1, p2}, Lo17;->Y(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {v0, v2, v1}, Layg;->P0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p3, v2}, Lht8;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p3, v1}, Lht8;->listIterator(I)Ljava/util/ListIterator;
    ...
    invoke-virtual {p1, p3}, Lo17;->z(Ljava/lang/String;)V
    ...
    invoke-static {p2, p1}, Ly17;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :cond_8
    iget-object p2, p0, Luxe;->c:Ljava/util/List;
    ...
    invoke-static {v2, p2, v0, p3, v1}, Lsa2;->l(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
