...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lox5;->o:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lox5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lox5;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final C0()J
    ...
    :cond_0
    invoke-virtual {p0}, Lox5;->G0()V

    :goto_0
    sget-object v0, Lox5;->o:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_5
    sget-object v5, Lqx5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_b
    sget-object v3, Lqx5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_c
    sget-object v0, Lox5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public F0(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lox5;->H0(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lpx5;->f0()Ljava/lang/Thread;
    ...
    invoke-virtual {v0, p1}, Ld05;->F0(Ljava/lang/Runnable;)V
...
.method public final G0()V
    ...
    invoke-virtual {p0, v3}, Lox5;->H0(Ljava/lang/Runnable;)Z
...
.method public final H0(Ljava/lang/Runnable;)Z
    ...
    sget-object v2, Lox5;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :cond_7
    sget-object v2, Lqx5;->b:Lkotlinx/coroutines/internal/Symbol;
...
.method public final J0(JLmx5;)V
    .locals 5

    sget-object v0, Lox5;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    sget-object v3, Lox5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_3
    invoke-virtual {p3, p1, p2, v0, p0}, Lmx5;->b(JLnx5;Lox5;)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lpx5;->E0(JLmx5;)V
...
.method public final dispatch(Lwk4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lox5;->F0(Ljava/lang/Runnable;)V
...
.method public invokeOnTimeout(JLjava/lang/Runnable;Lwk4;)Lad5;
    ...
    invoke-static {p1, p2, p3, p4}, Lgkk;->d(JLjava/lang/Runnable;Lwk4;)Lad5;
...
.method public final scheduleResumeAfterDelay(JLzb2;)V
    ...
    sget-object v0, Lqx5;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-direct {v2, p0, v0, v1, p3}, Lkx5;-><init>(Lox5;JLzb2;)V

    invoke-virtual {p0, p1, p2, v2}, Lox5;->J0(JLmx5;)V

    new-instance p1, Lkb2;

    const/4 p2, 0x1

    invoke-direct {p1, v2, p2}, Lkb2;-><init>(Ljava/lang/Object;I)V
...
.method public shutdown()V
    ...
    sget-object v0, Ltih;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v4, Lqx5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :goto_2
    sget-object v2, Lox5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_7
    invoke-virtual {p0, v0, v1, v2}, Lpx5;->E0(JLmx5;)V
