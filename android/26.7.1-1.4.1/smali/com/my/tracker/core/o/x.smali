...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-direct {v1, v4}, Ly55;-><init>(I)V

    invoke-virtual {v1, p1}, Ly55;->h(Ljava/lang/String;)V

    .line 32
    const-string p1, "GET"

    invoke-virtual {v1, p1, v3}, Ly55;->e(Ljava/lang/String;Loa3;)V
    ...
    .line 34
    invoke-interface {p2}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Ljkb;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Lfte;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    .line 100
    sget-object v4, Lkv9;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 101
    :try_start_6
    invoke-static {p2}, Lr90;->N(Ljava/lang/String;)Lkv9;
    ...
    invoke-virtual {v6, p1, v5}, Lyxc;->A(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 105
    invoke-static {v5, p2, p1}, Le7b;->b(ILkv9;[B)Ltre;
    ...
    invoke-virtual {v4, p2, p1}, Ly55;->e(Ljava/lang/String;Loa3;)V
    ...
    .line 110
    invoke-interface {p4}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Ljkb;
    ...
    .line 128
    invoke-virtual {v3}, Lfte;->close()V
