...
.method public static b(I)Ljava/lang/Integer;
    ...
    :cond_0
    sget-object v0, Ltj3;->$EnumSwitchMapping$0:[I
...
.method public final c([B)Lao2;
    ...
    :try_start_0
    invoke-static {v0, v1}, Ll6a;->mergeFrom(Ll6a;[B)Ll6a;
    ...
    :cond_0
    sget-object v6, Lyn2;->d:Lyn2;

    goto :goto_0

    :cond_1
    sget-object v6, Lyn2;->c:Lyn2;

    goto :goto_0

    :cond_2
    sget-object v6, Lyn2;->a:Lyn2;

    :cond_3
    :goto_0
    iput-object v6, v1, Lhn2;->b:Lyn2;
    ...
    iget-object v10, v1, Lhn2;->n:Lsn2;

    invoke-static {v9}, Lru/ok/tamtam/nano/a;->i(Lru/ok/tamtam/nano/Protos$Chat$Chunk;)Lrn2;

    move-result-object v9

    sget-object v11, Ll65;->o:Ll65;

    invoke-virtual {v10, v9, v11}, Lsn2;->a(Lrn2;Ll65;)V
    ...
    :cond_6
    sget-object v11, Lln2;->c:Lln2;

    invoke-virtual {v7, v11}, Lon2;->a(Lln2;)V

    goto :goto_5

    :cond_7
    sget-object v11, Lln2;->b:Lln2;
    ...
    :goto_6
    invoke-virtual {v8, v2}, Lnn2;->j(Ljava/util/List;)V

    invoke-virtual {v8}, Lnn2;->a()Lnn2;

    move-result-object v2

    iput-object v2, v1, Lhn2;->p:Lnn2;
    ...
    invoke-static {v2}, Lru/ok/tamtam/nano/a;->g(Lru/ok/tamtam/nano/Protos$Chat$ChatMedia;)Lkn2;

    move-result-object v2

    iput-object v2, v1, Lhn2;->q:Lkn2;
    ...
    iput-object v11, v1, Lhn2;->z:Ljava/util/ArrayList;
    ...
    :cond_19
    sget-object v10, Lin2;->d:Lin2;

    invoke-virtual {v1, v10}, Lhn2;->a(Lin2;)V

    goto :goto_9

    :cond_1a
    sget-object v10, Lin2;->c:Lin2;
    ...
    invoke-direct {v8, v2}, Lqn2;-><init>([J)V

    iput-object v8, v1, Lhn2;->E:Lqn2;
    ...
    invoke-virtual {v1}, Lhn2;->c()Ljava/util/Map;
    ...
    iput-object v2, v1, Lhn2;->J:Ljava/util/List;
    ...
    invoke-virtual {v14, v11, v12}, Lfn2;->c(J)V

    const/16 v11, 0xffb

    invoke-virtual {v14, v11}, Lfn2;->e(I)V

    invoke-virtual {v14}, Lfn2;->a()Lgn2;
    ...
    :cond_24
    invoke-virtual {v1, v2}, Lhn2;->d(Ljava/util/Map;)V
    ...
    iget-object v8, v1, Lhn2;->L:Lmn2;

    if-nez v8, :cond_26

    sget-object v8, Lmn2;->m:Lmn2;

    iput-object v8, v1, Lhn2;->L:Lmn2;

    :cond_26
    iget-object v8, v1, Lhn2;->L:Lmn2;

    iget-boolean v8, v8, Lmn2;->a:Z
    ...
    invoke-direct/range {v9 .. v21}, Lmn2;-><init>(ZZZZZZZZZZZZ)V

    iput-object v9, v1, Lhn2;->L:Lmn2;
    ...
    :cond_28
    iput v5, v1, Lhn2;->u0:I

    goto :goto_c

    :cond_29
    iput v4, v1, Lhn2;->u0:I

    :goto_c
    iget-object v2, v0, Lru/ok/tamtam/nano/Protos$Chat;->link:Ljava/lang/String;

    iput-object v2, v1, Lhn2;->F:Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v6}, Lvn2;-><init>(II)V

    iput-object v2, v1, Lhn2;->G:Lvn2;
    ...
    invoke-direct {v3}, Ltn2;-><init>()V

    iget-wide v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->groupId:J

    invoke-virtual {v3, v7, v8}, Ltn2;->m(J)V

    iget-boolean v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->isAnswered:Z

    invoke-virtual {v3, v7}, Ltn2;->o(Z)V

    iget-boolean v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->isModerator:Z

    invoke-virtual {v3, v7}, Ltn2;->s(Z)V

    iget-boolean v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->isImportant:Z

    invoke-virtual {v3, v7}, Ltn2;->q(Z)V

    iget-object v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->name:Ljava/lang/String;

    invoke-virtual {v3, v7}, Ltn2;->u(Ljava/lang/String;)V

    iget-object v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->baseIconUrl:Ljava/lang/String;

    invoke-virtual {v3, v7}, Ltn2;->l(Ljava/lang/String;)V

    iget-boolean v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->isCustomTitle:Z

    invoke-virtual {v3, v7}, Ltn2;->p(Z)V

    iget-boolean v7, v2, Lru/ok/tamtam/nano/Protos$Chat$GroupChatInfo;->isMember:Z

    invoke-virtual {v3, v7}, Ltn2;->r(Z)V
    ...
    invoke-direct {v8, v7}, Lse7;-><init>(Z)V

    move-object v7, v8

    :goto_d
    invoke-virtual {v3, v7}, Ltn2;->n(Lse7;)V
    ...
    invoke-virtual {v2, v5}, Lzn2;->d(Ljava/lang/String;)V

    iget-object v5, v0, Lru/ok/tamtam/nano/Protos$Chat;->videoConversation:Lru/ok/tamtam/nano/Protos$Chat$VideoConversation;

    iget-wide v7, v5, Lru/ok/tamtam/nano/Protos$Chat$VideoConversation;->startedAt:J

    invoke-virtual {v2, v7, v8}, Lzn2;->h(J)V

    iget-object v5, v0, Lru/ok/tamtam/nano/Protos$Chat;->videoConversation:Lru/ok/tamtam/nano/Protos$Chat$VideoConversation;

    iget-object v5, v5, Lru/ok/tamtam/nano/Protos$Chat$VideoConversation;->joinLink:Ljava/lang/String;

    invoke-virtual {v2, v5}, Lzn2;->e(Ljava/lang/String;)V

    iget-object v5, v0, Lru/ok/tamtam/nano/Protos$Chat;->videoConversation:Lru/ok/tamtam/nano/Protos$Chat$VideoConversation;

    iget v5, v5, Lru/ok/tamtam/nano/Protos$Chat$VideoConversation;->approxParticipantCount:I

    invoke-virtual {v2, v5}, Lzn2;->c(I)V

    invoke-virtual {v2, v3}, Lzn2;->g(Ljava/util/List;)V

    invoke-virtual {v2, v6}, Lzn2;->i(I)V

    invoke-virtual {v2, v4}, Lzn2;->f(I)V

    invoke-virtual {v2}, Lzn2;->a()Lzn2;

    move-result-object v2

    iput-object v2, v1, Lhn2;->V:Lzn2;

    :cond_35
    iget-wide v2, v0, Lru/ok/tamtam/nano/Protos$Chat;->lastOpenPositionTime:J

    iput-wide v2, v1, Lhn2;->W:J
    ...
    iput-object v4, v1, Lhn2;->n0:Ljava/lang/String;

    goto :goto_14

    :cond_37
    iput-object v2, v1, Lhn2;->n0:Ljava/lang/String;
