...
# instance fields
.field public A0:Lvgh;

.field public B0:Llm5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc6b;->J0:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lc6b;->K0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, Lc6b;->J0:Ljava/util/regex/Pattern;

    iput-object v0, p0, Lc6b;->a:Ljava/util/regex/Pattern;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lc6b;->b:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lc6b;->w0:F

    sget-object v0, Llm5;->b:Llm5;

    iput-object v0, p0, Lc6b;->B0:Llm5;

    const/high16 v0, -0x1000000

    iput v0, p0, Lc6b;->C0:I

    sget-object v0, Lc6b;->K0:Landroid/text/TextPaint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTypeface()Landroid/graphics/Typeface;

    move-result-object v1

    iput-object v1, p0, Lc6b;->D0:Landroid/graphics/Typeface;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getLetterSpacing()F

    move-result v1

    iput v1, p0, Lc6b;->E0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTextSize()F

    move-result v1

    iput v1, p0, Lc6b;->F0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->isElegantTextHeight()Z

    move-result v0

    iput-boolean v0, p0, Lc6b;->G0:Z

    const/4 v0, 0x2

    iput v0, p0, Lc6b;->H0:I

    new-instance v0, Lb6b;

    invoke-direct {v0, p0, p1}, Lb6b;-><init>(Lc6b;Landroid/content/Context;)V

    iput-object v0, p0, Lc6b;->I0:Lb6b;
...
.method private final getFullyVisibleLinesCount()I
    ...
    invoke-virtual {p0, v0, v1}, Lc6b;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
...
.method private final getLinesCount()I
    ...
    invoke-direct {p0}, Lc6b;->getFullyVisibleLinesCount()I
...
.method public static final h(Lc6b;Landroid/text/TextPaint;)V
    .locals 1

    iget-object v0, p0, Lc6b;->D0:Landroid/graphics/Typeface;

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v0, p0, Lc6b;->E0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setLetterSpacing(F)V

    iget v0, p0, Lc6b;->F0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTextSize(F)V

    iget p0, p0, Lc6b;->C0:I
...
.method private final setContent(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lc6b;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lc6b;->l()V

    iput-object p1, p0, Lc6b;->d:Ljava/lang/CharSequence;

    const/4 p1, 0x0

    iput-object p1, p0, Lc6b;->z0:Lwfh;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lc6b;->v0:Z
...
.method private final setLayoutInternal(Landroid/text/Layout;)V
    ...
    :goto_0
    iput-object v0, p0, Lc6b;->c:Landroid/text/StaticLayout;
    ...
    :goto_1
    iput-object v0, p0, Lc6b;->d:Ljava/lang/CharSequence;
    ...
    :cond_2
    iput-object v1, p0, Lc6b;->o:Ljava/lang/CharSequence;
...
.method private final setStaticLayoutsTextColor(I)V
    ...
    iget-object v0, p0, Lc6b;->c:Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object v0, p0, Lc6b;->z0:Lwfh;

    if-eqz v0, :cond_1

    iget-object v1, v0, Lwfh;->a:Lggh;
    ...
    iget-object v0, v0, Lwfh;->b:Lggh;

    invoke-virtual {v0}, Lggh;->a()Landroid/text/Layout;
...
.method public final a(Llm5;)V
    ...
    iget-object v0, p0, Lc6b;->A0:Lvgh;
    ...
    :cond_0
    iget-object v1, p0, Lc6b;->B0:Llm5;
    ...
    :cond_1
    iput-object p1, p0, Lc6b;->B0:Llm5;

    invoke-virtual {p0, v0, p1}, Lc6b;->i(Lvgh;Llm5;)V
...
.method public final d(Lvgh;Llm5;)V
    .locals 0

    iput-object p1, p0, Lc6b;->A0:Lvgh;

    iput-object p2, p0, Lc6b;->B0:Llm5;

    invoke-virtual {p0, p1, p2}, Lc6b;->i(Lvgh;Llm5;)V
...
.method public final e()Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lc6b;->b:Landroid/graphics/Rect;
...
.method public final g(Ljava/lang/String;)F
    ...
    :try_start_0
    invoke-static {p0, v0}, Lc6b;->h(Lc6b;Landroid/text/TextPaint;)V
...
.method public getLineHeight()I
    ...
    iget v0, p0, Lc6b;->x0:F

    int-to-float v1, v1

    iget v2, p0, Lc6b;->w0:F
...
.method public final i(Lvgh;Llm5;)V
    .locals 16
    ...
    iget-object v3, v0, Lvgh;->e:Ljava/lang/String;
    ...
    invoke-static {v5}, Lsa2;->c(I)I

    move-result v5

    invoke-static {v2, v3, v5}, Li0i;->a(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;

    move-result-object v2

    iput-object v2, v1, Lc6b;->D0:Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {p1 .. p2}, Lvgh;->h(Llm5;)J

    move-result-wide v5

    invoke-static {v5, v6, v2}, Lwa5;->d(JLandroid/util/DisplayMetrics;)F

    move-result v3

    iput v3, v1, Lc6b;->E0:F

    invoke-virtual/range {p1 .. p2}, Lvgh;->j(Llm5;)J
    ...
    iput v3, v1, Lc6b;->F0:F

    invoke-virtual/range {p1 .. p2}, Lvgh;->i(Llm5;)J
    ...
    sget-object v2, Lc6b;->K0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v2}, Lc6b;->h(Lc6b;Landroid/text/TextPaint;)V
    ...
    iput v0, v1, Lc6b;->x0:F

    const/4 v0, 0x0

    iput-boolean v0, v1, Lc6b;->G0:Z

    const/4 v0, 0x1

    iput-boolean v0, v1, Lc6b;->v0:Z
...
.method public final j()V
    ...
    invoke-interface {v1, p0}, Ldti;->attach(Landroid/view/View;)V
...
.method public final k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    sget-object v4, Lc6b;->K0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v4}, Lc6b;->h(Lc6b;Landroid/text/TextPaint;)V
    :try_end_0
...
.method public final l()V
    ...
    invoke-interface {v1, p0}, Ldti;->detach(Landroid/view/View;)V
...
.method public final onAttachedToWindow()V
    ...
    iget-object v2, v1, Lggh;->c:Ljava/util/concurrent/CopyOnWriteArraySet;

    iget-object v3, p0, Lc6b;->I0:Lb6b;
    ...
    iget-object v0, v0, Lggh;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v1, p0, Lc6b;->I0:Lb6b;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lwfh;->a:Lggh;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, v1, Lc6b;->v0:Z

    const/4 v3, 0x1

    if-nez v0, :cond_1

    iget-object v0, v1, Lc6b;->z0:Lwfh;
    ...
    :goto_0
    iget-object v0, v0, Lggh;->b:Llm5;

    iget-object v4, v1, Lc6b;->B0:Llm5;
    ...
    :cond_3
    iget-object v0, v1, Lc6b;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v4, v0}, Lc6b;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v5

    invoke-direct {v1}, Lc6b;->getLinesCount()I
    ...
    invoke-virtual {v1, v4, v9}, Lc6b;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    iget-object v6, v1, Lc6b;->a:Ljava/util/regex/Pattern;
    ...
    :cond_8
    :goto_3
    iput-object v3, v1, Lc6b;->o:Ljava/lang/CharSequence;

    goto :goto_4

    :cond_9
    iput-object v0, v1, Lc6b;->o:Ljava/lang/CharSequence;

    :goto_4
    iget-object v0, v1, Lc6b;->o:Ljava/lang/CharSequence;
    ...
    :goto_5
    invoke-virtual {v1, v4, v8}, Lc6b;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v0

    iput-object v0, v1, Lc6b;->c:Landroid/text/StaticLayout;

    iput-boolean v7, v1, Lc6b;->v0:Z

    :cond_b
    :goto_6
    iget-object v0, v1, Lc6b;->c:Landroid/text/StaticLayout;

    if-eqz v0, :cond_c

    sget-object v3, Lc6b;->K0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v3}, Lc6b;->h(Lc6b;Landroid/text/TextPaint;)V
...
.method public final onMeasure(II)V
    ...
    :goto_0
    iget-object v2, p0, Lc6b;->c:Landroid/text/StaticLayout;
    ...
    :cond_3
    invoke-virtual {p0, p2, v0}, Lc6b;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    invoke-virtual {p0}, Lc6b;->getMaxLinesValue()I
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p2, p0, Lc6b;->z0:Lwfh;
    ...
    :cond_0
    iget-object p1, p2, Lwfh;->b:Lggh;

    goto :goto_0

    :goto_1
    iget-object p2, p0, Lc6b;->c:Landroid/text/StaticLayout;

    if-eq p2, p1, :cond_1

    invoke-direct {p0, p1}, Lc6b;->setLayoutInternal(Landroid/text/Layout;)V
...
.method public final onWindowVisibilityChanged(I)V
    ...
    invoke-super {p0, p1}, Lmjb;->onWindowVisibilityChanged(I)V
...
.method public setLayout(Lwfh;)V
    .locals 4
    ...
    iget-object v2, v0, Lwfh;->a:Lggh;

    iget-object v3, v2, Lggh;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Lc6b;->o:Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-object p1, p0, Lc6b;->c:Landroid/text/StaticLayout;
...
.method public setTextColor(I)V
    ...
    iput p1, p0, Lc6b;->C0:I

    invoke-direct {p0, p1}, Lc6b;->setStaticLayoutsTextColor(I)V
...
.method public setTextValue(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lc6b;->setContent(Ljava/lang/CharSequence;)V
