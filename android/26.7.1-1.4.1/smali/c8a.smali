...
# static fields
.field public static final B0:Lorg/msgpack/core/buffer/MessageBuffer;


# instance fields
.field public A0:Ljava/nio/CharBuffer;

.field public final X:I

.field public final Y:Lorg/msgpack/core/buffer/ArrayBufferInput;

.field public Z:Lorg/msgpack/core/buffer/MessageBuffer;
...
.field public final w0:Lorg/msgpack/core/buffer/MessageBuffer;

.field public x0:I

.field public y0:Ljava/lang/StringBuilder;

.field public z0:Ljava/nio/charset/CharsetDecoder;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8a;->B0:Lorg/msgpack/core/buffer/MessageBuffer;

    return-void
.end method

.method public constructor <init>(Lorg/msgpack/core/buffer/ArrayBufferInput;Lp6a;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-object v0, Lc8a;->B0:Lorg/msgpack/core/buffer/MessageBuffer;

    iput-object v0, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    iput-object v0, p0, Lc8a;->w0:Lorg/msgpack/core/buffer/MessageBuffer;

    iput-object p1, p0, Lc8a;->Y:Lorg/msgpack/core/buffer/ArrayBufferInput;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lc8a;->a:Z

    iput-boolean p1, p0, Lc8a;->b:Z

    iget-object p1, p2, Lp6a;->a:Ljava/nio/charset/CodingErrorAction;

    iput-object p1, p0, Lc8a;->c:Ljava/nio/charset/CodingErrorAction;

    iget-object p1, p2, Lp6a;->b:Ljava/nio/charset/CodingErrorAction;

    iput-object p1, p0, Lc8a;->d:Ljava/nio/charset/CodingErrorAction;
...
.method public static G0(BLjava/lang/String;)Lorg/msgpack/core/MessagePackException;
    .locals 4

    sget-object v0, Lr4a;->Y0:[Lr4a;

    and-int/lit16 v1, p0, 0xff

    aget-object v0, v0, v1

    sget-object v1, Lr4a;->Y:Lr4a;
    ...
    invoke-static {v0}, Lbpg;->z(I)Ljava/lang/String;
...
.method public static f0(I)Lorg/msgpack/core/MessageIntegerOverflowException;
    .locals 4
...
.method public static r0(J)Lorg/msgpack/core/MessageIntegerOverflowException;
    .locals 2
...
.method public final B()V
    ...
    invoke-virtual {p0, v2}, Lc8a;->F0(I)V
    ...
    :pswitch_9
    invoke-virtual {p0, v4}, Lc8a;->F0(I)V
    ...
    :pswitch_b
    invoke-virtual {p0, v0}, Lc8a;->F0(I)V
...
.method public final B0(I)Lorg/msgpack/core/buffer/MessageBuffer;
    .locals 5

    iget-object v0, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;

    invoke-virtual {v0}, Lorg/msgpack/core/buffer/MessageBuffer;->size()I

    move-result v0

    iget v1, p0, Lc8a;->v0:I

    sub-int/2addr v0, v1

    if-lt v0, p1, :cond_0

    iput v1, p0, Lc8a;->x0:I

    add-int/2addr v1, p1

    iput v1, p0, Lc8a;->v0:I

    iget-object p1, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;

    return-object p1

    :cond_0
    iget-object v2, p0, Lc8a;->w0:Lorg/msgpack/core/buffer/MessageBuffer;

    const/4 v3, 0x0

    if-lez v0, :cond_1

    iget-object v4, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    :goto_0
    invoke-virtual {p0}, Lc8a;->e0()V

    iget-object v1, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    iput p1, p0, Lc8a;->v0:I

    iput v3, p0, Lc8a;->x0:I
...
.method public final D0()I
    ...
    invoke-direct {v0}, Lorg/msgpack/core/MessageSizeException;-><init>()V
...
.method public final E0(I)[B
    ...
    :goto_0
    iget-object v2, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;

    invoke-virtual {v2}, Lorg/msgpack/core/buffer/MessageBuffer;->size()I

    move-result v2

    iget v3, p0, Lc8a;->v0:I
...
.method public final H0()I
    ...
    invoke-static {v0, v1}, Lc8a;->G0(BLjava/lang/String;)Lorg/msgpack/core/MessagePackException;
...
.method public final I(Ljava/nio/charset/CoderResult;)V
    .locals 2
    ...
    iget-object v0, p0, Lc8a;->c:Ljava/nio/charset/CodingErrorAction;
    ...
    iget-object v0, p0, Lc8a;->d:Ljava/nio/charset/CodingErrorAction;
...
.method public final K0()B
    ...
    :cond_5
    invoke-static {v0}, Lc8a;->f0(I)Lorg/msgpack/core/MessageIntegerOverflowException;
...
.method public final L0()F
    ...
    invoke-virtual {p0, v0}, Lc8a;->B0(I)Lorg/msgpack/core/buffer/MessageBuffer;

    move-result-object v0

    iget v1, p0, Lc8a;->x0:I
...
.method public final M0()I
    ...
    :cond_2
    invoke-static {v3, v4}, Lc8a;->r0(J)Lorg/msgpack/core/MessageIntegerOverflowException;
...
.method public final Q0()Ljava/lang/String;
    ...
    iget-object v2, p0, Lc8a;->z0:Ljava/nio/charset/CharsetDecoder;
    ...
    iput-object v2, p0, Lc8a;->A0:Ljava/nio/CharBuffer;

    sget-object v2, Lq6a;->a:Ljava/nio/charset/Charset;

    invoke-virtual {v2}, Ljava/nio/charset/Charset;->newDecoder()Ljava/nio/charset/CharsetDecoder;

    move-result-object v2

    iget-object v3, p0, Lc8a;->c:Ljava/nio/charset/CodingErrorAction;
    ...
    iget-object v3, p0, Lc8a;->d:Ljava/nio/charset/CodingErrorAction;
    ...
    iput-object v2, p0, Lc8a;->z0:Ljava/nio/charset/CharsetDecoder;
    ...
    :goto_0
    iget-object v2, p0, Lc8a;->y0:Ljava/lang/StringBuilder;
    ...
    iput-object v2, p0, Lc8a;->y0:Ljava/lang/StringBuilder;
    ...
    iget v4, p0, Lc8a;->v0:I

    sub-int/2addr v2, v4

    if-lt v2, v1, :cond_3

    invoke-virtual {p0, v1}, Lc8a;->d(I)Ljava/lang/String;
    ...
    iget-object v0, p0, Lc8a;->y0:Ljava/lang/StringBuilder;
    ...
    :cond_5
    iget-object v5, p0, Lc8a;->Z:Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    iget-object v6, p0, Lc8a;->A0:Ljava/nio/CharBuffer;

    invoke-virtual {v6}, Ljava/nio/CharBuffer;->clear()Ljava/nio/Buffer;

    iget-object v6, p0, Lc8a;->z0:Ljava/nio/charset/CharsetDecoder;

    iget-object v7, p0, Lc8a;->A0:Ljava/nio/CharBuffer;
    ...
    iget v5, p0, Lc8a;->v0:I

    add-int/2addr v5, v4

    iput v5, p0, Lc8a;->v0:I

    sub-int/2addr v1, v4

    iget-object v5, p0, Lc8a;->y0:Ljava/lang/StringBuilder;
    ...
    invoke-virtual {p0, v6}, Lc8a;->I(Ljava/nio/charset/CoderResult;)V
    ...
    iput v4, p0, Lc8a;->v0:I

    invoke-virtual {v2, v3}, Ljava/nio/ByteBuffer;->position(I)Ljava/nio/Buffer;

    iget-object v4, p0, Lc8a;->A0:Ljava/nio/CharBuffer;

    invoke-virtual {v4}, Ljava/nio/CharBuffer;->clear()Ljava/nio/Buffer;

    iget-object v4, p0, Lc8a;->z0:Ljava/nio/charset/CharsetDecoder;

    iget-object v5, p0, Lc8a;->A0:Ljava/nio/CharBuffer;
    ...
    invoke-virtual {p0, v4}, Lc8a;->I(Ljava/nio/charset/CoderResult;)V
    ...
    invoke-direct {v1, v0}, Lorg/msgpack/core/MessageFormatException;-><init>(Ljava/lang/Exception;)V
    ...
    invoke-direct {v0, v1}, Lorg/msgpack/core/MessageSizeException;-><init>(Ljava/lang/String;)V

    throw v0
.end method

.method public final R0()La2;
    .locals 7
    ...
    invoke-direct {v1, v2, v0}, Lk36;-><init>(IB)V
    ...
    invoke-direct {v1, v3, v0}, Lk36;-><init>(IB)V
    ...
    invoke-direct {v1, v6, v0}, Lk36;-><init>(IB)V
    ...
    invoke-direct {v2, v1, v0}, Lk36;-><init>(IB)V
    ...
    :pswitch_8
    invoke-virtual {p0, v6}, Lc8a;->B0(I)Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    :goto_1
    invoke-virtual {v1}, Lk36;->b()B

    move-result v0

    invoke-virtual {v1}, Lk36;->a()I

    move-result v1

    invoke-virtual {p0, v1}, Lc8a;->E0(I)[B

    move-result-object v1

    new-instance v2, Lpw7;

    invoke-direct {v2, v0, v1}, Lpw7;-><init>(B[B)V
    ...
    invoke-direct {v0, v1}, Lcx7;-><init>([Lcbi;)V
    ...
    :pswitch_b
    invoke-virtual {p0}, Lc8a;->I0()I

    move-result v0

    invoke-virtual {p0, v0}, Lc8a;->E0(I)[B

    move-result-object v0

    new-instance v1, Liw7;

    invoke-direct {v1, v0}, Liw7;-><init>([B)V
    ...
    invoke-virtual {p0, v2}, Lc8a;->B0(I)Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    :cond_6
    invoke-virtual {p0, v3}, Lc8a;->B0(I)Lorg/msgpack/core/buffer/MessageBuffer;
    ...
    invoke-direct {v2, v0, v1}, Lnw7;-><init>(D)V

    return-object v2

    :pswitch_e
    sget-object v1, Lr4a;->G0:Lr4a;
    ...
    invoke-direct {v1, v0}, Lgw7;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-direct {v2, v0, v1}, Lww7;-><init>(J)V
...
.method public final close()V
    ...
    iput v0, p0, Lc8a;->v0:I

    iget-object v0, p0, Lc8a;->Y:Lorg/msgpack/core/buffer/ArrayBufferInput;
...
.method public final d(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lc8a;->c:Ljava/nio/charset/CodingErrorAction;

    if-ne v1, v0, :cond_0

    iget-object v1, p0, Lc8a;->d:Ljava/nio/charset/CodingErrorAction;
    ...
    sget-object v3, Lq6a;->a:Ljava/nio/charset/Charset;
    ...
    :try_start_0
    iget-object v1, p0, Lc8a;->z0:Ljava/nio/charset/CharsetDecoder;
