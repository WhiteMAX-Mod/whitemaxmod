...
.field public final g:Lfs9;

.field public final h:Lvs9;

.field public final i:Lns9;

.field public final j:Lmr9;

.field public final k:Lxr9;

.field public final l:Lxq;
...
.method public constructor <init>(Lfs9;Landroid/net/Uri;Landroid/os/Handler;Landroid/os/Bundle;Lvw7;Lvw7;Ljqf;Layc;Landroid/os/Bundle;)V
    .locals 9

    invoke-direct {p0}, Lor9;-><init>()V

    iput-object p1, p0, Lps9;->g:Lfs9;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lps9;->o:Z

    iput-object p5, p0, Lps9;->t:Lvw7;

    iput-object p6, p0, Lps9;->u:Lvw7;

    move-object/from16 v2, p7

    iput-object v2, p0, Lps9;->v:Ljqf;

    move-object/from16 v2, p8

    iput-object v2, p0, Lps9;->w:Layc;
    ...
    iput-object v2, p0, Lps9;->s:Landroid/os/Bundle;

    iget-object v4, p1, Lfs9;->f:Lone/me/android/media/service/OneMeMediaSessionService;

    invoke-static {v4}, Lvs9;->a(Landroid/content/Context;)Lvs9;

    move-result-object v2

    iput-object v2, p0, Lps9;->h:Lvs9;

    new-instance v2, Lns9;

    invoke-direct {v2, p0}, Lns9;-><init>(Lps9;)V

    iput-object v2, p0, Lps9;->i:Lns9;

    new-instance v2, Ls7h;

    invoke-direct {v2, p1}, Ls7h;-><init>(Lfs9;)V

    iput-object v2, p0, Lps9;->f:Ls7h;

    const-wide/32 v5, 0x493e0

    iput-wide v5, p0, Lps9;->p:J

    new-instance v3, Lmr9;

    iget-object v5, p1, Lfs9;->l:Landroid/os/Handler;

    invoke-virtual {v5}, Landroid/os/Handler;->getLooper()Landroid/os/Looper;

    move-result-object v5

    invoke-direct {v3, v5, v2}, Lmr9;-><init>(Landroid/os/Looper;Ls7h;)V

    iput-object v3, p0, Lps9;->j:Lmr9;
    ...
    :goto_0
    iput-object v2, p0, Lps9;->m:Landroid/content/ComponentName;
    ...
    invoke-static {v4, v7}, Lps9;->H(Lone/me/android/media/service/OneMeMediaSessionService;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    invoke-direct {v0, p0, v7}, Lxq;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, Lps9;->l:Lxq;
    ...
    :goto_4
    iput-object v6, p0, Lps9;->l:Lxq;

    :goto_5
    const-string v0, "androidx.media3.session.id"

    iget-object v3, p1, Lfs9;->i:Ljava/lang/String;
    ...
    :goto_8
    invoke-direct/range {v3 .. v8}, Lxr9;-><init>(Lone/me/android/media/service/OneMeMediaSessionService;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V

    iput-object v3, p0, Lps9;->k:Lxr9;

    if-lt v0, v1, :cond_b

    if-eqz v2, :cond_b

    invoke-static {v3, v2}, Lxuj;->c(Lxr9;Landroid/content/ComponentName;)V

    :cond_b
    iget-object p1, p1, Lfs9;->u:Landroid/app/PendingIntent;

    if-eqz p1, :cond_c

    iget-object p2, v3, Lxr9;->b:Ljava/lang/Object;
    ...
    :cond_c
    invoke-virtual {v3, p0, p3}, Lxr9;->z(Lor9;Landroid/os/Handler;)V
...
.method public static C(Lxr9;Ljava/util/ArrayList;)V
    .locals 6
    ...
    iput-object p1, p0, Lqr9;->h:Ljava/util/List;
    ...
    invoke-virtual {v1}, Lur9;->d()Landroid/media/session/MediaSession$QueueItem;
...
.method public static D(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Lwk9;
    .locals 9
    ...
    invoke-direct {v8, p0}, Lok9;-><init>(Lzej;)V
...
.method public final A(J)V
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lhs9;-><init>(Lps9;JI)V

    iget-object p1, p0, Lps9;->k:Lxr9;

    iget-object p1, p1, Lxr9;->b:Ljava/lang/Object;

    check-cast p1, Lrr9;

    invoke-virtual {p1}, Lqr9;->b()Lrs9;
    ...
    invoke-virtual {p0, v1, v0, p1, p2}, Lps9;->F(ILos9;Lrs9;Z)V
...
.method public final B()V
    ...
    invoke-direct {v0, p0, v1}, Lgs9;-><init>(Lps9;I)V

    iget-object v1, p0, Lps9;->k:Lxr9;

    iget-object v1, v1, Lxr9;->b:Ljava/lang/Object;

    check-cast v1, Lrr9;

    invoke-virtual {v1}, Lqr9;->b()Lrs9;
    ...
    invoke-virtual {p0, v3, v0, v1, v2}, Lps9;->F(ILos9;Lrs9;Z)V

    return-void
.end method

.method public final E(Lpzc;)Lqxc;
    .locals 31
    ...
    invoke-virtual {v1, v3}, Lpzc;->b(I)Z
    ...
    iget-boolean v6, v0, Lps9;->o:Z

    invoke-static {v1, v6}, Lrai;->g0(Lgyc;Z)Z
    ...
    :cond_4
    invoke-virtual {v1}, Lpzc;->getPlaybackState()I
    ...
    invoke-static {v12, v2}, Lw59;->g(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v13, v0, Lps9;->w:Layc;

    invoke-static {v13, v12}, Lexe;->B(Layc;Layc;)Layc;
    ...
    :goto_6
    iget-object v4, v12, Layc;->a:Lli6;

    iget-object v4, v4, Lli6;->a:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {v4, v13}, Lli6;->b(I)I
    ...
    :cond_10
    iget-object v4, v0, Lps9;->u:Lvw7;

    invoke-virtual {v4}, Ljava/util/AbstractCollection;->isEmpty()Z

    move-result v4

    iget-object v6, v0, Lps9;->s:Landroid/os/Bundle;
    ...
    invoke-virtual {v1, v4}, Lpzc;->b(I)Z
    ...
    :goto_9
    invoke-virtual {v1}, Lpzc;->L()Ljxc;

    move-result-object v4

    iget v4, v4, Ljxc;->a:F

    invoke-virtual {v1}, Lpzc;->S()Z
    ...
    :goto_d
    iget-object v10, v0, Lps9;->t:Lvw7;
    ...
    iget-object v3, v10, Lts3;->a:Liqf;

    iget-object v4, v10, Lts3;->e:Landroid/net/Uri;

    iget v11, v10, Lts3;->c:I

    if-eqz v3, :cond_23

    iget-object v13, v3, Liqf;->c:Landroid/os/Bundle;

    iget-boolean v5, v10, Lts3;->i:Z
    ...
    iget-object v5, v0, Lps9;->v:Ljqf;

    if-eqz v3, :cond_1b

    iget-object v5, v5, Ljqf;->a:Lgx7;

    invoke-virtual {v5, v3}, Lmw7;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v12, v5}, Layc;->a(I)Z
    ...
    iget-object v3, v3, Liqf;->b:Ljava/lang/String;

    iget-object v5, v10, Lts3;->f:Ljava/lang/CharSequence;

    iget v7, v10, Lts3;->d:I

    invoke-direct {v4, v3, v5, v7}, Llqk;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    invoke-virtual {v4, v13}, Llqk;->d(Landroid/os/Bundle;)V

    invoke-virtual {v4}, Llqk;->a()Lpxc;
    ...
    invoke-direct/range {v13 .. v29}, Lqxc;-><init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
...
.method public final F(ILos9;Lrs9;Z)V
    .locals 7

    iget-object v0, p0, Lps9;->g:Lfs9;
    ...
    invoke-static {p2, p1}, Lfk8;->k(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v6}, Ljs9;-><init>(Lps9;ILrs9;Los9;Z)V
...
.method public final G(Liqf;ILos9;Lrs9;)V
    .locals 8
...
.method public final I(Lwk9;Z)V
    .locals 2
...
.method public final J(Lrs9;)Lir9;
    .locals 8

    iget-object v0, p0, Lps9;->f:Ls7h;
    ...
    new-instance v6, Lms9;

    invoke-direct {v6, p1}, Lms9;-><init>(Lrs9;)V

    new-instance v1, Lir9;

    iget-object v0, p0, Lps9;->h:Lvs9;

    invoke-virtual {v0, p1}, Lvs9;->b(Lrs9;)Z
    ...
    invoke-direct/range {v1 .. v7}, Lir9;-><init>(Lrs9;IIZLhr9;Landroid/os/Bundle;)V

    iget-object p1, p0, Lps9;->g:Lfs9;

    invoke-virtual {p1, v1}, Lfs9;->m(Lir9;)Lgr9;

    move-result-object p1

    iget-object v0, p0, Lps9;->f:Ls7h;

    iget-object v3, p1, Lgr9;->a:Ljqf;

    iget-object p1, p1, Lgr9;->b:Layc;

    invoke-virtual {v0, v2, v1, v3, p1}, Ls7h;->f(Ljava/lang/Object;Lir9;Ljqf;Layc;)V

    iget-object p1, p0, Lps9;->g:Lfs9;

    iget-boolean v0, p1, Lfs9;->A:Z
    ...
    :cond_1
    iget-object p1, p0, Lps9;->j:Lmr9;

    iget-wide v1, p0, Lps9;->p:J
...
.method public final K()V
    ...
    iget-object v0, p0, Lps9;->u:Lvw7;

    iget-object v1, p0, Lps9;->v:Ljqf;

    iget-object v2, p0, Lps9;->w:Layc;

    invoke-static {v0, v1, v2}, Lts3;->c(Ljava/util/List;Ljqf;Layc;)Ldoe;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {v0, v1, v1}, Lts3;->e(Ljava/util/List;ZZ)Ldoe;

    move-result-object v0

    iput-object v0, p0, Lps9;->t:Lvw7;

    const/4 v2, 0x2

    invoke-static {v2, v0}, Lts3;->a(ILjava/util/List;)Z

    move-result v0

    xor-int/2addr v0, v1

    iget-object v2, p0, Lps9;->s:Landroid/os/Bundle;

    const-string v3, "android.media.playback.ALWAYS_RESERVE_SPACE_FOR.ACTION_SKIP_TO_PREVIOUS"

    invoke-virtual {v2, v3, v0}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget-object v0, p0, Lps9;->t:Lvw7;

    const/4 v3, 0x3

    invoke-static {v3, v0}, Lts3;->a(ILjava/util/List;)Z
...
.method public final b(Lsi9;)V
    ...
    invoke-direct {v0, p0, p1, v2, v1}, Lx62;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V
    ...
    invoke-virtual {p0, v2, v0, p1, v1}, Lps9;->F(ILos9;Lrs9;Z)V

    :cond_0
    return-void
.end method

.method public final c(Lsi9;I)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lx62;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V
...
.method public final d(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    iget-object p1, p1, Lfs9;->j:Lcsf;

    invoke-virtual {p1}, Lcsf;->b()Landroid/os/Bundle;
    ...
    invoke-direct {v0, p1, v2}, Liqf;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    new-instance p1, Leo;

    invoke-direct {p1, p0, v0, p2, p3}, Leo;-><init>(Lps9;Liqf;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V

    iget-object p2, p0, Lps9;->k:Lxr9;

    iget-object p2, p2, Lxr9;->b:Ljava/lang/Object;

    check-cast p2, Lrr9;

    invoke-virtual {p2}, Lqr9;->b()Lrs9;

    move-result-object p2

    invoke-virtual {p0, v0, v1, p1, p2}, Lps9;->G(Liqf;ILos9;Lrs9;)V
...
.method public final e(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {p1, p0, v0, p2}, Lt35;-><init>(Lps9;Liqf;Landroid/os/Bundle;)V
...
.method public final g(Landroid/content/Intent;)Z
    ...
    iget-object v1, p0, Lps9;->g:Lfs9;

    invoke-virtual {v1, v0, p1}, Lfs9;->o(Lir9;Landroid/content/Intent;)Z
...
.method public final h()V
    ...
    invoke-virtual {p0, v2, v0, v1, v2}, Lps9;->F(ILos9;Lrs9;Z)V
...
.method public final j(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {p1, v0, v0, p2}, Lps9;->D(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Lwk9;

    move-result-object p1

    const/4 p2, 0x1

    invoke-virtual {p0, p1, p2}, Lps9;->I(Lwk9;Z)V
...
.method public final k(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v0, v0, p1, p2}, Lps9;->D(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Lwk9;
...
.method public final l(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    invoke-static {v0, p1, v0, p2}, Lps9;->D(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Lwk9;
...
.method public final t(F)V
    ...
    invoke-direct {v0, p0, p1}, Lax4;-><init>(Ljava/lang/Object;F)V
...
.method public final u(Lsbe;)V
    .locals 0

    invoke-virtual {p0, p1}, Lps9;->v(Lsbe;)V

    return-void
.end method

.method public final v(Lsbe;)V
    .locals 3
    ...
    invoke-direct {p1, p0, v0}, Lgs9;-><init>(Lps9;Lpbe;)V

    iget-object v0, p0, Lps9;->k:Lxr9;

    iget-object v0, v0, Lxr9;->b:Ljava/lang/Object;

    check-cast v0, Lrr9;

    invoke-virtual {v0}, Lqr9;->b()Lrs9;
    ...
    invoke-virtual {p0, v1, v2, p1, v0}, Lps9;->G(Liqf;ILos9;Lrs9;)V
...
.method public final w(I)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lis9;-><init>(Lps9;II)V
...
.method public final y()V
    ...
    invoke-direct {v0, p0, v4}, Lgs9;-><init>(Lps9;I)V

    iget-object v3, v3, Lxr9;->b:Ljava/lang/Object;

    check-cast v3, Lrr9;

    invoke-virtual {v3}, Lqr9;->b()Lrs9;

    move-result-object v3

    invoke-virtual {p0, v1, v0, v3, v2}, Lps9;->F(ILos9;Lrs9;Z)V
    ...
    iget-object v1, v3, Lxr9;->b:Ljava/lang/Object;
