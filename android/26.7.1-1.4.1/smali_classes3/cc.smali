...
.method public synthetic constructor <init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iput-object p4, p0, Lcc;->c:Ljava/lang/Object;
...
.method public constructor <init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V
    ...
    .line 6
    iput-object p2, p0, Lcc;->c:Ljava/lang/Object;
...
.method public synthetic constructor <init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    iput-object p3, p0, Lcc;->d:Ljava/lang/Object;
...
.method public synthetic constructor <init>(Lmgk;Ltpj;Ljava/lang/String;)V
    .locals 1
...
.method public final run()V
    ...
    iget-object v1, p0, Lcc;->c:Ljava/lang/Object;

    check-cast v1, Ltpj;

    sget-object v4, Lz8k;->b:Lz8k;

    iget-object v6, p0, Lcc;->d:Ljava/lang/Object;

    check-cast v6, Ljava/lang/String;

    iget-object v7, v1, Ltpj;->a:Ljava/lang/Object;

    check-cast v7, Liv9;

    iput-object v4, v7, Liv9;->b:Ljava/lang/Object;

    iget-object v4, v7, Liv9;->a:Ljava/lang/Object;

    check-cast v4, Lvdk;

    if-eqz v4, :cond_0

    iget-object v4, v4, Lvdk;->d:Ljava/lang/String;
    ...
    iget-object v8, v0, Lmgk;->a:Ljava/lang/String;

    iput-object v8, v7, Lndk;->a:Ljava/lang/String;

    iget-object v8, v0, Lmgk;->b:Ljava/lang/String;

    iput-object v8, v7, Lndk;->b:Ljava/lang/String;
    ...
    invoke-direct {v11, v9}, Lry8;-><init>(Landroid/os/LocaleList;)V

    invoke-direct {v10, v11}, Lqy8;-><init>(Lry8;)V
    ...
    :goto_0
    invoke-virtual {v10}, Lqy8;->b()I

    move-result v11

    if-ge v5, v11, :cond_6

    iget-object v11, v10, Lqy8;->a:Lry8;

    iget-object v11, v11, Lry8;->a:Landroid/os/LocaleList;

    invoke-virtual {v11, v5}, Landroid/os/LocaleList;->get(I)Ljava/util/Locale;

    move-result-object v11

    sget-object v12, Lcu3;->a:Loc7;
    ...
    :cond_6
    sget-object v3, Lwjk;->b:Lohk;

    if-nez v9, :cond_7

    sget-object v2, Lopk;->o:Lopk;
    ...
    invoke-direct {v3, v9, v2}, Lopk;-><init>(I[Ljava/lang/Object;)V

    move-object v9, v3

    :goto_1
    sput-object v9, Lmgk;->j:Lopk;
    :try_end_1
    ...
    :goto_2
    iput-object v9, v7, Lndk;->k:Ljava/util/AbstractCollection;

    sget-object v2, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v2, v7, Lndk;->g:Ljava/lang/Boolean;

    iput-object v4, v7, Lndk;->d:Ljava/lang/String;

    iput-object v6, v7, Lndk;->c:Ljava/lang/String;

    iget-object v2, v0, Lmgk;->f:Lqrk;
    ...
    :goto_3
    iput-object v2, v7, Lndk;->e:Ljava/lang/String;
    ...
    iput-object v2, v7, Lndk;->i:Ljava/lang/Integer;
    ...
    iput-object v2, v7, Lndk;->j:Ljava/lang/Integer;

    iput-object v7, v1, Ltpj;->b:Ljava/lang/Object;

    iget-object v0, v0, Lmgk;->c:Lggk;

    invoke-virtual {v0, v1}, Lggk;->a(Ltpj;)V
    ...
    iget-object v2, v0, Lgp3;->a:Landroid/content/Intent;
    ...
    iget-object v6, v0, Lgp3;->a:Landroid/content/Intent;
    ...
    iget-object v0, v0, Lgp3;->a:Landroid/content/Intent;
    ...
    invoke-direct {v3, v4, v1, v2, v5}, Lylk;-><init>(IILandroid/os/Bundle;I)V

    invoke-virtual {v0, v3}, Llqk;->f(Lylk;)Lqrk;

    move-result-object v0

    :goto_4
    iget-object v1, p0, Lcc;->d:Ljava/lang/Object;

    check-cast v1, Ljava/util/concurrent/CountDownLatch;

    sget-object v2, Lib5;->c:Lib5;

    new-instance v3, Lmwa;

    const/16 v4, 0x12

    invoke-direct {v3, v1, v4}, Lmwa;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v2, v3}, Lqrk;->b(Ljava/util/concurrent/Executor;Ldlb;)Lqrk;
    ...
    invoke-virtual {v1}, Lhf2;->get()Ljava/lang/Object;
    ...
    iget-object v2, v2, Loli;->h:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4}, Lg0i;->L(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v1, v3}, Luji;->E(Luji;Lwhi;Z)V
    ...
    invoke-virtual {v0, v4}, Lddh;->c(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, p0, v5}, Lrch;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v2}, Lbolts/Task;->continueWith(Lth4;)Lbolts/Task;
    :try_end_6
    ...
    iget-object v4, v2, Lone/me/stickersshowcase/StickersShowcaseScreen;->Y:Lwee;

    sget-object v5, Lone/me/stickersshowcase/StickersShowcaseScreen;->z0:[Lki8;
    ...
    iget-object v4, v3, Lone/me/stickerssearch/StickersSearchScreen;->Z:Lwee;

    sget-object v5, Lone/me/stickerssearch/StickersSearchScreen;->y0:[Lki8;

    aget-object v1, v5, v1

    invoke-interface {v4, v3, v1}, Lwee;->y(Ljava/lang/Object;Lki8;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lcv6;->call()Ljava/lang/Object;
    ...
    invoke-direct {v2, v0, v3, v4}, Lw47;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v1, v0, Lone/me/profileedit/screens/adminpermissions/ProfileEditAdminPermissionsWidget;->Z:Lwee;

    sget-object v3, Lone/me/profileedit/screens/adminpermissions/ProfileEditAdminPermissionsWidget;->z0:[Lki8;
    ...
    iget-object v1, p0, Lcc;->b:Ljava/lang/Object;
    ...
    :try_start_8
    invoke-virtual {v1}, Leb6;->e()Landroid/net/Uri;

    move-result-object v3

    const/4 v5, 0x5

    invoke-virtual {v0, v3, v5}, Lnq7;->N(Landroid/net/Uri;I)Ljava/net/HttpURLConnection;
    ...
    :try_start_9
    iget-object v0, v0, Lnq7;->m:Lcom/facebook/common/time/RealtimeSinceBootClock;

    invoke-interface {v0}, Lvqa;->now()J

    move-result-wide v5

    iput-wide v5, v1, Lmq7;->e:J
    ...
    invoke-virtual {v2, v4, v0}, Lcl8;->G(Ljava/io/InputStream;I)V
    :try_end_9
    ...
    :goto_c
    :try_start_b
    invoke-virtual {v2, v0}, Lcl8;->F(Ljava/lang/Exception;)V
    :try_end_b
    ...
    invoke-virtual {v1, v0, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;)V

    iget-boolean v1, v2, Ldq;->B0:Z
    ...
    invoke-virtual {v2, v0}, Ldq;->g(Landroid/view/View;)Z

    move-result v0

    invoke-virtual {v2, v0}, Ldq;->f(Z)Z
    ...
    invoke-virtual {v1, v2}, Laz5;->b(Ljava/lang/Runnable;)Lxc5;
    ...
    invoke-virtual {v5, v8, v3}, Lzua;->o(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v3, v6}, Lzcc;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    const-class v3, Landroidx/work/impl/background/systemalarm/ConstraintProxy$StorageNotLowProxy;

    invoke-static {v1, v3, v7}, Lzcc;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    const-class v3, Landroidx/work/impl/background/systemalarm/ConstraintProxy$NetworkStateProxy;

    invoke-static {v1, v3, v2}, Lzcc;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    :try_end_e
    ...
    iget-object v8, v8, Len;->b:Ldn;

    invoke-virtual {v8}, Ldn;->start()V
    ...
    iget-object v6, v1, Ldc;->b:Landroid/text/TextPaint;

    iget-object v7, v1, Ldc;->a:Ljava/lang/String;
    ...
    invoke-interface {v8}, Lnhg;->a()Landroid/graphics/drawable/Drawable;
