...
# direct methods
.method public constructor <init>(Lzki;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lvki;->b:Lzki;

    iput-boolean p2, p0, Lvki;->a:Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object p1, p0, Lvki;->b:Lzki;

    iget-object v2, p1, Lzki;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lvki;->b:Lzki;

    iget-boolean v2, v0, Lzki;->x0:Z
    ...
    :cond_1
    iget-object v1, p0, Lvki;->b:Lzki;

    iget-object v2, v1, Lzki;->w0:Lpli;

    if-eqz v2, :cond_7

    iget-object v0, v1, Lzki;->Y:Ljava/util/LinkedHashMap;
    ...
    :goto_1
    iget-object v0, v1, Lzki;->v0:[F

    iget-object v9, v1, Lzki;->Z:[F

    invoke-virtual {v7, v0, v9}, Lr3h;->I([F[F)V

    :try_start_0
    iget-object v0, v1, Lzki;->v0:[F

    iget-boolean v7, p0, Lvki;->a:Z

    invoke-virtual {v2, p1, v5, v0, v7}, Lpli;->x(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    :try_end_0
    ...
    iget-object v5, v1, Lzki;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lzki;->z0:Z

    if-nez v0, :cond_9

    iput-boolean v6, p1, Lzki;->z0:Z
    ...
    :cond_6
    :goto_3
    iget-object p1, p1, Lzki;->X:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v1, v0, Lali;->b:Landroid/os/Handler;

    iget-object v0, v0, Lali;->a:Loli;

    new-instance v2, Lkvh;

    const/4 v3, 0x7

    invoke-direct {v2, v0, v3}, Lkvh;-><init>(Ljava/lang/Object;I)V
