...
.method public constructor <init>(ILjava/util/ArrayList;)V
    ...
    iget-wide v2, v0, Lvae;->b:J

    iget-wide v6, v0, Lvae;->a:J
    ...
    invoke-static {v2, v3, v1}, Lynk;->c(JLjava/nio/ByteBuffer;)I

    iget v2, p0, Lp7;->c:I

    invoke-static {v2, v1}, Lynk;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p2, v1}, Lynk;->b(ILjava/nio/ByteBuffer;)I
    ...
    iget-wide v2, p2, Lvae;->b:J

    iget-wide v8, p2, Lvae;->a:J
...
.method public final a(Lawd;Ldwd;Ljl;)V
    ...
    iget-object v2, v0, Lawd;->e1:Lelk;

    invoke-virtual/range {p2 .. p2}, Ldwd;->n()Le0d;
    ...
    invoke-virtual {v2, v1}, Lq7;->g(Lp7;)V

    iget-object v0, v0, Lawd;->z0:Lile;
    ...
    :cond_0
    iget-object v4, v0, Lile;->g:Ls09;

    const-string v6, "probe count not reset on ack because handshake not yet confirmed"

    invoke-interface {v4, v6}, Ls09;->recovery(Ljava/lang/String;)V

    :cond_1
    :goto_0
    iget-object v4, v0, Lile;->e:[Lr49;
    ...
    invoke-direct {v7, v2, v8}, Lo49;-><init>(Lr49;I)V
    ...
    invoke-direct {v7, v2, v8}, Lal;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v4, v7}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v4

    new-instance v7, Lq49;

    const/4 v8, 0x4

    invoke-direct {v7, v8}, Lq49;-><init>(I)V
    ...
    invoke-direct {v8, v9}, Lq49;-><init>(I)V
    ...
    iget-object v8, v2, Lr49;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v10, v11}, Lon3;-><init>(I)V
    ...
    :try_start_0
    iget-wide v11, v7, Lh6b;->c:J

    iget-wide v13, v7, Lh6b;->b:J
    ...
    :cond_3
    iget-wide v11, v7, Lh6b;->b:J

    invoke-virtual {v7, v8}, Lh6b;->c(Ljava/util/List;)V
    ...
    invoke-direct {v14, v7, v15}, Lx6;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v14, v15}, Lm0;-><init>(I)V
    ...
    iget-wide v13, v7, Lh6b;->c:J

    new-instance v5, Lm4;

    const/16 v15, 0xc

    invoke-direct {v5, v7, v15}, Lm4;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v8, v5}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    move-object v5, v10

    iget-wide v9, v7, Lh6b;->c:J

    cmp-long v8, v9, v13

    if-eqz v8, :cond_7

    iget-object v8, v7, Lh6b;->a:Ls09;
    ...
    invoke-interface {v8, v4}, Ls09;->cc(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {v2}, Lr49;->b()V

    iget-object v4, v2, Lr49;->b:Lile;

    invoke-virtual {v4}, Lile;->k()V

    iget-object v4, v2, Lr49;->c:Ld1f;
    ...
    invoke-direct {v7, v1, v8}, Lx6;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {v4, v3}, Ls09;->error(Ljava/lang/String;)V
    ...
    invoke-static {v7, v8, v9, v3, v10}, Li62;->x(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v5, v3}, Ls09;->debug(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v2, v5}, Lp49;-><init>(Lr49;I)V

    invoke-interface {v3, v4}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    :goto_6
    invoke-virtual {v0, v6}, Lile;->h(Z)V
...
.method public final h(IJ)V
    ...
    invoke-direct {v2, v0, v1, p2, p3}, Lvae;-><init>(JJ)V
...
.method public final l(Ljava/nio/ByteBuffer;Ls09;)V
    .locals 10

    const-string v0, "Parsing AckFrame"

    invoke-interface {p2, v0}, Ls09;->debug(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lynk;->g(Ljava/nio/ByteBuffer;)I
