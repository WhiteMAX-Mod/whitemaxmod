...
.field public final B0:Ldyb;

.field public final C0:Lo82;

.field public final D0:Ldyb;

.field public final E0:Ldyb;
...
.field public final w0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;

.field public final x0:Landroidx/appcompat/widget/AppCompatImageView;

.field public final y0:Ldyb;

.field public final z0:Landroid/widget/Chronometer;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Laxd;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Laxd;->w0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v10, v7}, Lava;->f(Landroid/content/Context;)Lil3;
    ...
    iput-object v5, v0, Laxd;->x0:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    sget-object v2, Layb;->b:Layb;

    invoke-virtual {v7, v2}, Ldyb;->setMode(Layb;)V
    ...
    invoke-virtual {v7, v11, v9, v13}, Ldyb;->a(FILjava/lang/String;)V

    new-instance v9, Luwd;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Luwd;-><init>(Laxd;I)V

    invoke-static {v7, v9}, Lbh4;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Laxd;->y0:Ldyb;
    ...
    iput-object v9, v0, Laxd;->z0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v10, v8}, Lava;->f(Landroid/content/Context;)Lil3;
    ...
    invoke-interface {v8}, La6c;->l()Lr5c;
    ...
    iput-object v13, v0, Laxd;->A0:Landroid/widget/LinearLayout;

    new-instance v3, Ldyb;

    invoke-direct {v3, v1}, Ldyb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Ldyb;->setMode(Layb;)V

    new-instance v6, Luwd;

    const/4 v8, 0x1

    invoke-direct {v6, v0, v8}, Luwd;-><init>(Laxd;I)V

    invoke-static {v3, v6}, Lbh4;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Laxd;->B0:Ldyb;

    new-instance v6, Lo82;

    invoke-direct {v6, v1}, Lo82;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v8, v0, v9}, Luwd;-><init>(Laxd;I)V

    invoke-static {v6, v8}, Lbh4;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Laxd;->C0:Lo82;

    new-instance v8, Ldyb;

    invoke-direct {v8, v1}, Ldyb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Ldyb;->setMode(Layb;)V
    ...
    invoke-virtual {v8, v11, v9, v10}, Ldyb;->a(FILjava/lang/String;)V

    new-instance v9, Luwd;

    const/4 v10, 0x3

    invoke-direct {v9, v0, v10}, Luwd;-><init>(Laxd;I)V

    invoke-static {v8, v9}, Lbh4;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Laxd;->D0:Ldyb;

    new-instance v9, Ldyb;

    invoke-direct {v9, v1}, Ldyb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v2}, Ldyb;->setMode(Layb;)V

    new-instance v2, Luwd;

    const/4 v10, 0x4

    invoke-direct {v2, v0, v10}, Luwd;-><init>(Laxd;I)V

    invoke-static {v9, v2}, Lbh4;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v9, v0, Laxd;->E0:Ldyb;
    ...
    invoke-direct {v3, v2, v1, v7}, Li58;-><init>(ILzy0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lexe;->d(Landroid/view/View;Li58;Le37;)V

    iput-object v6, v0, Laxd;->F0:Landroid/widget/FrameLayout;

    new-instance v1, Lvwd;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lvwd;-><init>(Laxd;I)V

    invoke-static {v2, v1}, Lfk8;->K(ILc37;)Lxk8;

    move-result-object v1

    iput-object v1, v0, Laxd;->G0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Laxd;->H0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Laxd;->I0:Ljava/lang/Object;
...
.method public static final synthetic a(Laxd;)Z
    .locals 0

    invoke-direct {p0}, Laxd;->getCanRecordingVideo()Z
...
.method public static final b(Laxd;Lq72;)V
    .locals 6
    ...
    invoke-direct {p0}, Laxd;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Laxd;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Laxd;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Laxd;->B0:Ldyb;

    sget v2, Laxd;->J0:F

    invoke-virtual {v1, v0, v5, v2}, Ldyb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Laxd;->getCameraApi()Lr72;
    ...
    invoke-interface {p0, p1}, Lr72;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Laxd;FFFFF)V
    .locals 2

    iget-object v0, p0, Laxd;->x0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Laxd;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Laxd;->F0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laxd;->G0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laxd;->I0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laxd;->H0:Ljava/lang/Object;
...
.method public final getCameraApi()Lr72;
    .locals 1

    iget-object v0, p0, Laxd;->w0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
