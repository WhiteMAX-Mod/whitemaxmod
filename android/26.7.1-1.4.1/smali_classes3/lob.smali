...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lcn;-><init>(Llob;)V

    iput-object v0, p0, Llob;->a:Lcn;

    new-instance v0, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v0}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v0, p0, Llob;->b:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v1, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v1}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v1, p0, Llob;->c:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v2}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v2, p0, Llob;->d:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v3, Landroid/graphics/Matrix;

    invoke-direct {v3}, Landroid/graphics/Matrix;-><init>()V

    iput-object v3, p0, Llob;->o:Landroid/graphics/Matrix;
    ...
    iput-object v3, p0, Llob;->v0:Ljava/lang/Object;

    new-instance v3, Lkl9;

    const/16 v5, 0x1d

    invoke-direct {v3, p1, v5, p0}, Lkl9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v4, v3}, Lfk8;->K(ILc37;)Lxk8;

    move-result-object p1

    iput-object p1, p0, Llob;->w0:Ljava/lang/Object;
    ...
    invoke-direct {p1, v3}, Ltk4;-><init>(F)V
    ...
    invoke-virtual {p0}, Llob;->getState()Lkob;

    move-result-object p1

    invoke-virtual {p0, p1}, Llob;->a(Lkob;)V
    ...
    invoke-virtual {p0, p1}, Llob;->onThemeChanged(La6c;)V
...
.method public final a(Lkob;)V
    ...
    iget-object v1, p0, Llob;->w0:Ljava/lang/Object;

    const/16 v2, 0x8

    iget-object v3, p0, Llob;->v0:Ljava/lang/Object;
...
.method public final getState()Lkob;
    .locals 2

    sget-object v0, Llob;->x0:[Lki8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Llob;->a:Lcn;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Llob;->o:Landroid/graphics/Matrix;
    ...
    iget-object p1, p0, Llob;->b:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object p1, p0, Llob;->c:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object p1, p0, Llob;->d:Landroid/graphics/drawable/ShapeDrawable;
...
.method public final onThemeChanged(La6c;)V
    ...
    iget-object v1, v0, Llob;->b:Landroid/graphics/drawable/ShapeDrawable;
    ...
    invoke-interface/range {p1 .. p1}, La6c;->s()Lhr;
    ...
    iget-object v3, v0, Llob;->o:Landroid/graphics/Matrix;

    invoke-virtual {v2, v3}, Landroid/graphics/Shader;->setLocalMatrix(Landroid/graphics/Matrix;)V

    invoke-virtual {v1, v2}, Landroid/graphics/Paint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;

    iget-object v1, v0, Llob;->c:Landroid/graphics/drawable/ShapeDrawable;
    ...
    invoke-interface/range {p1 .. p1}, La6c;->n()Lz5c;

    move-result-object v2

    iget-object v2, v2, Lz5c;->i:Lmlj;

    iget-object v2, v2, Lmlj;->b:Ljava/lang/Object;

    check-cast v2, Ls75;

    iget-object v2, v2, Ls75;->b:Ljava/lang/Object;

    check-cast v2, Ls5c;

    iget-object v13, v2, Ls5c;->a:[I
    ...
    iget-object v1, v0, Llob;->d:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object v1, v0, Llob;->v0:Ljava/lang/Object;
...
.method public final setState(Lkob;)V
    .locals 2
...
.method public final setText(I)V
    ...
    .line 5
    iget-object v0, p0, Llob;->v0:Ljava/lang/Object;
