...
.method public constructor <init>(Lsci;)V
    ...
    .line 2
    iput-object p1, p0, Lfwd;->a:Lsci;

    .line 3
    new-instance p1, Lcth;

    invoke-direct {p1}, Lcth;-><init>()V

    iput-object p1, p0, Lfwd;->d:Lcth;

    return-void
.end method

.method public constructor <init>(Lsci;Lcth;)V
    .locals 0
...
.method public static c(IJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p3}, Lynk;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Lynk;->c(JLjava/nio/ByteBuffer;)I
...
.method public static d(ILjava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, p1}, Lynk;->b(ILjava/nio/ByteBuffer;)I
...
.method public final a()[B
    ...
    sget-object v2, Lsci;->b:Lsci;

    iget-object v3, p0, Lfwd;->a:Lsci;

    invoke-virtual {v3, v2}, Lsci;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v3}, Lsci;->b()Z
    ...
    iget-object v4, p0, Lfwd;->d:Lcth;

    if-ne v3, v2, :cond_2

    iget-object v5, v4, Lcth;->a:[B

    invoke-static {v0, v1, v5}, Lfwd;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_2
    iget-wide v5, v4, Lcth;->b:J

    const/4 v7, 0x1

    invoke-static {v7, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    if-ne v3, v2, :cond_3

    iget-object v5, v4, Lcth;->q:[B

    if-eqz v5, :cond_3

    invoke-static {v2, v1, v5}, Lfwd;->d(ILjava/nio/ByteBuffer;[B)V
    ...
    iget-wide v5, v4, Lcth;->c:J

    const/4 v7, 0x4

    invoke-static {v7, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lcth;->d:J

    const/4 v8, 0x5

    invoke-static {v8, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lcth;->e:J

    const/4 v8, 0x6

    invoke-static {v8, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lcth;->f:J

    const/4 v8, 0x7

    invoke-static {v8, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lcth;->g:J

    const/16 v8, 0x8

    invoke-static {v8, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lcth;->h:J
    ...
    iget-boolean v5, v4, Lcth;->j:Z

    if-eqz v5, :cond_4

    const/16 v5, 0xc

    invoke-static {v5, v1}, Lynk;->b(ILjava/nio/ByteBuffer;)I

    invoke-static {v0, v1}, Lynk;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v0, v5, v6, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V

    iget-object v0, v4, Lcth;->n:[B

    const/16 v5, 0xf

    invoke-static {v5, v1, v0}, Lfwd;->d(ILjava/nio/ByteBuffer;[B)V

    if-ne v3, v2, :cond_5

    iget-object v0, v4, Lcth;->o:[B

    if-eqz v0, :cond_5

    const/16 v3, 0x10

    invoke-static {v3, v1, v0}, Lfwd;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_5
    iget-object v0, v4, Lcth;->r:Lef9;
    ...
    invoke-direct {v0, v6, v5}, Ltu;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v0, v3, v4, v1}, Lfwd;->c(IJLjava/nio/ByteBuffer;)V
...
.method public final e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Ls09;)V
    .locals 11
    ...
    invoke-static {p1}, Lynk;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-interface {p3, v1, v0}, Ls09;->debug(Ljava/lang/String;[B)V

    iput-object v0, v6, Lcth;->a:[B
    ...
    invoke-interface {p3, v2}, Ls09;->debug(Ljava/lang/String;)V

    iput-wide v0, v6, Lcth;->b:J
    ...
    invoke-interface {p3, v1}, Ls09;->debug(Ljava/lang/String;)V

    iput-object v0, v6, Lcth;->q:[B
    ...
    invoke-interface {p3, v0}, Ls09;->debug(Ljava/lang/String;)V

    iput-boolean v5, v6, Lcth;->j:Z
    ...
    invoke-direct {p3, v0, v1}, Ltld;-><init>(IZ)V
    ...
    iput-object v0, p3, Ltld;->b:Ljava/lang/Object;
    ...
    iput-object v0, p3, Ltld;->c:Ljava/lang/Object;
    ...
    iget-object v0, p3, Ltld;->b:Ljava/lang/Object;

    check-cast v0, Ljava/net/InetAddress;

    if-nez v0, :cond_14

    iget-object v0, p3, Ltld;->c:Ljava/lang/Object;
    ...
    iput-object v0, p3, Ltld;->d:Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Lsci;-><init>(I)V
    ...
    invoke-direct {v2, p3}, Lsci;-><init>(I)V

    const/16 p3, 0x18

    invoke-direct {v1, v2, p3, v0}, Lef9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v1, v6, Lcth;->r:Lef9;
    ...
    :goto_a
    invoke-interface {p3, v0}, Ls09;->warn(Ljava/lang/String;)V
