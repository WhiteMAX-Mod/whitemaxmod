...
# direct methods
.method public static c(Ljava/nio/ByteBuffer;Lkmh;Ltm2;)Ljava/util/ArrayList;
    .locals 20
    ...
    sget-object v11, Ljmh;->b:Ljmh;

    iget-short v11, v11, Ljmh;->a:S
    ...
    invoke-virtual {v7, v0, v11, v6}, Lj36;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {v14, v0}, Luu;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v0}, Luu;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v6, v0}, Luu;->c(ILjava/nio/ByteBuffer;)V
    ...
    iput-object v13, v7, Luu;->b:Ljava/lang/Object;
    ...
    invoke-direct {v6, v7, v0}, Latd;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    :cond_8
    sget-object v11, Ljmh;->d:Ljmh;

    iget-short v14, v11, Ljmh;->a:S
    ...
    iput-object v12, v8, Ltag;->a:Ljava/util/List;

    iget-short v11, v11, Ljmh;->a:S

    invoke-virtual {v8, v0, v11, v7}, Lj36;->b(Ljava/nio/ByteBuffer;II)I
    ...
    new-instance v13, Lnn3;

    const/4 v14, 0x4

    invoke-direct {v13, v7, v14}, Lnn3;-><init>(II)V
    ...
    invoke-direct {v12, v8, v13}, Lm4;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v6, v0}, Luu;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_d
    sget-object v11, Ljmh;->X:Ljmh;

    iget-short v14, v11, Ljmh;->a:S

    if-ne v8, v14, :cond_1e

    sget-object v6, Lkmh;->c:Lkmh;
    ...
    invoke-virtual {v6, v0, v14, v4}, Lj36;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0, v11, v12}, Lj36;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v12, v6, Lsn3;->a:Ljava/util/List;
    ...
    iget-object v7, v6, Lsn3;->a:Ljava/util/List;
    ...
    invoke-direct {v4, v8, v9, v15}, Lrn3;-><init>(J[B)V
    ...
    iput-object v4, v6, Lsn3;->b:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Lsn3;->b:Ljava/util/ArrayList;

    new-instance v12, Lqn3;

    invoke-direct {v12, v8}, Lqn3;-><init>([B)V
    ...
    iget-object v4, v6, Lsn3;->a:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v7, v6, Lsn3;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v1, v4}, Lx6;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v1, v2}, Lw59;->j(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v4, Ljmh;->Y:Ljmh;

    iget-short v4, v4, Ljmh;->a:S
    ...
    invoke-virtual {v7, v0, v4, v6}, Lj36;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v4, v7, Lym5;->a:Ljava/lang/Long;
    ...
    :cond_22
    sget-object v4, Ljmh;->Z:Ljmh;

    iget-short v4, v4, Ljmh;->a:S

    if-ne v8, v4, :cond_23

    new-instance v4, Lh3h;

    invoke-direct {v4, v0, v1}, Lh3h;-><init>(Ljava/nio/ByteBuffer;Lkmh;)V
    ...
    invoke-direct {v4, v6, v0}, Latd;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v0}, Lve2;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_25
    sget-object v4, Ljmh;->x0:Ljmh;

    iget-short v6, v4, Ljmh;->a:S

    if-ne v8, v6, :cond_2d

    new-instance v6, Lxi8;
    ...
    iput-object v7, v6, Lxi8;->b:Ljava/util/ArrayList;

    iget-short v4, v4, Ljmh;->a:S

    const/4 v7, 0x1

    invoke-virtual {v6, v0, v4, v7}, Lj36;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0}, Lxi8;->d(Ljava/nio/ByteBuffer;)I
    ...
    iget-object v4, v2, Ltm2;->b:Ljava/lang/Object;
    ...
    iget-object v6, v4, Leo4;->a:Luci;

    iget-object v6, v6, Luci;->a:Lsci;

    invoke-direct {v13, v6}, Lfwd;-><init>(Lsci;)V

    iget-object v4, v4, Leo4;->f:Ls09;
    ...
    invoke-interface {v4, v12}, Ls09;->debug(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v13, v0, v11, v4}, Lfwd;->e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Ls09;)V
    :try_end_0
    ...
    invoke-static {v4}, Lr09;->a(Ljava/lang/String;)V
...
.method public abstract b()Lkmh;
.end method

.method public final d(Ljava/nio/ByteBuffer;Lkmh;I)I
    .locals 3
