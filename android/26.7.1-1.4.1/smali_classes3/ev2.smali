...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lev2;->a:Landroid/graphics/drawable/ColorDrawable;

    new-instance v0, Ldv2;

    const/4 v2, 0x0

    invoke-direct {v0, p0, v2}, Ldv2;-><init>(Lev2;I)V
    ...
    iput-object v0, p0, Lev2;->b:Ljava/lang/Object;

    new-instance v0, Ldv2;

    const/4 v3, 0x1

    invoke-direct {v0, p0, v3}, Ldv2;-><init>(Lev2;I)V

    invoke-static {v2, v0}, Lfk8;->K(ILc37;)Lxk8;

    move-result-object v0

    iput-object v0, p0, Lev2;->c:Ljava/lang/Object;
    ...
    invoke-direct {v5, v3}, Le87;-><init>(Landroid/content/res/Resources;)V

    iput-object v1, v5, Le87;->d:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v5}, Le87;->a()Ld87;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcj5;->setHierarchy(Lzi5;)V

    iput-object v0, p0, Lev2;->d:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    new-instance v1, Lk3;

    const/16 v3, 0x1c

    invoke-direct {v1, p1, v3, p0}, Lk3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v2, v1}, Lfk8;->K(ILc37;)Lxk8;

    move-result-object p1

    iput-object p1, p0, Lev2;->o:Ljava/lang/Object;
...
.method public final onThemeChanged(La6c;)V
    ...
    iget-object v1, p0, Lev2;->a:Landroid/graphics/drawable/ColorDrawable;
    ...
    :cond_0
    iget-object p1, p0, Lev2;->c:Ljava/lang/Object;
...
.method public final setItem(Lgw9;)V
    .locals 8

    iget-boolean v0, p1, Lgw9;->x0:Z

    const/16 v1, 0x8

    const/4 v2, 0x1

    iget-object v3, p0, Lev2;->o:Ljava/lang/Object;

    iget-object v4, p0, Lev2;->d:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    const/4 v5, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v4, v5}, Lcj5;->setController(Lwi5;)V

    invoke-virtual {v4}, Lcj5;->getHierarchy()Lzi5;
    ...
    invoke-virtual {p1, v2, v0}, Ld87;->i(ILandroid/graphics/drawable/Drawable;)V
    ...
    :cond_2
    iget-object v0, p1, Lgw9;->d:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v6, p1, Lgw9;->v0:Landroid/net/Uri;

    if-eqz v6, :cond_3

    invoke-static {v6}, Lsv7;->d(Landroid/net/Uri;)Lsv7;

    move-result-object v6

    invoke-virtual {v6}, Lsv7;->a()Lrv7;
    ...
    invoke-virtual {v4, v0, v6}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->j(Lrv7;Lrv7;)V
    ...
    iget-object p1, p1, Lgw9;->X:Ljava/lang/Long;
    ...
    sget-object v7, Lfch;->Y:Lb7h;

    invoke-static {v6}, Lzua;->F0(Landroid/content/Context;)Lfch;
    ...
    invoke-static {v4, v6, p1}, Loa3;->C(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p1}, Lukk;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)V

    invoke-static {v0, v5}, Lukk;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)V
