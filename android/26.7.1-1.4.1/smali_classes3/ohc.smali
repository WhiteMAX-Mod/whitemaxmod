...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lohc;->c:Ljava/lang/Object;

    check-cast v1, Lmcg;

    check-cast p1, Lk12;

    invoke-static {v0, v1, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmcg;Lk12;)V
    ...
    iget-object p1, v0, Lcz0;->c:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lvhc;->a0:Lzx8;

    const/4 v0, 0x0

    invoke-virtual {p1, v0, v0}, Lzx8;->l(Ljava/lang/Float;Ljava/lang/Float;)V

    goto :goto_0

    :cond_0
    iget-object v0, p1, Lvhc;->a0:Lzx8;

    iget v1, p1, Lvhc;->m0:F

    invoke-static {v1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v1

    iget p1, p1, Lvhc;->n0:F

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    invoke-virtual {v0, v1, p1}, Lzx8;->l(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    invoke-virtual {v0, v1}, Lvhc;->g(Ljava/util/List;)Lorg/webrtc/PeerConnection$RTCConfiguration;
    ...
    invoke-interface {p1, v3, v2}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lphc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, v2}, Lvhc;->t(Lorg/webrtc/PeerConnection;Z)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0, p1, v2}, Lvhc;->l(Lorg/webrtc/PeerConnection;Z)V
    ...
    iget-object p1, v0, Lvhc;->Z:Ljava/util/ArrayList;
    ...
    iget-boolean v1, v0, Lvhc;->b0:Z

    if-eqz v1, :cond_7

    const/4 v1, 0x0

    iput-boolean v1, v0, Lvhc;->b0:Z
    ...
    iget-object p1, v0, Lvhc;->B:Ljae;

    const-string v0, "rtc.no.stun.candidates"

    const/4 v1, 0x0

    sget-object v2, Lvmg;->x0:Lvmg;

    invoke-virtual {p1, v2, v0, v1}, Ljae;->log(Lvmg;Ljava/lang/String;Ljava/lang/String;)V
