...
.method public constructor <init>(Lxk8;Lxk8;)V
    ...
    iput-object p1, p0, Lmdf;->a:Lxk8;

    iput-object p2, p0, Lmdf;->b:Lxk8;

    return-void
.end method

.method public static final b(Lmdf;Ljava/lang/Throwable;Luh4;)Ljava/lang/Object;
    .locals 9

    sget-object v1, La09;->Y:La09;

    instance-of v0, p2, Lldf;
    ...
    invoke-direct {v0, p0, p2}, Lldf;-><init>(Lmdf;Luh4;)V

    goto :goto_0

    :goto_1
    iget-object p2, p0, Lldf;->d:Ljava/lang/Object;
...
.method public final a(ILjava/lang/Object;Ljava/lang/String;)Lbl6;
    ...
    invoke-direct {p2, p0, p3}, Lkdf;-><init>(Lmdf;Lkotlin/coroutines/Continuation;)V
