...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;Leng;ZLjma;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lt89;->a:Landroid/widget/EditText;

    iput-object p2, p0, Lt89;->b:Leng;

    iput-boolean p3, p0, Lt89;->c:Z

    iput-object p4, p0, Lt89;->d:Ljma;

    new-instance p1, Lwxa;

    invoke-direct {p1}, Lwxa;-><init>()V

    iput-object p1, p0, Lt89;->e:Lwxa;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-static {p2, p3, p4, v1, p1}, Lzua;->m0(Landroid/text/Editable;IIZLu89;)V

    return-void

    :cond_0
    sget v0, Lz3e;->markdown_italic:I

    if-ne p1, v0, :cond_1

    new-instance p1, Lfa8;

    invoke-direct {p1}, Lfa8;-><init>()V
    ...
    :cond_1
    sget v0, Lz3e;->markdown_underline:I
    ...
    invoke-direct {p1, v2}, Lixg;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Lzua;->m0(Landroid/text/Editable;IIZLu89;)V

    return-void

    :cond_2
    sget v0, Lz3e;->markdown_mono:I

    if-ne p1, v0, :cond_3

    new-instance p1, Luqa;

    invoke-direct {p1}, Luqa;-><init>()V
    ...
    :cond_3
    sget v0, Lz3e;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Lixg;

    invoke-direct {p1, v1}, Lixg;-><init>(I)V
    ...
    :cond_4
    sget v0, Lz3e;->markdown_heading:I

    if-ne p1, v0, :cond_5

    new-instance p1, Lnh7;

    invoke-direct {p1}, Lnh7;-><init>()V
    ...
    :cond_5
    sget v0, Lz3e;->markdown_quote:I

    sget-object v3, Ld2i;->a:Ld2i;

    iget-object v4, p0, Lt89;->a:Landroid/widget/EditText;
    ...
    sget v0, Lc4e;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Lt89;->b()Lnxd;

    move-result-object p4

    new-instance v0, Loxd;

    invoke-direct {v0, p4}, Loxd;-><init>(Lnxd;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Lr1b;->J(Landroid/text/Spannable;Lu89;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Lzua;->n0(Landroid/text/Spannable;Lu89;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Lc4e;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Levj;->a(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Lc4e;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Lz3e;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Lzua;->n0(Landroid/text/Spannable;Lu89;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Lzua;->Z(Landroid/text/Spannable;II)V
...
.method public final b()Lnxd;
    .locals 20

    move-object/from16 v0, p0

    iget-object v1, v0, Lt89;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Lqsf;->p(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v18}, Lnxd;-><init>(Landroid/content/Context;Leng;Lp5c;Lvgh;Landroid/graphics/drawable/Drawable;IIIIIIIIIIF)V
    ...
    invoke-direct {v1, v3, v4}, Lyvd;-><init>(Ljava/lang/Object;I)V

    iput-object v1, v2, Lnxd;->f:Lyvd;
...
.method public final c()Z
    ...
    iget-object v0, p0, Lt89;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Lsr8;->c:Ljava/lang/String;

    iget-object v0, v2, Ljma;->a:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->Q0:[Lki8;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lxk8;
    ...
    invoke-direct {v1, p2, p3, p1}, Lzb;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Ljma;->a:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lxk8;
    ...
    iget-object p1, p1, Lv89;->c:Lfx5;

    new-instance v0, Lzb;

    invoke-direct {v0, p2, p3, v1}, Lzb;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Lt89;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Lz3e;->markdown_italic:I
    ...
    :cond_4
    sget v5, Lz3e;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Lz3e;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Lt89;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Lz3e;->markdown_heading:I
    ...
    :cond_8
    sget v5, Lz3e;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Lt89;->e:Lwxa;

    invoke-virtual {p1}, Lwxa;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lwxa;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lwxa;->a(I)V

    invoke-virtual {p0}, Lt89;->c()Z
    ...
    invoke-virtual {p1, v3}, Lwxa;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object v3, p0, Lt89;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lwxa;->a(I)V
    ...
    invoke-direct {p1, p2, v1}, Lxv;-><init>(Ljava/lang/Object;I)V
