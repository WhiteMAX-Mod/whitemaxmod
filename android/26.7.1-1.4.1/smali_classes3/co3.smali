...
.method public apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lio4;->b(Landroid/os/Bundle;)Lio4;
    ...
    invoke-virtual {p1}, Lio4;->c()Landroid/os/Bundle;

    move-result-object v0

    iget-object p1, p1, Lio4;->d:Landroid/graphics/Bitmap;

    if-eqz p1, :cond_1

    sget-object v1, Lio4;->w:Ljava/lang/String;
    ...
    iget-object v0, p1, Lts3;->g:Landroid/os/Bundle;

    iget-object v1, p1, Lts3;->h:Lqw7;
    ...
    sget-object v4, Lts3;->j:Ljava/lang/String;

    invoke-virtual {v3}, Liqf;->b()Landroid/os/Bundle;
    ...
    sget-object v4, Lts3;->k:Ljava/lang/String;
    ...
    sget-object v4, Lts3;->q:Ljava/lang/String;
    ...
    sget-object v4, Lts3;->l:Ljava/lang/String;
    ...
    sget-object v4, Lts3;->m:Ljava/lang/String;
    ...
    sget-object v3, Lts3;->n:Ljava/lang/String;

    invoke-virtual {v2, v3, v0}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V

    :cond_7
    iget-object v0, p1, Lts3;->e:Landroid/net/Uri;

    if-eqz v0, :cond_8

    sget-object v3, Lts3;->p:Ljava/lang/String;

    invoke-virtual {v2, v3, v0}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    :cond_8
    iget-boolean p1, p1, Lts3;->i:Z

    if-nez p1, :cond_9

    sget-object v0, Lts3;->o:Ljava/lang/String;

    invoke-virtual {v2, v0, p1}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    :cond_9
    invoke-virtual {v1}, Lqw7;->c()I
    ...
    invoke-virtual {v1, p1}, Lqw7;->b(I)I
    ...
    :cond_a
    sget-object p1, Lts3;->r:Ljava/lang/String;

    invoke-virtual {v1}, Lqw7;->g()[I
...
.method public g(Lc8a;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Llck;->d(Lc8a;)Ljava/lang/Object;
...
.method public h(Landroid/os/Bundle;)Lg21;
    ...
    invoke-direct/range {v6 .. v23}, Lho4;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;Landroid/text/Layout$Alignment;Landroid/graphics/Bitmap;FIIFIIFFFZIIF)V
    ...
    invoke-direct {v0, v2, v5, v4, v1}, Lrr3;-><init>(III[B)V
...
.method public parse(Lmh8;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/api/ConversationParams;->a(Lmh8;)Lru/ok/android/externcalls/sdk/api/ConversationParams;
    ...
    :sswitch_0
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/ConversationFactory;->b(Lmh8;)Ljava/lang/Object;
    ...
    :sswitch_1
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/api/request/ClientSupportedCodecs$Request;->a(Lmh8;)Lru/ok/android/externcalls/sdk/api/request/ClientSupportedCodecs$Response;
...
.method public setInternalId(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lnp1;)V
    .locals 0

    invoke-virtual {p1, p2}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Lnp1;)V
