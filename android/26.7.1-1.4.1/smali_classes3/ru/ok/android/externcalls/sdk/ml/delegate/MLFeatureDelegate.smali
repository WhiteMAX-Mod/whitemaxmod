...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "context",
        "<init>",
        "(Lo59;Lru/ok/android/externcalls/sdk/ml/config/MLFeaturesConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Lgae;Landroid/content/Context;)V",
        "downloadDir",
        "()Ljava/lang/String;",
        "fileName",
        "Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$MLModelValidationResult;",
        ...
        "downloadModel",
        "(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldcg;",
        "stage",
...
.field private final disposables:Lrx3;
...
.field private final mlFeaturesInfoDataSource:Lo59;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$Companion;-><init>(Lpy4;)V
...
.method public constructor <init>(Lo59;Lru/ok/android/externcalls/sdk/ml/config/MLFeaturesConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Lgae;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lo59;
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lgae;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->disposables:Lrx3;

    return-void
.end method

.method public static final synthetic access$downloadModel(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldcg;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldcg;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;)Lgae;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lgae;
...
.method private final clearDir()V
    ...
    invoke-static {v3, v4}, Lgnk;->a(Ljava/io/File;Le37;)V
...
.method private final downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ldcg;
    .locals 5
    ...
    sget-object v4, Lxg7;->b:Lxg7;

    invoke-direct {v3, p1, v4}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;-><init>(Ljava/lang/String;Lxg7;)V

    invoke-interface {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/net/DownloadService;->download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ldcg;
    ...
    invoke-interface {p1}, Lm47;->d()Lvm6;
    ...
    invoke-direct {v0, p1, v2}, Len6;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lrn6;-><init>(Lvm6;Ljava/lang/Object;I)V

    new-instance p1, Lwn6;

    invoke-direct {p1, v0}, Lwn6;-><init>(Lb1;)V
...
.method private final fetchConfig()Lra9;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lra9;
...
.method private final log(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lgae;
...
.method private final removeCurrentModel()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lo59;
...
.method private final saveNewModelInfo(Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;)Lru/ok/android/externcalls/sdk/ml/stage/SaveNewModelInfoStage;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lo59;
    ...
    :try_start_6
    invoke-static {v5, v6}, Ly17;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v5, v0, v4}, Lgae;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final unzipModel(Lru/ok/android/externcalls/sdk/ml/stage/DownloadStage;)Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;
    ...
    invoke-static {v0, v1}, Lnf6;->i(Ljava/io/File;Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v0}, Lgnk;->a(Ljava/io/File;Le37;)V
    ...
    invoke-static {p1, v1}, Lgnk;->a(Ljava/io/File;Le37;)V
...
.method private final validateCurrentModel()Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$MLModelValidationResult;
    ...
    :try_start_8
    invoke-static {v4, v2}, Ly17;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v4, v1, v2}, Lgae;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
# virtual methods
.method public final checkModel()Ldcg;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->fetchConfig()Lra9;
    ...
    invoke-direct {v2, v0, v1, v3}, Lib9;-><init>(Lra9;Ljava/lang/Object;I)V

    invoke-static {}, Lq7f;->b()Lf7f;

    move-result-object v0

    invoke-virtual {v2, v0}, Lra9;->d(Lf7f;)Lib9;
    ...
    invoke-direct {v2, v0, v1}, Lcb9;-><init>(Lra9;Lt37;)V
    ...
    invoke-direct {v1, v2, v3, v0}, Lmw3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final dispose()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->disposables:Lrx3;
