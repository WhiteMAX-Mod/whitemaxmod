...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(Liae;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Ldgb;",
        "observeStat",
        "()Ldgb;",
        "rtcStat",
...
.field private final statSubject:Los0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Lpy4;)V
...
.method public constructor <init>(Lgae;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lgae;

    new-instance p1, Los0;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Los0;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Los0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lgae;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lgae;

    return-object p0
.end method

.method private final mapToMonitoringStat(Liae;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILpy4;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Lkc2;->h:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, Lyxg;->D0(Ljava/lang/String;)Z
    ...
    :goto_1
    iget-object p1, p1, Liae;->b:Ljava/util/List;

    invoke-static {p1, v0}, Lrek;->c(Ljava/util/List;Lkc2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lgae;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lgae;
    ...
    :cond_c
    iget-object p1, v5, Ltjg;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Ltjg;->h:Ljava/math/BigInteger;
    ...
    :goto_7
    iget-object p1, v0, Lkc2;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lgae;
    ...
    invoke-interface {p1, v2, v1}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public observeStat()Ldgb;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Los0;
...
.method public onRtcStats(Liae;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(Liae;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
