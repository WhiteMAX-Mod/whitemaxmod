...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "exception",
        "debugIoException",
        "(Ljo;Lap;Ljava/io/IOException;)V",
        "Lgae;",
        "Lkp;",
...
.field private final sessionStore:Lkp;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lpy4;)V
...
.method public constructor <init>(Lgae;Lkp;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lgae;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lkp;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lgae;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Lydc;
    .locals 2
...
.method private final getParams(Lap;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lap;)Ljava/lang/String;
...
.method private final getRawParams(Lap;)Ljava/lang/String;
    .locals 3
    ...
    invoke-direct {v1, v0}, Lwwc;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lwwc;->q()V

    invoke-interface {p1, v1}, Lap;->writeParams(Luh8;)V

    invoke-virtual {v1}, Lwwc;->n()V

    invoke-virtual {v1}, Lwwc;->flush()V
    :try_end_0
    ...
    :catch_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lgae;

    const-string v1, "CallsApiDebug"

    const-string v2, "failed to log request params"

    invoke-interface {p1, v1, v2}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lkp;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Lydc;
...
.method public debugApiRequest(Ljo;Lap;Llo;)V
    ...
    instance-of p1, p2, Ldp;

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lap;)Ljava/lang/String;

    move-result-object p1

    const-string p3, "start with params "

    invoke-static {p3, p1}, Li62;->F(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lgae;
    ...
    invoke-static {v0, p2, v1, p1}, Li62;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugApiResponseFail(Ljo;Lap;Lmh8;)Lmh8;
    ...
    invoke-interface {p3}, Lmh8;->g0()Ljava/lang/String;
    ...
    invoke-static {v1, p2, v2, p3}, Li62;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string p3, "CallsApiDebug"

    invoke-interface {v0, p3, p2}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Lnh8;->l(Ljava/lang/String;)Lnh8;
...
.method public debugApiResponseOk(Ljo;Lap;Lmh8;)Lmh8;
    ...
    invoke-static {v0, p3}, Li62;->F(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugIoException(Ljo;Lap;Ljava/io/IOException;)V
    ...
    invoke-static {v0, p2, v1}, Lw59;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string v0, "CallsApiDebug"

    invoke-interface {p1, v0, p2, p3}, Lgae;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
