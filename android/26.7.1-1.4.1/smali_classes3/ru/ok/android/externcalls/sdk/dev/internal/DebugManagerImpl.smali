...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Le61;Lru/ok/android/externcalls/sdk/log/ExtLogger;Ltj4;Lgae;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "Lvmg;",
        "operation",
        "",
        "param",
        ...
        "(Lbog;ILjava/util/concurrent/TimeUnit;)V",
        "removeStatListener",
        "(Lbog;)V",
        "Le61;",
        "getUnderlyingCall",
...
.field private final underlyingCall:Le61;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl$Companion;-><init>(Lpy4;)V
...
.method public constructor <init>(Le61;Lru/ok/android/externcalls/sdk/log/ExtLogger;Ltj4;Lgae;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Le61;
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->cidProvider:Ltj4;

    iput-object p4, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lgae;

    new-instance p1, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Le61;

    move-result-object p2

    invoke-direct {p1, p2, p5}, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;-><init>(Le61;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
...
.method public enableFullAudioDump(Ljava/lang/String;)V
    ...
    iget-object v1, v0, Le61;->f0:Lx4g;
    ...
    :cond_0
    iget-object v2, v0, Le61;->c:Ljava/util/concurrent/ExecutorService;

    new-instance v3, Lkl;

    const/4 v4, 0x6

    invoke-direct {v3, v0, v1, p1, v4}, Lkl;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public getUnderlyingCall()Le61;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Le61;

    return-object v0
.end method

.method public registerStatListener(Lbog;ILjava/util/concurrent/TimeUnit;)V
    .locals 3
    ...
    iget-object v0, v0, Le61;->M0:Lep7;

    int-to-long v1, p2

    iget-object p2, v0, Lep7;->b:Ljava/lang/Object;

    check-cast p2, Ljava/util/HashMap;

    new-instance v0, Lmpj;

    invoke-direct {v0, v1, v2, p3}, Lmpj;-><init>(JLjava/util/concurrent/TimeUnit;)V
...
.method public removeStatListener(Lbog;)V
    .locals 1
...
.method public report(Lvmg;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->cidProvider:Ltj4;

    check-cast v1, Luj4;

    iget-object v1, v1, Luj4;->a:Ljava/lang/String;

    invoke-virtual {v0, p1, v1, p2}, Lru/ok/android/externcalls/sdk/log/ExtLogger;->logSimple(Lvmg;Ljava/lang/String;Ljava/lang/String;)V
...
.method public reportError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lgae;
...
.method public updateCameraToggles(Le37;)V
    .locals 3
    ...
    iget-object v0, v0, Le61;->h0:Llne;

    iget-object v0, v0, Llne;->i:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v2, v0, Lzl4;->b:Ljava/lang/Object;

    check-cast v2, Lva2;

    invoke-interface {p1, v2}, Le37;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lva2;

    iput-object p1, v0, Lzl4;->b:Ljava/lang/Object;
