...
.method public final k0()Landroid/app/Dialog;
    ...
    iget-object v6, v6, Lmvd;->a:Ljvd;

    iget-object v6, v6, Ljvd;->a:Lhvd;
    ...
    invoke-static {v2}, Lzua;->F0(Landroid/content/Context;)Lfch;
    ...
    iget-object v7, v7, Lmvd;->a:Ljvd;

    iget-boolean v9, v7, Ljvd;->f:Z

    iget-object v10, v7, Ljvd;->a:Lhvd;

    iget-object v10, v10, Lhvd;->a:Ljava/lang/String;
    ...
    iget-wide v13, v7, Ljvd;->e:J

    const/4 v7, 0x0

    invoke-static {v13, v14, v8, v7}, Lkhh;->v(JZLandroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v3}, Lj99;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v2}, Lj99;->a(Ljava/lang/String;)Lj99;
    ...
    invoke-direct {v3, p0, v0}, Lmoi;-><init>(Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;Ljava/util/ArrayList;)V

    iget-object v0, v1, Ldf;->a:Lze;

    iput-object v2, v0, Lze;->n:[Ljava/lang/CharSequence;

    iput-object v3, v0, Lze;->p:Landroid/content/DialogInterface$OnClickListener;

    iput v5, v0, Lze;->s:I

    iput-boolean v8, v0, Lze;->r:Z
    ...
    invoke-direct {v2, p0, v3}, Ln24;-><init>(Landroidx/fragment/app/DialogFragment;I)V

    iget-object v3, v1, Ldf;->a:Lze;

    iput-object v0, v3, Lze;->k:Ljava/lang/CharSequence;

    iput-object v2, v3, Lze;->l:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v1}, Lj99;->create()Lef;
