...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Ld9e;->UiUtils_TextAppearance_LongRoundedTitleSubtitleButton_Title:I

    invoke-direct {v0, p1, v1}, Landroid/text/style/TextAppearanceSpan;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->v0:Landroid/text/style/TextAppearanceSpan;

    new-instance v0, Landroid/text/style/TextAppearanceSpan;

    sget v1, Ld9e;->UiUtils_TextAppearance_LongRoundedTitleSubtitleButton_Subtitle:I

    invoke-direct {v0, p1, v1}, Landroid/text/style/TextAppearanceSpan;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->w0:Landroid/text/style/TextAppearanceSpan;

    sget-object v0, Lo9e;->LongRoundedTitleSubtitleButton:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lo9e;->LongRoundedTitleSubtitleButton_lrts_title:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p2

    sget v0, Lo9e;->LongRoundedTitleSubtitleButton_lrts_subtitle:I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->d(Lfch;)V
...
.method public final b(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    iget-object v4, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->v0:Landroid/text/style/TextAppearanceSpan;
    ...
    iget-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->w0:Landroid/text/style/TextAppearanceSpan;
...
.method public final d(Lfch;)V
    ...
    invoke-static {v1, v3}, Lfk8;->U(IF)I
    ...
    invoke-static {v0, v1, v1, v4}, Lr1b;->E(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[F)Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {v3, v1, v1, v4}, Lr1b;->E(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[F)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v3

    invoke-static {v0, v1, v3}, Lr1b;->G(Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;)Landroid/graphics/drawable/StateListDrawable;
