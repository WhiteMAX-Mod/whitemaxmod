...
.method public final accept(Ljava/lang/Object;)V
    ...
    iput-object v6, v2, Lvhc;->W:Lorg/webrtc/RtpSender;

    iput-object v6, v2, Lvhc;->Y:Lorg/webrtc/RtpSender;
    ...
    iget-object v0, v2, Lvhc;->C:Lgae;

    const-string v10, "audioShareTransceiver found"

    invoke-interface {v0, v9, v10}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v11, v2, Lvhc;->C:Lgae;
    ...
    invoke-interface {v11, v9, v0}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    iget-object v0, v2, Lvhc;->x:Lu4g;
    ...
    iput-object v7, v2, Lvhc;->W:Lorg/webrtc/RtpSender;

    iget-object v11, v2, Lvhc;->t:Lev8;

    const-string v12, "audio-share"

    invoke-virtual {v11, v7, v12}, Lev8;->j(Lorg/webrtc/RtpSender;Ljava/lang/String;)V

    invoke-virtual {v7, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v7, v2, Lvhc;->C:Lgae;
    ...
    invoke-interface {v7, v9, v0}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v9, v7}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v11 .. v17}, Lev8;->k(Lorg/webrtc/RtpSender;Ljava/lang/String;IILjava/lang/Double;Z)V

    iput-object v12, v2, Lvhc;->Y:Lorg/webrtc/RtpSender;

    invoke-virtual {v12, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v5, v2, Lvhc;->Y:Lorg/webrtc/RtpSender;

    iget-boolean v7, v2, Lvhc;->l0:Z
    ...
    invoke-interface {v5, v9, v0}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_2
    iget-object v0, v2, Lvhc;->Y:Lorg/webrtc/RtpSender;

    const/4 v5, 0x1

    invoke-virtual {v2, v3, v10, v5, v0}, Lvhc;->m(Lorg/webrtc/PeerConnection;ZZLorg/webrtc/RtpSender;)V
    :try_end_2
    ...
    :cond_9
    :goto_8
    invoke-virtual {v2, v3}, Lvhc;->u(Lorg/webrtc/PeerConnection;)V

    sget-object v0, Lo2b;->b:Lo2b;

    iget-object v4, v2, Lvhc;->E:Lkp1;

    iget-object v4, v4, Lkp1;->t:Lo2b;
    ...
    iget-object v4, v2, Lvhc;->O:Lorg/webrtc/PeerConnection;

    invoke-virtual {v4}, Lorg/webrtc/PeerConnection;->getRemoteDescription()Lorg/webrtc/SessionDescription;

    move-result-object v4

    const-string v5, "emulated error"

    invoke-direct {v3, v0, v5, v6, v4}, Lp2b;-><init>(Lo2b;Ljava/lang/String;Lorg/webrtc/SessionDescription;Lorg/webrtc/SessionDescription;)V

    invoke-virtual {v2, v3}, Lvhc;->h(Lp2b;)V
    ...
    invoke-direct {v0, v2, v4}, Lshc;-><init>(Lvhc;I)V

    iget-object v2, v2, Lvhc;->R:Lorg/webrtc/MediaConstraints;
    ...
    invoke-virtual {v0, v2, v3}, Lvhc;->t(Lorg/webrtc/PeerConnection;Z)V

    invoke-virtual {v0, v2, v3}, Lvhc;->l(Lorg/webrtc/PeerConnection;Z)V
