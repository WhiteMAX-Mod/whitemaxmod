...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlaybackException;)V
    ...
    iget-object v0, p1, Landroidx/media3/exoplayer/ExoPlaybackException;->z0:Lew6;
    ...
    iget-object v3, p1, Landroidx/media3/exoplayer/ExoPlaybackException;->x0:Ljava/lang/String;
    ...
    invoke-static {v0}, Lcuj;->a(Lew6;)La90;
    ...
    invoke-static {v0}, Lcuj;->b(Lew6;)Lgfh;
    ...
    :goto_2
    iput-object v0, p0, Lone/video/exo/error/OneVideoExoRendererException;->b:Ljj9;

    sget-object v0, Lgw6;->a:Ljava/util/HashMap;

    iget p1, p1, Landroidx/media3/exoplayer/ExoPlaybackException;->A0:I
    ...
    sget-object p1, Lfw6;->X:Lfw6;

    :cond_8
    iput-object p1, p0, Lone/video/exo/error/OneVideoExoRendererException;->c:Lfw6;
    ...
    iget-object p1, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer$DecoderInitializationException;->c:Lhg9;

    invoke-static {p1}, Lone/video/exo/error/OneVideoExoRendererException;->a(Lhg9;)V
    ...
    iget-object p1, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecDecoderException;->a:Lhg9;
...
.method public static a(Lhg9;)V
    ...
    :cond_0
    iget-boolean v0, p0, Lhg9;->h:Z

    const/4 v1, 0x0

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lhg9;->e:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    invoke-virtual {p0}, Lhg9;->h()Z
    ...
    iget-boolean v0, p0, Lhg9;->j:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean p0, p0, Lhg9;->f:Z
