...
.method public constructor <init>(La79;Leah;)V
    ...
    iput-object v0, p0, Lfo0;->a:Lq4g;

    new-instance v1, Lbfe;

    invoke-direct {v1, v0}, Lbfe;-><init>(Lqya;)V

    iput-object v1, p0, Lfo0;->b:Lbfe;
    ...
    iput-object p2, p0, Lfo0;->c:Lkotlinx/coroutines/internal/ContextScope;
...
# virtual methods
.method public final onBaseError(Lbp0;)V
    .locals 3
    ...
    invoke-direct {v0, p0, p1, v1}, Leo0;-><init>(Lfo0;Lbp0;Lkotlin/coroutines/Continuation;)V

    const/4 p1, 0x3

    iget-object v2, p0, Lfo0;->c:Lkotlinx/coroutines/internal/ContextScope;
