...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lvuj;->a:Ljava/lang/Object;
...
.method public static b(Landroid/media/MediaRoute2Info;)Lvp9;
    .locals 10
    ...
    invoke-static {p0}, Lkg;->m(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lzo9;->m(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Ltv8;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Ltv8;->b:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Lzo9;->a(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lzo9;->x(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lzo9;->C(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lzo9;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lkg;->i(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lzo9;->y(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Lzo9;->k(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Ltv8;->A(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Ltv8;->C()Lvp9;
