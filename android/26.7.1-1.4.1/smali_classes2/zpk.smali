...
# direct methods
.method public static a(Ljv7;)Landroid/graphics/Bitmap;
    .locals 4
    ...
    :cond_4
    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->c(Ljv7;)Landroid/graphics/Bitmap;
...
.method public static d(Ljv7;Landroid/graphics/Rect;II)[B
    .locals 21

    invoke-interface/range {p0 .. p0}, Ljv7;->getFormat()I
    ...
    invoke-virtual {v4}, Lyye;->t()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v2}, Lyye;->A()I

    move-result v10

    invoke-virtual {v4}, Lyye;->z()I

    move-result v4

    invoke-virtual {v2}, Lyye;->z()I
    ...
    sget-object v4, Ltz5;->c:[Lf06;

    new-instance v4, Lsz5;

    sget-object v5, Ljava/nio/ByteOrder;->BIG_ENDIAN:Ljava/nio/ByteOrder;

    invoke-direct {v4}, Lsz5;-><init>()V
    ...
    iget-object v7, v4, Lsz5;->a:Ljava/util/ArrayList;

    invoke-virtual {v4, v6, v5, v7}, Lsz5;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V

    const-string v5, "XResolution"

    const-string v6, "72/1"

    invoke-virtual {v4, v5, v6, v7}, Lsz5;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-interface/range {p0 .. p0}, Ljv7;->getImageInfo()Lou7;
    ...
    invoke-interface {v5, v4}, Lou7;->c(Lsz5;)V

    :cond_3
    move/from16 v5, p3

    invoke-virtual {v4, v5}, Lsz5;->d(I)V
    ...
    invoke-direct {v5, v4}, Lrz5;-><init>(Lsz5;)V
    ...
    invoke-virtual {v4, v6, v7, v5}, Lsz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v7, v6, v5}, Lsz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v6, v3, v5}, Lsz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v5}, Lsz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v7, v5}, Lsz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v4, v4, Lsz5;->b:Ljava/nio/ByteOrder;

    invoke-direct {v3, v4, v5}, Ltz5;-><init>(Ljava/nio/ByteOrder;Ljava/util/ArrayList;)V

    invoke-direct {v2, v0, v3}, Le06;-><init>(Ljava/io/ByteArrayOutputStream;Ltz5;)V
