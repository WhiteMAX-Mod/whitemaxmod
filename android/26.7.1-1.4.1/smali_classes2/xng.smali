...
.field public static final b:Lns8;
...
.method public static a(Landroid/text/Spannable;I)Z
    ...
    sget-object v3, Lzgc;->b:Ljava/util/regex/Pattern;
    ...
    invoke-static {v1, p0, v3, v5, v6}, Lxng;->e(Ljava/util/ArrayList;Landroid/text/Spannable;Ljava/util/regex/Pattern;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;)V
    ...
    sget-object v3, Lzgc;->c:Ljava/util/regex/Pattern;
    ...
    :goto_1
    :try_start_0
    invoke-static {p1}, Lxng;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v5, v7, Los8;->b:Ljava/lang/String;
    ...
    iput-object v5, v6, Los8;->a:Landroid/text/style/URLSpan;
    ...
    iget-object v5, v5, Los8;->a:Landroid/text/style/URLSpan;
    ...
    iget-object v1, v0, Los8;->a:Landroid/text/style/URLSpan;

    if-nez v1, :cond_10

    iget-object v1, v0, Los8;->b:Ljava/lang/String;
...
.method public static b(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;)Z
    ...
    invoke-static {v5, p1, p2}, Lxng;->f(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;)Ljava/lang/String;
...
.method public static declared-synchronized c()V
    ...
    :try_start_0
    sget-boolean v1, Lxng;->a:Z

    if-nez v1, :cond_0

    const-string v1, "static-webp"

    invoke-static {v1}, Lr1b;->y(Ljava/lang/String;)Z

    const/4 v1, 0x1

    sput-boolean v1, Lxng;->a:Z
    :try_end_0
...
.method public static d(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-object v1, Lag6;->c:Ljava/util/regex/Pattern;
    ...
    invoke-static {v4}, Lag6;->a(Ljava/lang/String;)Z
    ...
    sget-object v7, Lag6;->b:Ljava/util/regex/Pattern;
    ...
    invoke-static/range {v20 .. v20}, Lag6;->a(Ljava/lang/String;)Z
    ...
    sget-object v10, Lag6;->e:Ljava/util/regex/Pattern;
    ...
    :cond_10
    sget-object v10, Lag6;->d:Ljava/util/regex/Pattern;
    ...
    :cond_13
    :goto_9
    sget-object v6, Lag6;->g:Ljava/util/regex/Pattern;
    ...
    iget v11, v6, Lzf6;->b:I

    if-gt v11, v3, :cond_14

    iget v11, v6, Lzf6;->c:I

    if-le v3, v11, :cond_15

    :cond_14
    iget v11, v6, Lzf6;->d:I
...
.method public static e(Ljava/util/ArrayList;Landroid/text/Spannable;Ljava/util/regex/Pattern;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;)V
    .locals 4
    ...
    invoke-static {v2, p3, p2}, Lxng;->f(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v3, Los8;->b:Ljava/lang/String;
...
.method public static f(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;)Ljava/lang/String;
    ...
    invoke-static {v5}, Li62;->w(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, p1, p0}, Lw59;->p(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final g(Lone/me/messages/list/loader/MessageModel;)Ljava/util/List;
    .locals 13

    iget-boolean v0, p0, Lone/me/messages/list/loader/MessageModel;->y0:Z

    iget-object v1, p0, Lone/me/messages/list/loader/MessageModel;->w0:Lk40;

    iget-object v7, v1, Lk40;->b:Ll50;

    instance-of v1, v7, Ldc9;

    if-nez v1, :cond_0

    instance-of v1, v7, Lub6;
    ...
    iget-object v1, v1, Lkq3;->b:Ljava/util/ArrayList;
    ...
    iget-wide v5, v2, Lit7;->a:J

    iget-object v2, v2, Lit7;->k:Ljava/lang/String;
    ...
    invoke-direct/range {v2 .. v8}, Lfk9;-><init>(JJLl50;Ljava/lang/String;)V
    ...
    iget-wide v5, v8, Lit7;->a:J

    const/4 v9, 0x0

    const/16 v10, 0x30

    invoke-direct/range {v2 .. v10}, Lmk9;-><init>(JJLl50;Lit7;Ljava/lang/String;I)V
    ...
    iget-wide v5, v2, Lidi;->a:J

    iget-object v2, v2, Lidi;->h:Ljava/lang/String;
    ...
    iget-wide v5, v8, Lidi;->a:J

    invoke-direct/range {v2 .. v8}, Ltk9;-><init>(JJLl50;Lidi;)V
    ...
    iget-wide v5, v0, Lit7;->a:J

    iget-object v0, v0, Lit7;->k:Ljava/lang/String;
    ...
    iget-wide v5, v0, Lidi;->a:J

    iget-object v0, v0, Lidi;->h:Ljava/lang/String;
    ...
    iget-object v8, v2, Lub6;->j:Lit7;

    move-object v3, v8

    iget-object v8, v2, Lub6;->k:Lidi;

    if-eqz v0, :cond_f

    if-eqz v3, :cond_f

    iget-wide v5, v3, Lit7;->a:J

    iget-object v8, v2, Lub6;->c:Ljava/lang/String;
    ...
    iget-object v9, v0, Lub6;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v2 .. v9}, Ltk9;-><init>(JJLl50;Lidi;Ljava/lang/String;)V
