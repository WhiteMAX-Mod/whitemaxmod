...
.method private final a(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lqza;->A0:Ljy5;
    ...
    :cond_1
    iget-object v1, p1, Lqza;->c:Ldy8;

    iget-boolean v1, v1, Ldy8;->a:Z
    ...
    :cond_2
    iget-object v1, p1, Lqza;->D0:Lz12;

    sget-object v3, Ll2f;->a:Llhg;

    if-eqz v1, :cond_4

    invoke-virtual {v1}, Lz12;->f()Z
    ...
    :cond_5
    iget-object v1, p1, Lqza;->X:Ljava/lang/Object;
    ...
    iget-boolean v11, v3, Ljvd;->f:Z

    invoke-direct/range {v4 .. v11}, Ljvd;-><init>(Lhvd;IIIJZ)V
    ...
    :cond_7
    iget-object v1, p1, Lqza;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    iget-object p1, p1, Lqza;->Z:Lbfi;
    ...
    sget-object v3, Ljvd;->g:Lns8;

    invoke-static {v3, v0}, Lnr3;->Y(Ljava/util/Comparator;Ljava/util/List;)V
    ...
    invoke-direct {v5, v4}, Lmvd;-><init>(Ljvd;)V
    ...
    filled-new-array {v0, v3, v4}, [Lydc;
    ...
    invoke-virtual {v1}, Landroidx/fragment/app/b;->B()Lrz6;
    ...
    invoke-direct {v0, v1, v3}, Ljd7;-><init>(Ljava/lang/Object;I)V

    new-instance v1, La8;

    const/4 v3, 0x0

    invoke-direct {v1, v3}, La8;-><init>(I)V

    new-instance v3, Ljzg;

    const/16 v4, 0x14

    invoke-direct {v3, v1, v4, v0}, Ljzg;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v2}, La07;->b()V

    iget-object v0, v2, La07;->d:Lwn8;
    ...
    invoke-direct {v1, p1, v3, v0}, Lkz6;-><init>(Lrz6;Ljzg;Lwn8;)V

    iget-object p1, p1, Landroidx/fragment/app/c;->m:Ljava/util/Map;

    new-instance v2, Lnz6;

    invoke-direct {v2, v0, v3, v1}, Lnz6;-><init>(Lwn8;Ljzg;Lkz6;)V
    ...
    iget-object v2, p1, Lnz6;->a:Lwn8;

    iget-object p1, p1, Lnz6;->c:Lkz6;

    invoke-virtual {v2, p1}, Lwn8;->f(Lrn8;)V
...
.method private final b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Lix8;->e()Z

    move-result v0

    if-nez v0, :cond_6

    iget-object v0, p1, Lqza;->v0:Lkoc;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v2, v0, Lkoc;->d:Leo5;
    ...
    :goto_0
    iget-object v3, p1, Lqza;->d:Lix8;

    if-eqz v0, :cond_2

    iget-object v4, v0, Lkoc;->o:Landroid/net/Uri;
    ...
    :cond_2
    :goto_1
    invoke-static {v0, v3}, Lkoc;->a(Lkoc;Lix8;)Landroid/net/Uri;

    move-result-object v0

    iget-object p1, p1, Lqza;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;
...
.method private final c(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lqza;->Z:Lbfi;

    iget-boolean v1, v0, Lbfi;->d:Z

    xor-int/lit8 v2, v1, 0x1

    invoke-virtual {v0}, Lbfi;->a()Lv60;
    ...
    invoke-direct {v3, v0}, Lbfi;-><init>(Lv60;)V

    iput-object v3, p1, Lqza;->Z:Lbfi;

    invoke-virtual {p1}, Lqza;->T()V

    new-instance v0, Lnza;

    invoke-direct {v0, v2}, Lnza;-><init>(Z)V

    invoke-virtual {p1, v0}, Lqza;->U(Ld47;)V

    iget-object v0, p1, Lqza;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    const/4 v3, 0x1

    invoke-virtual {v0, v1, v3}, Lru/ok/messages/media/mediabar/ActLocalMedias;->U(ZZ)V

    iget-object p1, p1, Lqza;->w0:Lnf;
    ...
    invoke-virtual {p1, v1, v0}, Ltz8;->j(Ljava/lang/String;Ljava/util/Map;)V
...
.method private final d(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lm0b;->Y:Lhj;

    iget-object v2, v0, Lm0b;->E0:Landroidx/appcompat/widget/AppCompatImageButton;

    invoke-virtual {v1, v2}, Lhj;->f(Landroid/view/View;)Ln89;

    iget-object v2, v0, Lm0b;->F0:Landroid/widget/ProgressBar;

    invoke-virtual {v1, v2}, Lhj;->e(Landroid/view/View;)Ln89;
    ...
    invoke-static {v0}, Lzuj;->g(Landroid/view/ViewGroup;)V

    iget-object v2, p1, Lwza;->b:Lru/ok/messages/media/trim/FrgTrimVideo;
    ...
    invoke-virtual {v0, v1}, Ldcg;->n(Lf7f;)Lxcg;
    ...
    invoke-direct {v1, p1, v2}, Lvza;-><init>(Lwza;I)V

    new-instance p1, Lft9;

    const/16 v2, 0x17

    invoke-direct {p1, v2}, Lft9;-><init>(I)V
...
.method private final e(Ljava/lang/Object;)V
    ...
    iget-wide v0, p1, Lwza;->X:J

    iget-object v2, p1, Lg3;->a:Ljava/lang/Object;

    check-cast v2, Lxza;

    iget-wide v3, p1, Lwza;->Y:J
    ...
    iput-wide v5, p1, Lwza;->Y:J

    iput-wide v0, p1, Lwza;->Z:J

    check-cast v2, Lm0b;

    iget-object v0, v2, Lm0b;->A0:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v0, v5, v6}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->setStartPosition(J)V

    iget-wide v0, p1, Lwza;->Z:J

    iget-object v3, v2, Lm0b;->A0:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v3, v0, v1}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->setEndPosition(J)V

    iget-wide v0, p1, Lwza;->Y:J
    ...
    iget-object v3, v2, Lm0b;->y0:Landroid/widget/TextView;
    ...
    invoke-static {v0, v1}, Lfk8;->s(J)Ljava/lang/String;

    move-result-object v0

    iget-object v1, v2, Lm0b;->z0:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lwza;->o:Lqx8;

    iget-wide v1, p1, Lwza;->Y:J

    invoke-virtual {v0, v1, v2}, Lqx8;->h(J)V

    invoke-virtual {p1}, Lwza;->U()V
...
.method private final f(Ljava/lang/Object;)V
    ...
    iput-boolean v1, v0, Lqx8;->j:Z

    iget-object v0, v0, Lqx8;->b:Lr06;

    invoke-virtual {v0}, Lr06;->play()V

    :goto_0
    iget-object v0, p1, Lwza;->y0:Lkk8;
    ...
    iput-object v4, p1, Lwza;->y0:Lkk8;
...
.method private final g(Ljava/lang/Object;)V
    ...
    iget-boolean v0, p1, Lwza;->z0:Z

    xor-int/lit8 v0, v0, 0x1

    iput-boolean v0, p1, Lwza;->z0:Z

    iget-object v1, p1, Lg3;->a:Ljava/lang/Object;

    check-cast v1, Lxza;

    check-cast v1, Lm0b;

    iget-object p1, p1, Lwza;->o:Lqx8;

    invoke-virtual {p1}, Lqx8;->c()Z

    move-result p1

    invoke-virtual {v1, v0, p1}, Lm0b;->w(ZZ)V
...
.method public final accept(Ljava/lang/Object;)V
    ...
    sget-object v2, Lone/me/mediaeditor/PhotoEditScreen;->L0:[Lki8;

    if-eqz v1, :cond_0

    iget-object v1, v1, Ljoc;->c:Lioc;

    invoke-interface {v1}, Lioc;->l()V

    :cond_0
    return-void

    :pswitch_0
    invoke-direct/range {p0 .. p1}, Ls95;->i(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Ljoc;->c()V

    :cond_1
    return-void

    :pswitch_2
    invoke-direct/range {p0 .. p1}, Ls95;->h(Ljava/lang/Object;)V

    return-void

    :pswitch_3
    invoke-direct/range {p0 .. p1}, Ls95;->g(Ljava/lang/Object;)V

    return-void

    :pswitch_4
    invoke-direct/range {p0 .. p1}, Ls95;->f(Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Lwza;->b:Lru/ok/messages/media/trim/FrgTrimVideo;
    ...
    :pswitch_6
    invoke-direct/range {p0 .. p1}, Ls95;->e(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lwza;->Q()V

    return-void

    :pswitch_8
    invoke-direct/range {p0 .. p1}, Ls95;->d(Ljava/lang/Object;)V

    return-void

    :pswitch_9
    invoke-direct/range {p0 .. p1}, Ls95;->c(Ljava/lang/Object;)V

    return-void

    :pswitch_a
    invoke-direct/range {p0 .. p1}, Ls95;->b(Ljava/lang/Object;)V
    ...
    iget-object v2, v1, Lqza;->d:Lix8;

    if-eqz v2, :cond_2

    invoke-virtual {v2}, Lc3;->c()Z
    ...
    iget-object v3, v3, Lix8;->c:Ljava/lang/String;

    iget-object v4, v1, Lqza;->Z:Lbfi;

    iget v5, v4, Lbfi;->b:F

    iget-wide v6, v1, Lqza;->Y:J
    ...
    invoke-virtual {v2}, Lix8;->e()Z

    move-result v2

    if-nez v2, :cond_d

    iget-object v2, v1, Lqza;->w0:Lnf;

    const-string v3, "LOCAL_MEDIA_CROP"

    invoke-interface {v2, v3}, Lnf;->c(Ljava/lang/String;)V

    iget-object v2, v1, Lqza;->y0:Lce6;

    const-string v3, "jpg"

    invoke-interface {v2, v3}, Lce6;->a(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v4, v1, Lqza;->v0:Lkoc;

    if-eqz v4, :cond_3

    iget-object v5, v4, Lkoc;->b:Landroid/net/Uri;
    ...
    iget-object v4, v4, Lkoc;->a:Landroid/net/Uri;
    ...
    invoke-static {v12, v4}, Lg0i;->H(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, v1, Lqza;->v0:Lkoc;

    if-eqz v4, :cond_b

    iget-object v10, v4, Lkoc;->o:Landroid/net/Uri;
    ...
    iget-object v4, v1, Lqza;->z0:Lf8c;

    new-instance v5, Leo;

    const/16 v6, 0x13

    invoke-direct {v5, v4, v3, v10, v6}, Leo;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance v3, Lvib;

    invoke-direct {v3, v5, v15}, Lvib;-><init>(Ljava/lang/Object;I)V

    new-instance v4, Leia;

    const/4 v5, 0x2

    invoke-direct {v4, v1, v5, v2}, Leia;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v2, Lmza;

    invoke-direct {v2, v1, v14}, Lmza;-><init>(Lqza;I)V

    invoke-virtual {v3, v4, v2}, Ldcg;->k(Lm64;Lm64;)Lz12;

    goto :goto_4

    :cond_c
    iget-object v1, v1, Lqza;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    invoke-virtual {v1, v3, v2, v6}, Lru/ok/messages/media/mediabar/ActLocalMedias;->Y(Landroid/net/Uri;Ljava/io/File;Lzm4;)V
    ...
    iget-object v2, v1, Lru/ok/messages/media/mediabar/ActLocalMedias;->p1:Lb7h;
    ...
    :pswitch_f
    invoke-direct/range {p0 .. p1}, Ls95;->a(Ljava/lang/Object;)V
    ...
    iput-boolean v15, v2, Lqx8;->j:Z

    iget-object v3, v2, Lqx8;->b:Lr06;

    invoke-virtual {v3}, Lr06;->play()V

    :goto_6
    iget-object v3, v1, Luza;->X:Lru/ok/messages/media/mediabar/FrgLocalVideo;

    if-eqz v3, :cond_11

    invoke-virtual {v3, v15}, Lru/ok/messages/media/mediabar/FrgLocalVideo;->u0(Z)V
    ...
    invoke-virtual {v2}, Lqx8;->f()V

    iget-object v1, v1, Luza;->X:Lru/ok/messages/media/mediabar/FrgLocalVideo;

    if-eqz v1, :cond_13

    invoke-virtual {v1, v15}, Lru/ok/messages/media/mediabar/FrgLocalVideo;->u0(Z)V
    ...
    iput-boolean v14, v1, Lgoi;->b:Z

    iput-boolean v14, v1, Lgoi;->c:Z

    iput-boolean v15, v1, Lgoi;->a:Z
    ...
    iput-boolean v15, v1, Lgoi;->d:Z

    iput-object v10, v1, Lgoi;->h:Lrei;

    iput-boolean v15, v1, Lgoi;->i:Z
    ...
    invoke-virtual {v1, v9, v10}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v10, v14}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v8, v0}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v10, v0}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v14, v10}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v11, v10}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_22
    sget-object v10, Landroidx/camera/camera2/internal/compat/quirk/ExtraSupportedSurfaceCombinationsQuirk;->a:Li3h;
    ...
    invoke-virtual {v1, v6, v0}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v0, v6}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v10, v6}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v5, v4}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v4, v0}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v0, v14}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_40
    invoke-direct {v2, v3}, Lp8c;-><init>(Ljava/util/List;)V

    sput-object v2, Lw95;->a:Lp8c;
    ...
    invoke-static {v1}, Lp8c;->m(Lp8c;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v4, v3}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v3, v14}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_47
    invoke-direct {v1, v2}, Lp8c;-><init>(Ljava/util/List;)V

    sput-object v1, Lv95;->a:Lp8c;
    ...
    invoke-virtual {v0, v9, v10}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v1, v6}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v11, v7}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v13, v2}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v1}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v1, v14}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-direct {v0, v8}, Lp8c;-><init>(Ljava/util/List;)V

    sput-object v0, Lu95;->a:Lp8c;
    ...
    invoke-virtual {v0, v9, v8}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v8, v9}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v12, v10}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v10, v2}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v14}, Lfxd;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_95
    invoke-direct {v4, v5}, Lp8c;-><init>(Ljava/util/List;)V

    sput-object v4, Lt95;->a:Lp8c;
    ...
    invoke-static {v2}, Lp8c;->m(Lp8c;)Ljava/lang/String;
