...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lgza;->t:J

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lbza;Lehe;ILew6;Z)V
    .locals 0
    ...
    iput-object p2, p0, Lgza;->b:Lbza;

    iput-object p3, p0, Lgza;->c:Lehe;
    ...
    iput-object p5, p0, Lgza;->e:Lew6;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lgza;->d:Landroid/util/SparseArray;
    ...
    iput-wide p1, p0, Lgza;->q:J

    const-wide p1, 0x7fffffffffffffffL

    iput-wide p1, p0, Lgza;->k:J

    return-void
.end method

.method public static c(Landroid/util/SparseArray;)Lfza;
    .locals 7
    ...
    iget-wide v3, v2, Lfza;->f:J

    iget-wide v5, v0, Lfza;->f:J
...
.method public final a(Lew6;)V
    ...
    invoke-static {v0, v5}, Lg0i;->l(Ljava/lang/Object;Z)V
    ...
    iget-object v0, p0, Lgza;->e:Lew6;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v5, "video/avc"

    invoke-virtual {p1, v0}, Lew6;->c(Lew6;)Z

    move-result v6

    iget-object v7, p1, Lew6;->q:Ljava/util/List;

    iget-object v8, v0, Lew6;->q:Ljava/util/List;
    ...
    iput-object v7, p1, Lcw6;->p:Ljava/util/List;
    ...
    iget-object v0, p0, Lgza;->d:Landroid/util/SparseArray;

    invoke-static {v0, v3}, Lrai;->k(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v0, v4}, Lrai;->k(Landroid/util/SparseArray;I)Z
    ...
    invoke-virtual {v0, p1}, Lew6;->c(Lew6;)Z
    ...
    invoke-static {v5, v3}, Lg0i;->u(Ljava/lang/Object;Z)V

    iget-object v3, p0, Lgza;->d:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, Lgza;->m:Leza;

    if-nez v3, :cond_1f

    iget-object v3, p0, Lgza;->b:Lbza;

    iget-object v5, p0, Lgza;->a:Ljava/lang/String;

    invoke-interface {v3, v5}, Lbza;->f(Ljava/lang/String;)Leza;

    move-result-object v3

    iput-object v3, p0, Lgza;->m:Leza;

    :cond_1f
    new-instance v3, Lfza;

    iget-object v5, p0, Lgza;->m:Leza;

    invoke-interface {v5, p1}, Leza;->u0(Lew6;)I

    move-result v5

    invoke-direct {v3, v5, p1}, Lfza;-><init>(ILew6;)V

    iget-object v5, p0, Lgza;->d:Landroid/util/SparseArray;

    invoke-virtual {v5, v1, v3}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-static {v1}, Lrai;->I(I)Ljava/lang/String;
    ...
    invoke-interface {v3, v1}, Leza;->k(Lzma;)V
    ...
    :cond_20
    iget-object p1, p0, Lgza;->d:Landroid/util/SparseArray;
...
.method public final d(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lgza;->b:Lbza;

    invoke-interface {v1, v0}, Lbza;->c(I)Ldoe;

    move-result-object v0

    invoke-virtual {v0, p1}, Lvw7;->contains(Ljava/lang/Object;)Z
...
.method public final e(ILjava/nio/ByteBuffer;ZJ)Z
    ...
    iget-object v1, p0, Lgza;->d:Landroid/util/SparseArray;

    iget-boolean v2, p0, Lgza;->g:Z
    ...
    iget-wide v5, v2, Lfza;->f:J

    sub-long v5, p4, v5

    sget-wide v7, Lgza;->t:J

    cmp-long v2, v5, v7

    if-lez v2, :cond_3

    invoke-static {v1}, Lgza;->c(Landroid/util/SparseArray;)Lfza;

    move-result-object v2

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, v2, Lfza;->a:Lew6;
    ...
    iget-wide v1, v1, Lfza;->f:J

    iput-wide v1, p0, Lgza;->j:J

    :cond_4
    iget-wide v1, p0, Lgza;->j:J
    ...
    :goto_1
    invoke-static {p1}, Lrai;->I(I)Ljava/lang/String;
    ...
    iget-wide v7, p0, Lgza;->q:J

    cmp-long v7, v7, v5

    if-nez v7, :cond_5

    iput-wide p4, p0, Lgza;->q:J
    ...
    invoke-static {v1, v4}, Lrai;->k(Landroid/util/SparseArray;I)Z

    move-result v1

    if-eqz v1, :cond_9

    iget-boolean v1, p0, Lgza;->f:Z
    ...
    invoke-static {p4, p5}, Lfk8;->S(Ljava/lang/String;Ljava/lang/String;)V

    move-wide p4, v7

    :cond_9
    iput-wide p4, v0, Lfza;->c:J
    ...
    iput-wide v1, v0, Lfza;->d:J

    iget-wide v1, v0, Lfza;->f:J

    invoke-static {v1, v2, p4, p5}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v1

    iput-wide v1, v0, Lfza;->f:J

    iget-object v1, p0, Lgza;->c:Lehe;

    iget-object v1, v1, Lehe;->b:Ljava/lang/Object;

    check-cast v1, Lash;

    iget-object v2, v1, Lash;->y:Lj0h;

    if-eqz v2, :cond_b

    iget-object v1, v2, Lj0h;->d:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lj0h;->c:Ljava/lang/Object;

    check-cast v1, Ljava/util/concurrent/ScheduledExecutorService;

    iget-object v3, v2, Lj0h;->b:Ljava/lang/Object;
    ...
    invoke-direct {v5, v3, v6}, Lkvh;-><init>(Ljava/lang/Object;I)V

    iget-wide v6, v2, Lj0h;->a:J
    ...
    iput-object v1, v2, Lj0h;->d:Ljava/lang/Object;

    goto :goto_3

    :cond_b
    iget-wide v1, v1, Lash;->e:J
    ...
    invoke-direct {v1, v2, p3, p4, p5}, Lx01;-><init>(IIJ)V

    iget-object p3, p0, Lgza;->m:Leza;

    iget p4, v0, Lfza;->b:I

    invoke-interface {p3, p4, p2, v1}, Leza;->X(ILjava/nio/ByteBuffer;Lx01;)V
