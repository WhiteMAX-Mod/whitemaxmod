...
.field public final d:Lo99;

.field public final o:Ljava/util/LinkedHashSet;

.field public v0:Lm99;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/material/button/MaterialButton;->J0:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v3, Lhyd;->materialButtonStyle:I

    sget v4, Lcom/google/android/material/button/MaterialButton;->J0:I
    ...
    sget-object v2, Lj9e;->MaterialButton:[I
    ...
    sget v2, Lj9e;->MaterialButton_iconPadding:I
    ...
    sget v2, Lj9e;->MaterialButton_iconTintMode:I
    ...
    invoke-static {v2, v6}, Lgce;->F(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButton;->w0:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    sget v7, Lj9e;->MaterialButton_iconTint:I

    invoke-static {v2, p2, v7}, Lgce;->n(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButton;->x0:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    sget v7, Lj9e;->MaterialButton_icon:I

    invoke-static {v2, p2, v7}, Lgce;->u(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButton;->y0:Landroid/graphics/drawable/Drawable;

    sget v2, Lj9e;->MaterialButton_iconGravity:I
    ...
    iput v2, p0, Lcom/google/android/material/button/MaterialButton;->G0:I

    sget v2, Lj9e;->MaterialButton_iconSize:I
    ...
    invoke-static {v0, v1, v3, v4}, Lc2g;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lqz7;
    ...
    invoke-direct {v1, p0, v0}, Lo99;-><init>(Lcom/google/android/material/button/MaterialButton;Lc2g;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lo99;
    ...
    iget-object v2, v1, Lo99;->b:Lc2g;

    int-to-float v0, v0

    invoke-virtual {v2, v0}, Lc2g;->h(F)Lc2g;

    move-result-object v0

    invoke-virtual {v1, v0}, Lo99;->c(Lc2g;)V

    iput-boolean v7, v1, Lo99;->p:Z
    ...
    invoke-static {v0, v6}, Lgce;->F(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, Lo99;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Lj9e;->MaterialButton_backgroundTint:I
    ...
    iput-object v0, v1, Lo99;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Lj9e;->MaterialButton_strokeColor:I

    invoke-static {v0, p2, v2}, Lgce;->n(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lo99;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Lj9e;->MaterialButton_rippleColor:I

    invoke-static {v0, p2, v2}, Lgce;->n(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lo99;->l:Landroid/content/res/ColorStateList;
    ...
    sget v5, Lj9e;->MaterialButton_android_background:I
    ...
    iput-boolean v7, v1, Lo99;->o:Z

    iget-object v5, v1, Lo99;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, Lo99;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final b()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lo99;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lo99;->o:Z
...
.method public final e(Z)V
    ...
    iget v4, p0, Lcom/google/android/material/button/MaterialButton;->G0:I
...
.method public final f(II)V
    ...
    :cond_4
    :goto_0
    iput v5, p0, Lcom/google/android/material/button/MaterialButton;->B0:I

    if-ne v0, p1, :cond_5

    iput v5, p0, Lcom/google/android/material/button/MaterialButton;->C0:I
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lo99;->l:Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lo99;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lo99;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lo99;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final isChecked()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/material/button/MaterialButton;->E0:Z
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lo99;->b(Z)Lba9;
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lba9;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lo99;

    iput-boolean v0, v1, Lo99;->o:Z

    iget-object v0, v1, Lo99;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v1, Lo99;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lo99;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setChecked(Z)V
    ...
    iget-boolean v1, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup;->v0:Z
    ...
    :cond_1
    :goto_0
    iget-boolean p1, p0, Lcom/google/android/material/button/MaterialButton;->F0:Z
...
.method public setCornerRadius(I)V
    ...
    iput-boolean v1, v0, Lo99;->p:Z

    iget-object v1, v0, Lo99;->b:Lc2g;

    int-to-float p1, p1

    invoke-virtual {v1, p1}, Lc2g;->h(F)Lc2g;

    move-result-object p1

    invoke-virtual {v0, p1}, Lo99;->c(Lc2g;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lo99;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {v0, p1, v1}, Lo99;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lm99;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->v0:Lm99;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->v0:Lm99;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lo99;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lo99;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p1, :cond_0

    iput-object p1, v0, Lo99;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1}, Lzve;->c(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lo99;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lo99;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lo99;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lo99;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lo99;->b(Z)Lba9;
    ...
    invoke-virtual {p1, v0}, Lba9;->setTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lo99;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lo99;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p1, v0}, Lba9;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
