...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lgti;-><init>(I)V
...
.method public static K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;IIZ)V
    .locals 7
    ...
    invoke-virtual {p1, p2}, Ldq;->g(Landroid/view/View;)Z

    move-result v3

    :cond_4
    invoke-virtual {p1, v3}, Ldq;->f(Z)Z
    ...
    iget-object p0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lrlb;

    iget-object p0, p0, Lrlb;->c:Ljava/lang/Object;

    check-cast p0, Lzag;

    invoke-virtual {p0, p1}, Lzag;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;II[II)V
    .locals 6
    ...
    invoke-virtual {p2}, Ldq;->getTotalScrollRange()I

    move-result p4

    neg-int p4, p4

    invoke-virtual {p2}, Ldq;->getDownNestedPreScrollRange()I
    ...
    :cond_0
    invoke-virtual {p2}, Ldq;->getUpNestedPreScrollRange()I
    ...
    :goto_2
    iget-boolean p1, v2, Ldq;->B0:Z

    if-eqz p1, :cond_2

    invoke-virtual {v2, p3}, Ldq;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {v2, p1}, Ldq;->f(Z)Z

    :cond_2
    return-void
.end method

.method public C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;IIIII[I)V
    .locals 6

    if-gez p7, :cond_0

    invoke-virtual {p2}, Ldq;->getDownNestedScrollRange()I
    ...
    invoke-static {v1}, Lfsi;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p1, p0, v2, v1}, Lyp;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ldq;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, p1}, Lfsi;->m(Landroid/view/View;La5;)V
...
.method public D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;Landroid/view/View;II)Z
    .locals 0
...
.method public E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;I)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;)V

    iget-boolean p1, p2, Ldq;->B0:Z

    if-eqz p1, :cond_1

    invoke-virtual {p2, p3}, Ldq;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p2, p1}, Ldq;->f(Z)Z
...
.method public final F(Lzp;Z)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzp;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzp;

    return-void
.end method

.method public final G(Landroid/os/Parcelable;Ldq;)Lzp;
    .locals 7
    ...
    :cond_0
    invoke-direct {v1, p1}, Lh0;-><init>(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p2}, Ldq;->getTopInset()I
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, Lg0i;->A(III)I

    move-result v2

    if-eq v4, v2, :cond_d

    iget-boolean v6, v3, Ldq;->o:Z
    ...
    iget-object v11, v10, Lbq;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v3}, Ldq;->getTopInset()I
    ...
    :goto_2
    invoke-virtual {v0, v8}, Lgti;->v(I)Z
    ...
    iget-object v11, v10, Lbq;->b:Lvj9;

    if-eqz v11, :cond_7

    iget v10, v10, Lbq;->a:I
    ...
    invoke-virtual {v0}, Lgti;->t()I

    move-result v12

    int-to-float v12, v12

    iget-object v13, v11, Lvj9;->b:Ljava/lang/Object;

    check-cast v13, Landroid/graphics/Rect;

    iget-object v11, v11, Lvj9;->a:Ljava/lang/Object;
    ...
    invoke-static {v15, v12, v8}, Lg0i;->z(FFF)F
    ...
    iget-object v6, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lrlb;

    iget-object v6, v6, Lrlb;->c:Ljava/lang/Object;

    check-cast v6, Lzag;

    invoke-virtual {v6, v3}, Lzag;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v1, v9, v3}, Ldk4;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v6}, Ldq;->d(I)V
    ...
    :goto_7
    invoke-static {v1, v3, v2, v8, v5}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;IIZ)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lyp;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ldq;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, v2}, Lfsi;->m(Landroid/view/View;La5;)V
...
.method public final J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;)V
    .locals 12
    ...
    invoke-static {v8, v0, v3}, Lg0i;->A(III)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;I)V
...
.method public final h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-super {p0, p1, p2, p3}, Lgti;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z

    invoke-virtual {p2}, Ldq;->getPendingAction()I
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzp;

    iget-boolean v3, v3, Lzp;->Y:Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;I)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzp;
    ...
    invoke-static {p3, v0, v1}, Lg0i;->A(III)I

    move-result p3

    invoke-virtual {p0, p3}, Lgti;->v(I)Z

    invoke-virtual {p0}, Lgti;->t()I

    move-result p3

    invoke-static {p1, p2, p3, v1, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;IIZ)V

    invoke-virtual {p0}, Lgti;->t()I

    move-result p3

    invoke-virtual {p2, p3}, Ldq;->d(I)V
    ...
    invoke-direct {p3, p0, p2, p1}, Lyp;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ldq;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {p1, p3}, Lfsi;->m(Landroid/view/View;La5;)V
...
.method public bridge synthetic k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;II[II)V
...
.method public bridge synthetic l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual/range {p0 .. p9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;IIIII[I)V
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->F(Lzp;Z)V

    iget-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lzp;

    iget-object p1, p1, Lh0;->a:Landroid/os/Parcelable;
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->G(Landroid/os/Parcelable;Ldq;)Lzp;
...
.method public bridge synthetic q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;Landroid/view/View;II)Z
...
.method public bridge synthetic r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;Landroid/view/View;I)V
...
.method public final s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Ldq;->getDownNestedScrollRange()I

    move-result v3

    neg-int v3, v3

    invoke-virtual {v1}, Ldq;->getTopInset()I
    ...
    invoke-virtual {v9}, Ldq;->getTotalScrollRange()I

    move-result v10

    neg-int v10, v10

    iget-object v11, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lcc;

    if-eqz v11, :cond_5

    invoke-virtual {v4, v11}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v2, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lcc;
    ...
    invoke-direct {v5, v0, v1, v4}, Lcc;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V

    iput-object v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lcc;
    ...
    :cond_7
    invoke-virtual {v0, v1, v9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;)V

    iget-boolean v4, v9, Ldq;->B0:Z
    ...
    invoke-virtual {v9, v1}, Ldq;->g(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v9, v1}, Ldq;->f(Z)Z
...
.method public final y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ldq;I)V
    .locals 5
    ...
    invoke-direct {v3, p0, p1, p2, v4}, Lxp;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/view/View;I)V
