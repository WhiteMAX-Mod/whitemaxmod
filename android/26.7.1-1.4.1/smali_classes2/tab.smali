...
.method public final b(Lvqh;)V
    ...
    iget-object v2, v1, Lvqh;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Llbb;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Ltab;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Lsab;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Ltab;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Ltab;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lrab;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Llbb;->d:Z

    if-eqz v1, :cond_8

    iget-object v1, v0, Llbb;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, Lsab;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lsab;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
