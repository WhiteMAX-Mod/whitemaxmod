...
.method public synthetic constructor <init>(Ljava/lang/Object;III)V
    ...
    iput-object p1, p0, Lt01;->d:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v0, p0, Lt01;->d:Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v2}, Lmhi;->l(II)V
    ...
    invoke-virtual {v0, v1, v2}, Lk07;->a(II)V
    ...
    iget-boolean v3, v0, Lk07;->v0:Z

    if-eqz v3, :cond_4

    iget-boolean v3, v0, Lk07;->w0:Z

    if-eqz v3, :cond_4

    iget-object v3, v0, Lk07;->X:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    invoke-interface {v0, v1, v3, v2}, Lgae;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_5
    iget-object v5, v0, Lv01;->i:Lxh6;

    iget v6, v0, Lv01;->e:I

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4, v6}, Lexe;->X(II)Ly58;
    ...
    invoke-virtual {v8}, Lx58;->nextInt()I

    move-result v8

    add-int/2addr v8, v3

    invoke-virtual {v5, v8}, Lxh6;->e(I)I
    ...
    iget-object v8, v0, Lv01;->l:Ljava/util/Set;
    ...
    iget-object v7, v0, Lv01;->f:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v7}, Ljava/util/concurrent/ConcurrentHashMap;->keySet()Ljava/util/Set;

    move-result-object v7

    invoke-static {v7, v5}, Lqsf;->D(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    iget-object v10, v0, Lv01;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v12, v10, Lu01;->a:Lmy4;

    invoke-virtual {v12}, Ldp3;->F()Ldp3;
    ...
    iget-object v12, v0, Lv01;->a:Lzwc;

    invoke-virtual {v12}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v13, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v12, v1, v2, v13}, Lzwc;->c(IILandroid/graphics/Bitmap$Config;)Ldp3;
    ...
    invoke-direct {v10, v13}, Lu01;-><init>(Lmy4;)V

    invoke-virtual {v12}, Ldp3;->l()Ldp3;

    move-result-object v12

    :goto_8
    iput-boolean v9, v10, Lu01;->b:Z

    :try_start_1
    invoke-virtual {v0, v8, v12}, Lv01;->f(ILdp3;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-interface {v12}, Ljava/io/Closeable;->close()V

    iget-object v9, v0, Lv01;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v12, v0}, Ly17;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v4, v1}, Lexe;->m(III)I
