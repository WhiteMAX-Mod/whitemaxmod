...
.method public static a(Ljv7;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->g(Ljv7;)Z
    ...
    invoke-static {v1, p0}, Li89;->b(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p0}, Ljv7;->getWidth()I

    move-result v10

    invoke-interface {p0}, Ljv7;->getHeight()I

    move-result v11

    invoke-interface {p0}, Ljv7;->v()[Lyye;
    ...
    invoke-virtual {p0}, Lyye;->t()Ljava/nio/ByteBuffer;
...
.method public static b(Lgf9;[B)Ljv7;
    .locals 2

    invoke-virtual {p0}, Lgf9;->e()I
    ...
    invoke-virtual {p0}, Lgf9;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p0}, Li89;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static c(Ljv7;)Landroid/graphics/Bitmap;
    .locals 14

    invoke-interface {p0}, Ljv7;->getFormat()I
    ...
    invoke-virtual {v1}, Lyye;->t()Ljava/nio/ByteBuffer;
...
.method public static d(Ljv7;Llv7;Ljava/nio/ByteBuffer;IZ)Let7;
    .locals 21

    move/from16 v0, p3

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->g(Ljv7;)Z
    ...
    :cond_2
    :goto_0
    invoke-interface/range {p1 .. p1}, Llv7;->getSurface()Landroid/view/Surface;

    move-result-object v9

    invoke-interface/range {p0 .. p0}, Ljv7;->getWidth()I

    move-result v11

    invoke-interface/range {p0 .. p0}, Ljv7;->getHeight()I

    move-result v12

    invoke-interface/range {p0 .. p0}, Ljv7;->v()[Lyye;
    ...
    invoke-virtual {v3}, Lyye;->t()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v10}, Lyye;->t()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v6}, Lyye;->t()Ljava/nio/ByteBuffer;
    ...
    :cond_7
    invoke-interface/range {p1 .. p1}, Llv7;->d()Ljv7;
    ...
    invoke-direct {v0, v1}, Let7;-><init>(Ljv7;)V
    ...
    invoke-direct {v2, v1, v4, v3}, Liv7;-><init>(Ljv7;Ljv7;I)V

    invoke-virtual {v0, v2}, Ley6;->d(Ldy6;)V
...
.method public static h(Ljv7;Llv7;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Let7;
    .locals 25
    ...
    invoke-virtual {v11}, Lyye;->t()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v12}, Lyye;->t()Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v1, v0}, Let7;-><init>(Ljv7;)V
    ...
    invoke-direct {v2, v0, v4, v3}, Liv7;-><init>(Ljv7;Ljv7;I)V

    invoke-virtual {v1, v2}, Ley6;->d(Ldy6;)V
...
.method public static i([BLandroid/view/Surface;)V
    ...
    invoke-static {p0, p1}, Li89;->b(Ljava/lang/String;Ljava/lang/String;)V
