...
.field public D0:Lami;

.field public E0:Lbmi;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcmi;->d:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, Lcmi;->getBorderColor()I
    ...
    iput-object p1, p0, Lcmi;->o:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, Lcmi;->getCursorColor()I

    move-result v2

    invoke-virtual {p1, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object p1, p0, Lcmi;->x0:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, Lcmi;->getCursorBorderColor()I
    ...
    iput-object p1, p0, Lcmi;->y0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lcmi;->z0:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lcmi;->A0:Landroid/graphics/RectF;
    ...
    iput p1, p0, Lcmi;->B0:F

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcmi;->C0:Landroid/graphics/Path;
...
.method public final getFramesListBitmap()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcmi;->b:Landroid/graphics/Bitmap;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcmi;->a(II)I
    ...
    iget-object v4, p0, Lcmi;->C0:Landroid/graphics/Path;

    invoke-virtual {p1, v4}, Landroid/graphics/Canvas;->clipPath(Landroid/graphics/Path;)Z

    :try_start_0
    iget-object v4, p0, Lcmi;->b:Landroid/graphics/Bitmap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v5, p0, Lcmi;->d:Landroid/graphics/Paint;
    ...
    :cond_1
    :goto_0
    iget-object v4, p0, Lcmi;->F0:Landroid/graphics/Bitmap;
    ...
    iget v0, p0, Lcmi;->B0:F

    iget-object v1, p0, Lcmi;->o:Landroid/graphics/Paint;

    iget-object v3, p0, Lcmi;->A0:Landroid/graphics/RectF;
    ...
    iget v4, p0, Lcmi;->v0:F

    sub-float/2addr v0, v4

    invoke-static {v1, v4, v0}, Lexe;->l(FFF)F
    ...
    iget-object v1, p0, Lcmi;->y0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lcmi;->z0:Landroid/graphics/RectF;

    invoke-virtual {v3, v2, v5, v0, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object v0, p0, Lcmi;->x0:Landroid/graphics/Paint;

    iget v2, p0, Lcmi;->w0:F
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, p1, p2}, Lcmi;->a(II)I
    ...
    iget-object v0, p0, Lcmi;->D0:Lami;
    ...
    iput p4, v0, Lvmi;->w0:I

    iput p3, v0, Lvmi;->x0:I

    :cond_1
    iget-object p3, p0, Lcmi;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lcmi;->A0:Landroid/graphics/RectF;
    ...
    iget-object p1, p0, Lcmi;->C0:Landroid/graphics/Path;

    invoke-virtual {p1}, Landroid/graphics/Path;->reset()V

    iget-object p1, p0, Lcmi;->C0:Landroid/graphics/Path;

    iget-object p2, p0, Lcmi;->A0:Landroid/graphics/RectF;

    iget p3, p0, Lcmi;->B0:F
...
.method public final onThemeChanged(La6c;)V
    ...
    iget-object p1, p0, Lcmi;->o:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Lcmi;->x0:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Lcmi;->y0:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, Lcmi;->v0:F

    sub-float/2addr v1, v2

    invoke-static {v0, v2, v1}, Lexe;->l(FFF)F
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lcmi;->setProgress(F)V

    iget-object p1, p0, Lcmi;->E0:Lbmi;
    ...
    sget-object v2, Lone/me/chatscreen/videomsg/VideoMessageWidget;->L0:[Lki8;
    ...
    invoke-direct {v2, v0}, Ltii;-><init>(F)V
...
.method public final setFramesListBitmap(Landroid/graphics/Bitmap;)V
    ...
    iput-object p1, p0, Lcmi;->b:Landroid/graphics/Bitmap;

    return-void
.end method

.method public final setFramesProvider(Lami;)V
    .locals 0

    iput-object p1, p0, Lcmi;->D0:Lami;
...
.method public final setPreviewBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lcmi;->F0:Landroid/graphics/Bitmap;
    ...
    :cond_0
    iput-object p1, p0, Lcmi;->F0:Landroid/graphics/Bitmap;
...
.method public final setSeekListener(Lbmi;)V
    .locals 0

    iput-object p1, p0, Lcmi;->E0:Lbmi;
