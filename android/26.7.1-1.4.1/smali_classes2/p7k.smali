...
# direct methods
.method public static final a(Ltf8;Lgmf;)Ljava/lang/String;
    .locals 2

    invoke-interface {p1}, Lgmf;->getAnnotations()Ljava/util/List;
    ...
    instance-of v1, v0, Lzf8;

    if-eqz v1, :cond_0

    check-cast v0, Lzf8;

    invoke-interface {v0}, Lzf8;->discriminator()Ljava/lang/String;
    ...
    :cond_1
    iget-object p0, p0, Ltf8;->a:Lag8;

    iget-object p0, p0, Lag8;->f:Ljava/lang/String;
...
.method public static b([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1}, Lb06;-><init>(Ljava/io/InputStream;)V
    :try_end_0
    ...
    invoke-virtual {p0, v2, p1}, Lb06;->e(ILjava/lang/String;)I
