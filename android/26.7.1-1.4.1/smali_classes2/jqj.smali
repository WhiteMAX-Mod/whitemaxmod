...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Ljqj;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Ljqj;->U(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Lc5k;->f:Le7k;

    iget-object p1, p1, Le7k;->a:Llok;

    if-eqz p1, :cond_9

    iget-object p2, p3, Lc5k;->e:Lcdh;

    iget-object p4, p1, Llok;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Llok;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, p1, v3}, Lkhk;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1}, Llok;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Lc5k;->d:Lpd5;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lpd5;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lcsj;

    invoke-direct {p4, p1, p2}, Lcsj;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lc5k;->e:Lcdh;

    invoke-virtual {p1, p4}, Lcdh;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Ldlk;->f:Lcmk;

    iget-object p1, p1, Lcmk;->a:Lcsk;

    iget-object p2, p3, Ldlk;->e:Lcdh;

    invoke-virtual {p1, p2}, Lcsk;->d(Lcdh;)V

    iget-object p1, p3, Ldlk;->d:Lyua;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lyua;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lyua;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lcdh;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Ldlk;->g:Lcmk;
    ...
    iget-object p1, p1, Lcmk;->d:Ljok;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Ljok;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Ljok;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lht;-><init>(I)V

    invoke-virtual {p2, p1}, Lcdh;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Ljqj;->T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
