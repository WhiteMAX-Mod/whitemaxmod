...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqre;->m:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Ljava/lang/Long;Lyzg;Lxg8;)V
    .locals 2

    invoke-direct {p0}, Ltki;-><init>()V

    iput-object p1, p0, Lqre;->b:Ljava/lang/Long;

    iput-object p2, p0, Lqre;->c:Lyzg;
    ...
    iput-object v0, p0, Lqre;->d:Lj6g;

    new-instance v1, Lhzd;

    invoke-direct {v1, v0}, Lhzd;-><init>(Lloa;)V

    iput-object v1, p0, Lqre;->e:Lhzd;

    iput-object p3, p0, Lqre;->f:Lxg8;

    invoke-static {p1}, Lk6g;->a(Ljava/lang/Object;)Lj6g;

    move-result-object p3

    iput-object p3, p0, Lqre;->g:Lj6g;

    new-instance v0, Lhzd;

    invoke-direct {v0, p3}, Lhzd;-><init>(Lloa;)V

    iput-object v0, p0, Lqre;->h:Lhzd;

    sget-object p3, Lsoa;->a:Lkotlinx/coroutines/internal/Symbol;

    new-instance p3, Lroa;

    invoke-direct {p3}, Lroa;-><init>()V

    iput-object p3, p0, Lqre;->i:Lroa;

    sget-object p3, Lgr5;->a:Lgr5;

    iput-object p3, p0, Lqre;->j:Ljava/lang/Object;

    new-instance p3, Lbke;

    const/4 v0, 0x4

    invoke-direct {p3, v0, p0}, Lbke;-><init>(ILjava/lang/Object;)V

    new-instance v0, Ldxg;

    invoke-direct {v0, p3}, Ldxg;-><init>(Lpz6;)V

    iput-object v0, p0, Lqre;->k:Ldxg;
    ...
    invoke-direct {v0, p0, p1, v1}, Ldtc;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    const/4 v1, 0x2

    invoke-static {p3, p2, p1, v0, v1}, Llhe;->I(Lui4;Lki4;Lxi4;Lf07;I)Ll3g;

    new-instance p2, Lcx5;

    invoke-direct {p2, p1}, Lcx5;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Lqre;->l:Lcx5;

    return-void
.end method

.method public static final s(Lqre;)Ljava/util/ArrayList;
    .locals 23

    move-object/from16 v0, p0

    iget-object v1, v0, Lqre;->k:Ldxg;
    ...
    iget-object v1, v1, Ln57;->a:Ljava/lang/String;
    ...
    invoke-direct/range {v10 .. v17}, Les4;-><init>(JIIILjava/lang/String;Lu5h;)V
    ...
    invoke-direct/range {v14 .. v21}, Les4;-><init>(JIIILjava/lang/String;Lu5h;)V
    ...
    :cond_8
    iput-object v3, v0, Lqre;->j:Ljava/lang/Object;

    return-object v3
.end method

.method public static t(Lqre;Ljava/util/List;Les4;II)Llre;
    .locals 16
    ...
    iget v10, v0, Les4;->d:I

    if-ne v9, v10, :cond_0

    iget v9, v7, Les4;->c:I

    iget v10, v0, Les4;->c:I
    ...
    invoke-static {v10, v1, v2, v3}, Lqre;->u(Ljava/util/List;IILjava/util/Calendar;)Llre;
    ...
    invoke-static {v1, v5, v0}, Lbt4;->o(III)I

    move-result v1

    invoke-static {v5}, Laak;->b(I)Ljava/util/ArrayList;

    move-result-object v4

    add-int/lit8 v6, v0, 0x1

    invoke-static {v4, v6}, Lwm3;->E1(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    :goto_6
    invoke-static {v2, v5, v0}, Lbt4;->o(III)I

    move-result v1

    invoke-static {v5}, Laak;->c(I)Ljava/util/ArrayList;

    move-result-object v2

    add-int/lit8 v0, v0, 0x1

    invoke-static {v2, v0}, Lwm3;->E1(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-direct/range {v9 .. v15}, Llre;-><init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;III)V
    ...
    invoke-static {v11}, Lxm3;->I0(Ljava/util/List;)I
...
.method public static u(Ljava/util/List;IILjava/util/Calendar;)Llre;
    .locals 11
    ...
    invoke-static {p1, v3, v1}, Lbt4;->o(III)I
    ...
    invoke-static {v0}, Laak;->b(I)Ljava/util/ArrayList;
    ...
    invoke-static {p2, v3, v1}, Lbt4;->o(III)I
    ...
    :cond_5
    invoke-static {p3}, Laak;->c(I)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v4 .. v10}, Llre;-><init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;III)V
...
.method public final v()V
    ...
    :cond_0
    iget-object v1, p0, Lqre;->j:Ljava/lang/Object;

    iget-object v2, v0, Lrr4;->a:Les4;

    iget-object v3, v0, Lrr4;->b:Lk9h;
    ...
    invoke-static {p0, v1, v2, v3, v0}, Lqre;->t(Lqre;Ljava/util/List;Les4;II)Llre;

    move-result-object v0

    invoke-virtual {p0, v0}, Lqre;->w(Llre;)V

    return-void
.end method

.method public final w(Llre;)V
    .locals 5
    ...
    iget-object v2, p1, Llre;->a:Ljava/util/List;
    ...
    iget-object v3, p1, Llre;->b:Ljava/util/List;
    ...
    iget-object v4, p1, Llre;->c:Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3, p1}, Lrr4;-><init>(Les4;Lk9h;Lk9h;)V

    iget-object p1, p0, Lqre;->g:Lj6g;
