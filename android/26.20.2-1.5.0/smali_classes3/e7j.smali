...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Le7j;->a:Lo;

    new-instance v1, Ld7j;

    invoke-direct {v1, p1}, Ld7j;-><init>(Landroid/content/Context;)V
...
.method public final a(Lo8g;I)V
    ...
    :cond_0
    iget-object v0, p1, Lo8g;->f:Ljava/lang/String;

    iget-object v1, p0, Le7j;->a:Lo;

    const/4 v2, 0x1

    iget-object v3, p0, Le7j;->b:Ld7j;
    ...
    :cond_1
    new-instance v5, Lq1j;

    const/4 v6, 0x2

    invoke-direct {v5, v6, p0}, Lq1j;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v3, v5}, Ld7j;->setOnFirstFrameListener(Lc7j;)V

    invoke-virtual {v3, v4}, Landroid/view/View;->setVisibility(I)V

    iput-boolean v2, p0, Le7j;->c:Z
    ...
    :cond_2
    iget-object v5, v3, Ld7j;->a:Ljava/lang/String;
    ...
    :cond_3
    iput-boolean v2, v3, Ld7j;->b:Z

    iput-object v0, v3, Ld7j;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, p2}, Ld7j;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :goto_1
    iput-boolean v4, p0, Le7j;->c:Z

    if-eqz p2, :cond_4

    iget-boolean p2, p0, Le7j;->d:Z
