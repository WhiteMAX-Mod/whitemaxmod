...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1, p0, v2}, Lilb;-><init>(Landroid/content/Context;Lklb;I)V
    ...
    iput-object v1, p0, Lklb;->v:Ljava/lang/Object;

    new-instance v1, Lilb;

    const/4 v4, 0x1

    invoke-direct {v1, p1, p0, v4}, Lilb;-><init>(Landroid/content/Context;Lklb;I)V

    invoke-static {v3, v1}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object v1

    iput-object v1, p0, Lklb;->w:Ljava/lang/Object;

    new-instance v1, Lyeb;

    invoke-direct {v1, p1, v3}, Lyeb;-><init>(Landroid/content/Context;I)V

    invoke-static {v3, v1}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object v1

    iput-object v1, p0, Lklb;->x:Ljava/lang/Object;

    new-instance v1, Lilb;

    const/4 v5, 0x2

    invoke-direct {v1, p1, p0, v5}, Lilb;-><init>(Landroid/content/Context;Lklb;I)V

    invoke-static {v3, v1}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object v1

    iput-object v1, p0, Lklb;->y:Ljava/lang/Object;
    ...
    invoke-static {v1, v6, v7}, Lhvk;->b(Landroid/graphics/drawable/GradientDrawable;[I[F)V
    ...
    iput-object v1, p0, Lklb;->z:Landroid/graphics/drawable/LayerDrawable;

    new-instance v1, Lilb;

    invoke-direct {v1, p1, p0, v3}, Lilb;-><init>(Landroid/content/Context;Lklb;I)V

    invoke-static {v3, v1}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object v1

    iput-object v1, p0, Lklb;->A:Ljava/lang/Object;
    ...
    invoke-direct {v5, v4, v4}, Lw44;-><init>(II)V
    ...
    iput-object v1, p0, Lklb;->B:Landroid/view/View;
    ...
    invoke-direct {v6, v7}, Lycb;-><init>(I)V

    invoke-direct {v5, p1, v6}, Lrn7;-><init>(Landroid/content/Context;Lrz6;)V
    ...
    invoke-direct {v6, v2, v9}, Lw44;-><init>(II)V
    ...
    invoke-virtual {v5, v2}, Lrn7;->setInitialRadius$common_release(F)V

    iput-object v5, p0, Lklb;->C:Lrn7;
    ...
    iput-object v2, p0, Lklb;->D:Landroid/graphics/drawable/GradientDrawable;

    new-instance v6, Lyeb;

    invoke-direct {v6, p1, v7}, Lyeb;-><init>(Landroid/content/Context;I)V

    invoke-static {v3, v6}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object v6

    iput-object v6, p0, Lklb;->E:Ljava/lang/Object;

    new-instance v6, Lilb;

    invoke-direct {v6, p0, p1}, Lilb;-><init>(Lklb;Landroid/content/Context;)V

    invoke-static {v3, v6}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object v3

    iput-object v3, p0, Lklb;->F:Ljava/lang/Object;

    sget-object v3, Ljlb;->a:Ljlb;

    iput-object v3, p0, Lklb;->G:Ljlb;
    ...
    :goto_0
    invoke-virtual {p0, v3}, Lklb;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {p0, v2}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    invoke-static {p0, v1, v0}, Llhe;->e(Landroid/view/ViewGroup;Landroid/view/View;Ljava/lang/Integer;)V

    invoke-static {p0, v5, v0}, Llhe;->e(Landroid/view/ViewGroup;Landroid/view/View;Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1}, Lklb;->onThemeChanged(Lzub;)V
...
.method private final getChevronDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lklb;->F:Ljava/lang/Object;
...
.method private final getCloseBadgeDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    iget-object v0, p0, Lklb;->E:Ljava/lang/Object;
...
.method public static u(Lklb;Landroid/content/Context;)Landroid/widget/ImageView;
    .locals 4
    ...
    invoke-direct {p0}, Lklb;->getCloseBadgeDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, Lklb;->getChevronDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iget-object v1, p0, Lklb;->w:Ljava/lang/Object;
    ...
    :cond_3
    iget-object v1, p0, Lklb;->v:Ljava/lang/Object;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-object v0, p0, Lklb;->v:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Lklb;->w:Ljava/lang/Object;
...
.method public final setChevronAppearance(Ljlb;)V
    .locals 0

    iput-object p1, p0, Lklb;->G:Ljlb;
...
.method public final v(Landroid/graphics/drawable/Drawable;II)V
    ...
    iget-object p2, p0, Lklb;->C:Lrn7;

    iget-object p3, p0, Lklb;->A:Ljava/lang/Object;

    iget-object v0, p0, Lklb;->x:Ljava/lang/Object;
    ...
    invoke-virtual {p2, v1}, Lrn7;->setIcon$common_release(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p2, p1}, Lrn7;->setIcon$common_release(Landroid/graphics/drawable/Drawable;)V

    invoke-static {p0, p3, v1}, Llhe;->e(Landroid/view/ViewGroup;Landroid/view/View;Ljava/lang/Integer;)V

    invoke-static {p0, v0, v1}, Llhe;->e(Landroid/view/ViewGroup;Landroid/view/View;Ljava/lang/Integer;)V
...
.method public final w()V
    ...
    iget-object v4, p0, Lklb;->w:Ljava/lang/Object;

    const/4 v5, -0x1

    iget-object v6, p0, Lklb;->A:Ljava/lang/Object;
...
.method public final x()V
    ...
    iget-object v2, p0, Lklb;->A:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lklb;->B:Landroid/view/View;
