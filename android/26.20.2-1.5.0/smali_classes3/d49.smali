...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;Le6g;ZLb99;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ld49;->a:Landroid/widget/EditText;

    iput-object p2, p0, Ld49;->b:Le6g;

    iput-boolean p3, p0, Ld49;->c:Z

    iput-object p4, p0, Ld49;->d:Lb99;

    iput-boolean p5, p0, Ld49;->e:Z

    new-instance p1, Llna;

    invoke-direct {p1}, Llna;-><init>()V

    iput-object p1, p0, Ld49;->f:Llna;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-direct {p1}, Luv0;-><init>()V

    invoke-static {p2, p3, p4, v1, p1}, Llhe;->P(Landroid/text/Editable;IIZLe49;)V

    return-void

    :cond_0
    sget v0, Llpd;->markdown_italic:I

    if-ne p1, v0, :cond_1

    new-instance p1, Lf68;

    invoke-direct {p1}, Lf68;-><init>()V
    ...
    :cond_1
    sget v0, Llpd;->markdown_underline:I
    ...
    invoke-direct {p1, v2}, Ling;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Llhe;->P(Landroid/text/Editable;IIZLe49;)V

    return-void

    :cond_2
    sget v0, Llpd;->markdown_mono:I
    ...
    :cond_3
    sget v0, Llpd;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Ling;

    invoke-direct {p1, v1}, Ling;-><init>(I)V
    ...
    :cond_4
    sget v0, Llpd;->markdown_heading:I

    if-ne p1, v0, :cond_5

    new-instance p1, Lne7;

    invoke-direct {p1}, Lne7;-><init>()V
    ...
    :cond_5
    sget v0, Llpd;->markdown_quote:I

    sget-object v3, Lzqh;->a:Lzqh;

    iget-object v4, p0, Ld49;->a:Landroid/widget/EditText;
    ...
    sget v0, Lopd;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Ld49;->b()Lpjd;

    move-result-object p4

    new-instance v0, Lqjd;

    invoke-direct {v0, p4}, Lqjd;-><init>(Lpjd;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Liof;->F0(Landroid/text/Spannable;Le49;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Llhe;->Q(Landroid/text/Spannable;Le49;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Lopd;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Lj8k;->b(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Lopd;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Llpd;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Llhe;->Q(Landroid/text/Spannable;Le49;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Llhe;->K(Landroid/text/Spannable;II)V
...
.method public final b()Lpjd;
    .locals 21

    move-object/from16 v0, p0

    iget-object v1, v0, Ld49;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Ln9b;->y(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v19}, Lpjd;-><init>(Landroid/content/Context;Le6g;Lnub;Lb6h;Landroid/graphics/drawable/Drawable;IIIIIIIIIIFZ)V
    ...
    invoke-direct {v1, v4, v3}, Lojd;-><init>(ILjava/lang/Object;)V

    iput-object v1, v2, Lpjd;->f:Lojd;
...
.method public final c()Z
    ...
    iget-object v0, p0, Ld49;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Ldn8;->c:Ljava/lang/String;

    iget-object v0, v2, Lb99;->a:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->I:[Lre8;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lxg8;
    ...
    invoke-direct {v1, p2, p3, p1}, Lxa;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Lb99;->a:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lxg8;
    ...
    iget-object p1, p1, Lf49;->c:Lcx5;

    new-instance v0, Lxa;

    invoke-direct {v0, p2, p3, v1}, Lxa;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Ld49;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Llpd;->markdown_italic:I
    ...
    :cond_4
    sget v5, Llpd;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Llpd;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Ld49;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Llpd;->markdown_heading:I
    ...
    :cond_8
    sget v5, Llpd;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Ld49;->f:Llna;

    invoke-virtual {p1}, Llna;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Llna;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Llna;->a(I)V

    invoke-virtual {p0}, Ld49;->c()Z

    move-result v0

    sget-object v1, Lc49;->c:Lkuk;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v1, Lc49;->d:Ljava/util/LinkedHashSet;
    ...
    :cond_1
    sget v4, Llpd;->markdown_link:I

    if-ne v3, v4, :cond_2

    iget-boolean v4, p0, Ld49;->e:Z
    ...
    invoke-virtual {p1, v3}, Llna;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Lc49;->e:Lc49;

    iget v2, v1, Lc49;->a:I

    iget-object v3, p0, Ld49;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Llna;->a(I)V

    :goto_2
    iget-boolean p1, p0, Ld49;->e:Z

    if-nez p1, :cond_5

    sget p1, Llpd;->markdown_link:I
    ...
    invoke-direct {p1, v1, p2}, Lgv;-><init>(ILjava/lang/Object;)V
