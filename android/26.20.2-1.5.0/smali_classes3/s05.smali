...
# static fields
.field public static final j:[Lqhi;
...
.method static constructor <clinit>()V
    ...
    filled-new-array {v0, v1}, [Lqhi;

    move-result-object v0

    sput-object v0, Ls05;->j:[Lqhi;
...
.method public constructor <init>(Lxag;Lyud;Lp7c;Lgdj;)V
    ...
    iput-object p1, p0, Ls05;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Ls05;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Ls05;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Ls05;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Leo1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Ls05;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, p2}, Lvgi;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v2, p0}, Lq54;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Lsvj;-><init>(Lc8c;Lt54;I)V
...
.method public final e(Leo1;Ljava/lang/String;)V
    ...
    iput-object p1, v2, Lqcc;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lqcc;->B()Lyy1;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Ls05;->n(Ljava/lang/String;Lyy1;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Ls05;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lvgi;->a:Lorg/webrtc/VideoSink;
...
.method public final n(Ljava/lang/String;Lyy1;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lq05;-><init>(Ls05;Ljava/lang/String;Lyy1;Ljava/util/List;)V
    ...
    invoke-direct {p2, p1, v1, p3}, Lsvj;-><init>(Lc8c;Lt54;I)V
...
.method public final p(Ljava/lang/String;Lyy1;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Ls05;->g:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v1, p0, Ls05;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v1, v4, v0}, Lyud;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, v1, Lvgi;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Ls05;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Ls05;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Ls05;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Ls05;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Ls05;->f:Ljava/util/concurrent/ConcurrentHashMap;
