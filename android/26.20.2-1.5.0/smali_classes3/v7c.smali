.class public final synthetic Lv7c;
...
.method public final run()V
    ...
    iget-object v0, p0, Lv7c;->b:Lc8c;

    invoke-virtual {v0}, Lc8c;->r()V
    ...
    iget-object v1, v0, Lc8c;->h:Lul;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lul;->d()V

    iget-object v2, v1, Lul;->a:Lfk;

    iget-boolean v3, v2, Lfk;->i:Z
    ...
    :cond_0
    iget-object v2, v2, Lfk;->g:Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-virtual {v2, v1}, Ljava/util/concurrent/CopyOnWriteArraySet;->remove(Ljava/lang/Object;)Z

    :cond_1
    :goto_0
    iget-object v1, v0, Lc8c;->j:Lbl;

    if-eqz v1, :cond_3

    iget-object v2, v1, Lbl;->c:Leq4;

    if-eqz v2, :cond_2

    invoke-virtual {v2, v1}, Leq4;->c(Lple;)V

    :cond_2
    const/4 v2, 0x0

    iput-object v2, v1, Lbl;->c:Leq4;
    ...
    iget-object v0, v0, Lc8c;->J:Ljava/lang/Object;

    if-eqz v0, :cond_4

    invoke-interface {v0}, Lb8c;->o()V
    ...
    invoke-interface {v1, v0}, Lb8c;->b(Lc8c;)V
    ...
    iput-boolean v1, v0, Lc8c;->V:Z

    iget-object v1, v0, Lc8c;->J:Ljava/lang/Object;

    if-eqz v1, :cond_7

    invoke-interface {v1, v0}, Lb8c;->c(Lc8c;)V
