...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;Ldo1;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lz3b;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Lz3b;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    new-instance p1, Lcvj;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lcvj;-><init>(Lz3b;I)V

    new-instance p2, Ldxg;

    invoke-direct {p2, p1}, Ldxg;-><init>(Lpz6;)V

    iput-object p2, p0, Lz3b;->c:Ldxg;
    ...
    iput-object p2, p0, Lz3b;->d:Ldxg;

    iget-object p1, p3, Ldo1;->r:Lks7;

    iget-boolean p1, p1, Lks7;->A:Z

    iput-boolean p1, p0, Lz3b;->e:Z

    const/4 p1, 0x1

    iput-boolean p1, p0, Lz3b;->f:Z
...
# virtual methods
.method public final a(Lorg/webrtc/VideoCodecInfo;)Lfc6;
    .locals 5
    ...
    :cond_1
    iget-boolean v1, p0, Lz3b;->f:Z

    if-nez v1, :cond_2

    iget-object v1, p0, Lz3b;->d:Ldxg;
    ...
    iget-object v2, p0, Lz3b;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    invoke-direct {v0, v1, p1, v2}, Lfc6;-><init>(Lorg/webrtc/VideoDecoder;Lorg/webrtc/VideoCodecInfo;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V

    return-object v0

    :cond_2
    :try_start_0
    iget-object v1, p0, Lz3b;->c:Ldxg;
...
.method public final createDecoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoDecoder;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lz3b;->a(Lorg/webrtc/VideoCodecInfo;)Lfc6;
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    :try_start_0
    invoke-virtual {p0}, Lz3b;->b()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v3, p0, Lz3b;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;

    invoke-interface {v3, v1, v2, v0}, Lyud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
