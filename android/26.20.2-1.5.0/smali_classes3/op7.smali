...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lop7;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x0

    sput-boolean v0, Lop7;->c:Z
...
.method public final a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    sget-boolean v0, Lop7;->c:Z

    if-eqz v0, :cond_0

    invoke-static {p1, p2, p3}, Lop7;->c(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_0
    :try_start_0
    sget-object v0, Lop7;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lop7;->b(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lop7;->d(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    const-string v2, "blur: failed to blur image with renderscript, try with old blur"
...
.method public final b(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    .locals 6
    ...
    const-string v4, "checkRsSpeedAndForceOldBlur: time for rs blur %d"
    ...
    sput-boolean p2, Lop7;->c:Z

    :cond_0
    return-object p1
.end method

.method public final d(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    .locals 5
    ...
    invoke-static {v1, p1, v2, v0}, Landroid/renderscript/Allocation;->createFromBitmap(Landroid/renderscript/RenderScript;Landroid/graphics/Bitmap;Landroid/renderscript/Allocation$MipmapControl;I)Landroid/renderscript/Allocation;
    ...
    invoke-virtual {p3, v0}, Landroid/renderscript/ScriptIntrinsicBlur;->setInput(Landroid/renderscript/Allocation;)V

    invoke-virtual {p3, v3}, Landroid/renderscript/ScriptIntrinsicBlur;->forEach(Landroid/renderscript/Allocation;)V
