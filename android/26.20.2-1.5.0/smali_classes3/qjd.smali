...
.method public constructor <init>(Lpjd;)V
    ...
    iput-object v0, p0, Lqjd;->b:Ljava/lang/String;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lqjd;->c:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lqjd;->d:Ljava/lang/ref/WeakReference;

    iget-object v0, p1, Lpjd;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lpjd;->c:Lnub;

    invoke-virtual {p0, p1}, Lqjd;->d(Lnub;)V
...
.method public final chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;)V
    ...
    .line 1
    invoke-virtual/range {v0 .. v7}, Lqjd;->chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
...
.method public final copy()Lwh4;
    ...
    invoke-direct {v0, v1}, Lqjd;-><init>(Lpjd;)V
...
.method public final d(Lnub;)V
    ...
    iget-object v0, p0, Lqjd;->a:Lpjd;

    iput-object p1, v0, Lpjd;->c:Lnub;
    ...
    iget-object p1, v0, Lpjd;->e:Landroid/graphics/drawable/Drawable;
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v6, v1, Lqjd;->a:Lpjd;

    iget-object v7, v6, Lpjd;->f:Lojd;

    iget-object v8, v6, Lpjd;->t:Landroid/graphics/Path;

    iget v9, v6, Lpjd;->j:I

    iget v10, v6, Lpjd;->g:I

    iget v11, v6, Lpjd;->k:I

    iget v12, v6, Lpjd;->q:F

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Lojd;->getAsInt()I
    ...
    :cond_2
    iget-object v7, v1, Lqjd;->d:Ljava/lang/ref/WeakReference;
    ...
    iput-object v5, v1, Lqjd;->d:Ljava/lang/ref/WeakReference;

    iput v13, v1, Lqjd;->e:F
    ...
    iget-object v7, v1, Lqjd;->b:Ljava/lang/String;
    ...
    iget-object v13, v1, Lqjd;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual/range {p5 .. p12}, Lqjd;->c(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v7, v6, Lpjd;->s:Landroid/graphics/Path;
    ...
    :try_start_5
    iget-object v7, v6, Lpjd;->w:Landroid/graphics/Path;
    ...
    iget-object v8, v6, Lpjd;->v:Landroid/graphics/Path;
    ...
    iget-object v2, v6, Lpjd;->u:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v2, v6, Lpjd;->x:Landroid/graphics/Path;
    ...
    :cond_1b
    iget-object v0, v6, Lpjd;->e:Landroid/graphics/drawable/Drawable;
...
.method public final hashCode()I
    ...
    invoke-virtual {v0}, Lpjd;->hashCode()I
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v1, v0, Lpjd;->d:Lb6h;

    iget-object v2, v0, Lpjd;->a:Landroid/content/Context;

    iget-object v0, v0, Lpjd;->b:Le6g;
...
.method public final updateMeasureState(Landroid/text/TextPaint;)V
    ...
    iget-object p1, v0, Lpjd;->f:Lojd;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lojd;->getAsInt()I
