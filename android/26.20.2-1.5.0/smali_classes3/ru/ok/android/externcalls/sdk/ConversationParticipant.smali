...
.method public static fromExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Leo1;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Leo1;)V

    :cond_0
    return-object v0
.end method

.method public static fromInternal(Leo1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Leo1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
# virtual methods
.method public deAnonymize(Ljo1;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Ljo1;
...
.method public getAcceptCallEpochMs()J
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Ljo1;

    if-eqz v0, :cond_0

    iget-wide v0, v0, Ljo1;->n:J
...
.method public getAcceptedCallClientType()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Ljo1;->l:Ljava/lang/String;
...
.method public getAcceptedCallPlatform()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Ljo1;->m:Ljava/lang/String;

    return-object v0
.end method

.method public getAudioOptionState()Leh9;
    .locals 1
    ...
    iget-object v0, v0, Ljo1;->b:Ltna;

    iget-object v0, v0, Ltna;->a:Leh9;
...
.method public getCallParticipant()Ljo1;
    .locals 1
...
.method public getInternalId()Leo1;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Leo1;
...
.method public getNetworkStatus()Ljsa;
    .locals 1
    ...
    :cond_0
    iget-object v0, v0, Ljo1;->j:Ljsa;

    return-object v0
.end method

.method public getScreenshareOptionState()Leh9;
    .locals 1
...
.method public getVideoOptionState()Leh9;
    .locals 1
...
.method public getWatchTogetherOptionState()Leh9;
    .locals 1
...
.method public hasRegisteredPeers()Z
    ...
    iget-object v0, v0, Ljo1;->f:Ljava/util/HashMap;
...
.method public isAdmin()Z
    ...
    iget-object v0, v0, Ljo1;->e:Ljava/util/List;

    sget-object v1, Lho1;->b:Lho1;
...
.method public setCallParticipant(Ljo1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Leo1;
...
.method public setDeviceIndex(ILru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    iget-wide v2, v0, Leo1;->a:J

    iget v0, v0, Leo1;->b:I

    invoke-direct {v1, v0, p1, v2, v3}, Leo1;-><init>(IIJ)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Leo1;
    ...
    iget-wide v3, v1, Leo1;->a:J

    iget v1, v1, Leo1;->b:I

    invoke-direct {v2, v1, p1, v3, v4}, Leo1;-><init>(IIJ)V

    iput-object v2, v0, Ljo1;->a:Leo1;

    iget-object v1, v0, Ljo1;->q:Lnd1;

    if-eqz v1, :cond_3

    new-instance v2, Lnd1;

    iget-object v3, v1, Lnd1;->a:Ljava/lang/String;

    iget v1, v1, Lnd1;->b:I

    invoke-direct {v2, v3, v1, p1}, Lnd1;-><init>(Ljava/lang/String;II)V

    iput-object v2, v0, Ljo1;->q:Lnd1;
...
.method public setInternalId(Leo1;)V
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Leo1;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Ljo1;
