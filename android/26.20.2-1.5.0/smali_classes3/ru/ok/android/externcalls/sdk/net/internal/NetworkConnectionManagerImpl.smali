...
.method public constructor <init>(Lz41;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/NetworkConnectionManagerImpl;->call:Lz41;
...
# virtual methods
.method public addNetworkConnectivityListener(Lcsa;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/NetworkConnectionManagerImpl;->call:Lz41;
    ...
    invoke-interface {p1}, Lcsa;->a()V

    :cond_0
    return-void
.end method

.method public getTopology()Lgdh;
    .locals 1
...
.method public minusAssign(Lkdh;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/NetworkConnectionManagerImpl;->call:Lz41;

    iget-object v0, v0, Lz41;->m0:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public plusAssign(Lkdh;)V
    .locals 1
...
.method public registerBadConnectionCallback(Ldk0;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/NetworkConnectionManagerImpl;->call:Lz41;

    iget-boolean v1, v0, Lz41;->Q:Z

    if-eqz v1, :cond_0

    iget-object v0, v0, Lz41;->P:Lek0;

    iget-object v0, v0, Lek0;->k:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    :cond_0
    iget-object p1, v0, Lz41;->O:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
...
.method public removeNetworkConnectivityListener(Lcsa;)V
    .locals 1
...
.method public unregisterBadConnectionCallback(Ldk0;)V
    .locals 2
