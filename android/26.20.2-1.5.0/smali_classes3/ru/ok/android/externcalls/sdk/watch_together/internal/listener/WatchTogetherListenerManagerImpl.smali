...
.method private final getPosition(Ljava/lang/Long;)Lmha;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lkha;-><init>(J)V
...
.method private final updateState(Lsha;)V
    .locals 12
    ...
    iget-object p1, p1, Lsha;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lrha;->a:Lyy1;

    iget-object v3, v3, Lyy1;->b:Leo1;
    ...
    iget-object v11, v3, Lyy1;->c:Ljha;
    ...
    sget-object v5, Lpha;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lgha;->d:Loha;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lgha;->a:Ljha;

    invoke-virtual {v8, v11}, Ljha;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lrha;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lmha;

    move-result-object v5

    iget-boolean v2, v1, Lrha;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lrha;->b:F

    invoke-static {v7}, Lwha;->a(F)V

    iget-boolean v8, v1, Lrha;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmha;ZFZLgha;Lax4;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lgbf;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lgbf;Lgha;)V
...
.method public final onVideoStarted(Lqha;)V
    .locals 12
    ...
    iget-object v11, v7, Lgha;->a:Ljha;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmha;ZFZLgha;Lax4;)V
    ...
    iget-object p1, p1, Lqha;->b:Lgbf;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lgbf;Lgha;)V
...
.method public final onVideoStatesUpdatedChanged(Lsha;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lsha;)V
...
.method public final onVideoStopped(Ltha;)V
    .locals 4
    ...
    iget-object v2, p1, Ltha;->b:Lgbf;

    iget-object v3, p1, Ltha;->c:Ljha;

    iget-object p1, p1, Ltha;->d:Loha;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lgbf;Ljha;Loha;)V
