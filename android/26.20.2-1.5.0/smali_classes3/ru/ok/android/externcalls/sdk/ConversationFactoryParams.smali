...
.field private badNetworkIndicatorConfig:Lhk0;

.field private bitrates:Lbo1;
...
.field protected final experiments:Lfna;

.field private fastRecoverEnabled:Z

.field private forceRelayPolicy:Z

.field private groupCallMediaAdaptationConfig:La79;
...
.field joinConversationDelegate:Le98;

.field protected log:Lyud;
...
.field private sslProvider:Lfne;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lyje;->B0:Lp2g;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lyje;

    const-string v1, "sdk-0.1.18.1"
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lbo1;
    ...
    sget-object v2, Lhk0;->e:Lhk0;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lhk0;

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lfne;
    ...
    invoke-direct {v0, v2}, Lfna;-><init>(Lqj2;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Lfna;
...
.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactoryParams;Lpz6;)Lzqh;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->lambda$new$0(Lpz6;)Lzqh;
...
.method private synthetic lambda$new$0(Lpz6;)Lzqh;
    .locals 2
...
.method public getBaseBuilder(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->experiments:Lfna;

    invoke-direct {v1, p1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lfna;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lbo1;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Lbo1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lyje;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Lyje;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:La79;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(La79;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:La79;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(La79;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lhk0;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBadNetworkIndicatorConfig(Lhk0;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Lvse;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Lvse;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lfne;

    invoke-virtual {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setSSLProvider(Lfne;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public setBadNetworkIndicatorConfig(Lhk0;)V
    .locals 0

    if-nez p1, :cond_0

    sget-object p1, Lhk0;->e:Lhk0;

    :cond_0
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->badNetworkIndicatorConfig:Lhk0;

    return-void
.end method

.method public setBitrates(Lbo1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->bitrates:Lbo1;
...
.method public setGroupCallMediaAdaptationConfig(La79;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->groupCallMediaAdaptationConfig:La79;
...
.method public setJoinConversationDelegate(Le98;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->joinConversationDelegate:Le98;
...
.method public setP2PCallMediaAdaptationConfig(La79;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->p2pCallMediaAdaptationConfig:La79;
...
.method public setRotationProvider(Lyje;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->rotationProvider:Lyje;
...
.method public setScreenCapturePermissionProvider(Lvse;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->screenCapturePermissionProvider:Lvse;
...
.method public setSslProvider(Lfne;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactoryParams;->sslProvider:Lfne;
