...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Luuh;",
        "Lp8;",
        "params",
        "Lkotlin/Function0;",
        "Lzqh;",
...
.method public static synthetic a(Lpz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->switchRoom$lambda$4(Lpz6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private static final activateRooms$lambda$0(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final activateRooms$lambda$1(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V
    .locals 1

    const-string v0, "activateRooms"

    invoke-virtual {p0, v0, p2, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomCommandExecutorBase;->parseErrorResponse(Ljava/lang/String;Lorg/json/JSONObject;Lrz6;)V
...
.method public static synthetic b(Lpz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->updateRooms$lambda$6(Lpz6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final buildUpdateRoomsParams(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Luuh;
    .locals 8
    ...
    invoke-static {v2, p3}, Lym3;->Q0(Ljava/lang/Iterable;I)I
    ...
    iput-object v5, v4, Lsuh;->b:Ljava/util/Collection;
    ...
    iput-object v3, v4, Lsuh;->c:Ljava/util/Collection;
    ...
    iget-object v3, v1, Lsuh;->a:Lfbf;

    iget-object v4, v1, Lsuh;->b:Ljava/util/Collection;

    iget-object v1, v1, Lsuh;->c:Ljava/util/Collection;

    invoke-direct {v2, v3, v4, v1}, Ltuh;-><init>(Lfbf;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    invoke-direct {p1, p2}, Luuh;-><init>(Ljava/util/ArrayList;)V

    return-object p1
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->updateRooms$lambda$7(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->switchRoom$lambda$5(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private static final removeRooms$lambda$2(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final removeRooms$lambda$3(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V
    .locals 1
...
.method private static final switchRoom$lambda$4(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final switchRoom$lambda$5(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V
    .locals 1
...
.method private static final updateRooms$lambda$6(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final updateRooms$lambda$7(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;Lorg/json/JSONObject;)V
    .locals 1
...
.method public assignParticipantsToRooms(Lru/ok/android/externcalls/sdk/sessionroom/admin/AssignParticipantsToRoomsParams;Lpz6;Lrz6;)V
    ...
    invoke-direct {p0, v1, p1, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->buildUpdateRoomsParams(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Luuh;

    move-result-object p1

    invoke-virtual {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->updateRooms(Luuh;Lpz6;Lrz6;)V
    :try_end_0
    ...
    invoke-interface {p3, p1}, Lrz6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public moveParticipant(Lru/ok/android/externcalls/sdk/sessionroom/admin/MoveParticipantParams;Lpz6;Lrz6;)V
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl$moveParticipant$1;-><init>(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lru/ok/android/externcalls/sdk/sessionroom/admin/MoveParticipantParams;Lpz6;Lrz6;)V

    invoke-virtual {v1, v0, v2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lrz6;Lrz6;)V

    return-void

    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/sessionroom/admin/MoveParticipantParams;->getToRoomId()Lgbf;
    ...
    invoke-direct {v0, v1, p1}, Lswg;-><init>(Leo1;Lgbf;)V

    invoke-virtual {p0, v0, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;->switchRoom(Lswg;Lpz6;Lrz6;)V
...
.method public switchRoom(Lswg;Lpz6;Lrz6;)V
    ...
    :cond_1
    iget-object p1, p1, Lswg;->b:Leo1;

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Leo1;->b()Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p3, v2}, Lbbf;-><init>(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;I)V
...
.method public updateRooms(Luuh;Lpz6;Lrz6;)V
    ...
    iget-object p1, p1, Luuh;->a:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v5, v3, Ltuh;->b:Ljava/util/Collection;
    ...
    invoke-virtual {v7}, Leo1;->b()Ljava/lang/String;
    ...
    :cond_3
    iget-object v3, v3, Ltuh;->c:Ljava/util/Collection;
    ...
    invoke-virtual {v6}, Leo1;->b()Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p3, v3}, Lbbf;-><init>(Lru/ok/android/externcalls/sdk/sessionroom/internal/command/SessionRoomAdminCommandExecutorImpl;Lrz6;I)V
