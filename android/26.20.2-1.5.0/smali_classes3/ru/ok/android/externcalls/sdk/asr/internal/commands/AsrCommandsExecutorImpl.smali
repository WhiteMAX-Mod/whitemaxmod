...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onSuccess",
        "startRecord",
        "(Ljava/lang/String;Lgbf;Lpz6;Lrz6;)V",
        "stopRecord",
        "(Lgbf;Lpz6;Lrz6;)V",
        "Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;",
        "Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;",
...
.method public static synthetic a(Lrz6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->startRecord$lambda$1(Lrz6;Lorg/json/JSONObject;)V
...
.method public static synthetic b(Lpz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->stopRecord$lambda$2(Lpz6;Lorg/json/JSONObject;)V
...
.method public static synthetic c(Lrz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->stopRecord$lambda$3(Lrz6;Lorg/json/JSONObject;)V
...
.method public static synthetic d(Lpz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->startRecord$lambda$0(Lpz6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final getActiveRoomId()Lgbf;
    .locals 1
...
.method private static final startRecord$lambda$0(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final startRecord$lambda$1(Lrz6;Lorg/json/JSONObject;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/asr/exceptions/AsrException;-><init>(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Throwable;ILax4;)V
...
.method private static final stopRecord$lambda$2(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final stopRecord$lambda$3(Lrz6;Lorg/json/JSONObject;)V
    .locals 6
...
# virtual methods
.method public startRecord(Ljava/lang/String;Lgbf;Lpz6;Lrz6;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->getActiveRoomId()Lgbf;

    move-result-object p2

    :cond_0
    invoke-direct {p0, p4}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lrz6;)Llrf;
    ...
    invoke-direct {p1, p2, p3}, Lxv;-><init>(ILpz6;)V

    new-instance p2, Lyv;

    const/4 p3, 0x0

    invoke-direct {p2, p3, p4}, Lyv;-><init>(ILrz6;)V

    invoke-virtual {v0, v1, p3, p1, p2}, Llrf;->d(Lorf;ZLirf;Lirf;)V
...
.method public stopRecord(Lgbf;Lpz6;Lrz6;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/asr/internal/commands/AsrCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lrz6;)Llrf;
    ...
    iget-object v3, v1, Lj47;->a:Lorg/json/JSONObject;
    ...
    invoke-direct {p1, v2, p2}, Lxv;-><init>(ILpz6;)V

    new-instance p2, Lyv;

    invoke-direct {p2, v2, p3}, Lyv;-><init>(ILrz6;)V
