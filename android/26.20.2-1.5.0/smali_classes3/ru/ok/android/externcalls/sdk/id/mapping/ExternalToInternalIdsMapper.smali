...
.field private final rtcLog:Lyud;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper$Companion;-><init>(Lax4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Lyud;)V
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Lyud;
...
.method private final filterEmptyParticipantIds(Ljava/util/Collection;)Ljava/util/List;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Lyud;
    ...
    invoke-interface {v3, v6, v5, v4}, Lyud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public map(Ljava/util/Collection;Lru/ok/android/externcalls/sdk/id/mapping/MappingContext;)Ljava/util/Map;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->getOkIdsByExternalIds(Ljava/util/Collection;)Ltuf;

    move-result-object p1

    invoke-virtual {p1}, Ltuf;->d()Ljava/lang/Object;
    ...
    :goto_3
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Lyud;

    const-string v1, "ExternalToInternalIdsMapper"

    const-string v2, "Can\'t map external ids to internal"

    invoke-interface {p2, v1, v2, p1}, Lyud;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
