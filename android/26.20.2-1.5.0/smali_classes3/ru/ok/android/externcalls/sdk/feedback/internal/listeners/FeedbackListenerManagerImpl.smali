...
.method private final notifyFeedbackAdded(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->listeners:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    check-cast v1, Lru/ok/android/externcalls/sdk/feedback/listener/FeedbackListener;

    invoke-interface {v1, p1}, Lru/ok/android/externcalls/sdk/feedback/listener/FeedbackListener;->onFeedbackAdded(Ljava/util/List;)V
...
.method private final notifyFeedbackEnabledChanged(Z)V
    ...
    invoke-interface {v1, p1}, Lru/ok/android/externcalls/sdk/feedback/listener/FeedbackListener;->onFeedbackEnabledChanged(Z)V
...
.method private final notifyFeedbackRemoved(Ljava/util/List;)V
    ...
    invoke-interface {v1, p1}, Lru/ok/android/externcalls/sdk/feedback/listener/FeedbackListener;->onFeedbackRemoved(Ljava/util/List;)V
...
.method private final notifyResolvedFeedbackItems(Ljava/util/List;)V
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->notifyFeedbackAdded(Ljava/util/List;)V
...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Leo1;
    ...
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Leo1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILax4;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lw90;-><init>(Ljava/lang/Object;JI)V
...
.method private final unrollReceivedFeedback(Lzd1;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Lzd1;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lyd1;->b:Ljava/lang/Object;
    ...
    iget-object v5, v1, Lyd1;->a:Ljava/lang/String;

    new-instance v6, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;

    invoke-direct {v6, v4, v5}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Leo1;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {v3, v0}, Lcn3;->T0(Ljava/lang/Iterable;Ljava/util/Collection;)V
...
.method public getOwnCurrentFeedback()Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->conversation:Lru/ok/android/externcalls/sdk/Conversation;
...
.method public onFeedback(Lzd1;)V
    .locals 5

    iget-object v0, p1, Lzd1;->a:Lgbf;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lzd1;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Leo1;
    ...
    invoke-direct {v2, p0, p1, v0, v4}, Lfo5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lra5;

    const/16 v4, 0x12

    invoke-direct {p1, p0, v4, v0}, Lra5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v1, v3, v2, p1}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->resolveExternalsByInternalsIds(Ljava/util/List;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
