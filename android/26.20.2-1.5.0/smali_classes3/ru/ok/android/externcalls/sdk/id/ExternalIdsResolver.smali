...
.method private applyExternals(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Leo1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v3, v0, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Leo1;)V
...
.method private collectExternalIdResolutionCandidatesForSessionRoom(Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->getInternalIdExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Leo1;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Leo1;)V
...
.method public resolveIds(Ljava/util/List;Lru/ok/android/externcalls/sdk/id/mapping/MappingContext;)Ljv3;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Ljn;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lnv3;

    const/4 p2, 0x0

    invoke-direct {p1, p2, v0}, Lnv3;-><init>(ILjava/lang/Object;)V

    invoke-static {}, Lgse;->b()Lxre;

    move-result-object p2

    invoke-virtual {p1, p2}, Ljv3;->c(Lxre;)Lsv3;
