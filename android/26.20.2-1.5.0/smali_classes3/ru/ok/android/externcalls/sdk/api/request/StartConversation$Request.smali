...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lk07;)V",
        "canRepeat",
        "()Z",
        "shouldGzip",
        "shouldNeverGzip",
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lk07;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lpp0;-><init>(Landroid/net/Uri;)V

    sget-object v0, Lno;->c:Lno;

    iput-object v0, v1, Lpp0;->b:Lno;
    ...
    invoke-virtual {v1, v0, v2}, Lpp0;->c(Ljava/lang/String;Z)V

    const-string v0, "turnServers"

    invoke-virtual {v1, v0, p1}, Lpp0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "conversationId"

    invoke-virtual {v1, p1, p2}, Lpp0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "createJoinLink"

    invoke-virtual {v1, p1, p3}, Lpp0;->c(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, p1, p2}, Lpp0;->c(Ljava/lang/String;Z)V
    ...
    invoke-direct {p1, v0, p2, p3}, Lf28;-><init>(Ljava/lang/String;J)V

    iget-object p2, v1, Lpp0;->c:Lgo;

    invoke-virtual {p2, p1}, Lgo;->a(Lfo;)V
    ...
    invoke-virtual {v1, p2, p1}, Lpp0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-interface {p7, p4, p5, p6, v1}, Lk07;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p2, p1}, Lpp0;->c(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/api/CallInfo$Companion;->getPARSER()Lzc8;

    move-result-object p1

    invoke-virtual {v1, p1}, Lpp0;->a(Lzc8;)Lqp0;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;->$$delegate_0:Lqp0;
...
.method public canRepeat()Z
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;->$$delegate_0:Lqp0;
...
.method public handleInterruptedIO()Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v15}, Lru/ok/android/externcalls/sdk/api/CallInfo;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/util/List;Ljava/util/List;ZIILax4;)V
