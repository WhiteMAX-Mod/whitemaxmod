...
.method public static synthetic a(Lrz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->start$lambda$1(Lrz6;Lorg/json/JSONObject;)V
...
.method public static synthetic b(Lpz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->start$lambda$0(Lpz6;Lorg/json/JSONObject;)V
...
.method public static synthetic c(Lrz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->stop$lambda$3(Lrz6;Lorg/json/JSONObject;)V
...
.method public static synthetic d(Lpz6;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->stop$lambda$2(Lpz6;Lorg/json/JSONObject;)V
...
.method private static final start$lambda$0(Lpz6;Lorg/json/JSONObject;)V
    .locals 0
...
.method private static final start$lambda$1(Lrz6;Lorg/json/JSONObject;)V
    .locals 3
...
.method private static final stop$lambda$3(Lrz6;Lorg/json/JSONObject;)V
    .locals 3
...
# virtual methods
.method public start(Ljava/lang/String;Lpz6;Lrz6;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lrz6;)Llrf;
    ...
    invoke-virtual {v0, v1, p1, p2}, Llrf;->k(Lorg/json/JSONObject;Lirf;Lirf;)V

    return-void
.end method

.method public stop(Lpz6;Lrz6;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/urlsharing/external/internal/commands/UrlSharingCommandsExecutorImpl;->getSignalingOrPassExceptionToOnError(Lrz6;)Llrf;
    ...
    invoke-direct {v2, v3, p1}, Lxv;-><init>(ILpz6;)V

    new-instance p1, Lyv;

    const/16 v3, 0x9

    invoke-direct {p1, v3, p2}, Lyv;-><init>(ILrz6;)V
