...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lwme;Lp9h;Lpz6;Ljava/util/Set;Ljava/lang/Long;)V",
        "Ltuf;",
        "",
        "getSettings",
        "(Ljava/util/Set;)Ltuf;",
...
# instance fields
.field private volatile cachedSettingsSource:Ltuf;
...
.field private newSettings:Ltuf;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ltuf;"
        }
...
.field private readSettingsDisposable:Lmb5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared$Companion;-><init>(Lax4;)V
...
.method public constructor <init>(Lwme;Lp9h;Lpz6;Ljava/util/Set;Ljava/lang/Long;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->rxApiClient:Lwme;

    .line 3
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->timeProvider:Lp9h;

    .line 4
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lpz6;
    ...
    .line 8
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->createSettingsSource()Ltuf;

    move-result-object p1

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Ltuf;

    .line 9
    sget-object p1, Lar5;->a:Lar5;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettingsDisposable:Lmb5;
    ...
    invoke-interface {p1, p2, p3}, Lyud;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, p3}, Lz8e;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;I)V

    invoke-virtual {p1, p2}, Lxre;->b(Ljava/lang/Runnable;)Lmb5;

    :cond_0
    return-void
.end method

.method public synthetic constructor <init>(Lwme;Lp9h;Lpz6;Ljava/util/Set;Ljava/lang/Long;ILax4;)V
    .locals 6
...
.method private static final _init_$lambda$0(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->cachedSettingsSource:Ltuf;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettings-IoAF18A(Ltuf;)Ljava/lang/Object;
...
.method public static final synthetic access$applySettings(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;Ltuf;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->applySettings(Ltuf;)V
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)Lpz6;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lpz6;
...
.method private final applySettings(Ltuf;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->newSettings:Ltuf;
    ...
    :try_start_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lpz6;
    ...
    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->newSettings:Ltuf;
    ...
    :cond_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lpz6;
    ...
    invoke-interface {p1, v2, v1}, Lyud;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
...
.method private final createSettingsSource()Ltuf;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->getSettings(Ljava/util/Set;)Ltuf;
...
.method private final getSettings(Ljava/util/Set;)Ltuf;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->rxApiClient:Lwme;
...
.method private final getSettingsSource()Ltuf;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->timeProvider:Lp9h;
...
.method private final readSettings-IoAF18A(Ltuf;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->log:Lpz6;
    ...
    :try_start_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettingsDisposable:Lmb5;
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared$readSettings$1$1$1;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;Ltuf;)V
    ...
    invoke-virtual {p1, v1, v2}, Ltuf;->g(Ls54;Ls54;)Ln02;
...
.method private final scheduleCreateNewSettings()V
    ...
    invoke-direct {v2, p0, v3}, Lz8e;-><init>(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;I)V

    sget-object v3, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    const-wide/16 v4, 0x1388

    invoke-virtual {v1, v2, v4, v5, v3}, Lxre;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lmb5;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final scheduleCreateNewSettings$lambda$4$lambda$3(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;)V
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->readSettings-IoAF18A(Ltuf;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public get(Ljava/lang/String;)Ltuf;
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsShared;->getSettingsSource()Ltuf;
