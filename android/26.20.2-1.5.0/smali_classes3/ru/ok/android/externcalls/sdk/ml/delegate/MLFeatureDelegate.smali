...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "downloadModel",
        "(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ltuf;",
        "stage",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate$Companion;-><init>(Lax4;)V
...
.method public constructor <init>(Lx09;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfigProvider;Lru/ok/android/externcalls/sdk/net/DownloadService;Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;Lru/ok/android/externcalls/sdk/ml/model/MLFeatureType;Ljava/lang/String;Lyud;Landroid/content/Context;Lru/ok/android/externcalls/sdk/ml/model/ModelSpec;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lx09;
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lyud;
...
.method public static final synthetic access$downloadModel(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ltuf;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ltuf;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;)Lyud;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lyud;
...
.method private final clearDir()V
    ...
    invoke-static {v3, v4}, Lcuk;->a(Ljava/io/File;Lrz6;)V
...
.method private final downloadModel(Lru/ok/android/externcalls/sdk/ml/config/MLFeatureConfig;)Ltuf;
    .locals 5
    ...
    sget-object v4, Lae7;->b:Lae7;

    invoke-direct {v3, p1, v4}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;-><init>(Ljava/lang/String;Lae7;)V

    invoke-interface {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/net/DownloadService;->download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Ltuf;
    ...
    iget-object p1, p1, Lbm6;->a:Lxl6;

    invoke-direct {v0, p1}, Lzl6;-><init>(Lxl6;)V
    ...
    invoke-direct {v0, p1}, Lzwf;-><init>(Ltuf;)V

    :goto_0
    new-instance p1, Lxl6;

    invoke-direct {p1, v0, v1}, Lxl6;-><init>(Lsl6;Lur0;)V

    new-instance v0, Lbm6;

    invoke-direct {v0, p1}, Lbm6;-><init>(Lxl6;)V
...
.method private final fetchConfig()Lz59;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lz59;
...
.method private final log(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->logger:Lyud;
...
.method private final removeCurrentModel()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lx09;
...
.method private final saveNewModelInfo(Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;)Lru/ok/android/externcalls/sdk/ml/stage/SaveNewModelInfoStage;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->mlFeaturesInfoDataSource:Lx09;
    ...
    invoke-virtual {v1, v2, v0}, Lkq;->X(Ljava/lang/String;Ljava/io/Serializable;)V
...
.method private final unzipModel(Lru/ok/android/externcalls/sdk/ml/stage/DownloadStage;)Lru/ok/android/externcalls/sdk/ml/stage/UnzipStage;
    ...
    invoke-static {v0, v1}, Lye6;->i(Ljava/io/File;Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v1}, Lcuk;->a(Ljava/io/File;Lrz6;)V
...
# virtual methods
.method public final checkModel()Ltuf;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ml/delegate/MLFeatureDelegate;->fetchConfig()Lz59;
    ...
    invoke-direct {v3, v0, v1, v4}, Lh69;-><init>(Lz59;Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, v3, v0, v2}, Lh69;-><init>(Lz59;Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v1, v0, v3}, Le69;-><init>(Ljava/lang/Object;Lh07;I)V
    ...
    invoke-direct {v1, v2, v3, v0}, Ll69;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public isModelValid(Ljava/io/File;)Z
    ...
    invoke-static {v1}, Lbf6;->p0(Ljava/io/File;)Ljava/lang/String;
