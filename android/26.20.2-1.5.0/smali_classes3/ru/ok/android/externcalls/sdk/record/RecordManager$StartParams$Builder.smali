...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "withSessionRoomId",
        "(Lgbf;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "name",
        "withName",
        ...
        "onSuccess",
        "withCallOnSuccess",
        "(Lrz6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;",
        "",
        "onError",
        "withCallOnError",
...
.field private sessionRoomId:Lgbf;
...
.method public final build()Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lgbf;
    ...
    iget-object v9, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Lrz6;

    iget-object v10, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Lrz6;

    new-instance v0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;

    const/4 v11, 0x0

    invoke-direct/range {v0 .. v11}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;-><init>(ZLjava/lang/Long;Ljava/lang/String;Lgbf;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Long;Ljava/lang/String;Lrz6;Lrz6;Lax4;)V
...
.method public final withCallOnError(Lrz6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onError:Lrz6;

    return-object p0
.end method

.method public final withCallOnSuccess(Lrz6;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->onSuccess:Lrz6;
...
.method public final withSessionRoomId(Lgbf;)Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams$Builder;->sessionRoomId:Lgbf;
