...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(Lavd;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Ll4b;",
        "observeStat",
        "()Ll4b;",
        "rtcStat",
...
.field private final statSubject:Lsr0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Lax4;)V
...
.method public constructor <init>(Lyud;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lyud;

    new-instance p1, Lsr0;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lsr0;-><init>(Lqr5;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lsr0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lyud;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lyud;

    return-object p0
.end method

.method private final mapToMonitoringStat(Lavd;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILax4;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Lzc2;->h:Ljava/lang/Double;
    ...
    :goto_0
    iget-object p1, p1, Lavd;->b:Ljava/util/List;

    invoke-static {p1, v0}, Liqk;->e(Ljava/util/List;Lzc2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lyud;
    ...
    :cond_6
    iget-object v4, v5, Lv2g;->i:Ljava/math/BigInteger;

    iget-object v5, v5, Lv2g;->h:Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Lyud;
    ...
    :cond_b
    iget-object p1, v5, Lv2g;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Lv2g;->h:Ljava/math/BigInteger;
    ...
    :goto_6
    iget-object p1, v0, Lzc2;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Lyud;
...
# virtual methods
.method public observeStat()Ll4b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lsr0;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v1, Lf5b;

    invoke-direct {v1, v0}, Lh3;-><init>(Ll4b;)V

    return-object v1
.end method

.method public onRtcStats(Lavd;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(Lavd;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    ...
    invoke-virtual {v0, p1}, Lsr0;->d(Ljava/lang/Object;)V
