...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "store",
        "<init>",
        "(Lpz6;Lz41;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V",
        "Lyy1;",
        "key",
        "",
...
.field private final state:Lpz6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lpz6;"
        }
...
# direct methods
.method public constructor <init>(Lpz6;Lz41;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lpz6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lz41;
...
.method private final setRenderers(Lyy1;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final setRenderersForMe(Lyy1;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderers(Lyy1;Ljava/util/List;)V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lz41;
    ...
    invoke-virtual {v1, p1, p2}, Llx1;->S(Lyy1;Ljava/util/List;)V

    iget-object v0, v0, Lz41;->y0:Lfk;

    invoke-virtual {v0, p1, p2}, Lfk;->c(Lyy1;Ljava/util/List;)V

    return-void

    :cond_2
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lz41;
    ...
    iput-object v0, v1, Lqcc;->b:Ljava/lang/Object;

    sget-object v0, Lqhi;->c:Lqhi;

    iput-object v0, v1, Lqcc;->c:Ljava/lang/Object;

    invoke-virtual {v1}, Lqcc;->B()Lyy1;

    move-result-object v0

    iget-object p1, p1, Lz41;->y0:Lfk;

    invoke-virtual {p1, v0, p2}, Lfk;->c(Lyy1;Ljava/util/List;)V
    ...
    :cond_7
    iget-object p1, p1, Lz41;->g0:Lnmf;

    iput-object p2, p1, Lnmf;->p:Lorg/webrtc/VideoSink;

    iget-object p1, p1, Lnmf;->o:Lgt8;

    if-eqz p1, :cond_8

    invoke-virtual {p1, p2}, Lgt8;->j(Lorg/webrtc/VideoSink;)V
...
.method private final setRenderersForOthers(Lyy1;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public getCallRenderer()Lwm1;
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lpz6;
...
.method public setRenderers(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Ljava/util/List;)V
    ...
    .line 4
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lqhi;

    move-result-object v2

    .line 5
    iput-object v2, v1, Lqcc;->c:Ljava/lang/Object;
    ...
    .line 8
    iput-object v2, v1, Lqcc;->b:Ljava/lang/Object;

    .line 9
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Ljha;

    move-result-object v2

    .line 10
    iput-object v2, v1, Lqcc;->d:Ljava/lang/Object;
    ...
    .line 14
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForMe(Lyy1;Ljava/util/List;)V

    return-void

    .line 15
    :cond_1
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForOthers(Lyy1;Ljava/util/List;)V
