...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lgbf;Ljava/util/Collection;)Ljava/util/Collection;",
        "internalId",
        "mapInternalIdToSessionRoomParticipant",
        "(Leo1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;",
        ...
        "(Ljava/util/Collection;Lpz6;Lrz6;)V",
        "getRoomParticipants",
        "(Lgbf;Lrz6;Lrz6;)V",
...
.method public static synthetic a(Lrz6;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$9(Lrz6;)V
...
.method public static final synthetic access$getRoomParticipantIds(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lfbf;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lfbf;)Ljava/util/Collection;
...
.method public static final synthetic access$mapInternalIdsToSessionRoomParticipants(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lgbf;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdsToSessionRoomParticipants(Lgbf;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static synthetic b(Lrz6;Lrz6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Leo1;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$0(Lrz6;Lrz6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Leo1;)V

    return-void
.end method

.method public static synthetic c(Lrz6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$1(Lrz6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
...
.method public static synthetic d(Lpz6;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$8(Lpz6;)V
...
.method private final getAllRoomParticipantIds()Ljava/util/Collection;
    ...
    iget-object v2, v2, Labf;->e:Ljava/util/List;
...
.method private final getMainCallParticipantIds(Lrz6;Lrz6;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lgbf;)Ljava/util/Collection;
    ...
    invoke-static {v2, v0}, Lym3;->Q0(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {v0, v1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants;-><init>(Lgbf;Ljava/util/Collection;)V
...
.method private final getRoomParticipantIds(Lfbf;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Labf;->e:Ljava/util/List;
...
.method private final getUnresolvedExternalIds(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Leo1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final mapConversationParticipantToSessionRoomParticipant(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {v2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lgbf;

    move-result-object v2

    invoke-direct {v0, v1, v2, p1}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lgbf;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V

    return-object v0
.end method

.method private final mapInternalIdToSessionRoomParticipant(Leo1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    .locals 2
    ...
    invoke-direct {v1, p1, v0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lgbf;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
...
.method private final mapInternalIdsToSessionRoomParticipants(Lgbf;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdToSessionRoomParticipant(Leo1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lgbf;)Ljava/util/Collection;
...
.method private static final resolveInternalIdByExternal$lambda$0(Lrz6;Lrz6;Lru/ok/android/externcalls/sdk/id/ParticipantId;Leo1;)V
    .locals 1

    if-eqz p3, :cond_0

    invoke-interface {p0, p3}, Lrz6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final resolveInternalIdByExternal$lambda$1(Lrz6;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 3
...
.method private final resolveParticipantIds(Ljava/util/Collection;Lpz6;Lrz6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, p2}, Lim0;-><init>(ILpz6;)V

    new-instance p2, Lhbf;

    const/4 v2, 0x0

    invoke-direct {p2, v2, p3}, Lhbf;-><init>(ILrz6;)V
...
.method private static final resolveParticipantIds$lambda$8(Lpz6;)V
    .locals 0
...
.method private static final resolveParticipantIds$lambda$9(Lrz6;)V
    .locals 2
...
.method public getAllInRoomParticipants(Lrz6;Lrz6;)V
    ...
    invoke-direct {v2, v0, p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getAllInRoomParticipants$1;-><init>(Ljava/util/Set;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lrz6;)V

    invoke-direct {p0, v1, v2, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lpz6;Lrz6;)V
...
.method public final getInternalIdsByExternal(Ljava/util/Collection;)Ljava/util/Map;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Leo1;
...
.method public getParticipantRoomId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lrz6;Lrz6;)V
    ...
    invoke-interface {p3, p2}, Lrz6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lgbf;
...
.method public getRoomParticipants(Lgbf;Lrz6;Lrz6;)V
    ...
    invoke-direct {p0, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getMainCallParticipantIds(Lrz6;Lrz6;)V
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lfbf;)Ljava/util/Collection;
    ...
    invoke-direct {v1, p2, p1, p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getRoomParticipants$1;-><init>(Lrz6;Lgbf;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ljava/util/Collection;)V

    invoke-direct {p0, v0, v1, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lpz6;Lrz6;)V

    :cond_1
    return-void
.end method

.method public final resolveInternalIdByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lrz6;Lrz6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2, p3, p1, v2}, Lr05;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/Serializable;I)V

    new-instance p2, Lyte;

    const/4 v2, 0x7

    invoke-direct {p2, p3, v2, p1}, Lyte;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v0, p1, v1, p2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lt54;Ljava/lang/Runnable;)V
