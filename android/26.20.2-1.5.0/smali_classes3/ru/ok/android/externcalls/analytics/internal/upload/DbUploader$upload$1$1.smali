...
.method public final invoke(Ljava/util/Iterator;)V
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Ln6b;

    move-result-object v1

    invoke-virtual {v1}, Ln6b;->b()Lin;

    move-result-object v1

    invoke-static {v0, v1, p1}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->access$uploadImpl(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lin;Ljava/util/Iterator;)V
