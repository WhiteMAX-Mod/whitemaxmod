...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorCallback",
        "send-B_83SRM",
        "(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lf07;)V",
        "send",
        "Lin;",
        "getApiClient",
        "()Lin;",
...
.method public static synthetic a(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lzqh;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/onelog/OneLogDirect;->send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lzqh;
...
.method public static synthetic c(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lin;Lf07;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/onelog/OneLogDirect;->send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lin;Lf07;)V
...
.method private final getApiClient()Lin;
    .locals 1
    ...
    invoke-virtual {v0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Lin;
...
.method private final send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lf07;)V
    .locals 7
    ...
    invoke-direct {p0}, Lru/ok/android/onelog/OneLogDirect;->getApiClient()Lin;
    ...
    :cond_0
    sget-object v1, Ll9b;->a:Ll9b;

    sget-object v0, Ll9b;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v0, Ll9b;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    ...
    :cond_2
    :goto_2
    sget-object v6, Ll9b;->c:Ljava/util/concurrent/Executor;
...
.method private static final send_B_83SRM$lambda$1(Ljava/lang/String;Lru/ok/android/onelog/OneLogItem;Lin;Lf07;)V
    .locals 3
    ...
    invoke-interface {p2, v2}, Lin;->a(Lun;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_1
    invoke-interface {p3, p1, p0}, Lf07;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    return-void
.end method

.method private static final send_PCEVtD0$lambda$0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/Exception;)Lzqh;
    .locals 0
...
.method public final flush()V
    ...
    sget-object v0, Ll9b;->a:Ll9b;

    sget-object v1, Ll9b;->c:Ljava/util/concurrent/Executor;
    ...
    sput-object v1, Ll9b;->c:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final send-PCEVtD0(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1}, Lz51;-><init>(I)V

    invoke-direct {p0, p1, p2, v0}, Lru/ok/android/onelog/OneLogDirect;->send-B_83SRM(Lru/ok/android/onelog/OneLogItem;Ljava/lang/String;Lf07;)V
