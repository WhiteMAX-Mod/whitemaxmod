...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, p1}, Lu2c;-><init>(Ljava/io/OutputStream;)V
...
.method public static dump(Lru/ok/android/onelog/OneLogItem;Ljava/io/Writer;)V
    ...
    invoke-direct {v0, p1}, Ltkc;-><init>(Ljava/io/Writer;)V

    .line 7
    invoke-static {p0, v0}, Lru/ok/android/onelog/ItemDumper;->dump(Lru/ok/android/onelog/OneLogItem;Lzd8;)V

    .line 8
    invoke-virtual {v0}, Ltkc;->flush()V

    return-void
.end method

.method public static dump(Lru/ok/android/onelog/OneLogItem;Lzd8;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1, p0}, Lru/ok/android/onelog/ItemSerializer;->serialize(Lzd8;Lru/ok/android/onelog/OneLogItem;)V
