...
.method public final g()Lup8;
    ...
    iget-object v2, v1, Landroidx/work/WorkerParameters;->b:Lcq4;

    const-string v3, "param_dump_path"

    invoke-virtual {v2, v3}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v8}, Lck7;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v7, v8}, Lzi0;->m(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v7}, Lck7;->close()V
    :try_end_5
    ...
    :try_start_7
    invoke-static {v8, v1}, Lrwd;->i(Ljava/io/Closeable;Ljava/lang/Throwable;)V
