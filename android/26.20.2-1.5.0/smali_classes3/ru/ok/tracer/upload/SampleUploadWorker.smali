...
.method public final g()Lup8;
    ...
    iget-object v4, v1, Landroidx/work/WorkerParameters;->b:Lcq4;

    iget-object v1, v1, Landroidx/work/WorkerParameters;->b:Lcq4;

    const-string v5, "tracer_sample_file_path"

    invoke-virtual {v4, v5}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4, v5, v6}, Lcq4;->d(Ljava/lang/String;J)J
    ...
    invoke-virtual {v1, v4}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string v5, "tracer_version_code"

    invoke-virtual {v1, v5, v7, v8}, Lcq4;->d(Ljava/lang/String;J)J
    ...
    invoke-static {v1, v0}, Lqka;->A(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {v0}, Lbu8;->y(Landroid/content/pm/PackageInfo;)J
...
.method public final h(Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/String;
    ...
    iget-object v4, v3, Landroidx/work/WorkerParameters;->b:Lcq4;

    iget-object v5, v3, Landroidx/work/WorkerParameters;->b:Lcq4;

    const-string v6, "tracer_custom_properties_keys"

    iget-object v4, v4, Lcq4;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v5, v9}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    if-eqz v10, :cond_3

    invoke-virtual {v2, v9, v10}, Lp29;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lwdh;->a:Lwdh;

    sget-object v4, Lwdh;->e:Lvbf;
    ...
    :goto_2
    invoke-virtual {v4}, Lvbf;->b()V

    iget-object v4, v4, Lvbf;->f:Lkyg;
    ...
    :cond_6
    invoke-virtual {v2}, Lp29;->isEmpty()Z
    ...
    :cond_7
    iget-object v7, v4, Lkyg;->n:Ljava/util/Map;

    invoke-static {v2, v7}, Lu39;->Q(Ljava/util/Map;Ljava/util/Map;)Ljava/util/LinkedHashMap;

    move-result-object v2

    const/16 v7, 0x5fff

    invoke-static {v4, v6, v2, v7}, Lkyg;->a(Lkyg;ZLjava/util/Map;I)Lkyg;
    ...
    invoke-virtual {v4, v2}, Lkyg;->b(Ljava/util/Date;)Lkyg;

    move-result-object v2

    invoke-static {v2}, Liof;->E0(Lkyg;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v4, v7}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, p1, v6}, Lcq4;->b(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v5, p1, v8, v9}, Lcq4;->d(Ljava/lang/String;J)J
    ...
    :cond_9
    iget-object p1, v3, Landroidx/work/WorkerParameters;->b:Lcq4;
    ...
    invoke-direct {p1, v4}, Lnj9;-><init>(I)V
    ...
    invoke-static {v4, v5}, Lgw4;->e(Ljava/lang/String;Ljava/lang/String;)Lhl7;

    move-result-object v4

    invoke-direct {v0, p1, v4}, Lacj;-><init>(Ljava/lang/String;Lvl7;)V

    invoke-virtual {v2}, Lorg/json/JSONObject;->toString()Ljava/lang/String;

    sget-object p1, Lwdh;->h:Ldxg;
    ...
    invoke-virtual {p1, v0}, Ljm7;->b(Lacj;)Lxl7;

    move-result-object p1

    :try_start_0
    iget-object v0, p1, Lxl7;->c:Lhl7;

    new-instance v2, Lorg/json/JSONObject;

    iget-object v0, v0, Lhl7;->b:[B

    invoke-static {v0}, Lcog;->w0([B)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v0}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V

    iget-object v0, v3, Landroidx/work/WorkerParameters;->b:Lcq4;

    invoke-virtual {v0, v7}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iget-object v3, v3, Landroidx/work/WorkerParameters;->b:Lcq4;

    invoke-virtual {v3, p2}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-static {v2, v0, p2}, Lgw4;->r(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final i(Ljava/io/File;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Landroidx/work/WorkerParameters;->b:Lcq4;

    const-string v2, "tracer_feature_uze_gzip"

    const/4 v3, 0x1

    invoke-virtual {v1, v2, v3}, Lcq4;->b(Ljava/lang/String;Z)Z
    ...
    iget-object v5, p0, Lvp8;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v6, v7, v2}, Lcog;->z0(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v6}, Lbu8;->G(Ljava/io/File;)V
    ...
    invoke-static {v6, v1}, Lbf6;->t0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v1

    :try_start_0
    invoke-static {p1, v1}, Ltik;->a(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    ...
    invoke-direct {v1, v4}, Lnj9;-><init>(I)V

    invoke-virtual {v1}, Lnj9;->h()Ldi4;
    ...
    invoke-direct {v4, v6, p1}, Lb75;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v6, v8, v9, v7, v4}, Lul7;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lvl7;)V

    invoke-virtual {v1, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v4, Lrl7;

    sget-object v6, Ljvd;->b:Lo3;

    invoke-virtual {v6}, Lo3;->f()J
    ...
    invoke-direct {v4, v3, v1}, Lrl7;-><init>(Ljava/lang/String;Ljava/util/List;)V

    new-instance v1, Lacj;

    invoke-direct {v1, p2, v4}, Lacj;-><init>(Ljava/lang/String;Lvl7;)V

    :try_start_1
    sget-object p2, Lwdh;->h:Ldxg;
    ...
    invoke-virtual {p2, v1}, Ljm7;->b(Lacj;)Lxl7;
    ...
    iget-object v3, p2, Lxl7;->b:Ljava/lang/String;

    iget-object v4, p2, Lxl7;->c:Lhl7;
    ...
    :cond_4
    :goto_3
    iget-object v4, v0, Landroidx/work/WorkerParameters;->b:Lcq4;

    const-string v6, "tracer_feature_name"

    invoke-virtual {v4, v6}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lcq4;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_4
    invoke-static {v2, v4, v0}, Lgw4;->r(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
