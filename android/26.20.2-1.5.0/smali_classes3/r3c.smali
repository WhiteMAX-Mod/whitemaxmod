...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v1}, Lw9b;->o(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Lr3c;->c:Ljava/util/Map;
    ...
    sput-object v0, Lr3c;->d:Ljava/util/List;
...
.method public final b()[B
    ...
    iget-object v0, p0, Lr3c;->b:Ljava/util/ArrayList;
    ...
    sget-object v3, Lr3c;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lk3c;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Lr3c;->e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Lr3c;->e(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lprj;->e:Lprj;
    ...
    invoke-static {v2}, Lvj5;->l(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Lvj5;->k(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lr3c;->f([B)V

    iget-object v1, v1, Lk3c;->a:Lprj;
...
.method public final c(Ljava/nio/ByteBuffer;)I
    ...
    invoke-direct {v6, v2, v7}, Lugj;-><init>(II)V
    ...
    sget-object v3, Lr3c;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Lr3c;->d(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Lj3c;-><init>(Lprj;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :cond_1
    sget-object v3, Lprj;->e:Lprj;

    if-eq v2, v3, :cond_2

    sget-object v3, Lprj;->f:Lprj;
    ...
    invoke-static {v5}, Lqd;->m(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lvj5;->x()V

    invoke-static {v5, v4}, Lvj5;->m(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    new-instance v4, Lk3c;

    invoke-direct {v4, v2, v3}, Lk3c;-><init>(Lprj;Ljava/security/PublicKey;)V
    ...
    invoke-direct {p1, v3}, Lone/video/calls/sdk_private/j;-><init>(Ljava/lang/String;)V
