...
# direct methods
.method public synthetic constructor <init>(Lv85;I)V
    .locals 0

    iput p2, p0, Lu85;->a:I

    iput-object p1, p0, Lu85;->b:Lv85;
...
# virtual methods
.method public a(Lcle;Ljava/lang/Throwable;)V
    .locals 2
    ...
    iget-object p1, p0, Lu85;->b:Lv85;

    iget-object p1, p1, Lv85;->a:Lyud;
    ...
    iget-object p2, p1, Lv85;->a:Lyud;

    const-string v0, "DisplayLayouts"

    const-string v1, "Resend next time after error"

    invoke-interface {p2, v0, v1}, Lyud;->log(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p2, 0x1

    iput-boolean p2, p1, Lv85;->e:Z
...
.method public f(Lcle;Lmle;)V
    ...
    :pswitch_0
    iget-object p1, p2, Leuh;->a:Ljava/util/Map;
