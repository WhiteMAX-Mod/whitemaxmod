...
.method public synthetic constructor <init>(Lc8c;Lorg/webrtc/SessionDescription;I)V
    ...
    iput-object p1, p0, Lt7c;->b:Lc8c;

    iput-object p2, p0, Lt7c;->c:Lorg/webrtc/SessionDescription;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v0, v1, Lt7c;->b:Lc8c;

    iget-object v2, v1, Lt7c;->c:Lorg/webrtc/SessionDescription;
    ...
    iget-object v5, v0, Lc8c;->w:Lyud;

    invoke-static {v4, v5}, Lrik;->d(Ljava/lang/String;Lyud;)V

    const/4 v5, 0x0

    invoke-virtual {v0, v4, v5}, Lc8c;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object v4, v0, Lc8c;->h:Lul;

    iget-object v4, v4, Lul;->c:Ljava/lang/Integer;
    ...
    sget-object v7, Lc8c;->i0:Ljava/util/regex/Pattern;
    ...
    iget-object v7, v0, Lc8c;->h:Lul;

    iget-object v8, v7, Lul;->c:Ljava/lang/Integer;
    ...
    iget-object v9, v7, Lul;->a:Lfk;

    iget-object v9, v9, Lfk;->b:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-interface {v9, v11, v10, v8}, Lyud;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iput-object v4, v7, Lul;->c:Ljava/lang/Integer;

    iget-object v4, v7, Lul;->g:Lyo5;

    if-eqz v4, :cond_5

    invoke-virtual {v4}, Lyo5;->b()V
    ...
    invoke-interface {v4, v6, v2}, Lyud;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v0, Lc8c;->y:Lks7;

    iget-object v2, v2, Lks7;->n:Lcra;

    sget-object v4, Lcra;->d:Lcra;

    sget-object v6, Lcra;->f:Lcra;

    sget-object v7, Lcra;->h:Lcra;

    sget-object v8, Lcra;->j:Lcra;

    filled-new-array {v4, v6, v7, v8}, [Lcra;
    ...
    invoke-static {v4, v2}, Lwm3;->b1(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    invoke-direct {v2, v0, v5, v4}, Ly7c;-><init>(Lc8c;Lorg/webrtc/SessionDescription;I)V
    ...
    :pswitch_4
    iget-object v2, v1, Lt7c;->b:Lc8c;

    iget-object v3, v1, Lt7c;->c:Lorg/webrtc/SessionDescription;
    ...
    iget-object v5, v2, Lc8c;->w:Lyud;

    invoke-static {v0, v5}, Lrik;->d(Ljava/lang/String;Lyud;)V

    const/4 v6, 0x1

    invoke-virtual {v2, v0, v6}, Lc8c;->e(Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v0

    iget-boolean v7, v2, Lc8c;->f:Z
    ...
    invoke-static {v6, v13, v5}, Lrik;->a(Z[Ljava/lang/String;Lyud;)Lyrj;

    move-result-object v13

    if-eqz v13, :cond_8

    invoke-virtual {v13, v7}, Lyrj;->d(Ljava/util/List;)Z

    move-result v13

    if-eqz v13, :cond_8

    invoke-static {v0, v6, v7, v9, v5}, Lrik;->g(Ljava/lang/String;ZLjava/util/List;Ljava/util/LinkedList;Lyud;)Ljava/lang/String;
    ...
    invoke-interface {v5, v8, v13, v7}, Lyud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v7, v13, v5}, Lrik;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lyud;)Ljava/lang/String;
    ...
    invoke-static {v0, v7, v11, v6, v5}, Lrik;->f(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;ZLyud;)Ljava/lang/String;
    ...
    invoke-static {v0, v7, v11}, Lf52;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v11, v7, v5}, Lrik;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lyud;)Ljava/lang/String;

    move-result-object v0

    iget-boolean v7, v2, Lc8c;->g:Z
    ...
    invoke-static {v0, v7, v11, v13, v5}, Lrik;->f(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;ZLyud;)Ljava/lang/String;
    ...
    iget-boolean v0, v2, Lc8c;->S:Z

    if-eqz v0, :cond_1a

    iget-object v0, v2, Lc8c;->o:Lfc6;

    iget-object v11, v2, Lc8c;->L:Lorg/webrtc/RtpSender;

    iget-object v13, v2, Lc8c;->T:Lruf;

    iget-object v13, v13, Lruf;->a:Ljava/lang/String;

    iget v14, v2, Lc8c;->m:I

    if-eqz v14, :cond_c

    iget v15, v2, Lc8c;->n:I
    ...
    :goto_7
    new-instance v14, Lruf;

    invoke-virtual {v0, v11, v6}, Lfc6;->F(Lorg/webrtc/RtpSender;Lorg/webrtc/Size;)Lso8;

    move-result-object v0

    invoke-direct {v14, v13, v0}, Lruf;-><init>(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {v0, v6, v11}, Lung;->d1(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-static {v13, v9, v15}, Lcog;->B0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v13}, Lung;->p1(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget-object v15, v14, Lruf;->a:Ljava/lang/String;

    invoke-static {v13, v15}, Lh73;->c(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :try_start_2
    invoke-static {v1, v9, v7}, Lcog;->B0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    new-instance v7, Lt75;

    const/16 v9, 0xa

    invoke-direct {v7, v9, v11}, Lt75;-><init>(ILjava/lang/Object;)V

    invoke-static {v0, v7}, Lcn3;->W0(Ljava/util/List;Lrz6;)V

    iget-object v0, v14, Lruf;->b:Ljava/util/List;
    ...
    invoke-virtual {v9}, Lsuf;->a()Ljava/lang/String;
    ...
    invoke-virtual {v14}, Lruf;->a()Ljava/util/ArrayList;
    ...
    invoke-interface {v5, v6, v10, v0}, Lyud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2}, Lc8c;->toString()Ljava/lang/String;
    ...
    invoke-interface {v5, v8, v1}, Lyud;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lc8c;->y:Lks7;

    iget-object v1, v1, Lks7;->n:Lcra;

    sget-object v3, Lcra;->c:Lcra;

    sget-object v5, Lcra;->e:Lcra;

    sget-object v6, Lcra;->g:Lcra;

    sget-object v7, Lcra;->i:Lcra;

    filled-new-array {v3, v5, v6, v7}, [Lcra;
    ...
    invoke-static {v3, v1}, Lwm3;->b1(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, v2, v0, v3}, Ly7c;-><init>(Lc8c;Lorg/webrtc/SessionDescription;I)V
