...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1}, Lzag;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lwag;->b:Lzag;
    ...
    invoke-virtual {v2, p1}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Ln5e;)V
    ...
    invoke-direct {v3, p1, p1, v4}, Lb51;-><init>(III)V

    const/4 p1, -0x1

    invoke-virtual {v2, v3, p1}, Landroidx/recyclerview/widget/RecyclerView;->i(Ll5e;I)V

    const/4 p1, 0x1

    invoke-virtual {v2, p1}, Landroidx/recyclerview/widget/RecyclerView;->setHasFixedSize(Z)V

    iput-object v2, p0, Lwag;->c:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object v0, p0, Lwag;->c:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final onMeasure(II)V
    ...
    iget-object v1, p0, Lwag;->b:Lzag;

    invoke-virtual {v1, p1, p2}, Landroid/view/View;->measure(II)V

    iget-object v2, p0, Lwag;->c:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final onThemeChanged(Lzub;)V
    ...
    invoke-virtual {v0, p1}, Lzag;->onThemeChanged(Lzub;)V
...
.method public final setCustomTheme(Lzub;)V
    ...
    iput-object p1, p0, Lwag;->a:Lzub;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lwag;->onThemeChanged(Lzub;)V

    :cond_0
    return-void
.end method

.method public final setHeaderClickAction(Lpz6;)V
    .locals 3
    ...
    invoke-virtual {v0}, Lzag;->getHeaderButton()Lpcb;
