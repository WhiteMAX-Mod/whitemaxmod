...
.method public constructor <init>(Lxg8;Lxg8;Lxg8;)V
    ...
    iput-object p1, p0, Luwi;->a:Lxg8;

    iput-object p2, p0, Luwi;->b:Lxg8;

    iput-object p3, p0, Luwi;->c:Lxg8;
    ...
    iput-object p2, p0, Luwi;->e:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p2, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p2, p3}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p2, p0, Luwi;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p2, p0, Luwi;->g:Ljava/lang/String;

    new-instance p2, Lswi;

    invoke-direct {p2, p0, p1}, Lswi;-><init>(Luwi;Lxg8;)V

    iput-object p2, p0, Luwi;->h:Lswi;
...
.method public final a(Ljava/lang/String;Lcf4;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Ltwi;-><init>(Luwi;Lcf4;)V

    :goto_0
    iget-object p2, v0, Ltwi;->e:Ljava/lang/Object;
    ...
    iget-object p2, p0, Luwi;->g:Ljava/lang/String;
    ...
    iget-object p2, p0, Luwi;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v5}, Ln35;-><init>(I)V

    invoke-virtual {v2, p1}, Ln35;->g(Ljava/lang/String;)V

    invoke-virtual {v2}, Ln35;->a()Lf70;
    ...
    iput-object p1, v0, Ltwi;->d:Lf70;

    iput v4, v0, Ltwi;->g:I

    invoke-static {p2, v0}, Lzbk;->a(Lozd;Lcf4;)Ljava/lang/Object;
    ...
    :goto_1
    iget-object v2, p0, Luwi;->g:Ljava/lang/String;
    ...
    invoke-static {v2, v5, v7}, Lung;->C0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z

    move-result v2

    if-ne v2, v4, :cond_8

    iget-object p2, p0, Luwi;->a:Lxg8;
    ...
    :cond_9
    iget-object p1, p0, Luwi;->g:Ljava/lang/String;
