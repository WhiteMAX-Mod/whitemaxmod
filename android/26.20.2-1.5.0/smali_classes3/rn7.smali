...
.method public constructor <init>(Landroid/content/Context;Lrz6;)V
    ...
    iput-object p1, p0, Lrn7;->b:Landroid/graphics/drawable/Drawable;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lrn7;->d:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lrn7;->g:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lrn7;->h:Landroid/graphics/Matrix;

    const/4 p1, 0x0

    const/high16 p2, 0x3f400000    # 0.75f

    invoke-static {p1, p2}, Ln0k;->z0(IF)I
...
# virtual methods
.method public final a(Landroid/graphics/Canvas;FFFILpn7;)V
    .locals 13
    ...
    sget-object v9, Lpn7;->d:Lpn7;

    if-eq v2, v9, :cond_1

    iget-object v10, v2, Lpn7;->a:Ljava/util/List;
    ...
    :goto_1
    invoke-interface {v8, v5}, Lrz6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lrn7;->d:Landroid/graphics/Rect;

    invoke-virtual {v7, v6, v8, v9, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v5, p0, Lrn7;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    sget-object v4, Lqn7;->$EnumSwitchMapping$0:[I
    ...
    invoke-static {v4, v9}, Lym3;->Q0(Ljava/lang/Iterable;I)I
    ...
    invoke-virtual/range {v0 .. v6}, Lrn7;->a(Landroid/graphics/Canvas;FFFILpn7;)V

    sget-object v6, Lpn7;->c:Lpn7;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Lrn7;->i:[I

    invoke-direct/range {v2 .. v8}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v0, p0, Lrn7;->h:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lrn7;->g:Landroid/graphics/Paint;
    ...
    sget-object v8, Lpn7;->d:Lpn7;

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Lrn7;->a(Landroid/graphics/Canvas;FFFILpn7;)V
