...
.method public constructor <init>(La1a;)V
    ...
    iget-object p1, p0, Lvw;->c:Ljava/util/List;
    ...
    :cond_0
    iget-object p1, p0, Lvw;->d:Ljava/util/List;

    if-nez p1, :cond_1

    sget-object p1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p1, p0, Lvw;->d:Ljava/util/List;

    :cond_1
    iget-object p1, p0, Lvw;->e:Ljava/util/List;

    if-nez p1, :cond_2

    sget-object p1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p1, p0, Lvw;->e:Ljava/util/List;
...
.method public final b(La1a;Ljava/lang/String;)V
    ...
    :pswitch_0
    invoke-static/range {p1 .. p1}, Llhe;->Z(La1a;)I
    ...
    iput-object v2, v0, Lvw;->e:Ljava/util/List;
    ...
    iget-object v4, v0, Lvw;->e:Ljava/util/List;
    ...
    invoke-virtual/range {p1 .. p1}, La1a;->a1()Ljava/lang/String;
    ...
    :cond_6
    invoke-static/range {p1 .. p1}, Llhe;->n0(La1a;)Ljava/lang/String;
    ...
    invoke-static {v3, v6, v7}, Llhe;->k0(La1a;J)J
    ...
    invoke-direct {v5, v10, v11, v12, v13}, Lsi0;-><init>(JLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Ln30;->g(La1a;)Ln30;

    move-result-object v1

    iput-object v1, v0, Lvw;->d:Ljava/util/List;
    ...
    iput-object v1, v0, Lvw;->c:Ljava/util/List;
    ...
    invoke-virtual {v3}, La1a;->W0()J

    move-result-wide v1

    iput-wide v1, v0, Lvw;->f:J
...
.method public final h()Ljava/util/List;
    ...
    iget-object v0, p0, Lvw;->d:Ljava/util/List;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lvw;->d:Ljava/util/List;

    invoke-static {v1}, Lfg8;->j(Ljava/util/Collection;)I

    move-result v1

    iget-object v2, p0, Lvw;->e:Ljava/util/List;

    invoke-static {v2}, Lfg8;->j(Ljava/util/Collection;)I

    move-result v2

    iget-wide v3, p0, Lvw;->f:J
