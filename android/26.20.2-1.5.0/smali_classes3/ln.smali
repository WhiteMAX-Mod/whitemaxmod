...
.method public synthetic constructor <init>(Lcom/my/tracker/applifecycle/o/d;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lln;->a:Ljava/lang/String;

    iput-object p3, p0, Lln;->c:Ljava/lang/Object;

    iput-object p4, p0, Lln;->d:Ljava/io/Serializable;

    iput-object p5, p0, Lln;->e:Ljava/io/Serializable;

    iput-object p6, p0, Lln;->f:Ljava/io/Serializable;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;Lno;Lmn;Lru/ok/android/api/core/ApiInvocationException;Lo6e;Lo6e;)V
    .locals 0
...
.method public d(Lpn;)Lpn;
    ...
    iget-object v1, v1, Lmn;->c:Lpo;

    iget-object v2, p0, Lln;->d:Ljava/io/Serializable;

    check-cast v2, Lru/ok/android/api/core/ApiInvocationException;

    iget-object v3, p0, Lln;->e:Ljava/io/Serializable;

    check-cast v3, Lo6e;

    iget-object v4, p0, Lln;->f:Ljava/io/Serializable;

    check-cast v4, Lo6e;

    iget-object v5, p1, Lpn;->c:Ljava/lang/String;

    iget-object v6, p0, Lln;->a:Ljava/lang/String;
    ...
    iget-object v6, p1, Lpn;->a:Ljava/lang/String;

    iget-object p1, p1, Lpn;->b:Ljava/lang/String;

    const/4 v7, 0x0

    invoke-direct {v5, v6, p1, v7, v7}, Lpn;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v6, Lno;->d:Lno;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-eq v0, v6, :cond_7

    sget-object v7, Lno;->c:Lno;
    ...
    :cond_2
    :try_start_1
    iget-object v5, p1, Lpn;->b:Ljava/lang/String;
    ...
    :cond_4
    invoke-interface {v1, p1}, Lpo;->d(Lpn;)Lpn;
    ...
    :goto_2
    iget-object v5, v1, Lpn;->c:Ljava/lang/String;
...
.method public invoke(Lcom/my/tracker/core/EngineCore$InsertEventTools;)[B
    ...
    iget-object v0, p0, Lln;->d:Ljava/io/Serializable;

    move-object v4, v0

    check-cast v4, Ljava/lang/String;

    iget-object v0, p0, Lln;->e:Ljava/io/Serializable;

    move-object v5, v0

    check-cast v5, Ljava/lang/String;

    iget-object v0, p0, Lln;->f:Ljava/io/Serializable;

    move-object v6, v0

    check-cast v6, Ljava/lang/String;

    iget-object v2, p0, Lln;->a:Ljava/lang/String;
