...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Logb;->a:Landroid/graphics/Paint;
    ...
    invoke-static {p0, v0, v3}, Lbt4;->P(Landroid/view/View;Landroid/text/TextPaint;Lb6h;)V

    invoke-virtual {v0, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object v0, p0, Logb;->b:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Logb;->p:Ljava/lang/String;

    new-instance v0, Lkm;

    invoke-direct {v0, p0}, Lkm;-><init>(Logb;)V

    iput-object v0, p0, Logb;->r:Lkm;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Logb;->t:Landroid/graphics/RectF;

    new-instance v0, Landroid/widget/OverScroller;

    invoke-direct {v0, p1}, Landroid/widget/OverScroller;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Logb;->v:Landroid/widget/OverScroller;
    ...
    invoke-direct {p0, p1}, Logb;->setIntAngle(I)V
...
.method private final getIntAngle()I
    ...
    sget-object v0, Logb;->z:[Lre8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Logb;->r:Lkm;
...
.method private final setAngleFromScroll(I)V
    ...
    invoke-direct {p0}, Logb;->getDegPerPx()F
    ...
    invoke-direct {v1, v0}, Lmk4;-><init>(F)V
...
.method public final b()V
    ...
    invoke-direct {p0, v1}, Logb;->setIntAngle(I)V

    invoke-virtual {p0}, Landroid/view/View;->invalidate()V

    invoke-virtual {p0, v0}, Logb;->a(F)I

    move-result v0

    iput v0, p0, Logb;->y:I

    iget-object v0, p0, Logb;->u:Lngb;
    ...
    iget-object v0, v0, Ltl4;->i:Lcx5;

    new-instance v2, Lmk4;

    invoke-direct {v2, v1}, Lmk4;-><init>(F)V
...
.method public final c(F)V
    ...
    invoke-direct {p0, v0}, Logb;->setIntAngle(I)V

    invoke-virtual {p0}, Landroid/view/View;->invalidate()V

    invoke-virtual {p0, p1}, Logb;->a(F)I
...
.method public final computeScroll()V
    ...
    iget-object v0, p0, Logb;->v:Landroid/widget/OverScroller;
    ...
    invoke-direct {p0, v0}, Logb;->setAngleFromScroll(I)V
    ...
    :cond_0
    iget-boolean v0, p0, Logb;->x:Z

    if-eqz v0, :cond_1

    const/4 v0, 0x0

    iput-boolean v0, p0, Logb;->x:Z
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v12, v0, Logb;->k:F

    iget-object v14, v0, Logb;->a:Landroid/graphics/Paint;

    iget-object v15, v0, Logb;->t:Landroid/graphics/RectF;

    move/from16 v16, v3

    if-ge v10, v11, :cond_6

    iget v11, v0, Logb;->l:I
    ...
    invoke-static {v3, v11, v13}, Lbt4;->n(FFF)F
    ...
    invoke-static {v11, v13, v3}, Lbt4;->o(III)I
    ...
    invoke-direct {v0}, Logb;->getIntAngle()I
    ...
    iget-object v4, v0, Logb;->p:Ljava/lang/String;

    iget-object v5, v0, Logb;->b:Landroid/text/TextPaint;
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Logb;->b:Landroid/text/TextPaint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Logb;->v:Landroid/widget/OverScroller;
    ...
    :cond_0
    iget-object v0, p0, Logb;->w:Landroid/view/VelocityTracker;
    ...
    invoke-direct {p0, p1}, Logb;->setAngleFromScroll(I)V
    ...
    :cond_2
    iget-object v1, p0, Logb;->w:Landroid/view/VelocityTracker;
    ...
    :cond_3
    iget-object p1, p0, Logb;->w:Landroid/view/VelocityTracker;
    ...
    iput-object v1, p0, Logb;->w:Landroid/view/VelocityTracker;
    ...
    invoke-static {p1, v0, v3}, Lbt4;->n(FFF)F
    ...
    invoke-virtual {v1, v0}, Ltl4;->A(Lvl4;)V

    iget-object v0, v1, Ltl4;->i:Lcx5;
    ...
    iput-object v0, p0, Logb;->w:Landroid/view/VelocityTracker;
...
.method public final setListener(Lngb;)V
    .locals 0

    iput-object p1, p0, Logb;->u:Lngb;
