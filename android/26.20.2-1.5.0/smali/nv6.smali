...
.method public constructor <init>(Ljava/util/Set;)V
    ...
    iput-object p1, p0, Lnv6;->a:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lnv6;->a:Ljava/util/ArrayList;

    invoke-static {p1, v0}, Lwm3;->h1(Ljava/lang/Iterable;Ljava/util/Collection;)V
...
.method public final a(Lq0d;Ljava/lang/String;Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lnv6;->a:Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-interface {v1, p1, p2, p3}, Lt0d;->a(Lq0d;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_0
    ...
    invoke-static {v2, v3, v1}, Le46;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b(Lrcf;)V
    ...
    :try_start_0
    invoke-interface {v1, p1}, Lkce;->b(Lrcf;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final c(Lq0d;)V
    ...
    :try_start_0
    invoke-interface {v1, p1}, Lt0d;->c(Lq0d;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final d(Lq0d;Ljava/lang/String;Ljava/lang/Throwable;Ljava/util/Map;)V
    ...
    :try_start_0
    invoke-interface {v1, p1, p2, p3, p4}, Lt0d;->d(Lq0d;Ljava/lang/String;Ljava/lang/Throwable;Ljava/util/Map;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final e(Lq0d;Ljava/lang/String;Z)V
    ...
    :try_start_0
    invoke-interface {v1, p1, p2, p3}, Lt0d;->e(Lq0d;Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final f(Lq0d;Ljava/lang/Throwable;)V
    ...
    :try_start_0
    invoke-interface {v1, p1, p2}, Lkce;->f(Lq0d;Ljava/lang/Throwable;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final g(Lq0d;)V
    ...
    :try_start_0
    invoke-interface {v1, p1}, Lkce;->g(Lq0d;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final h(Lq0d;)V
    ...
    :try_start_0
    invoke-interface {v1, p1}, Lkce;->h(Lq0d;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final i(Lq0d;Ljava/lang/String;)Z
    ...
    invoke-interface {v1, p1, p2}, Lt0d;->i(Lq0d;Ljava/lang/String;)Z
...
.method public final j(Lq0d;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-interface {v1, p1, p2}, Lt0d;->j(Lq0d;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final k(Lq0d;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-interface {v1, p1, p2}, Lt0d;->k(Lq0d;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
