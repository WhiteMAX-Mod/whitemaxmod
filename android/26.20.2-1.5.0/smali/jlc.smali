...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljlc;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V
    ...
    .line 3
    iput-wide p2, p0, Ljlc;->b:J

    .line 4
    iput-wide p4, p0, Ljlc;->c:J

    .line 5
    iput p6, p0, Ljlc;->d:F

    .line 6
    iput-wide p7, p0, Ljlc;->e:J

    .line 7
    iput p9, p0, Ljlc;->f:I

    .line 8
    iput-object p10, p0, Ljlc;->g:Ljava/lang/CharSequence;

    .line 9
    iput-wide p11, p0, Ljlc;->h:J
    ...
    :goto_0
    iput-object p1, p0, Ljlc;->i:Ljava/util/AbstractCollection;
    ...
    .line 14
    iput-object p1, p0, Ljlc;->k:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Ljlc;->g:Ljava/lang/CharSequence;

    .line 23
    sget-object v0, Lilc;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 26
    :cond_0
    iput-object v0, p0, Ljlc;->i:Ljava/util/AbstractCollection;
    ...
    iput-object v0, p0, Ljlc;->k:Landroid/os/Bundle;
...
.method public static a(Landroid/media/session/PlaybackState;)Ljlc;
    .locals 21
    ...
    :cond_0
    invoke-static {v3}, Lilc;->a(Landroid/media/session/PlaybackState$CustomAction;)Lilc;
    ...
    invoke-direct/range {v4 .. v20}, Ljlc;-><init>(IJJFJILjava/lang/CharSequence;JLjava/util/ArrayList;JLandroid/os/Bundle;)V

    iput-object v0, v4, Ljlc;->l:Landroid/media/session/PlaybackState;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Ljlc;->g:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Ljlc;->i:Ljava/util/AbstractCollection;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-wide v0, p0, Ljlc;->e:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object v0, p0, Ljlc;->g:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    iget-object p2, p0, Ljlc;->i:Ljava/util/AbstractCollection;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    iget-wide v0, p0, Ljlc;->j:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    iget-object p2, p0, Ljlc;->k:Landroid/os/Bundle;
