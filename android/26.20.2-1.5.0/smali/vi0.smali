...
.method public constructor <init>(Lxg8;Lxg8;)V
    ...
    iput-object p1, p0, Lvi0;->a:Lxg8;

    iput-object p2, p0, Lvi0;->b:Lxg8;

    return-void
.end method

.method public static final a(Lvi0;[BLm4i;)Lawg;
    .locals 2

    new-instance p0, Lawg;
    ...
    invoke-virtual {p2}, Lm4i;->c()I

    move-result v0

    invoke-virtual {p2}, Lm4i;->a()I

    move-result v1

    invoke-direct {p0, p1, v0, v1}, Lawg;-><init>(Ljava/lang/String;II)V

    invoke-virtual {p2}, Lm4i;->b()I

    move-result p1

    invoke-virtual {p0, p1}, Lawg;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    invoke-virtual {p2}, Lm4i;->d()Z
    ...
    invoke-virtual {p0, p1}, Lawg;->c(Landroid/graphics/Xfermode;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lsoh;->R(II)V
    ...
    invoke-direct/range {v11 .. v18}, Ll4i;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Laj0;)Ljava/util/LinkedHashMap;
    .locals 28
    ...
    sget-object v9, Lil2;->a:Ljava/nio/charset/Charset;
    ...
    new-instance v14, Laj0;

    invoke-virtual {v10, v2}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    iget-object v8, v11, Lui0;->a:Ljava/lang/String;
    ...
    invoke-direct {v14, v2}, Laj0;-><init>(Ljava/lang/String;)V

    sget-object v2, Lxg3;->j:Lwj3;

    move-object/from16 v8, p1

    invoke-virtual {v2, v8}, Lwj3;->f(Landroid/content/Context;)Lxg3;

    move-result-object v2

    iget-object v2, v2, Lxg3;->d:Ljava/lang/Object;
    ...
    iget-boolean v2, v11, Lui0;->b:Z

    invoke-static {v15, v2}, Lpy6;->u(Lcvb;Z)Lzub;

    move-result-object v2

    invoke-interface {v2}, Lzub;->B()Lpub;

    move-result-object v2

    iget-object v2, v2, Lpub;->a:Lufh;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v11, v2, Lufh;->f:Ljava/lang/Object;

    check-cast v11, [I

    iget v13, v2, Lufh;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v14}, Laj0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v13}, Ltik;->c(I)I

    move-result v26

    invoke-direct/range {v20 .. v26}, Lm4i;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v13, v11, v8}, Lk4i;-><init>([IF)V
    ...
    iget-object v8, v2, Lufh;->e:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v4, v8}, Lvi0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v4}, Lvi0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lk4i;-><init>([IF)V
    ...
    invoke-static {v0, v11}, Lcv;->R0(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Ln4i;

    invoke-direct/range {v20 .. v26}, Ln4i;-><init>(Lm4i;Lk4i;Lk4i;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lm4i;Lgvg;)Ljava/lang/Object;
    .locals 7

    iget-object v0, p0, Lvi0;->a:Lxg8;
