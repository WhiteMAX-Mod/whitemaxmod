...
.method public constructor <init>(Landroid/view/View;Lh18;Lrz6;)V
    ...
    iput-object p1, p0, Lt6g;->a:Landroid/view/View;

    iput-object p2, p0, Lt6g;->b:Lh18;

    iput-object p3, p0, Lt6g;->c:Lrz6;
    ...
    invoke-direct {p2, p3, p0}, Lske;-><init>(ILjava/lang/Object;)V
    ...
    iput-object p3, p0, Lt6g;->h:Landroid/graphics/Rect;
    ...
    :goto_1
    iput-object v0, p0, Lt6g;->i:Landroid/graphics/Rect;

    sget-object p3, Ldki;->a:Ljava/util/WeakHashMap;

    invoke-static {p1, p2}, Ltji;->l(Landroid/view/View;Li7b;)V
    ...
    sget-object p2, Li18;->a:Lioa;

    invoke-virtual {p2, p0}, Lioa;->a(Ljava/lang/Object;)V

    :cond_2
    new-instance p2, Ls6g;

    invoke-direct {p2, p0}, Ls6g;-><init>(Lt6g;)V
...
# virtual methods
.method public final a(Lf18;Lfx0;)V
    .locals 3
    ...
    iget-object v0, p0, Lt6g;->i:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object p2, p0, Lt6g;->h:Landroid/graphics/Rect;
...
.method public c(Laaj;)V
    ...
    iget-object v3, v0, Lt6g;->b:Lh18;

    iget v4, v3, Lh18;->a:I

    const/16 v5, 0x80

    iget-object v6, v0, Lt6g;->h:Landroid/graphics/Rect;

    const-string v7, "null cannot be cast to non-null type android.view.ViewGroup.MarginLayoutParams"

    iget-object v8, v0, Lt6g;->i:Landroid/graphics/Rect;
    ...
    iget-object v13, v0, Lt6g;->a:Landroid/view/View;

    iget v14, v0, Lt6g;->d:I

    if-eqz v4, :cond_5

    or-int v15, v5, v14

    invoke-virtual {v2, v15}, Lw9j;->f(I)Lf18;

    move-result-object v15

    iget v15, v15, Lf18;->a:I
    ...
    invoke-virtual {v2, v5}, Lw9j;->f(I)Lf18;
    ...
    invoke-virtual {v2, v14}, Lw9j;->f(I)Lf18;
    ...
    :cond_11
    :goto_2
    iget-object v2, v3, Lh18;->d:Lfx0;

    if-eqz v2, :cond_12

    invoke-virtual {v0, v1, v2}, Lt6g;->b(Laaj;Lfx0;)V

    :cond_12
    iget-object v2, v0, Lt6g;->c:Lrz6;
