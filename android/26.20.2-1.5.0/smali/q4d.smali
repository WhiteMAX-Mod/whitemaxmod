...
.method public constructor <init>(Lunc;)V
    ...
    .line 2
    iput-object p1, p0, Lq4d;->b:Ljava/lang/Object;

    .line 3
    sget-object p1, Lfdc;->c:Lfdc;

    iput-object p1, p0, Lq4d;->c:Ldo0;

    return-void
.end method

.method public constructor <init>(Lxg8;I)V
    .locals 0
...
.method public final b(Ljava/lang/String;Lju4;Landroid/os/Bundle;)Lru4;
    ...
    invoke-direct {v2, v4}, Lg6b;-><init>(I)V

    new-instance v4, Lg6b;

    const/16 v5, 0x17

    invoke-direct {v4, v5}, Lg6b;-><init>(I)V

    invoke-direct {v0, v2, v4}, Lnu4;-><init>(Lpz6;Lpz6;)V

    sget-object v2, Lfdc;->c:Lfdc;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v2, Lfdc;->d:Lju4;
    ...
    invoke-static {p3, v0}, Lqka;->U(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "media_id"

    invoke-static {p3, v1}, Lqka;->K(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Long;

    move-result-object v1

    iget-object v2, p0, Lq4d;->b:Ljava/lang/Object;
    ...
    :cond_1
    invoke-static {v2}, Luk5;->valueOf(Ljava/lang/String;)Luk5;
    ...
    invoke-direct {v5, v6}, Lg6b;-><init>(I)V

    new-instance v6, Lg6b;

    const/16 v7, 0x19

    invoke-direct {v6, v7}, Lg6b;-><init>(I)V

    invoke-direct {v4, v5, v6}, Lnu4;-><init>(Lpz6;Lpz6;)V
    ...
    invoke-direct {v5, v0, v1, v2, v6}, Ljn;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-static {p3, v2}, Lqka;->S(Landroid/os/Bundle;Ljava/lang/String;)J

    move-result-wide v5

    const-string v2, "chat_id"

    invoke-static {p3, v2}, Lqka;->K(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-direct {v4, v2, v1, v7}, Lpse;-><init>(Ljava/lang/String;Ltr8;I)V
    ...
    invoke-static {p3, v1}, Lqka;->I(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-direct/range {v4 .. v11}, Ledc;-><init>(JZZLjava/lang/Long;Lpse;Ljava/lang/Long;)V
    ...
    invoke-static {v0, p2}, Ldtg;->n(Ljava/lang/String;Lju4;)Ljava/lang/String;
    ...
    invoke-static {p3, v6}, Lqka;->S(Landroid/os/Bundle;Ljava/lang/String;)J

    move-result-wide v8

    invoke-virtual {v0, v6, v8, v9}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V

    invoke-static {p3, v5}, Lqka;->U(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Luhk;->b(Ljava/lang/String;)Lhp2;
    ...
    invoke-static {p3, v5}, Lqka;->K(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Long;
    ...
    :cond_b
    invoke-static {p3, v4}, Lqka;->K(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-static {v1, v5, v6}, Lung;->d1(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-static {p3, v1}, Lqka;->T(Landroid/os/Bundle;Ljava/lang/String;)[J
    ...
    invoke-static {p3, v1}, Lqka;->J(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-direct {v1, v0, v4}, Lef1;-><init>(Landroid/os/Bundle;I)V
    ...
    invoke-direct {v0, v8, v9, v10, v11}, Les3;-><init>(JJ)V
    ...
    invoke-direct {v1, v4, v0}, Lef1;-><init>(Landroid/os/Bundle;I)V

    goto/16 :goto_7

    :cond_20
    sget-object v0, Lip2;->e:Lju4;
    ...
    iget-object v0, p0, Lq4d;->b:Ljava/lang/Object;
    ...
    invoke-direct {v1, v4}, Lhi2;-><init>(I)V
    ...
    invoke-static {p3, v5}, Lqka;->S(Landroid/os/Bundle;Ljava/lang/String;)J
    ...
    invoke-static {v4}, Logk;->d(Ljava/lang/String;)Ls4d;
    ...
    invoke-direct {v6, v0, v1, v4, v5}, Luk9;-><init>(JLs4d;I)V
    ...
    invoke-direct {v6, v0, v1, v4}, Lk40;-><init>(JI)V

    goto :goto_a

    :cond_25
    sget-object v0, Lt4d;->f:Lju4;
    ...
    invoke-static {v0}, Logk;->d(Ljava/lang/String;)Ls4d;

    move-result-object v0

    sget-object v4, Ls4d;->c:Ls4d;

    if-ne v0, v4, :cond_26

    iget-object v4, p0, Lq4d;->b:Ljava/lang/Object;
    ...
    invoke-static {v1}, Lmgk;->a(Ljava/lang/String;)Lr4d;

    move-result-object v1

    new-instance v4, Lyn2;

    invoke-direct {v4, v5, v6, v0, v1}, Lyn2;-><init>(JLs4d;Lr4d;)V
    ...
    invoke-direct/range {v4 .. v9}, Lxn2;-><init>(JJLjava/lang/String;)V

    goto :goto_b

    :cond_28
    sget-object v0, Lt4d;->h:Lju4;
    ...
    invoke-static {v3, p2}, Lhz7;->g(Ljava/lang/String;Lju4;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5, p1, p2, v0}, Lyjb;->c(Lnv8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
