...
.field public final c:Lgbj;

.field public final d:Lwxg;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxxg;->e:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lgbj;)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Lwxg;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lxxg;->a:Landroid/content/Context;

    iput-object p2, p0, Lxxg;->c:Lgbj;

    iput-object v0, p0, Lxxg;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lxxg;->d:Lwxg;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lxxg;->e:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lbu8;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lxxg;->e:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lbu8;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lbbj;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lbbj;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lxxg;->a:Landroid/content/Context;

    iget-object v1, p0, Lxxg;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lxxg;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lxxg;->f(Landroid/app/job/JobInfo;)Lbbj;
    ...
    invoke-static {v1, v2}, Lxxg;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lxxg;->c:Lgbj;

    iget-object v0, v0, Lgbj;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->x()Lvxg;

    move-result-object v0

    iget-object v1, v0, Lvxg;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lanf;->c(Lly6;)V
...
.method public final varargs e([Lwbj;)V
    ...
    iget-object v7, v5, Lwbj;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lybj;->o(Ljava/lang/String;)Lwbj;
    ...
    sget-object v9, Lxxg;->e:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lbu8;->c0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Ldqa;->y(Lwbj;)Lbbj;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->x()Lvxg;

    move-result-object v7

    invoke-virtual {v7, v6}, Lvxg;->g(Lbbj;)Ltxg;
    ...
    iget-object v9, v2, Lf17;->a:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lbo7;

    invoke-direct {v10, v2, v8}, Lbo7;-><init>(Lf17;I)V
    ...
    invoke-direct {v8, v11, v10}, Lrfa;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v9, v8}, Lkhe;->s(Lpz6;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lbbj;->a:Ljava/lang/String;

    iget v6, v6, Lbbj;->b:I

    invoke-direct {v7, v9, v6, v8}, Ltxg;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lgbj;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->x()Lvxg;

    move-result-object v6

    invoke-virtual {v6, v7}, Lvxg;->i(Ltxg;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lxxg;->g(Lwbj;I)V
...
.method public final g(Lwbj;I)V
    .locals 18
    ...
    iget-object v3, v1, Lxxg;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lxxg;->d:Lwxg;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lwbj;->j:Ln54;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lwbj;->a:Ljava/lang/String;
    ...
    sget-object v14, Lwxg;->b:Ljava/lang/String;

    invoke-static {v6}, Lr16;->C(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lbu8;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lwbj;->l:Lwj0;

    sget-object v8, Lwj0;->b:Lwj0;
    ...
    invoke-virtual {v10}, Lm54;->b()Z

    move-result v11

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    invoke-virtual {v10}, Lm54;->a()Landroid/net/Uri;
    ...
    invoke-static {v4}, Lix0;->v(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lbu8;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lbu8;->c0(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lwbj;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lwbj;->r:Lp1c;

    sget-object v5, Lp1c;->a:Lp1c;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Lbu8;->n(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lxxg;->g(Lwbj;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lbu8;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lxxg;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lxxg;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Lxxg;->c:Lgbj;

    iget-object v5, v4, Lgbj;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->A()Lybj;

    move-result-object v5

    invoke-virtual {v5}, Lybj;->k()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lbu8;->r(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lgbj;->b:Lkz3;
