...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lngd;->a:Lgwa;

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lgwa;
...
.method public static b(Logd;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lug8;Landroid/content/Context;Lzub;)Llgd;
    .locals 19

    invoke-virtual/range {p0 .. p0}, Logd;->d()I

    move-result v0

    add-int/lit8 v0, v0, 0x2

    invoke-virtual/range {p0 .. p0}, Logd;->c()I
    ...
    invoke-virtual/range {p0 .. p0}, Logd;->f()I
    ...
    invoke-static/range {v7 .. v12}, Lb6h;->d(Lb6h;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Lhj5;I)V

    invoke-interface/range {p5 .. p5}, Lzub;->getText()Luub;
    ...
    invoke-static/range {v3 .. v12}, Lug8;->a(Lug8;Ljava/lang/CharSequence;Landroid/text/TextPaint;IIZLandroid/text/TextUtils$TruncateAt;FZI)Landroid/text/Layout;
    ...
    invoke-static/range {v13 .. v18}, Lb6h;->d(Lb6h;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Lhj5;I)V
    ...
    invoke-virtual/range {p0 .. p0}, Logd;->h()I
    ...
    invoke-direct/range {p0 .. p5}, Llgd;-><init>(Landroid/text/Layout;Landroid/text/Layout;III)V
...
.method public static c(Lone/me/sdk/uikit/qr/QrCodeGenerator;Ljava/lang/String;ILzub;)Lr4c;
    .locals 10
    ...
    invoke-direct {p0, p1, p3}, Lr4c;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v3, p1}, Lw9b;->l(ILjava/lang/String;)Ljava/lang/String;
...
.method public static e(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILzub;)V
    .locals 16
    ...
    invoke-interface/range {p8 .. p8}, Lzub;->k()Lg40;

    move-result-object v7

    iget-object v7, v7, Lg40;->c:Ljava/lang/Object;

    check-cast v7, Lxx3;

    iget v7, v7, Lxx3;->b:I

    invoke-static {v7, v0}, Ldqa;->W(ILandroid/graphics/drawable/Drawable;)V
    ...
    iget-object v4, v4, Lg40;->c:Ljava/lang/Object;

    check-cast v4, Lxx3;

    iget-object v4, v4, Lxx3;->i:Ljava/lang/Object;
    ...
    invoke-static {v14, v13}, Lcv;->R0(I[I)Ljava/lang/Integer;
    ...
    :goto_0
    invoke-static {v3, v13}, Lcv;->R0(I[I)Ljava/lang/Integer;
    ...
    invoke-static {v9, v13}, Lcv;->R0(I[I)Ljava/lang/Integer;
    ...
    :goto_2
    invoke-static {v12, v13}, Lcv;->R0(I[I)Ljava/lang/Integer;
...
# virtual methods
.method public final g(Landroid/content/Context;ILze6;Lyzg;Lug8;Lsgd;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lcf4;)Ljava/lang/Object;
    .locals 35
    ...
    const-string v12, "QR generation failed for type: "
    ...
    invoke-direct {v3, v1, v2}, Lpgd;-><init>(Lone/me/sdk/uikit/qr/QrCodeGenerator;Lcf4;)V

    goto :goto_0

    :goto_1
    iget-object v2, v13, Lpgd;->j:Ljava/lang/Object;

    iget v3, v13, Lpgd;->l:I

    const-string v14, "sharedQr"
    ...
    iget-object v0, v13, Lpgd;->i:Landroid/graphics/Bitmap;

    iget-object v3, v13, Lpgd;->h:Landroid/graphics/Bitmap;

    iget-object v4, v13, Lpgd;->g:Ljava/lang/String;

    iget-object v5, v13, Lpgd;->f:Lsgd;

    iget-object v6, v13, Lpgd;->e:Lze6;

    iget-object v7, v13, Lpgd;->d:Landroid/content/Context;
    ...
    :cond_3
    invoke-virtual {v9, v6}, Lwj3;->h(Landroid/content/Context;)Lcvb;

    move-result-object v2

    iget-object v7, v2, Lcvb;->a:Lzub;

    new-instance v18, Logd;
    ...
    invoke-direct/range {v18 .. v27}, Logd;-><init>(IIIIIIIII)V
    ...
    invoke-static/range {v2 .. v7}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b(Logd;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lug8;Landroid/content/Context;Lzub;)Llgd;

    move-result-object v10

    invoke-virtual {v2, v10}, Logd;->a(Llgd;)I

    move-result v3

    invoke-virtual {v2}, Logd;->i()I
    ...
    invoke-static/range {p1 .. p1}, Ln9b;->D(Landroid/content/Context;)I
    ...
    :goto_3
    invoke-virtual {v2, v3}, Logd;->j(F)Logd;
    ...
    :try_start_1
    invoke-virtual {v2}, Logd;->d()I

    move-result v6

    invoke-static {v1, v15, v6, v7}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->c(Lone/me/sdk/uikit/qr/QrCodeGenerator;Ljava/lang/String;ILzub;)Lr4c;

    move-result-object v6

    iget-object v4, v6, Lr4c;->a:Ljava/lang/Object;

    move-object/from16 v22, v4

    check-cast v22, Landroid/graphics/Bitmap;

    iget-object v4, v6, Lr4c;->b:Ljava/lang/Object;
    ...
    invoke-static {v3, v1}, Llgd;->a(Llgd;I)Llgd;

    move-result-object v1

    invoke-virtual {v2, v1}, Logd;->a(Llgd;)I
    ...
    invoke-virtual/range {v18 .. v18}, Logd;->i()I
    ...
    invoke-interface {v7}, Lzub;->o()Lwub;

    move-result-object v8

    iget-object v8, v8, Lwub;->e:Ljava/lang/Object;
    ...
    invoke-virtual/range {v18 .. v18}, Logd;->c()I
    ...
    :try_start_3
    invoke-static/range {v2 .. v10}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->e(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILzub;)V

    move-object/from16 v19, v4

    invoke-virtual/range {p5 .. p5}, Llgd;->d()Landroid/text/Layout;

    move-result-object v20

    invoke-virtual/range {p5 .. p5}, Llgd;->c()Landroid/text/Layout;

    move-result-object v21

    invoke-virtual/range {v18 .. v18}, Logd;->e()I

    move-result v23

    invoke-virtual/range {p5 .. p5}, Llgd;->b()I

    move-result v24

    invoke-virtual/range {p5 .. p5}, Llgd;->e()I
    ...
    :try_start_4
    invoke-static/range {v19 .. v28}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->f(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/text/Layout;Landroid/graphics/Bitmap;IIIIII)V
    :try_end_4
    ...
    :try_start_5
    invoke-virtual/range {v18 .. v18}, Logd;->b()I
    ...
    invoke-virtual/range {v18 .. v18}, Logd;->g()I
    ...
    invoke-virtual/range {p3 .. p3}, Lze6;->n()Ljava/io/File;
    ...
    invoke-static {v2, v15}, Lze6;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    invoke-virtual {v0, v6}, Lwj3;->f(Landroid/content/Context;)Lxg3;
    ...
    invoke-static {v2}, Lv01;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_a
    iput-object v6, v1, Lpgd;->d:Landroid/content/Context;
    :try_end_a
    ...
    :try_start_d
    iput-object v4, v1, Lpgd;->g:Ljava/lang/String;
    :try_end_d
    ...
    :try_start_e
    iput-object v8, v1, Lpgd;->h:Landroid/graphics/Bitmap;

    iput-object v7, v1, Lpgd;->i:Landroid/graphics/Bitmap;

    const/4 v9, 0x1

    iput v9, v1, Lpgd;->l:I

    invoke-static {v10, v2, v1}, Llhe;->B0(Lki4;Lf07;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v2, v7, v0}, Ljgd;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;Lzub;)V

    new-instance v0, Lr4c;

    invoke-direct {v0, v3, v1}, Lr4c;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->e:Lr4c;
    :try_end_f
    ...
    invoke-virtual {v1, v2, v0}, Lgwa;->e(Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v5}, Lze6;->n()Ljava/io/File;
    ...
    invoke-static {v0, v15}, Lze6;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
