...
.method public static q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lxoh;->s0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lxoh;->s0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static r0([Los6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Los6;->b()Landroid/net/Uri;
...
.method public static s0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    .locals 2
...
.method public final T(Landroid/content/Context;Lls6;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lms6;->c()Ljava/lang/String;
    ...
    invoke-static {p2, p4}, Lxoh;->q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final U(Landroid/content/Context;[Los6;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Lxoh;->r0([Los6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, Lxoh;->q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final V(ILandroid/content/Context;Ljava/util/List;)Landroid/graphics/Typeface;
    .locals 5
    ...
    invoke-static {v0, p2}, Lxoh;->r0([Los6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p2}, Lxoh;->r0([Los6;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p1}, Lxoh;->q0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final X(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
    .locals 0
...
.method public final Z([Los6;I)Los6;
    .locals 0
