...
.method public final b(Ld6e;)V
    ...
    iget-object v3, p1, Ld6e;->h:Ld6e;

    const/4 v4, 0x0

    if-eqz v3, :cond_0

    iget-object v3, p1, Ld6e;->i:Ld6e;

    if-nez v3, :cond_0

    iput-object v4, p1, Ld6e;->h:Ld6e;

    :cond_0
    iput-object v4, p1, Ld6e;->i:Ld6e;
    ...
    iget-object v1, v3, Lufh;->f:Ljava/lang/Object;
    ...
    iget-object v6, v5, Lw34;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v3, v2}, Lufh;->L(Landroid/view/View;)V
    :try_end_0
    ...
    :cond_4
    :try_start_1
    invoke-virtual {v4, v6}, Lcg3;->d(I)Z

    move-result v8

    if-eqz v8, :cond_5

    invoke-virtual {v4, v6}, Lcg3;->g(I)Z

    invoke-virtual {v3, v2}, Lufh;->L(Landroid/view/View;)V

    invoke-virtual {v5, v6}, Lw34;->y(I)V
    :try_end_1
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView;->c:Lu5e;

    invoke-virtual {v4, v3}, Lu5e;->l(Ld6e;)V

    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView;->c:Lu5e;

    invoke-virtual {v4, v3}, Lu5e;->i(Ld6e;)V
...
.method public abstract c(Ld6e;)V
.end method
