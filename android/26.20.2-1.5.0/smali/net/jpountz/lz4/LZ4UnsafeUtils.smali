...
.method public static commonBytes([BIII)I
    ...
    invoke-static {p2, p0}, Lrsh;->e(I[B)J

    move-result-wide v1

    invoke-static {p1, p0}, Lrsh;->e(I[B)J
    ...
    :cond_0
    sget-object p3, Lr3i;->a:Ljava/nio/ByteOrder;
    ...
    invoke-static {p1, p0}, Lrsh;->a(I[B)B

    move-result p1

    add-int/lit8 v2, p2, 0x1

    invoke-static {p2, p0}, Lrsh;->a(I[B)B
...
.method public static readIntEquals([BII)Z
    ...
    invoke-static {p1, p0}, Lrsh;->b(I[B)I

    move-result p1

    invoke-static {p2, p0}, Lrsh;->b(I[B)I
...
.method public static readShortLittleEndian([BI)I
    ...
    invoke-static {p1, p0}, Lrsh;->g(I[B)S

    move-result p0

    sget-object p1, Lr3i;->a:Ljava/nio/ByteOrder;
...
.method public static safeArraycopy([BI[BII)V
    ...
    invoke-static {v3, p0}, Lrsh;->a(I[B)B

    move-result v3

    invoke-static {p2, v2, v3}, Lrsh;->h([BIB)V
...
.method public static safeIncrementalCopy([BIII)V
    ...
    invoke-static {v2, p0}, Lrsh;->a(I[B)B

    move-result v2

    invoke-static {p0, v1, v2}, Lrsh;->h([BIB)V
...
.method public static wildArraycopy([BI[BII)V
    ...
    invoke-static {v2, p0}, Lrsh;->e(I[B)J

    move-result-wide v2

    invoke-static {v1, v2, v3, p2}, Lrsh;->k(IJ[B)V
...
.method public static wildIncrementalCopy([BIII)V
    ...
    invoke-static {v5, p0}, Lrsh;->a(I[B)B

    move-result v5

    invoke-static {p0, v4, v5}, Lrsh;->h([BIB)V
    ...
    :goto_1
    invoke-static {v3, p0}, Lrsh;->b(I[B)I

    move-result p1

    invoke-static {v2, p0, p1}, Lrsh;->j(I[BI)V
    ...
    invoke-static {p2, v2, v3, p0}, Lrsh;->k(IJ[B)V
...
.method public static writeLen(I[BI)I
    ...
    invoke-static {p1, p2, v0}, Lrsh;->h([BIB)V
    ...
    invoke-static {p1, p2, p0}, Lrsh;->h([BIB)V
...
.method public static writeShortLittleEndian([BII)V
    ...
    sget-object v0, Lr3i;->a:Ljava/nio/ByteOrder;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lrsh;->m([BIS)V
