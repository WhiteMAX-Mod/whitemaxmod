...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "continuation",
        "<init>",
        "(Lmi4;Lkotlin/coroutines/Continuation;)V",
...
.field public final dispatcher:Lmi4;
...
.method public constructor <init>(Lmi4;Lkotlin/coroutines/Continuation;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0}, Lwa5;-><init>(I)V

    iput-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lmi4;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lki4;

    move-result-object p1

    invoke-static {p1}, Lkotlinx/coroutines/internal/ThreadContextKt;->threadContextElements(Lki4;)Ljava/lang/Object;
...
.method private final getReusableCancellableContinuation()Lqc2;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final synthetic loop$atomicfu$ATOMIC_FIELD_UPDATER$Any(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/lang/Object;Lrz6;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final claimReusableCancellableContinuation$kotlinx_coroutines_core()Lqc2;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dispatchYield$kotlinx_coroutines_core(Lki4;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Lwa5;->resumeMode:I

    iget-object p2, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lmi4;

    invoke-virtual {p2, p1, p0}, Lmi4;->dispatchYield(Lki4;Ljava/lang/Runnable;)V

    return-void
.end method

.method public getCallerFrame()Lwi4;
    .locals 2
...
.method public final release$kotlinx_coroutines_core()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getReusableCancellableContinuation()Lqc2;
...
.method public final resumeCancellableWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lmi4;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lki4;

    move-result-object v2

    invoke-static {v1, v2}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeIsDispatchNeeded(Lmi4;Lki4;)Z
    ...
    iput v2, p0, Lwa5;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lmi4;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lki4;

    move-result-object v0

    invoke-static {p1, v0, p0}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeDispatch(Lmi4;Lki4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p0}, Lmx5;->k(Lwa5;)V

    return-void

    :cond_1
    invoke-virtual {v1, v2}, Lmx5;->V(Z)V
    ...
    invoke-interface {v3, v4}, Lki4;->get(Lji4;)Lii4;
    ...
    invoke-interface {v3}, Lr78;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lwa5;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lki4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v4, v3}, Ln0k;->u0(Lkotlin/coroutines/Continuation;Lki4;Ljava/lang/Object;)Lkqh;
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lki4;Ljava/lang/Object;)V

    :cond_5
    :goto_1
    invoke-virtual {v1}, Lmx5;->f0()Z
    ...
    :goto_2
    invoke-virtual {v1, v2}, Lmx5;->j(Z)V
    ...
    :goto_3
    :try_start_4
    invoke-virtual {p0, p1}, Lwa5;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;)V
    :try_end_4
...
.method public final resumeCancelled$kotlinx_coroutines_core(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0}, Lr78;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lwa5;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final resumeUndispatchedWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lki4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v1}, Ln0k;->u0(Lkotlin/coroutines/Continuation;Lki4;Ljava/lang/Object;)Lkqh;
    ...
    :cond_1
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lki4;Ljava/lang/Object;)V
...
.method public resumeWith(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Lmx5;->V(Z)V
    ...
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lki4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lki4;Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {v1, v0}, Lmx5;->j(Z)V
...
.method public final tryReleaseClaimedContinuation$kotlinx_coroutines_core(Loc2;)Ljava/lang/Throwable;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
