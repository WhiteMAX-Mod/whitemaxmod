...
.method public constructor <init>(Lxg8;)V
    ...
    iput-object p1, p0, Ltca;->a:Lxg8;

    return-void
.end method

.method public static a([B)Lg40;
    .locals 1
    ...
    :try_start_2
    invoke-static {p0}, Lru/ok/tamtam/nano/a;->e(Lru/ok/tamtam/nano/Protos$Attaches;)Lg40;
...
.method public static c([B)Ljava/util/List;
    ...
    invoke-static {p0}, Lqw9;->a([Lru/ok/tamtam/nano/Protos$MessageElement;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, p0}, Lsca;-><init>(Ljava/lang/Throwable;)V

    const-string p0, "MessagesTypeConverters"

    const-string v1, "InvalidProtocolBufferNanoException"

    invoke-static {p0, v1, v0}, Lzi0;->l0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(I)Ls0a;
    .locals 5

    invoke-static {}, Ls0a;->values()[Ls0a;
...
# virtual methods
.method public final f([B)Lzz9;
    .locals 2

    iget-object v0, p0, Ltca;->a:Lxg8;
    ...
    :try_start_0
    invoke-virtual {v0, p1}, La0a;->a([B)Lzz9;
