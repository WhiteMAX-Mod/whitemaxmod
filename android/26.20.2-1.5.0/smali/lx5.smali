...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llx5;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Llx5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Llx5;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
# virtual methods
.method public final D0(JLjx5;)V
    .locals 5

    sget-object v0, Llx5;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    sget-object v3, Llx5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_3
    invoke-virtual {p3, p1, p2, v0, p0}, Ljx5;->b(JLkx5;Llx5;)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lmx5;->h0(JLjx5;)V
    ...
    invoke-virtual {p0}, Lmx5;->R()Ljava/lang/Thread;
...
.method public final Y()J
    ...
    :cond_0
    invoke-virtual {p0}, Llx5;->l0()V

    :goto_0
    sget-object v0, Llx5;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_5
    sget-object v5, Lnx5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_b
    sget-object v3, Lnx5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_c
    sget-object v0, Llx5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public final dispatch(Lki4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Llx5;->i0(Ljava/lang/Runnable;)V
...
.method public i0(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Llx5;->o0(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, p1}, Ley4;->i0(Ljava/lang/Runnable;)V

    return-void
.end method

.method public invokeOnTimeout(JLjava/lang/Runnable;Lki4;)Lpb5;
    .locals 0

    invoke-static {p1, p2, p3, p4}, Lgrk;->c(JLjava/lang/Runnable;Lki4;)Lpb5;
...
.method public final l0()V
    ...
    invoke-virtual {p0, v3}, Llx5;->o0(Ljava/lang/Runnable;)Z
...
.method public final o0(Ljava/lang/Runnable;)Z
    ...
    sget-object v2, Llx5;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :cond_7
    sget-object v2, Lnx5;->b:Lkotlinx/coroutines/internal/Symbol;
...
.method public final scheduleResumeAfterDelay(JLoc2;)V
    ...
    sget-object v0, Lnx5;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-direct {v2, p0, v0, v1, p3}, Lhx5;-><init>(Llx5;JLoc2;)V

    invoke-virtual {p0, p1, p2, v2}, Llx5;->D0(JLjx5;)V

    new-instance p1, Lbc2;

    const/4 p2, 0x1

    invoke-direct {p1, p2, v2}, Lbc2;-><init>(ILjava/lang/Object;)V
...
.method public shutdown()V
    ...
    sget-object v0, Lz7h;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v4, Lnx5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :goto_2
    sget-object v2, Llx5;->f:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_7
    invoke-virtual {p0, v0, v1, v2}, Lmx5;->h0(JLjx5;)V
