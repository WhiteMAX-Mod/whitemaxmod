...
.method public constructor <init>(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Ljm7;->a:Landroid/content/Context;

    iput-object p3, p0, Ljm7;->b:Ljava/lang/String;
...
# virtual methods
.method public final b(Lacj;)Lxl7;
    .locals 12
    ...
    iget-object v2, p1, Lacj;->b:Ljava/lang/Object;
    ...
    invoke-static {v6}, Lcv;->P0([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Ljavax/net/ssl/X509TrustManager;

    sget v8, Lyqd;->rootca_ssl_rsa2022:I

    iget-object v9, p0, Ljm7;->a:Landroid/content/Context;
    ...
    invoke-static {v8}, Lcv;->P0([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v6, v9}, Lnx3;-><init>([Ljavax/net/ssl/X509TrustManager;)V
    ...
    invoke-static {v10, p1}, Lrwd;->i(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Ljm7;->b:Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    invoke-interface {p1}, Lvl7;->getContentType()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lvl7;->getContentLength()J
    ...
    invoke-static {v2, v1}, Ljm7;->a(Ljava/net/HttpURLConnection;I)V
    ...
    :try_start_3
    invoke-interface {p1, v1}, Lvl7;->writeTo(Ljava/io/OutputStream;)V
    :try_end_3
    ...
    :goto_3
    :try_start_7
    invoke-static {v3}, Lzi0;->W(Ljava/io/InputStream;)[B
    ...
    :try_start_a
    invoke-static {v3, p1}, Lrwd;->i(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v5, v4, v0}, Lhl7;-><init>([BLjava/lang/String;)V

    invoke-direct {v3, p1, v1, v5}, Lxl7;-><init>(ILjava/lang/String;Lhl7;)V
    :try_end_c
    ...
    invoke-static {v0, v1, v5}, Lcog;->B0(Ljava/lang/String;Ljava/lang/String;Z)Z
