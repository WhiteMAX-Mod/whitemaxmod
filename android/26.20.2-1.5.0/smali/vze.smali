...
.method public constructor <init>(Lbd6;)V
    ...
    iput-object p1, p0, Lvze;->a:Lbd6;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lvze;->b:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    invoke-virtual {p1, v0}, Lbd6;->d(Landroid/text/TextPaint;)V

    iput-object v0, p0, Lvze;->c:Landroid/text/TextPaint;

    new-instance p1, Lg68;

    invoke-direct {p1}, Lg68;-><init>()V

    iput-object p1, p0, Lvze;->d:Lg68;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lz5e;)V
    ...
    iget-object p4, v0, Lone/me/chats/list/ChatsListWidget;->y:Ld56;

    invoke-virtual {p4}, Loo8;->m()I
    ...
    iget-object v1, p0, Lvze;->c:Landroid/text/TextPaint;
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    iget-object v4, p0, Lvze;->a:Lbd6;

    iget-object v5, v4, Lbd6;->b:Ljava/lang/Object;

    check-cast v5, Lone/me/chats/list/ChatsListWidget;

    iget-object v6, v5, Lone/me/chats/list/ChatsListWidget;->t:Lh83;
    ...
    iget-object v5, v5, Lone/me/chats/list/ChatsListWidget;->y:Ld56;
    ...
    iget-object v4, v4, Lbd6;->a:Ljava/lang/Object;

    check-cast v4, Ljava/lang/String;

    iget-object v5, p0, Lvze;->d:Lg68;

    iget-object v6, p0, Lvze;->b:Landroid/graphics/Rect;

    invoke-virtual {v5, v6, v1, v3}, Lg68;->d(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v5, p0, Lvze;->c:Landroid/text/TextPaint;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-object p1, p0, Lvze;->c:Landroid/text/TextPaint;

    iget-object v0, p0, Lvze;->a:Lbd6;

    invoke-virtual {v0, p1}, Lbd6;->d(Landroid/text/TextPaint;)V
