...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lgli;-><init>(I)V
    ...
    .line 9
    sget-object v1, Lpud;->ScrollingViewBehavior_Layout:[I
    ...
    .line 11
    sget p2, Lpud;->ScrollingViewBehavior_Layout_behavior_overlapTop:I
...
.method public static u(Ljava/util/List;)Ljp;
    .locals 4
...
.method public d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_0
    instance-of p1, p3, Ljp;

    if-eqz p1, :cond_1

    check-cast p3, Ljp;

    iget-boolean p1, p3, Ljp;->l:Z

    if-eqz p1, :cond_1

    invoke-virtual {p3, p2}, Ljp;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p3, p1}, Ljp;->g(Z)Z
...
.method public final i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->u(Ljava/util/List;)Ljp;
    ...
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Laaj;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Laaj;->d()I
    ...
    :cond_2
    :goto_0
    invoke-virtual {v2}, Ljp;->getTotalScrollRange()I
...
.method public final m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->u(Ljava/util/List;)Ljp;
    ...
    invoke-virtual {v0, v1, p2, p1}, Ljp;->f(ZZZ)V
...
.method public final v(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, p1}, Lbt4;->k(III)I
