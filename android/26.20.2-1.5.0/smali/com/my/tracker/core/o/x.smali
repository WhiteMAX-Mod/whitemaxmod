...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-direct {v1, v4}, Ln35;-><init>(I)V

    invoke-virtual {v1, p1}, Ln35;->g(Ljava/lang/String;)V

    .line 32
    const-string p1, "GET"

    invoke-virtual {v1, p1, v3}, Ln35;->d(Ljava/lang/String;Lnbe;)V
    ...
    .line 34
    invoke-interface {p2}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lw6b;
    ...
    .line 41
    iget-object p2, p1, Ltde;->g:Lvde;

    if-eqz p2, :cond_1

    .line 42
    invoke-virtual {p2}, Lvde;->V()Ljava/lang/String;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Ltde;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    .line 100
    sget-object v4, Lkn9;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 101
    :try_start_6
    invoke-static {p2}, Lfg8;->w(Ljava/lang/String;)Lkn9;
    ...
    invoke-virtual {v4, p1}, Ln35;->g(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, p1, v5}, Lw34;->z(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 105
    invoke-static {p1, p2, v5}, Lcwa;->a([BLkn9;I)Lnbe;
    ...
    invoke-virtual {v4, p2, p1}, Ln35;->d(Ljava/lang/String;Lnbe;)V
    ...
    .line 110
    invoke-interface {p4}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lw6b;
    ...
    .line 128
    invoke-virtual {v3}, Ltde;->close()V
