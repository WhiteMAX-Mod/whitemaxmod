...
# virtual methods
.method public final a(Lqt8;Lct0;)V
    .locals 6

    iget-object v0, p0, Ldt0;->a:Ljw6;
    ...
    invoke-direct {v4, v0}, Loi0;-><init>(Landroidx/fragment/app/c;)V

    const/4 v5, 0x0

    invoke-virtual {v4, v5, v2, v1, v3}, Loi0;->e(ILandroidx/fragment/app/a;Ljava/lang/String;I)V

    invoke-virtual {v4, v3}, Loi0;->d(Z)I
    ...
    :cond_3
    iget-object v1, v2, Landroidx/biometric/BiometricFragment;->r1:Landroidx/biometric/BiometricViewModel;

    iput-object p1, v1, Landroidx/biometric/BiometricViewModel;->c:Lqt8;
    ...
    iput-object p1, v1, Landroidx/biometric/BiometricViewModel;->d:Lct0;

    goto :goto_1

    :cond_4
    iput-object p2, v1, Landroidx/biometric/BiometricViewModel;->d:Lct0;
    ...
    iget-object p1, v2, Landroidx/biometric/BiometricFragment;->r1:Landroidx/biometric/BiometricViewModel;

    sget p2, Lkrd;->confirm_device_credential_password:I
    ...
    invoke-direct {p2, v0, v1}, Lat0;-><init>(Landroid/content/Context;I)V

    invoke-direct {p1, p2}, Lu6j;-><init>(Lat0;)V

    const/16 p2, 0xff

    invoke-virtual {p1, p2}, Lu6j;->x(I)I
    ...
    iget-object p1, v2, Landroidx/biometric/BiometricFragment;->q1:Landroid/os/Handler;

    new-instance p2, Lxs0;

    invoke-direct {p2, v2}, Lxs0;-><init>(Landroidx/biometric/BiometricFragment;)V
