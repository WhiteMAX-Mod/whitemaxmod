...
# direct methods
.method public constructor <init>(Lhfh;[ILpk0;JJJLrs7;)V
    .locals 0
    ...
    :cond_0
    iput-object p3, p0, Lca;->g:Lpk0;

    const-wide/16 p1, 0x3e8

    mul-long/2addr p4, p1

    iput-wide p4, p0, Lca;->h:J

    mul-long/2addr p6, p1

    iput-wide p6, p0, Lca;->i:J
    ...
    invoke-static {p10}, Lrs7;->n(Ljava/util/Collection;)Lrs7;

    move-result-object p1

    iput-object p1, p0, Lca;->o:Lrs7;

    sget-object p1, Ltj3;->a:Lkxg;

    iput-object p1, p0, Lca;->p:Lkxg;
...
.method public static v([Lk16;)Lx7e;
    ...
    invoke-direct {v7, v5, v6, v5, v6}, Lba;-><init>(JJ)V
    ...
    :cond_7
    invoke-static {v1, v9}, Lca;->w(Ljava/util/ArrayList;[J)V
...
.method public static w(Ljava/util/ArrayList;[J)V
    ...
    invoke-direct {v4, v0, v1, v5, v6}, Lba;-><init>(JJ)V
...
.method public final b(JJJLjava/util/List;[Lz99;)V
    ...
    invoke-interface {p2}, Lz99;->next()Z
    ...
    invoke-interface {v3}, Lz99;->next()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-interface {v3}, Lz99;->d()J

    move-result-wide p1

    invoke-interface {v3}, Lz99;->c()J
    ...
    :cond_2
    invoke-static/range {p7 .. p7}, Lca;->y(Ljava/util/List;)J
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lca;->x(JJ)I
    ...
    :cond_4
    invoke-static/range {p7 .. p7}, Lfv7;->x(Ljava/lang/Iterable;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Ly99;

    iget-object v4, v4, Lah3;->d:Lft6;

    invoke-virtual {p0, v4}, Lto0;->e(Lft6;)I
    ...
    invoke-virtual {p0, p2, v0, v1}, Lto0;->a(IJ)Z
...
.method public final i()V
    ...
    iput-wide v0, p0, Lca;->t:J

    const/4 v0, 0x0

    iput-object v0, p0, Lca;->u:Ly99;
...
.method public final k(JLjava/util/List;)I
    ...
    :cond_4
    invoke-static {p3}, Lca;->y(Ljava/util/List;)J

    move-result-wide v4

    invoke-virtual {p0, v0, v1, v4, v5}, Lca;->x(JJ)I
    ...
    invoke-static {v1, v8, v9}, Lq3i;->I(FJ)J
...
.method public final x(JJ)I
    ...
    iget-wide v2, v1, Lba;->a:J

    sub-long/2addr p3, v2

    long-to-float p3, p3

    iget-wide v4, v0, Lba;->a:J
    ...
    iget-wide v1, v1, Lba;->b:J

    iget-wide v3, v0, Lba;->b:J
