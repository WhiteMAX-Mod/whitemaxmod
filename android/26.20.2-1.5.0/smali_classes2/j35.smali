...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lj35;->k:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    sput-object v0, Lj35;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    sput-object v0, Lj35;->m:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>(ILandroid/util/Size;)V
    ...
    iput-object v0, p0, Lj35;->a:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lj35;->b:I

    iput-boolean v0, p0, Lj35;->c:Z

    iput-object p2, p0, Lj35;->h:Landroid/util/Size;
    ...
    invoke-direct {p1, p0, p2}, Li35;-><init>(Lj35;I)V

    invoke-static {p1}, Lmfk;->b(Lr02;)Lt02;

    move-result-object p1

    iput-object p1, p0, Lj35;->e:Lt02;

    new-instance p2, Li35;

    const/4 v0, 0x1

    invoke-direct {p2, p0, v0}, Li35;-><init>(Lj35;I)V

    invoke-static {p2}, Lmfk;->b(Lr02;)Lt02;

    move-result-object p2

    iput-object p2, p0, Lj35;->g:Lt02;
    ...
    sget-object p2, Lj35;->m:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result p2

    sget-object v0, Lj35;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p0, p2, v0, v1}, Lj35;->e(IILjava/lang/String;)V
    ...
    invoke-virtual {p1, v0, p2}, Lh4;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public a()V
    ...
    iget-object v1, p0, Lj35;->a:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lj35;->f:Lq02;

    invoke-virtual {v2, v3}, Lq02;->b(Ljava/lang/Object;)Z

    iget v2, p0, Lj35;->b:I

    if-nez v2, :cond_0

    iget-object v2, p0, Lj35;->d:Lq02;

    iput-object v3, p0, Lj35;->d:Lq02;
...
.method public final b()V
    ...
    sget-object v4, Lj35;->m:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v4}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v4

    sget-object v5, Lj35;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    move-result v5

    invoke-virtual {p0, v4, v5, v0}, Lj35;->e(IILjava/lang/String;)V
...
.method public final c()Lqp8;
    ...
    invoke-direct {v1, v2, p0}, Landroidx/camera/core/impl/DeferrableSurface$SurfaceClosedException;-><init>(Ljava/lang/String;Lj35;)V
...
.method public final d()V
    ...
    invoke-direct {v0, v2, p0}, Landroidx/camera/core/impl/DeferrableSurface$SurfaceClosedException;-><init>(Ljava/lang/String;Lj35;)V
    ...
    invoke-virtual {p0, v3, v4, v2}, Lj35;->e(IILjava/lang/String;)V
