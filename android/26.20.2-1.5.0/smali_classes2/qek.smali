...
.method public static b(La1a;)Lmoc;
    .locals 19
    ...
    invoke-direct {v0, v13, v14, v11, v12}, Lmoc;-><init>(JJ)V
...
.method public static c(Lo21;)[B
    ...
    invoke-virtual {p0, v7, v8, v9}, Lo21;->read([BII)I

    move-result v9

    if-ne v9, v5, :cond_0

    invoke-static {v0, v4}, Lqek;->a(Ljava/util/ArrayDeque;I)[B
    ...
    :cond_5
    invoke-virtual {p0}, Lo21;->read()I

    move-result p0

    if-ne p0, v5, :cond_6

    invoke-static {v0, v6}, Lqek;->a(Ljava/util/ArrayDeque;I)[B
