...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lpuc;->getTitleColor()I

    move-result v8

    invoke-virtual {v2, v8}, Landroid/widget/TextView;->setTextColor(I)V

    sget-object v8, Ldph;->d:Lb6h;

    invoke-static {v8, v2}, Lb6h;->e(Lb6h;Landroid/widget/TextView;)V

    iput-object v2, p0, Lpuc;->a:Landroid/widget/TextView;
    ...
    invoke-direct {p0}, Lpuc;->getSubtitleColor()I
    ...
    invoke-static {v1, v8}, Lb6h;->e(Lb6h;Landroid/widget/TextView;)V

    iput-object v8, p0, Lpuc;->b:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Lpuc;->c:Landroid/widget/TextView;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-object p1, p0, Lpuc;->a:Landroid/widget/TextView;
    ...
    iget-object p1, p0, Lpuc;->b:Landroid/widget/TextView;
...
.method public final setState(Lvr5;)V
    .locals 2

    iget-object v0, p1, Lvr5;->a:Lp5h;

    invoke-virtual {v0, p0}, Lu5h;->d(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v0

    iget-object v1, p0, Lpuc;->a:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lvr5;->b:Lp5h;

    invoke-virtual {v0, p0}, Lu5h;->d(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v0

    iget-object v1, p0, Lpuc;->b:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object p1, p1, Lvr5;->c:Lp5h;

    invoke-virtual {p1, p0}, Lu5h;->d(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object p1

    iget-object v0, p0, Lpuc;->c:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, p1}, Lpuc;->onThemeChanged(Lzub;)V
