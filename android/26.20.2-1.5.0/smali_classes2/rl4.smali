...
# instance fields
.field public final synthetic c:Ltl4;
...
.method public final a(Landroid/graphics/Bitmap;Lwkc;)Lek3;
    ...
    iget-object v0, p0, Lrl4;->c:Ltl4;

    iget-object v0, v0, Ltl4;->p:Lwl4;

    if-eqz v0, :cond_0

    iget-object p2, p0, Lrl4;->c:Ltl4;

    invoke-virtual {p2, p1, v0}, Ltl4;->t(Landroid/graphics/Bitmap;Lwl4;)Landroid/graphics/Bitmap;
    ...
    sget-object v0, Lgo0;->a:Landroid/graphics/Bitmap$Config;
    ...
    invoke-virtual {p2, v1, v2, v0}, Lwkc;->c(IILandroid/graphics/Bitmap$Config;)Lek3;
    ...
    :try_start_0
    invoke-virtual {v0}, Ltl4;->w()Landroid/graphics/Canvas;
...
.method public final d(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, p0, Lrl4;->c:Ltl4;

    invoke-virtual {p1}, Ltl4;->w()Landroid/graphics/Canvas;

    move-result-object p1

    iget-object v0, p0, Lrl4;->c:Ltl4;

    iget-object v0, v0, Ltl4;->k:Landroid/graphics/Matrix;
