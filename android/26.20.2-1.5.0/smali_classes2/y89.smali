...
.method public final onConnected()V
    ...
    iget-object v5, v1, Lz89;->d:Lx89;

    iget-object v6, v1, Lz89;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-static {v7}, Lq3i;->n(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    iget-object v10, v1, Lz89;->c:Landroid/os/Bundle;

    invoke-direct {v9, v8, v10}, Lfec;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v9, v1, Lz89;->f:Lfec;

    new-instance v8, Landroid/os/Messenger;

    invoke-direct {v8, v5}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v8, v1, Lz89;->g:Landroid/os/Messenger;
    ...
    iput-object v10, v5, Lx89;->b:Ljava/lang/ref/WeakReference;

    :try_start_1
    iget-object v5, v1, Lz89;->a:Landroid/content/Context;
    ...
    iget-object v11, v9, Lfec;->c:Ljava/lang/Object;
    ...
    iget-object v8, v9, Lfec;->b:Ljava/lang/Object;
    ...
    invoke-static {v4, v5}, Lfv7;->A(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v4}, Lzm7;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v6, v4, v5}, Lmj9;-><init>(Landroid/media/session/MediaSession$Token;Lbn7;)V

    iput-object v6, v1, Lz89;->h:Lmj9;
    ...
    invoke-static {v4, v5, v1}, Lfv7;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v4, v1, Lz89;->h:Lmj9;

    if-nez v4, :cond_5

    iget-object v4, v1, Lz89;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-direct {v5, v4, v3}, Lmj9;-><init>(Landroid/media/session/MediaSession$Token;Lbn7;)V

    iput-object v5, v1, Lz89;->h:Lmj9;

    :cond_5
    iget-object v1, v1, Lz89;->h:Lmj9;

    iget-object v3, v0, Ljc9;->b:Lcb9;

    new-instance v4, Lff8;

    const/16 v5, 0x8

    invoke-direct {v4, v0, v5, v1}, Lff8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3, v4}, Lcb9;->S(Ljava/lang/Runnable;)V

    iget-object v1, v3, Lcb9;->e:Landroid/os/Handler;

    new-instance v3, Lfc9;

    invoke-direct {v3, v0, v2}, Lfc9;-><init>(Ljc9;I)V
...
.method public final onConnectionSuspended()V
    ...
    iput-object v2, v1, Lz89;->f:Lfec;

    iput-object v2, v1, Lz89;->g:Landroid/os/Messenger;

    iput-object v2, v1, Lz89;->h:Lmj9;

    iget-object v1, v1, Lz89;->d:Lx89;
    ...
    iput-object v3, v1, Lx89;->b:Ljava/lang/ref/WeakReference;
