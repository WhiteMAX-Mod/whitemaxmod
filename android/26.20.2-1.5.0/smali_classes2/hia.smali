...
.method static constructor <clinit>()V
    ...
    invoke-static/range {v1 .. v6}, Lrs7;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lx7e;

    move-result-object v0

    sput-object v0, Lhia;->h:Lx7e;
...
.method public constructor <init>(Lqc6;)V
    ...
    iput-object p1, p0, Lhia;->a:Lqc6;

    new-instance v0, Lj46;

    const/16 v1, 0xa

    invoke-direct {v0, v1}, Lj46;-><init>(I)V

    iput-object v0, p0, Lhia;->b:Lj46;

    new-instance v1, Lmia;

    invoke-direct {v1, p1, v0}, Lmia;-><init>(Lqc6;Lj46;)V

    iput-object v1, p0, Lhia;->c:Lmia;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lhia;->d:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lhia;->e:Ljava/util/ArrayList;
...
.method public final O0(Lft6;)I
    ...
    iget-object v1, p0, Lhia;->c:Lmia;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v2, Ldfh;

    invoke-direct {v2, v0, p1}, Ldfh;-><init>(ILft6;)V

    iget-object p1, v1, Lmia;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v3}, Lso0;-><init>(I)V

    invoke-static {p1, v1}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    iget-object p1, p0, Lhia;->d:Ljava/util/ArrayList;
...
.method public final U(Lzca;)V
    ...
    iget-object v0, p0, Lhia;->b:Lj46;

    invoke-virtual {v0, p1}, Lj46;->j(Lzca;)V
...
.method public final close()V
    ...
    :goto_2
    :try_start_1
    iget-object v1, p0, Lhia;->a:Lqc6;

    invoke-virtual {v1}, Lqc6;->close()V
    :try_end_1
...
.method public final k0(ILjava/nio/ByteBuffer;Loz0;)V
    ...
    iget-object v0, p0, Lhia;->d:Ljava/util/ArrayList;
    ...
    :try_start_0
    iget-object v0, p0, Lhia;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lmia;->h(Ldfh;Ljava/nio/ByteBuffer;Loz0;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
