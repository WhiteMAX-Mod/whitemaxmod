...
.method public constructor <init>(Landroid/content/SharedPreferences;Ljava/util/concurrent/ScheduledThreadPoolExecutor;)V
    ...
    iput-object p2, p0, Lbdh;->b:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
# virtual methods
.method public final declared-synchronized a()Ladh;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lbdh;->a:Ldw4;
    ...
    :try_start_2
    sget-object v1, Ladh;->d:Ljava/util/regex/Pattern;
    ...
    invoke-direct {v2, v1, v0}, Ladh;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
