...
# direct methods
.method public static a(Lyq7;)Landroid/graphics/Bitmap;
    .locals 4
    ...
    :cond_4
    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->c(Lyq7;)Landroid/graphics/Bitmap;
...
.method public static d(Lyq7;Landroid/graphics/Rect;II)[B
    .locals 21

    invoke-interface/range {p0 .. p0}, Lyq7;->getFormat()I
    ...
    invoke-interface {v4}, Lxq7;->i()I

    move-result v9

    invoke-interface {v2}, Lxq7;->i()I
    ...
    sget-object v4, Lhz5;->c:[Lqz5;

    new-instance v4, Lgz5;

    sget-object v5, Ljava/nio/ByteOrder;->BIG_ENDIAN:Ljava/nio/ByteOrder;

    invoke-direct {v4}, Lgz5;-><init>()V
    ...
    iget-object v7, v4, Lgz5;->a:Ljava/util/ArrayList;

    invoke-virtual {v4, v6, v5, v7}, Lgz5;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V

    const-string v5, "XResolution"

    const-string v6, "72/1"

    invoke-virtual {v4, v5, v6, v7}, Lgz5;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-interface/range {p0 .. p0}, Lyq7;->getImageInfo()Ldq7;
    ...
    invoke-interface {v5, v4}, Ldq7;->a(Lgz5;)V

    :cond_3
    move/from16 v5, p3

    invoke-virtual {v4, v5}, Lgz5;->d(I)V
    ...
    invoke-direct {v5, v4}, Lfz5;-><init>(Lgz5;)V
    ...
    invoke-virtual {v4, v6, v7, v5}, Lgz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    sget-object v7, Lhz5;->f:Ljava/lang/String;
    ...
    invoke-virtual {v4, v7, v6, v5}, Lgz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v6, v3, v5}, Lgz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v5}, Lgz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v7, v5}, Lgz5;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v4, v4, Lgz5;->b:Ljava/nio/ByteOrder;

    invoke-direct {v3, v4, v5}, Lhz5;-><init>(Ljava/nio/ByteOrder;Ljava/util/ArrayList;)V

    invoke-direct {v2, v0, v3}, Lpz5;-><init>(Ljava/io/ByteArrayOutputStream;Lhz5;)V
