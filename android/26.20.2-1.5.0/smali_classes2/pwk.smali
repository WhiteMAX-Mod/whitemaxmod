...
# direct methods
.method public static a(Lqz7;)Ljava/nio/ByteBuffer;
    .locals 16
    ...
    :cond_1
    invoke-virtual {v0}, Lqz7;->b()[Landroid/media/Image$Plane;
    ...
    invoke-static/range {v4 .. v9}, Lpwk;->c(Landroid/media/Image$Plane;II[BII)V
    ...
    :cond_5
    iget-object v0, v0, Lqz7;->a:Landroid/graphics/Bitmap;
...
.method public static final b(Lpj8;Lui8;ZLh19;Lpz6;Lgvg;)Ljava/lang/Object;
    .locals 2

    new-instance v0, Lqc2;

    invoke-static {p5}, Lbt4;->G(Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p5

    const/4 v1, 0x1

    invoke-direct {v0, v1, p5}, Lqc2;-><init>(ILkotlin/coroutines/Continuation;)V

    invoke-virtual {v0}, Lqc2;->o()V

    new-instance p5, Llaj;

    invoke-direct {p5, p1, p0, v0, p4}, Llaj;-><init>(Lui8;Lpj8;Lqc2;Lpz6;)V
    ...
    invoke-direct {p1, p0, p2, p5}, Lmaj;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    sget-object p2, Lzq5;->a:Lzq5;

    invoke-virtual {p3, p2, p1}, Lmi4;->dispatch(Lki4;Ljava/lang/Runnable;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p5}, Lpj8;->a(Ljj8;)V
    ...
    invoke-direct {p1, p3, p0, p5, p2}, Lln0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
