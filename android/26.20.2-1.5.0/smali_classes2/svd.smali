...
.method private final setDataList(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lsvd;->c:Ljava/util/List;
    ...
    :cond_2
    iput-object p1, p0, Lsvd;->c:Ljava/util/List;
...
.method public final a()V
    ...
    iget-object v1, p0, Lsvd;->c:Ljava/util/List;
    ...
    iget-object v0, p0, Lsvd;->c:Ljava/util/List;
    ...
    invoke-direct {v3, v4}, Lpvd;-><init>(Landroid/content/Context;)V
    ...
    sget-object v6, Lovd;->b:Lovd;

    invoke-virtual {v5, v6}, Lpvd;->setSize(Lovd;)V

    iget-boolean v6, v3, Lrvd;->c:Z

    invoke-virtual {v5, v6}, Lpvd;->setEnabled(Z)V

    iget-object v6, v3, Lrvd;->b:Ljava/lang/Integer;

    invoke-virtual {v5, v6}, Lpvd;->setImage(Ljava/lang/Integer;)V

    new-instance v6, Lgwb;

    const/16 v7, 0xd

    invoke-direct {v6, p0, v7, v3}, Lgwb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final setButtonToolDataList(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, Lsvd;->setDataList(Ljava/util/List;)V

    return-void
.end method

.method public final setListener(Lqvd;)V
    .locals 0

    iput-object p1, p0, Lsvd;->a:Lqvd;
