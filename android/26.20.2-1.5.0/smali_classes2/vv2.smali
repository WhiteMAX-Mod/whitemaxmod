...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lvv2;->s:Landroid/widget/TextView;
    ...
    iput-object v8, p0, Lvv2;->t:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, p1}, Lvv2;->onThemeChanged(Lzub;)V

    return-void
.end method

.method private final setButtonState(Lkei;)V
    .locals 3
    ...
    :cond_1
    invoke-virtual {v0, v1}, Lpmb;->setPlaying(Z)V
    ...
    invoke-virtual {v0, p1}, Lpmb;->setPlaying(Z)V
...
.method private final setSubtitle(Ljava/lang/CharSequence;)V
    ...
    :goto_2
    iget-object v1, p0, Lvv2;->t:Landroid/widget/TextView;
...
.method private final setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lvv2;->s:Landroid/widget/TextView;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-object v1, p0, Lvv2;->s:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lvv2;->t:Landroid/widget/TextView;
...
.method public final setupVideo(Lio9;)V
    .locals 2

    iget-wide v0, p1, Lio9;->b:J

    invoke-static {v0, v1}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lvv2;->x:Ljava/lang/Long;

    iget-object v0, p0, Lvv2;->u:Lpmb;

    iget-object v1, p1, Lio9;->e:Landroid/net/Uri;

    invoke-virtual {v0, v1}, Lpmb;->setCover(Landroid/net/Uri;)V

    iget-object v0, p1, Lio9;->f:Ljava/lang/String;

    invoke-direct {p0, v0}, Lvv2;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lio9;->g:Ljava/lang/String;

    invoke-direct {p0, v0}, Lvv2;->setSubtitle(Ljava/lang/CharSequence;)V

    iget-object p1, p1, Lio9;->h:Lfmf;

    invoke-interface {p1}, Lfmf;->a()Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Lvv2;->u(Llei;)V

    :cond_0
    invoke-direct {p0, p1}, Lvv2;->setState(Lpi6;)V

    return-void
.end method

.method public final u(Llei;)V
    .locals 5

    if-eqz p1, :cond_0

    iget-object v0, p1, Llei;->f:Lkei;
    ...
    iget-wide v1, p1, Llei;->b:J

    iget-object v3, p0, Lvv2;->x:Ljava/lang/Long;
    ...
    :cond_3
    invoke-direct {p0, v0}, Lvv2;->setButtonState(Lkei;)V

    goto :goto_2

    :cond_4
    :goto_1
    sget-object v1, Lkei;->a:Lkei;

    invoke-direct {p0, v1}, Lvv2;->setButtonState(Lkei;)V

    :cond_5
    :goto_2
    iput-object v0, p0, Lvv2;->y:Lkei;
    ...
    invoke-virtual {v0, p1}, Lpmb;->setProgress(F)V
