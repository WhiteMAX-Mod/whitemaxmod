...
.field public static final g:Lx7e;

.field public static final h:Lx7e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcy6;->f:Ljava/lang/String;

    new-instance v0, Los7;

    const/4 v2, 0x4

    invoke-direct {v0, v2}, Lfs7;-><init>(I)V
    ...
    invoke-virtual {v0, v2}, Lfs7;->d([Ljava/lang/Object;)V
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Lcy6;->a:Landroid/media/MediaMuxer;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lcy6;->b:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lcy6;->c:Landroid/util/SparseArray;
...
.method public final O0(Lft6;)I
    ...
    iget-object v5, p0, Lcy6;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v6, p1, Lft6;->D:Len3;

    invoke-static {v4, v6}, Le1k;->i(Landroid/media/MediaFormat;Len3;)V
    ...
    :cond_10
    :goto_2
    iget-object v0, p1, Lft6;->q:Ljava/util/List;

    invoke-static {v4, v0}, Le1k;->n(Landroid/media/MediaFormat;Ljava/util/List;)V
...
.method public final U(Lzca;)V
    ...
    iget-object v1, p0, Lcy6;->a:Landroid/media/MediaMuxer;
...
.method public final close()V
    ...
    iget-object v2, p0, Lcy6;->a:Landroid/media/MediaMuxer;
    ...
    :try_start_1
    invoke-static {v2}, Lcy6;->i(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final k0(ILjava/nio/ByteBuffer;Loz0;)V
    ...
    iget-wide v3, v2, Loz0;->a:J

    iget-boolean v5, v1, Lcy6;->d:Z

    iget-object v6, v1, Lcy6;->a:Landroid/media/MediaMuxer;

    const/4 v7, 0x1

    iget-object v8, v1, Lcy6;->c:Landroid/util/SparseArray;
    ...
    iget-object v3, v1, Lcy6;->b:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Lq3i;->l(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v8, v9, v5, v12}, Ldtg;->u(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v6, v7}, Ldtg;->u(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
