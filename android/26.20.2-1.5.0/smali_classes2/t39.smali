...
.method public static final a(Luki;Lype;Lpj8;)V
    .locals 2

    const-string v0, "androidx.lifecycle.savedstate.vm.tag"

    iget-object p0, p0, Luki;->a:Lwki;

    if-eqz p0, :cond_0

    iget-object v1, p0, Lwki;->a:Liwa;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lwki;->b:Ljava/util/LinkedHashMap;
    ...
    iput-boolean v0, p0, Ltpe;->c:Z

    invoke-virtual {p2, p0}, Lpj8;->a(Ljj8;)V

    iget-object v0, p0, Ltpe;->a:Ljava/lang/String;

    iget-object p0, p0, Ltpe;->b:Lspe;

    iget-object p0, p0, Lspe;->e:Lxpe;

    invoke-virtual {p1, v0, p0}, Lype;->c(Ljava/lang/String;Lxpe;)V

    iget-object p0, p2, Lpj8;->d:Lui8;
    ...
    invoke-virtual {p0, v0}, Lui8;->a(Lui8;)Z
    ...
    invoke-direct {p0, p2, p1}, Lzh8;-><init>(Lpj8;Lype;)V
...
.method public static declared-synchronized b(Landroid/content/Context;)I
    ...
    :cond_0
    :try_start_1
    invoke-static {p0}, Lkyk;->b(Landroid/content/Context;)Ly5k;
    ...
    :try_start_2
    invoke-virtual {v1}, Ly5k;->q0()Lm0k;

    move-result-object v3

    invoke-static {v3}, Lpy6;->k(Ljava/lang/Object;)V

    sput-object v3, Lwgk;->a:Lm0k;

    invoke-virtual {v1}, Ly5k;->s0()Lyhk;

    move-result-object v3

    sget-object v4, Lsdk;->a:Lyhk;
    ...
    invoke-static {v3, v4}, Lpy6;->l(Ljava/lang/Object;Ljava/lang/String;)V

    sput-object v3, Lsdk;->a:Lyhk;
    :try_end_2
    ...
    invoke-virtual {v1, v5, v6}, Ldwj;->m0(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    invoke-direct {v5, p0}, Lj4b;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v1}, Ldwj;->n0()Landroid/os/Parcel;

    move-result-object p0

    invoke-static {p0, v5}, Lo2k;->d(Landroid/os/Parcel;Landroid/os/IInterface;)V

    invoke-virtual {p0, v2}, Landroid/os/Parcel;->writeInt(I)V

    const/16 v5, 0xa

    invoke-virtual {v1, p0, v5}, Ldwj;->p0(Landroid/os/Parcel;I)V
    :try_end_4
