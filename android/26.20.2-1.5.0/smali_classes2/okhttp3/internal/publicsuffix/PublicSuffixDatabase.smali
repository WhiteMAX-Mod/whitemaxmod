...
.method public static c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lung;->c1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v0, p0}, Lwm3;->e1(ILjava/util/List;)Ljava/util/List;
...
.method public final a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v7, v5}, Lukc;->i(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_4
    invoke-static {v8, v5, v6}, Lufe;->g([B[[BI)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v11, v6, v10}, Lufe;->g([B[[BI)Ljava/lang/String;
    ...
    :cond_a
    invoke-static {v9, v5, v6}, Lufe;->g([B[[BI)Ljava/lang/String;
    ...
    invoke-static {v1, v5}, Lung;->c1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v8, v5}, Lung;->c1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v11, v1}, Lung;->c1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-direct {v1, v4, p1}, Lfv;-><init>(ILjava/lang/Object;)V

    invoke-static {v1, v0}, Lz5f;->T(Lp5f;I)Lp5f;

    move-result-object p1

    const-string v0, "."

    invoke-static {p1, v0}, Lz5f;->Z(Lp5f;Ljava/lang/String;)Ljava/lang/String;
...
.method public final b()V
    ...
    sget-object v2, Ld7b;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v2, v0, v4, v3}, Lc20;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v1, v2}, Lzb7;-><init>(Ld0g;)V

    new-instance v0, Lkzd;

    invoke-direct {v0, v1}, Lkzd;-><init>(Ld0g;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    invoke-virtual {v0}, Lkzd;->readInt()I

    move-result v1

    int-to-long v1, v1

    invoke-virtual {v0, v1, v2}, Lkzd;->S0(J)V

    iget-object v3, v0, Lkzd;->b:Lez0;

    invoke-virtual {v3, v1, v2}, Lez0;->V(J)[B
    ...
    invoke-virtual {v0, v2, v3}, Lkzd;->S0(J)V

    iget-object v4, v0, Lkzd;->b:Lez0;

    invoke-virtual {v4, v2, v3}, Lez0;->V(J)[B
    ...
    :try_start_3
    invoke-virtual {v0}, Lkzd;->close()V
