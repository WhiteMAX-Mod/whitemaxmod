...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lf70;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;Lkwj;Lkwj;)V
    .locals 14
    ...
    invoke-direct/range {v1 .. v8}, Lcom/google/android/gms/common/internal/a;-><init>(Landroid/content/Context;Landroid/os/Looper;ILf70;Lu87;Lv87;I)V

    iget-object p1, v5, Lf70;->c:Ljava/lang/Object;
    ...
    iput-object v3, v2, Ll97;->a:Ljava/util/HashSet;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, v2, Ll97;->h:Ljava/util/HashMap;
    ...
    iput-object v0, v2, Ll97;->i:Ljava/lang/String;
    ...
    iput-object v0, v2, Ll97;->a:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, v2, Ll97;->h:Ljava/util/HashMap;
    ...
    sget-object v3, Lv0k;->a:Ljava/util/Random;
    ...
    iget-object v4, v2, Ll97;->a:Ljava/util/HashSet;
    ...
    :cond_1
    iget-object p1, v2, Ll97;->a:Ljava/util/HashSet;
    ...
    :cond_2
    iget-boolean v0, v2, Ll97;->d:Z

    if-eqz v0, :cond_4

    iget-object v0, v2, Ll97;->f:Landroid/accounts/Account;
    ...
    iget-object v6, v2, Ll97;->f:Landroid/accounts/Account;

    iget-boolean v7, v2, Ll97;->d:Z

    iget-boolean v8, v2, Ll97;->b:Z

    iget-boolean v9, v2, Ll97;->c:Z

    iget-object v10, v2, Ll97;->e:Ljava/lang/String;

    iget-object v11, v2, Ll97;->g:Ljava/lang/String;

    iget-object v12, v2, Ll97;->h:Ljava/util/HashMap;

    iget-object v13, v2, Ll97;->i:Ljava/lang/String;
    ...
    iput-object v3, p0, Lo7k;->y:Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
...
.method public final l(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-direct {v1, p1, v0, v2}, Ldwj;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V
