...
.method public constructor <init>(Lel7;Lun;Lpn;IZ)V
    .locals 0

    .line 4
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lg70;->e:Ljava/lang/Object;
...
.method public a()Lh70;
    ...
    iget-boolean v6, p0, Lg70;->b:Z

    invoke-direct/range {v1 .. v6}, Lh70;-><init>(ILandroid/media/AudioManager$OnAudioFocusChangeListener;Landroid/os/Handler;Lc60;Z)V
...
.method public c(La70;Landroid/os/Handler;)V
    .locals 0
...
.method public e(Ljava/io/BufferedOutputStream;)V
    ...
    iget-object v3, v3, Lel7;->b:Lnn;

    iget-boolean v4, p0, Lg70;->b:Z
    ...
    invoke-virtual {v3, v4, v2, v1, v0}, Lnn;->c(Ljava/io/OutputStream;Lho;Lpn;I)V

    invoke-virtual {v4}, Ljava/util/zip/DeflaterOutputStream;->finish()V

    invoke-virtual {v4}, Lbl7;->l()V

    return-void

    :cond_0
    invoke-virtual {v3, p1, v2, v1, v0}, Lnn;->c(Ljava/io/OutputStream;Lho;Lpn;I)V
