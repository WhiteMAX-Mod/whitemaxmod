...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Liwj;->o0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Liwj;->n0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Llbk;->f:Lldk;

    iget-object p1, p1, Lldk;->a:Lsuk;

    if-eqz p1, :cond_9

    iget-object p2, p3, Llbk;->e:Ls1h;

    iget-object p4, p1, Lsuk;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lsuk;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Lqnk;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lsuk;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Llbk;->d:Lctf;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lctf;->n(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p4, p1, p2}, Layj;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Llbk;->e:Ls1h;

    invoke-virtual {p1, p4}, Ls1h;->d(Ljava/lang/Object;)V
    ...
    invoke-static {p1, p3}, Lr16;->f(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, p3, Lmrk;->f:Lksk;

    iget-object p1, p1, Lksk;->a:Ljyk;

    iget-object p2, p3, Lmrk;->e:Ls1h;

    invoke-virtual {p1, p2}, Ljyk;->d(Ls1h;)V

    iget-object p1, p3, Lmrk;->d:Lew8;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lew8;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lew8;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Ls1h;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lmrk;->g:Lksk;
    ...
    iget-object p1, p1, Lksk;->d:Lquk;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lquk;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lquk;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lvs;-><init>(I)V

    invoke-virtual {p2, p1}, Ls1h;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Liwj;->m0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
