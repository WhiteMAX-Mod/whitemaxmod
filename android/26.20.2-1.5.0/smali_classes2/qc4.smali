...
.method public constructor <init>(Landroid/content/Context;Lob4;Lol0;)V
    ...
    invoke-direct {v0, p1}, Lklb;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v0}, Ld6e;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lqc4;->u:Lob4;

    iput-object p3, p0, Lqc4;->v:Lol0;
    ...
    invoke-virtual {v0, p1}, Lklb;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Ltq1;

    const/4 p2, 0x1

    invoke-direct {p1, p2, p0}, Ltq1;-><init>(ILjava/lang/Object;)V
