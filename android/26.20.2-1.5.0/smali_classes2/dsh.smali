...
# direct methods
.method public constructor <init>(Ll6a;Lfu5;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldsh;->a:Ll6a;

    iput-object p2, p0, Ldsh;->b:Lfu5;

    new-instance p1, Lg68;

    invoke-direct {p1}, Lg68;-><init>()V

    iput-object p1, p0, Ldsh;->d:Lg68;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Ldsh;->e:Landroid/graphics/Rect;

    sget-object p1, Lhj5;->b:Lhj5;

    iput-object p1, p0, Ldsh;->h:Lhj5;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lz5e;)V
    ...
    iget-object v0, p0, Ldsh;->d:Lg68;

    if-ltz p4, :cond_5

    iget-object v1, p0, Ldsh;->a:Ll6a;

    iget-object v2, v1, Loo8;->d:Lo00;
    ...
    :cond_0
    invoke-virtual {v1, v2, v3}, Ll6a;->P(J)I

    move-result v4

    invoke-virtual {v1, v4}, Ll6a;->R(I)Lone/me/messages/list/loader/MessageModel;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, Ldsh;->i()Landroid/view/ViewGroup;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v0, p1, p2, p3}, Lg68;->f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    invoke-virtual {v0, v1, v2}, Ll6a;->P(J)I
    ...
    :cond_4
    invoke-virtual {v0, v5}, Ll6a;->R(I)Lone/me/messages/list/loader/MessageModel;
    ...
    iget-object v6, p0, Ldsh;->d:Lg68;

    iget-object v8, p0, Ldsh;->e:Landroid/graphics/Rect;

    invoke-virtual {v6, v8, v3, v5}, Lg68;->d(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v8, p0, Ldsh;->b:Lfu5;

    invoke-static/range {v7 .. v12}, Lbt4;->K(Landroid/view/View;Landroid/view/View;IIII)V
...
.method public final i()Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, Ldsh;->b:Lfu5;

    invoke-virtual {v0}, Landroid/view/View;->getMeasuredWidth()I

    move-result v1

    iget-object v2, p0, Ldsh;->f:Landroid/widget/FrameLayout;
    ...
    invoke-interface {v8}, Lzub;->m()Ly75;

    move-result-object v8

    iget-object v8, v8, Ly75;->d:Ljava/lang/Object;

    check-cast v8, Lobj;

    iget-object v8, v8, Lobj;->c:Ljava/lang/Object;

    check-cast v8, Ldub;

    iget-object v8, v8, Ldub;->a:[I
    ...
    invoke-virtual {v9, v6}, Lwj3;->f(Landroid/content/Context;)Lxg3;
    ...
    iget-object v7, p0, Ldsh;->h:Lhj5;

    invoke-virtual {v6, v5, v7}, Lb6h;->b(Landroid/widget/TextView;Lhj5;)V
    ...
    :goto_1
    iput-object v3, p0, Ldsh;->f:Landroid/widget/FrameLayout;

    iput v1, p0, Ldsh;->g:I

    :cond_3
    iget-object v0, p0, Ldsh;->f:Landroid/widget/FrameLayout;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-object v3, v3, Ly75;->d:Ljava/lang/Object;

    check-cast v3, Lobj;

    iget-object v3, v3, Lobj;->c:Ljava/lang/Object;

    check-cast v3, Ldub;

    iget-object v3, v3, Ldub;->a:[I
