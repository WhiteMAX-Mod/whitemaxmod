...
.method public final b(Lufh;)V
    ...
    iget-object v2, v0, Ll0b;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Luza;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Ltza;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Luza;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Luza;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lsza;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Ll0b;->d:Z

    if-eqz v1, :cond_8

    iget-object v1, v0, Ll0b;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, Ltza;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Ltza;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
