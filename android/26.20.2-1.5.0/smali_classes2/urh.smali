...
.method public final dispatch(Lki4;Ljava/lang/Runnable;)V
    ...
    sget-object p1, Lw05;->b:Lw05;

    const/4 v0, 0x1

    iget-object p1, p1, Lase;->a:Lti4;

    const/4 v1, 0x0

    invoke-virtual {p1, p2, v0, v1}, Lti4;->F(Ljava/lang/Runnable;ZZ)V
...
.method public final dispatchYield(Lki4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1, p2, v0, v0}, Lti4;->F(Ljava/lang/Runnable;ZZ)V
