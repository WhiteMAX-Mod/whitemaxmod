...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lvgh;->t:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lvgh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    iput-object v1, p0, Lvgh;->b:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lvgh;->c:Landroid/widget/ImageView;
    ...
    iput-object p1, p0, Lvgh;->d:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lvgh;->e:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lvgh;->f:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lvgh;->g:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lvgh;->h:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/PathMeasure;

    invoke-direct {p1}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object p1, p0, Lvgh;->i:Landroid/graphics/PathMeasure;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lvgh;->j:Landroid/graphics/RectF;

    new-instance p1, Lpgh;

    const/4 v3, 0x0

    invoke-direct {p1, v3, p0}, Lpgh;-><init>(ILvgh;)V
    ...
    iput-object p1, p0, Lvgh;->k:Ljava/lang/Object;

    new-instance p1, Lpgh;

    const/4 v4, 0x1

    invoke-direct {p1, v4, p0}, Lpgh;-><init>(ILvgh;)V

    invoke-static {v3, p1}, Lrwd;->w(ILpz6;)Lxg8;

    move-result-object p1

    iput-object p1, p0, Lvgh;->l:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lvgh;->m:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lvgh;->n:Ljava/lang/Object;
...
.method public static a(Lvgh;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-direct {p0, p1}, Lvgh;->setDrawableColor(I)V
...
.method private final getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lvgh;->l:Ljava/lang/Object;
...
.method private final getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lvgh;->m:Ljava/lang/Object;
...
.method private final getLoadingAnimator()Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lvgh;->k:Ljava/lang/Object;
...
.method private final getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, Lvgh;->n:Ljava/lang/Object;
...
.method private final setDrawableColor(I)V
    ...
    iget-object v1, p0, Lvgh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;

    invoke-static {v1, v0, p1}, Llhe;->r0(Lb5i;Ljava/lang/String;I)V
...
.method public final b(IZ)V
    ...
    invoke-virtual {p0, v1}, Lvgh;->onThemeChanged(Lzub;)V
    ...
    invoke-direct {p2, p1, p0}, Lur9;-><init>(ILvgh;)V

    invoke-static {p0, p2}, Lhki;->e(Landroid/view/View;Lpz6;)V
    ...
    :cond_2
    iget-object p2, p0, Lvgh;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    invoke-direct {p0}, Lvgh;->getBackgroundColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lvgh;->getLoadingToSuccessAnimatorSet()Landroid/animation/AnimatorSet;
    ...
    iget-boolean v0, p0, Lvgh;->r:Z

    invoke-static {p2, v0}, Lpy6;->n(Lg40;Z)Lnub;

    move-result-object p2

    iget-object p2, p2, Lnub;->c:Llub;

    iget p2, p2, Llub;->a:I

    invoke-direct {p0, p2}, Lvgh;->setDrawableColor(I)V
    ...
    iget-boolean p2, p0, Lvgh;->s:Z

    if-nez p2, :cond_8

    invoke-direct {p0}, Lvgh;->getDrawableColorAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0}, Lvgh;->getLoadingAnimator()Landroid/animation/ValueAnimator;
...
.method public final onAttachedToWindow()V
    ...
    invoke-direct {v1, v0, p0}, Lur9;-><init>(ILvgh;)V

    invoke-static {p0, v1}, Lhki;->e(Landroid/view/View;Lpz6;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lvgh;->d:Landroid/graphics/Paint;

    iget-object v3, p0, Lvgh;->j:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-object v0, p0, Lvgh;->i:Landroid/graphics/PathMeasure;
    ...
    iget-object v4, p0, Lvgh;->h:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    cmpl-float v5, v2, v8

    iget-object v6, p0, Lvgh;->f:Landroid/graphics/Paint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lvgh;->b:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lvgh;->c:Landroid/widget/ImageView;
...
.method public final onMeasure(II)V
    ...
    invoke-static {v0, v1, v2}, Lf52;->b(FFI)I
    ...
    iget-object v4, p0, Lvgh;->b:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lvgh;->c:Landroid/widget/ImageView;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lvgh;->j:Landroid/graphics/RectF;

    const/4 p4, 0x0

    invoke-virtual {p3, p4, p4, p1, p2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lvgh;->g:Landroid/graphics/Path;
    ...
    iget-object p4, p0, Lvgh;->e:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Lvgh;->i:Landroid/graphics/PathMeasure;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-boolean v1, p0, Lvgh;->r:Z

    invoke-static {p1, v1}, Lpy6;->n(Lg40;Z)Lnub;

    move-result-object p1

    iget-object v1, p1, Lnub;->d:Ljub;
    ...
    iget-object v5, p0, Lvgh;->e:Landroid/graphics/Paint;

    invoke-virtual {v5, v4}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v4, p0, Lvgh;->s:Z
    ...
    :goto_0
    iget-object v4, p0, Lvgh;->f:Landroid/graphics/Paint;

    invoke-virtual {v4, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget-boolean v1, p0, Lvgh;->s:Z
    ...
    iget-object v4, p0, Lvgh;->c:Landroid/widget/ImageView;
    ...
    :goto_3
    invoke-direct {p0, v2}, Lvgh;->setDrawableColor(I)V
