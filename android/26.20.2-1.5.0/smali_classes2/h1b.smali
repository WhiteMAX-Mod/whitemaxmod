...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lz5e;)V
    ...
    :cond_1
    invoke-virtual {p3, p2}, Lvx3;->H(I)Landroid/util/Pair;

    move-result-object p3

    iget-object p4, p3, Landroid/util/Pair;->first:Ljava/lang/Object;

    instance-of p4, p4, Lj2b;
    ...
    invoke-virtual {p3, v1}, Loo8;->G(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lzo8;

    instance-of v2, v1, Ld2b;
    ...
    invoke-virtual {p3, v2}, Lbtf;->K(I)Lzo8;

    move-result-object p3

    instance-of v2, p3, Ld2b;
