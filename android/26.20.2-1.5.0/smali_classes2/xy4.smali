...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILi55;)V
    .locals 1
    ...
    iput-object p1, p0, Lxy4;->g:Ljava/lang/String;

    iput p2, p0, Lxy4;->e:I

    iput p3, p0, Lxy4;->f:I

    iput-object p4, p0, Lxy4;->h:Li55;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lxy4;->l:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Lxy4;->l:Ljava/io/InputStream;

    invoke-virtual {p0}, Lxy4;->g()V

    iget-boolean v2, p0, Lxy4;->m:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Lxy4;->m:Z

    invoke-virtual {p0}, Lrm0;->c()V

    :cond_1
    iput-object v1, p0, Lxy4;->k:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Lxy4;->j:Lzq4;
...
.method public final g()V
    ...
    iget-object v0, p0, Lxy4;->k:Ljava/net/HttpURLConnection;
...
.method public final h(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lxy4;->h:Li55;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Li55;->A()Ljava/util/Map;
    ...
    :cond_1
    invoke-static {p4, p5, p6, p7}, Lnm7;->a(JJ)Ljava/lang/String;
    ...
    :cond_2
    iget-object p4, p0, Lxy4;->g:Ljava/lang/String;
    ...
    invoke-static {p2}, Lzq4;->b(I)Ljava/lang/String;
...
.method public final i(Lzq4;)J
    ...
    iput-object v0, v1, Lxy4;->j:Lzq4;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Lxy4;->p:J

    iput-wide v12, v1, Lxy4;->o:J
    ...
    iget-object v3, v0, Lzq4;->a:Landroid/net/Uri;
    ...
    iget-object v4, v0, Lzq4;->d:[B

    iget-wide v5, v0, Lzq4;->f:J

    iget-wide v7, v0, Lzq4;->g:J

    invoke-virtual {v0, v14}, Lzq4;->c(I)Z

    move-result v9

    iget-object v11, v0, Lzq4;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lxy4;->h(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lzq4;->f:J

    iget-wide v5, v0, Lzq4;->g:J

    iput-object v2, v1, Lxy4;->k:Ljava/net/HttpURLConnection;
    ...
    sget-object v8, Lnm7;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, Lfv7;->q(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, Lnm7;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v5}, Lfv7;->S(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10, v5}, Lfv7;->q(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, Lxy4;->l:Ljava/io/InputStream;

    if-eqz v7, :cond_9

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Lxy4;->l:Ljava/io/InputStream;
    ...
    :goto_5
    iput-boolean v9, v1, Lxy4;->m:Z

    invoke-virtual/range {p0 .. p1}, Lrm0;->f(Lzq4;)V

    :try_start_5
    invoke-virtual {v1, v3, v4}, Lxy4;->j(J)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_4

    iget-wide v2, v1, Lxy4;->o:J
    ...
    invoke-static {v7}, Lnm7;->b(Ljava/lang/String;)J
...
.method public final j(J)V
    ...
    iget-object v5, p0, Lxy4;->l:Ljava/io/InputStream;
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lxy4;->l:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lxy4;->p:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lxy4;->p:J
...
.method public final v()Ljava/util/Map;
    ...
    invoke-direct {v1, v0}, Lwy4;-><init>(Ljava/util/Map;)V
