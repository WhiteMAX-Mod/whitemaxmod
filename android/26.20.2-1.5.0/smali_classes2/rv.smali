...
.method public constructor <init>(Landroid/util/Rational;Landroid/util/Rational;)V
    ...
    :goto_0
    iput-object p2, p0, Lrv;->b:Landroid/util/Rational;

    invoke-virtual {p0, p1}, Lrv;->b(Landroid/util/Rational;)Landroid/graphics/RectF;

    move-result-object p1

    iput-object p1, p0, Lrv;->a:Landroid/graphics/RectF;
...
.method public final b(Landroid/util/Rational;)Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lrv;->b:Landroid/util/Rational;
...
.method public final compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p2}, Lrv;->b(Landroid/util/Rational;)Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lrv;->a:Landroid/graphics/RectF;
    ...
    :cond_5
    invoke-static {p1, v2}, Lrv;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;)F

    move-result p1

    invoke-static {p2, v2}, Lrv;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;)F
