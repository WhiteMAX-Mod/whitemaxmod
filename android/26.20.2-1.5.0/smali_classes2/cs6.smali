...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcs6;->b:Lso0;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;)Ll25;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, Lcs6;->b(Landroid/content/pm/PackageManager;Les6;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0, v2, v3}, Lcs6;->c(Landroid/content/Context;Les6;Ljava/lang/String;)[Los6;
    ...
    invoke-direct {p0, v0}, Ll25;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;Les6;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9

    sget-object v0, Lcs6;->b:Lso0;

    sget-object v1, Lcs6;->a:Ln09;
    ...
    :try_start_0
    iget-object v4, p1, Les6;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v5, p1, Les6;->a:Ljava/lang/String;

    iget-object p1, p1, Les6;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2, v6}, Luuk;->f(Landroid/content/res/Resources;I)Ljava/util/List;

    move-result-object v4

    :goto_0
    new-instance p2, Lbs6;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object v5, p2, Lbs6;->a:Ljava/lang/String;

    iput-object p1, p2, Lbs6;->b:Ljava/lang/String;

    iput-object v4, p2, Lbs6;->c:Ljava/util/List;

    invoke-virtual {v1, p2}, Ln09;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v1, p2, v7}, Ln09;->d(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_2
...
.method public static c(Landroid/content/Context;Les6;Ljava/lang/String;)[Los6;
    .locals 18
    ...
    iget-object v0, v0, Les6;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v12 .. v17}, Los6;-><init>(Landroid/net/Uri;IIZI)V
