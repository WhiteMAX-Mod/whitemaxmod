...
# direct methods
.method public constructor <init>(Ln3c;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lbtf;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Li2f;->e:Ln3c;

    iput-object p2, p0, Li2f;->f:Ljava/util/concurrent/ExecutorService;
...
.method public final L(Lquf;I)V
    ...
    invoke-virtual {p1, p2}, Lh2f;->G(Lc27;)V
...
.method public final x(Landroid/view/ViewGroup;I)Ld6e;
    ...
    invoke-direct {p2, p1}, Lfhb;-><init>(Landroid/content/Context;)V
    ...
    iget-object v2, p0, Li2f;->e:Ln3c;

    invoke-direct {p1, v2, p2, v0, v1}, Lh2f;-><init>(Ln3c;Lfhb;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
