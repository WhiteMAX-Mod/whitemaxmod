...
.method public synthetic constructor <init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    iput-object p1, p0, Ls5d;->b:Lone/me/profileedit/ProfileEditScreen;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v6, v0, Ls5d;->b:Lone/me/profileedit/ProfileEditScreen;
    ...
    invoke-virtual {v6}, Lrf4;->getOnBackPressedDispatcher()Ls7b;
    ...
    invoke-virtual {v2, v7}, Lqab;->setAddBadgeVisibility(Z)V

    new-instance v3, Lt5d;

    invoke-direct {v3, v6, v8}, Lt5d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    sget-object v9, Lone/me/profileedit/ProfileEditScreen;->p:[Lre8;
    ...
    invoke-direct {v10, v3, v2}, Lpm3;-><init>(II)V

    iput v8, v10, Lpm3;->a:I
    ...
    sget-object v4, Lone/me/profileedit/ProfileEditScreen;->p:[Lre8;
    ...
    invoke-direct {v4, v7}, Lfwb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v7}, Lfwb;->setForm(Luvb;)V
    ...
    invoke-direct {v10, v6, v11}, Ls5d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V

    invoke-direct {v7, v10}, Lkvb;-><init>(Lrz6;)V

    invoke-virtual {v4, v7}, Lfwb;->setLeftActions(Lpvb;)V

    sget-object v7, Lmvb;->a:Lmvb;

    invoke-virtual {v4, v7}, Lfwb;->setRightActions(Lrvb;)V
    ...
    invoke-direct {v4, v6, v7}, Ls5d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    invoke-direct {v9, v3, v2}, Lpm3;-><init>(II)V
    ...
    invoke-virtual {v4, v6}, Ls5d;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v10}, Ljp;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v8}, Ljp;->setLiftOnScroll(Z)V

    invoke-virtual {v9, v4}, Landroid/view/View;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

    sget-object v10, Lone/me/profileedit/ProfileEditScreen;->p:[Lre8;

    new-instance v10, Ls5d;

    invoke-direct {v10, v6, v8}, Ls5d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    invoke-direct {v8, v11}, Lsm3;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v11}, Lhp;-><init>()V

    const/16 v12, 0x13

    iput v12, v11, Lhp;->a:I

    invoke-virtual {v8, v11}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v8, v7}, Lsm3;->setTitleEnabled(Z)V

    invoke-virtual {v10, v8}, Ls5d;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v3, v3}, Lth4;-><init>(II)V
    ...
    invoke-virtual {v9, v10}, Lth4;->b(Lqh4;)V
    ...
    invoke-virtual {v8, v9}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Ln5e;)V
    ...
    iget-object v9, v6, Lone/me/profileedit/ProfileEditScreen;->g:Lpl0;

    invoke-virtual {v8, v9}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lf5e;)V

    invoke-virtual {v8, v4}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lk5e;)V
    ...
    sget-object v10, Ld28;->a:Llna;

    new-instance v10, Llna;

    invoke-direct {v10, v4}, Llna;-><init>(I)V
    ...
    invoke-virtual {v10, v12}, Llna;->h(I)V
    ...
    :cond_1
    new-instance v14, Lj18;

    const/16 v4, 0x1d

    invoke-direct {v14, v6, v4, v10}, Lj18;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v12, La0f;

    sget-object v4, Lxg3;->j:Lwj3;

    invoke-static {v8, v4}, Ln;->e(Landroidx/recyclerview/widget/RecyclerView;Lwj3;)Lzub;
    ...
    invoke-direct/range {v12 .. v17}, La0f;-><init>(Lzub;Lyze;Lrz6;Lf5a;I)V

    invoke-virtual {v8, v12, v3}, Landroidx/recyclerview/widget/RecyclerView;->i(Ll5e;I)V

    new-instance v9, Lw39;

    invoke-direct {v9, v7}, Lw39;-><init>(I)V

    invoke-virtual {v8, v9, v3}, Landroidx/recyclerview/widget/RecyclerView;->i(Ll5e;I)V
    ...
    invoke-direct {v9, v3, v2}, Lth4;-><init>(II)V

    const/16 v10, 0x50

    iput v10, v9, Lth4;->c:I
    ...
    invoke-virtual {v4, v9}, Lwj3;->f(Landroid/content/Context;)Lxg3;
    ...
    invoke-static {v6, v4}, Lone/me/profileedit/ProfileEditScreen;->k1(Lone/me/profileedit/ProfileEditScreen;Lzub;)V
    ...
    invoke-direct {v4, v6, v9, v8}, Lcz1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    sget-object v9, Lhcb;->a:Lhcb;

    invoke-virtual {v4, v9}, Lpcb;->setMode(Lhcb;)V

    sget-object v9, Lfcb;->d:Lfcb;
    ...
    invoke-virtual {v4, v2}, Lpcb;->setText(I)V

    new-instance v2, Lt5d;

    invoke-direct {v2, v6, v7}, Lt5d;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
