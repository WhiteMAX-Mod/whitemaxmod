...
.method public synthetic constructor <init>(Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;I)V
    ...
    iput-object p1, p0, Lr7e;->b:Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v5, p0, Lr7e;->b:Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;
    ...
    iget-object v7, v5, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->m:Lzyd;

    sget-object v8, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->u:[Lre8;

    aget-object v2, v8, v2

    invoke-interface {v7, v5, v2}, Lzyd;->C(Ljava/lang/Object;Lre8;)Ljava/lang/Object;
    ...
    iget-object v2, v5, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->c:Lpse;
    ...
    invoke-static {v6, v7, p1}, Lr16;->b(FFI)I

    move-result p1

    invoke-direct {v8, v2, p1}, Lone/me/login/neuroavatars/NeuroAvatarPickerBottomSheet;-><init>(Lpse;I)V
    ...
    invoke-static {v0, v7, v4, v1}, Ln;->k(ZLxke;ZLjava/lang/String;)V

    invoke-virtual {v3, v7}, Ltke;->I(Lxke;)V
    ...
    invoke-virtual {v5}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->k1()Lo7e;
    ...
    :cond_4
    invoke-virtual {v5}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->l1()Lwta;
    ...
    sget v6, Lasd;->oneme_login_neuro_avatars_bottomsheet_title:I

    invoke-static {v6, v3, v3, v2}, Ln;->c(ILandroid/os/Bundle;Ltse;I)Ll14;
    ...
    invoke-virtual {v6}, Lro8;->hasNext()Z

    move-result v7

    if-eqz v7, :cond_5

    invoke-virtual {v6}, Lro8;->next()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lm14;

    filled-new-array {v6}, [Lm14;

    move-result-object v6

    invoke-virtual {v2, v6}, Ll14;->a([Lm14;)V
    ...
    invoke-virtual {v5, v4}, Lone/me/login/neuroavatars/RegistrationNeuroAvatarsScreen;->m1(Z)V
