...
.method public onChangeEnded(Lwf4;Lxf4;)V
    ...
    invoke-virtual {p0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->t1()V

    :cond_0
    return-void
.end method

.method public onChangeStarted(Lwf4;Lxf4;)V
    .locals 1
    ...
    invoke-interface {p1, v0}, Lnwg;->setOnTouch(Lrz6;)V

    invoke-interface {p1, v0}, Lnwg;->setOnRequestInterceptTouchEvent(Lpz6;)V
...
.method public final s1(Lrf4;)V
    ...
    invoke-virtual {p0, v1}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->s1(Lrf4;)V
...
.method public final t1()V
    ...
    invoke-virtual {v4, v1, v2, v6, v3}, Lyjb;->c(Lnv8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v13, v0, v1, v12}, Lljd;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    instance-of v1, v11, Lnwg;

    if-eqz v1, :cond_b

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->w1()Ljava/lang/Integer;

    move-result-object v7

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->k1()I

    move-result v14

    new-instance v17, Liwg;

    new-instance v8, Lpwg;

    const/4 v2, 0x0

    invoke-direct {v8, v0, v2}, Lpwg;-><init>(Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;I)V

    new-instance v9, Lpwg;

    const/4 v2, 0x1

    invoke-direct {v9, v0, v2}, Lpwg;-><init>(Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;I)V

    new-instance v10, Lpwg;

    const/4 v2, 0x2

    invoke-direct {v10, v0, v2}, Lpwg;-><init>(Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;I)V

    move-object/from16 v6, v17

    invoke-direct/range {v6 .. v14}, Liwg;-><init>(Ljava/lang/Integer;Lpwg;Lpwg;Lpwg;Landroid/view/View;Landroid/view/ViewGroup;Lljd;I)V

    iput-object v0, v6, Liwg;->s:Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->v1()Ljava/lang/Long;

    move-result-object v2

    iput-object v2, v6, Liwg;->t:Ljava/lang/Long;
    ...
    invoke-direct/range {v15 .. v22}, Llr9;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-interface {v3, v15}, Lnwg;->setOnTouch(Lrz6;)V

    new-instance v15, Lcwb;
    ...
    invoke-direct/range {v15 .. v22}, Lcwb;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-interface {v3, v15}, Lnwg;->setOnRequestInterceptTouchEvent(Lpz6;)V
...
.method public v1()Ljava/lang/Long;
    .locals 1
