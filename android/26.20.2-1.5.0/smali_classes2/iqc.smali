...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Liqc;->a:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Liqc;->b:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Liqc;->c:Landroid/text/TextPaint;
    ...
    iput-object v1, p0, Liqc;->g:Ldxg;

    new-instance v0, Lhqc;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lhqc;-><init>(Liqc;I)V

    new-instance v1, Ldxg;

    invoke-direct {v1, v0}, Ldxg;-><init>(Lpz6;)V

    iput-object v1, p0, Liqc;->h:Ldxg;
    ...
    invoke-virtual {p0, p1}, Liqc;->onThemeChanged(Lzub;)V

    new-instance p1, Lg68;

    invoke-direct {p1}, Lg68;-><init>()V

    iput-object p1, p0, Liqc;->j:Lg68;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lz5e;)V
    ...
    invoke-static {p3, p4}, Liqc;->i(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
...
.method public final g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lz5e;)V
    ...
    invoke-static {p2, v2}, Liqc;->i(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-static {p2, v5}, Liqc;->i(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    iget-object v4, p0, Liqc;->j:Lg68;

    iget-object v5, p0, Liqc;->b:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Liqc;->c:Landroid/text/TextPaint;
...
.method public final onThemeChanged(Lzub;)V
    ...
    iget-object v2, p0, Liqc;->a:Landroid/content/Context;

    iget-object v3, p0, Liqc;->c:Landroid/text/TextPaint;
