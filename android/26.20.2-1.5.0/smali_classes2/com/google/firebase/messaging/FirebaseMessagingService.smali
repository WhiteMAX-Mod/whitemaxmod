...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Loje;->J(Landroid/os/Bundle;)Z
    ...
    iput-object v5, v4, Loje;->a:Ljava/lang/Object;
    ...
    invoke-direct {v8, p0, v4, v5}, Lcn9;-><init>(Lcom/google/firebase/messaging/FirebaseMessagingService;Loje;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v8}, Lcn9;->K()Z
    ...
    invoke-static {p1}, Lm9k;->e(Landroid/content/Intent;)Z
    ...
    invoke-static {v5, v4}, Lm9k;->c(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {v4, v0}, Lw8e;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Lw8e;)V
    ...
    :cond_10
    :goto_4
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lble;
    ...
    invoke-direct {v0, v4}, Lble;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lble;

    :cond_11
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lble;

    iget-object v4, v0, Lble;->c:Lx9c;

    invoke-virtual {v4}, Lx9c;->B()I
    ...
    :cond_14
    iget-object p1, v0, Lble;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, v1, v6, v4, v7}, Lisk;-><init>(IILandroid/os/Bundle;I)V
