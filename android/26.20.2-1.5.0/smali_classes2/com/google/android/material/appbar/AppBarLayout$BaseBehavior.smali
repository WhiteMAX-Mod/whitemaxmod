...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lgli;-><init>(I)V
...
.method public static I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;IIZ)V
    .locals 7
    ...
    invoke-virtual {p1, p2}, Ljp;->h(Landroid/view/View;)Z

    move-result v3

    :cond_4
    invoke-virtual {p1, v3}, Ljp;->g(Z)Z
    ...
    iget-object p0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lvxg;

    iget-object p0, p0, Lvxg;->b:Ljava/lang/Object;

    check-cast p0, Ldtf;

    invoke-virtual {p0, p1}, Ldtf;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
# virtual methods
.method public final A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;Landroid/view/View;I[I)V
    .locals 8
    ...
    invoke-virtual {p2}, Ljp;->getDownNestedPreScrollRange()I
    ...
    :cond_0
    invoke-virtual {p2}, Ljp;->getUpNestedPreScrollRange()I
    ...
    :goto_2
    iget-boolean p1, v4, Ljp;->l:Z

    if-eqz p1, :cond_2

    invoke-virtual {v4, p3}, Ljp;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {v4, p1}, Ljp;->g(Z)Z

    :cond_2
    return-void
.end method

.method public B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;Landroid/view/View;Landroid/view/View;II)Z
    .locals 0
...
.method public C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;Landroid/view/View;I)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;)V

    iget-boolean p1, p2, Ljp;->l:Z

    if-eqz p1, :cond_1

    invoke-virtual {p2, p3}, Ljp;->h(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p2, p1}, Ljp;->g(Z)Z
...
.method public final D(Lfp;Z)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lfp;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lfp;

    return-void
.end method

.method public final E(Landroid/os/Parcelable;Ljp;)Lfp;
    .locals 7

    invoke-virtual {p0}, Lgli;->s()I
    ...
    invoke-virtual {p2}, Ljp;->getTopInset()I
...
.method public final F(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, Lbt4;->k(III)I

    move-result v2

    if-eq v4, v2, :cond_e

    iget-boolean v6, v3, Ljp;->e:Z
    ...
    iget-object v11, v10, Lhp;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v3}, Ljp;->getTopInset()I
    ...
    :goto_2
    iget-object v6, v0, Lgli;->a:Lhli;

    if-eqz v6, :cond_5

    invoke-virtual {v6, v8}, Lhli;->b(I)Z
    ...
    iget-object v11, v10, Lhp;->b:Lt69;

    if-eqz v11, :cond_8

    iget v10, v10, Lhp;->a:I
    ...
    invoke-virtual {v0}, Lgli;->s()I

    move-result v12

    int-to-float v12, v12

    iget-object v13, v11, Lt69;->c:Ljava/lang/Object;

    check-cast v13, Landroid/graphics/Rect;

    iget-object v11, v11, Lt69;->b:Ljava/lang/Object;
    ...
    invoke-static {v15, v12, v8}, Lbt4;->j(FFF)F
    ...
    iget-object v6, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Lvxg;

    iget-object v6, v6, Lvxg;->b:Ljava/lang/Object;

    check-cast v6, Ldtf;

    invoke-virtual {v6, v3}, Ldtf;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v1, v9, v3}, Lqh4;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v6}, Ljp;->d(I)V
    ...
    :goto_8
    invoke-static {v1, v3, v2, v8, v5}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;IIZ)V
    ...
    :cond_e
    :goto_9
    invoke-static {v1}, Ldki;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {v2, v0, v3, v1}, Lep;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ljp;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, v2}, Ldki;->l(Landroid/view/View;Lu4;)V
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;)V
    .locals 12
    ...
    invoke-static {v8, v0, v3}, Lbt4;->k(III)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;I)V
...
.method public final g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->o:Ldsf;
...
.method public bridge synthetic h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->z(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;I)V
...
.method public final bridge synthetic k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {p1 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;Landroid/view/View;I[I)V
...
.method public final l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III[I)V
    ...
    invoke-virtual {v2}, Ljp;->getDownNestedScrollRange()I
    ...
    invoke-direct {p1, p0, v2, v1}, Lep;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ljp;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, p1}, Ldki;->l(Landroid/view/View;Lu4;)V
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->D(Lfp;Z)V

    iget-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lfp;
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->E(Landroid/os/Parcelable;Ljp;)Lfp;
...
.method public bridge synthetic p(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;Landroid/view/View;Landroid/view/View;II)Z
...
.method public bridge synthetic q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;Landroid/view/View;I)V
...
.method public final r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Ljp;->getDownNestedScrollRange()I

    move-result v3

    neg-int v3, v3

    invoke-virtual {v1}, Ljp;->getTopInset()I
    ...
    invoke-virtual {v3}, Ljp;->getTotalScrollRange()I

    move-result v4

    neg-int v4, v4

    iget-object v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lbei;

    if-eqz v5, :cond_5

    invoke-virtual {v2, v5}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v7, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lbei;
    ...
    invoke-direct/range {v0 .. v5}, Lbei;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iput-object v1, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lbei;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;)V

    iget-boolean v2, v3, Ljp;->l:Z
    ...
    invoke-virtual {v3, v1}, Ljp;->h(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v3, v1}, Ljp;->g(Z)Z
...
.method public final w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;I)V
    .locals 5
    ...
    sget-object v3, Lbj;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-direct {v3, p0, p1, p2, v4}, Ldp;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/view/View;I)V
...
.method public z(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;I)V
    .locals 4

    invoke-super {p0, p1, p2, p3}, Lgli;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z

    invoke-virtual {p2}, Ljp;->getPendingAction()I
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lfp;

    iget-boolean v3, v3, Lfp;->g:Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;I)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Lfp;
    ...
    invoke-static {p3, v0, v1}, Lbt4;->k(III)I
    ...
    invoke-virtual {v0, p3}, Lhli;->b(I)Z
    ...
    invoke-static {p1, p2, p3, v1, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Ljp;IIZ)V

    invoke-virtual {p0}, Lgli;->s()I

    move-result p3

    invoke-virtual {p2, p3}, Ljp;->d(I)V

    invoke-static {p1}, Ldki;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p3, p0, p2, p1}, Lep;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Ljp;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {p1, p3}, Ldki;->l(Landroid/view/View;Lu4;)V
