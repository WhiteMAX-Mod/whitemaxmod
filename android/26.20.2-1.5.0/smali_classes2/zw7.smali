...
.method public constructor <init>(Lxg8;Lxg8;Lxg8;Lxg8;)V
    ...
    iput-wide v5, v1, Lzw7;->b:J

    invoke-static {}, Liof;->N()Lso8;

    move-result-object v2

    new-instance v12, Lat4;

    invoke-interface/range {p4 .. p4}, Lxg8;->getValue()Ljava/lang/Object;
    ...
    const-string v0, "26.20.2(6758)"

    invoke-direct {v15, v0}, Lt5h;-><init>(Ljava/lang/CharSequence;)V

    sget v0, Lprd;->oneme_settings_app_version:I
    ...
    invoke-direct/range {v12 .. v19}, Lat4;-><init>(JLu5h;ILu5h;Lsqk;I)V

    invoke-virtual {v2, v12}, Lso8;->add(Ljava/lang/Object;)Z
    ...
    sget v0, Lprd;->oneme_settings_user_id:I
    ...
    invoke-virtual {v13, v2}, Lso8;->add(Ljava/lang/Object;)Z

    new-instance v5, Lat4;

    invoke-interface/range {p3 .. p3}, Lxg8;->getValue()Ljava/lang/Object;
    ...
    invoke-direct {v8, v0}, Lt5h;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v10, v0}, Lt5h;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v2, v3, v4}, Lzk2;-><init>(CC)V
    ...
    invoke-direct {v3, v4, v5}, Lzk2;-><init>(CC)V
    ...
    invoke-static {v3, v2}, Lwm3;->y1(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, v4}, Lcn3;->T0(Ljava/lang/Iterable;Ljava/util/Collection;)V

    invoke-static {v3, v4}, Lcn3;->T0(Ljava/lang/Iterable;Ljava/util/Collection;)V
    ...
    invoke-virtual {v6, v5}, Lo3;->d(I)I

    move-result v5

    invoke-static {v2, v5}, Lwm3;->f1(Ljava/lang/Iterable;I)Ljava/lang/Object;
    ...
    invoke-direct {v7, v0}, Lt5h;-><init>(Ljava/lang/CharSequence;)V
