...
.method public static synthetic b(Lby0;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lby0;->a(Z)V

    return-void
.end method

.method public static c(Lby0;Lacb;ILu5h;IILqe1;I)V
    .locals 13
    ...
    :goto_2
    invoke-static {v5}, Lbt4;->E(Landroid/view/View;)I
    ...
    invoke-static {p2}, Ln9b;->a0(Landroid/content/Context;)I
    ...
    invoke-virtual {p0, v9}, Lby0;->a(Z)V

    new-instance v3, Luch;

    new-instance v6, Lo80;

    invoke-direct {v6, v4, v7}, Lo80;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v3, p2}, Luch;->c(Lu5h;)V

    const-wide/16 v4, 0xbb8

    invoke-virtual {v3, v12, p1, v4, v5}, Luch;->e(Landroid/graphics/Point;IJ)V

    new-instance p1, Lay0;

    invoke-direct {p1, p0, v1, v2}, Lay0;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3, p1}, Landroid/widget/PopupWindow;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    iput-object v3, p0, Lby0;->a:Luch;
...
.method public final a(Z)V
    ...
    iput-boolean p1, p0, Lby0;->b:Z

    iget-object p1, p0, Lby0;->a:Luch;
