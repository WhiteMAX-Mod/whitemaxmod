...
.field public k1:Landroid/window/OnBackInvokedDispatcher;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, p0, v3}, Lfch;-><init>(Landroidx/appcompat/widget/Toolbar;I)V

    invoke-direct {v1, v2}, Lbd6;-><init>(Ljava/lang/Runnable;)V

    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->G:Lbd6;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->I:Lnag;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->m1:Leu9;
    ...
    sget-object v2, Lqud;->Toolbar:[I

    invoke-static {v1, p2, v2, p3}, Lt83;->n(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lt83;

    move-result-object v1

    .line 12
    sget-object v4, Lqud;->Toolbar:[I
    ...
    .line 14
    invoke-static/range {v2 .. v8}, Ldki;->k(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    .line 15
    sget p1, Lqud;->Toolbar_titleTextAppearance:I

    .line 16
    iget-object p2, v1, Lt83;->b:Ljava/lang/Object;
    ...
    .line 18
    sget p1, Lqud;->Toolbar_subtitleTextAppearance:I
    ...
    .line 21
    sget p1, Lqud;->Toolbar_android_gravity:I
    ...
    .line 24
    sget p1, Lqud;->Toolbar_buttonGravity:I
    ...
    .line 27
    sget p1, Lqud;->Toolbar_titleMargin:I
    ...
    .line 29
    sget v0, Lqud;->Toolbar_titleMargins:I
    ...
    .line 34
    sget p1, Lqud;->Toolbar_titleMarginStart:I
    ...
    .line 37
    :cond_1
    sget p1, Lqud;->Toolbar_titleMarginEnd:I
    ...
    .line 40
    :cond_2
    sget p1, Lqud;->Toolbar_titleMarginTop:I
    ...
    .line 43
    :cond_3
    sget p1, Lqud;->Toolbar_titleMarginBottom:I
    ...
    .line 46
    :cond_4
    sget p1, Lqud;->Toolbar_maxButtonHeight:I
    ...
    .line 49
    sget p1, Lqud;->Toolbar_contentInsetStart:I
    ...
    .line 51
    sget v3, Lqud;->Toolbar_contentInsetEnd:I
    ...
    .line 53
    sget v4, Lqud;->Toolbar_contentInsetLeft:I
    ...
    .line 55
    sget v5, Lqud;->Toolbar_contentInsetRight:I
    ...
    .line 58
    iget-object v6, v2, Landroidx/appcompat/widget/Toolbar;->t:Lqle;

    .line 59
    iput-boolean p3, v6, Lqle;->h:Z
    ...
    .line 62
    :cond_7
    invoke-virtual {v6, p1, v3}, Lqle;->a(II)V

    .line 63
    :cond_8
    sget p1, Lqud;->Toolbar_contentInsetStartWithNavigation:I
    ...
    .line 66
    sget p1, Lqud;->Toolbar_contentInsetEndWithActions:I
    ...
    .line 69
    sget p1, Lqud;->Toolbar_collapseIcon:I

    invoke-virtual {v1, p1}, Lt83;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 70
    sget p1, Lqud;->Toolbar_collapseContentDescription:I
    ...
    .line 77
    :cond_9
    sget p1, Lqud;->Toolbar_subtitle:I
    ...
    .line 82
    sget p1, Lqud;->Toolbar_popupTheme:I
    ...
    .line 85
    sget p1, Lqud;->Toolbar_navigationIcon:I
    ...
    .line 87
    :cond_b
    sget p1, Lqud;->Toolbar_navigationContentDescription:I
    ...
    .line 93
    :cond_d
    sget p1, Lqud;->Toolbar_logoDescription:I
    ...
    .line 97
    :cond_e
    sget p1, Lqud;->Toolbar_titleTextColor:I
    ...
    .line 100
    :cond_f
    sget p1, Lqud;->Toolbar_subtitleTextColor:I
...
.method public static i(Landroid/view/ViewGroup$LayoutParams;)Lich;
    .locals 2

    instance-of v0, p0, Lich;
    ...
    invoke-direct {v0, p0}, Lich;-><init>(Lich;)V
    ...
    invoke-direct {v0, p0}, Lich;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final b(Landroid/view/View;Z)V
    ...
    invoke-static {}, Landroidx/appcompat/widget/Toolbar;->h()Lich;
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/Toolbar;->i(Landroid/view/ViewGroup$LayoutParams;)Lich;
...
.method public final c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;
    ...
    sget v3, Lfkd;->toolbarNavigationButtonStyle:I

    invoke-direct {v0, v1, v2, v3}, Ltq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v1}, Ltq;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;
...
.method public final d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->t:Lqle;
    ...
    iput-boolean v1, v0, Lqle;->g:Z

    iput-boolean v1, v0, Lqle;->h:Z

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->t:Lqle;
...
.method public final e()V
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/ActionMenuView;->p:Lms9;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->h1:Lhch;

    if-nez v1, :cond_0

    new-instance v1, Lhch;

    invoke-direct {v1, p0}, Lhch;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->h1:Lhch;
    ...
    invoke-virtual {v0, v1, v2}, Lms9;->c(Ldt9;Landroid/content/Context;)V
...
.method public final f()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->I:Lnag;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ActionMenuView;->setOnMenuItemClickListener(Ld8;)V
    ...
    iput-object v1, v0, Landroidx/appcompat/widget/ActionMenuView;->u:Lxag;
...
.method public final g()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->d:Ltq;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->d:Ltq;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->d:Ltq;
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 5
    sget-object v3, Lqud;->ActionBarLayout:[I
    ...
    .line 6
    sget v1, Lqud;->ActionBarLayout_android_layout_gravity:I
...
.method public final bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-static {p1}, Landroidx/appcompat/widget/Toolbar;->i(Landroid/view/ViewGroup$LayoutParams;)Lich;
...
.method public getCurrentContentInsetEnd()I
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/ActionMenuView;->p:Lms9;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lms9;->hasVisibleItems()Z
...
.method public getLogo()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->e:Luq;
...
.method public getOuterActionMenuPresenter()La8;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->K:La8;
...
.method public getWrapper()Lyt4;
    .locals 9

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->J:Loch;

    if-nez v0, :cond_13

    new-instance v0, Loch;

    sget v1, Lbud;->abc_action_bar_up_description:I
    ...
    iput-object p0, v0, Loch;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {p0}, Landroidx/appcompat/widget/Toolbar;->getTitle()Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, v0, Loch;->h:Ljava/lang/CharSequence;

    invoke-virtual {p0}, Landroidx/appcompat/widget/Toolbar;->getSubtitle()Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, v0, Loch;->i:Ljava/lang/CharSequence;

    iget-object v3, v0, Loch;->h:Ljava/lang/CharSequence;
    ...
    :goto_0
    iput-boolean v3, v0, Loch;->g:Z

    invoke-virtual {p0}, Landroidx/appcompat/widget/Toolbar;->getNavigationIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, v0, Loch;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v3

    sget-object v5, Lqud;->ActionBar:[I

    sget v6, Lfkd;->actionBarStyle:I

    const/4 v7, 0x0

    invoke-static {v3, v7, v5, v6}, Lt83;->n(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lt83;

    move-result-object v3

    iget-object v5, v3, Lt83;->b:Ljava/lang/Object;

    check-cast v5, Landroid/content/res/TypedArray;

    sget v6, Lqud;->ActionBar_homeAsUpIndicator:I

    invoke-virtual {v3, v6}, Lt83;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    iput-object v6, v0, Loch;->o:Landroid/graphics/drawable/Drawable;

    sget v6, Lqud;->ActionBar_title:I
    ...
    iput-boolean v4, v0, Loch;->g:Z

    iput-object v6, v0, Loch;->h:Ljava/lang/CharSequence;
    ...
    invoke-static {v4, v6}, Ldki;->m(Landroid/view/View;Ljava/lang/CharSequence;)V

    :cond_1
    sget v4, Lqud;->ActionBar_subtitle:I
    ...
    iput-object v4, v0, Loch;->i:Ljava/lang/CharSequence;
    ...
    :cond_2
    sget v4, Lqud;->ActionBar_logo:I

    invoke-virtual {v3, v4}, Lt83;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    if-eqz v4, :cond_3

    iput-object v4, v0, Loch;->e:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0}, Loch;->c()V

    :cond_3
    sget v4, Lqud;->ActionBar_icon:I
    ...
    iput-object v4, v0, Loch;->d:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0}, Loch;->c()V

    :cond_4
    iget-object v4, v0, Loch;->f:Landroid/graphics/drawable/Drawable;

    if-nez v4, :cond_6

    iget-object v4, v0, Loch;->o:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_6

    iput-object v4, v0, Loch;->f:Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    :goto_1
    sget v4, Lqud;->ActionBar_displayOptions:I

    invoke-virtual {v5, v4, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {v0, v4}, Loch;->a(I)V

    sget v4, Lqud;->ActionBar_customNavigationLayout:I
    ...
    iget-object v6, v0, Loch;->c:Landroid/view/View;
    ...
    :cond_7
    iput-object v4, v0, Loch;->c:Landroid/view/View;
    ...
    :cond_9
    sget v4, Lqud;->ActionBar_height:I
    ...
    :cond_a
    sget v4, Lqud;->ActionBar_contentInsetStart:I
    ...
    sget v8, Lqud;->ActionBar_contentInsetEnd:I
    ...
    invoke-virtual {p0, v4, v6}, Landroidx/appcompat/widget/Toolbar;->t(II)V

    :cond_c
    sget v4, Lqud;->ActionBar_titleTextStyle:I
    ...
    invoke-virtual {v8, v6, v4}, Landroidx/appcompat/widget/AppCompatTextView;->setTextAppearance(Landroid/content/Context;I)V

    :cond_d
    sget v4, Lqud;->ActionBar_subtitleTextStyle:I
    ...
    :cond_e
    sget v4, Lqud;->ActionBar_popupTheme:I
    ...
    :goto_2
    iput-object v7, v0, Loch;->j:Ljava/lang/CharSequence;

    invoke-virtual {v0}, Loch;->b()V
    ...
    iput-object v1, v0, Loch;->j:Ljava/lang/CharSequence;

    new-instance v1, Lxz1;

    invoke-direct {v1, v0}, Lxz1;-><init>(Loch;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->J:Loch;
...
.method public final n()V
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar;->G:Lbd6;
    ...
    iget-object v4, v4, Lcw6;->a:Landroidx/fragment/app/c;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->m1:Leu9;
...
.method public onLayout(ZIIII)V
    ...
    :goto_1
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->d:Ltq;
    ...
    :goto_3
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;
    ...
    :cond_9
    :goto_6
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->e:Luq;
...
.method public final onMeasure(II)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->d:Ltq;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/Toolbar;->d:Ltq;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;
    ...
    :cond_4
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->e:Luq;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->e:Luq;
    ...
    iget-boolean v3, p0, Landroidx/appcompat/widget/Toolbar;->i1:Z
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->h1:Lhch;

    if-eqz v2, :cond_2

    if-eqz v0, :cond_2

    invoke-virtual {v0, v1}, Lms9;->findItem(I)Landroid/view/MenuItem;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->m1:Leu9;
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Lf0;-><init>(Landroid/os/Parcelable;)V

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->h1:Lhch;

    if-eqz v1, :cond_0

    iget-object v1, v1, Lhch;->b:Lqs9;
    ...
    :goto_0
    iput-boolean v1, v0, Landroidx/appcompat/widget/Toolbar$a;->d:Z
...
.method public setBackInvokedCallbackEnabled(Z)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/Toolbar;->l1:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Landroidx/appcompat/widget/Toolbar;->l1:Z
...
.method public setCollapseIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 4
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->h:Ltq;
    ...
    invoke-virtual {p1, v0}, Ltq;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->e:Luq;
...
.method public setNavigationContentDescription(Ljava/lang/CharSequence;)V
    ...
    .line 7
    invoke-static {v0, p1}, Lpch;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public setOnMenuItemClickListener(Ljch;)V
    .locals 0
...
.method public final t(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lqle;->a(II)V
...
.method public final v()V
    ...
    invoke-static {p0}, Lgch;->a(Landroid/view/View;)Landroid/window/OnBackInvokedDispatcher;
    ...
    iget-boolean v1, p0, Landroidx/appcompat/widget/Toolbar;->l1:Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->k1:Landroid/window/OnBackInvokedDispatcher;

    if-nez v2, :cond_2

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->j1:Landroid/window/OnBackInvokedCallback;
    ...
    invoke-direct {v1, p0, v2}, Lfch;-><init>(Landroidx/appcompat/widget/Toolbar;I)V

    invoke-static {v1}, Lgch;->b(Ljava/lang/Runnable;)Landroid/window/OnBackInvokedCallback;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->j1:Landroid/window/OnBackInvokedCallback;

    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->j1:Landroid/window/OnBackInvokedCallback;

    invoke-static {v0, v1}, Lgch;->c(Ljava/lang/Object;Ljava/lang/Object;)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->k1:Landroid/window/OnBackInvokedDispatcher;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->k1:Landroid/window/OnBackInvokedDispatcher;

    if-eqz v0, :cond_3

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->j1:Landroid/window/OnBackInvokedCallback;

    invoke-static {v0, v1}, Lgch;->d(Ljava/lang/Object;Ljava/lang/Object;)V
