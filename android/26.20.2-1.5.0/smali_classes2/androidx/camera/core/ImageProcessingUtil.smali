...
.method public static a(Lyq7;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lyq7;)Z
    ...
    invoke-static {v1, p0}, Lulh;->c(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p0}, Lyq7;->getWidth()I

    move-result v10

    invoke-interface {p0}, Lyq7;->getHeight()I

    move-result v11

    invoke-interface {p0}, Lyq7;->w()[Lxq7;
    ...
    invoke-interface {p0}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static b(Lc99;[B)Lyq7;
    .locals 2

    invoke-virtual {p0}, Lc99;->g()I
    ...
    invoke-virtual {p0}, Lc99;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p1}, Lulh;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    return-object p0
.end method

.method public static c(Lyq7;)Landroid/graphics/Bitmap;
    .locals 14

    invoke-interface {p0}, Lyq7;->getFormat()I
    ...
    invoke-interface {v1}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static d(Lyq7;Lbr7;Ljava/nio/ByteBuffer;IZ)Lvo7;
    .locals 22

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lyq7;)Z
    ...
    invoke-static {v2, v0}, Lulh;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-interface/range {p1 .. p1}, Lbr7;->getSurface()Landroid/view/Surface;

    move-result-object v13

    invoke-interface/range {p0 .. p0}, Lyq7;->getWidth()I

    move-result v15

    invoke-interface/range {p0 .. p0}, Lyq7;->getHeight()I

    move-result v16

    invoke-interface/range {p0 .. p0}, Lyq7;->w()[Lxq7;
    ...
    invoke-interface {v7}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v5, v6, v3, v4}, Lr16;->e(IJLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_6
    invoke-interface/range {p1 .. p1}, Lbr7;->f()Lyq7;
    ...
    invoke-direct {v1, v0}, Lvo7;-><init>(Lyq7;)V
    ...
    invoke-direct {v2, v0, v4, v3}, Luq7;-><init>(Lyq7;Lyq7;I)V

    invoke-virtual {v1, v2}, Lav6;->i(Lzu6;)V
...
.method public static i(Lyq7;Lbr7;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lvo7;
    .locals 25
    ...
    invoke-interface {v10}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v12}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static j(Lyq7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lvo7;
    .locals 25
    ...
    invoke-interface {v4}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v5}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v6}, Lxq7;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1}, Lulh;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v6 .. v12}, Lwq7;-><init>(Lyq7;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II)V

    invoke-direct {v0, v6}, Lvo7;-><init>(Lyq7;)V
...
.method public static k([BLandroid/view/Surface;)V
    ...
    invoke-static {p0, p1}, Lulh;->c(Ljava/lang/String;Ljava/lang/String;)V
