...
# instance fields
.field public final c:Lh2g;


# direct methods
.method public constructor <init>(Lh2g;)V
    .locals 0

    invoke-direct {p0}, Lk2g;-><init>()V

    iput-object p1, p0, Lf2g;->c:Lh2g;
...
.method public final b(Landroid/graphics/Matrix;La2g;ILandroid/graphics/Canvas;)V
    ...
    iget v10, v4, Lh2g;->d:F

    iget v4, v4, Lh2g;->e:F

    invoke-direct {v7, v8, v9, v10, v4}, Landroid/graphics/RectF;-><init>(FFFF)V

    iget-object v8, v0, La2g;->b:Landroid/graphics/Paint;
    ...
    :goto_0
    iget-object v12, v0, La2g;->g:Landroid/graphics/Path;

    const/4 v13, 0x3

    const/4 v14, 0x2

    sget-object v19, La2g;->k:[I

    if-eqz v9, :cond_1

    aput v11, v19, v11

    iget v11, v0, La2g;->f:I

    aput v11, v19, v10

    iget v11, v0, La2g;->e:I

    aput v11, v19, v14

    iget v11, v0, La2g;->d:I
    ...
    iget-object v0, v0, La2g;->h:Landroid/graphics/Paint;
