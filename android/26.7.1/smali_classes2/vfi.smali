...
.method public constructor <init>(Ltfi;)V
    ...
    iput-object v0, p0, Lvfi;->d:Ljava/util/HashSet;

    iput-object p1, p0, Lvfi;->a:Ltfi;

    invoke-interface {p1}, Ltfi;->b()I
    ...
    iput-object v1, p0, Lvfi;->b:Landroid/util/Range;

    invoke-interface {p1}, Ltfi;->v()I
    ...
    iput-object p1, p0, Lvfi;->c:Landroid/util/Range;
...
.method public static c(Ltfi;Landroid/util/Size;)Ltfi;
    .locals 4
    ...
    invoke-interface {p0, v0, v1}, Ltfi;->a(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Ltfi;->w()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Ltfi;->z()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lvfi;-><init>(Ltfi;)V
    ...
    iget-object v0, v0, Lvfi;->d:Ljava/util/HashSet;
...
.method public final s(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lvfi;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lvfi;->a:Ltfi;
    ...
    iget-object p1, p0, Lvfi;->b:Landroid/util/Range;
...
.method public final u(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lvfi;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Lvfi;->c:Landroid/util/Range;
...
.method public final w()Landroid/util/Range;
    ...
    iget-object v0, p0, Lvfi;->b:Landroid/util/Range;
...
.method public final x(II)Z
    ...
    invoke-interface {v0, p1, p2}, Ltfi;->x(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lvfi;->d:Ljava/util/HashSet;
...
.method public final z()Landroid/util/Range;
    ...
    iget-object v0, p0, Lvfi;->c:Landroid/util/Range;
