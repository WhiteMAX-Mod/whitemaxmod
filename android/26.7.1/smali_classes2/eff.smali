...
.method public constructor <init>(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iput-object v1, p0, Leff;->b:Landroid/graphics/Rect;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, Leff;->d:Landroid/graphics/Rect;

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    iput-object v3, p0, Leff;->c:Landroid/graphics/Rect;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-boolean v2, p0, Leff;->f:Z

    iput-boolean v4, p0, Leff;->f:Z
    ...
    iget-object v6, p0, Leff;->d:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object v2, p0, Leff;->b:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Leff;->c:Landroid/graphics/Rect;

    iget-object v5, p0, Leff;->a:Landroid/view/View;
