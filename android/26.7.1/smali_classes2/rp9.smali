...
.method public constructor <init>(Landroidx/mediarouter/app/d;)V
    ...
    iput-object p1, p0, Lrp9;->a:Landroidx/mediarouter/app/d;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lrp9;->a:Landroidx/mediarouter/app/d;

    iget-object v1, v0, Landroidx/mediarouter/app/d;->z1:Landroid/view/accessibility/AccessibilityManager;
    ...
    :cond_0
    sget v3, Lo0e;->mr_control_playback_ctrl:I

    if-ne p1, v3, :cond_5

    iget-object p1, v0, Landroidx/mediarouter/app/d;->e1:Landroid/support/v4/media/session/MediaControllerCompat;

    if-eqz p1, :cond_6

    iget-object p1, v0, Landroidx/mediarouter/app/d;->g1:Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iget-object v2, v0, Landroidx/mediarouter/app/d;->w0:Landroid/content/Context;
    ...
    :cond_7
    :goto_2
    iget-object v1, v0, Landroidx/mediarouter/app/d;->v0:Lyq9;

    invoke-virtual {v1}, Lyq9;->g()Z

    move-result v1

    if-eqz v1, :cond_9

    iget-object v1, v0, Landroidx/mediarouter/app/d;->Y:Lzq9;
