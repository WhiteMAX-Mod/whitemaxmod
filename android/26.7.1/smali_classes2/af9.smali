...
.method public final onConnected()V
    ...
    iget-object v5, v1, Lbf9;->d:Lze9;

    iget-object v6, v1, Lbf9;->b:Landroid/media/browse/MediaBrowser;
    ...
    iget-object v10, v1, Lbf9;->c:Landroid/os/Bundle;

    invoke-direct {v9, v8, v10}, Lef9;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v9, v1, Lbf9;->f:Lef9;

    new-instance v8, Landroid/os/Messenger;

    invoke-direct {v8, v5}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v8, v1, Lbf9;->g:Landroid/os/Messenger;
    ...
    iput-object v10, v5, Lze9;->b:Ljava/lang/ref/WeakReference;

    :try_start_1
    iget-object v5, v1, Lbf9;->a:Landroid/content/Context;
    ...
    iget-object v11, v9, Lef9;->c:Ljava/lang/Object;
    ...
    iget-object v8, v9, Lef9;->b:Ljava/lang/Object;
    ...
    invoke-direct {v5, v4}, Ldr7;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v6, v4, v5}, Lwr9;-><init>(Landroid/media/session/MediaSession$Token;Lfr7;)V

    iput-object v6, v1, Lbf9;->h:Lwr9;
    ...
    iget-object v1, v0, Loi9;->j:Lff9;

    if-eqz v1, :cond_6

    iget-object v1, v1, Lff9;->a:Lbf9;

    iget-object v4, v1, Lbf9;->h:Lwr9;

    if-nez v4, :cond_5

    iget-object v4, v1, Lbf9;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-direct {v5, v4, v3}, Lwr9;-><init>(Landroid/media/session/MediaSession$Token;Lfr7;)V

    iput-object v5, v1, Lbf9;->h:Lwr9;

    :cond_5
    iget-object v1, v1, Lbf9;->h:Lwr9;

    iget-object v3, v0, Loi9;->b:Lmh9;

    new-instance v4, Ltu7;

    const/16 v5, 0xa

    invoke-direct {v4, v0, v5, v1}, Ltu7;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3, v4}, Lmh9;->C(Ljava/lang/Runnable;)V

    iget-object v1, v3, Lmh9;->o:Landroid/os/Handler;

    new-instance v3, Lli9;

    invoke-direct {v3, v0, v2}, Lli9;-><init>(Loi9;I)V
...
.method public final onConnectionSuspended()V
    ...
    iput-object v2, v1, Lbf9;->f:Lef9;

    iput-object v2, v1, Lbf9;->g:Landroid/os/Messenger;

    iput-object v2, v1, Lbf9;->h:Lwr9;

    iget-object v1, v1, Lbf9;->d:Lze9;
    ...
    iput-object v3, v1, Lze9;->b:Ljava/lang/ref/WeakReference;
