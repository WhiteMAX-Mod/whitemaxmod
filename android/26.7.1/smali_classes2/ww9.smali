...
.method public final bridge synthetic C(Llt8;)V
    ...
    invoke-virtual {p0, p1}, Lww9;->I(Lvw9;)V

    return-void
.end method

.method public final I(Lvw9;)V
    .locals 6
    ...
    iget-boolean v3, p1, Lvw9;->w0:Z

    invoke-virtual {v0, v3}, Lvpb;->setEnabled(Z)V

    iget-object v3, p1, Lvw9;->b:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lvpb;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v3, p1, Lvw9;->d:Ltgh;
    ...
    iget-boolean v3, p1, Lvw9;->Y:Z

    invoke-virtual {v0, v3}, Lvpb;->setVerified(Z)V

    iget-object v3, p1, Lvw9;->z0:Ltgh;
    ...
    :goto_0
    invoke-virtual {v0, v3}, Lvpb;->setAlias(Ljava/lang/CharSequence;)V

    invoke-virtual {v0}, Lvpb;->h()V

    invoke-virtual {v0, v4}, Lvpb;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v3, p1, Lvw9;->X:Ljava/lang/CharSequence;

    iget-object p1, p1, Lvw9;->o:Landroid/net/Uri;
