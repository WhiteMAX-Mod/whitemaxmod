...
.method public final onGlobalLayout()V
    ...
    :goto_0
    iget-object v7, v1, Landroidx/mediarouter/app/d;->Q0:Landroidx/mediarouter/app/OverlayListView;
    ...
    iget-object v12, v1, Landroidx/mediarouter/app/d;->R0:Landroidx/mediarouter/app/c;
    ...
    :cond_1
    iget v12, v1, Landroidx/mediarouter/app/d;->a1:I
    ...
    iget-object v15, v1, Landroidx/mediarouter/app/d;->T0:Ljava/util/HashSet;
    ...
    iget v15, v1, Landroidx/mediarouter/app/d;->u1:I
    ...
    iget v11, v1, Landroidx/mediarouter/app/d;->t1:I
    ...
    iget-object v11, v1, Landroidx/mediarouter/app/d;->w1:Landroid/view/animation/Interpolator;
    ...
    iget-object v7, v1, Landroidx/mediarouter/app/d;->U0:Ljava/util/HashSet;
    ...
    invoke-direct {v5, v4, v6}, Lccc;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    const/4 v12, 0x0

    iput v12, v5, Lccc;->h:F

    iget v4, v1, Landroidx/mediarouter/app/d;->v1:I

    int-to-long v6, v4

    iput-wide v6, v5, Lccc;->e:J

    iget-object v4, v1, Landroidx/mediarouter/app/d;->w1:Landroid/view/animation/Interpolator;

    iput-object v4, v5, Lccc;->d:Landroid/view/animation/Interpolator;
    ...
    iget v7, v1, Landroidx/mediarouter/app/d;->a1:I

    mul-int/2addr v7, v2

    new-instance v9, Lccc;

    invoke-direct {v9, v4, v6}, Lccc;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    iput v7, v9, Lccc;->g:I

    iget v4, v1, Landroidx/mediarouter/app/d;->t1:I

    int-to-long v6, v4

    iput-wide v6, v9, Lccc;->e:J

    iget-object v4, v1, Landroidx/mediarouter/app/d;->w1:Landroid/view/animation/Interpolator;

    iput-object v4, v9, Lccc;->d:Landroid/view/animation/Interpolator;

    new-instance v4, Lcl8;

    const/4 v6, 0x2

    invoke-direct {v4, v1, v6, v5}, Lcl8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v4, v9, Lccc;->l:Lcl8;

    iget-object v4, v1, Landroidx/mediarouter/app/d;->V0:Ljava/util/HashSet;
