...
.method public constructor <init>(Landroid/content/Context;Lde4;Lun0;)V
    ...
    invoke-direct {v0, p1}, Loxb;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v0}, Lmme;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lff4;->H0:Lde4;

    iput-object p3, p0, Lff4;->I0:Lun0;
    ...
    invoke-virtual {v0, p1}, Loxb;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Lbs1;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, Lbs1;-><init>(Ljava/lang/Object;I)V
