...
.field public static b:Lqzj;


# direct methods
.method public static b(Landroid/content/Context;)Lqzj;
    .locals 5
    ...
    invoke-static {p0, v0}, Lgd7;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p0, v0}, Lxpk;->d(Landroid/content/Context;I)Lqzj;

    move-result-object v2

    sput-object v2, Lxpk;->b:Lqzj;
    ...
    invoke-virtual {v2, v3, v4}, Leqj;->T(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    :try_start_1
    sget-object v2, Lxpk;->b:Lqzj;

    invoke-static {p0, v0}, Lxpk;->c(Landroid/content/Context;I)Landroid/content/Context;

    move-result-object v3

    new-instance v4, Lbgb;

    invoke-direct {v4, v3}, Lbgb;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2}, Leqj;->U()Landroid/os/Parcel;

    move-result-object v3

    invoke-static {v3, v4}, Lzvj;->d(Landroid/os/Parcel;Landroid/os/IInterface;)V

    const/16 v4, 0xb

    invoke-virtual {v2, v3, v4}, Leqj;->W(Landroid/os/Parcel;I)V
    :try_end_1
    ...
    sput-object v1, Lxpk;->a:Landroid/content/Context;

    const/4 v1, 0x1

    invoke-static {p0, v1}, Lxpk;->d(Landroid/content/Context;I)Lqzj;

    move-result-object v1

    sput-object v1, Lxpk;->b:Lqzj;
    ...
    invoke-direct {v0, p0}, Lbgb;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v1}, Leqj;->U()Landroid/os/Parcel;

    move-result-object p0

    invoke-static {p0, v0}, Lzvj;->d(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    invoke-virtual {v1, p0, v0}, Leqj;->W(Landroid/os/Parcel;I)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_2

    sget-object p0, Lxpk;->b:Lqzj;
...
.method public static c(Landroid/content/Context;I)Landroid/content/Context;
    ...
    sget-object v0, Lxpk;->a:Landroid/content/Context;
    ...
    invoke-static {p0, v0, p1}, Lwm5;->c(Landroid/content/Context;Lvm5;Ljava/lang/String;)Lwm5;

    move-result-object v0

    iget-object p0, v0, Lwm5;->a:Landroid/content/Context;
    :try_end_0
    ...
    sget-object p1, Lwm5;->b:Loib;

    invoke-static {p0, p1, v1}, Lwm5;->c(Landroid/content/Context;Lvm5;Ljava/lang/String;)Lwm5;

    move-result-object p1

    iget-object p0, p1, Lwm5;->a:Landroid/content/Context;
    :try_end_1
    ...
    :goto_1
    sput-object p0, Lxpk;->a:Landroid/content/Context;
...
.method public static d(Landroid/content/Context;I)Lqzj;
    .locals 2
    ...
    invoke-static {p0, p1}, Lxpk;->c(Landroid/content/Context;I)Landroid/content/Context;
    ...
    invoke-direct {v0, p0, p1, v1}, Leqj;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V
