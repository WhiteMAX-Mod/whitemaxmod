...
.method public constructor <init>(JLjava/lang/String;Ljava/lang/String;Ljava/lang/CharSequence;ZZI)V
    ...
    iput-object p3, p0, Lfge;->b:Ljava/lang/CharSequence;

    iput-object p4, p0, Lfge;->c:Ljava/lang/String;

    iput-object p5, p0, Lfge;->d:Ljava/lang/CharSequence;

    iput-boolean p6, p0, Lfge;->o:Z

    iput-boolean p7, p0, Lfge;->X:Z

    iput-boolean v1, p0, Lfge;->Y:Z

    iput-wide p1, p0, Lfge;->Z:J
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    iget-object v1, p0, Lfge;->b:Ljava/lang/CharSequence;

    iget-object v2, p1, Lfge;->b:Ljava/lang/CharSequence;
    ...
    iget-object v2, p1, Lfge;->c:Ljava/lang/String;
    ...
    :cond_4
    iget-object v1, p0, Lfge;->d:Ljava/lang/CharSequence;

    iget-object v2, p1, Lfge;->d:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-boolean v1, p0, Lfge;->o:Z

    iget-boolean v2, p1, Lfge;->o:Z
    ...
    :cond_6
    iget-boolean v1, p0, Lfge;->X:Z

    iget-boolean v2, p1, Lfge;->X:Z
    ...
    :cond_7
    iget-boolean v1, p0, Lfge;->Y:Z

    iget-boolean p1, p1, Lfge;->Y:Z
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Lfge;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Lfge;->d:Ljava/lang/CharSequence;

    invoke-static {v0, v1, v3}, Lno4;->e(IILjava/lang/CharSequence;)I

    move-result v0

    iget-boolean v3, p0, Lfge;->o:Z

    invoke-static {v0, v1, v3}, Lbpg;->n(IIZ)I

    move-result v0

    iget-boolean v3, p0, Lfge;->X:Z

    invoke-static {v0, v1, v3}, Lbpg;->n(IIZ)I

    move-result v0

    iget-boolean v3, p0, Lfge;->Y:Z
...
.method public final k(Llt8;)Ljava/lang/Object;
    ...
    iget-object v3, p1, Lfge;->b:Ljava/lang/CharSequence;

    iget-object v4, p0, Lfge;->b:Ljava/lang/CharSequence;
    ...
    invoke-direct {v4, v3}, Lcge;-><init>(Ljava/lang/CharSequence;)V

    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_0
    iget-boolean v3, p1, Lfge;->X:Z

    iget-boolean v4, p0, Lfge;->X:Z

    if-eq v4, v3, :cond_1

    new-instance v4, Lege;

    invoke-direct {v4, v3}, Lege;-><init>(Z)V
    ...
    invoke-direct {v3, v1}, Lbge;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0}, Lage;-><init>(Ljava/lang/CharSequence;)V
    ...
    iget-boolean v0, p0, Lfge;->o:Z

    if-eq v0, p1, :cond_4

    new-instance v0, Ldge;

    invoke-direct {v0, p1}, Ldge;-><init>(Z)V
...
.method public final q(Llt8;)Z
    ...
    invoke-virtual {p0, p1}, Lfge;->equals(Ljava/lang/Object;)Z
