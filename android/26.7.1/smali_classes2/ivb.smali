...
.method public static a(Lorg/json/JSONObject;)Lx0f;
    .locals 6
    ...
    invoke-static {v3}, Ljdk;->I(Ljava/lang/String;)Ll02;
    ...
    :cond_2
    invoke-direct {v0, v1}, Ld5i;-><init>(Ljava/util/Map;)V

    return-object v0

    :cond_3
    new-instance p0, Ld5i;

    sget-object v0, Ljava/util/Collections;->EMPTY_MAP:Ljava/util/Map;

    invoke-direct {p0, v0}, Ld5i;-><init>(Ljava/util/Map;)V
    ...
    invoke-direct {p0, v2}, Lkre;-><init>(Ljava/lang/Integer;)V

    return-object p0
.end method

.method public static c(JLl0f;)Lorg/json/JSONObject;
    .locals 8

    instance-of v0, p2, Ljre;
    ...
    iget-wide v3, p2, Ljre;->a:J

    const-string v5, "framesReceived"

    invoke-virtual {v0, v5, v3, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    iget-wide v3, p2, Ljre;->b:J
    ...
    iget-object v3, p2, Lb5i;->a:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Lcnf;->b:Lbnf;

    iget-boolean v6, v5, Lbnf;->a:Z
    ...
    invoke-static {v5}, Lmpe;->c(I)Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v4}, Ljdk;->G(Lcnf;)Ljava/lang/String;
    ...
    iget-wide p0, p2, Lhre;->a:J

    const-string v1, "timestamp"

    invoke-virtual {v0, v1, p0, p1}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    iget-wide p0, p2, Lhre;->b:J
...
.method public static f(Leya;)Laag;
    .locals 2
    ...
    iput-boolean v1, v0, Lz9g;->a:Z

    iget-boolean v1, p0, Leya;->b:Z

    iput-boolean v1, v0, Lz9g;->c:Z

    iget-boolean v1, p0, Leya;->c:Z

    iput-boolean v1, v0, Lz9g;->d:Z

    iget-boolean v1, p0, Leya;->e:Z

    iput-boolean v1, v0, Lz9g;->b:Z

    iget-boolean v1, p0, Leya;->g:Z

    iput-boolean v1, v0, Lz9g;->e:Z

    iget-boolean p0, p0, Leya;->d:Z

    iput-boolean p0, v0, Lz9g;->f:Z

    new-instance p0, Laag;

    invoke-direct {p0, v0}, Laag;-><init>(Lz9g;)V
...
.method public b(I[B)Lgb2;
    ...
    :try_start_3
    invoke-static {p2}, Livb;->a(Lorg/json/JSONObject;)Lx0f;
    ...
    invoke-direct {v0, v3, v4, p2, v5}, Lgb2;-><init>(JLjava/lang/Object;I)V
    :try_end_3
...
.method public d(JLl0f;)Lge5;
    ...
    :try_start_0
    invoke-static {p1, p2, p3}, Livb;->c(JLl0f;)Lorg/json/JSONObject;
    ...
    invoke-direct {p1, p3, p2}, Lge5;-><init>(I[B)V
