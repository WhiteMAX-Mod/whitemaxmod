...
.method private final setDataList(Ljava/util/List;)V
    ...
    :cond_2
    iput-object p1, p0, Lfbe;->c:Ljava/util/List;
...
.method public final a()V
    ...
    iget-object v1, p0, Lfbe;->c:Ljava/util/List;
    ...
    invoke-direct {v3, v4}, Lcbe;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v6}, Lcbe;->setSize(Labe;)V

    iget-boolean v6, v3, Lebe;->c:Z

    invoke-virtual {v5, v6}, Lcbe;->setEnabled(Z)V

    iget-object v6, v3, Lebe;->b:Ljava/lang/Integer;

    invoke-virtual {v5, v6}, Lcbe;->setImage(Ljava/lang/Integer;)V

    new-instance v6, La4d;

    const/4 v7, 0x3

    invoke-direct {v6, p0, v7, v3}, La4d;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final setButtonToolDataList(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, Lfbe;->setDataList(Ljava/util/List;)V

    return-void
.end method

.method public final setListener(Ldbe;)V
    .locals 0

    iput-object p1, p0, Lfbe;->a:Ldbe;
