...
.method public constructor <init>(Ltld;)V
    ...
    iput-object v0, p0, Lnc2;->a:Ljava/util/LinkedHashMap;
    ...
    iput-object v0, p0, Lnc2;->b:Ljava/util/TreeMap;

    sget-object v0, Lhh0;->d:Lhh0;

    new-instance v0, Ljava/util/ArrayList;

    sget-object v1, Lhh0;->l:Ljava/util/List;
    ...
    invoke-virtual {p1, v5}, Ltld;->l(I)Lwt5;
    ...
    invoke-interface {v5}, Lwt5;->d()Ljava/util/List;
    ...
    :cond_1
    invoke-interface {v5}, Lwt5;->a()I

    move-result v8

    invoke-interface {v5}, Lwt5;->b()I

    move-result v9

    invoke-interface {v5}, Lwt5;->c()Ljava/util/List;
    ...
    invoke-static {v10, v7}, Loa3;->f(Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v7 .. v13}, Lji0;-><init>(IILjava/util/List;Ljava/util/List;Lyf0;Lag0;)V
    ...
    invoke-static {v4, v1}, Li89;->f(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    :cond_3
    iget-object v4, v3, Lji0;->f:Lag0;
    ...
    :cond_4
    iget-object p1, p0, Lnc2;->a:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v4, p1}, Li89;->b(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v3, p0, Lnc2;->d:Lji0;

    iput-object v3, p0, Lnc2;->c:Lji0;
    ...
    iget-object v0, p0, Lnc2;->a:Ljava/util/LinkedHashMap;
...
# virtual methods
.method public final a(Lhh0;)Lji0;
    .locals 3
