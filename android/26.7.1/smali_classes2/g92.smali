...
.method public X(Ltqf;)V
    ...
    iget-object p1, p1, Ltqf;->a:Lsqf;

    invoke-interface {p1}, Lsqf;->e()Landroid/hardware/camera2/CameraCaptureSession$StateCallback;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Lsqf;->f()Ljava/util/List;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-interface {p1}, Lsqf;->c()Ljava/util/concurrent/Executor;
    ...
    iget-object v3, v3, Lrbc;->a:Ltbc;

    invoke-virtual {v3}, Ltbc;->b()Ljava/lang/String;
    ...
    invoke-static {v6, v2, v4, v3, v5}, Li62;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "CameraDeviceCompat"

    invoke-static {v4, v3}, Li89;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v3}, Lg82;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V

    invoke-interface {p1}, Lsqf;->f()Ljava/util/List;

    move-result-object v2

    iget-object v3, p0, Lyq;->b:Ljava/lang/Object;

    check-cast v3, Li92;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v3, v3, Li92;->a:Landroid/os/Handler;

    invoke-interface {p1}, Lsqf;->b()Lc38;
    ...
    :try_start_0
    iget-object p1, v4, Lc38;->a:La38;

    iget-object p1, p1, La38;->a:Landroid/hardware/camera2/params/InputConfiguration;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, Ltqf;->a(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Lrbc;->a:Ltbc;

    invoke-virtual {v4}, Ltbc;->c()Landroid/view/Surface;
