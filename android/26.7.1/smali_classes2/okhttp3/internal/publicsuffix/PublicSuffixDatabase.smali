...
.method public static c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lsxg;->p1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v0, p0}, Lir3;->i0(ILjava/util/List;)Ljava/util/List;
...
.method public final a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v7, v5}, Lxwc;->i(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_4
    invoke-static {v8, v5, v6}, Lnkb;->i([B[[BI)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v11, v6, v10}, Lnkb;->i([B[[BI)Ljava/lang/String;
    ...
    :cond_a
    invoke-static {v9, v5, v6}, Lnkb;->i([B[[BI)Ljava/lang/String;
    ...
    invoke-static {v1, v5}, Lsxg;->p1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v8, v5}, Lsxg;->p1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v11, v1}, Lsxg;->p1(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-direct {v1, p1, v4}, Lwv;-><init>(Ljava/lang/Object;I)V

    invoke-static {v1, v0}, Lzlf;->z0(Lolf;I)Lolf;

    move-result-object p1

    const-string v0, "."

    invoke-static {p1, v0}, Lzlf;->F0(Lolf;Ljava/lang/String;)Ljava/lang/String;
...
.method public final b()V
    ...
    sget-object v2, Lqkb;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v2, v0, v4, v3}, Lv20;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v1, v2}, Lve7;-><init>(Lzgg;)V

    new-instance v0, Lefe;

    invoke-direct {v0, v1}, Lefe;-><init>(Lzgg;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    invoke-virtual {v0}, Lefe;->readInt()I

    move-result v1

    int-to-long v1, v1

    invoke-virtual {v0, v1, v2}, Lefe;->w0(J)V

    iget-object v3, v0, Lefe;->b:Lo01;

    invoke-virtual {v3, v1, v2}, Lo01;->B0(J)[B
    ...
    invoke-virtual {v0, v2, v3}, Lefe;->w0(J)V

    iget-object v4, v0, Lefe;->b:Lo01;

    invoke-virtual {v4, v2, v3}, Lo01;->B0(J)[B
