...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lgih;-><init>(Ljava/lang/Object;Lhih;I)V

    iput-object v0, p0, Lhih;->a:Lgih;
    ...
    invoke-direct {p0}, Lhih;->getTheme()La6c;
    ...
    iput-object p1, p0, Lhih;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-interface {v2}, La6c;->x()Lbr5;
    ...
    iput-object v0, p0, Lhih;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lhih;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lhih;->v0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lhih;->w0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lhih;)La6c;
    .locals 0
...
.method private final getTheme()La6c;
    .locals 3
    ...
    invoke-virtual {p0}, Lhih;->getThemeName()Ljava/lang/String;

    move-result-object v2

    iget-object v0, v0, Lil3;->c:Ljava/lang/Object;

    check-cast v0, Lc6c;

    invoke-virtual {v0, v2}, Lc6c;->a(Ljava/lang/String;)Ld6c;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lhih;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lhih;->x0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lhih;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lhih;->y0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lhih;->z0:[Lki8;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lhih;->c:Lgih;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Lhih;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lhih;->v0:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lhih;->x0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lhih;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lhih;->w0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lhih;->y0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(La6c;)V
    ...
    :goto_0
    iget-object v0, p0, Lhih;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lhih;->b:Landroid/graphics/drawable/GradientDrawable;
