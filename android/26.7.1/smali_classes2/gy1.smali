...
# virtual methods
.method public final a(Logh;)Lsgh;
    .locals 4

    new-instance v0, Landroid/text/SpannableStringBuilder;

    iget-object v1, p0, Lgy1;->a:Landroid/content/Context;
...
.method public final b(Lrvi;)Lde1;
    .locals 11
    ...
    iget-object v3, p0, Lgy1;->a:Landroid/content/Context;

    if-eqz v1, :cond_0

    sget v1, Lc0e;->check_outline_16:I
    ...
    sget v1, Lc0e;->ic_microphone_off_fill_16:I
    ...
    invoke-direct/range {v4 .. v10}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;-><init>(Landroid/graphics/drawable/Drawable;Lkh6;ZZILpy4;)V
    ...
    invoke-direct {p1, v2, v3, v1}, Lde1;-><init>(JLandroid/text/SpannableStringBuilder;)V
...
.method public final c(Z)Landroid/text/SpannableStringBuilder;
    ...
    iget-object v4, p0, Lgy1;->a:Landroid/content/Context;

    if-eqz p1, :cond_1

    sget p1, Lo1f;->i1:I

    invoke-virtual {v2, v4}, Lava;->h(Landroid/content/Context;)Ld6c;
    ...
    invoke-direct/range {v5 .. v11}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;-><init>(Landroid/graphics/drawable/Drawable;Lkh6;ZZILpy4;)V
...
.method public final d(Z)Landroid/text/SpannableStringBuilder;
    ...
    sget v0, Lj6e;->call_incoming_video_call:I
    ...
    :cond_1
    sget p1, Lj6e;->call_incoming_audio_call:I
...
.method public final e(Ljava/lang/CharSequence;ZIZZZLw36;)Landroid/text/SpannableStringBuilder;
    .locals 9
    ...
    instance-of v5, v2, Ls36;

    if-nez v5, :cond_0

    instance-of v5, v2, Lu36;
    ...
    iget-object v6, p0, Lgy1;->a:Landroid/content/Context;
    ...
    sget v1, Lkzd;->ic_share_screen_20:I

    invoke-virtual {v5, v6}, Lava;->h(Landroid/content/Context;)Ld6c;
    ...
    sget v1, Lkzd;->ic_microphone_disable_12:I
    ...
    invoke-direct {v5, v8}, Lao1;-><init>(I)V

    invoke-direct {v3, v6, v1, v5}, Lgfg;-><init>(Landroid/content/Context;La6c;Lao1;)V
...
.method public final g(ZZZLw36;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lgy1;->a:Landroid/content/Context;

    if-nez p3, :cond_1

    if-nez p2, :cond_1

    instance-of p2, p4, Ls36;

    if-nez p2, :cond_0

    instance-of p2, p4, Lu36;
    ...
    :cond_1
    instance-of p1, p4, Ls36;

    if-nez p1, :cond_2

    instance-of p1, p4, Lu36;
    ...
    sget p1, Lj6e;->call_connecting:I
    ...
    :cond_3
    instance-of p1, p4, Lp36;

    if-eqz p1, :cond_4

    check-cast p4, Lp36;

    iget-object p1, p4, Lp36;->a:Lo36;
    ...
    :pswitch_1
    sget p1, Lj6e;->call_opponent_reject_call:I
    ...
    :pswitch_2
    sget p1, Lj6e;->call_participants_limit_reached:I
    ...
    :pswitch_3
    sget p1, Lj6e;->call_user_restricted_info:I
    ...
    :pswitch_4
    sget p1, Lj6e;->call_group_wait_admin:I
    ...
    :pswitch_5
    sget p1, Lj6e;->call_group_user_not_in_chat:I
    ...
    :pswitch_6
    sget p1, Lj6e;->call_group_was_removed_from_waiting_room:I
    ...
    :pswitch_7
    sget p1, Lj6e;->call_group_was_removed_from_call:I
    ...
    :pswitch_8
    sget p1, Lj6e;->call_opponent_failed_timout:I
    ...
    :pswitch_a
    sget p1, Lj6e;->call_opponent_unavailable_privacy:I
    ...
    :pswitch_b
    sget p1, Lj6e;->call_opponent_unavailable_busy:I
    ...
    :pswitch_c
    sget p1, Lj6e;->call_opponent_unavailable_missed:I
...
.method public final h(ZILjava/lang/CharSequence;ZZZZLw36;)Landroid/text/SpannableStringBuilder;
    .locals 8
    ...
    invoke-static {p3, p4}, Lsxg;->p1(Ljava/lang/CharSequence;[C)Ljava/util/List;
...
.method public final i()Lzv8;
    ...
    invoke-direct {v0, v1, v2, v3}, Lzv8;-><init>(IILandroid/content/Context;)V
