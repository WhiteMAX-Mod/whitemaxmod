...
.method public constructor <init>(Lnm5;)V
    ...
    iput-object v0, p0, Lv35;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lv35;->X:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lv35;->Y:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lv35;->Z:Ljava/util/LinkedHashMap;

    iput v1, p0, Lv35;->v0:I

    iput-boolean v1, p0, Lv35;->w0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lv35;->x0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lv35;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lv35;->d:Landroid/os/Handler;

    new-instance v0, Lwf7;

    invoke-direct {v0, v1}, Lwf7;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lv35;->c:Lwf7;

    new-instance v0, Lce5;

    invoke-direct {v0}, Lce5;-><init>()V

    iput-object v0, p0, Lv35;->a:Lce5;

    :try_start_0
    new-instance v0, Llt;

    invoke-direct {v0, p0, p1}, Llt;-><init>(Lv35;Lnm5;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lf22;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lv35;->release()V
...
.method public final a(Ly3h;)V
    ...
    iget-object v0, p0, Lv35;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Ls35;-><init>(Ly3h;I)V

    invoke-virtual {p0, v0, v1}, Lv35;->e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final b(II)Lzt8;
    .locals 1

    new-instance v0, Luw4;

    invoke-direct {v0, p1, p2, p0}, Luw4;-><init>(IILjava/lang/Object;)V
...
.method public final d()V
    ...
    iget-boolean v0, p0, Lv35;->w0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lv35;->v0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lv35;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lr3h;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lv35;->x0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lc22;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lv35;->a:Lce5;

    invoke-virtual {v0}, Lce5;->r()V

    iget-object v0, p0, Lv35;->b:Landroid/os/HandlerThread;
...
.method public final e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lv35;->c:Lwf7;

    new-instance v1, Lkl;

    const/16 v2, 0x14

    invoke-direct {v1, p0, p2, p1, v2}, Lkl;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final f(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lv35;->x0:Ljava/util/ArrayList;
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lqtj;->e([FF)V

    invoke-static {v1}, Lqtj;->f([F)V
    ...
    invoke-static {v6}, Le57;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Le57;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Le57;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Le57;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Le57;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Le57;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Lce5;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Lce5;->m:Ljava/lang/Object;

    check-cast v6, Lc57;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Ld57;
    ...
    invoke-static {v1}, Le57;->b(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Le57;->b(Ljava/lang/String;)V
...
.method public final h(Lguh;)V
    ...
    invoke-virtual {p0, p1}, Lv35;->f(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lguh;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lguh;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lv35;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lguh;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lvf0;->c:Lc22;

    invoke-virtual {v8, v3}, Lc22;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lv35;->X:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lv35;->Z:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lv35;->Y:[F

    invoke-virtual {v3, v5, v0}, Lr3h;->I([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lv35;->a:Lce5;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lce5;->u(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Loa3;->k(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Loa3;->k(Ljava/lang/String;Z)V

    new-instance v2, Lguh;

    iget-object v3, v3, Lr3h;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lguh;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lv35;->h(Lguh;)V
    :try_end_1
...
.method public final release()V
    ...
    invoke-direct {v0, p0, v1}, Lr35;-><init>(Ljava/lang/Object;I)V
