...
.method public static A0(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lsxg;->u1(Ljava/lang/String;CLjava/lang/String;)Ljava/lang/String;
...
.method public static B0(Ljava/io/File;)[B
    .locals 8
    ...
    invoke-direct {v6}, Lg36;-><init>()V

    invoke-virtual {v6, v5}, Ljava/io/OutputStream;->write(I)V

    invoke-static {v0, v6}, Lg0i;->C(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static C0(Ljava/io/File;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-direct {p0, v2, v0}, Lwv;-><init>(Ljava/lang/Object;I)V

    new-instance v0, Lj54;

    invoke-direct {v0, p0}, Lj54;-><init>(Lolf;)V

    invoke-virtual {v0}, Lj54;->iterator()Ljava/util/Iterator;
...
.method public static E0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    .locals 7
    ...
    invoke-static {p1, v1, v2, v3}, Lsxg;->a1(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p1, v1, v4, v3}, Lsxg;->a1(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p0, v1}, Lsxg;->T0(Ljava/lang/CharSequence;C)Z
...
.method public static F0(Ljava/io/File;Ljava/lang/String;)V
    .locals 2
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Lpf6;->G0(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static final G0(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    .locals 8
...
.method public static y0(Ljava/io/File;Ljava/io/File;)V
    .locals 2
    ...
    invoke-static {p0, p1, v1}, Lwlk;->a(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {v0, p0}, Lg0i;->C(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public static z0(Ljava/io/File;)Z
    .locals 4

    new-instance v0, Loe6;

    invoke-direct {v0, p0}, Loe6;-><init>(Ljava/io/File;)V

    new-instance p0, Lme6;

    invoke-direct {p0, v0}, Lme6;-><init>(Loe6;)V
