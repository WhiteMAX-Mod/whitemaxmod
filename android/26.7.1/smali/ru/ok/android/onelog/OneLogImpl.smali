...
.field private volatile forceFallbackLogs:Lh2h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh2h;"
        }
...
.method public getApiClient()Lco;
    .locals 2
...
.method public setForceFallbackLogs(Lh2h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public startUpload(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p1, v2}, Lc49;-><init>(Ljava/lang/Object;I)V
...
.method public upload(Ljava/util/Collection;)V
    ...
    .line 2
    invoke-virtual {p0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Lco;

    move-result-object v0

    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lco;Ljava/util/Collection;)V
...
.method public upload(Lru/ok/android/onelog/OneLogItem;)V
    ...
    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lco;Lru/ok/android/onelog/OneLogItem;)V
