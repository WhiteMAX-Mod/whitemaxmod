...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmdg;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lk2f;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Lmdg;->d:Lk2f;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmdg;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Ll7f;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Lmdg;->d:Lk2f;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Ll7f;->a:Z
...
.method public final a()Ld7f;
    ...
    iget-object v1, p0, Lmdg;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lldg;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lxc5;
    ...
    invoke-direct {v0, p1, v1}, Lt0;-><init>(Ljava/lang/Runnable;Z)V
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lt0;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lxc5;
    ...
    iget-object v6, p0, Lmdg;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Ln58;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Ln58;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p1, v5}, Lt0;-><init>(Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {v1, v0}, Lt0;->a(Ljava/util/concurrent/Future;)V
    :try_end_1
