...
.method public static final a(Lone/me/android/notifications/NotificationsImagesProvider;Lgl4;Ldbg;Luh4;)Ljava/lang/Object;
    .locals 5

    instance-of v0, p3, Lcdb;
    ...
    invoke-direct {v0, p0, p3}, Lcdb;-><init>(Lone/me/android/notifications/NotificationsImagesProvider;Luh4;)V

    :goto_0
    iget-object p0, v0, Lcdb;->X:Ljava/lang/Object;
    ...
    iget-object p1, v0, Lcdb;->o:Lm41;

    iget-object p2, v0, Lcdb;->d:Lgl4;
    ...
    invoke-static {p2}, Lone/me/android/notifications/NotificationsImagesProvider;->c(Lm41;)Ljava/io/File;
    ...
    :cond_4
    iput-object p1, v0, Lcdb;->d:Lgl4;

    iput-object p2, v0, Lcdb;->o:Lm41;

    iput v1, v0, Lcdb;->Z:I

    const-wide/16 v2, 0x64

    invoke-static {v2, v3, v0}, Loa3;->r(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static final b(Lone/me/android/notifications/NotificationsImagesProvider;Landroid/net/Uri;Lddb;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-direct {p0, v0, p2}, Lbc2;-><init>(ILkotlin/coroutines/Continuation;)V
    ...
    invoke-direct {p2, p1, v0}, Ledb;-><init>(Ls0;I)V

    invoke-virtual {p0, p2}, Lbc2;->e(Le37;)V

    new-instance p2, Lfdb;

    invoke-direct {p2, p0, v0}, Lfdb;-><init>(Lbc2;I)V
...
.method public static c(Lm41;)Ljava/io/File;
    .locals 2
    ...
    iget-object v0, v0, Lgv7;->d:Lyb5;

    invoke-virtual {v0}, Lyb5;->get()Ljava/lang/Object;
    ...
    invoke-virtual {v0, p0}, Lcc5;->b(Lm41;)Lxb6;

    move-result-object p0

    instance-of v0, p0, Lxb6;
    ...
    iget-object p0, p0, Lxb6;->a:Ljava/io/File;
...
.method public final getStreamTypes(Landroid/net/Uri;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {p2, p1, v0}, Layg;->P0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :cond_1
    :goto_0
    sget-object p1, Ljoa;->b:[Ljava/lang/String;
...
.method public final openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {p1, v0, p2}, Lg0i;->K(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v3, v0}, Lf2k;->j(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v4, p1, p2}, Lg0i;->K(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v3, p1}, Lhy4;->g(Landroid/net/Uri;)Ldbg;

    move-result-object p1

    invoke-static {p1}, Lone/me/android/notifications/NotificationsImagesProvider;->c(Lm41;)Ljava/io/File;
    ...
    invoke-direct {v5, v1}, Lcue;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p0, v0, p1, v2}, Lgdb;-><init>(Lone/me/android/notifications/NotificationsImagesProvider;Landroid/net/Uri;Ldbg;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-virtual {v0, v1, v4, p2, p1}, Lawb;->c(La09;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
