...
.method public d(Lu17;Ljava/lang/Object;)V
    .locals 11
    ...
    :goto_0
    iget-object v1, p2, Lgkj;->b:Lljj;

    invoke-static {v1}, Ly17;->j0(Lljj;)I
    ...
    :cond_1
    invoke-interface {p1, v2, v1}, Ly2h;->h(ILjava/lang/String;)V

    :goto_1
    iget-object v1, p2, Lgkj;->d:Ljava/lang/String;
    ...
    :goto_2
    iget-object v1, p2, Lgkj;->e:Lpr4;

    invoke-static {v1}, Lpr4;->e(Lpr4;)[B
    ...
    :cond_3
    invoke-interface {p1, v2, v1}, Ly2h;->c(I[B)V

    :goto_3
    iget-object v1, p2, Lgkj;->f:Lpr4;
    ...
    iget-wide v2, p2, Lgkj;->g:J

    invoke-interface {p1, v1, v2, v3}, Ly2h;->b(IJ)V

    const/16 v1, 0x8

    iget-wide v2, p2, Lgkj;->h:J

    invoke-interface {p1, v1, v2, v3}, Ly2h;->b(IJ)V

    const/16 v1, 0x9

    iget-wide v2, p2, Lgkj;->i:J
    ...
    invoke-interface {p1, v3, v1, v2}, Ly2h;->b(IJ)V

    iget-object v1, p2, Lgkj;->l:Ltl0;

    invoke-static {v1}, Ly17;->e(Ltl0;)I
    ...
    iget-wide v2, p2, Lgkj;->m:J

    invoke-interface {p1, v1, v2, v3}, Ly2h;->b(IJ)V

    const/16 v1, 0xd

    iget-wide v2, p2, Lgkj;->n:J

    invoke-interface {p1, v1, v2, v3}, Ly2h;->b(IJ)V

    const/16 v1, 0xe

    iget-wide v2, p2, Lgkj;->o:J

    invoke-interface {p1, v1, v2, v3}, Ly2h;->b(IJ)V

    const/16 v1, 0xf

    iget-wide v2, p2, Lgkj;->p:J

    invoke-interface {p1, v1, v2, v3}, Ly2h;->b(IJ)V

    iget-boolean v1, p2, Lgkj;->q:Z
    ...
    iget-object v1, p2, Lgkj;->r:Lgbc;

    invoke-static {v1}, Ly17;->U(Lgbc;)I
    ...
    invoke-static {v9}, Ly17;->S(I)I

    move-result v9

    int-to-long v9, v9

    invoke-interface {p1, v8, v9, v10}, Ly2h;->b(IJ)V

    iget-boolean v8, p2, Lh64;->b:Z

    int-to-long v8, v8

    invoke-interface {p1, v7, v8, v9}, Ly2h;->b(IJ)V

    iget-boolean v7, p2, Lh64;->c:Z

    int-to-long v7, v7

    invoke-interface {p1, v6, v7, v8}, Ly2h;->b(IJ)V

    iget-boolean v6, p2, Lh64;->d:Z

    int-to-long v6, v6

    invoke-interface {p1, v5, v6, v7}, Ly2h;->b(IJ)V

    iget-boolean v5, p2, Lh64;->e:Z

    int-to-long v5, v5

    invoke-interface {p1, v4, v5, v6}, Ly2h;->b(IJ)V

    iget-wide v4, p2, Lh64;->f:J

    invoke-interface {p1, v3, v4, v5}, Ly2h;->b(IJ)V

    iget-wide v3, p2, Lh64;->g:J
    ...
    invoke-interface {p1, v1, p2}, Ly2h;->c(I[B)V

    goto :goto_5

    :cond_5
    invoke-interface {p1, v8}, Ly2h;->e(I)V
    ...
    invoke-interface {p1, p2}, Ly2h;->e(I)V

    return-void

    :cond_6
    invoke-interface {p1, p2, v0}, Ly2h;->h(ILjava/lang/String;)V
