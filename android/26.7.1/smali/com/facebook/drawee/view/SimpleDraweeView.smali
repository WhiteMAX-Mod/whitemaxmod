...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcj5;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final f(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0}, Lcj5;->getTopLevelDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget-object v0, Lcom/facebook/drawee/view/SimpleDraweeView;->y0:Lcv7;
    ...
    iput-object v0, p0, Lcom/facebook/drawee/view/SimpleDraweeView;->x0:Lz0;

    :goto_0
    if-eqz p2, :cond_4

    sget-object v0, Lh9e;->SimpleDraweeView:[I
    ...
    :try_start_1
    sget p2, Lh9e;->SimpleDraweeView_actualImageUri:I
    ...
    :cond_1
    sget p2, Lh9e;->SimpleDraweeView_actualImageResource:I
...
.method public final g(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lcom/facebook/drawee/view/SimpleDraweeView;->x0:Lz0;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast v0, Lkwc;

    invoke-virtual {v0, p1}, Lkwc;->b(Landroid/net/Uri;)V
...
.method public getControllerBuilder()Lz0;
    .locals 1
...
.method public setActualImageResource(I)V
    ...
    invoke-static {p1}, Lz8i;->c(I)Landroid/net/Uri;
...
.method public setImageRequest(Lrv7;)V
    .locals 1

    iget-object v0, p0, Lcom/facebook/drawee/view/SimpleDraweeView;->x0:Lz0;

    iput-object p1, v0, Lz0;->b:Lrv7;
...
.method public setImageResource(I)V
    ...
    invoke-super {p0, p1}, Lcj5;->setImageResource(I)V
