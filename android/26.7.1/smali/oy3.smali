...
# static fields
.field public static final d:Lmy3;

.field public static final e:Lk2f;

.field public static final f:I

.field public static final g:Lny3;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lk2f;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lo6b;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Loy3;->g:Lny3;
    ...
    invoke-direct {v3, v4, v0, v1}, Lk2f;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Loy3;->e:Lk2f;

    new-instance v0, Lmy3;

    invoke-direct {v0, v2, v3}, Lmy3;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Loy3;->d:Lmy3;

    iget-object v0, v0, Lmy3;->b:[Lny3;
    ...
    invoke-virtual {v3}, Lo6b;->dispose()V
...
.method public constructor <init>()V
    ...
    sget-object v1, Loy3;->d:Lmy3;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Loy3;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v2, Lmy3;

    sget v3, Loy3;->f:I

    sget-object v4, Loy3;->e:Lk2f;

    invoke-direct {v2, v3, v4}, Lmy3;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()Ld7f;
    ...
    iget-object v1, p0, Loy3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v1}, Lmy3;->a()Lny3;

    move-result-object v1

    invoke-direct {v0, v1}, Lly3;-><init>(Lny3;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lxc5;
    ...
    iget-object v0, p0, Loy3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v0}, Lmy3;->a()Lny3;

    move-result-object v0

    iget-object v0, v0, Lo6b;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lxc5;
    ...
    iget-object v1, v0, Lo6b;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    invoke-direct {p4, p1, v1}, Ln58;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Ln58;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
