...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "setBackoffCriteria",
        "(Ltl0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;",
        "Ljava/time/Duration;",
        "duration",
        "(Ltl0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;",
        "Lh64;",
        "constraints",
        "setConstraints",
        "(Lh64;)Landroidx/work/WorkRequest$Builder;",
        "Lpr4;",
        "inputData",
        "setInputData",
        "(Lpr4;)Landroidx/work/WorkRequest$Builder;",
        "",
        "tag",
        "addTag",
        ...
        "policy",
        "setExpedited",
        "(Lgbc;)Landroidx/work/WorkRequest$Builder;",
        "build",
        "()Landroidx/work/WorkRequest;",
        ...
        "state",
        "setInitialState",
        "(Lljj;)Landroidx/work/WorkRequest$Builder;",
        "",
        "runAttemptCount",
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    invoke-direct/range {v3 .. v31}, Lgkj;-><init>(Ljava/lang/String;Lljj;Ljava/lang/String;Ljava/lang/String;Lpr4;Lpr4;JJJLh64;ILtl0;JJJJZLgbc;III)V

    iput-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;
    ...
    invoke-static {v1, v2}, Luv;->x0([Ljava/lang/Object;Ljava/util/HashSet;)V
...
.method public final build()Landroidx/work/WorkRequest;
    ...
    iget-object v1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;

    iget-object v1, v1, Lgkj;->j:Lh64;

    iget-object v2, v1, Lh64;->h:Ljava/util/Set;
    ...
    iget-boolean v2, v1, Lh64;->d:Z

    if-nez v2, :cond_1

    iget-boolean v2, v1, Lh64;->b:Z

    if-nez v2, :cond_1

    iget-boolean v1, v1, Lh64;->c:Z
    ...
    :goto_1
    iget-object v2, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;

    iget-boolean v3, v2, Lgkj;->q:Z

    if-eqz v3, :cond_4

    if-nez v1, :cond_3

    iget-wide v1, v2, Lgkj;->g:J
...
.method public final getWorkSpec$work_runtime_release()Lgkj;
    .locals 1

    iget-object v0, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;
...
.method public final keepResultsForAtLeast(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-static {p1}, Ljl5;->a(Ljava/time/Duration;)J

    move-result-wide v1

    iput-wide v1, v0, Lgkj;->o:J
...
.method public final setBackoffCriteria(Ltl0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lgkj;->e(J)V
...
.method public final setBackoffCriteria(Ltl0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p2}, Ljl5;->a(Ljava/time/Duration;)J
...
.method public final setConstraints(Lh64;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setExpedited(Lgbc;)Landroidx/work/WorkRequest$Builder;
    .locals 2
    ...
    iput-boolean v1, v0, Lgkj;->q:Z

    iput-object p1, v0, Lgkj;->r:Lgbc;
...
.method public final setId(Ljava/util/UUID;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;

    iget-object v4, v3, Lgkj;->c:Ljava/lang/String;

    iget-object v5, v3, Lgkj;->b:Lljj;

    move-object v6, v5

    iget-object v5, v3, Lgkj;->d:Ljava/lang/String;

    move-object v7, v6

    new-instance v6, Lpr4;

    iget-object v8, v3, Lgkj;->e:Lpr4;

    invoke-direct {v6, v8}, Lpr4;-><init>(Lpr4;)V

    move-object v8, v7

    new-instance v7, Lpr4;

    iget-object v9, v3, Lgkj;->f:Lpr4;

    invoke-direct {v7, v9}, Lpr4;-><init>(Lpr4;)V

    move-object v10, v8

    iget-wide v8, v3, Lgkj;->g:J

    move-object v12, v10

    iget-wide v10, v3, Lgkj;->h:J

    move-object v14, v12

    iget-wide v12, v3, Lgkj;->i:J

    new-instance v15, Lh64;

    move-object/from16 v26, v1

    iget-object v1, v3, Lgkj;->j:Lh64;
    ...
    iget-wide v4, v1, Lh64;->f:J

    move-object/from16 v25, v2

    iget-wide v1, v1, Lh64;->g:J

    move-wide/from16 v23, v1

    move-wide/from16 v21, v4

    invoke-direct/range {v15 .. v25}, Lh64;-><init>(IZZZZJJLjava/util/Set;)V

    iget v1, v3, Lgkj;->k:I

    iget-object v2, v3, Lgkj;->l:Ltl0;

    iget-wide v4, v3, Lgkj;->m:J

    move/from16 v16, v1

    move-object/from16 v17, v2

    iget-wide v1, v3, Lgkj;->n:J

    move-wide/from16 v19, v1

    iget-wide v1, v3, Lgkj;->o:J

    move-wide/from16 v21, v1

    iget-wide v1, v3, Lgkj;->p:J

    move-wide/from16 v23, v1

    iget-boolean v1, v3, Lgkj;->q:Z

    iget-object v2, v3, Lgkj;->r:Lgbc;
    ...
    invoke-direct/range {v1 .. v29}, Lgkj;-><init>(Ljava/lang/String;Lljj;Ljava/lang/String;Ljava/lang/String;Lpr4;Lpr4;JJJLh64;ILtl0;JJJJZLgbc;III)V

    iput-object v1, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;
...
.method public setInitialDelay(JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p3, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;

    iget-wide v0, p3, Lgkj;->g:J
...
.method public setInitialDelay(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;

    iget-wide v2, p1, Lgkj;->g:J
...
.method public final setInitialState(Lljj;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setInputData(Lpr4;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setWorkSpec$work_runtime_release(Lgkj;)V
    .locals 0

    iput-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lgkj;
