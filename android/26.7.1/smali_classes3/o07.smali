...
.field public volatile Y:Ld17;

.field public volatile Z:Ld17;
...
.field public final o:Lfze;

.field public volatile v0:J

.field public final w0:Lhkh;

.field public final x0:Lhkh;
...
# direct methods
.method public constructor <init>(Lgae;Lfze;)V
    .locals 4
    ...
    iput-object v0, p0, Lo07;->y0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lo07;->d:Lgae;

    iput-object p2, p0, Lo07;->o:Lfze;
    ...
    iput-object p1, p0, Lo07;->c:Lyh4;

    new-instance p1, Lhkh;

    invoke-direct {p1}, Lhkh;-><init>()V

    iput-object p1, p0, Lo07;->w0:Lhkh;

    new-instance p1, Lhkh;

    invoke-direct {p1}, Lhkh;-><init>()V

    iput-object p1, p0, Lo07;->x0:Lhkh;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lo07;->z0:Z

    iget-object v0, p0, Lo07;->X:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lo07;->X:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Lo07;->w0:Lhkh;
    ...
    iput-wide v2, p0, Lo07;->v0:J

    :cond_0
    iget-object v0, p0, Lo07;->Y:Ld17;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lo07;->Y:Ld17;

    iget-boolean v2, v0, Ld17;->a:Z
    ...
    iput-boolean v1, v0, Ld17;->h:Z

    :cond_2
    iget-object v1, v0, Ld17;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Ld17;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Ld17;->g:Lgnj;

    invoke-static {p1}, Ld17;->b(Lgnj;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lo07;->Z:Ld17;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lo07;->A0:J

    iget-wide v7, p0, Lo07;->b:J
    ...
    iget-object v5, v2, Ld17;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Ld17;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lo07;->y0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lo07;->A0:J

    iget-object p1, p0, Lo07;->y0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lo07;->c:Lyh4;

    new-instance v0, Lqp5;

    const/16 v3, 0xa

    invoke-direct {v0, p0, v2, v1, v3}, Lqp5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lo07;->x0:Lhkh;
