...
.field public final o:Lsdd;


# direct methods
.method public constructor <init>(Lsdd;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lxag;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lhjf;->o:Lsdd;

    iput-object p2, p0, Lhjf;->X:Ljava/util/concurrent/ExecutorService;
...
.method public final L(Lccg;I)V
    ...
    invoke-virtual {p1, p2}, Lgjf;->I(Lt57;)V
...
.method public final x(Landroid/view/ViewGroup;I)Lmme;
    ...
    iget-object v2, p0, Lhjf;->o:Lsdd;

    invoke-direct {p1, v2, p2, v0, v1}, Lgjf;-><init>(Lsdd;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
