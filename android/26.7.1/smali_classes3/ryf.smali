...
# direct methods
.method public constructor <init>(Lf8c;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lxag;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lryf;->o:Lf8c;
...
.method public final L(Lccg;I)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lqyf;->C(Llt8;)V
    ...
    iget-object v0, v0, Luff;->o:Lixf;

    instance-of v0, v0, Lgxf;

    iget-object v1, p0, Lryf;->o:Lf8c;
    ...
    invoke-virtual {p1, v0}, Lvxf;->setOnSwitchListener(Lrxf;)V
...
.method public final bridge synthetic v(Lmme;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lryf;->L(Lccg;I)V
