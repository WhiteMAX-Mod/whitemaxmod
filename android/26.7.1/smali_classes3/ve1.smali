...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lve1;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lyjh;Lf8c;Lqq;Lbb9;Lgae;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lve1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lve1;->b:Lyjh;

    iput-object p3, p0, Lve1;->c:Lf8c;

    iput-object p4, p0, Lve1;->d:Lqq;

    iput-object p5, p0, Lve1;->e:Lbb9;

    iput-object p6, p0, Lve1;->f:Lgae;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lve1;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Lve1;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lve1;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lir3;->J0(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Lve1;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lnpj;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Lnpj;->d:Ljava/lang/Long;
    ...
    :cond_0
    iget-object v3, p0, Lve1;->b:Lyjh;

    invoke-interface {v3}, Lyjh;->getServerTimeMs()Ljava/lang/Long;
    ...
    invoke-interface {v3}, Lyjh;->localTimeMs()J
    ...
    iget-object v6, v1, Lnpj;->a:Ljava/lang/String;

    iget-object v1, v1, Lnpj;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Lve1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Lve1;->b:Lyjh;

    invoke-interface {v1}, Lyjh;->getServerTimeMs()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lnpj;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Lve1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Lve1;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lve1;->h:Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Lyjh;->localTimeMs()J
    ...
    iget-object p2, p0, Lve1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Lznh;Lznh;)V
    ...
    iget-object p1, p0, Lve1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p0, Lve1;->c:Lf8c;

    invoke-virtual {p2, p1}, Lf8c;->a(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iget-object p2, p0, Lve1;->d:Lqq;

    iget-object p2, p2, Lqq;->a:Ljava/lang/Object;

    check-cast p2, Luj4;

    iget-object p2, p2, Luj4;->a:Ljava/lang/String;
    ...
    iget-object p2, p0, Lve1;->e:Lbb9;

    invoke-virtual {p2, p1}, Lbb9;->F(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {p0, p1}, Lve1;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iput-object p1, p0, Lve1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
