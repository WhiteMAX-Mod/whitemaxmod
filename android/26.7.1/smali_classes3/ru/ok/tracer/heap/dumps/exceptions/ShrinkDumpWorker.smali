...
.method public final g()Ldu8;
    ...
    iget-object v2, v1, Landroidx/work/WorkerParameters;->b:Lpr4;

    const-string v3, "param_dump_path"

    invoke-virtual {v2, v3}, Lpr4;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lpr4;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v8}, Lco7;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v7, v8}, Lg0i;->C(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v7}, Lco7;->close()V
    :try_end_5
    ...
    :try_start_7
    invoke-static {v8, v1}, Ly17;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_9
    invoke-static {v7, v1}, Ly17;->m(Ljava/io/Closeable;Ljava/lang/Throwable;)V
