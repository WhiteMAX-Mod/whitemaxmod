...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Ld2i;",
        "init",
        "(Lon1;Lorg/webrtc/RendererCommon$GlDrawer;)V",
...
# instance fields
.field private final callVideoDrawer:Li02;

.field private final drawerListener:Lh02;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1}, Li02;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Li02;
    ...
    invoke-direct {p1, p0}, Lwvi;-><init>(Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lh02;
...
.method public clearImage()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Li02;

    iget-object v1, v0, Li02;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, v0, Li02;->g:Lon1;

    if-eqz v2, :cond_0

    iget-object v2, v2, Lon1;->e:Lmn1;

    new-instance v3, Lxb8;

    const/4 v4, 0x6

    invoke-direct {v3, v0, v4}, Lxb8;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v3}, Lmn1;->c(Le37;)Z
    :try_end_0
...
.method public createEglSurface(Landroid/view/Surface;)V
    ...
    iget-object v4, v0, Li02;->j:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v4, p1}, Lsnj;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :cond_0
    iput-object p1, v0, Li02;->i:Landroid/view/Surface;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public init(Lon1;Lorg/webrtc/RendererCommon$GlDrawer;)V
    .locals 5
    ...
    :cond_0
    :try_start_1
    iput-object p1, v0, Li02;->g:Lon1;

    iget-object v2, p1, Lon1;->e:Lmn1;

    new-instance v3, Lyij;

    const/4 v4, 0x1

    invoke-direct {v3, v0, p2, p1, v4}, Lyij;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {v2, v3}, Lmn1;->c(Le37;)Z

    iget-object p2, v0, Li02;->i:Landroid/view/Surface;

    if-eqz p2, :cond_1

    iget-object v2, p1, Lon1;->a:Lgae;

    iget-object v3, v0, Li02;->j:Ljava/lang/String;
    ...
    iget-object p1, p1, Lon1;->e:Lmn1;

    new-instance v2, Lsnj;

    const/4 v3, 0x1

    invoke-direct {v2, v0, v3, p2}, Lsnj;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {p1, v2}, Lmn1;->c(Le37;)Z
    ...
    :goto_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Li02;

    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lh02;

    iget-object p1, p1, Li02;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v1, v0, Li02;->l:Lj02;

    iget-object v1, v1, Lj02;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    :try_start_1
    iget-object v3, v0, Li02;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v3, v2, Lon1;->e:Lmn1;

    new-instance v4, Lspj;

    invoke-direct {v4, v0, v2}, Lspj;-><init>(Lnn1;Lon1;)V
    ...
    :try_start_2
    iget-object v2, v3, Lmn1;->k:Lopj;

    new-instance v5, Lln1;

    const/4 v6, 0x0

    invoke-direct {v5, v4, v3, v6}, Lln1;-><init>(Le37;Lmn1;I)V
    ...
    :try_start_3
    iget-object v4, v3, Lmn1;->a:Lgae;

    iget-object v3, v3, Lmn1;->j:Ljava/lang/String;

    const-string v5, "OpenGL tread died, is it fine?"

    invoke-interface {v4, v3, v5, v2}, Lgae;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
...
.method public release()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lh02;

    iget-object v0, v0, Li02;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lspj;-><init>(Lon1;Lnn1;)V

    invoke-virtual {v3, v4}, Lmn1;->c(Le37;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public releaseEglSurface(Lc37;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iput-object v2, v0, Li02;->i:Landroid/view/Surface;
    ...
    invoke-direct {v4, v2, v0, p1, v5}, Lyij;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public setFpsReduction(F)V
    ...
    iget-object v0, v0, Li02;->e:Lyv;

    monitor-enter v0

    :try_start_0
    iget-wide v1, v0, Lyv;->c:J
