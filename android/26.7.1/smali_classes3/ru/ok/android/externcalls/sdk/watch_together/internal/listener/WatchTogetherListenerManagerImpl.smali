...
.method private final getPosition(Ljava/lang/Long;)Ltra;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lrra;-><init>(J)V
...
.method private final updateState(Lzra;)V
    .locals 12
    ...
    iget-object p1, p1, Lzra;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lyra;->a:Ll02;

    iget-object v3, v3, Ll02;->b:Lnp1;
    ...
    iget-object v11, v3, Ll02;->c:Lqra;
    ...
    sget-object v5, Lwra;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lnra;->d:Lvra;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lnra;->a:Lqra;

    invoke-virtual {v8, v11}, Lqra;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lyra;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Ltra;

    move-result-object v5

    iget-boolean v2, v1, Lyra;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lyra;->b:F

    invoke-static {v7}, Ldsa;->a(F)V

    iget-boolean v8, v1, Lyra;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ltra;ZFZLnra;Lpy4;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lmrf;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmrf;Lnra;)V
...
.method public final onVideoStarted(Lxra;)V
    .locals 12
    ...
    iget-object v11, v7, Lnra;->a:Lqra;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ltra;ZFZLnra;Lpy4;)V
    ...
    iget-object p1, p1, Lxra;->b:Lmrf;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmrf;Lnra;)V
...
.method public final onVideoStatesUpdatedChanged(Lzra;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lzra;)V
...
.method public final onVideoStopped(Lasa;)V
    .locals 4
    ...
    iget-object v2, p1, Lasa;->b:Lmrf;

    iget-object v3, p1, Lasa;->c:Lqra;

    iget-object p1, p1, Lasa;->d:Lvra;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lmrf;Lqra;Lvra;)V
