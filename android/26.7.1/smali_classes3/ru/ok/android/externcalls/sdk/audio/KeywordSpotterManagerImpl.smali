...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "logger",
        "<init>",
        "(Le61;Lru/ok/android/externcalls/sdk/stat/kws/ConversationKwsStat;Lru/ok/android/externcalls/sdk/audio/internal/KeywordSpotterConfigProvider;Lyjh;Lgae;)V",
        "",
        "timeout",
        "Ld2i;",
        "scheduleTurnOff",
...
.field private shutDownDisposable:Lxc5;
...
.field private turnOffDisposable:Lxc5;

.field private final turnOffInMs:Los0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl$Companion;-><init>(Lpy4;)V
...
.method public constructor <init>(Le61;Lru/ok/android/externcalls/sdk/stat/kws/ConversationKwsStat;Lru/ok/android/externcalls/sdk/audio/internal/KeywordSpotterConfigProvider;Lyjh;Lgae;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->call:Le61;
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->timeProvider:Lyjh;

    iput-object p5, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Lgae;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffInMs:Los0;

    sget-object p1, Lsr5;->a:Lsr5;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffDisposable:Lxc5;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->shutDownDisposable:Lxc5;

    invoke-interface {p3}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lra9;
    ...
    new-instance p4, Lbk8;

    invoke-direct {p4, p0}, Lbk8;-><init>(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)V
    ...
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->initDisposable:Lxc5;
    ...
    invoke-direct {p1, p0}, Lbk8;-><init>(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)V
...
.method public static final synthetic access$getCall$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Le61;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->call:Le61;

    return-object p0
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Lgae;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Lgae;
...
.method public static final synthetic access$getTimeProvider$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Lyjh;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->timeProvider:Lyjh;

    return-object p0
.end method

.method public static final synthetic access$getTurnOffInMs$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Los0;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffInMs:Los0;
...
.method private static final consumer$lambda$3(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;[Ljava/lang/Double;)V
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Lgae;
...
.method private final scheduleTurnOff(J)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Lgae;
    ...
    invoke-direct {v0, p1, p2, v1}, Ludg;-><init>(JLf7f;)V

    invoke-static {}, Lng;->a()Lf7f;

    move-result-object p1

    invoke-virtual {v0, p1}, Ldcg;->i(Lf7f;)Lxcg;
    ...
    invoke-virtual {p1, p2, v0}, Ldcg;->k(Lm64;Lm64;)Lz12;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->initDisposable:Lxc5;

    invoke-interface {v0}, Lxc5;->dispose()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffDisposable:Lxc5;

    invoke-interface {v0}, Lxc5;->dispose()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->shutDownDisposable:Lxc5;
...
.method public setKeywordSpotterParams(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManager$KeywordSpotterParams;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->call:Le61;
    ...
    invoke-direct {v1, v2, v3, v4}, Lck8;-><init>(ZLjava/lang/String;Lorg/webrtc/NativeDoubleArrayConsumer$Consumer;)V
    ...
    invoke-direct {v4, v0, v2, v1, v5}, Lkl;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    :cond_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->timeProvider:Lyjh;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffInMs:Los0;

    invoke-static {}, Lng;->a()Lf7f;

    move-result-object v0

    invoke-virtual {p1, v0}, Ldgb;->j(Lf7f;)Lcib;
    ...
    invoke-direct {v3, v0, v1, v2}, Lkk8;-><init>(Lm64;Lm64;Lb8;)V

    invoke-virtual {p1, v3}, Ldgb;->a(Lkjb;)V

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffDisposable:Lxc5;
