...
# direct methods
.method public constructor <init>(Lofb;Lorg/webrtc/CameraVideoCapturer;Lyq;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLgae;)V
    .locals 4
    ...
    iput-object v0, p0, Ll82;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Ll82;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Ll82;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ll82;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Ll82;->h:Ljava/lang/String;

    iput-object p7, p0, Ll82;->e:Lgae;

    check-cast p1, Liy4;

    new-instance p7, Lpfb;

    new-instance v2, Lkgc;

    new-instance v3, Lqa2;

    iget-object p1, p1, Liy4;->a:Lgae;

    invoke-direct {v3, p1}, Lqa2;-><init>(Lgae;)V

    invoke-direct {v2, p2, v3, p1}, Lkgc;-><init>(Lorg/webrtc/CameraVideoCapturer;Lqa2;Lgae;)V

    const/4 p1, 0x0

    invoke-direct {p7, v2, p1}, Lpfb;-><init>(Ljava/lang/Object;I)V

    iput-object p7, p0, Ll82;->c:Lpfb;

    iput-object p3, p0, Ll82;->d:Lyq;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Ll82;->i:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Ll82;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Ll82;->i:Z

    if-eqz v1, :cond_0

    iget-object v2, p0, Ll82;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Ll82;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3}, Lc78;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lsa2;->w(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lw59;->k(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Ll82;->e:Lgae;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lgae;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Ll82;->e:Lgae;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Li62;->x(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Ll82;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lzx8;->r:Ll82;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lzx8;->n:Lgae;
    ...
    invoke-interface {v8, v10, v11, v9}, Lgae;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lzx8;->y:Lsoi;

    iget-object v8, v7, Lyo9;->a:Lgae;

    const-string v9, "VideoRecord"

    const-string v10, "Camera capture dimensions were changed to "

    invoke-static {v10, v2, v0, v5}, Lw59;->k(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lsoi;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Lsoi;->p()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Ll82;->k:Z
    ...
    invoke-interface {v4, v6, v5}, Lgae;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Ll82;->c:Lpfb;

    iget-object v4, v4, Lpfb;->b:Ljava/lang/Object;

    check-cast v4, Lkgc;

    invoke-virtual {v4, v2, v0, v3}, Lkgc;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lkgc;->startCapture(III)V

    iput-boolean v1, p0, Ll82;->k:Z
    :try_end_1
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lkgc;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Ll82;->k:Z
    :try_end_0
