...
# static fields
.field public static final z0:Landroid/view/animation/AccelerateDecelerateInterpolator;
...
.field public final x0:Ljava/util/EnumMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laaf;->z0:Landroid/view/animation/AccelerateDecelerateInterpolator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Laaf;->a:Lc37;

    new-instance v0, Lr9f;

    const/4 v1, 0x0

    invoke-direct {v0, p1, p0, v1}, Lr9f;-><init>(Landroid/content/Context;Laaf;I)V
    ...
    iput-object v0, p0, Laaf;->c:Lc37;

    new-instance v0, Lr9f;

    const/4 v2, 0x1

    invoke-direct {v0, p1, p0, v2}, Lr9f;-><init>(Landroid/content/Context;Laaf;I)V

    invoke-static {v1, v0}, Lfk8;->K(ILc37;)Lxk8;

    move-result-object v0

    iput-object v0, p0, Laaf;->d:Ljava/lang/Object;
    ...
    iput-object p1, p0, Laaf;->v0:Ljava/lang/Object;
    ...
    iput-object p1, p0, Laaf;->w0:Ljava/util/EnumMap;

    new-instance p1, Ljava/util/EnumMap;

    invoke-direct {p1, v0}, Ljava/util/EnumMap;-><init>(Ljava/lang/Class;)V

    iput-object p1, p0, Laaf;->x0:Ljava/util/EnumMap;

    new-instance p1, Ljava/util/EnumMap;

    invoke-direct {p1, v0}, Ljava/util/EnumMap;-><init>(Ljava/lang/Class;)V

    iput-object p1, p0, Laaf;->y0:Ljava/util/EnumMap;
...
.method public static a(Lt9f;Ljava/util/EnumMap;Ljava/util/EnumMap;Le37;)V
    .locals 2
...
.method private final getMentionButton()Lp9f;
    .locals 1
...
.method private final getReactionButton()Lp9f;
    .locals 1

    iget-object v0, p0, Laaf;->v0:Ljava/lang/Object;
...
.method private final getScrollToBottomButton()Lp9f;
    .locals 1
...
# virtual methods
.method public final b(Lt9f;)V
    .locals 9

    invoke-virtual {p0, p1}, Laaf;->d(Lt9f;)Lp9f;

    move-result-object v0

    iget-object v1, p0, Laaf;->x0:Ljava/util/EnumMap;
    ...
    iget-object v2, p0, Laaf;->w0:Ljava/util/EnumMap;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Laaf;->y0:Ljava/util/EnumMap;
    ...
    invoke-static {v4}, Ln3k;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v1, p0, v2, p1}, Ld43;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {p0, v1}, Lmui;->b(Landroid/view/ViewGroup;Lc37;)Lkui;
    ...
    invoke-direct/range {v3 .. v8}, Lx9f;-><init>(Lp9f;Laaf;Lt9f;Laaf;Lp9f;)V

    invoke-static {v6, v1, v2, v3}, Laaf;->a(Lt9f;Ljava/util/EnumMap;Ljava/util/EnumMap;Le37;)V

    return-void
.end method

.method public final c(Lt9f;)V
    .locals 6
    ...
    iget-object v1, p0, Laaf;->w0:Ljava/util/EnumMap;
    ...
    iget-object v3, p0, Laaf;->x0:Ljava/util/EnumMap;
    ...
    :cond_2
    :goto_0
    iget-object v2, p0, Laaf;->y0:Ljava/util/EnumMap;
    ...
    invoke-static {v5}, Ln3k;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v1, v0, p0, p1, v3}, Ly9f;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v0, p0, p1, v4}, Ld32;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {p1, v1, v3, v2}, Laaf;->a(Lt9f;Ljava/util/EnumMap;Ljava/util/EnumMap;Le37;)V

    return-void
.end method

.method public final d(Lt9f;)Lp9f;
    .locals 1
    ...
    invoke-direct {p0}, Laaf;->getReactionButton()Lp9f;
    ...
    :cond_1
    invoke-direct {p0}, Laaf;->getMentionButton()Lp9f;
    ...
    :cond_2
    invoke-direct {p0}, Laaf;->getScrollToBottomButton()Lp9f;
...
.method public final onThemeChanged(La6c;)V
    ...
    invoke-virtual {v0, p1}, Lp9f;->onThemeChanged(La6c;)V
...
.method public final setOnClickListener(Le37;)V
    ...
    invoke-direct {v0, v1, p1}, Ls9f;-><init>(ILe37;)V
