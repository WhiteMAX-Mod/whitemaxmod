...
# direct methods
.method public constructor <init>(Lelk;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lxag;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Ltdb;->o:Lelk;
...
.method public final L(Lccg;I)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lsdb;->C(Llt8;)V

    move-object p1, p2

    check-cast p1, Lkdb;

    iget-object p1, p1, Lkdb;->o:Lixf;

    instance-of p1, p1, Lgxf;

    iget-object v1, p0, Ltdb;->o:Lelk;
    ...
    invoke-direct {p1, v1, v2, p2}, Lhx6;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final bridge synthetic v(Lmme;I)V
    ...
    invoke-virtual {p0, p1, p2}, Ltdb;->L(Lccg;I)V
