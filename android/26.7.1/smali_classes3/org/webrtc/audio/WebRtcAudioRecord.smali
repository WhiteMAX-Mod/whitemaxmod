...
.method private logMainParameters(Landroid/media/AudioRecord;)V
    ...
    invoke-static {v4, v0, v2, v1, v3}, Li62;->x(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public initDeviceAudioRecord(Landroid/media/projection/MediaProjection;)V
    ...
    :try_start_0
    invoke-static {}, Ltui;->g()V

    invoke-static {p1}, Ltui;->d(Landroid/media/projection/MediaProjection;)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    move-result-object v4

    invoke-static {v4}, Ltui;->h(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)V

    invoke-static {v4}, Ltui;->n(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)V

    new-instance v5, Landroid/media/AudioRecord$Builder;

    invoke-direct {v5}, Landroid/media/AudioRecord$Builder;-><init>()V

    invoke-static {v4}, Ltui;->e(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)Landroid/media/AudioPlaybackCaptureConfiguration;

    move-result-object v4

    invoke-static {v5, v4}, Ltui;->i(Landroid/media/AudioRecord$Builder;Landroid/media/AudioPlaybackCaptureConfiguration;)V
    ...
    invoke-static {v1, p1}, Lw59;->g(ILjava/lang/String;)Ljava/lang/String;
