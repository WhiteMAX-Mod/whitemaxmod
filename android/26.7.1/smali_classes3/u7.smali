...
.method public synthetic constructor <init>(Lru/ok/messages/media/mediabar/ActLocalMedias;I)V
    ...
    iput-object p1, p0, Lu7;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;
...
.method public final run()V
    ...
    iget-object v2, p0, Lu7;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    packed-switch v0, :pswitch_data_0

    iget-object v0, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->d1:Landroid/view/View;
    ...
    :pswitch_5
    iget-object v0, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->U0:Ljava/util/ArrayList;
    ...
    iget-object v4, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->j1:Lqx8;

    invoke-virtual {v3, v4}, Lho9;->l(Lqx8;)V
    ...
    iget-object v4, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->k1:Lqx8;

    invoke-virtual {v3, v4}, Lho9;->l(Lqx8;)V

    :cond_2
    iget-object v3, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->Y0:Lvm9;
    ...
    :cond_3
    iget v3, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->V0:I
    ...
    :cond_4
    iget-object v2, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->Y0:Lvm9;

    iget-wide v3, v0, Lix8;->b:J

    invoke-virtual {v2, v3, v4}, Lvm9;->J(J)Lru/ok/messages/media/mediabar/FrgLocalMedia;
    ...
    iget-object v2, v0, Lru/ok/messages/media/mediabar/FrgLocalVideo;->D1:Luza;
    ...
    :cond_5
    iget-object v0, v0, Lru/ok/messages/media/mediabar/FrgLocalVideo;->B1:Lqx8;

    iget-object v3, v0, Lqx8;->b:Lr06;
    ...
    :cond_7
    iget v1, v3, Lr06;->x0:I

    :goto_2
    iget v2, v3, Lr06;->y0:I

    iget-object v0, v0, Lqx8;->e:Lg3;

    if-eqz v0, :cond_8

    invoke-interface {v0, v4, v1, v2}, Lfo9;->l(III)V
