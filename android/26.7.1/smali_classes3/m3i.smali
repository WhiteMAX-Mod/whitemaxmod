...
# direct methods
.method public constructor <init>(Lyda;Lone/me/sdk/lists/widgets/EndlessRecyclerView2;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lm3i;->a:Lyda;

    iput-object p2, p0, Lm3i;->b:Lone/me/sdk/lists/widgets/EndlessRecyclerView2;
    ...
    invoke-direct {p1, p2, v0}, Llhg;-><init>(IZ)V

    iput-object p1, p0, Lm3i;->d:Llhg;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lm3i;->o:Landroid/graphics/Rect;

    sget-object p1, Llm5;->b:Llm5;

    iput-object p1, p0, Lm3i;->Z:Llm5;
...
.method public final g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lime;)V
    ...
    iget-object v0, p0, Lm3i;->d:Llhg;

    if-ltz p4, :cond_5

    iget-object v1, p0, Lm3i;->a:Lyda;

    iget-object v2, v1, Ldt8;->d:Lv00;
    ...
    :cond_0
    invoke-virtual {v1, v2, v3}, Lyda;->O(J)I

    move-result v4

    invoke-virtual {v1, v4}, Lyda;->Q(I)Lone/me/messages/list/loader/MessageModel;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, Lm3i;->j()Landroid/view/ViewGroup;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v0, p1, p2, p3}, Llhg;->l(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public final i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    invoke-virtual {v0, v1, v2}, Lyda;->O(J)I
    ...
    :cond_4
    invoke-virtual {v0, v5}, Lyda;->Q(I)Lone/me/messages/list/loader/MessageModel;
    ...
    iget-object v6, p0, Lm3i;->d:Llhg;

    iget-object v8, p0, Lm3i;->o:Landroid/graphics/Rect;

    invoke-virtual {v6, v8, v3, v5}, Llhg;->i(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v8, p0, Lm3i;->b:Lone/me/sdk/lists/widgets/EndlessRecyclerView2;

    invoke-static/range {v7 .. v12}, Ll6g;->W(Landroid/view/View;Landroid/view/ViewGroup;IIII)V
...
.method public final j()Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, Lm3i;->b:Lone/me/sdk/lists/widgets/EndlessRecyclerView2;

    invoke-virtual {v0}, Landroid/view/View;->getMeasuredWidth()I

    move-result v1

    iget-object v2, p0, Lm3i;->X:Landroid/widget/FrameLayout;
    ...
    invoke-interface {v8}, La6c;->k()Ln95;

    move-result-object v8

    iget-object v8, v8, Ln95;->d:Ljava/lang/Object;

    check-cast v8, Lmlj;

    iget-object v8, v8, Lmlj;->b:Ljava/lang/Object;

    check-cast v8, Ls5c;

    iget-object v8, v8, Ls5c;->a:[I
    ...
    iget-object v7, p0, Lm3i;->Z:Llm5;

    invoke-virtual {v6, v5, v7}, Lvgh;->b(Landroid/widget/TextView;Llm5;)V
    ...
    :goto_1
    iput-object v3, p0, Lm3i;->X:Landroid/widget/FrameLayout;

    iput v1, p0, Lm3i;->Y:I

    :cond_3
    iget-object v0, p0, Lm3i;->X:Landroid/widget/FrameLayout;
...
.method public final onThemeChanged(La6c;)V
    ...
    iget-object v3, v3, Ln95;->d:Ljava/lang/Object;

    check-cast v3, Lmlj;

    iget-object v3, v3, Lmlj;->b:Ljava/lang/Object;

    check-cast v3, Ls5c;

    iget-object v3, v3, Ls5c;->a:[I
