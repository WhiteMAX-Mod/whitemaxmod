...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v1}, Lw59;->j(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Lxi8;->c:Ljava/util/Map;
    ...
    sput-object v0, Lxi8;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Lxi8;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Ljmh;->x0:Ljmh;

    iget-short v6, v6, Ljmh;->a:S
    ...
    iget-object v2, v1, Lwi8;->a:Llmh;

    iget-short v2, v2, Llmh;->a:S

    invoke-virtual {v5, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, v1, Lwi8;->a:Llmh;

    sget-object v3, Lxi8;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lwi8;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Lxi8;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Lxi8;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Llmh;->o:Llmh;
    ...
    invoke-static {v2}, Lse;->p(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Lse;->o(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lxi8;->e([B)V

    iget-object v1, v1, Lwi8;->a:Llmh;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {}, Llmh;->values()[Llmh;
    ...
    invoke-direct {v6, v2, v7}, Lnn3;-><init>(II)V
    ...
    sget-object v3, Lxi8;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Lxi8;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Lvi8;-><init>(Llmh;Ljava/security/interfaces/ECPublicKey;)V
    ...
    invoke-static {v5}, Li7c;->c(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lse;->t()V

    invoke-static {v5, v4}, Lse;->q(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Lwi8;-><init>(Llmh;Ljava/security/PublicKey;)V
