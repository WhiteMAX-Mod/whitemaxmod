...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lnm5;)V
    .locals 5

    invoke-direct {p0}, Lce5;-><init>()V

    iput-object p1, p0, Lpli;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lpli;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lpli;->t:[F
    ...
    invoke-virtual {p0, p2}, Lce5;->o(Lnm5;)Lgg0;
...
.method public final r()V
    ...
    iget-object v0, p0, Lpli;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lg0i;->x0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lpli;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lpli;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lpli;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lpli;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lpli;->q:Lrog;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lrog;->d:Ljava/lang/String;

    invoke-static {v3, v1}, Lg0i;->x0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lrog;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;->release()V

    iget-object v1, v2, Lrog;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->release()V

    :cond_2
    iput-object v0, p0, Lpli;->q:Lrog;

    iput-object v0, p0, Lpli;->w:Lnzf;

    invoke-super {p0}, Lce5;->r()V

    return-void
.end method

.method public final x(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    .locals 18
    ...
    invoke-virtual {v1, v0}, Lce5;->m(Landroid/view/Surface;)Lyg0;

    move-result-object v2

    sget-object v3, Le57;->j:Lyg0;

    invoke-virtual {v2, v3}, Lyg0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v1, v0}, Lce5;->i(Landroid/view/Surface;)Lyg0;
    ...
    :cond_1
    iget-object v3, v1, Lce5;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Le57;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v1, Lce5;->e:Ljava/lang/Object;

    check-cast v3, Ljava/lang/Thread;

    invoke-static {v3}, Le57;->c(Ljava/lang/Thread;)V

    iget v3, v1, Lce5;->b:I

    iget v11, v2, Lyg0;->b:I

    iget v12, v2, Lyg0;->c:I

    iget-object v9, v2, Lyg0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v1, Lpli;->q:Lrog;

    if-nez v2, :cond_2

    new-instance v2, Lrog;

    iget-object v5, v1, Lpli;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Lrog;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lpli;->q:Lrog;

    :cond_2
    move-object v10, v2

    iget-object v2, v1, Lpli;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lpli;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lpli;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lpli;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lpli;->u:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Lrog;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v6}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->bind()V

    iget v6, v10, Lrog;->b:I

    iget v7, v10, Lrog;->c:I
    ...
    iget-object v9, v10, Lrog;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Lrog;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v4}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->getTextureId()I

    move-result v4

    iget-object v5, v10, Lrog;->a:Landroid/util/Size;
    ...
    iget-object v5, v1, Lce5;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Lce5;->p(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Lce5;->k:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v2, Lrog;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v5, v1, Lpli;->w:Lnzf;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v2, v2, Lrog;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v2, v1, Lpli;->w:Lnzf;

    if-eqz v2, :cond_8

    invoke-virtual {v2, v11}, Lnzf;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_9
    :goto_2
    iget-object v2, v1, Lce5;->f:Ljava/lang/Object;
    ...
    iget-object v11, v1, Lpli;->p:Ljava/lang/String;

    invoke-static {}, Landroid/opengl/EGL14;->eglGetError()I

    move-result v2

    invoke-static {v8}, Lr1b;->d(I)V
    ...
    invoke-static {v8, v2, v3}, Lenk;->d(IJ)Ljava/lang/String;
    ...
    :cond_b
    invoke-virtual {v1, v0, v4}, Lce5;->t(Landroid/view/Surface;Z)V
