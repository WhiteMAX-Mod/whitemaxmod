...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lsq6;->X:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lrk7;->b([Ljava/lang/Object;)V
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Lsq6;->a:Landroid/media/MediaMuxer;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lsq6;->b:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lsq6;->c:Landroid/util/SparseArray;
...
.method public final M(Ld7a;)V
    ...
    iget-object v1, p0, Lsq6;->a:Landroid/media/MediaMuxer;
...
.method public final W(ILjava/nio/ByteBuffer;Lww0;)V
    ...
    iget-wide v3, v2, Lww0;->a:J

    iget-boolean v5, v1, Lsq6;->d:Z

    iget-object v6, v1, Lsq6;->a:Landroid/media/MediaMuxer;

    const/4 v7, 0x1

    iget-object v8, v1, Lsq6;->c:Landroid/util/SparseArray;
    ...
    iget-object v3, v1, Lsq6;->b:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Lvih;->k(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v8, v9, v5, v12}, Ly12;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v6, v7}, Ly12;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Lsq6;->d:Z

    const/4 v1, 0x1

    iget-object v2, p0, Lsq6;->a:Landroid/media/MediaMuxer;
    ...
    iput-boolean v0, p0, Lsq6;->d:Z

    :try_start_1
    invoke-static {v2}, Lsq6;->d(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final t0(Lol6;)I
    ...
    iget-object v5, p0, Lsq6;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v6, p1, Lol6;->D:Lok3;

    invoke-static {v4, v6}, Lpij;->d(Landroid/media/MediaFormat;Lok3;)V
    ...
    :cond_10
    :goto_2
    iget-object v0, p1, Lol6;->q:Ljava/util/List;

    invoke-static {v4, v0}, Lpij;->f(Landroid/media/MediaFormat;Ljava/util/List;)V
