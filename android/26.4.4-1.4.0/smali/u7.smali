...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v8, p0, Lu7;->b:Ljava/lang/Object;
    ...
    iget-object p1, v8, Landroidx/appcompat/widget/Toolbar;->Z0:Lovg;
    ...
    :cond_3
    iget-object v5, p1, Lovg;->b:Lxl9;

    :goto_1
    if-eqz v5, :cond_4

    invoke-virtual {v5}, Lxl9;->collapseActionView()Z
    ...
    invoke-virtual {v8, v7}, Lone/me/sdk/bottomsheet/BaseBottomSheetWidget;->N0(Z)V
    ...
    invoke-virtual {v8}, Lone/me/profile/ProfileScreen;->O0()Lq2d;
    ...
    iget-object v1, v1, Ltoc;->c:Ljava/util/List;
    ...
    invoke-direct {v3, v4, v7, v6, v8}, Luu3;-><init>(ILhpg;II)V
    ...
    invoke-direct {v3, v4, v9, v6, v8}, Luu3;-><init>(ILhpg;II)V
    ...
    invoke-direct {v1, v2, v5, p1, v5}, Le1d;-><init>(Lhpg;Lhpg;Ljava/util/List;Landroid/os/Bundle;)V
    ...
    iget-object p1, v8, Landroidx/mediarouter/app/g;->R0:Lgb9;

    iget-object v0, v8, Landroidx/mediarouter/app/e;->E0:Lvb9;

    invoke-virtual {v8, v0}, Landroidx/mediarouter/app/g;->A(Lvb9;)Z

    move-result v0

    xor-int/lit8 v5, v0, 0x1

    iget-object v9, v8, Landroidx/mediarouter/app/e;->E0:Lvb9;

    invoke-virtual {v9}, Lvb9;->e()Z

    move-result v9

    if-nez v0, :cond_b

    iget-object v10, p1, Lgb9;->w0:Lib9;

    iget-object v10, v10, Lib9;->X:Lwb9;

    iget-object v11, v8, Landroidx/mediarouter/app/e;->E0:Lvb9;
    ...
    iget-object v10, v3, Lsb9;->s:Llb9;

    instance-of v10, v10, Lkb9;

    if-eqz v10, :cond_9

    iget-object v2, v3, Lsb9;->r:Lvb9;

    invoke-virtual {v2, v11}, Lvb9;->b(Lvb9;)Ln8;

    move-result-object v2

    iget-object v10, v3, Lsb9;->r:Lvb9;

    iget-object v10, v10, Lvb9;->u:Ljava/util/ArrayList;
    ...
    iget-boolean v2, v2, Ljb9;->d:Z

    if-eqz v2, :cond_8

    iget-object v1, v3, Lsb9;->s:Llb9;

    check-cast v1, Lkb9;

    iget-object v2, v11, Lvb9;->b:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lkb9;->m(Ljava/lang/String;)V
    ...
    iget-object v2, v2, Lvb9;->u:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2}, Lkb9;->n(Ljava/lang/String;)V
    ...
    iget-object v1, p1, Lgb9;->w0:Lib9;

    iget-object v1, v1, Lib9;->s0:Lvb9;

    iget-object v1, v1, Lvb9;->u:Ljava/util/ArrayList;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iget-object v2, v8, Landroidx/mediarouter/app/e;->E0:Lvb9;
    ...
    iget-object v9, p1, Lgb9;->w0:Lib9;

    iget-object v9, v9, Lib9;->F0:Ljava/util/HashMap;
    ...
    iget-object v3, v1, Lib9;->s0:Lvb9;
    ...
    :cond_15
    iget-boolean v0, v1, Lib9;->c1:Z

    if-eqz v0, :cond_16

    iget-object v0, v1, Lib9;->s0:Lvb9;
    ...
    iget-object v0, v1, Lib9;->C0:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, v6}, Landroidx/recyclerview/widget/RecyclerView;->M(I)Lpyd;
    ...
    :cond_18
    invoke-virtual {p1, v1, v6}, Lgb9;->D(Landroid/view/View;I)V
    ...
    iget-object p1, v8, Ldb9;->K0:Lgb9;

    iget-object p1, p1, Lgb9;->w0:Lib9;

    iget-object p1, p1, Lib9;->X:Lwb9;

    iget-object v0, v8, Ldb9;->J0:Lvb9;
    ...
    iget-object v3, p1, Lsb9;->s:Llb9;

    instance-of v3, v3, Lkb9;

    if-eqz v3, :cond_1d

    iget-object v2, p1, Lsb9;->r:Lvb9;

    invoke-virtual {v2, v0}, Lvb9;->b(Lvb9;)Ln8;
    ...
    iget-boolean v2, v2, Ljb9;->e:Z

    if-eqz v2, :cond_1c

    iget-object p1, p1, Lsb9;->s:Llb9;

    check-cast p1, Lkb9;

    iget-object v0, v0, Lvb9;->b:Ljava/lang/String;

    invoke-static {v0}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    invoke-virtual {p1, v0}, Lkb9;->o(Ljava/util/List;)V
    ...
    :goto_a
    iget-object p1, v8, Ldb9;->F0:Landroid/widget/ImageView;

    const/4 v0, 0x4

    invoke-virtual {p1, v0}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p1, v8, Ldb9;->G0:Landroid/widget/ProgressBar;
    ...
    iget-object v0, v8, Landroidx/mediarouter/app/e;->H0:Lib9;

    iget-object v1, v0, Lib9;->G0:Lvb9;

    if-eqz v1, :cond_1f

    iget-object v1, v0, Lib9;->B0:Li00;

    invoke-virtual {v1, v4}, Landroid/os/Handler;->removeMessages(I)V

    :cond_1f
    iget-object v1, v8, Landroidx/mediarouter/app/e;->E0:Lvb9;

    iput-object v1, v0, Lib9;->G0:Lvb9;
    ...
    :cond_20
    iget-object p1, v0, Lib9;->H0:Ljava/util/HashMap;
    ...
    iget-object p1, v8, Landroidx/mediarouter/app/e;->E0:Lvb9;

    invoke-virtual {p1, v6}, Lvb9;->j(I)V

    iget-object p1, v0, Lib9;->B0:Li00;
    ...
    invoke-virtual {v8}, Laq;->dismiss()V
    ...
    invoke-virtual {v8}, Lone/me/calllist/ui/callpresettings/CallPresettingsScreen;->H0()Lsm1;

    move-result-object p1

    iget-object v0, p1, Lsm1;->t0:Ltn5;

    invoke-virtual {p1}, Lsm1;->p()Z
    ...
    iget-object v2, v1, Lim1;->a:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v2}, Lsm1;->r(Ljava/lang/CharSequence;)V

    :cond_27
    iget-object v2, p1, Lsm1;->c:Lj88;
    ...
    invoke-direct {v3, p1, v1, v5}, Lrm1;-><init>(Lsm1;Lim1;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object v0, v8, Lje;->i:Landroid/widget/Button;

    if-ne p1, v0, :cond_29

    iget-object v0, v8, Lje;->k:Landroid/os/Message;
    ...
    :cond_29
    iget-object v0, v8, Lje;->l:Landroid/widget/Button;

    if-ne p1, v0, :cond_2a

    iget-object v0, v8, Lje;->n:Landroid/os/Message;
    ...
    :cond_2a
    iget-object v0, v8, Lje;->o:Landroid/widget/Button;

    if-ne p1, v0, :cond_2b

    iget-object p1, v8, Lje;->q:Landroid/os/Message;
    ...
    :cond_2c
    iget-object p1, v8, Lje;->E:Lhe;

    iget-object v0, v8, Lje;->b:Lle;
