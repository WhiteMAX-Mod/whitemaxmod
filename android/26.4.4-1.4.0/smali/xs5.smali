...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lxs5;->b:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v1, p0, p1}, Ldm;-><init>(ILandroid/view/View;Ljava/lang/Object;)V

    iput-object v0, p0, Lxs5;->c:Ldm;
    ...
    invoke-virtual {p0}, Lxs5;->getTypography()Lipg;
    ...
    iput-object p1, p0, Lxs5;->d:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lxs5;->s0:I
    ...
    invoke-virtual {p0, p1}, Lxs5;->onThemeChanged(Llob;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Lfe5;->p(Ljava/lang/CharSequence;)Ltrf;
    ...
    iget-object v1, p0, Lxs5;->a:Lg88;

    iget-object v3, p0, Lxs5;->d:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lxs5;->o:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lxs5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lxs5;->v0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lxs5;->s0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lxs5;->v0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lxs5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lxs5;->d:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Ld7g;->Z(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Lgs7;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Lahj;->j(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lxs5;->u0:Landroid/text/Layout;

    iget-boolean v0, p0, Lxs5;->y0:Z
    ...
    :cond_8
    iput-object p1, p0, Lxs5;->t0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lxs5;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lxs5;->w0:Z
    ...
    :cond_0
    iget-object v0, p0, Lxs5;->A0:Llt0;
    ...
    invoke-direct {v0, v1, p0}, Llt0;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Lxs5;->A0:Llt0;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Lxs5;->A0:Llt0;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object v0, p0, Lxs5;->t0:Landroid/text/Layout;

    return-object v0
.end method

.method public final getTypography()Lipg;
    .locals 2

    sget-object v0, Lxs5;->B0:[Lv58;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lxs5;->c:Ldm;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lxs5;->z0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lxs5;->t0:Landroid/text/Layout;
...
.method public final onThemeChanged(Llob;)V
    ...
    iget-object v0, p0, Lxs5;->d:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lxs5;->o:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v1, p0, Lxs5;->t0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lj64;->b(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lxs5;->o:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    .line 6
    invoke-static {v0, v1, p1}, Lyp4;->J(IILjava/lang/CharSequence;)Landroid/text/Spannable;
    ...
    .line 10
    iput-boolean p1, p0, Lxs5;->y0:Z

    .line 11
    iput-boolean p1, p0, Lxs5;->w0:Z
