...
.method public x(Lbr6;Ljava/lang/Object;)V
    .locals 11
    ...
    :goto_0
    iget-object v1, p2, Lori;->b:Ltqi;

    invoke-static {v1}, Lehj;->p(Ltqi;)I
    ...
    :cond_1
    invoke-interface {p1, v2, v1}, Ldcg;->h(ILjava/lang/String;)V

    :goto_1
    iget-object v1, p2, Lori;->d:Ljava/lang/String;
    ...
    :goto_2
    iget-object v1, p2, Lori;->e:Lmj4;

    invoke-static {v1}, Lmj4;->e(Lmj4;)[B
    ...
    :cond_3
    invoke-interface {p1, v2, v1}, Ldcg;->c(I[B)V

    :goto_3
    iget-object v1, p2, Lori;->f:Lmj4;
    ...
    iget-wide v2, p2, Lori;->g:J

    invoke-interface {p1, v1, v2, v3}, Ldcg;->b(IJ)V

    const/16 v1, 0x8

    iget-wide v2, p2, Lori;->h:J

    invoke-interface {p1, v1, v2, v3}, Ldcg;->b(IJ)V

    const/16 v1, 0x9

    iget-wide v2, p2, Lori;->i:J
    ...
    invoke-interface {p1, v3, v1, v2}, Ldcg;->b(IJ)V

    iget-object v1, p2, Lori;->l:Loi0;

    invoke-static {v1}, Lehj;->b(Loi0;)I
    ...
    iget-wide v2, p2, Lori;->m:J

    invoke-interface {p1, v1, v2, v3}, Ldcg;->b(IJ)V

    const/16 v1, 0xd

    iget-wide v2, p2, Lori;->n:J

    invoke-interface {p1, v1, v2, v3}, Ldcg;->b(IJ)V

    const/16 v1, 0xe

    iget-wide v2, p2, Lori;->o:J

    invoke-interface {p1, v1, v2, v3}, Ldcg;->b(IJ)V

    const/16 v1, 0xf

    iget-wide v2, p2, Lori;->p:J

    invoke-interface {p1, v1, v2, v3}, Ldcg;->b(IJ)V

    iget-boolean v1, p2, Lori;->q:Z
    ...
    iget-object v1, p2, Lori;->r:Lktb;

    invoke-static {v1}, Lehj;->k(Lktb;)I
    ...
    invoke-static {v9}, Lehj;->j(I)I

    move-result v9

    int-to-long v9, v9

    invoke-interface {p1, v8, v9, v10}, Ldcg;->b(IJ)V

    iget-boolean v8, p2, Lny3;->b:Z

    int-to-long v8, v8

    invoke-interface {p1, v7, v8, v9}, Ldcg;->b(IJ)V

    iget-boolean v7, p2, Lny3;->c:Z

    int-to-long v7, v7

    invoke-interface {p1, v6, v7, v8}, Ldcg;->b(IJ)V

    iget-boolean v6, p2, Lny3;->d:Z

    int-to-long v6, v6

    invoke-interface {p1, v5, v6, v7}, Ldcg;->b(IJ)V

    iget-boolean v5, p2, Lny3;->e:Z

    int-to-long v5, v5

    invoke-interface {p1, v4, v5, v6}, Ldcg;->b(IJ)V

    iget-wide v4, p2, Lny3;->f:J

    invoke-interface {p1, v3, v4, v5}, Ldcg;->b(IJ)V

    iget-wide v3, p2, Lny3;->g:J
    ...
    invoke-interface {p1, v1, p2}, Ldcg;->c(I[B)V

    goto :goto_5

    :cond_5
    invoke-interface {p1, v8}, Ldcg;->e(I)V
    ...
    invoke-interface {p1, p2}, Ldcg;->e(I)V

    return-void

    :cond_6
    invoke-interface {p1, p2, v0}, Ldcg;->h(ILjava/lang/String;)V
