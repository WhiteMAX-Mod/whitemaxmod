...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqnf;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lpde;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Lqnf;->d:Lpde;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqnf;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Lkie;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Lqnf;->d:Lpde;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Lkie;->a:Z
...
.method public final a()Lcie;
    ...
    iget-object v1, p0, Lqnf;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lpnf;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ly35;
    ...
    invoke-direct {v0, p1, v1}, Lr0;-><init>(Ljava/lang/Runnable;Z)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ly35;
    ...
    sget-object v7, Lni5;->a:Lni5;

    iget-object v6, p0, Lqnf;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lzs7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lzs7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p1, v5}, Lr0;-><init>(Ljava/lang/Runnable;Z)V
