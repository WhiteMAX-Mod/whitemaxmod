...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lju6;->e:Leu6;

    new-instance v0, Leu6;

    const/4 v2, 0x1

    invoke-direct {v0, v2}, Leu6;-><init>(I)V

    sput-object v0, Lju6;->f:Leu6;
    ...
    sput-object v4, Lju6;->h:Ljava/nio/FloatBuffer;
    ...
    sput-object v2, Lju6;->i:Ljava/nio/FloatBuffer;

    sget-object v0, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    new-instance v2, Lsd0;

    invoke-direct {v2, v0, v1, v1}, Lsd0;-><init>(Landroid/opengl/EGLSurface;II)V

    sput-object v2, Lju6;->j:Lsd0;
...
.method public static d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V
    ...
    :goto_1
    invoke-static {p1, p0}, Lmtj;->f(Ljava/lang/String;Z)V
...
.method public static f(Ljava/lang/String;Ljd5;)[I
    .locals 2
...
.method public static g(Ljd5;)Ljava/util/HashMap;
    .locals 11
    ...
    invoke-static {}, Lgu6;->values()[Lgu6;
    ...
    invoke-direct {v8, p0, v7}, Liu6;-><init>(Ljd5;Leu6;)V

    goto :goto_3

    :cond_0
    sget-object v7, Lgu6;->c:Lgu6;

    if-eq v6, v7, :cond_5

    sget-object v7, Lgu6;->b:Lgu6;
    ...
    invoke-static {v9, v8}, Lmtj;->f(Ljava/lang/String;Z)V

    invoke-virtual {p0}, Ljd5;->a()Z

    move-result v8

    if-eqz v8, :cond_3

    new-instance v8, Lfu6;

    const-string v7, "uniform mat4 uTransMatrix;\nattribute vec4 aPosition;\nvoid main() {\n    gl_Position = uTransMatrix * aPosition;\n}\n"

    const-string v9, "precision mediump float;\nuniform float uAlphaScale;\nvoid main() {\n    gl_FragColor = vec4(0.0, 0.0, 0.0, uAlphaScale);\n}\n"

    invoke-direct {v8, v7, v9}, Lhu6;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v7, Liu6;

    invoke-direct {v7, p0, v8}, Liu6;-><init>(Ljd5;Leu6;)V
    ...
    invoke-direct {v8, p0, v7}, Liu6;-><init>(Ljd5;Lgu6;)V
    ...
    invoke-direct {v8, p0, v6}, Liu6;-><init>(Ljd5;Lgu6;)V
...
.method public static i(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/view/Surface;[I)Landroid/opengl/EGLSurface;
    ...
    invoke-static {p1}, Lju6;->a(Ljava/lang/String;)V
