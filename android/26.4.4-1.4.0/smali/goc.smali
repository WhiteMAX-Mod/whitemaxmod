...
# direct methods
.method public constructor <init>(Led4;Lmx0;)V
    .locals 1
...
.method public final D(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lgoc;->a:Lmx0;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lmx0;->m(Ljava/lang/Throwable;Z)Z
...
.method public final E(Lis;)V
    ...
    sget-object v1, Lmx0;->v0:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sget-object v3, Lox0;->q:Lkotlinx/coroutines/internal/Symbol;

    if-ne v2, v3, :cond_4

    sget-object v4, Lox0;->r:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-virtual {v0}, Lmx0;->r()Ljava/lang/Throwable;
    ...
    :cond_4
    sget-object p1, Lox0;->r:Lkotlinx/coroutines/internal/Symbol;
...
.method public final synthetic cancel()V
    ...
    .line 5
    invoke-virtual {p0, v0}, Lgoc;->cancelInternal(Ljava/lang/Throwable;)V
...
.method public final cancel(Ljava/util/concurrent/CancellationException;)V
    ...
    .line 1
    invoke-virtual {p0}, Lyz7;->isCancelled()Z
    ...
    .line 3
    :cond_1
    invoke-virtual {p0, p1}, Lgoc;->cancelInternal(Ljava/lang/Throwable;)V
...
.method public final cancelInternal(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, p1, v0, v1, v0}, Lyz7;->toCancellationException$default(Lyz7;Ljava/lang/Throwable;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/concurrent/CancellationException;

    move-result-object p1

    iget-object v0, p0, Lgoc;->a:Lmx0;

    invoke-virtual {v0, p1}, Lmx0;->cancel(Ljava/util/concurrent/CancellationException;)V

    invoke-virtual {p0, p1}, Lyz7;->cancelCoroutine(Ljava/lang/Throwable;)Z
...
.method public final i(Lll3;)Ljava/lang/Object;
    ...
    invoke-static {v0, p1}, Lmx0;->F(Lmx0;Lda4;)Ljava/lang/Object;
...
.method public final iterator()Lgx0;
    ...
    invoke-direct {v1, v0}, Lgx0;-><init>(Lmx0;)V
...
.method public final onCancelled(Ljava/lang/Throwable;Z)V
    ...
    invoke-static {p2, p1}, Lxtj;->a(Led4;Ljava/lang/Throwable;)V
...
.method public final onCompleted(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lgoc;->a:Lmx0;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lmx0;->l(Ljava/lang/Throwable;)Z
