...
# direct methods
.method public static c(Ljava/nio/ByteBuffer;Lbvg;Lgb2;)Ljava/util/ArrayList;
    .locals 20
    ...
    sget-object v11, Lavg;->b:Lavg;

    iget-short v11, v11, Lavg;->a:S
    ...
    invoke-direct {v7}, Lqt;-><init>()V

    invoke-virtual {v7, v0, v11, v6}, Lkt5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {v14, v0}, Lqt;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v0}, Lqt;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v6, v0}, Lqt;->c(ILjava/nio/ByteBuffer;)V
    ...
    iput-object v13, v7, Lqt;->b:Ljava/lang/Object;
    ...
    invoke-direct {v6, v7, v0}, Lo5d;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    :cond_8
    sget-object v11, Lavg;->d:Lavg;

    iget-short v14, v11, Lavg;->a:S
    ...
    iput-object v12, v8, Lwkf;->a:Ljava/util/List;

    iget-short v11, v11, Lavg;->a:S

    invoke-virtual {v8, v0, v11, v7}, Lkt5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    new-instance v13, Lkg3;

    const/4 v14, 0x4

    invoke-direct {v13, v7, v14}, Lkg3;-><init>(II)V
    ...
    invoke-direct {v12, v13, v8}, Lh4;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v6, v0}, Lqt;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_d
    sget-object v11, Lavg;->X:Lavg;

    iget-short v14, v11, Lavg;->a:S

    if-ne v8, v14, :cond_1e

    sget-object v6, Lbvg;->c:Lbvg;
    ...
    invoke-virtual {v6, v0, v14, v4}, Lkt5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0, v11, v12}, Lkt5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v12, v6, Lpg3;->a:Ljava/util/List;
    ...
    iget-object v7, v6, Lpg3;->a:Ljava/util/List;
    ...
    invoke-direct {v4, v8, v9, v15}, Log3;-><init>(J[B)V
    ...
    iput-object v4, v6, Lpg3;->b:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Lpg3;->b:Ljava/util/ArrayList;

    new-instance v12, Lng3;

    invoke-direct {v12, v8}, Lng3;-><init>([B)V
    ...
    iget-object v4, v6, Lpg3;->a:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v7, v6, Lpg3;->b:Ljava/util/ArrayList;
    ...
    invoke-static {}, Lbvg;->values()[Lbvg;
    ...
    invoke-direct {v3, v4, v1}, Ln6;-><init>(ILjava/lang/Object;)V
    ...
    sget-object v4, Lavg;->Y:Lavg;

    iget-short v4, v4, Lavg;->a:S

    if-ne v8, v4, :cond_22

    new-instance v7, Lvd5;

    invoke-direct {v7}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v7, v0, v4, v6}, Lkt5;->b(Ljava/nio/ByteBuffer;II)I

    move-result v4

    sget-object v6, Lbvg;->d:Lbvg;
    ...
    iput-object v4, v7, Lvd5;->a:Ljava/lang/Long;
    ...
    invoke-direct {v4, v0, v1}, Llcg;-><init>(Ljava/nio/ByteBuffer;Lbvg;)V
    ...
    invoke-direct {v4, v6, v0}, Lo5d;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v0}, Lfa2;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_25
    sget-object v4, Lavg;->u0:Lavg;

    iget-short v6, v4, Lavg;->a:S
    ...
    iput-object v7, v6, Lh68;->b:Ljava/util/ArrayList;

    iget-short v4, v4, Lavg;->a:S

    const/4 v7, 0x1

    invoke-virtual {v6, v0, v4, v7}, Lkt5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0}, Lh68;->d(Ljava/nio/ByteBuffer;)I
    ...
    iget-object v4, v2, Lgb2;->b:Ljava/lang/Object;
    ...
    iget-object v6, v4, Leg4;->a:Lh2f;

    iget-object v6, v6, Lh2f;->b:Ljava/lang/Object;

    check-cast v6, Lukh;

    invoke-direct {v13, v6}, Lr8d;-><init>(Lukh;)V

    iget-object v4, v4, Leg4;->f:Lrn8;
    ...
    invoke-interface {v4, v12}, Lrn8;->debug(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v13, v0, v11, v4}, Lr8d;->e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lrn8;)V
    :try_end_0
    ...
    invoke-static {v4}, Lqn8;->a(Ljava/lang/String;)V
...
.method public abstract b()Lbvg;
.end method

.method public final d(Ljava/nio/ByteBuffer;Lbvg;I)I
    .locals 3
