...
.method public final a(Ll8d;Lp8d;Lmk;)V
    ...
    :try_start_0
    iget-wide v0, p0, Lnj4;->b:J

    iget-wide v2, p2, Lf96;->e:J

    cmp-long p1, v0, v2

    if-lez p1, :cond_1

    iget-wide v4, p2, Lf96;->f:J
    ...
    :goto_0
    iput-wide v0, p2, Lf96;->e:J

    if-eqz p1, :cond_1

    iget-object p1, p2, Lf96;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p3, Ln04;

    const/4 v0, 0x1

    invoke-direct {p3, v0, p2}, Ln04;-><init>(ILjava/lang/Object;)V
