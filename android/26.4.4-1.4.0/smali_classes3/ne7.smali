...
.method public constructor <init>(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lne7;->a:Landroid/content/Context;

    iput-object p3, p0, Lne7;->b:Ljava/lang/String;
...
# virtual methods
.method public final b(Lhri;)Lke7;
    .locals 12

    const-string v0, "Content-Type"

    iget-object v1, p1, Lhri;->a:Ljava/lang/Object;

    check-cast v1, Ljava/lang/String;

    iget-object v2, p1, Lhri;->b:Ljava/lang/Object;
    ...
    invoke-static {v6}, Lnu;->v([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Ljavax/net/ssl/X509TrustManager;

    sget v8, Liid;->rootca_ssl_rsa2022:I

    iget-object v9, p0, Lne7;->a:Landroid/content/Context;
    ...
    invoke-static {v8}, Lnu;->v([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v6, v9}, Lyq3;-><init>([Ljavax/net/ssl/X509TrustManager;)V
    ...
    invoke-static {v10, p1}, Lerj;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :cond_1
    :goto_1
    invoke-interface {p1}, Lje7;->getContentType()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lje7;->getContentLength()J
    ...
    invoke-static {v2, v1}, Lne7;->a(Ljava/net/HttpURLConnection;I)V
    ...
    :try_start_3
    invoke-interface {p1, v1}, Lje7;->writeTo(Ljava/io/OutputStream;)V
    :try_end_3
    ...
    invoke-static {v3, v7}, Lojj;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    :try_start_a
    invoke-static {v3, p1}, Lerj;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v7, v0, v4, v6}, Lx26;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v3, p1, v1, v7, v5}, Lke7;-><init>(ILjava/lang/Object;Ljava/io/Closeable;I)V
    :try_end_c
    ...
    invoke-static {v0, v1, v5}, Ll7g;->s(Ljava/lang/String;Ljava/lang/String;Z)Z
