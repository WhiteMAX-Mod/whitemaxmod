...
# virtual methods
.method public a(Lrbe;Ljava/lang/Throwable;)V
    .locals 2
    ...
    iget-object p1, p0, Lr15;->b:Ls15;

    iget-object p1, p1, Ls15;->a:Ltmd;
    ...
    iget-object p2, p1, Ls15;->a:Ltmd;

    const-string v0, "DisplayLayouts"

    const-string v1, "Resend next time after error"

    invoke-interface {p2, v0, v1}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p2, 0x1

    iput-boolean p2, p1, Ls15;->e:Z
...
.method public c(Lrbe;Lbce;)V
    ...
    :pswitch_0
    iget-object p1, p2, Lidh;->a:Ljava/util/Map;
