...
.field public final synthetic d:Libb;
...
.method public constructor <init>(Ljava/lang/Object;Libb;)V
    .locals 1
...
.method public final Y(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lhbb;->d:Libb;

    if-eqz p2, :cond_0

    iget-object p2, p1, Libb;->B0:Landroid/graphics/drawable/GradientDrawable;
    ...
    :pswitch_0
    iget-object v0, p0, Lhbb;->d:Libb;

    iget-object v1, v0, Libb;->B0:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {p1, p2}, Lmhj;->e(D)I
    ...
    invoke-virtual {p2, p1}, Libb;->g(Llob;)V
    ...
    iget-boolean p2, p1, Libb;->C0:Z

    if-nez p2, :cond_5

    invoke-static {p1}, Libb;->c(Libb;)Lhd5;

    move-result-object p2

    invoke-virtual {p1, p2}, Libb;->a(Lhd5;)V
