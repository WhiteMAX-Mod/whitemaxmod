...
.method public constructor <init>(Lj88;Lj88;)V
    ...
    iput-object p1, p0, Lth0;->a:Lj88;

    iput-object p2, p0, Lth0;->b:Lj88;

    return-void
.end method

.method public static final a(Lth0;[BLtjh;)Lseg;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, v1}, Lseg;-><init>(Ljava/lang/String;II)V

    iget p1, p2, Ltjh;->d:I

    invoke-virtual {p0, p1}, Lseg;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    iget-boolean p2, p2, Ltjh;->e:Z
    ...
    iget-object p2, p0, Lseg;->a:Lisg;

    iget-object p2, p2, Lisg;->g:Landroid/graphics/Paint;
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lpej;->b(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lsjh;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Lyh0;)Ljava/util/LinkedHashMap;
    .locals 28
    ...
    iget-object v8, v11, Lrh0;->a:Ljava/lang/String;
    ...
    invoke-direct {v14, v2}, Lyh0;-><init>(Ljava/lang/String;)V
    ...
    iget-object v2, v2, Lfe3;->d:Ljava/lang/Object;

    check-cast v2, Lnob;

    iget-object v2, v2, Lnob;->b:Ljava/util/Map;
    ...
    :goto_3
    invoke-static {v2, v13}, Lgbj;->D(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-boolean v2, v11, Lrh0;->b:Z

    invoke-static {v15, v2}, Lom9;->b(Loob;Z)Llob;

    move-result-object v2

    invoke-interface {v2}, Llob;->z()Lmk3;

    move-result-object v2

    iget-object v2, v2, Lmk3;->f:Ljava/lang/Object;
    ...
    iget-object v11, v2, Ljzg;->c:Ljava/lang/Object;

    check-cast v11, [I

    iget v13, v2, Ljzg;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v14}, Lyh0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct/range {v20 .. v26}, Ltjh;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v13, v11, v8}, Lrjh;-><init>([IF)V
    ...
    iget-object v8, v2, Ljzg;->X:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v4, v8}, Lth0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    iget-object v4, v2, Ljzg;->o:Ljava/lang/Object;

    check-cast v4, [I

    invoke-static {v5, v4}, Lth0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lrjh;-><init>([IF)V
    ...
    invoke-static {v6, v0}, Lgbj;->D(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v11}, Lnu;->x(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Lujh;

    invoke-direct/range {v20 .. v26}, Lujh;-><init>(Ltjh;Lrjh;Lrjh;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Ltjh;Lpdg;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Lth0;->a:Lj88;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lsh0;-><init>(Lth0;Landroid/content/Context;Ltjh;Lkotlin/coroutines/Continuation;)V
