...
# instance fields
.field private final lossCalc:Lzq8;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lzq8;
...
.method private final calculateLoss(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lzq8;
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lzq8;->a(JJ)D
    ...
    invoke-static {p1, p2, v0}, Liuj;->c(FFF)F
...
.method private final synthetic findSender(Ljava/util/List;)Lntf;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final synthetic getLoss(Ljava/util/List;)Ljava/lang/Float;
    ...
    iget-object p1, v1, Lntf;->i:Ljava/math/BigInteger;

    iget-object v0, v1, Lntf;->h:Ljava/math/BigInteger;
