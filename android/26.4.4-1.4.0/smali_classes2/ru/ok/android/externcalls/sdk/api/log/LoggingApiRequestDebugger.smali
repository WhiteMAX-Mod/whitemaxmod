...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;)Lyvb;",
        "Lyn;",
        "request",
        "getParams",
        "(Lyn;)Ljava/lang/String;",
        "jsonString",
        "eraseSecrets",
        ...
        "exception",
        "debugApiException",
        "(Lin;Lyn;Lru/ok/android/api/core/ApiException;)V",
        "Ljava/io/IOException;",
        "debugIoException",
        "(Lin;Lyn;Ljava/io/IOException;)V",
        "Ltmd;",
        "Ljo;",
...
.field private final sessionStore:Ljo;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lfq4;)V
...
.method public constructor <init>(Ltmd;Ljo;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ltmd;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Ljo;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ltmd;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Lyvb;
    .locals 2
...
.method private final getParams(Lyn;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lyn;)Ljava/lang/String;
...
.method private final getRawParams(Lyn;)Ljava/lang/String;
    .locals 3
    ...
    invoke-direct {v1, v0}, Lbec;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lbec;->q()V

    invoke-interface {p1, v1}, Lyn;->writeParams(Lf58;)V

    invoke-virtual {v1}, Lbec;->n()V

    invoke-virtual {v1}, Lbec;->flush()V
    :try_end_0
    ...
    :catch_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ltmd;

    const-string v1, "CallsApiDebug"

    const-string v2, "failed to log request params"

    invoke-interface {p1, v1, v2}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Ljo;
    ...
    iget-object v0, v0, Lio;->c:Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Lyvb;
...
.method public debugApiException(Lin;Lyn;Lru/ok/android/api/core/ApiException;)V
    ...
    invoke-static {v0, p2, v1}, Ltx8;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string v0, "CallsApiDebug"

    invoke-interface {p1, v0, p2, p3}, Ltmd;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public debugApiRequest(Lin;Lyn;Ljn;)V
    ...
    instance-of p1, p2, Lbo;

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lyn;)Ljava/lang/String;

    move-result-object p1

    const-string p3, "start with params "

    invoke-static {p3, p1}, Lau1;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ltmd;
    ...
    invoke-static {v0, p2, v1, p1}, Lau1;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugApiResponseFail(Lin;Lyn;Lx48;)Lx48;
    ...
    invoke-interface {p3}, Lx48;->f0()Ljava/lang/String;
    ...
    invoke-static {v1, p2, v2, p3}, Lau1;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string p3, "CallsApiDebug"

    invoke-interface {v0, p3, p2}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Ly48;->k(Ljava/lang/String;)Ly48;
...
.method public debugApiResponseOk(Lin;Lyn;Lx48;)Lx48;
    ...
    invoke-static {v0, p3}, Lau1;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
