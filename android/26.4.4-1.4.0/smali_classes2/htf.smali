...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lhtf;->b:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lhtf;->c:Landroid/content/Context;

    new-instance p1, Litf;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhtf;->d:Litf;

    new-instance v1, Lcmf;

    invoke-direct {v1, p1, v0}, Lcmf;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iput-object v1, p0, Lhtf;->e:Lcmf;
...
.method public final a(Ljava/lang/String;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    iget-object v1, p0, Lhtf;->b:Ljava/lang/String;
    ...
    iget-object v4, p0, Lhtf;->c:Landroid/content/Context;

    invoke-direct {v2, v4, p1}, Loqf;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    ...
    iput-wide v6, p1, Litf;->a:J

    iget-wide v8, p1, Litf;->b:J

    add-long/2addr v8, v6

    iput-wide v8, p1, Litf;->b:J
    ...
    :goto_1
    iget-object p1, p0, Lhtf;->b:Ljava/lang/String;
    ...
    invoke-virtual {v1, v0, p1, v4, v3}, Lafb;->c(Lzm8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()Ljtf;
    .locals 21

    move-object/from16 v0, p0

    iget-object v1, v0, Lhtf;->d:Litf;

    iget-wide v3, v1, Litf;->a:J

    iget v2, v1, Litf;->c:I

    const/4 v5, 0x1

    iget-wide v6, v1, Litf;->b:J
    ...
    iget-wide v8, v1, Litf;->d:J

    iget v10, v1, Litf;->f:I

    if-le v10, v5, :cond_1

    iget-wide v10, v1, Litf;->e:J

    iget v12, v1, Litf;->f:I
    ...
    iget-wide v13, v1, Litf;->g:J

    iget v15, v1, Litf;->i:I
    ...
    invoke-direct/range {v2 .. v17}, Ljtf;-><init>(JJIJJIJJI)V
...
.method public final c(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lhtf;->b:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lhtf;->a:Lnh3;

    invoke-virtual {v2}, Lk2;->e0()Len3;

    move-result-object v2

    iget-object v3, p0, Lhtf;->e:Lcmf;

    iget-object v5, v3, Lcmf;->a:Ljava/lang/Object;

    check-cast v5, Litf;

    const-string v6, "session is not valid "

    iget-object v3, v3, Lcmf;->b:Ljava/lang/Object;

    check-cast v3, Lnh3;

    invoke-virtual {v3}, Lk2;->e0()Len3;
    ...
    iput-wide v9, v5, Litf;->g:J

    iget-wide v6, v5, Litf;->h:J

    add-long/2addr v6, v9

    iput-wide v6, v5, Litf;->h:J
    ...
    invoke-virtual {v2}, Lj2;->e()J

    move-result-wide v2

    iget-object v5, p0, Lhtf;->a:Lnh3;

    invoke-virtual {v5}, Lk2;->e0()Len3;

    move-result-object v5

    iget-object v6, p0, Lhtf;->e:Lcmf;

    iget-object v7, v6, Lcmf;->a:Ljava/lang/Object;

    check-cast v7, Litf;

    const-string v8, "Failed to verify host="

    iget-object v6, v6, Lcmf;->b:Ljava/lang/Object;

    check-cast v6, Lnh3;

    invoke-virtual {v6}, Lk2;->e0()Len3;
    ...
    invoke-virtual {v7, p1, p2}, Litf;->a(J)V

    check-cast v5, Lj2;

    invoke-virtual {v5}, Lj2;->e()J
    ...
    invoke-static {v2, v3, p1, p2}, Lgc5;->n(JJ)J

    move-result-wide p1

    invoke-static {p1, p2}, Lgc5;->q(J)Ljava/lang/String;
    ...
    invoke-virtual {v7, v2, v3}, Litf;->a(J)V

    invoke-static {p1, p2}, Lnm4;->b(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide v0, v5, Litf;->g:J

    iget-wide v2, v5, Litf;->h:J

    add-long/2addr v2, v0

    iput-wide v2, v5, Litf;->h:J
