...
.field public volatile Y:Lkq6;

.field public volatile Z:Lkq6;
...
.field public final o:Lnae;

.field public volatile s0:J

.field public final t0:Lxsg;

.field public final u0:Lxsg;
...
# direct methods
.method public constructor <init>(Ltmd;Lnae;)V
    .locals 4
    ...
    iput-object v0, p0, Lvp6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lvp6;->d:Ltmd;

    iput-object p2, p0, Lvp6;->o:Lnae;

    new-instance p1, Lha4;

    const-string p2, "SSFrameEncoder"

    invoke-direct {p1, p2}, Lha4;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Lvp6;->c:Lha4;

    new-instance p1, Lxsg;

    invoke-direct {p1}, Lxsg;-><init>()V

    iput-object p1, p0, Lvp6;->t0:Lxsg;

    new-instance p1, Lxsg;

    invoke-direct {p1}, Lxsg;-><init>()V

    iput-object p1, p0, Lvp6;->u0:Lxsg;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lvp6;->w0:Z

    iget-object v0, p0, Lvp6;->X:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lvp6;->X:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Lvp6;->t0:Lxsg;
    ...
    iput-wide v2, p0, Lvp6;->s0:J

    :cond_0
    iget-object v0, p0, Lvp6;->Y:Lkq6;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lvp6;->Y:Lkq6;

    iget-boolean v2, v0, Lkq6;->a:Z
    ...
    iput-boolean v1, v0, Lkq6;->h:Z

    :cond_2
    iget-object v1, v0, Lkq6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lkq6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Lkq6;->g:Lhui;

    invoke-static {p1}, Lkq6;->b(Lhui;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lvp6;->Z:Lkq6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lvp6;->x0:J

    iget-wide v7, p0, Lvp6;->b:J
    ...
    iget-object v5, v2, Lkq6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lkq6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lvp6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Ltmd;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lvp6;->x0:J

    iget-object p1, p0, Lvp6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lvp6;->c:Lha4;

    new-instance v0, Lof5;

    const/16 v3, 0xb

    invoke-direct {v0, p0, v2, v1, v3}, Lof5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lvp6;->u0:Lxsg;

    invoke-virtual {p1}, Lxsg;->a()V
