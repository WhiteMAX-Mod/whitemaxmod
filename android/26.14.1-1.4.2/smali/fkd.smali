...
.method public constructor <init>(Lrtc;)V
    ...
    iput-object v0, p0, Lfkd;->b:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lfkd;->c:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Lfkd;->onThemeChanged(Lrtc;)V
...
.method public final g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Lhff;)V
    ...
    iget-object p3, p4, Lhff;->b:Landroid/util/SparseArray;
    ...
    iput-object p3, p4, Lhff;->b:Landroid/util/SparseArray;
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Lhff;)V
    ...
    iget-object v0, p0, Lfkd;->b:Landroid/graphics/RectF;
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->U(Landroid/view/View;)Llff;

    move-result-object v6

    instance-of v6, v6, Lrh3;

    if-eqz v6, :cond_5

    iget-object v6, p3, Lhff;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Lfkd;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Lfkd;->a:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Lrtc;)V
    ...
    iget-object v0, p0, Lfkd;->a:Landroid/graphics/Paint;
