...
.method public d(Lvg7;Ljava/lang/Object;)V
    .locals 11
    ...
    :goto_0
    iget-object v1, p2, Lhok;->b:Ljnk;

    invoke-static {v1}, Lspg;->Q(Ljnk;)I
    ...
    :cond_1
    invoke-interface {p1, v2, v1}, Ld1i;->h(ILjava/lang/String;)V

    :goto_1
    iget-object v1, p2, Lhok;->d:Ljava/lang/String;
    ...
    :goto_2
    iget-object v1, p2, Lhok;->e:Ly25;

    invoke-static {v1}, Ly25;->f(Ly25;)[B
    ...
    :cond_3
    invoke-interface {p1, v2, v1}, Ld1i;->c(I[B)V

    :goto_3
    iget-object v1, p2, Lhok;->f:Ly25;
    ...
    iget-wide v2, p2, Lhok;->g:J

    invoke-interface {p1, v1, v2, v3}, Ld1i;->b(IJ)V

    const/16 v1, 0x8

    iget-wide v2, p2, Lhok;->h:J

    invoke-interface {p1, v1, v2, v3}, Ld1i;->b(IJ)V

    const/16 v1, 0x9

    iget-wide v2, p2, Lhok;->i:J
    ...
    invoke-interface {p1, v3, v1, v2}, Ld1i;->b(IJ)V

    iget-object v1, p2, Lhok;->l:Lvn0;

    invoke-static {v1}, Lspg;->b(Lvn0;)I
    ...
    iget-wide v2, p2, Lhok;->m:J

    invoke-interface {p1, v1, v2, v3}, Ld1i;->b(IJ)V

    const/16 v1, 0xd

    iget-wide v2, p2, Lhok;->n:J

    invoke-interface {p1, v1, v2, v3}, Ld1i;->b(IJ)V

    const/16 v1, 0xe

    iget-wide v2, p2, Lhok;->o:J

    invoke-interface {p1, v1, v2, v3}, Ld1i;->b(IJ)V

    const/16 v1, 0xf

    iget-wide v2, p2, Lhok;->p:J

    invoke-interface {p1, v1, v2, v3}, Ld1i;->b(IJ)V

    iget-boolean v1, p2, Lhok;->q:Z
    ...
    iget-object v1, p2, Lhok;->r:Lb0d;

    invoke-static {v1}, Lspg;->E(Lb0d;)I
    ...
    invoke-static {v9}, Lspg;->D(I)I

    move-result v9

    int-to-long v9, v9

    invoke-interface {p1, v8, v9, v10}, Ld1i;->b(IJ)V

    iget-boolean v8, p2, Lzf4;->b:Z

    int-to-long v8, v8

    invoke-interface {p1, v7, v8, v9}, Ld1i;->b(IJ)V

    iget-boolean v7, p2, Lzf4;->c:Z

    int-to-long v7, v7

    invoke-interface {p1, v6, v7, v8}, Ld1i;->b(IJ)V

    iget-boolean v6, p2, Lzf4;->d:Z

    int-to-long v6, v6

    invoke-interface {p1, v5, v6, v7}, Ld1i;->b(IJ)V

    iget-boolean v5, p2, Lzf4;->e:Z

    int-to-long v5, v5

    invoke-interface {p1, v4, v5, v6}, Ld1i;->b(IJ)V

    iget-wide v4, p2, Lzf4;->f:J

    invoke-interface {p1, v3, v4, v5}, Ld1i;->b(IJ)V

    iget-wide v3, p2, Lzf4;->g:J
    ...
    invoke-interface {p1, v1, p2}, Ld1i;->c(I[B)V

    goto :goto_5

    :cond_5
    invoke-interface {p1, v8}, Ld1i;->e(I)V
    ...
    invoke-interface {p1, p2}, Ld1i;->e(I)V

    return-void

    :cond_6
    invoke-interface {p1, p2, v0}, Ld1i;->h(ILjava/lang/String;)V
