...
# static fields
.field public static final d:Lo74;

.field public static final e:Lmwf;

.field public static final f:I

.field public static final g:Lp74;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lmwf;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lbtb;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lq74;->g:Lp74;

    invoke-virtual {v0}, Lbtb;->dispose()V
    ...
    invoke-direct {v3, v4, v0, v1}, Lmwf;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Lq74;->e:Lmwf;

    new-instance v0, Lo74;

    invoke-direct {v0, v2, v3}, Lo74;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lq74;->d:Lo74;

    iget-object v0, v0, Lo74;->b:[Lp74;
    ...
    invoke-virtual {v3}, Lbtb;->dispose()V
...
.method public constructor <init>()V
    ...
    sget-object v1, Lq74;->d:Lo74;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lq74;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v2, Lo74;

    sget v3, Lq74;->f:I

    sget-object v4, Lq74;->e:Lmwf;

    invoke-direct {v2, v3, v4}, Lo74;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()La2g;
    ...
    iget-object v1, p0, Lq74;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v1}, Lo74;->a()Lp74;

    move-result-object v1

    invoke-direct {v0, v1}, Ln74;-><init>(Lp74;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljo5;
    ...
    iget-object v0, p0, Lq74;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v0}, Lo74;->a()Lp74;

    move-result-object v0

    iget-object v0, v0, Lbtb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljo5;
    ...
    iget-object v1, v0, Lbtb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    new-instance p4, Lpm8;

    invoke-direct {p4, p1, v1}, Lpm8;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lpm8;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v2, p1, v0}, Lw0;-><init>(Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {v2, p1}, Lw0;->a(Ljava/util/concurrent/Future;)V
    :try_end_1
