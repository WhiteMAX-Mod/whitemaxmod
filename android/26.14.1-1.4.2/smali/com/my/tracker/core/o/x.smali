...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-virtual {v1, p1}, Lfh5;->h(Ljava/lang/String;)V

    .line 32
    const-string p1, "GET"

    invoke-virtual {v1, p1, v3}, Lfh5;->e(Ljava/lang/String;Lhb0;)V
    ...
    .line 34
    invoke-interface {p2}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lc7c;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Lrmf;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    .line 100
    sget-object v4, Lhha;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 101
    :try_start_6
    invoke-static {p2}, Lag8;->z(Ljava/lang/String;)Lhha;
    ...
    .line 103
    iget-object v6, v4, Lfh5;->c:Ljava/lang/Object;

    check-cast v6, Lw26;

    invoke-virtual {v6, p1, v5}, Lw26;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 105
    invoke-static {v5, p2, p1}, Lzhb;->a(ILhha;[B)Ldlf;
    ...
    invoke-virtual {v4, p2, p1}, Lfh5;->e(Ljava/lang/String;Lhb0;)V
    ...
    .line 110
    invoke-interface {p4}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lc7c;
    ...
    .line 128
    invoke-virtual {v3}, Lrmf;->close()V
