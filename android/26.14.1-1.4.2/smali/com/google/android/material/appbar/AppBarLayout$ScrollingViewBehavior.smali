...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lzuj;-><init>(I)V
    ...
    .line 9
    sget-object v1, Li2f;->ScrollingViewBehavior_Layout:[I
    ...
    .line 11
    sget p2, Li2f;->ScrollingViewBehavior_Layout_behavior_overlapTop:I
...
.method public static w(Ljava/util/List;)Llq;
    .locals 4
...
.method public d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->x(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;)I
    ...
    invoke-virtual {p0, p3}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->x(Landroid/view/View;)I
    ...
    :cond_0
    instance-of p1, p3, Llq;

    if-eqz p1, :cond_1

    check-cast p3, Llq;

    iget-boolean p1, p3, Llq;->l:Z

    if-eqz p1, :cond_1

    invoke-virtual {p3, p2}, Llq;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p3, p1}, Llq;->f(Z)Z
...
.method public final i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->w(Ljava/util/List;)Llq;
    ...
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Lomk;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {v3}, Lomk;->d()I
    ...
    :cond_2
    :goto_0
    invoke-virtual {v2}, Llq;->getTotalScrollRange()I
...
.method public final m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->w(Ljava/util/List;)Llq;
    ...
    invoke-virtual {v0, v1, p2, p1}, Llq;->e(ZZZ)V
...
.method public final u(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->x(Landroid/view/View;)I
...
.method public final x(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, p1}, Le65;->f(III)I
