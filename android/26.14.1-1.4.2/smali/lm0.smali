...
.method public constructor <init>(Lt29;Lt29;)V
    ...
    iput-object p1, p0, Llm0;->a:Lt29;

    iput-object p2, p0, Llm0;->b:Lt29;

    return-void
.end method

.method public static final a(Llm0;[BLpcj;)Ld4i;
    .locals 2

    new-instance p0, Ld4i;
    ...
    invoke-virtual {p2}, Lpcj;->c()I

    move-result v0

    invoke-virtual {p2}, Lpcj;->a()I

    move-result v1

    invoke-direct {p0, p1, v0, v1}, Ld4i;-><init>(Ljava/lang/String;II)V

    invoke-virtual {p2}, Lpcj;->b()I

    move-result p1

    invoke-virtual {p0, p1}, Ld4i;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    invoke-virtual {p2}, Lpcj;->d()Z
    ...
    invoke-virtual {p0, p1}, Ld4i;->c(Landroid/graphics/Xfermode;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lr8c;->f(II)V
    ...
    invoke-direct/range {v11 .. v18}, Locj;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Lqm0;)Ljava/util/LinkedHashMap;
    .locals 28
    ...
    sget-object v9, Lpq2;->a:Ljava/nio/charset/Charset;
    ...
    new-instance v14, Lqm0;

    invoke-virtual {v10, v2}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    iget-object v8, v11, Ljm0;->a:Ljava/lang/String;
    ...
    invoke-direct {v14, v2}, Lqm0;-><init>(Ljava/lang/String;)V

    sget-object v2, Lbu3;->j:Lhub;

    move-object/from16 v8, p1

    invoke-virtual {v2, v8}, Lhub;->c(Landroid/content/Context;)Lbu3;
    ...
    iget-boolean v2, v11, Ljm0;->b:Z

    invoke-static {v15, v2}, Lnqf;->A(Lutc;Z)Lrtc;

    move-result-object v2

    invoke-interface {v2}, Lrtc;->A()Litc;

    move-result-object v2

    iget-object v2, v2, Litc;->a:Lspi;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v11, v2, Lspi;->f:Ljava/lang/Object;

    check-cast v11, [I

    iget v13, v2, Lspi;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v14}, Lqm0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v13}, Lwgl;->f(I)I

    move-result v26

    invoke-direct/range {v20 .. v26}, Lpcj;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v13, v11, v8}, Lncj;-><init>([IF)V
    ...
    iget-object v8, v2, Lspi;->e:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v4, v8}, Llm0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v4}, Llm0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lncj;-><init>([IF)V
    ...
    invoke-static {v0, v11}, Lqw;->h0(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Lqcj;

    invoke-direct/range {v20 .. v26}, Lqcj;-><init>(Lpcj;Lncj;Lncj;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lpcj;Ll3i;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Llm0;->a:Lt29;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lkm0;-><init>(Llm0;Landroid/content/Context;Lpcj;Lkotlin/coroutines/Continuation;)V
