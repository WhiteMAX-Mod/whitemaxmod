...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lzi5;

    return-void
.end method

.method public static b(Landroid/app/job/JobParameters;)Link;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Link;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final a(Link;Z)V
    ...
    iget-object v3, p1, Link;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lzi5;

    invoke-virtual {v0, p1}, Lzi5;->v(Link;)Ldkh;
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lpnk;
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lpnk;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lpnk;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->b(Landroid/app/job/JobParameters;)Link;
    ...
    invoke-virtual {p1, v0, v1}, Lbh9;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, Lbh9;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v4}, Lst6;-><init>(I)V

    invoke-static {p1}, Li6i;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1}, Li6i;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    invoke-static {p1}, Lj6i;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    :cond_5
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lpnk;

    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lzi5;

    invoke-virtual {v0, v2}, Lzi5;->D(Link;)Ldkh;

    move-result-object v0

    invoke-virtual {p1, v0, v1}, Lpnk;->h(Ldkh;Lst6;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p1, v0, v2}, Lbh9;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1, v2}, Lbh9;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lzi5;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lpnk;

    iget-object v4, v3, Lpnk;->d:Lmr6;

    new-instance v5, Lbth;

    invoke-direct {v5, v3, v2, v0}, Lbth;-><init>(Lpnk;Ldkh;Z)V

    invoke-virtual {v4, v5}, Lmr6;->a(Ljava/lang/Runnable;)V
    ...
    iget-object p1, p1, Link;->a:Ljava/lang/String;

    iget-object v3, v0, Lt2e;->l:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v0, v0, Lt2e;->j:Ljava/util/HashSet;
