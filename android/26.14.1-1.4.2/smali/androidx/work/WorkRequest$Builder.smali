...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "setBackoffCriteria",
        "(Lvn0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;",
        "Ljava/time/Duration;",
        "duration",
        "(Lvn0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;",
        "Lzf4;",
        "constraints",
        "setConstraints",
        "(Lzf4;)Landroidx/work/WorkRequest$Builder;",
        "Ly25;",
        "inputData",
        "setInputData",
        "(Ly25;)Landroidx/work/WorkRequest$Builder;",
        "",
        "tag",
        "addTag",
        ...
        "policy",
        "setExpedited",
        "(Lb0d;)Landroidx/work/WorkRequest$Builder;",
        "build",
        "()Landroidx/work/WorkRequest;",
        ...
        "state",
        "setInitialState",
        "(Ljnk;)Landroidx/work/WorkRequest$Builder;",
        "",
        "runAttemptCount",
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    invoke-direct/range {v3 .. v31}, Lhok;-><init>(Ljava/lang/String;Ljnk;Ljava/lang/String;Ljava/lang/String;Ly25;Ly25;JJJLzf4;ILvn0;JJJJZLb0d;III)V

    iput-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;
    ...
    invoke-static {v1, v2}, Lqw;->p0([Ljava/lang/Object;Ljava/util/HashSet;)V
...
.method public final build()Landroidx/work/WorkRequest;
    ...
    iget-object v1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;

    iget-object v1, v1, Lhok;->j:Lzf4;

    iget-object v2, v1, Lzf4;->h:Ljava/util/Set;
    ...
    iget-boolean v2, v1, Lzf4;->d:Z

    if-nez v2, :cond_1

    iget-boolean v2, v1, Lzf4;->b:Z

    if-nez v2, :cond_1

    iget-boolean v1, v1, Lzf4;->c:Z
    ...
    :goto_1
    iget-object v2, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;

    iget-boolean v3, v2, Lhok;->q:Z

    if-eqz v3, :cond_4

    if-nez v1, :cond_3

    iget-wide v1, v2, Lhok;->g:J
...
.method public final getWorkSpec$work_runtime_release()Lhok;
    .locals 1

    iget-object v0, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;
...
.method public final keepResultsForAtLeast(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-static {p1}, Lex5;->a(Ljava/time/Duration;)J

    move-result-wide v1

    iput-wide v1, v0, Lhok;->o:J
...
.method public final setBackoffCriteria(Lvn0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lhok;->e(J)V
...
.method public final setBackoffCriteria(Lvn0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p2}, Lex5;->a(Ljava/time/Duration;)J
...
.method public final setConstraints(Lzf4;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setExpedited(Lb0d;)Landroidx/work/WorkRequest$Builder;
    .locals 2
    ...
    iput-boolean v1, v0, Lhok;->q:Z

    iput-object p1, v0, Lhok;->r:Lb0d;
...
.method public final setId(Ljava/util/UUID;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object v3, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;

    iget-object v4, v3, Lhok;->c:Ljava/lang/String;

    iget-object v5, v3, Lhok;->b:Ljnk;

    move-object v6, v5

    iget-object v5, v3, Lhok;->d:Ljava/lang/String;

    move-object v7, v6

    new-instance v6, Ly25;

    iget-object v8, v3, Lhok;->e:Ly25;

    invoke-direct {v6, v8}, Ly25;-><init>(Ly25;)V

    move-object v8, v7

    new-instance v7, Ly25;

    iget-object v9, v3, Lhok;->f:Ly25;

    invoke-direct {v7, v9}, Ly25;-><init>(Ly25;)V

    move-object v10, v8

    iget-wide v8, v3, Lhok;->g:J

    move-object v12, v10

    iget-wide v10, v3, Lhok;->h:J

    move-object v14, v12

    iget-wide v12, v3, Lhok;->i:J

    new-instance v15, Lzf4;

    move-object/from16 v26, v1

    iget-object v1, v3, Lhok;->j:Lzf4;
    ...
    iget-wide v4, v1, Lzf4;->f:J

    move-object/from16 v25, v2

    iget-wide v1, v1, Lzf4;->g:J

    move-wide/from16 v23, v1

    move-wide/from16 v21, v4

    invoke-direct/range {v15 .. v25}, Lzf4;-><init>(IZZZZJJLjava/util/Set;)V

    iget v1, v3, Lhok;->k:I

    iget-object v2, v3, Lhok;->l:Lvn0;

    iget-wide v4, v3, Lhok;->m:J

    move/from16 v16, v1

    move-object/from16 v17, v2

    iget-wide v1, v3, Lhok;->n:J

    move-wide/from16 v19, v1

    iget-wide v1, v3, Lhok;->o:J

    move-wide/from16 v21, v1

    iget-wide v1, v3, Lhok;->p:J

    move-wide/from16 v23, v1

    iget-boolean v1, v3, Lhok;->q:Z

    iget-object v2, v3, Lhok;->r:Lb0d;
    ...
    invoke-direct/range {v1 .. v29}, Lhok;-><init>(Ljava/lang/String;Ljnk;Ljava/lang/String;Ljava/lang/String;Ly25;Ly25;JJJLzf4;ILvn0;JJJJZLb0d;III)V

    iput-object v1, v0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;
...
.method public setInitialDelay(JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p3, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;

    iget-wide v0, p3, Lhok;->g:J
...
.method public setInitialDelay(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;

    iget-wide v2, p1, Lhok;->g:J
...
.method public final setInitialState(Ljnk;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setInputData(Ly25;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setWorkSpec$work_runtime_release(Lhok;)V
    .locals 0

    iput-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lhok;
