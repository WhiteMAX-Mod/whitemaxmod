...
.field public static final d:Las7;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Las7;->c:Ljava/lang/Object;

    new-instance v0, Las7;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Las7;->d:Las7;
...
.method public final d(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p2, p1, v0}, Lbs7;->b(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {v0, p1}, Lnvk;->a(Landroid/content/Intent;Lcom/google/android/gms/common/api/GoogleApiActivity;)Lnvk;
    ...
    :cond_2
    invoke-static {p1, p2}, Ldvk;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Ldvk;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Ldvk;->f(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v1, p3}, Lv76;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lv76;
...
.method public final e(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, Lpvk;-><init>(Las7;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Ldvk;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Ldvk;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v5, p1, v6}, Lcyb;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-boolean v1, v5, Lcyb;->u:Z

    const/16 v6, 0x10

    invoke-virtual {v5, v6, v1}, Lcyb;->f(IZ)V

    invoke-static {v0}, Lcyb;->c(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v5, Lcyb;->e:Ljava/lang/CharSequence;

    new-instance v0, Layb;

    invoke-direct {v0}, Layb;-><init>()V

    invoke-virtual {v0, v2}, Layb;->d(Ljava/lang/String;)V

    invoke-virtual {v5, v0}, Lcyb;->i(Lryb;)V

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    sget-object v6, Lag8;->f:Ljava/lang/Boolean;
    ...
    iget-object v2, v5, Lcyb;->F:Landroid/app/Notification;

    iput v0, v2, Landroid/app/Notification;->icon:I

    iput v6, v5, Lcyb;->k:I

    invoke-static {p1}, Lag8;->Q(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_4

    sget v0, Lbte;->common_full_open_on_phone:I

    sget v2, Lr1f;->common_open_on_phone:I

    invoke-virtual {v3, v2}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v3, v5, Lcyb;->b:Ljava/util/ArrayList;

    new-instance v7, Luxb;

    invoke-direct {v7, v0, v2, p3}, Luxb;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    :cond_4
    iput-object p3, v5, Lcyb;->g:Landroid/app/PendingIntent;
    ...
    iget-object v7, v5, Lcyb;->F:Landroid/app/Notification;

    iput v0, v7, Landroid/app/Notification;->icon:I

    sget v0, Lr1f;->common_google_play_services_notification_ticker:I

    invoke-virtual {v3, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    iget-object v3, v5, Lcyb;->F:Landroid/app/Notification;
    ...
    iget-object v0, v5, Lcyb;->F:Landroid/app/Notification;

    iput-wide v7, v0, Landroid/app/Notification;->when:J

    iput-object p3, v5, Lcyb;->g:Landroid/app/PendingIntent;

    invoke-virtual {v5, v2}, Lcyb;->d(Ljava/lang/CharSequence;)V

    :goto_0
    sget-object p3, Las7;->c:Ljava/lang/Object;
    ...
    sget v2, Lr1f;->common_google_play_services_notification_channel_name:I
    ...
    :cond_7
    :goto_1
    iput-object p3, v5, Lcyb;->z:Ljava/lang/String;

    invoke-virtual {v5}, Lcyb;->a()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p2, Los7;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
