...
.method public static a([Lru/ok/tamtam/nano/Protos$MessageElement;)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v3}, Le65;->o(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :pswitch_1
    sget-object v3, Lfqa;->k:Lfqa;

    goto :goto_1

    :pswitch_2
    sget-object v3, Lfqa;->h:Lfqa;

    goto :goto_1

    :pswitch_3
    sget-object v3, Lfqa;->j:Lfqa;

    goto :goto_1

    :pswitch_4
    sget-object v3, Lfqa;->i:Lfqa;
    ...
    :pswitch_6
    sget-object v3, Lfqa;->f:Lfqa;

    goto :goto_1

    :pswitch_7
    sget-object v3, Lfqa;->e:Lfqa;

    goto :goto_1

    :pswitch_8
    sget-object v3, Lfqa;->c:Lfqa;

    goto :goto_1

    :pswitch_9
    sget-object v3, Lfqa;->d:Lfqa;

    goto :goto_1

    :pswitch_a
    sget-object v3, Lfqa;->b:Lfqa;

    goto :goto_1

    :pswitch_b
    sget-object v3, Lfqa;->a:Lfqa;
...
.method public static b(Ljava/util/List;)[B
    ...
    invoke-static {p0}, Lhqa;->c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;

    move-result-object p0

    invoke-static {p0}, Lusa;->toByteArray(Lusa;)[B
...
.method public static c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;
    ...
    iget-wide v5, v3, Lgqa;->a:J

    iget-object v7, v3, Lgqa;->f:Ljava/util/Map;

    iput-wide v5, v4, Lru/ok/tamtam/nano/Protos$MessageElement;->entityId:J

    iget-object v5, v3, Lgqa;->b:Ljava/lang/String;
