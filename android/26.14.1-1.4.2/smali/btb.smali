...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Li2g;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Lbtb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Ljo5;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lbtb;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljo5;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Lbtb;->b:Z

    iget-object v0, p0, Lbtb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lko5;)La1g;
    .locals 3

    new-instance v0, La1g;

    invoke-direct {v0, p1, p5}, La1g;-><init>(Ljava/lang/Runnable;Lko5;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lko5;->a(Ljo5;)Z
    ...
    iget-object v1, p0, Lbtb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :goto_0
    invoke-virtual {v0, p1}, La1g;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lko5;->b(Ljo5;)Z
