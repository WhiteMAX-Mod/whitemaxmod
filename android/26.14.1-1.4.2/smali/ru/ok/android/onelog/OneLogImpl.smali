...
.field private volatile forceFallbackLogs:Lm0i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lm0i;"
        }
...
.method public getApiClient()Llo;
    .locals 2
...
.method public setForceFallbackLogs(Lm0i;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public startUpload(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, p1}, Lq98;-><init>(ILjava/lang/Object;)V
...
.method public upload(Ljava/util/Collection;)V
    ...
    .line 2
    invoke-virtual {p0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Llo;

    move-result-object v0

    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Llo;Ljava/util/Collection;)V
...
.method public upload(Lru/ok/android/onelog/OneLogItem;)V
    ...
    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Llo;Lru/ok/android/onelog/OneLogItem;)V
