...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldbh;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lmwf;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Ldbh;->d:Lmwf;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldbh;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Li2g;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Ldbh;->d:Lmwf;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Li2g;->a:Z
...
.method public final a()La2g;
    ...
    iget-object v1, p0, Ldbh;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lcbh;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljo5;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lw0;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljo5;
    ...
    iget-object v6, p0, Ldbh;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lpm8;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lpm8;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p1, v5}, Lw0;-><init>(Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {v1, v0}, Lw0;->a(Ljava/util/concurrent/Future;)V
    :try_end_1
