...
# instance fields
.field public final synthetic a:Lhbd;
...
.method public final onConnected()V
    ...
    iget-object v5, v1, Lcy9;->d:Lay9;

    iget-object v6, v1, Lcy9;->b:Landroid/media/browse/MediaBrowser;
    ...
    new-instance v9, Lsp7;

    iget-object v10, v1, Lcy9;->c:Landroid/os/Bundle;

    invoke-direct {v9, v8, v10}, Lsp7;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v9, v1, Lcy9;->f:Lsp7;

    new-instance v8, Landroid/os/Messenger;

    invoke-direct {v8, v5}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v8, v1, Lcy9;->g:Landroid/os/Messenger;
    ...
    iput-object v10, v5, Lay9;->b:Ljava/lang/ref/WeakReference;

    :try_start_1
    iget-object v5, v1, Lcy9;->a:Landroid/content/Context;
    ...
    iget-object v11, v9, Lsp7;->c:Ljava/lang/Object;
    ...
    iget-object v8, v9, Lsp7;->b:Ljava/lang/Object;
    ...
    invoke-direct {v5, v4}, Lj78;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v6, v4, v5}, Lgda;-><init>(Landroid/media/session/MediaSession$Token;Ll78;)V

    iput-object v6, v1, Lcy9;->h:Lgda;
    ...
    iget-object v1, v0, Ll1a;->j:Ley9;

    if-eqz v1, :cond_6

    iget-object v1, v1, Ley9;->a:Lcy9;

    iget-object v4, v1, Lcy9;->h:Lgda;

    if-nez v4, :cond_5

    iget-object v4, v1, Lcy9;->b:Landroid/media/browse/MediaBrowser;
    ...
    invoke-direct {v5, v4, v3}, Lgda;-><init>(Landroid/media/session/MediaSession$Token;Ll78;)V

    iput-object v5, v1, Lcy9;->h:Lgda;

    :cond_5
    iget-object v1, v1, Lcy9;->h:Lgda;

    iget-object v3, v0, Ll1a;->b:Lj0a;

    new-instance v4, Lex7;

    const/16 v5, 0x12

    invoke-direct {v4, v0, v5, v1}, Lex7;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3, v4}, Lj0a;->C(Ljava/lang/Runnable;)V

    iget-object v1, v3, Lj0a;->e:Landroid/os/Handler;

    new-instance v3, Li1a;

    invoke-direct {v3, v0, v2}, Li1a;-><init>(Ll1a;I)V
...
.method public final onConnectionSuspended()V
    ...
    iput-object v2, v1, Lcy9;->f:Lsp7;

    iput-object v2, v1, Lcy9;->g:Landroid/os/Messenger;

    iput-object v2, v1, Lcy9;->h:Lgda;

    iget-object v1, v1, Lcy9;->d:Lay9;
    ...
    iput-object v3, v1, Lay9;->b:Ljava/lang/ref/WeakReference;
