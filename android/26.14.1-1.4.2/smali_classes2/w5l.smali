...
# instance fields
.field public final P0:Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lia0;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;Lzuk;Lzuk;)V
    .locals 15
    ...
    invoke-direct/range {v1 .. v8}, Lcom/google/android/gms/common/internal/a;-><init>(Landroid/content/Context;Landroid/os/Looper;ILia0;Lcs7;Lds7;I)V

    iget-object v1, v5, Lia0;->c:Ljava/lang/Object;
    ...
    iput-object v3, v2, Lps7;->a:Ljava/util/HashSet;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, v2, Lps7;->h:Ljava/util/HashMap;
    ...
    iput-object v0, v2, Lps7;->i:Ljava/lang/String;
    ...
    iput-object v0, v2, Lps7;->a:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, v2, Lps7;->h:Ljava/util/HashMap;
    ...
    sget-object v3, Lfzk;->a:Ljava/util/Random;
    ...
    iget-object v4, v2, Lps7;->a:Ljava/util/HashSet;
    ...
    :cond_1
    iget-object v0, v2, Lps7;->a:Ljava/util/HashSet;
    ...
    :cond_2
    iget-boolean v1, v2, Lps7;->d:Z

    if-eqz v1, :cond_4

    iget-object v1, v2, Lps7;->f:Landroid/accounts/Account;
    ...
    :cond_3
    iget-object v1, v2, Lps7;->a:Ljava/util/HashSet;
    ...
    iget-object v7, v2, Lps7;->f:Landroid/accounts/Account;

    iget-boolean v8, v2, Lps7;->d:Z

    iget-boolean v9, v2, Lps7;->b:Z

    iget-boolean v10, v2, Lps7;->c:Z

    iget-object v11, v2, Lps7;->e:Ljava/lang/String;

    iget-object v12, v2, Lps7;->g:Ljava/lang/String;

    iget-object v13, v2, Lps7;->h:Ljava/util/HashMap;

    iget-object v14, v2, Lps7;->i:Ljava/lang/String;
    ...
    iput-object v4, p0, Lw5l;->P0:Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
...
.method public final l(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-direct {v1, p1, v0, v2}, Lsuk;-><init>(Landroid/os/IBinder;Ljava/lang/String;I)V
