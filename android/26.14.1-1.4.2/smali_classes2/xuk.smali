...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lxuk;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lxuk;->U(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Lr9l;->f:Lsbl;

    iget-object p1, p1, Lsbl;->a:Latl;

    if-eqz p1, :cond_9

    iget-object p2, p3, Lr9l;->e:Lobi;

    iget-object p4, p1, Latl;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Latl;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Laml;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Latl;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Lr9l;->d:Low8;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Low8;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lqwk;

    invoke-direct {p4, p1, p2}, Lqwk;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lr9l;->e:Lobi;

    invoke-virtual {p1, p4}, Lobi;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lspl;->f:Lsql;

    iget-object p1, p1, Lsql;->a:Lrwl;

    iget-object p2, p3, Lspl;->e:Lobi;

    invoke-virtual {p1, p2}, Lrwl;->d(Lobi;)V

    iget-object p1, p3, Lspl;->d:Ldb0;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Ldb0;->C(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Ldb0;->C(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lobi;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lspl;->g:Lsql;
    ...
    iget-object p1, p1, Lsql;->d:Lysl;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lysl;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lysl;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lcu;-><init>(I)V

    invoke-virtual {p2, p1}, Lobi;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Lxuk;->T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
