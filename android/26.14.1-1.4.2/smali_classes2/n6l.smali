...
.method public static d(Landroid/media/MediaRoute2Info;)Leba;
    .locals 10
    ...
    invoke-static {p0}, Lvg;->m(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Liaa;->n(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Lede;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Lede;->a:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Liaa;->b(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Liaa;->x(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Liaa;->C(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Liaa;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lvg;->i(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Liaa;->y(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Liaa;->l(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Lede;->v(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Lede;->x()Leba;
