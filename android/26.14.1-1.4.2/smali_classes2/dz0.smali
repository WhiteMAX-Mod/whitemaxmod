...
.field public final f:Lulb;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILulb;)V
    .locals 0

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    iput-object p1, p0, Ldz0;->a:Landroid/content/Context;

    iput-object p2, p0, Ldz0;->b:Landroid/net/Uri;

    iput-object p3, p0, Ldz0;->c:Landroid/net/Uri;

    iput p4, p0, Ldz0;->d:I

    iput p5, p0, Ldz0;->e:I

    iput-object p6, p0, Ldz0;->f:Lulb;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Ldz0;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v2, p0, Ldz0;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, Llcl;->b(Ljava/io/Closeable;)V

    invoke-static {p1}, Llcl;->b(Ljava/io/Closeable;)V

    iput-object v0, p0, Ldz0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Llcl;->b(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-direct {v2}, Lb7c;-><init>()V

    invoke-direct {v1, v2}, Lc7c;-><init>(Lb7c;)V

    iget-object v2, v1, Lc7c;->a:Lf6i;
    ...
    invoke-virtual {v4, p1}, Lfh5;->h(Ljava/lang/String;)V

    invoke-virtual {v4}, Lfh5;->a()Lia0;

    move-result-object p1

    invoke-virtual {v1, p1}, Lc7c;->b(Lia0;)Li8f;
    ...
    :try_start_2
    iget-object v5, p0, Ldz0;->a:Landroid/content/Context;
    ...
    sget-object v5, Li7c;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v5, p2, v7, v6}, Lv30;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-interface {v4, v5}, Lu51;->X(Lv30;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Llcl;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Llcl;->b(Ljava/io/Closeable;)V

    invoke-static {v1}, Llcl;->b(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Lf6i;->c()V
    ...
    :goto_2
    invoke-static {v3}, Llcl;->b(Ljava/io/Closeable;)V
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v1, p0, Ldz0;->a:Landroid/content/Context;

    invoke-static {v1, v0}, Ler4;->i(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Ldz0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Lhsl;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Lhsl;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Lcz0;
    ...
    iget-object v3, v1, Ldz0;->a:Landroid/content/Context;

    iget-object v0, v1, Ldz0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Lcz0;-><init>(Ljava/lang/Exception;)V

    return-object v0

    :cond_0
    :try_start_0
    invoke-virtual {v1}, Ldz0;->e()V
    :try_end_0
    ...
    iget-object v4, v1, Ldz0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Ldz0;->d:I

    iget v13, v1, Ldz0;->e:I
    ...
    invoke-direct {v3, v0}, Lbb8;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lbb8;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Llcl;->b(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Lub6;->b:I

    iput v10, v4, Lub6;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Lcz0;-><init>(Landroid/graphics/Bitmap;Lub6;)V
    ...
    invoke-direct {v0, v13, v4}, Lcz0;-><init>(Landroid/graphics/Bitmap;Lub6;)V
    ...
    invoke-direct {v2, v0}, Lcz0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Ldz0;->c:Landroid/net/Uri;
    ...
    iget-object v0, p0, Ldz0;->a:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v1, p0, Ldz0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Ldz0;->c()Ljava/lang/String;
    ...
    iput-object v1, p0, Ldz0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Ldz0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Ldz0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v0, v3}, Ldz0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lcz0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Ldz0;->f:Lulb;

    if-nez v0, :cond_1

    iget-object p1, p1, Lcz0;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v1, v1, Lulb;->a:Ljava/lang/Object;

    check-cast v1, Ltri;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, v1, Ltri;->m:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Ltri;->j:Z

    invoke-virtual {v1, p1}, Ltri;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Lulb;->a:Ljava/lang/Object;
