...
.field public final synthetic b:Lrpi;


# direct methods
.method public constructor <init>(Lrpi;Lyx;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lwc6;->b:Lrpi;

    iput-object p2, p0, Lwc6;->a:Lyx;
...
.method public final L0(Landroidx/media3/common/PlaybackException;)V
    ...
    :cond_0
    sget-object v0, Landroidx/media3/transformer/ExportException;->b:Ljhf;
    ...
    invoke-virtual {v0, v1}, Ljhf;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v1, p1}, Lyx;->d(Landroidx/media3/transformer/ExportException;)V
...
.method public final e0(Lxpi;)V
    ...
    iget-object v0, p0, Lwc6;->a:Lyx;

    const/4 v1, 0x1

    :try_start_0
    invoke-virtual {p1, v1}, Lxpi;->a(I)Z

    move-result v2

    const/4 v3, 0x2

    invoke-virtual {p1, v3}, Lxpi;->a(I)Z
    ...
    invoke-static {v4, v6, v5}, Lgh2;->t(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :cond_3
    iget-object p1, p0, Lwc6;->b:Lrpi;

    if-lez v2, :cond_4

    :try_start_1
    invoke-interface {v0, v2}, Lyx;->b(I)V

    iget-object p1, p1, Lrpi;->e:Ljava/lang/Object;

    check-cast p1, Lud6;

    invoke-virtual {p1}, Lgs0;->play()V
    ...
    iget-object v3, p1, Lrpi;->b:Ljava/lang/Object;
    ...
    invoke-static {v3, p1}, Lasl;->a(Landroid/content/Context;Ly5a;)Ljava/lang/String;
...
.method public final m0(Liji;I)V
    ...
    iget-object p2, p0, Lwc6;->a:Lyx;

    iget-object v0, p0, Lwc6;->b:Lrpi;
    ...
    invoke-virtual {p1, v2, v1}, Liji;->n(ILgji;)V

    iget-boolean p1, v1, Lgji;->k:Z

    if-nez p1, :cond_3

    iget-wide v1, v1, Lgji;->m:J
    ...
    invoke-interface {p2, v1, v2}, Lyx;->e(J)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
