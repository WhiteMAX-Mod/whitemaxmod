...
.method public S(Lung;)V
    ...
    invoke-interface {p1}, Ltng;->e()Landroid/hardware/camera2/CameraCaptureSession$StateCallback;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Ltng;->f()Ljava/util/List;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-interface {p1}, Ltng;->c()Ljava/util/concurrent/Executor;
    ...
    iget-object v3, v3, Ll0d;->a:Ln0d;

    invoke-virtual {v3}, Ln0d;->b()Ljava/lang/String;
    ...
    invoke-static {v6, v2, v4, v3, v5}, Lpc2;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "CameraDeviceCompat"

    invoke-static {v4, v3}, Lauj;->s(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v3}, Lqe2;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V

    invoke-interface {p1}, Ltng;->f()Ljava/util/List;

    move-result-object v2

    iget-object v3, p0, Llr;->b:Ljava/lang/Object;

    check-cast v3, Lsf2;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v3, v3, Lsf2;->a:Landroid/os/Handler;

    invoke-interface {p1}, Ltng;->b()Ldk8;
    ...
    :try_start_0
    iget-object p1, v4, Ldk8;->a:Lbk8;

    iget-object p1, p1, Lbk8;->a:Landroid/hardware/camera2/params/InputConfiguration;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, Lung;->a(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Ll0d;->a:Ln0d;

    invoke-virtual {v4}, Ln0d;->c()Landroid/view/Surface;
