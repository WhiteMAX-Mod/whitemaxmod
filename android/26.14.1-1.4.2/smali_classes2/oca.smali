...
.method public final onRouteAdded(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p1, p0, Loca;->a:Lp6i;

    invoke-virtual {p1, p2}, Lp6i;->j(Ljava/lang/Object;)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1}, Lp6i;->t()V
...
.method public final onRouteChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    invoke-static {p2}, Lp6i;->o(Ljava/lang/Object;)Lo6i;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-virtual {p1, p2}, Lp6i;->k(Ljava/lang/Object;)I

    move-result p2

    if-ltz p2, :cond_1

    iget-object v0, p1, Lp6i;->q:Ljava/util/ArrayList;
    ...
    iget-object v1, p2, Ln6i;->b:Ljava/lang/String;

    iget-object v2, p2, Ln6i;->a:Ljava/lang/Object;

    iget-object v3, p1, Lbzd;->c:Ljava/lang/Object;
    ...
    :goto_0
    invoke-direct {v0, v1, v2}, Lede;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1, p2, v0}, Lp6i;->p(Ln6i;Lede;)V

    invoke-virtual {v0}, Lede;->x()Leba;

    move-result-object v0

    iput-object v0, p2, Ln6i;->c:Leba;
...
.method public final onRoutePresentationDisplayChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v1, p1, Lp6i;->q:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v3, v0, Ln6i;->c:Leba;

    iget-object v3, v3, Leba;->a:Landroid/os/Bundle;
    ...
    iget-object v2, v0, Ln6i;->c:Leba;

    if-eqz v2, :cond_5

    new-instance v3, Landroid/os/Bundle;

    iget-object v5, v2, Leba;->a:Landroid/os/Bundle;

    invoke-direct {v3, v5}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v2}, Leba;->b()Ljava/util/List;
    ...
    :goto_2
    invoke-virtual {v2}, Leba;->a()V

    iget-object v6, v2, Leba;->c:Ljava/util/List;
    ...
    iget-object v2, v2, Leba;->c:Ljava/util/List;
    ...
    invoke-direct {p2, v3}, Leba;-><init>(Landroid/os/Bundle;)V

    iput-object p2, v0, Ln6i;->c:Leba;
...
.method public final onRouteSelected(Landroid/media/MediaRouter;ILandroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p2, p1, Lp6i;->j:Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p3}, Lp6i;->o(Ljava/lang/Object;)Lo6i;

    move-result-object p2

    if-eqz p2, :cond_1

    iget-object p1, p2, Lo6i;->a:Lica;
    ...
    :cond_1
    invoke-virtual {p1, p3}, Lp6i;->k(Ljava/lang/Object;)I

    move-result p2

    if-ltz p2, :cond_2

    iget-object p3, p1, Lp6i;->q:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lp6i;->i:Lq6i;

    iget-object p2, p2, Ln6i;->b:Ljava/lang/String;

    check-cast p1, Lfca;

    iget-object p3, p1, Lfca;->m:Ldca;

    const/16 v0, 0x106

    invoke-virtual {p3, v0}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p3, p1, Lfca;->c:Ll6i;

    invoke-virtual {p1, p3}, Lfca;->d(Lbzd;)Lhca;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1, p2}, Lhca;->a(Ljava/lang/String;)Lica;
...
.method public final onRouteVolumeChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v1, v0, Ln6i;->c:Leba;

    iget-object v1, v1, Leba;->a:Landroid/os/Bundle;
    ...
    iget-object v4, v1, Leba;->a:Landroid/os/Bundle;

    invoke-direct {v3, v4}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v1}, Leba;->b()Ljava/util/List;
    ...
    :goto_0
    invoke-virtual {v1}, Leba;->a()V

    iget-object v6, v1, Leba;->c:Ljava/util/List;
    ...
    iget-object v1, v1, Leba;->c:Ljava/util/List;
