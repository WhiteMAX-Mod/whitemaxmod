...
# static fields
.field public static final l1:Lb69;
...
.field public final R0:Landroid/view/VelocityTracker;
...
.field public final c1:Landroid/text/TextPaint;
...
.field public e1:Landroid/text/StaticLayout;

.field public f:Landroid/graphics/drawable/Drawable;

.field public f1:Landroid/text/StaticLayout;

.field public g:Landroid/content/res/ColorStateList;

.field public final g1:Ltf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->l1:Lb69;
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->m1:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->R0:Landroid/view/VelocityTracker;

    const/4 v9, 0x1

    iput-boolean v9, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Z

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->k1:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {p0, v0}, Lwgi;->a(Landroid/view/View;Landroid/content/Context;)V

    new-instance v10, Landroid/text/TextPaint;

    invoke-direct {v10, v9}, Landroid/text/TextPaint;-><init>(I)V

    iput-object v10, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/text/TextPaint;
    ...
    invoke-static {p1, p2, v0, v5}, Llok;->n(Landroid/content/Context;Landroid/util/AttributeSet;[II)Llok;

    move-result-object v11

    iget-object v0, v11, Llok;->b:Ljava/lang/Object;

    move-object v4, v0

    check-cast v4, Landroid/content/res/TypedArray;

    sget-object v2, Lx2f;->SwitchCompat:[I
    ...
    sget p1, Lx2f;->SwitchCompat_android_thumb:I

    invoke-virtual {v11, p1}, Llok;->d(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p1, Lx2f;->SwitchCompat_track:I
    ...
    :cond_1
    sget p1, Lx2f;->SwitchCompat_android_textOn:I
    ...
    sget p1, Lx2f;->SwitchCompat_android_textOff:I
    ...
    sget p1, Lx2f;->SwitchCompat_showText:I
    ...
    sget p1, Lx2f;->SwitchCompat_thumbTextPadding:I
    ...
    sget p1, Lx2f;->SwitchCompat_switchMinWidth:I
    ...
    sget p1, Lx2f;->SwitchCompat_switchPadding:I
    ...
    sget p1, Lx2f;->SwitchCompat_splitTrack:I
    ...
    sget p1, Lx2f;->SwitchCompat_thumbTint:I

    invoke-virtual {v11, p1}, Llok;->c(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p1, Lx2f;->SwitchCompat_thumbTintMode:I
    ...
    invoke-static {p1, v7}, Lmu5;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget p1, Lx2f;->SwitchCompat_trackTint:I
    ...
    :cond_6
    sget p1, Lx2f;->SwitchCompat_trackTintMode:I
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_9
    sget p1, Lx2f;->SwitchCompat_switchTextAppearance:I
    ...
    invoke-static {v1, v4}, Ler4;->o(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v4, v0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/content/res/ColorStateList;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/content/res/ColorStateList;

    :goto_1
    sget v2, Lx2f;->TextAppearance_android_textSize:I
    ...
    :cond_c
    sget v2, Lx2f;->TextAppearance_android_typeface:I

    invoke-virtual {p1, v2, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    sget v4, Lx2f;->TextAppearance_android_textStyle:I
    ...
    :goto_6
    sget p2, Lx2f;->TextAppearance_textAllCaps:I
    ...
    iput-object v2, p2, Ltf;->a:Ljava/util/Locale;

    iput-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->g1:Ltf;

    goto :goto_7

    :cond_15
    iput-object v7, v0, Landroidx/appcompat/widget/SwitchCompat;->g1:Ltf;
    ...
    invoke-virtual {p1, v3, v5}, Lts;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v11}, Llok;->o()V
    ...
    iput p2, v0, Landroidx/appcompat/widget/SwitchCompat;->O0:I

    invoke-virtual {p1}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result p1

    iput p1, v0, Landroidx/appcompat/widget/SwitchCompat;->S0:I

    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Ltr;

    move-result-object p1

    invoke-virtual {p1, v3, v5}, Ltr;->c(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Ltr;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->i1:Ltr;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->i1:Ltr;
...
.method private getTargetCheckedState()Z
    ...
    iget v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T0:F
...
.method private getThumbScrollRange()I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->k1:Landroid/graphics/Rect;
    ...
    invoke-static {v0}, Lmu5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lmu5;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Ltr;->b:Ltpg;

    iget-object v0, v0, Ltpg;->a:Ljava/lang/Object;

    check-cast v0, Le65;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->g1:Ltf;

    invoke-virtual {v0, v1}, Le65;->c0(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->f1:Landroid/text/StaticLayout;
...
.method private setTextOnInternal(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->e1:Landroid/text/StaticLayout;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->Z0:I

    iget v3, p0, Landroidx/appcompat/widget/SwitchCompat;->a1:I
    ...
    invoke-static {v5}, Lmu5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lmu5;->c:Landroid/graphics/Rect;

    :goto_0
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/graphics/drawable/Drawable;

    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->k1:Landroid/graphics/Rect;
...
.method public final e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Lt26;
    ...
    invoke-direct {v1, p0}, Lt26;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->j1:Lt26;

    invoke-virtual {v0, v1}, Ll16;->g(Lj16;)V
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->h1:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->h1:Landroid/animation/ObjectAnimator;
...
.method public final onCreateDrawableState(I)[I
    ...
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->m1:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lmu5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->e1:Landroid/text/StaticLayout;

    goto :goto_2

    :cond_4
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->f1:Landroid/text/StaticLayout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/text/TextPaint;

    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/content/res/ColorStateList;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p4, p1, Landroidx/appcompat/widget/SwitchCompat;->k1:Landroid/graphics/Rect;
    ...
    invoke-static {p2}, Lmu5;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p4, p1, Landroidx/appcompat/widget/SwitchCompat;->U0:I
    ...
    iget p2, p1, Landroidx/appcompat/widget/SwitchCompat;->U0:I
    ...
    iget p5, p1, Landroidx/appcompat/widget/SwitchCompat;->V0:I
    ...
    iget p3, p1, Landroidx/appcompat/widget/SwitchCompat;->V0:I
    ...
    :goto_3
    iput p2, p1, Landroidx/appcompat/widget/SwitchCompat;->X0:I

    iput p3, p1, Landroidx/appcompat/widget/SwitchCompat;->Y0:I

    iput p5, p1, Landroidx/appcompat/widget/SwitchCompat;->a1:I

    iput p4, p1, Landroidx/appcompat/widget/SwitchCompat;->Z0:I
...
.method public final onMeasure(II)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->e1:Landroid/text/StaticLayout;

    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/text/TextPaint;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->e1:Landroid/text/StaticLayout;

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->f1:Landroid/text/StaticLayout;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->f1:Landroid/text/StaticLayout;

    :cond_3
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/drawable/Drawable;

    iget-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->k1:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->e1:Landroid/text/StaticLayout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->f1:Landroid/text/StaticLayout;
    ...
    iput v0, p0, Landroidx/appcompat/widget/SwitchCompat;->W0:I
    ...
    :cond_7
    iget-boolean v4, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Z
    ...
    iput v1, p0, Landroidx/appcompat/widget/SwitchCompat;->V0:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->R0:Landroid/view/VelocityTracker;
    ...
    :cond_0
    iget v0, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->Q0:F
    ...
    :cond_9
    iput v6, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    iput v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P0:F

    iput v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Q0:F
    ...
    iput v2, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    iget v7, p0, Landroidx/appcompat/widget/SwitchCompat;->S0:I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->k1:Landroid/graphics/Rect;
    ...
    iget v7, p0, Landroidx/appcompat/widget/SwitchCompat;->X0:I

    add-int/2addr v7, v4

    sub-int/2addr v7, v2

    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->W0:I
    ...
    iget v6, p0, Landroidx/appcompat/widget/SwitchCompat;->a1:I
    ...
    iput v3, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
...
.method public setChecked(Z)V
    ...
    sget v1, Lxue;->tag_state_description:I

    const/4 v5, 0x2

    invoke-direct/range {v0 .. v5}, Lktj;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v0, p0, v6}, Llq9;->e(Landroid/view/View;Ljava/lang/Object;)V
    ...
    sget v1, Lt1f;->abc_capital_off:I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->l1:Lb69;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->h1:Landroid/animation/ObjectAnimator;
...
.method public final setEnforceSwitchWidth(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Z
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/text/TextPaint;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    sget v0, Lt1f;->abc_capital_off:I
