...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Lx2f;->ActionMenuItemView:[I

    invoke-virtual {p1, p2, v2, v0, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lx2f;->ActionMenuItemView_android_minWidth:I
...
.method public final c(Ltma;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Ltma;
    ...
    invoke-virtual {p1}, Ltma;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Ls8;

    if-nez p1, :cond_1

    new-instance p1, Ls8;

    invoke-direct {p1, p0}, Ls8;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Ls8;
...
.method public final e()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Ltma;

    invoke-virtual {v0}, Ltma;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Loma;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Ltma;

    invoke-interface {p1, v0}, Loma;->a(Ltma;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Ltma;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Ls8;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Ltma;
...
.method public setItemInvoker(Loma;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Loma;
...
.method public setPopupCallback(Lt8;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:Lt8;
...
.method public final t()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Ltma;

    iget v2, v2, Ltma;->P0:I
    ...
    iget-object v2, v2, Ltma;->q:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Ltma;->e:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Ltma;->r:Ljava/lang/CharSequence;
    ...
    iget-object v1, v0, Ltma;->e:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Lbmi;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Lbmi;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
