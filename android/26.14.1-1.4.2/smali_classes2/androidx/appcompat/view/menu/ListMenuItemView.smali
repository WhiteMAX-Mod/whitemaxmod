...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lzqe;->listMenuViewStyle:I
    ...
    sget-object v2, Lx2f;->MenuView:[I

    invoke-static {v1, p2, v2, v0}, Llok;->n(Landroid/content/Context;Landroid/util/AttributeSet;[II)Llok;

    move-result-object p2

    sget v0, Lx2f;->MenuView_android_itemBackground:I

    invoke-virtual {p2, v0}, Llok;->d(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p2, Llok;->b:Ljava/lang/Object;
    ...
    sget v1, Lzqe;->dropDownListViewStyle:I
...
.method public final c(Ltma;)V
    .locals 10

    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ltma;

    invoke-virtual {p1}, Ltma;->isVisible()Z
    ...
    iget-object v0, p1, Ltma;->e:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Ltma;->isCheckable()Z

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setCheckable(Z)V

    iget-object v0, p1, Ltma;->n:Lpma;

    invoke-virtual {v0}, Lpma;->p()Z
    ...
    invoke-virtual {v0}, Lpma;->o()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Ltma;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Ltma;->h:C
    ...
    :goto_2
    iget-object v4, p1, Ltma;->n:Lpma;

    invoke-virtual {v4}, Lpma;->o()Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ltma;

    iget-object v4, v0, Ltma;->n:Lpma;

    invoke-virtual {v4}, Lpma;->p()Z
    ...
    iget-char v0, v0, Ltma;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Ltma;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ltma;

    iget-object v5, v4, Ltma;->n:Lpma;

    iget-object v6, v5, Lpma;->a:Landroid/content/Context;

    invoke-virtual {v5}, Lpma;->o()Z

    move-result v7

    if-eqz v7, :cond_6

    iget-char v7, v4, Ltma;->j:C

    goto :goto_6

    :cond_6
    iget-char v7, v4, Ltma;->h:C
    ...
    sget v6, Lt1f;->abc_prepend_shortcut_label:I
    ...
    :goto_7
    sget v5, Lt1f;->abc_menu_meta_shortcut_label:I
    ...
    invoke-static {v4, v6, v5, v9}, Ltma;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v5, Lt1f;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v5, Lt1f;->abc_menu_alt_shortcut_label:I
    ...
    sget v5, Lt1f;->abc_menu_shift_shortcut_label:I

    invoke-virtual {v8, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v5

    invoke-static {v4, v3, v5, v9}, Ltma;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v3, Lt1f;->abc_menu_sym_shortcut_label:I
    ...
    invoke-static {v4, v5, v3, v9}, Ltma;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v3, Lt1f;->abc_menu_function_shortcut_label:I

    invoke-virtual {v8, v3}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-static {v4, v1, v3, v9}, Ltma;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :cond_a
    sget v1, Lt1f;->abc_menu_space_shortcut_label:I
    ...
    :cond_b
    sget v1, Lt1f;->abc_menu_enter_shortcut_label:I
    ...
    :cond_c
    sget v1, Lt1f;->abc_menu_delete_shortcut_label:I
    ...
    :cond_e
    invoke-virtual {p1}, Ltma;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Ltma;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Ltma;
    .locals 1
...
.method public setCheckable(Z)V
    ...
    sget v3, Loxe;->abc_list_menu_item_radio:I
    ...
    sget v3, Loxe;->abc_list_menu_item_checkbox:I
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ltma;

    invoke-virtual {p1}, Ltma;->isChecked()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    sget v3, Loxe;->abc_list_menu_item_icon:I
