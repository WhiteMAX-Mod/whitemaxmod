...
.method public final onGlobalLayout()V
    ...
    :goto_0
    iget-object v7, v1, Landroidx/mediarouter/app/d;->U0:Landroidx/mediarouter/app/OverlayListView;
    ...
    iget-object v12, v1, Landroidx/mediarouter/app/d;->V0:Landroidx/mediarouter/app/c;
    ...
    :cond_1
    iget v12, v1, Landroidx/mediarouter/app/d;->e1:I
    ...
    iget-object v15, v1, Landroidx/mediarouter/app/d;->X0:Ljava/util/HashSet;
    ...
    iget v15, v1, Landroidx/mediarouter/app/d;->y1:I
    ...
    iget v11, v1, Landroidx/mediarouter/app/d;->x1:I
    ...
    iget-object v11, v1, Landroidx/mediarouter/app/d;->A1:Landroid/view/animation/Interpolator;
    ...
    iget-object v7, v1, Landroidx/mediarouter/app/d;->Y0:Ljava/util/HashSet;
    ...
    new-instance v5, Lx0d;

    invoke-direct {v5, v4, v6}, Lx0d;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    const/4 v12, 0x0

    iput v12, v5, Lx0d;->h:F

    iget v4, v1, Landroidx/mediarouter/app/d;->z1:I

    int-to-long v6, v4

    iput-wide v6, v5, Lx0d;->e:J

    iget-object v4, v1, Landroidx/mediarouter/app/d;->A1:Landroid/view/animation/Interpolator;

    iput-object v4, v5, Lx0d;->d:Landroid/view/animation/Interpolator;
    ...
    iget v7, v1, Landroidx/mediarouter/app/d;->e1:I

    mul-int/2addr v7, v2

    new-instance v9, Lx0d;

    invoke-direct {v9, v4, v6}, Lx0d;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V
    ...
    iput-wide v6, v9, Lx0d;->e:J

    iget-object v4, v1, Landroidx/mediarouter/app/d;->A1:Landroid/view/animation/Interpolator;

    iput-object v4, v9, Lx0d;->d:Landroid/view/animation/Interpolator;

    new-instance v4, Lsp7;

    invoke-direct {v4, v1, v5}, Lsp7;-><init>(Landroidx/mediarouter/app/d;Lica;)V

    iput-object v4, v9, Lx0d;->l:Lsp7;

    iget-object v4, v1, Landroidx/mediarouter/app/d;->Z0:Ljava/util/HashSet;
