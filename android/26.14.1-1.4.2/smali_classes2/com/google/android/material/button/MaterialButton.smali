...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v3, Lxqe;->materialButtonStyle:I

    sget v4, Lcom/google/android/material/button/MaterialButton;->N0:I
    ...
    sget-object v2, Li2f;->MaterialButton:[I
    ...
    sget v2, Li2f;->MaterialButton_iconPadding:I
    ...
    sget v2, Li2f;->MaterialButton_iconTintMode:I
    ...
    invoke-static {v2, v6}, Lnqf;->L(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget v7, Li2f;->MaterialButton_iconTint:I

    invoke-static {v2, p2, v7}, Ler4;->q(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget v7, Li2f;->MaterialButton_icon:I

    invoke-static {v2, p2, v7}, Ler4;->t(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/button/MaterialButton;->i:Landroid/graphics/drawable/Drawable;

    sget v2, Li2f;->MaterialButton_iconGravity:I
    ...
    sget v2, Li2f;->MaterialButton_iconSize:I
    ...
    invoke-static {v0, v1, v3, v4}, Lgzg;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lqg8;
    ...
    invoke-direct {v1, p0, v0}, Lps9;-><init>(Lcom/google/android/material/button/MaterialButton;Lgzg;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lps9;
    ...
    iget-object v2, v1, Lps9;->b:Lgzg;

    int-to-float v0, v0

    invoke-virtual {v2, v0}, Lgzg;->h(F)Lgzg;

    move-result-object v0

    invoke-virtual {v1, v0}, Lps9;->c(Lgzg;)V

    iput-boolean v7, v1, Lps9;->p:Z
    ...
    invoke-static {v0, v6}, Lnqf;->L(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, Lps9;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Li2f;->MaterialButton_backgroundTint:I
    ...
    iput-object v0, v1, Lps9;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Li2f;->MaterialButton_strokeColor:I

    invoke-static {v0, p2, v2}, Ler4;->q(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lps9;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Li2f;->MaterialButton_rippleColor:I

    invoke-static {v0, p2, v2}, Ler4;->q(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lps9;->l:Landroid/content/res/ColorStateList;
    ...
    sget v5, Li2f;->MaterialButton_android_background:I
    ...
    iput-boolean v7, v1, Lps9;->o:Z

    iget-object v5, v1, Lps9;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, Lps9;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final b()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lps9;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lps9;->o:Z
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lps9;->l:Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lps9;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lps9;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lps9;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lps9;->b(Z)Lct9;
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lct9;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lps9;

    iput-boolean v0, v1, Lps9;->o:Z

    iget-object v0, v1, Lps9;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v1, Lps9;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lps9;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    iput-boolean v1, v0, Lps9;->p:Z

    iget-object v1, v0, Lps9;->b:Lgzg;

    int-to-float p1, p1

    invoke-virtual {v1, p1}, Lgzg;->h(F)Lgzg;

    move-result-object p1

    invoke-virtual {v0, p1}, Lps9;->c(Lgzg;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lps9;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {v0, p1, v1}, Lps9;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lns9;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->f:Lns9;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->f:Lns9;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lps9;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lps9;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p1, :cond_0

    iput-object p1, v0, Lps9;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1}, Llpf;->c(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, v0, Lps9;->n:Z

    invoke-virtual {v0}, Lps9;->f()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lps9;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lps9;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lps9;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lps9;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lps9;->b(Z)Lct9;
    ...
    invoke-virtual {p1, v0}, Lct9;->setTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lps9;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lps9;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p1, v0}, Lct9;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
