...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lx8;->P(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v0}, Lx8;-><init>(Landroid/os/Bundle;)V
    ...
    iput-object v5, v8, Lede;->a:Ljava/lang/Object;

    iput-object p0, v8, Lede;->b:Ljava/lang/Object;

    iput-object v4, v8, Lede;->c:Ljava/lang/Object;

    :try_start_0
    invoke-virtual {v8}, Lede;->D()Z
    ...
    invoke-static {p1}, Le8l;->m(Landroid/content/Intent;)Z
    ...
    invoke-static {v4, v5}, Le8l;->j(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v0}, Leif;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Leif;)V
    ...
    :cond_10
    :goto_4
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Liuf;
    ...
    invoke-direct {v0, v4}, Liuf;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Liuf;

    :cond_11
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Liuf;

    iget-object v4, v0, Liuf;->c:Lu7d;

    invoke-virtual {v4}, Lu7d;->u()I
    ...
    :cond_14
    iget-object p1, v0, Liuf;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, v1, v6, v4, v7}, Loql;-><init>(IILandroid/os/Bundle;I)V
