...
.method public final b(Lspi;)V
    ...
    iget-object v2, v1, Lspi;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lryb;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lzxb;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Lyxb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Lzxb;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lzxb;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lxxb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Lryb;->d:Z

    if-eqz v1, :cond_8

    iget-object v1, v0, Lryb;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, Lyxb;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lyxb;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
