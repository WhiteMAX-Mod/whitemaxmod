...
.method public constructor <init>(Lt29;Lt29;Lt29;Lt29;)V
    ...
    const-string p4, "26.14.1(6686)"

    invoke-direct {v6, p4}, Lffi;-><init>(Ljava/lang/CharSequence;)V

    sget p4, Lkze;->oneme_settings_app_version:I

    new-instance v8, Lbfi;

    invoke-direct {v8, p4}, Lbfi;-><init>(I)V
    ...
    invoke-direct {v3, p2}, Lffi;-><init>(Ljava/lang/CharSequence;)V

    sget p2, Lkze;->oneme_settings_user_id:I

    new-instance v5, Lbfi;

    invoke-direct {v5, p2}, Lbfi;-><init>(I)V
    ...
    iget-object p2, p2, Lyk5;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p4, p2}, Lmnf;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {p3, p4, v0}, Lgq2;-><init>(CC)V
    ...
    invoke-direct {p4, v0, v1}, Lgq2;-><init>(CC)V
    ...
    invoke-static {p3, p4}, Lh04;->V0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, p3}, Lo04;->w0(Ljava/util/Collection;Ljava/lang/Iterable;)V

    invoke-static {v0, p4}, Lo04;->w0(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-virtual {v2, v1}, Lu3;->d(I)I

    move-result v1

    invoke-static {v1, p3}, Lh04;->E0(ILjava/util/Collection;)Ljava/lang/Object;
