...
# direct methods
.method public static final a(Li8f;Ltpk;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-direct {p1, v0}, Lr0d;-><init>(Ljava/lang/Object;)V
...
.method public static b(Lzb8;)Landroid/graphics/Bitmap;
    .locals 4
    ...
    :cond_4
    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->c(Lzb8;)Landroid/graphics/Bitmap;
...
.method public static e(Lzb8;Landroid/graphics/Rect;II)[B
    .locals 21

    invoke-interface/range {p0 .. p0}, Lzb8;->getFormat()I
    ...
    invoke-interface {v2}, Lyb8;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v4}, Lyb8;->g()I

    move-result v9

    invoke-interface {v2}, Lyb8;->g()I
    ...
    sget-object v4, Ltb6;->c:[Ldc6;

    new-instance v4, Lsb6;

    sget-object v5, Ljava/nio/ByteOrder;->BIG_ENDIAN:Ljava/nio/ByteOrder;

    invoke-direct {v4}, Lsb6;-><init>()V
    ...
    iget-object v7, v4, Lsb6;->a:Ljava/util/ArrayList;

    invoke-virtual {v4, v6, v5, v7}, Lsb6;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V

    const-string v5, "XResolution"

    const-string v6, "72/1"

    invoke-virtual {v4, v5, v6, v7}, Lsb6;->c(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-interface/range {p0 .. p0}, Lzb8;->getImageInfo()Ldb8;
    ...
    invoke-interface {v5, v4}, Ldb8;->b(Lsb6;)V

    :cond_3
    move/from16 v5, p3

    invoke-virtual {v4, v5}, Lsb6;->d(I)V
    ...
    invoke-direct {v5, v4}, Lrb6;-><init>(Lsb6;)V
    ...
    invoke-virtual {v4, v6, v7, v5}, Lsb6;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    sget-object v7, Ltb6;->f:Ljava/lang/String;
    ...
    invoke-virtual {v4, v7, v6, v5}, Lsb6;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v6, v3, v5}, Lsb6;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v5}, Lsb6;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v7, v5}, Lsb6;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v4, v4, Lsb6;->b:Ljava/nio/ByteOrder;

    invoke-direct {v3, v4, v5}, Ltb6;-><init>(Ljava/nio/ByteOrder;Ljava/util/ArrayList;)V

    invoke-direct {v2, v0, v3}, Lcc6;-><init>(Ljava/io/ByteArrayOutputStream;Ltb6;)V
