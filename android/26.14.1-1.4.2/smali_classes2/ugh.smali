...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lugh;->r:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lobj;->m([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Luh;->a(Ljava/lang/String;)Luh;

    move-result-object v0

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, p0, Lugh;->n:Luh;
    ...
    invoke-virtual {p0, v0}, Lugh;->i(Licj;)V

    return-void

    :cond_0
    iput-boolean v0, p0, Lugh;->m:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lugh;->n:Luh;
...
.method public static j(Ljava/lang/String;)J
    ...
    sget-object v0, Lugh;->r:Ljava/util/regex/Pattern;
...
.method public final e(IZ[B)Laxh;
    ...
    invoke-direct {v3, v4, v5}, Licj;-><init>(I[B)V

    iget-boolean v4, v0, Lugh;->m:Z

    if-nez v4, :cond_0

    invoke-virtual {v0, v3}, Lugh;->i(Licj;)V

    :cond_0
    if-eqz v4, :cond_1

    iget-object v4, v0, Lugh;->n:Luh;
    ...
    :goto_0
    invoke-virtual {v3}, Licj;->g()Ljava/lang/String;
    ...
    invoke-static {v6}, Luh;->a(Ljava/lang/String;)Luh;
    ...
    invoke-static {v9}, Lugh;->j(Ljava/lang/String;)J
    ...
    invoke-static {v13}, Lugh;->j(Ljava/lang/String;)J
    ...
    :cond_b
    iget-object v6, v0, Lugh;->o:Ljava/util/LinkedHashMap;
    ...
    sget-object v14, Lygh;->a:Ljava/util/regex/Pattern;
    ...
    :try_start_0
    invoke-static {v3}, Lygh;->a(Ljava/lang/String;)Landroid/graphics/PointF;
    ...
    :cond_d
    :try_start_1
    sget-object v13, Lygh;->d:Ljava/util/regex/Pattern;
    ...
    invoke-static {v3}, Lahh;->a(Ljava/lang/String;)I
    ...
    sget-object v3, Lygh;->a:Ljava/util/regex/Pattern;
    ...
    iget-boolean v3, v6, Lahh;->f:Z

    iget-object v0, v6, Lahh;->c:Ljava/lang/Integer;
    ...
    :pswitch_0
    invoke-static {v4, v6, v0, v8}, Ln;->k(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct/range {v17 .. v34}, Lpz4;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;Landroid/text/Layout$Alignment;Landroid/graphics/Bitmap;FIIFIIFFFZIIF)V

    move-object/from16 v0, v17

    invoke-static {v9, v10, v2, v1}, Lugh;->h(JLjava/util/ArrayList;Ljava/util/ArrayList;)I

    move-result v3

    invoke-static {v11, v12, v2, v1}, Lugh;->h(JLjava/util/ArrayList;Ljava/util/ArrayList;)I
    ...
    invoke-direct {v0, v1, v3, v2}, Luwf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final i(Licj;)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {v2}, Licj;->g()Ljava/lang/String;
    ...
    invoke-static {v14}, Ld5f;->p0(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v14, Lwgh;

    array-length v0, v10

    move/from16 v23, v0

    invoke-direct/range {v14 .. v23}, Lwgh;-><init>(IIIIIIIII)V
    ...
    invoke-static {v5, v14, v12, v0, v13}, Lpc2;->x(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_14
    :try_start_1
    new-instance v18, Lahh;

    iget v0, v10, Lwgh;->a:I
    ...
    invoke-static {v0}, Lahh;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lahh;->c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v4, v5, v0}, Ldwi;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {v0}, Lahh;->b(Ljava/lang/String;)Z
    ...
    :goto_10
    invoke-direct/range {v18 .. v26}, Lahh;-><init>(Ljava/lang/String;ILjava/lang/Integer;FZZZZ)V
    :try_end_3
    ...
    iget-object v4, v0, Lahh;->a:Ljava/lang/String;
    ...
    :cond_1d
    iput-object v3, v1, Lugh;->o:Ljava/util/LinkedHashMap;
