...
.method public constructor <init>(Lahj;)V
    ...
    iput-object v0, p0, Ldhj;->d:Ljava/util/HashSet;

    iput-object p1, p0, Ldhj;->a:Lahj;

    invoke-interface {p1}, Lahj;->b()I
    ...
    iput-object v1, p0, Ldhj;->b:Landroid/util/Range;

    invoke-interface {p1}, Lahj;->v()I
    ...
    iput-object p1, p0, Ldhj;->c:Landroid/util/Range;
...
.method public static c(Lahj;Landroid/util/Size;)Lahj;
    .locals 4
    ...
    invoke-interface {p0, v0, v1}, Lahj;->a(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lahj;->w()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lahj;->z()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Ldhj;-><init>(Lahj;)V
    ...
    iget-object v0, v0, Ldhj;->d:Ljava/util/HashSet;
...
.method public final s(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ldhj;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Ldhj;->a:Lahj;
    ...
    iget-object p1, p0, Ldhj;->b:Landroid/util/Range;
...
.method public final u(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Ldhj;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Ldhj;->c:Landroid/util/Range;
...
.method public final w()Landroid/util/Range;
    ...
    iget-object v0, p0, Ldhj;->b:Landroid/util/Range;
...
.method public final x(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lahj;->x(II)Z
    ...
    :cond_0
    iget-object v1, p0, Ldhj;->d:Ljava/util/HashSet;
...
.method public final z()Landroid/util/Range;
    ...
    iget-object v0, p0, Ldhj;->c:Landroid/util/Range;
