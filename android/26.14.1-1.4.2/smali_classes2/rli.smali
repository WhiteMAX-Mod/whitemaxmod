...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;)V
    ...
    iput-object p1, p0, Lrli;->c:Landroidx/appcompat/widget/Toolbar;
...
.method public final d(Ltma;)Z
    ...
    iget-object v0, p0, Lrli;->c:Landroidx/appcompat/widget/Toolbar;

    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->i:Landroid/view/View;

    instance-of v2, v1, Lzz3;

    if-eqz v2, :cond_0

    check-cast v1, Lzz3;

    invoke-interface {v1}, Lzz3;->onActionViewCollapsed()V
    ...
    iput-object v1, p0, Lrli;->b:Ltma;

    invoke-virtual {v0}, Landroid/view/View;->requestLayout()V

    const/4 v1, 0x0

    iput-boolean v1, p1, Ltma;->T0:Z
...
.method public final f(Ltma;)Z
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/Toolbar;->Y0:Ljava/util/ArrayList;
    ...
    invoke-interface {p1}, Lzz3;->onActionViewExpanded()V
...
.method public final h()V
    ...
    iget-object v0, p0, Lrli;->b:Ltma;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lrli;->a:Lpma;

    if-eqz v0, :cond_1

    iget-object v0, v0, Lpma;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lrli;->a:Lpma;

    invoke-virtual {v2, v1}, Lpma;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Lrli;->b:Ltma;
    ...
    invoke-virtual {p0, v0}, Lrli;->d(Ltma;)Z
...
.method public final k(Landroid/content/Context;Lpma;)V
    ...
    invoke-virtual {p1, v0}, Lpma;->e(Ltma;)Z

    :cond_0
    iput-object p2, p0, Lrli;->a:Lpma;
