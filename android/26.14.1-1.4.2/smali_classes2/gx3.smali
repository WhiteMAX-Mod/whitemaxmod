...
# direct methods
.method public constructor <init>(Liji;JJZ)V
    .locals 8
    ...
    invoke-virtual {p1, p5, p2, v4, v5}, Liji;->m(ILgji;J)Lgji;
    ...
    :cond_6
    iput-wide p2, p0, Lgx3;->f:J

    iput-wide v0, p0, Lgx3;->g:J
    ...
    :goto_3
    iput-wide p2, p0, Lgx3;->h:J

    iget-boolean p1, p1, Lgji;->i:Z
...
.method public final f(ILdji;Z)Ldji;
    ...
    iget-object v1, p0, Lvd7;->e:Liji;

    const/4 v2, 0x0

    invoke-virtual {v1, v2, p2, p3}, Liji;->f(ILdji;Z)Ldji;
    ...
    :goto_1
    iget-object v1, p2, Ldji;->a:Ljava/lang/Object;

    iget-object v2, p2, Ldji;->b:Ljava/lang/Object;
...
.method public final m(ILgji;J)Lgji;
    ...
    iget-wide p3, p2, Lgji;->p:J

    iget-wide v0, p0, Lgx3;->f:J

    add-long/2addr p3, v0

    iput-wide p3, p2, Lgji;->p:J

    iget-wide p3, p0, Lgx3;->h:J

    iput-wide p3, p2, Lgji;->m:J

    iget-boolean p1, p0, Lgx3;->i:Z

    iput-boolean p1, p2, Lgji;->i:Z

    iget-wide p3, p2, Lgji;->l:J
    ...
    iput-wide p3, p2, Lgji;->l:J

    iget-wide v4, p0, Lgx3;->g:J
    ...
    iput-wide v0, p2, Lgji;->e:J

    :cond_2
    iget-wide v0, p2, Lgji;->f:J
