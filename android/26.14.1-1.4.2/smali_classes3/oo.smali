...
.method public synthetic constructor <init>(Lcom/my/tracker/applifecycle/o/d;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Loo;->a:Ljava/lang/String;

    iput-object p3, p0, Loo;->c:Ljava/lang/Object;

    iput-object p4, p0, Loo;->d:Ljava/io/Serializable;

    iput-object p5, p0, Loo;->e:Ljava/io/Serializable;

    iput-object p6, p0, Loo;->f:Ljava/io/Serializable;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;Lop;Lpo;Lru/ok/android/api/core/ApiInvocationException;Lyff;Lyff;)V
    .locals 0

    .line 2
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Loo;->a:Ljava/lang/String;
...
.method public c(Lto;)Lto;
    ...
    iget-object v1, v1, Lpo;->c:Lqp;

    iget-object v2, p0, Loo;->d:Ljava/io/Serializable;

    check-cast v2, Lru/ok/android/api/core/ApiInvocationException;

    iget-object v3, p0, Loo;->e:Ljava/io/Serializable;

    check-cast v3, Lyff;

    iget-object v4, p0, Loo;->f:Ljava/io/Serializable;

    check-cast v4, Lyff;

    iget-object v5, p1, Lto;->c:Ljava/lang/String;

    iget-object v6, p0, Loo;->a:Ljava/lang/String;
    ...
    iget-object v6, p1, Lto;->a:Ljava/lang/String;

    iget-object p1, p1, Lto;->b:Ljava/lang/String;

    const/4 v7, 0x0

    invoke-direct {v5, v6, p1, v7, v7}, Lto;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_4
    invoke-interface {v1, p1}, Lqp;->e(Lto;)Lto;
    ...
    :goto_2
    iget-object v5, v1, Lto;->c:Ljava/lang/String;
    ...
    :cond_6
    iput-object v1, v4, Lyff;->a:Ljava/lang/Object;
...
.method public invoke(Lcom/my/tracker/core/EngineCore$InsertEventTools;)[B
    ...
    iget-object v0, p0, Loo;->d:Ljava/io/Serializable;

    move-object v4, v0

    check-cast v4, Ljava/lang/String;

    iget-object v0, p0, Loo;->e:Ljava/io/Serializable;

    move-object v5, v0

    check-cast v5, Ljava/lang/String;

    iget-object v0, p0, Loo;->f:Ljava/io/Serializable;

    move-object v6, v0

    check-cast v6, Ljava/lang/String;

    iget-object v2, p0, Loo;->a:Ljava/lang/String;
