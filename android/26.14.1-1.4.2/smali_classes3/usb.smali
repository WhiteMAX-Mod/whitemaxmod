...
# direct methods
.method public constructor <init>(Lej9;Lxhg;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lusb;->a:Lej9;

    iput-object p2, p0, Lusb;->d:Lxhg;

    const-wide/16 p1, 0x2ee0

    iput-wide p1, p0, Lusb;->c:J

    const-wide p1, 0x7fffffffffffffffL

    iput-wide p1, p0, Lusb;->e:J

    sget-object p1, Ljava/time/Instant;->MIN:Ljava/time/Instant;

    iput-object p1, p0, Lusb;->f:Ljava/time/Instant;
...
.method public final a()V
    ...
    iget-object v0, p0, Lusb;->a:Lej9;

    const-string v1, "Inconsistency error in congestion controller; attempt to set bytes in-flight below 0"

    invoke-interface {v0, v1}, Lej9;->error(Ljava/lang/String;)V

    iput-wide v2, p0, Lusb;->b:J

    iget-object v0, p0, Lusb;->d:Lxhg;
...
.method public final declared-synchronized b(Ljava/util/List;)V
    ...
    iget-object v3, p0, Lusb;->d:Lxhg;

    invoke-virtual {v3}, Lxhg;->k()V
    ...
    invoke-virtual {p0}, Lusb;->a()V

    iget-object v3, p0, Lusb;->a:Lej9;

    iget-wide v4, p0, Lusb;->b:J
    ...
    invoke-interface {v3, p1}, Lej9;->debug(Ljava/lang/String;)V
    :try_end_0
...
.method public final declared-synchronized c(Ljava/util/List;)V
    ...
    iget-object v1, p0, Lusb;->d:Lxhg;

    invoke-virtual {v1}, Lxhg;->k()V

    invoke-virtual {p0}, Lusb;->a()V

    iget-object v1, p0, Lusb;->a:Lej9;
...
.method public final declared-synchronized d(Lsoe;)V
    .locals 6
    ...
    invoke-interface {p1, v1}, Lej9;->debug(Ljava/lang/String;)V

    iget-wide v1, p0, Lusb;->b:J

    iget-wide v3, p0, Lusb;->c:J
    ...
    invoke-interface {p1, v0}, Lej9;->cc(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
