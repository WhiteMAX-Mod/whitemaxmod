...
.method public final a(Looe;Lul;)I
    ...
    iget-object v2, v0, Ldd4;->e:Lseh;

    iget-object v3, v2, Led4;->b:[B
    ...
    iget-object v3, v2, Led4;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v4, v2, v5}, Lreh;-><init>(Lseh;I)V
    ...
    iput-object v1, v2, Led4;->b:[B

    iget-object v1, v2, Led4;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v3, v2, v4}, Lreh;-><init>(Lseh;I)V
    ...
    invoke-interface {v3, v2}, Lej9;->info(Ljava/lang/String;)V
    ...
    iget-object v1, v0, Ldd4;->e:Lseh;

    invoke-virtual {v1}, Led4;->b()Ljava/util/List;
...
.method public final h(I)I
    ...
    invoke-static {v0, v1}, Lsoe;->e(J)I
...
.method public final i(Lye;)[B
    ...
    invoke-static {v2, v3, v1}, Lsoe;->g(JB)B
    ...
    invoke-static {v1, v2}, Lsoe;->f(J)[B
    ...
    invoke-virtual {p0, v2}, Lsoe;->j(I)Ljava/nio/ByteBuffer;

    move-result-object v2

    array-length v1, v1

    invoke-virtual {p0, v0, v1, v2, p1}, Lsoe;->u(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lye;)V
...
.method public final s(Ljava/nio/ByteBuffer;Lye;JLej9;I)V
    ...
    invoke-interface {p5, v0}, Lej9;->debug(Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-virtual/range {v1 .. v8}, Lsoe;->t(Ljava/nio/ByteBuffer;BILye;JLej9;)V

    move-object p2, v5

    check-cast p2, Lbf;

    invoke-virtual {p2}, Lbf;->g()V
    :try_end_1
    ...
    :try_start_3
    iget-boolean p3, p2, Lbf;->p:Z

    if-eqz p3, :cond_0

    iget-object p3, p2, Lbf;->b:Lej9;

    const-string p4, "Discarding updated keys (initiated by peer)"

    invoke-interface {p3, p4}, Lej9;->info(Ljava/lang/String;)V

    const/4 p3, 0x0

    iput-object p3, p2, Lbf;->e:[B

    const/4 p4, 0x0

    iput-boolean p4, p2, Lbf;->p:Z

    iput-object p3, p2, Lbf;->g:[B

    iput-object p3, p2, Lbf;->i:[B
    :try_end_3
...
.method public final toString()Ljava/lang/String;
    ...
    :goto_1
    iget-short v3, p0, Ll3h;->g:S

    iget-object v4, p0, Lsoe;->e:[B
    ...
    iget-object v7, p0, Lsoe;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v8, v9}, Libd;-><init>(I)V
    ...
    invoke-static {v8, v0, v7}, Ltog;->v(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
