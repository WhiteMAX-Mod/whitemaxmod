...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2, p0}, Lx8;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Lus0;->b:Lx8;
...
.method private final getAgslDelegate()Lgf;
    .locals 1
...
# virtual methods
.method public abstract a(Lff;FF)V
.end method

.method public final b()V
    .locals 1

    iget-boolean v0, p0, Lus0;->e:Z
    ...
    :cond_1
    iget-object v0, p0, Lus0;->d:Lyq7;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lyq7;->a()V
...
.method public final c()V
    ...
    iget-boolean v1, p0, Lus0;->a:Z

    if-eqz v1, :cond_6

    invoke-direct {p0}, Lus0;->getAgslDelegate()Lgf;

    move-result-object v1

    iget-object v2, v1, Lgf;->a:Lx8;

    iget-object v3, v1, Lgf;->b:Landroid/graphics/RuntimeShader;
    ...
    invoke-virtual {v3}, Lus0;->getSpec()Lz1j;
    ...
    sget-object v4, Lgf;->g:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v3}, Lef;->c(Ljava/lang/Object;)Landroid/graphics/RuntimeShader;
    ...
    :goto_0
    iput-object v3, v1, Lgf;->b:Landroid/graphics/RuntimeShader;

    if-nez v3, :cond_8

    sget-object v3, Lbzg;->a:Ljava/lang/Object;

    iget-object v2, v2, Lx8;->b:Ljava/lang/Object;

    check-cast v2, Lus0;

    invoke-virtual {v2}, Lus0;->getSpec()Lz1j;
    ...
    invoke-virtual {v2}, Luu3;->x()Ljava/util/List;
    ...
    :goto_2
    iget-object v4, v4, La2j;->a:Ljava/lang/String;
    ...
    invoke-static {v9, v6, v7, v4, v8}, Lpc2;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lbzg;->a:Ljava/lang/Object;
    ...
    invoke-direct {v4, v5}, Lvpf;-><init>(I)V
    ...
    invoke-virtual {v2, v6, v4}, Ldgf;->c(Ljava/lang/String;Lgi7;)Ljava/lang/String;
    ...
    invoke-direct {v2, v5}, Lvpf;-><init>(I)V
    ...
    invoke-virtual {v0, v4, v2}, Ldgf;->c(Ljava/lang/String;Lgi7;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lef;->d(Ljava/lang/String;)Landroid/graphics/RuntimeShader;

    move-result-object v0

    iput-object v0, v1, Lgf;->b:Landroid/graphics/RuntimeShader;

    return-void

    :cond_6
    iget-object v1, p0, Lus0;->d:Lyq7;
    ...
    iget-object v3, p0, Lus0;->b:Lx8;

    invoke-direct {v1, v2, v3}, Lyq7;-><init>(Landroid/content/Context;Lx8;)V

    iput-object v1, p0, Lus0;->d:Lyq7;
    ...
    invoke-virtual {v1, v0}, Lyq7;->setStarted(Z)V
...
.method public final d()V
    ...
    iget-object v1, v0, Lgf;->c:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lgf;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iput-object v2, v0, Lgf;->b:Landroid/graphics/RuntimeShader;

    sget-object v2, Lgf;->g:Ljava/util/LinkedHashMap;

    iget-object v0, v0, Lgf;->a:Lx8;

    iget-object v0, v0, Lx8;->b:Ljava/lang/Object;

    check-cast v0, Lus0;

    invoke-virtual {v0}, Lus0;->getSpec()Lz1j;
...
.method public abstract getSpec()Lz1j;
.end method
...
.method public final onDrawForeground(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v1, Lgf;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_2
    iget-object v4, v0, Lgf;->e:[F

    iget-object v5, v0, Lgf;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v4}, Lef;->C(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, v0, Lgf;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lus0;->a(Lff;FF)V
