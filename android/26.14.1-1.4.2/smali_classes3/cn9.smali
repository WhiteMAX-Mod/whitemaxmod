...
.method public final a(IILjava/lang/String;)Z
    ...
    :cond_0
    iget-object v1, p0, Lcn9;->j:Ljava/lang/String;

    if-eqz v1, :cond_1

    invoke-static {v1, p3}, Lph7;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_1
    iput-boolean v0, p0, Lcn9;->k:Z

    iput-object p3, p0, Lcn9;->j:Ljava/lang/String;
...
.method public final f()V
    ...
    iput-object v0, p0, Lcn9;->j:Ljava/lang/String;
...
.method public final onNextFrameRendered(Lone/me/rlottie/RLottieDrawable;I)V
    ...
    iget-boolean p1, p0, Lcn9;->k:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcn9;->l:Lbn9;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lbn9;->d()V

    :cond_0
    const/4 p1, 0x0

    iput-boolean p1, p0, Lcn9;->k:Z

    :cond_1
    return-void
.end method

.method public final setFailureListener(Lan9;)V
    .locals 0

    iput-object p1, p0, Lcn9;->m:Lan9;

    return-void
.end method

.method public final setOnFirstFrameListener(Lbn9;)V
    .locals 0

    iput-object p1, p0, Lcn9;->l:Lbn9;
