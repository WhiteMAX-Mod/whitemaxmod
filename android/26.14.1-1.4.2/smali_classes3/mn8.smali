...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmn8;->a:Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Z)Landroid/content/Intent;
    ...
    :cond_1
    invoke-static {p0}, Lmn8;->b(Landroid/content/Context;)Landroid/content/Intent;
...
.method public static final g(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    .locals 5
    ...
    invoke-static {v2, p1, v1}, Le65;->X(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static i(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lwkg;-><init>(Landroid/content/Context;I)V

    iget-object p0, v0, Lwkg;->d:Ljava/lang/Object;
    ...
    iput-object p0, v0, Lwkg;->e:Ljava/lang/Object;
...
.method public static j(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/net/Uri;)V
    .locals 3
    ...
    invoke-virtual {v0, p1}, Lwkg;->a0(Ljava/lang/CharSequence;)V

    const/4 p1, 0x0

    iput-object p1, v0, Lwkg;->e:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lwkg;->e:Ljava/lang/Object;

    invoke-virtual {v1, p2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_2
    invoke-virtual {v0}, Lwkg;->E()Landroid/content/Intent;

    move-result-object p2

    invoke-static {p0, p2}, Lmn8;->a(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static k(Landroid/content/Context;Z)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Lmn8;->c(Landroid/content/Context;Z)Landroid/content/Intent;
...
.method public static l(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    .locals 3
    ...
    invoke-static {p0, v1}, Lmn8;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
