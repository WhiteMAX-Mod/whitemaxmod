...
.field public volatile g:Leg7;

.field public volatile h:Leg7;
...
# direct methods
.method public constructor <init>(Le3f;Ldtf;)V
    .locals 4
    ...
    iput-object v0, p0, Lpf7;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lpf7;->d:Le3f;

    iput-object p2, p0, Lpf7;->e:Ldtf;
    ...
    iput-object p1, p0, Lpf7;->c:Lcs4;

    new-instance p1, Lyii;

    invoke-direct {p1}, Lyii;-><init>()V

    iput-object p1, p0, Lpf7;->j:Lyii;

    new-instance p1, Lyii;

    invoke-direct {p1}, Lyii;-><init>()V

    iput-object p1, p0, Lpf7;->k:Lyii;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lpf7;->m:Z

    iget-object v0, p0, Lpf7;->f:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lpf7;->f:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iput-wide v2, p0, Lpf7;->i:J

    :cond_0
    iget-object v0, p0, Lpf7;->g:Leg7;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lpf7;->g:Leg7;

    iget-boolean v2, v0, Leg7;->a:Z
    ...
    iput-boolean v1, v0, Leg7;->h:Z

    :cond_2
    iget-object v1, v0, Leg7;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Leg7;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Leg7;->g:Lfrk;

    invoke-static {p1}, Leg7;->b(Lfrk;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lpf7;->h:Leg7;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lpf7;->n:J

    iget-wide v7, p0, Lpf7;->b:J
    ...
    iget-object v5, v2, Leg7;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Leg7;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lpf7;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lpf7;->n:J

    iget-object p1, p0, Lpf7;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lpf7;->c:Lcs4;

    new-instance v0, Ln06;

    const/16 v3, 0xc

    invoke-direct {v0, p0, v2, v1, v3}, Ln06;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lpf7;->k:Lyii;

    invoke-virtual {p1}, Lyii;->a()V
