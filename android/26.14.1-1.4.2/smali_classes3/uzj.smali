...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lrzj;-><init>(Luzj;I)V
    ...
    iput-object v0, p0, Luzj;->a:Ljava/lang/Object;

    new-instance v0, Lrzj;

    const/4 v2, 0x1

    invoke-direct {v0, p0, v2}, Lrzj;-><init>(Luzj;I)V

    invoke-static {v1, v0}, Lv3h;->F(ILei7;)Lt29;

    move-result-object v0

    iput-object v0, p0, Luzj;->b:Ljava/lang/Object;

    invoke-static {}, Lyhb;->w()Lgif;

    move-result-object v0

    iput-object v0, p0, Luzj;->d:Lgif;
    ...
    invoke-direct {v2, v1, v5, v4}, Lmp4;-><init>(ILkotlin/coroutines/Continuation;I)V

    invoke-static {v2, v0}, Lcob;->K(Lwi7;Landroid/view/View;)V

    iput-object v0, p0, Luzj;->e:Landroid/view/View;
    ...
    invoke-direct {v4, v2, p0, v9, v8}, Lidi;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V

    invoke-virtual {v2, v4}, Lpe0;->setListener(Lne0;)V

    const-wide/16 v8, 0x4b

    invoke-virtual {v2, v8, v9}, Lpe0;->setShiftOffset(J)V

    iput-object v2, p0, Luzj;->f:Lpe0;
    ...
    invoke-direct {p0}, Luzj;->getPlayIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v3, p0, v5, v8}, Lszh;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    invoke-static {v3, v4}, Lcob;->K(Lwi7;Landroid/view/View;)V

    new-instance v3, Lx0i;

    const/16 v8, 0x8

    invoke-direct {v3, v8, p0}, Lx0i;-><init>(ILjava/lang/Object;)V

    invoke-static {v4, v3}, Lyyk;->R(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v4, p0, Luzj;->g:Landroid/widget/ImageView;
    ...
    invoke-direct {p1, p0, v5}, Lszj;-><init>(Luzj;Lkotlin/coroutines/Continuation;)V

    invoke-static {p1, v0}, Lcob;->K(Lwi7;Landroid/view/View;)V

    iput-object v0, p0, Luzj;->h:Landroid/widget/TextView;
    ...
    invoke-direct {p1, v1, v5}, Lszj;-><init>(ILkotlin/coroutines/Continuation;)V
...
.method public static final synthetic a(Luzj;)Landroid/graphics/drawable/Drawable;
    .locals 0

    invoke-direct {p0}, Luzj;->getPauseSmallIcon()Landroid/graphics/drawable/Drawable;
...
.method public static final synthetic b(Luzj;)Landroid/graphics/drawable/Drawable;
    .locals 0
...
.method private final getAnimateDotViewJob()Lus8;
    .locals 2

    sget-object v0, Luzj;->i:[Lf09;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v1, p0, Luzj;->d:Lgif;
...
.method private final getPauseSmallIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Luzj;->b:Ljava/lang/Object;
...
.method private final getPlayIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Luzj;->a:Ljava/lang/Object;
...
.method private final setAnimateDotViewJob(Lus8;)V
    .locals 2
...
.method public final c()V
    ...
    invoke-direct {p0}, Luzj;->getAnimateDotViewJob()Lus8;
    ...
    :cond_0
    invoke-direct {p0, v1}, Luzj;->setAnimateDotViewJob(Lus8;)V

    return-void
.end method

.method public final d(Ljava/lang/Long;Ltb9;)V
    .locals 4

    iget-boolean v0, p2, Ltb9;->b:Z

    iget-object p2, p2, Ltb9;->a:Ljava/lang/Float;

    iget-object v1, p0, Luzj;->g:Landroid/widget/ImageView;
    ...
    :goto_0
    iget-object v0, p0, Luzj;->f:Lpe0;

    if-nez p2, :cond_2

    iget-boolean v1, v0, Lpe0;->q:Z
    ...
    iput-wide v1, v0, Lpe0;->e:J

    const/4 v1, 0x0

    iput-boolean v1, v0, Lpe0;->h:Z
    ...
    invoke-static {p1, p2}, Lzql;->b(J)Ljava/lang/String;

    move-result-object v0

    :cond_6
    iget-object p1, p0, Luzj;->h:Landroid/widget/TextView;
...
.method public final e()V
    ...
    iget-object v0, p0, Luzj;->e:Landroid/view/View;
    ...
    invoke-direct {v2, v0, v3}, Laj;-><init>(Landroid/view/View;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-direct {p0, v0}, Luzj;->setAnimateDotViewJob(Lus8;)V
...
.method public final getPauseAnimations()Ljava/util/List;
    ...
    iget-object v2, v0, Luzj;->e:Landroid/view/View;

    const/high16 v3, 0x3f800000    # 1.0f

    const/high16 v4, 0x3f000000    # 0.5f

    invoke-static/range {v2 .. v8}, Ly7l;->e(Landroid/view/View;FFJJ)Ldb9;
    ...
    iget-object v3, v0, Luzj;->g:Landroid/widget/ImageView;
    ...
    invoke-direct {v9, v0, v10}, Lpzj;-><init>(Luzj;I)V
    ...
    invoke-static {v2, v9}, Lbh9;->S(IF)I
    ...
    invoke-direct {v0}, Luzj;->getWaveContainerBackground()Landroid/graphics/drawable/GradientDrawable;

    move-result-object v9

    new-instance v10, Lqzj;

    const/4 v11, 0x1

    invoke-direct {v10, v9, v11}, Lqzj;-><init>(Landroid/graphics/drawable/GradientDrawable;I)V
    ...
    invoke-static {v4, v9}, Lbh9;->S(IF)I
    ...
    invoke-direct {v3, v0, v4}, Lpzj;-><init>(Luzj;I)V
...
.method public final getResumeAnimations()Ljava/util/List;
    ...
    invoke-interface {v9}, Lrtc;->m()Lhtc;
    ...
    invoke-static {v9, v10}, Lbh9;->S(IF)I
    ...
    invoke-static {v4, v2}, Lbh9;->S(IF)I
    ...
    invoke-static {v3, v2}, Lbh9;->S(IF)I
...
.method public final getWaveView()Lpe0;
    .locals 1
...
.method public final setBackgroundColor(Z)V
    ...
    :goto_0
    invoke-direct {p0}, Luzj;->getWaveContainerBackground()Landroid/graphics/drawable/GradientDrawable;
...
.method public final setCallback(Ltzj;)V
    .locals 0

    iput-object p1, p0, Luzj;->c:Ltzj;
...
.method public final setDurationColor(Z)V
    ...
    iget-object v1, p0, Luzj;->h:Landroid/widget/TextView;
...
.method public final setDurationText(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Luzj;->h:Landroid/widget/TextView;
...
.method public final setVisiblePlayPauseButton(Z)V
    ...
    :goto_0
    iget-object v0, p0, Luzj;->g:Landroid/widget/ImageView;
