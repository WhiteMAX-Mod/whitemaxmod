...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Le3f;)V",
        "Lfa1;",
        "call",
        "Lb2j;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lu9h;",
        "Lm62;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lvu1;)Lm62;",
        "",
        "Ll62;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Lfa1;

.field private final compositeDisposable:Lt64;
...
.field private final loadEventSubject:Lmle;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Lz95;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Le3f;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Le3f;

    new-instance p1, Lmle;

    invoke-direct {p1}, Lmle;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lmle;

    new-instance p2, Lt64;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lt64;
    ...
    invoke-direct {p4, p1, v0, v1}, Lx3c;-><init>(Lmle;Lc2g;I)V

    invoke-static {}, Ln2g;->b()Lc2g;

    move-result-object p1

    invoke-virtual {p4, p1}, Lj3c;->h(Lc2g;)Lh5c;
    ...
    invoke-direct {v0, p1, p4, v1}, Ln4c;-><init>(Lj3c;Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p3}, Llj7;-><init>(Ljava/lang/Object;)V

    new-instance p3, Lm3c;

    const/4 p4, 0x1

    invoke-direct {p3, v0, p1, p4}, Lm3c;-><init>(Lj3c;Ljava/lang/Object;I)V

    invoke-static {}, Lyg;->a()Lc2g;

    move-result-object p1

    invoke-virtual {p3, p1}, Lj3c;->h(Lc2g;)Lh5c;
    ...
    invoke-virtual {p1, p3}, Lj3c;->i(Leg4;)Lf29;
...
.method public static synthetic a(Lfa1;Lm62;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Laah;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6(Lfa1;Lm62;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lcah;)V
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Laah;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lcah;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lcah;Lf72;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lcah;Lf72;)V

    return-void
.end method

.method public static synthetic d(Lcah;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lcah;)V

    return-void
.end method

.method public static synthetic e(Lcah;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1$lambda$0(Lcah;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lvu1;)Lm62;
    .locals 3
    ...
    invoke-direct {v0, p2, v1, v2}, Lm62;-><init>(Lvu1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Ll62;->a:Lm62;

    iget-object v1, v1, Lm62;->b:Lvu1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lfa1;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lu9h;

    move-result-object v6

    invoke-virtual {v6}, Lu9h;->e()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lvu1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lvu1;)Lm62;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Le3f;
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Lfa1;Lm62;)Lu9h;
    ...
    invoke-static {v2, v3, v0, v4}, Le2j;->k(Le3f;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private final loadWaitingParticipantIdsPageSingle(Lfa1;Lm62;)Lu9h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Lfhj;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Ln5c;

    const/4 p2, 0x1

    invoke-direct {p1, p2, v0}, Ln5c;-><init>(ILjava/lang/Object;)V

    return-object p1
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6(Lfa1;Lm62;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lcah;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lf6d;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Lwdi;

    const/16 v1, 0x11

    invoke-direct {p2, v1, p3}, Lwdi;-><init>(ILjava/lang/Object;)V

    iget-object p3, p0, Lfa1;->k:Lb7h;
    ...
    iget-object v5, p1, Lm62;->b:Lvu1;

    invoke-virtual {v5}, Lvu1;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, Lin7;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Lo91;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lz91;

    const/4 v0, 0x0

    invoke-direct {p0, v0, p2}, Lz91;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p3, v1, v4, p1, p0}, Lb7h;->d(Lf7h;ZLy6h;Ly6h;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lcah;Lf72;)V
    .locals 8

    iget-object v2, p2, Lf72;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lcah;Lf72;Lcah;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$2;-><init>(Lcah;)V
    ...
    invoke-virtual {p0, p1}, Laah;->b(Ljava/lang/Object;)V

    return-void
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lcah;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Laah;->c(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v1, v0, Ll62;->b:Lij1;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lij1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v0, v0, Ll62;->a:Lm62;

    iget-object v0, v0, Lm62;->b:Lvu1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lvu1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lu9h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lcah;)V
    .locals 4
    ...
    invoke-direct {v1, v2, p2}, Lcg4;-><init>(ILjava/lang/Object;)V

    new-instance v2, Lmah;

    const/16 v3, 0x1d

    invoke-direct {v2, p2, v3, p1}, Lmah;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lfg4;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$1$lambda$0(Lcah;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, Laah;->a(Ljava/lang/Throwable;)V

    return-void
.end method

.method private final resolveInternalIds(Ljava/util/List;Lgi7;Lgi7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lgi7;Lgi7;)V

    new-instance p1, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p1, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lgi7;)V
...
.method private final scheduleLoad()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lmle;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lt64;
...
.method public final setCall(Lfa1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lfa1;
