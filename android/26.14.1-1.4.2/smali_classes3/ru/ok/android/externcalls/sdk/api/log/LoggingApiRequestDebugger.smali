...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "exception",
        "debugIoException",
        "(Lro;Lip;Ljava/io/IOException;)V",
        "Le3f;",
        "Lsp;",
...
.field private final sessionStore:Lsp;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lz95;)V
...
.method public constructor <init>(Le3f;Lsp;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Le3f;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lsp;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Le3f;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Ls2d;
    .locals 2
...
.method private final getParams(Lip;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lip;)Ljava/lang/String;
...
.method private final getRawParams(Lip;)Ljava/lang/String;
    .locals 3
    ...
    invoke-direct {v1, v0}, Limd;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Limd;->q()V

    invoke-interface {p1, v1}, Lip;->writeParams(Lpz8;)V

    invoke-virtual {v1}, Limd;->n()V

    invoke-virtual {v1}, Limd;->flush()V
    :try_end_0
    ...
    :catch_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Le3f;

    const-string v1, "CallsApiDebug"

    const-string v2, "failed to log request params"

    invoke-interface {p1, v1, v2}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lsp;
    ...
    iget-object v0, v0, Lrp;->c:Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Ls2d;
...
.method public debugApiRequest(Lro;Lip;Lto;)V
    ...
    instance-of p1, p2, Llp;

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lip;)Ljava/lang/String;

    move-result-object p1

    const-string p3, "start with params "

    invoke-static {p3, p1}, Lgh2;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Le3f;
    ...
    invoke-static {v0, p2, v1, p1}, Lpc2;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugApiResponseFail(Lro;Lip;Lhz8;)Lhz8;
    ...
    invoke-interface {p3}, Lhz8;->j0()Ljava/lang/String;
    ...
    invoke-static {v1, p2, v2, p3}, Lpc2;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string p3, "CallsApiDebug"

    invoke-interface {v0, p3, p2}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Liz8;->l(Ljava/lang/String;)Liz8;
...
.method public debugIoException(Lro;Lip;Ljava/io/IOException;)V
    ...
    invoke-static {v0, p2, v1}, Lka8;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string v0, "CallsApiDebug"

    invoke-interface {p1, v0, p2, p3}, Le3f;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
