...
# direct methods
.method public constructor <init>(Lei7;Lnii;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->getEventualStatSender:Lei7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->timeProvider:Lnii;
...
# virtual methods
.method public final onServerTopologyRequested(Lxmi;)V
    .locals 4

    instance-of v0, p1, Lwmi;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->timeProvider:Lnii;
    ...
    :goto_1
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;->getEventualStatSender:Lei7;
    ...
    iget-object p1, p1, Lxmi;->a:Lvmi;

    iget-object p1, p1, Lvmi;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, p1, v0, v1}, Lhj1;->c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
