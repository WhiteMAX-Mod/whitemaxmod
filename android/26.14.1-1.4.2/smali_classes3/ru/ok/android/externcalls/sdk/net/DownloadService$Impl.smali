...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lu9h;",
        "Le3f;",
        "Companion",
        "calls-sdk_release"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lz95;)V
...
.method public constructor <init>(Le3f;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Le3f;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Laah;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lcah;)V

    return-void
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;)Le3f;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Le3f;

    return-object p0
.end method

.method private static final download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lcah;)V
    .locals 8
    ...
    invoke-static {p1, v1, v1}, Lprl;->a(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    invoke-virtual {p2, v0}, Laah;->a(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    invoke-static {p1}, Lgsl;->b(Ljava/io/File;)V
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Ljw7;
    ...
    invoke-virtual {p2, p3}, Laah;->b(Ljava/lang/Object;)V
    ...
    :goto_3
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Le3f;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lpc2;->z(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {p0, p3, p1}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p0}, Lgsl;->a(Ljava/io/File;Lgi7;)V

    check-cast p4, Laah;

    invoke-virtual {p4}, Laah;->f()Z

    move-result p0

    if-nez p0, :cond_5

    invoke-virtual {p4, p2}, Laah;->a(Ljava/lang/Throwable;)V
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v2, v0, p3}, Lw9j;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v5, p2}, Lqt6;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lu9h;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lno;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
