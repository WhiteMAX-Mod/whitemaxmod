...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Le3f;)V",
        "Lb2j;",
        "drainEmitters",
        "()V",
        "requestReadSettings",
...
.field private final requestSettingsDisposable:Ljo5;

.field private final wantedSettings:Lpw0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lpw0;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$Companion;-><init>(Lz95;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Le3f;)V
    .locals 6
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Le3f;
    ...
    invoke-direct {v1, p1}, Lpw0;-><init>(Ljava/io/Serializable;)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lpw0;
    ...
    invoke-direct/range {v0 .. v5}, Lk5c;-><init>(Lj3c;JLjava/util/concurrent/TimeUnit;Lc2g;)V
    ...
    invoke-virtual {v0, p1}, Lj3c;->a(Ltxd;)Ln4c;
    ...
    invoke-direct {v0, p1, p2, v1}, Ln4c;-><init>(Lj3c;Ljava/lang/Object;I)V

    invoke-static {}, Lyg;->a()Lc2g;

    move-result-object p1

    invoke-virtual {v0, p1}, Lj3c;->h(Lc2g;)Lh5c;
    ...
    invoke-direct {v2, p2, v0, v1}, Lf29;-><init>(Leg4;Leg4;Lg8;)V

    invoke-virtual {p1, v2}, Lj3c;->j(Lc6c;)V

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Ljo5;
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;)Le3f;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Le3f;
...
.method public static synthetic b(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Laah;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lcah;)V
...
.method private static final get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lcah;)V
    .locals 2

    new-instance v0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;

    invoke-direct {v0, p0, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;-><init>(Ljava/lang/String;Lcah;)V
    ...
    invoke-static {p2, v0}, Lno5;->g(Ljava/util/concurrent/atomic/AtomicReference;Lri2;)V
...
.method private final requestReadSettings()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lpw0;

    invoke-virtual {v1, v0}, Lpw0;->b(Ljava/lang/Object;)V
...
.method public get(Ljava/lang/String;)Lu9h;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Le3f;
    ...
    invoke-direct {v0, p1, v1, p0}, Lw4b;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Ljo5;
