...
.method public static fromExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lvu1;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Lvu1;)V

    :cond_0
    return-object v0
.end method

.method public static fromInternal(Lvu1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
# virtual methods
.method public deAnonymize(Lav1;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lav1;
...
.method public getAcceptCallEpochMs()J
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lav1;

    if-eqz v0, :cond_0

    iget-wide v0, v0, Lav1;->n:J
...
.method public getAcceptedCallClientType()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Lav1;->l:Ljava/lang/String;
...
.method public getAcceptedCallPlatform()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Lav1;->m:Ljava/lang/String;

    return-object v0
.end method

.method public getAudioOptionState()Lt7a;
    .locals 1
...
.method public getCallParticipant()Lav1;
    .locals 1
...
.method public getInternalId()Lvu1;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lvu1;
...
.method public getMovies()Ljava/util/List;
    ...
    :cond_0
    iget-object v0, v0, Lav1;->r:Ljava/util/List;

    return-object v0
.end method

.method public getNetworkStatus()Lcqb;
    .locals 1
    ...
    :cond_0
    iget-object v0, v0, Lav1;->j:Lcqb;

    return-object v0
.end method

.method public getScreenshareOptionState()Lt7a;
    .locals 1
...
.method public getVideoOptionState()Lt7a;
    .locals 1
...
.method public getWatchTogetherOptionState()Lt7a;
    .locals 1
...
.method public hasRegisteredPeers()Z
    ...
    iget-object v0, v0, Lav1;->f:Ljava/util/HashMap;
...
.method public isAdmin()Z
    ...
    iget-object v0, v0, Lav1;->e:Ljava/util/List;
...
.method public setCallParticipant(Lav1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lvu1;
...
.method public setDeviceIndex(ILru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    iget-wide v2, v0, Lvu1;->a:J

    iget v0, v0, Lvu1;->b:I

    invoke-direct {v1, v0, p1, v2, v3}, Lvu1;-><init>(IIJ)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lvu1;
    ...
    iget-wide v3, v1, Lvu1;->a:J

    iget v1, v1, Lvu1;->b:I

    invoke-direct {v2, v1, p1, v3, v4}, Lvu1;-><init>(IIJ)V

    iput-object v2, v0, Lav1;->a:Lvu1;

    iget-object v1, v0, Lav1;->q:Lij1;

    if-eqz v1, :cond_3

    new-instance v2, Lij1;

    iget-object v3, v1, Lij1;->a:Ljava/lang/String;

    iget v1, v1, Lij1;->b:I

    invoke-direct {v2, v3, v1, p1}, Lij1;-><init>(Ljava/lang/String;II)V

    iput-object v2, v0, Lav1;->q:Lij1;
...
.method public setInternalId(Lvu1;)V
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lvu1;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lav1;
