...
.method private handleCallAccepted(Lav1;)V
    .locals 3
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->X(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lfa1;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lav1;
...
.method private handleHangup(Lfa1;Ljava/lang/Object;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    iget-object v1, p1, Lfa1;->K:Lvv7;

    invoke-static {v0, v1, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->y0(Lru/ok/android/externcalls/sdk/ConversationImpl;Lvv7;Ljava/lang/Object;)Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;
    ...
    iget-object v1, p1, Lfa1;->e1:Ly4a;
...
.method private handleMuteParticipant(Lhlb;)V
    .locals 2

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->shouldNotifyLegacyListener(Lhlb;)Z
    ...
    iget-object v1, p1, Lhlb;->a:Lglb;

    invoke-interface {v0, v1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteChanged(Lglb;)V
    ...
    iget-object p1, p1, Lhlb;->a:Lglb;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteChanged(Lglb;)V

    return-void
.end method

.method private handleMuteStateInitialized(Lhlb;)V
    .locals 1

    iget-boolean v0, p1, Lhlb;->b:Z
    ...
    invoke-interface {v0, p1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteStateInitialized(Lglb;)V
    ...
    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteStateInitialized(Lglb;)V

    return-void
.end method

.method private handleRolesChanged(Lav1;)V
    .locals 2
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lav1;
    ...
    invoke-virtual {v0, p1, v1}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lav1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method private maybeInitP2PRelaySwitchTrigger()V
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->d0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lsu1;
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->r0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lru/ok/android/externcalls/sdk/api/RemoteSettings;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->l0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Le3f;

    move-result-object v1

    invoke-direct {v7, v0, v1}, Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProviderImpl;-><init>(Lru/ok/android/externcalls/sdk/api/RemoteSettings;Le3f;)V
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->X(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lfa1;
    ...
    invoke-direct {v5, v1, v6}, Lk91;-><init>(Lfa1;I)V
    ...
    invoke-direct/range {v2 .. v7}, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;-><init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;Le3f;Lei7;Lru/ok/android/externcalls/sdk/stat/ConversationStats;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProvider;)V
...
.method private shouldNotifyLegacyListener(Lhlb;)Z
    .locals 3
    ...
    iget-object v0, p1, Lglb;->a:Ljava/util/AbstractMap;

    iget-object p1, p1, Lglb;->b:Ljava/util/Set;
...
.method public onAsrOnlineAvailableChanged()V
    ...
    sget-object v2, Lda1;->f:Lda1;

    iget-object v1, v1, Lfa1;->t:Ljava/util/EnumSet;
...
.method public onCallParticipantFingerprint(Lav1;J)V
    .locals 3
...
.method public onCallParticipantNetworkStatusChanged(Ljava/util/List;)V
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lav1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lnog;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lnog;
...
.method public onCustomData(Lvu1;Lorg/json/JSONObject;)V
    .locals 0
...
.method public onEvent(Lfa1;Lpi1;Ljava/lang/Object;)V
    .locals 6

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->l0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Le3f;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStopped(Lyeb;)V

    return-void

    :pswitch_2
    instance-of p1, p3, Lxeb;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStatesUpdatedChanged(Lxeb;)V

    return-void

    :pswitch_3
    instance-of p1, p3, Lveb;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStarted(Lveb;)V
    ...
    :pswitch_6
    instance-of p1, p3, Lhlb;

    if-eqz p1, :cond_6

    check-cast p3, Lhlb;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteStateInitialized(Lhlb;)V
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteParticipant(Lhlb;)V

    return-void

    :pswitch_8
    instance-of p1, p3, Lvu1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lav1;)V

    goto :goto_1

    :pswitch_a
    instance-of p1, p3, Lav1;

    if-eqz p1, :cond_6

    check-cast p3, Lav1;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lav1;)V
    ...
    :pswitch_d
    invoke-virtual {p1, v1}, Lfa1;->F(Z)V
    ...
    :pswitch_e
    invoke-virtual {p1, v2}, Lfa1;->F(Z)V
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeaturesPerRoleChanged(Ltj1;)V

    return-void

    :pswitch_13
    instance-of p1, p3, Lsj1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeatureSetChanged(Lsj1;)V
    ...
    :cond_3
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleCallAccepted(Lav1;)V
    ...
    iget-object v0, p1, Lfa1;->e1:Ly4a;
    ...
    sget-object v0, Lvv7;->f:Lvv7;

    sget-object v1, Ljava/util/Collections;->EMPTY_SET:Ljava/util/Set;

    invoke-direct {p3, v0, v1, v3}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;-><init>(Lvv7;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iget-object p2, p1, Lfa1;->e1:Ly4a;
    ...
    invoke-virtual {p2, p3}, Ly4a;->I(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;)V
    ...
    :pswitch_1c
    invoke-direct {p0, p1, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleHangup(Lfa1;Ljava/lang/Object;)V
    ...
    invoke-static {p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->w0(Lru/ok/android/externcalls/sdk/ConversationImpl;)V
    ...
    invoke-static {p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->U(Lru/ok/android/externcalls/sdk/ConversationImpl;)I

    move-result p2

    int-to-long v3, p2

    iget-object v1, p1, Lfa1;->e0:Lg2h;

    iget-object p1, v1, Lg2h;->a:Ljava/util/concurrent/ExecutorService;
...
.method public onStateChanged(Lvu1;Lxu1;)V
    .locals 2
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->fromInternal(Lvu1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-interface {v1, v0, p2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onStateChanged(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lxu1;)V
    ...
    invoke-virtual {v0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/state/internal/ParticipantStatesManagerImpl;->onStateChanged(Lvu1;Lxu1;)V
