...
.method private final getPosition(Ljava/lang/Long;)Lreb;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lpeb;-><init>(J)V
...
.method private final sendActualState(Lru/ok/android/externcalls/sdk/watch_together/listener/WatchTogetherListener;)V
    ...
    invoke-direct {v1, p0, v2, p1}, Lzyj;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method private final updateState(Lxeb;)V
    .locals 12
    ...
    iget-object p1, p1, Lxeb;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lweb;->a:Ld62;

    iget-object v3, v3, Ld62;->b:Lvu1;
    ...
    iget-object v11, v3, Ld62;->c:Loeb;
    ...
    sget-object v5, Lueb;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lleb;->d:Lteb;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lleb;->a:Loeb;

    invoke-virtual {v8, v11}, Loeb;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Lweb;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lreb;

    move-result-object v5

    iget-boolean v2, v1, Lweb;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Lweb;->b:F

    invoke-static {v7}, Lbfb;->a(F)V

    iget-boolean v8, v1, Lweb;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lreb;ZFZLleb;Lz95;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lnog;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Lleb;)V
...
.method public final onVideoStarted(Lveb;)V
    .locals 12
    ...
    iget-object v11, v7, Lleb;->a:Loeb;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lreb;ZFZLleb;Lz95;)V
    ...
    iget-object p1, p1, Lveb;->b:Lnog;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Lleb;)V
...
.method public final onVideoStatesUpdatedChanged(Lxeb;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lxeb;)V
...
.method public final onVideoStopped(Lyeb;)V
    .locals 4
    ...
    iget-object v2, p1, Lyeb;->b:Lnog;

    iget-object v3, p1, Lyeb;->c:Loeb;

    iget-object p1, p1, Lyeb;->d:Lteb;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Loeb;Lteb;)V
