...
.field private final noise:Ldkk;
...
.method public constructor <init>(SLandroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ldkk;
...
.method public onSample(IIILr1d;)V
    ...
    invoke-virtual {p4, p2}, Lr1d;->a(I)S
    ...
    :goto_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ldkk;
    ...
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ldkk;
