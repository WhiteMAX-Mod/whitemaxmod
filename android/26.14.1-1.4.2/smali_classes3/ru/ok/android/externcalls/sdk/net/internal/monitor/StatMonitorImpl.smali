...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(Lg3f;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Lj3c;",
        "observeStat",
        "()Lj3c;",
        "rtcStat",
...
.field private final statSubject:Lpw0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Lz95;)V
...
.method public constructor <init>(Le3f;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Le3f;

    new-instance p1, Lpw0;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lpw0;-><init>(Ljava/io/Serializable;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lpw0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Le3f;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Le3f;

    return-object p0
.end method

.method private final mapToMonitoringStat(Lg3f;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILz95;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Lyi2;->h:Ljava/lang/String;

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    invoke-static {v1}, Lzvh;->i0(Ljava/lang/String;)Ljava/lang/Float;
    ...
    :goto_0
    iget-object p1, p1, Lg3f;->b:Ljava/util/List;

    invoke-static {p1, v0}, Lwol;->d(Ljava/util/List;Lyi2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Le3f;
    ...
    :cond_6
    iget-object v4, v5, Lhhh;->i:Ljava/math/BigInteger;

    iget-object v5, v5, Lhhh;->h:Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Le3f;
    ...
    :cond_b
    iget-object p1, v5, Lhhh;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Lhhh;->h:Ljava/math/BigInteger;
    ...
    :goto_6
    iget-object p1, v0, Lyi2;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Le3f;
    ...
    invoke-interface {p1, v2, v1}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public observeStat()Lj3c;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lpw0;
    ...
    invoke-direct {v1, v0, v2}, Lc4c;-><init>(Lj3c;I)V

    return-object v1
.end method

.method public onRtcStats(Lg3f;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(Lg3f;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
