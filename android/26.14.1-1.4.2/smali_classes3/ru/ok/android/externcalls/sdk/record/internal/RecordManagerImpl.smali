...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "toRecordDescription",
        "(Lax1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;",
        ...
        "current",
        "setMyRecordHistory",
        "(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V",
        "reportStarted",
        "()V",
        "whoStoppedRecordId",
        "reportStopped",
        ...
        "onError",
        "startRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lei7;Lgi7;)V",
        "Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;",
        "stopRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lei7;Lgi7;)V",
...
# instance fields
.field private activeRoomId:Lnog;

.field private final commandParamsCreator:Lmaf;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl$Companion;-><init>(Lz95;)V
...
.method public constructor <init>(Le3f;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lru/ok/android/externcalls/sdk/events/RecordEventListener;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Le3f;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lmaf;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnog;

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgi7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgi7;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final applyRecordStarted(Lcx1;)V
    .locals 2

    iget-object v0, p1, Lcx1;->b:Lax1;

    iget-object p1, p1, Lcx1;->a:Lnog;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->toRecordDescription(Lax1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    ...
    invoke-direct {p0, v1, p1, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnog;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lcx1;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lcx1;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lei7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lei7;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgi7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgi7;Lorg/json/JSONObject;)V
...
.method public static synthetic f(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lei7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lei7;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final notifyListenersWhenActiveRoomChanged(Lnog;Lnog;)V
    .locals 1
...
.method private static final onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lcx1;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->applyRecordStarted(Lcx1;)V
...
.method private static final onRecordStarted$lambda$5(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Le3f;
...
.method private final setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    .locals 3
...
.method private static final startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lei7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnSuccess()Lgi7;
...
.method private static final startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgi7;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnError()Lgi7;
    ...
    invoke-interface {p2, p0}, Lgi7;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_2
    return-void
.end method

.method private static final stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lei7;Lorg/json/JSONObject;)V
    .locals 1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnSuccess()Lgi7;
...
.method private static final stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgi7;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnError()Lgi7;
...
.method private final toRecordDescription(Lax1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    .locals 9

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lax1;->c:Lvu1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lvu1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v2, p1, Lax1;->b:Lkdf;

    iget-wide v3, p1, Lax1;->d:J

    iget-wide v5, p1, Lax1;->a:J

    iget-object v7, p1, Lax1;->e:Ljava/lang/String;

    iget-object v8, p1, Lax1;->f:Ljava/lang/String;

    invoke-direct/range {v0 .. v8}, Lru/ok/android/externcalls/sdk/record/RecordDescription;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lkdf;JJLjava/lang/String;Ljava/lang/String;)V
...
.method public final getRecordAdmin()Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnog;
...
.method public onCurrentParticipantActiveRoomChanged(Lo12;)V
    .locals 1

    iget-object p1, p1, Lo12;->a:Lnog;
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->notifyListenersWhenActiveRoomChanged(Lnog;Lnog;)V

    return-void
.end method

.method public bridge synthetic onCurrentParticipantInvitedToRoom(Lp12;)V
    .locals 0

    return-void
.end method

.method public onRecordError(Lbx1;)V
    .locals 0
...
.method public onRecordStarted(Lcx1;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lcx1;->b:Lax1;

    iget-object v1, v1, Lax1;->c:Lvu1;
    ...
    invoke-direct {v2, p0, v3, p1}, Ljdf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p1, Lq98;

    const/16 v3, 0x1d

    invoke-direct {p1, v3, p0}, Lq98;-><init>(ILjava/lang/Object;)V
...
.method public onRecordStopped(Ldx1;)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->sessionRoomToRecordInfo:Ljava/util/HashMap;

    iget-object v1, p1, Ldx1;->a:Lnog;
    ...
    :goto_0
    invoke-direct {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnog;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
...
.method public bridge synthetic onRoomRemoved(Lq12;)V
    .locals 0

    return-void
.end method

.method public bridge synthetic onRoomUpdated(Lr12;)V
    .locals 0
...
.method public startRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lei7;Lgi7;)V
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v3, v2}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lgi7;)Lb7h;
    ...
    :cond_0
    iget-object v4, v1, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lmaf;
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getSessionRoomId()Lnog;

    move-result-object v7

    if-nez v7, :cond_1

    iget-object v7, v1, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnog;
    ...
    invoke-static {v5, v4}, Lzjl;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lin7;

    move-result-object v4

    instance-of v5, v7, Lmog;
    ...
    invoke-virtual {v4, v6, v5}, Lin7;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v5, v0, v7, v6}, Lidf;-><init>(Ljava/lang/Object;Lei7;I)V

    new-instance v6, Lo91;

    const/4 v7, 0x5

    invoke-direct {v6, v1, v0, v2, v7}, Lo91;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 v0, 0x0

    invoke-virtual {v3, v4, v0, v5, v6}, Lb7h;->d(Lf7h;ZLy6h;Ly6h;)V
...
.method public stopRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lei7;Lgi7;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p3}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lgi7;)Lb7h;
    ...
    :cond_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lmaf;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getSessionRoomId()Lnog;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnog;
    ...
    invoke-static {v1, v4}, Lzjl;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lin7;

    move-result-object v1

    iget-object v5, v1, Lin7;->a:Lorg/json/JSONObject;

    const-string v6, "command"

    invoke-virtual {v5, v6, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    instance-of v4, v2, Lmog;
    ...
    invoke-virtual {v1, v2, v4}, Lin7;->b(ILjava/lang/String;)V
    ...
    invoke-direct {v2, p1, p2, v3}, Lidf;-><init>(Ljava/lang/Object;Lei7;I)V

    new-instance p2, Lo91;

    const/4 v3, 0x4

    invoke-direct {p2, p0, p1, p3, v3}, Lo91;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 p1, 0x0

    invoke-virtual {v0, v1, p1, v2, p2}, Lb7h;->d(Lf7h;ZLy6h;Ly6h;)V
