...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lb2j;",
        "init",
        "(Lts1;Lorg/webrtc/RendererCommon$GlDrawer;)V",
...
# instance fields
.field private final callVideoDrawer:La62;

.field private final drawerListener:Lz52;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:La62;
    ...
    invoke-direct {p1, p0}, Lnxj;-><init>(Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lz52;
...
.method public clearImage()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:La62;

    iget-object v1, v0, La62;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, v0, La62;->g:Lts1;

    if-eqz v2, :cond_0

    iget-object v2, v2, Lts1;->e:Lrs1;

    new-instance v3, Lgt8;

    const/4 v4, 0x4

    invoke-direct {v3, v4, v0}, Lgt8;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v2, v3}, Lrs1;->c(Lgi7;)Z
    :try_end_0
...
.method public createEglSurface(Landroid/view/Surface;)V
    ...
    iget-object v4, v0, La62;->j:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v4, p1}, Lrrk;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :cond_0
    iput-object p1, v0, La62;->i:Landroid/view/Surface;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public init(Lts1;Lorg/webrtc/RendererCommon$GlDrawer;)V
    .locals 5
    ...
    :cond_0
    :try_start_1
    iput-object p1, v0, La62;->g:Lts1;

    iget-object v2, p1, Lts1;->e:Lrs1;

    new-instance v3, Ltmk;

    const/4 v4, 0x1

    invoke-direct {v3, v0, p2, p1, v4}, Ltmk;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {v2, v3}, Lrs1;->c(Lgi7;)Z

    iget-object p2, v0, La62;->i:Landroid/view/Surface;

    if-eqz p2, :cond_1

    iget-object v2, p1, Lts1;->a:Le3f;

    iget-object v3, v0, La62;->j:Ljava/lang/String;
    ...
    iget-object p1, p1, Lts1;->e:Lrs1;

    new-instance v2, Lrrk;

    const/4 v3, 0x2

    invoke-direct {v2, v0, v3, p2}, Lrrk;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {p1, v2}, Lrs1;->c(Lgi7;)Z
    ...
    :goto_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:La62;

    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lz52;

    iget-object p1, p1, La62;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v1, v0, La62;->l:Lb62;

    iget-object v1, v1, Lb62;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    :try_start_1
    iget-object v3, v0, La62;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v3, v2, Lts1;->e:Lrs1;

    new-instance v4, Lnuk;

    invoke-direct {v4, v0, v2}, Lnuk;-><init>(Lss1;Lts1;)V
    ...
    :try_start_2
    iget-object v2, v3, Lrs1;->k:Lcuk;

    new-instance v5, Lqs1;

    const/4 v6, 0x0

    invoke-direct {v5, v4, v3, v6}, Lqs1;-><init>(Lgi7;Lrs1;I)V
    ...
    :try_start_3
    iget-object v4, v3, Lrs1;->a:Le3f;

    iget-object v3, v3, Lrs1;->j:Ljava/lang/String;

    const-string v5, "OpenGL tread died, is it fine?"

    invoke-interface {v4, v3, v5, v2}, Le3f;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    iget-object p1, v0, La62;->l:Lb62;

    iget-object p1, p1, Lb62;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public release()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lz52;

    iget-object v0, v0, La62;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lnuk;-><init>(Lts1;Lss1;)V

    invoke-virtual {v3, v4}, Lrs1;->c(Lgi7;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public releaseEglSurface(Lei7;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iput-object v2, v0, La62;->i:Landroid/view/Surface;
    ...
    invoke-direct {v4, v2, v0, p1, v5}, Ltmk;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public setFpsReduction(F)V
    ...
    iget-object v0, v0, La62;->e:Luw;

    monitor-enter v0

    :try_start_0
    iget-wide v1, v0, Luw;->c:J
