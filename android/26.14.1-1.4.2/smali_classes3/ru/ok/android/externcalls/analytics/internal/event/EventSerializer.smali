...
.method private final writeValue(Lpz8;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
    .locals 2
    ...
    invoke-virtual {p1, v0, v1}, Li2;->G(D)V
    ...
    invoke-virtual {p1, p2}, Li2;->J(I)V
    ...
    invoke-virtual {p1, p2}, Li2;->d(Ljava/lang/String;)V
    ...
    invoke-interface {p1, p2}, Lpz8;->i(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-iurDigI(Lpz8;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-4i0utlQ(Lpz8;Ljava/util/Map;)V

    :cond_5
    return-void
.end method

.method private final writeValue-4i0utlQ(Lpz8;Ljava/util/Map;)V
    .locals 2
...
.method private final writeValue-iurDigI(Lpz8;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final serialize(Lpz8;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    .locals 2
    ...
    invoke-direct {p0, p1, v0}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue(Lpz8;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
