...
.method public final l0()Landroid/app/Dialog;
    ...
    invoke-static {v2}, Ld5f;->u0(Landroid/content/Context;)Lqai;
    ...
    iget-object v7, v7, Lboe;->a:Lune;

    iget-boolean v9, v7, Lune;->f:Z

    iget-object v10, v7, Lune;->a:Lpne;

    iget-object v10, v10, Lpne;->a:Ljava/lang/String;
    ...
    iget-wide v13, v7, Lune;->e:J

    const/4 v7, 0x0

    invoke-static {v13, v14, v8, v7}, Lxfi;->v(JZLandroid/content/Context;)Ljava/lang/String;

    move-result-object v7

    if-eqz v9, :cond_3

    invoke-static {v12, v7}, Lgh2;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Landroidx/fragment/app/a;->u(I)Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v3}, Lks9;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v2}, Lks9;->a(Ljava/lang/String;)Lks9;
    ...
    invoke-direct {v3, p0, v0}, Ltpj;-><init>(Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;Ljava/util/ArrayList;)V

    iget-object v0, v1, Lqf;->a:Lmf;

    iput-object v2, v0, Lmf;->n:[Ljava/lang/CharSequence;

    iput-object v3, v0, Lmf;->p:Landroid/content/DialogInterface$OnClickListener;

    iput v5, v0, Lmf;->s:I

    iput-boolean v8, v0, Lmf;->r:Z
    ...
    iput-object v0, v3, Lmf;->k:Ljava/lang/CharSequence;

    iput-object v2, v3, Lmf;->l:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v1}, Lks9;->create()Lrf;
