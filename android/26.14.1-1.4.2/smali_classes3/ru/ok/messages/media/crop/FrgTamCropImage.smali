...
.field public y1:Lone/me/image/crop/view/ImageCropView;
...
.method public final I(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p3, Lmxe;->frg_tam_crop_image:I
...
.method public final U(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->y1:Lone/me/image/crop/view/ImageCropView;

    invoke-virtual {v0}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lgy4;
...
.method public final X(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    sget v0, Lrwe;->frg_tam_crop_image__iv_crop:I
    ...
    iput-object v0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->y1:Lone/me/image/crop/view/ImageCropView;
    ...
    sget v0, Lrwe;->frg_tam_crop_image__rotate:I
    ...
    sget v0, Lrwe;->frg_tam_crop_image__flip:I
    ...
    sget v0, Lrwe;->frg_tam_crop_image__btn_clear:I
    ...
    iput-object v0, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->D1:Landroid/widget/TextView;

    sget v0, Lrwe;->frg_tam_crop_image__btn_done:I
    ...
    sget v0, Lrwe;->frg_tam_crop_image__btn_close:I
    ...
    iput-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->C1:Landroid/widget/ImageButton;
    ...
    invoke-static {v10, v0, p1}, Le65;->l(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_0
    :try_start_0
    iget-object p2, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->y1:Lone/me/image/crop/view/ImageCropView;

    iget-object p2, p2, Lone/me/image/crop/view/ImageCropView;->a:Lvn7;

    invoke-virtual {p2}, Ltri;->getMaxBitmapSize()I
    ...
    invoke-direct {v9, p2}, Lulb;-><init>(Ljava/lang/Object;)V

    new-instance v3, Ldz0;

    move v8, v7

    invoke-direct/range {v3 .. v9}, Ldz0;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILulb;)V
    ...
    iput-object p1, p2, Ltn8;->N0:Lgy4;
    :try_end_0
    ...
    invoke-static {v10, p2, p1}, Le65;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, p1, p2}, Lnrl;->b(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, v2}, Lth7;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-direct {p2, p0, v1}, Lth7;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    invoke-static {p1, p2}, Lchl;->a(Landroid/view/View;Lg8;)V

    iget-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->D1:Landroid/widget/TextView;

    new-instance p2, Lth7;

    const/4 v0, 0x2

    invoke-direct {p2, p0, v0}, Lth7;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-virtual {p2}, Lqai;->b()Landroid/graphics/drawable/RippleDrawable;
