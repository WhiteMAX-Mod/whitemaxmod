...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p2, p3, p0}, Lnn;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {p1, p0, p2, p3}, Lpn;-><init>(Lru/ok/tamtam/animoji/views/AnimojiTextView;Lnn;Ll;)V

    iput-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->h:Lpn;

    .line 3
    iget-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->i:Ls2d;
    ...
    .line 8
    iput-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->i:Ls2d;
...
.method public final getAnimojiEnabled()Z
    ...
    iget-object v0, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->h:Lpn;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2, v3}, Lqk;->b(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, v0, Lpn;->e:Ljava/lang/Object;
    ...
    invoke-static {v2, p1}, Lqk;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setText(Ljava/lang/CharSequence;Landroid/widget/TextView$BufferType;)V
    ...
    iput-object v0, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->i:Ls2d;
    ...
    iget-object v2, v0, Lpn;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v4, p1}, Ll16;->f(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2, p1, p2}, Lnn;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_6

    :cond_8
    invoke-virtual {v3, v4}, Lnm;->a(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    :cond_9
    invoke-interface {v1}, Lm16;->a()Z

    move-result p1

    if-eqz p1, :cond_a

    invoke-interface {v1, v5}, Lm16;->setEmojiCompatEnabled(Z)V
    ...
    iget-object p1, v0, Lpn;->f:Ljava/lang/Object;
    ...
    invoke-direct {p1, v1}, Lpm;-><init>(Lru/ok/tamtam/animoji/views/AnimojiTextView;)V

    iput-object p1, v0, Lpn;->f:Ljava/lang/Object;
    ...
    invoke-static {p1, v3, v0}, Lq8l;->a(Landroid/text/Spannable;Ljava/util/ArrayList;Lnm;)V

    invoke-static {v4}, Lq8l;->e(Ljava/lang/CharSequence;)V

    :goto_5
    invoke-virtual {v2, v4, p2}, Lnn;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
