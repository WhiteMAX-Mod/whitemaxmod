...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p2, p1}, Lc1e;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->b:Lc1e;

    .line 5
    new-instance p3, Lz49;

    .line 6
    invoke-direct {p3, p1}, Lof2;-><init>(Landroid/content/Context;)V

    .line 7
    iput-object p3, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->c:Lz49;
    ...
    iput-object v0, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->d:Lig2;
    ...
    .line 11
    iput-object v2, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->e:Ln5i;
    ...
    .line 17
    invoke-virtual {p2}, Lc1e;->getPreviewStreamState()Lsc9;
    ...
    invoke-direct {v3, v2}, Lth2;-><init>(Ll;)V

    invoke-virtual {p1, v0, v3}, Lsc9;->e(Lr59;Ld6c;)V

    .line 18
    sget-object p1, Lz0e;->c:Lz0e;

    invoke-virtual {p2, p1}, Lc1e;->setImplementationMode(Lz0e;)V

    .line 19
    sget-object p1, Ldh2;->c:Ldh2;

    invoke-virtual {p3, p1}, Lof2;->m(Ldh2;)V

    .line 20
    invoke-virtual {p3, v1}, Lof2;->n(I)V

    .line 21
    invoke-virtual {p2}, Lc1e;->getViewPort()Lqvj;

    .line 22
    invoke-static {}, Lerl;->a()V

    .line 23
    iput-boolean v1, p3, Lof2;->x:Z

    .line 24
    invoke-virtual {p2, p3}, Lc1e;->setController(Lof2;)V

    return-void
.end method

.method public static final synthetic a(Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;)Lxg7;
    .locals 0

    invoke-direct {p0}, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->getFreezeCameraDetector()Lxg7;
...
.method private final getFreezeCameraDetector()Lxg7;
    .locals 1

    iget-object v0, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->e:Ln5i;
...
.method private final getStatusBarHeight()I
    ...
    invoke-static {v0}, Lvg;->c(Landroid/view/WindowInsets;)Landroid/graphics/Insets;
...
.method public final b()V
    ...
    :try_start_0
    iget-object v0, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->c:Lz49;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lof2;->n(I)V
    :try_end_0
    ...
    iget-object v1, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->f:Llg2;
    ...
    invoke-virtual {v1, v2}, Lr0d;->b(Lru/ok/tamtam/android/widgets/quickcamera/CameraExceptionImpl;)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->d:Lig2;

    iget-object v1, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->c:Lz49;
    ...
    iput-object v0, v1, Lz49;->K:Lr59;

    const/4 v3, 0x0

    invoke-virtual {v1, v3}, Lof2;->s(Ljava/lang/Runnable;)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setCameraListener(Llg2;)V
    .locals 0

    iput-object p1, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->f:Llg2;
...
.method public setFlash(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lae2;->valueOf(Ljava/lang/String;)Lae2;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->c:Lz49;

    invoke-virtual {p1, v0}, Lof2;->o(I)V
...
.method public setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iget-object v0, p0, Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;->b:Lc1e;
...
.method public setPictureSize(Lzoe;)V
    .locals 0

    return-void
.end method

.method public setVideoQuality(Lrpj;)V
    .locals 2
    ...
    :pswitch_0
    sget-object p1, Lhj0;->h:Lhj0;

    sget-object v1, Lei0;->c:Lei0;

    invoke-static {p1, v1}, Lpwc;->r(Lhj0;Lei0;)Lpwc;

    move-result-object p1

    invoke-virtual {v0, p1}, Lof2;->p(Lpwc;)V

    return-void

    :pswitch_1
    sget-object p1, Lhj0;->g:Lhj0;
