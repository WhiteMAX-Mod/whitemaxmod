...
.method public final g()Lzb9;
    ...
    iget-object v2, v1, Landroidx/work/WorkerParameters;->b:Ly25;

    const-string v3, "param_dump_path"

    invoke-virtual {v2, v3}, Ly25;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Ly25;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v8}, Lc48;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v7, v8}, Lf0j;->p(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v7}, Lc48;->close()V
    :try_end_5
    ...
    :try_start_9
    invoke-static {v7, v1}, Lspg;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
