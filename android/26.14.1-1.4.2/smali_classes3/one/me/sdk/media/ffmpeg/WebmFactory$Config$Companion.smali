.class public final Lone/me/sdk/media/ffmpeg/WebmFactory$Config$Companion;
...
.method public synthetic constructor <init>(Lz95;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config$Companion;-><init>()V
...
.method public final getDefaultAutoRepeat()Z
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultAutoRepeat$cp()Z
...
.method public final getDefaultAutoStart()Z
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultAutoStart$cp()Z
...
.method public final getDefaultNetworkFetchEnabled()Z
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultNetworkFetchEnabled$cp()Z
...
.method public final getDefaultPrecache()Z
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultPrecache$cp()Z
...
.method public final getDefaultShouldLimitFps()Z
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultShouldLimitFps$cp()Z
...
.method public final getDefaultSize()I
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultSize$cp()I
...
.method public final getDefaultStartDecodeFirstFrame()Z
    ...
    invoke-static {}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$getDefaultStartDecodeFirstFrame$cp()Z
...
.method public final setDefaultAutoRepeat(Z)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultAutoRepeat$cp(Z)V
...
.method public final setDefaultAutoStart(Z)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultAutoStart$cp(Z)V
...
.method public final setDefaultNetworkFetchEnabled(Z)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultNetworkFetchEnabled$cp(Z)V
...
.method public final setDefaultPrecache(Z)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultPrecache$cp(Z)V
...
.method public final setDefaultShouldLimitFps(Z)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultShouldLimitFps$cp(Z)V
...
.method public final setDefaultSize(I)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultSize$cp(I)V
...
.method public final setDefaultStartDecodeFirstFrame(Z)V
    ...
    invoke-static {p1}, Lone/me/sdk/media/ffmpeg/WebmFactory$Config;->access$setDefaultStartDecodeFirstFrame$cp(Z)V
