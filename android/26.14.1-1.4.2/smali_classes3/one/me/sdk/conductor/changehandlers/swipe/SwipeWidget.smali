...
.method public final h1(Lks4;)V
    ...
    invoke-virtual {p0, v1}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->h1(Lks4;)V
...
.method public j1()Ljava/lang/Long;
    .locals 1
...
.method public k1()Ljava/lang/Integer;
    .locals 1
...
.method public onChangeEnded(Lps4;Lqs4;)V
    ...
    invoke-super/range {p0 .. p2}, Lks4;->onChangeEnded(Lps4;Lqs4;)V

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->c1()Z
    ...
    iget-object v2, v2, Lztf;->a:Lxn0;

    iget-object v2, v2, Lxn0;->a:Ljava/util/ArrayDeque;
    ...
    invoke-virtual {v4, v1, v2, v6, v3}, Lajc;->c(Lli9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    new-instance v13, Lm0h;

    const/4 v1, 0x6

    invoke-direct {v13, v0, v1, v12}, Lm0h;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    instance-of v1, v11, Lr4i;

    if-eqz v1, :cond_a

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->k1()Ljava/lang/Integer;

    move-result-object v7

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->a1()I

    move-result v14

    new-instance v17, Lm4i;

    new-instance v8, Lt4i;

    const/4 v2, 0x0

    invoke-direct {v8, v0, v2}, Lt4i;-><init>(Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;I)V

    new-instance v9, Lt4i;

    const/4 v2, 0x1

    invoke-direct {v9, v0, v2}, Lt4i;-><init>(Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;I)V

    new-instance v10, Lt4i;

    const/4 v2, 0x2

    invoke-direct {v10, v0, v2}, Lt4i;-><init>(Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;I)V

    move-object/from16 v6, v17

    invoke-direct/range {v6 .. v14}, Lm4i;-><init>(Ljava/lang/Integer;Lt4i;Lt4i;Lt4i;Landroid/view/View;Landroid/view/ViewGroup;Lm0h;I)V

    iput-object v0, v6, Lm4i;->s:Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->j1()Ljava/lang/Long;

    move-result-object v2

    iput-object v2, v6, Lm4i;->t:Ljava/lang/Long;
    ...
    invoke-direct/range {v15 .. v22}, La3b;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-interface {v3, v15}, Lr4i;->setOnTouch(Lgi7;)V
    ...
    invoke-direct/range {v15 .. v22}, Lptd;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-interface {v3, v15}, Lr4i;->setOnRequestInterceptTouchEvent(Lei7;)V
...
.method public onChangeStarted(Lps4;Lqs4;)V
    .locals 1
    ...
    invoke-interface {p1, v0}, Lr4i;->setOnTouch(Lgi7;)V

    invoke-interface {p1, v0}, Lr4i;->setOnRequestInterceptTouchEvent(Lei7;)V
