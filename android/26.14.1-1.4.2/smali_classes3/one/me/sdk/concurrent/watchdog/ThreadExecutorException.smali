...
# direct methods
.method public constructor <init>(Ljava/lang/Iterable;Lhb6;)V
    .locals 9

    invoke-interface {p2}, Lhb6;->a()J

    move-result-wide v0

    new-instance p2, Lx9g;

    const/4 v2, 0x1

    invoke-direct {p2, v0, v1, v2}, Lx9g;-><init>(JI)V
    ...
    invoke-static {p2, v4, v5}, Lka8;->f(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v0, v1, p2}, Lgi3;-><init>(JI)V
    ...
    invoke-static {v0, v1, p2}, Lyyk;->Y(JLjx5;)J
    ...
    invoke-direct {p2, v3, v4}, Ldx5;-><init>(J)V
    ...
    invoke-virtual {v4, v0, v1}, Lfzj;->a(J)J

    move-result-wide v4

    new-instance v6, Ldx5;

    invoke-direct {v6, v4, v5}, Ldx5;-><init>(J)V

    invoke-virtual {p2, v6}, Ldx5;->compareTo(Ljava/lang/Object;)I
    ...
    iget-object p1, v2, Lfzj;->d:Ljava/lang/Thread;
