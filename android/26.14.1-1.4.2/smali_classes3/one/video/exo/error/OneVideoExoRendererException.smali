...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlaybackException;)V
    ...
    iget-object v0, p1, Landroidx/media3/exoplayer/ExoPlaybackException;->m:Lgb7;
    ...
    invoke-static {v0}, Lszk;->c(Lgb7;)Loa0;
    ...
    invoke-static {v0}, Lszk;->d(Lgb7;)Ltdi;
    ...
    :goto_2
    iput-object v0, p0, Lone/video/exo/error/OneVideoExoRendererException;->b:Ln4a;

    sget-object v0, Lib7;->a:Ljava/util/HashMap;
    ...
    sget-object p1, Lhb7;->f:Lhb7;

    :cond_8
    iput-object p1, p0, Lone/video/exo/error/OneVideoExoRendererException;->c:Lhb7;
    ...
    iget-object p1, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer$DecoderInitializationException;->c:Lgz9;

    invoke-static {p1}, Lone/video/exo/error/OneVideoExoRendererException;->a(Lgz9;)V
    ...
    iget-object p1, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecDecoderException;->a:Lgz9;
...
.method public static a(Lgz9;)V
    ...
    :cond_0
    iget-boolean v0, p0, Lgz9;->h:Z

    const/4 v1, 0x0

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lgz9;->e:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    invoke-virtual {p0}, Lgz9;->f()Z
    ...
    :goto_0
    iget-boolean v0, p0, Lgz9;->g:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lgz9;->i:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lgz9;->j:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean p0, p0, Lgz9;->f:Z
