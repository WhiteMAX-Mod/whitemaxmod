...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lzkh;Lgtc;Lifi;Landroid/graphics/drawable/Drawable;IIIIIIIIIIF)V
    .locals 9
    ...
    iput-object p2, p0, Leqe;->b:Lzkh;

    iput-object p3, p0, Leqe;->c:Lgtc;

    iput-object p4, p0, Leqe;->d:Lifi;

    iput-object p5, p0, Leqe;->e:Landroid/graphics/drawable/Drawable;

    const/4 v2, 0x0

    iput-object v2, p0, Leqe;->f:Lmoe;
    ...
    invoke-static/range {p1 .. p8}, Leqe;->a(Leqe;FFFFFFI)Landroid/graphics/Path;

    move-result-object p3

    iput-object p3, p0, Leqe;->v:Landroid/graphics/Path;
    ...
    iput-object p3, p0, Leqe;->w:Landroid/graphics/Path;
    ...
    iput-object p3, p0, Leqe;->r:Landroid/graphics/Path;
    ...
    iput-object p3, p0, Leqe;->s:Landroid/graphics/Path;
    ...
    iput-object p2, p0, Leqe;->t:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Leqe;->u:Landroid/graphics/Path;
    ...
    iput-object v2, p0, Leqe;->s:Landroid/graphics/Path;
    ...
    iput-object v2, p0, Leqe;->u:Landroid/graphics/Path;

    return-void
.end method

.method public static a(Leqe;FFFFFFI)Landroid/graphics/Path;
    .locals 7
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Leqe;->a:Landroid/content/Context;

    iget-object v1, p1, Leqe;->a:Landroid/content/Context;
    ...
    :cond_2
    iget-object v0, p0, Leqe;->b:Lzkh;

    iget-object v1, p1, Leqe;->b:Lzkh;
    ...
    :cond_3
    iget-object v0, p0, Leqe;->c:Lgtc;

    iget-object v1, p1, Leqe;->c:Lgtc;
    ...
    :cond_4
    iget-object v0, p0, Leqe;->d:Lifi;

    iget-object v1, p1, Leqe;->d:Lifi;
    ...
    :cond_5
    iget-object v0, p0, Leqe;->e:Landroid/graphics/drawable/Drawable;

    iget-object v1, p1, Leqe;->e:Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    iget-object v0, p0, Leqe;->f:Lmoe;

    iget-object v1, p1, Leqe;->f:Lmoe;
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Leqe;->d:Lifi;

    invoke-virtual {v2}, Lifi;->hashCode()I
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Leqe;->a:Landroid/content/Context;
