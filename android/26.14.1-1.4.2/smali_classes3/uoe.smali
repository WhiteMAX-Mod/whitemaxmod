...
.method public constructor <init>(Lqdj;)V
    ...
    iput-object p1, p0, Luoe;->d:Lbti;

    return-void
.end method

.method public constructor <init>(Lqdj;Lbti;)V
    .locals 0
...
.method public static c(IJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p3}, Lttl;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Lttl;->c(JLjava/nio/ByteBuffer;)I
...
.method public static d(ILjava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, p1}, Lttl;->b(ILjava/nio/ByteBuffer;)I
...
.method public final a()[B
    ...
    iget-object v3, p0, Luoe;->a:Lqdj;

    invoke-virtual {v3, v2}, Lqdj;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v3}, Lqdj;->b()Z
    ...
    iget-object v4, p0, Luoe;->d:Lbti;

    if-ne v3, v2, :cond_2

    iget-object v5, v4, Lbti;->a:[B

    invoke-static {v0, v1, v5}, Luoe;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_2
    iget-wide v5, v4, Lbti;->b:J

    const/4 v7, 0x1

    invoke-static {v7, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    if-ne v3, v2, :cond_3

    iget-object v5, v4, Lbti;->q:[B

    if-eqz v5, :cond_3

    invoke-static {v2, v1, v5}, Luoe;->d(ILjava/nio/ByteBuffer;[B)V
    ...
    iget-wide v5, v4, Lbti;->c:J

    const/4 v7, 0x4

    invoke-static {v7, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lbti;->d:J

    const/4 v8, 0x5

    invoke-static {v8, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lbti;->e:J

    const/4 v8, 0x6

    invoke-static {v8, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lbti;->f:J

    const/4 v8, 0x7

    invoke-static {v8, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lbti;->g:J

    const/16 v8, 0x8

    invoke-static {v8, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lbti;->h:J
    ...
    iget-boolean v5, v4, Lbti;->j:Z

    if-eqz v5, :cond_4

    const/16 v5, 0xc

    invoke-static {v5, v1}, Lttl;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v0, v5, v6, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V

    iget-object v0, v4, Lbti;->n:[B

    const/16 v5, 0xf

    invoke-static {v5, v1, v0}, Luoe;->d(ILjava/nio/ByteBuffer;[B)V

    if-ne v3, v2, :cond_5

    iget-object v0, v4, Lbti;->o:[B

    if-eqz v0, :cond_5

    const/16 v3, 0x10

    invoke-static {v3, v1, v0}, Luoe;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_5
    iget-object v0, v4, Lbti;->r:Lidi;
    ...
    invoke-direct {v0, v5, v6}, Lpv;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v0, v3, v4, v1}, Luoe;->c(IJLjava/nio/ByteBuffer;)V
...
.method public final e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lej9;)V
    .locals 11
    ...
    invoke-static {p1}, Lttl;->e(Ljava/nio/ByteBuffer;)I
    ...
    invoke-interface {p3, v1, v0}, Lej9;->debug(Ljava/lang/String;[B)V

    iput-object v0, v6, Lbti;->a:[B
    ...
    invoke-interface {p3, v2}, Lej9;->debug(Ljava/lang/String;)V

    iput-wide v0, v6, Lbti;->b:J
    ...
    invoke-interface {p3, v1}, Lej9;->debug(Ljava/lang/String;)V

    iput-object v0, v6, Lbti;->q:[B
    ...
    :try_start_0
    new-instance p3, Laha;

    const/16 v0, 0x11

    const/4 v1, 0x0

    invoke-direct {p3, v1, v0}, Laha;-><init>(CI)V
    ...
    iput-object v0, p3, Laha;->b:Ljava/lang/Object;
    ...
    iput-object v0, p3, Laha;->c:Ljava/lang/Object;
    ...
    iget-object v0, p3, Laha;->b:Ljava/lang/Object;

    check-cast v0, Ljava/net/InetAddress;

    if-nez v0, :cond_14

    iget-object v0, p3, Laha;->c:Ljava/lang/Object;
    ...
    iput-object v0, p3, Laha;->d:Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Lqdj;-><init>(I)V
    ...
    invoke-direct {v2, p3}, Lqdj;-><init>(I)V

    const/16 p3, 0x8

    const/4 v4, 0x0

    invoke-direct {v1, v2, v0, v4, p3}, Lidi;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V

    iput-object v1, v6, Lbti;->r:Lidi;
    ...
    :goto_a
    invoke-interface {p3, v0}, Lej9;->warn(Ljava/lang/String;)V
