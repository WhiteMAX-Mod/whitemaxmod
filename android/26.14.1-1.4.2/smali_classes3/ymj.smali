...
# direct methods
.method public constructor <init>(Landroid/util/Size;Liy5;)V
    .locals 5

    invoke-direct {p0}, Lrp5;-><init>()V

    iput-object p1, p0, Lymj;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lymj;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lymj;->t:[F
    ...
    invoke-virtual {p0, p2}, Lrp5;->o(Liy5;)Lgi0;
...
.method public final r()V
    ...
    iget-object v0, p0, Lymj;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Le65;->a0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lymj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lymj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lymj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lymj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lymj;->q:Lmmh;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lmmh;->d:Ljava/lang/String;

    invoke-static {v3, v1}, Le65;->a0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lmmh;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;->release()V

    iget-object v1, v2, Lmmh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->release()V

    :cond_2
    iput-object v0, p0, Lymj;->q:Lmmh;

    iput-object v0, p0, Lymj;->w:Lbzi;
...
.method public final x(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Lrp5;->m(Landroid/view/Surface;)Lyi0;

    move-result-object v2

    sget-object v3, Lfk7;->j:Lyi0;

    invoke-virtual {v2, v3}, Lyi0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v1, v0}, Lrp5;->i(Landroid/view/Surface;)Lyi0;
    ...
    :cond_0
    iget-object v3, v1, Lrp5;->d:Ljava/lang/Object;
    ...
    :cond_1
    iget-object v3, v1, Lrp5;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Lfk7;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v1, Lrp5;->e:Ljava/lang/Object;
    ...
    iget v11, v2, Lyi0;->b:I

    iget v12, v2, Lyi0;->c:I

    iget-object v9, v2, Lyi0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v1, Lymj;->q:Lmmh;
    ...
    invoke-direct {v2, v5}, Lmmh;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lymj;->q:Lmmh;

    :cond_2
    move-object v10, v2

    iget-object v2, v1, Lymj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lymj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lymj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lymj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lymj;->u:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Lmmh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v6}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->bind()V

    iget v6, v10, Lmmh;->b:I

    iget v7, v10, Lmmh;->c:I
    ...
    iget-object v9, v10, Lmmh;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Lmmh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v4}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->getTextureId()I

    move-result v4

    iget-object v5, v10, Lmmh;->a:Landroid/util/Size;
    ...
    iget-object v5, v1, Lrp5;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Lrp5;->p(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Lrp5;->k:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v2, Lmmh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v5, v1, Lymj;->w:Lbzi;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v2, v2, Lmmh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v2, v1, Lymj;->w:Lbzi;

    if-eqz v2, :cond_8

    invoke-virtual {v2, v11}, Lbzi;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_9
    :goto_2
    iget-object v2, v1, Lrp5;->f:Ljava/lang/Object;
    ...
    iget-object v11, v1, Lymj;->p:Ljava/lang/String;
    ...
    invoke-static {v8, v2, v3}, Lusl;->g(IJ)Ljava/lang/String;
    ...
    :cond_b
    invoke-virtual {v1, v0, v4}, Lrp5;->t(Landroid/view/Surface;Z)V
