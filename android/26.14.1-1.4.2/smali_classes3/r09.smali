...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v1}, Lka8;->h(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Lr09;->c:Ljava/util/Map;

    sget-object v1, Lfli;->b:Lfli;
    ...
    sput-object v0, Lr09;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Lr09;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Ldli;->k:Ldli;

    iget-short v6, v6, Ldli;->a:S
    ...
    sget-object v3, Lr09;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lq09;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Lr09;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Lr09;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lfli;->e:Lfli;
    ...
    invoke-static {v2}, Lef;->p(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Lef;->o(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lr09;->e([B)V

    iget-object v1, v1, Lq09;->a:Lfli;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-direct {v6, v2, v7}, Lgw3;-><init>(II)V
    ...
    sget-object v3, Lr09;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Lr09;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Lp09;-><init>(Lfli;Ljava/security/interfaces/ECPublicKey;)V
    ...
    invoke-static {v5}, Lyuc;->c(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lef;->t()V

    invoke-static {v5, v4}, Lef;->q(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Lq09;-><init>(Lfli;Ljava/security/PublicKey;)V
