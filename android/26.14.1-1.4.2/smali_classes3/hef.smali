...
# direct methods
.method public constructor <init>(ILavf;Lusb;Lxhg;Lej9;)V
    .locals 16
    ...
    new-array v0, v0, [Lzm9;

    iput-object v0, v2, Lhef;->e:[Lzm9;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, v2, Lhef;->l:Ljava/lang/Object;
    ...
    iput-boolean v10, v2, Lhef;->p:Z

    iput-object v1, v2, Lhef;->a:Ljava/time/Clock;
    ...
    iput-object v3, v2, Lhef;->c:Lavf;

    move-object/from16 v4, p3

    iput-object v4, v2, Lhef;->d:Lusb;
    ...
    iget-object v14, v2, Lhef;->e:[Lzm9;
    ...
    invoke-direct {v5, v7, v10}, Lcef;-><init>(Lxhg;I)V

    invoke-interface {v8}, Lej9;->getQLog()Lame;

    move-result-object v6

    invoke-direct/range {v0 .. v6}, Lzm9;-><init>(Ljava/time/Clock;Lhef;Lavf;Lusb;Lcef;Lame;)V
    ...
    :cond_0
    iput-object v7, v2, Lhef;->f:Lxhg;

    iput-object v8, v2, Lhef;->g:Lej9;

    new-instance v0, Lp15;

    const-string v1, "loss-detection"

    invoke-direct {v0, v1, v10}, Lp15;-><init>(Ljava/lang/String;I)V
    ...
    iput-object v0, v2, Lhef;->h:Ljava/util/concurrent/ScheduledExecutorService;

    iget-object v1, v2, Lhef;->l:Ljava/lang/Object;
    ...
    iput-object v0, v2, Lhef;->k:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-interface {v8, v0}, Lej9;->recovery(Ljava/lang/String;)V
...
# virtual methods
.method public final a(Ljava/util/function/Function;)Lpwc;
    .locals 7
    ...
    invoke-direct {v2, v4, v6, v5}, Lpwc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    goto :goto_1

    :cond_0
    iget-object v6, v2, Lpwc;->c:Ljava/lang/Object;
...
.method public final b(Llpd;)Ljava/util/List;
    .locals 2

    iget-object v0, p0, Lhef;->e:[Lzm9;
    ...
    iget-object p1, p1, Lzm9;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final c()Lpwc;
    .locals 15

    iget-object v0, p0, Lhef;->c:Lavf;

    invoke-virtual {v0}, Lavf;->b()I

    move-result v0

    iget-object v1, p0, Lhef;->c:Lavf;
    ...
    invoke-direct {v0, v2, v3, v1}, Lpwc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v11, p0, Lhef;->e:[Lzm9;
    ...
    iget-object v11, v11, Lzm9;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v11, Llpd;->c:Llpd;

    if-ne v10, v11, :cond_2

    iget v12, p0, Lhef;->o:I
    ...
    iget v11, p0, Lhef;->j:I

    iget v12, p0, Lhef;->m:I
    ...
    iget-object v11, v11, Lzm9;->k:Ljava/time/Instant;
    ...
    invoke-direct {v1, v9, v2, v0}, Lpwc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final d(I)V
    ...
    invoke-static {p1}, Lio4;->l(I)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lej9;->recovery(Ljava/lang/String;)V

    invoke-virtual {p0}, Lhef;->k()V
...
.method public final e()V
    ...
    iget-object v0, p0, Lhef;->n:Ljava/time/Instant;
    ...
    :cond_0
    iget-object v1, p0, Lhef;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Lhef;->g:Lej9;

    iget-object v2, p0, Lhef;->a:Ljava/time/Clock;
    ...
    invoke-interface {v1, v0}, Lej9;->warn(Ljava/lang/String;)V

    iget-object v0, p0, Lhef;->n:Ljava/time/Instant;

    invoke-virtual {p0, v0}, Lhef;->i(Ljava/time/Instant;)V
    ...
    invoke-interface {v0, v2, v1}, Lej9;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
    ...
    invoke-virtual {p0, v0}, Lhef;->a(Ljava/util/function/Function;)Lpwc;
    ...
    invoke-virtual {v0}, Lzm9;->b()V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lhef;->h(Z)V

    iget-object v0, p0, Lhef;->f:Lxhg;
    ...
    invoke-interface {v0}, Lej9;->logRecovery()Z
    ...
    iget-object v3, p0, Lhef;->c:Lavf;

    invoke-virtual {v3}, Lavf;->b()I
    ...
    iget-object v4, p0, Lhef;->c:Lavf;

    invoke-virtual {v4}, Lavf;->a()I
    ...
    invoke-interface {v1, v2, v0}, Lej9;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
    ...
    iget-object v2, p0, Lhef;->c:Lavf;

    invoke-virtual {v2}, Lavf;->b()I
    ...
    invoke-interface {v0, v1}, Lej9;->recovery(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Lhef;->j(Llpd;I)V
    ...
    invoke-virtual {p0, v0, v1}, Lhef;->j(Llpd;I)V
...
.method public final h(Z)V
    ...
    iget-object v0, p0, Lhef;->d:Lusb;

    iget-wide v0, v0, Lusb;->c:J

    iget-object v0, p0, Lhef;->d:Lusb;

    iget-wide v0, v0, Lusb;->b:J

    if-eqz p1, :cond_0

    iget-object p1, p0, Lhef;->g:Lej9;
...
.method public final i(Ljava/time/Instant;)V
    ...
    :try_start_0
    iget-object v0, p0, Lhef;->l:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Lhef;->k:Ljava/util/concurrent/ScheduledFuture;

    const/4 v2, 0x0

    invoke-interface {v1, v2}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object p1, p0, Lhef;->n:Ljava/time/Instant;
    ...
    iget-object p1, p0, Lhef;->h:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v3, Ldef;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Ldef;-><init>(Lhef;I)V
    ...
    iput-object p1, p0, Lhef;->k:Ljava/util/concurrent/ScheduledFuture;
...
.method public final j(Llpd;I)V
    .locals 5
    ...
    invoke-interface {v1, v0}, Lej9;->recovery(Ljava/lang/String;)V

    new-instance v0, Leef;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, v1}, Leef;-><init>(Lhef;Llpd;I)V

    invoke-static {v0, p2}, Lhef;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p0, v0}, Lhef;->b(Llpd;)Ljava/util/List;
    ...
    invoke-direct {v0, p0, p1, v1}, Lfef;-><init>(Lhef;Ljava/util/List;I)V
    ...
    invoke-interface {v1, p1}, Lej9;->recovery(Ljava/lang/String;)V

    new-instance p1, Ldef;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, Ldef;-><init>(Lhef;I)V

    invoke-static {p1, p2}, Lhef;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p0, p1}, Lhef;->b(Llpd;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, p1, v0, v2}, Ln06;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {v1, p2}, Lhef;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-direct {p1, p0, v1, v0}, Ljdf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final k()V
    ...
    invoke-virtual {p0, v2}, Lhef;->a(Ljava/util/function/Function;)Lpwc;
    ...
    iget-object v2, v2, Lpwc;->c:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2}, Lhef;->i(Ljava/time/Instant;)V
    ...
    invoke-direct {v4, v5}, Lym9;-><init>(I)V
    ...
    iget-object v0, p0, Lhef;->k:Ljava/util/concurrent/ScheduledFuture;

    invoke-interface {v0, v5}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v3, p0, Lhef;->n:Ljava/time/Instant;
    ...
    :cond_4
    iget-object v3, v6, Lpwc;->c:Ljava/lang/Object;

    check-cast v3, Ljava/time/Instant;

    invoke-virtual {p0, v3}, Lhef;->i(Ljava/time/Instant;)V

    invoke-interface {v1}, Lej9;->logRecovery()Z

    move-result v5

    if-eqz v5, :cond_7

    iget-object v5, p0, Lhef;->a:Ljava/time/Clock;
    ...
    iget-object v6, v6, Lpwc;->b:Ljava/lang/Object;
    ...
    invoke-interface {v1, v0, v3}, Lej9;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
