...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2}, Llff;-><init>(Landroid/view/View;)V
    ...
    sget-object v7, Lp0j;->e:Lifi;

    invoke-static {v7, v3}, Lifi;->d(Lifi;Landroid/widget/TextView;)V

    iput-object v3, v0, Lr3h;->Z:Landroid/widget/TextView;
    ...
    invoke-static {v7, v8}, Lifi;->d(Lifi;Landroid/widget/TextView;)V
    ...
    invoke-virtual {v12, v10}, Lhub;->c(Landroid/content/Context;)Lbu3;
    ...
    new-instance v10, Lq3h;

    invoke-direct {v10, v0, v8}, Lq3h;-><init>(Lr3h;Landroidx/appcompat/widget/AppCompatEditText;)V
    ...
    invoke-direct {v10, v14}, Ljj5;-><init>(I)V
    ...
    iput-object v8, v0, Lr3h;->N0:Landroidx/appcompat/widget/AppCompatEditText;
    ...
    iput-object v10, v0, Lr3h;->O0:Landroidx/appcompat/widget/AppCompatTextView;

    new-instance v4, Ljbc;

    invoke-direct {v4, v1}, Ljbc;-><init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lr3h;->P0:Ljbc;
    ...
    invoke-direct {v7, v9, v0}, Lx4d;-><init>(ILjava/lang/Object;)V

    invoke-static {v5, v7}, Lyyk;->R(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v12, v9}, Lhub;->c(Landroid/content/Context;)Lbu3;
    ...
    invoke-static {v9, v7}, Lspg;->O(ILandroid/graphics/drawable/Drawable;)V

    invoke-virtual {v5, v7}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v5, v0, Lr3h;->Q0:Landroid/widget/ImageView;
    ...
    invoke-static {v9, v6}, Lspg;->O(ILandroid/graphics/drawable/Drawable;)V

    invoke-virtual {v7, v6}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v7, v0, Lr3h;->R0:Landroid/widget/ImageView;
    ...
    invoke-direct {v9, v11}, Lev4;-><init>(F)V
    ...
    iput-object v6, v0, Lr3h;->S0:Landroid/widget/LinearLayout;

    new-instance v3, Landroid/widget/TextView;

    invoke-direct {v3, v1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-static {v3, v12}, Lpc2;->h(Landroid/widget/TextView;Lhub;)Lqtc;
    ...
    iput-object v3, v0, Lr3h;->T0:Landroid/widget/TextView;
    ...
    iput-object v7, v0, Lr3h;->U0:Landroid/widget/TextView;
    ...
    invoke-direct {v1, v0, v4, v3}, Lgsb;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    invoke-static {v1, v2}, Lcob;->K(Lwi7;Landroid/view/View;)V
...
.method public final C(Lhb9;)V
    ...
    invoke-virtual {p0, p1}, Lr3h;->I(Lsjl;)V

    return-void
.end method

.method public final I(Lsjl;)V
    .locals 12
    ...
    iget-object v2, p0, Lr3h;->U0:Landroid/widget/TextView;

    iget-object v3, p0, Lr3h;->R0:Landroid/widget/ImageView;

    iget-object v4, p0, Lr3h;->Q0:Landroid/widget/ImageView;

    iget-object v5, p0, Lr3h;->S0:Landroid/widget/LinearLayout;

    iget-object v6, p0, Lr3h;->P0:Ljbc;

    iget-object v7, p0, Lr3h;->Z:Landroid/widget/TextView;

    iget-object v8, p0, Lr3h;->O0:Landroidx/appcompat/widget/AppCompatTextView;

    iget-object v9, p0, Lr3h;->N0:Landroidx/appcompat/widget/AppCompatEditText;
    ...
    invoke-static {v9}, Le35;->b(Landroid/view/View;)V
    ...
    iget-object v4, v0, Ln3h;->b:Ljava/lang/String;

    invoke-virtual {v3, v10}, Landroid/view/View;->setVisibility(I)V

    iget-boolean v3, v0, Ln3h;->d:Z
    ...
    iget-object v2, v0, Ln3h;->a:Ljava/lang/String;

    invoke-virtual {v7, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v2, p0, Lr3h;->Y:Lsjl;

    instance-of v2, v2, Ln3h;
    ...
    invoke-direct {v2, v9, v9, v3}, Ly09;-><init>(Landroid/view/View;Landroid/view/View;I)V
    ...
    :goto_4
    iput-object p1, p0, Lr3h;->Y:Lsjl;

    invoke-virtual {p1}, Lsjl;->b()Lgfi;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-virtual {p1}, Lsjl;->c()Ljava/lang/Integer;
    ...
    :cond_6
    iget-object v0, p0, Lr3h;->T0:Landroid/widget/TextView;
