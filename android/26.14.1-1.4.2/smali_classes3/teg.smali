...
# direct methods
.method public constructor <init>(Lycd;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lm8h;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lteg;->e:Lycd;

    iput-object p2, p0, Lteg;->f:Ljava/util/concurrent/ExecutorService;
...
.method public final L(Lt9h;I)V
    ...
    invoke-virtual {p1, p2}, Lseg;->I(Luk7;)V
...
.method public final x(Landroid/view/ViewGroup;I)Llff;
    ...
    iget-object v2, p0, Lteg;->e:Lycd;

    invoke-direct {p1, v2, p2, v0, v1}, Lseg;-><init>(Lycd;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
