...
# direct methods
.method public constructor <init>(La35;Lj1d;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Lc35;->a:Lj1d;

    const/16 p2, 0x1e

    iput p2, p0, Lc35;->b:I

    iput-object p1, p0, Lc35;->c:La35;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lc35;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lc35;->e:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lc35;->h:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lc35;->i:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lc35;->j:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    iget-object v0, p0, Lc35;->j:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Lc35;->c:La35;
    ...
    iget-object v2, v2, La35;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Lc35;->f:Lqm;

    if-nez v0, :cond_7

    iget-object v0, p0, Lc35;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lc35;->h:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Lc35;->i:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lc35;->e:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    instance-of v0, v6, Lcl;

    instance-of v8, v6, Lzk;

    if-eqz v8, :cond_b

    check-cast v6, Lzk;

    iget-object v6, v6, Lzk;->a:[F
    ...
    invoke-virtual {v2, v7, v8}, La35;->e(I[B)Z
    ...
    iget-object v2, v2, Lj1d;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v1, p0, Lc35;->f:Lqm;
    :try_end_6
