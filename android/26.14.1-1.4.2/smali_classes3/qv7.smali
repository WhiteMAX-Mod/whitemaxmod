...
# direct methods
.method public static c(Ljava/nio/ByteBuffer;Leli;Ldl2;)Ljava/util/ArrayList;
    .locals 20
    ...
    sget-object v11, Ldli;->b:Ldli;

    iget-short v11, v11, Ldli;->a:S
    ...
    invoke-virtual {v7, v0, v11, v6}, Lkf6;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {v14, v0}, Lqv;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v0}, Lqv;->c(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v6, v0}, Lqv;->c(ILjava/nio/ByteBuffer;)V
    ...
    iput-object v13, v7, Lqv;->b:Ljava/lang/Object;
    ...
    invoke-direct {v6, v0, v7}, Lnke;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    :cond_8
    sget-object v11, Ldli;->d:Ldli;

    iget-short v14, v11, Ldli;->a:S
    ...
    iput-object v12, v8, Li8h;->a:Ljava/util/List;

    iget-short v11, v11, Ldli;->a:S

    invoke-virtual {v8, v0, v11, v7}, Lkf6;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-direct {v13, v7, v14}, Lgw3;-><init>(II)V
    ...
    invoke-direct {v12, v13, v8}, Lq4;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v6, v0}, Lqv;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_d
    sget-object v11, Ldli;->f:Ldli;

    iget-short v14, v11, Ldli;->a:S

    if-ne v8, v14, :cond_1e

    sget-object v6, Leli;->c:Leli;
    ...
    invoke-virtual {v6, v0, v14, v4}, Lkf6;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0, v11, v12}, Lkf6;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v12, v6, Llw3;->a:Ljava/util/List;
    ...
    iget-object v7, v6, Llw3;->a:Ljava/util/List;
    ...
    invoke-direct {v4, v8, v9, v15}, Lkw3;-><init>(J[B)V
    ...
    iput-object v4, v6, Llw3;->b:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Llw3;->b:Ljava/util/ArrayList;

    new-instance v12, Ljw3;

    invoke-direct {v12, v8}, Ljw3;-><init>([B)V
    ...
    iget-object v4, v6, Llw3;->a:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v7, v6, Llw3;->b:Ljava/util/ArrayList;
    ...
    invoke-static {}, Leli;->values()[Leli;
    ...
    invoke-direct {v3, v4, v1}, Lf7;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v1, v2}, Lka8;->h(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v4, Ldli;->g:Ldli;

    iget-short v4, v4, Ldli;->a:S
    ...
    invoke-virtual {v7, v0, v4, v6}, Lkf6;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v4, v7, Luy5;->a:Ljava/lang/Long;
    ...
    invoke-direct {v4, v0, v1}, Ln1i;-><init>(Ljava/nio/ByteBuffer;Leli;)V
    ...
    invoke-direct {v4, v0, v6}, Lnke;-><init>(Ljava/nio/ByteBuffer;I)V
    ...
    invoke-direct {v4, v0}, Lml2;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_25
    sget-object v4, Ldli;->k:Ldli;

    iget-short v6, v4, Ldli;->a:S
    ...
    iput-object v7, v6, Lr09;->b:Ljava/util/ArrayList;

    iget-short v4, v4, Ldli;->a:S

    const/4 v7, 0x1

    invoke-virtual {v6, v0, v4, v7}, Lkf6;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0}, Lr09;->d(Ljava/nio/ByteBuffer;)I
    ...
    iget-object v4, v2, Ldl2;->b:Ljava/lang/Object;
    ...
    iget-object v6, v4, Lmz4;->a:Lsdj;

    iget-object v6, v6, Lsdj;->a:Lqdj;

    invoke-direct {v13, v6}, Luoe;-><init>(Lqdj;)V

    iget-object v4, v4, Lmz4;->f:Lej9;
    ...
    invoke-interface {v4, v12}, Lej9;->debug(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v13, v0, v11, v4}, Luoe;->e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lej9;)V
    :try_end_0
    ...
    invoke-static {v4}, Ldj9;->a(Ljava/lang/String;)V
...
.method public abstract b()Leli;
.end method

.method public final d(Ljava/nio/ByteBuffer;Leli;I)I
    .locals 3
