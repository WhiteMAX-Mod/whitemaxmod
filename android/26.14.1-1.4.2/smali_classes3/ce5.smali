...
# static fields
.field public static final j:[Lhrj;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lhrj;->b:Lhrj;

    filled-new-array {v0, v1}, [Lhrj;

    move-result-object v0

    sput-object v0, Lce5;->j:[Lhrj;
...
.method public constructor <init>(Lxba;Le3f;Lb6d;Lf9b;)V
    ...
    iput-object p1, p0, Lce5;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lce5;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lce5;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lce5;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lvu1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Lce5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, p2}, Lkqj;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v2, p0}, Lcg4;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Ljuk;-><init>(Lm6d;Lfg4;I)V
...
.method public final e(Lvu1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lvg9;-><init>(I)V

    iput-object v1, v2, Lvg9;->b:Ljava/lang/Object;

    iput-object p1, v2, Lvg9;->a:Ljava/lang/Object;

    invoke-virtual {v2}, Lvg9;->i()Ld62;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lce5;->n(Ljava/lang/String;Ld62;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Lce5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lkqj;->a:Lorg/webrtc/VideoSink;
...
.method public final n(Ljava/lang/String;Ld62;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lzd5;-><init>(Lce5;Ljava/lang/String;Ld62;Ljava/util/List;)V
    ...
    invoke-direct {p2, p1, v1, p3}, Ljuk;-><init>(Lm6d;Lfg4;I)V
...
.method public final p(Ljava/lang/String;Ld62;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lce5;->g:Ljava/util/HashMap;
    ...
    invoke-interface {p1, p3, p2}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, Lce5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v1, v4, v0}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, v1, Lkqj;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Lce5;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lce5;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lce5;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Lce5;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Lce5;->f:Ljava/util/concurrent/ConcurrentHashMap;
