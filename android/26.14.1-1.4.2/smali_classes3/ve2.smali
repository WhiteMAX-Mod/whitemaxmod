...
# direct methods
.method public constructor <init>(Lu2c;Lorg/webrtc/CameraVideoCapturer;Llr;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLe3f;)V
    .locals 4
    ...
    iput-object v0, p0, Lve2;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lve2;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lve2;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lve2;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lve2;->h:Ljava/lang/String;

    iput-object p7, p0, Lve2;->e:Le3f;

    check-cast p1, Lnj2;

    new-instance p7, Lv2c;

    new-instance v2, Lb5d;

    new-instance v3, Leh2;

    iget-object p1, p1, Lnj2;->a:Le3f;

    invoke-direct {v3, p1}, Leh2;-><init>(Le3f;)V

    invoke-direct {v2, p2, v3, p1}, Lb5d;-><init>(Lorg/webrtc/CameraVideoCapturer;Leh2;Le3f;)V

    const/4 p1, 0x0

    invoke-direct {p7, p1, v2}, Lv2c;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Lve2;->c:Lv2c;

    iput-object p3, p0, Lve2;->d:Llr;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lve2;->i:Z
...
.method public final a()V
    ...
    :cond_0
    iget-object v2, p0, Lve2;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3}, Lkf8;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lpc2;->E(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lka8;->i(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lve2;->e:Le3f;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Le3f;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lve2;->e:Le3f;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lpc2;->x(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lve2;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lig9;->r:Lve2;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lig9;->n:Le3f;
    ...
    invoke-interface {v8, v10, v11, v9}, Le3f;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lig9;->y:Lzpj;

    iget-object v8, v7, Lhaa;->a:Le3f;

    const-string v9, "VideoRecord"

    const-string v10, "Camera capture dimensions were changed to "

    invoke-static {v10, v2, v0, v5}, Lka8;->i(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lzpj;->l:Lorg/webrtc/Size;
    ...
    invoke-interface {v4, v6, v5}, Le3f;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Lve2;->c:Lv2c;

    iget-object v4, v4, Lv2c;->b:Ljava/lang/Object;

    check-cast v4, Lb5d;

    invoke-virtual {v4, v2, v0, v3}, Lb5d;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lb5d;->startCapture(III)V
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lb5d;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lve2;->k:Z
    :try_end_0
