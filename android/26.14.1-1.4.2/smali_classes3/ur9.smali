...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;Lzkh;ZLe8;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lur9;->a:Landroid/widget/EditText;

    iput-object p2, p0, Lur9;->b:Lzkh;

    iput-boolean p3, p0, Lur9;->c:Z

    iput-object p4, p0, Lur9;->d:Le8;

    new-instance p1, Lgkb;

    invoke-direct {p1}, Lgkb;-><init>()V

    iput-object p1, p0, Lur9;->e:Lgkb;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-direct {p1}, Lc11;-><init>()V

    invoke-static {p2, p3, p4, v1, p1}, Lv3h;->T(Landroid/text/Editable;IIZLvr9;)V

    return-void

    :cond_0
    sget v0, Ltwe;->markdown_italic:I

    if-ne p1, v0, :cond_1

    new-instance p1, Lpr8;

    invoke-direct {p1}, Lpr8;-><init>()V
    ...
    :cond_1
    sget v0, Ltwe;->markdown_underline:I
    ...
    invoke-direct {p1, v2}, Livh;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Lv3h;->T(Landroid/text/Editable;IIZLvr9;)V

    return-void

    :cond_2
    sget v0, Ltwe;->markdown_mono:I
    ...
    :cond_3
    sget v0, Ltwe;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Livh;

    invoke-direct {p1, v1}, Livh;-><init>(I)V
    ...
    :cond_4
    sget v0, Ltwe;->markdown_heading:I

    if-ne p1, v0, :cond_5

    new-instance p1, Lzw7;

    invoke-direct {p1}, Lzw7;-><init>()V
    ...
    :cond_5
    sget v0, Ltwe;->markdown_quote:I

    sget-object v3, Lb2j;->a:Lb2j;

    iget-object v4, p0, Lur9;->a:Landroid/widget/EditText;
    ...
    sget v0, Lwwe;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Lur9;->b()Leqe;

    move-result-object p4

    new-instance v0, Lfqe;

    invoke-direct {v0, p4}, Lfqe;-><init>(Leqe;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Lf0j;->R(Landroid/text/Spannable;Lvr9;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Lv3h;->U(Landroid/text/Spannable;Lvr9;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Lwwe;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Ll7l;->c(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Lwwe;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Ltwe;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Lv3h;->U(Landroid/text/Spannable;Lvr9;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Lv3h;->I(Landroid/text/Spannable;II)V
...
.method public final b()Leqe;
    .locals 20

    move-object/from16 v0, p0

    iget-object v1, v0, Lur9;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Le65;->x(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v18}, Leqe;-><init>(Landroid/content/Context;Lzkh;Lgtc;Lifi;Landroid/graphics/drawable/Drawable;IIIIIIIIIIF)V
    ...
    invoke-direct {v1, v4, v3}, Lmoe;-><init>(ILjava/lang/Object;)V

    iput-object v1, v2, Leqe;->f:Lmoe;
...
.method public final c()Z
    ...
    iget-object v0, p0, Lur9;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Lp99;->c:Ljava/lang/String;
    ...
    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lt29;
    ...
    invoke-direct {v1, p2, p3, p1}, Lhc;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Le8;->b:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->d:Lt29;
    ...
    iget-object p1, p1, Lwr9;->c:Lf96;

    new-instance v0, Lhc;

    invoke-direct {v0, p2, p3, v1}, Lhc;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Lur9;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Ltwe;->markdown_italic:I
    ...
    :cond_4
    sget v5, Ltwe;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Ltwe;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Lur9;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Ltwe;->markdown_heading:I
    ...
    :cond_8
    sget v5, Ltwe;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Lur9;->e:Lgkb;

    invoke-virtual {p1}, Lgkb;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lgkb;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lgkb;->a(I)V

    invoke-virtual {p0}, Lur9;->c()Z
    ...
    invoke-virtual {p1, v3}, Lgkb;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Lqr9;->f:Lqr9;

    iget v2, v1, Lqr9;->a:I

    iget-object v3, p0, Lur9;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lgkb;->a(I)V
