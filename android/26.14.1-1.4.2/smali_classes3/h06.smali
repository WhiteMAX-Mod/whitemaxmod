...
.method private getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lh06;->d:Landroid/graphics/Matrix;

    iget-object v1, p0, Lh06;->h:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lh06;->j:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v0, p0, Lh06;->a:Ljava/util/ArrayList;
    ...
    invoke-interface {v1, p1}, La06;->a(Landroid/graphics/Canvas;)V
...
.method public getResultBounds()Landroid/graphics/Rect;
    ...
    :goto_0
    iget-boolean v1, p0, Lh06;->k:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lh06;->l:Lf06;
...
.method public final onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object v2, p0, Lh06;->d:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v0, v1, p1}, Landroid/graphics/Matrix;->postScale(FFFF)Z

    iget-object v0, p0, Lh06;->f:Ljava/lang/Float;

    if-eqz v0, :cond_0

    iget-object v3, p0, Lh06;->g:Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lh06;->e:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lh06;->f:Ljava/lang/Float;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iput-object p1, p0, Lh06;->g:Ljava/lang/Float;
...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object p1, p0, Lh06;->c:Lg06;

    if-eqz p1, :cond_1

    check-cast p1, Ld06;

    iget-object v0, p1, Ld06;->c:Lvw;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lvw;->c()Ldc;

    move-result-object v0

    iget-object v1, p1, Ld06;->a:Lh06;

    invoke-virtual {v0, v1}, Ldc;->a(Lc06;)V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p1, Ld06;->c:Lvw;
...
.method public final onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iget-object v3, p0, Lh06;->h:[F

    const/4 p1, 0x0

    iput-object p1, p0, Lh06;->f:Ljava/lang/Float;

    iput-object p1, p0, Lh06;->g:Ljava/lang/Float;

    invoke-direct {p0}, Lh06;->getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct {v0, p0, v4, v3, v2}, Lek;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lh06;->k:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lh06;->l:Lf06;
    ...
    :cond_1
    iget-object v0, p0, Lh06;->c:Lg06;

    if-eqz v0, :cond_2

    check-cast v0, Ld06;

    invoke-virtual {v0, p1}, Ld06;->d(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, p0, Lh06;->b:Landroid/view/ScaleGestureDetector;
...
.method public setBoundingListener(Lf06;)V
    .locals 0

    iput-object p1, p0, Lh06;->l:Lf06;
...
.method public setBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lh06;->j:Landroid/graphics/Rect;
...
.method public setDrawStickerEnabled(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lh06;->k:Z

    iget-object v0, p0, Lh06;->l:Lf06;

    if-eqz v0, :cond_1

    invoke-interface {v0, p1}, Lf06;->setDrawStickerEnabled(Z)V
...
.method public setListener(Lg06;)V
    .locals 0

    iput-object p1, p0, Lh06;->c:Lg06;
