...
# direct methods
.method public static E0(Ljava/io/File;Ljava/io/File;)V
    .locals 2
    ...
    :try_start_1
    invoke-static {v0, p0}, Lxbk;->R(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_1
...
.method public static F0(Ljava/io/File;)Z
    ...
    invoke-direct {v0, p0}, Ldo6;-><init>(Ljava/io/File;)V

    new-instance p0, Lbo6;

    invoke-direct {p0, v0}, Lbo6;-><init>(Ldo6;)V
...
.method public static G0(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v0, p0, v1}, Lhug;->q1(CLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static H0(Ljava/io/File;)[B
    .locals 8
...
.method public static I0(Ljava/io/File;)Ljava/util/ArrayList;
    .locals 6
    ...
    invoke-direct {v2, v3, v1}, Lnp6;-><init>(ILjava/util/ArrayList;)V
    ...
    invoke-direct {p0, v0, v3}, Lgw;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lmc4;

    invoke-direct {v0, p0}, Lmc4;-><init>(Lx7f;)V

    invoke-virtual {v0}, Lmc4;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v2, v0}, Lnp6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static J0(Ljava/io/File;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, Lj68;->z(Ljava/io/Reader;)Ljava/lang/String;
...
.method public static K0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    .locals 7
    ...
    invoke-static {p1, v1, v2, v3}, Lhug;->T0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p1, v3}, Lhug;->M0(Ljava/lang/String;C)Z
    ...
    :cond_6
    invoke-static {p0, v1}, Lhug;->M0(Ljava/lang/String;C)Z
...
.method public static M0(Ljava/io/File;Ljava/lang/String;)V
    .locals 2
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Lmp6;->N0(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
