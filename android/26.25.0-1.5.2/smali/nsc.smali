...
.method public constructor <init>(Lc4c;)V
    ...
    iput-object v0, p0, Lnsc;->a:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lnsc;->b:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lnsc;->c:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Lnsc;->onThemeChanged(Lc4c;)V
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Ld6e;)V
    ...
    iget-object p2, p4, Ld6e;->b:Landroid/util/SparseArray;
    ...
    iput-object p2, p4, Ld6e;->b:Landroid/util/SparseArray;
...
.method public final g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Ld6e;)V
    ...
    iget-object v0, p0, Lnsc;->b:Landroid/graphics/RectF;
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->S(Landroid/view/View;)Lh6e;

    move-result-object v6

    instance-of v6, v6, Lsd3;

    if-eqz v6, :cond_5

    iget-object v6, p3, Ld6e;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Lnsc;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Lnsc;->a:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Lc4c;)V
    ...
    iget-object p0, p0, Lnsc;->a:Landroid/graphics/Paint;
