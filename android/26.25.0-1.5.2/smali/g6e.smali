...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lg6e;->g:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->h2:Li5e;

    iput-object v0, p0, Lg6e;->d:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lg6e;->e:Z

    iput-boolean v1, p0, Lg6e;->f:Z
    ...
    iput-object v1, p0, Lg6e;->c:Landroid/widget/OverScroller;
...
.method public final a(II)V
    ...
    iget-object v1, p0, Lg6e;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, p0, Lg6e;->d:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->h2:Li5e;

    if-eq v0, v2, :cond_0

    iput-object v2, p0, Lg6e;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Lg6e;->c:Landroid/widget/OverScroller;

    :cond_0
    iget-object v3, p0, Lg6e;->c:Landroid/widget/OverScroller;
...
.method public final b()V
    ...
    iget-boolean v0, p0, Lg6e;->e:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lg6e;->f:Z

    return-void

    :cond_0
    iget-object v0, p0, Lg6e;->g:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final c(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v2, p0, Lg6e;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->h2:Li5e;

    :cond_4
    iget-object p3, p0, Lg6e;->d:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Lg6e;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Lg6e;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iput-boolean v9, p0, Lg6e;->f:Z

    const/4 v10, 0x1

    iput-boolean v10, p0, Lg6e;->e:Z

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->q()V

    iget-object v11, p0, Lg6e;->c:Landroid/widget/OverScroller;
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView;->n:Lr5e;

    iget-object v5, v5, Lr5e;->e:Lxv8;

    if-eqz v5, :cond_5

    invoke-virtual {v5}, Lxv8;->j()Z

    move-result v6

    if-nez v6, :cond_5

    invoke-virtual {v5}, Lxv8;->k()Z

    move-result v6

    if-eqz v6, :cond_5

    iget-object v6, v0, Landroidx/recyclerview/widget/RecyclerView;->G1:Ld6e;

    invoke-virtual {v6}, Ld6e;->b()I

    move-result v6

    if-nez v6, :cond_3

    invoke-virtual {v5}, Lxv8;->s()V

    goto :goto_0

    :cond_3
    invoke-virtual {v5}, Lxv8;->h()I
    ...
    invoke-virtual {v5, v6}, Lxv8;->q(I)V

    invoke-virtual {v5, v3, v4}, Lxv8;->l(II)V
    ...
    iget-object v6, v6, Lr5e;->e:Lxv8;

    if-eqz v6, :cond_10

    invoke-virtual {v6}, Lxv8;->j()Z
    ...
    iget-object v2, v1, Lvg5;->d:Ljava/lang/Object;
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView;->E1:Lee7;

    if-eqz v3, :cond_1d

    invoke-virtual {v3, v0, v1, v2}, Lee7;->a(Landroidx/recyclerview/widget/RecyclerView;II)V

    :cond_1d
    :goto_b
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->n:Lr5e;

    iget-object v1, v1, Lr5e;->e:Lxv8;

    if-eqz v1, :cond_1e

    invoke-virtual {v1}, Lxv8;->j()Z

    move-result v2

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v9, v9}, Lxv8;->l(II)V

    :cond_1e
    iput-boolean v9, p0, Lg6e;->e:Z

    iget-boolean v1, p0, Lg6e;->f:Z
