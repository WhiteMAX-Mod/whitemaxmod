...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Ljm4;->s(II)I

    move-result p3

    iget-object p4, p0, Lpq5;->a:Lpr0;
    ...
    invoke-virtual/range {v1 .. v7}, Llv8;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Loq5;I)V
    .locals 9

    iget v0, p3, Loq5;->c:I

    invoke-static {v0, p4}, Ljm4;->s(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Llv8;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Ljm4;->s(II)I

    move-result p5

    move p6, p7

    invoke-virtual/range {p0 .. p7}, Llv8;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, Lif8;->m(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, Lif8;->m(FFF)F
    ...
    invoke-static {v3, v1, p3}, Lj68;->v(FFF)F
    ...
    invoke-static {v3, v1, v2}, Lj68;->v(FFF)F
    ...
    invoke-static {p3, v0, v4}, Lif8;->m(FFF)F
    ...
    invoke-static {v2, v6, v1}, Lif8;->m(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, Llv8;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
