...
.method public static parseFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->mergeFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;
...
.method public clear()Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;
    ...
    iput-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->convertOptions:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video$ConvertOptions;

    iput-object v3, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->token:Ljava/lang/String;

    iput-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->videoCollage:Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video$VideoCollage;
    ...
    iput-wide v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->size:J
...
.method public computeSerializedSize()I
    ...
    invoke-static {v5, v1}, Lqr3;->f(II)I
    ...
    iget-object v6, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->externalSiteName:Ljava/lang/String;
    ...
    iget-object v6, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->token:Ljava/lang/String;
    ...
    iget-object v6, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->embedUrl:Ljava/lang/String;
    ...
    iget-object v6, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->wave:[B
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->transcription:Ljava/lang/String;
    ...
    iget-object v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->thumbhashData:[B

    invoke-static {v1, v4}, Lqr3;->b(I[B)I
    ...
    :cond_15
    iget-wide v4, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->size:J
...
.method public mergeFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic mergeFrom(Lor3;)Lsba;
    ...
    .line 226
    invoke-virtual {p0, p1}, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->mergeFrom(Lor3;)Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;
...
.method public writeTo(Lqr3;)V
    ...
    invoke-virtual {p1, v0, v5}, Lqr3;->s(I[B)V
    ...
    invoke-virtual {p1, v5, v0}, Lqr3;->r(IZ)V
    ...
    iget-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->externalSiteName:Ljava/lang/String;
    ...
    invoke-virtual {p1, v5, v0}, Lqr3;->y(ILsba;)V
    ...
    iget-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->token:Ljava/lang/String;
    ...
    iget-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->embedUrl:Ljava/lang/String;
    ...
    iget-object v5, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->wave:[B
    ...
    invoke-virtual {p1, v0, v1}, Lqr3;->s(I[B)V

    :cond_15
    iget-wide v0, p0, Lru/ok/tamtam/nano/Protos$Attaches$Attach$Video;->size:J
