...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, v0}, Lcvi;-><init>(I)V
...
.method public static u(Ljava/util/List;)Leq;
    .locals 4
...
.method public d(Lzp4;Landroid/view/View;Landroid/view/View;)Z
    .locals 2
    ...
    :cond_0
    instance-of p0, p3, Leq;

    if-eqz p0, :cond_1

    check-cast p3, Leq;

    iget-boolean p0, p3, Leq;->l:Z

    if-eqz p0, :cond_1

    invoke-virtual {p3, p2}, Leq;->i(Landroid/view/View;)Z

    move-result p0

    invoke-virtual {p3, p0}, Leq;->h(Z)Z
...
.method public final e(Lzp4;Landroid/view/View;)V
    .locals 0
    ...
    invoke-static {p1, p0}, Lyti;->l(Landroid/view/View;Lm4;)V
...
.method public final i(Lzp4;Landroid/view/View;III)Z
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lzp4;->d(Landroid/view/View;)Ljava/util/List;

    move-result-object v2

    invoke-static {v2}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->u(Ljava/util/List;)Leq;
    ...
    invoke-virtual {p1}, Lzp4;->getLastWindowInsets()Lzjj;
...
.method public final m(Lzp4;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    .locals 3
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->u(Ljava/util/List;)Leq;
    ...
    invoke-virtual {v0, v1, p1, p0}, Leq;->g(ZZZ)V
...
.method public final t(Lzp4;Landroid/view/View;I)V
    .locals 13

    invoke-virtual/range {p1 .. p2}, Lzp4;->d(Landroid/view/View;)Ljava/util/List;
...
.method public final v(Landroid/view/View;)I
    ...
    invoke-static {p1, v0, p0}, Lif8;->n(III)I
