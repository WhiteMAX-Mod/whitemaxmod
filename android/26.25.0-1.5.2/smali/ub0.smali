...
.method public constructor <init>(Laob;)V
    ...
    iput-object v1, p0, Lub0;->c:Lyv9;

    iget-object v1, p1, Laob;->d:Ljava/lang/Object;

    check-cast v1, Llp6;

    iput-object v1, p0, Lub0;->b:Llp6;
    ...
    invoke-direct {p1, v0, p0}, Ln6g;-><init>(ILjava/lang/Object;)V

    :goto_0
    iput-object p1, p0, Lub0;->d:Ln6g;

    sget-object p1, Lmq3;->a:Lo3h;

    iput-object p1, p0, Lub0;->f:Lmq3;
...
.method public final a(Lfa0;)Ltb0;
    ...
    :cond_0
    invoke-static {v2, v1}, Lah;->c(Landroid/content/Context;I)Landroid/content/Context;
    ...
    :cond_3
    invoke-virtual {v4}, Ld70;->c()Landroid/media/AudioAttributes;
    ...
    invoke-static {v0, v4}, Ltn;->l(Landroid/media/AudioTrack$Builder;Z)V
    ...
    invoke-static {v0, v1}, Lah;->v(Landroid/media/AudioTrack$Builder;Landroid/content/Context;)V
    ...
    iget-object v2, p0, Lub0;->d:Ln6g;

    iget-object p0, p0, Lub0;->f:Lmq3;

    invoke-direct {v1, v0, p1, v2, p0}, Ltb0;-><init>(Landroid/media/AudioTrack;Lfa0;Ln6g;Lmq3;)V
...
.method public final b(Lba0;)Lda0;
    ...
    iget-object v1, p0, Lub0;->c:Lyv9;

    invoke-virtual {v1, v0, p1}, Lyv9;->G(Lz27;Ld70;)Laa0;
    ...
    :cond_0
    iget-object p0, p0, Lub0;->g:Li70;

    invoke-virtual {p0, v0, p1}, Li70;->d(Lz27;Ld70;)Landroid/util/Pair;
...
.method public final c(Lba0;)Lfa0;
    ...
    iget-object v5, v2, Lz27;->n:Ljava/lang/String;
    ...
    iget-object v7, v0, Lub0;->c:Lyv9;

    invoke-virtual {v7, v2, v4}, Lyv9;->G(Lz27;Ld70;)Laa0;
    ...
    iget-object v3, v2, Lz27;->k:Ljava/lang/String;

    invoke-static {v5, v3}, Lora;->c(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_2
    iget-object v3, v0, Lub0;->g:Li70;

    invoke-virtual {v3, v2, v4}, Li70;->d(Lz27;Ld70;)Landroid/util/Pair;
    ...
    invoke-static {v2, v13}, Ljpl;->b(II)I
    ...
    invoke-static {v10, v11}, Lnpl;->b(J)I
    ...
    invoke-static {v0, v2, v10}, Ljdi;->j(III)I
    ...
    invoke-virtual {v0, v4}, Lea0;->b(Ld70;)V
...
.method public final d(Lba0;)V
    ...
    invoke-direct {v1, v2, v3, p1, v0}, Ll70;-><init>(Landroid/content/Context;Lkq4;Ld70;Landroid/media/AudioDeviceInfo;)V

    iput-object v1, p0, Lub0;->h:Ll70;

    invoke-virtual {v1}, Ll70;->j()Li70;
    ...
    :cond_1
    iget-object v0, p0, Lub0;->h:Ll70;

    invoke-virtual {v0, p1}, Ll70;->l(Ld70;)V
