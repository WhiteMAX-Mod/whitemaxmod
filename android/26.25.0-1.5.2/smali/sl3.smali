...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lzje;->i(Lv7h;)Lu7h;
    ...
    iget-object v1, p0, Lc6c;->E:Landroid/content/Context;

    new-instance v2, Lgod;

    sget-object v3, Llp6;->m:Llp6;

    invoke-virtual {v3, v1}, Llp6;->r(Landroid/content/Context;)Lu5c;

    move-result-object v3

    iget-object v3, v3, Lu5c;->c:Lt5c;

    invoke-direct {v2, v3}, Lgod;-><init>(Lrph;)V

    iget-object v3, p0, Lc6c;->L:Lwb6;

    invoke-virtual {v2, v3}, Lgod;->b(Lrph;)V

    invoke-virtual {v2}, Lgod;->a()V

    iget-object v3, p0, Lc6c;->I:Ljava/lang/String;

    iget-object v4, p0, Lc6c;->X:Lmb7;

    iget-object v5, p0, Lc6c;->Y:Leme;

    new-instance v6, Lvp0;

    invoke-direct {v6, v3, v2}, Lvp0;-><init>(Ljava/lang/String;Lrph;)V

    new-instance v2, Ltv4;

    invoke-direct {v2, v6, v4, v5}, Ltv4;-><init>(Lvp0;Lmb7;Leme;)V

    sget-boolean v3, Ld7c;->a:Z

    invoke-direct {v0, v1, p1, v2}, Lpm1;-><init>(Landroid/content/Context;Lbri;Ltv4;)V

    iget-object p1, p0, Lc6c;->H:Lz6d;

    invoke-virtual {v0, p1}, Lpm1;->v(Lz6d;)V

    invoke-virtual {v0, v5}, Lpm1;->s(Leme;)V

    iget-object p1, p0, Lc6c;->F:Ltb4;

    invoke-virtual {v0, p1}, Lpm1;->u(Ltb4;)V

    new-instance p1, Lyx4;

    invoke-direct {p1}, Lyx4;-><init>()V

    invoke-virtual {v0, p1}, Lpm1;->r(Lyx4;)V

    iget-object p0, p0, Lone/video/player/BaseVideoPlayer;->p:Lr47;

    invoke-virtual {v0, p0}, Lpm1;->t(Lr47;)V

    invoke-virtual {v0}, Lpm1;->c()Lzq0;
    ...
    invoke-direct {v1, p0, v3, v4}, Ld79;-><init>(Ljava/lang/Object;Lgn4;I)V
    ...
    :try_start_0
    iget-object p0, p0, Lvf8;->d:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v0, p1}, Lqkb;->b(Ljava/util/Set;)V
    ...
    invoke-virtual {p0, p1}, Lj55;->i(Lo39;)Lmz1;
    ...
    :try_start_2
    invoke-static {v2, v0, v7}, Lq87;->d0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v9, v3, v7}, Les4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
    ...
    invoke-static {v2, p0, v9}, Lq87;->d0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_3
    invoke-static {p1, v3}, Lbe3;->e0(Lfda;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v13, v3, v11}, Les4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_6
    invoke-static {v2, p0, v13}, Lq87;->d0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_8
    invoke-static {p1}, Lbe3;->V(Lfda;)Ljava/lang/Byte;
    ...
    :goto_7
    invoke-static {v11}, Lh9l;->b(Ljava/lang/Byte;)Ln24;
    ...
    invoke-direct {v11, v12}, Lm51;-><init>(I)V

    invoke-static {p1, v10, v11}, Lp9f;->a(Lfda;Ljava/util/List;Lx97;)Ljava/util/List;
    ...
    :try_start_13
    invoke-static {v2, v0, p1}, Lq87;->d0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v3, p1}, Les4;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_13
    ...
    invoke-static {v2, p0, v5}, Lq87;->d0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_16
    invoke-direct {v3, v8, v9}, Lf24;-><init>(Ln24;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lone/me/chats/tab/ChatsTabWidget;->D1(Ljava/lang/String;)V
