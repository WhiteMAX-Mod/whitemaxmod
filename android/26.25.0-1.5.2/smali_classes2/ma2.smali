...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ldfh;Lglc;Lbmi;Lj4h;)V
    .locals 0
    ...
    iput-object p2, p0, Lma2;->b:Ldfh;

    iput-object p3, p0, Lma2;->c:Lglc;

    iput-object p4, p0, Lma2;->d:Lbmi;

    iput-object p5, p0, Lma2;->e:Lj4h;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lma2;->f:Landroid/util/ArrayMap;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lma2;->g:Landroid/util/ArrayMap;

    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    iput-object p1, p0, Lma2;->h:Landroid/util/ArrayMap;

    return-void
.end method

.method public static final a(Lma2;Ljava/lang/String;ZI)Lo92;
    .locals 8
    ...
    invoke-virtual {p0, p1}, Lma2;->e(Ljava/lang/String;)Landroid/hardware/camera2/CameraExtensionCharacteristics;

    move-result-object p0

    new-instance v3, Lo92;

    invoke-direct {v3, p1, p3, p0}, Lo92;-><init>(Ljava/lang/String;ILandroid/hardware/camera2/CameraExtensionCharacteristics;)V
...
.method public static final b(Lma2;Ljava/lang/String;Z)Lr92;
    .locals 11

    iget-object v0, p0, Lma2;->d:Lbmi;
    ...
    invoke-static {}, Lc70;->c()Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    iget-object v8, v0, Lbmi;->b:Ljava/lang/Object;

    check-cast v8, Ljava/util/Map;

    new-instance v9, Lgd2;

    invoke-direct {v9, p1}, Lgd2;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v8, v9}, Lref;->N(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v0, v8}, Lref;->M(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-direct {v8, p1, v4, p0, v0}, Lr92;-><init>(Ljava/lang/String;Landroid/hardware/camera2/CameraCharacteristics;Lma2;Ljava/util/Set;)V
...
.method public static final c(Lma2;)Z
    .locals 3

    iget-object p0, p0, Lma2;->c:Lglc;
    ...
    iput-boolean v1, p0, Lglc;->b:Z

    :cond_1
    invoke-static {}, Landroid/os/Trace;->endSection()V

    :cond_2
    iget-boolean p0, p0, Lglc;->b:Z
...
# virtual methods
.method public final d(Ljava/lang/String;)Lde2;
    .locals 2
    ...
    iget-object v0, p0, Lma2;->f:Landroid/util/ArrayMap;
    ...
    :try_start_1
    iget-object v1, p0, Lma2;->f:Landroid/util/ArrayMap;
    ...
    :cond_0
    :try_start_3
    invoke-static {p0}, Lma2;->c(Lma2;)Z
    ...
    invoke-static {p0, p1, v1}, Lma2;->b(Lma2;Ljava/lang/String;Z)Lr92;

    move-result-object v1

    iget-object p0, p0, Lma2;->f:Landroid/util/ArrayMap;
    ...
    invoke-static {p0, p1, v0}, Lma2;->b(Lma2;Ljava/lang/String;Z)Lr92;
...
.method public final e(Ljava/lang/String;)Landroid/hardware/camera2/CameraExtensionCharacteristics;
    ...
    iget-object v0, p0, Lma2;->h:Landroid/util/ArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lma2;->h:Landroid/util/ArrayMap;

    invoke-virtual {v1, p1}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    invoke-static {v1}, Ls62;->d(Ljava/lang/Object;)Landroid/hardware/camera2/CameraExtensionCharacteristics;
    ...
    invoke-static {p0, p1}, Lqf;->e(Landroid/hardware/camera2/CameraManager;Ljava/lang/String;)Landroid/hardware/camera2/CameraExtensionCharacteristics;
