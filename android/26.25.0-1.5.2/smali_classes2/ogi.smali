...
.method static constructor <clinit>()V
    ...
    sput-object v3, Logi;->o:[Lfq8;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    sput-object v0, Logi;->p:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, v2}, Lrdi;-><init>(I)V
    ...
    invoke-direct {v1, p0, v3}, Lngi;-><init>(Logi;I)V

    iput-object v1, p0, Logi;->g:Lngi;

    new-instance v1, Lngi;

    const/4 v4, 0x2

    invoke-direct {v1, p0, v4}, Lngi;-><init>(Logi;I)V

    iput-object v1, p0, Logi;->h:Lngi;

    new-instance v1, Lngi;

    invoke-direct {v1, p0, v2}, Lngi;-><init>(Logi;I)V

    iput-object v1, p0, Logi;->i:Lngi;
    ...
    iput-object v1, p0, Logi;->j:Lngi;

    new-instance v4, Lrdi;

    const/16 v5, 0x9

    invoke-direct {v4, v5}, Lrdi;-><init>(I)V

    invoke-static {v2, v4}, Luie;->d0(ILv97;)Lks8;

    move-result-object v4

    iput-object v4, p0, Logi;->m:Lks8;

    new-instance v4, Lngi;

    const/4 v5, 0x0

    invoke-direct {v4, p0, v5}, Lngi;-><init>(Logi;I)V

    iput-object v4, p0, Logi;->n:Lngi;
    ...
    sget-object v4, Logi;->p:Landroid/text/TextPaint;

    invoke-virtual {v4, v3}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    sget-object v3, Ljxh;->x:Lrch;

    sget-object v6, Lft5;->b:Lft5;

    invoke-virtual {v3, v6}, Lrch;->k(Lft5;)J

    move-result-wide v7

    invoke-static {v7, v8, p1}, Ldi5;->c(JLandroid/content/Context;)F

    move-result v7

    invoke-virtual {v4, v7}, Landroid/graphics/Paint;->setTextSize(F)V

    invoke-virtual {v3, v6}, Lrch;->i(Lft5;)J

    move-result-wide v6

    invoke-static {v6, v7, p1}, Ldi5;->c(JLandroid/content/Context;)F

    move-result p1

    invoke-virtual {v4, p1}, Landroid/graphics/Paint;->setLetterSpacing(F)V

    iget-object p1, v3, Lrch;->e:Ljava/lang/String;
    ...
    invoke-direct {p0}, Logi;->getDrawableColor()I

    move-result v0

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setTint(I)V

    iput-object p1, p0, Logi;->k:Landroid/graphics/drawable/Drawable;

    :cond_0
    return-void
.end method

.method public static final synthetic a(Logi;)I
    .locals 0
...
.method public static final synthetic b(Logi;)Landroid/text/BoringLayout$Metrics;
    .locals 0

    invoke-direct {p0}, Logi;->getMetrics()Landroid/text/BoringLayout$Metrics;
...
.method private final getBackgroundColor()I
    ...
    sget-object v0, Logi;->o:[Lfq8;

    const/4 v1, 0x2

    aget-object v0, v0, v1

    iget-object v0, p0, Logi;->i:Lngi;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Logi;->l:Landroid/text/Layout;
    ...
    invoke-virtual {p0}, Logi;->getTextColor()I
    ...
    sget-object v3, Logi;->o:[Lfq8;

    const/4 v4, 0x1

    aget-object v3, v3, v4

    iget-object v3, p0, Logi;->h:Lngi;

    iget-object v3, v3, Lu53;->b:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Logi;->getBackgroundColor()I
    ...
    invoke-direct {p0}, Logi;->getBackgroundCornerRadius()F
    ...
    iget-object p1, p0, Logi;->k:Landroid/graphics/drawable/Drawable;
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Logi;->l:Landroid/text/Layout;
    ...
    :goto_0
    iget-object v0, p0, Logi;->k:Landroid/graphics/drawable/Drawable;
...
.method public final setContent(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Logi;->setText(Ljava/lang/CharSequence;)V
