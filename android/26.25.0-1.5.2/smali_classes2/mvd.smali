...
.method private final setDataList(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lmvd;->c:Ljava/util/List;
...
.method public final a()V
    ...
    iget-object v1, p0, Lmvd;->c:Ljava/util/List;
    ...
    invoke-direct {v3, v4}, Ljvd;-><init>(Landroid/content/Context;)V
    ...
    sget-object v6, Livd;->b:Livd;

    invoke-virtual {v5, v6}, Ljvd;->setSize(Livd;)V

    iget-boolean v6, v3, Llvd;->c:Z

    invoke-virtual {v5, v6}, Ljvd;->setEnabled(Z)V

    iget-object v6, v3, Llvd;->b:Ljava/lang/Integer;

    invoke-virtual {v5, v6}, Ljvd;->setImage(Ljava/lang/Integer;)V

    new-instance v6, Ltgb;

    const/16 v7, 0x10

    invoke-direct {v6, p0, v7, v3}, Ltgb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final setButtonToolDataList(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, Lmvd;->setDataList(Ljava/util/List;)V

    return-void
.end method

.method public final setListener(Lkvd;)V
    .locals 0

    iput-object p1, p0, Lmvd;->a:Lkvd;
