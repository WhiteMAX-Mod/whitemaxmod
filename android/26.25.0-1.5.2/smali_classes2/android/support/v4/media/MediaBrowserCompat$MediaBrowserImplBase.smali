...
.field private final mSubscriptions:Lzv;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mSubscriptions:Lzv;
    ...
    :cond_1
    const-string p0, "connection callback must not be null"
    ...
    :cond_2
    const-string p0, "service component must not be null"
...
.method private isCurrent(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    invoke-static {p2, p1}, Lh45;->z(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public getItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    ...
    :cond_2
    const-string p0, "mediaId is empty"
...
.method public onLoadChildren(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mSubscriptions:Lzv;
...
.method public onServiceConnected(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mSubscriptions:Lzv;

    invoke-virtual {p1}, Lzv;->entrySet()Ljava/util/Set;

    move-result-object p1

    check-cast p1, Ltv;

    invoke-virtual {p1}, Ltv;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {p2}, Lwv;->hasNext()Z

    move-result p3

    if-eqz p3, :cond_4

    invoke-virtual {p2}, Lwv;->next()Ljava/lang/Object;
...
.method public search(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;)V
    ...
    invoke-static {p1, p0, p2}, Lh45;->w(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public sendCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    const-string p3, " because the browser is not connected to the service."

    const-string v0, "Cannot send a custom action ("

    invoke-static {v0, p1, p0, p2, p3}, Lfp6;->d(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public subscribe(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mSubscriptions:Lzv;
    ...
    invoke-virtual {v1, p1, v0}, Lhwf;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public unsubscribe(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    :cond_5
    iget-object p0, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mSubscriptions:Lzv;
