.class public abstract Liel;
.super Ljava/lang/Object;
.source "SourceFile"


# direct methods
.method public static final a(Ljava/util/ArrayList;Lx97;)V
    .locals 1
...
.method public static b(Lgz4;Ljava/lang/String;[BLjava/util/Map;)Lap9;
    .locals 17
    ...
    invoke-direct {v1, v0}, Lkag;-><init>(Lgz4;)V
    ...
    invoke-direct {v4, v1, v14}, Ljz4;-><init>(Lgz4;Lmz4;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_4

    :try_start_1
    invoke-static {v4}, Ly51;->b(Ljava/io/InputStream;)[B
    ...
    iget-object v6, v1, Lkag;->c:Landroid/net/Uri;

    iget-object v7, v1, Lkag;->d:Ljava/util/Map;
    ...
    invoke-direct {v6, v7, v0}, Lznc;-><init>(ILjava/io/Serializable;)V

    iput-object v4, v6, Lznc;->c:Ljava/lang/Object;

    new-instance v0, Lap9;

    invoke-direct {v0, v6}, Lap9;-><init>(Lznc;)V
    :try_end_3
    ...
    invoke-virtual {v14}, Lmz4;->a()Llz4;
    ...
    iput-object v4, v0, Llz4;->a:Landroid/net/Uri;

    invoke-virtual {v0}, Llz4;->a()Lmz4;
    ...
    iget-object v0, v1, Lkag;->a:Lgz4;

    invoke-interface {v0}, Lgz4;->p()Ljava/util/Map;

    move-result-object v7

    iget-wide v8, v1, Lkag;->b:J

    invoke-direct/range {v4 .. v10}, Landroidx/media3/exoplayer/drm/MediaDrmCallbackException;-><init>(Lmz4;Landroid/net/Uri;Ljava/util/Map;JLjava/lang/Exception;)V
