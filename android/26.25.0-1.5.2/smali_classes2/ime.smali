...
.method public constructor <init>(Lone/me/sdk/arch/Widget;)V
    ...
    iput-object p1, p0, Lime;->d:Lone/me/sdk/arch/Widget;

    new-instance p1, Landroid/util/LongSparseArray;

    invoke-direct {p1}, Landroid/util/LongSparseArray;-><init>()V

    iput-object p1, p0, Lime;->e:Landroid/util/LongSparseArray;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lime;->f:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lime;->h:Landroid/util/SparseArray;
...
.method public static I(Landroidx/recyclerview/widget/RecyclerView;)Lnvi;
    .locals 3
...
.method public final A(Lh6e;)V
    ...
    invoke-virtual {p0, p1}, Lime;->H(Llme;)V

    iget-object p0, p1, Llme;->u:Ljn2;
...
.method public bridge synthetic B(Lh6e;)V
    ...
    invoke-virtual {p0, p1}, Lime;->J(Llme;)V

    return-void
.end method

.method public final F(Llme;I)V
    .locals 7

    invoke-virtual {p0, p2}, Lime;->m(I)J

    move-result-wide v0

    iget-object v2, p1, Llme;->u:Ljn2;
    ...
    iget-object v5, p0, Lime;->d:Lone/me/sdk/arch/Widget;

    const/4 v6, 0x1

    invoke-virtual {v5, v2, v3, v6, v4}, Lwn4;->getChildRouter(Landroid/view/ViewGroup;Ljava/lang/String;ZZ)Lfme;

    move-result-object v2

    iput v6, v2, Lfme;->e:I

    iget-object v3, p1, Llme;->v:Lfme;
    ...
    invoke-virtual {v5, v3}, Lwn4;->removeChildRouter(Lfme;)V

    :cond_0
    iput-object v2, p1, Llme;->v:Lfme;

    iput-wide v0, p1, Llme;->x:J
    ...
    iget-object v3, p0, Lime;->e:Landroid/util/LongSparseArray;
    ...
    iget-object v3, p0, Lime;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, p2}, Lime;->G(Lfme;I)V
    ...
    invoke-virtual {v1, v6}, Lwn4;->setOptionsMenuHidden(Z)V
...
.method public final H(Llme;)V
    .locals 3

    iget-boolean v0, p1, Llme;->y:Z
    ...
    :cond_0
    iget-object v0, p1, Llme;->v:Lfme;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lfme;->H()V

    iget-wide v1, p1, Llme;->x:J

    invoke-virtual {p0, v1, v2, v0}, Lime;->K(JLfme;)V
    ...
    iput-boolean p0, p1, Llme;->y:Z

    return-void
.end method

.method public J(Llme;)V
    .locals 1
    ...
    iget-object p0, p0, Lime;->d:Lone/me/sdk/arch/Widget;

    invoke-virtual {p0, v0}, Lwn4;->removeChildRouter(Lfme;)V

    const/4 p0, 0x0

    iput-object p0, p1, Llme;->v:Lfme;
...
.method public final K(JLfme;)V
    ...
    iget-object p3, p0, Lime;->e:Landroid/util/LongSparseArray;

    invoke-virtual {p3, p1, p2, v0}, Landroid/util/LongSparseArray;->put(JLjava/lang/Object;)V

    iget-object p3, p0, Lime;->f:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object p1, p0, Lime;->e:Landroid/util/LongSparseArray;
    ...
    iget-object p1, p0, Lime;->f:Ljava/util/ArrayList;
...
.method public final a()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v3}, Lime;->m(I)J
    ...
    invoke-virtual {p0, v5, v6, v3}, Lime;->K(JLfme;)V
    ...
    :cond_2
    iget-object v0, p0, Lime;->e:Landroid/util/LongSparseArray;
    ...
    iget-object v5, p0, Lime;->e:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Lime;->e:Landroid/util/LongSparseArray;
    ...
    :cond_4
    iget-object v0, p0, Lime;->f:Ljava/util/ArrayList;

    iget p0, p0, Lime;->g:I

    new-instance v3, Lhme;

    invoke-direct {v3, v1, v2, v0, p0}, Lhme;-><init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;I)V
...
.method public final e(Landroid/os/Parcelable;)V
    ...
    iput-object v0, p0, Lime;->e:Landroid/util/LongSparseArray;

    check-cast p1, Lhme;

    iget-object v0, p1, Lhme;->a:Ljava/util/ArrayList;
    ...
    iget-object v6, p1, Lhme;->b:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p1, Lhme;->c:Ljava/util/List;
    ...
    iput-object v1, p0, Lime;->f:Ljava/util/ArrayList;
...
.method public final t(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-static {p1}, Lime;->I(Landroidx/recyclerview/widget/RecyclerView;)Lnvi;
...
.method public final u(Lh6e;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lime;->F(Llme;I)V
...
.method public final w(Landroid/view/ViewGroup;I)Lh6e;
    ...
    invoke-direct {p1, p0}, Llme;-><init>(Ljn2;)V
...
.method public final z(Lh6e;)V
    ...
    invoke-virtual {p0, p1, v0}, Lime;->F(Llme;I)V
