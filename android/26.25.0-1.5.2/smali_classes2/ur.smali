...
.method public static a(Landroid/view/DragEvent;Landroid/widget/TextView;Landroid/app/Activity;)Z
    ...
    invoke-direct {p2, p0, v1}, Lanl;-><init>(Landroid/content/ClipData;I)V
    ...
    iput-object p0, p2, Lul4;->b:Landroid/content/ClipData;

    iput v1, p2, Lul4;->c:I

    :goto_0
    invoke-interface {p2}, Ltl4;->build()Lwl4;

    move-result-object p0

    invoke-static {p1, p0}, Lyti;->h(Landroid/view/View;Lwl4;)Lwl4;
    :try_end_0
