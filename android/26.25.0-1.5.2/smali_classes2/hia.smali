...
.field public final r:Lgia;

.field public volatile s:Ljava/lang/Integer;


# direct methods
.method public constructor <init>(Landroid/content/Context;ILxve;Lgia;)V
    .locals 0

    invoke-direct {p0, p1}, Lxv8;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lhia;->q:Lxve;

    iput-object p4, p0, Lhia;->r:Lgia;
...
# virtual methods
.method public final n(IILd6e;Lb6e;)V
    .locals 9

    sget-object v0, Lq79;->d:Lq79;

    iget-object v1, p0, Lhia;->s:Ljava/lang/Integer;
    ...
    invoke-virtual {v6, v0, v5, v7, v3}, Lrwb;->c(Lq79;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    :goto_0
    iput v1, p4, Lb6e;->d:I

    iput-object v3, p0, Lhia;->s:Ljava/lang/Integer;

    :cond_2
    invoke-super {p0, p1, p2, p3, p4}, Lxv8;->n(IILd6e;Lb6e;)V
    ...
    iget-object p4, p4, Lb6e;->e:Landroid/view/animation/Interpolator;
    ...
    invoke-static {v2, v4, p2, v6, p1}, Lmq4;->x(IILjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
...
.method public final o()V
    ...
    iget-object v1, p0, Lhia;->r:Lgia;

    invoke-virtual {v1, v0}, Lgia;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-super {p0}, Lxv8;->o()V

    return-void
.end method

.method public final p(Landroid/view/View;Ld6e;Lb6e;)V
    .locals 7

    iget-boolean p2, p2, Ld6e;->h:Z
    ...
    iget-object p2, p0, Lxv8;->c:Lr5e;

    const/4 v6, 0x0

    if-eqz p2, :cond_1

    invoke-virtual {p2}, Lr5e;->f()Z
    ...
    invoke-virtual {p2}, Lr5e;->L()I

    move-result v3

    iget p1, p2, Lr5e;->o:I

    invoke-virtual {p2}, Lr5e;->I()I
    ...
    invoke-virtual/range {v0 .. v5}, Lhia;->t(IIIII)I
    ...
    invoke-virtual {v0, p1}, Lxv8;->e(I)I
    ...
    :cond_3
    iget-object p2, v0, Lxv8;->j:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {p3, v6, p0, p1, p2}, Lb6e;->b(IIILandroid/view/animation/BaseInterpolator;)V
...
.method public final t(IIIII)I
    ...
    invoke-virtual/range {v3 .. v8}, Lhia;->t(IIIII)I
    ...
    invoke-static {p1, p0, p3}, Lh45;->b(FFI)I
...
.method public final u(I)V
    ...
    iput-object p1, p0, Lhia;->s:Ljava/lang/Integer;
