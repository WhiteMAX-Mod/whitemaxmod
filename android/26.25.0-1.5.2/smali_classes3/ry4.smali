...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;Luud;)V
    .locals 1
    ...
    iput-object v0, p0, Lry4;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lry4;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lry4;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Lry4;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Lry4;->b:Luud;

    new-instance p2, Lyi9;

    invoke-direct {p2, p0, p1}, Lyi9;-><init>(Lry4;Lorg/webrtc/DataChannel;)V
...
.method public final a(Lzme;)V
    ...
    iget-object p0, p0, Lry4;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object p0, p0, Lry4;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    iget-object v4, p0, Lry4;->b:Luud;

    invoke-interface {v4, v1, v3, v2}, Luud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(I[B)Z
    ...
    iget-object v1, p0, Lry4;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v5, p0, Lry4;->b:Luud;

    invoke-interface {v5, v2, v4, v3}, Luud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
