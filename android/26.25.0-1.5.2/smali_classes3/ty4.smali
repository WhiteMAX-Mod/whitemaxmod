...
# direct methods
.method public constructor <init>(Lry4;Lsz9;)V
    .locals 0
    ...
    iput-object p2, p0, Lty4;->a:Lsz9;

    const/16 p2, 0x1e

    iput p2, p0, Lty4;->b:I

    iput-object p1, p0, Lty4;->c:Lry4;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lty4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lty4;->e:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lty4;->h:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lty4;->i:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lty4;->j:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lty4;->k:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1b

    iget-object v0, p0, Lty4;->j:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Lty4;->c:Lry4;
    ...
    iget-object v2, v2, Lry4;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Lty4;->f:Llm;

    if-nez v0, :cond_7

    iget-object v0, p0, Lty4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lty4;->h:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Lty4;->i:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lty4;->e:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, v0, Llm;->c:Ldl;

    const/4 v7, 0x2

    if-ne v6, v4, :cond_e

    instance-of v6, v0, Lfl;

    instance-of v8, v0, Lcl;
    ...
    :cond_16
    iget-object v2, p0, Lty4;->a:Lsz9;

    array-length v4, v8

    iget-object v2, v2, Lsz9;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v7, v8}, Lry4;->e(I[B)Z
    ...
    iget-object v2, v2, Lsz9;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v1, p0, Lty4;->f:Llm;
    :try_end_6
    ...
    iget-object p0, p0, Lty4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
