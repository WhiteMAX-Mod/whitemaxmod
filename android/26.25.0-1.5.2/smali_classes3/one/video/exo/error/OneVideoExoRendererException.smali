...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlaybackException;)V
    ...
    iget-object v0, p1, Landroidx/media3/exoplayer/ExoPlaybackException;->m:Lz27;
    ...
    :goto_2
    iput-object v0, p0, Lone/video/exo/error/OneVideoExoRendererException;->b:Lxq9;

    sget-object v0, Ld37;->a:Ljava/util/HashMap;
    ...
    sget-object p1, Lc37;->f:Lc37;

    :cond_8
    iput-object p1, p0, Lone/video/exo/error/OneVideoExoRendererException;->c:Lc37;
    ...
    iget-object p0, p1, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer$DecoderInitializationException;->c:Lrm9;

    invoke-static {p0}, Lone/video/exo/error/OneVideoExoRendererException;->a(Lrm9;)V
    ...
    iget-object p0, v4, Landroidx/media3/exoplayer/mediacodec/MediaCodecDecoderException;->a:Lrm9;
...
.method public static a(Lrm9;)V
    ...
    iget-boolean v0, p0, Lrm9;->e:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    invoke-virtual {p0}, Lrm9;->f()Z
    ...
    iget-boolean v0, p0, Lrm9;->g:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lrm9;->i:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean v0, p0, Lrm9;->j:Z

    invoke-static {v0, v1}, Ljava/lang/Boolean;->compare(ZZ)I

    iget-boolean p0, p0, Lrm9;->f:Z
