...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltx0;->x:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Ljava/io/File;Lrx0;Lqx0;IIZ)V
    .locals 12
    ...
    iput-object v2, p0, Ltx0;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Ltx0;->e:Ljava/util/ArrayList;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, p0, Ltx0;->h:Ljava/lang/Object;

    new-instance v4, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v4, v3}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v4, p0, Ltx0;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v4, Lkb;

    const/4 v5, 0x6

    invoke-direct {v4, v5, p0}, Lkb;-><init>(ILjava/lang/Object;)V

    iput-object v4, p0, Ltx0;->p:Lkb;

    iput-object p2, p0, Ltx0;->a:Lrx0;
    ...
    sget-object p2, Ltx0;->A:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    sput-object v4, Ltx0;->A:Ljava/util/concurrent/ThreadPoolExecutor;

    :cond_0
    new-instance p2, Ljava/io/File;

    sget-object v4, Ljm4;->j:Lv3b;

    iget-object v4, v4, Lv3b;->g:Ltb4;

    invoke-virtual {v4}, Ltb4;->f()Ljava/io/File;
    ...
    invoke-static {v6, p1, v7}, Lh45;->w(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {v4, p2, p1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v4, p0, Ltx0;->m:Ljava/io/File;

    const/high16 p1, 0x42700000    # 60.0f

    invoke-static {p1}, Lmh;->a(F)I
    ...
    iput-boolean p1, p0, Ltx0;->k:Z

    iget-boolean p1, p0, Ltx0;->k:Z
    ...
    iput-boolean p1, p0, Ltx0;->s:Z

    iget-boolean p1, p0, Ltx0;->s:Z
    ...
    :cond_4
    invoke-virtual {p0, p2, p1}, Ltx0;->d(Ljava/io/RandomAccessFile;I)V
    ...
    iput-boolean v3, p0, Ltx0;->s:Z

    iput-boolean v3, p0, Ltx0;->k:Z

    iput-boolean v5, p0, Ltx0;->q:Z
    ...
    :cond_5
    iget-object p1, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
    ...
    :cond_6
    iput-object p2, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
    :try_end_1
    ...
    iget-object p1, p0, Ltx0;->m:Ljava/io/File;
    ...
    :try_start_5
    iget-object p0, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
...
.method public final b()V
    ...
    :try_start_0
    iget-object v0, v1, Ltx0;->m:Ljava/io/File;
    ...
    iget-object v3, v1, Ltx0;->m:Ljava/io/File;
    ...
    iput-boolean v0, v1, Ltx0;->s:Z

    iget-boolean v0, v1, Ltx0;->s:Z

    if-eqz v0, :cond_4

    iget-object v0, v1, Ltx0;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v0}, Ltx0;->d(Ljava/io/RandomAccessFile;I)V

    invoke-virtual {v2, v11, v12}, Ljava/io/RandomAccessFile;->seek(J)V

    iget-object v0, v1, Ltx0;->u:Ljava/io/RandomAccessFile;

    if-eq v0, v2, :cond_1

    invoke-virtual {v1}, Ltx0;->a()V
    ...
    :cond_1
    :goto_0
    iput-object v2, v1, Ltx0;->u:Ljava/io/RandomAccessFile;

    iput-boolean v13, v1, Ltx0;->k:Z

    iput-boolean v13, v1, Ltx0;->q:Z
    :try_end_2
    ...
    :cond_2
    :goto_1
    iget-object v0, v1, Ltx0;->a:Lrx0;

    invoke-interface {v0}, Lrx0;->releaseForGenerateCache()V
    ...
    :cond_3
    :try_start_5
    iput-boolean v14, v1, Ltx0;->k:Z

    iput-boolean v14, v1, Ltx0;->s:Z
    ...
    :goto_2
    :try_start_8
    iget-object v2, v1, Ltx0;->m:Ljava/io/File;
    ...
    :catchall_4
    :try_start_9
    iget-object v2, v1, Ltx0;->u:Ljava/io/RandomAccessFile;
    :try_end_9
    ...
    invoke-direct {v0, v15}, Lz77;-><init>(I)V

    sput-object v0, Ltx0;->C:Lz77;
    ...
    invoke-virtual {v0, v2, v3}, Lz77;->h(II)V
    ...
    invoke-interface {v0}, Lrx0;->prepareForGenerateCache()V
    ...
    :cond_8
    :goto_5
    iget-object v0, v1, Ltx0;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-interface {v0, v15}, Lrx0;->getNextFrame(Landroid/graphics/Bitmap;)I
    ...
    invoke-virtual {v4, v3}, Lh38;->g(I)V
    ...
    invoke-virtual {v6, v9}, Lh38;->g(I)V
    ...
    iput-object v0, v1, Ltx0;->u:Ljava/io/RandomAccessFile;

    iput-boolean v13, v1, Ltx0;->s:Z
    ...
    sget-object v15, Ltx0;->A:Ljava/util/concurrent/ThreadPoolExecutor;

    new-instance v0, Lox0;

    invoke-direct/range {v0 .. v9}, Lox0;-><init>(Ltx0;Ljava/util/concurrent/atomic/AtomicBoolean;[Landroid/graphics/Bitmap;I[Lh38;ILjava/io/RandomAccessFile;Ljava/util/ArrayList;[Ljava/util/concurrent/CountDownLatch;)V
    ...
    :cond_e
    iget-object v0, v1, Ltx0;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, v4}, Lx3b;->k(Ljava/lang/String;)V
    ...
    :goto_10
    iget-object v1, v1, Ltx0;->a:Lrx0;

    invoke-interface {v1}, Lrx0;->releaseForGenerateCache()V
...
.method public final d(Ljava/io/RandomAccessFile;I)V
    ...
    invoke-direct {v1, v0}, Lsx0;-><init>(I)V
    ...
    iget-object v2, p0, Ltx0;->e:Ljava/util/ArrayList;
...
.method public final e(Lsx0;)[B
    ...
    sget-object v2, Ltx0;->x:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-boolean v0, Ltx0;->y:Z

    if-nez v0, :cond_4

    sput-boolean v1, Ltx0;->y:Z

    iget-object p0, p0, Ltx0;->p:Lkb;

    const-wide/16 v0, 0x1388

    invoke-static {p0, v0, v1}, Lmh;->e(Ljava/lang/Runnable;J)V

    :cond_4
    return-object p1

    :cond_5
    iput-object p1, p0, Ltx0;->g:[B
...
.method public final f(Landroid/graphics/Bitmap;I)I
    ...
    :try_start_0
    iget-boolean v3, p0, Ltx0;->s:Z

    if-nez v3, :cond_1

    iget-boolean v3, p0, Ltx0;->k:Z
    ...
    iget-object v3, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
    ...
    iget-object v5, p0, Ltx0;->m:Ljava/io/File;
    ...
    iput-boolean v5, p0, Ltx0;->s:Z

    iget-boolean v5, p0, Ltx0;->s:Z

    if-eqz v5, :cond_3

    iget-object v5, p0, Ltx0;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v3, v5}, Ltx0;->d(Ljava/io/RandomAccessFile;I)V
    ...
    invoke-virtual {p0, p2}, Ltx0;->e(Lsx0;)[B
    ...
    iget-boolean v6, p0, Ltx0;->t:Z

    if-nez v6, :cond_8

    iget-object v6, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
    ...
    :cond_7
    iput-object v3, p0, Ltx0;->u:Ljava/io/RandomAccessFile;

    goto :goto_1

    :cond_8
    iput-object v2, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
    ...
    :goto_1
    iget-object v6, p0, Ltx0;->v:Landroid/graphics/BitmapFactory$Options;
    ...
    iput-object v6, p0, Ltx0;->v:Landroid/graphics/BitmapFactory$Options;
    ...
    iget-object p1, p0, Ltx0;->v:Landroid/graphics/BitmapFactory$Options;
...
.method public final h()Z
    ...
    iget-boolean v0, p0, Ltx0;->s:Z

    if-eqz v0, :cond_1

    iget-boolean p0, p0, Ltx0;->k:Z
...
.method public final i()V
    ...
    iget-object v0, p0, Ltx0;->u:Ljava/io/RandomAccessFile;
    ...
    iput-object v0, p0, Ltx0;->u:Ljava/io/RandomAccessFile;

    :cond_0
    const/4 v0, 0x1

    iput-boolean v0, p0, Ltx0;->t:Z
