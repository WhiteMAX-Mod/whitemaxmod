...
.method public constructor <init>(Lfda;)V
    ...
    iget-object p1, p0, Lf3h;->c:Ljava/util/List;

    if-nez p1, :cond_0

    sget-object p1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p1, p0, Lf3h;->c:Ljava/util/List;

    :cond_0
    iget-object p1, p0, Lf3h;->d:Ljava/util/Map;

    if-nez p1, :cond_1

    sget-object p1, Ljava/util/Collections;->EMPTY_MAP:Ljava/util/Map;

    iput-object p1, p0, Lf3h;->d:Ljava/util/Map;
...
.method public final b(Lfda;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lf3h;->d:Ljava/util/Map;
    ...
    iget-object v1, p0, Lf3h;->d:Ljava/util/Map;
...
.method public final h()Ljava/util/List;
    ...
    iget-object p0, p0, Lf3h;->c:Ljava/util/List;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lf3h;->c:Ljava/util/List;

    invoke-static {v0}, Luie;->M(Ljava/util/Collection;)I

    move-result v0

    iget-object p0, p0, Lf3h;->d:Ljava/util/Map;
