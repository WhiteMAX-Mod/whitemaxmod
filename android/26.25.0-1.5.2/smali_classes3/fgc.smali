...
.method public constructor <init>(Lks8;Lks8;Lks8;)V
    ...
    iput-object p3, p0, Lfgc;->a:Lks8;

    iput-object p1, p0, Lfgc;->b:Lks8;

    iput-object p2, p0, Lfgc;->c:Lks8;
    ...
    iput-object p1, p0, Lfgc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    iput-object p1, p0, Lfgc;->e:Legc;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lfgc;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    return-void
.end method

.method public static d(Leri;)Ldgc;
    .locals 2

    new-instance v0, Ldgc;

    iget-object v1, p0, Leri;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    iget-object p0, p0, Leri;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lkri;

    move-result-object p0

    invoke-direct {v0, v1, p0}, Ldgc;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lkri;)V
...
.method public final clear()V
    ...
    iget-object v0, p0, Lfgc;->f:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2, v3}, Lp42;->e(Z)V

    const/4 v3, 0x0

    iput-object v3, v2, Lp42;->j:Lmci;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lp42;->k:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lfgc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/video/VideoRender;->clear()V

    iget-object p0, p0, Lfgc;->e:Legc;
...
.method public final e()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    .locals 0

    iget-object p0, p0, Lfgc;->c:Lks8;
...
.method public final f(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    .locals 2

    invoke-virtual {p0}, Lfgc;->c()Lru/ok/android/externcalls/sdk/Conversation;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object p0, p0, Lfgc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final onCameraChanged()V
    ...
    iget-object v3, v1, Lp42;->l:Leri;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Leri;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lp42;->d:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lfgc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0}, Lfgc;->e()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v0

    invoke-virtual {p0, v0, p1}, Lfgc;->f(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lfgc;->f(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lfgc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-interface {p0}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lfr1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lfr1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
