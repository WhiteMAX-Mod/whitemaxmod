...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2, p0}, Lnl9;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Ltr0;->b:Lnl9;

    new-instance v0, Lgj7;

    const/16 v2, 0xf

    invoke-direct {v0, v2, p0}, Lgj7;-><init>(ILjava/lang/Object;)V
...
.method private final getAgslDelegate()Lge;
    .locals 0

    iget-object p0, p0, Ltr0;->c:Lks8;
...
# virtual methods
.method public abstract a(Lfe;FF)V
.end method
...
.method public final c()V
    ...
    invoke-direct {p0}, Ltr0;->getAgslDelegate()Lge;

    move-result-object p0

    iget-object v1, p0, Lge;->a:Lnl9;

    iget-object v2, p0, Lge;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iget-object v2, v1, Lnl9;->b:Ljava/lang/Object;

    check-cast v2, Ltr0;

    invoke-virtual {v2}, Ltr0;->getSpec()Lizh;
    ...
    sget-object v3, Lge;->g:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v2}, Lee;->b(Ljava/lang/Object;)Landroid/graphics/RuntimeShader;
    ...
    :goto_0
    iput-object v2, p0, Lge;->b:Landroid/graphics/RuntimeShader;

    if-nez v2, :cond_8

    sget-object v2, Lvmf;->a:Lks8;

    iget-object v1, v1, Lnl9;->b:Ljava/lang/Object;

    check-cast v1, Ltr0;

    invoke-virtual {v1}, Ltr0;->getSpec()Lizh;
    ...
    invoke-virtual {v1}, Lxfl;->w()Ljava/util/List;
    ...
    invoke-static {v8, v5, v6, v3, v7}, Lnzg;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, v4}, Ljmd;-><init>(I)V
    ...
    invoke-virtual {v1, v5, v3}, Lh7e;->c(Ljava/lang/String;Lx97;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3, v1}, Lh7e;->c(Ljava/lang/String;Lx97;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lee;->c(Ljava/lang/String;)Landroid/graphics/RuntimeShader;

    move-result-object v0

    iput-object v0, p0, Lge;->b:Landroid/graphics/RuntimeShader;

    return-void

    :cond_6
    iget-object v1, p0, Ltr0;->d:Lyh7;
    ...
    iget-object v3, p0, Ltr0;->b:Lnl9;

    invoke-direct {v1, v2, v3}, Lyh7;-><init>(Landroid/content/Context;Lnl9;)V

    iput-object v1, p0, Ltr0;->d:Lyh7;
    ...
    invoke-virtual {p0, v0}, Lyh7;->setStarted(Z)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lge;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iput-object v1, p0, Lge;->b:Landroid/graphics/RuntimeShader;

    sget-object v1, Lge;->g:Ljava/util/LinkedHashMap;

    iget-object p0, p0, Lge;->a:Lnl9;

    iget-object p0, p0, Lnl9;->b:Ljava/lang/Object;

    check-cast p0, Ltr0;

    invoke-virtual {p0}, Ltr0;->getSpec()Lizh;
...
.method public abstract getSpec()Lizh;
.end method
...
.method public final onDrawForeground(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v1, Lge;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_2
    iget-object v4, v0, Lge;->e:[F

    iget-object v5, v0, Lge;->c:Lks8;
    ...
    invoke-static {v1, v4}, Lee;->B(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, v0, Lge;->f:Lks8;
    ...
    invoke-virtual {p0, v0, v2, v3}, Ltr0;->a(Lfe;FF)V
