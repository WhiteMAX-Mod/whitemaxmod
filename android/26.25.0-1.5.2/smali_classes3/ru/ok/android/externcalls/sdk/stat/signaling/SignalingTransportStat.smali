...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Lv97;Ljgh;Luud;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lv97;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Ljgh;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->log:Luud;
    ...
    invoke-direct {p3, p2}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTracker;-><init>(Ljgh;)V
    ...
    invoke-direct {p1, p2}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTracker;-><init>(Ljgh;)V
...
.method private final addCommonStats(Lru/ok/android/externcalls/analytics/events/EventItemsMap;Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTracker$StatisticsInfo;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->log:Luud;

    const-string v3, "SignalingTransportStat"

    const-string v4, "issue with OnlineQuantilesApproximator"

    invoke-interface {p0, v3, v4, v2}, Luud;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    const-string p0, "median_value"

    invoke-virtual {p1, p0, v0}, Lru/ok/android/externcalls/analytics/events/EventItemsMap;->set(Ljava/lang/String;Ljava/lang/Long;)Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    const-string p0, "p95_value"

    invoke-virtual {p1, p0, v1}, Lru/ok/android/externcalls/analytics/events/EventItemsMap;->set(Ljava/lang/String;Ljava/lang/Long;)Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    const-string p2, "values_count"

    invoke-virtual {p1, p2, p0}, Lru/ok/android/externcalls/analytics/events/EventItemsMap;->set(Ljava/lang/String;Ljava/lang/Integer;)Lru/ok/android/externcalls/analytics/events/EventItemsMap;
...
.method private final onFailed()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Ljgh;
...
.method private final report(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lv97;
    ...
    invoke-static {p0, p1, p2, v0, v1}, Lxg1;->a(Lxg1;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;I)V
...
.method private final reportCommandSummary()V
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lv97;
    ...
    invoke-static {v2, v4, v5, v3, v1}, Lxg1;->a(Lxg1;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;I)V
...
.method private final reportPingSummary()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->getEventualStatSender:Lv97;
    ...
    invoke-static {v1, v0, v3, v2, p0}, Lxg1;->a(Lxg1;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;I)V
...
.method public onCommandSent(Lqvf;Ljava/lang/String;Z)V
    .locals 0
...
.method public onConnect(Lqvf;)V
    .locals 2

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Ljgh;
...
.method public onConnected(Lqvf;)V
    .locals 4
    ...
    invoke-virtual {p1, v2}, Lqvf;->a(I)Ljava/lang/String;
...
.method public onDisconnectedSuccessfully(Lqvf;)V
    .locals 0
...
.method public onFailedByException(Lqvf;Ljava/lang/Throwable;)V
    .locals 2
    ...
    invoke-static {p2, v0}, Lhug;->t1(ILjava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p1, v0}, Lqvf;->a(I)Ljava/lang/String;
...
.method public onFailedByPings(Lqvf;)V
    .locals 4
...
.method public onMessageReceived(Lqvf;Ljava/lang/String;Z)V
    .locals 2
...
.method public onRestart(Lqvf;)V
    .locals 2
...
.method public onTimeout(Lqvf;)V
    .locals 4
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;->timeProvider:Ljgh;
    ...
    invoke-virtual {p1, v1}, Lqvf;->a(I)Ljava/lang/String;
