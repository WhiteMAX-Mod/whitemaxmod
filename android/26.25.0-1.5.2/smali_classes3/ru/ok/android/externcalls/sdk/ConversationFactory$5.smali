...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/ok/android/externcalls/sdk/ConversationFactory;->joinAnonByLinkInternal(Lx97;Z)Lru/ok/android/externcalls/sdk/LazyConversation;
.end annotation
...
.method public static synthetic a(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationFactory$5;->lambda$start$1(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;Ljava/lang/Throwable;)V
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;Lru/ok/android/externcalls/sdk/Conversation;)V
    ...
    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationFactory$5;->lambda$start$0(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;Lru/ok/android/externcalls/sdk/Conversation;)V

    return-void
.end method

.method private static synthetic lambda$start$0(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;Lru/ok/android/externcalls/sdk/Conversation;)V
    .locals 0
...
.method private static synthetic lambda$start$1(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;Ljava/lang/Throwable;)V
    .locals 0
...
.method public getConversation()Lru/ok/android/externcalls/sdk/Conversation;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory$5;->val$conversation:Lru/ok/android/externcalls/sdk/ConversationImpl;
...
.method public start()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory$5;->val$params:Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;

    new-instance v1, Lru/ok/android/externcalls/sdk/d;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lru/ok/android/externcalls/sdk/d;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    new-instance v2, Lru/ok/android/externcalls/sdk/d;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lru/ok/android/externcalls/sdk/d;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    invoke-virtual {v0, v1, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepareJoinByLink(Lrd4;Lrd4;)V
