...
.method private applyExternals(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Los1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v3, v0, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Los1;)V
...
.method private collectExternalIdResolutionCandidatesForSessionRoom(Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->getInternalIdExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Los1;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Los1;)V
...
.method public resolveIds(Ljava/util/List;Lru/ok/android/externcalls/sdk/id/mapping/MappingContext;)Le34;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p0, p1, p2}, Lao;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, Lh34;

    const/4 p1, 0x0

    invoke-direct {p0, p1, v0}, Lh34;-><init>(ILjava/lang/Object;)V

    invoke-static {}, Laue;->b()Lrte;

    move-result-object p1

    invoke-virtual {p0, p1}, Le34;->c(Lrte;)Ll34;
