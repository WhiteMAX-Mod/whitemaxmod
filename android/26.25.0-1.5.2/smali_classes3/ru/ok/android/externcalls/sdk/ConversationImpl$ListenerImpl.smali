...
.method private handleCallAccepted(Lts1;)V
    .locals 3
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->c0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lk81;

    move-result-object v0

    iget-object v0, v0, Lk81;->n0:Lv22;

    invoke-virtual {v0}, Lv22;->w()Ldkh;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lts1;
...
.method private handleHangup(Lk81;Ljava/lang/Object;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    iget-object v1, p1, Lk81;->J:Lzn7;

    invoke-static {v0, v1, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->C0(Lru/ok/android/externcalls/sdk/ConversationImpl;Lzn7;Ljava/lang/Object;)Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;
    ...
    iget-object v1, p1, Lk81;->e1:Lyi9;

    invoke-virtual {v1}, Lyi9;->y()Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;
...
.method private handleMuteParticipant(Lc2b;)V
    .locals 2

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->shouldNotifyLegacyListener(Lc2b;)Z
    ...
    iget-object v1, p1, Lc2b;->a:Lb2b;

    invoke-interface {v0, v1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteChanged(Lb2b;)V
    ...
    iget-object p1, p1, Lc2b;->a:Lb2b;

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteChanged(Lb2b;)V

    return-void
.end method

.method private handleMuteStateInitialized(Lc2b;)V
    .locals 1

    iget-boolean v0, p1, Lc2b;->b:Z
    ...
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteStateInitialized(Lb2b;)V

    return-void
.end method

.method private handleRolesChanged(Lts1;)V
    .locals 2
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Los1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lts1;
    ...
    invoke-virtual {v0, p1, v1}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lts1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method private maybeInitP2PRelaySwitchTrigger()V
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->p0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Luud;

    move-result-object v1

    invoke-direct {v7, v0, v1}, Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProviderImpl;-><init>(Lru/ok/android/externcalls/sdk/api/RemoteSettings;Luud;)V
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->c0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lk81;
    ...
    invoke-direct {v5, v1, v6}, Ln71;-><init>(Lk81;I)V
    ...
    invoke-direct/range {v2 .. v7}, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;-><init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;Luud;Lv97;Lru/ok/android/externcalls/sdk/stat/ConversationStats;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProvider;)V
...
.method private shouldNotifyLegacyListener(Lc2b;)Z
    .locals 2
    ...
    iget-object p0, p1, Lc2b;->a:Lb2b;

    iget-object p1, p0, Lb2b;->a:Ljava/util/AbstractMap;

    iget-object p0, p0, Lb2b;->b:Ljava/util/Set;
...
.method public onAsrOnlineAvailableChanged()V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->c0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lk81;

    move-result-object p0

    sget-object v1, Li81;->f:Li81;
...
.method public onCallParticipantFingerprint(Lts1;J)V
    .locals 2
...
.method public onCallParticipantNetworkStatusChanged(Ljava/util/List;)V
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Los1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lts1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lkdf;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lkdf;
...
.method public onCustomData(Los1;Lorg/json/JSONObject;)V
    .locals 0
...
.method public onEvent(Lk81;Lig1;Ljava/lang/Object;)V
    .locals 6

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->p0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Luud;
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStopped(Lzua;)V

    return-void

    :pswitch_2
    instance-of p1, p3, Lyua;
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStatesUpdatedChanged(Lyua;)V

    return-void

    :pswitch_3
    instance-of p1, p3, Lwua;
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStarted(Lwua;)V
    ...
    :pswitch_6
    instance-of p1, p3, Lc2b;

    if-eqz p1, :cond_4

    check-cast p3, Lc2b;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteStateInitialized(Lc2b;)V
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteParticipant(Lc2b;)V

    return-void

    :pswitch_8
    instance-of p1, p3, Los1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Los1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lts1;)V

    goto :goto_1

    :pswitch_a
    instance-of p1, p3, Lts1;

    if-eqz p1, :cond_4

    check-cast p3, Lts1;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lts1;)V
    ...
    :pswitch_d
    invoke-virtual {p1, v1}, Lk81;->K(Z)V
    ...
    :pswitch_e
    invoke-virtual {p1, v2}, Lk81;->K(Z)V
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeaturesPerRoleChanged(Ljh1;)V
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeatureSetChanged(Lih1;)V
    ...
    :cond_3
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleCallAccepted(Lts1;)V
    ...
    iget-object v0, p1, Lk81;->e1:Lyi9;
    ...
    sget-object v0, Lzn7;->f:Lzn7;

    sget-object v1, Ljava/util/Collections;->EMPTY_SET:Ljava/util/Set;

    invoke-direct {p3, v0, v1, v3}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;-><init>(Lzn7;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iget-object p2, p1, Lk81;->e1:Lyi9;
    ...
    invoke-virtual {p2, p3}, Lyi9;->I(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;)V
    ...
    :pswitch_1d
    invoke-direct {p0, p1, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleHangup(Lk81;Ljava/lang/Object;)V
    ...
    iget-object v1, p1, Lk81;->e0:Lzpf;

    iget-object p0, v1, Lzpf;->a:Ljava/util/concurrent/ExecutorService;
...
.method public onStateChanged(Los1;Lqs1;)V
    .locals 2
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->fromInternal(Los1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-interface {v1, v0, p2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onStateChanged(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lqs1;)V
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/state/internal/ParticipantStatesManagerImpl;->onStateChanged(Los1;Lqs1;)V
