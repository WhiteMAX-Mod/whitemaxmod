...
.field private final getConfigDisposable:Ltk5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Lagj;Luud;Ljgh;Lv97;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Luud;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ljgh;

    iput-object p4, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getEventualStatSender:Lv97;
    ...
    invoke-interface {p1}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Lei9;
    ...
    iput-object v1, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getConfigDisposable:Ltk5;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;)Luud;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Luud;

    return-object p0
.end method

.method public static final synthetic access$getTimeProvider$p(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;)Ljgh;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ljgh;

    return-object p0
.end method

.method public static final synthetic access$maybeInitWebRTCStat(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;Lzfj;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->maybeInitWebRTCStat(Lzfj;)V
...
.method private final maybeInitWebRTCStat(Lzfj;)V
    .locals 1
    ...
    iget-object p1, p1, Lzfj;->a:Ljava/util/Set;
...
.method private final onIceCandidateGenerated(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ljgh;
...
.method private final parseIceCandidateSdp(Ljava/lang/String;)Losa;
    .locals 5
    ...
    :try_start_0
    invoke-static {p1}, Losa;->a(Ljava/lang/String;)Losa;

    move-result-object v4

    if-nez v4, :cond_0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Luud;
    ...
    invoke-interface {v1, v0, p1}, Luud;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v2, v4, Losa;->b:Ljava/lang/String;

    if-nez v2, :cond_1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Luud;
    ...
    invoke-interface {v2, v0, p1}, Luud;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final send(Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat$Event;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getEventualStatSender:Lv97;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat$Event;->getTs()Lhhh;
    ...
    invoke-virtual {v0, v4, v3, v5, v6}, Lyg1;->e(Lhhh;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    :cond_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->logger:Luud;
...
.method public final onAnswerReceived()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->timeProvider:Ljgh;
...
.method public final onIceCandidateGenerated(Ljava/lang/String;)V
    ...
    .line 35
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->parseIceCandidateSdp(Ljava/lang/String;)Losa;
    ...
    iget-object p1, p1, Losa;->c:Ljava/lang/String;
...
.method public final release()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/stat/webrtc/ConversationWebRTCStat;->getConfigDisposable:Ltk5;
