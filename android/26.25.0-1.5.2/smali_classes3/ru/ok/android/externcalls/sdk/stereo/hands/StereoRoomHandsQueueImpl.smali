...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/stereo/internal/command/StereoRoomCommandExecutor;Lla7;Lx97;Lru/ok/android/externcalls/sdk/stereo/internal/listener/StereoRoomListenerManagerImpl;Ljgh;)V",
        "onSuccess",
        "",
        "onError",
        "loadHandsQueue",
...
.field private final getExternalId:Lx97;
...
.field private final idsResolverHelper:Lla7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lla7;"
        }
...
# direct methods
.method public constructor <init>(Lru/ok/android/externcalls/sdk/stereo/internal/command/StereoRoomCommandExecutor;Lla7;Lx97;Lru/ok/android/externcalls/sdk/stereo/internal/listener/StereoRoomListenerManagerImpl;Ljgh;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->idsResolverHelper:Lla7;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->getExternalId:Lx97;
    ...
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->timeProvider:Ljgh;
...
.method public static synthetic a(Lx42;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->onHandUp$lambda$0(Lx42;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Lv97;IZLjava/util/List;)Lkzh;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue$lambda$0(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Lv97;IZLjava/util/List;)Lkzh;
...
.method public static synthetic c(Lx97;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadMoreElements$lambda$0(Lx97;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
...
.method public static synthetic d(Ljava/util/List;Lv97;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue$lambda$0$1(Ljava/util/List;Lv97;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
...
.method private final loadHandsQueue(Lv97;Lx97;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v2, p1}, Ls0d;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {v0, v1, p2}, Lru/ok/android/externcalls/sdk/stereo/internal/command/StereoRoomCommandExecutor;->getHandsQueue(Loa7;Lx97;)V

    return-void
.end method

.method public static synthetic loadHandsQueue$default(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Lv97;Lx97;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue(Lv97;Lx97;)V

    return-void
.end method

.method private static final loadHandsQueue$lambda$0(Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;Lv97;IZLjava/util/List;)Lkzh;
    .locals 2
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->idsResolverHelper:Lla7;
    ...
    invoke-static {p3, v1}, Lut3;->M0(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {p3, v1, p4, p1, p0}, Lh7c;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-interface {p2, v0, p3}, Lla7;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final loadHandsQueue$lambda$0$1(Ljava/util/List;Lv97;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
    .locals 5
    ...
    iget-object v1, p2, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->getExternalId:Lx97;

    iget-object v2, v0, Lu42;->b:Los1;
...
.method private static final loadMoreElements$lambda$0(Lx97;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
    .locals 0
...
.method private static final onHandUp$lambda$0(Lx42;Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;)Lkzh;
    .locals 5
    ...
    iget-object v2, p1, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->getExternalId:Lx97;
    ...
    iget-object v3, p1, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->timeProvider:Ljgh;
    ...
    :cond_1
    iget-object v0, p0, Lx42;->b:Ljava/util/List;
...
.method public getQueue()Ljava/util/List;
    ...
    invoke-static {v0, p0}, Lst3;->B1(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public loadMoreElements(Lx97;Lx97;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, p2}, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->loadHandsQueue(Lv97;Lx97;)V
...
.method public final onHandUp(Lx42;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/stereo/hands/StereoRoomHandsQueueImpl;->idsResolverHelper:Lla7;

    iget-object v1, p1, Lx42;->b:Ljava/util/List;

    check-cast v1, Ljava/util/Collection;

    iget-object v2, p1, Lx42;->c:Ljava/util/List;
