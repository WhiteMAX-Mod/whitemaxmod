...
.method private constructor <init>(Landroid/content/Context;Luud;)V
    .locals 1
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Luud;
...
.method private declared-synchronized ensureMappingNotOutdated(Los1;)V
    .locals 1
...
.method public static get(Landroid/content/Context;Luud;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;-><init>(Landroid/content/Context;Luud;)V
...
.method private getFile(Z)Ljava/io/File;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Luud;
...
.method private declared-synchronized read()V
    ...
    invoke-static {v1}, Los1;->a(Ljava/lang/String;)Los1;
    ...
    :catch_0
    :try_start_4
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Luud;
    ...
    invoke-interface {v3, v4, v1}, Luud;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Luud;
...
.method private declared-synchronized write()V
    ...
    invoke-virtual {v3}, Los1;->b()Ljava/lang/String;
...
# virtual methods
.method public declared-synchronized addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Los1;)V
    .locals 2
...
.method public declared-synchronized getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Los1;
    .locals 1
...
.method public declared-synchronized getByInternal(Los1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->ensureMappingNotOutdated(Los1;)V
...
.method public declared-synchronized readCacheFromDisk()V
    ...
    :try_start_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Luud;
...
.method public scheduleReadCacheFromDisk()V
    ...
    invoke-direct {v1, p0, v2}, Lcz7;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;I)V
...
.method public declared-synchronized writeCacheToDisk()V
    ...
    invoke-interface {v1, v2, v3, v0}, Luud;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
