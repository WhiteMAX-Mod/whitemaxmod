...
.field private final multiUploadHelper$delegate:Lks8;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$Companion;-><init>(Lr55;)V
...
.method public constructor <init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljava/util/concurrent/locks/Lock;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;ILjava/lang/Long;)V
    ...
    invoke-direct {p3, p1, p5, p0}, Lba2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p5, Lj3h;

    invoke-direct {p5, p3}, Lj3h;-><init>(Lv97;)V

    iput-object p5, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lks8;
    ...
    invoke-direct {p1, p2, p5, p0}, Ln72;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method private static final _init_$lambda$0(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)V
    ...
    invoke-static {p0}, Ljp6;->b(Ljava/io/File;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic d(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lkzh;
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->upload$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lkzh;
...
.method private final getMultiUploadHelper()Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lks8;
...
.method private static final multiUploadHelper_delegate$lambda$0(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    invoke-direct {v5, v1, p1}, Lcq3;-><init>(ILjava/lang/Object;)V

    const-string v4, "CallAnalyticsDbUploader"

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;-><init>(Ljavax/inject/Provider;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Ljava/lang/Long;Ljava/lang/String;Lv97;)V
...
.method private static final multiUploadHelper_delegate$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;)Z
    ...
    invoke-static {v8, v5, v6, p0, v7}, Lgu1;->o(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private static final upload$lambda$0$0(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;Ljava/util/Iterator;)Lkzh;
    .locals 0

    invoke-virtual {p1}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Lalb;

    move-result-object p1

    invoke-virtual {p1}, Lalb;->b()Lzn;

    move-result-object p1

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->uploadImpl(Lzn;Ljava/util/Iterator;)V
...
.method private final uploadImpl(Lzn;Ljava/util/Iterator;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v6, p1, v7, v8}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics(Lzn;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Ls11;)V
...
.method public upload()V
    ...
    invoke-direct {v6, p0, v7, v1}, Lh24;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v0, v2, v6}, Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;->grab(ILx97;)V
