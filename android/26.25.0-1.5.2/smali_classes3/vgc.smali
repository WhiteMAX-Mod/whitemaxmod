...
# direct methods
.method public constructor <init>(Ltgc;Lxg1;Lns1;Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;)V
    .locals 0
    ...
    iput-object p1, p0, Lvgc;->a:Ltgc;

    iput-object p2, p0, Lvgc;->b:Lxg1;

    iput-object p4, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-direct {p2, p3, p4, p3, p4}, Lcj9;-><init>(DD)V

    const/4 p3, 0x0

    const/4 p4, 0x1

    invoke-direct {p1, p4, p2, p3}, Ll5k;-><init>(ILcj9;Z)V

    iput-object p1, p0, Lvgc;->g:Ll5k;

    iput-boolean p4, p0, Lvgc;->h:Z

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lvgc;->i:Ljava/lang/Object;
...
.method public final a()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lvgc;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_0
    iget-object v0, p0, Lvgc;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_3
    iget-object v0, p0, Lvgc;->g:Ll5k;

    iget v3, v0, Ll5k;->a:I

    sget-object v4, Lugc;->$EnumSwitchMapping$0:[I
    ...
    :cond_4
    iget-boolean v0, v0, Ll5k;->c:Z

    iget-object v3, p0, Lvgc;->a:Ltgc;

    if-eqz v0, :cond_7

    iget-object v0, v3, Ltgc;->a:Lns1;
    ...
    iget-object v0, v3, Ltgc;->c:Lldg;

    invoke-virtual {v0}, Lldg;->c()Ldkh;
    ...
    invoke-static {v0, v3}, Lvgc;->b([Lorg/webrtc/VideoCodecInfo;Ljava/lang/String;)Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lvgc;->a:Ltgc;

    invoke-virtual {v0}, Ltgc;->a()[Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_7
    invoke-virtual {v3}, Ltgc;->a()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v3, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    :cond_8
    :goto_3
    iget-object v3, p0, Lvgc;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_d
    iget-object v5, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-static {v6, v4, v7, v3, v8}, Lnzg;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lvgc;->i:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-boolean v6, p0, Lvgc;->h:Z
    ...
    :cond_e
    iput-boolean v2, p0, Lvgc;->h:Z

    iget-object v6, p0, Lvgc;->g:Ll5k;
    :try_end_0
    ...
    iget-object v5, p0, Lvgc;->b:Lxg1;

    new-instance v6, Lorg/json/JSONObject;

    invoke-direct {v6}, Lorg/json/JSONObject;-><init>()V

    iget-object v7, p0, Lvgc;->g:Ll5k;

    iget-object v7, v7, Ll5k;->b:Lcj9;

    iget-wide v7, v7, Lcj9;->a:D
    ...
    invoke-static {v5, v2, p0, v1, v3}, Lxg1;->a(Lxg1;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;I)V
    ...
    :cond_13
    :goto_8
    iget-boolean v0, p0, Lvgc;->f:Z

    if-nez v0, :cond_14

    iput-boolean v2, p0, Lvgc;->f:Z

    iget-object p0, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    invoke-interface {p0, v0, v2}, Luud;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final g(Lbj9;)V
    ...
    iget-object v0, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    iget-object v0, p0, Lvgc;->i:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    new-instance v1, Ll5k;

    iget v2, p1, Lbj9;->a:I

    iget-object v3, p1, Lbj9;->b:Lcj9;

    iget-boolean p1, p1, Lbj9;->d:Z

    invoke-direct {v1, v2, v3, p1}, Ll5k;-><init>(ILcj9;Z)V

    iput-object v1, p0, Lvgc;->g:Ll5k;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lvgc;->h:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onAvailableBitrate(I)Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-virtual {p0}, Lvgc;->a()Lorg/webrtc/VideoCodecInfo;
...
.method public final onCurrentEncoder(Lorg/webrtc/VideoCodecInfo;)V
    ...
    iget-object v2, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    iput-object p1, p0, Lvgc;->e:Lorg/webrtc/VideoCodecInfo;

    :cond_0
    iput-object p1, p0, Lvgc;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-interface {v2, v1, p0}, Luud;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onEncoderBroken()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v1, p0, Lvgc;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v4, p0, Lvgc;->c:Lru/ok/android/externcalls/sdk/factory/internal/CidLogger;
    ...
    :cond_0
    iput-object v1, p0, Lvgc;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_2
    iput-object v1, p0, Lvgc;->d:Lorg/webrtc/VideoCodecInfo;
