...
.field private volatile initBufferSize:I
...
.field private final useSilenceProviderIfMutedOnInit:Z
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ScheduledExecutorService;Landroid/media/AudioManager;IILorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordErrorCallback;Lorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordStateCallback;Lorg/webrtc/audio/JavaAudioDeviceModule$SamplesReadyCallback;Lorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordSampleHook;ZZZ)V
    ...
    iput-boolean p12, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->useSilenceProviderIfMutedOnInit:Z
...
.method private doAudioRecordInit(II)Z
    ...
    const-string v1, "Creation or initialization of audio recorder failed. Buffer size="

    const-string v2, "bufferSizeInBytes: "

    const-string v3, "AudioRecord.getMinBufferSize: "

    iget-object v4, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->recordSwapLock:Ljava/lang/Object;
    ...
    iget v6, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->audioFormat:I

    invoke-static {p1, v5, v6}, Landroid/media/AudioRecord;->getMinBufferSize(III)I
    ...
    iput v6, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->initBufferSize:I
    ...
    :try_start_1
    iget v3, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->audioSource:I

    iget v7, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->audioFormat:I

    invoke-static {v3, p1, v5, v7, v0}, Lorg/webrtc/audio/WebRtcAudioRecord;->createAudioRecordOnMOrHigher(IIIII)Landroid/media/AudioRecord;
    ...
    invoke-direct {p0, v2}, Lorg/webrtc/audio/WebRtcAudioRecord;->releaseAudioResources(Z)V
...
.method private initRecording(II)I
    ...
    invoke-static {v2, p1, v0, p2, v1}, Lnzg;->t(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean p1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->microphoneMute:Z

    if-eqz p1, :cond_2

    iget-boolean p1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->useSilenceProviderIfMutedOnInit:Z

    if-eqz p1, :cond_2

    const-string p0, "Avoid audio record initialization in muted-on-start mode"
...
.method private logMainParameters(Landroid/media/AudioRecord;)V
    ...
    invoke-static {v3, p0, v1, v0, v2}, Lgu1;->o(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private reportWebRtcAudioRecordError(Ljava/lang/String;)V
    ...
    iget v1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->initBufferSize:I

    iget v2, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->initChannels:I

    iget p0, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->initSampleRate:I
    ...
    invoke-interface {v0, p0}, Lorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordErrorCallback;->onWebRtcAudioRecordError(Ljava/lang/String;)V
...
.method private reportWebRtcAudioRecordStartError(Lorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordStartErrorCode;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, p0}, Lorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordErrorCallback;->onWebRtcAudioRecordStartError(Lorg/webrtc/audio/JavaAudioDeviceModule$AudioRecordStartErrorCode;Ljava/lang/String;)V
...
.method private stopAudioStuff()V
    ...
    iget-object v0, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->recordState:Lorg/webrtc/audio/WebRtcAudioRecord$RecordState;
...
.method public initDeviceAudioRecord(Landroid/media/projection/MediaProjection;)V
    ...
    :try_start_0
    invoke-static {}, Lmve;->j()V

    invoke-static {p1}, Lmve;->f(Landroid/media/projection/MediaProjection;)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    move-result-object v4

    invoke-static {v4}, Lmve;->m(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)V

    invoke-static {v4}, Lmve;->u(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)V

    new-instance v5, Landroid/media/AudioRecord$Builder;

    invoke-direct {v5}, Landroid/media/AudioRecord$Builder;-><init>()V

    invoke-static {v4}, Lmve;->g(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)Landroid/media/AudioPlaybackCaptureConfiguration;

    move-result-object v4

    invoke-static {v5, v4}, Lmve;->n(Landroid/media/AudioRecord$Builder;Landroid/media/AudioPlaybackCaptureConfiguration;)V
    ...
    :cond_4
    :goto_1
    const-string p1, "device: Failed to create a new device AudioRecord instance"
    ...
    const-string v0, "device: device AudioRecord ctor error: "
    ...
    const-string v5, "device: AudioRecord.getMinBufferSize failed: "

    invoke-static {v5, v1, v3, p1, v4}, Lgu1;->o(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public restartAudioRecording(Z)V
    ...
    const-string v0, "Try to restart audio recording (force="

    const-string v1, "Audio record is initialized already ("
    ...
    const-string p1, "). Target state is "
    ...
    iget-object p1, p0, Lorg/webrtc/audio/WebRtcAudioRecord;->recordSwapLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lorg/webrtc/audio/WebRtcAudioRecord;->startAudioStuff(Lorg/webrtc/audio/WebRtcAudioRecord$RecordState;)V
