...
# static fields
.field private static final DEFAULT_EXCEPTION_HANDLER:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;
...
.field public static volatile bitrateAdjusterFactory:Lorg/webrtc/BitrateAdjusterFactory;

.field public static final defaultBitrateAdjusterFactory:Lorg/webrtc/BitrateAdjusterFactory;

.field public static odklSupportedH264HwCodecPrefixes:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final exceptionHandler:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

.field private final isSimulcastEnabled:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/webrtc/HardwareVideoEncoderFactory;->odklSupportedH264HwCodecPrefixes:Ljava/util/ArrayList;
    ...
    sput-object v0, Lorg/webrtc/HardwareVideoEncoderFactory;->defaultBitrateAdjusterFactory:Lorg/webrtc/BitrateAdjusterFactory;
    ...
    sput-object v0, Lorg/webrtc/HardwareVideoEncoderFactory;->DEFAULT_EXCEPTION_HANDLER:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

    return-void
.end method

.method public constructor <init>(Lorg/webrtc/EglBase$Context;ZZLorg/webrtc/Predicate;ZLorg/webrtc/CropAndScaleParamsProvider;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-boolean p5, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->isSimulcastEnabled:Z

    iput-object p6, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->cropAndScaleParamsProvider:Lorg/webrtc/CropAndScaleParamsProvider;
    ...
    :cond_1
    sget-object p7, Lorg/webrtc/HardwareVideoEncoderFactory;->DEFAULT_EXCEPTION_HANDLER:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

    :goto_1
    iput-object p7, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->exceptionHandler:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

    return-void
.end method

.method public constructor <init>(Lorg/webrtc/EglBase$Context;ZZZLorg/webrtc/CropAndScaleParamsProvider;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V
    .locals 8
    ...
    .line 40
    invoke-direct/range {v0 .. v7}, Lorg/webrtc/HardwareVideoEncoderFactory;-><init>(Lorg/webrtc/EglBase$Context;ZZLorg/webrtc/Predicate;ZLorg/webrtc/CropAndScaleParamsProvider;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V

    return-void
.end method

.method public constructor <init>(ZZZLorg/webrtc/CropAndScaleParamsProvider;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V
    .locals 8
...
.method public static synthetic a(Lorg/webrtc/VideoCodecMimeType;Ljava/lang/String;)Lorg/webrtc/BitrateAdjuster;
    .locals 0

    invoke-static {p0, p1}, Lorg/webrtc/HardwareVideoEncoderFactory;->lambda$static$0(Lorg/webrtc/VideoCodecMimeType;Ljava/lang/String;)Lorg/webrtc/BitrateAdjuster;
...
.method public static synthetic b(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0}, Lorg/webrtc/HardwareVideoEncoderFactory;->lambda$static$1(Ljava/lang/Throwable;)V
...
.method private createBitrateAdjuster(Lorg/webrtc/VideoCodecMimeType;Ljava/lang/String;)Lorg/webrtc/BitrateAdjuster;
    ...
    sget-object p0, Lorg/webrtc/HardwareVideoEncoderFactory;->bitrateAdjusterFactory:Lorg/webrtc/BitrateAdjusterFactory;

    if-eqz p0, :cond_0

    invoke-interface {p0, p1, p2}, Lorg/webrtc/BitrateAdjusterFactory;->createBitrateAdjuster(Lorg/webrtc/VideoCodecMimeType;Ljava/lang/String;)Lorg/webrtc/BitrateAdjuster;
    ...
    :cond_0
    sget-object p0, Lorg/webrtc/HardwareVideoEncoderFactory;->defaultBitrateAdjusterFactory:Lorg/webrtc/BitrateAdjusterFactory;
...
.method private isHardwareSupportedInCurrentSdk(Landroid/media/MediaCodecInfo;Lorg/webrtc/VideoCodecMimeType;)Z
    ...
    invoke-static {p1}, Ltn;->C(Landroid/media/MediaCodecInfo;)Z
...
.method private isHardwareSupportedInCurrentSdkH264(Landroid/media/MediaCodecInfo;)Z
    ...
    :goto_0
    sget-object v1, Lorg/webrtc/HardwareVideoEncoderFactory;->odklSupportedH264HwCodecPrefixes:Ljava/util/ArrayList;
...
.method private static synthetic lambda$static$0(Lorg/webrtc/VideoCodecMimeType;Ljava/lang/String;)Lorg/webrtc/BitrateAdjuster;
    .locals 1
...
.method private static synthetic lambda$static$1(Ljava/lang/Throwable;)V
    .locals 0
...
.method public createEncoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoEncoder;
    ...
    :cond_2
    iget-boolean v0, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->isSimulcastEnabled:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->cropAndScaleParamsProvider:Lorg/webrtc/CropAndScaleParamsProvider;

    if-eqz v0, :cond_3

    new-instance v1, Lorg/webrtc/HardwareVideoEncoderV2;
    ...
    iget-object v12, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->cropAndScaleParamsProvider:Lorg/webrtc/CropAndScaleParamsProvider;

    iget-object v13, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->exceptionHandler:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

    const/16 v8, 0xe10

    invoke-direct/range {v1 .. v13}, Lorg/webrtc/HardwareVideoEncoderV2;-><init>(Lorg/webrtc/MediaCodecWrapperFactory;Ljava/lang/String;Lorg/webrtc/VideoCodecMimeType;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Map;IILorg/webrtc/BitrateAdjuster;Lorg/webrtc/EglBase14$Context;Lorg/webrtc/CropAndScaleParamsProvider;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V
    ...
    iget-object v12, p0, Lorg/webrtc/HardwareVideoEncoderFactory;->exceptionHandler:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

    const/16 v8, 0xe10

    invoke-direct/range {v1 .. v12}, Lorg/webrtc/HardwareVideoEncoder;-><init>(Lorg/webrtc/MediaCodecWrapperFactory;Ljava/lang/String;Lorg/webrtc/VideoCodecMimeType;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Map;IILorg/webrtc/BitrateAdjuster;Lorg/webrtc/EglBase14$Context;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V
