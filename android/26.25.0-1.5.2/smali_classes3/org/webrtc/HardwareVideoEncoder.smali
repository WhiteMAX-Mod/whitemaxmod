...
# static fields
.field protected static final DEQUEUE_OUTPUT_BUFFER_TIMEOUT_US:I = 0x186a0

.field protected static final MAX_ENCODER_Q_SIZE:I = 0x2

.field private static final MAX_VIDEO_FRAMERATE:I = 0x1e

.field protected static final MEDIA_CODEC_RELEASE_TIMEOUT_MS:I = 0x1388

.field public static ODKL_CBR_SUPPORTED_CHECK:Z = false

.field public static ODKL_CHANGE_CBR_BEHAVIOR:Z = false

.field private static final REQUIRED_RESOLUTION_ALIGNMENT:I = 0x10

.field private static final TAG:Ljava/lang/String; = "HardwareVideoEncoderV1"


# instance fields
.field protected adjustedBitrate:I

.field protected automaticResizeOn:Z

.field protected final bitrateAdjuster:Lorg/webrtc/BitrateAdjuster;

.field protected callback:Lorg/webrtc/VideoEncoder$Callback;

.field protected codec:Lorg/webrtc/MediaCodecWrapper;

.field protected final codecName:Ljava/lang/String;

.field protected final codecType:Lorg/webrtc/VideoCodecMimeType;

.field protected configBuffer:Ljava/nio/ByteBuffer;

.field protected final encodeThreadChecker:Lorg/webrtc/ThreadUtils$ThreadChecker;

.field protected exceptionHandler:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;

.field protected final forcedKeyFrameNs:J

.field protected frameSizeBytes:I

.field protected height:I

.field protected isEncodingStatisticsEnabled:Z

.field protected isSemiPlanar:Z

.field protected final keyFrameIntervalSec:I

.field protected lastKeyFrameNs:J

.field protected final mediaCodecWrapperFactory:Lorg/webrtc/MediaCodecWrapperFactory;

.field protected nextPresentationTimestampUs:J

.field protected final outputBuffersBusyCount:Lorg/webrtc/HardwareVideoEncoder$BusyCount;

.field protected final outputBuilders:Ljava/util/concurrent/BlockingDeque;
...
.field protected outputThread:Ljava/lang/Thread;

.field protected final outputThreadChecker:Lorg/webrtc/ThreadUtils$ThreadChecker;
...
.field protected final sharedContext:Lorg/webrtc/EglBase14$Context;

.field protected volatile shutdownException:Ljava/lang/Exception;

.field protected sliceHeight:I

.field protected stride:I

.field protected final surfaceColorFormat:Ljava/lang/Integer;

.field protected final textureDrawer:Lorg/webrtc/GlRectDrawer;

.field protected textureEglBase:Lorg/webrtc/EglBase14;

.field protected textureInputSurface:Landroid/view/Surface;

.field protected useSurfaceMode:Z

.field protected final videoFrameDrawer:Lorg/webrtc/VideoFrameDrawer;

.field protected width:I

.field protected final yuvColorFormat:Ljava/lang/Integer;


# direct methods
.method public constructor <init>(Lorg/webrtc/MediaCodecWrapperFactory;Ljava/lang/String;Lorg/webrtc/VideoCodecMimeType;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Map;IILorg/webrtc/BitrateAdjuster;Lorg/webrtc/EglBase14$Context;Lorg/webrtc/HardwareVideoEncoderExceptionHandler;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1}, Lorg/webrtc/HardwareVideoEncoder$BusyCount;-><init>()V
    ...
    iput-object p11, p0, Lorg/webrtc/HardwareVideoEncoder;->exceptionHandler:Lorg/webrtc/HardwareVideoEncoderExceptionHandler;
...
.method private synthetic lambda$deliverEncodedImage$0(I)V
    ...
    const-string v0, "HardwareVideoEncoderV1"
...
.method public deliverEncodedImage()V
    ...
    const-string v1, "HardwareVideoEncoderV1"
    ...
    invoke-virtual {p0}, Lorg/webrtc/HardwareVideoEncoder;->updateBitrate()Lorg/webrtc/VideoCodecStatus;
    ...
    invoke-direct {v9, p0, v5, v3}, Ljh;-><init>(Ljava/lang/Object;II)V
...
.method public encode(Lorg/webrtc/VideoFrame;Lorg/webrtc/VideoEncoder$EncodeInfo;)Lorg/webrtc/VideoCodecStatus;
    ...
    :cond_2
    invoke-virtual {p0, v1, v2, v0}, Lorg/webrtc/HardwareVideoEncoder;->resetCodec(IIZ)Lorg/webrtc/VideoCodecStatus;
    ...
    const-string p0, "HardwareVideoEncoderV1"
    ...
    invoke-virtual {p0, v0, v1}, Lorg/webrtc/HardwareVideoEncoder;->shouldForceKeyFrame(J)Z
    ...
    invoke-virtual {p0, v0, v1}, Lorg/webrtc/HardwareVideoEncoder;->requestKeyFrame(J)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Lorg/webrtc/HardwareVideoEncoder;->encodeTextureBuffer(Lorg/webrtc/VideoFrame;J)Lorg/webrtc/VideoCodecStatus;
    ...
    :cond_9
    invoke-virtual {p0, p1, v0, v1}, Lorg/webrtc/HardwareVideoEncoder;->encodeByteBuffer(Lorg/webrtc/VideoFrame;J)Lorg/webrtc/VideoCodecStatus;
...
.method public encodeByteBuffer(Lorg/webrtc/VideoFrame;J)Lorg/webrtc/VideoCodecStatus;
    .locals 11
...
.method public encodeTextureBuffer(Lorg/webrtc/VideoFrame;J)Lorg/webrtc/VideoCodecStatus;
    .locals 4
    ...
    const-string p2, "HardwareVideoEncoderV1"
...
.method public initEncode(Lorg/webrtc/VideoEncoder$Settings;Lorg/webrtc/VideoEncoder$Callback;)Lorg/webrtc/VideoCodecStatus;
    ...
    invoke-static {v7, p2, v5, v0, v6}, Lgu1;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v1, v2, v0, v5, p2}, Lmq4;->x(IILjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v0, " bitrate_kbps: "

    const-string v1, " surface mode: "

    invoke-static {v3, p1, v0, v1, p2}, Lmq4;->x(IILjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-virtual {p0}, Lorg/webrtc/HardwareVideoEncoder;->initEncodeInternal()Lorg/webrtc/VideoCodecStatus;
...
.method public initEncodeInternal()Lorg/webrtc/VideoCodecStatus;
    ...
    const-string v3, "    cbr supported "

    iget-object v4, p0, Lorg/webrtc/HardwareVideoEncoder;->encodeThreadChecker:Lorg/webrtc/ThreadUtils$ThreadChecker;
    ...
    iput-wide v4, p0, Lorg/webrtc/HardwareVideoEncoder;->lastKeyFrameNs:J
    ...
    sget-boolean v6, Lorg/webrtc/HardwareVideoEncoder;->ODKL_CHANGE_CBR_BEHAVIOR:Z
    :try_end_1
    ...
    :try_start_2
    sget-boolean v6, Lorg/webrtc/HardwareVideoEncoder;->ODKL_CBR_SUPPORTED_CHECK:Z

    if-eqz v6, :cond_1

    iget-object v6, p0, Lorg/webrtc/HardwareVideoEncoder;->codec:Lorg/webrtc/MediaCodecWrapper;

    invoke-interface {v6, v5}, Lorg/webrtc/MediaCodecWrapper;->cbrSupported(Landroid/media/MediaFormat;)Z
    ...
    invoke-virtual {v5, v3, v4}, Landroid/media/MediaFormat;->setFloat(Ljava/lang/String;F)V
    ...
    invoke-interface {v1, v5, v2, v2, v3}, Lorg/webrtc/MediaCodecWrapper;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    ...
    invoke-virtual {p0, v1}, Lorg/webrtc/HardwareVideoEncoder;->updateInputFormat(Landroid/media/MediaFormat;)V
    ...
    invoke-virtual {p0}, Lorg/webrtc/HardwareVideoEncoder;->createOutputThread()Ljava/lang/Thread;
...
.method public resetCodec(IIZ)Lorg/webrtc/VideoCodecStatus;
    .locals 2
...
.method public updateInputFormat(Landroid/media/MediaFormat;)V
    .locals 6
    ...
    const-string v4, " sliceHeight: "

    const-string v5, "updateInputFormat format: "

    invoke-static {v0, v5, p1, v3, v4}, Let9;->q(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string p1, "HardwareVideoEncoderV1"
