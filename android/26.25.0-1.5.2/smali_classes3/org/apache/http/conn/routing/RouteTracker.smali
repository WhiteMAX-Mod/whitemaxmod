...
.method public final connectProxy(Lorg/apache/http/HttpHost;Z)V
    ...
    :cond_1
    const-string p0, "Proxy host may not be null."
...
.method public final getHopTarget(I)Lorg/apache/http/HttpHost;
    ...
    :cond_1
    const-string p0, " exceeds tracked route length "

    const-string v1, "."

    const-string v2, "Hop index "

    invoke-static {v2, p1, p0, v0, v1}, Lnzg;->t(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    const-string p0, "Hop index must not be negative: "
...
.method public final layerProtocol(Z)V
    ...
    :cond_0
    const-string p0, "No layered protocol unless connected."
...
.method public final tunnelProxy(Lorg/apache/http/HttpHost;Z)V
    ...
    :cond_0
    const-string p0, "No proxy tunnel without proxy."
    ...
    :cond_1
    const-string p0, "No tunnel unless connected."
...
.method public final tunnelTarget(Z)V
    ...
    :cond_0
    const-string p0, "No tunnel without proxy."
