...
.method public dropEntry()V
    ...
    :cond_0
    const-string p0, "There is no entry that could be dropped."
...
.method public freeEntry(Lorg/apache/http/impl/conn/tsccm/BasicPoolEntry;)V
    ...
    :cond_0
    const-string p1, "No entry allocated from this pool. "
    ...
    :cond_1
    const-string p1, "No entry created for this pool. "
...
.method public queueThread(Lorg/apache/http/impl/conn/tsccm/WaitingThread;)V
    ...
    :cond_0
    const-string p0, "Waiting thread must not be null."
