...
.field public final f:Lyve;

.field public final g:Lrn8;
...
# direct methods
.method public constructor <init>(ILhce;Lppa;Lyve;Lrn8;)V
    .locals 16
    ...
    new-array v0, v0, [Ldr8;

    iput-object v0, v2, Loxd;->e:[Ldr8;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, v2, Loxd;->l:Ljava/lang/Object;
    ...
    iput-boolean v10, v2, Loxd;->p:Z

    iput-object v1, v2, Loxd;->a:Ljava/time/Clock;
    ...
    iput-object v3, v2, Loxd;->c:Lhce;

    move-object/from16 v4, p3

    iput-object v4, v2, Loxd;->d:Lppa;
    ...
    iget-object v14, v2, Loxd;->e:[Ldr8;
    ...
    invoke-direct {v5, v7, v10}, Ljxd;-><init>(Lyve;I)V

    invoke-interface {v8}, Lrn8;->getQLog()Ld6d;

    move-result-object v6

    invoke-direct/range {v0 .. v6}, Ldr8;-><init>(Ljava/time/Clock;Loxd;Lhce;Lppa;Ljxd;Ld6d;)V
    ...
    :cond_0
    iput-object v7, v2, Loxd;->f:Lyve;

    iput-object v8, v2, Loxd;->g:Lrn8;

    new-instance v0, Lei4;

    const-string v1, "loss-detection"

    invoke-direct {v0, v1, v10}, Lei4;-><init>(Ljava/lang/String;I)V
    ...
    iput-object v0, v2, Loxd;->h:Ljava/util/concurrent/ScheduledExecutorService;

    iget-object v1, v2, Loxd;->l:Ljava/lang/Object;
    ...
    iput-object v0, v2, Loxd;->k:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-interface {v8, v0}, Lrn8;->recovery(Ljava/lang/String;)V
...
# virtual methods
.method public final a(Ljava/util/function/Function;)Lilc;
    .locals 7
    ...
    invoke-direct {v2, v4, v6, v5}, Lilc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    goto :goto_1

    :cond_0
    iget-object v6, v2, Lilc;->c:Ljava/lang/Object;
...
.method public final b(Lahc;)Ljava/util/List;
    .locals 2

    iget-object v0, p0, Loxd;->e:[Ldr8;
    ...
    iget-object p1, p1, Ldr8;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final c()Lilc;
    ...
    iget-object v0, p0, Loxd;->c:Lhce;

    invoke-virtual {v0}, Lhce;->b()I

    move-result v0

    iget-object v1, p0, Loxd;->c:Lhce;
    ...
    invoke-direct {v0, v2, v3, v1}, Lilc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v11, p0, Loxd;->e:[Ldr8;
    ...
    iget-object v11, v11, Ldr8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v11, Lahc;->c:Lahc;

    if-ne v10, v11, :cond_2

    iget v12, p0, Loxd;->o:I
    ...
    iget v11, p0, Loxd;->j:I

    iget v12, p0, Loxd;->m:I
    ...
    iget-object v11, v11, Ldr8;->k:Ljava/time/Instant;
    ...
    invoke-direct {v1, v9, v2, v0}, Lilc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final d(I)V
    ...
    invoke-static {p1}, Lo16;->m(I)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lrn8;->recovery(Ljava/lang/String;)V

    invoke-virtual {p0}, Loxd;->k()V
...
.method public final e()V
    ...
    iget-object v0, p0, Loxd;->n:Ljava/time/Instant;
    ...
    invoke-interface {v0, v1}, Lrn8;->warn(Ljava/lang/String;)V

    return-void

    :cond_0
    iget-object v1, p0, Loxd;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Loxd;->g:Lrn8;

    iget-object v2, p0, Loxd;->a:Ljava/time/Clock;
    ...
    invoke-interface {v1, v0}, Lrn8;->warn(Ljava/lang/String;)V

    iget-object v0, p0, Loxd;->n:Ljava/time/Instant;

    invoke-virtual {p0, v0}, Loxd;->i(Ljava/time/Instant;)V
    ...
    invoke-interface {v0, v2, v1}, Lrn8;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
    ...
    invoke-virtual {p0, v0}, Loxd;->a(Ljava/util/function/Function;)Lilc;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v1, v0, Lilc;->c:Ljava/lang/Object;
    ...
    iget-object v1, p0, Loxd;->e:[Ldr8;

    iget-object v0, v0, Lilc;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Ldr8;->b()V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Loxd;->h(Z)V

    iget-object v0, p0, Loxd;->f:Lyve;
    ...
    invoke-interface {v0}, Lrn8;->logRecovery()Z
    ...
    iget-object v3, p0, Loxd;->c:Lhce;

    invoke-virtual {v3}, Lhce;->b()I
    ...
    iget-object v4, p0, Loxd;->c:Lhce;

    invoke-virtual {v4}, Lhce;->a()I
    ...
    invoke-interface {v1, v2, v0}, Lrn8;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
    ...
    iget-object v2, p0, Loxd;->c:Lhce;

    invoke-virtual {v2}, Lhce;->b()I
    ...
    invoke-interface {v0, v1}, Lrn8;->recovery(Ljava/lang/String;)V
    ...
    :cond_7
    iget-object v1, v1, Lilc;->b:Ljava/lang/Object;

    check-cast v1, Lahc;

    invoke-virtual {p0, v1, v0}, Loxd;->j(Lahc;I)V
    ...
    invoke-virtual {p0, v0, v1}, Loxd;->j(Lahc;I)V
...
.method public final h(Z)V
    ...
    iget-object v0, p0, Loxd;->d:Lppa;

    iget-wide v0, v0, Lppa;->c:J

    iget-object v0, p0, Loxd;->d:Lppa;

    iget-wide v0, v0, Lppa;->b:J

    if-eqz p1, :cond_0

    iget-object p1, p0, Loxd;->g:Lrn8;
...
.method public final i(Ljava/time/Instant;)V
    ...
    :try_start_0
    iget-object v0, p0, Loxd;->l:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Loxd;->k:Ljava/util/concurrent/ScheduledFuture;

    const/4 v2, 0x0

    invoke-interface {v1, v2}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object p1, p0, Loxd;->n:Ljava/time/Instant;
    ...
    iget-object p1, p0, Loxd;->h:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v3, Lkxd;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lkxd;-><init>(Loxd;I)V
    ...
    iput-object p1, p0, Loxd;->k:Ljava/util/concurrent/ScheduledFuture;
...
.method public final j(Lahc;I)V
    .locals 5
    ...
    invoke-interface {v1, v0}, Lrn8;->recovery(Ljava/lang/String;)V

    new-instance v0, Llxd;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, v1}, Llxd;-><init>(Loxd;Lahc;I)V

    invoke-static {v0, p2}, Loxd;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p0, v0}, Loxd;->b(Lahc;)Ljava/util/List;
    ...
    invoke-direct {v0, p0, p1, v1}, Lmxd;-><init>(Loxd;Ljava/util/List;I)V
    ...
    invoke-interface {v1, p1}, Lrn8;->recovery(Ljava/lang/String;)V

    new-instance p1, Lkxd;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, Lkxd;-><init>(Loxd;I)V

    invoke-static {p1, p2}, Loxd;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p0, p1}, Loxd;->b(Lahc;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, p1, v0, v2}, Lgtd;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {v1, p2}, Loxd;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-direct {p1, p0, v1, v0}, Lklc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final k()V
    ...
    invoke-virtual {p0, v2}, Loxd;->a(Ljava/util/function/Function;)Lilc;
    ...
    iget-object v2, v2, Lilc;->c:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2}, Loxd;->i(Ljava/time/Instant;)V
    ...
    invoke-direct {v4, v5}, Lcr8;-><init>(I)V
    ...
    iget-object v0, p0, Loxd;->k:Ljava/util/concurrent/ScheduledFuture;

    invoke-interface {v0, v5}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v3, p0, Loxd;->n:Ljava/time/Instant;
    ...
    :cond_4
    iget-object v3, v6, Lilc;->c:Ljava/lang/Object;

    check-cast v3, Ljava/time/Instant;

    invoke-virtual {p0, v3}, Loxd;->i(Ljava/time/Instant;)V

    invoke-interface {v1}, Lrn8;->logRecovery()Z

    move-result v5

    if-eqz v5, :cond_7

    iget-object v5, p0, Loxd;->a:Ljava/time/Clock;
    ...
    iget-object v6, v6, Lilc;->b:Ljava/lang/Object;
    ...
    invoke-interface {v1, v0, v3}, Lrn8;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
