...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbe;->s:Ljava/nio/charset/Charset;

    return-void
.end method

.method public constructor <init>(Lukh;ILrn8;I)V
    .locals 0
    ...
    .line 3
    iput-boolean p4, p0, Lbe;->p:Z

    .line 4
    iput p2, p0, Lbe;->a:I

    .line 5
    iput-object p3, p0, Lbe;->b:Lrn8;

    .line 6
    iput-object p1, p0, Lbe;->c:Lukh;

    return-void
.end method

.method public constructor <init>(Lukh;[BILrn8;)V
    .locals 2
    ...
    .line 9
    iput-boolean v0, p0, Lbe;->p:Z

    .line 10
    iput p3, p0, Lbe;->a:I

    .line 11
    iput-object p4, p0, Lbe;->b:Lrn8;
    ...
    :goto_0
    invoke-virtual {p0}, Lbe;->i()S

    move-result v1

    invoke-virtual {p0, p2, v0, v1}, Lbe;->m([BLjava/lang/String;S)[B

    move-result-object p2

    .line 14
    invoke-static {p3}, Ln8d;->q(I)Ljava/lang/String;
    ...
    invoke-interface {p4, p3, p2}, Lrn8;->secret(Ljava/lang/String;[B)V

    .line 15
    invoke-virtual {p0, p2, p1, p1}, Lbe;->f([BZZ)V
...
.method public final a([B)[B
    ...
    invoke-static {}, Lc00;->j()V

    invoke-static {p1, v3}, Lc00;->i(I[B)Ljavax/crypto/spec/ChaCha20ParameterSpec;

    move-result-object p1

    new-instance v3, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v4, p0, Lbe;->j:[B
    ...
    :pswitch_0
    iget-object v0, p0, Lbe;->k:Ljavax/crypto/Cipher;
    ...
    iput-object v0, p0, Lbe;->k:Ljavax/crypto/Cipher;

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lbe;->j:[B

    const-string v3, "AES"

    invoke-direct {v0, v2, v3}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iget-object v2, p0, Lbe;->k:Ljavax/crypto/Cipher;
...
.method public final b([B[B[B)[B
    ...
    :try_start_0
    invoke-virtual {p0}, Lbe;->k()Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p0}, Lbe;->l()Ljavax/crypto/spec/SecretKeySpec;
...
.method public final declared-synchronized d(Z)V
    ...
    invoke-virtual {p0, v3, v1, v2}, Lbe;->m([BLjava/lang/String;S)[B

    move-result-object v1

    iput-object v1, p0, Lbe;->e:[B

    iget-object v1, p0, Lbe;->b:Lrn8;
    ...
    iget-object v2, p0, Lbe;->e:[B

    invoke-interface {v1, v0, v2}, Lrn8;->secret(Ljava/lang/String;[B)V

    iget-object v0, p0, Lbe;->e:[B

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1, p1}, Lbe;->f([BZZ)V

    if-eqz p1, :cond_2

    iget-object p1, p0, Lbe;->e:[B

    iput-object p1, p0, Lbe;->d:[B
...
.method public final declared-synchronized e([B)V
    ...
    invoke-virtual {p0, p1, v0, v0}, Lbe;->f([BZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final f([BZZ)V
    ...
    invoke-virtual {p0}, Lbe;->j()S

    move-result v2

    invoke-virtual {p0, p1, v1, v2}, Lbe;->m([BLjava/lang/String;S)[B
    ...
    iput-object v1, p0, Lbe;->f:[B

    iput-object v2, p0, Lbe;->l:Ljavax/crypto/spec/SecretKeySpec;

    goto :goto_1

    :cond_1
    iput-object v1, p0, Lbe;->g:[B

    iput-object v2, p0, Lbe;->m:Ljavax/crypto/spec/SecretKeySpec;

    :goto_1
    iget v2, p0, Lbe;->a:I

    invoke-static {v2}, Ln8d;->q(I)Ljava/lang/String;
    ...
    iget-object v4, p0, Lbe;->b:Lrn8;

    invoke-interface {v4, v3, v1}, Lrn8;->secret(Ljava/lang/String;[B)V
    ...
    invoke-virtual {p0, p1, v1, v3}, Lbe;->m([BLjava/lang/String;S)[B

    move-result-object v1

    if-eqz p3, :cond_2

    iput-object v1, p0, Lbe;->h:[B

    goto :goto_2

    :cond_2
    iput-object v1, p0, Lbe;->i:[B
    ...
    invoke-interface {v4, p3, v1}, Lrn8;->secret(Ljava/lang/String;[B)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lbe;->m([BLjava/lang/String;S)[B

    move-result-object p1

    iput-object p1, p0, Lbe;->j:[B
    ...
    iget-object p2, p0, Lbe;->j:[B

    invoke-interface {v4, p1, p2}, Lrn8;->secret(Ljava/lang/String;[B)V
...
.method public final declared-synchronized g()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lbe;->p:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lbe;->b:Lrn8;
    ...
    iput-object v0, p0, Lbe;->d:[B

    iget-object v0, p0, Lbe;->g:[B

    iput-object v0, p0, Lbe;->f:[B

    const/4 v0, 0x0

    iput-object v0, p0, Lbe;->l:Ljavax/crypto/spec/SecretKeySpec;

    iget-object v1, p0, Lbe;->i:[B
    ...
    iput-object v0, p0, Lbe;->e:[B

    const/4 v1, 0x0

    iput-boolean v1, p0, Lbe;->p:Z

    iput-object v0, p0, Lbe;->g:[B

    iput-object v0, p0, Lbe;->i:[B

    iget-object v0, p0, Lbe;->q:Lbe;
    ...
    invoke-virtual {v0, v2}, Lbe;->d(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final k()Ljavax/crypto/Cipher;
    ...
    iget-object v0, p0, Lbe;->n:Ljavax/crypto/Cipher;
    ...
    iput-object v0, p0, Lbe;->n:Ljavax/crypto/Cipher;
    :try_end_0
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final l()Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-object v0, p0, Lbe;->m:Ljavax/crypto/spec/SecretKeySpec;

    if-nez v0, :cond_0

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lbe;->g:[B

    invoke-direct {v0, v2, v1}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iput-object v0, p0, Lbe;->m:Ljavax/crypto/spec/SecretKeySpec;
    ...
    :cond_1
    iget-object v0, p0, Lbe;->l:Ljavax/crypto/spec/SecretKeySpec;

    if-nez v0, :cond_2

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lbe;->f:[B
...
.method public final m([BLjava/lang/String;S)[B
    ...
    sget-object v1, Lbe;->s:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p2, p1, v0, p3}, Lm6a;->g([B[BI)[B
