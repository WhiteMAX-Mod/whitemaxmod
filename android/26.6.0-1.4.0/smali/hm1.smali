...
# direct methods
.method public constructor <init>(Llbb;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lalf;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lhm1;->o:Llbb;
...
.method public final bridge synthetic s(Lpyd;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lhm1;->I(Lhmf;I)V
...
.method public final u(Landroid/view/ViewGroup;I)Lpyd;
    ...
    invoke-direct {v0, p1}, Lznb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Lznb;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-virtual {v0, p1}, Lznb;->setBackgroundColorAttr(Ljava/lang/Integer;)V

    new-instance p1, Lk;

    const/16 v1, 0x19

    iget-object v2, p0, Lhm1;->o:Llbb;

    invoke-direct {p1, v1, v2}, Lk;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, p1}, Lznb;->f(Lks6;)Landroid/text/TextWatcher;

    sget-object p1, Lxnb;->a:Lxnb;

    invoke-virtual {v0, p1}, Lznb;->setTypingMode(Lxnb;)V
