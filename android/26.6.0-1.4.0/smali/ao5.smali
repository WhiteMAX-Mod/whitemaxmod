...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lao5;->o:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lao5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lao5;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final A0()J
    ...
    :cond_0
    invoke-virtual {p0}, Lao5;->E0()V

    :goto_0
    sget-object v0, Lao5;->o:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_5
    sget-object v5, Lco5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_b
    sget-object v3, Lco5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_c
    sget-object v0, Lao5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public D0(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lao5;->F0(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lbo5;->d0()Ljava/lang/Thread;
    ...
    invoke-virtual {v0, p1}, Lsr4;->D0(Ljava/lang/Runnable;)V
...
.method public final E0()V
    ...
    invoke-virtual {p0, v3}, Lao5;->F0(Ljava/lang/Runnable;)Z
...
.method public final F0(Ljava/lang/Runnable;)Z
    ...
    sget-object v2, Lao5;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :cond_7
    sget-object v2, Lco5;->b:Lkotlinx/coroutines/internal/Symbol;
...
.method public final H0(JLyn5;)V
    .locals 5

    sget-object v0, Lao5;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    sget-object v3, Lao5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_3
    invoke-virtual {p3, p1, p2, v0, p0}, Lyn5;->b(JLzn5;Lao5;)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lbo5;->C0(JLyn5;)V
...
.method public final dispatch(Led4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lao5;->D0(Ljava/lang/Runnable;)V
...
.method public final scheduleResumeAfterDelay(JLl72;)V
    ...
    sget-object v0, Lco5;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-direct {v2, p0, v0, v1, p3}, Lwn5;-><init>(Lao5;JLl72;)V

    invoke-virtual {p0, p1, p2, v2}, Lao5;->H0(JLyn5;)V

    new-instance p1, Lx62;

    const/4 p2, 0x2

    invoke-direct {p1, p2, v2}, Lx62;-><init>(ILjava/lang/Object;)V

    invoke-static {p3, p1}, Lnga;->b(Ll72;Ly62;)V
...
.method public shutdown()V
    ...
    sget-object v4, Lco5;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :goto_2
    sget-object v2, Lao5;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_7
    invoke-virtual {p0, v0, v1, v2}, Lbo5;->C0(JLyn5;)V
