...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Lmmc;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p1, p2}, Lmmc;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Lmmc;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object v2, p0, Lmmc;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Lmmc;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, Li0h;->c(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Ljfj;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v6, Lpmc;->d:Lpmc;

    if-eq v3, v6, :cond_5

    sget-object v6, Lpmc;->c:Lpmc;

    if-eq v3, v6, :cond_5

    sget-object v6, Lpmc;->o:Lpmc;
    ...
    iget-object v0, p0, Lmmc;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p1, p2, v0, v1}, Li0h;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Lmmc;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lmmc;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Lmmc;->c:I

    invoke-static {p2}, Li0h;->b(I)Z
    ...
    iget-object p2, p0, Lmmc;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lmmc;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Lmmc;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, v1, v2}, Li0h;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lmmc;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Lmmc;->b:Landroid/graphics/Rect;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lmmc;->a:Landroid/util/Size;
