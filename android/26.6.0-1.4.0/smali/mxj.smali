...
# direct methods
.method public static a(Landroid/net/Uri;Landroid/content/Context;Lv36;)Landroid/net/Uri;
    .locals 7
    ...
    invoke-virtual {p2, v3}, Lh56;->o(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_2
    invoke-static {v4, v3}, Lxx0;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static b(Landroid/content/Intent;)I
    ...
    invoke-static {v0, v3, v1}, Ll7g;->s(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, p0, v1}, Ld7g;->t(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method public static c(Landroid/content/Intent;Landroid/content/Context;Lpo5;Lv36;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-static {v1, p1, p2}, Lhcj;->j(Landroid/net/Uri;Landroid/content/Context;Lpo5;)Z
    ...
    invoke-static {v1, p1, p3}, Lmxj;->a(Landroid/net/Uri;Landroid/content/Context;Lv36;)Landroid/net/Uri;
...
.method public static d(Landroid/content/Intent;Landroid/content/Context;Lpo5;Lv36;)Ljava/util/ArrayList;
    .locals 3
    ...
    :cond_3
    invoke-static {p0, p1, p2}, Lhcj;->j(Landroid/net/Uri;Landroid/content/Context;Lpo5;)Z
    ...
    invoke-static {p0, p1, p3}, Lmxj;->a(Landroid/net/Uri;Landroid/content/Context;Lv36;)Landroid/net/Uri;
