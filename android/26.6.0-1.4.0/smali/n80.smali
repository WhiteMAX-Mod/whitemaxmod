...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Ln80;->m:J

    return-void
.end method

.method public constructor <init>(Lbc0;Landroid/content/Context;)V
    .locals 9
    ...
    iput-object v0, p0, Ln80;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Ln80;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Ln80;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Ln80;->l:Z
    ...
    invoke-static {v0, p1, p2}, Ln80;->b(ILbc0;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Ln80;->a:Landroid/media/AudioRecord;
...
.method public static b(ILbc0;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
    ...
    invoke-static {v2, p2}, Lzm;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Ln80;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Ln80;->i:Lywe;

    iget-object v1, p0, Ln80;->h:Lo27;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Ln80;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v3, v1, p1}, Lfk;-><init>(ILjava/lang/Object;Z)V
...
.method public final d()V
    ...
    iget-object v0, p0, Ln80;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Ln80;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Ln80;->j:J

    iput-boolean v4, p0, Ln80;->l:Z

    iget-object v0, p0, Ln80;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, Ln80;->a:Landroid/media/AudioRecord;

    invoke-static {v0}, Lym;->b(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-static {v0}, Lym;->c(Landroid/media/AudioRecordingConfiguration;)Z
    ...
    :cond_4
    invoke-virtual {p0, v4}, Ln80;->c(Z)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lec0;
    ...
    iget-object v5, p0, Ln80;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Ln80;->b:Lbc0;

    iget v5, v5, Lbc0;->b:I

    iget-wide v7, p0, Ln80;->j:J
    ...
    invoke-static {v11, v9}, Lmtj;->a(Ljava/lang/String;Z)V
    ...
    invoke-static {v9, v6}, Lmtj;->a(Ljava/lang/String;Z)V

    iget-wide v11, p1, Landroid/media/AudioTimestamp;->framePosition:J

    sub-long/2addr v7, v11

    invoke-static {v5, v7, v8}, Logj;->c(IJ)J
    ...
    sget-wide v7, Ln80;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_5

    iput-boolean v10, p0, Ln80;->l:Z
    ...
    invoke-static {p1, v1}, Ljfj;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    iget-wide v3, p0, Ln80;->j:J

    int-to-long v5, v0

    iget p1, p0, Ln80;->g:I

    invoke-static {p1, v5, v6}, Logj;->i(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Ln80;->j:J

    :cond_7
    new-instance p1, Lec0;

    invoke-direct {p1, v0, v1, v2}, Lec0;-><init>(IJ)V
