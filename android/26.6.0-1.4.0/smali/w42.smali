...
.method public q0(Lc1f;)V
    ...
    iget-object p1, p1, Lc1f;->a:Lb1f;

    invoke-interface {p1}, Lb1f;->e()Landroid/hardware/camera2/CameraCaptureSession$StateCallback;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Lb1f;->f()Ljava/util/List;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-interface {p1}, Lb1f;->c()Ljava/util/concurrent/Executor;
    ...
    iget-object v3, v3, Lutb;->a:Lwtb;

    invoke-virtual {v3}, Lwtb;->b()Ljava/lang/String;
    ...
    invoke-static {v6, v2, v4, v3, v5}, Lau1;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "CameraDeviceCompat"

    invoke-static {v4, v3}, Ljfj;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v3}, Lw32;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V
    ...
    iget-object v3, v3, Ly42;->a:Landroid/os/Handler;

    invoke-interface {p1}, Lb1f;->b()Luq7;
    ...
    :try_start_0
    iget-object p1, v4, Luq7;->a:Lsq7;

    iget-object p1, p1, Lsq7;->a:Landroid/hardware/camera2/params/InputConfiguration;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, Lc1f;->a(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Lutb;->a:Lwtb;

    invoke-virtual {v4}, Lwtb;->c()Landroid/view/Surface;
