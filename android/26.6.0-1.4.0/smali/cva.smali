...
.method public static e(Ljava/util/ArrayList;I)Lzta;
    .locals 19
    ...
    invoke-static {v0}, Laua;->g(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    invoke-static {v7}, Laua;->h(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v9

    invoke-static {v7}, Laua;->f(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v10

    invoke-static {v7}, Laua;->b(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v11

    invoke-static {v7}, Laua;->a(Landroid/app/RemoteInput;)Z
    ...
    invoke-static {v7}, Lfua;->c(Landroid/app/RemoteInput;)I
    ...
    :goto_1
    invoke-static {v7}, Laua;->d(Landroid/app/RemoteInput;)Landroid/os/Bundle;

    move-result-object v14

    const/4 v15, 0x0

    invoke-direct/range {v8 .. v15}, Lv0e;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V
    ...
    invoke-static {v0}, Laua;->c(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v0}, Ldua;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Leua;->a(Landroid/app/Notification$Action;)I
    ...
    invoke-static {v0}, Lfua;->e(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lgua;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lcua;->a(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct/range {v7 .. v18}, Lzta;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Lv0e;[Lv0e;ZIZZZ)V
    ...
    invoke-static {v1}, Luf7;->d(Ljava/lang/Object;)I
    ...
    invoke-static {v1}, Luf7;->b(Ljava/lang/Object;)I
    ...
    :cond_b
    invoke-static {v1}, Luf7;->a(Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
