...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lgwf;

    return-void
.end method

.method public static b(Landroid/app/job/JobParameters;)Lsqi;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Lsqi;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final a(Lsqi;Z)V
    ...
    iget-object v3, p1, Lsqi;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lgwf;

    invoke-virtual {v0, p1}, Lgwf;->e(Lsqi;)Lfwf;
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lzqi;
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lzqi;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lzqi;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->b(Landroid/app/job/JobParameters;)Lsqi;
    ...
    invoke-virtual {p1, v0, v1}, Lm0j;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, Lm0j;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lvgg;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1}, Lvgg;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    invoke-static {p1}, Lwgg;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    :cond_5
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lzqi;

    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lgwf;

    invoke-virtual {v0, v2}, Lgwf;->h(Lsqi;)Lfwf;

    move-result-object v0

    invoke-virtual {p1, v0, v1}, Lzqi;->h(Lfwf;Lqh3;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p1, v0, v2}, Lm0j;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1, v2}, Lm0j;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lgwf;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lzqi;

    iget-object v4, v3, Lzqi;->d:Limi;

    new-instance v5, Lx4g;

    invoke-direct {v5, v3, v2, v0}, Lx4g;-><init>(Lzqi;Lfwf;Z)V

    invoke-virtual {v4, v5}, Limi;->n(Ljava/lang/Runnable;)V
    ...
    iget-object p1, p1, Lsqi;->a:Ljava/lang/String;

    iget-object v3, v0, Laoc;->v0:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v0, v0, Laoc;->t0:Ljava/util/HashSet;
