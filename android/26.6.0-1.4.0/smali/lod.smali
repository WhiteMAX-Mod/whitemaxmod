...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Llod;->o:Landroid/content/Context;
...
.method public final G(Lok4;)J
    ...
    iput-object v0, v1, Llod;->X:Lok4;

    invoke-virtual/range {p0 .. p1}, Lpl0;->c(Lok4;)V

    iget-object v2, v0, Lok4;->a:Landroid/net/Uri;

    iget-wide v3, v0, Lok4;->g:J
    ...
    iget-object v10, v1, Llod;->o:Landroid/content/Context;
    ...
    invoke-static {v15, v8, v7}, Lj64;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v7, v1, Llod;->Y:Landroid/content/res/AssetFileDescriptor;
    ...
    iget-object v9, v1, Llod;->Y:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v1, Llod;->Z:Ljava/io/FileInputStream;
    ...
    :cond_7
    :goto_5
    iget-object v11, v1, Llod;->Y:Landroid/content/res/AssetFileDescriptor;
    ...
    :goto_7
    iput-wide v5, v1, Llod;->s0:J

    :cond_c
    const/4 v11, 0x1

    iput-boolean v11, v1, Llod;->t0:Z
    ...
    invoke-static {v2, v4}, Ljye;->j(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v3, p0, Llod;->Z:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Llod;->Z:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Llod;->Y:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Llod;->Y:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Llod;->t0:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Llod;->t0:Z
    ...
    :try_start_4
    iget-object v4, p0, Llod;->Y:Landroid/content/res/AssetFileDescriptor;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Llod;->Z:Ljava/io/FileInputStream;
