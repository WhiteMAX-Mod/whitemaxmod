...
.method public static d(I[B)[B
    ...
    sget-object p0, Lvk0;->b:[B

    goto :goto_2

    :cond_2
    sget-object p0, Lvk0;->c:[B
...
.method public static final e(Lda4;)Ljava/lang/Object;
    .locals 5
    ...
    :cond_2
    iget-object v3, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lgd4;

    invoke-static {v3, v0}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeIsDispatchNeeded(Lgd4;Led4;)Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-virtual {p0, v0, v2}, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatchYield$kotlinx_coroutines_core(Led4;Ljava/lang/Object;)V
    ...
    sget-object v4, Leti;->b:Lyp4;

    invoke-direct {v3, v4}, Lo0;-><init>(Ldd4;)V
