...
# direct methods
.method public static A(I[J)Ljava/lang/String;
    .locals 8
...
.method public static B([Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;
    .locals 7
    ...
    invoke-static {p2, v5, v6}, Lwhe;->a(Ljava/lang/StringBuilder;Ljava/lang/Object;Lks6;)V
...
.method public static final D([Ljava/lang/Object;Ljava/util/HashSet;)V
    .locals 3
...
.method public static G([J)Ljava/util/Set;
    .locals 5
...
.method public static f([Ljava/lang/Object;)Lgwe;
    .locals 2
...
.method public static i([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {p0, p1}, Lnu;->z([Ljava/lang/Object;Ljava/lang/Object;)I
...
.method public static j([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    invoke-static {v4, v5}, Lnu;->j([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    :cond_c
    instance-of v6, v4, Le9h;

    const/4 v7, 0x0

    if-eqz v6, :cond_f

    instance-of v6, v5, Le9h;

    if-eqz v6, :cond_f

    check-cast v4, Le9h;

    iget-object v4, v4, Le9h;->a:[B

    check-cast v5, Le9h;

    iget-object v5, v5, Le9h;->a:[B
    ...
    :cond_f
    instance-of v6, v4, Lt9h;

    if-eqz v6, :cond_12

    instance-of v6, v5, Lt9h;

    if-eqz v6, :cond_12

    check-cast v4, Lt9h;

    iget-object v4, v4, Lt9h;->a:[S

    check-cast v5, Lt9h;

    iget-object v5, v5, Lt9h;->a:[S
    ...
    :cond_12
    instance-of v6, v4, Lj9h;

    if-eqz v6, :cond_15

    instance-of v6, v5, Lj9h;

    if-eqz v6, :cond_15

    check-cast v4, Lj9h;

    iget-object v4, v4, Lj9h;->a:[I

    check-cast v5, Lj9h;

    iget-object v5, v5, Lj9h;->a:[I
    ...
    instance-of v6, v5, Lo9h;

    if-eqz v6, :cond_18

    check-cast v4, Lo9h;

    iget-object v4, v4, Lo9h;->a:[J

    check-cast v5, Lo9h;

    iget-object v5, v5, Lo9h;->a:[J
...
.method public static n([BI[BI)V
    .locals 1
...
.method public static o(I[BI)[B
    .locals 1

    array-length v0, p1

    invoke-static {p2, v0}, Lpej;->b(II)V
...
.method public static p(II[Ljava/lang/Object;)[Ljava/lang/Object;
    .locals 1

    array-length v0, p2

    invoke-static {p1, v0}, Lpej;->b(II)V
