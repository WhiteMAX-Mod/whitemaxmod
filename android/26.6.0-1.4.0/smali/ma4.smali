...
.method public synthetic constructor <init>(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lc4b;-><init>(Z)V
...
.method public constructor <init>(Lone/me/startconversation/StartConversationScreen;Z)V
    ...
    .line 3
    invoke-direct {p0, p2}, Lc4b;-><init>(Z)V

    return-void
.end method

.method public constructor <init>(ZLks6;)V
    .locals 1
...
.method public a()V
    ...
    :cond_0
    iget-object v1, v0, Landroidx/fragment/app/c;->h:Llh0;

    if-eqz v1, :cond_2

    const/4 v2, 0x0

    iput-boolean v2, v1, Llh0;->r:Z

    new-instance v3, Lws5;

    const/4 v4, 0x7

    invoke-direct {v3, v4, v0}, Lws5;-><init>(ILjava/lang/Object;)V

    iget-object v4, v1, Llh0;->p:Ljava/util/ArrayList;
    ...
    iput-object v4, v1, Llh0;->p:Ljava/util/ArrayList;

    :cond_1
    iget-object v1, v1, Llh0;->p:Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Landroidx/fragment/app/c;->h:Llh0;

    invoke-virtual {v1, v2}, Llh0;->d(Z)I
    ...
    iput-object v1, v0, Landroidx/fragment/app/c;->h:Llh0;
...
.method public final b()V
    ...
    iget-object v3, p0, Lma4;->e:Ljava/lang/Object;

    packed-switch v0, :pswitch_data_0

    check-cast v3, Lone/me/startconversation/StartConversationScreen;

    iget-object v0, v3, Lone/me/startconversation/StartConversationScreen;->w0:Lgrd;
    ...
    invoke-interface {v0, v3, v1}, Lgrd;->D(Ljava/lang/Object;Lv58;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lone/me/settings/multilang/SettingsLocaleScreen;->J0()V
    ...
    invoke-virtual {v3}, Lone/me/qrscanner/QrScannerWidget;->K0()Le7d;
    ...
    invoke-virtual {v3}, Lone/me/profileedit/screens/adminpermissions/ProfileEditAdminPermissionsWidget;->I0()Ljsc;

    move-result-object v0

    invoke-virtual {v0}, Ljsc;->x()V
    ...
    invoke-virtual {v3}, Lone/me/login/inputname/InputNameScreen;->M0()V
    ...
    iget-object v9, v3, Landroidx/fragment/app/c;->h:Llh0;
    ...
    :cond_6
    iget-object v6, v3, Landroidx/fragment/app/c;->h:Llh0;

    iget-object v6, v6, Llh0;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Lfp6;->b:Landroidx/fragment/app/a;
    ...
    iget-object v6, v2, Lav4;->c:Ljava/util/ArrayList;
    ...
    :cond_9
    invoke-virtual {v2, v6}, Lav4;->i(Ljava/util/List;)V

    invoke-virtual {v2, v6}, Lav4;->c(Ljava/util/List;)V

    goto :goto_3

    :cond_a
    iget-object v1, v3, Landroidx/fragment/app/c;->h:Llh0;
    ...
    :cond_c
    iput-object v8, v3, Landroidx/fragment/app/c;->h:Llh0;

    invoke-virtual {v3}, Landroidx/fragment/app/c;->j0()V
    ...
    :cond_10
    iget-object v0, v3, Landroidx/fragment/app/c;->g:Lk4b;
    ...
    invoke-virtual {v3, v2}, Lone/me/calls/ui/ui/call/CallScreen;->M0(Z)V
    ...
    sget-object v0, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->s0:Lmqa;

    invoke-virtual {v3}, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->J0()Lwd1;

    move-result-object v0

    iget-object v0, v0, Lwd1;->t0:Lhxf;
    ...
    invoke-direct {v3, v2, v2}, Lsd1;-><init>(ZZ)V
    ...
    invoke-virtual {v3}, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->H0()Llt;

    move-result-object v0

    iget-object v0, v0, Llt;->E0:Ltn5;
    ...
    iget-object v0, v3, Lpa4;->router:Ljbe;
    ...
    invoke-virtual {p0, v2}, Lc4b;->f(Z)V

    invoke-virtual {v3}, Lpa4;->getOnBackPressedDispatcher()Lk4b;

    move-result-object v0

    invoke-virtual {v0}, Lk4b;->d()V

    iget-boolean v0, v3, Lpa4;->isBeingDestroyed:Z

    if-nez v0, :cond_14

    invoke-virtual {p0, v1}, Lc4b;->f(Z)V
...
.method public c(Lkh0;)V
    ...
    :cond_0
    iget-object v2, v0, Landroidx/fragment/app/c;->h:Llh0;

    if-eqz v2, :cond_6

    new-instance v2, Ljava/util/ArrayList;

    iget-object v4, v0, Landroidx/fragment/app/c;->h:Llh0;
    ...
    :cond_2
    iget-object v5, v5, Lav4;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Lbsf;->k:Ljava/util/ArrayList;

    invoke-static {v7, v6}, Lkk3;->q(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
    ...
    invoke-static {v5}, Lek3;->Z(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v8, p1}, Lasf;->c(Lkh0;)V
...
.method public d()V
    ...
    invoke-direct {v1, v0}, Lyo6;-><init>(Landroidx/fragment/app/c;)V

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroidx/fragment/app/c;->y(Lwo6;Z)V
