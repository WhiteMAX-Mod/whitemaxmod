...
.method private final getPosition(Ljava/lang/Long;)Lpba;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lnba;-><init>(J)V

    return-object v0

    :cond_1
    :goto_0
    sget-object p1, Loba;->a:Loba;
...
.method private final updateState(Lvba;)V
    .locals 12
    ...
    iget-object v3, v1, Luba;->a:Ldw1;

    iget-object v3, v3, Ldw1;->b:Ljl1;
    ...
    iget-object v11, v3, Ldw1;->c:Lmba;
    ...
    :cond_2
    iget-object v3, v3, Ldw1;->a:Layh;

    sget-object v5, Lsba;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Ljba;->d:Lrba;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Ljba;->a:Lmba;

    invoke-virtual {v8, v11}, Lmba;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Luba;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lpba;

    move-result-object v5

    iget-boolean v2, v1, Luba;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Luba;->b:F

    invoke-static {v7}, Lzba;->a(F)V

    iget-boolean v8, v1, Luba;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lpba;ZFZLjba;Lfq4;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lw1f;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lw1f;Ljba;)V
...
.method public final onVideoStarted(Ltba;)V
    .locals 12
    ...
    iget-object v11, v7, Ljba;->a:Lmba;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lpba;ZFZLjba;Lfq4;)V
    ...
    iget-object p1, p1, Ltba;->b:Lw1f;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lw1f;Ljba;)V
...
.method public final onVideoStatesUpdatedChanged(Lvba;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lvba;)V
...
.method public final onVideoStopped(Lwba;)V
    .locals 4
    ...
    iget-object v2, p1, Lwba;->b:Lw1f;

    iget-object v3, p1, Lwba;->c:Lmba;

    iget-object p1, p1, Lwba;->d:Lrba;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lw1f;Lmba;Lrba;)V
