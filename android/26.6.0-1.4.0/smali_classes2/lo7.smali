...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v10, v1, Llo7;->b:Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v2, v9, v10}, Lxde;->G(ILjava/lang/String;)V
    ...
    :goto_0
    invoke-static {v6}, Lv9;->g(Ljava/lang/Integer;)Lngh;
    ...
    :try_start_1
    invoke-interface {v2, v9}, Lxde;->e(I)V
    ...
    invoke-static {v3}, Lrqj;->e(Ljava/lang/String;)Ljava/util/EnumSet;
    ...
    invoke-static {v4, v3}, Lhr9;->mergeFrom(Lhr9;[B)Lhr9;

    iget-object v3, v4, Lru/ok/tamtam/nano/Protos$MessageElements;->elements:[Lru/ok/tamtam/nano/Protos$MessageElement;

    invoke-static {v3}, Lap9;->a([Lru/ok/tamtam/nano/Protos$MessageElement;)Ljava/util/ArrayList;
    ...
    :goto_c
    invoke-static {v3}, Lrqj;->b([B)Ljava/util/Map;
    ...
    :goto_d
    invoke-static {v3}, Lrqj;->c([B)Ljava/util/List;
    ...
    invoke-direct {v4, v5}, Lpj6;-><init>(I)V

    invoke-static {v4, v3}, Lhr9;->mergeFrom(Lhr9;[B)Lhr9;

    invoke-static {v4}, Lugj;->b(Lpj6;)Ljava/util/EnumSet;
    ...
    :goto_11
    invoke-static {v3}, Lrqj;->a([B)Ljava/util/ArrayList;
    ...
    :goto_13
    new-instance v17, Lr7e;

    move/from16 v20, v0

    invoke-direct/range {v17 .. v32}, Lr7e;-><init>(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/util/Set;ZLjava/util/List;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;JLjava/util/List;Ljava/lang/Long;Ljava/lang/Long;)V
    :try_end_4
    ...
    invoke-virtual {v2, v0, v10}, Lope;->g(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v2, v10}, Lau1;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v4}, Lss9;-><init>(Ljava/lang/Runnable;I)V

    invoke-static {v2, v3}, Lc2j;->b(Ljava/lang/String;Lis6;)V
    ...
    invoke-direct {v3, v0, v5}, Lss9;-><init>(Ljava/lang/Runnable;I)V
    ...
    :try_start_5
    invoke-interface {v2, v5, v10}, Lxde;->G(ILjava/lang/String;)V
    ...
    invoke-static {v4}, Llaj;->j(I)Ldp7;
    ...
    invoke-direct/range {v17 .. v36}, Lep7;-><init>(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;BBJJLjava/lang/String;Ldp7;JJJI)V
    :try_end_5
