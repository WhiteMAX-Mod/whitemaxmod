...
.method public constructor <init>(Landroid/view/View;Lus7;Lks6;)V
    ...
    iput-object p1, p0, Lrxf;->a:Landroid/view/View;

    iput-object p2, p0, Lrxf;->b:Lus7;

    iput-object p3, p0, Lrxf;->c:Lks6;
    ...
    invoke-direct {p2, p3, p0}, Lswf;-><init>(ILjava/lang/Object;)V
    ...
    iput-object p3, p0, Lrxf;->h:Landroid/graphics/Rect;
    ...
    :goto_1
    iput-object v0, p0, Lrxf;->i:Landroid/graphics/Rect;
    ...
    sget-object p2, Lvs7;->a:Ldia;

    invoke-virtual {p2, p0}, Ldia;->a(Ljava/lang/Object;)V
    ...
    invoke-direct {p2, p3, p0}, Ly60;-><init>(ILjava/lang/Object;)V
...
# virtual methods
.method public final a(Lss7;Lbv0;)V
    .locals 3
    ...
    iget-object v0, p0, Lrxf;->i:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object p2, p0, Lrxf;->h:Landroid/graphics/Rect;
...
.method public c(Ldqi;)V
    ...
    iget-object v3, v0, Lrxf;->b:Lus7;

    iget v4, v3, Lus7;->a:I

    const/16 v5, 0x80

    iget-object v6, v0, Lrxf;->h:Landroid/graphics/Rect;

    const-string v7, "null cannot be cast to non-null type android.view.ViewGroup.MarginLayoutParams"

    iget-object v8, v0, Lrxf;->i:Landroid/graphics/Rect;
    ...
    iget-object v13, v0, Lrxf;->a:Landroid/view/View;

    iget v14, v0, Lrxf;->d:I

    if-eqz v4, :cond_5

    or-int v15, v5, v14

    invoke-virtual {v2, v15}, Lbqi;->f(I)Lss7;

    move-result-object v15

    iget v15, v15, Lss7;->a:I
    ...
    invoke-virtual {v2, v5}, Lbqi;->f(I)Lss7;
    ...
    invoke-virtual {v2, v14}, Lbqi;->f(I)Lss7;
    ...
    :cond_11
    :goto_2
    iget-object v2, v3, Lus7;->d:Lbv0;

    if-eqz v2, :cond_12

    invoke-virtual {v0, v1, v2}, Lrxf;->b(Ldqi;Lbv0;)V

    :cond_12
    iget-object v2, v0, Lrxf;->c:Lks6;

    if-eqz v2, :cond_13

    invoke-interface {v2, v1}, Lks6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_13
    return-void
.end method

.method public d(Ldqi;)Ldqi;
    .locals 0
