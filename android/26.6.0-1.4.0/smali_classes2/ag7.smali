...
.method public constructor <init>(Landroid/content/Context;Lks6;)V
    ...
    iput-object p1, p0, Lag7;->b:Landroid/graphics/drawable/Drawable;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lag7;->d:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lag7;->t0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lag7;->u0:Landroid/graphics/Matrix;

    const/4 p1, 0x0

    const/high16 p2, 0x3f400000    # 0.75f

    invoke-static {p1, p2}, Lprj;->g(IF)I
...
# virtual methods
.method public final a(Landroid/graphics/Canvas;FFFILyf7;)V
    .locals 13
    ...
    sget-object v9, Lyf7;->d:Lyf7;

    if-eq v2, v9, :cond_1

    iget-object v10, v2, Lyf7;->a:Ljava/util/List;
    ...
    :goto_1
    invoke-interface {v8, v5}, Lks6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lag7;->d:Landroid/graphics/Rect;

    invoke-virtual {v7, v6, v8, v9, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v5, p0, Lag7;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    sget-object v4, Lzf7;->$EnumSwitchMapping$0:[I
    ...
    invoke-virtual/range {v0 .. v6}, Lag7;->a(Landroid/graphics/Canvas;FFFILyf7;)V

    sget-object v6, Lyf7;->c:Lyf7;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v6, p0, Lag7;->v0:[I

    invoke-direct/range {v2 .. v8}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v0, p0, Lag7;->u0:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lag7;->t0:Landroid/graphics/Paint;
    ...
    sget-object v8, Lyf7;->d:Lyf7;

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Lag7;->a(Landroid/graphics/Canvas;FFFILyf7;)V
