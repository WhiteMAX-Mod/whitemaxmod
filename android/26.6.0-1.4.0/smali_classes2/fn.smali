...
.method public synthetic constructor <init>(Lcom/my/tracker/applifecycle/o/d;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p4, p0, Lfn;->d:Ljava/io/Serializable;

    iput-object p5, p0, Lfn;->o:Ljava/io/Serializable;

    iput-object p6, p0, Lfn;->X:Ljava/io/Serializable;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;Lfo;Lgn;Lru/ok/android/api/core/ApiInvocationException;Lyyd;Lyyd;)V
    .locals 0
...
.method public c(Ljn;)Ljn;
    ...
    iget-object v1, p0, Lfn;->c:Ljava/lang/Object;

    check-cast v1, Lgn;

    iget-object v2, p0, Lfn;->d:Ljava/io/Serializable;

    check-cast v2, Lru/ok/android/api/core/ApiInvocationException;

    iget-object v3, p0, Lfn;->o:Ljava/io/Serializable;

    check-cast v3, Lyyd;

    iget-object v4, p0, Lfn;->X:Ljava/io/Serializable;

    check-cast v4, Lyyd;

    iget-object v1, v1, Lgn;->c:Lho;

    iget-object v5, p1, Ljn;->c:Ljava/lang/String;

    iget-object v6, p0, Lfn;->a:Ljava/lang/String;
    ...
    iget-object v6, p1, Ljn;->a:Ljava/lang/String;

    iget-object p1, p1, Ljn;->b:Ljava/lang/String;

    const/4 v7, 0x0

    invoke-direct {v5, v6, p1, v7, v7}, Ljn;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v6, Lfo;->d:Lfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-eq v0, v6, :cond_7

    sget-object v7, Lfo;->c:Lfo;
    ...
    :cond_2
    :try_start_1
    iget-object v5, p1, Ljn;->b:Ljava/lang/String;
    ...
    :cond_4
    invoke-interface {v1, p1}, Lho;->f(Ljn;)Ljn;
    ...
    :goto_2
    iget-object v5, v1, Ljn;->c:Ljava/lang/String;
    ...
    :cond_6
    iput-object v1, v4, Lyyd;->a:Ljava/lang/Object;
...
.method public invoke(Lcom/my/tracker/core/EngineCore$InsertEventTools;)[B
    ...
    iget-object v0, p0, Lfn;->d:Ljava/io/Serializable;

    move-object v4, v0

    check-cast v4, Ljava/lang/String;

    iget-object v0, p0, Lfn;->o:Ljava/io/Serializable;

    move-object v5, v0

    check-cast v5, Ljava/lang/String;

    iget-object v0, p0, Lfn;->X:Ljava/io/Serializable;
