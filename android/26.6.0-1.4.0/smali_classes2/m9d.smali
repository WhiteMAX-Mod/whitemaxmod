...
# instance fields
.field public final A0:Lbhb;

.field public final B0:Lbhb;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lm9d;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lm9d;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v10}, Ltea;->n(Landroid/content/Context;)Lfe3;
    ...
    iput-object v5, v0, Lm9d;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lbhb;

    invoke-direct {v10, v1}, Lbhb;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Lygb;->b:Lygb;

    invoke-virtual {v10, v2}, Lbhb;->setMode(Lygb;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lbhb;->a(FILjava/lang/String;)V

    new-instance v9, Lg9d;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lg9d;-><init>(Lm9d;I)V

    invoke-static {v10, v9}, Lwuj;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lm9d;->v0:Lbhb;
    ...
    invoke-virtual {v7, v13}, Ltea;->n(Landroid/content/Context;)Lfe3;
    ...
    iput-object v9, v0, Lm9d;->w0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v6}, Ltea;->n(Landroid/content/Context;)Lfe3;
    ...
    invoke-static {v3, v6}, Lu1j;->d(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {v6, v7}, Lu1j;->d(Landroid/graphics/drawable/Drawable;I)V
    ...
    iput-object v13, v0, Lm9d;->x0:Landroid/widget/LinearLayout;

    new-instance v3, Lbhb;

    invoke-direct {v3, v1}, Lbhb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lbhb;->setMode(Lygb;)V

    new-instance v6, Lg9d;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lg9d;-><init>(Lm9d;I)V

    invoke-static {v3, v6}, Lwuj;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lm9d;->y0:Lbhb;

    new-instance v6, Le42;

    invoke-direct {v6, v1}, Le42;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lg9d;-><init>(Lm9d;I)V

    invoke-static {v6, v7}, Lwuj;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lm9d;->z0:Le42;

    new-instance v7, Lbhb;

    invoke-direct {v7, v1}, Lbhb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lbhb;->setMode(Lygb;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lbhb;->a(FILjava/lang/String;)V

    new-instance v8, Lg9d;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lg9d;-><init>(Lm9d;I)V

    invoke-static {v7, v8}, Lwuj;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lm9d;->A0:Lbhb;

    new-instance v8, Lbhb;

    invoke-direct {v8, v1}, Lbhb;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lbhb;->setMode(Lygb;)V

    new-instance v2, Lg9d;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lg9d;-><init>(Lm9d;I)V

    invoke-static {v8, v2}, Lwuj;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lm9d;->B0:Lbhb;
    ...
    invoke-direct {v3, v2, v1, v7}, Lus7;-><init>(ILbv0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lqaj;->b(Landroid/view/View;Lus7;Lks6;)V

    iput-object v6, v0, Lm9d;->C0:Landroid/widget/FrameLayout;

    new-instance v1, Lh9d;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lh9d;-><init>(Lm9d;I)V

    invoke-static {v2, v1}, Lbdj;->d(ILis6;)Lj88;

    move-result-object v1

    iput-object v1, v0, Lm9d;->D0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lm9d;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lm9d;->F0:Ljava/lang/Object;
...
.method public static final synthetic a(Lm9d;)Z
    .locals 0

    invoke-direct {p0}, Lm9d;->getCanRecordingVideo()Z
...
.method public static final b(Lm9d;Lg32;)V
    .locals 6
    ...
    invoke-direct {p0}, Lm9d;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lm9d;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lm9d;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lm9d;->y0:Lbhb;

    sget v2, Lm9d;->G0:F

    invoke-virtual {v1, v0, v5, v2}, Lbhb;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Lm9d;->getCameraApi()Lh32;
    ...
    invoke-interface {p0, p1}, Lh32;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lm9d;FFFFF)V
    .locals 2

    iget-object v0, p0, Lm9d;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lm9d;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lm9d;->C0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lm9d;->D0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lm9d;->F0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lm9d;->E0:Ljava/lang/Object;
...
.method public final getCameraApi()Lh32;
    .locals 1

    iget-object v0, p0, Lm9d;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
