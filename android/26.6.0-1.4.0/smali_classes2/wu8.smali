...
# direct methods
.method public constructor <init>(Landroid/widget/EditText;Laxf;ZLxh5;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lwu8;->a:Landroid/widget/EditText;

    iput-object p2, p0, Lwu8;->b:Laxf;

    iput-boolean p3, p0, Lwu8;->c:Z

    iput-object p4, p0, Lwu8;->d:Lxh5;

    new-instance p1, Lkha;

    invoke-direct {p1}, Lkha;-><init>()V

    iput-object p1, p0, Lwu8;->e:Lkha;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-direct {p1, v1}, Lpt0;-><init>(I)V

    invoke-static {p2, p3, p4, v1, p1}, Lahj;->g(Landroid/text/Editable;IIZLxu8;)V

    return-void

    :cond_0
    sget v0, Llgd;->markdown_italic:I
    ...
    invoke-direct {p1, v2}, Lpt0;-><init>(I)V
    ...
    :cond_1
    sget v0, Llgd;->markdown_underline:I

    if-ne p1, v0, :cond_2

    new-instance p1, Lt6g;

    invoke-direct {p1, v2}, Lt6g;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Lahj;->g(Landroid/text/Editable;IIZLxu8;)V

    return-void

    :cond_2
    sget v0, Llgd;->markdown_mono:I
    ...
    :cond_3
    sget v0, Llgd;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Lt6g;

    invoke-direct {p1, v1}, Lt6g;-><init>(I)V
    ...
    :cond_4
    sget v0, Llgd;->markdown_heading:I
    ...
    :cond_5
    sget v0, Llgd;->markdown_quote:I

    sget-object v3, Lmah;->a:Lmah;

    iget-object v4, p0, Lwu8;->a:Landroid/widget/EditText;
    ...
    sget v0, Logd;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Lwu8;->b()Lz9d;

    move-result-object p4

    new-instance v0, Laad;

    invoke-direct {v0, p4}, Laad;-><init>(Lz9d;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Lchj;->c(Landroid/text/Spannable;Lxu8;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Lahj;->h(Landroid/text/Spannable;Lxu8;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Logd;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Lqjj;->b(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Logd;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Llgd;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Lahj;->h(Landroid/text/Spannable;Lxu8;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Lahj;->e(Landroid/text/Spannable;II)V
...
.method public final b()Lz9d;
    .locals 20

    move-object/from16 v0, p0

    iget-object v1, v0, Lwu8;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Lmtj;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v18}, Lz9d;-><init>(Landroid/content/Context;Laxf;Lgob;Lipg;Landroid/graphics/drawable/Drawable;IIIIIIIIIIF)V
    ...
    invoke-direct {v1, v4, v3}, Lj8d;-><init>(ILjava/lang/Object;)V

    iput-object v1, v2, Lz9d;->f:Lj8d;
...
.method public final c()Z
    ...
    iget-object v0, p0, Lwu8;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Lue8;->c:Ljava/lang/String;

    iget-object v0, v2, Lxh5;->a:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->M0:[Lv58;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lj88;
    ...
    invoke-direct {v1, p2, p3, p1}, Lmb;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Lxh5;->a:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lj88;
    ...
    iget-object p1, p1, Lyu8;->c:Ltn5;

    new-instance v0, Lmb;

    invoke-direct {v0, p2, p3, v1}, Lmb;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Lwu8;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Llgd;->markdown_italic:I
    ...
    :cond_2
    sget v5, Llgd;->markdown_underline:I
    ...
    :cond_4
    sget v5, Llgd;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Llgd;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Lwu8;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Llgd;->markdown_heading:I
    ...
    :cond_8
    sget v5, Llgd;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Lwu8;->e:Lkha;

    invoke-virtual {p1}, Lkha;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lkha;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lkha;->a(I)V

    invoke-virtual {p0}, Lwu8;->c()Z
    ...
    invoke-virtual {p1, v3}, Lkha;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Lsu8;->X:Lsu8;

    iget v2, v1, Lsu8;->a:I

    iget-object v3, p0, Lwu8;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lkha;->a(I)V
